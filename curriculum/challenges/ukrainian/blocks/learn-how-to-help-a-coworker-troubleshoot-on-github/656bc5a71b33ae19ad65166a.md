...
Зверніть увагу, як використання Бобом минулого безперервного часу може передавати кілька одночасних дій у розповіді.
...
Вказує на безперервну дію завантаження функції в той час.
...
Показує, що тести безперервно провалювалися, поки Боб працював.
