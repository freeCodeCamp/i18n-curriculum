...
Mwisho wa kitendakazi chako, rudisha data uliyoihesabu ili iweze kutumika nje ya kitendakazi.

Rudisha orodha ya `distances` fupi kutoka `start_node` hadi nodi zote nyingine pamoja na orodha ya `paths` zinazosababisha kila nodi

# --hints--

Unapaswa kuwa na tamko la `return` mwishoni mwa kitendakazi chako.
...
Unapaswa kurudisha `distances` na `paths` zote mbili.
