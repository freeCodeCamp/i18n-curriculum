...
Tu diccionario `constraints` debe tener una clave `medications`.
...
La clave `medications` de tu diccionario `constraints` debe tener el valor de `isinstance(medications, list)`.
