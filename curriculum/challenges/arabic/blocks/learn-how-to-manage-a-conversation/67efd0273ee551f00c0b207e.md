...
هذا يصف شيئًا مستمرًا أو لا يزال جاريًا.

# --explanation--

`Ongoing` تعني شيئًا لا يزال يحدث أو مستمرًا مع مرور الوقت. على سبيل المثال:

`The team is working on an ongoing investigation into the issue.` – في هذه الجملة، `ongoing` تُظهر أن التحقيق لم ينتهِ بعد.
