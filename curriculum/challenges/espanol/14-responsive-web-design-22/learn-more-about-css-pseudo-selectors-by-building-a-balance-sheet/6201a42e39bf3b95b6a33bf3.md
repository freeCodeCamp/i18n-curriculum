...
Tu selector `tr.data th .description` debe tener una propiedad `display` establecida en `block`.

```js
assert(new __helpers.CSSHelp(document).getStyle('tr.data th .description')?.getPropertyValue('display') === 'block');
```

Tu selector `tr.data th .description` debe tener una propiedad `font-style` establecida en `italic`.

```js
assert(new __helpers.CSSHelp(document).getStyle('tr.data th .description')?.getPropertyValue('font-style') === 'italic');
```

Tu selector `tr.data th .description` debe tener una propiedad `font-weight` establecida en `normal`.

```js
assert(new __helpers.CSSHelp(document).getStyle('tr.data th .description')?.getPropertyValue('font-weight') === 'normal');
```

Tu selector `tr.data th .description` debe tener una propiedad `padding` establecida en `1rem 0 0.75rem`.

```js
assert(new __helpers.CSSHelp(document).getStyle('tr.data th .description')?.getPropertyValue('padding') === '1rem 0px 0.75rem');
```

Tu selector `tr.data th .description` debe tener una propiedad `margin-right` establecida en `-13.5rem`.
