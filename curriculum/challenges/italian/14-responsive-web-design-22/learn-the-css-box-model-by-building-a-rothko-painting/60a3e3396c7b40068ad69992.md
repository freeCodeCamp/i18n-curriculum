...
Arrotonda gli angoli dell'elemento `.one` di 9 pixel, usando la proprietà `border-radius`.

# --hints--

Dovresti assegnare alla proprietà `border-radius` il valore `9px`.
...
Il selettore `.one` dovrebbe avere una proprietà `border-radius` con il valore `9px`.
