...
Тепер ми не можемо прочитати текст. Задайте `footer` та елементу посилання всередині нього колір шрифту з достатнім коефіцієнтом контрастності.
...
Ви повинні встановити `color` на значення з коефіцієнтом контрастності не менше ніж `7:1`. _Підказка: я пропоную `#dfdfe2`_
