...
Añade un detector de eventos para el evento `click` a `scaryStoryBtn` y pásale la función `displayStory`. Luego, haga clic en el botón y vea la salida en la consola.

# --hints--

Debes añadir un detector de eventos para el evento `click` a `scaryStoryBtn`, pasándole la función `displayStory`.
