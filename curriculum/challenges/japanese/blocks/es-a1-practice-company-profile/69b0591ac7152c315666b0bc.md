...
このタスクでは、会話の中で特定の情報がどのように尋ねられているかの理解を確認します。

# --instructions--

会話を読んで、次の文が正しいか間違っているかを判断してください。

# --questions--

## --text--

次の文は正しいですか、それとも間違っていますか：セバスティアンが`¿Cuál es su sitio web?`と尋ねるとき、彼は会社のウェブサイトのアドレスを尋ねています。
...
この文脈で`¿Cuál...?`がどのような種類の情報を尋ねるために使われているかを確認してください。
...
`¿Cuál...?`は特定の情報や識別を尋ねるために使われます。例えば：

- `¿Cuál es tu nombre?` - あなたの名前は何ですか？

- `¿Cuál es tu número de teléfono?` - あなたの電話番号は何ですか？

会話の中で、`¿Cuál es su sitio web?`は特定の情報、つまりウェブサイトを尋ねています。

`Su`は会社（その）を指し、`es`は主語が`su sitio web`なので三人称単数形です。
