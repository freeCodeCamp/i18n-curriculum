...
When Sarah asks, `Are you into these activities?`, she uses `these` to refer back to something Tom just mentioned. Таким чином можна вказати на види діяльності, про які вона розповідає, не повторюючи цілої фрази.
