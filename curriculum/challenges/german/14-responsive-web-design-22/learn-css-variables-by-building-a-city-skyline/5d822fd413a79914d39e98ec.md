...
Du solltest zwei `div`-Elemente als die ersten untergeordneten Elemente von `.foreground-buildings` hinzufügen.
...
Du solltest ein `div`-Element zwischen `.fb2` und `.fb3` hinzufügen.
...
Du solltest zwei `div`-Elemente als die letzten untergeordneten Elemente von `.foreground-buildings` hinzufügen.
...
Du solltest 5 neue `div`-Elemente hinzugefügt haben.
