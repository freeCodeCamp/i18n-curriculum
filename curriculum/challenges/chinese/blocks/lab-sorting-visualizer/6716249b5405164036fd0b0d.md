...
本实验已为你提供了所有的超文本标记语言和 CSS。你将使用 JavaScript 完成冒泡排序可视化工具，使其能够可视化冒泡排序算法对五个整数数组进行排序所需的每一步。
...
点击 `#sort-btn` 后，`#array-container` 中的每个 `div` 都应包含五个 `span`，每个都以一个数字作为其文本，并排列以表示 Bubble Sort 算法对初始数组进行排序所需的步骤。
