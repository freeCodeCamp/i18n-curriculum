...
Anidar un `div` con una clase de `bb1` en el contenedor de edificios de fondo. Abra su archivo `styles.css`, y asigne a `.bb1` un `width` de `10%` y un `height` de `70%`. "bb" significa "building background", este será tu primer edificio.
