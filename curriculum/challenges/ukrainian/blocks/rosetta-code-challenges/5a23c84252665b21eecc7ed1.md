...
Задача про рюкзак 0-1 визначається так:

Вам дано масив об’єктів, які представляють елементи для покладання в рюкзак. Об’єкти мають 3 атрибути: назва, вага та значення. Потрібно вибрати елементи так, щоб загальна вага не перевищувала максимальну вагу, а значення було максимальним.
