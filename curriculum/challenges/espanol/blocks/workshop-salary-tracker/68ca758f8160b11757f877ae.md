...
Tu sentencia `if` debería comparar `Employee._base_salaries[new_level]` con `Employee._base_salaries[self.level]` para verificar si el nuevo nivel tiene un salario base menor.
