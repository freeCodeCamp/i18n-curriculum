...
Це тип даних, який використовується для збереження тексту.
...
Це слово використовується, щоб позначити тип числа; це цілі числа без дробів або десяткових частин.
...
Воно позначає символи або значення, які люди використовують для підрахунку, вимірювання або маркування речей.
...
Це скорочення від "integer"; цей тип даних використовується в програмуванні для збереження цілих чисел.
