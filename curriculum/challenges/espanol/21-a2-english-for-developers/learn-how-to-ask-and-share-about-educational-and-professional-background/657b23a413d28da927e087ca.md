...
`Most` is an adjective you can use when to talk about the biggest part of something. Por ejemplo:

`We completed most of our work before lunch,` it means a group finished the biggest part of their work.

`Mostly` es un adverbio. You use it to talk about what something is like most of the time. For exemple:
