...
Todavía dentro de tu función, añade el objeto `prettyPolly` a tu conjunto.

# --hints--

Deberías usar el método `add` para agregar el objeto `prettyPolly` dentro de la función `displayPlantsSet`.
