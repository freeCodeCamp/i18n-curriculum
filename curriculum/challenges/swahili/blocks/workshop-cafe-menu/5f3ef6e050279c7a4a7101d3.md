...
Hiyo inaonekana bora zaidi. Sasa jaribu kuongeza nafasi ya ndani ya `20px` juu na chini ya menyu.

# --hints--

Haupaswi kuondoa sifa za `padding-left` au `padding-right`.
...
Unapaswa kuweka sifa ya `padding-top` kuwa `20px`.
...
Unapaswa kuweka sifa ya `padding-bottom` kuwa `20px`.
...
Kipengele chako cha `.menu` kinapaswa kuwa na nafasi ya ndani ya `padding-top` ya `20px`.
