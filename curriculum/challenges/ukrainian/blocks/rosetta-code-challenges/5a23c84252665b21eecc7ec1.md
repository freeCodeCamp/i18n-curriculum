...
title: Квадратування ітерованих цифр
challengeType: 1
forumTopicId: 302291
...
Якщо додати квадрат цифр натурального числа (цілого числа, більшого за нуль), то завжди в кінці отримаєте або 1, або 89:
...
Напишіть функцію, яка приймає число як параметр і повертає 1 або 89 після виконання описаного процесу.
