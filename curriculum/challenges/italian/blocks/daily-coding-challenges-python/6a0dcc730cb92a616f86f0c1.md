...
`is_valid_schema({"username": "henry", "posts": 0, "verified": True, "role": "staff"})` dovrebbe restituire `True`.
...
`is_valid_schema({"username": "sara", "posts": 45, "verified": False, "role": "creator", "followers": 70})` dovrebbe restituire `True`.
...
`is_valid_schema({"username": "penelope", "posts": 20, "verified": True, "role": "admin"})` dovrebbe restituire `True`.
...
`is_valid_schema({"username": "kevin", "posts": 0, "verified": False, "role": "user"})` dovrebbe restituire `True`.
...
`is_valid_schema({"username": "george", "posts": 15, "verified": True, "role": "moderator"})` dovrebbe restituire `True`.
...
`is_valid_schema({"username": "david", "posts": 0, "verified": False, "role": "guest"})` dovrebbe restituire `False`.
...
`is_valid_schema({"username": "wendy", "posts": 10, "verified": True})` dovrebbe restituire `False`.
...
`is_valid_schema({"username": "fabian", "posts": 1, "verified": True, "role": True})` dovrebbe restituire `False`.
...
`is_valid_schema({"username": 8, "posts": 1, "verified": True, "role": "user"})` dovrebbe restituire `False`.
...
`is_valid_schema({"username": "penny", "posts": "10", "verified": True, "role": "staff"})` dovrebbe restituire `False`.
...
`is_valid_schema({"username": "john", "posts": "1", "verified": "true", "role": "admin"})` dovrebbe restituire `False`.
