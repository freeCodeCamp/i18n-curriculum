...
Встановіть значення властивості `msg` у наступний рядок:
...
Ваш об’єкт анімації на вершині стеку має мати властивість `msg`.
...
Ви повинні встановити значення властивості `msg` у `"decimalToBinary(1) returns '1' (base case) and gives that value to the stack below. Then it pops off the stack."`
