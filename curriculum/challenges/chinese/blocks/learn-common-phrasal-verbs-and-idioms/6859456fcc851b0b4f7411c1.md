...
The `Present Continuous` tense (`to be`+ verb in the `-ing` form) is often used to talk about scheduled future events, especially when arrangements have been made. 例如：
