...
`more`, `easier`, `better`, `as flexible`, `nicer`, `as easily` und `slightly`.
...
Dieses Komparativ-Adjektiv beschreibt etwas, das in der Qualität besser ist als ein anderes.
...
Dieses Wort wird verwendet, um den Komparativ von Adjektiven zu bilden. Es steht vor einem Adjektiv und zeigt einen höheren Grad an.  
...
Dieses Komparativ-Adjektiv bedeutet, dass etwas weniger Anstrengung erfordert.
...
Dieses Komparativ-Adjektiv bedeutet angenehmer oder attraktiver.
...
Dieses Adverb bedeutet ein wenig oder in geringem Maße.
...
Dieser Ausdruck wird in Vergleichen verwendet, um gleiche Anpassungsfähigkeit zu zeigen. Das erste Wort ist eine Konjunktion, das zweite ein Adjektiv.  
...
Dieser Ausdruck wird in Vergleichen verwendet, um gleiche Leichtigkeit einer Handlung zu zeigen. Das erste Wort ist eine Konjunktion, das zweite ein Adverb.
