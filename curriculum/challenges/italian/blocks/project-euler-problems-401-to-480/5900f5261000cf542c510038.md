...
title: 'Problema 441: la somma inversa delle coppie coprime'
challengeType: 1
forumTopicId: 302113
...
Per un intero $M$, definiamo $R(M)$ come la somma di $\frac{1}{p·q}$ per tutte le coppie di interi $p$ e $q$ che soddisfano tutte queste condizioni:

- $1 ≤ p &lt; q ≤ M$
- $p + q ≥ M$
- $p$ e $q$ sono coprimi.

Definiamo inoltre $S(N)$ come la somma di $R(i)$ per $2 ≤ i ≤ N$.

Possiamo verificare che $S(2) = R(2) = \frac{1}{2}$, $S(10) ≈ 6.9147$ e $S(100) ≈ 58.2962$.

Trova $S({10}^7)$. Fornisci la tua risposta arrotondata a quattro cifre decimali.
