...
Скопіюйте та вставте свій цілий клас `sky` разом із усіма його пропами та значеннями у медіазапит. Ви створите ще одну кольорову схему для силуету міста, яка змінюватиме його з денного на нічний.

Примітка: вам доведеться прокрутити повз редаговану область, щоб скопіювати клас.

# --hints--

Ви не повинні видаляти існуюче оголошення `.sky`.
...
Ви повинні скопіювати існуюче оголошення `.sky` у медіазапит.
