...
Mstatili ni mdogo sana na makali yake hayana ubora laini wa uchoraji.

Ongeza eneo na lainisha makali ya `.one` kwa kuweka `box-shadow` yake kuwa `0 0 3px 3px #efb762`.
