...
太好了！既然你已经练习了 datetime 格式化，删除代码底部的 `current_time` 变量和打印语句。我们将在下一步将时间戳集成到 `Email` 类中。

# --hints--

你的代码中不应有语句 `current_time = datetime.datetime.now()")`。
