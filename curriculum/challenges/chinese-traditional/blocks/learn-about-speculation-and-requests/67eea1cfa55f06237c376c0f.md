...
- 如果那個人有為這個 `You could have added a comment to explain this function.` 添加註解來說明它的功能，會更有幫助。

- `We could have added a search bar to make the website more user-friendly.` - 團隊當時在考慮添加搜尋欄，但尚未完成。
