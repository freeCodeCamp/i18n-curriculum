...
ワークショップの最後のステップでは、メッセージ `"It was fun learning about the different Math methods with you!"` をコンソールに出力します。

これで最後の変更が完了し、MathBot ワークショップを終了です！

# --hints--

メッセージ `"It was fun learning about the different Math methods with you!"` をコンソールに出力してください。
