...
In this lab, you'll build an app that will search for Pokémon by name or ID and display the results to the user. Щоб отримати дані та зображення покемонів, використайте <a href="https://pokeapi-proxy.freecodecamp.rocks/" target="_blank" rel="noopener noreferrer nofollow">PokéAPI Proxy</a> від freeCodeCamp.

Fulfill the user stories below and get all the tests to pass to complete the lab.

**Історія користувача:**

1. Ви повинні мати елемент `input` з `id="search-input"`.
1. Ви повинні мати елемент `button` з `id="search-button"`.
...
Ви повинні мати елемент `input` з `id` зі значенням `"search-input"`, який є **обов’язковим**.
...
Якщо елемент `#search-input` містить значення `Pikachu` та натиснути на елемент `#search-button`, то елемент `#types` повинен містити один внутрішній елемент зі значенням `ELECTRIC`. Переконайтеся, що вміст елемента `#types` очищено між пошуками.
...
Якщо елемент `#search-input` містить значення `94` та натиснути на елемент `#search-button`, то елемент `#types` повинен містити два внутрішні елементи з текстовими значеннями `GHOST` та `POISON` відповідно. Переконайтеся, що вміст елемента `#types` очищено між пошуками.
...
Коли елемент `#search-input` містить дійсний id Покемона та натискається елемент `#search-button`, інтерфейс користувача має бути заповнений правильними даними.
