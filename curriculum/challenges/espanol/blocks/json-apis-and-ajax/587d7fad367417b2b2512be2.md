...
Debes utilizar el método `document.getElementsByClassName` para seleccionar todos los elementos con la clase `message` para asignarles una cadena mediante el método `textContent`.
