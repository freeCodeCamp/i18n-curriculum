...
Переходимо до значка `Most popular`. Його потрібно розмістити у верхньому правому куті картки, тому ви можете використати деякі утиліти позиціонування Tailwind для цього.
