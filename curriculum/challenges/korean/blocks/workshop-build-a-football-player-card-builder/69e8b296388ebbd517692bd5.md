...
`form-group`의 `className`를 가진 다섯 번째 `div` 요소에는 `def`의 `htmlFor` 속성, `label`의 `className`, 텍스트 `DEF`를 가진 `label`가 있어야 합니다.
...
`form-group`의 `className`를 가진 다섯 번째 `div` 요소에는 `input`의 `className`, `def`의 `id`, `number`의 `type`를 가진 `input`가 있어야 합니다.
...
`form-group`의 `className`를 가진 여섯 번째 `div` 요소에는 `phy`의 `htmlFor` 속성, `label`의 `className`, 텍스트 `PHY`를 가진 `label`가 있어야 합니다.
...
`form-group`의 `className`를 가진 여섯 번째 `div` 요소에는 `input`의 `className`, `phy`의 `id`, `number`의 `type`를 가진 `input`가 있어야 합니다.
