...
Tu cuarto <code>p` debería tener el texto `Ampliamos el plan de estudios a 3 certificaciones, incluyendo Front End, Back End y Visualización de Datos. Cada uno tenía 10 proyectos requeridos, pero solo la sección de Front End tenía sus propios desafíos.  For the other certs, we were still using external resources like Node School.`
