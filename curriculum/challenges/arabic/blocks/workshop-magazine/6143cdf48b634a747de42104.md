...
داخل عنصر `.image-wrapper`، عرّف العنصر الثالث `img` بخاصية `src` تساوي `https://cdn.freecodecamp.org/testable-projects-fcc/images/survey-form-background.jpeg`، وخاصية `alt` تساوي `four people working on code`، وخاصية `loading` تساوي `lazy`، وصنف `class` يساوي `image-3`، وخاصية `width` تساوي `600`، وخاصية `height` تساوي `400`.

# --hints--

يجب أن يحتوي العنصر الثالث `img` على خاصية `src` تساوي `https://cdn.freecodecamp.org/testable-projects-fcc/images/survey-form-background.jpeg`.
...
يجب أن يحتوي العنصر الثالث `img` على خاصية `alt` تساوي `four people working on code`.
...
يجب أن يحتوي العنصر الثالث `img` على خاصية `loading` تساوي `lazy`.
...
يجب أن يحتوي العنصر الثالث `img` على صنف `class` يساوي `image-3`.
...
يجب أن يحتوي العنصر الثالث `img` على خاصية `width` تساوي `600`.
...
يجب أن يحتوي العنصر الثالث `img` على خاصية `height` تساوي `400`.
