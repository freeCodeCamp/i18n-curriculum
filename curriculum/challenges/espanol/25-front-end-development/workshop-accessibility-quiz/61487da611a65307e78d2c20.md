...
En pantallas pequeñas, la lista desordenada en la barra de navegación se desborda por el lado derecho de la pantalla.

Soluciona esto usando _Flexbox_ para envolver el contenido del `ul`. Luego, establece las siguientes propiedades CSS para alinear correctamente el texto:
