...
Ahora, usarás `grid` para organizar los elementos dentro del contenedor `div`.

Agrega las clases `grid`, `grid-rows-[1fr_auto]` y `gap-6` al `div` contenedor.

# --hints--

Tu elemento `div` contenedor para el plan familiar debe tener la clase `grid`.
...
Tu elemento `div` contenedor para el plan familiar debe tener la clase `grid-rows-[1fr_auto]`.
...
El elemento `div` contenedor para el plan familiar debe tener la clase `gap-6`.
