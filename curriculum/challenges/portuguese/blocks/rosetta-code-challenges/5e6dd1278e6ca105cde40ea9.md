...
A **subsequência comum mais longa** (ou **LCS**) dos grupos A e B é o maior grupo de elementos de A e B que são comuns entre os dois grupos e na mesma ordem em cada grupo. Por exemplo, as sequências `1234` e `1224533324` têm um LCS de `1234`:
