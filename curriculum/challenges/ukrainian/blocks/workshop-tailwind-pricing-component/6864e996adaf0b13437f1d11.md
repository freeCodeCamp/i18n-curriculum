...
Тепер слід перейти до стилізації елементів для **плану слухача**.

Додайте зовнішньому `div` для плану класи `bg-gray-100`, `ring-1`, щоб створити товсті обриси навколо `div`, і `ring-gray-300`, щоб призначити темний колір цим обрисам.

# --hints--

Вашому елементу `div` слід призначити клас `bg-gray-100`.
...
Вашому елементу `div` слід призначити клас `ring-1`.
...
Вашому елементу `div` слід призначити клас `ring-gray-300`.
