...
O código a seguir imprimirá o número 19 porque o primeiro operando `age` é truthy.
...
Agora que você entende como funcionam os valores truthy e falsy, os operadores `and`, `or` e `not` e como o short-circuiting funciona, você pode escrever lógica condicional mais flexível e legível.
