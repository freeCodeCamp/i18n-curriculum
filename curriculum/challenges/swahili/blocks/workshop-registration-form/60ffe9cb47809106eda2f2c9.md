...
Mwishowe, kwa kitufe cha kuwasilisha, unataka kukitenganisha na `fieldset` hapo juu, na kurekebisha upana wake usiwe chini ya `300px`.

Badilisha sifa ya `margin` ili ijumuishe `1em` juu na chini, huku ukingo wa kulia na kushoto ukiwa `auto`. Kisha weka upana kama ilivyoelezwa hapo juu.
...
Unapaswa kutumia sifa iliyopo ya `margin` kujumuisha `1em` juu na chini.
