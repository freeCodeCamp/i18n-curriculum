...
Der Lempel-Ziv-Welch (LZW)-Algorithmus ermöglicht verlustfreie Datenkompression.

# --instructions--

Schreiben Sie eine Funktion, die zwei Parameter entgegennimmt. Der erste Parameter ist ein Boolean, bei dem `true` für Komprimieren und `false` für Dekomprimieren steht. Der zweite Parameter ist entweder ein String oder ein Array, das verarbeitet werden soll. Wenn es sich um einen zu komprimierenden String handelt, geben Sie ein Array von Zahlen zurück. Wenn es sich um ein Array von Zahlen handelt, das dekomprimiert werden soll, geben Sie einen String zurück.
