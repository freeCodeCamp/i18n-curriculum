...
`批覆 (pī fù)` means "to reply officially". It is often used in work or government contexts, for example when a request or document receives an official response.
