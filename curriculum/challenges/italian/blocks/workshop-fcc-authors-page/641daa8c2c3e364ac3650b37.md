...
Non c'è molto spazio tra il nome e l'immagine di ogni autore e il resto dei dettagli sulla scheda. Una separazione darà alla scheda dell'autore una chiara gerarchia visuale.
...
Dovresti creare un elemento `div` prima dell'elemento `p`.
