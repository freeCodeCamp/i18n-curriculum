...
Setze die `innerText`-Eigenschaft von `outputValueNode` auf `num`.

# --hints--

Du solltest `innerText` verwenden, um den Text von `outputValueNode` festzulegen.
...
Du solltest `innerText` verwenden, um den Text von `outputValueNode` auf `num` zu setzen.
