...
I numeri della forma $n^{15} + 1$ sono composti per ogni numero intero $n > 1$.

Per numeri interi positivi $n$ e $m$ definiamo $s(n, m)$ come la somma dei fattori primi distinti di $n^{15} + 1$ che non superano $m$.

Ad esempio, $2^{15} + 1 = 3 × 3 × 11 × 331$.
