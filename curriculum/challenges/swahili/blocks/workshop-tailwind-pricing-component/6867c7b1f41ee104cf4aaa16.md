...
Sasa, utatumia `grid` kupanga vitu ndani ya kifungashio `div`.

Ongeza madarasa la vitu `grid`, `grid-rows-[1fr_auto]`, na `gap-6` kwenye kifungashio `div`.

# --hints--

Kifungashio chako `div` kwa mpango wa familia kinapaswa kuwa na darasa la vitu `grid`.
...
Kifungashio chako `div` kwa mpango wa familia kinapaswa kuwa na darasa la vitu `grid-rows-[1fr_auto]`.
...
Kifungashio chako `div` kwa mpango wa familia kinapaswa kuwa na darasa la vitu `gap-6`.
