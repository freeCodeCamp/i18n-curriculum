...
Erstelle ein neues `div`-Element unter deinem `header`-Element und weise ihm ein `class`-Attribut mit `divider large` als Wert zu.
...
Dein neues `div`-Element sollte das `class`-Attribut auf `divider large` gesetzt haben.
