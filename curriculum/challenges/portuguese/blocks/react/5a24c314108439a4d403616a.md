...
Isso irá juntar todos os itens do array `colors` em uma string separada por vírgulas e produzir: `<p>green, blue, red</p>`.Mais tarde, aprenderemos sobre outros métodos comuns de se renderizar arrays de dados em React.
