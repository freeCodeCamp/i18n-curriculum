...
Debes usar el selector `nav li` o el `nav > ul > li`.
...
Debes dar a los elementos `li` un `color` de `#dfdfe2`.
...
Debes dar a los elementos `li` un `margin` de `0 0.2rem`.
...
Debes dar a los elementos `li` un `padding` de `0.2rem`.
