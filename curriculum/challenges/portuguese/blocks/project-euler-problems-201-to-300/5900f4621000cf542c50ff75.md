...
Dado um círculo $c$ com centro $M$ e raio $r$ e um ponto $G$ tal que $d(G, M) < r$, o lugar geométrico dos pontos que são equidistantes de $c$ e $G$ forma uma elipse.
...
Dado também o círculo $c$ com centro em $M$ e raio $15\,000$.
