...
Ndani ya kipengele chako cha `select`, ongeza vipengele vitano vya `option` zifuatazo zikiwa na thamani zinazolingana kwa maandishi ya `option` na sifa ya `value`:
