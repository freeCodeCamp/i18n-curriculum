...
Ndani ya `body`, tengeneza kipengele cha `main`. Kisha ndani ya kipengele hicho, tengeneza `section` yenye `class` iliyowekwa kuwa `heading`.
...
Kipengele chako cha `section` kinapaswa kuwa na `class` iliyowekwa kuwa `heading`.
