...
Endelea kwa kuongeza `div` ya `className` ya `form-row`. Ndani yake, ongeza vipengele viwili vya `div` vyenye `className` ya `form-group` kila kimoja.

Kipengele cha kwanza cha `div` kinapaswa kuwa na `label` ya `className` ya `label`, sifa ya kipengele ya `htmlFor` ya `position`, maandishi ya `Position`, na `input` yenye `id` ya `position`, `className` ya `input` na `type` ya `text`.

# --hints--

Sehemu yako ya Player Info inapaswa kuwa na `div` yenye `className` ya `form-row`.
...
`div.form-row` yako inapaswa kuwa na vipengele viwili vya `div` kila kimoja chenye `className` ya `form-group`.
...
`form-group` yako ya kwanza katika safu inapaswa kuwa na `label` yenye `className` ya `label` na `htmlFor` ya `position`.
...
`label` yako ya nafasi inapaswa kuwa na maandishi ya `Position`.
...
`form-group` yako ya kwanza katika safu inapaswa kuwa na `input` yenye `className` ya `input`, `id` ya `position` na `type` ya `text`.
