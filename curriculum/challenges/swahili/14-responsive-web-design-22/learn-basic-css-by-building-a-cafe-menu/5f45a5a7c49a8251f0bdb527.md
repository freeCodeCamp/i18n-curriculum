...
Kwa kutumia kiteuzi cha mtindo sawa katika hatua ya awali, ongeza ukubwa wa fonti ya bidhaa na bei kwa kutumia thamani ya `18px`.
...
Vipengele vyako vya `p` vilivyowekwa katika vipengele vya `.item` vinapaswa kuwa na `font-size` ya `18px`.
