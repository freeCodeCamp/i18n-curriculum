...
Sasa, lenga `h2` ya mpango na weka thamani darasa la vitu `text-lg`, `font-semibold`, na `text-indigo-600`.
...
Kipengele chako cha `h2` kinapaswa kuwa na darasa la vitu `text-indigo-600`.
