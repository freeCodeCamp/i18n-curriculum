...
Si può ignorare il caso in cui la collezione è vuota. Bisogna fare attenzione a gestire il caso in cui la moda non sia unica.

Se non è appropriato o possibile supportare una collezione generica, usa un vettore (array), se possibile. Se non è appropriato o possibile supportare un tipo di valore non specificato, usa numeri interi.
