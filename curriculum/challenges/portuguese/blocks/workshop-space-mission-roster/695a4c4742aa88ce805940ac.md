...
Para completar a preparação para sua missão espacial, faça a chamada de `printCrewSummary()` com seu array `updatedSquad`!

# --hints--

Você deve fazer a chamada da sua função `printCrewSummary()` com `updatedSquad`.
