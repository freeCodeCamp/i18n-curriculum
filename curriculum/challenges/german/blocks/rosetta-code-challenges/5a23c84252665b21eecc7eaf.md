...
Die International Bank Account Number (IBAN) ist ein international vereinbartes Mittel zur Identifizierung von Bankkonten über nationale Grenzen hinweg mit einem geringeren Risiko von Übertragungsfehlern.

Die <abbr title="International Bank Account Number">IBAN</abbr> besteht aus bis zu 34 alphanumerischen Zeichen:

<ul>
  <li>zuerst dem zweibuchstabigen <abbr title="International Organization for Standardization">ISO</abbr> 3166-1 alpha-2 Ländercode</li>
  <li>dann zwei Prüfziffern, und</li>
  <li>schließlich einer länderspezifischen Basic Bank Account Number (BBAN).</li>
</ul>

Die Prüfziffern ermöglichen eine Plausibilitätsprüfung der Kontonummer, um deren Integrität bereits vor dem Absenden einer Transaktion zu bestätigen.

# --instructions--

Schreiben Sie eine Funktion, die einen IBAN-String als Parameter erhält. Wenn dieser gültig ist, geben Sie true zurück. Andernfalls geben Sie false zurück.
