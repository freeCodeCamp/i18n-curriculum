...
Após o término do laço `for`, você precisa retornar o array.Você deve poder ver a mudança de `Output` ao clicar no botão `Sort` novamente.

# --hints--

A instrução `return` deve retornar o `array`.
