...
`Going forward` is a phrase meaning from now on or in the future. It is often used to talk about plans or actions that will happen after the current moment. Zum Beispiel:
