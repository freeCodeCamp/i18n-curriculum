...
Adicione mais dois elementos `div`, cada um com o `className` de `form-group` dentro de `stats-grid`, um para PAS e outro para DRI.

Para o de PAS, adicione um `label` com um `htmlFor` de `pas` e o texto `PAS`, depois uma entrada com um `id` de `pas` e um `type` de `number`.

E para o de DRI, adicione um `label` com um `htmlFor` de `dri` e o texto `DRI`, depois uma entrada com um `id` de `dri` e um `type` de `number`.

# --hints--

Você deve adicionar mais dois elementos `div`, cada um com o `className` de `form-group` dentro do `div` de `className` de `stats-grid`.
...
Seu terceiro elemento `div` de `className` de `form-group` deve ter um `label` com um atributo `htmlFor` de `pas`, um `className` de `label` e um texto `PAS`.
...
Seu terceiro elemento `div` de `className` de `form-group` deve ter um `input` com um `className` de `input`, um `id` de `pas` e um `type` de `number`.
...
Seu quarto elemento `div` de `className` de `form-group` deve ter um `label` com um atributo `htmlFor` de `dri`, um `className` de `label` e um texto `DRI`.
...
Seu quarto elemento `div` de `className` de `form-group` deve ter um `input` com um `className` de `input`, um `id` de `dri` e um `type` de `number`.
