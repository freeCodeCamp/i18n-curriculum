...
Fügen Sie innerhalb des `stats-grid` zwei `div`-Elemente hinzu, jeweils mit dem `className` von `form-group`.

Für das erste fügen Sie ein `label` mit dem `className` von `label`, einem `htmlFor` von `pac` und dem Text `PAC` hinzu, dann eine Eingabe mit einem `id` von `pac`, einem `className` von `input` und einem `type` von `number`.

Und für das zweite fügen Sie `label` mit einem `htmlFor` von `sho` und dem Text `SHO` hinzu, dann eine Eingabe mit einem `id` von `sho` und einem `type` von `number`.

# --hints--

Sie sollten zwei `div`-Elemente haben, jeweils mit dem `className` von `form-group` innerhalb des `div` von `className` von `stats-grid`.
...
Ihr erstes `div`-Element mit dem `className` von `form-group` sollte ein `label` mit einem `htmlFor`-Attribut von `pac`, einem `className` von `label` und einem Text `PAC` haben.
...
Ihr erstes `div`-Element mit dem `className` von `form-group` sollte ein `input` mit einem `className` von `input`, einem `id` von `pac` und einem `type` von `number` haben.
...
Ihr zweites `div`-Element mit dem `className` von `form-group` sollte ein `label` mit einem `htmlFor`-Attribut von `sho`, einem `className` von `label` und einem Text `SHO` haben.
...
Ihr zweites `div`-Element mit dem `className` von `form-group` sollte ein `input` mit einem `id` von `sho`, einem `className` von `input` und einem `type` von `number` haben.
