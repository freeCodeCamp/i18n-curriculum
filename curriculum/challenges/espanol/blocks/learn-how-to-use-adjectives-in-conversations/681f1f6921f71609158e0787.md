...
`Specify` means to clearly state or describe something in detail. Por ejemplo:

`Please specify the time and place of the meeting.` – This means to say exactly when and where the meeting will be.

`What makes it` is a noun clause. A group of words that acts like a noun in the sentence. It explains the reason or cause behind something. Por ejemplo:
