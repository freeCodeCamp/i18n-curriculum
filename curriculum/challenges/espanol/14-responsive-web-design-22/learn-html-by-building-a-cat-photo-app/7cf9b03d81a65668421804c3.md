...
Tu elemento `input` debe tener un atributo `name` con el valor `catphotourl`.  Has omitido el valor o tienes un error de escritura. Recuerda que los valores de los atributos deben estar entre comillas.
