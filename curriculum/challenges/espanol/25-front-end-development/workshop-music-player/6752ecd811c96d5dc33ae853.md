...
Para asegurar que la pantalla del jugador se actualice siempre que una nueva canción comience a sonar, llama a la función `setPlayerDisplay()` dentro de la función `playSong()`.
