...
1つ目には、`className`が`label`、`htmlFor`が`pac`、テキストが`PAC`の`label`を追加し、次に`id`が`pac`、`className`が`input`、`type`が`number`の入力を追加してください。
...
`className`が`form-group`の1番目の`div`要素には、`htmlFor`属性が`pac`、`className`が`label`、テキストが`PAC`の`label`があるはずです。
...
`className`が`form-group`の1番目の`div`要素には、`className`が`input`、`id`が`pac`、`type`が`number`の`input`があるはずです。
...
`className`が`form-group`の2番目の`div`要素には、`htmlFor`属性が`sho`、`className`が`label`、テキストが`SHO`の`label`があるはずです。
...
`className`が`form-group`の2番目の`div`要素には、`id`が`sho`、`className`が`input`、`type`が`number`の`input`があるはずです。
