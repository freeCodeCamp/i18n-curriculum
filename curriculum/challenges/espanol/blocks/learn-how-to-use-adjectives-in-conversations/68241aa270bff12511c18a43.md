...
This is the process of setting up software so it can run on a device. Termina con `-ing`.

# --explanation--

`Installing` is the action of putting a program or app onto a device so it can be used. Por ejemplo:
