...
الآن بعد أن أصبح شرط `if` موجودًا، استخدم `e.target.value` للبحث عن الخطأ البرمجي المقابل في `bugMap` واستدعِ طريقة `render` الخاصة به. بعد ذلك، يجب أن تتمكن من اختيار الأخطاء البرمجية ورؤية النتيجة فورًا.

بهذا، تكتمل ورشة عمل اختيار رمز الخطأ البرمجي الخاص بك!

# --hints--

يجب أن تستدعي طريقة `render` على الخطأ البرمجي المقابل من `bugMap`.
