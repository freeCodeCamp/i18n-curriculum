...
Hiyo inashughulikia baadhi ya nafasi za mtindo wa msingi kwa kadi ya kipengee, ikiwa ni pamoja na kitufe cha CTA. Kwa yaliyobaki ya maudhui ya ndani, unahitaji kupanga kila kitu katika gridi kwa kulenga `div` ya ndani.

Weka darasa la vitu `grid`, `grid-rows-[auto_auto_auto_1fr]`, na `gap-y-2` kwa `div` ya ndani.

# --hints--

Kipengee chako cha `div` cha ndani kwa mpango wa familia kinapaswa kuwa na darasa la vitu `grid`.
...
Kipengee chako cha `div` cha ndani kwa mpango wa familia kinapaswa kuwa na darasa la vitu `grid-rows-[auto_auto_auto_1fr]`.
...
Kipengee chako cha `div` cha ndani kwa mpango wa familia kinapaswa kuwa na darasa la vitu `gap-y-2`.
