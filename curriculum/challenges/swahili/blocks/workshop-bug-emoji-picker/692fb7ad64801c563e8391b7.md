...
Unda darasa la vitu la chini `Spider` ambalo linaongeza darasa la vitu `Bug` na kigezo cha aina ya jumla kikiwa `string`.

# --hints--

Unapaswa kuwa na darasa la vitu linaloitwa `Spider`.
...
Darasa lako la vitu `Spider` linapaswa kuongeza `Bug`.
...
Darasa lako la vitu `Spider` linapaswa kuongeza `Bug` na hoja ya aina `string`.
