...
Para consertar isso, você pode usar o operador `||` para definir o valor como `0`, se ele não existir. Envolva o lado direito de `totalCountPerProduct[dessert.id]` em parênteses e adicione `|| 0` ao final da expressão.

# --hints--

Você deve envolver o lado direito de `totalCountPerProduct[dessert.id]` em parênteses.
