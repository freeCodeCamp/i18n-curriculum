...
This three-word phrase expresses strong certainty about something based on evidence or logic. Перша літера є з великою.

# --explanation--

`There must be...` is used when someone is sure about something based on the situation. Наприклад:
