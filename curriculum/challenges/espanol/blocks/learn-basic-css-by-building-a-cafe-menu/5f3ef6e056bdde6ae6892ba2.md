...
Debes utilizar un selector `h1, h2`.
...
La propiedad `font-family` debe tener el valor `Impact`.
...
La propiedad `font-family` de tu elemento `h1` debe tener el valor `Impact`.
...
La propiedad `font-family` de tu elemento `h2` debe tener el valor `Impact`.
