...
Erstelle innerhalb des `.cat-whiskers`-Elements zwei `div`-Elemente mit der Klasse `cat-whiskers-left` und `cat-whiskers-right`.
...
Du solltest zwei `div`-Elemente innerhalb des `.cat-whiskers`-Elements haben.
