...
如同你在前一步驟所做的，使用子孫選擇器來標的你的 `.cat-whiskers-right` 元素內的三個 `div` 元素。為它設定 `width` 為 `40px`、`height` 為 `1px`，以及 `background-color` 為 `#000`。
