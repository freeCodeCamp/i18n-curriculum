...
Imposta il livello di sovrapposizione dell'elemento mountain in modo che rimanga direttamente dietro l'elemento `.ground`.
...
Non dovresti modificare il `z-index` dell'elemento `.ground`.
