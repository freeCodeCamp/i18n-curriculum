...
title: Tengeneza mradi wa kalkuleta ya muda
challengeType: 23
...
Andika kitendakazi kinachoitwa `add_time` kinachopokea vigezo viwili vinavyohitajika na kigezo kimoja cha hiari:

- wakati wa kuanzia katika muundo wa saa 12 (unaomalizika na AM au PM)
- muda wa kuhesabu unaoonyesha idadi ya saa na dakika
- (hiari) siku ya kuanzia ya wiki, isiyo na tofauti ya herufi kubwa au ndogo

Kitendakazi kinapaswa kuongeza muda wa kuhesabu kwenye wakati wa kuanzia na kurudisha matokeo.

Ikiwa matokeo yatakuwa siku inayofuata, kinapaswa kuonyesha `(next day)` baada ya wakati. Ikiwa matokeo yatakuwa siku zaidi ya moja baadaye, kinapaswa kuonyesha `(n days later)` baada ya wakati, ambapo "n" ni idadi ya siku zilizopita.

Ikiwa kitendakazi kimepewa kigezo cha hiari cha siku ya kuanzia ya wiki, basi matokeo yanapaswa kuonyesha siku ya wiki ya matokeo. Siku ya wiki katika matokeo inapaswa kuonekana baada ya wakati na kabla ya idadi ya siku zilizopita.

Hapa chini kuna mifano ya matukio tofauti ambayo kitendakazi kinapaswa kushughulikia. Tafadhali zingatia kwa makini nafasi na alama za uandishi za matokeo.
...
Usilete maktaba yoyote ya Python. Kubali kuwa nyakati za kuanzia ni sahihi. Dakika katika muda wa kuhesabu zitakuwa nambari kamili chini ya 60, lakini saa inaweza kuwa nambari kamili yoyote.

Kumbuka: fungua konsoli ya kivinjari kwa F12 kuona maelezo zaidi ya mitihani.

# --hints--
Kuitisha `add_time('3:30 PM', '2:12')` kunapaswa kurudisha `'5:42 PM'`.
...
Kuitisha `add_time('11:55 AM', '3:12')` kunapaswa kurudisha `'3:07 PM'`.
...
Inatarajiwa wakati kumalizika na `'(next day)'` wakati ni siku inayofuata.
...
Inatarajiwa kipindi kubadilika kutoka `AM` hadi `PM` saa `12:00`.
...
Kuitisha `add_time('2:59 AM', '24:00')` kunapaswa kurudisha `'2:59 AM (next day)'`.
...
Kuitisha `add_time('11:59 PM', '24:05')` kunapaswa kurudisha `'12:04 AM (2 days later)'`.
