...
نحتاج الآن إلى بعض التنسيق السريع. ابدأ بإعطاء `body` خاصية `background-color` بقيمة `#0a0a23`.
...
يجب أن يحتوي محدِّد `body` على خاصية `background-color` بقيمة `#0a0a23`.
