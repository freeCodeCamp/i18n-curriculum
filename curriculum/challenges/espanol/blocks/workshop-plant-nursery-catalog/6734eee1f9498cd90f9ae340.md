...
`sellPlants(ballerina, "small", 10)` debería devolver `Catalog successfully updated.` y restar `10` de la propiedad `small` del objeto asociado con la clave `ballerina` en el catálogo.
