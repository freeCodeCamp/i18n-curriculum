...
Оновіть свою функцію зворотного виклику `.map()`, щоб викликати функцію `Number()`. Передайте `dropdown.value` у цей виклик функції.

Відкрийте вкладку Консоль, щоб побачити, що ваш `inputValues` тепер є масивом чисел.

# --hints--

Ви повинні викликати функцію `Number()` у своїй функції зворотного виклику `.map()`.
...
Ви повинні передати `dropdown.value` у свій виклик `Number()`.
