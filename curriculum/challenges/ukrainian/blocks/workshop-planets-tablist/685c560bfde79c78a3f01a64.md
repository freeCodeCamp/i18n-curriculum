...
Оскільки `associatedPanel` є `id`, це дозволить вам зробити запит до документа і знайти відповідний елемент панелі.

Створіть нову змінну з назвою `panel` і призначте їй значення `document.getElementById(associatedPanel)`.

# --hints--

У вас має бути змінна з назвою `panel`, яка містить елемент панелі, пов’язаний із вкладкою, на яку натиснули.
