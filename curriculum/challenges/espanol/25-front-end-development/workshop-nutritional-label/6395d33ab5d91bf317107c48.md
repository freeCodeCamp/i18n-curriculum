...
Cree un selector `.calories-info h2` y quite todos los márgenes.

# --hints--

Cree un selector `.calories-info h2`.

```js
assert(new __helpers.CSSHelp(document).getStyle('.calories-info h2'));
```

El selector `.calories-info h2` debe tener un `margin` establecido en `0`.
