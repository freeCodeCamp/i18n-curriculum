...
All'interno di questa clausola `case`, chiama la funzione `setPlayerCards` con l'argomento `players.filter()`.
...
Dovresti passare `players.filter()` alla chiamata di `setPlayerCards`.
