...
Щоб завершити вашу функцію `simulateFestival`, відобразіть підсумок результатів симуляції. Викличте `printSummary()` з вашим локальним об’єктом `throughputSummary`.

# --hints--

Ви повинні викликати `printSummary()` з `throughputSummary`.
