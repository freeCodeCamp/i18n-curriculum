...
`Allocate` means to divide and assign resources, such as time, money, or technology, for a specific task or project. 例如：
...
`Server capacity` means the available computing resources - storage, power, or space - that a server can provide. 例如：
