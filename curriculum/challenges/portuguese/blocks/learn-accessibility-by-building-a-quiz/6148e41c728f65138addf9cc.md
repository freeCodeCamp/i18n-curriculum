...
Envolva a regra de estilo que define `scroll-behavior: smooth` dentro de uma regra de `@media` com o recurso de mídia `prefers-reduced-motion`, definindo `no-preference` como o valor.
