...
Agora, transforme os quatro padrões da lista `constraints` em strings brutas.

# --hints--

Você deve transformar as quatro strings dentro da lista `constraints` em strings raw.
