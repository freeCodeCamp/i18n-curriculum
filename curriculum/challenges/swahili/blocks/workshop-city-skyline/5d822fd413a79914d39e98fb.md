...
Mabadiliko ya mwelekeo wa rangi mara nyingi hubadilika polepole kutoka rangi moja hadi nyingine. Wakati mabadiliko makali yanahitajika, mabadiliko yanaweza kufanywa kwa kusimama ghafla kama hivi:
...
Unapaswa kumpa `.bb2b` sifa ya `background`.
...
`.bb2b` inapaswa kuwa na mabadiliko ya `linear-gradient` kutoka `--building-color2` saa `0%` hadi `6%`, na `--window-color2` saa `6%` hadi `9%`.
