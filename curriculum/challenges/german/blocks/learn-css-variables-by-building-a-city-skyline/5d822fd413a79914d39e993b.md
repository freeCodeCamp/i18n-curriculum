...
Kopieren Sie Ihre gesamte `sky`-Klasse zusammen mit all ihren Eigenschaften und Werten in die Media Query. Sie werden ein weiteres Farbschema für die Skyline erstellen, das sie vom Tag zur Nacht ändert.

Hinweis: Sie müssen über den bearbeitbaren Bereich hinaus scrollen, um die Klasse zu kopieren.

# --hints--

Sie sollten die bestehende `.sky`-Deklaration nicht löschen.
...
Sie sollten die bestehende `.sky`-Deklaration in die Media Query kopieren.
