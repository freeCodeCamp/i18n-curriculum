...
Finalmente, para eliminar los bordes afilados del elemento externo `div`, agrega la clase `rounded-md`.

# --hints--

Tu elemento externo `div` debe tener la clase de utilidad `rounded-md`.
