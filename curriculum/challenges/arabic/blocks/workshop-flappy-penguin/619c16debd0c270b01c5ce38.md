...
اجعل الزوايا العلوية لعناصر `.face` لها انحناء زوايا بنسبة `70%`، والزوايا السفلية لها انحناء زوايا بنسبة `60%`.

# --hints--

يجب أن تعطي `.face` قيمة `border-radius` تساوي `70% 70% 60% 60%`.
