...
You should assign the `#player-song-title` element to the variable `playingSong`. 変数の宣言に `const` を使うことを忘れないでください。
...
You should assign the `#player-song-artist` element to the variable `songArtist`. 変数の宣言に `const` を使うことを忘れないでください。
