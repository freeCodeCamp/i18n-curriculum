...
El elemento `s` nunca debe usarse solo para mostrar cambios en un documento. Los elementos más apropiados en ese caso serían el elemento de texto eliminado y el elemento de texto insertado.
...
Revisa el comienzo de la lección para ver los ejemplos que usan el elemento `u`.
...
Se usa para crear ayudas de navegación en sitios web.
