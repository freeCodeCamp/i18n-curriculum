...
1. Você deve ter um elemento `input` com um `id` de `"search-input"`, e ele deve ser obrigatório.
...
1. Quando o elemento `#search-input` contiver o valor `Red` e o elemento `#search-button` for clicado, deve aparecer um alerta com o texto `"Creature not found"`.
1. Quando o elemento `#search-input` contiver o valor `Pyrolynx` e o elemento `#search-button` for clicado, os valores nos elementos `#creature-name`, `#creature-id`, `#weight`, `#height`, `#hp`, `#attack`, `#defense`, `#special-attack`, `#special-defense` e `#speed` devem ser, respectivamente, `PYROLYNX`, `#1` ou `1`, `Weight: 42` ou `42`, `Height: 32` ou `32`, `65`, `80`, `50`, `90`, `55` e `100`.
1. Quando o elemento `#search-input` contiver o valor `Pyrolynx` e o elemento `#search-button` for clicado, um único elemento deve ser adicionado dentro do elemento `#types` contendo o texto `FIRE`. O conteúdo do elemento `#types` deve ser limpo entre as buscas.
1. Quando o elemento `#search-input` contiver o valor `2` e o elemento `#search-button` for clicado, os valores nos elementos `#creature-name`, `#creature-id`, `#weight`, `#height`, `#hp`, `#attack`, `#defense`, `#special-attack`, `#special-defense` e `#speed` devem ser, respectivamente, `AQUOROC`, `#2` ou `2`, `Weight: 220` ou `220`, `Height: 53` ou `53`, `85`, `90`, `120`, `60`, `70` e `40`.
1. Quando o elemento `#search-input` contiver o valor `2` e o elemento `#search-button` for clicado, dois elementos devem ser adicionados dentro do elemento `#types` contendo os textos `WATER` e `ROCK`, respectivamente. O conteúdo do elemento `#types` deve ser limpo entre as buscas.
1. Quando o elemento `#search-input` contiver um nome de criatura inválido e o elemento `#search-button` for clicado, deve aparecer um alerta com o texto `"Creature not found"`.
1. Quando o elemento `#search-input` contiver um ID de criatura válido e o elemento `#search-button` for clicado, a interface deve ser preenchida com os dados corretos.
...
Quando o elemento `#search-input` contiver um nome de criatura inválido e o elemento `#search-button` for clicado, deve aparecer um alerta com o texto `"Creature not found"`.
