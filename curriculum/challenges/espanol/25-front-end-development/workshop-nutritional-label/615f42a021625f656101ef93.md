...
El espaciado horizontal entre elementos igualmente importantes puede aumentar la legibilidad del texto.

Coloque el texto `2/3 cup (55g)` en un elemento `span`.

# --hints--

Debe crear un nuevo elemento `span`.
...
Su elemento `p` debe aún tener el texto `Serving size 2/3 cup (55g)`.
