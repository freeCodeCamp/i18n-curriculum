...
title: Metti in maiuscolo la prima lettera di ogni parola in una frase
challengeType: 1
forumTopicId: 16088
...
Per questo esercizio, dovresti anche mettere in maiuscolo le parole di collegamento come `the` e `of`.
