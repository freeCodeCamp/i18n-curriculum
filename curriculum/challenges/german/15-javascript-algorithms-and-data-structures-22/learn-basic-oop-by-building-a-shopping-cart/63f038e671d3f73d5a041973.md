...
Denke daran, dass `0` ein falscher Wert ist, so dass du den `!`-Operator verwenden kannst, um zu prüfen, ob das Array leer ist.

Nachdem die Meldung angezeigt wurde, verlasse die Funktion, um die Ausführung zu beenden.

# --hints--

Du solltest eine `if`-Anweisung erstellen, die mit dem Negationsoperator prüft, ob das `items`-Array leer ist.
