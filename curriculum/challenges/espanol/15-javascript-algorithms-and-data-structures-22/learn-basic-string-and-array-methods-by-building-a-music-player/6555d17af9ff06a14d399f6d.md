...
You should assign the `#player-song-title` element to the variable `playingSong`. No te olvides de usar `const` para declarar la variable.
...
You should assign the `#player-song-artist` element to the variable `songArtist`. No te olvides de usar `const` para declarar la variable.
