...
`generate_slug("helloWorld")` 应该返回 `"helloworld"`。
...
`generate_slug("hello world!")` 应该返回 `"hello%20world"`。
...
`generate_slug(" hello-world ")` 应该返回 `"helloworld"`。
...
`generate_slug("  ?H^3-1*1]0! W[0%R#1]D  ")` 应该返回 `"h3110%20w0r1d"`。
