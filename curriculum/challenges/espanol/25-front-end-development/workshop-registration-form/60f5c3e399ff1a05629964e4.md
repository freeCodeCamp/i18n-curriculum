...
Como sugiere el título, estás creando un formulario. Entonces, después del elemento `p`, inserta un `form` con un atributo `action` que apunte a `https://register-demo.freecodecamp.org`.
