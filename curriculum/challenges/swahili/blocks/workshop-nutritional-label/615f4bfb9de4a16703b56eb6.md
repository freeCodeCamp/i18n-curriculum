...
Sasa unaweza kuongeza nafasi ya usawa kwa kutumia `flex`. Katika kichaguzi chako cha `p`, ongeza sifa ya `display` iliyowekwa kuwa `flex` na sifa ya `justify-content` iliyowekwa kuwa `space-between`. 
