...
Наприкінці, зробіть `rangeRegex` глобальним та незалежним від регістру.

# --hints--

Ваш `rangeRegex` має бути нечутливим до регістру.
...
Ваш `rangeRegex` має бути глобальним.
...
Ваш `rangeRegex` має бути одночасно глобальним та нечутливим до регістру.
