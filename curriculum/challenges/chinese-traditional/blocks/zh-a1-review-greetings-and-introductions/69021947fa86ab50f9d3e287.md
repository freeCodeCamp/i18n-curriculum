...
- `你們好 (nǐ men hǎo)` means "hello everyone" and is used when greeting a group of people.
...
- `我是王華 (wǒ shì wáng huá)。` – I am Wang Hua.

- `我是中國人 (wǒ shì zhōng guó rén)。` – I am Chinese.

- `我是開發者 (wǒ shì kāi fā zhě)。` – I am a developer.
