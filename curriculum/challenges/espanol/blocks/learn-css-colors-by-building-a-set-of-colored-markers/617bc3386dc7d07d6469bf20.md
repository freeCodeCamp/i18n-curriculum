...
Para crear el color terciario verde primavera, combina el cian con el verde. Actualiza la función `rgb` en la regla CSS `.two` para que el verde esté en el valor máximo, y establece azul a `127`.
