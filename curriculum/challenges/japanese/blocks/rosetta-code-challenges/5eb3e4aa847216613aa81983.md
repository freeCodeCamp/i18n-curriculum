...
セミプライム数は、ちょうど2つの（同じ場合もある）<a href="https://rosettacode.org/wiki/prime_number" target="_blank" rel="noopener noreferrer nofollow">素数</a>の積である自然数です。

<pre>1679  =  23 x 73</pre>

# --instructions--

数がセミプライムであればtrueを、そうでなければfalseを返す関数を書いてください。

# --hints--

`isSemiPrime` は関数である必要があります。
