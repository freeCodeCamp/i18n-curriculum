...
للحفاظ على التدرج الخطي في الجانب الصحيح من ذراع البطريق اليسرى، قم أولًا بتدويرها بـ `130deg`، ثم اقلب المحور السيني.

# --hints--

يجب أن تعطي `.arm.left` خاصية `transform` بقيمة `rotate(130deg) scaleX(-1)`.
