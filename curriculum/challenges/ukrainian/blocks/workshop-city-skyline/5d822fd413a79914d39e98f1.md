...
Було б добре додати той самий градієнт до двох наступних секцій. Замість цього створіть новий селектор класу під назвою `bb1-window` та перемістіть властивості `height` і `background` та їхні значення з `.bb1a` до нового селектора класу.
