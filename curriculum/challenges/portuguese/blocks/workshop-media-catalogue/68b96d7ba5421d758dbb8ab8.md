...
Crie outra cláusula `except` que capture `MediaError as e`. Dentro do bloco `except`, use uma f-string para imprimir `Media Error:` seguido de um espaço e da mensagem de erro.

# --hints--

Você deve ter uma cláusula `except` que capture `MediaError as e`.
...
Você deve usar uma f-string para imprimir `Media Error:` seguido de um espaço e a mensagem de erro dentro do seu novo bloco `except`.
