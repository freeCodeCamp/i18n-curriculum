...
Kigezo cha kwanza, `id`, ni `id` ya bidhaa ambayo mtumizi ameiongeza kwenye gari lao la manunuzi. Kigezo cha pili, `products`, ni safu ya `Dessert` za matukio. Kwa kutumia kigezo badala ya kurejelea moja kwa moja safu yako ya `products`, njia hii itakuwa na ufanisi zaidi ikiwa ungependa kuongeza orodha za bidhaa zaidi siku zijazo.
