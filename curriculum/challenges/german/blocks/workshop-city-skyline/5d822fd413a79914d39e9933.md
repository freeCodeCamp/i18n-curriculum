...
Fügen Sie unter dem gerade hinzugefügten `repeating-linear-gradient` einen weiteren `repeating-linear-gradient` hinzu. Geben Sie ihm eine `90deg`-Richtung, verwenden Sie Ihre Gebäude-Farbe von `0%` bis `12%` und die Fensterfarbe von `12%` bis `44%`. Dadurch entstehen viele rechteckige Fenster.

# --hints--

Sie sollten `.fb5` eine zweite `repeating-linear-gradient` in der `background`-Eigenschaft geben.
...
Sie sollten dem zweiten `repeating-linear-gradient` eine Richtung von `90deg` geben.
...
Sie sollten dem zweiten `repeating-linear-gradient` eine erste Farbe von `--building-color2` von `0%` bis `12%` geben.
...
Sie sollten dem zweiten `repeating-linear-gradient` eine zweite Farbe von `--window-color2` von `12%` bis `44%` geben.
