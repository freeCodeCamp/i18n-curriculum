...
Ongeza vipengele viwili zaidi vya `div` kila kikiwa na `className` ya `form-group` ndani ya `stats-grid`, kimoja kwa PAS na kingine kwa DRI.

Kwa ile ya PAS, ongeza `label` yenye `htmlFor` ya `pas` na maandishi ya `PAS`, kisha ingizo lenye `id` ya `pas` na `type` ya `number`.

Na kwa ile ya DRI, ongeza `label` yenye `htmlFor` ya `dri` na maandishi ya `DRI`, kisha ingizo lenye `id` ya `dri` na `type` ya `number`.

# --hints--

Unapaswa kuongeza vipengele viwili zaidi vya `div` kila kikiwa na `className` ya `form-group` ndani ya `div` ya `className` ya `stats-grid`.
...
Kipengele chako cha tatu cha `div` cha `className` cha `form-group` kinapaswa kuwa na `label` yenye sifa ya kipengele `htmlFor` ya `pas`, `className` ya `label`, na maandishi ya `PAS`.
...
Kipengele chako cha tatu cha `div` cha `className` cha `form-group` kinapaswa kuwa na `input` yenye `className` ya `input`, `id` ya `pas` na `type` ya `number`.
...
Kipengele chako cha nne cha `div` cha `className` cha `form-group` kinapaswa kuwa na `label` yenye sifa ya kipengele `htmlFor` ya `dri`, `className` ya `label`, na maandishi ya `DRI`.
...
Kipengele chako cha nne cha `div` cha `className` cha `form-group` kinapaswa kuwa na `input` yenye `className` ya `input`, `id` ya `dri` na `type` ya `number`.
