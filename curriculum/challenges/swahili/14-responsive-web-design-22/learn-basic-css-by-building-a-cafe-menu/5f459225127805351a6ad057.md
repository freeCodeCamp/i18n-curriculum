...
Badilisha rangi ya mandharinyuma ya kipengele cha `hr` kuwa `brown` ili iendane na rangi ya kahawa.
...
Kipengele chako cha `hr` kinafaa kuwa na `background-color` ya `brown`.
