...
Kwa kuwa fomu itakuwa na sehemu tatu tofauti, ongeza vipengele vitatu vya `fieldset` ndani ya kipengele cha `form`.

# --hints--

Unapaswa kuongeza vipengele vitatu vya `fieldset`.
...
Vipengele vitatu vya `fieldset` vinapaswa kuwa ndugu wa karibu.
