...
Тепер алгоритм автоматичного розміщення спрацює, коли ви додасте новий елемент іконки. Однак алгоритм за замовчуванням встановлює ширину нового стовпця як `auto`, що не відповідатиме вашим поточним стовпцям.

Ви можете замістити це за допомогою властивості `grid-auto-columns`. Додайте селектору `.social-icons` властивість `grid-auto-columns` зі значенням `1fr`.

# --hints--

Ваш селектор `.social-icons` має мати властивість `grid-auto-columns` зі значенням `1fr`.
