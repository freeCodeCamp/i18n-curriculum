...
Ahora necesitas agregar un event listener en el elemento `happyBtn`.

Escribe el event listener y su callback para que cuando se haga clic en el botón, la app registre en la consola `Button clicked!`.

# --hints--

Cuando se hace clic en `happyBtn`, se debe registrar `Button clicked!` en la consola.
