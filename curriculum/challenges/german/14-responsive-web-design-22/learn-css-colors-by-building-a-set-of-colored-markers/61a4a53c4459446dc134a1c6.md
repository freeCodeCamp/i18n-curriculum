...
Setze in der `linear-gradient`-Funktion `gradientDirection` auf `180deg`.

# --hints--

Deine `.red`-CSS-Regel sollte eine `background`-Eigenschaft auf `linear-gradient(180deg, rgb(255, 0, 0) 75%, rgb(0, 255, 0), rgb(0, 0, 255))` gesetzt haben.
