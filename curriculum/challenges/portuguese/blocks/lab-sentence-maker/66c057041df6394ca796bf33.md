...
1. Você deve declarar uma variável `firstStory`.
   
1. Você deve usar o seguinte modelo de história para criar a primeira história e atribuí-la à variável `firstStory`: `"Era uma vez um(a) [adjetivo] [substantivo] que adorava comer [substantivo2]. O [substantivo] vivia em um(a) [lugar] e tinha narinas [adjetivo2] que soltavam fogo quando estava [verbo]."`;
...
1. Você deve declarar uma variável `secondStory`.
...
Você deve usar o formato correto da história para a primeira história: `"Era uma vez, havia um(a) [adjetivo] [substantivo] que adorava comer [substantivo2]."` The [noun] lived in a [place] and had [adjective2] nostrils that blew fire when it was [verb]."`. Preste atenção nos espaços.
...
Você deve montar sua primeira história usando as variáveis que você declarou na ordem correta.
...
Você deve usar o formato correto da história para a segunda história: `"Era uma vez, havia um(a) [adjetivo] [substantivo] que adorava comer [substantivo2]."` The [noun] lived in a [place] and had [adjective2] nostrils that blew fire when it was [verb]."`. Preste atenção nos espaços.
...
Você deve montar sua segunda história usando as variáveis que você declarou na ordem correta.
