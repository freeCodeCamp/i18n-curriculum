...
これは詳細を省いて簡単に話すことを意味します。

# --explanation--

`To mention` は、あまり詳しく説明せずに会話の中で話題を出すことを意味します。例えば：

`She mentioned a new project, but she didn't explain it yet.` - これは彼女が新しいプロジェクトについて簡単に話したが、詳しい情報は提供しなかったことを意味します。
