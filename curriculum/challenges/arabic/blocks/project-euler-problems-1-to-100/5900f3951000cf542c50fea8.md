...
title: "المشكلة 41: عدد أولي شامل الأرقام"
challengeType: 1
forumTopicId: 302078
...
نقول إن الرقم الذي يحتوي على `n` أرقام هو شامل الأرقام إذا استخدم كل الأرقام من 1 إلى `n` مرة واحدة بالضبط. على سبيل المثال، 2143 هو عدد شامل الأرقام مكون من 4 أرقام وهو أيضًا عدد أولي.

ما هو أكبر عدد أولي شامل الأرقام مكون من `n` أرقام موجود؟

# --hints--

يجب أن تُرجع الدالة `pandigitalPrime(4)` رقمًا.

```js
assert(typeof pandigitalPrime(4) === 'number');
```

يجب أن تُرجع الدالة `pandigitalPrime(4)` الرقم 4231.

```js
assert(pandigitalPrime(4) == 4231);
```

يجب أن تُرجع الدالة `pandigitalPrime(7)` الرقم 7652413.
