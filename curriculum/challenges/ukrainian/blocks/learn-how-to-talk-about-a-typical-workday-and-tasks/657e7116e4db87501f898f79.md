...
У цьому завданні фокусуйтеся на відмінюванні дієслів у третій особі однини, описуючи розпорядок іншої людини.

Примітка: to `head to` означає йти або рухатися в напрямку до місця.

# --instructions--

Прослухайте аудіо, щоб зрозуміти контекст. Напишіть правильні форми дієслів, щоб доповнити речення про ранковий розпорядок Сари, зосереджуючись на відмінюванні в третій особі однини.
...
Це форма дієслова `wake`, яка використовується з `he`, `she` або `it`.
...
Це форма дієслова `get`, яка використовується з `he`, `she` або `it`.
...
Це форма дієслова `have`, яка використовується з `he`, `she` або `it`.
...
Це форма дієслова `head`, яка використовується з `he`, `she` або `it`.
