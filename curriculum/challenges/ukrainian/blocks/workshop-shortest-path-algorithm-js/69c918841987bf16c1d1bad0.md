...
Функція має повертати обчислені дані, щоб виклики могли використовувати їх програмно.

Після циклу `for...of` додайте інструкцію `return`, яка повертає масив, що містить `distances` та `paths` у такому порядку.

# --hints--

Ви маєте повертати `[distances, paths]` після циклу `for...of`.
