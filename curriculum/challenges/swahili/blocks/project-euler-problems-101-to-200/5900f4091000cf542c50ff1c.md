...
title: 'Zoezi la 157: Kutatua usemi wa diophantine'
challengeType: 1
forumTopicId: 301788
...
Chukulia usemi wa diophantine $\frac{1}{a} + \frac{1}{b} = \frac{p}{{10}^n}$ ambapo $a$, $b$, $p$, $n$ ni nambari kamili chanya na $a ≤ b$.

Kwa $n = 1$ usemi huu una suluhisho 20 kama zilivyoorodheshwa hapa chini:
...
Ni suluhisho ngapi usemi huu una kwa $1 ≤ n ≤ 9$?

# --hints--

`diophantineEquation()` inapaswa kurudisha `53490`.
