...
2. Dentro de la función, debes enmascarar el `email` y agregarle el nombre del dominio. Recuerda que puedes usar métodos como `slice`, `repeat`, `indexOf` o incluso `replace` para ayudarte.
