...
배지를 더 잘 스타일링할 수 있습니다. 이를 위해 Tailwind 그라디언트 클래스를 사용하세요. Tailwind에서 그라디언트 스타일을 사용하는 방법은 다음과 같습니다.
...
배지 `bg-gradient-to-r`에 `from-fuchsia-500`, `to-indigo-500`, `div` 클래스를 추가하세요. 또한 `rounded-full`, `px-3`, `py-1`, `text-xs`, `font-bold`, `text-white`도 추가하세요.

# --hints--

텍스트 `div`가 있는 `Most popular` 요소에 `bg-gradient-to-r` 클래스를 추가하세요.
...
텍스트 `div`가 있는 `Most popular` 요소에 `from-fuchsia-500` 클래스를 추가하세요.
...
텍스트 `div`가 있는 `Most popular` 요소에 `to-indigo-500` 클래스를 추가하세요.
...
텍스트 `div`가 있는 `Most popular` 요소에 `rounded-full` 클래스를 추가하세요.
...
텍스트 `div`가 있는 `Most popular` 요소에 `px-3` 클래스를 추가하세요.
...
텍스트 `div`가 있는 `Most popular` 요소에 `py-1` 클래스를 추가하세요.
...
텍스트 `div`가 있는 `Most popular` 요소에 `text-xs` 클래스를 추가하세요.
...
텍스트 `div`가 있는 `Most popular` 요소에 `font-bold` 클래스를 추가하세요.
...
텍스트 `div`가 있는 `Most popular` 요소에 `text-white` 클래스를 추가하세요.
