...
title: 'Problema 435: polinomi dei numeri di Fibonacci'
challengeType: 1
forumTopicId: 302106
...
I numeri di Fibonacci $\\{f_n, n ≥ 0\\}$ sono definiti ricorsivamente come $f_n = f_{n - 1} + f_{n - 2}$ con i casi base $f_0 = 0$ e $f_1 = 1$.
...
Sia $n = {10}^{15}$. Trova la somma $\displaystyle\sum_{x = 0}^{100} F_n(x)$ e fornisci la tua risposta modulo $1\\,307\\,674\\,368\\,000 \\, (= 15!)$.
