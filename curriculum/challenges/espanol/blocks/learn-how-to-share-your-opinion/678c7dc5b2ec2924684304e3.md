...
This expression is used to agree with something that has already been said. La primer letra se escribe en mayúscula.
...
`That's true` is often used to show agreement. Por ejemplo:
...
`Stuff` alone is a general word used to refer to things, tasks, or activities. Por ejemplo:
