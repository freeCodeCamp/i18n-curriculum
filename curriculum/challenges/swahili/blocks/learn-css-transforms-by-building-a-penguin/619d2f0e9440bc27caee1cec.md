...
Tafiti ya kufurahisha: Flippers nyingi, kama si zote, si mstatili kwa asili.

Toa mduara wa `.arm` kwa pembe za juu-kushoto, juu-kulia, na chini-kulia za vipengele vya `30%`, na mduara wa `120%` kwa pembe ya chini-kushoto.

# --hints--

Unapaswa kumpa `.arm` `border-radius` ya `30% 30% 30% 120%`.
