...
Finalmente, puedes ejecutar tus simulaciones.

Comienza con el turno de la mañana. Llama a `simulateFestival()` con `morningGates` y `"Morning"`. 

# --hints--

Debes llamar a `simulateFestival()` con `morningGates` y `"Morning"`.
