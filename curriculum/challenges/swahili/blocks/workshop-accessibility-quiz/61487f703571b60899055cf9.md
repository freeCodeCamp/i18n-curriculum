...
Weka upana wa vipengele vya `section` kuwa `80%` ya kontena yao mama. Kisha, tumia vikingo kuziweka katikati vipengele vya `section`, ukiongeza `10px` kwenye ukingo wa chini.

Pia, hakikisha vipengele vya `section` haviwezi kuwa vikubwa zaidi ya `600px` kwa upana.
