...
title: Tumia darasa la vitu la CSS kuunda mtindo kwa vitu vingi
challengeType: 0
...
Madarasa ya vitu yanakuwezesha kutumia mitindo ile ile ya CSS kwa vitu vingi vya HTML. Unaweza kuona hili kwa kutumia darasa lako la `red-text` kwenye kipengele cha kwanza cha `p`.

# --hints--

Kipengele chako cha `h2` kinapaswa kuwa chepua.
...
Kipengele chako cha kwanza cha `p` kinapaswa kuwa chepua.
...
Vipengele vyako vya pili na vya tatu vya `p` havipaswi kuwa chepua.
...
Kipengele chako cha kwanza cha `p` kinapaswa kuwa na darasa la `red-text`.
