...
В межах елемента `div` викличте функцію `avatars` і передайте аргументи `posters` та `users`.

Тепер ви повинні побачити аватари, показані на сторінці.

# --hints--

Викличте функцію під назвою `avatars`.
...
Ваш виклик функції повинен мати аргументи `posters` та `users`.
