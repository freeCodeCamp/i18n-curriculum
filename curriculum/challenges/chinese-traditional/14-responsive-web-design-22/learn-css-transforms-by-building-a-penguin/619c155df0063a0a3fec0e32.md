...
你應該給 `.face` 一個 `width` 爲 `--fcc-expected--`，而不是 `--fcc-actual--`。
...
你應該給 `.face` 一個 `height` 爲 `--fcc-expected--`，而不是 `--fcc-actual--`。
...
你應該給 `.face` 一個 `background-color` 爲 `--fcc-expected--`，而不是 `--fcc-actual--`。
