...
للمشاركة الثالثة في المدونة، تحتاج إلى إضافة عنصر `article` آخر.

داخل عنصر الـ `article`، أضف عنصر `h3` يحتوي على النص `Mr. Whiskers' First Birthday Party`.

أسفل عنصر الـ `h3`، أضف فقرتين من نص lorem ipsum.

# --hints--

يجب أن يكون لديك عنصر `article` ثالث داخل عنصر الـ `section` مع تعيين الخاصية `id` إلى `posts`.
...
يجب أن يكون لديك عنصر `h3` داخل عنصر الـ `article` يحتوي على النص `Mr. Whiskers' First Birthday Party`.
