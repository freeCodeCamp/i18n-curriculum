...
Варто зазначити, що завдання непомітно викликають `ReactDOM.render(JSX, document.getElementById('root'))`. Цей виклик функції розміщує JSX у просте вираження DOM, що створює React. Потім React використовує снапшоти своєї DOM, щоб оптимізувати оновлення конкретних частин фактичної DOM.
