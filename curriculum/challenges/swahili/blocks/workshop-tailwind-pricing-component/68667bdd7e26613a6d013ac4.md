...
Ongeza madarasa `text-4xl`, `font-bold`, na `text-white` kwa kipengele cha `p` chenye maandishi ya bei ili kiweze kuonekana zaidi.
...
Kipengele chako cha `p` kinapaswa kuwa na darasa la `text-white`.
