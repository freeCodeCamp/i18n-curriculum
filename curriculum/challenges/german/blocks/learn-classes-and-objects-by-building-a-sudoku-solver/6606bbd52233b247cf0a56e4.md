...
Verwandeln Sie nun das `1`, das Sie zuvor geändert haben, wieder zurück in ein `0`, um die ursprüngliche Brettkonfiguration wiederherzustellen. Löschen Sie anschließend Ihren `print`-Aufruf.

# --hints--

Sie sollten das erste Element der ersten Liste von `puzzle` wieder in eine Null umwandeln.
...
In Ihrem Code sollte kein `print(gameboard.find_empty_cell())` enthalten sein.
