...
Використайте свій існуючий елемент `.divider` як приклад, щоб додати новий роздільник після елемента `p`.

# --hints--

Ви повинні створити новий `div` всередині вашого елемента `.daily-value`.
...
Ваш новий `div` має йти після вашого елемента `p`.
