...
Dai a `.fb1b` un `width` di `60%` e `height` di `10%`, e a `.fb1c` un `width` di `100%` e `height` di `80%`.

# --hints--

Dovresti dare a `.fb1b` un `width` di `60%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle(".fb1b")?.width, "60%");
```

Dovresti dare a `.fb1b` un `height` di `10%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle(".fb1b")?.height, "10%");
```

Dovresti dare a `.fb1c` un `width` di `100%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle(".fb1c")?.width, "100%");
```

Dovresti dare a `.fb1c` un `height` di `80%`.
