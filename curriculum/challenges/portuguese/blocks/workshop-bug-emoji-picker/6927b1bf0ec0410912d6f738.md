...
Ainda dentro da classe `Bug`, declare uma propriedade chamada `emojiElement` com o tipo `HTMLParagraphElement`. Essa propriedade vai armazenar uma referência para o elemento de parágrafo HTML onde o emoji de bug será exibido.

# --hints--

Sua classe `Bug` deve ter uma propriedade chamada `emojiElement`.
...
Sua propriedade `emojiElement` deve ter o tipo `HTMLParagraphElement`.
...
Sua propriedade `emojiElement` deve usar o operador de assertiva de atribuição definitiva (`!`).
