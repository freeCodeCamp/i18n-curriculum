...
Fahren Sie fort, indem Sie ein `div` von `className` von `form-row` hinzufügen. Fügen Sie darin zwei `div`-Elemente mit dem `className` von `form-group` jeweils hinzu.

Das erste `div`-Element sollte ein `label` von `className` von `label`, ein `htmlFor`-Attribut von `position`, einen Text-`Position` und ein `input` mit dem `id` von `position`, ein `className` von `input` und ein `type` von `text` haben.

# --hints--

Ihr Player Info-Abschnitt sollte ein `div` mit dem `className` von `form-row` enthalten.
...
Ihr `div.form-row` sollte zwei `div`-Elemente enthalten, die jeweils das `className` von `form-group` haben.
...
Ihr erstes `form-group` in der Zeile sollte ein `label` mit dem `className` von `label` und ein `htmlFor` von `position` haben.
...
Ihr Positions-`label` sollte den Text `Position` haben.
...
Ihr erstes `form-group` in der Zeile sollte ein `input` mit dem `className` von `input`, ein `id` von `position` und `type` von `text` haben.
