...
Kuhifadhi pembejeo zote katika `localStorage` kutazuia hili. Ili kuanza, unda konstanti `STORAGE_KEY` yenye mfuatano wa herufi `football_player_card` kama thamani yake.
