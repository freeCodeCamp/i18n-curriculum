...
Kivinjari cha mwisho utakachoongeza kwenye orodha kitakuwa kivinjari cha Arc.

Ongeza kipengele kingine cha `dt` chenye maandishi `Arc`.
...
Kwa kuongeza hiyo ya mwisho, orodha yako ya vivinjari itakamilika!

# --hints--

Unapaswa kuwa na vipengele vitano vya `dt` katika msimbo wako.
...
Kipengele chako cha tano cha `dt` kinapaswa kuwa na maandishi `Arc`.
...
Unapaswa kuwa na vipengele vitano vya `dd` katika msimbo wako.
...
Kipengele chako cha tano cha `dd` kinapaswa kuwa na maandishi `This is a free Chromium based web browser first released in 2023 by The Browser Company.`.
