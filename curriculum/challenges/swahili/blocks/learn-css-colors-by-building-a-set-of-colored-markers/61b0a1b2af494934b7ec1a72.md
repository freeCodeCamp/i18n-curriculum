...
Nzuri sana. Alama yako nyekundu inaonekana vizuri. Sasa unachohitaji kufanya ni kuongeza vichwa na mikono kwa alama zako zingine.

Ongeza kichwa na mkono kwa alama za kijani na buluu. Unaweza kunakili tu vipengele vya `div` kutoka kwa alama nyekundu na kuvinakili kwenye alama nyingine mbili.
...
Kichwa cha alama yako ya kijani `div` kinapaswa kuwa kabla ya kipengele cha mkono `div`.
...
Alama yako ya buluu `div` inapaswa kuwa na vipengele viwili vya `div`.
...
Kichwa cha alama yako ya buluu `div` kinapaswa kuwa kabla ya kipengele cha mkono `div`.
