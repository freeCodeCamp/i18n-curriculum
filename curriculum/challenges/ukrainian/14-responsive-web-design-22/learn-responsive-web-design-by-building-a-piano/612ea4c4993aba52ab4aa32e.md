...
Now it is time to use the pseudo-selectors you prepared for earlier. Щоб створити чорні клавіші, додайте новий селектор `.key.black--key::after`. This will target the elements with the class `key black--key`, and select the pseudo-element after these elements in the HTML.
