...
Ahora recorre los nodos objetivo para mostrar resultados para cada uno.

Agrega un ciclo `for...of` que itere sobre `targets` usando `nodeNo` como variable del ciclo. Deja el cuerpo vacío por ahora.

# --hints--

Debes crear un ciclo `for...of` con la variable `nodeNo` iterando sobre `targets`.
