...
دوّر العنصر `.two` باتجاه عقارب الساعة بمقدار 0.4 درجة.

# --hints--

يجب تعيين خاصية `transform` إلى `rotate(0.4deg)`.
...
يجب أن يحتوي العنصر `.two` على قيمة `transform` تساوي `rotate(0.4deg)`.
