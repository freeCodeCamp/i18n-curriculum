...
استخدم الطريقة `.forEach()` للتكرار عبر مصفوفة `items`. مرر دالة استدعاء راجع فارغة تأخذ معلمة واحدة `dessert`.

# --hints--

يجب استخدام الطريقة `.forEach()` على مصفوفة `items` الخاصة بك.
...
تذكر استخدام الكلمة المفتاحية `this` للوصول إلى مصفوفة `items`.
...
يجب تمرير دالة استدعاء راجع إلى الطريقة `.forEach()`.
...
يجب أن تأخذ دالة الاستدعاء الراجعة معلمة واحدة.
...
يجب أن تكون دالة الاستدعاء الراجعة فارغة.
