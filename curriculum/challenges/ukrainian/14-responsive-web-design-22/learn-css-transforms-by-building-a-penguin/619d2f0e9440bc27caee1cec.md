...
Надайте верхньому лівому, верхньому правому та нижньому правому кутам елемента `.arm` радіус `30%`, а нижньому лівому куту радіус `120%`.

# --hints--

Ви повинні надати `.arm` властивість `border-radius` зі значенням `30% 30% 30% 120%`.
