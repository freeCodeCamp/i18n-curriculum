...
Il tuo quarto elemento `fieldset` dovrebbe venire dopo il terzo elemento `fieldset`.
...
Il tuo quinto elemento `fieldset` dovrebbe venire dopo il quarto elemento `fieldset`.
