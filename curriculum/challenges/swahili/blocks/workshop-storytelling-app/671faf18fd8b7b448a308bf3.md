...
Ili kutofautisha kati ya aina tofauti za hadithi, utahitaji kupitisha aina ya hadithi iliyochaguliwa kwa kitendakazi cha `displayStory`.

Ongeza kigezo kinachoitwa `genre` kwa kitendakazi cha `displayStory`.

# --hints--

Unapaswa kuongeza kigezo cha `genre` kwa kitendakazi cha `displayStory`.
