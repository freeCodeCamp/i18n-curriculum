...
Na sua folha de estilo, comente a linha que contém a propriedade e valor do `background-color`, para poder ver o efeito de estilizar apenas o elemento `#menu`. Isto tornará o fundo branco de novo.
