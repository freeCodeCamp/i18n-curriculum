...
「`In a similar context`」意指在一個與正在討論的情況相似的情境中。這是關於將某事與類似的情境做比較。舉例來說，「`In a similar context, I also choose to walk instead of drive`」比較了兩個情境，該人在這兩個情境中都偏好步行。
