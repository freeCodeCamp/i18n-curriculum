...
`infixToFunction[operator]` inarudisha kitendakazi. Fanya wito wa kitendakazi hicho moja kwa moja, ukipitisha `arg1` na `arg2` kama hoja.

# --hints--

Kitendakazi chako cha mwitiko kinapaswa kurudisha matokeo ya kufanya wito wa `infixToFunction[operator]`.
...
Unapaswa kupitisha `arg1` kama hoja ya kwanza katika wito wako wa `infixToFunction[operator]`.
...
Unapaswa kupitisha `arg2` kama hoja ya pili katika wito wako wa `infixToFunction[operator]`.
