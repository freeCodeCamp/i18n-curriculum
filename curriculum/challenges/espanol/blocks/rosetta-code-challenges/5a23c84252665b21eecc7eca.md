...
`isKaprekar(1, 10)` debería devolver `true`.

```js
assert.equal(isKaprekar(1, 10), true);
```

`isKaprekar(9, 10)` debería retornar `true`.

```js
assert.equal(isKaprekar(9, 10), true);
```

`isKaprekar(2223, 10)` debería devolver `true`.

```js
assert.equal(isKaprekar(2223, 10), true);
```

`isKaprekar(22823, 10)` debe devolver `false`.
...
`isKaprekar(225, 17)` debería devolver `true`.
