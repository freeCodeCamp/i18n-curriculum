...
你的代码中不应有 `discount = PercentageDiscount(10)` 这一行。
...
你的代码中不应有 `print(discount.apply_discount(product))` 这一行。
...
你的代码中不应有这一行 `fixed_discount = FixedAmountDiscount(5)`。
...
你的代码中不应有 `print(fixed_discount.apply_discount(product))` 这一行。
