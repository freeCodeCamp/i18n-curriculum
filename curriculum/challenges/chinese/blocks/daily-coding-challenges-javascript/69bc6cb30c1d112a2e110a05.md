...
给定一个整数数组，按照以下规则返回一个新数组：

1. 将整数按升序排序
2. 然后将所有索引是 3 的倍数的值与它前面的值交换。

# --hints--

`sortAndSwap([3, 1, 2, 4, 6, 5])` 应该返回 `[1, 2, 4, 3, 5, 6]`。

```js
assert.deepEqual(sortAndSwap([3, 1, 2, 4, 6, 5]), [1, 2, 4, 3, 5, 6]);
```

`sortAndSwap([9, 7, 5, 3, 1, 2, 4, 6, 8])` 应该返回 `[1, 2, 4, 3, 5, 7, 6, 8, 9]`。

```js
assert.deepEqual(sortAndSwap([9, 7, 5, 3, 1, 2, 4, 6, 8]), [1, 2, 4, 3, 5, 7, 6, 8, 9]);
```

`sortAndSwap([1, 2, 3, 4, 5, 6, 7, 8, 9])` 应该返回 `[1, 2, 4, 3, 5, 7, 6, 8, 9]`。

```js
assert.deepEqual(sortAndSwap([1, 2, 3, 4, 5, 6, 7, 8, 9]), [1, 2, 4, 3, 5, 7, 6, 8, 9]);
```

`sortAndSwap([12, 5, 8, 1, 3, 10, 2, 7, 6, 4, 9, 11])` 应该返回 `[1, 2, 4, 3, 5, 7, 6, 8, 10, 9, 11, 12]`。

```js
assert.deepEqual(sortAndSwap([12, 5, 8, 1, 3, 10, 2, 7, 6, 4, 9, 11]), [1, 2, 4, 3, 5, 7, 6, 8, 10, 9, 11, 12]);
```

`sortAndSwap([100, -50, 0, 75, -25, 50, -75, 25])` 应该返回 `[-75, -50, 0, -25, 25, 75, 50, 100]`。

```js
assert.deepEqual(sortAndSwap([100, -50, 0, 75, -25, 50, -75, 25]), [-75, -50, 0, -25, 25, 75, 50, 100]);
```

`sortAndSwap([5, 9, 13, 77, 88, 313, -10, -65, 0, 8, 99, 101, -4, 2])` 应该返回 `[-65, -10, 0, -4, 2, 8, 5, 9, 77, 13, 88, 101, 99, 313]`。
