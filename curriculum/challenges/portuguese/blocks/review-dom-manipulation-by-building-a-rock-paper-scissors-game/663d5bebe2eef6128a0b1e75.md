...
Se o jogador ou o computador venceu o jogo, deve haver uma opção para redefinir o jogo e jogar novamente.

Complete a função `resetGame` que realiza o seguinte:
...
- Você pode usar a propriedade `innerText` para atualizar o conteúdo de um elemento. Para limpar o conteúdo de um elemento, você pode definir o `innerText` como uma string vazia.

Depois de aplicar essas mudanças, você terá concluído o jogo Rock, Paper, Scissors!
