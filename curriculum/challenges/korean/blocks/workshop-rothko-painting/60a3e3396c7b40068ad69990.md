...
`box-shadow`에 대해 같은 `.two` 선언을 사용하되, 색상을 `#efb762`에서 `#8f0401`으로 변경하세요.

# --hints--

`box-shadow` 속성을 `0 0 3px 3px #8f0401`로 설정해야 합니다.
...
`.two` 요소는 `box-shadow` 값이 `0 0 3px 3px #8f0401`이어야 합니다.
