...
У вас є невелика помилка. `arg1` і `arg2` — це рядки, а не числа. `infixToFunction['+']("1", "2")` поверне `12`, що математично некоректно.

Обгорніть кожен зі своїх аргументів `infixToFunction[operator]` у виклик `parseFloat()`.

# --hints--

Ви повинні обгорнути `arg1` у виклик `parseFloat()`.
...
Ви повинні обгорнути `arg2` у виклик `parseFloat()`.
