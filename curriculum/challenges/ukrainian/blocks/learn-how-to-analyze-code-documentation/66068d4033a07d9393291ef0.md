...
Це означає уважно подивитися на щось. Браян пропонує уважно розглянути опис функції.
...
Це означає зробити щось зрозумілим.
...
Це означає надати або забезпечити. Документація надає приклади, як використовувати функцію.
...
Ці приклади показують, як щось використовувати, як у цьому випадку функцію.
