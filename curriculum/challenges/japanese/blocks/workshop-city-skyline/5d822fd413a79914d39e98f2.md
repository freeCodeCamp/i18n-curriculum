...
新しい `bb1-window` クラスを `.bb1a`、`.bb1b`、`.bb1c` の各要素に追加してください。これでグラデーションが適用されます。
...
`bb1-window` 要素に `.bb1a` クラスを追加してください。
...
`bb1-window` 要素に `.bb1b` クラスを追加してください。
...
`bb1-window` 要素に `.bb1c` クラスを追加してください。
