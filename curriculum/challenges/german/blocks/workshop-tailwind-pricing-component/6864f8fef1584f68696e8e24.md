...
Jetzt sollten Sie zum `Start listening` CTA wechseln, um daraus einen richtigen Button zu machen.

Weisen Sie ihm die Utility-Klassen `bg-indigo-100`, `px-4`, `py-2`, `text-center`, `font-semibold`, `text-indigo-700` und `hover:bg-indigo-200` zu.

# --hints--

Ihr Ankerelement sollte die Klasse `bg-indigo-100` haben.
...
Ihr Ankerelement sollte die Klasse `text-indigo-700` haben.
...
Ihr Ankerelement sollte die Klasse `hover:bg-indigo-200` haben.
