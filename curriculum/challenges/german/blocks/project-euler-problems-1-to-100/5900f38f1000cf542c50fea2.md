...
title: 'Aufgabe 35: Zirkuläre Primzahlen'
challengeType: 1
forumTopicId: 302009
...
Die Zahl 197 wird als zirkuläre Primzahl bezeichnet, weil alle Drehungen der Ziffern: 197, 971 und 719, selbst Primzahlen sind.

Es gibt dreizehn solcher Primzahlen unter 100: 2, 3, 5, 7, 11, 13, 17, 31, 37, 71, 73, 79 und 97.

Wie viele zirkuläre Primzahlen gibt es unter `n`, wobei 100 ≤ `n` ≤ 1000000 gilt?

**Hinweis:**  

Die einzelnen Drehungen der zirkulären Primzahlen können `n` überschreiten.
...
`circularPrimes(100)` sollte 13 zurückgeben.
