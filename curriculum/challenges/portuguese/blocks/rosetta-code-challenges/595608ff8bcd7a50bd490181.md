...
2. Sua função deve retornar um array com o número menor que `limit` que possui a sequência hailstone mais longa e o comprimento dessa sequência. (Mas não mostre a sequência real!)
