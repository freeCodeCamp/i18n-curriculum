...
Como sua função `countdown()` fará a contagem regressiva de um número dado até zero, o caso base é quando o parâmetro `number` é igual a `0`.Então ele deve `return` para sair do seu loop recursivo.
