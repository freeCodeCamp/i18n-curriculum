...
Antes de comenzar a añadir la funcionalidad de filtro a tu página, vincula tu archivo `script.js` con el HTML.

# --hints--

Debes tener un elemento `script` con el atributo `src` establecido en `script.js`.
