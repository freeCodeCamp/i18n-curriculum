...
Ще всередині функції `playSong` встановіть властивість `audio.src` рівною `song.src`. Це вказує аудіоелементу, де знайти аудіодані для вибраної пісні.

Також встановіть властивість `audio.title` рівною `song.title`. Це вказує аудіоелементу, що відображати як назву пісні.

# --hints--

Ви повинні встановити властивість `audio.src` рівною `song.src` всередині вашої функції `playSong`.
...
Ви повинні встановити властивість `audio.title` рівною `song.title` всередині вашої функції `playSong`.
