...
Mover el texto del precio dentro de los elementos `p` y `span`, asigna al elemento `p` las clases `text-4xl`, `font-bold` y `text-gray-900` para que el precio sea más visible.
