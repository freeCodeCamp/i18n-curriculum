...
Dovresti creare un elemento `h3` all'interno dell'elemento `article`.

```js
assert.exists(document.querySelector('article h3'));
```

Dovresti creare un elemento `p` all'interno dell'elemento `article`.

```js
assert.exists(document.querySelector('article p'));
```

Dovresti creare un elemento `ul` all'interno dell'elemento `article`.

```js
assert.exists(document.querySelector('article ul'));
```

Gli elementi all'interno dell'elemento `article` dovrebbero essere nell'ordine corretto.
...
Il nuovo elemento `h3` dovrebbe avere l'attributo `class` impostato su `list-title`.

```js
assert(document.querySelector('article h3')?.className === 'list-title');
```

Il nuovo elemento `h3` dovrebbe avere il testo `A Brief History`.

```js
assert(document.querySelector('article h3')?.innerText === 'A Brief History');
```

Il nuovo elemento `p` dovrebbe avere il testo `Of the Curriculum`.

```js
assert(document.querySelector('article p')?.innerText === 'Of the Curriculum');
```

Il nuovo elemento `ul` dovrebbe avere l'attributo `class` impostato su `lists`.
