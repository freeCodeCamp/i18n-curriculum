...
Kamilisha setter kwa kuchapisha `'{name}' promoted to '{new_level}'.` ndani ya njia yako. Badilisha `{name}` na `{new_level}` kwa jina la mfanyakazi na kiwango kipya, mtawaliwa.

# --hints--

Unapaswa kuchapisha `'{name}' promoted to '{new_level}'.` ambapo `{name}` na `{new_level}` zinapaswa kubadilishwa na jina la mfanyakazi na kiwango kipya, mtawaliwa.
