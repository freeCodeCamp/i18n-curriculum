...
`input` 要素と `textarea` 要素が背景のテーマと馴染むように、`background-color` を `#0a0a23` に設定してください。 そして、`1px`、`solid`、色が `#0a0a23` の境界線を設定してください。

# --hints--

`input` および `textarea` の要素を選択するため、カンマ区切りの要素セレクターを使用してください。
