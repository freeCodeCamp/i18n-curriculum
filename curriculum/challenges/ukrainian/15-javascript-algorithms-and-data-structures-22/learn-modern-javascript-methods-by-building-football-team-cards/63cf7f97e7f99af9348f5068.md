...
Потім використайте `id` під назвою `"head-coach"` із документа HTML та збережіть його в `const` змінній під назвою `headCoach`. Під цією змінною призначте `id` зі значенням `"player-cards"` `const` змінній під назвою `playerCards`.

# --hints--

Ви повинні використати метод `document.getElementById()`, щоб отримати елемент `#head-coach`.
...
Ви повинні використати метод `document.getElementById()`, щоб отримати елемент `#player-cards`.
