...
Після виклику `print()` викличте функцію `print_expenses`, щоб відобразити всі витрати, які були додані до цього моменту. Передайте список `expenses` як аргумент.

# --hints--

Ви повинні викликати функцію `print_expenses()` у вашій умові `elif`.
...
Ви повинні передати список `expenses` як аргумент у ваш виклик `print_expenses()`.
