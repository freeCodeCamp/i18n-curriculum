...
Para la última parte del taller, aprenderás cómo obtener el número total de páginas de todos los libros en la biblioteca. 

Comienza registrando en la consola el mensaje `"\nTotal number of pages for all library books:\n"`.
