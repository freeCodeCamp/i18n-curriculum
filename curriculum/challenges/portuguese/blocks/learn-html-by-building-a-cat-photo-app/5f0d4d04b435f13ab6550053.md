...
Adicione um elemento `legend` com o texto `What's your cat's personality?` dentro do segundo elemento `fieldset`.

# --hints--

Você excluiu o segundo elemento `fieldset` ou está faltando nele uma tag de abertura ou fechamento.
...
O elemento `legend` deve ter uma tag de abertura.As tags de abertura têm essa sintaxe: `<elementName>`.
...
O elemento `legend` deve ter o texto `What's your cat's personality?`.Você omitiu o texto ou tem um erro de digitação.
