...
داخل الصنف، أضف خاصية `elements` خاصة ككائن. بداخله، أضف الخصائص `singleCardBtn` و`singleCard` و`multipleCardsBtn`، كل منها من النوع `HTMLElement`.

# --hints--

يجب إعلان خاصية `private` باسم `elements` داخل صنف `Game`.
...
يجب أن تحتوي الخاصية الخاصة `elements` على خاصية `singleCardBtn` من النوع `HTMLElement`.
...
يجب أن تحتوي الخاصية الخاصة `elements` على خاصية `multipleCardsBtn` من النوع `HTMLElement`.
...
يجب أن تحتوي الخاصية الخاصة `elements` على خاصية `singleCard` من النوع `HTMLElement`.
