...
新しい`flavor`クラスをセレクターとして使い、`text-align`プロパティの値を`left`に設定してください。

# --hints--

`flavor`クラスのセレクターがあるはずです。
...
`text-align`プロパティを`left`に設定してください。
...
`flavor`クラスのセレクターは`text-align`プロパティを`left`に設定するはずです。
