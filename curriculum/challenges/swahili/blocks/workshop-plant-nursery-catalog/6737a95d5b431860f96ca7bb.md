...
Sasa jaribu kuongeza kitu cha `ballerina` kwenye `catalogSet` yako ndani ya kitendakazi chako mara ya pili. Utaona kwamba hakuna kinachotokea, kwa sababu kitu hicho tayari kimehifadhiwa katika seti yako na vitu vinavyorudiwa haviruhusiwi katika seti.

Ikiwa unataka, unaweza kuangalia idadi ya vitu katika seti yako kwa kutumia sifa ya `size`, kwa njia ile ile uliyotumia awali kwa ramani yako.

# --hints--

Unapaswa `add` kitu cha `ballerina` mara ya pili kwenye seti yako ndani ya kitendakazi cha `displayPlantsSet`.
