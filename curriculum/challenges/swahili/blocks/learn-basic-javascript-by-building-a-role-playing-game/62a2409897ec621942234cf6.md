...
Mpe kipengele cha `#text` nafasi ya ndani ya `background-color` ya `#0a0a23`, nafasi ya nje ya `color` ya `#ffffff`, na `10px` ya nafasi ya ndani upande wote.
...
Kipengele chako cha `#text` kinapaswa kuwa na `background-color` ya `#0a0a23`.
...
Kipengele chako cha `#text` kinapaswa kuwa na `color` ya `#ffffff`.
...
Kipengele chako cha `#text` kinapaswa kuwa na `10px` ya nafasi ya ndani upande wote.
