...
Uma `interview` é uma reunião formal onde alguém faz perguntas para aprender sobre a experiência, habilidades, ou opiniões de outra pessoa.

Em `job interview`, como no diálogo, o entrevistador pergunta sobre as experiências anteriores de trabalho do candidato.
...
Para discutir um novo projeto na empresa.
...
Fazer uma apresentação sobre desenvolvimento web.
...
Para conduzir uma entrevista sobre a experiência profissional do candidato.
