...
1. Debes tener una función llamada `getGrade` que tome una puntuación de estudiante como parámetro y devuelva una cadena que represente una calificación en letra basada en la puntuación. Aquí están las puntuaciones y sus calificaciones en letra correspondientes:  
...
1. Debes tener una función llamada `studentMsg` que tome un array de puntuaciones y la puntuación de un estudiante como parámetros. La función debe devolver una cadena con el formato:

    - `"Class average: average-goes-here. Your grade: grade-goes-here. You passed the course."`, si el estudiante aprobó el curso.
    - `"Class average: average-goes-here. Your grade: grade-goes-here. You failed the course."`, si el estudiante no aprobó el curso.

    Reemplaza `average-goes-here` con el promedio de las puntuaciones totales y `grade-goes-here` con la calificación del estudiante.
    Usa `getAverage` para obtener la puntuación promedio y `getGrade` para obtener la calificación del estudiante.
