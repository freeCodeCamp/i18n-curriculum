...
title: 'Aufgabe 53: Kombinatorische Auswahlen'
challengeType: 1
forumTopicId: 302164
...
Es gibt genau zehn Möglichkeiten, drei aus fünf auszuwählen, 12345:
...
Allgemein gilt $\\displaystyle \\binom n r = \\dfrac{n!}{r!(n-r)!}$, wobei $r \\le n$, $n! = n \\times (n-1) \\times ... \\times 3 \\times 2 \\times 1$ und $0! = 1$.

Erst bei $n = 23$ überschreitet ein Wert eine Million: $\\displaystyle \\binom {23} {10} = 1144066$.

Wie viele, nicht unbedingt verschiedene, Werte von $\\displaystyle \\binom n r$ für $1 \\le n \\le 100$ sind größer als eine Million?
