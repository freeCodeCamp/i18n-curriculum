...
كخطوة نهائية، أضف عبارة `console.log()` مع الرسالة: `"Workshop complete! You now know how to use includes() and slice()."`

تهانينا! لقد أكملت ورشة عمل String Inspector.

# --hints--

يجب أن تسجل `"Workshop complete! You now know how to use includes() and slice()."` في وحدة التحكم.
