...
この3語のフレーズは、何かの真向かい、または向かい合っていることを意味します。

# --explanation--

`Right across from` は、何かの真向かいにあることを意味します。例えば：

`The printer is right across from the filing cabinet.` – これはプリンターが反対側のキャビネットの向かいにあることを意味します。
