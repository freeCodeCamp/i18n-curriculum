...
Agora, você precisa criar uma função para esconder elementos do DOM. Declare uma função `hideElements` que receba `...elements` como parâmetro com o tipo `HTMLElement[]`.

Essa função, com uma classe CSS `hidden`, será usada em todo o app para alternar a visibilidade dos elementos da interface.

# --hints--

Você deve ter declarado uma função chamada `hideElements`.
...
Sua função `hideElements` deve ter um parâmetro chamado `...elements` com o tipo `HTMLElement[]`.
