...
Per far sì che gli elementi `input` e `textarea` si fondano con il tema di sfondo, imposta il loro `background-color` su `#0a0a23`. Poi, assegna loro un bordo `1px`, `solid` con un colore `#0a0a23`.
