...
Mambo yanaonekana kufanya kazi isipokuwa tatizo dogo moja. Ikiwa uhariri kumbukumbu kisha uondoke kwenye kumbukumbu hiyo, unapaswa kuona ujumbe wa `"Note saved successfully!"`. Lakini ikiwa utajaribu kuhariri kumbukumbu tena, ujumbe bado unaonekana.

Tabia inayotakiwa ni kwamba ujumbe uondoke wakati mtumizi anapokuwa makini na kipengele hicho. Unaweza kutumia tukio la `focus` kwa hili.
...
Unganisha `addEventListener` kwa variable ya `noteEl`. Hoja ya kwanza inapaswa kuwa tukio la `"focus"` na hoja ya pili inapaswa kuwa kitendakazi cha mwitiko. Ndani ya kitendakazi hicho cha mwitiko, weka `statusEl.textContent` kuwa mfuatano wa herufi tupu. Hii itarejesha eneo la moja kwa moja wakati kumbukumbu inapokuwa makini.

Na kwa mabadiliko hayo ya mwisho, warsha yako imekamilika!

# --hints--

Wakati mtumizi anapokuwa makini na kumbukumbu, unapaswa kuweka `statusEl.textContent` kuwa mfuatano wa herufi tupu.
