...
Puoi sovrascrivere questa impostazione con la proprietà `grid-auto-columns`. Assegna al selettore `.social-icons` una proprietà `grid-auto-columns` impostata su `1fr`.

# --hints--

Il selettore `.social-icons` dovrebbe avere una proprietà `grid-auto-columns` impostata su `1fr`.
