...
Per la proprietà `border-left`, cambia il valore dello stile del bordo da `solid` a `double`.

# --hints--

La regola CSS `.sleeve` dovrebbe avere una proprietà `border-left` con il valore `10px double black`.
