...
Браян використовує це слово, щоб зробити від’ємну заяву про розмір проєктів.
...
Це слово описує стан або умови проєктів, вказуючи, що вони існували в певному вигляді.
...
Це слово використовується, щоб описати загальний досвід, який Браян отримав із проєктами.
