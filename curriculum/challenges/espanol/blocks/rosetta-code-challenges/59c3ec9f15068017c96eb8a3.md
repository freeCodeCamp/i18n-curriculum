...
La secuencia de Farey <code>F<sub>n</sub></code> de orden `n` es la secuencia de fracciones completamente reducidas entre `0` y `1` que, al estar en términos más bajos, tienen denominadores menores o iguales a `n`, ordenadas en orden creciente.
