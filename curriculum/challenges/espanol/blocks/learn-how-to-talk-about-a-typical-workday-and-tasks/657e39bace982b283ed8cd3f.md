...
La frase `not that much` se usa para indicar una pequeña cantidad o grado, a menudo en respuesta a una pregunta sobre cantidad o frecuencia. For example:
...
Por otro lado, `at all times` significa siempre o continuamente, indicando algo que sucede sin interrupción. For example:
