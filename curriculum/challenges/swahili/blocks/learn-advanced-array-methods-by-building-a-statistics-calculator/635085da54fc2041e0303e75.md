...
Mwishowe, unahitaji kurudisha thamani ya `mean`.

# --hints--

Kitendakazi chako cha `getMean` kinapaswa kutumia neno kuu la `return`.
...
Kitendakazi chako cha `getMean` kinapaswa kurudisha thamani ya `mean`.
...
Tamko lako la `return` linapaswa kuwa baada ya tamko la mabadiliko ya `mean`.
