...
`form-group`의 `className`를 가진 세 번째 `div` 요소에는 `pas`의 `htmlFor` 속성, `label`의 `className`, 텍스트 `PAS`를 가진 `label`가 있어야 합니다.
...
`form-group`의 `className`를 가진 세 번째 `div` 요소에는 `input`의 `className`, `pas`의 `id`, `number`의 `type`를 가진 `input`가 있어야 합니다.
...
`form-group`의 `className`를 가진 네 번째 `div` 요소에는 `dri`의 `htmlFor` 속성, `label`의 `className`, 텍스트 `DRI`를 가진 `label`가 있어야 합니다.
...
`form-group`의 `className`를 가진 네 번째 `div` 요소에는 `input`의 `className`, `dri`의 `id`, `number`의 `type`를 가진 `input`가 있어야 합니다.
