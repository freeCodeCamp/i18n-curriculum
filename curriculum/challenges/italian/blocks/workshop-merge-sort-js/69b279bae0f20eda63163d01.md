...
Dopo aver stampato la stringa, registra l'array `numbers` stesso in modo che appaia la lista non ordinata.

# --hints--

Dovresti chiamare `console.log(numbers);` dopo il messaggio `'Unsorted array: '`.
