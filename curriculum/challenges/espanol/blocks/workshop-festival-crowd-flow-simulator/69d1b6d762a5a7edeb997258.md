...
Simula el turno nocturno llamando a `simulateFestival()` con `nightGates` y `"Night"`.

¡Con eso, tus simulaciones están completas!

# --hints--

Debes llamar a `simulateFestival()` con `nightGates` y `"Night"`.
