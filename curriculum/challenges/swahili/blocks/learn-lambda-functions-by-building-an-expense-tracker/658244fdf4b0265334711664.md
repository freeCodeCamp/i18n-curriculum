...
Mwishowe, rudisha matokeo ya wito la `filter()`.

# --hints--

Unapaswa kurudisha matokeo ya wito la `filter()` kutoka kwenye kitendakazi chako cha `filter_expenses_by_category`.
