...
Agora dê à regra `@keyframes wheel` um seletor de `100%`. Dentro disso, defina `transform` para `rotate(360deg)`. Ao fazer isso, sua animação completará uma rotação inteira.

# --hints--

Sua regra `@keyframes wheel` deve ter um seletor de `100%`.
