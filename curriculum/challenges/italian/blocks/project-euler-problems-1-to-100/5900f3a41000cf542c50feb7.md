...
title: 'Problema 56: somma potente delle cifre'
challengeType: 1
forumTopicId: 302167
...
Un googol ($10^{100}$) è un numero enorme: uno seguito da cento zeri; $100^{100}$ è quasi inimmaginabilmente grande: uno seguito da duecento zeri. Nonostante la loro grandezza, la somma delle cifre di ciascun numero è solo 1.

Considerando i numeri naturali della forma $a^b$, dove `a`, `b` &lt; `n`, qual è la somma digitale massima?
