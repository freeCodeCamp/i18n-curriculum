...
Dê a `wave` quatro pontos de divisão, começando em `10%` e aumentando a cada `10%`.

# --hints--

Você deve adicionar um ponto de divisão de `10%` a `@keyframes wave`.
...
Você deve adicionar um ponto de divisão de `20%` a `@keyframes wave`.
...
Você deve adicionar um ponto de divisão de `30%` a `@keyframes wave`.
...
Você deve adicionar um ponto de divisão de `40%` a `@keyframes wave`.
...
Deve haver 4 waypoints no keyframe.
