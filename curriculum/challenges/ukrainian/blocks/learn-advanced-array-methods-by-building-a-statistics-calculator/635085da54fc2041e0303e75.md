...
Тепер потрібно повернути значення `mean`.

# --hints--

Функція `getMean` повинна використовувати ключове слово `return`.
...
Функція `getMean` повинна повернути значення `mean`.
...
Інструкція `return` має бути після оголошення змінної `mean`.
