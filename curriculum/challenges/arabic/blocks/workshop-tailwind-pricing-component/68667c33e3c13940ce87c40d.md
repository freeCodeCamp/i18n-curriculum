...
يحتاج عنصر `span` الذي يحتوي على المدة إلى بعض التنسيق أيضًا، فأضف إليه الأصناف `text-base` و`font-medium` و`text-fuchsia-300`.
...
يجب أن يحتوي عنصر `span` على الصنف `text-fuchsia-300`.
