...
Додайте селектор `:root` на початок свого медіазапиту. Потім перевизначте всі чотири змінні `--building-color`, щоб вони використовували значення `#000` у цьому медіазапиті.
