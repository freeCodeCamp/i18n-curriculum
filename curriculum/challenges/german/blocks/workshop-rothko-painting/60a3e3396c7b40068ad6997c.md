...
Setzen Sie die `background-color` von `.one` auf `#efb762`.

# --hints--

Sie sollten die `background-color`-Eigenschaft auf `#efb762` setzen.
...
Ihr `.one`-Element sollte einen `background-color`-Wert von `#efb762` haben.
