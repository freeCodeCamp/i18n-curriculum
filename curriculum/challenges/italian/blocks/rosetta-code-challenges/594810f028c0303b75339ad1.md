...
Un numero felice si definisce con il seguente processo:

Partendo da un qualsiasi numero intero positivo, sostituisci il numero con la somma dei quadrati delle sue cifre e ripeti il processo finché il numero non è `1` (dove rimarrà), oppure finché non entra in un loop infinito in un ciclo che non include `1`. I numeri per cui questo processo termina in `1` sono numeri felici, mentre quelli che non terminano in `1` sono numeri infelici.

# --instructions--

Implementa una funzione che restituisce true se il numero è felice, o false altrimenti.
