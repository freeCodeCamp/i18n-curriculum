...
У методі `__str__` ви покажете, чи було прочитано е-пошту.

Умовні вирази дозволяють призначити значення на основі умови в одному рядку.
...
У методі, перед цим, використайте умовний вираз, щоб призначити рядок `Read` змінній `status`, якщо е-пошту прочитано, і `Unread`, якщо ні.

# --hints--

У вас має бути змінна `status` у методі `__str__`.
...
Ви маєте призначити умовний вираз змінній `status`.
...
Ваш умовний вираз має оцінюватися у рядок `Read`, якщо е-пошту прочитано, і `Unread`, якщо ні.
