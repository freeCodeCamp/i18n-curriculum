...
Next, we have to minimize HTTP requests. Cada archivo que solicita tu sitio web suma al tiempo de carga. Reducir el número de solicitudes HTTP puede conducir a cargas de página más rápidas. Puedes:
