...
Para este proyecto, no querrás cambiar estos valores de variable. Así que, en su lugar, debes usar `const` para declararlos. Las variables `const` son especiales.
