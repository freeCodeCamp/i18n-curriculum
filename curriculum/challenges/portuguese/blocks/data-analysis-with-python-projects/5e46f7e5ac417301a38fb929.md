...
- Quantas pessoas de cada raça estão representadas neste conjunto de dados? Isso deve ser uma série do Pandas com os nomes das raças como rótulos do índice. (`race`)
