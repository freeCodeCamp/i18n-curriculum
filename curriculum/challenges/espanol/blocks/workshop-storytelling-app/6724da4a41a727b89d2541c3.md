...
Ahora que la función `displayStory` está funcionando correctamente, es hora de añadir la funcionalidad a los botones. 

Antes de eso, elimina la llamada a la función `displayStory("scary")`.

# --hints--

Debes eliminar la llamada a la función `displayStory("scary")`.
