...
Потім використати інтерполяцію рядків, щоб встановити атрибут `id` на властивість `inputVal` поточного об’єкта, `obj`.

# --hints--

Використайте інтерполяцію рядків, щоб встановити атрибут `id` на властивість `inputVal` з `obj`.
