...
Agora você sabe o que são objetos, seus recursos básicos e suas vantagens.Em resumo, eles são armazenamentos de chave-valor que fornecem uma maneira flexível e intuitiva de estruturar dados, ***e***, oferecem um tempo de busca muito rápido.Ao longo do resto destes desafios, descreveremos diversas operações que você pode executar em objetos, com a finalidade de torná-lo confortável ao usar essas estruturas de dados úteis em seus programas.

Nos desafios anteriores, nós adicionamos e modificamos os pares de chave-valor de objetos.Aqui veremos como podemos *remover* um par chave-valor de um objeto.
