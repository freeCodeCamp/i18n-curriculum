...
Derzeit können Sie den Text in den `input`- oder `textarea`-Elementen nicht sehen, wenn Sie etwas eingeben. Außerdem ist ihre Höhe zu klein, um sie einfach zu benutzen.
