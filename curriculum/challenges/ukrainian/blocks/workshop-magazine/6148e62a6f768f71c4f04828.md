...
Властивість `place-items` можна використовувати, щоб одночасно встановити значення `align-items` та `justify-items`. Властивість `place-items` приймає одне або два значення. Якщо вказано одне значення, воно використовується обома властивостями `align-items` та `justify-items`. Якщо надано два значення, перше значення використовується для властивості `align-items`, а друге значення використовується для властивості `justify-items`.

Надайте селектору `.image-wrapper` властивість `place-items` зі значенням `center`.

# --hints--

Ваш селектор `.image-wrapper` повинен мати `place-items` зі значенням `center`.
