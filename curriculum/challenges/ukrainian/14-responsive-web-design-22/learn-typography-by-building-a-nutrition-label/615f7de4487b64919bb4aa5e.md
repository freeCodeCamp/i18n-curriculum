...
Після останнього `.divider` створіть новий елемент `p` з текстом `Cholesterol 0mg 0%`. Потім обгорніть текст `Cholesterol` одним елементом `span`, текст `0%` — іншим елементом, та надайте їм клас `bold`.

Вкінці вкладіть елемент `span`, який містить текст `Cholesterol`, та текст `0mg` в додатковий елемент `span` з метою центрування.
...
Новий елемент `p` повинен мати текст `Cholesterol 0mg 0%`.
...
Елемент `span` з текстом `Cholesterol` повинен мати атрибут `class` зі значенням `bold`.
...
Текст `0%` повинен бути вкладеним у `span`.
...
Елемент `span` з текстом `0%` повинен мати атрибут `class` зі значенням `bold`.
...
Елемент `span` з текстом `Cholesterol` та `0mg` мають бути обгорнуті в `span`.
