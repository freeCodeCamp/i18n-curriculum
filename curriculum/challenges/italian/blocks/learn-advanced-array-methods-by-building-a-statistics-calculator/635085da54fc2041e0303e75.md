...
La tua funzione `getMean` dovrebbe usare la parola chiave `return`.
...
La tua funzione `getMean` dovrebbe restituire il valore di `mean`.
...
La tua istruzione `return` dovrebbe essere dopo la dichiarazione della variabile `mean`.
