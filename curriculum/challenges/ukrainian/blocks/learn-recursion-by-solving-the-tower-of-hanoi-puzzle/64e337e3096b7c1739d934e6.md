...
Перед вашим рекурсивним викликом додайте коментар із текстом `move n - 1 disks from source to auxiliary, so they are out of the way`.

# --hints--

Ви повинні додати коментар із наданим текстом перед вашим рекурсивним викликом.
