...
No debes cambiar el elemento `div` existente con la clase `cat-whiskers-left`.

```js
assert(document.querySelectorAll('div.cat-whiskers-left').length === 1)
```

Debes crear tres elementos `div` dentro de tu elemento `.cat-whiskers-left`.

```js
assert(document.querySelectorAll('.cat-whiskers-left div').length === 3)
```

El primer elemento `div` dentro del elemento `.cat-whiskers-left` debe tener la clase `cat-whisker-left-top`.

```js
assert(document.querySelectorAll('.cat-whiskers-left div')[0].classList.contains('cat-whisker-left-top'))
```

El segundo elemento `div` dentro del elemento `.cat-whiskers-left` debe tener la clase `cat-whisker-left-middle`.

```js
assert(document.querySelectorAll('.cat-whiskers-left div')[1].classList.contains('cat-whisker-left-middle'))
```

El tercer elemento `div` dentro del elemento `.cat-whiskers-left` debe tener la clase `cat-whisker-left-bottom`.
