...
Darasa la tabia `\d` ni kifupi cha `[0-9]`. Badilisha darasa hili la tabia na kifupi ndani ya tuple yako ya vizingiti vya kwanza.

# --hints--

Unapaswa kubadilisha darasa la `[0-9]` kuwa `\d`.
