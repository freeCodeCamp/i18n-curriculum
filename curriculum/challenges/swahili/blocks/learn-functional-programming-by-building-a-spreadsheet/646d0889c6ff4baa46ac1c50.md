...
Katika kitendakazi chako cha `elemValue`, tangaza kitendakazi kinachoitwa `inner` kinachopokea kigezo cha `character`.

Kisha, rudisha kitendakazi chako cha `inner`.

# --hints--

Unapaswa kutangaza kigezo cha `inner`.
...
Unapaswa kutumia `const` kutangaza kigezo chako cha `inner`.
...
Kigezo chako cha `inner` kinapaswa kuwa kitendakazi cha mshale.
...
Kitendakazi chako cha `inner` kinapaswa kuwa na `character` kama kigezo pekee.
...
Kitendakazi chako cha `inner` kinapaswa kuwa tupu.
...
Unapaswa kurudisha wazi kitendakazi chako cha `inner`.
