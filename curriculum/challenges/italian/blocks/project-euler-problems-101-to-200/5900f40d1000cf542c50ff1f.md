...
title: 'Problema 160: cifre finali del fattoriale'
challengeType: 1
forumTopicId: 301794
...
Per ogni $N$, sia $f(N)$ le ultime cinque cifre prima degli zeri finali in $N!$.

Per esempio,

$$\begin{align}
  & 9! = 362880 \\; \text{quindi} \\; f(9) = 36288 \\\\
  & 10! = 3628800 \\; \text{quindi} \\; f(10) = 36288 \\\\
  & 20! = 2432902008176640000 \\; \text{quindi} \\; f(20) = 17664
\end{align}$$
