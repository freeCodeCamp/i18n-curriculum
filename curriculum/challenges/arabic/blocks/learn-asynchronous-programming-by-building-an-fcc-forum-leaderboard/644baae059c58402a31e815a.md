...
إذا لم يكن `id` موجودًا في كائن `allCategories`، ستحتاج إلى عرض فئة `General`.

أسفل جملة `if` الخاصة بك، أضف بند `else`.

# --hints--

يجب أن يكون لديك بند `else` أسفل جملة `if` الخاصة بك.
