...
将 `.three` 的圆角半径分别设置为：左上角 30 像素，右上角 25 像素，右下角 60 像素，左下角 12 像素。

# --hints--

你应将 `border-radius` 属性设置为 `30px 25px 60px 12px`。
...
你的 `.three` 元素应该有个 `border-radius`，值为 `30px 25px 60px 12px`。
