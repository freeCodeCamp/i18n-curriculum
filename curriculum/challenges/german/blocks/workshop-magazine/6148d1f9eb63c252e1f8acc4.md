...
Um dem `hr` eine Farbe zu geben, müssen Sie die `border`-Eigenschaft anpassen. Geben Sie dem `hr`-Selektor eine `border`-Eigenschaft mit dem Wert `1px solid rgba(120, 120, 120, 0.6)`.

# --hints--

Ihre `hr` sollte eine `border`-Eigenschaft mit dem Wert `1px solid rgba(120, 120, 120, 0.6)` haben.
