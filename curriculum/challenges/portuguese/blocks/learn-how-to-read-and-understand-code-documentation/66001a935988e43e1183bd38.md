...
Significa começar algo.Sarah sugere começar lendo as descrições dos parâmetros.
...
Significa oferecer informações ou detalhes.A documentação fornece informações sobre os parâmetros.
...
Refere-se a cada um dos parâmetros, considerados um a um.
