...
استخدم تعليقًا متعدد الأسطر لإضافة تعليق للكود على هذا التكرار أيضًا، للتحضير للطريقة التالية.

# --hints--

يجب إضافة تعليق للكود على حلقة `for` باستخدام تعليق متعدد الأسطر.
...
يجب إضافة تعليق للكود على جسم حلقة `for` كجزء من تعليق متعدد الأسطر.
