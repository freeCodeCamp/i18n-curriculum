...
Atualize a instrução `console` para imprimir um número inteiro entre `0` e `9`. 

Lembre-se de que você trabalhou com um método no Role Playing Game que arredonda um número para baixo até o inteiro mais próximo. 
