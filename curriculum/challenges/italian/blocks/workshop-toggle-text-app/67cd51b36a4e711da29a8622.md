...
Per attivare o disattivare la visibilità del testo, devi prima creare una funzione che si occupi di questo comportamento.

Inizia creando una nuova funzione chiamata `handleToggleVisibility`. 

# --hints--

Dovresti avere una funzione `handleToggleVisibility`.
