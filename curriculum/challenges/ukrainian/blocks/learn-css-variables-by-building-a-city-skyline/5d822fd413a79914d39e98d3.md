...
Ви повинні дати одному з нових елементів `div` клас `bb1a`.

```js
assert.exists(document.querySelector('div.bb1a'));
```

Ви повинні дати одному з нових елементів `div` клас `bb1b`.

```js
assert.exists(document.querySelector('div.bb1b'));
```

Ви повинні дати одному з нових елементів `div` клас `bb1c`.

```js
assert.exists(document.querySelector('div.bb1c'));
```

Ви повинні дати одному з нових елементів `div` клас `bb1d`.
...
Ви повинні розмістити нові елементи `div` всередині елемента `.bb1`.
