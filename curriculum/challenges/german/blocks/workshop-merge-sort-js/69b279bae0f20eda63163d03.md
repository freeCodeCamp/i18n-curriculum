...
Jetzt, da `numbers` sortiert ist, geben Sie `'Sorted array: '` in der Konsole aus, gefolgt vom `numbers` Array.

Damit ist der Merge-Sort-Algorithmus abgeschlossen.

# --hints--

Sie sollten `'Sorted array: '` in der Konsole ausgeben.
...
Sie sollten das `numbers` Array in der Konsole ausgeben, nachdem Sie `'Sorted array: '` ausgegeben haben.
