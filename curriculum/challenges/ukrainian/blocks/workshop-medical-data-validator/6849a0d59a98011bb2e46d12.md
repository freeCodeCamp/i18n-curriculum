...
Після інструкції `if` виведіть рядок `Valid format.`. Потім поверніть `True`.

# --hints--

Ви повинні вивести `Valid format.` після вашої інструкції `if`.
...
Ви повинні повернути `True` після вашого виклику `print()`.
