...
Давайте подивимося, як валідатор виявить реальну проблему. `catalog[0]` — це "From a Buick 8" Стівена Кінга, у якому заповнені всі чотири поля. `catalog[16]` — це "Unknown Title", у якому поле автора порожнє.
