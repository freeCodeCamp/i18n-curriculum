...
Оскільки проєкт тепер працює з HTML DOM-елементами, вам потрібен спосіб відтворити fortune у DOM.

Оголосіть функцію з іменем `renderCard`, яка приймає чотири аргументи: `drawingType`, `isReversed`, `shortName` і `img`.

Параметри `drawingType`, `shortName` і `img` мають бути типу `string`, а `isReversed` — типу `boolean`. Функція повинна мати тип повернення `string`.

# --hints--

У вас має бути функція з іменем `renderCard`.
...
Ваша функція `renderCard` має мати чотири параметри.
...
Перший параметр має бути `drawingType` типу `string`.
...
Другий параметр має бути `isReversed` типу `boolean`.
...
Третій параметр має бути `shortName` типу `string`.
...
Четвертий параметр має бути `img` типу `string`.
...
Ваша функція `renderCard` має мати тип повернення `string`.
...
Ваша функція `renderCard` має повертати шаблонний літерал.
