...
Para ver tu excepción personalizada en acción, convierte la línea `catalogue.add(series2)` en `catalogue.add('series2')`.

# --hints--

Debes convertir la línea `catalogue.add(series2)` en `catalogue.add('series2')`.
