...
Tu selector de `section` debe tener una propiedad `max-width` configurada a `40rem`.
...
Tu selector de `section` debe tener una propiedad `margin` configurada a `0 auto`.
...
Tu selector de `section` debe tener una propiedad `border` configurada a `2px solid #d0d0d5`.
