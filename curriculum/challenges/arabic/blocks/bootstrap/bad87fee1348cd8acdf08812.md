...
يمتلك Bootstrap أنماطًا خاصة بعناصر `button`، تبدو أفضل بكثير من تلك البسيطة في HTML.

أنشئ عنصر `button` جديدًا أسفل صورة القط الكبير. أضف له الصنفين `btn` و `btn-default`، وكذلك النص `Like`.

# --hints--

يجب أن تنشئ عنصر `button` جديدًا يحتوي على النص `Like`.
...
يجب أن يحتوي الزر الجديد على صنفين: `btn` و `btn-default`.
