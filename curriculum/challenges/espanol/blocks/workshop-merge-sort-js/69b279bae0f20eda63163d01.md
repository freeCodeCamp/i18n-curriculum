...
Después de imprimir la cadena, registra el arreglo `numbers` para que aparezca la lista sin ordenar a continuación.

# --hints--

Debes llamar a `console.log(numbers);` después del mensaje `'Unsorted array: '`.
