...
Ahora, pasemos a observar expresiones. Las expresiones de observación te permiten monitorear los valores de variables o expresiones mientras se ejecuta el código, incluso si están fuera del ámbito actual.
...
Ahora, pasemos a inspeccionar las solicitudes de red. Inspeccionar las solicitudes de red puede ayudarte a depurar problemas relacionados con solicitudes API, como errores en los parámetros, errores de dirección o errores del servidor.
...
Para la última parte de esta lección, nos enfocaremos en `console.table` y `console.dir`.
