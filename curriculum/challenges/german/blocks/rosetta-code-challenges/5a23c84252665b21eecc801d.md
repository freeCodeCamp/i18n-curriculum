...
title: Einen String anhand von Zeichenwechsel aufteilen
challengeType: 1
forumTopicId: 302322
...
Teilen Sie einen (Zeichen-)String in durch Komma (plus Leerzeichen) getrennte Strings auf, basierend auf einem Wechsel des Zeichens (von links nach rechts). Leerzeichen sollen wie jedes andere Zeichen behandelt werden (außer dass sie schwer klar darstellbar sind). Gleiches gilt für Kommas. Zum Beispiel sollte der String:
