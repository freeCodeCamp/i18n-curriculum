...
**Uso** Em matemática, um número pode ser verificado como par ou ímpar ao verificar o resto da divisão do número por `2`. Números pares têm um resto de `0`, enquanto números ímpares têm um resto de `1`.
