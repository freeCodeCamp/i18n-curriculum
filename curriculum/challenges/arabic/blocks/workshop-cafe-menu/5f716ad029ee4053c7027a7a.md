...
قم بتسكين عنصرين `p` داخل عنصر `article` الخاص بك. يجب أن يكون نص العنصر الأول `Donut`، ونص العنصر الثاني `1.50`. ضع كلاهما في نفس السطر مع التأكد من عدم وجود فراغ بينهما.
