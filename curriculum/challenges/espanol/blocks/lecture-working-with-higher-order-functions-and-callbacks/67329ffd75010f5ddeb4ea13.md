...
Imagina que tienes una función, y dentro de la función quieres hacer algo varias veces. En lugar de escribir todo el código en una función grande, puedes pasar una segunda función (el callback) para que se ejecute cada vez que necesites que se haga ese algo específico. Esto permite un código más flexible y modular.
