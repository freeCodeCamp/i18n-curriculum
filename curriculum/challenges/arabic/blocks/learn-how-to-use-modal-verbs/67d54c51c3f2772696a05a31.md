...
هناك إرشادات محددة لتشفير البيانات. ماذا ستقول جيسيكا؟
...
يجب أن تشير الاستجابة إلى وجود إرشادات، وليس أن التشفير اختياري.
...
الإجابة الصحيحة تؤكد وجود إرشادات محددة لتشفير البيانات.

عبارة `must be encrypted` تُظهر أن التشفير مطلب.
