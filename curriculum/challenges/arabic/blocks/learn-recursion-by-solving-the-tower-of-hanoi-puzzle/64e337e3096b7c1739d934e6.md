...
قبل استدعائك التكراري، أضف تعليقًا يقول `move n - 1 disks from source to auxiliary, so they are out of the way`.

# --hints--

يجب أن تضيف تعليقًا بالنص المقدم قبل استدعائك التكراري.
