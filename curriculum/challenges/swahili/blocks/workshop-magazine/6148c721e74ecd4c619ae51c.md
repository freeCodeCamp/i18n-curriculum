...
Kipengele chako cha `.text` si CSS Grid, lakini unaweza kuunda safu ndani ya kipengele bila kutumia Grid kwa kutumia sifa ya `column-width`.

Toa kichaguzi chako cha `.text` sifa ya `column-width` iliyowekwa kuwa `25rem`.

# --hints--

Kichaguzi chako cha `.text` kinapaswa kuwa na sifa ya `column-width` iliyowekwa kuwa `25rem`.
