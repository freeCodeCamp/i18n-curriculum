...
Квантори використовуються в регулярних виразах, щоб вказати, скільки разів символ може повторюватися. Наприклад, символ `+` відповідає попередньому символу один або більше разів:
...
Отже, додайте квантор `+` до свого шаблону регулярного виразу, щоб відповідати одній або більше цифрам.

# --hints--

Ви повинні додати квантор `+` до вашого поточного шаблону регулярного виразу `p\d`.
