...
Siguiendo eso, agrega tres elementos `td` con el siguiente texto (en ese order): `$579`, `$736`, `$809`. Da al tercer elemento `td` un atributo `class` establecido en `current`.
