...
Kipengele chako cha kwanza cha `div` cha `className` cha `form-group` kinapaswa kuwa na `label` yenye sifa ya kipengele `htmlFor` ya `pac`, `className` ya `label`, na maandishi ya `PAC`.
...
Kipengele chako cha kwanza cha `div` cha `className` cha `form-group` kinapaswa kuwa na `input` yenye `className` ya `input`, `id` ya `pac` na `type` ya `number`.
...
Kipengele chako cha pili cha `div` cha `className` cha `form-group` kinapaswa kuwa na `label` yenye sifa ya kipengele `htmlFor` ya `sho`, `className` ya `label`, na maandishi ya `SHO`.
...
Kipengele chako cha pili cha `div` cha `className` cha `form-group` kinapaswa kuwa na `input` yenye `id` ya `sho`, `className` ya `input`, na `type` ya `number`.
