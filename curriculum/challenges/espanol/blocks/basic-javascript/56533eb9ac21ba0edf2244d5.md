...
The greater than or equal to operator (`>=`) compares the values of two numbers. Si el número de la izquierda es mayor o igual que el número de la derecha, devuelve `true`. De lo contrario, devuelve `false`.
