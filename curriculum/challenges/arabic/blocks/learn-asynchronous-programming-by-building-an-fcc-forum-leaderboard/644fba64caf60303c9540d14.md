...
بعد خاصية `href`، عرّف خاصية `class` لتساوي الثابت المسمى `linkClass`.

بعد خاصية `class`، عرّف خاصية `target` لتساوي `"_blank"`.

أخيرًا، ضع الثابت `linkText` بين وسمَي الرابط لعرض النص في الرابط.

# --hints--

يجب أن يكون لديك خاصية `class` بعد خاصية `href`.
...
يجب أن تعيّن قيمة خاصية `class` إلى الثابت المسمى `linkClass`.
...
يجب أن يكون لديك خاصية `target` بعد خاصية `class`.
...
يجب أن تعيّن قيمة خاصية `target` إلى `"_blank"`.
...
يجب أن تضع الثابت `linkText` بين وسمَي الرابط.
