...
變量主要與顏色一起使用，這就是你在此處使用它們的方式。 但它們可以被賦予任何值並用於任何屬性。 你的項目看起來很棒！

# --hints--

你應該添加 `--window-color1`，其值爲 `#777`。
