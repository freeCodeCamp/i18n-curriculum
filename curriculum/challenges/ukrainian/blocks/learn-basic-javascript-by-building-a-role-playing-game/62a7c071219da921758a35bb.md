...
Вкінці оновіть властивість `innerText` з `text` на `"You are in the town square. You see a sign that says Store."`.
...
Встановіть властивість `text.innerText` на `"You are in the town square. You see a sign that says Store."` у функцій `goTown`.
