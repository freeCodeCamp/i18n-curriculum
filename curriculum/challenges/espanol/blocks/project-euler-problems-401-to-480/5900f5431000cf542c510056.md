...
Find $G({10}^{11})$. Give your answer as a string in scientific notation rounded to 10 significant digits. Usa una minúscula `e` para separar mantissa y exponente.
