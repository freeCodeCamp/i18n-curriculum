...
Тепер, коли функція `displayStory` працює правильно, настав час додати функціональність кнопкам.

Перед цим видаліть виклик функції `displayStory("scary")`.

# --hints--

Ви повинні видалити виклик функції `displayStory("scary")`.
