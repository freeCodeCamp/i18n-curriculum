...
Ongeza mihimili ya x na y kwenye mchoro ili kupata matokeo yafuatayo:
...
Alama zinapatikana kama `x_axis_tick` na `y_axis_tick`.

# --hints--

Njia inapaswa kurudisha matokeo sahihi.
...
Njia inapaswa kurudisha matokeo sahihi kwa matukio tofauti.
