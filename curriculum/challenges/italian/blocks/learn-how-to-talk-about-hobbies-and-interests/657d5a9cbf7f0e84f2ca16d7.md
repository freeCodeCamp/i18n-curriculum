...
Questo è il verbo `to be`, usato con `you`. È la parola iniziale di una domanda, quindi scrivila con la lettera maiuscola.
...
Questa preposizione si usa con il verbo `to be` per esprimere che a qualcuno piace qualcosa o che è interessato a qualcosa.
