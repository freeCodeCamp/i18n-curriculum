...
`To have strong opinions` means to hold firm or intense beliefs about something, often with conviction. 例如：
...
`To approach` refers to a method or way of doing something. 例如：
