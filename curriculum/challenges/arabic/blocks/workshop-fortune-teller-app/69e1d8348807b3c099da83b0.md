...
يجب أن تختبر تقدمك حتى الآن. أنشئ مثيلًا من `Game` الصنف وعيّنه في متغير `game`.

في هذه المرحلة، سترى أنه يمكنك رؤية البطاقات عند نقر زري Single Card Reading و
Three Card Spread.

# --hints--

يجب إعلان متغير باسم `game`.
...
يجب تهيئة متغير `game` باستخدام `new Game()`.
