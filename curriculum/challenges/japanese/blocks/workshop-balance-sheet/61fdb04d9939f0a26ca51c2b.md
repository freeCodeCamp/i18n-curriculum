...
テーブルの見出しをスタイル設定する時間です。`h1` セレクターを作成してください。`max-width` プロパティを `37.25rem` に、`margin` プロパティを `0 auto` に、`padding` プロパティを `1.5rem 1.25rem` に設定してください。
...
`h1` セレクターには `max-width` プロパティが `37.25rem` に設定されているはずです。
...
`h1` セレクターには `margin` プロパティが `0 auto` に設定されているはずです。
...
`h1` セレクターには `padding` プロパティが `1.5rem 1.25rem` に設定されているはずです。
