...
Aumenta l'area e addolcisci i bordi di `.one` impostando la sua proprietà `box-shadow` su `0 0 3px 3px #efb762`.

# --hints--

Dovresti assegnare alla proprietà `box-shadow` il valore `0 0 3px 3px #efb762`.
...
Il selettore `.one` dovrebbe avere una proprietà `box-shadow` con il valore `0 0 3px 3px #efb762`.
