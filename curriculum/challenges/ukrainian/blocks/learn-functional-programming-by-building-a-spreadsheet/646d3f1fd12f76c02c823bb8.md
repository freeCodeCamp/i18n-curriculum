...
У вас невелика помилка. `arg1` та `arg2` є рядками, а не числами. `infixToFunction['+']("1", "2")` поверне `12`, що є математично неправильним.

Оберніть кожен із аргументів `infixToFunction[operator]` у виклик `parseFloat()`.

# --hints--

Обгорніть `arg1` у виклик `parseFloat()`.
...
Обгорніть `arg2` у виклик `parseFloat()`.
