...
五角数は、式 P<sub>n</sub>=`n`(3`n`−1)/2 で生成されます。最初の10個の五角数は次の通りです：

1、5、12、22、35、51、70、92、117、145、...

P<sub>4</sub> + P<sub>7</sub> = 22 + 70 = 92 = P<sub>8</sub> であることがわかります。しかし、それらの差である 70 − 22 = 48 は五角数ではありません。

和と差が五角数であり、かつ D = |P<sub>k</sub> − P<sub>j</sub>| が最小となる五角数のペア P<sub>j</sub> と P<sub>k</sub> を見つけてください。D の値はいくつですか？
