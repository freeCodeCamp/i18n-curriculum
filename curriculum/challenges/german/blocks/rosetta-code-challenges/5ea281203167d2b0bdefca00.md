...
Ludische Zahlen stehen in Beziehung zu Primzahlen, da sie durch ein Sieb erzeugt werden, das dem Sieb des Eratosthenes ähnelt, mit dem Primzahlen erzeugt werden.

Die erste ludische Zahl ist 1.

Um die folgenden ludischen Zahlen zu erzeugen, erstellen Sie ein Array mit aufsteigenden ganzen Zahlen, beginnend bei 2.
...
<ul>
  <li>Nehmen Sie das erste Element des resultierenden Arrays als die nächste ludische Zahl <span style='color:blue;font-weight:bold'>2</span>.</li>
  <li>Entfernen Sie jedes <strong>2.<sup>te</sup></strong> Element aus dem Array (einschließlich des ersten).</li>
...
<ul>
  <li>(Einige Schleifen ausgeführt...)</li>
  <li>Nehmen Sie das erste Element des resultierenden Arrays als die nächste ludische Zahl <span style='color:blue;font-weight:bold'>3</span>.</li>
  <li>Entfernen Sie jedes <strong>3.<sup>te</sup></strong> Element aus dem Array (einschließlich des ersten).</li>
...
<ul>
  <li>Nehmen Sie das erste Element des resultierenden Arrays als die nächste ludische Zahl <span style='color:blue;font-weight:bold'>5</span>.</li>
  <li>Entfernen Sie jedes <strong>5.<sup>te</sup></strong> Element aus dem Array (einschließlich des ersten).</li>
...
<ul>
  <li>Nehmen Sie das erste Element des resultierenden Arrays als die nächste ludische Zahl <span style='color:blue;font-weight:bold'>7</span>.</li>
  <li>Entfernen Sie jedes <strong>7.<sup>te</sup></strong> Element aus dem Array (einschließlich des ersten).</li>
...
<ul>
  <li><big><b> ... </b></big></li>
  <li>Nehmen Sie das erste Element des aktuellen Arrays als die nächste ludische Zahl <span style='color:blue;font-weight:bold'>L</span>.</li>
  <li>Entfernen Sie jedes <strong>L.<sup>te</sup></strong> Element aus dem Array (einschließlich des ersten).</li>
  <li><big><b> ... </b></big></li>
</ul>

# --instructions--

Schreiben Sie eine Funktion, die alle ludischen Zahlen kleiner oder gleich der gegebenen Zahl zurückgibt.
