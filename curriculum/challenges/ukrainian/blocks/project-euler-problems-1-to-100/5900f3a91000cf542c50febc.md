...
Трикутні, квадратні, п’ятикутні, шестикутні, семикутні та восьмикутні числа — це всі фігурні (полігональні) числа, які генеруються за такими формулами:
...
1. Множина є циклічною, оскільки останні дві цифри кожного числа є першими двома цифрами наступного числа (включно з останнім числом і першим).
2. Кожен полігональний тип: трикутний ($P_3(127) = 8128$), квадратний ($P_4(91) = 8281$) і п’ятикутний ($P_5(44) = 2882$), представлений різним числом у множині.
3. Це єдина множина 4-значних чисел з такою властивістю.

Знайдіть суму всіх чисел у впорядкованих множинах `n` циклічних 4-значних чисел, для яких кожен полігональний тип від $P_3$ до $P_{n + 2}$ представлений різним числом у множині.
