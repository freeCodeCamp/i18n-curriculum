...
Tu función `idToText` debería devolver el resultado de llamar al método `.find()` en tu matriz `cells`. Tu función de callback debería usar un retorno implícito.
