...
Baada ya kuweka thamani ya kipengele katika `left_part` kwenye safu ya data iliyopangwa, ongeza `left_array_index` kwa `1`.

# --hints--

Unapaswa kuongeza `1` kwenye thamani ya sasa ya `left_array_index` baada ya kuingiza kipengele kwenye safu ya data iliyopangwa.
