...
Umejifunza katika somo lililopita kwamba neno kuu la `this` linarejelea mfano wa sasa unaojengwa, kama ulivyoona katika kijenzi cha `Dessert`. Hapa, utatumia wazo lile lile kwa darasa la `ShoppingCart`.
