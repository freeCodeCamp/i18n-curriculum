...
Las funciones internas también pueden devolver una función. Usando la misma sintaxis de flecha, actualice su función `addCharacters` para devolver una tercera función que toma un parámetro `num`.

# --hints--

Tu función de flecha interna debe devolver otra función de flecha con un parámetro `num`.
...
Tu función de flecha más interior debe estar vacía.
