...
Щоб додати пробіл між рядками в макеті сітки, ви можете використати властивість `row-gap`. Додайте селектору `main` властивість `row-gap` зі значенням `3rem`.

# --hints--

Ваш селектор `main` має мати властивість `row-gap` зі значенням `3rem`.
