...
`Average usage` means how much something is used on a regular basis, usually calculated by adding up usage over time and dividing by the number of days or users. Per esempio:
