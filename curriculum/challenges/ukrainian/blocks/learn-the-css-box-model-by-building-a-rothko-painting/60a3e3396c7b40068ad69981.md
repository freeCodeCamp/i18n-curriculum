...
Створіть нове CSS-правило, використовуючи селектор `.two`, і встановіть його властивість `width` у 475 пікселів.

# --hints--

Ви повинні мати селектор `.two`.
...
Ви повинні встановити властивість `width` у значення `475px`.
...
Ваш елемент `.two` повинен мати значення `width` рівне `475px`.
