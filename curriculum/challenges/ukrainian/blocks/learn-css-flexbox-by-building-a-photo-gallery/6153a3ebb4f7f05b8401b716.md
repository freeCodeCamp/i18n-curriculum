...
Атрибут `alt` для зображення має описувати вміст зображення. Читачі екрана оголошують альтернативний текст замість зображень. Якщо зображення не можна завантажити, цей текст відображається замість зображення.
...
Усі дев’ять ваших елементів `img` повинні мати атрибут `alt` з текстом, що описує кожне зображення, причому кожен опис має містити щонайменше `5` літер.
