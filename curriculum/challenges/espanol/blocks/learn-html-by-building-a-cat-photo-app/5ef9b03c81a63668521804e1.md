...
El elemento `fieldset` se usa para agrupar entradas y etiquetas relacionadas en un formulario web. Los elementos `fieldset` son <dfn>elementos de nivel bloque</dfn>, lo que significa que aparecen en una nueva línea.
...
Tu elemento `fieldset` debe tener una etiqueta de apertura. Las etiquetas de apertura tienen la siguiente sintaxis: `<elementName>`.
