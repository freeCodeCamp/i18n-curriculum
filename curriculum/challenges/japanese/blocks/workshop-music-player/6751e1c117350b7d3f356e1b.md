...
`playSong` 関数の中で、`highlightCurrentSong` 関数を呼び出してください。

その後、操作ボタンをいじって、`highlightCurrentSong` 関数がどのように動くか試してみてください。

# --hints--

`highlightCurrentSong` 関数の中で `playSong` を呼び出す必要があります。
