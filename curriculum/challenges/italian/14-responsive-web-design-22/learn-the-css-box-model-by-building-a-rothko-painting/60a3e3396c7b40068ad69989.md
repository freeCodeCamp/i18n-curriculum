...
Dovresti assegnare alla proprietà `background-color` il valore `#b20403`.
...
Il selettore `.three` dovrebbe avere una proprietà `background-color` con il valore `#b20403`.
