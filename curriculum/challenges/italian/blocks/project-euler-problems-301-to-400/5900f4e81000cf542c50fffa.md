...
Sia $f(n)$ il numero di coppie ($x$, $y$) con $x$ e $y$ numeri interi positivi, $x ≤ y$ e il minimo comune multiplo di $x$ e $y$ uguale a $n$.

Sia $g$ la funzione sommatoria di $f$, cioè: $g(n) = \sum f(i)$ per $1 ≤ i ≤ n$.

Ti viene dato che $g({10}^6) = 37\\,429\\,395$.
