...
7. El usuario no debería poder ingresar más de `50` caracteres en el elemento `textarea`. Cuando el conteo de caracteres alcanza `50`, el texto `Character Count: 50/50` debería mostrarse en `rojo`.
...
Si el conteo de caracteres es mayor o igual a `50`, el usuario no debería poder ingresar más caracteres.
