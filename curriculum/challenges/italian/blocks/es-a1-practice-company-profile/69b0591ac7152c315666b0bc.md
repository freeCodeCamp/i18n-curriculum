...
Questa attività verifica la tua comprensione di come si richiede un'informazione specifica nel dialogo.

# --instructions--

Leggi il dialogo e decidi se la seguente affermazione è vera o falsa.

# --questions--

## --text--

È vero o falso: quando Sebastián chiede `¿Cuál es su sitio web?`, sta chiedendo l'indirizzo del sito web dell'azienda.
...
Rivedi che tipo di informazione `¿Cuál...?` viene usata per richiedere in questo contesto.
...
`¿Cuál...?` si usa per chiedere un'informazione specifica o un'identificazione. Per esempio:

- `¿Cuál es tu nombre?` - Qual è il tuo nome?

- `¿Cuál es tu número de teléfono?` - Qual è il tuo numero di telefono?

Nel dialogo, `¿Cuál es su sitio web?` chiede un'informazione specifica: il sito web.

`Su` si riferisce all'azienda (suo), e `es` è terza persona singolare perché il soggetto è `su sitio web`.
