...
Tronca una stringa (primo argomento) se è più lunga della lunghezza massima data (secondo argomento). Ritorna la stringa troncata con un finale `...`.
