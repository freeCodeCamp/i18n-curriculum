...
Infine, nel selettore `:root` della media query, ridefinisci tutte e quattro le variabili `--window-color` per usare `#777`. Quando hai finito, ridimensiona la finestra e guarda il passaggio dal giorno alla notte.

Le variabili si usano principalmente con i colori, ed è così che le hai usate qui. Ma possono assumere qualsiasi valore e essere usate su qualsiasi proprietà. Il tuo progetto è fantastico!

# --hints--

Dovresti aggiungere `--window-color1` con un valore di `#777`.
...
Dovresti aggiungere `--window-color2` con un valore di `#777`.
...
Dovresti aggiungere `--window-color3` con un valore di `#777`.
...
Dovresti aggiungere `--window-color4` con un valore di `#777`.
