...
HTML의 일부 요소에 `center` 클래스를 추가했습니다. 이제 그 클래스를 정의하여 해당 요소들을 가운데 정렬하세요.

`center` 클래스를 선택하고, `text-align` 속성을 `center`로 설정하여 그 클래스를 가진 요소들을 가운데 정렬하세요.

# --hints--

`center` 클래스를 가진 요소를 선택하세요.
