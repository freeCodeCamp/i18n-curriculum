...
1. Debes declarar una variable `num` y asignarle un número de tu elección. El número asignado debe estar entre `1` y `20` inclusive.
...
Debes imprimir el valor de `resultMsg` en la consola.
