...
لا تزال داخل دالة `playSong`، عرّف الخاصية `audio.src` لتساوي `song.src`. هذا يخبر عنصر الصوت أين يجد بيانات الصوت للأغنية المختارة.

أيضًا، عرّف الخاصية `audio.title` لتساوي `song.title`. هذا يخبر عنصر الصوت بما يعرضه كعنوان للأغنية.

# --hints--

يجب أن تعرّف الخاصية `audio.src` لتساوي `song.src` داخل دالة `playSong` الخاصة بك.
...
يجب أن تعرّف الخاصية `audio.title` لتساوي `song.title` داخل دالة `playSong` الخاصة بك.
