...
`Real-time alerts` are messages or warnings that appear immediately as something happens. 例如：
...
`Graphics` are images or visual elements used to communicate information. 例如：
