...
Então, crie outra variável chamada `greeting` e atribua a ela a sentença `"Hi there! My name is [botName goes here] and I am here to teach you about the Math object!"` No lugar do espaço reservado `[botName goes here]`, use a variável `botName`.
