...
`Who` is a relative pronoun. It introduces a clause that gives more information about a person. It connects the description or action directly to that person. 举个例子：
