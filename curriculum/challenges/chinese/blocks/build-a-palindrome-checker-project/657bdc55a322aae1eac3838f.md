...
1. 当 `#text-input` 元素包含文本 `A man, a plan, a canal Panama` and the `#check-btn` element is clicked, the `#result` element should contain the text `A man, a plan, a canal. Panama is a palindrome`.
...
当 `#text-input` 元素包含文本 `A man, a plan, a canal Panama` and the `#check-btn` element is clicked, the `#result` element should contain the text `A man, a plan, a canal. Panama is a palindrome`.
