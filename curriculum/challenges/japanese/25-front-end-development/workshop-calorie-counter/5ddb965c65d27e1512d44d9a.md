...
In this workshop, you'll learn to create a calorie counter form that enables users to input their daily calorie budget and the calorie counts of various meals. そして、ユーザーがカロリー不足か過剰かを計算して表示します。
