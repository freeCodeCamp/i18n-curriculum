...
На малих екранах невпорядкований список у навігаційній панелі виходить за правий край екрану.

Виправте це, використавши _гнучкий контейнер_ для обгортання `ul` вмісту. Потім встановіть такі CSS-властивості, щоб правильно вирівняти текст:
