...
إذا نظرت عن قرب، ستلاحظ أن عناصر `.inline` مرتفعة جدًا على السطر.

لمعالجة هذا، عرّف الخاصية `vertical-align` على القيمة `middle`.

# --hints--

يجب أن تعرّف الخاصية `vertical-align` على القيمة `middle` لجميع عناصر `.inline`.
