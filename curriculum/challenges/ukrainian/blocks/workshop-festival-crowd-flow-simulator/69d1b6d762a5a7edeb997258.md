...
Симулюйте нічну зміну, викликавши `simulateFestival()` з `nightGates` та `"Night"`.

На цьому ваші симуляції завершені!

# --hints--

Ви маєте викликати `simulateFestival()` з `nightGates` та `"Night"`.
