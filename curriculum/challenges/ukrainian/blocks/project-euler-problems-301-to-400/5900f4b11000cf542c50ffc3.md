...
Нехай $f(n)$ представляє кількість способів, якими можна заповнити вежу розміром $3×3×n$ блоками розміром $2×1×1$. Ви можете обертати блоки будь-яким чином; однак обертання, віддзеркалення тощо самої вежі вважаються різними способами.
...
`buildingTower()` має повертати `96972774`.
