...
Sasa fanya wito kwa njia yako ya `.calculateTotal()` ndani ya mzunguko wako wa `forEach`.

# --hints--

Unapaswa kufanya wito wa `cart.calculateTotal()` ndani ya mzunguko wako wa `forEach`.
