...
Para el tercer y cuarto puntos de referencia, repita el patrón `transform` una vez más.

# --hints--

Debe darle al punto de referencia `30%` un `transform` de `rotate(110deg) scaleX(-1)`.
...
Debe darle al punto de referencia `40%` un `transform` de `rotate(130deg) scaleX(-1)`.
