...
Agrega dos objetos más al arreglo `profiles`: uno para Tiffany y otro para Doug:
...
La lógica de tu `map()` debe permanecer sin cambios y ahora mostrar las tres tarjetas.

Con eso, ¡tu proyecto de componente de tarjeta de perfil reutilizable está completo!

# --hints--

Debes renderizar exactamente tres componentes `Card`.
