...
في قالب النص الخاص بك، أنشئ عنصر `div` بصنف `dessert-card`. داخل هذا العنصر `div`، أنشئ عنصر `h2` وأعطه نص المتغير `name`.
...
يجب أن يحتوي عنصر `div` على صنف `dessert-card`.
