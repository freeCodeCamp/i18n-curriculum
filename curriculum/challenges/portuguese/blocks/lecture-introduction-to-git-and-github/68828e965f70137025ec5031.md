...
Você frequentemente vai combinar um sistema de controle de versão como o Git com um provedor de controle de versão como o GitHub ou GitLab, que oferecem ferramentas adicionais de colaboração e a capacidade de fazer backup dos seus projetos na nuvem.
