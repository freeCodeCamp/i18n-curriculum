...
Тепер використайте оператор **OR**, щоб додати параметр `start` як другу умову до інструкції `if` після `userData.currentSong === null`. 


# --hints--

Ви повинні використати оператор **OR**, щоб додати параметр `start` як другу умову до інструкції `if` після `userData.currentSong === null`. 
