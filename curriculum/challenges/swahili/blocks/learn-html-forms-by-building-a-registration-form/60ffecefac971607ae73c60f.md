...
Kuhusu `padding`, kitufe cha kuwasilisha kiko chini ya kipengele cha `form`. Ongeza `2em` ya `padding` tu chini ya `form`.
...
Unapaswa kumpa `padding-bottom` thamani ya `2em`.
