...
This word in the plural form refers to separate sections or pages in software, usually located at the top of a window or application, that you can switch between.

# --explanation--

`Flickers` describes an effect where the image or light on the screen changes quickly and repeatedly, often in a way that can be distracting. Zum Beispiel:
