...
`btn-container` クラスを持つ要素の中の最初のボタンには、値が `view-cart-btn` の `id` 属性が必要です。
...
`btn-container` クラスを持つ要素の中の最初のボタンには、値が `btn` の `class` 属性が必要です。
...
`btn-container` クラスを持つ要素の中の2つ目のボタンには、値が `checkout-btn` の `id` 属性が必要です。
...
`class="btn-container"` を持つ要素の中の2つ目のボタンには、値が `btn` の `class` 属性が必要です。
