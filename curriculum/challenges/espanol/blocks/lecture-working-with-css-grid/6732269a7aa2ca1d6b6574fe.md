...
Dos elementos llenan la primera fila usando las dos columnas explícitas: `Item 1` en la primera columna y `Item 2` en la segunda columna.

Los siguientes elementos inician una nueva fila con `Item 3` yendo en la primera columna de la segunda fila y `Item 4` en la segunda columna de la segunda fila, y así sucesivamente.
