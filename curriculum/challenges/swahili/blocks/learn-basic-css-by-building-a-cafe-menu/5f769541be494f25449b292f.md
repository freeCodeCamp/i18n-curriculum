...
Kutumia darasa lako jipya la `flavor` kama kichaguzi, weka thamani ya sifa ya `text-align` kuwa `left`.

# --hints--

Unapaswa kuwa na kichaguzi cha darasa la `flavor`.
...
Unapaswa kuweka sifa ya `text-align` kuwa `left`.
...
Kichaguzi chako cha darasa la `flavor` kinapaswa kuweka sifa ya `text-align` kuwa `left`.
