...
你最後要做的是為家庭方案的 CTA 按鈕設計樣式。

為它添加 `block`、`rounded-md`、`bg-indigo-600`、`px-4`、`py-2`、`text-center`、`font-semibold`、`text-white` 和 `hover:bg-indigo-700` 類別。

這樣，你的 Tailwind 定價組件工作坊就完成了！

# --hints--

你的錨點元素應該有類別 `bg-indigo-600`。
...
你的錨點元素應該有 `hover:bg-indigo-700` 類別。
