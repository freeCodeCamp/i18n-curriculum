...
آخر شيء ستفعله هو تنسيق زر الدعوة إلى الإجراء (CTA) لخطة العائلة.

أضف له الأصناف `block`، `rounded-md`، `bg-indigo-600`، `px-4`، `py-2`، `text-center`، `font-semibold`، `text-white`، و`hover:bg-indigo-700`.

بهذا، تكتمل ورشة عمل مكوِّن التسعير باستخدام Tailwind!

# --hints--

يجب أن يحتوي عنصر وسم الرابط على الصنف `bg-indigo-600`.
...
يجب أن يحتوي عنصر وسم الرابط على الصنف `px-4`.
...
يجب أن يحتوي عنصر وسم الرابط على الصنف `py-2`.
...
يجب أن يحتوي عنصر وسم الرابط على الصنف `text-center`.
...
يجب أن يحتوي عنصر وسم الرابط على الصنف `font-semibold`.
...
يجب أن يحتوي عنصر وسم الرابط على الصنف `hover:bg-indigo-700`.
