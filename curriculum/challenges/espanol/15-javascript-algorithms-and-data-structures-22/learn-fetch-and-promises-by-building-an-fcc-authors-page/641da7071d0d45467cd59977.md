...
Ahora necesitas mostrar información sobre el autor. Primero, muestra el nombre del autor.

Crea una etiqueta `h2` con la `clase` `"author-name"`. Luego, interpola `author` dentro de la etiqueta `h2`. Este es el nombre del autor.
...
Tu elemento `h2` debe tener una clase establecida a `"author-name"`
...
Debes interpolar el `author` en tu etiqueta `h2` para mostrar los nombres de los autores.
