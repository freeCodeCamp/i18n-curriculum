...
Текст `.sr-only` все ще видимий. Щоб візуально приховати текст, який буде доступний лише для читачів екрана, існує базовий шаблон.

Для цього потрібно встановити наступні CSS-властивості:
...
Використайте наведені вище властивості, щоб визначити CSS-правило `.sr-only`.
