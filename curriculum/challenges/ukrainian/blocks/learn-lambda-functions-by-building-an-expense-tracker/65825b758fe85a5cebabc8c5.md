...
Якщо це правда, це означає, що користувач хоче побачити загальні витрати. Тож викличте `print()` і передайте рядок `'\nTotal Expenses: '` як перший аргумент і `total_expenses(expenses)` як другий аргумент.

# --hints--

Ви повинні створити умову `elif`, яка перевіряє, чи `choice == '3'`.
...
Ви повинні вивести `'\nTotal Expenses: ', total_expenses(expenses)` у вашій новій умові `elif`.
