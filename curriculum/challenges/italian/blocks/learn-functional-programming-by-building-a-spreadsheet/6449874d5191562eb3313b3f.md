...
Infine, rendi il tuo `rangeRegex` globale e insensibile al caso.

# --hints--

Il tuo `rangeRegex` dovrebbe essere insensibile al caso.
...
Il tuo `rangeRegex` dovrebbe essere globale.
...
Il tuo `rangeRegex` dovrebbe essere sia globale sia insensibile al caso.
