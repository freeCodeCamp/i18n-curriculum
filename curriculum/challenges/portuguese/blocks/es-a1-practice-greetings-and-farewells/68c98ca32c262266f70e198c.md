...
|--------------------|-----------------|----------------------------------------------------------------|
| `Adiós`            | Adeus         | Uma despedida em geral ou ligeramente formal. |
| `Hasta luego`      | Até logo   | Quando você planeja ver a pessoa novamente, mas não de imediato.    |
| `Hasta mañana`     | Até amanhã| Quando você espera ver a pessoa no dia seguinte.                |
| `Hasta pronto`     | Até mais    | Quando você espera ver a persona logo.                   |
| `Chao`             | Tchau             | Informal e amigável. |
