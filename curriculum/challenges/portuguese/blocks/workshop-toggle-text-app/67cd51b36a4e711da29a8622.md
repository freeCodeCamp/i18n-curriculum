...
Para alternar a visibilidade do texto, você precisará primeiro criar uma função que será responsável por esse comportamento.

Comece criando uma nova função chamada `handleToggleVisibility`. 

# --hints--

Você deve ter uma função `handleToggleVisibility`.
