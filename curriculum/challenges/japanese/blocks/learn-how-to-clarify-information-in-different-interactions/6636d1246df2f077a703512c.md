...
誰かが`part of`何かであると言うとき、その人がグループや場所に属しているか含まれていることを意味します。たとえば、`you are part of a team`と言うと、そのチームで一緒に働くメンバーの一人であることを示します。
...
`of`と組み合わせると、誰かがメンバーである、またはグループに含まれていることを表す表現になります。
