...
# --description--
Il calendario gregoriano è un calendario solare con 12 mesi di 28-31 giorni ciascuno. Una settimana è composta da sette giorni, e ci sono 52 settimane e 1 giorno all'anno. L'anno è composto da 365 giorni con un giorno bisestile aggiunto a febbraio ogni anno bisestile. Un anno bisestile si verifica ogni quattro anni, tranne che per i primi tre anni secolari di ogni 400 anni.

Il <a href="http://www.rosettacode.org/wiki/Discordian_date" target="_blank" rel="noopener noreferrer nofollow">calendario discordiano</a> è allineato con il calendario gregoriano e inizia il 1° gennaio. La settimana è composta da cinque giorni, e ci sono 73 settimane all'anno. L'anno è anch'esso composto da 365 giorni, con un giorno extra inserito tra Chaos 59 e Chaos 60 ogni anno bisestile.

I mesi, i giorni della settimana, gli eventi degli Apostoli e le festività nel calendario discordiano sono:

Stagioni: `'Chaos', 'Discord', 'Confusion', 'Bureaucracy', 'The Aftermath'`.
...
Festività: `'Chaoflux', 'Discoflux', 'Confuflux', 'Bureflux', 'Afflux'`.

# --instructions--

Converti una data data dal calendario gregoriano al calendario discordiano.

Nota che il giorno Chaos 1, 3188 YOLD nel calendario discordiano corrisponde al 1° gennaio 2022 nel calendario gregoriano.
