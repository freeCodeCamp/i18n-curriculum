...
Bevor Sie mit der BFS-Logik weitermachen, rufen Sie `genParentheses(1)` auf und geben Sie das Ergebnis in der Konsole aus.

# --hints--

Sie sollten `genParentheses(1)` in der Konsole ausgeben.
