...
Ви також маєте повторно відтворити пісні, призупинити пісню, що зараз відтворюється, встановити відображення плеєра та знову встановити доступний текст кнопки відтворення.

Викличте функцію `renderSongs` і передайте `userData?.songs` як аргумент. Також викличте функції `pauseSong`, `setPlayerDisplay` і `setPlayButtonAccessibleText`.

# --hints--

Ви не повинні змінювати існуючу функцію `shuffle` та її вміст.
...
Ви маєте викликати функцію `renderSongs` з `userData?.songs`.
...
Ви маєте викликати функцію `pauseSong`.
...
Ви маєте викликати функцію `setPlayerDisplay`.
