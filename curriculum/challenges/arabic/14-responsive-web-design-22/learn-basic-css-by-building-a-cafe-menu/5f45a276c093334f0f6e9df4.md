...
بالتركيز على بنود القائمة وأسعارها، هناك فجوة كبيرة نسبيا بين كل سطر.
...
يجب عليك تعيين خاصية `margin-top` إلى `5px`.
...
يجب عليك استخدام منتقي `.item p` الحالي.
...
عناصر `p` الخاصة بك المتداخلة في `.item` يجب أن تحتوي على `margin-top` من `5px`.
...
عناصر `p` الخاصة بك المتداخلة في `.item` يجب أن تحتوي على `margin-bottom` من `5px`.
