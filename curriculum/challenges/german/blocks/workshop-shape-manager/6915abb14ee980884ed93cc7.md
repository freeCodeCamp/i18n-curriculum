...
Setzen Sie innerhalb der Schleife das `oninput`-Ereignis jedes `input`-Elements auf die `handleInput`-Funktion.

Damit ist der Workshop zum Shape-Manager abgeschlossen!

# --hints--

Sie sollten `input.oninput` auf die `handleInput`-Funktion setzen.
