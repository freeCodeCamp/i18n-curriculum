...
In aggiunta a queste tre regole date sopra, se vengono usate delle combinazioni sottrattive, allora bisogna seguire le seguenti quattro regole.
...
Per esempio, sembrerebbe che ci siano almeno sei modi per scrivere il numero sedici:
...
Invece, secondo le regole, solo XIIIIII e XVI sono validi, e l'ultimo esempio è considerato il più efficiente, visto che usa il minor numero di simboli.
...
**Nota:** puoi assumere che tutti i numeri contenuti nell'array non abbiano più di quattro simboli consecutivi identici.
