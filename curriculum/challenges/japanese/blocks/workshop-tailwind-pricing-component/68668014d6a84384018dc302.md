...
次は最後の料金プラン、**ファミリープラン**です。

まず、このプランのラッパー`div`にクラス`bg-gray-100`、`ring-1`、`ring-gray-300`、`p-8`、`rounded-xl`を付けてください。

# --hints--

ファミリープランのラッパー`div`要素にはクラス`bg-gray-100`を付ける必要があります。
...
ファミリープランのラッパー`div`要素にはクラス`ring-1`を付ける必要があります。
...
ファミリープランのラッパー`div`要素にはクラス`ring-gray-300`を付ける必要があります。
...
ファミリープランのラッパー`div`要素にはクラス`p-8`を付ける必要があります。
...
ファミリープランのラッパー`div`要素にはクラス`rounded-xl`を付ける必要があります。
