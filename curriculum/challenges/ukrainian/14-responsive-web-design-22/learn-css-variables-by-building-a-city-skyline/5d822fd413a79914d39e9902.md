...
У властивості `border-bottom` елемента `.bb2a` змініть `1vw` на `5vh` та змініть колір `#000` на змінну `--building-color2`. Тепер чудовий вигляд! В будь-який час протягом виконання проєкту ви можете коментувати або видалити властивість `border`, яку ви додали напочатку, щоб побачити як виглядатимуть будівлі, коли вона буде видалена.
