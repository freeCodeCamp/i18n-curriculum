...
Essendo stata fornita un'immagine predefinita per la scheda e l'URL per effettuare una richiesta API, ti servono solo alcune variabili per salvarli.

Crea una variabile `CDN_URL` e impostala su `https://cdn.freecodecamp.org/curriculum/typescript/tarot-app`. Crea anche una variabile `defaultImg` con il valore `new URL("default.svg", CDN_URL + "/")` e una variabile `LOCAL_DEFAULT_IMG` con il valore `defaultImg`.

# --hints--

Dovresti creare una variabile chiamata `CDN_URL`.
...
La tua variabile `CDN_URL` dovrebbe essere impostata su `"https://cdn.freecodecamp.org/curriculum/typescript/tarot-app"`.
...
Dovresti creare una variabile chiamata `defaultImg`.
...
La tua variabile `defaultImg` dovrebbe essere impostata su `new URL("default.svg", CDN_URL + "/")`.
...
Dovresti creare una variabile chiamata `LOCAL_DEFAULT_IMG`.
...
La tua variabile `LOCAL_DEFAULT_IMG` dovrebbe essere impostata su `defaultImg`.
