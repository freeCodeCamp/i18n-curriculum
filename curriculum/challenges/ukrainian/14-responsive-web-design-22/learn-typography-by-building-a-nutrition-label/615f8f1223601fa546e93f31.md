...
Створіть останній елемент `p` для секції `.daily-value`. Надайте йому текст `Potassium 235mg 6%`. Вирівняйте текст `6%` за правим краєм та видаліть нижній кордон елемента `p`.
...
Ваш новий елемент `p` повинен мати текст `Potassium 235mg 6%`.
