...
`find_differences([1, 2, 4, 7])` 应该返回 `[1, 2, 3, 0]`。
...
`find_differences([10, 15, 19, 22, 24, 25])` 应该返回 `[5, 4, 3, 2, 1, 0]`。
...
`find_differences([25, 20, 16, 13, 11, 10])` 应该返回 `[-5, -4, -3, -2, -1, 0]`。
...
`find_differences([0, 1, 2, 2, 3, 3, 4, 5])` 应该返回 `[1, 1, 0, 1, 0, 1, 1, 0]`。
...
`find_differences([1, 2, 5, 12, 34, -15, -1, 41, 113, -222, -99, -40, 10, -18, -6, -2, -1])` 应该返回 `[1, 3, 7, 22, -49, 14, 42, 72, -335, 123, 59, 50, -28, 12, 4, 1, 0]`。
