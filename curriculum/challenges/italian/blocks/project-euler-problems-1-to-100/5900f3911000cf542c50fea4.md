...
Il numero 3797 ha una proprietà interessante. Essendo esso stesso un numero primo, è possibile rimuovere continuamente le cifre da sinistra a destra, rimanendo primo a ogni passaggio: 3797, 797, 97 e 7. Allo stesso modo possiamo procedere da destra a sinistra: 3797, 379, 37 e 3.

Trova la somma degli unici `n` (8 ≤ `n` ≤ 11) numeri primi che sono troncabili sia da sinistra a destra sia da destra a sinistra.
