...
Kwa sababu unapunguza moja tu kutoka `i`, unaweza kutumia <dfn>opereta ya kupunguza</dfn> `--`.

Badilisha mgawo wako wa thamani wa upunguzaji kwa opereta ya kupunguza.

# --hints--

Mzunguko wako wa `for` haupaswi kutumia mgawo wa thamani wa upunguzaji.
...
Mzunguko wako wa `for` unapaswa kutumia opereta ya kupunguza.
