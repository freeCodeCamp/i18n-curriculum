...
Para los pasos restantes, agregará la funcionalidad para mostrar los avatares de usuario.

Dentro del segundo elemento `td`, añade un elemento `div` con un nombre de clase de `"avatar-container"`.

# --hints--

Debes tener un elemento `div` dentro de tu elemento `td`.
...
Tu etiqueta `div` de apertura debería tener un atributo de clase con el valor de `"avatar-container"`.
