...
Ongeza msikilizaji wa tukio la `"click"` kwenye kipengele cha `shuffleButton`. Ili kitendakazi kifanye kazi, pita kitendakazi cha `shuffle`.

**Kumbuka**: Huna haja ya wito wa kurudisha ndani ya msikilizaji huu wa tukio. Huna haja pia ya kuita kitendakazi cha `shuffle`, pita tu kitambulisho chake.

# --hints--

Unapaswa kuunganisha njia ya `addEventListener()` na `shuffleButton`.
...
Unapaswa kupitisha `shuffle` kama thamani ya pili ya msikilizaji wako wa tukio wa `"click"`.
