...
이제 DOM에서 UI를 동적으로 렌더링하는 데 도움이 될 메인 클래스를 만들어야 합니다.

`Game`라는 클래스를 만드세요. 그 안에 `cards` 타입의 `Card[]` 속성을 추가하고, 일단 빈 배열로 초기화하세요.

# --hints--

`Game`라는 클래스가 있어야 합니다.
