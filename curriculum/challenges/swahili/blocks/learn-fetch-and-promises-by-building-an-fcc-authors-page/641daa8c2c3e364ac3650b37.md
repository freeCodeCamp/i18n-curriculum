...
Ongeza kipengele cha `div` juu ya maelezo mafupi ya mwandishi na kipawe `class` `"purple-divider"`.
...
Kipengele chako cha `div` kinapaswa kuwa na `class` iliyowekwa kuwa `"purple-divider"`.
