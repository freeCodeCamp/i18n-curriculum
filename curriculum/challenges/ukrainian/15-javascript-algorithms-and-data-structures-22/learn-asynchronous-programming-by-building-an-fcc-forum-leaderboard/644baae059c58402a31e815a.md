...
Якщо `id` не є в об’єкті `allCategories`, вам потрібно буде показати категорію `General`.

Під інструкцією `if` додайте умову `else`.

# --hints--

Ви повинні мати умову `else` під інструкцією `if`.
