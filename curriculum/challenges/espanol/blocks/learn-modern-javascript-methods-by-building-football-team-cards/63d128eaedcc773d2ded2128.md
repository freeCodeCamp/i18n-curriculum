...
Debajo de ese objeto, crea un objeto nuevo con las siguientes propiedades:
...
Tu array `myFavoriteFootballTeam.players` debe tener dos valores.
...
Tu array `myFavoriteFootballTeam.players` debe tener un objeto como el segundo valor.
...
Tu propiedad `name` debe establecerse en `"Sergio Batista"`.
...
Tu propiedad `position` debe establecerse en `"midfielder"`.
...
Tu propiedad `number` debe establecerse en `2`.
