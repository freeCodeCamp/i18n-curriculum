...
Ndani ya kipengele cha kwanza cha `td`, ongeza usemi wa kihesabu uliyoingizwa `${}`. Ndani ya usemi huo wa kihesabu, fanya wito wa kitendakazi cha `forumCategory` kwa hoja ya `category_id`.

Sasa, unapaswa kuona kategoria ikionyeshwa chini ya kila mada ya chapisho.

# --hints--

Unapaswa kufanya wito wa kitendakazi cha `forumCategory` kwa hoja ya `category_id`
