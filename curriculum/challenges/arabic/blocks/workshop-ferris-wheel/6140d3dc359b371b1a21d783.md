...
حان الوقت لوضع الكبائن حول العجلة. اختر أول عنصر `.cabin`. عيّن الخاصية `right` إلى `-8.5%` والخاصية `top` إلى `50%`.

# --hints--

يجب أن يكون لديك محدِّد `.cabin:nth-of-type(1)`.
...
يجب أن يحتوي محدِّد `.cabin:nth-of-type(1)` على خاصية `right` مضبوطة على `-8.5%`.
...
يجب أن يحتوي محدِّد `.cabin:nth-of-type(1)` على خاصية `top` مضبوطة على `50%`.
