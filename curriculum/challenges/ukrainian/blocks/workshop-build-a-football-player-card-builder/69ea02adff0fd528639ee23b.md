...
Далі створіть функцію `loadPlayer` з типом повернення `PlayerData`. Всередині неї додайте синтаксис `try...catch` з параметром `error` у блоці `catch`. Поки що залиште все інше порожнім.

# --hints--

Ви повинні створити функцію з назвою `loadPlayer`.
...
Ваша функція `loadPlayer` має мати тип повернення `PlayerData`.
...
Ваша функція `loadPlayer` має містити блок `try...catch`.
