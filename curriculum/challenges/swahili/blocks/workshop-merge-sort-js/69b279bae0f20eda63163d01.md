...
Baada ya kuchapisha mfuatano wa herufi, andika safu ya data `numbers` yenyewe ili orodha isiyo pangiliwa ionekane ifuatayo.

# --hints--

Unapaswa kuita `console.log(numbers);` baada ya ujumbe wa `'Unsorted array: '`.
