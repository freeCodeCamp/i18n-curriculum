...
Тепер ви знаєте, що кнопка працює. Видаліть інструкцію `console.log` з функції `displayStory`.

# --hints--

Ви повинні видалити інструкцію `console.log` з функції `displayStory`.
