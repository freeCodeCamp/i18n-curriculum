...
在工作坊的最后一步，你要将信息 `"It was fun learning about the different Math methods with you!"` 记录到控制台。

完成最后一项更改后，你就完成了数学机器人工作坊！ 

# --hints--

你应该将信息 `"It was fun learning about the different Math methods with you!"` 记录到控制台。
