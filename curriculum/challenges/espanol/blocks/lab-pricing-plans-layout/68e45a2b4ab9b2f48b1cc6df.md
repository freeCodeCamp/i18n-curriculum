...
4. Tu elemento `.basic-plan` debe tener un elemento `h2` con el texto `Basic Plan`.
5. Tu elemento `.basic-plan` debe tener un elemento `p` con el texto `$9/month`.
6. Tu elemento `.pro-plan` debe tener un elemento `h2` con el texto `Pro Plan`.
7. Tu elemento `.pro-plan` debe tener un elemento `p` con el texto `$19/month`.
8. Tu elemento `.premium-plan` debe tener un elemento `h2` con el texto `Premium Plan`.
