...
ソフィーとトムの会話をレビューしましょう。

聞いて空欄を埋めて、対話を完成させてください。
...
ソフィーがトムに尋ねている話題、現実を別の見方で捉えることについて考えてください。ここでは大文字を使ってください。
...
トムはARを、デジタル情報と現実世界の**融合**だと説明しています。
