...
Для налагодження додайте виклик `console.log()` у свій внутрішній цикл. Передайте йому аргументи `array`, `array[j]` і `array[j+1]`.

# --hints--

Ви повинні використати виклик `console.log()` у своєму внутрішньому циклі.
...
Ви повинні передати `array` як перший аргумент до `console.log()`.
...
Ви повинні передати `array[j]` як другий аргумент до `console.log()`.
...
Ви повинні передати `array[j+1]` як третій аргумент до `console.log()`.
