...
Adicione um event listener ao elemento `audio` que escute o evento `"ended"`.Passe uma callback usando a sintaxe de arrow com chaves vazias.
...
Você deve usar a sintaxe de arrow para passar um callback vazio para o seu listener do evento `"ended"`.
