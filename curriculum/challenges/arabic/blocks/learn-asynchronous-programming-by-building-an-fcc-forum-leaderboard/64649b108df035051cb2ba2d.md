...
لوسم الرابط الافتتاحي `a`، عرّف الخاصية `target` لتكون `"_blank"`. ثم عرّف الخاصية `href` لتكون `${forumTopicUrl}${slug}/${id}`.

وبهذه التغييرات، أصبح مشروع لوحة المتصدرين لمنتدى freeCodeCamp مكتملًا الآن!

# --hints--

يجب أن يحتوي وسم الرابط الافتتاحي على خاصية `target` معرّفة إلى `"_blank"`.
...
يجب أن يحتوي وسم الرابط الافتتاحي على خاصية `href` معرّفة إلى `${forumTopicUrl}${slug}/${id}`.
