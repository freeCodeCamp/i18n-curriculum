...
Щоб побачити, як працює ваш кастомний виняток, перетворіть лінію `catalogue.add(series2)` на `catalogue.add('series2')`.

# --hints--

Вам слід перетворити лінію `catalogue.add(series2)` на `catalogue.add('series2')`.
