...
¡Vamos al siguiente edificio! Es el verde en primer plano. Dale una `repeating-linear-gradient` con tu color de construcción de `0%` a `5%`, y `transparent` de `5%` a `10%`.
