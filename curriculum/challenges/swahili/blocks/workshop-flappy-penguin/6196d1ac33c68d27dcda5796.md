...
Geuza kipengele cha `.back-mountain` kwa mwelekeo wa saa `45deg`. Kisha, kipa sifa ya `left` yenye thamani ya `110px`, na sifa ya `top` yenye thamani ya `225px`.

# --hints--

Unapaswa kutumia sifa ya `transform` kugeuza kipengele hicho.
...
Unapaswa kumpa `.back-mountain` sifa ya `left`.
...
Unapaswa kumpa `.back-mountain` sifa ya `top`.
