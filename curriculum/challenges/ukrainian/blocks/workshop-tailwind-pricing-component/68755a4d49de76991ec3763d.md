...
Тепер призначте `span` всередині елемента `p` класи `text-base`, `font-medium` та `text-gray-500`.

# --hints--

`span` всередині вашого елемента `p` має мати клас `text-base`.
...
`span` всередині вашого елемента `p` має мати клас `font-medium`.
...
`span` всередині вашого елемента `p` має мати клас `text-gray-500`.
