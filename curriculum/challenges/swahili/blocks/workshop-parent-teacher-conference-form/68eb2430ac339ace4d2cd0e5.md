...
Sasa, unapaswa kuongeza ukubwa wa fonti kwa vipengele vyote vya `label`.

Chagua kipengele cha `label` na weka `font-size` yake kuwa `1.2rem`.

# --hints--

Unapaswa kulenga kipengele cha `label`.
