...
Declare uma função `elemValue` que receba um parâmetro `num`.A função deve estar vazia.

# --hints--

Você deve declarar uma variável `elemValue` após a função `rangeFromString()`.
