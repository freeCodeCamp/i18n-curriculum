...
Si `isOldEnoughToDrive` es `true`, entonces la oración `You're old enough to drive` se registrará en la consola. De lo contrario, si `isOldEnoughToDrive` es `false`, entonces la oración `Sorry, you are not old enough to drive` se registrará en la consola. Dado que la variable `isOldEnoughToDrive` está configurada como `true`, la primera oración se registrará en la consola.  You will learn more about `if/else` statements in a future lesson.
