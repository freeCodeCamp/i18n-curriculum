...
title: "المشكلة 46: التخمين الآخر لـ Goldbach"
challengeType: 1
forumTopicId: 302134
...
اقترح كريستيان جولدباخ أن كل عدد مركب فردي يمكن كتابته كمجموع عدد أولي ومرتين مربع.
...
اتضح أن هذا التخمين كان خاطئًا.

ما هو أصغر عدد مركب فردي لا يمكن كتابته كمجموع عدد أولي ومرتين مربع؟

# --hints--

يجب أن تُرجع الدالة `goldbachsOtherConjecture()` رقمًا.

```js
assert(typeof goldbachsOtherConjecture() === 'number');
```

يجب أن تُرجع الدالة `goldbachsOtherConjecture()` الرقم 5777.
