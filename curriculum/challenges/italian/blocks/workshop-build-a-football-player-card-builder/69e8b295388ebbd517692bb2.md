...
All'interno del componente `FootballPlayerCard`, rimuovi il `h1` e restituisci il componente `PlayerCard`.

# --hints--

Il componente `FootballPlayerCard` dovrebbe renderizzare il componente `PlayerCard`.
