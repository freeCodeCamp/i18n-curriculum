...
Il prossimo calcolo è la <dfn>moda</dfn>, che è il numero che appare più spesso nella lista. Per iniziare, dichiara una funzione `getMode` che prende lo stesso parametro `array` che stavi utilizzando.
