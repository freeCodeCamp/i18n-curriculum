...
Ese fondo color café hace difícil leer el texto. Cambia el color de fondo del elemento `body` a `burlywood` para que tenga algo de color pero aún puedas leer el texto.
