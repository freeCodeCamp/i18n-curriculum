...
Встановіть властивість `innerText` об’єкта `outputValueNode` у значення `num`.

# --hints--

Ви маєте використати `innerText` для встановлення тексту `outputValueNode`.
...
Ви маєте використати `innerText` для встановлення тексту `outputValueNode` у значення `num`.
