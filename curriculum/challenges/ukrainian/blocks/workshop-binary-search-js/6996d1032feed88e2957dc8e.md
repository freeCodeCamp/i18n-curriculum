...
Ви бачите, що останній виклик виводить порожній масив. Щоб додатково вказати, що значення відсутнє в масиві пошуку, оновіть інструкцію `return`, щоб вона повертала масив із двох елементів: порожнього масиву та рядка `Value not found`.
