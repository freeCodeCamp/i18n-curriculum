...
Il terzo elemento `div` di `className` di `form-group` dovrebbe avere un `label` con un attributo `htmlFor` di `pas`, un `className` di `label` e un testo `PAS`.
...
Il terzo elemento `div` di `className` di `form-group` dovrebbe avere un `input` con un `className` di `input`, un `id` di `pas` e un `type` di `number`.
...
Il quarto elemento `div` di `className` di `form-group` dovrebbe avere un `label` con un attributo `htmlFor` di `dri`, un `className` di `label` e un testo `DRI`.
...
Il quarto elemento `div` di `className` di `form-group` dovrebbe avere un `input` con un `className` di `input`, un `id` di `dri` e un `type` di `number`.
