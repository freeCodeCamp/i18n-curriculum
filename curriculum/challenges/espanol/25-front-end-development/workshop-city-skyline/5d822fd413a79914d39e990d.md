...
Anide cuatro nuevos elementos `div` dentro de `.bb4c`, asígnales la clase `bb4-window` a todos. Estos serán las ventanas para este edificio.
...
Debe asignarle a cada nuevo `div` una clase de `bb4-window`.
