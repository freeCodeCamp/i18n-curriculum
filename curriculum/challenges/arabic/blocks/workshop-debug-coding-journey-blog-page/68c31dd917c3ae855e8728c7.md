...
في الجزء الأخير من ورشة العمل، هناك بعض التغييرات المطلوبة في قسم الاتصال في الأسفل.

التغيير الأول هو تغليف قسم الاتصال داخل عنصر `footer`. هذا سيساعد قارئ الشاشة على التعرف على هذا القسم كتذييل للصفحة.

# --hints--

يجب أن تحتوي صفحتك على عنصر `footer`.
...
يجب أن يحتوي عنصر `footer` على عنصر `h3` بالنص `Contact Me`.
...
يجب أن يحتوي عنصر `footer` على عنصر `p` بالنص `Email me at camperbot@blog.io`.
