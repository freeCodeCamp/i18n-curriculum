...
- **Nombrar Funciones**: Para las funciones, el nombre debe indicar claramente qué hace la función. Para las funciones que devuelven un valor booleano (a menudo llamadas predicados), puedes usar los mismos prefijos "is", "has" o "can". Cuando tengas funciones que recuperan datos, es común comenzar con la palabra "get". When you have functions that set data, it is common to start with the word "set". Para funciones manejadoras de eventos, podrías usar prefijos como "handle" o sufijos como "Handler".
