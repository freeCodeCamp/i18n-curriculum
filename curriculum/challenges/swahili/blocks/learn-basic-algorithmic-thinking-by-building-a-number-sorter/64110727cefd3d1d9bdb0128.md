...
Mwishowe, baada ya mzunguko wako wa nje kumalizika, unahitaji kurudisha safu ya data. Mara tu utakapo fanya hivyo, unapaswa kuona mabadiliko ya `Output` unapobofya kitufe cha `Sort` tena.

# --hints--

Unapaswa `return` `array` baada ya mzunguko wako wa nje kumalizika.
