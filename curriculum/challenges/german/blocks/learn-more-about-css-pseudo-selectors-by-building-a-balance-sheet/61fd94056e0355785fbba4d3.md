...
Füge innerhalb des zweiten `tr` ein `th`-Element mit dem Text `Expenses Annual anticipated expenses, such as payroll.` hinzu. Verpacke den Text, mit Außnahme von `Expenses`, in ein `span` Element mit einer `class` von `description`.
