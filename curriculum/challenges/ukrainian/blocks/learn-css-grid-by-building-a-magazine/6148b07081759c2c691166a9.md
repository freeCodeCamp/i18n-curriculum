...
Створіть селектор `.text` і надайте йому множину властивостей `grid-column`, встановлену в `2 / 3`.
...
Ваш селектор `.text` повинен мати множину властивостей `grid-column`, встановлену в `2 / 3`.
