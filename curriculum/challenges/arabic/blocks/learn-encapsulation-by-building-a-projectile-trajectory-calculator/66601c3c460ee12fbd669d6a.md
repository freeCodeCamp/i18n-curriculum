...
يمكنك الآن إزالة الحلقة التي تطبع كل صف من المخرجات، واستبدالها بـ `print(graph.create_trajectory())`.

# --hints--

يجب ألا يكون لديك حلقة في النطاق العام.
...
يجب أن يكون لديك `print(graph.create_trajectory())`.
