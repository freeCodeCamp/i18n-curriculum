...
Ви повинні мати змінну під назвою `playerScore`.

```js
assert.isNotNull(playerScore);
```

Використайте `let`, щоб оголосити змінну `playerScore`.
...
Ви повинні мати змінну під назвою `computerScore`.

```js
assert.isNotNull(computerScore);
```

Використайте `let`, щоб оголосити змінну `computerScore`.
