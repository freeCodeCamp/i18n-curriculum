...
الآن داخل `showElements`، مرر هذه كمعلمات: `singleCardBtn`، `multipleCardsBtn`، و`headerTitle`. تذكر أنك تحصل عليها من `elements`، وتصل إليها باستخدام الكلمة المفتاحية `this`.

# --hints--

يجب أن تمرر `singleCardBtn` كالمعلمة الأولى إلى الدالة `showElements`.
...
يجب أن تمرر `multipleCardsBtn` كالمعلمة الثانية إلى الدالة `showElements`.
...
يجب أن تمرر `headerTitle` كمعلمة إلى الدالة `showElements`.
