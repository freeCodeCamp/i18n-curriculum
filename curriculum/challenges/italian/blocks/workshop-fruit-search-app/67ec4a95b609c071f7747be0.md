...
All'interno dell'elemento `form`, aggiungi un elemento `label`. Il tuo elemento `label` dovrebbe contenere il testo `Search for fruits:` e un attributo `htmlFor` con il valore `"search-input"`.

# --hints--

Dovresti avere un elemento `label` all'interno dell'elemento `form`.
...
L'elemento `label` dovrebbe avere un attributo `htmlFor` con il valore `"search-input"`.
...
Il tuo elemento `label` dovrebbe contenere il testo `Search for fruits:`.
