...
Usa una asignación por destructuración con la sintaxis rest para emular el comportamiento de `Array.prototype.slice()`. `removeFirstTwo()` debería devolver un subarreglo del arreglo original `list` con los dos primeros elementos omitidos.
