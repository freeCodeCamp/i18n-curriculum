...
Comencemos con los linters. Un linter es una herramienta de análisis estático de código que señala errores de programación, bugs, errores de estilo y estructuras sospechosas. El término lint proviene de una utilidad Unix que examina el código fuente del lenguaje C. 
