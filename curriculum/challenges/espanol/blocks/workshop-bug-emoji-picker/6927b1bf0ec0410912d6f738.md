...
Todavía dentro de la clase `Bug`, declara una propiedad llamada `emojiElement` con el tipo `HTMLParagraphElement`. Esta propiedad contendrá una referencia al elemento de párrafo HTML donde se mostrará el emoji de insecto.

# --hints--

Tu clase `Bug` debe tener una propiedad llamada `emojiElement`.
...
Tu propiedad `emojiElement` debe tener el tipo `HTMLParagraphElement`.
...
Tu propiedad `emojiElement` debe usar el operador de afirmación de asignación definitiva (`!`).
