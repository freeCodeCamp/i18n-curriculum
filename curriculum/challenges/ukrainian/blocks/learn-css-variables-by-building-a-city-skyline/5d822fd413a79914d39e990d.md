...
Вкладіть чотири нові `div` елементи всередину `.bb4c`, надайте їм усім клас `bb4-window`. Це будуть вікна для цієї будівлі.

# --hints--

Ви повинні додати чотири `div` елементи до `.bb4c`.
