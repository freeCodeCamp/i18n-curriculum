...
Після вашого нового коментаря напишіть цикл `for`, щоб ітерувати над списком `constraints`. Використовуйте `constraint` і `pattern` як змінні циклу.

# --hints--

Ви повинні написати цикл `for`, щоб ітерувати над списком `constraints`.
...
Ваш цикл `for` має використовувати `constraint` і `pattern` як змінні циклу для ітерації над списком `constraints`.
