...
Das Speichern aller Eingaben im Localstorage verhindert dies. Um damit zu beginnen, erstellen Sie eine `STORAGE_KEY`-Konstante mit dem String `football_player_card` als Wert.
