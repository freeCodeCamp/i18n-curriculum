...
الآن، استخدم عامل **OR** لإضافة المعلمة `start` كشرط ثاني إلى جملة `if` بعد `userData.currentSong === null`.


# --hints--

يجب أن تستخدم عامل **OR** لإضافة المعلمة `start` كشرط ثاني إلى جملة `if` بعد `userData.currentSong === null`.
