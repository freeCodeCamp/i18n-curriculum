...
Katika muktadha wa usimamizi wa hifadhidata, `secure` inamaanisha kuweka data salama dhidi ya upatikanaji usioidhinishwa au vitisho vya mtandao. `Efficient` inahusu jinsi data inavyosimamiwa na kutumika vizuri, kuhakikisha inapatikana kwa urahisi na inafanya kazi kwa ufanisi.
...
Neno hili linahusu usalama na ulinzi wa data.
...
Neno hili linaelezea jinsi data inavyosimamiwa kwa ufanisi kwa ajili ya utendaji na upatikanaji.
