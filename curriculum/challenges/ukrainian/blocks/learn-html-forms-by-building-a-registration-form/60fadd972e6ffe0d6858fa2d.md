...
Було б краще, якби текст `label` з’являвся над елементами форми.

Виберіть усі елементи `input`, `textarea` і `select` та зробіть так, щоб вони займали всю ширину своїх батьківських елементів.

Також додайте `10px` `margin` зверху вибраних елементів. Встановіть інші поля на `0`.

# --hints--

Ви повинні використати селектор елементів, розділених комою, щоб вибрати елементи `input`, `textarea` і `select`.
...
Ви повинні встановити властивість `width` у значення `100%`.
...
Ви повинні встановити властивість `margin-top` у значення `10px`.
...
Ви повинні встановити властивість `margin-bottom` у значення `0`.
...
Ви повинні встановити властивість `margin-left` у значення `0`.
...
Ви повинні встановити властивість `margin-right` у значення `0`.
