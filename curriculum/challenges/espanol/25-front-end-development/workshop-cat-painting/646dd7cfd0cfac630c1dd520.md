...
Para eliminar todos los bordes puntiagudos de la oreja, establece un radio de borde inferior derecho e inferior izquierdo de `40%` cada uno, un radio de borde superior izquierdo de `90px`, y un radio de borde superior derecho de `10px`.
...
Tu selector `.cat-left-inner-ear` debe tener una propiedad `border-top-right-radius` establecida en `10px`.
