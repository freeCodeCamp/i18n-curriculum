...
Después de que tu `for` loop haya terminado, necesitas devolver el array. Deberías poder ver el cambio en el `Output` cuando haces clic en el botón `Sort` nuevamente.

# --hints--

Deberías `return` el `array`.
