...
`getAverageGrade([92, 91, 90, 94, 89, 93])` 應該傳回 `"A-"`。

```js
assert.equal(getAverageGrade([92, 91, 90, 94, 89, 93]), "A-");
```

`getAverageGrade([84, 89, 85, 100, 91, 88, 79])` 應該傳回 `"B+"`。

```js
assert.equal(getAverageGrade([84, 89, 85, 100, 91, 88, 79]), "B+");
```

`getAverageGrade([63, 69, 65, 66, 71, 64, 65])` 應該傳回 `"D"`。

```js
assert.equal(getAverageGrade([63, 69, 65, 66, 71, 64, 65]), "D");
```

`getAverageGrade([97, 98, 99, 100, 96, 97, 98, 99, 100])` 應該傳回 `"A+"`。

```js
assert.equal(getAverageGrade([97, 98, 99, 100, 96, 97, 98, 99, 100]), "A+");
```

`getAverageGrade([75, 100, 88, 79, 80, 78, 64, 60])` 應該傳回 `"C+"`。

```js
assert.equal(getAverageGrade([75, 100, 88, 79, 80, 78, 64, 60]), "C+");
```

`getAverageGrade([45, 48, 50, 52, 100, 54, 56, 58, 59])` 應該傳回 `"F"`。
