...
Tengeneza sheria mpya ya CSS inayolenga darasa la vitu `sleeve`. Weka sifa ya `width` kuwa `110px`, na sifa ya `height` kuwa `25px`.

# --hints--

Unapaswa kutumia kichaguzi cha darasa la vitu kulenga darasa la vitu `sleeve`.
