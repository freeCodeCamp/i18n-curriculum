...
I due elementi HTML semantici finali per questo progetto sono gli elementi `footer` e `address`. L'elemento `footer` agisce da un contenitore per una raccolta di contenuti correlata alla pagina, mentre l'elemento `address` contiene le informazioni di contatto dell'autore della pagina.
