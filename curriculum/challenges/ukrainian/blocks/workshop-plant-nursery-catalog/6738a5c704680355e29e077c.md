...
Як ви вже дізналися, метод `delete` використовується для видалення запису зі спроєктованої множини. Множини мають метод `delete`, який ви також можете використати для видалення елемента з них.

Іноді може знадобитися видалити всі елементи зі спроєктованої множини або множини. Метод `clear` виконує саме це завдання.

Викличте метод `clear` на `plantsSet`, щоб видалити з неї всі елементи.

# --hints--

Ви повинні викликати метод `clear` на `plantsSet`.
