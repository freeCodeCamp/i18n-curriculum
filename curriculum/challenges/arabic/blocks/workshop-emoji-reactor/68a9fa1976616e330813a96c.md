...
افسح بعض المساحة، واحذف كل متغيرات الأزرار و`eventListener` التي أنشأتها لكل منها.

# --hints--

يجب ألا يوجد متغير `happyBtn`.
...
يجب ألا يوجد متغير `confusedBtn`.
