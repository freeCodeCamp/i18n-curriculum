...
Usando sua nova classe `flavor` como seletor, defina o valor da propriedade `text-align` para `left`.

# --hints--

Você deve usar um seletor de classe `flavor`.
...
Você deve definir a propriedade `text-align` para `left`.
...
Seu seletor de classe `flavor` deve definir a propriedade `text-align` para `left`.
