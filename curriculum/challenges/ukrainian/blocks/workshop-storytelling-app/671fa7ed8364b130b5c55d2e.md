...
Виберіть абзац `#result` і збережіть його у змінну з назвою `resultParagraph`. Ви будете використовувати цю змінну, щоб відобразити вибрану історію.

# --hints--

Ви повинні вибрати абзац `#result` за допомогою методу `getElementById` і зберегти його у змінну `resultParagraph`.
