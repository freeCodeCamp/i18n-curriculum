...
Ihre Funktion ist jetzt fertig. Testen Sie sie erneut, indem Sie `gen_parentheses(2)` anstelle von `gen_parentheses(1)` ausgeben.

# --hints--

Sie sollten `gen_parentheses(2)` ausgeben.
...
Sie sollten `print(gen_parentheses(1))` nicht in Ihrem Code haben.
