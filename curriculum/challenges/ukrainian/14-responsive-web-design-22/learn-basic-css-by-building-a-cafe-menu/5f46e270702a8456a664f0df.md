...
Щоб видалити трохи вертикального простору між елементом `h1` та текстом `Est. 2020`, змініть нижнє поле `h1` на `15px`.

# --hints--

Ви повинні встановити властивість `margin-bottom` на `15px`.
...
Ваш елемент `h1` повинен мати `margin-bottom` зі значенням `15px`.
