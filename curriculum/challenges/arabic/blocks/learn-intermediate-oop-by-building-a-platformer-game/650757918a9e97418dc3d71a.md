...
آخر شيء تحتاج إلى فعله هو إضافة جملة `else if`.

يجب أن تتحقق شرطك مما إذا كان موضع `x` الخاص باللاعب أكبر من أو يساوي موضع `x` الخاص بنقطة التحقق وأقل من أو يساوي موضع `x` الخاص بنقطة التحقق زائد `40`.

داخل جسم جملة `else if`، تحتاج إلى استدعاء الدالة `showCheckpointScreen` وتمرير السلسلة النصية `"You reached a checkpoint!"` كمعلمة.

تهانينا! لقد أكملت مشروع لعبة المنصة!

# --hints--

يجب أن تضيف بند `else if` للتحقق مما إذا كان موضع `x` الخاص باللاعب أكبر من أو يساوي موضع `x` الخاص بنقطة التحقق وأقل من أو يساوي موضع `x` الخاص بنقطة التحقق زائد `40`.
...
يجب أن تستدعي الدالة `showCheckpointScreen` وتمرير "You reached a checkpoint!" كمعلمة.
