...
Infine, passa la chiamata `tuple()` come argomento alla funzione `str()`. 

# --hints--

Dovresti passare la chiamata `tuple()` che stai attualmente restituendo dal metodo `__str__` alla funzione `str()`.
