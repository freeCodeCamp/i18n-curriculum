...
مرة أخرى، استخدم مكوِّن `Card` مرتين إضافيتين مع التالي:

| الخصائص  | قيم البطاقة الأولى | قيم البطاقة الثانية |
|-------|------------------------------------------------------------|-----------------------------------------------------|
| `name`  | `"Tiffany"` | `"Doug"`|
...
لا تعدل مكوِّن `Card` الموجود في مكوِّن `App` الخاص بك.
...
استخدم مكوِّن `Card` كعنصر مع الخصائص المناسبة وقيم البطاقة الأولى.
...
استخدم مكوِّن `Card` كعنصر مع الخصائص المناسبة وقيم البطاقة الثانية.
