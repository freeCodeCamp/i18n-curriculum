...
**Nota:** También debes llamar `event.preventDefault()` en el manejador de envío, para prevenir el comportamiento predeterminado de envío de formularios que actualizará la página web. Para la comodidad de los campistas, el comportamiento predeterminado se ha desactivado aquí para evitar que las actualizaciones restablezcan el código de desafío.
