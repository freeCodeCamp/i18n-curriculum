...
移動到 **Listener plan** 裡的 `h2`，為它添加工具類別 `text-lg` 使其變大，`font-semibold` 使其變粗，以及 `text-indigo-600` 使其呈現美麗的靛藍色。

# --hints--

你的 `h2` 元素應該有 `text-lg` 類別。
...
你的 `h2` 元素應該有 `text-indigo-600` 類別。
