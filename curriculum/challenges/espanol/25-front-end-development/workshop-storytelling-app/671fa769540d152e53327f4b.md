...
Selecciona los botones `#scary-btn`, `#funny-btn` y `#adventure-btn` y guárdalos en variables llamadas `scaryStoryBtn`, `funnyStoryBtn` y `adventureStoryBtn`.

# --hints--

Debes seleccionar el botón `#scary-btn` usando el método `getElementById` y almacenarlo en la variable `scaryStoryBtn`.
...
Debes seleccionar el botón `#funny-btn` usando el método `getElementById` y almacenarlo en la variable `funnyStoryBtn`.
...
Debes seleccionar el botón `#adventure-btn` usando el método `getElementById` y almacenarlo en la variable `adventureStoryBtn`.
