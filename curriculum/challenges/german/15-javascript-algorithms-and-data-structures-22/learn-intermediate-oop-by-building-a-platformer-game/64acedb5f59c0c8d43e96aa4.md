...
Um die Bewegungen des Spielers im Spiel zu steuern, musst du überwachen, wann die linke und rechte Pfeiltaste gedrückt werden.

Create a new `const` variable called `keys` and assign it an empty object.

# --hints--

Du solltest eine neue `const`-Variable namens `keys` erstellen.
