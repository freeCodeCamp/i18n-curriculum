...
title: Jenga Kigeuzi cha Sarafu
challengeType: 25
...
1. Sehemu yako ya `CurrencyConverter` inapaswa onyesha kipengele cha `input` ili kupokea kiasi cha kubadilishwa.
2. Kipengele chako cha `input` kinapaswa kupokea nambari.
3. Sehemu yako ya `CurrencyConverter` inapaswa onyesha vipengele viwili vya `select` kuchagua sarafu ya kubadilisha **kutoka** na **kwenda**.
4. Kipengele chako cha `select` kinapaswa kuwa na chaguzi za **angalia angalau** `USD`, `EUR`, `GBP`, na `JPY`. Unaweza kutumia kiwango chochote cha kubadilisha, mradi tu hakuna ulinganifu wa moja kwa moja kati ya sarafu hizo. Hapa kuna mifano ya ulinganifu mzuri na mbaya:
...
5. Sehemu yako ya `CurrencyConverter` inapaswa kuhifadhi kumbukumbu ya hesabu ya kiasi kilichobadilishwa kwa sarafu ya **kutoka** ili mabadiliko ya chaguo la `select` la **kwenda** yasihesabu upya kiasi kilichobadilishwa.
6. Sehemu yako ya `CurrencyConverter` inapaswa onyesha kipengele kinachoonyesha kiasi kilichobadilishwa kwa muundo wa `XX.XX CCC`, ambapo `XX.XX` ni kiasi kilichobadilishwa na `CCC` ni msimbo wa sarafu.
7. Kiasi kilichobadilishwa kinapaswa kuzungushwa hadi sehemu mbili za desimali.

# --hints--

Unapaswa kusafirisha sehemu ya `CurrencyConverter`.
...
Unapaswa kuwa na kipengele kimoja cha `input[type="number"]` kupokea kiasi cha kubadilisha.
...
Unapaswa kuwa na vipengele viwili vya `select`.
...
Vipengele vya `select` vinapaswa kuwa na chaguzi za angalau `USD`, `EUR`, `GBP`, na `JPY`.
...
Kubadilisha thamani ya kipengele cha kwanza cha `select` kunapaswa kusababisha upya hesabu ya kiasi kilichobadilishwa.
...
Kubadilisha thamani ya kipengele cha pili cha `select` hakutapasababisha upya hesabu ya kiasi kilichobadilishwa.
...
Kubadilisha thamani ya kipengele cha kwanza cha `select` kunapaswa kuonyesha kiasi kipya kilichobadilishwa.
...
Kubadilisha thamani ya kipengele cha pili cha `select` kunapaswa kuonyesha kiasi kipya kilichobadilishwa na sarafu.
...
Kiasi kilichobadilishwa kinapaswa kuonyeshwa kwa muundo wa `XX.XX CCC`, ambapo `XX.XX` ni kiasi kilichobadilishwa kilichozungushwa hadi sehemu mbili za desimali na `CCC` ni msimbo wa sarafu.
...
Kiasi kilichobadilishwa kinapaswa kutofautiana na kiasi cha ingizo.
