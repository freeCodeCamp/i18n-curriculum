...
Cree una nueva variable en `:root` llamada `--window-color1` y dele un valor de `black`. Este será un color secundario para los edificios morados.
...
Debe darle al variable de propiedad `--window-color1` un valor de `black`.
