...
Яке запитання найкраще поставити Джейку, щоб дізнатися більше про проблему?
...
Це запитання зосереджене на реакції команди, а не на деталях самої фішингової атаки.
...
Правильний варіант — `Oh no! Do you know where it originated from?`, оскільки він запитує про конкретні деталі фішингової атаки.

Фраза `where it originated from` стосується джерела або початкової точки фішингової атаки.
