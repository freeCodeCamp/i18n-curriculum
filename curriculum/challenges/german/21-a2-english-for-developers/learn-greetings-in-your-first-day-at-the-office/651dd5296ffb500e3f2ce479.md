...
In dem Audio, wird `you're` benutzt, welches die Kurzform von `you are` ist. Das Verb `to be` ist unregelmäßig. Wenn mit `you` konjugiert wird, wird es `are`, wie in `You are an English learner.` Hier hat `you're` die gleiche Bedeutung.
