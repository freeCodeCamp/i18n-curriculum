...
Una vez que obtengas el contenido editado, ese será ahora el contenido actual.

Dentro del listener de eventos, asigna `newContent` a `currentContent`. 

# --hints--

Debes asignar `newContent` a `currentContent` dentro del listener de eventos.
