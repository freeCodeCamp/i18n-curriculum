...
Willkommen im CSS-Variablen-Skyline-Projekt! Beginne, indem du die `!DOCTYPE html`-Deklaration oben im Dokument hinzufügst, damit der Browser weiß, welche Art von Dokument er ließt.
