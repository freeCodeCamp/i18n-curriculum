...
Dove 0.1(6) significa 0.166666..., e ha un ciclo ricorrente di 1 cifra. Si può vedere che <sup>1</sup>/<sub>7</sub> ha un ciclo ricorrente di 6 cifre.

Trova il valore di `d` &lt; `n` per cui <sup>1</sup>/<sub>d</sub> contiene il ciclo ricorrente più lungo nella sua parte decimale frazionaria.
