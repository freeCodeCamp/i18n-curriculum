...
Infine, dopo che il tuo loop esterno è terminato, devi restituire l'array. Una volta fatto, dovresti riuscire a vedere il `Output` cambiare quando clicchi di nuovo il pulsante `Sort`.

# --hints--

Dovresti `return` il `array` dopo che il tuo loop esterno è completato.
