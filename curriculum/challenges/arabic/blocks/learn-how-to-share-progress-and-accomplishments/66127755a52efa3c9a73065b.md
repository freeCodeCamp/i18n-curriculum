...
هي صيغة الماضي البسيط للفعل `attend`، وتُظهر أن سارة شاركت في ورشة العمل.
...
هي صيغة الماضي البسيط للفعل `learn`، وتدل على أن سارة اكتسبت معرفة جديدة.
...
هي صيغة الماضي البسيط للفعل `help`، وتُظهر أن تطبيق التقنيات الجديدة كان له تأثير إيجابي.
