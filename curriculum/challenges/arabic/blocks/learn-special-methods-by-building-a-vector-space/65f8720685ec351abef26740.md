...
للحصول على تمثيل صحيح كسلسلة نصية، استدعِ دالة البناء `tuple()` ومرر لها تعبير المولِّد الذي كتبته في الخطوة السابقة كمعلمة.

# --hints--

يجب أن تمرر التعبير الذي تُرجعه الطريقة `__str__` إلى دالة البناء `tuple()`.
