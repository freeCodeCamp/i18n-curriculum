...
Debes darle a la primera `label` un atributo `for`.

```js
assert.notEmpty(document.querySelectorAll('ul.answers-list > li > label')?.[0]?.htmlFor);
```

Debes darle a la primer `label` un atributo `for` que coincida con el `id` de su elemento `input`.
...
Debes darle a la segunda `label` un atributo `for`.

```js
assert.notEmpty(document.querySelectorAll('ul.answers-list > li > label')?.[1]?.htmlFor);
```

Debes darle a la segunda `label` un atributo `for` que coincida con el `id` de su elemento `input`.
...
Debes darle a la tercera `label` un atributo `for`.

```js
assert.notEmpty(document.querySelectorAll('ul.answers-list > li > label')?.[2]?.htmlFor);
```

Debes darle a la tercera `label` un atributo `for` que coincida con el `id` de su elemento `input`.
...
Debes darle a la cuarta `label` un atributo `for`.

```js
assert.notEmpty(document.querySelectorAll('ul.answers-list > li > label')?.[3]?.htmlFor);
```

Debes darle a la cuarta `label` un atributo `for` que coincida con el `id` de su elemento `input`.
