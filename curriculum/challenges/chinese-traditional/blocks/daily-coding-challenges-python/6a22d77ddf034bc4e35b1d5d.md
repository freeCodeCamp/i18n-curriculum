...
`solve_magic_square([[2, 7, 6], [9, 0, 1], [4, 3, 8]])` 應該傳回 `5`。
...
`solve_magic_square([[0, 14, 12], [18, 10, 2], [8, 6, 16]])` 應該傳回 `4`。
...
`solve_magic_square([[12, 17, 16], [19, 0, 10], [14, 13, 18]])` 應該傳回 `"impossible"`。
...
`solve_magic_square([[15, 35, 31], [43, 27, 11], [23, 19, 0]])` 應該傳回 `39`。
...
`solve_magic_square([[26, 41, 14], [47, 35, 0], [32, 29, 44]])` 應該傳回 `"impossible"`。
