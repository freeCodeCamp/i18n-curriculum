...
هذا يحرك نص الشارة، لكنه ليس بالضبط في المكان الذي تريده. السحر يكمن في أصناف الأدوات `right-[num]`، `left-[num]`، `top-[num]`، و`bottom-[num]`.
...
يمكنك أيضًا تحديد القيم السالبة بإضافة شرطة ناقص في البداية:
...
أضف الأصناف `-top-3` و`right-3` إلى عنصر `div` الخاص بشارة `Most popular`.

# --hints--

يجب أن يحتوي عنصر `div` الذي يحمل النص `Most popular` على الصنف `-top-3`.
...
يجب أن يحتوي عنصر `div` الذي يحمل النص `Most popular` على الصنف `right-3`.
