...
`build_acronym("National Aeronautics and Space Administration")` deve retornar `"NASA"`.
...
`build_acronym("An unstoppable herd of waddling penguins overtakes the icy mountains and sings happily")` deve retornar `"AUHWPOTIMSH"`.
