...
Dai al nuovo selettore una proprietà `font-size` di `0.7em` per farlo sembrare un sottotitolo.
...
Il selettore `h1 .flex span:first-of-type` dovrebbe avere una proprietà `font-size` con il valore `0.7em`.
