...
Utiliza la función `linear-gradient` y pásala con la función `hsl` con los valores `186` para tono, `76%` para saturación y `16%` para claridad como el primer argumento de color.
