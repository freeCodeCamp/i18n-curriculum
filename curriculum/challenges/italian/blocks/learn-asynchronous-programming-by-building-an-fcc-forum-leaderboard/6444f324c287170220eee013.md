...
All’interno del quarto elemento `td`, aggiorna il valore corrente per chiamare invece la funzione `viewCount` con la variabile `views` come argomento.

# --hints--

Dovresti chiamare la funzione `viewCount` e passare la variabile `views` come argomento.
