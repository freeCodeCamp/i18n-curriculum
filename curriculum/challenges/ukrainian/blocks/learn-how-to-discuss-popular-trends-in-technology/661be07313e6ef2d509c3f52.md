...
Коли хтось запитує `Is it safe?`, він хоче дізнатися, чи щось не є небезпечним або чи щось добре захищене. Це спосіб перевірити, чи ситуація або дія є прийнятною, чи існує ризик при її виконанні або використанні.

# --questions--

## --text--

Що Том хоче дізнатися, чи є `safe`?
...
У діалозі не згадуються військові бази.
...
Еліс використовує аеропорти лише як приклад використання біометрії.
