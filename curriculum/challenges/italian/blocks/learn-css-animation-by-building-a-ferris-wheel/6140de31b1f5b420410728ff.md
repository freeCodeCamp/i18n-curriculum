...
Ora assegna alla regola `@keyframes wheel` un selettore `100%`. All’interno di questo, imposta la proprietà `transform` su `rotate(360deg)`. Così facendo, la tua animazione completerà una rotazione completa.
