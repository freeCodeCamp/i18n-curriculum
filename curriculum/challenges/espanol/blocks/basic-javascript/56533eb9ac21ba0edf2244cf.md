...
Completa la función usando las reglas siguientes para modificar el objeto pasado a la función.
...
**Nota:** Se usa una copia del objeto `recordCollection` para las pruebas. No debes modificar directamente el objeto `recordCollection`.
