...
مكوِّن `PlayerCard` يعمل لكنه يستخدم قيمًا ثابتة. لجعله مرنًا، تحتاج إلى وصف شكل بيانات اللاعب باستخدام واجهة TypeScript.

قبل دالة `PlayerCard`، أنشئ واجهة تُسمى `PlayerData` تحتوي على `name` من نوع `string`، و`overallRating` من نوع `number`، و`position` من نوع `string`، و`club` من نوع `string`.

# --hints--

يجب أن تنشئ واجهة تُسمى `PlayerData`.
...
يجب أن تحتوي واجهة `PlayerData` على `name` من نوع `string`.
...
يجب أن تحتوي واجهة `PlayerData` على `overallRating` من نوع `number`.
...
يجب أن تحتوي واجهة `PlayerData` على `position` من نوع `string`.
...
يجب أن تحتوي واجهة `playerData` على `club` من نوع `string`.
