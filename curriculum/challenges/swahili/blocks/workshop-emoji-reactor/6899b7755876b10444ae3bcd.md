...
Sasa ni wakati wa kuunganisha faili la JavaScript.

Ongeza kipengele cha `script` kabla kabisa ya lebo ya kufunga ya kipengele cha `body` kwa sifa ya kipengele na thamani sahihi ili kuunganisha faili la `script.js`.
...
Kipengele cha `script` kinapaswa kuwa na sifa ya kipengele ya `src` yenye thamani ya `./script.js`.
