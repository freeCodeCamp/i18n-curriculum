...
`@for` é usado de duas maneiras: "começo ao fim" ou "começo até o fim".A principal diferença é que o "start **to** end" *exclui* o número final como parte da contagem e o "start **through** end" *inclui* o número final como parte da contagem.

Aqui está um exemplo do **início** até o fim:
...
Escreva uma diretiva `@for` que recebe uma variável `$j` que vai de 1 **a** 6.
