...
When Sarah asks, `Are you into these activities?`, she uses `these` to refer back to something Tom just mentioned. Es una forma de especificar exactamente de qué actividades está hablando sin repetir toda la frase.
