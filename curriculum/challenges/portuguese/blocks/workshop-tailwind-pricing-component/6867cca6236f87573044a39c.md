...
A última coisa que você fará é estilizar o botão CTA para o plano familiar.

Dê a ele as classes `block`, `rounded-md`, `bg-indigo-600`, `px-4`, `py-2`, `text-center`, `font-semibold`, `text-white` e `hover:bg-indigo-700`.

Com isso, seu workshop do componente de preços Tailwind está completo!

# --hints--

Seu elemento anchor deve ter a classe `bg-indigo-600`.
...
Seu elemento anchor deve ter a classe `px-4`.
...
Seu elemento anchor deve ter a classe `py-2`.
...
Seu elemento anchor deve ter a classe `text-center`.
...
Seu elemento anchor deve ter a classe `font-semibold`.
...
Seu elemento anchor deve ter a classe `hover:bg-indigo-700`.
