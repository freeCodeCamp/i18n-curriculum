...
Lenga kipengele cha `body` kuweka `background` kuwa mwelekeo wa mstari wa mviringo wa digrii 45 kwa mwelekeo wa saa, kuanzia `rgb(118, 201, 255)` na kumalizika `rgb(247, 255, 222)`.
