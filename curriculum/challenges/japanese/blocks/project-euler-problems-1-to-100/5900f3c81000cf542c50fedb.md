...
数列は、ある数の各桁の平方の和を繰り返し計算して新しい数を作り、その数が以前に現れたことがあるまで続けて作られます。
...
したがって、1または89に到達する数列は、無限ループに陥ります。驚くべきことに、すべての開始数は最終的に1か89に到達します。

`limit` 未満の開始数のうち、いくつが89に到達するでしょうか？
