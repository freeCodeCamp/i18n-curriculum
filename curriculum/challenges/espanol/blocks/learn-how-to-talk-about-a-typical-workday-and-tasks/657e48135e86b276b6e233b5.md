...
`Access control` se refiere a la práctica de restringir y gestionar la entrada a un lugar o recurso. For example, `Access control systems are used to secure the building`.
