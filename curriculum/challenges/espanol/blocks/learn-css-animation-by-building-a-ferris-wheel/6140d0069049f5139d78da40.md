...
Asigna al selector `.line` una propiedad `transform-origin` de `0% 0%`. Esto desplazará el punto de origen en `0%` desde la izquierda y en `0%` desde el borde superior, colocándolo en la esquina superior izquierda del elemento.
