...
Ukicheza kidogo na mchezaji wako utaona hitilafu chache. Kwanza, unapoanza kucheza wimbo, kuusitisha kwa muda kisha kubofya kitufe cha wimbo uliopita au ufuatao, wimbo hautaanza kutoka mwanzo.

Ili kuanza kurekebisha hilo, ongeza kigezo cha pili kinachoitwa `start` katika kitendakazi chako cha `playSong`. Mpe thamani ya msingi ya `true`.

# --hints--

Kitendakazi chako cha `playSong` kinapaswa kuwa na kigezo cha pili kinachoitwa `start` chenye thamani ya msingi ya `true`.
