...
Crie uma variável `CDN_URL` e defina-a como `https://cdn.freecodecamp.org/curriculum/typescript/tarot-app`. Também crie uma variável `defaultImg` com o valor `new URL("default.svg", import.meta.url)` e uma variável `LOCAL_DEFAULT_IMG` com o valor `defaultImg`.
...
Sua variável `defaultImg` deve ser definida como `new URL("default.svg", import.meta.url)`.
