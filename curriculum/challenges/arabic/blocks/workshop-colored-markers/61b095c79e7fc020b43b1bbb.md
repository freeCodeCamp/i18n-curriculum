...
بالنسبة إلى المعلمة الثانية للون، استخدم رمز لون سداسي عشري بالقيم `71` للأحمر، و`F5` للأخضر، و`3E` للأزرق.

# --hints--

يجب أن تحتوي قاعدة CSS الخاصة بـ `.green` على خاصية `background` مضبوطة على `linear-gradient(180deg, #55680D, #71F53E)`.
