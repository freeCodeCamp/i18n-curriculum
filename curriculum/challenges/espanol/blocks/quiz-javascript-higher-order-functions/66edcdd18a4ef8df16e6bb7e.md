...
Un arreglo con todos los elementos reducidos por la función callback especificada.
...
¿Cuál será el valor de `shortWords` después de que se ejecute el siguiente código?
