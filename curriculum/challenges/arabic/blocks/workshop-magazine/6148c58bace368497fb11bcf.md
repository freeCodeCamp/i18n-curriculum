...
تمامًا مثل Flexbox، مع CSS Grid يمكنك محاذاة محتوى عناصر الشبكة باستخدام `align-items` و `justify-items`. تقوم `align-items` بمحاذاة العناصر الفرعية على محور العمود، وتقوم `justify-items` بمحاذاة العناصر الفرعية على محور الصف.

أضف خاصية `align-items` بقيمة `center` إلى المحدِّد `.social-icons`.

# --hints--

يجب أن يحتوي المحدِّد `.social-icons` على خاصية `align-items` بقيمة `center`.
