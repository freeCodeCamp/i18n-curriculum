...
قم بمحاذاة النص إلى `right` للعناصر التي تحمل صنف `price`.

# --hints--

يجب أن يكون لديك محدِّد صنف `price`.
...
يجب أن يضبط محدِّد صنف `price` الخاص بك خاصية `text-align` إلى `right`.
