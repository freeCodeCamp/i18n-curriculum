...
In **reported speech**, `to explain` is used when someone gives a reason or makes something clear. 例如：
...
A `system component` is a part or piece of a larger system, usually in computers or networks. 例如：
