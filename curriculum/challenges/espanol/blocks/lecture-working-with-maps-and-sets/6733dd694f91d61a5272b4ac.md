...
| **Tamaño de la propriedad** | `Map` tiene una propiedad `size` para obtener el número de pares clave-valor. | `WeakMap` no tiene una propiedad `size`. |
