...
Deklarieren Sie eine Funktion `elemValue`, die einen `num`-Parameter entgegennimmt. Die Funktion soll leer sein.

# --hints--

Sie sollten eine `elemValue`-Variable nach Ihrer `rangeFromString()`-Funktion deklarieren.
