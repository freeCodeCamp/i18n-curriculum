...
Ora, fai lo stesso per il resto delle proprietà. Usa la funzione `getElement` per selezionare ciascuna di esse:
...
Dovresti consultare `multipleCardsBtn` usando il metodo `getElement` e passando `#btn-multiple-cards`.
...
Dovresti consultare `multipleCard` usando il metodo `getElement` e passando `.multiple_card`.
...
Dovresti consultare `title` usando il metodo `getElement` e passando `.title`.
...
Dovresti consultare `newReadingBtn` usando il metodo `getElement` e passando `.btn_reveal`.
...
Dovresti consultare `fortuneContainer` usando il metodo `getElement` e passando `.fortune_container`.
...
Dovresti consultare `fortuneDescription` usando il metodo `getElement` e passando `.fortune_description`.
...
Dovresti consultare `headerTitle` usando il metodo `getElement` e passando `.header_title`.
...
Dovresti consultare `subTitle` usando il metodo `getElement` e passando `.sub_title`.
...
Dovresti consultare `cardTitle` usando il metodo `getElement` e passando `.desc_title`.
...
Dovresti consultare `description` usando il metodo `getElement` e passando `.description`.
...
Dovresti consultare `text` usando il metodo `getElement` e passando `.text`.
