...
title: إيجاد القيمة الحد الأدنى والحد الأقصى في شجرة البحث الثنائي
challengeType: 1
forumTopicId: 301642
...
في هذا التحدٍّ ستعرّف طريقتين، `findMin` و `findMax`. يجب أن تُرجع هاتان الطريقتان الحد الأدنى والحد الأقصى للقيمة المخزنة في شجرة البحث الثنائي (لا تقلق بشأن إضافة قيم إلى الشجرة الآن، لقد أضفنا بعض القيم في الخلفية). إذا واجهت صعوبة، تأمل في الثابت الذي يجب أن يكون صحيحًا لشجرات البحث الثنائي: كل شجرة فرعية على اليسار أقل من أو تساوي الأصل الخاص بها، وكل شجرة فرعية على اليمين أكبر من أو تساوي الأصل. لنفترض أيضًا أن شجرتنا يمكنها تخزين القيم الصحيحة فقط. إذا كانت الشجرة فارغة، يجب أن تُرجع أي من الطريقتين `null`.
...
يجب أن تحتوي شجرة البحث الثنائي على طريقة تسمى `findMin`.
...
يجب أن تحتوي شجرة البحث الثنائي على طريقة تسمى `findMax`.
...
يجب أن تُرجع الطريقة `findMin` الحد الأدنى للقيمة في شجرة البحث الثنائي.
...
يجب أن تُرجع الطريقة `findMax` الحد الأقصى للقيمة في شجرة البحث الثنائي.
...
يجب أن تُرجع الطريقتان `findMin` و `findMax` القيمة `null` إذا كانت الشجرة فارغة.
