...
`update_inventory([[2, "apples"], [5, "bananas"]], [[1, "apples"], [3, "bananas"]])` 應該傳回 `[[3, "apples"], [8, "bananas"]]`。
...
`update_inventory([[2, "apples"], [5, "bananas"]], [[1, "apples"], [3, "bananas"], [4, "oranges"]])` 應該傳回 `[[3, "apples"], [8, "bananas"], [4, "oranges"]]`。
...
`update_inventory([], [[10, "apples"], [30, "bananas"], [20, "oranges"]])` 應該傳回 `[[10, "apples"], [30, "bananas"], [20, "oranges"]]`。
...
`update_inventory([[0, "Bowling Ball"], [0, "Dirty Socks"], [0, "Hair Pin"], [0, "Microphone"]], [[1, "Hair Pin"], [1, "Half-Eaten Apple"], [1, "Bowling Ball"], [1, "Toothpaste"]])` 應該傳回 `[[1, "Bowling Ball"], [0, "Dirty Socks"], [1, "Hair Pin"], [0, "Microphone"], [1, "Half-Eaten Apple"], [1, "Toothpaste"]]`。
