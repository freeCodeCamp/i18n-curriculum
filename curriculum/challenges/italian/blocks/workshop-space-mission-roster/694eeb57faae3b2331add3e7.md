...
All'interno della funzione `getEVAReadyCrew`, chiama `sortByPriorityDescending()` con l'array locale `eligible` in modo che venga ordinato prima di essere restituito.

# --hints--

Dovresti chiamare `sortByPriorityDescending()` con l'array locale `eligible`.
