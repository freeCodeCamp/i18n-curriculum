...
Remember that `.getElementsByClassName()` method returns an <dfn>HTMLCollection</dfn>, which is an array-like object of all the elements that have a matching class name. Você pode usar o operador spread para convertê-lo em um array.
