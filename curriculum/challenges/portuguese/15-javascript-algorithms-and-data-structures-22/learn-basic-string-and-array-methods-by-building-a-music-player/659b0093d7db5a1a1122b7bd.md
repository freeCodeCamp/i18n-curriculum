...
To get the index for the current song, you can use the <dfn>indexOf()</dfn> method. O método de array `indexOf()` retorna o primeiro índice em que um determinado elemento pode ser encontrado no array, ou `-1` se o elemento não estiver presente.
