...
Docstring ni mfuatano wa herufi unaowekwa kama tamko la kwanza katika darasa la vitu au kitendakazi, na hutumika kutoa nyaraka za darasa hilo au kitendakazi hicho. Docstring kawaida huwekwa ndani ya alama za nukuu maradufu tatu:
...
Kamilisha darasa lako la `Movie` kwa kuongeza docstring ifuatayo: `Parent class representing a movie.`

# --hints--

Unapaswa kuongeza docstring `Parent class representing a movie.` katika darasa lako la `Movie`.
