...
Especificar o atributo `type` do elemento `input` é importante para o navegador saber qual tipo de dados ele deve esperar. Se `type` não for especificado, o navegador o definirá por padrão como `text`.
