...
على الشاشات الصغيرة، تتجاوز (overflows) القائمة الغير منظمة (unordered list) في شريط التنقل (navigation bar) الجانب الأيمن من الشاشة العرض.

أصلح هذا باستخدام _Flexbox_ لتغليف محتوى `ul`. بعد ذلك، قم بتعيين خصائص CSS التالية لمحاذاة النص بشكل صحيح:
