...
Ще всередині класу `Bug` оголосіть властивість з іменем `emojiElement` типу `HTMLParagraphElement`. Ця властивість буде містити референс на HTML-елемент абзацу, де відображатиметься емодзі помилки.

# --hints--

Ваш клас `Bug` має мати властивість з іменем `emojiElement`.
...
Ваша властивість `emojiElement` має бути типу `HTMLParagraphElement`.
...
Ваша властивість `emojiElement` має використовувати оператор твердження визначеного присвоєння (`!`).
