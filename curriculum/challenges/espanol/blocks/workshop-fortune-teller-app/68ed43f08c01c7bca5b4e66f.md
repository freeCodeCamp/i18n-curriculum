...
Ahora, haz lo mismo para el resto de las propiedades. Usa la función `getElement` para seleccionar cada una:
...
Debes acceder a `multipleCardsBtn` usando el método `getElement` y pasando `#btn-multiple-cards`.
...
Debes acceder a `multipleCard` usando el método `getElement` y pasando `.multiple_card`.
...
Debes acceder a `title` usando el método `getElement` y pasando `.title`.
...
Debes acceder a `newReadingBtn` usando el método `getElement` y pasando `.btn_reveal`.
...
Debes acceder a `fortuneContainer` usando el método `getElement` y pasando `.fortune_container`.
...
Debes acceder a `fortuneDescription` usando el método `getElement` y pasando `.fortune_description`.
...
Debes acceder a `headerTitle` usando el método `getElement` y pasando `.header_title`.
...
Debes acceder a `subTitle` usando el método `getElement` y pasando `.sub_title`.
...
Debes acceder a `cardTitle` usando el método `getElement` y pasando `.desc_title`.
...
Debes acceder a `description` usando el método `getElement` y pasando `.description`.
...
Debes acceder a `text` usando el método `getElement` y pasando `.text`.
