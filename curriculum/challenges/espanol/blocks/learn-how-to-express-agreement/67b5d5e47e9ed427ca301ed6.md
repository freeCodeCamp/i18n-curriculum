...
This word refers to users who have already visited or used the system before. Termina con `-ing`.
...
`Returning` refers to someone or something that is coming back. Por ejemplo:
...
`Thoughts` refers to opinions, ideas, or feedback on a topic. It is often used in discussions to ask for input. Por ejemplo:
