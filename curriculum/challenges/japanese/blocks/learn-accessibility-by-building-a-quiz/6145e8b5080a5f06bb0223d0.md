...
2番目の `label` に `False` のテキストを与えてください。
...
4番目の `label` に `False` のテキストを与えてください。
...
最初の `input` に `value` を与えて、`label` のテキストコンテンツと一致させてください。
...
2番目の `input` に `value` を与えて、`label` のテキストコンテンツと一致させてください。
...
3番目の `input` に `value` を与えて、`label` のテキストコンテンツと一致させてください。
...
4番目の `input` に `value` を与えて、`label` のテキストコンテンツと一致させてください。
