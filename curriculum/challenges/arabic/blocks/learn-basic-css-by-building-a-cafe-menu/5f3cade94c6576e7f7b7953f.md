...
تابع الآن وغير عرض الصنفين `flavor` و `price` ليصبحا `50%` مرة أخرى.

# --hints--

يجب تعيين خاصية `width` إلى `50%` في المحدِّد `.flavor` الخاص بك.
...
يجب تعيين خاصية `width` إلى `50%` في المحدِّد `.price` الخاص بك.
