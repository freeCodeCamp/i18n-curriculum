...
`The company made an interactive infographic where readers can click to see details about each product.`——这里，`interactive infographic` 指的是不仅展示信息，还允许读者与之互动的视觉形式。
