...
Нарешті, поверніть `secret_codes`, потім розкоментуйте виклик функції та оновіть аргумент, щоб він був `[poem, poem2, poem3]`. Тепер ваша функція працює з кількома віршами одночасно і може витягувати кілька шпильок!

Функція `pin_extractor` завершена.

# --hints--

Функція має повертати `secret_codes` наприкінці.
...
У вас має бути виклик функції `print(pin_extractor([poem, poem2, poem3]))`.
...
`pin_extractor([poem, poem2, poem3])` має повертати `['5202', '3346', '50000']`.
...
Функція має коректно працювати з іншими списками віршів.
