...
Aggiungi anche un elemento `label` a destra della nuova casella di spunta con il testo `Lazy`. Assicurati di associare l'elemento `label` alla nuova casella di spunta usando l'attributo `for`.
...
La tua nuova casella di spunta dovrebbe avere un attributo `id` con il valore `lazy` e un attributo `name` con il valore `personality`. Controlla che ci sia uno spazio dopo il nome del tag di apertura e/o che ci siano spazi prima di tutti i nomi degli attributi.
...
La tua nuova casella di spunta dovrebbe essere dopo la prima. Le hai nell'ordine sbagliato.
...
Sul lato destro della tua nuova casella di spunta, dovrebbe esserci un elemento `label` con il testo `Lazy`.
