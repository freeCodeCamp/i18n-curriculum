...
Що ж, `file` з типом `input` дозволяє саме це. Додайте `label` з текстом `Upload a profile picture:` та вкладіть `input`, що приймає завантаження файлу.

# --hints--

Додайте елемент `label` з текстом `Upload a profile picture:`.
