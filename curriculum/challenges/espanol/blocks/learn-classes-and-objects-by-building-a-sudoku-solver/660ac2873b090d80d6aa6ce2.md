...
Ahora, crea un ciclo `for` para iterar sobre las filas en el tablero. Usa `row` como la variable del ciclo.

# --hints--

Debes crear un ciclo `for` que itere sobre `self.board`.
...
Debes usar `row` como la variable del ciclo.
