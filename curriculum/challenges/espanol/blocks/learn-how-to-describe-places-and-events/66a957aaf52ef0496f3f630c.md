...
In business, the word `branch` refers to a local office or division of a larger organization. Por ejemplo:
...
`Headquarters` refers to the main office or central hub of an organization. Por ejemplo:
