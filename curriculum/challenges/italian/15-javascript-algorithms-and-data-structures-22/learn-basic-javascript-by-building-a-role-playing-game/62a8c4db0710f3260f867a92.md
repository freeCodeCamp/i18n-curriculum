...
Cosa succede se il giocatore non ha abbastanza oro per comprare vita? You should use an `if` statement to check if the player has enough gold to buy health.
