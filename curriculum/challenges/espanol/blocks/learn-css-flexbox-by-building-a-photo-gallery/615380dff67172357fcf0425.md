...
Crea un selector `.gallery img` que las apunte. Dales a todas un `width` del `100%` y un `max-width` de `350px`.

También establece la propiedad `height` a `300px` para mantener tus imágenes a un tamaño uniforme.
