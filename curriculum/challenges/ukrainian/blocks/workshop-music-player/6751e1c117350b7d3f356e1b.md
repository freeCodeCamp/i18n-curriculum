...
Всередині функції `playSong` викличте функцію `highlightCurrentSong`.

Після цього поекспериментуйте з кнопками керування, щоб побачити, як працює функція `highlightCurrentSong`.

# --hints--

Ви повинні викликати `highlightCurrentSong` всередині функції `playSong`.
