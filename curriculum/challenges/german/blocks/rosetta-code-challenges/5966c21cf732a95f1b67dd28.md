...
Gegeben ist ein Datumsstring in EST. Geben Sie das angegebene Datum als String aus, wobei 12 Stunden zur Zeit hinzugefügt werden. Die Zeitzone soll erhalten bleiben.

Beispiel-Eingabe: `"March 6 2009 7:30pm EST"`

Beispiel-Ausgabe: `"March 7 2009 7:30am EST"`
...
Es sollte ein Tageswechsel berücksichtigt werden. `add12Hours("March 6 2009 7:30pm EST")` sollte `"March 7 2009 7:30am EST"` zurückgeben.

```js
assert(add12Hours('March 6 2009 7:30pm EST') === 'March 7 2009 7:30am EST');
```

Es sollte ein Monatswechsel in Schaltjahren berücksichtigt werden. `add12Hours("February 29 2004 9:15pm EST")` sollte `"March 1 2004 9:15am EST"` zurückgeben.

```js
assert(add12Hours('February 29 2004 9:15pm EST') === 'March 1 2004 9:15am EST');
```

Es sollte ein Monatswechsel in normalen Jahren berücksichtigt werden. `add12Hours("February 28 1999 3:15pm EST")` sollte `"March 1 1999 3:15am EST"` zurückgeben.

```js
assert(add12Hours('February 28 1999 3:15pm EST') === 'March 1 1999 3:15am EST');
```

Es sollte ein Jahreswechsel berücksichtigt werden. `add12Hours("December 31 2020 1:45pm EST")` sollte `"January 1 2021 1:45am EST"` zurückgeben.
