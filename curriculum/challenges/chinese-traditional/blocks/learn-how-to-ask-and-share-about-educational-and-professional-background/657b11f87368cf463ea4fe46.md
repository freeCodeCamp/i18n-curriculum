...
Questions in the `Past Simple` tense with the verb `to be` are very similar to how you do it in the `Present Simple` tense. The only difference is that you need to remember to conjugate the verb to `were` or `was`, followed by the subject and then the main verb. 例如：
