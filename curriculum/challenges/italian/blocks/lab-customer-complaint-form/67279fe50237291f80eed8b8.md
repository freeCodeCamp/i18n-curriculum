...
Quando `#other-complaint` non è selezionata, `validateForm()["complaint-description"]` dovrebbe essere `true`.
...
Quando `#other-solution` non è selezionato, `validateForm()["solution-description"]` dovrebbe essere `true`.
