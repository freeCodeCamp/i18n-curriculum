...
عندما تريد تأكيد معلومة (لتقول إن شيئًا ما صحيح)، يمكنك استخدام الفعل `do`. هذا يجعل إجابتك أقوى. على سبيل المثال:

- السؤال: `Do you like pizza?`

- الإجابة: `Yes, I do.` - هذه الإجابة أقوى من مجرد `Yes.`

تستخدم `do` لتُظهر أنك متأكد.
...
سوفي تؤكد سؤال توم بشكل إيجابي، لذا تكرر الفعل المساعد المستخدم في سؤال توم.
