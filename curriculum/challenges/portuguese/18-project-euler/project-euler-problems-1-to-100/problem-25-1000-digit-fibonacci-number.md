...
title: 'Problema 25: Número de Fibonacci de 1000 algarismos'
challengeType: 1
forumTopicId: 301897
...
<div style='padding-left: 4em;'>F<sub>n</sub> = F<sub>n−1</sub> + F<sub>n−2</sub>, onde F<sub>1</sub> = 1 e F<sub>2</sub> = 1.</div>
