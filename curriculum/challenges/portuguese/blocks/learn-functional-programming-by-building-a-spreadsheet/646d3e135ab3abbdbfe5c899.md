...
Sua callback precisa de quatro parâmetros. `match`, `arg1`, `operator` e `arg2`.

Você não usará o parâmetro `match`. Então, lembre-se de prefixá-lo.
...
A função de callback ainda deve estar vazia.
