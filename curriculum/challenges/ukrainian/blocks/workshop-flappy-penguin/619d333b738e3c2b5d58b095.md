...
У межах другої контрольної точки поверніть до `130deg` і збережіть масштабування лівої руки.

# --hints--

Ви повинні надати контрольній точці `20%` `transform` зі значенням `rotate(130deg) scaleX(-1)`.
