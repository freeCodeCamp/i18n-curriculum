...
الآن، عدل استدعاء `removePlant` ومرر له الكائن `ballerina` ثم راقب وحدة التحكم. سترى خطأً ستصلحه في الخطوة التالية.

# --hints--

يجب أن تسجل `removePlant(ballerina)` في وحدة التحكم.
