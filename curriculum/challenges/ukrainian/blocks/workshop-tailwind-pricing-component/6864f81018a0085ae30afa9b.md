...
Пташка в кожному `span` на початку елемента списку є декоративною. Додайте `aria-hidden` цим `span` елементам, щоб приховати їх від читачів екрана.

Також призначте класи `text-green-700` і `mr-2` кожному з `span` елементів.

# --hints--

Ваші два `span` елементи повинні мати атрибут `aria-hidden`.
...
Ваші два `span` елементи повинні мати клас `text-green-700`.
...
Ваші два `span` елементи повинні мати клас `mr-2`.
