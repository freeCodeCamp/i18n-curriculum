...
Цей двослівний вираз означає дуже близько або поруч із чимось.

# --explanation--

`Next to` означає поруч або дуже близько до чогось. Наприклад:

`The printer is next to the desk.` – Це показує, що принтер розташований прямо поруч із столом.
