...
فوق عنصر `.penguin`، أضف `div` مع `class` باسم `left-mountain`.

# --hints--

يجب إضافة `div` جديد داخل `body`. كان من المتوقع رؤية عناصر `div` بعدد `--fcc-expected--`، لكن وُجد عدد `--fcc-actual--`.
