...
Aninhe ambos os seus botões de opção dentro de um elemento `<div class="row">`. Então aninhe cada um deles dentro de um elemento `<div class="col-xs-6">`.

**Nota:** Como lembrete, os botões de opção são elementos `input` do tipo `radio`.
