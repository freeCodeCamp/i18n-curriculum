...
A continuación, necesitas crear una función para ocultar elementos del DOM. Declara una función `hideElements` que reciba `...elements` como parámetro con el tipo `HTMLElement[]`.

Esta función, con una clase CSS `hidden`, se usará en toda la aplicación para alternar la visibilidad de los elementos de la interfaz.

# --hints--

Debes haber declarado una función llamada `hideElements`.
...
Tu función `hideElements` debe tener un parámetro llamado `...elements` con el tipo `HTMLElement[]`.
