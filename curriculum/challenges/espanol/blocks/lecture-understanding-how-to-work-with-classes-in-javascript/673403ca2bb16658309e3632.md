...
Aprendiste que las clases son como planos que puedes usar para crear objetos.
...
¿Qué valor tendrá la palabra clave `this` en el contexto de este método? Se referirá al objeto en el cual se está llamando el método.  In this case, we're creating a new Dessert instance with the name `"Brownie"` and the price `$5.99`:
