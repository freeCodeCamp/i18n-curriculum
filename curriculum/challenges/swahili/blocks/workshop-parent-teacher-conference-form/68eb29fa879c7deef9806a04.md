...
Ili kuhakikisha maandishi yaliyoingizwa katika ingizo na maeneo ya maandishi, pamoja na viwakilishi vyake, vinaonekana, weka rangi yao.

Chagua `input, input::placeholder, textarea` na weka `color` kuwa `whitesmoke`.

# --hints--

Unapaswa kulenga `input`, `input::placeholder`, `textarea`.
