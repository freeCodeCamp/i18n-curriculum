...
En una lección anterior, te presentaron por primera vez las aserciones y las pruebas unitarias. Pero como repaso, las pruebas unitarias son cuando verificas la salida de funciones o componentes individuales de forma independiente, en contraste con probar la salida final de todo el programa. Las aserciones se usan para comprobar que el código se está comportando como se espera.

En esta lección, vamos a examinar más de cerca las aserciones en las pruebas unitarias y explorar algunas mejores prácticas.
...
Echemos un vistazo a algunos ejemplos que son del Currículo de Desarrollador Full-Stack.
