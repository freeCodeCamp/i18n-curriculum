...
На цьому етапі ви хочете відображати результати лише для вузлів, які не є початковим вузлом і до яких можна дістатися з нього.

Додайте умовну інструкцію, яка перевіряє, чи дорівнює `node_no` `start_node` **або** чи дорівнює `distances[node_no]` `INF`.

Якщо будь-яка з умов істинна, використайте `continue`, щоб перейти до наступної ітерації циклу.

# --hints--

Ви повинні додати умовну інструкцію всередині циклу.
...
Ваша інструкція `if` має перевіряти, чи дорівнює `node_no` `start_node` *або* чи дорівнює `distances[node_no]` `INF`.
...
Ви повинні використати `continue`, щоб перейти до наступної ітерації циклу.
