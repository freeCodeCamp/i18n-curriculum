...
1. A linha no elemento de rodapé da sua tabela deve conter um elemento de dados da tabela que abranja quatro colunas e tenha o texto `Total Books: N`, onde `N` deve ser substituído pelo número de livros na sua tabela.
