...
Виглядає краще. Тепер спробуйте додати той самий `20px` відступ зверху та знизу меню.

# --hints--

Вам не слід видаляти властивості `padding-left` або `padding-right`.
...
Вам слід встановити властивість `padding-top` у значення `20px`.
...
Вам слід встановити властивість `padding-bottom` у значення `20px`.
...
Ваш елемент `.menu` має мати відступ `padding-top` зі значенням `20px`.
...
Ваш елемент `.menu` має мати відступ `padding-bottom` зі значенням `20px`.
