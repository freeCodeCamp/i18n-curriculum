...
Dein `legend`-Element sollte ein öffnendes Tag enthalten. Opening tags have this syntax: `<elementName>`.
...
Dein `legend`-Element sollte ein abschließendes Tag haben. Closing tags have a `/` just after the `<` character.
