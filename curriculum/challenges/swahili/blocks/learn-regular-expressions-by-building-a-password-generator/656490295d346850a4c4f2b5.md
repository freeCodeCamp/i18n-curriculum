...
Baada ya mzunguko, ongeza tamko la `return` katika kitendakazi chako ili lirudishe tofauti ya `password`.

# --hints--

Unapaswa kurudisha `password` mwishoni mwa kitendakazi chako.
