...
Tumia tukio la `oninput` kwenye `shapeTypeSelect` na uilishe kuwa `handleShapeSelect`. Hii itafanya kitendakazi kifikie kila wakati uchaguzi wa umbo linapobadilika.

Baada ya kufanya hivyo, utakuwa na uwezo wa kuona sehemu za ingizo za kila umbo. Lakini hesabu bado hazitafanya kazi, na hiyo ndiyo utakayoshughulikia ifuatayo.

# --hints--

Unapaswa kuweka `shapeTypeSelect.oninput` kuwa `handleShapeSelect`.
