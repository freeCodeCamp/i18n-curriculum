...
للبناء التالي، قم بتسكين أربعة عناصر `div` داخل `.fb3` مع أصناف `fb3a`، `fb3b`، ثم `fb3a` مرة أخرى، و`fb3b` مرة أخرى، بهذا الترتيب. سيكون لهذا البناء أربعة أقسام، والقسمان العلويان سيكونان متشابهان تقريبًا مع القسمين السفليين.
