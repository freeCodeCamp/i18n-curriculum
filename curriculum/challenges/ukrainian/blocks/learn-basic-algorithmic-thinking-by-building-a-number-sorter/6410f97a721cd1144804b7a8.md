...
Як і в сортуванні бульбашкою, сортування вибором потребує ітерування по масиву. Оголосіть цикл `for` для цього.
