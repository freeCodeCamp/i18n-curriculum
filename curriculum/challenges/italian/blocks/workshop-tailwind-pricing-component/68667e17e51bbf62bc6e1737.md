...
Ora dovresti definire lo stile del CTA per farlo sembrare più un pulsante.

Per i colori di sfondo e primo piano, assegna le classi `bg-gradient-to-r`, `from-fuchsia-500`, `to-indigo-600`, `text-white`, `hover:from-fuchsia-600` e `hover:to-indigo-700`. Assegna anche le classi `rounded-md` e `block`.

# --hints--

Il tuo elemento àncora dovrebbe avere la classe `bg-gradient-to-r`.
...
Il tuo elemento àncora dovrebbe avere la classe `from-fuchsia-500`.
...
Il tuo elemento àncora dovrebbe avere la classe `to-indigo-600`.
...
Il tuo elemento àncora dovrebbe avere la classe `hover:from-fuchsia-600`.
...
Il tuo elemento àncora dovrebbe avere la classe `hover:to-indigo-700`.
