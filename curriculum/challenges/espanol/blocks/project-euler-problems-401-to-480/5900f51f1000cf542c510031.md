...
Recuerda que un gráfico es una colección de vértices y bordes conectando los vértices, y esos dos vértices conectados por un borde se llama adyacentes.
...
Por ejemplo, $R(2, 3) = 19$ y $R(5, 5) = 23\,679\,901$.

Define $S(N)$ como $\sum R(i, j)$ para $1 ≤ i$, $j ≤ N$.

Por ejemplo, $S(5) = 25\,021\,721$.

Encuentra $S(100)$, da tu respuesta módulo $1\,000\,000\,033$.
