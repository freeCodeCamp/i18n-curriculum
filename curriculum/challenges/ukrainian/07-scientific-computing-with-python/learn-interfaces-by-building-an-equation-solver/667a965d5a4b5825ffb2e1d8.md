...
Змініть рядки, що містяться в `details_list`, щоб вирівняти праворуч числові значення кутового коефіцієнту та перетину. Кінцевий вивід має виглядати так:
...
Зауважте, що параметр вирівнювання та ширину слід розміщувати між двокрапкою та специфікатором формату точності.
