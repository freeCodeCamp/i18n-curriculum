...
Debes tener un selector de clase `flavor`.
...
La propiedad `text-align` Debe tener el valor `left`.
...
El selector de clase `flavor` debe de darle a la propiedad `text-align` el valor `left`.
