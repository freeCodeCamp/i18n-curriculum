...
Due numeri interi $N$ e $M$ si dicono coppie amichevoli se $N \\neq M$ e la somma dei divisori propri di $N$ ($\\mathrm{sum}(\\mathrm{propDivs}(N))$) $= M$ così come $\\mathrm{sum}(\\mathrm{propDivs}(M)) = N$.

**Esempio:**

**1184** e **1210** sono una coppia amichevole, con i divisori propri:
...
La somma dei divisori per il primo valore, **1184**, è **1210** e la somma dei divisori per il secondo valore, **1210**, è **1184**.

# --instructions--

Calcola e mostra qui le coppie amichevoli sotto 20.000 (sono otto).
