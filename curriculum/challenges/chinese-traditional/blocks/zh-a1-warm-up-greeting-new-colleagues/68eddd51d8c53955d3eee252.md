...
<!-- (Audio) Chen Na: 數據分析師 (shù jù fēn xī shī) -->
...
Chen Na is saying `數據分析師 (shù jù fēn xī shī)`, which means "data analyst". It refers to someone who examines and interprets data to help make informed decisions. For example:

`我是數據分析師 (wǒ shì shù jù fēn xī shī)。` - I am a data analyst.
