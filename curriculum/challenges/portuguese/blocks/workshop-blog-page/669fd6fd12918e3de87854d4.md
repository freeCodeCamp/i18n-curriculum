...
O elemento `nav` é usado para fornecer links de navegação para outras seções no documento ou outras seções no site. Muitas vezes, você verá o elemento `nav` usado para menus ou tabela de conteúdos. 
