...
\- Se uma palavra começa com uma consoante, pegue a primeira consoante ou grupo consonantal, mova-a para o final da palavra e adicione `ay` a ela.

\- Se uma palavra começa com uma vogal, basta adicionar `way` no final.
