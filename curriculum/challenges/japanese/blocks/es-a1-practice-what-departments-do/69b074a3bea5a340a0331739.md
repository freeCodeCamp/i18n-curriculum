...
このタスクでは、業務内容に基づいて部署を特定する練習をします。

# --instructions--

聞いて、正しい部署で文を完成させてください。
...
セバスティアンは `el departamento de recursos humanos apoya a los empleados` と言っています。これは「人事部は従業員をサポートします」という意味です。
