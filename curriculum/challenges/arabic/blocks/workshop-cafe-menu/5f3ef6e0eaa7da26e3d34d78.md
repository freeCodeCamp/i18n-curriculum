...
يمكنك إعطاء القائمة مساحة بين المحتوى والجوانب باستخدام خاصيات `padding` المختلفة.

أعطِ الصنف `menu` خاصيتي `padding-left` و `padding-right` بنفس القيمة `20px`.

# --hints--

يجب تعيين الخاصية `padding-left` إلى `20px`.
...
يجب تعيين الخاصية `padding-right` إلى `20px`.
...
يجب أن يحتوي عنصر `.menu` على `padding-left` بقيمة `20px`.
...
يجب أن يحتوي عنصر `.menu` على `padding-right` بقيمة `20px`.
