...
title: створіть форму RSVP для події
challengeType: 25
...
1. Ви повинні створити форму з полями для імені, е-пошти, кількості учасників, дієтичних уподобань і опцією вказати, чи приводите ви додаткових гостей.

2. Ви повинні мати текстове поле введення, куди вводитимете своє ім’я (обов’язково).

3. Ви повинні мати поле введення е-пошти, куди вводитимете свою адресу е-пошти (обов’язково). Форма має перевіряти формат, щоб переконатися, що це правильна е-пошта.

4. Ви повинні мати числове поле введення, куди вводитимете кількість учасників у формі (обов’язково), і це число не повинно бути меншим за один.

5. Ви повинні мати текстове поле введення, куди вводитимете свої дієтичні уподобання, і ця інформація має бути необов’язковою.

6. Ви повинні мати можливість встановити або зняти прапорець, щоб вказати, чи приводите ви додаткових гостей.

7. Ви повинні мати кнопку, яка відправляє форму, і форма не має спричиняти перезавантаження сторінки після відправлення.

8. Після відправлення ви повинні бачити повідомлення підтвердження під формою, а також деталі, які ви надали (ім’я, е-пошта, кількість учасників, дієтичні уподобання та необов’язкові додаткові гості).

Ось приклад повідомлення після відправлення форми:
...
Ви повинні мати один `form` елемент, щоб утримувати весь вміст форми.
...
Ви повинні мати два `input` елементи типу `text`.
...
Ви повинні мати один `input` елемент типу `email`.
...
Ви повинні мати один `input` елемент типу `number`.
...
Ви повинні мати один `input` елемент типу `checkbox`.
...
Один `input[type="text"]` елемент має бути обов’язковим.
...
Елемент `input[type="email"]` має бути обов’язковим.
...
Елемент `input[type="number"]` має бути обов’язковим.
...
Елемент `input[type="number"]` не повинен приймати значення менше за 1.
...
Зміна значення елементів `input[type="text"]` має оновлювати стан компонента.
...
Зміна значення елементів `input[type="email"]` має оновлювати стан компонента.
...
Зміна значення елементів `input[type="number"]` має оновлювати стан компонента.
...
Зміна значення елементів `input[type="checkbox"]` має оновлювати стан компонента.
...
Відправлення форми не має спричиняти перезавантаження сторінки.
...
Після відправлення має бути елемент на сторінці, який відображає стан імені `input`.
...
Після відправлення має бути елемент на сторінці, який відображає стан е-пошти `input`.
...
Після відправлення має бути елемент на сторінці, який відображає стан кількості учасників `input`.
...
Після відправлення має бути елемент на сторінці, який відображає стан дієтичних уподобань `input`.
...
Після відправлення має бути елемент на сторінці, який відображає стан додаткових гостей `input`.
