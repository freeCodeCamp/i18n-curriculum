...
Crea un selector `body`. Establece la propiedad `font-family` en `Baskervville`, con un respaldo de `serif`. Establece la propiedad `color` en `linen` y la propiedad `background-color` en `rgb(20, 30, 40)`.
