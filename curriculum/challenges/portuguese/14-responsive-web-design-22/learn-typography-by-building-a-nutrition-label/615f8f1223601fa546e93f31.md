...
Crie o elemento final `p` para a seção `.daily-value`. Dê a ela o texto `Potassium 235mg 6%`. Alinhe o texto `6%` para a direita e remova a borda inferior do elemento `p`.
...
O novo elemento `p` deve ter o texto `Potassium 235mg 6%`.
