...
在你的 `currentWeapon` 之後，使用串接運算子將 `text.innerText` 設定為字串 `"You sold a "`，接著是 `currentWeapon`，然後是字串 `"."`。

# --hints--

你應該對 `text.innerText` 使用指定運算子。
