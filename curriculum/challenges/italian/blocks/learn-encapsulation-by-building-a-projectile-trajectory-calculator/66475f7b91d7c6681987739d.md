...
Hai una lista di liste di stringhe. Unisci le liste interne per ottenere una lista di stringhe.
...
`create_trajectory()` dovrebbe calcolare l'output corretto per istanze diverse.
