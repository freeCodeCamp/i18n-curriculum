...
Si verificas el tamaño del `div` en el navegador usando `content-box` y `border-box` notarás que hay una diferencia muy importante. Estos son los dos `div` en HTML:
