...
Цей дієслово означає підготуватися до чогось.

# --explanation--

`Need to prepare` означає, що підготовка до чогось є необхідною.

Софі розуміє, що можуть статися різні ситуації, і робить висновок, що команда має бути готовою до всіх них.
