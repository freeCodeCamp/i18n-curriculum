...
title: 'Zoezi la 10: Jumla ya namba msingi'
challengeType: 1
forumTopicId: 301723
...
Jumla ya namba msingi chini ya 10 ni 2 + 3 + 5 + 7 = 17.

Tafuta jumla ya namba msingi zote chini ya `n`.

# --hints--

`primeSummation(17)` inapaswa kurudisha nambari.

```js
assert.isNumber(primeSummation(17));
```

`primeSummation(17)` inapaswa kurudisha 41.

```js
assert.strictEqual(primeSummation(17), 41);
```

`primeSummation(2001)` inapaswa kurudisha 277050.

```js
assert.strictEqual(primeSummation(2001), 277050);
```

`primeSummation(140759)` inapaswa kurudisha 873608362.

```js
assert.strictEqual(primeSummation(140759), 873608362);
```

`primeSummation(2000000)` inapaswa kurudisha 142913828922.
