...
Ndani ya kila kipengele cha `li`, tengeneza kipengele cha nanga chenye sifa ya kipengele cha `href` iliyowekwa kuwa `#`.

# --hints--

Unapaswa kutengeneza kipengele kipya cha `a` ndani ya kila kipengee cha orodha na kuweka sifa yake ya kipengele ya `href` kuwa `#`.
