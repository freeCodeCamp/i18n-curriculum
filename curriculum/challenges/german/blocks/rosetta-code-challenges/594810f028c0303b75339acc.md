...
Sie erhalten eine Sammlung von ABC-Blöcken (z. B. Buchstabenblöcke aus der Kindheit). Es gibt 20 Blöcke, auf jedem Block sind zwei Buchstaben. Ein vollständiges Alphabet ist auf allen Seiten der Blöcke garantiert. Die Beispielsammlung der Blöcke:
...
Implementieren Sie eine Funktion, die einen String (Wort) entgegennimmt und bestimmt, ob das Wort mit der gegebenen Sammlung von Blöcken buchstabiert werden kann.

Einige Regeln, die Sie beachten sollten:

<ul>
<li>Wenn ein Buchstabe auf einem Block verwendet wurde, kann dieser Block nicht erneut verwendet werden.</li>
  <li>Die Funktion sollte nicht zwischen Groß- und Kleinschreibung unterscheiden.</li>
</ul>
