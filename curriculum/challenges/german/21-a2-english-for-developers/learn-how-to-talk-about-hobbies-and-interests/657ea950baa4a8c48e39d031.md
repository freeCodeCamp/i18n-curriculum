...
The expression `I would love to` is used to express enthusiasm and agreement with a suggested or proposed activity. In bejahenden Sätzen wird `would` oft verkürzt zu `'d`, wie in `I'd love to`.
