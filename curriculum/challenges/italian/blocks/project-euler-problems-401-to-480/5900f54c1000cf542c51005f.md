...
Considera tutte le parole che si possono formare selezionando lettere, in qualsiasi ordine, dalla frase:

$$\mathbf{\text{thereisasyetinsufficientdataforameaningfulanswer}}$$

Supponi che quelle con 15 lettere o meno siano elencate in ordine alfabetico e numerate sequenzialmente a partire da 1.
...
Definisci $P(w)$ come la posizione della parola $w$.

Definisci $W(p)$ come la parola in posizione $p$.

Possiamo vedere che $P(w)$ e $W(p)$ sono funzioni inverse: $P(W(p)) = p$ e $W(P(w)) = w$.
