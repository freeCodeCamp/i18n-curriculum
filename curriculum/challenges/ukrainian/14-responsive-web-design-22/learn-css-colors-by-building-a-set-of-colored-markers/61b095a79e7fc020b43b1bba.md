...
В тій самій функції `linear-gradient` використайте функцію `rgb`, щоб встановити другий аргумент на чисто зелений.

# --hints--

Ваше CSS-правило `.red` повинне мати властивість `background` зі значенням `linear-gradient(90deg, rgb(255, 0, 0), rgb(0, 255, 0))`.
