...
هذه العبارة المكونة من كلمتين تعني أن شيئًا ما موجه أو مخصص لغرض معين.

# --explanation--

`Directed towards` تعني أن شيئًا ما مُعيَّن أو مُركَّز أو موجه إلى مساحة أو هدف معين. على سبيل المثال:

`A large part of the funding was directed towards research and development.` — هذا يعني أن المال استُخدم عمدًا لتلك المساحة.

في جملة أليس، تعني أن جزءًا من الميزانية يُستخدم في تطوير الواجهة الخلفية.
