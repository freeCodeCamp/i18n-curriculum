...
Matokeo ni sahihi, `repr` inakupa mfuatano wa herufi unaohitajika kuanzisha vitu.

Sasa toa maoni kwenye wito zako zote za `print`.

# --hints--

Unapaswa kutoa maoni kwenye wito zako zote za `print()`.
