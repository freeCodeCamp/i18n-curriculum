...
Kipengele chako cha `legend` kinafaa kuwa na tagi ya kufungua. Opening tags have this syntax: `<elementName>`.
...
Kipengele chako cha `legend` kinapaswa kuwa na tagi ya kufunga. Closing tags have a `/` just after the `<` character.
