...
Cree una nueva regla de CSS usando el selector `.two` y establezca su propiedad `width` a 475 píxeles.

# --hints--

Debe tener un selector `.two`.
...
Su elemento `.two` debe tener un valor de propiedad `width` de `475px`.
