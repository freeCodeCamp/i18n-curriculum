...
Останнє, що потрібно зробити — це стилізувати кнопку CTA для сімейного плану.

Додайте їй класи `block`, `rounded-md`, `bg-indigo-600`, `px-4`, `py-2`, `text-center`, `font-semibold`, `text-white` та `hover:bg-indigo-700`.

Після цього ваше практичне заняття зі створення компонента ціноутворення на Tailwind буде завершене!

# --hints--

Ваш елемент посилання повинен мати клас `bg-indigo-600`.
...
Ваш елемент посилання повинен мати клас `px-4`.
...
Ваш елемент посилання повинен мати клас `py-2`.
...
Ваш елемент посилання повинен мати клас `text-center`.
...
Ваш елемент посилання повинен мати клас `text-white`.
...
Ваш елемент посилання повинен мати клас `font-semibold`.
...
Ваш елемент посилання повинен мати клас `hover:bg-indigo-700`.
...
Ваш елемент посилання повинен мати клас `rounded-md`.
...
Ваш елемент посилання повинен мати клас `block`.
