...
Utaendelea kuongeza sehemu za fomu hii katika hatua zinazofuata.

# --hints--

`div.form-panel` yako inapaswa kuwa na `div` kufunika sehemu ya Player Info.
...
`div` ndani ya `div.form-panel` inapaswa kuwa na `p` yenye `className` ya `form-section-title` na maandishi `Player Info`.
