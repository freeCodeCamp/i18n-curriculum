...
`Today` é usado para se referir ao dia atual, o dia que está acontecendo agora.
...
Sophie usa esta palavra para se referir ao dia atual. A primeira letra é maiúscula.
