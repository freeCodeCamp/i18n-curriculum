...
You should assign the `goCave` function reference to `button2.onclick`. Certifique-se de não chamar a função.
...
You should assign the `fightDragon` function reference to `button3.onclick`. Certifique-se de não chamar a função.
