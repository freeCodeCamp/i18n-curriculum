...
Umeongeza wito wa `console.log()` kwenye script yako kuthibitisha safu ya data ya `EVAReadySquad`, na sasa wito huo hauhitajiki tena. Ili kuzuia konsoli kuwa na msongamano katika hatua zijazo, endelea na futa mzunguko wa sasa wa `for` unaoandika `EVAReadySquad` waangani kwenye konsoli.

# --hints--

Futa mzunguko wa `for` unaoandika `EVAReadySquad` waangani kwenye konsoli. Unapaswa kufuta sehemu yote ya mzunguko huo.
