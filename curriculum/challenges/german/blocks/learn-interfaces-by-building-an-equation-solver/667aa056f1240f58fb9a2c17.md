...
Als letzten Schritt ändern Sie die Strings in `details_list` so, dass der Text, der nach dem Gleichheitszeichen steht, in jeder Zeile rechtsbündig ausgerichtet ist. Ihre endgültige Ausgabe sollte so aussehen:
