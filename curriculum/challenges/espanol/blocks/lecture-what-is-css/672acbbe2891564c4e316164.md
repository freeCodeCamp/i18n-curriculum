...
Un selector es un patrón utilizado en CSS para identificar y apuntar elementos específicos de HTML para su estilización.
...
Ahora que conoces la sintaxis para una regla CSS, veamos un ejemplo. Activa el editor interactivo y haz clic en la pestaña `styles.css` para ver el código CSS.
...
Aquí tienes un ejemplo de cómo dar estilo a múltiples selectores (para interactuar con el ejemplo, activa el editor interactivo): 
...
Dado el siguiente HTML, ¿qué regla CSS establece correctamente el color de texto de `h1` y `h2` a `green`?
...
Consulta al final de la lección para la sintaxis correcta.
