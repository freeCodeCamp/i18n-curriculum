...
Додайте клас `sky` властивість `radial-gradient`. Використайте `#ffcf33` від `0%` до `20%`, `#ffff66` на `21%` і `#bbeeff` на `100%`. Це додасть круговий градієнт до фону, який буде вашим сонцем.
...
Ви повинні додати третій колір `radial-gradient` `#bbeeff` на `100%`.
