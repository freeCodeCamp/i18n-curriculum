...
Elimina la palabra clave `pass` y retorna `vigenere(message, key)` desde tu nueva función.

# --hints--

Tu función `encrypt` debería devolver `vigenere(message, key)`. Recuerda eliminar `pass`.
