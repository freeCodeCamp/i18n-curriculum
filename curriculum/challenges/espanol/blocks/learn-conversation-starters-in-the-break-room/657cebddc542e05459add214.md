...
Para `schedule` significa organizar un evento o actividad para que ocurra en un tiempo específico. Es como hacer una cita o establecer una hora para algo. For example:
...
Este verbo se usa para hablar sobre planificar u organizar una reunión o evento para un momento concreto. Don't forget about the ending `-s`.
