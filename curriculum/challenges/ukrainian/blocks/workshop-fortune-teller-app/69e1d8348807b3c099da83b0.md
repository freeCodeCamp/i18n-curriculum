...
Ви маєте перевірити свій прогрес на цей момент. Створіть екземпляр класу `Game` і призначте його змінній `game`.

На цьому етапі ви побачите, що можете бачити картки, коли натискаєте на кнопки Single Card Reading та Three Card Spread.

# --hints--

Ви маєте оголосити змінну з ім’ям `game`.
...
Ваша змінна `game` має бути ініціалізована `new Game()`.
