...
Rufen Sie jetzt die `setPlayButtonAccessibleText`-Funktion innerhalb der `playSong`-Funktion auf.

# --hints--

Sie sollten die `setPlayButtonAccessibleText`-Funktion innerhalb der `playSong`-Funktion aufrufen.
