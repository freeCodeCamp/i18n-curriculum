...
Для останнього кроку практичного заняття ви маєте вивести повідомлення `"It was fun learning about the different Math methods with you!"` у консоль.

І з цією останньою зміною ви завершили практичне заняття MathBot!

# --hints--

Ви маєте вивести повідомлення `"It was fun learning about the different Math methods with you!"` у консоль.
