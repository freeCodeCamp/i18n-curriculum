...
Abaixo do elemento de citação em bloco, adicione um elemento de parágrafo com o texto `&mdash;Quincy Larson, How to Learn to Code and Get a Developer Job [Full Book]`.

`&mdash;` é uma entidade HTML que representa um travessão em `—`.
...
Seu elemento `p` deve conter o texto `&mdash;Quincy Larson, How to Learn to Code and Get a Developer Job [Full Book]`.
