...
Agora, você deve aumentar o tamanho da fonte para todos os elementos `label`.

Selecione o elemento `label` e defina seu `font-size` para `1.2rem`.

# --hints--

Você deve direcionar o elemento `label`.
