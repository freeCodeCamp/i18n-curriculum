...
Тепер виглядає краще. Спробуйте додати той самий `20px` відступ зверху і знизу меню.
...
Вам слід встановити властивість `padding-top` у `20px`.
...
Вам слід встановити властивість `padding-bottom` у `20px`.
...
Ваш елемент `.menu` має мати відступ `padding-top` рівний `20px`.
...
Ваш елемент `.menu` має мати відступ `padding-bottom` рівний `20px`.
