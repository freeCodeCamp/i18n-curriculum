...
Durchlaufen Sie die geraden Ziffern und geben Sie jede in der Konsole aus.

# --hints--

Sie sollten eine `for`-Schleife über `even_digits` innerhalb der `verify_card_number`-Funktion haben.
