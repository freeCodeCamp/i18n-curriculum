...
Використовуйте `for` цикл, щоб ітерувати над кожною цифрою в списку `odd_digits`. Перенесіть свій виклик `print` з попереднього кроку всередину `for` циклу і змініть його так, щоб він виводив кожну цифру.

# --hints--

Ви повинні використовувати `for` цикл над `odd_digits`.
...
Ви повинні мати `--fcc-expected--` всередині `for` циклу.
