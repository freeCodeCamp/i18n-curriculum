...
Saying `Absolutely` is a strong, enthusiastic way to agree with a suggestion. In response to a question like `Would that help?`, it is like saying `Yes, that would definitely help`. Приклад:
