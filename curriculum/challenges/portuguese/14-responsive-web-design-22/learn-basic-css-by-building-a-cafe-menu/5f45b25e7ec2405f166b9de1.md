...
Você muda as propriedades de um link quando o link tenha sido visitado de fato usando um <dfn>pseudosseletor</dfn>, que tem essa aparência: `a:visited { propertyName: propertyValue; }`.
