...
You should have `array[sorted_index] = right_part[right_array_index]` in the body of the loop. No olvides eliminar la palabra clave `pass` en el cuerpo del bucle.
