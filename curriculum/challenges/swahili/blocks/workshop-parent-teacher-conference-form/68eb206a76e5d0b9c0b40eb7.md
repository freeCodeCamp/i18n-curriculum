...
Ni wakati wa kupamba vipengele vya `fieldset` ili kuviweka na mpaka wa kipekee.

Chagua kipengele cha `fieldset`. Weka sifa yake ya `border` kuwa `1px solid gray`, `border-radius` kuwa `5px`, `margin` kuwa `20px 0`, na `padding` kuwa `20px`.

# --hints--

Unapaswa kulenga kipengele cha `fieldset`.
...
Weka sifa ya `margin` kuwa `20px 0`.
...
Weka sifa ya `padding` kuwa `20px`.
