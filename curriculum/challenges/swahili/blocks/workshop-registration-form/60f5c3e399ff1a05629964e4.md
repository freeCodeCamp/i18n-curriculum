...
Kama inavyopendekezwa na kichwa, unaunda fomu. Hivyo, baada ya kipengele cha `p`, weka `form` yenye sifa ya kipengele ya `action` inayolenga `https://register-demo.freecodecamp.org`.
