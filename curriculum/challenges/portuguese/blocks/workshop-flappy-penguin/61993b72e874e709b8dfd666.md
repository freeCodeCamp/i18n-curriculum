...
Vincule um elemento `.penguin-head` e dê a ele uma `width` de metade de seu pai e uma `height` de `45%`.Depois, defina o `background` como um gradiente linear a `45deg` começando em `gray` e terminando em `rgb(239, 240, 228)`.
