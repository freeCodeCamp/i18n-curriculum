...
Visualmente, esto es lo que está haciendo el algoritmo:  
<img alt="animación que muestra el algoritmo de búsqueda en anchura" src='https://cdn.freecodecamp.org/curriculum/coding-interview-prep/breadth-first-search.gif'>
