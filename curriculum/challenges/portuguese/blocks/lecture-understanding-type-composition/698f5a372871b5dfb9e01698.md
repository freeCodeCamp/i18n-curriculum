...
Nas lições anteriores, você aprendeu a trabalhar com tipos primitivos como `string` e `boolean`. Mas o TypeScript permite que você crie novos tipos a partir dos existentes. Um exemplo disso seria o tipo união.
