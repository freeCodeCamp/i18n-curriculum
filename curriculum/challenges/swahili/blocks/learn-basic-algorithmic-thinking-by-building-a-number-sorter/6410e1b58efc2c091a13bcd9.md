...
Kwa madhumuni ya kurekebisha makosa, ongeza wito wa `console.log()` katika mzunguko wako wa ndani. Pitisha hoja `array`, `array[j]`, na `array[j+1]`.

# --hints--

Unapaswa kutumia wito wa `console.log()` katika mzunguko wako wa ndani.
...
Unapaswa kupitisha `array[j+1]` kama hoja ya tatu kwa `console.log()`.
