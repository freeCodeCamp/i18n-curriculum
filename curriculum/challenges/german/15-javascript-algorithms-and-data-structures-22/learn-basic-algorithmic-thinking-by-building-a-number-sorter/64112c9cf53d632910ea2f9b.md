...
Nach deiner while-Schleife musst du deinen aktuellen Wert einfügen. Denke daran, dass deine Schleife endet, wenn `j` entweder außerhalb der Array-Grenzen liegt oder wenn der Wert an `j` kleiner als dein aktueller Wert ist.

Verwende den Zuweisungsoperator, um deinen aktuellen Wert in den richtigen Index einzufügen.

# --hints--

Du solltest `currValue` dem Index `j + 1` zuweisen.
