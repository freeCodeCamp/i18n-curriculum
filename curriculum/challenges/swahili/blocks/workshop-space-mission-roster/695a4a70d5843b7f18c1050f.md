...
Panga moja kwa moja safu ya data ya `sorted` kwa kutumia kitendakazi chako cha msaada `sortByPriorityDescending()`.

# --hints--

Unapaswa kuitisha `sortByPriorityDescending()` ukiwa na safu ya data `sorted`.
