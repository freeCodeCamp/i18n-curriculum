...
La cosa successiva che mostrerai sono i dettagli biografici sull'autore. Puoi farlo con `bio` che hai destrutturato prima.

Aggiungi un elemento paragrafo con `class` `"bio"`, poi inserisci `bio` all'interno dell'elemento paragrafo.
