...
Debes asignar la siguiente frase a la variable `greeting`: `"Hi there! My name is [MathBot goes here] and I am here to teach you about the Math object!"`. Asegúrate de reemplazar `[MathBot goes here]` con la variable `botName`.
