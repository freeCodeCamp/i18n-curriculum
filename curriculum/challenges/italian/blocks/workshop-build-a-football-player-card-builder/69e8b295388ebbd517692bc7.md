...
Sostituisci il nome del giocatore codificato `PELE` all'interno di `card-name` con `player.name`.

# --hints--

Dovresti sostituire il valore codificato `PELE` con `player.name` all'interno di `.card-name`.
