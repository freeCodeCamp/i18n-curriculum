...
Katika karatasi yako ya mtindo, toa maoni kwenye mstari unaoonyesha sifa na thamani ya `background-color`, ili uone athari ya kupangilia tu kipengele cha `#menu`. Hii itafanya nyuma kuwa nyeupe tena.
...
`body` yako inapaswa kuwa na nyuma nyeupe.
