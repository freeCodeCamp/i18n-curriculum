...
¿Qué significa la frase `review and adjust` en el plan?

## --answers--

Mira el plan de nuevo y mejóralo si es necesario.

---

Escribe un plan completamente nuevo.

### --feedback--

La frase no significa empezar de nuevo.

---

Prueba la función de chat nuevamente en todos los países.

### --feedback--

Las pruebas son parte de pasos anteriores, lo cual no es el significado de `review and adjust`.

---

Pregunta a los usuarios si les gusta la característica.

### --feedback--

La retroalimentación del usuario es útil, pero no es el enfoque aquí.
...
Encuentra el paso que habla sobre `reviewing` y `adjusting`. Después de hacerlo, lee su explicación. Te ayudará a responder esta pregunta correctamente.
