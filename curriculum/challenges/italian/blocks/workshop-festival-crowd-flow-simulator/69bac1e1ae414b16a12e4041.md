...
Finalmente puoi eseguire le tue simulazioni.

Inizia con il turno mattutino. Chiama `simulateFestival()` con `morningGates` e `"Morning"`. 

# --hints--

Dovresti chiamare `simulateFestival()` con `morningGates` e `"Morning"`.
