...
Ti serve un'altra interfaccia chiamata `Deck`. Questa interfaccia dovrebbe avere una proprietà `cards`, che è un array dell'interfaccia precedente.

# --hints--

Dovresti dichiarare un'interfaccia chiamata `Deck`.
...
La tua interfaccia `Deck` dovrebbe avere una proprietà `cards` di tipo `Card[]`.
