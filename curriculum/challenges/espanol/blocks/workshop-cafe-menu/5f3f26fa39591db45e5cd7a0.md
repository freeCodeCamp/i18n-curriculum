...
Cambia la altura del elemento `hr` a `3px`.

# --hints--

Debes utilizar el selector `hr`.
...
La propiedad `height` debe tener el valor `3px`.
...
Tu elemento `hr` debe tener una altura (height) dé `3px`.
