...
이제 텍스트를 읽을 수 없습니다. `footer`와 그 안에 있는 앵커 요소를 대상으로 폰트 색상을 적절한 명암 대비율을 가진 색상으로 설정하세요.

# --hints--

`footer, footer a` 선택자를 사용하세요.
...
`color`를 명암 대비율이 최소 `7:1`인 값으로 설정하세요. _힌트: `#dfdfe2`를 추천합니다__
