...
ارجع إلى دالتك `showLatestPosts()`، واستخدم التفكيك للحصول على الخاصيتين `topic_list` و `users` من كائن `data`.

# --hints--

يجب أن تستخدم `const` لتفكيك `topic_list` و `users` من كائن `data`.
