...
title: 如何使用 Font Squirrel 和 Google Fonts 等外部字體？
challengeType: 19
...
- 用於查看、查找和過濾字體的區域。
- 特別介紹 Noto 字體的區域，這是一套高質量字體，具有不同的字重、寬度和樣式，支持超過 1,000 多種語言和 150 多種書寫系統進行的交流。
- 可以爲你的網絡項目查找和下載圖標的區域。
- 可以瞭解更多有關字體及其最佳實踐以及常見問題的區域。
...
If you choose the `@import` option instead, you will need to add that rule to your CSS file. 這是一個例子：
