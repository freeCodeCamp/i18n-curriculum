...
Hatua inayofuata ni kuunda kigezo kinachoitwa `currentWeapon`.
...
Tumia neno kuu la `let` kuunda kigezo kinachoitwa `currentWeapon`. Usiliweke thamani bado.

# --hints--

Unapaswa kutumia `let` kutangaza kigezo cha `currentWeapon`.
