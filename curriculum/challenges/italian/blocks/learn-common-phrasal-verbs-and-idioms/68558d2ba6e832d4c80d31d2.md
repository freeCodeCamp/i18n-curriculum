...
Come potrebbe Jake dire a Linda che pensa che la sua idea sia buona?
...
`I like that.` è un modo informale e amichevole per mostrare accordo o approvazione dell'idea di qualcuno. Per esempio:

- Persona 1: `Let's move the meeting to 10 a.m.` – Questa persona sta suggerendo un cambio di programma.

- Persona 2: `I like that.` – Questo significa che chi parla supporta o è d'accordo con il suggerimento.
