...
Ви повинні додати атрибут `label` першому `for`, який відповідає `id` його `input` елемента.
...
Ви повинні додати атрибут `label` другому `for`, який відповідає `id` його `input` елемента.
...
Ви повинні додати атрибут `label` третьому `for`, який відповідає `id` його `input` елемента.
...
Ви повинні додати атрибут `label` четвертому `for`, який відповідає `id` його `input` елемента.
