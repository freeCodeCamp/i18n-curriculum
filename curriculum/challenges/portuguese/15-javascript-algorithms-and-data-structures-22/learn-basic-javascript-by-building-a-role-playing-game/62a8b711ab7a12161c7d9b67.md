...
Agora, a função `update` precisa usar o argumento que você passa dentro dela.

Dentro da função `update`, altere o valor de atribuição de `button1.innerText` para que seja `location["button text"]`. That way, you use bracket notation to get the `"button text"` property of the `location` object passed into the function.
