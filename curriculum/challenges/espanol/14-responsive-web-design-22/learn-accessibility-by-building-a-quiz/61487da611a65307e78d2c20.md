...
Soluciona esto usando _Flexbox_ para envolver el contenido de `ul`. Luego, establezca las siguientes propiedades CSS para alinear correctamente el texto:
