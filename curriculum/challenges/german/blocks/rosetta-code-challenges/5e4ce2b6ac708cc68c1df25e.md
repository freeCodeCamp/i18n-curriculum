...
Ein bestimmtes Kinderspiel besteht darin, mit einem Wort aus einer bestimmten Kategorie zu beginnen. Jeder Teilnehmer sagt reihum ein Wort, das aber mit dem letzten Buchstaben des vorherigen Wortes beginnen muss. Sobald ein Wort genannt wurde, darf es nicht wiederholt werden. Wenn ein Mitspieler kein Wort aus der Kategorie nennen kann, scheidet er aus dem Spiel aus.

Zum Beispiel bei der Kategorie „Tiere“,
...
Schreiben Sie eine Funktion, die ein Eingabe-Array von Wörtern erhält. Die Funktion soll ein Array von Wörtern zurückgeben, bei dem der erste Buchstabe jedes Wortes mit dem letzten Buchstaben des vorherigen Wortes übereinstimmt. Verwenden Sie nur die Wörter aus dem Eingabe-Array, und sobald ein Wort verwendet wurde, darf es nicht wiederholt werden. Die Wörter im Rückgabe-Array sollen so ausgewählt und angeordnet werden, dass die Länge maximiert wird.
