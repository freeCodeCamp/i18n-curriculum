...
Em chinês, o número 80 é chamado `八十 (bā shí)`.

Os números de 81 a 89 são formados adicionando o dígito das unidades (1–9) após `八十 (bā shí)` (80).
...
Eu pratiquei a pronúncia dos números de 80 a 89.
