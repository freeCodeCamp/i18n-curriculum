...
Ndani ya kitendakazi cha `playNextSong`, fanya wito wa vitendakazi vya `setPlayerDisplay`, `highlightCurrentSong`, na `setPlayButtonAccessibleText` ili kusahihisha mchezaji anapomaliza orodha ya nyimbo.

# --hints--

Unapaswa kufanya wito wa `setPlayerDisplay` ndani ya tamko la `else` la kitendakazi chako cha `playNextSong`.
...
Unapaswa kufanya wito wa `highlightCurrentSong` ndani ya tamko la `else` la kitendakazi chako cha `playNextSong`.
...
Unapaswa kufanya wito wa `setPlayButtonAccessibleText` ndani ya tamko la `else` la kitendakazi chako cha `playNextSong`.
