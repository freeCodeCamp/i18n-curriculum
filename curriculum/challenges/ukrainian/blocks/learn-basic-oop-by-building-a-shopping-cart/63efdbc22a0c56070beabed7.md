...
Ви на правильному шляху! Однак давайте на мить зупинимося, щоб розглянути загальну проблему при роботі з об’єктами в JavaScript.
...
Ви повинні використовувати дужкову нотацію, щоб отримати доступ до властивості об’єкта `totalCountPerProduct`, що відповідає `dessert.id`.
