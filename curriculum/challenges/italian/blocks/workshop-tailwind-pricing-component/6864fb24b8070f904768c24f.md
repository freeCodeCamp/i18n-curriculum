...
La prossima scheda prezzi è il **piano premium**.

Dai al wrapper `div` del piano premium le classi `bg-gray-950`, `text-white`, `ring-2`, `ring-fuchsia-500` e `p-8`.

# --hints--

Il tuo elemento wrapper `div` per il piano premium dovrebbe avere la classe `bg-gray-950`.
...
Il tuo elemento wrapper `div` per il piano premium dovrebbe avere la classe `text-white`.
...
Il tuo elemento wrapper `div` per il piano premium dovrebbe avere la classe `ring-2`.
...
Il tuo elemento wrapper `div` per il piano premium dovrebbe avere la classe `ring-fuchsia-500`.
...
Il tuo elemento wrapper `div` per il piano premium dovrebbe avere la classe `p-8`.
