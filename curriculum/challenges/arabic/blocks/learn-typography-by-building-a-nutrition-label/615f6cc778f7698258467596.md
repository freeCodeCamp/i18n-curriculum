...
أسفل العنصر الذي يحتوي على النص `Total Fat`، أنشئ عنصر `p` جديدًا يحتوي على النص `Saturated Fat 1g 5%`. غلف النص `5%` بعنصر `span` مع تعيين خاصية `class` إلى `bold`. في هذه الحالة، هذا يكفي لمحاذاة النسبة المئوية إلى `5%`.

# --hints--

يجب أن تنشئ عنصر `p` جديدًا أسفل العنصر الذي يحتوي على النص `Total Fat`.
...
يجب أن يحتوي عنصر `p` الجديد على النص `Saturated Fat 1g 5%`.
...
يجب أن يحتوي عنصر `span` على خاصية `class` مع تعيينها إلى `bold`.
