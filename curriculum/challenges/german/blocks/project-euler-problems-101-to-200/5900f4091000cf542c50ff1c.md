...
title: 'Aufgabe 157: Lösen der diophantischen Gleichung'
challengeType: 1
forumTopicId: 301788
...
Betrachten Sie die diophantische Gleichung $\frac{1}{a} + \frac{1}{b} = \frac{p}{{10}^n}$ mit $a$, $b$, $p$, $n$ als positive ganze Zahlen und $a ≤ b$.

Für $n = 1$ hat diese Gleichung 20 Lösungen, die unten aufgeführt sind:
