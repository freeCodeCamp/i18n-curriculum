...
Ora che la funzione `displayStory` funziona correttamente, è il momento di aggiungere la funzionalità ai pulsanti.

Prima di tutto, rimuovi la chiamata alla funzione `displayStory("scary")`.

# --hints--

Dovresti rimuovere la chiamata alla funzione `displayStory("scary")`.
