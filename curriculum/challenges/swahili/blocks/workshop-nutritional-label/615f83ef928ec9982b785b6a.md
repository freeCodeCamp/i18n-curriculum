...
Tengeneza kichaguzi cha `.double-indent` na umpe ukingo wa kushoto wa `2em`.
...
Kichaguzi chako cha `.double-indent` kinapaswa kuweka sifa ya `margin-left` tu, si sifa nyingine za ukingo.
