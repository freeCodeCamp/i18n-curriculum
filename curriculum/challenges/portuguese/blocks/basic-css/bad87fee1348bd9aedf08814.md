...
**Nota:** Este desafio permite múltiplas soluções possíveis.Por exemplo, você pode adicionar `border-radius` tanto à classe `.thick-green-border` quanto à classe `.smaller-image`.
