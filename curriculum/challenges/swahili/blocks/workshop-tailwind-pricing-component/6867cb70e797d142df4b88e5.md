...
Ifuatayo, weka madarasa la vitu `mt-6`, `space-y-2`, `text-sm`, na `text-gray-700` kwa kipengele cha `ul`.
...
Kipengele chako cha `ul` kinapaswa kuwa na darasa la vitu `text-gray-700`.
