...
`Everything` é uma forma de mencionar todas as coisas em um grupo específico. Quando Tom diz `everything is perfect`, ele quer dizer que todos os aspectos do seu novo local de trabalho estão perfeitos.
...
Esta palavra se refere a cada coisa individual.
