...
Ein Docstring ist ein String, der als erste Anweisung in einer Klasse oder Funktion steht und zur Dokumentation dieser Klasse oder Funktion dient. Docstrings sind typischerweise von dreifachen Anführungszeichen umgeben:
...
Vervollständigen Sie Ihre `Movie`-Klasse, indem Sie ihr den folgenden Docstring hinzufügen: `Parent class representing a movie.`

# --hints--

Sie sollten den Docstring `Parent class representing a movie.` zu Ihrer `Movie`-Klasse hinzufügen.
