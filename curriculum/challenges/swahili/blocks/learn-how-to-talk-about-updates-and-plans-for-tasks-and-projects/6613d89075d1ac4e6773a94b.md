...
Kulingana na mazungumzo, ni sentensi gani inaonyesha matumizi sahihi ya `going to` kulingana na ushahidi wa sasa?
...
Sentensi hii inatumia `will` kwa tendo linaloweza kutokea baadaye, ambalo halina hisia ya uamuzi uliofanywa kulingana na ushahidi wa sasa.
...
Hapa, `will` inatumiwa kwa tendo la baadaye kulingana na hali ya sasa, lakini `going to` ingekuwa sahihi zaidi kwani uamuzi unaonekana kutegemea utaalamu wa sasa wa timu.
...
Sentensi hii inatumia `will` kwa uamuzi wa ghafla (`calling the designer`), ambao ni sahihi, lakini haionyeshi matumizi ya `going to` kulingana na ushahidi wa sasa.
