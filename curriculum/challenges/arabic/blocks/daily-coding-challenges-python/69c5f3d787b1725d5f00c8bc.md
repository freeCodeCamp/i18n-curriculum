...
title: "تحدٍّ 258: فك ضغط الكلمات"
challengeType: 29
...
بالنظر إلى سلسلة نصية مضغوطة، أعد النسخة المفكوكة باستخدام القواعد التالية:

- تتكون السلسلة النصية المعطاة من كلمات وأرقام مفصولة بمسافات.
- اترك الكلمات كما هي دون تغيير.
- استبدل الأرقام بالكلمة في ذلك الموضع، حيث تكون الكلمة الأولى في الموضع 1.

على سبيل المثال، إذا كانت السلسلة `"practice makes perfect and 3 1 2 3"`، فأعد `"practice makes perfect and perfect practice makes perfect"`.

# --hints--

`decompress("practice makes perfect and 3 1 2 3")` يجب أن تُعيد `"practice makes perfect and perfect practice makes perfect"`.
...
`decompress("hello 1 1")` يجب أن تُعيد `"hello hello hello"`.
...
`decompress("the cat sat on 1 mat 4 which 1 2 3")` يجب أن تُعيد `"the cat sat on the mat on which the cat sat"`.
...
`decompress("the more you know 1 2 3 realize 3 don't 4")` يجب أن تُعيد `"the more you know the more you realize you don't know"`.
