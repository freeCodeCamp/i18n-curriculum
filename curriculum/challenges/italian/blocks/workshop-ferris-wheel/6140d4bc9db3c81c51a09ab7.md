...
- Il secondo `.cabin` deve avere la proprietà `right` impostata su `17%` e la proprietà `top` impostata su `93.5%`.
- Il terzo `.cabin` deve avere la proprietà `right` impostata su `67%` e la proprietà `top` impostata su `93.5%`.
- Il quarto `.cabin` deve avere la proprietà `left` impostata su `-8.5%` e la proprietà `top` impostata su `50%`.
- Il quinto `.cabin` deve avere la proprietà `left` impostata su `17%` e la proprietà `top` impostata su `7%`.
- Il sesto `.cabin` deve avere la proprietà `right` impostata su `17%` e la proprietà `top` impostata su `7%`.
