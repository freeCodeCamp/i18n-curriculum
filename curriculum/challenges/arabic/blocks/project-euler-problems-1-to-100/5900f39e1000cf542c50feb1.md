...
title: "المشكلة 50: مجموع الأعداد الأولية المتتالية"
challengeType: 1
forumTopicId: 302161
...
يمكن كتابة العدد الأولي 41 كمجموع ستة أعداد أولية متتالية:

<div style='text-align: center;'>41 = 2 + 3 + 5 + 7 + 11 + 13</div>

هذا هو أطول مجموع لأعداد أولية متتالية يساوي عددًا أوليًا أقل من مئة.

أطول مجموع لأعداد أولية متتالية أقل من ألف يساوي عددًا أوليًا، يحتوي على 21 حدًا، ويساوي 953.

أي عدد أولي أقل من مليون يمكن كتابته كمجموع لأكبر عدد من الأعداد الأولية المتتالية؟

# --hints--

يجب أن تُرجع الدالة `consecutivePrimeSum(1000)` رقمًا.

```js
assert(typeof consecutivePrimeSum(1000) === 'number');
```

يجب أن تُرجع الدالة `consecutivePrimeSum(1000)` القيمة 953.

```js
assert.strictEqual(consecutivePrimeSum(1000), 953);
```

يجب أن تُرجع الدالة `consecutivePrimeSum(1000000)` القيمة 997651.
