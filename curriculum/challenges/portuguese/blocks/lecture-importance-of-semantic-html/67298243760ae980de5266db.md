...
Finalmente, usar os elementos semânticos corretos pode melhorar sua experiência de desenvolvimento. Em vez de ter que vasculhar vários `div`s para encontrar sua barra de navegação, você pode editar diretamente o elemento `nav` e saber exatamente o que está mudando. Ao longo desta seção, você vai aprender mais sobre esses tópicos, como usar elementos semânticos e por que o HTML semântico é tão importante.
...
Ficar pegando detalhes no código.
