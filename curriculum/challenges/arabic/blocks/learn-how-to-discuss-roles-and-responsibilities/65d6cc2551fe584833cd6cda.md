...
`Easygoing` تعني عكس الصرامة؛ تصف شخصًا مسترخيًا ومرنًا.

---

هي مسترخية ولا تغضب بسهولة.
...
كون الشخص `easygoing` يعني أنه لا يغضب أو ينزعج بسهولة.
...
الشخص `easygoing` يوصف بأنه لا يقلق أو يتوتر بسهولة.
