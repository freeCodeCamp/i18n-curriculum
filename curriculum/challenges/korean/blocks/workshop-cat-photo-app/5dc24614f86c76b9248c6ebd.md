...
단락 뒤에 `https://freecatphotoapp.com`에 링크하는 앵커 요소를 추가하세요. 이 시점에서는 미리보기에서 링크가 표시되지 않습니다.

# --hints--

앵커(`a`) 요소에는 여는 태그가 있어야 합니다. 여는 태그의 구문은 다음과 같습니다: `<elementName>`.
...
앵커(`a`) 요소는 `https://freecatphotoapp.com`에 링크해야 합니다. URL을 누락했거나 오타가 있을 수 있습니다.
