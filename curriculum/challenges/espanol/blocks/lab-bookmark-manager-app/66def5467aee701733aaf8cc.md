...
1. Si ninguno de los marcadores en el almacenamiento local tiene la categoría, debe establecer el HTML interno de `#category-list` en un elemento `p` con el texto `No Bookmarks Found`.
...
Al hacer clic en `#view-category-button`, debe agregar un elemento `p` con el texto `No Bookmarks Found` en el HTML interno de `#category-list` si ninguno de los marcadores en el almacenamiento local tiene la categoría seleccionada.
