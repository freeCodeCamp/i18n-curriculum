...
Ora, modifica la board direttamente consultando la cella alla riga e colonna indicate e assegnandole il valore `guess`.

# --hints--

Dovresti assegnare `guess` a `self.board[row][col]`.
