...
建物が離れすぎています。`div` 要素の上に空の `.background-buildings` 要素を2つ、下に2つ、そして `.bb3` と `.bb4` の間に1つ追加して、建物をぎゅっと寄せてください。これらはコンテナ全体に均等に配置され、建物が中央に近づくように動きます。

# --hints--

`div` 要素の前に新しい `.bb1` 要素を2つ追加してください。
