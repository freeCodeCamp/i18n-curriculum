...
`Perhaps` is used to indicate uncertainty or to suggest something without being definite. Por ejemplo:
...
`To make sure` means to ensure that something happens or is done correctly. Por ejemplo:
