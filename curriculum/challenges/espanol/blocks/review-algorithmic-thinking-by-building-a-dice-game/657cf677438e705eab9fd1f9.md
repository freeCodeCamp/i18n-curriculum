...
Si tiras los dados y obtienes una `Three of a kind` o `Four of a kind`, entonces puedes obtener una puntuación que totalice la suma de todos los valores de los cinco dados.  To calculate this, create a `getHighestDuplicates` function which takes an array of numbers. La función necesitará contar cuántas veces se encuentra cada número en el arreglo.
...
Cuando el arreglo tiene tres del mismo número, tu función `getHighestDuplicates` debe actualizar la opción de radio `Three of a Kind` con `, score = ` y la suma total de los dados.
...
Cuando el arreglo tiene tres del mismo número, tu función `getHighestDuplicates` no debería actualizar la opción de radio `Four of a Kind`.
...
Cuando el arreglo tiene cuatro del mismo número, tu función `getHighestDuplicates` también debe actualizar la opción de radio `Three of a Kind` con `, score = ` y la suma total de los dados.
