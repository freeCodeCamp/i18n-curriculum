...
Kwa hatua zilizobaki, utaongeza kitendakazi cha kuonyesha picha za watumizi.

Ndani ya kipengele cha `td` cha pili, ongeza kipengele cha `div` chenye jina la darasa la `"avatar-container"`.

# --hints--

Unapaswa kuwa na kipengele cha `div` ndani ya kipengele cha `td` cha pili.
...
Lebo yako ya kufungua ya `div` inapaswa kuwa na sifa ya kipengele cha darasa lenye thamani ya `"avatar-container"`.
