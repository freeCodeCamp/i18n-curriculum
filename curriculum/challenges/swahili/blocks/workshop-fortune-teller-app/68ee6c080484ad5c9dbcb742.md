...
Sasa utaanza kuunda njia.

Unda njia iitwayo `singleCardSelected`. Ndani yake, fanya wito wa kitendakazi `hideElements` na pitisha vigezo vifuatavyo: `singleCardBtn`, `multipleCardsBtn`, `multipleCard`, `text`, na `headerTitle`.

Kumbuka lazima upate upatikanaji wa vyote kwa kutumia `this.elements`.

# --hints--

Unapaswa kufafanua njia iitwayo `singleCardSelected`.
...
Ndani ya `singleCardSelected`, unapaswa kufanya wito wa kitendakazi `hideElements`.
...
Unapaswa kupitisha `singleCardBtn` kwa kitendakazi `hideElements`.
...
Unapaswa kupitisha `multipleCardsBtn` kwa kitendakazi `hideElements`.
...
Unapaswa kupitisha `multipleCard` kwa kitendakazi `hideElements`.
...
Unapaswa kupitisha `text` kwa kitendakazi `hideElements`.
...
Unapaswa kupitisha `headerTitle` kwa kitendakazi `hideElements`.
