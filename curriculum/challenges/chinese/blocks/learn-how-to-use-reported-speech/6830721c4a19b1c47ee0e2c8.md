...
`To mention` means to say or bring something up, often without going into detail. 例如：

`The deadline was mentioned during the meeting.` – This means the team talked about the deadline during the meeting.

`Easier` means that something takes less effort or is simpler to do compared to something else. 例如：
