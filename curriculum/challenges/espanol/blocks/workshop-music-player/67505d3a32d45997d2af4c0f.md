...
Crea una función llamada `playPreviousSong`. Dentro de su nueva función, use el valor devuelto por la función `getPreviousSong` para encontrar la canción que se va a reproducir. Cuando `getPreviousSong()` sea `undefined`, reproduce la primera canción de la lista de reproducción. De lo contrario, reproduzca la canción anterior a la que se está reproduciendo actualmente.

# --hints--

Deberías tener una función llamada `playPreviousSong`.

```js
assert.isFunction(playPreviousSong);
```

La función `playPreviousSong` debería reproducir la canción anterior a la que se está reproduciendo actualmente en la lista de reproducción.
...
Cuando `getPreviousSong()` sea `undefined`, la función `playPreviousSong` debería reproducir la primera canción de la lista de reproducción.
