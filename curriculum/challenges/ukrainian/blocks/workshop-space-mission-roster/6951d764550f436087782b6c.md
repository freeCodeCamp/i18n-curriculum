...
Ви додали виклик `console.log()` у свій скрипт, щоб перевірити масив `EVAReadySquad`, і тепер цей виклик більше не потрібен. Щоб уникнути захаращення терміналу в наступних кроках, видаліть поточний цикл `for`, який виводить у консоль `EVAReadySquad` астронавтів.

# --hints--

Видаліть цикл `for`, який виводить у консоль `EVAReadySquad` астронавтів. Потрібно видалити весь блок циклу.
