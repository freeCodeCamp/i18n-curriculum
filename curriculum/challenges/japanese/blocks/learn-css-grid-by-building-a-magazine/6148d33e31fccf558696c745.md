...
引用テキストをより目立たせるために、`.quote` セレクターに `font-family` プロパティを設定し、`Raleway` を指定して、フォールバックとして `sans-serif` を設定してください。

# --hints--

`.quote` セレクターに `font-family` プロパティを設定し、`Raleway` を指定して、フォールバックとして `sans-serif` を設定してください。
