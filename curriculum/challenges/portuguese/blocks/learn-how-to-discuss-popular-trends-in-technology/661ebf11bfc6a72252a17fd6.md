...
O verbo `maintain` significa conservar algo em um estado, condição ou posição particular. Por exemplo, se você atualiza e depura seu código regularmente, você mantém sua funcionalidade.
...
Um sinônimo para `keep`, preservar em uma determinada condição.
