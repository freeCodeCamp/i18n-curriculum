...
`if` 文の中で、分割代入を使って `className` と `category` を `allCategories[id]` オブジェクトから取り出してください。

# --hints--

You should destructure `className` and `category` from the `allCategories[id]` object. The properties can be in any order.
