...
Después del DRI `form-group`, añade dos elementos `div` más, cada uno con el `className` de `form-group` dentro de `stats-grid`, uno para DEF y otro para PHY.

Para el de DEF, añade un `label` con un `htmlFor` de `def` y el texto `DEF`, luego un input con un `id` de `def` y un `type` de `number`.

Y para el de PHY, añade una etiqueta con un `htmlFor` de `phy` y el texto `PHY`, luego un input con un `id` de `phy` y un `type` de `number`.

# --hints--

Debes añadir otro conjunto de dos elementos `div`, cada uno con el `className` de `form-group` dentro del `div` de `className` de `stats-grid`.
...
Tu quinto elemento `div` de `className` de `form-group` debería tener un `label` con un atributo `htmlFor` de `def`, un `className` de `label` y el texto `DEF`.
...
Tu quinto elemento `div` de `className` de `form-group` debería tener un `input` con un `className` de `input`, un `id` de `def` y un `type` de `number`.
...
Tu sexto elemento `div` de `className` de `form-group` debería tener un `label` con un atributo `htmlFor` de `phy`, un `className` de `label` y el texto `PHY`.
...
Tu sexto elemento `div` de `className` de `form-group` debería tener un `input` con un `className` de `input`, un `id` de `phy` y un `type` de `number`.
