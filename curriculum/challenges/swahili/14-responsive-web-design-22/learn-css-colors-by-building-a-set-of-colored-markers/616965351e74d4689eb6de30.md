...
You can have multiple `meta` elements on a web page. Kila kipengele cha `meta` huongeza maelezo kuhusu ukurasa ambayo hayawezi kuonyeshwa na vipengele vingine vya HTML.
