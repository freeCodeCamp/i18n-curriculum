...
Ndani ya `card` div, ongeza `div` yenye `className` ya `card-header`. Sehemu hii itahifadhi kiwango cha mchezaji, nafasi, beji ya tier, na jina la klabu.

# --hints--

Unapaswa kuongeza `div` yenye `className` ya `card-header` ndani ya `div` yenye `className` ya `.card`.
