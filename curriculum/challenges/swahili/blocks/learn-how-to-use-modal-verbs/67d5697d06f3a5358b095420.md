...
`have to`, `multi-factor authentication`, `data encryption`, `security protocols`, `can`, `security audits`, na `requirement`.
...
Hizi ni sheria na taratibu zilizoundwa ili kuweka mifumo salama.
...
Kitenzi hiki cha modal kinadhihirisha uwezo — wafanyakazi wana uwezo wa kufanya jambo fulani.
...
Njia hii ya usalama inahitaji hatua nyingi kuthibitisha utambulisho wa mtumizi.
...
Neno hili linamaanisha jambo la lazima ambalo linapaswa kufuatwa.
...
Kipimo hiki cha usalama kinahifadhi taarifa kwa kuifanya isisomeke bila ufunguo.
...
Usemi huu unaonyesha wajibu, maana yake ni lazima kufuatwa.
...
Hizi ni tathmini zinazokagua udhaifu na kuhakikisha kufuata viwango vya usalama.
