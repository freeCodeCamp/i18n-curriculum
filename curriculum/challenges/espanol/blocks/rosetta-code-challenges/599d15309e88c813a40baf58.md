...
`entropy("0")` debería retornar `0`

```js
assert.equal(entropy('0'), 0);
```

`entropy("01")` debería retornar `1`

```js
assert.equal(entropy('01'), 1);
```

`entropy("0123")` debería retornar `2`

```js
assert.equal(entropy('0123'), 2);
```

`entropy("01234567")` debería retornar `3`

```js
assert.equal(entropy('01234567'), 3);
```

`entropy("0123456789abcdef")` debería retornar `4`

```js
assert.equal(entropy('0123456789abcdef'), 4);
```

`entropy("1223334444")` debería retornar `1.8464393446710154`
