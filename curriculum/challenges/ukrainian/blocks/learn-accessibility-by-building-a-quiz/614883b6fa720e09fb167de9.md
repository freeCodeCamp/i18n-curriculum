...
Додайте відступ зверху та зліва елементам `.info`, а інші значення встановіть у `0`.
...
Ви повинні задати `.info` `padding-top` відступ принаймні `1px`.
...
Ви повинні задати `.info` `padding-left` відступ принаймні `1px`.
