...
Drehen Sie innerhalb des ersten Wegpunkts zu `110deg` und behalten Sie die Skalierung des linken Arms bei.

# --hints--

Sie sollten dem `10%`-Wegpunkt eine `transform` von `rotate(110deg) scaleX(-1)` geben.
