...
Al igual que con Flexbox, con CSS Grid puedes alinear el contenido de los elementos de la cuadrícula con `align-items` y `justify-items`. `align-items` alineará los elementos hijos a lo largo del eje de columnas, y `justify-items` alineará los elementos hijos a lo largo del eje de filas.

Dale al selector `.social-icons` una propiedad `align-items` establecida en `center`.

# --hints--

Tu selector `.social-icons` debe tener una propiedad `align-items` establecida en `center`.
