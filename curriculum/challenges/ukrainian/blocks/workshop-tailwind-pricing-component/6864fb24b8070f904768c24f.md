...
Наступна картка з цінами — це **преміум-план**.

Додайте обгортці `div` преміум-плану класи `bg-gray-950`, `text-white`, `ring-2`, `ring-fuchsia-500` і `p-8`.

# --hints--

Ваш обгортковий елемент `div` для преміум-плану має мати клас `bg-gray-950`.
...
Ваш обгортковий елемент `div` для преміум-плану має мати клас `text-white`.
...
Ваш обгортковий елемент `div` для преміум-плану має мати клас `ring-2`.
...
Ваш обгортковий елемент `div` для преміум-плану має мати клас `ring-fuchsia-500`.
...
Ваш обгортковий елемент `div` для преміум-плану має мати клас `p-8`.
