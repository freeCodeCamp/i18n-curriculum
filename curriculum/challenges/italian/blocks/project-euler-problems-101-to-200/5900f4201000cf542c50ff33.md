...
Per ogni intero $n$, considera le tre funzioni
...
Chiamiamo $(x,y,z)$ tripla aurea di ordine $k$ se $x$, $y$ e $z$ sono tutti numeri razionali della forma $\frac{a}{b}$ con $0 < a < b ≤ k$ e esiste (almeno) un intero $n$ tale che $f_n(x,y,z) = 0$.

Sia $s(x,y,z) = x + y + z$.

Sia $t = \frac{u}{v}$ la somma di tutti i distinti $s(x,y,z)$ per tutte le triple auree $(x,y,z)$ di ordine 35. Tutti gli $s(x,y,z)$ e $t$ devono essere in forma ridotta.
