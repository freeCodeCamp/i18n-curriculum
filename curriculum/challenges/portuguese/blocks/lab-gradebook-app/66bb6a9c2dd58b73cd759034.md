...
1. Você deve ter uma função chamada `getGrade` que recebe a pontuação de um aluno como parâmetro e retorna uma string representando uma nota em letra com base na pontuação. Aqui estão as pontuações e suas respectivas notas em letra:Faixa de PontuaçãoNota`100``"A+"``90 - 99``"A"``80 - 89``"B"``70 - 79``"C"``60 - 69``"D"``0 - 59``"F"`
