...
ما الذي يمكنه تغيير السلوك بناءً على المُدخَل أو السياق؟
...
التغليف يتعلق بإخفاء التفاصيل، وليس بتغيير السلوك.
...
يركز التجريد على تقليل التعقيد، وليس على تغييرات السلوك.
...
الوراثة تتعلق بإعادة استخدام الهيكل، وليس بالسلوك الديناميكي.
...
للعثور على الإجابة الصحيحة، ركز على النص حيث يذكر مارك طريقة `changes behavior depending on the input`.

هو يصف تعدد الأشكال، الذي يسمح بسلوك مختلف اعتمادًا على المُدخَل أو السياق.
