...
هذا ترتيب الكلمات لجملة خبرية، وليس سؤالًا.
...
`Is` ليست الصيغة الصحيحة للفعل `to be` مع الفاعل `you`.
...
هذا الخيار يحتوي على كلمات بترتيب مختلط لا يشكل سؤالًا صحيحًا.
