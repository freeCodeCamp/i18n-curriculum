...
In this project, you will build a freeCodeCamp forum leaderboard that displays the latest topics, users, and replies from the [freeCodeCamp forum](https://forum.freecodecamp.org/). Das HTML und CSS wurden dir bereits zur Verfügung gestellt. Probiere sie ruhig aus.
...
You should declare a `forumLatest` variable with `const`.
