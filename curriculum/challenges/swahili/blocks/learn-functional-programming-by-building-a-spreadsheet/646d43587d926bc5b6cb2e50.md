...
Tangaza variable ya `str2`, na weka thamani yake matokeo ya wito wa `infixEval()` ukiwa na `noHigh` na `infix` kama hoja.

# --hints--

Unapaswa kutangaza variable ya `str2`.
...
Unapaswa kutumia `const` kutangaza variable yako ya `str2`.
...
Unapaswa kuweka thamani ya `str2` matokeo ya wito wa `infixEval()`.
...
Unapaswa kupitisha `noHigh` kama hoja ya kwanza kwa `infixEval()`.
...
Unapaswa kupitisha `infix` kama hoja ya pili kwa `infixEval()`.
