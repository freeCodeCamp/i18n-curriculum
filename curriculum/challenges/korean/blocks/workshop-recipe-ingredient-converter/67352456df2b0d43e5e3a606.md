...
`conversionTable`에 `gram` 속성을 추가하고, `cup` 속성이 `1/240`으로 설정된 객체, `ounce` 속성이 `0.0353`로 설정된 객체, `teaspoon` 속성이 `0.2`로 설정된 객체를 할당하세요.

# --hints--

`conversionTable`에는 `gram` 속성이 있어야 합니다.
