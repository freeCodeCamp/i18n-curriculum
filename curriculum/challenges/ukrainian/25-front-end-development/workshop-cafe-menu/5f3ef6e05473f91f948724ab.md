...
Ви можете змінити `font-family` тексту, щоб він відрізнявся від шрифту за замовчуванням. Each browser has some common fonts available to it.
...
Встановіть властивість `font-family` на `sans-serif`.
