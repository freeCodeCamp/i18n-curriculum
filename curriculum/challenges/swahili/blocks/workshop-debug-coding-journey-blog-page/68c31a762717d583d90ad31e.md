...
Katika ukurasa wa blogu, kuna jumla ya machapisho matatu ya blogu yaliyofunikwa ndani ya vipengele vya `div` vya kawaida. Lakini itakuwa bora kutumia vipengele vya maana kufunika chapisho kila moja.

Badilisha kila kipengele cha `div` kinachofunika chapisho kila moja kuwa kipengele cha `article`.

# --hints--

Kipengele chako cha kwanza cha `div` kwa chapisho la kwanza kinapaswa kubadilishwa kuwa kipengele cha `article`.
...
Kipengele chako cha pili cha `div` kwa chapisho la pili kinapaswa kubadilishwa kuwa kipengele cha `article`.
...
Kipengele chako cha tatu cha `div` kwa chapisho la tatu kinapaswa kubadilishwa kuwa kipengele cha `article`.
