...
Agora adicione as propriedades restantes ao objeto privado `elements`. Elas são: `multipleCard`, `title`, `newReadingBtn`, `fortuneContainer`, `fortuneDescription`, `headerTitle`, `subTitle`, `cardTitle`, `description` e `text`. Certifique-se de que cada propriedade use o tipo `HTMLElement`.

# --hints--

Você deve ter a propriedade `multipleCard` dentro da propriedade `elements` atribuída ao tipo `HTMLElement`.
...
Você deve ter a propriedade `title` dentro da propriedade `elements` atribuída ao tipo `HTMLElement`.
...
Você deve ter a propriedade `newReadingBtn` dentro da propriedade `elements` atribuída ao tipo `HTMLElement`.
...
Você deve ter a propriedade `fortuneContainer` dentro da propriedade `elements` atribuída ao tipo `HTMLElement`.
...
Você deve ter a propriedade `fortuneDescription` dentro da propriedade `elements` atribuída ao tipo `HTMLElement`.
...
Você deve ter a propriedade `headerTitle` dentro da propriedade `elements` atribuída ao tipo `HTMLElement`.
...
Você deve ter a propriedade `subTitle` dentro da propriedade `elements` atribuída ao tipo `HTMLElement`.
...
Você deve ter a propriedade `cardTitle` dentro da propriedade `elements` atribuída ao tipo `HTMLElement`.
...
Você deve ter a propriedade `description` dentro da propriedade `elements` atribuída ao tipo `HTMLElement`.
...
Você deve ter a propriedade `text` dentro da propriedade `elements` atribuída ao tipo `HTMLElement`.
