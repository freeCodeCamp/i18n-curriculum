...
`Can't` є скороченою формою `cannot`. It means you are not able to do something or it's not allowed. For example, `I can't swim` means I am unable to swim. It's different from `mustn't` which means you're prohibited do something.
