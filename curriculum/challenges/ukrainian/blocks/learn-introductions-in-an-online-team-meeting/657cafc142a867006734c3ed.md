...
Як довго Джон працює адміністратором бази даних у компанії?
...
Зазначений термін довший за один рік.
...
Зазначений термін довший за два роки.
...
Зазначений термін не такий довгий, як п’ять років.
