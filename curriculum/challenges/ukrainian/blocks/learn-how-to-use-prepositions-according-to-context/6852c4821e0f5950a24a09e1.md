...
Яка основна причина, чому команда маркетингу розміщена з лівого боку будівлі?

## --answers--

Тому що це поруч із головним входом.

### --feedback--

Ця причина була наведена для відділу кадрів, а не для команди маркетингу.

---

Тому що це єдина область із вікнами.

### --feedback--

В е-пошті взагалі не згадуються вікна.

---

Тому що вона ізольована від проходів, що робить її тихішою.

---

Тому що це найближче до серверної кімнати.

### --feedback--

Це стосується ІТ-відділу, а не команди маркетингу.
...
Боб пише, що команда маркетингу розміщена `on the left side of the building`, і що ця область `a bit isolated from the main walkways`. Він пояснює, що це допомагає зробити простір тихішим.

Зосередьте увагу на абзаці для `Marketing team` у огляді макету.
