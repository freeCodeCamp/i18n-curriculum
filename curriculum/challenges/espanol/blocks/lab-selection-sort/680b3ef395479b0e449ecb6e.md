...
Tu `selection_sort` debe seguir el algoritmo de ordenamiento por selección, intercambiando el valor mínimo en la parte no ordenada de la lista con el primer elemento no ordenado.
