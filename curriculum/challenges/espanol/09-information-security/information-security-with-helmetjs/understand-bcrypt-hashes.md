...
Para los siguientes ejercicios, utilizarás un nuevo proyecto que es diferente al anterior. You can find the new starter project to clone on <a href="https://github.com/freeCodeCamp/boilerplate-bcrypt/" target="_blank" rel="noopener noreferrer nofollow">GitHub</a>.
