...
لتحسين تجربة المستخدم، عليك تعزيز رقم الهاتف بحيث ينقر المستخدمون عليه ويبدؤون مكالمة.

إليك كيفية جعل أرقام الهاتف قابلة للنقر:

```html
<a href="tel:2345678912">234-567-8912</a>
```

لف النص `555-555-5555` داخل عنصر وسم الرابط واستخدم `tel:` لجعله رقم هاتف قابل للنقر.

# --hints--

يجب أن تلف النص `555-555-5555` داخل عنصر `a`.
...
يجب تعيين خاصية `href` لعنصر `a` الجديد إلى `tel:5555555555`.
