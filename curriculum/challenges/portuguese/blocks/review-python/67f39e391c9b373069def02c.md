...
- **Declaração de variáveis**: Para declarar uma variável, comece com o nome da variável seguido do operador de atribuição (`=`) e do valor. Isto pode ser um número, string, boolean, etc. Aqui estão alguns exemplos:
