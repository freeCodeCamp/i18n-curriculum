...
**Nota:** Este fallback não é usado para aumentar a compatibilidade do navegador e não funcionará em navegadores IE. Em vez disso, ele é usado quando o navegador não encontra a variável.
