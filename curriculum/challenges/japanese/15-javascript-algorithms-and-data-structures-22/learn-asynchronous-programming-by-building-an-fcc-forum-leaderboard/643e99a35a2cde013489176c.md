...
次に、フォーラムのデータを表示するテーブルを作成します。

分割代入の下に、`return` キーワードと、その後に続けてテンプレートリテラルを追加してください。 テンプレートリテラルの中には、テーブル行となる `tr` 要素を 1 つ追加してください。

# --hints--

You should return a set of template literals.
