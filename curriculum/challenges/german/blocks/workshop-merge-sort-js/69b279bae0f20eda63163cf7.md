...
Bleiben Sie weiterhin im `else`-Block und erhöhen Sie `rightArrayIndex` um `1`.

# --hints--

Sie sollten `rightArrayIndex` erhöhen, nachdem Sie das Element in das sortierte Array eingefügt haben.
