...
Uma vez que você obtenha o conteúdo editado, esse será agora o conteúdo atual.

Dentro do event listener, atribua `newContent` a `currentContent`. 

# --hints--

Você deve atribuir `newContent` a `currentContent` dentro do event listener.
