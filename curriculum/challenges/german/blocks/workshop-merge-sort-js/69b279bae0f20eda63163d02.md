...
Rufen Sie nach dem Ausgeben des unsortierten Arrays die `mergeSort`-Funktion auf und übergeben Sie das `numbers`-Array als Argument.

# --hints--

Sie sollten `mergeSort(numbers)` nach dem Ausgeben des unsortierten Arrays aufrufen.
