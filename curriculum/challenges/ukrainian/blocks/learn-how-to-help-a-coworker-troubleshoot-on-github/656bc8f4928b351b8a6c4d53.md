...
`Attach` означає додати щось додаткове до чогось іншого.

`Error messages` — це нотатки, які повідомляють, що пішло не так у комп’ютерному коді. Приєднання їх до проблеми допомагає іншим краще зрозуміти проблему.
...
### --feedback--
Означає додати щось додаткове до чогось іншого.
...
Додавання `error` повідомлень до проблеми дає більше інформації про те, що працює неправильно.
