...
Per completare la preparazione per la tua missione spaziale, chiama `printCrewSummary()` con il tuo array `updatedSquad`!

# --hints--

Dovresti chiamare la tua funzione `printCrewSummary()` con `updatedSquad`.
