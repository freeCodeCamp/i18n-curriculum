...
Find the $100\,000\,000$th squarefree fibonacci number. Da como respuesta una cadena con sus últimos dieciséis dígitos seguidos por una coma seguida del número en notación científica (redondeado a un decimal). Para el número libre de cuadrados $200$th, la respuesta habría sido: `1608739584170445,9.7e53`
...
Si resulta que la conjetura es falsa, entonces la respuesta aceptada a este problema no está garantizada como el $100\,000\,000$-ésimo número de Fibonacci libre de cuadrados, sino que representa solo un límite inferior para ese número.
