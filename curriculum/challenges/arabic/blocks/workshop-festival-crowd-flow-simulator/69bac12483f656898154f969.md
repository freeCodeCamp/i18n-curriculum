...
استخدم حلقة `for...in` للتكرار خلال كل بوابة في كائن `summary` المُدخَل وسجل إجمالي الحضور المعالج.

لكل بوابة، سجل رسالة بهذا التنسيق: `gate + ": " + summary[gate] + " attendees processed"`.

كمثال، لكائن `summary` المُدخَل المعرف كـ `{ North: 5, East: 3, South: 4, West: 2 }`، يجب أن تسجل:
...
يجب أن تتكرر خلال كل عنصر في كائن `summary` وتسجل الرسالة التالية مرة واحدة لكل عنصر: `element + ": " + summary[element] + " attendees processed`.
