...
En este caso, resolvimos este ejemplo usando una pila. Alternativamente, la búsqueda en profundidad (DFS) puede implementarse usando recursión, donde la función procesa el nodo actual y luego se llama a sí misma para cada uno de sus vecinos no visitados. La pila de llamadas de función gestiona implícitamente el orden LIFO (último en entrar, primero en salir).
