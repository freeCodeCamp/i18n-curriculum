...
更新 `healthText.innerText` 和 `monsterHealthText.innerText` 以相等於 `health` 和 `monsterHealth`。
...
你應該將 `healthText.innerText` 設定為 `health`。
...
你應該將 `monsterHealthText.innerText` 設定為 `monsterHealth`。
