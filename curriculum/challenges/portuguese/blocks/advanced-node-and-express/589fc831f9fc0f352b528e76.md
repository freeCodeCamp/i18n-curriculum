...
**Nota:** Assim como `'disconnect'`, todos os outros eventos que um socket pode emitir para o servidor devem ser tratados dentro do listener de conexão onde temos o 'socket' definido.

Envie sua página quando você achar que ela está certa.Se você estiver enfrentando erros, pode <a href="https://forum.freecodecamp.org/t/advanced-node-and-express/567135#handle-a-disconnect-8" target="_blank" rel="noopener noreferrer nofollow">verificar o projeto concluído até este ponto</a>.
