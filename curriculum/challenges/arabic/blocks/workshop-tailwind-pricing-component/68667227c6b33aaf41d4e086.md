...
لوضع العناصر في البطاقة، تحتاج إلى استخدام أصناف الشبكة مرة أخرى. عيّن أصناف الأدوات `grid`، و`grid-rows-[1fr_auto]`، و`gap-6` على عنصر التغليف `div`.

أيضًا، أزل الحواف الحادة باستخدام الصنف `rounded-xl`.

# --hints--

يجب أن يحتوي عنصر التغليف `div` الخاص بالخطة المميزة على الصنف `grid`.
...
يجب أن يحتوي عنصر التغليف `div` الخاص بالخطة المميزة على الصنف `grid-rows-[1fr_auto]`.
...
يجب أن يحتوي عنصر التغليف `div` الخاص بالخطة المميزة على الصنف `gap-6`.
...
يجب أن يحتوي عنصر التغليف `div` الخاص بالخطة المميزة على الصنف `rounded-xl`.
