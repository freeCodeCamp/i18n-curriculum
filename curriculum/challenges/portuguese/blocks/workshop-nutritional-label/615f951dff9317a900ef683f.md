...
Dê ao seletor `.note` um preenchimento à esquerda e à direita de `8px`, removendo o preenchimento inferior e superior.Também defina a propriedade `text-indent` como `-8px`.

Com estas últimas mudanças, o rótulo nutricional está completo!

# --hints--

O seletor `.note` deve ter a propriedade `padding` definida como `0 8px`.
...
O seletor `.note` deve ter a propriedade `text-indent` definida como `-8px`.
