...
title: Deviazione standard cumulativa
challengeType: 1
forumTopicId: 302240
...
Supponiamo che l'intera popolazione di interesse sia composta da otto studenti di una determinata classe. Per un insieme finito di numeri, la deviazione standard della popolazione si calcola prendendo la radice quadrata della media delle deviazioni al quadrato dei valori sottratti dalla loro media. I voti di una classe di otto studenti (cioè una popolazione statistica) sono i seguenti otto valori:

$2, 4, 4, 4, 5, 5, 7, 9$

Questi otto dati hanno una media (average) di 5:

$$\mu ={\frac {2+4+4+4+5+5+7+9}{8}}={\frac {40}{8}}=5$$

Per prima cosa, calcola le deviazioni di ogni dato dalla media e poi eleva al quadrato ciascun risultato:

| Deviazioni di ogni dato |  Eleva al quadrato il risultato  |
| ----------------------- | ------------------------------- |
...
e la deviazione standard della popolazione è uguale alla radice quadrata della varianza:

$$\sigma ={\sqrt {4}}=2$$

Scrivi una funzione che prenda un array di numeri come parametro e restituisca la <a href="https://rosettacode.org/wiki/Standard_deviation" target="_blank" rel="noopener noreferrer nofollow">deviazione standard</a> della serie.
