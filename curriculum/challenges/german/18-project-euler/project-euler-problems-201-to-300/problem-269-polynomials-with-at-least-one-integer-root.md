...
title: 'Probleme 269: Polynome mit mindestens einer Integer-Wurzel'
challengeType: 1
forumTopicId: 301918
...
Definiere $Z(k)$ als die Anzahl der positiven Integer $n$, die nicht größer als $k$ sind und für die das Polynom $P_n$ mindestens eine ganzzahlige Wurzel hat.
