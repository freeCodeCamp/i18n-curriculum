...
الآن ستبدأ بإنشاء الطرق.

أنشئ طريقة تسمى `singleCardSelected`. داخلها، استدعِ الدالة `hideElements` ومرر الخصائص التالية: `singleCardBtn`، `multipleCardsBtn`، `multipleCard`، `text`، و`headerTitle`.

تذكر أنه يجب عليك الوصول إلى جميعها باستخدام `this.elements`.

# --hints--

يجب أن تعرف طريقة باسم `singleCardSelected`.
...
داخل `singleCardSelected`، يجب أن تستدعي الدالة `hideElements`.
...
يجب أن تمرر `singleCardBtn` إلى الدالة `hideElements`.
...
يجب أن تمرر `multipleCardsBtn` إلى الدالة `hideElements`.
...
يجب أن تمرر `multipleCard` إلى الدالة `hideElements`.
...
يجب أن تمرر `text` إلى الدالة `hideElements`.
...
يجب أن تمرر `headerTitle` إلى الدالة `hideElements`.
