...
`infixToFunction[operator]` gibt eine Funktion zurück. Rufe diese Funktion direkt auf und übergib `arg1` und `arg2` als Argumente.

# --hints--

Deine Callback-Funktion sollte das Resultat des Aufrufs von `infixToFunction[operator]` zurückgeben.
...
Du solltest `arg1` als erstes Argument an deinen `infixToFunction[operator]`-Aufruf übergeben.
...
Du solltest `arg2` als zweites Argument an deinen `infixToFunction[operator]`-Aufruf überweisen.
