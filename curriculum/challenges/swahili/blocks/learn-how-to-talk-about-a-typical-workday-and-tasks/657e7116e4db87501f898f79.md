...
Katika zoezi hili, makini na mabadiliko ya kitenzi katika mtu wa tatu wingi unapotaja ratiba ya mtu mwingine.

Kumbuka: `head to` ina maana ya kwenda au kusogea kuelekea mahali.

# --instructions--

Sikiliza sauti ili kuelewa muktadha. Andika aina sahihi za vitenzi ili ukamilishe sentensi kuhusu ratiba ya asubuhi ya Sarah, ukizingatia mabadiliko ya kitenzi kwa mtu wa tatu wingi.
...
Hii ni aina ya kitenzi `wake`, kinachotumika na `he`, `she`, au `it`.
...
Hii ni aina ya kitenzi `get`, kinachotumika na `he`, `she`, au `it`.
...
Hii ni aina ya kitenzi `have`, kinachotumika na `he`, `she`, au `it`.
...
Hii ni aina ya kitenzi `head`, kinachotumika na `he`, `she`, au `it`.
