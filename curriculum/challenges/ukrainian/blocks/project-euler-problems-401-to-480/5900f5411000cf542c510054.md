...
Ціле число називається B-гладким, якщо жоден із його простих множників не більший за $B$.

Нехай $SB(n)$ — найбільший B-гладкий дільник числа $n$.
...
`smoothDivisorsOfBinomialCoefficients()` має повертати `852950321`.
