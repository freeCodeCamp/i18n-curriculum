...
La sequenza aritmetica 1487, 4817, 8147, in cui ciascun termine aumenta di 3330, è insolita per due motivi: (i) ciascuno dei tre termini è un numero primo, e (ii) ciascuno dei numeri di 4 cifre è una permutazione degli altri.

Non esistono sequenze aritmetiche composte da tre numeri primi di 1, 2 o 3 cifre che mostrino questa proprietà, ma esiste un'altra sequenza crescente di 4 cifre.

Quale numero di 12 cifre ottieni concatenando i tre termini di questa sequenza?
