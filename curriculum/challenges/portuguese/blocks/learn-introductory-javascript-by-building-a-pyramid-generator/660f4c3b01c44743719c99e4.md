...
Como você está subtraindo apenas um de `i`, você pode usar o <dfn>operador de decremento</dfn> `--`.

Substitua sua atribuição de subtração pelo operador de decremento.

# --hints--

Seu loop `for` não deve usar atribuição de subtração.
...
Seu loop `for` deve usar o operador de decremento.
