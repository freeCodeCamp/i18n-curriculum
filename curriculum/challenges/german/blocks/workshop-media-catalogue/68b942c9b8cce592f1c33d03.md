...
Vervollständigen Sie jetzt die `TVSeries`-Klasse, indem Sie die Docstring `Child class representing an entire TV series.` hinzufügen.

# --hints--

Sie sollten die Docstring `Child class representing an entire TV series.` zu Ihrer `TVSeries`-Klasse hinzufügen.
