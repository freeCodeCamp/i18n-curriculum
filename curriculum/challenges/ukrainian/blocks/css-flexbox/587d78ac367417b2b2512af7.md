...
title: Використання властивості justify-content у вставці твіта
challengeType: 0
...
Останнє завдання показало приклад властивості `justify-content`. Для вставки твіта цю властивість можна застосувати, щоб вирівняти елементи в `.profile-name` елементі.

# --instructions--

Додайте CSS-властивість `justify-content` до `.profile-name` елемента заголовка і встановіть значення на будь-який із варіантів із останнього завдання.

# --hints--

Ваш `.follow-btn` має відтворюватися на сторінці. Обов’язково вимкніть будь-які розширення, як-от блокувальники реклами.
...
`.profile-name` елемент має мати властивість `justify-content`, встановлену на будь-яке з цих значень: `center`, `flex-start`, `flex-end`, `space-between`, `space-around` або `space-evenly`.
