...
`sum_array([1, 2, 3, 4, 5])` має повертати `15`.
...
`sum_array([5, -2, 7, -3])` має повертати `7`.
...
`sum_array([203, 145, -129, 6293, 523, -919, 845, 2434])` має повертати `9395`.
