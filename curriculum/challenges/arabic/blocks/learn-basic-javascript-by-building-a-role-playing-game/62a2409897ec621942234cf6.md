...
أعطِ عنصر `#text` خاصية `background-color` بقيمة `#0a0a23`، و`color` بقيمة `#ffffff`، و`10px` من الحشو على جميع الجوانب.

# --hints--

يجب أن يكون لديك محدِّد `#text`.
...
يجب أن يحتوي عنصر `#text` على خاصية `background-color` بقيمة `#0a0a23`.
...
يجب أن يحتوي عنصر `#text` على خاصية `color` بقيمة `#ffffff`.
...
يجب أن يحتوي عنصر `#text` على `10px` من الحشو على جميع الجوانب.
