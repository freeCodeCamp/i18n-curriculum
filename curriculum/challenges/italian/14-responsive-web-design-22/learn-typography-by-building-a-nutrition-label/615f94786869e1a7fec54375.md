...
Crea un selettore `.note` e imposta la dimensione del font a `0.6rem`. Imposta anche i margini superiore e inferiore a `5px`, rimuovendo i margini destro e sinistro.
