...
Finalmente, faça a saída final uma string multilinha. Deve começar com um caractere de nova linha e terminar com um caractere de nova linha.
...
O método deve retornar a string correta.
