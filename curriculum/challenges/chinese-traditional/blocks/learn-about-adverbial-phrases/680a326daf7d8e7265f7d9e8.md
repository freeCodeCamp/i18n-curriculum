...
`To start small` means to begin with a simple, limited, or smaller version of something before expanding or scaling up. It's often used to reduce risk and learn from early steps. 例如：
