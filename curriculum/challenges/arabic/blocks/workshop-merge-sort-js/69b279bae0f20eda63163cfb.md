...
لا تزال داخل حلقة `while`، زد قيمة `leftArrayIndex` بمقدار 1.

# --hints--

يجب زيادة القيمة الحالية لـ `leftArrayIndex` بمقدار `1` بعد تعيين عنصر الجزء الأيسر في المصفوفة المرتبة.
