...
El proceso de crear carpetas es exactamente el mismo.  Click the "New" button at the top right and then select the "Folder" option or right-click on an empty spot and go to "New." Then, select the "Folder" option. Verás una nueva carpeta vacía en tu ubicación actual.
