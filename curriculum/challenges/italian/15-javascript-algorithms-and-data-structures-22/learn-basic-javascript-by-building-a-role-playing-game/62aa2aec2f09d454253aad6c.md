...
Dato che hai sottratto vita dal giocatore, devi verificare se il suo valore di `health` è minore o uguale a `0`. Se lo è, chiama la funzione `lose`.
...
L'istruzione `if` dovrebbe verificare se la `health` del giocatore è minore o uguale a `0`.
