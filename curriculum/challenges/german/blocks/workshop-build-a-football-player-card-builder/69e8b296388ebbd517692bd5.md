...
Fügen Sie nach dem DRI `form-group` zwei weitere `div`-Elemente hinzu, jeweils mit dem `className` von `form-group` innerhalb von `stats-grid`, eines für DEF und das andere für PHY.

Für das von DEF fügen Sie ein `label` mit einem `htmlFor` von `def` und dem Text `DEF` hinzu, dann eine Eingabe mit einem `id` von `def` und einem `type` von `number`.

Und für das von PHY fügen Sie eine Bezeichnung mit einem `htmlFor` von `phy` und dem Text `PHY` hinzu, dann eine Eingabe mit einem `id` von `phy` und einem `type` von `number`.

# --hints--

Sie sollten ein weiteres Paar von zwei `div`-Elementen hinzufügen, jeweils mit dem `className` von `form-group` innerhalb des `div` von `className` von `stats-grid`.
...
Ihr fünftes `div`-Element mit dem `className` von `form-group` sollte ein `label` mit einem `htmlFor`-Attribut von `def`, einem `className` von `label` und einem Text `DEF` haben.
...
Ihr fünftes `div`-Element mit dem `className` von `form-group` sollte ein `input` mit einem `className` von `input`, einem `id` von `def` und einem `type` von `number` haben.
...
Ihr sechstes `div`-Element mit dem `className` von `form-group` sollte ein `label` mit einem `htmlFor`-Attribut von `phy`, einem `className` von `label` und einem Text `PHY` haben.
...
Ihr sechstes `div`-Element mit dem `className` von `form-group` sollte ein `input` mit einem `className` von `input`, einem `id` von `phy` und einem `type` von `number` haben.
