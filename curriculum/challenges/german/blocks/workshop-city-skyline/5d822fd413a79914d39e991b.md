...
Geben Sie `.fb2a` eine `width` von `100%` und `.fb2b` eine `width` von `100%` und `height` von `75%`.

# --hints--

Sie sollten `.fb2a` eine `width` von `100%` geben.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle(".fb2a")?.width, "100%");
```

Sie sollten `.fb2b` eine `width` von `100%` geben.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle(".fb2b")?.width, "100%");
```

Sie sollten `.fb2b` eine `height` von `75%` geben.
