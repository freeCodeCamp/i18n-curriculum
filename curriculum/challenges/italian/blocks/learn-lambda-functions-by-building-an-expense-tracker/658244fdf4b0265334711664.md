...
Infine, restituisci il risultato della chiamata `filter()`.

# --hints--

Dovresti restituire il risultato della chiamata `filter()` dalla tua funzione `filter_expenses_by_category`.
