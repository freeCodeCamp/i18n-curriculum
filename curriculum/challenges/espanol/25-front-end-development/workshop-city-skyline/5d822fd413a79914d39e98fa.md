...
Cree una nueva variable en `:root` llamada `window-color2` con un valor de `#8cd9b3`. Esto será utilizado como el color secundario para este edificio.
...
Debe dar a `window-color2` un valor de `#8cd9b3`.
