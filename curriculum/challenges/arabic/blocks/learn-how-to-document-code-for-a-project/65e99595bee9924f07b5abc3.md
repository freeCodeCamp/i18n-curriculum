...
ماذا يقترح بريان بشأن كتابة رسائل الالتزام؟

## --answers--

اطلب دائمًا الموافقة قبل تنفيذ الالتزامات.

### --feedback--

نصيحة بريان تتعلق بكيفية كتابة رسائل الالتزام، وليست حول طلب الموافقة على التغييرات.

---

استخدم رسائل وصفية تبدأ بفعل في صيغة الأمر، يتبعها وصف موجز للتغييرات.

---

اكتب تقريرًا طويلًا ومفصلًا لكل تغيير.

### --feedback--

يوصي بريان بوصف موجز، وليس تقريرًا طويلًا ومفصلًا، لرسائل الالتزام.

---

تجنب استخدام الأفعال في رسائل الالتزام.

### --feedback--

في الواقع، يقترح بريان بدء رسائل الالتزام بفعل في صيغة الأمر.
