      ...
      <table style="border:none; border-collapse:collapse;">
        <tr>
          ...
          <td style="border:none">
            <table>
              <tr>
<th style="padding: 4px; margin: 5px;">年齢</th>
                <th style="padding: 4px; margin: 5px;">名前</th>
              </tr>
              <tr>
...
<td style="padding: 4px; margin: 5px;">Alan</td>
          ...
          <td style="border:none">
            <table>
              <tr>
<th style="padding: 4px; margin: 5px;">キャラクター</th>
                <th style="padding: 4px; margin: 5px;">宿敵</th>
              </tr>
              <tr>
<td style="padding: 4px; margin: 5px;">Jonah</td>
