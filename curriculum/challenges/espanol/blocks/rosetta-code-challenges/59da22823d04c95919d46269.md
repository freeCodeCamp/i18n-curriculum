...
Por la mañana (después de la acción subrepticia y separada de cada uno de los cinco marineros durante la noche), los cocos restantes se dividen en cinco pilas iguales para cada uno de los marineros, y se encuentra que la pila de cocos se divide igualmente entre los marineros sin ningún resto. (Nada para el mono en la mañana.)

# --instructions--

Crea una función que devuelva el tamaño mínimo posible del montón inicial de cocos recolectados durante el día para `N` marineros. **Nota:** Por supuesto, el cuento se narra en un mundo donde la recolección de cualquier cantidad de cocos en un día y múltiples divisiones del montón, etc., pueden ocurrir en un tiempo que encaje con la línea argumental, para no afectar las matemáticas.
