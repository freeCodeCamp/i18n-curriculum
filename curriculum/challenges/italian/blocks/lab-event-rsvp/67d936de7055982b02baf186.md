...
title: Costruisci un modulo RSVP per un evento
challengeType: 25
...
1. Devi creare un modulo con campi per nome, email, numero di partecipanti, preferenze alimentari e un’opzione per indicare se porterai ospiti aggiuntivi.

2. Devi avere un campo di input testuale dove inserire il tuo nome (obbligatorio).

3. Devi avere un campo di input email dove inserire il tuo indirizzo email (obbligatorio). Il modulo deve validare il formato per assicurarsi che sia una email corretta.

4. Devi avere un campo di input numerico dove inserire il numero di partecipanti nel modulo (obbligatorio), e il numero non deve essere inferiore a uno.

5. Devi avere un campo di input testuale dove inserire le tue preferenze alimentari, e questa informazione è opzionale.

6. Devi poter selezionare o deselezionare una casella di spunta per indicare se porterai ospiti aggiuntivi.

7. Devi avere un pulsante che invia il modulo, e il modulo non deve causare il ricaricamento della pagina al momento dell’invio.

8. Dopo l’invio, devi vedere un messaggio di conferma mostrato sotto il modulo, seguito dai dettagli forniti (nome, email, numero di partecipanti, preferenze alimentari e ospiti aggiuntivi opzionali).

Ecco un esempio di messaggio dopo l’invio del modulo:
...
Devi avere un solo elemento `form` che contenga tutto il contenuto del modulo.
...
Devi avere due elementi `input` di tipo `text`.
...
Devi avere un elemento `input` di tipo `email`.
...
Devi avere un elemento `input` di tipo `number`.
...
Devi avere un elemento `input` di tipo `checkbox`.
...
Un elemento `input[type="text"]` deve essere obbligatorio.
...
L’elemento `input[type="email"]` deve essere obbligatorio.
...
L’elemento `input[type="number"]` deve essere obbligatorio.
...
L’elemento `input[type="number"]` non deve accettare valori inferiori a 1.
...
Modificare il valore degli elementi `input[type="text"]` deve aggiornare lo stato del componente.
...
Modificare il valore degli elementi `input[type="email"]` deve aggiornare lo stato del componente.
...
Modificare il valore degli elementi `input[type="number"]` deve aggiornare lo stato del componente.
...
Modificare il valore degli elementi `input[type="checkbox"]` deve aggiornare lo stato del componente.
...
L’invio del modulo non deve causare il ricaricamento della pagina.
...
Dopo l’invio, deve esserci un elemento nella pagina che indica lo stato del nome `input`.
...
Dopo l’invio, deve esserci un elemento nella pagina che indica lo stato dell’email `input`.
...
Dopo l’invio, deve esserci un elemento nella pagina che indica lo stato del numero di partecipanti `input`.
...
Dopo l’invio, deve esserci un elemento nella pagina che indica lo stato delle preferenze alimentari `input`.
...
Dopo l’invio, deve esserci un elemento nella pagina che indica lo stato degli ospiti aggiuntivi `input`.
