...
Sasa zungusha sehemu ya `PlayerCard` ndani ya kipengele cha `main` cha `className` cha `main`.

Ndani ya kipengele cha `main`, ongeza `div` ya `className` ya `layout`. Ndani ya `layout`, ongeza vipengele viwili tofauti vya `div` vya `className` vya `form-panel` na `preview-panel` mtawalia.

# --hints--

Sehemu yako ya `FootballPlayerCard` inapaswa kuonyesha kipengele cha `main` chenye `className` ya `main` ndani ya `div.page`.
...
Sehemu yako ya `main.main` inapaswa kuwa na `div` yenye `className` ya `layout`.
...
Sehemu yako ya `layout` inapaswa kuwa na `div` yenye `className` ya `form-panel`.
...
Sehemu yako ya `layout` inapaswa kuwa na `div` yenye `className` ya `preview-panel`.
