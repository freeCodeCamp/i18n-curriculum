...
Sul tema dell'accessibilità visiva, il contrasto tra gli elementi è un fattore chiave. Per esempio, il contrasto tra il testo e lo sfondo di un'intestazione dovrebbe essere almeno 4,5:1.

Cambia il colore del carattere di tutti gli elementi àncora all'interno degli elementi lista in modo che abbiano un rapporto di contrasto di almeno 7:1.

# --hints--

Il tuo selettore dovrebbe prendere di mira i collegamenti all'interno degli elementi lista.
...
Dovresti dare agli elementi `a` all'interno degli elementi lista una proprietà `color`.
...
Dovresti cambiare solo il colore degli elementi `a` all'interno degli elementi lista.
