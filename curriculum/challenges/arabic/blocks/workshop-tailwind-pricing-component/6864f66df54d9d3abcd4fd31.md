...
لـ `span` داخل عنصر `p` الذي يحتوي على النص `/month`، أضف له الأصناف `text-base` و`font-medium` و`text-gray-500`. هذا سيميزه عن السعر نفسه بجعل النص أخف.

# --hints--

يجب أن يحتوي عنصر `span` على الصنف `text-base`.
...
يجب أن يحتوي عنصر `span` على الصنف `font-medium`.
...
يجب أن يحتوي عنصر `span` على الصنف `text-gray-500`.
