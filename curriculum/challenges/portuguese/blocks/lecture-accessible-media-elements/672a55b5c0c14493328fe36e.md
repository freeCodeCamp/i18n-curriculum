...
Apenas imagens que transmitam informações importantes devem ter texto `alt`. Se uma imagem for usada apenas para fins decorativos, ela deve ter texto `null` `alt` (vazio), para que possa ser ignorada por leitores de tela e outras tecnologias assistivas.
