...
移动到 **Listener 计划** 内的 `h2`，为它添加实用类 `text-lg` 以使其更大，`font-semibold` 以使其更粗，以及 `text-indigo-600` 以赋予其漂亮的靛蓝色。

# --hints--

你的 `h2` 元素应具有 `text-lg` 类。
