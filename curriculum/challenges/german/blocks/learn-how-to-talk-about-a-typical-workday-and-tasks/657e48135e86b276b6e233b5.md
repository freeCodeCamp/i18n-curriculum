...
`Access control` bezieht sich auf die Praxis der Einschränkung und Verwaltung des Zugangs zu einem Ort oder einer Ressource. For example, `Access control systems are used to secure the building`.
