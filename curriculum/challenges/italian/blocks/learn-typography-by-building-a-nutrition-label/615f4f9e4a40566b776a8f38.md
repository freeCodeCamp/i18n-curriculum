...
Crea un nuovo selettore `.large` e dagli una proprietà `height` impostata su `10px`. Crea anche un selettore `.large, .medium` e imposta la proprietà `background-color` su `black`.
...
Il tuo selettore `.large` dovrebbe avere una proprietà `height` impostata su `10px`.
...
Il tuo selettore `.large, .medium` dovrebbe avere una proprietà `background-color` impostata su `black`.
