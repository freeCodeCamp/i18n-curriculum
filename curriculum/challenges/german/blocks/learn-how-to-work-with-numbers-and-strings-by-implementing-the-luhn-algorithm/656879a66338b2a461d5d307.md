...
Der Luhn Algorithmus lautet wie folgt:
...
Du solltest `sum_of_odd_digits = 0` innerhalb der `verify_card_number`-Funktion haben.
...
Du solltest nicht `pass` innerhalb der `verify_card_number`-Funktion haben.
