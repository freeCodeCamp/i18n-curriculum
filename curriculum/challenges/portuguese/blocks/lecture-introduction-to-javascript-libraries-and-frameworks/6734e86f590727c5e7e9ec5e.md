...
Diferente do JavaScript tradicional, que exige manipulação direta do DOM (Document Object Model), o React usa um DOM virtual, que melhora o desempenho e a eficiência. Você vai aprender mais sobre o DOM virtual e como ele funciona nas próximas lições.
...
Pense na posição do React dentro da indústria.
