...
Alla fine del tuo metodo `map`, concatena il metodo `join()`. Per il separatore, passa una stringa vuota.

# --hints--

Dovresti concatenare il metodo `join` al metodo `map` e usare una stringa vuota come separatore.
