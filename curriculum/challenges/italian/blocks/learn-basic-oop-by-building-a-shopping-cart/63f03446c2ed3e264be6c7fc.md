...
Inizia invertendo il valore di `isCartShowing`. Ricorda che puoi usare l'operatore logico not `!` per invertire il valore di un booleano. Assegna il valore invertito a `isCartShowing`.
