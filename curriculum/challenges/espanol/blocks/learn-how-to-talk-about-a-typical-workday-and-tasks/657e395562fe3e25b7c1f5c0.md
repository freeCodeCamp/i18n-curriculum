...
`Danger` es una situación cuando algo malo puede suceder o donde pones tu vida en riesgo. You can say that in situations like these, you are `in danger`. For example:
