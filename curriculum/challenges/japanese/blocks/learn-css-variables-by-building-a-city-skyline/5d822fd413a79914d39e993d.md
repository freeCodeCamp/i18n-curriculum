...
メディアクエリの先頭に`:root`セレクターを追加してください。それから、4つの`--building-color`変数すべてをそこで`#000`の値を使うように再定義してください。

# --hints--

メディアクエリに`:root`セレクターを追加してください。
...
`--building-color1`の値で`#000`を追加してください。
...
`--building-color2`の値で`#000`を追加してください。
...
`--building-color3`の値で`#000`を追加してください。
...
`--building-color4`の値で`#000`を追加してください。
