...
Елемент `figure` представляє автономний вміст і дозволить вам додати зображення з підписом.
...
Останній елемент `img` для лазаньї має бути вкладений у елемент `figure`.
