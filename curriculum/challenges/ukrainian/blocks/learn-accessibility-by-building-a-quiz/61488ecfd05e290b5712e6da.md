...
Щоб зробити перший розділ більш рядковим, націльтеся лише на `input` елементи всередині `.info` елементів і встановіть їхній `width` у `50%`, а також вирівняйте їхній текст по лівому краю.

# --hints--

Ви повинні використати або селектор `.info input`, або `.info > input`.
...
Ви повинні надати `input` елементам `width` зі значенням `50%`.
...
Ви повинні надати `input` елементам `text-align` зі значенням `left`.
