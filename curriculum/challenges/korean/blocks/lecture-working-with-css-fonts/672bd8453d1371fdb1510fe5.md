...
미리보기 텍스트 크기는 미리보기 텍스트 입력란 옆에 있는 파란색 슬라이더로 조절할 수 있습니다.
...
프로젝트에 폰트를 추가할 준비가 되면 상단의 파란색 "Get font" 버튼을 클릭하세요. 현재 선택한 폰트가 요약 페이지에 표시됩니다. 여러 폰트를 동시에 선택할 수 있습니다.
...
`@import` 옵션을 선택하면 해당 규칙을 CSS 파일에 추가해야 합니다.
...
또 다른 훌륭한 옵션은 Font Squirrel입니다. 여기서 원하는 맞춤 폰트를 찾아 다운로드할 수 있습니다.
...
폰트를 검색하고 결과를 클릭하면 폰트에 대한 자세한 정보, 샘플, 테스트 드라이브, 글리프, Webfont 키트를 볼 수 있습니다.
...
얇은, 라이트, 미디엄, 굵게, 블랙 같은 다양한 스타일과 변형 샘플도 확인할 수 있습니다.
...
"Download @font-face Kit" 버튼을 클릭하면 압축(zip) 파일이 다운로드됩니다. 압축을 풀면 "web fonts" 폴더, 텍스트 파일 형태의 라이선스, 웹 폰트 사용법이 담긴 HTML 파일이 있습니다.
...
web fonts 폴더에는 프로젝트에 필요한 모든 폰트 파일이 들어 있습니다. 서로 다른 폰트 스타일별로 특정 폴더에 그룹화되어 있습니다.
