...
In this lab, you'll build an app that will search for Pokémon by name or ID and display the results to the user. 要搜索寶可夢的數據和圖像，你將使用 freeCodeCamp 的 <a href="https://pokeapi-proxy.freecodecamp.rocks/" target="_blank" rel="noopener noreferrer nofollow">PokeAPI Proxy</a>。
