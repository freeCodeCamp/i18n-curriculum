...
Quincy Larson 对 Python 有什么看法？

## --answers--

Python 也是一种很好的语言，但 JavaScript 更有用。
...
Quincy 提到 Python 很好，但他认为从长远来看 JavaScript 更有用。
...
Quincy 描述 Python 是一种好语言，只是从长期使用来看不如 JavaScript 有用。
...
Quincy 没有提到 Python 社区的规模。他关注的是更大的 JavaScript 社区和资源。
...
寻找显示 Quincy 对 Python 视图的关键字。  

`Also a good language` – 这表明 Quincy 认为 Python 是一个好的选项。  

`More useful in the long run` – 这告诉你他仍然更喜欢 JavaScript 而不是 Python 作为初学者的选择。  

`Large community and many resources`——这解释了他为什么认为 JavaScript 是更好的首选。  
