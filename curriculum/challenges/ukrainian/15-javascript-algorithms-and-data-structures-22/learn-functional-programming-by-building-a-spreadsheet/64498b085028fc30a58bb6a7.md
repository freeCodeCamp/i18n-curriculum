...
Оголосіть функцію `elemValue`, яка приймає параметр `num`. Функція має бути порожньою.

# --hints--

Оголосіть змінну `elemValue` після функції `rangeFromString()`.
