...
Ahora agrega las propiedades restantes al objeto privado `elements`. Son: `multipleCard`, `title`, `newReadingBtn`, `fortuneContainer`, `fortuneDescription`, `headerTitle`, `subTitle`, `cardTitle`, `description` y `text`. Asegúrate de que cada propiedad use el tipo `HTMLElement`.

# --hints--

Deberías tener la propiedad `multipleCard` dentro de la propiedad `elements` asignada al tipo `HTMLElement`.
...
Deberías tener la propiedad `title` dentro de la propiedad `elements` asignada al tipo `HTMLElement`.
...
Deberías tener la propiedad `newReadingBtn` dentro de la propiedad `elements` asignada al tipo `HTMLElement`.
...
Deberías tener la propiedad `fortuneContainer` dentro de la propiedad `elements` asignada al tipo `HTMLElement`.
...
Deberías tener la propiedad `fortuneDescription` dentro de la propiedad `elements` asignada al tipo `HTMLElement`.
...
Deberías tener la propiedad `headerTitle` dentro de la propiedad `elements` asignada al tipo `HTMLElement`.
...
Deberías tener la propiedad `subTitle` dentro de la propiedad `elements` asignada al tipo `HTMLElement`.
...
Deberías tener la propiedad `cardTitle` dentro de la propiedad `elements` asignada al tipo `HTMLElement`.
...
Deberías tener la propiedad `description` dentro de la propiedad `elements` asignada al tipo `HTMLElement`.
...
Deberías tener la propiedad `text` dentro de la propiedad `elements` asignada al tipo `HTMLElement`.
