...
Ndani ya `tbody`, ongeza `tr` yenye `class` iliyowekwa kuwa `total`. Ndani yake, ongeza `th` yenye maandishi `Total Net Worth`, na zungusha `Net Worth` ndani ya `span` yenye `class` iliyowekwa kuwa `sr-only`.

Kisha ongeza vipengele vitatu vya `td`, ukimpa cha tatu `class` iliyowekwa kuwa `current`, na kila kimoja ukipe maandishi yafuatayo: `$-171`, `$136`, `$334`.

# --hints--

Kipengele chako cha `tbody` kinapaswa kuwa na kipengele kimoja cha `tr`.
...
Kipengele chako cha `tr` kinapaswa kuwa na `class` iliyowekwa kuwa `total`.
...
`tr` yako inapaswa kuwa na kipengele cha `th`.
...
Unapaswa kuzungusha maandishi `Net Worth` ndani ya kipengele cha `span`.
