...
Cree una función llamada `setPlayerDisplay`. Dentro de la función, establezca el `textContent` de `playingSong` al título de la canción actual, si está definido. De lo contrario, establezca en una cadena vacía.

Debajo de eso, establezca el `textContent` de `songArtist` al artista de la canción actual, si está definido. De lo contrario, establezca en cadena vacía. 
