...
È una contrazione di `I have`, che indica qualcosa che Sophie ha trovato o sperimentato.
...
È una contrazione di `cannot`, che mostra la difficoltà di Sophie nell'identificare il problema.
