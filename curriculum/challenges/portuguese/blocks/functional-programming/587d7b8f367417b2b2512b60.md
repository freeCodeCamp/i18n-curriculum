...
Declare os parâmetros da função - qualquer cálculo dentro de uma função depende apenas dos argumentos passados para a função, e não de nenhum objeto ou variável global.
