...
title: Відключіть елемент за допомогою jQuery
challengeType: 6
forumTopicId: 17563
...
jQuery має функцію `.prop()`, яка дозволяє налаштувати властивості елементів.

Ось так ви можете відключити всі кнопки:
...
Кнопка `target1` має бути відключеною.
