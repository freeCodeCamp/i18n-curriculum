...
title: 'Problema 92: catene di cifre al quadrato'
challengeType: 1
forumTopicId: 302209
...
Una catena numerica si crea sommando continuamente il quadrato delle cifre di un numero per formare un nuovo numero finché non si incontra un numero già visto.
...
Quindi qualsiasi catena che arriva a 1 o a 89 rimarrà bloccata in un loop infinito. La cosa più sorprendente è che OGNI numero di partenza arriverà infine a 1 o a 89.

Quanti numeri di partenza inferiori a `limit` arriveranno a 89?
