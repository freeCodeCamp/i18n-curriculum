...
Jetzt können wir den Text nicht lesen. Wähle den `footer` und das Anker-Element aus, um die Schriftfarbe auf eine Farbe mit angemessenem Kontrastverhältnis einzustellen.

# --hints--

Du solltest den `footer, footer a` Selektor verwenden.
...
Du solltest `color` auf einen Wert mit einem Kontrastverhältnis von mindestens `7:1` setzen. _Tipp: Ich empfehle `#dfdfe2`_
