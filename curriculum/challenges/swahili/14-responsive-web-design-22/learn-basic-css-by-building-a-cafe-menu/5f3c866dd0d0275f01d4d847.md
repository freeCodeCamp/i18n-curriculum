...
One way to fix this is to make each `p` element's width a little less than `50%`. Badilisha thamani ya `width` iwe `49%` kwa kila darasa ili kuona kitakachotokea.
