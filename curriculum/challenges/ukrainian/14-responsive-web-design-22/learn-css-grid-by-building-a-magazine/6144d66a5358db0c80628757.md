...
Створіть селектор `html` та надайте йому властивість `font-size` зі значенням `62.5%`. Це встановить розмір шрифту за замовчуванням для вебсторінки на 10 пікселів (в браузері на 16 пікселів).
