...
Властивість `place-items` можна використати, щоб одночасно задати значення `align-items` і `justify-items`. Властивість `place-items` приймає одне або два значення. Якщо задано одне значення, воно використовується для властивостей `align-items` і `justify-items`. Якщо задано два значення, перше використовується для властивості `align-items`, а друге — для властивості `justify-items`.

Задайте селектору `.image-wrapper` множину властивостей `place-items` зі значенням `center`.

# --hints--

Ваш селектор `.image-wrapper` має мати властивість `place-items` зі значенням `center`.
