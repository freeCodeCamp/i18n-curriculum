...
Assegna ai sei nuovi elementi questi valori `width` e `height`: `10%` e `60%` a `.fb1`, `10%` e `40%` a `.fb2`, `10%` e `35%` a `.fb3`, `8%` e `45%` a `.fb4`, `10%` e `33%` a `.fb5`, e `9%` e `38%` a `.fb6`.
...
Dovresti dare al selettore `.fb1` una `width` di `10%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.fb1')?.width, '10%');
```

Dovresti dare al selettore `.fb1` una `height` di `60%`.
...
Dovresti dare al selettore `.fb2` una `width` di `10%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.fb2')?.width, '10%');
```

Dovresti dare al selettore `.fb2` una `height` di `40%`.
...
Dovresti dare al selettore `.fb3` una `width` di `10%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.fb3')?.width, '10%');
```

Dovresti dare al selettore `.fb3` una `height` di `35%`.
...
Dovresti dare al selettore `.fb4` una `width` di `8%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.fb4')?.width, '8%');
```

Dovresti dare al selettore `.fb4` una `height` di `45%`.
...
Dovresti dare al selettore `.fb5` una `width` di `10%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.fb5')?.width, '10%');
```

Dovresti dare al selettore `.fb5` una `height` di `33%`.
...
Dovresti dare al selettore `.fb6` una `width` di `9%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.fb6')?.width, '9%');
```

Dovresti dare al selettore `.fb6` una `height` di `38%`.
