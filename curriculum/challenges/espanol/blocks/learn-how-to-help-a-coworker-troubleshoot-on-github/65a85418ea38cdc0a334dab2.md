...
Una `previous version` es una forma anterior de algo, como una versión antigua de un software. Vamos a usarlo en la misma oración que arriba:
...
Significa volver a un estado anterior. Sarah intentó regresar a una versión anterior del código. Este verbo usa `-ing`.
