...
某些类型的基于运动的动画可能会给一些用户带来不适。 特别是，患有<dfn>前庭</dfn>功能障碍的人对某些运动触发器敏感。
...
将设置 `scroll-behavior: smooth` 的样式规则放在 `@media` 规则中，其中媒体功能 `prefers-reduced-motion` 具有的值为 `no-preference`。
