...
Cada `tab` representa uno de los botones en la lista de pestañas. El usuario debe poder hacer clic en una pestaña para mostrar el panel correspondiente y ocultar los demás.
