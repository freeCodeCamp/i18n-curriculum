...
`getMood("rock", 111)` deve retornar `"happy"`.

```js
assert.equal(getMood("rock", 111), "happy");
```

`getMood("electronic", 74)` deve retornar `"focus"`.

```js
assert.equal(getMood("electronic", 74), "focus");
```

`getMood("classical", 180)` deve retornar `"happy"`.

```js
assert.equal(getMood("classical", 180), "happy");
```

`getMood("rock", 155)` deve retornar `"hype"`.

```js
assert.equal(getMood("rock", 155), "hype");
```

`getMood("electronic", 90)` deve retornar `"happy"`.

```js
assert.equal(getMood("electronic", 90), "happy");
```

`getMood("classical", 67)` deve retornar `"focus"`.

```js
assert.equal(getMood("classical", 67), "focus");
```

`getMood("pop", 100)` deve retornar `"happy"`.

```js
assert.equal(getMood("pop", 100), "happy");
```

`getMood("electronic", 135)` deve retornar `"hype"`.
