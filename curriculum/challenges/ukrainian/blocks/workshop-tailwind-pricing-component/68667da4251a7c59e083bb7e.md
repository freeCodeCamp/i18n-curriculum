...
Для елементів `span` всередині кожного елемента списку призначте їм класи `text-green-500` і `mr-2`, щоб зробити маркери зеленими та трохи відсунути їх від тексту.

Також призначте їм атрибут `aria-hidden`, як ви робили для елементів `span` першого тарифного плану.

# --hints--

Ваші елементи `span` повинні мати клас `text-green-500`.
...
Ваші елементи `span` повинні мати клас `mr-2`.
...
Ваші елементи `span` повинні мати атрибут `aria-hidden`.
