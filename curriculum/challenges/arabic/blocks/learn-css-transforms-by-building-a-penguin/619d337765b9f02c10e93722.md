...
بالنسبة لنقطتي التوقف الثالثة والرابعة، كرر نمط `transform` مرة أخرى.

# --hints--

يجب أن تعطي نقطة التوقف `30%` خاصية `transform` بقيمة `rotate(110deg) scaleX(-1)`.
...
يجب أن تعطي نقطة التوقف `40%` خاصية `transform` بقيمة `rotate(130deg) scaleX(-1)`.
