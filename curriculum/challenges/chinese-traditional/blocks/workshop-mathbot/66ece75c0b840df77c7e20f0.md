...
在工作坊的最後一步，你將在主控台記錄訊息 `"It was fun learning about the different Math methods with you!"`。

隨著最後一次更改，你已完成 MathBot 工作坊！ 

# --hints--

你應該將訊息 `"It was fun learning about the different Math methods with you!"` 記錄到主控台。
