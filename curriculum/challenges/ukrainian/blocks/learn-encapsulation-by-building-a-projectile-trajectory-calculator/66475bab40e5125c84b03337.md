...
Тепер, коли у вас є округлені координати, знайдіть максимальне значення серед усіх координат x та максимальне значення серед усіх координат y.

Ці максимальні значення будуть кількістю рядків і стовпців на графіку. Збережіть перше у нову змінну з ім’ям `x_max`, а друге — у змінну з ім’ям `y_max`.

Поверніть `x_max, y_max`.

# --hints--

Метод має повертати `x_max, y_max`.
...
Змінна `x_max` має містити найбільше значення x.
...
Змінна `y_max` має містити найбільше значення y.
