...
The `rules` in the form of nested array, and the `data` in the form of array, too. 以及想要的輸出 (`outputs`)。
...
基於馬爾可夫算法，使用提供給你的規則 (`rules`) 將數據 (`data`) 更改爲想要的輸出 (`outputs`) 。
