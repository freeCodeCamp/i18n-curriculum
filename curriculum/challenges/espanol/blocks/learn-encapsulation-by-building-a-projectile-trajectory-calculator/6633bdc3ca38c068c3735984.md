...
Agrega los ejes x e y al gráfico para obtener la siguiente salida:
...
Los símbolos están disponibles como `x_axis_tick` y `y_axis_tick`.

# --hints--

El método debe devolver la salida correcta.
...
El método debe devolver la salida correcta para diferentes instancias.
