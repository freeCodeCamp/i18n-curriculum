...
Kuboreshwa kwa viungo vya urambazaji kunapaswa kusababisha eneo la kuona kuruka moja kwa moja kwenye sehemu husika. Hata hivyo, kuruka hivi kunaweza kuwachanganya baadhi ya watumizi.

Chagua vipengele vyote, na weka `scroll-behavior` kuwa `smooth`.
...
Unapaswa kumpa `*` `scroll-behavior` ya `smooth`.
