...
أسفل الحلوى التي أضفتها للتو، أضف بقية الحلويات والأسعار باستخدام ثلاثة عناصر `article` إضافية، كل منها يحتوي على عنصرين `p` مسكنين. يجب أن يحتوي كل عنصر على نص الحلوى والسعر الصحيح، ويجب أن تحتوي جميعها على الأصناف الصحيحة.
...
يجب أن يحتوي عنصر `section` على ثمانية عناصر `p`.
...
يجب ألا يكون هناك أي فراغات بين عناصر `p`.
