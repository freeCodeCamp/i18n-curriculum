...
Тепер змініть свій виклик `removePlant`, передаючи йому об’єкт `ballerina`, і подивіться на консоль. Ви побачите помилку, яку виправите на наступному кроці.

# --hints--

Ви маєте вивести `removePlant(ballerina)` у консоль.
