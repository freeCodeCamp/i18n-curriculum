...
Тепер потрібно відцентрувати `#menu` горизонтально. Це можна зробити, встановивши властивості `margin-left` та `margin-right` на `auto`. Думайте про поле як невидимий простір навколо елементу. Використовуючи ці дві властивості, відцентруйте елемент `#menu` в межах елемента `body`.
