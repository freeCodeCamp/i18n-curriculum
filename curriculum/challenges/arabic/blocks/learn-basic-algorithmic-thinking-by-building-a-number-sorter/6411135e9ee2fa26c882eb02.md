...
في كل دورة من حلقة `while` الخاصة بك، تجد عنصرًا أكبر من القيمة الحالية. يجب نقل هذا العنصر إلى اليمين لإفساح المجال للقيمة الحالية.

افعل ذلك بتعيين القيمة عند فهرس `j` إلى الفهرس التالي.

# --hints--

قبل تقليل قيمة `j`، عيّن القيمة عند `j` إلى الفهرس `j + 1`.
