...
انتقل إلى عنصر القائمة، وأضف الأصناف `mt-6`، `space-y-2`، `text-sm`، و`text-fuchsia-100` إلى `ul` لتباعد عناصر القائمة وجعلها تبدو أكثر جاذبية.

# --hints--

يجب أن يحتوي عنصر `ul` على الصنف `mt-6`.
...
يجب أن يحتوي عنصر `ul` على الصنف `space-y-2`.
...
يجب أن يحتوي عنصر `ul` على الصنف `text-sm`.
...
يجب أن يحتوي عنصر `ul` على الصنف `text-fuchsia-100`.
