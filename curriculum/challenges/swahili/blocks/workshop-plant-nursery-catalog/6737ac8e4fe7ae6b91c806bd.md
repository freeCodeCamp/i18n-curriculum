...
Bado ndani ya kitendakazi chako, ongeza kitu cha `prettyPolly` kwenye seti yako.

# --hints--

Unapaswa kutumia njia ya `add` kuongeza kitu cha `prettyPolly` kwenye seti yako ndani ya kitendakazi cha `displayPlantsSet`.
