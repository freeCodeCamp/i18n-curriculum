...
تتفق صوفي مع جيمس وتشير إلى أمر آخر تود معرفته. ماذا ستقول؟
...
هذا لا يُظهر اتفاقًا؛ بل يعبر عن اختلاف.
...
للتعبير عن الاتفاق مع شخص ما، يمكنك استخدام عبارات مثل:
...
لإضافة نقطة أخرى، يمكنك استخدام:

- `Another thing I'm curious about is...`

- `One more thing I'd like to know is...`

تتفق صوفي أولًا مع جيمس (`I agree.`) ثم تقدم موضوعًا جديدًا تريد مناقشته (`Another thing I'm curious about is performance.`).
