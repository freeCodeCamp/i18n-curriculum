...
Você pode adicionar imagens ao seu site usando o elemento `img`. Elementos `img` têm uma tag de abertura sem uma tag de fechamento. Um elemento que não precisa de uma tag de fechamento é conhecido como <dfn>elemento nulo</dfn>.
