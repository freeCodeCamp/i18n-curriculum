...
Così va meglio. Ora prova ad aggiungere la stessa spaziatura interna `20px` in alto e in basso al menu.
...
Dovresti impostare la proprietà `padding-top` su `20px`.
...
Dovresti impostare la proprietà `padding-bottom` su `20px`.
...
Il tuo elemento `.menu` dovrebbe avere una spaziatura interna `padding-top` di `20px`.
...
Il tuo elemento `.menu` dovrebbe avere una spaziatura interna `padding-bottom` di `20px`.
