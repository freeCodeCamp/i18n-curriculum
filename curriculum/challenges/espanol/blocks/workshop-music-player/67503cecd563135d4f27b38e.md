...
Ahora es el momento de probar la función `playNextSong`.

Añade un oyente de eventos `"click"` al elemento `nextButton`, luego pasa `playNextSong` como el segundo argumento de tu oyente de eventos. Esta es la función que ejecutará el oyente de eventos.

Prueba tu aplicación haciendo primero clic en el botón de reproducir seguido por el botón siguiente. Debes ver que todo funciona como se espera.
...
El escucha de eventos debería escuchar un evento de `"click"`.
