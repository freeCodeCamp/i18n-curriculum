...
Функція `len` повертає довжину рядка. Оновіть другий виклик `print`, щоб вивести довжину цього слова.

# --hints--

У вас має бути `print(len(words[line_index]))` наприкінці циклу.
