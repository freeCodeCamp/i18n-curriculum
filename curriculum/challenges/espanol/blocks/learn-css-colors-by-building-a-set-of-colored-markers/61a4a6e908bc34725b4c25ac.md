...
A continuación, establece el color-stop para el rojo en `0%`, el color-stop para el verde en `50%`, y el color-stop para el azul en `100%`.

# --hints--

La regla CSS `.red` debe tener una propiedad de `background` establecida en `linear-gradient(180deg, rgb(255, 0, 0) 0%, rgb(0, 255, 0) 50%, rgb(0, 0, 255) 100%)`.
