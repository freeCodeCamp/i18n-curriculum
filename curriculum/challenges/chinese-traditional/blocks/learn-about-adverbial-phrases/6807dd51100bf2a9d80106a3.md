...
`As` at the beginning of a sentence can be used to talk about the reason why you are raising a topic. It introduces the reason why you are saying what comes next. 例如：
