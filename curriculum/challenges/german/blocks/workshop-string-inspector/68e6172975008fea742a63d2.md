...
Fügen Sie als letzten Schritt eine `console.log()`-Anweisung mit der Nachricht `"Workshop complete! You now know how to use includes() and slice()."` hinzu.

Herzlichen Glückwunsch! Sie haben den String-Inspector-Workshop abgeschlossen.

# --hints--

Sie sollten `"Workshop complete! You now know how to use includes() and slice()."` in der Konsole ausgeben.
