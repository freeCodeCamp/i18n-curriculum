...
Es hora de mover algo de código de la función `move()` a la función `make_allowed_move()`. Mueve el código anidado dentro de la primera sentencia `if` (excepto la primera llamada a `print()`) a tu nueva función. Presta mucha atención a la indentación.  
No olvides eliminar la palabra clave `pass`.

# --hints--

Debes mover el código anidado dentro de la primera sentencia `if` (excepto la primera llamada a `print()`) a tu nueva función.
