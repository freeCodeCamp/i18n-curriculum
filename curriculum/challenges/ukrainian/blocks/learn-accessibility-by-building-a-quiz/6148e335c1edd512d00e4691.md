...
Натиснення на навігаційні посилання має переміщувати вікно перегляду до відповідного розділу. Однак таке переміщення може дезорієнтувати деяких користувачів.

Виберіть усі елементи та встановіть `scroll-behavior` у `smooth`.

# --hints--

Ви маєте використати селектор `*`.

```js
assert.exists(new __helpers.CSSHelp(document).getStyle('*'));
```

Ви маєте надати `*` властивість `scroll-behavior` зі значенням `smooth`.
