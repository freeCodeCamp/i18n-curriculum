...
Jetzt müssen Sie die Warteschlange nicht mehr protokollieren. Entfernen Sie also `console.log(queue)` aus Ihrer `while`-Schleife.

# --hints--

Sie sollten `console.log(queue)` nicht in Ihrer `while`-Schleife haben.
