...
Kipengele cha `address` si lazima kiwe na eneo halisi la kijiografia. Inaweza kutumika kutoa kiungo kwa kitu chochote.

Weka kiungo kwenye maandishi `freeCodeCamp`, na uweke eneo lake kuwa `https://freecodecamp.org`.
...
Unapaswa kukipa kipengele cha `a` maandishi yaliyopo ya `freeCodeCamp`.
