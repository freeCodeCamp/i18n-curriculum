...
title: Use && para uma Condicional Mais Concisa
challengeType: 6
forumTopicId: 301413
...
O método render deve usar o operador lógico `&&` para verificar a condição de `this.state.display`.
