...
Debes dar a los elementos `a` dentro de los ítems de la lista una propiedad `color`.
...
Debes cambiar el color solamente de los elementos `a` dentro de los elementos de lista.
