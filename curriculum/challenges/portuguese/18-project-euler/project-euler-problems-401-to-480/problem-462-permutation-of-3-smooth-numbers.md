...
Encontre $F({10}^{18})$. Give your answer as a string in scientific notation rounded to ten digits after the decimal point. Ao dar sua resposta, use letra minúscula `e` para separar a mantissa e o expoente. Ex: se a resposta é $112.233.445.566.778.899$, o formato da resposta seria `1.1223344557e17`.
