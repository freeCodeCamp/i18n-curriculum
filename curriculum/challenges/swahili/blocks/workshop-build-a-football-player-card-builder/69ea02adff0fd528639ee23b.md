...
Ifuatayo, tengeneza kitendakazi cha `loadPlayer` chenye `PlayerData` kama aina ya kurudisha. Ndani yake, ongeza sintaksia ya `try...catch` yenye `error` kama kigezo cha sehemu ya `catch`. Acha kila kitu kingine kuwa tupu kwa sasa.

# --hints--

Unapaswa kutengeneza kitendakazi kinachoitwa `loadPlayer`.
...
Kitendakazi chako cha `loadPlayer` kinapaswa kuwa na aina ya kurudisha `PlayerData`.
...
Kitendakazi chako cha `loadPlayer` kinapaswa kuwa na sehemu ya `try...catch`.
