...
Ваш селектор `.cabin:nth-of-type(1)` має мати властивість `right`, встановлену в `-8.5%`.
...
Ваш селектор `.cabin:nth-of-type(1)` має мати властивість `top`, встановлену в `50%`.
