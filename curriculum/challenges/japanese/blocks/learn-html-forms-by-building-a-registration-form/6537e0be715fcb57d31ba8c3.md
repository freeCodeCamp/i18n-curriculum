...
最後に、CSSに新しいセレクターを追加して、`terms and conditions` リンク要素のテキスト色を `#dfdfe2` に変更してください。

よくできました！_Registration Form_ 練習プロジェクトの最後の部分を完了しました。

# --hints--


`a` 要素に `color` の `#dfdfe2` を付ける必要があります。
