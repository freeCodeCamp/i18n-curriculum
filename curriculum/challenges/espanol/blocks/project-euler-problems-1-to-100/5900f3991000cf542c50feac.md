...
title: 'Problema 45: Triangular, pentagonal y hexagonal'
challengeType: 1
forumTopicId: 302122
...
Los números triangulares, pentagonales y hexagonales se generan mediante las siguientes fórmulas:
...
`triPentaHexa(40756)` debería devolver un número.

```js
assert(typeof triPentaHexa(40756) === 'number');
```

`triPentaHexa(40756)` debería devolver 1533776805.
