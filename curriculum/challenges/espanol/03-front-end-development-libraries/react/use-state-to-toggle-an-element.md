...
Al hacer click en el elemento botón se debe alternar la propiedad `visibility` en el estado entre `true` y `false` y renderizar condicionalmente el elemento `h1`.
