...
Crea un selettore `html` e dagli una proprietà `font-size` impostata su `62.5%`. Questo imposterà la dimensione del carattere tipografico predefinita per la tua pagina web a 10px (il valore predefinito del browser è 16px).
