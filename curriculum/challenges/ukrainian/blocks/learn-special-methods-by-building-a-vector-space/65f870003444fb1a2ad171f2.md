...
Змініть два виклики `print`, щоб вивести норму ваших векторів, і перевірте, що метод `norm()` працює правильно.

# --hints--

Ви повинні вивести `v1.norm()`.

```js
({ test: () => assert(runPython(`_Node(_code).has_call("print(v1.norm())")`)) })
```

Ви повинні вивести `v2.norm()`.
