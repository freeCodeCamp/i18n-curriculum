...
`To be within budget` or `to stay within budget` means to spend only the amount of money that was planned or allowed and no more. It shows that the project or activity is managed well financially. 例如：
