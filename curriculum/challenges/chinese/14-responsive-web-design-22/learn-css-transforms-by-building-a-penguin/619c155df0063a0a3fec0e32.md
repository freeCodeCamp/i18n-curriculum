...
你应该给 `.face` 一个 `width` 为 `--fcc-expected--`，而不是 `--fcc-actual--`。
...
你应该给 `.face` 一个 `height` 为 `--fcc-expected--`，而不是 `--fcc-actual--`。
...
你应该给 `.face` 一个 `background-color` 为 `--fcc-expected--`，而不是 `--fcc-actual--`。
