...
Як фінальний крок, додайте інструкцію `console.log()` з повідомленням: `"Workshop complete! You now know how to use includes() and slice()."`

Вітаємо! Ви завершили практичне заняття String Inspector.

# --hints--

Ви повинні вивести `"Workshop complete! You now know how to use includes() and slice()."` у консоль.
