...
`telephoneCheck()`, cuando se llama con cualquier número válido, debería devolver `true`.
...
`telephoneCheck()`, cuando se llama con un número inválido, debería devolver `false`.
