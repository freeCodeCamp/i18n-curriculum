...
Kwa hatua hii, utahitaji kuongeza nambari ya simu na anwani ya barua pepe ya mwandishi wa blogu.

Ndani ya kipengele cha `address`, ongeza kipengele cha aya chenye maandishi ya `Phone: 555-555-5555`.

Chini ya kipengele hicho cha aya, ongeza kipengele kingine cha aya chenye maandishi ya `Email: fake@email.com`.

# --hints--

Unapaswa kuwa na vipengele viwili vya `p` ndani ya kipengele chako cha `address`.
...
Kipengele chako cha kwanza cha `p` kinapaswa kuwa na maandishi ya `Phone: 555-555-5555`.
...
Kipengele chako cha pili cha `p` kinapaswa kuwa na maandishi ya `Email: fake@email.com`.
