...
`Frustration` es la sensación de estar molesto o irritado debido a la incapacidad de cambiar o lograr algo. Por ejemplo, puede ser `frustrating` cuando intentas aprender una nueva habilidad pero lo encuentras difícil. Esta emoción a menudo surge cuando algo es difícil o no sale como se planeó.

# --questions--

## --text--

¿Qué significa `feel frustrated`?
