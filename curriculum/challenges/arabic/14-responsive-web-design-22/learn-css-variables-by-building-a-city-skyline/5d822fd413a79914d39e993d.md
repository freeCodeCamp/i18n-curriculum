...
يجب عليك إضافة منتقي `:root` إلى media query.
...
يجب عليك إضافة `--building-color1` بقيمة `#000`.
...
يجب عليك إضافة `--building-color2` بقيمة `#000`.
...
يجب عليك إضافة `--building-color3` بقيمة `#000`.
...
يجب عليك إضافة `--building-color4` بقيمة `#000`.
