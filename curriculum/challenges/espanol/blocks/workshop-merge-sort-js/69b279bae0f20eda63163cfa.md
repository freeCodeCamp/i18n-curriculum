...
Copia los valores restantes de la izquierda en `array` asignando `leftPart[leftArrayIndex]` a `array[sortedIndex]`.

# --hints--

El cuerpo del ciclo debe asignar `leftPart[leftArrayIndex]` a `array[sortedIndex]`.
