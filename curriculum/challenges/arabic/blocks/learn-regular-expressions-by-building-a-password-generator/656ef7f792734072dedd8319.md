...
بعد حلقة `for`، أنشئ متغيرًا باسم `constraints` وقم بتعيين قائمة فارغة لهذا المتغير.

# --hints--

يجب إعلان متغير `constraints` بعد حلقة `for` وتعيين قائمة فارغة لهذا المتغير.
