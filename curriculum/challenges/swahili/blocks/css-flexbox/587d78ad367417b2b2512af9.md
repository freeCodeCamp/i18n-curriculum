...
title: Tumia sifa ya align-items katika ingizo la tweet
challengeType: 0
...
Changamoto ya mwisho ilianzisha sifa ya `align-items` na kutoa mfano. Sifa hii inaweza kutumika kwa vipengele vichache vya ingizo la tweet ili kupanga vipande vya kubadilika ndani yake.

# --instructions--

Ongeza sifa ya CSS `align-items` kwa kipengele cha `.follow-btn` cha kichwa. Weka thamani kuwa `center`.
...
Kipengele cha `.follow-btn` kinapaswa kuwa na sifa ya `align-items` ikiwa na thamani ya `center`.
