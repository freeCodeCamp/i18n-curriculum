...
Infine, aggiorna l'assegnazione di `text.innerText` in modo che sia uguale a `text` dall'oggetto `location`. Invece di usare la notazione a parentesi, usa la <dfn>dot notation</dfn>.

Ecco un esempio di come accedere alla proprietà `name` di un oggetto chiamato `person`:
