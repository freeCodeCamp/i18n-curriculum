...
Simule o turno da noite fazendo uma chamada a `simulateFestival()` com `nightGates` e `"Night"`.

Com isso, suas simulações estão completas!

# --hints--

Você deve fazer uma chamada a `simulateFestival()` com `nightGates` e `"Night"`.
