...
Quieres comparar dos vectores, solo cuando pertenecen a la misma clase. Para eso crea una estructura `if` que verifique si `self` y `other` no pertenecen a la misma clase y devuelve `NotImplemented` en ese caso.
# --hints--
