...
Se essa condição for atendida, desabilite o botão definindo a propriedade `disabled` como `true`. Also, set the `textContent` of the button to `"No more data to load"`.
