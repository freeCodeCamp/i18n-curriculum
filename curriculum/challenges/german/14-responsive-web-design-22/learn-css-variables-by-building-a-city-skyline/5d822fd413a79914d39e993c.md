...
Innerhalb der `sky` Klasse der media query, ändere die beiden `#ffcf33` Farbeigenschaften zu `#ccc`, die `#ffff66` zu `#445`, und die `#bbeeff` zu `#223`. Dann kannst du die Größe deines Fensters ändern, um zu sehen, wie der Hintergrund seine Farbe ändert.

# --hints--

Du solltest die ersten Farbwerte von `#ffcf33` zu `#ccc` ändern.
...
Du solltest den zweiten Farbwert von `#ffff66` in `#445` ändern.
...
Du solltest den dritten Farbwert von `#bbeeff` in `#223` ändern.
