...
Tumia sifa ya `border-radius` kwenye kichaguzi cha `.two`, kuweka mduara wa juu-kushoto na mduara wa chini-kulia kuwa `8px`, na mduara wa juu-kulia na mduara wa chini-kushoto kuwa `10px`.

# --hints--

Unapaswa kuweka sifa ya `border-radius` kuwa `8px 10px`.
