...
ادعُ الآن الدالة `displayAuthors` مع جزء من بيانات المؤلف تمامًا كما فعلت سابقًا.

إذا نقرت على زر `Load More Authors` بعد استدعاء الدالة، فلن يعمل. ذلك لأنك لا تزال بحاجة إلى إضافة مستمع حدث `click` إلى الزر. ستفعل ذلك في الخطوة التالية.
