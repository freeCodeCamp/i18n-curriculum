...
Ordena directamente el arreglo local `sorted` usando tu función auxiliar `sortByPriorityDescending()`.

# --hints--

Debes invocar `sortByPriorityDescending()` con el arreglo `sorted`.
