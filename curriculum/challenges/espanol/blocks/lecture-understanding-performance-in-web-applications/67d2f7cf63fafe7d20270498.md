...
En esta lección, desglosaremos cómo usar tres APIs clave de la Web para medir y analizar la velocidad de tu sitio web.
...
Esto es más preciso que usar `Date.now()` porque mide el tiempo en milisegundos con precisión de microsegundos, evitando problemas de deriva del reloj. Puedes usarlo para rastrear el tiempo de ejecución de scripts, retrasos en la respuesta de eventos y el rendimiento de animaciones.
...
API de rendimientoMejor para
| :--------------------- | :------------------------------------------------- |
| `performance.now()`    Cronometraje preciso de funciones y scripts
API de Temporización de RendimientoMedición del rendimiento de carga completa de páginas
Observador de RendimientoMonitoreo en tiempo real de interacciones y renderizado
...
Es más preciso y mide el tiempo en milisegundos con precisión de microsegundos.
