...
قبل إلحاق العنصر الأخير إلى الهدف، أضف تعليقًا يقول `move the nth disk from source to target`.

# --hints--

يجب إضافة تعليق بالنص المقدم قبل `rods[target].append(rods[source].pop())`.
