...
Toa kwa kipengele chako cha `#monsterStats` `border` na `padding` sawa na zile za kipengele chako cha `#stats`. Weka rangi yake kuwa `#ffffff` na mpe mandhari ya nyuma ya `#c70d0d`.
...
Kichaguzi chako cha `#monsterStats` kinapaswa kuwa na `border` ya `1px solid #0a0a23`.
...
Kichaguzi chako cha `#monsterStats` kinapaswa kuwa na `color` ya `#ffffff`.
...
Kichaguzi chako cha `#monsterStats` kinapaswa kuwa na `background-color` ya `#c70d0d`.
