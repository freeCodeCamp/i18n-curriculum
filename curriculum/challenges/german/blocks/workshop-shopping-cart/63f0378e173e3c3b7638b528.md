...
Geben Sie schließlich den Wert der `total`-Eigenschaft zurück. Denken Sie an Ihr `this`-Schlüsselwort.

# --hints--

Ihre `calculateTotal`-Methode sollte den Wert der `total`-Eigenschaft zurückgeben.
