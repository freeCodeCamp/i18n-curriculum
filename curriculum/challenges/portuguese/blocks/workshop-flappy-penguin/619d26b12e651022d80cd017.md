...
Selecione os elementos `.arm` e dê a eles uma `width` de `30%`, uma `height` de `60%` e um `background` de gradiente linear a `90deg` partindo do sentido horário, começando em `gray` e terminando em `rgb(209, 210, 199)`.
