...
За словами Браяна, що Софі має шукати в документації фреймворку?
...
Фокус Браяна на інструкціях з ініціалізації, а не просто на встановленні.
...
Браян конкретно згадує про пошук інструкцій з ініціалізації.
...
Порада стосується налаштування бібліотеки, а не покращення її продуктивності.
