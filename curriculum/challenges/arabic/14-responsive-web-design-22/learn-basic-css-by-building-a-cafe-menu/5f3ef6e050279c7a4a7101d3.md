...
هذا يبدو أفضل. الآن حاول إضافة `20px` مطابق إلى padding في الجزء العلوي والأسفل من القائمة.

# --hints--

لا يجب عليك إزالة خواص `padding-left` أو `padding-right`.
...
يجب عليك تعيين خاصية `padding-top` إلى `20px`.
...
يجب عليك تعيين خاصية `padding-bottom` إلى `20px`.
...
يجب أن يكون للعنصر `.menu` الخاص بك `padding-top` بقيمة `20px`.
...
يجب أن يكون للعنصر `.menu` الخاص بك `padding-bottom` بقيمة `20px`.
