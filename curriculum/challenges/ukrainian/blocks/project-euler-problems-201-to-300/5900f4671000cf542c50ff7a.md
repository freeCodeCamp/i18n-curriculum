...
Трійка натуральних чисел ($a$,$b$,$c$) називається трійкою Кардано, якщо вона задовольняє умову:

$$\sqrt[3]{a + b \sqrt{c}} + \sqrt[3]{a - b \sqrt{c}} = 1$$

Наприклад, (2,1,5) — це трійка Кардано.

Існує 149 трійок Кардано, для яких $a + b + c ≤ 1000$.

Знайдіть, скільки існує трійок Кардано таких, що $a + b + c ≤ 110\\,000\\,000$.
