...
هذا هو الفعل `to be`، يُستخدم مع `you`. هو الكلمة الأولى في السؤال، لذا اكتبها بحرف كبير.
...
هذه حرف الجر يترافق مع الفعل `to be` للتعبير عن أن شخصًا يحب شيئًا أو مهتم به.
