...
Далі призначте утилітарні класи `mt-6`, `space-y-2`, `text-sm` і `text-gray-700` `ul`.

# --hints--

Вашому елементу `ul` слід призначити клас `mt-6`.
...
Вашому елементу `ul` слід призначити клас `space-y-2`.
...
Вашому елементу `ul` слід призначити клас `text-sm`.
...
Вашому елементу `ul` слід призначити клас `text-gray-700`.
