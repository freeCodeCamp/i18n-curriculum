...
本实验已经为你提供了所有的超文本标记语言和 CSS。你将使用 JavaScript 完成冒泡排序可视化工具，使其能够展示冒泡排序算法对五个整数数组进行排序所需的每一步。
...
当你点击 `#sort-btn` 后，`#array-container` 内的每个 `div` 应包含五个 `span`，每个的文本是一个数字，并排列以表现冒泡排序算法对初始数组排序所需的步骤。
