...
Використайте цикл `for`, щоб вивести `name` кожного астронавта з масиву `updatedCrew`. Після циклу поверніть масив `updatedCrew`, щоб завершити вашу функцію `swapCrewMembers`.

# --hints--

Ви повинні використати цикл `for`, щоб ітерувати по масиву `updatedCrew` і вивести `name` кожного астронавта.
...
Після виведення імен астронавтів поверніть масив `updatedCrew`.
