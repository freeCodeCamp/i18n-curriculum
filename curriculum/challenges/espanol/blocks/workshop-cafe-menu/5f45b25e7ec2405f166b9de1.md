...
Cambias las propiedades de un enlace cuando el enlace ha sido visitado usando un <dfn>pseudo-selector</dfn> que se ve así: `a:visited { propertyName: propertyValue; }`.

Cambia el color del enlace `Visita nuestra página web` en el pie de página a `gris` cuando un usuario ha visitado el enlace.

# --hints--

Deberías usar el pseudo-selector `a:visited`.
