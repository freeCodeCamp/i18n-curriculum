...
Кожен елемент, призначений до відсортованого масиву, займає індекс в списку. So you have to move to the next index in the sorted array after each assignment.
