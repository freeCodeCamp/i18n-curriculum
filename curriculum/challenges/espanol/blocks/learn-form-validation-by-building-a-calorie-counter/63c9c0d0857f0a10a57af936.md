...
Siguiendo el mismo patrón, busca tus entradas de `number` en los elementos `#dinner`, `#snacks` y `#exercise`. Asígnales a variables siguiendo el esquema de nombres de los dos anteriores.
