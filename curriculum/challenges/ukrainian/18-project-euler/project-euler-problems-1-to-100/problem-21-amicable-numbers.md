...
Визначимо d(`n`) як суму властивих дільників числа `n` (числа менші за `n`, які діляться на `n` без остачі).

Якщо d(`a`) = `b` й d(`b`) = `a`, де `a` ≠ `b`, тоді `a` та `b` є дружньою парою і кожен з `a` та `b` називаються дружніми числами.

Наприклад, властивими дільниками числа 220 є 1, 2, 4, 5, 10, 11, 20, 22, 44, 55 та 110, тому d(220) = 284. Властивими дільниками числа 284 є 1, 2, 4, 71 та 142, тому d(284) = 220.
