...
사용자 경험을 향상하려면 전화번호를 탭하면 통화가 시작되도록 개선하세요.

전화번호를 클릭 가능한 상태로 만드는 방법은 다음과 같습니다:

```html
<a href="tel:2345678912">234-567-8912</a>
```

텍스트 `555-555-5555`를 앵커 요소로 감싸고 `tel:`를 사용해 클릭 가능한 전화번호로 만드세요.

# --hints--

텍스트 `555-555-5555`를 `a` 요소로 감싸야 합니다.
...
새 `href` 요소의 `a` 속성은 `tel:5555555555`로 설정해야 합니다.
