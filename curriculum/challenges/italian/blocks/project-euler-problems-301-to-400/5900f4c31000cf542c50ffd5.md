...
${50}^2 = 2500 = 2^2 × 5^4$, quindi $φ(2500) = 2 × 4 × 5^3 = 8 × 5^3 = 2^3 × 5^3$. $φ$ indica la funzione toziente di Euler.

Quindi 2500 è un quadrato e $φ(2500)$ è un cubo.

Trova la somma di tutti i numeri $n$, $1 &lt; n &lt; {10}^{10}$ tali che $φ(n^2)$ sia un cubo.
