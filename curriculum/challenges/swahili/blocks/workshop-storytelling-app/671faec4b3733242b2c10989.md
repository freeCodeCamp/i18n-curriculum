...
Sasa, unajua kwamba kitufe kinafanya kazi. Ondoa tamko la `console.log` kutoka kwenye kitendakazi cha `displayStory`.

# --hints--

Unapaswa kuondoa tamko la `console.log` kutoka kwenye kitendakazi cha `displayStory`.
