...
Esta es la contracción de `we are`. La primera letra está en mayúscula.
...
Es un pronombre que se refiere a un grupo que incluye a la persona que está hablando.
