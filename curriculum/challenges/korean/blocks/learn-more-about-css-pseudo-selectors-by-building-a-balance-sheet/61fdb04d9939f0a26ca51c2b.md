...
표 제목을 스타일링할 시간입니다. `h1` 선택자를 만드세요. `max-width` 속성을 `37.25rem`로, `margin` 속성을 `0 auto`로, `padding` 속성을 `1.5rem 1.25rem`로 설정하세요.
