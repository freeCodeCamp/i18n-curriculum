...
Щоб зменшити вертикальний пробіл між елементом `h1` і текстом `Est. 2020`, змініть нижнє поле `h1` на `15px`.
...
Ваш елемент `h1` має мати поле `margin-bottom` рівне `15px`.
