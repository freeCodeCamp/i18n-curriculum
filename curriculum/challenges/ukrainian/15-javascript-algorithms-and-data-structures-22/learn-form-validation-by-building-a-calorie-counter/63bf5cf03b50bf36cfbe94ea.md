...
Ваш наступний крок — дозволити користувачам додавати записи до лічильника калорій. Оголосіть порожню функцію `addEntry`. Ця функція не повинна приймати жодних параметрів.
