...
Dentro de la función `playSong`, llama a la función `highlightCurrentSong`.

Después de eso, experimenta con los botones de control para ver cómo funciona la función `highlightCurrentSong`.

# --hints--

Deberías llamar a `highlightCurrentSong` dentro de la función `playSong`.
