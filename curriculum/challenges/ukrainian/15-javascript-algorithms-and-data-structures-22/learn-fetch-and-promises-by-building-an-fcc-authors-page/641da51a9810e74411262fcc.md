...
**Примітка:** тепер ви можете завершити свій код крапкою з комою. Ви не могли цього зробити на попередніх кроках, тому що ви просигналізуйте JavaScript припинити розбір коду, що вплине на `fetch()` синтаксис.
