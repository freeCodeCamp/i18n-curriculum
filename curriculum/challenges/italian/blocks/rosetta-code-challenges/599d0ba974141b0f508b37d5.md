...
Un emirp (un **primo** scritto al contrario) è un numero primo che, se invertito (nella sua rappresentazione decimale), è un primo diverso.
...
<ul>
  <li>Mostri i primi <code>n</code> numeri emirp.</li>
  <li>Mostri i numeri emirp in un intervallo.</li>
  <li>Mostri il numero di emirp in un intervallo.</li>
  <li>Mostri il <code>n<sup>esimo</sup></code> numero emirp.</li>
</ul>

La funzione deve accettare due parametri. Il primo riceverà `n` oppure l’intervallo come array. Il secondo riceverà un booleano, che specifica se la funzione deve restituire gli emirp come array o un singolo numero (il numero di primi nell’intervallo o il <code>n<sup>esimo</sup></code> primo). In base ai parametri la funzione deve restituire un array o un numero.
