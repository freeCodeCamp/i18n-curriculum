...
Ili kupanga visanduku vya ingizo kwa kila kimoja, unda sheria mpya ambayo inalenga vipengele vyote vya `input` na `label` ndani ya kipengele cha `.info` na uweke sifa ya `display` kuwa `inline-block`.
