...
O que são casos de borda no design de algoritmos?

#### --distractors--

Entradas que sempre causam erros de tempo de execução durante a execução do programa.

---

Entradas geradas aleatoriamente para medir o desempenho de um algoritmo.

---

Entradas inválidas que nunca devem ser consideradas durante os testes.

#### --answer--

Entradas específicas e válidas nos limites do que um algoritmo deve tratar.

### --question--

#### --text--

O que é o nó cabeça em uma lista ligada simples?

#### --distractors--

O nó localizado no meio da lista.

---

O nó com o maior valor na lista.

---

O nó mais recentemente adicionado na lista.

#### --answer--

O primeiro nó da lista, geralmente o único nó acessível diretamente.
...
Ignore casos de borda.

---

Vá direto para a otimização.

#### --answer--

Leia a declaração do problema várias vezes.
...
A linguagem de programação e a IDE.

---

Os nomes das variáveis e outros identificadores.

---

O esquema de cores e a formatação do código.

#### --answer--

A entrada e a saída esperada.
