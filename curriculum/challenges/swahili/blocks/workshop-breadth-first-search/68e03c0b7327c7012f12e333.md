...
Mwishowe, fanya wito la `gen_parentheses` ukiwa na `3` kama hoja yake ili kuzalisha mchanganyiko wote watano halali wa mabano ya kawaida matatu na uchapishe matokeo kwenye konsoli. Kwa hiyo warsha imekamilika.

# --hints--

Unapaswa kuchapisha `gen_parentheses(3)`.
