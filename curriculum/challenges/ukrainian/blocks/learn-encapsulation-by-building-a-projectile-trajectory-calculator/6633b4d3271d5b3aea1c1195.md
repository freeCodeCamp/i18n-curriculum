...
Як перший крок цього нового методу створіть локальну копію координат, але де всі значення округлені до цілих чисел. Збережіть цю нову версію координат у змінній під назвою `rounded_coords` та поверніть цю змінну.
