...
Lembre-se de que você consultou aquele dropdown anteriormente no seu JavaScript e o atribuiu à variável `entryDropdown`. Você pode usar a propriedade <dfn>value</dfn> para obter o valor da opção selecionada.

Use concatenação para adicionar um `#` ao início da propriedade `value` de `entryDropdown` e atribua esse resultado a uma variável `targetId`.
