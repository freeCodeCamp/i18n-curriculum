...
До рядків документації можна отримати доступ через атрибут `__doc__`, який за замовчуванням встановлений у `None`.

Перевірте це, вивівши `movie1.__doc__` та `series1.__doc__`. Зверніть увагу, що атрибут `__doc__` не успадковується жодним дочірнім класом.

# --hints--

Ви повинні вивести `movie1.__doc__`.
...
Ви повинні вивести `series1.__doc__`.
