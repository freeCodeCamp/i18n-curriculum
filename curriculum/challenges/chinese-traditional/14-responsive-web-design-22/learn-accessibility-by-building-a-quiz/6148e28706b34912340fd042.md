...
將 `address` 元素中的所有文本水平居中，並添加一些 padding。
...
你應該給 `address` 添加 `padding-right` 值爲至少 `1px`。
...
你應該給 `address` 添加 `padding-bottom` 值爲至少 `1px`。
...
你應該給 `address` 添加 `padding-left` 值爲至少 `1px`。
