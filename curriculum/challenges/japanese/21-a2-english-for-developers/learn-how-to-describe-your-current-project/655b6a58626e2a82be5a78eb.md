...
To `steal` means to take something that doesn't belong to you without permission. 例えば、次のように記述できます。
...
`Identity` refers to who a person is, including their name, date of birth, and other personal information. 例えば、次のようになります。
