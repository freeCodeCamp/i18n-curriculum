...
Sobald Sie den bearbeiteten Inhalt erhalten, wird dieser nun der aktuelle Inhalt sein.

Weisen Sie innerhalb des Ereignis-Listeners `newContent` `currentContent` zu.

# --hints--

Sie sollten `newContent` innerhalb des Ereignis-Listeners `currentContent` zuweisen.
