...
Sasa utaongeza mantiki ya kuhifadhi katika `localStorage` kwa kutumia `useEffect`. 

Kupata au kuhifadhi data katika `localStorage` huchukuliwa kama athari ya pembeni katika React, kwa hivyo unapaswa kutumia `useEffect` kwa mantiki hii.

Anza kwa kutekeleza ufumbuzi wa muundo wa `useEffect` kutoka React, kama ilivyofanywa na `useState`.

# --hints--

Unapaswa kutekeleza ufumbuzi wa muundo wa `useEffect` kutoka `React`.
