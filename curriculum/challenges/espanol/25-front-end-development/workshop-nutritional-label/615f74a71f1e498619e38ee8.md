...
Los bordes inferiores debajo de sus elementos `% Daily Value *` y `Saturated Fat 1g 5%` no se extienden a todo el ancho de la etiqueta. Agregue `no-divider` a la `class` para estos dos elementos.
