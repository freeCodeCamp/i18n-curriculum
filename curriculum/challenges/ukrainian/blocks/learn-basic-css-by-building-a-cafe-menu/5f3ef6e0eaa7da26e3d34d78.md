...
Ви можете додати вашому меню трохи простору між вмістом і краями за допомогою різних властивостей `padding`.

Додайте класу `menu` властивість `padding-left` і властивість `padding-right` з однаковим значенням `20px`.

# --hints--

Ви повинні встановити властивість `padding-left` у `20px`.
...
Ви повинні встановити властивість `padding-right` у `20px`.
...
Ваш елемент `.menu` повинен мати ідентифікатор `padding-left` зі значенням `20px`.
...
Ваш елемент `.menu` повинен мати ідентифікатор `padding-right` зі значенням `20px`.
