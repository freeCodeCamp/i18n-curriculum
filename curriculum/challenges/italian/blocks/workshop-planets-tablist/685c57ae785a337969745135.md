...
Per l’ultimo passaggio, devi rendere visibile il pannello quando si clicca sulla scheda associata. Puoi farlo impostando la proprietà `hidden` del `panel` su `false`.

Clicca su una qualsiasi delle schede e dovresti vedere visualizzato il contenuto del pannello corrispondente.

E con quest’ultima modifica, il tuo workshop è completo!

# --hints--

Quando si clicca su una scheda, devi impostare la proprietà `hidden` del pannello su `false`.
