...
Geben Sie den oberen Ecken der `.face`-Elemente einen Radius von `70%` und den unteren Ecken einen Radius von `60%`.

# --hints--

Sie sollten `.face` eine `border-radius` von `70% 70% 60% 60%` geben.
