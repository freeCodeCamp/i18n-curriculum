...
Imposta gli angoli in alto a sinistra, in alto a destra e in basso a destra degli elementi `.arm` con un raggio del `30%` e l'angolo in basso a sinistra con un raggio del `120%`.

# --hints--

Dovresti dare a `.arm` un valore `border-radius` di `30% 30% 30% 120%`.
