...
Una `function` es un conjunto de instrucciones que realiza una tarea específica. Las `functions` pueden hacer que el código sea más organizado, reutilizable y fácil de leer. Por ejemplo, una `function` podría calcular la suma de dos números o mostrar un mensaje al usuario.
