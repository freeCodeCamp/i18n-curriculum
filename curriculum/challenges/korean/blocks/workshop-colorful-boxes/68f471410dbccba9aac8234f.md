...
이제 `.box5` 선택자를 만들고 `background` 속성을 값 `#457b9d`로 추가하세요.

그다음 새 선택자에 `order` 속성을 값 `4`로 추가하세요. 그러면 이 상자가 `box4` 클래스를 가진 상자 뒤로 이동하는 것을 볼 수 있습니다.
