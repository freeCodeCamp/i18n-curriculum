...
**`wasn't` / `weren't` + verb ending in `-ing`**. Por ejemplo:
...
The verb `consider` means to think carefully about something before making a decision or taking action. Por ejemplo:
