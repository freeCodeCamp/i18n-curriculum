...
Passe den Wert der `min-height`-Eigenschaft so an, dass alle drei Elementtypen den gleichen `min-height`-Wert besitzen und das `select`-Element immer noch einen weißen Hintergrund hat.
