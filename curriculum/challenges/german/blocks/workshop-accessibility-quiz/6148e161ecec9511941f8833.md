...
Jetzt können wir den Text nicht lesen. Richten Sie den `footer` und das darin enthaltene Ankerelement so aus, dass die Schriftfarbe ein ausreichend gutes Kontrastverhältnis hat.

# --hints--

Sie sollten den `footer, footer a` Selektor verwenden.
...
Sie sollten den `color` auf einen Wert mit einem Kontrastverhältnis von mindestens `7:1` setzen. _Hinweis: Ich empfehle `#dfdfe2`_
