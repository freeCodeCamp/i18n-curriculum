...
Що Анна каже, що Том робитиме після перевірки е-пошти?

## --answers--

Взяти перерву на каву.

### --feedback--

Перерва на каву в цьому контексті не згадується.

---

Почати працювати над проєктами дизайну.

### --feedback--

Робота над проєктами згадується, але не одразу після перевірки е-пошти.

---

Відвідати щоденну командну нараду.

---

Пообідати з колегами.

### --feedback--

Обід згадується, але не як наступна діяльність після перевірки е-пошти.
