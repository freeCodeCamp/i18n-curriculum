...
O quinto elemento `div` de `className` de `form-group` deve ter um `label` com um atributo `htmlFor` de `def`, um `className` de `label` e um texto `DEF`.
...
O quinto elemento `div` de `className` de `form-group` deve ter um `input` com um `className` de `input`, um `id` de `def` e um `type` de `number`.
...
O sexto elemento `div` de `className` de `form-group` deve ter um `label` com um atributo `htmlFor` de `phy`, um `className` de `label` e um texto `PHY`.
...
O sexto elemento `div` de `className` de `form-group` deve ter um `input` com um `className` de `input`, um `id` de `phy` e um `type` de `number`.
