...
Abaixo do elemento `.heading`, crie um elemento `section` com a `class` definida como `text`.Dentro, crie um elemento `p` com a `class` definida como `first-paragraph` e o seguinte texto:
