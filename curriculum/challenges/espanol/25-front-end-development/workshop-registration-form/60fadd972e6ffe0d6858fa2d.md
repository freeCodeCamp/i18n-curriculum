...
"Sería mejor que el texto de `label` apareciera encima de los elementos del formulario."

"Seleccione todos los elementos `input`, `textarea` y `select`, y haga que ocupen todo el ancho de sus elementos padre."

"Además, agregue `10px` de `margin` en la parte superior de los elementos seleccionados." "Establezca los demás márgenes a `0`."

# --hints--

"Debe usar un selector de elementos separado por comas para seleccionar los elementos `input`, `textarea` y `select`."
...
"Debe establecer la propiedad `width` en `100%`."
...
"Debe establecer la propiedad `margin-top` en `10px`."
...
"Debe establecer la propiedad `margin-bottom` en `0`."
...
"Debe establecer la propiedad `margin-left` en `0`."
...
"Debe establecer la propiedad `margin-right` en `0`."
