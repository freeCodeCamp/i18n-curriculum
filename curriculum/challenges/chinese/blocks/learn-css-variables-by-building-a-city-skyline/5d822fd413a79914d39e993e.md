...
最后，在媒体查询的 `:root` 选择器中，重新定义所有四个 `--window-color` 变量，值为 `#777`。 完成后，调整窗口大小并观察它从白天到晚上的变化。

变量主要与颜色一起使用，这就是你在此处使用它们的方式。 但它们可以被赋予任何值并用于任何属性。 你的项目看起来很棒！

# --hints--

你应该添加 `--window-color1`，其值为 `#777`。
