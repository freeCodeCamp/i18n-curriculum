...
소수 41은 여섯 개의 연속된 소수의 합으로 나타낼 수 있습니다:

<div style='text-align: center;'>41 = 2 + 3 + 5 + 7 + 11 + 13</div>

이것은 100 미만의 소수 중에서 가장 긴 연속 소수 합입니다.

1000 미만의 소수 중에서 소수가 되는 가장 긴 연속 소수 합은 21개의 항을 포함하며, 그 값은 953입니다.

100만 미만의 소수 중에서 가장 많은 연속 소수의 합으로 나타낼 수 있는 소수는 무엇일까요?

# --hints--

`consecutivePrimeSum(1000)`은 숫자를 반환해야 합니다.

```js
assert(typeof consecutivePrimeSum(1000) === 'number');
```

`consecutivePrimeSum(1000)`은 953을 반환해야 합니다.

```js
assert.strictEqual(consecutivePrimeSum(1000), 953);
```

`consecutivePrimeSum(1000000)`는 997651를 반환해야 합니다.
