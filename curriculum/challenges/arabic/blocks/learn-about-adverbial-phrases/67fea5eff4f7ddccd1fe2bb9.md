...
هذا يشير إلى شيء يحدث مرة واحدة في الأسبوع.

# --explanation--

`Weekly` تُستخدم لوصف شيء يحدث مرة واحدة فقط كل أسبوع. تشير إلى تكرار حدث أو فعل يحدث على أساس أسبوعي. على سبيل المثال:

`The team has weekly meetings to discuss project progress.` – هذا يعني أن الاجتماعات تحدث كل أسبوع.
