...
Dentro de la función `playNextSong`, realiza la llamada a las funciones `setPlayerDisplay`, `highlightCurrentSong`, y `setPlayButtonAccessibleText` para actualizar correctamente el reproductor cuando termine la lista de reproducción.

# --hints--

Deberías llamar a `setPlayerDisplay` dentro de la declaración `else` de tu función `playNextSong`.
...
Deberías llamar a `highlightCurrentSong` dentro de la declaración `else` de tu función `playNextSong`.
...
Deberías llamar a `setPlayButtonAccessibleText` dentro de la declaración `else` de tu función `playNextSong`.
