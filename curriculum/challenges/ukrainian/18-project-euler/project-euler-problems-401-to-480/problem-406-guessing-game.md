...
Ми намагаємось знайти приховане число, вибране із множини цілих чисел {1, 2, ..., $n$} за допомогою запитань. На кожне запитання (число) ми отримуємо одну з трьох можливих відповідей:
