...
أخيرًا، في محدِّد `:root` لاستعلام الوسائط، أعد تعريف جميع المتغيرات الأربعة `--window-color` لاستخدام `#777`. عند الانتهاء، غيّر حجم النافذة وراقب كيف تتحول من النهار إلى الليل.

تُستخدم المتغيرات بشكل أساسي مع الألوان، وهكذا استخدمتها هنا. لكنها يمكن أن تأخذ أي قيمة وتُستخدم على أي خاصية. مشروعك يبدو رائعًا!

# --hints--

يجب إضافة `--window-color1` بقيمة `#777`.
...
يجب إضافة `--window-color2` بقيمة `#777`.
...
يجب إضافة `--window-color3` بقيمة `#777`.
...
يجب إضافة `--window-color4` بقيمة `#777`.
