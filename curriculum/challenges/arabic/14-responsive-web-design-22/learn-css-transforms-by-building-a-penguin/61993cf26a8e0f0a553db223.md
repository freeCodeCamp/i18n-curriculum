...
أعطِ البطْرِيق رأسا بيضوي طفيفا عن طريق تعيين نصف قطر الزاوية العلوية إلى `70%` ونصف قطر الزاوية السفلى إلى `65%`.

# --hints--

يجب أن تعطي `.penguin-head` الـ `border-radius` بقيمة `70% 70% 65% 65%`.
