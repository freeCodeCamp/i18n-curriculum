...
Benutze schließlich `querySelector()` um das `#monsterHealth`-Element zu erhalten. Da du bereits eine `monsterHealth`-Variable deklariert hast, musst du für dieses Element einen anderen Variablenamen verwenden.
...
Deine `monsterHealthText`-Variable sollte den Wert deines `#monsterHealth`-Elements besitzen.
