...
Ви створили калькулятор траєкторії снаряда.

Тепер, щоб завершити, змініть код, який ви написали поза межами класів, і включіть його у невелику допоміжну функцію під назвою `projectile_helper`, яка прийматиме потрібні значення швидкості, висоти та кута і послідовно виводитиме в термінал деталі снаряда, таблицю координат і графік траєкторії.

Викличте `projectile_helper` один раз із значеннями на ваш вибір.

# --hints--

Ви повинні створити `projectile_helper` у глобальній області видимості.
...
Ви повинні виводити запитані рядки у правильному порядку. Не виводьте інші значення.
...
Ви повинні викликати функцію `projectile_helper` принаймні один раз.
...
У глобальній області видимості не повинно бути змінних або викликів print.
