...
*La distancia de Levenshtein entre "**rosettacode**" y "**raisethysword**" es **8**.*

*La distancia entre dos cadenas es la misma que cuando ambas cadenas están invertidas.*
