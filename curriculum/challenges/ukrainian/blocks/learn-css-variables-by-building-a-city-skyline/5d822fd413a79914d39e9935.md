...
Додайте ще один повторюваний градієнт до цієї будівлі; зробіть його таким самим, як той, що ви щойно додали, але не додавайте напрямок `90deg` і використовуйте колір вікна замість двох кольорів `transparent`.
...
Ви повинні дати другому `repeating-linear-gradient` перший колір `--building-color3` від `0%` до `10%`.
...
Ви повинні дати другому `repeating-linear-gradient` другий колір `--window-color3` від `10%` до `30%`.
