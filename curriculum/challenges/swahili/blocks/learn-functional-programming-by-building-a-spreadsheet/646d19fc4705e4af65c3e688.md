...
Kitendakazi chako cha `addCharacters` hatimaye hurejesha safu ya herufi. Unataka kirejeshe safu ya nambari za seli. Unganisha njia ya `.map()` na wito lako la `charRange()`. Usipitisha kitendakazi cha mwitiko bado.

# --hints--

Unapaswa kuunganisha `.map()` na wito lako la `charRange()`.
...
Hupaswi kupitisha chochote kwa wito lako la `.map()`.
