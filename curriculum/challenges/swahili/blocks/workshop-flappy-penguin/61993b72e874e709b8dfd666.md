...
Lenga kipengele cha `.penguin-head`, na kimpatie `width` nusu ya `45%` ya mzazi wake, na `height` ya `45%`. Kisha, weka `background` kuwa mwelekeo wa mstari wa mviringo kuanzia `gray` hadi `rgb(239, 240, 228)` katika `45deg`.
