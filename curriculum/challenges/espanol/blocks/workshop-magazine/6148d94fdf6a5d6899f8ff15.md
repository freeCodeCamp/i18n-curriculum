...
Dar al selector `.text-with-images` una propiedad `margin-bottom` establecida en `3rem`.

# --hints--

Tu selector `.text-with-images` debe tener una propiedad `margin-bottom` establecida en `3rem`.
