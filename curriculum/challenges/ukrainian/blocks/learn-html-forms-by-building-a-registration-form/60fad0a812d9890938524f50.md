...
Щоб дати учасникам уявлення про те, що написати у своєму біо, використовується атрибут `placeholder`. `placeholder` приймає текстове значення, яке відображається, доки користувач не почне вводити текст.

Надайте `textarea` атрибут `placeholder` зі значенням `I like coding on the beach...`.
