...
Оголосіть функцію `checkForStraights`, яка приймає масив чисел. Якщо користувач отримує велику чергу, оновіть п’ятий перемикач на рахунок `40`. Якщо користувач отримує малу чергу, оновіть четвертий перемикач на рахунок `30`. Regardless, it should always update the last radio button to display a score of 0, with the correct attributes.
