...
In this dialogue, Anna does not think using the stipend for office furniture is a good idea. She uses `I don't think so, Bob` to express her disagreement. 这是另一个示例：
