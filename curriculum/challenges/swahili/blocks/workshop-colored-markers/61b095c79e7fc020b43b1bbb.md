...
Kwa hoja ya rangi ya pili, tumia msimbo wa rangi wa hex wenye thamani `71` kwa nyekundu, `F5` kwa kijani, na `3E` kwa buluu.

# --hints--

Kanuni yako ya `.green` CSS inapaswa kuwa na sifa ya `background` iliyowekwa kuwa `linear-gradient(180deg, #55680D, #71F53E)`.
