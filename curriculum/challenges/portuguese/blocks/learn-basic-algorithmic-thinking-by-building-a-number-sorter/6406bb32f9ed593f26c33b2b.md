...
Lembre-se que o método `.getElementsByClassName()` retorna um <dfn>HTMLCollection</dfn>, que é um objeto semelhante a um array de todos os elementos que possuem um nome de classe correspondente.Você pode usar o operador spread para convertê-lo em um array.
