...
Adicione um novo seletor `#piano` em sua `@media` query e defina `width` como `358px`.

# --hints--

A regra `@media` deve ter um seletor `#piano`.
...
O novo seletor `#piano` deve ter uma `width` de `358px`.
