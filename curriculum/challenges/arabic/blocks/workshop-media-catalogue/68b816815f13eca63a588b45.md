...
docstring هي سلسلة نصية توضع كأول بيان في صنف أو دالة، وتُستخدم لتوفير توثيق لذلك الصنف أو الدالة. عادةً ما تُحاط docstrings بثلاث علامات اقتباس مزدوجة:
...
أكمل صنف `Movie` الخاص بك بإضافة docstring التالية إليه: `Parent class representing a movie.`

# --hints--

يجب أن تضيف docstring `Parent class representing a movie.` إلى صنف `Movie` الخاص بك.
