...
Você não deve remover a classe `bb1a`.

```js
assert.exists(document.querySelector('div.bb1a'));
```

Você deve adicionar a classe `bb1-window` ao elemento `.bb1a`.

```js
assert.exists(document.querySelector('div.bb1a.bb1-window'));
```

Você não deve remover a classe `bb1b`.

```js
assert.exists(document.querySelector('div.bb1b'));
```

Você deve adicionar a classe `bb1-window` ao elemento `.bb1b`.

```js
assert.exists(document.querySelector('div.bb1b.bb1-window'));
```

Você não deve remover a classe `bb1c`.

```js
assert.exists(document.querySelector('div.bb1c'));
```

Você deve adicionar a classe `bb1-window` ao elemento `.bb1c`.

```js
assert.exists(document.querySelector('div.bb1c.bb1-window'));
```

Você não deve alterar o elemento `.bb1d`.
