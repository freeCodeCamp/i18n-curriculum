...
Fügen Sie die x- und y-Achsen zum Diagramm hinzu, um die folgende Ausgabe zu erhalten:
...
Die Symbole sind als `x_axis_tick` und `y_axis_tick` verfügbar.

# --hints--

Die Methode sollte die korrekte Ausgabe zurückgeben.
...
Die Methode sollte für verschiedene Instanzen die korrekte Ausgabe zurückgeben.
