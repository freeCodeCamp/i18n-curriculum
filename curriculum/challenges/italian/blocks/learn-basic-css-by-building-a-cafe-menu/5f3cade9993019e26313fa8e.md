...
Ora che sai che funziona, puoi modificare gli elementi `article` e `p` rimanenti per farli corrispondere al primo insieme. Inizia aggiungendo la classe `item` agli altri elementi `article`.
...
I tuoi elementi `.item` dovrebbero essere i tuoi elementi `article`.
