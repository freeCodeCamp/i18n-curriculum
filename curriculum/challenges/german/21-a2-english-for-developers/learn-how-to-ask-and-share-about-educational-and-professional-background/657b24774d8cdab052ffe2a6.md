...
Dieses Wort beschreibt, sich selber Wissen oder Fähigkeiten anzueignen. Es besteht aus zwei Teilen: der erste bedeutet `own` oder `personal` und der zweite bezieht sich auf Lernen oder Bildung.
