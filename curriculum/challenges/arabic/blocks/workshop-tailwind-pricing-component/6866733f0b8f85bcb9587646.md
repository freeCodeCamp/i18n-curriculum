...
يجب أن تكون بطاقة التسعير المميزة هي الأكثر بروزًا على الصفحة. كما أنها البطاقة الوحيدة التي ستحتوي على شارة `Most popular`. لجعل هذه البطاقة وشارتها تبرزان، يمكنك استخدام فئات المرافق الخاصة بالتحديد النسبي والتكبير في Tailwind.

إليك كيف تجعل عنصرًا أكبر باستخدام التكبير في Tailwind CSS:
...
سوف تتولى التحديد في الخطوات القادمة. الآن، عيّن الصنف `scale-105` على عنصر `div` الغلاف ليصبح أكبر قليلًا من بطاقات التسعير الأخرى.

# --hints--

يجب أن يحتوي عنصر `div` الغلاف الخاص بخطة المميزة على الصنف `scale-105`.
