...
Katika faili yako ya JavaScript, chagua kipengele cha `.story-container` na uhifadhi katika kigezo kinachoitwa `storyContainer`.

# --hints--

Unapaswa kuwa na kigezo cha `storyContainer`.

```js
assert.isDefined(storyContainer);
```

Unapaswa kuchagua kipengele cha `.story-container` kwa kutumia njia ya `querySelector` na kuuhifadhi katika kigezo cha `storyContainer`.
