...
Nakili na bandika darasa la `sky` lote pamoja na vigezo vyake na thamani zake ndani ya media query. Utaunda mpangilio mwingine wa rangi kwa skyline unaobadilisha kutoka mchana hadi usiku.

Kumbuka: Utahitaji kusogeza chini zaidi ya eneo la kuhariri ili kunakili darasa hilo.

# --hints--

Haupaswi kufuta tamko la `.sky` lililopo.
...
Unapaswa kunakili tamko la `.sky` lililopo ndani ya media query.
