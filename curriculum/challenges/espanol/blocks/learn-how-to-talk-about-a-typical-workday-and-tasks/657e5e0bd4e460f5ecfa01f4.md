...
En conversaciones, especialmente sobre reglas o procedimientos en el trabajo, `every` y `any` se usan para hablar de diferentes situaciones. `Every` se refiere a todos los elementos en un grupo, mientras que `any` a menudo se refiere a uno o más elementos en preguntas o frases negativas.
...
Esta palabra se usa para hablar de todos los elementos o situaciones en un grupo.
...
Esta palabra puede significar uno, algunos o todos, y se usa frecuentemente en preguntas.
