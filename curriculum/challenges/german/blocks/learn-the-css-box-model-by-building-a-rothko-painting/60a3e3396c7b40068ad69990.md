...
Verwenden Sie die gleiche `box-shadow`-Deklaration für `.two`, ändern Sie jedoch die Farbe von `#efb762` zu `#8f0401`.

# --hints--

Sie sollten die `box-shadow`-Eigenschaft auf `0 0 3px 3px #8f0401` setzen.
...
Ihr `.two`-Element sollte einen `box-shadow`-Wert von `0 0 3px 3px #8f0401` haben.
