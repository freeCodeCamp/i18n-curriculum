...
This is the contraction for `Who is`. A primeira letra é maiúscula.

# --explanation--

`Who's` is a contraction of `who is` and is used to ask about a person or people in the `Present Simple` tense. Por exemplo:
