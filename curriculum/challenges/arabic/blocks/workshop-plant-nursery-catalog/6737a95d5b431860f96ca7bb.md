...
جرّب الآن إضافة الكائن `ballerina` إلى `catalogSet` داخل دالتك مرة ثانية. سترى أنه لا يحدث شيء، لأن الكائن مخزن بالفعل في المجموعة ولا يُسمح بالعناصر المكررة في المجموعات.

إذا أردت، يمكنك التحقق من عدد العناصر في مجموعتك باستخدام الخاصية `size`، بنفس الطريقة التي استخدمتها سابقًا مع الخريطة.

# --hints--

يجب أن `add` كائن `ballerina` مرة ثانية إلى مجموعتك داخل الدالة `displayPlantsSet`.
