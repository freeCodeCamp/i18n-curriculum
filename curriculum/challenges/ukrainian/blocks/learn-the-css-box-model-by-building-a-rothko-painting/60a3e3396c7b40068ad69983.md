...
Встановіть `background-color` властивість елемента `.two` у значення `#8f0401`.

# --hints--

Ви повинні встановити властивість `background-color` у значення `#8f0401`.
...
Ваш елемент `.two` має мати властивість `background-color` зі значенням `#8f0401`.
