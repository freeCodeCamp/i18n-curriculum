...
Ndani ya `stats-grid`, ongeza vipengele viwili vya `div` kila kikiwa na `className` ya `form-group`.

Kwa cha kwanza, ongeza `label` yenye `className` ya `label`, `htmlFor` ya `pac` na maandishi ya `PAC`, kisha ingizo lenye `id` ya `pac`, `className` ya `input` na `type` ya `number`.

Na kwa cha pili, ongeza `label` yenye `htmlFor` ya `sho` na maandishi ya `SHO`, kisha ingizo lenye `id` ya `sho` na `type` ya `number`.

# --hints--

Unapaswa kuwa na vipengele viwili vya `div` kila kikiwa na `className` ya `form-group` ndani ya `div` ya `className` ya `stats-grid`.
...
Kipengele chako cha kwanza cha `div` chenye `className` ya `form-group` kinapaswa kuwa na `label` yenye sifa ya kipengele `htmlFor` ya `pac`, `className` ya `label`, na maandishi ya `PAC`.
...
Kipengele chako cha kwanza cha `div` chenye `className` ya `form-group` kinapaswa kuwa na `input` yenye `className` ya `input`, `id` ya `pac` na `type` ya `number`.
...
Kipengele chako cha pili cha `div` chenye `className` ya `form-group` kinapaswa kuwa na `label` yenye sifa ya kipengele `htmlFor` ya `sho`, `className` ya `label`, na maandishi ya `SHO`.
...
Kipengele chako cha pili cha `div` chenye `className` ya `form-group` kinapaswa kuwa na `input` yenye `id` ya `sho`, `className` ya `input` na `type` ya `number`.
