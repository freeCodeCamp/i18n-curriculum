...
Додайте `repeating-linear-gradient` до `.fb1c` під тим, що вже є; використайте свій `--building-color4` від `0%` до `10%` і `--window-color4` від `10%` і `90%`. Це заповнить фон позаду останнього доданого градієнта.
