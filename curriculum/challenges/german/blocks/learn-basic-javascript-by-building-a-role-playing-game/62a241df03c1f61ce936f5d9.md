...
Geben Sie als Nächstes Ihren `.stat`-Elementen eine `padding-right` von `10px`.

# --hints--

Sie sollten einen `.stat`-Selektor haben.
...
Ihr `.stat`-Selektor sollte eine `padding-right` von `10px` haben.
