...
Toa nafasi ya ndani ya kushoto na kulia ya `.note` kichaguzi ya `8px`, ukiondoa nafasi ya ndani ya juu na chini. Pia weka sifa ya `text-indent` kuwa `-8px`.

Kwa mabadiliko haya ya mwisho, lebo yako ya lishe itakuwa imekamilika!

# --hints--

Kichaguzi chako cha `.note` kinapaswa kuwa na sifa ya `padding` iliyowekwa kuwa `0 8px`.
...
Kichaguzi chako cha `.note` kinapaswa kuwa na sifa ya `text-indent` iliyowekwa kuwa `-8px`.
