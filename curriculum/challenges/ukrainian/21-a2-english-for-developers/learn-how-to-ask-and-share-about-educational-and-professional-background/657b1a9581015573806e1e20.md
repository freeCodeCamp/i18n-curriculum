...
Прослухайте діалог і заповніть пропуски правильними словами, які ви вивчили.
...
Це форма минулого часу `are`, що використовується для множини предметів.
...
Це форма минулого часу слова `is`, що використовується для позначення предметів однини.
...
Це слово означає спільну роботу в команді.
