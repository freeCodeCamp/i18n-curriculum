...
الآن، يجب أن تضيف بعض الحشو إلى الحاوية. عرّف `padding` على أنه `10px 20px`. بهذه الطريقة، تحدد حشوًا بقيمة `10px` في الأعلى والأسفل، و`20px` على اليسار واليمين.
...
عرّف الخاصية `padding` على أنها `10px 20px`.
