...
بعد ذلك، عيّن أصناف الأدوات `mt-6`، `space-y-2`، `text-sm`، و `text-gray-700` إلى العنصر `ul`.

# --hints--

يجب أن يحتوي العنصر `ul` على الصنف `mt-6`.
...
يجب أن يحتوي العنصر `ul` على الصنف `space-y-2`.
...
يجب أن يحتوي العنصر `ul` على الصنف `text-sm`.
...
يجب أن يحتوي العنصر `ul` على الصنف `text-gray-700`.
