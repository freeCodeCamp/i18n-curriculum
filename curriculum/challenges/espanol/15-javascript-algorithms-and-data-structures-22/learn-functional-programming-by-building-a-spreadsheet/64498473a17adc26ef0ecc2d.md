...
Tu función `idToText` actualmente devuelve un elemento `input`. Actualízala para que devuelva el `value` de ese elemento `input`.

# --hints--

Debes devolver la propiedad `value` del valor de retorno del método `.find()`.
