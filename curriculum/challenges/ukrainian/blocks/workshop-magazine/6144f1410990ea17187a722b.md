...
Тепер ви можете стилізувати макет сітки. CSS-сітка схожа на Flexbox тим, що має спеціальні властивості як для батьківського, так і для дочірнього елементів.

В цьому разі вашим батьківським елементом є елемент `main`. Надайте вмісту макет із трьох стовпчиків, додавши властивість `grid-template-columns` зі значенням `1fr 94rem 1fr`. Це створить три стовпчики, де середній стовпчик має ширину `94rem`, а перший та останній стовпчики займають 1 частку вільного місця в сітковому контейнері.

# --hints--

Ваша секція `main` повинна мати властивість `grid-template-columns` зі значенням `1fr 94rem 1fr`.
