...
Em seguida, adicione outra chamada `print()` e passe a string `'2. Liste todas as despesas`

# --hints--

Você deve imprimir `'2. Liste todas as despesas em seu `while` loop após as chamadas existentes de `print()`.
