...
استخدام حروف الجر الصحيحة في سياق الروتين اليومي ضروري للتواصل الواضح.

يُستخدم `At` للأوقات المحددة. على سبيل المثال، `I start work at 9:00`.

يُستخدم `After` لمتتاليات الأفعال. على سبيل المثال، `I have lunch after the meeting`.

يُستخدم `To` للدلالة على الاتجاه أو الوجهة. على سبيل المثال، `I go to the office by bus`.

# --instructions--

استمع إلى الصوت لفهم السياق. اكتب حروف الجر الصحيحة لإكمال الجمل عن روتين سارة الصباحي.
...
يُستخدم هذا حرف الجر لتحديد وقت.
...
يُستخدم هذا حرف الجر لمتتاليات الأفعال.
...
يدل هذا حرف الجر على الاتجاه أو الوجهة.
