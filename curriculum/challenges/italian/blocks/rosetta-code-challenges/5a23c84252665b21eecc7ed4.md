...
title: Problema dello zaino illimitato
challengeType: 1
forumTopicId: 323655
...
Un viaggiatore viene deviato e deve fare una sosta non programmata in quello che si rivela essere Shangri-La. Decidendo di andarsene, gli viene permesso di prendere quanto vuole degli oggetti disponibili, purché entrino nel suo zaino e lui possa trasportarli.

Sa di non poter trasportare un peso massimo totale superiore a un certo valore; e che la capacità del suo zaino ha un volume limitato.

Guardando appena sopra i codici a barre sugli oggetti, trova i loro pesi e volumi. Tira fuori la sua copia recente di un giornale finanziario e ottiene il valore di ogni oggetto.

Può prendere solo unità intere di ogni oggetto, ma ce ne sono molti più di quanti ne potrebbe mai trasportare.

# --instructions--

Scrivi una funzione che prenda come parametri un array di oggetti, il peso massimo e il volume massimo. Ogni oggetto ha 4 attributi: name, value, weight e volume. La funzione dovrebbe restituire il valore massimo degli oggetti che il viaggiatore può portare con sé.
