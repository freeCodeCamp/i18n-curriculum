...
Baada ya mzunguko wako wa `for` kumalizika, unahitaji kurudisha safu ya data. Kisha unapaswa kuweza kuona mabadiliko ya `Output` unapobofya kitufe cha `Sort` tena.

# --hints--

Unapaswa `return` `array`.
