...
Додайте класи `text-4xl`, `font-bold` і `text-white` до елемента `p`, який містить текст ціни, щоб зробити його більш помітним.
...
Ваш елемент `p` має мати клас `text-white`.
