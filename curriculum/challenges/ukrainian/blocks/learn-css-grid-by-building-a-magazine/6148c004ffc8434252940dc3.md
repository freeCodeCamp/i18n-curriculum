...
Створіть селектор `.social-icons`. Надайте йому множину властивостей `display` зі значенням `grid` та множину властивостей `font-size` зі значенням `3rem`.

# --hints--

У вас має бути селектор `.social-icons`.

```js
assert(new __helpers.CSSHelp(document).getStyle('.social-icons'));
```

Ваш селектор `.social-icons` має мати множину властивостей `display` зі значенням `grid`.

```js
assert(new __helpers.CSSHelp(document).getStyle('.social-icons')?.display === 'grid');
```

Ваш селектор `.social-icons` має мати множину властивостей `font-size` зі значенням `3rem`.
