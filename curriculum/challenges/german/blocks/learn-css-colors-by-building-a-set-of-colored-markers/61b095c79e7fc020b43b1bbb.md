...
Für das zweite Farbargument verwenden Sie einen Hex-Farbcode mit den Werten `71` für Rot, `F5` für Grün und `3E` für Blau.

# --hints--

Ihre `.green`-CSS-Regel sollte eine `background`-Eigenschaft mit dem Wert `linear-gradient(180deg, #55680D, #71F53E)` haben.
