...
`Have to` ni usemi wa kihesabu unaotumika kudhihirisha lazima au wajibu, hasa katika muktadha wa kazi. Kwa mfano:

`You have to wear a helmet on the construction site.` - Hii ina maana kwamba kuvaa kofia ni sheria muhimu ya usalama.
...
Maneno haya mawili hutumika kuonyesha kitendo kinachohitajika. 
