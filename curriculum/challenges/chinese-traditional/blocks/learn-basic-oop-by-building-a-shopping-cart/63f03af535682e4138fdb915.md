...
將 `totalNumberOfItems`、`cartSubTotal`、`cartTaxes` 和 `cartTotal` 項目的 `textContent` 全部設為數字 `0`。

# --hints--

你應該將 `totalNumberOfItems` 元素的 `textContent` 設為 `0`。
...
你應該將 `cartSubTotal` 元素的 `textContent` 設為 `0`。
...
你應該將 `cartTaxes` 元素的 `textContent` 設為 `0`。
...
你應該將 `cartTotal` 元素的 `textContent` 設定為 `0`。
