...
Ili kufanya vipengele vya `input` na `textarea` viendane na mandhari ya nyuma, weka `background-color` yao kuwa `#0a0a23`. Kisha, wape `1px`, mpaka wa `solid` wenye rangi ya `#0a0a23`.

# --hints--

Unapaswa kutumia kichaguzi cha vipengele kilichotenganishwa kwa koma kuchagua vipengele vya `input` na `textarea`.
...
Unapaswa kuwapa vipengele vya `input` na `textarea` `background-color` ya `#0a0a23`.
...
Unapaswa kuwapa vipengele vya `input` na `textarea` mpaka wa `1px`, `solid` wenye rangi ya `#0a0a23`.
