...
title: 'Завдання 303: Кратні з малими цифрами'
challengeType: 1
forumTopicId: 301957
...
Для додатного цілого числа $n$ визначимо $f(n)$ як найменше додатне кратне $n$, яке у десятковій системі числення містить лише цифри, що не перевищують 2.
