...
`Frustrated` means feeling annoyed, upset, or disappointed because of difficulties or obstacles. Por ejemplo:
...
`Access` means the ability to use or connect to something, especially technology or information. Por ejemplo:
