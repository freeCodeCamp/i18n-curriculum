...
Cuando reasigna una variable, puede utilizar la variable para referenciar el valor anterior antes de la reasignación. Esto te permite hacer cosas como añadir tres a un número existente. Por ejemplo, `bees = bees + 3;` aumentaría el valor de `bees` en tres.
