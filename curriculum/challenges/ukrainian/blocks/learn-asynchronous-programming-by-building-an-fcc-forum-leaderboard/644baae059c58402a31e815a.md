...
Якщо `id` не знаходиться в об’єкті `allCategories`, потрібно відобразити категорію `General`.

Під вашою інструкцією `if` додайте умову `else`.

# --hints--

У вас має бути умова `else` під інструкцією `if`.
