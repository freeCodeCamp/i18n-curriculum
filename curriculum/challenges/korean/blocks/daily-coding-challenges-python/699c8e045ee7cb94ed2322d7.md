...
정수 `n`가 주어질 때, 여기서 `n`은 1부터 1000 사이(포함)입니다, π의 `n`번째 소수 자리를 반환하세요.

- 문자열이 아닌 숫자를 반환해야 합니다.

π의 처음 다섯 소수 자리는 3.14159입니다. 예를 들어 `5`가 주어지면 다섯 번째 소수인 `9`를 반환하세요.

π의 처음 1000자리 소수를 어디선가 찾아야 할 수도 있습니다.
