...
Додайте властивість `transition` до селектора `.card-links a` і надайте їй значення `background-color 0.3s ease`.

# --hints--

Селектор `.card-links a` має мати властивість `transition`, встановлену в `background-color 0.3s ease`.
