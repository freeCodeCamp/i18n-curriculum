...
Un inner join es una operación que combina dos tablas de datos en una sola tabla, basada en valores coincidentes de columnas. La forma más sencilla de implementar esta operación es el algoritmo nested loop join, pero una alternativa más escalable es el algoritmo hash join.

El algoritmo de "hash join" consiste en dos pasos:
...
En pseudo-código, el algoritmo podría expresarse de la siguiente manera:
...
Implementa el algoritmo "hash join" como una función y demuestra que pasa el caso de prueba listado a continuación. La función debe aceptar dos arreglos de objetos y devolver un arreglo de objetos combinados.
...
A_edadA_nameB_caracterB_nemesis
| ----- | ------ | ----------- | --------- |
27JonahJonahBallenas
27JonahJonahArañas
18AlanAlanFantasmas
18AlanAlanZombis
28GloriaGloriaBuffy
...
`hashJoin` debería ser una función.

```js
assert(typeof hashJoin === 'function');
```

`hashJoin([{ age: 27, name: "Jonah" }, { age: 18, name: "Alan" }, { age: 28, name: "Glory" }, { age: 18, name: "Popeye" }, { age: 28, name: "Alan" }], [{ character: "Jonah", nemesis: "Whales" }, { character: "Jonah", nemesis: "Spiders" }, { character: "Alan", nemesis: "Ghosts" }, { character:"Alan", nemesis: "Zombies" }, { character: "Glory", nemesis: "Buffy" }, { character: "Bob", nemesis: "foo" }])` debería devolver `[{"A_age": 27,"A_name": "Jonah", "B_character": "Jonah", "B_nemesis": "Whales"}, {"A_age": 27,"A_name": "Jonah", "B_character": "Jonah", "B_nemesis": "Spiders"}, {"A_age": 18,"A_name": "Alan", "B_character": "Alan", "B_nemesis": "Ghosts"}, {"A_age": 18,"A_name": "Alan", "B_character": "Alan", "B_nemesis": "Zombies"}, {"A_age": 28,"A_name": "Glory", "B_character": "Glory", "B_nemesis": "Buffy"}, {"A_age": 28,"A_name": "Alan", "B_character": "Alan", "B_nemesis": "Ghosts"}, {"A_age": 28,"A_name": "Alan", "B_character": "Alan", "B_nemesis": "Zombies"}]`
