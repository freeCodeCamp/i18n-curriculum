...
# --description--
Las cadenas tienen un método <dfn>.match()</dfn>, que toma un argumento de regex. `.match()` will return an array of match results – containing either the first match, or all matches if the global flag is used.
