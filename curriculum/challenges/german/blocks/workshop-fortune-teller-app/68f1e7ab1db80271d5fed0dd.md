...
Prüfen Sie, ob `cardElement` falsy ist, und geben Sie in diesem Fall ohne Anzeige einer Nachricht zurück.

# --hints--

Sie sollten eine `if`-Anweisung mit der Bedingung `!cardElement` haben.
