...
A maneira mais fácil de instalar Python no Windows e Mac é baixar o instalador do site oficial do Python. Também abordaremos como executar Python no Linux mais adiante nesta lição.
