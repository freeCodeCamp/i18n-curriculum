...
El `span` que tiene la duración también necesita algo de estilo, así que agrega las clases `text-base`, `font-medium` y `text-fuchsia-300` a él.
...
Tu elemento `span` debe tener la clase `text-fuchsia-300`.
