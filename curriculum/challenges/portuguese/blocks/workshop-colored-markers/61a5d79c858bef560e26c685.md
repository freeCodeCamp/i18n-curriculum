...
E como o terceiro argumento de cor, estabeleça a função `hsl` com os valores `240` para matiz, `56%` para saturação e `42%` para luz.

# --hints--

A regra do CSS `.blue` deve ter uma propriedade `background` definida para `linear-gradient(hsl(186, 76%, 16%), hsl(223, 90%, 60%), hsl(240, 56%, 42%))`.
