...
Перемістіть вашу функцію `goTown` вище за функцію `goStore`. Потім скопіюйте та вставте вміст функції `goStore` у функцію `goTown`.

# --hints--

Ваша функція `goTown` має йти перед функцією `goStore`.
...
Ваша функція `goTown` має містити той самий вміст, що й функція `goStore`.
