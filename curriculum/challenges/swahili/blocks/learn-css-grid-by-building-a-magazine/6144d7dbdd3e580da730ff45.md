...
Tengeneza kichaguzi cha `body`. Weka sifa ya `font-family` kuwa `Baskervville`, ukiwa na njia mbadala ya `serif`. Weka sifa ya `color` kuwa `linen` na sifa ya `background-color` kuwa `rgb(20, 30, 40)`.
...
Kichaguzi chako cha `body` kinapaswa kuwa na sifa ya `font-family` iliyowekwa kuwa `Baskervville`, ukiwa na njia mbadala ya `serif`.
...
Kichaguzi chako cha `body` kinapaswa kuwa na sifa ya `color` iliyowekwa kuwa `linen`.
