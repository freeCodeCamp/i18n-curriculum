...
Las listas desordenadas comienzan con un elemento de apertura `<ul>`, seguido de cualquier número de elementos `<li>`. Finalmente, las listas desordenadas se cierran con un `</ul>`.
