...
Debes utilizar el método <Code>document.getElementsByClassName</Code> para seleccionar todos los elementos con la clase "message" para asignarles una cadena mediante el método "textContent".
