...
Wähle nun dein `#piano`-Element mit einem `id`-Selektor aus. Setze den `background-color` Wert zu `#00471b`, die `width` Eigenschaft auf `992px` und die `height` Eigenschaft auf `290px`.
