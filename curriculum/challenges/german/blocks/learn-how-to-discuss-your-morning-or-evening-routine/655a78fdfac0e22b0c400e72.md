...
Es ist die Vergangenheitsform von `say`, die hier verwendet wird, um anzuzeigen, was Sophie zuvor erwähnt hat.
...
Dieses Wort beschreibt etwas, das nicht einfach ist. Es endet mit `-ed`.
...
Es bezieht sich auf die fortlaufende oder wiederholte Bewegung der Kinder. Es endet mit `-ing`.
