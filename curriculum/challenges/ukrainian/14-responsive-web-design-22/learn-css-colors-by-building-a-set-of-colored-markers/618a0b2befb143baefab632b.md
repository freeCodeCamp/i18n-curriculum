...
Notice that the red and cyan colors are very bright right next to each other. Цей контраст може відвертати увагу, якщо його надмірно використовувати на вебсайті, та може ускладнити читання тексту, якщо він розміщений на фоні з доповнюючих кольорів.

Краще вибрати один домінантний колір та використовувати його доповнюючий колір як акцент, щоб привернути увагу до певної інформації на сторінці.
