...
Unda sifa mpya ya kigezo chini ya sifa yako ya `--building-color1`. Ipe jina `--building-color2` na ipe thamani ya `#66cc99`. Kisha iweke kama `background-color` ya `.bb2`.

# --hints--

Unapaswa kufafanua sifa mpya ya kigezo inayoitwa `--building-color2`.
...
Unapaswa kuweka `background-color` ukitumia sifa ya kigezo ya `--building-color2`.
