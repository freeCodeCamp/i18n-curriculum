...
Rimuovi le chiamate `print` esistenti. Poi, come hai fatto prima per `v1`, stampa `v2` e il valore restituito da `v2.norm()`.

# --hints--

Non dovresti avere `print(v1)` e `print(v1.norm())` nel tuo codice.
...
Dovresti stampare `v2` e `v2.norm()`.
