...
الاختصار `he's` هو دمج بين الضمير `he` و الفعل `is`. يُستخدم للإشارة إلى شخص ذكر ووصف شيء عنه.
...
يُستخدم هذا الاختصار لوصف وظيفة براين. الحرف الأول مكتوب بحرف كبير.
