...
Tengeneza usemi wa `if` unaochunguza kama `self` na `other` haziko katika darasa la vitu moja na urudishe `NotImplemented`.

# --hints--

Unapaswa kutengeneza usemi wa `if` unaochunguza kama `self` na `other` haziko katika darasa la vitu moja.
