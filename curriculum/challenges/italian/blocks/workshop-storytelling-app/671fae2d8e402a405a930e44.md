...
Aggiungi un listener per l'evento `click` a `scaryStoryBtn` e passagli la funzione `displayStory`. Poi, clicca il tuo pulsante e guarda l'output nella console.

# --hints--

Dovresti aggiungere un listener per l'evento `click` a `scaryStoryBtn` passandogli la funzione `displayStory`.
