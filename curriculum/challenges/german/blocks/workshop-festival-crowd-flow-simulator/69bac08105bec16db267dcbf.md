...
Loggen Sie als Nächstes die folgende Nachricht in der Konsole: `gate.queue[tickIndex] + " attendees arriving."`.

# --hints--

Ihre `handleGateAtTick`-Funktion sollte die folgende Nachricht in der Konsole loggen: `gate.queue[tickIndex] + " attendees arriving."`.
...
Ihre `handleGateAtTick`-Funktion sollte die korrekte Anzahl der Teilnehmer basierend auf der Warteschlange am Tor zum angegebenen tickIndex loggen.
