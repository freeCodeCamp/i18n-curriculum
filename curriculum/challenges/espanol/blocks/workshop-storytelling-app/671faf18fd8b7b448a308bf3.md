...
Para diferenciar entre los diferentes tipos de historias, necesitarás pasar el género de la historia seleccionada a la función `displayStory`.

Añade un parámetro llamado `genre` a la función `displayStory`.

# --hints--

Debes añadir el parámetro `genre` a la función `displayStory`.
