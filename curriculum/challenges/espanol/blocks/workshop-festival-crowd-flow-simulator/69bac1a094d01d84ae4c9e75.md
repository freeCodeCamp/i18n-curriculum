...
Esta variable se usará para recorrer todos los ticks en tu simulación y asegurar que cada compuerta se procese en el orden correcto.

# --hints--

Debes crear una variable llamada `tickIndex` y asignarle un valor de `0`.
