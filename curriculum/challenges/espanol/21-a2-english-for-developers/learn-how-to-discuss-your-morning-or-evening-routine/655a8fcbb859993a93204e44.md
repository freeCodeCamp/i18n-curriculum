...
Intenta escuchar la preposición.
...
Usado para introducir cómo se hace algo.
...
La forma gerundio de `listen`, usada aquí después de la conjunción `or` para describir otro método de relajación.
