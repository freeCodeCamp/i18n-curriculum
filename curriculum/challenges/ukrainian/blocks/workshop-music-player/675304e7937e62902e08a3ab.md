...
Тепер викличте функцію `setPlayButtonAccessibleText` всередині функції `playSong`.

# --hints--

Ви повинні викликати функцію `setPlayButtonAccessibleText` всередині функції `playSong`.
