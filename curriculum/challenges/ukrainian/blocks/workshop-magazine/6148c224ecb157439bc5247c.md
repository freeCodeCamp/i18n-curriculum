...
Заводські параметри CSS-сітки створюватимуть додаткові рядки за потреби, на відміну від Flexbox. Надайте селектору `.social-icons` властивість `grid-template-columns` зі значенням `repeat(5, 1fr)`, щоб впорядкувати іконки в одному рядку.

# --hints--

Ваш селектор `.social-icons` повинен мати властивість `grid-template-columns` зі значенням `repeat(5, 1fr)`.
