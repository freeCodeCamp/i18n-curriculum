...
All'interno della funzione `fetchMoreAuthors`, imposta le variabili `startingIndex` e `endingIndex` a `+= 8` ciascuna.
...
Dovresti impostare la variabile `startingIndex` a `+=8`.
