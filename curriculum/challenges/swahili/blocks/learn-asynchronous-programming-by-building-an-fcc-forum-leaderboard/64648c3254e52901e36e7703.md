...
Ndani ya kipengele cha `div`, fanya wito wa kitendakazi cha `avatars` na pita hoja za `posters` na `users`.

Sasa unapaswa kuona picha za watumiaji zikiwekwa kwenye ukurasa.

# --hints--

Unapaswa kuita kitendakazi chenye jina `avatars`.
...
Wito wa kitendakazi chako unapaswa kuwa na hoja za `posters` na `users`.
