...
Hora de estilizar os elementos `fieldset` para dar a eles uma borda distinta.

Selecione o elemento `fieldset`. Defina seu `border` para `1px solid gray`, `border-radius` para `5px`, `margin` para `20px 0` e `padding` para `20px`.

# --hints--

Você deve direcionar o elemento `fieldset`.
...
Defina a propriedade `margin` para `20px 0`.
...
Defina a propriedade `padding` para `20px`.
