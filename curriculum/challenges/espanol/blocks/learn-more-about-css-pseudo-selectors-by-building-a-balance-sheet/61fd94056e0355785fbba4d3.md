...
Dentro del segundo `tr`, agrega un elemento `th` con el texto `Expenses Annual anticipated expenses, such as payroll.`. Envuelve ese texto, excepto `Expenses `, dentro de un elemento `span` con el `class` establecido en `description`.
...
Su elemento `th` debe tener el texto `Expenses Annual anticipated expenses, such as payroll.`.
...
Debe envolver el texto `Annual anticipated expenses, such as payroll.` en un elemento `span`.
