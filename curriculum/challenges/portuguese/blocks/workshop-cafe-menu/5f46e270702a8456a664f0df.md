...
Para remover um pouco do espaço vertical entre o elemento `h1` e o texto `Est. 2020`, altere a margem inferior de `h1` para `15px`.

# --hints--

Você deve definir o valor da propriedade `margin-bottom` para `15px`.
...
O elemento `h1` deve ter uma `margin-bottom` de `15px`.
