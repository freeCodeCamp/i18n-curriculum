...
Excelente.  Your red marker is looking good. Agora tudo o que você precisa fazer é adicionar as tampas e capas aos seus outros marcadores.

Adicione uma tampa e capa para os marcadores verde e azul. Você pode copiar os elementos `div` do marcador vermelho e colá-los nos outros dois marcadores.

# --hints--

Seu marcador verde `div` deve conter dois elementos `div`.
...
Seu marcador azul `div` deve conter dois elementos `div`.
