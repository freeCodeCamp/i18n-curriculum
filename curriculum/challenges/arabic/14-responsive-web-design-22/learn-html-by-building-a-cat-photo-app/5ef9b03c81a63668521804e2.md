...
تستخدم النماذج عادة خانات اختيار (checkboxes) للأسئلة التي قد تحتوي على أكثر من إجابة واحدة. The `input` element with a `type` attribute set to `checkbox` creates a checkbox.
