...
If you want to create a negative sentence using the verb `to be` in the past, simply  add `not` after `was` or `were`. Hier ein Beispiel:
...
Dieses Wort wird benutzt, um eine negative Aussage in der Vergangenheit zu machen.
