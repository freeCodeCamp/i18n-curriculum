...
title: 'Aufgabe 381: (prime-k) Fakultät'
challengeType: 1
forumTopicId: 302045
...
Da $872\bmod (7) = 4$ ist, gilt $S(7) = 4$.

Es kann überprüft werden, dass $\sum S(p) = 480$ für $5 ≤ p &lt; 100$ gilt.

Finden Sie $\sum S(p)$ für $5 ≤ p &lt; {10}^8$.
