...
Agora teste a classe `Email` criando um objeto de email e verificando se ele armazena as informações corretamente. Você vai imprimir alguns atributos para verificar se tudo funciona.
