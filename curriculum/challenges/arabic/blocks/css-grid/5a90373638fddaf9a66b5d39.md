...
title: استخدام grid-row للتحكم في التباعد
challengeType: 0
...
بالطبع، يمكنك جعل العناصر تستهلك عدة صفوف تمامًا كما تفعل مع الأعمدة. تحدد الخطوط الأفقية التي تريد أن يبدأ عندها العنصر ويتوقف عندها باستخدام الخاصية `grid-row` على عنصر شبكي.

# --instructions--

اجعل العنصر الذي يحمل الصنف `item5` يستهلك الصفين الأخيرين.

# --hints--

يجب أن يحتوي الصنف `item5` على خاصية `grid-row`.
...
يجب أن يحتوي الصنف `item5` على خاصية `grid-row` تجعل العنصر يستهلك الصفين الأخيرين من الشبكة.
