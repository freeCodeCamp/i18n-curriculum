...
Ahora, elimina ambas llamadas `print(lin_eq.solve())` y `print(lin_eq.analyze())` de tu código.

# --hints--

Debes eliminar tanto tus llamadas `print(lin_eq.solve())` como `print(lin_eq.analyze())`.
