...
Você deve atribuir a referência da função `goCave` a `button2.onclick`.Certifique-se de não chamar a função.
...
Você deve atribuir a referência da função `fightDragon` a `button3.onclick`.Certifique-se de não chamar a função.
