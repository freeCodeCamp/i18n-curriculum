...
`Regulation` is a rule made by a government or another authority. `Regulations` is the plural form, and it means a set of rules. These rules are important to follow in many jobs. Наприклад, `Health regulations in restaurants are important for customer safety`.
