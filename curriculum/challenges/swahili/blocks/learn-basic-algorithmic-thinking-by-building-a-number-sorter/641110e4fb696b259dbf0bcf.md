...
Kwa algoriti hii, utahitaji kutumia mzunguko wa `while`. Mzunguko huu unahitaji masharti mawili:

- Kwanza, haupaswi kuendelea zaidi ya mwanzo wa safu ya data (ilifikiliwa na `j`).
- Pili, mzunguko haupaswi kuendelea baada ya kupata thamani ndogo kuliko thamani ya sasa.

Ili kuzuia mzunguko usioisha, punguza `j` ndani ya mzunguko wako.
...
Mzunguko wako wa `while` unapaswa kuwa na sharti la kwanza linalokagua kama thamani ya `j` ni kubwa au sawa na `0`.
...
Mzunguko wako wa `while` unapaswa kutumia kielekezi AND.
...
Mzunguko wako wa `while` unapaswa kuwa na sharti linalokagua kama thamani ya `array[j]` ni kubwa kuliko `currValue`.
...
Mzunguko wako wa `while` unapaswa kupunguza `j` ndani ya mzunguko.
