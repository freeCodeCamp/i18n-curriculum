...
`To be short on something` bedeutet, nicht genug davon zu haben, was Schwierigkeiten verursacht. Zum Beispiel:

`We're short on time, so we need to finish quickly.` – Das bedeutet, dass nicht genug Zeit vorhanden ist, um alles zu erledigen.
