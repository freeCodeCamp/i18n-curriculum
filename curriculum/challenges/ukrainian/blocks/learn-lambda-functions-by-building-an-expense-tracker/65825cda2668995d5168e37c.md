...
Створіть ще одну умову `elif`, яка перевіряє, чи `choice == '4'`. Усередині нової `elif` оголосіть змінну `category` і призначте їй `input('Enter category to filter: ')` для фільтрації категорії витрат.

# --hints--

Ви повинні створити умову `elif`, яка перевіряє, чи `choice == '4'`.
...
Ви повинні оголосити змінну з ім’ям `category` у вашій новій умові `elif`.
...
Ви повинні призначити `input('Enter category to filter: ')` вашій змінній `category`.
