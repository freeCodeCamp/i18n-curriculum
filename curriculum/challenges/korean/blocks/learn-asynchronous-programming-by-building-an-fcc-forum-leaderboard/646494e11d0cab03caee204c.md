...
프로젝트가 거의 완성되었습니다. 마지막 한 부분만 남았습니다.

사용자가 어떤 게시물 제목이든 클릭하면 실제 게시물로 이동할 수 있어야 합니다 [freeCodeCamp forum](https://forum.freecodecamp.org/)에서.

먼저 첫 번째 `td` 요소 안에 있는 기존 단락 요소를 앵커 요소로 바꾸세요.
