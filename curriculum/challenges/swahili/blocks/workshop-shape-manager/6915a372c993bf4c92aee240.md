...
Sasa, tengeneza kitendakazi cha `initializeApp` na uache tupu kwa sasa.

Hii itaanzisha programu nzima mara tu DOM itakapopakuliwa. Hivyo, ni kitendakazi utakachotuma hivi karibuni katika tukio la `DOMContentLoaded` litakalofanya programu ifanye kazi.

# --hints--

Unapaswa kutengeneza kitendakazi cha `initializeApp`.
