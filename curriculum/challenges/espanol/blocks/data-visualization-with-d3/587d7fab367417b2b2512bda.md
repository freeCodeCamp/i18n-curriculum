...
En D3, hay escalas para ayudar a graficar datos. Las `scales` son funciones que le indican al programa cómo mapear un conjunto de puntos de datos sin procesar sobre los píxeles del SVG.
