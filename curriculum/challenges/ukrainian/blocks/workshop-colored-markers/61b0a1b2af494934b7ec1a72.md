...
Чудово. Ваш червоний маркер виглядає добре. Тепер усе, що потрібно зробити — це додати ковпачки та рукави до інших маркерів.

Додайте ковпачок і рукав до зеленого та синього маркерів. Ви можете просто скопіювати елементи `div` з червоного маркера і вставити їх у два інші маркери.

# --hints--

Ваш зелений маркер `div` має містити два елементи `div`.
...
Елемент ковпачка `div` зеленого маркера має бути перед елементом рукава `div`.
...
Ваш синій маркер `div` має містити два елементи `div`.
...
Елемент ковпачка `div` синього маркера має бути перед елементом рукава `div`.
