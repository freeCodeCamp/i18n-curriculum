...
title: 'Problema 477: gioco della sequenza di numeri'
challengeType: 1
forumTopicId: 302154
...
Due giocatori si alternano nei turni. Al suo turno, un giocatore deve scegliere e rimuovere o il primo o l’ultimo numero rimasto nella sequenza.

Il punteggio del giocatore è la somma di tutti i numeri che ha preso. Ogni giocatore cerca di massimizzare la propria somma.
...
- Giocatore 2: rimuove l’ultimo numero dalla sequenza rimanente (3)
- Giocatore 1: rimuove l’ultimo numero dalla sequenza rimanente (10)
...
Ti vengono dati $F(2) = 45$, $F(4) = 4\\,284\\,990$, $F(100) = 26\\,365\\,463\\,243$, $F(104) = 2\\,495\\,838\\,522\\,951$.
