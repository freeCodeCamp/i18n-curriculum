...
أنشئ عنصر `p` آخر، وأعطه النص `Calcium 260mg 20%`. اجعل `20%` محاذاة إلى اليمين. أسفله، أنشئ عنصر `p` بالنص `Iron 8mg 45%`، مع محاذاة `45%` إلى اليمين.

# --hints--

يجب أن تنشئ عنصرين جديدين من نوع `p` في نهاية عنصر `.daily-value` الخاص بك.
...
يجب أن يحتوي أول عنصر `p` جديد على النص `Calcium 260mg 20%`.
...
يجب أن يحتوي أول عنصر `p` جديد على عنصر `span`.
...
يجب ألا يكون أول عنصر `span` عريضًا.
...
يجب أن يغلف أول عنصر `span` النص `20%`.
