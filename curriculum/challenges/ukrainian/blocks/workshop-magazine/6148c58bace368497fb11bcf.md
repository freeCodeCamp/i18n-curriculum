...
Подібно до Flexbox, за допомогою CSS-сітки ви можете вирівнювати вміст елементів сітки завдяки `align-items` та `justify-items`. `align-items` вирівняє дочірні елементи вздовж осі стовпчика, а `justify-items` вирівняє дочірні елементи вздовж осі рядка.

Надайте селектору `.social-icons` властивість `align-items` зі значенням `center`.

# --hints--

Ваш селектор `.social-icons` повинен мати `align-items` зі значенням `center`.
