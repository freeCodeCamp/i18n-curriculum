...
Usare le preposizioni corrette nel contesto delle routine quotidiane è essenziale per una comunicazione chiara.

`At` si usa per indicare orari specifici. Per esempio, `I start work at 9:00`.

`After` si usa per sequenze di azioni. Per esempio, `I have lunch after the meeting`.

`To` si usa per indicare direzione o destinazione. Per esempio, `I go to the office by bus`.

# --instructions--

Ascolta l’audio per capire il contesto. Scrivi le preposizioni corrette per completare le frasi sulla routine mattutina di Sarah.
...
Questa preposizione si usa per sequenze di azioni.
...
Questa preposizione indica direzione o destinazione.
