...
У темі візуальної доступності контраст між елементами є ключовим фактором. Наприклад, коефіцієнт контрастності між текстом і фоном заголовка має бути не менше 4.5:1.

Змініть колір шрифту всіх елементів посилання всередині елементів списку на такий, що має коефіцієнт контрастності не менше 7:1.

# --hints--

Ваш селектор має націлюватися на посилання всередині елементів списку.
...
Ви маєте надати елементам `a`, які знаходяться всередині елементів списку, властивість `color`.
...
Ви маєте змінити колір лише елементів `a`, які знаходяться всередині елементів списку.
...
Ви маєте надати властивості `color` контраст із фоном не менше 7:1. _Підказка: я б використав `#dfdfe2`_
