...
أعلن عن متغير `cellRegex` لمطابقة مراجع الخلايا. يجب أن يطابق حرفًا من `A` إلى `J`، يليه رقم من `1` إلى `9`، ورقم اختياري من `0` إلى `9`. اجعل التعبير النمطي غير حساس لحالة الأحرف وعالميًا.

# --hints--

يجب إعلان متغير `cellRegex`.
