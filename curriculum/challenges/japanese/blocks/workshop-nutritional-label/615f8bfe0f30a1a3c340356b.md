...
もう一つ`p`要素を作成し、テキストに`Calcium 260mg 20%`を設定してください。`20%`を右揃えにします。その下に、テキストが`p`の`Iron 8mg 45%`要素を作成し、`45%`を右揃えにしてください。

# --hints--

`p`要素の最後に新しい`.daily-value`要素を2つ作成してください。
...
最初の新しい`p`要素にはテキスト`Calcium 260mg 20%`を設定してください。
