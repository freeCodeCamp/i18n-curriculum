...
Ative o editor interativo e interaja com o elemento `input` na janela de visualização digitando seu nome no campo.
...
Clique no texto `Full Name:` na janela de visualização e você verá o campo de entrada receber o foco. Para interagir com o exemplo, você precisará ativar o editor interativo.
...
Interaja com o elemento `input` na janela de visualização digitando um endereço de email falso como `jane@example.com`. Para interagir com o exemplo, você precisará ativar o editor interativo.
...
Habilite o editor interativo, clique no campo de email e comece a digitar um email e você verá o texto do placeholder desaparecer. 
