...
In previous lessons, you learned about the <dfn>Web Audio API</dfn> and how to use it to play songs. Усі сучасні браузери підтримують Веб Аудіо API, який дозволяє створювати та обробляти аудіо у вебзастосунках.
