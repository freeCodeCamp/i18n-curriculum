...
Inaonekana bado kuna matatizo fulani kuhusu matumizi ya vichwa vya sehemu kwenye ukurasa. Ukitazama kipengele cha kwanza cha `div`, kuna vipengele viwili vya `h4` vinavyotumika kama vichwa vidogo. Mazoezi bora ni kutumia vipengele vya `h3` kwa vichwa vidogo hivi kwa kuwa viko ngazi chini ya kipengele cha `h2`.

Badilisha vipengele viwili vya `h4` kuwa vipengele vya `h3`.

# --hints--

Kipengele chako cha `h4` chenye maandishi ya `Early Challenges` kinapaswa kuwa kipengele cha `h3`.
...
Kipengele chako cha `h4` chenye maandishi ya `Breakthroughs` kinapaswa kuwa kipengele cha `h3`.
