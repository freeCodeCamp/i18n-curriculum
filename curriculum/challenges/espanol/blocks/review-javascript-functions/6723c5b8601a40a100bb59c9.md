...
- Las funciones anónimas son funciones sin nombre que pueden asignarse a variables. Al asignarlas a variables, puedes reutilizarlas en cualquier lugar donde la variable sea accesible.
