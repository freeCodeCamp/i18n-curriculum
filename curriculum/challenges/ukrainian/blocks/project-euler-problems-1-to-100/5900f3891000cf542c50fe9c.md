...
title: 'Завдання 29: унікальні степені'
challengeType: 1
forumTopicId: 301941
...
Розглянемо всі цілі комбінації $a^b$ для 2 ≤ a ≤ 5 та 2 ≤ b ≤ 5:
...
Якщо їх упорядкувати за числовим значенням, видаливши повтори, отримаємо таку послідовність із 15 унікальних членів:

<div style='padding-left: 4em;'>
  4, 8, 9, 16, 25, 27, 32, 64, 81, 125, 243, 256, 625, 1024, 3125
</div>

Скільки унікальних членів у послідовності, утвореній $a^b$ для 2 ≤ `a` ≤ `n` та 2 ≤ `b` ≤ `n`?
