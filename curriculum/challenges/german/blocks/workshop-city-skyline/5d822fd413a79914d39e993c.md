...
Ändern Sie in der `sky`-Klasse der Media Query die beiden `#ffcf33`-Farbwerte zu `#ccc`, den `#ffff66` zu `#445` und den `#bbeeff` zu `#223`. Danach können Sie die Fenstergröße ändern, um die Hintergrundfarbenänderung zu sehen.

# --hints--

Sie sollten die ersten Farbwerte von `#ffcf33` zu `#ccc` ändern.
...
Sie sollten den zweiten Farbwert von `#ffff66` zu `#445` ändern.
...
Sie sollten den dritten Farbwert von `#bbeeff` zu `#223` ändern.
