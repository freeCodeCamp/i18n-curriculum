...
Desviaciones de cada datoCuadra el resultado
| ---------------------- | --------------------|
...
Escribe una función que tome un arreglo de números como parámetro y devuelva la <a href="https://rosettacode.org/wiki/Standard_deviation" target="_blank" rel="noopener noreferrer nofollow">desviación estándar</a> de la serie.
