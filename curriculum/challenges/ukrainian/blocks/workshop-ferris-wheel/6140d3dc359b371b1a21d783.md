...
Час розташувати кабіни навколо колеса. Виберіть перший `.cabin` елемент. Встановіть властивість `right` у значення `-8.5%` та властивість `top` у значення `50%`.

# --hints--

У вас має бути селектор `.cabin:nth-of-type(1)`.
...
Ваш селектор `.cabin:nth-of-type(1)` має мати властивість `right`, встановлену у значення `-8.5%`.
...
Ваш селектор `.cabin:nth-of-type(1)` має мати властивість `top`, встановлену у значення `50%`.
