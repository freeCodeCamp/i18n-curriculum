...
- SQL significa Structured Query Language, un lenguaje para comunicarse con bases de datos relacionales.
...
Esta consulta devolvería todos los usuarios porque la condición `OR '1'='1'` siempre es verdadera, lo que permite a los atacantes evitar las verificaciones de inicio de sesión.
...
Revisa los temas y conceptos de Bash y SQL.
