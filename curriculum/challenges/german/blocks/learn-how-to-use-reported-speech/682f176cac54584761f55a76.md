...
Das bedeutet, etwas als Teil eines größeren Ganzen einzubeziehen oder hinzuzufügen.

# --explanation--

`To incorporate` bedeutet, etwas einzubeziehen, sodass es Teil eines größeren Systems oder Plans wird. Zum Beispiel:

`The developer incorporated user feedback to improve the app's design.` – Das bedeutet, dass das Feedback als Teil der Designänderungen verwendet wurde.
