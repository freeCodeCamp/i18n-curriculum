...
Elimina las llamadas existentes a `print`. Luego, como hiciste antes con `v1`, imprime `v2` y el valor devuelto por `v2.norm()`.

# --hints--

No deberías tener `print(v1)` y `print(v1.norm())` en tu código.
