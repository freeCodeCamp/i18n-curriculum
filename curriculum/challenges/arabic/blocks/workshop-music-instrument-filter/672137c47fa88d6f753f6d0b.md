...
حاليًا، تُرجع دالة `instrumentCards` مصفوفة تحتوي على كائنات الآلات، لذا تحتاج إلى بضع خطوات إضافية قبل أن تعرض بطاقات الآلات على الصفحة.

عدّل دالتك لتُرجع مصفوفة من السلاسل النصية التي تحتوي على شفرة HTML لعرض بطاقات الآلات، بحيث تمثل كل سلسلة نصية كائنًا في مصفوفة `instruments`. يجب أن تكون السلاسل النصية بهذا التنسيق `<div class="card"><h2>[instrument]</h2><p>$[price]</p></div>`
...
يجب أن تُرجع `instrumentCards("all")` مصفوفة من السلاسل النصية التي تمثل بطاقات الآلات، كل منها بالتنسيق `<div class="card"><h2>[instrument]</h2><p>$[price]</p></div>`.
...
يجب أن تُرجع `instrumentCards("woodwinds")` مصفوفة من السلاسل النصية التي تمثل بطاقات الآلات، كل منها بالتنسيق `<div class="card"><h2>[instrument]</h2><p>$[price]</p></div>`.
...
يجب أن تُرجع `instrumentCards("brass")` مصفوفة من السلاسل النصية التي تمثل بطاقات الآلات، كل منها بالتنسيق `<div class="card"><h2>[instrument]</h2><p>$[price]</p></div>`.
...
يجب أن تُرجع `instrumentCards("percussion")` مصفوفة من السلاسل النصية التي تمثل بطاقات الآلات، كل منها بالتنسيق `<div class="card"><h2>[instrument]</h2><p>$[price]</p></div>`.
...
يجب أن تُرجع `instrumentCards("all")` مصفوفة تحتوي على عشر سلاسل نصية تمثل بطاقات الآلات لجميع الآلات على صفحتك.
...
يجب أن تُرجع `instrumentCards("woodwinds")` مصفوفة تحتوي على ثلاث سلاسل نصية تمثل بطاقات الآلات لآلات النفخ الخشبية على صفحتك.
...
يجب أن تُرجع `instrumentCards("brass")` مصفوفة تحتوي على ثلاث سلاسل نصية تمثل بطاقات الآلات لآلات النفخ النحاسية على صفحتك.
...
يجب أن تُرجع `instrumentCards("percussion")` مصفوفة تحتوي على أربع سلاسل نصية تمثل بطاقات الآلات لآلات الإيقاع على صفحتك.
