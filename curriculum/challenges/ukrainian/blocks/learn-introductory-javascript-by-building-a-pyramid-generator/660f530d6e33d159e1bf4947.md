...
Якщо ваша піраміда не перевернута, тоді вам потрібно мати `else` блок, який будує піраміду у звичайному порядку.

У попередніх кроках ви навчились працювати з `else` інструкцією, як-от ця:
