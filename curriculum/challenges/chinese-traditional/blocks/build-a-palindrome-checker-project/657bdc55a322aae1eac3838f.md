...
<dfn>回文</dfn>是指一個字或片語，忽略標點符號、大小寫和空格後，正讀和反讀皆相同。

**注意：** 你需要移除 **所有非英數字元**（標點符號、空格和符號），並將所有字元轉成相同大小寫（小寫或大寫），才能檢查迴文。

**目標：** 建置一個功能上類似於 <a href="https://palindrome-checker.freecodecamp.rocks" target="_blank" rel="noopener noreferrer nofollow">https://palindrome-checker.freecodecamp.rocks</a> 的應用程式。

**使用者故事：**

1. 你應該有一個 `input` 元素，其 `id` 為 `"text-input"`。
1. 你應該有一個 `button` 元素，其 `id` 為 `"check-btn"`。
1. 你應該有一個 `div`、`span` 或 `p` 元素，其 `id` 為 `"result"`。
1. 當你點擊 `#check-btn` 元素而未在 `#text-input` 元素中輸入任何值時，應該會出現一個提示，文字為 `Please input a value`。
1. 當 `#text-input` 元素只包含字母 `A` 且點擊 `#check-btn` 元素時，`#result` 元素應該包含文字 `A is a palindrome`。
1. 當 `#text-input` 元素包含文字 `eye` 且點擊 `#check-btn` 元素時，`#result` 元素應該包含文字 `eye is a palindrome`。
1. 當 `#text-input` 元素包含文字 `_eye` 且點擊 `#check-btn` 元素時，`#result` 元素應包含文字 `_eye is a palindrome`。
1. 當 `#text-input` 元素包含文字 `race car` 且點擊 `#check-btn` 元素時，`#result` 元素應該包含文字 `race car is a palindrome`。
1. 當 `#text-input` 元素包含文字 `not a palindrome` 且點擊 `#check-btn` 元素時，`#result` 元素應該包含文字 `not a palindrome is not a palindrome`。
1. 當 `#text-input` 元素包含文字 `A man, a plan, a canal. Panama` 且點擊 `#check-btn` 元素時，`#result` 元素應該包含文字 `A man, a plan, a canal. Panama is a palindrome`。
1. 當 `#text-input` 元素包含文字 `never odd or even` 且點擊 `#check-btn` 元素時，`#result` 元素應該包含文字 `never odd or even is a palindrome`。
1. 當 `#text-input` 元素包含文字 `nope` 且點擊 `#check-btn` 元素時，`#result` 元素應包含文字 `nope is not a palindrome`。
1. 當 `#text-input` 元素包含文字 `almostomla` 且點擊 `#check-btn` 元素時，`#result` 元素應該包含文字 `almostomla is not a palindrome`。
1. 當 `#text-input` 元素包含文字 `My age is 0, 0 si ega ym.` 且點擊 `#check-btn` 元素時，`#result` 元素應該包含文字 `My age is 0, 0 si ega ym. is a palindrome`。
1. 當 `#text-input` 元素包含文字 `1 eye for of 1 eye.` 且點擊 `#check-btn` 元素時，`#result` 元素應該包含文字 `1 eye for of 1 eye. is not a palindrome`。
1. 當 `#text-input` 元素包含文字 `0_0 (: /-\ :) 0-0` 且點擊 `#check-btn` 元素時，`#result` 元素應該包含文字 `0_0 (: /-\ :) 0-0 is a palindrome`。
1. 當 `#text-input` 元素包含文字 `five|\_/|four` 且點擊 `#check-btn` 元素時，`#result` 元素應該包含文字 `five|\_/|four is not a palindrome`。

完成使用者故事並通過以下所有測試以完成此專案。展現你個人的風格。祝你程式設計愉快！

# --hints--

你應該有一個 `input` 元素，其 `id` 為 `"text-input"`。
...
你應該有一個 `div`、`span` 或 `p` 元素，其 `id` 為 `"result"`。
...
當你點擊 `#check-btn` 元素而未在 `#text-input` 元素中輸入任何值時，應該會出現一個提示，文字為 `Please input a value`。
...
當 `#text-input` 元素只包含字母 `A` 且點擊 `#check-btn` 元素時，`#result` 元素應該包含文字 `A is a palindrome`。
...
當 `#text-input` 元素包含文字 `eye` 且點擊 `#check-btn` 元素時，`#result` 元素應該包含文字 `eye is a palindrome`。
...
當 `#text-input` 元素包含文字 `_eye` 且點擊 `#check-btn` 元素時，`#result` 元素應包含文字 `_eye is a palindrome`。
...
當 `#text-input` 元素包含文字 `race car` 且點擊 `#check-btn` 元素時，`#result` 元素應該包含文字 `race car is a palindrome`。
...
當 `#text-input` 元素包含文字 `not a palindrome` 且點擊 `#check-btn` 元素時，`#result` 元素應該包含文字 `not a palindrome is not a palindrome`。
...
當 `#text-input` 元素包含文字 `A man, a plan, a canal. Panama` 且點擊 `#check-btn` 元素時，`#result` 元素應該包含文字 `A man, a plan, a canal. Panama is a palindrome`。
...
當 `#text-input` 元素包含文字 `never odd or even` 且點擊 `#check-btn` 元素時，`#result` 元素應該包含文字 `never odd or even is a palindrome`。
...
當 `#text-input` 元素包含文字 `nope` 且點擊 `#check-btn` 元素時，`#result` 元素應包含文字 `nope is not a palindrome`。
...
當 `#text-input` 元素包含文字 `almostomla` 且點擊 `#check-btn` 元素時，`#result` 元素應該包含文字 `almostomla is not a palindrome`。
...
當 `#text-input` 元素包含文字 `My age is 0, 0 si ega ym.` 且點擊 `#check-btn` 元素時，`#result` 元素應該包含文字 `My age is 0, 0 si ega ym. is a palindrome`。
...
當 `#text-input` 元素包含文字 `1 eye for of 1 eye.` 且點擊 `#check-btn` 元素時，`#result` 元素應該包含文字 `1 eye for of 1 eye. is not a palindrome`。
...
當 `#text-input` 元素包含文字 `0_0 (: /-\ :) 0-0` 且點擊 `#check-btn` 元素時，`#result` 元素應該包含文字 `0_0 (: /-\ :) 0-0 is a palindrome`。
...
當 `#text-input` 元素包含文字 `five|\_/|four` 且點擊 `#check-btn` 元素時，`#result` 元素應該包含文字 `five|\_/|four is not a palindrome`。
...
當 `#text-input` 元素包含字母數字回文時，`#result` 元素應正確識別它為回文。 
...
當 `#text-input` 元素包含一串隨機的字母數字字元且不是回文時，`#result` 元素應該顯示它不是回文。 
