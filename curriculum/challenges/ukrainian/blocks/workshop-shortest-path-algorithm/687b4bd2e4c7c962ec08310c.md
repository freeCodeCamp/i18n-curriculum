...
Тепер ви продемонструєте, що ваша функція працює. Наприкінці вашої програми викличте вашу функцію `shortest_path` з `adj_matrix` та `start_node` зі значенням `0` і `target_node` зі значенням `5` як аргументами.

На цьому алгоритм пошуку найкоротшого шляху завершено!

# --hints--

Ви повинні викликати функцію `shortest_path` з трьома аргументами: `adj_matrix`, `0` і `5`.
