...
Всередині четвертого елемента `td` оновіть поточне значення, щоб замість цього викликати функцію `viewCount` з змінною `views` як аргументом.

# --hints--

Ви повинні викликати функцію `viewCount` і передати змінну `views` як аргумент.
