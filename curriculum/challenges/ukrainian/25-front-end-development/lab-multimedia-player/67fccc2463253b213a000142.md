...
In the prior lectures, you were introduced to working with `audio` and `video` elements. У цій лабораторній роботі ви створите мультимедійний плеєр, який відтворюватиме `audio` та `video` з текстовою версією.
