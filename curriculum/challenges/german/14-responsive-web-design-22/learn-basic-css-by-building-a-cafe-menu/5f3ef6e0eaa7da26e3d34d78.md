...
Du kannst deiner Speisekarte mit verschiedenen `padding`-Eigenschaften etwas Platz zwischen dem Inhalt und den Seiten einfügen.

Gib der `menu`-Klasse ein `padding-left` und ein `padding-right` mit dem gleichen Wert `20px`.
