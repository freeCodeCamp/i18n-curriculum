...
Давайте перевіримо вашу нову карировану функцію. Оголосіть змінну `servingsResult` і призначте їй результат коригування від базової кількості 4 до порції 6.
