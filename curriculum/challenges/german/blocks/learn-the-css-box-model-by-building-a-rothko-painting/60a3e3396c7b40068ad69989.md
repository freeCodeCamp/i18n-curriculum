...
Ändern Sie die `background-color` von `.three` zu `#b20403`.

# --hints--

Sie sollten die `background-color`-Eigenschaft auf `#b20403` setzen.
...
Ihr `.three`-Element sollte einen `background-color`-Wert von `#b20403` haben.
