...
Pasemos a la insignia `Most popular`. Necesitas colocarla en la esquina superior derecha de la tarjeta, así que puedes usar algunas de las clases de utilidad de posicionamiento de Tailwind para hacerlo.
