...
Щоб надати `fieldset` елементам трохи відстані, виберіть їх і задайте `border-bottom` зі значенням `3px solid #3b3b4f`.

# --hints--

Ви повинні задати `fieldset` елементам `border-bottom` зі значенням `3px solid #3b3b4f`.
