...
L'International Bank Account Number (IBAN) è un metodo riconosciuto a livello internazionale per identificare i conti bancari oltre i confini nazionali con un rischio ridotto di errori di trascrizione.

L'<abbr title="International Bank Account Number">IBAN</abbr> è composto da un massimo di 34 caratteri alfanumerici:

<ul>
  <li>prima il codice paese ISO 3166-1 alpha-2 di due lettere</li>
  <li>poi due cifre di controllo, e</li>
  <li>infine un Basic Bank Account Number (BBAN) specifico per il paese.</li>
</ul>

Le cifre di controllo permettono una verifica di coerenza del numero di conto bancario per confermarne l'integrità anche prima di inviare una transazione.

# --instructions--

Scrivi una funzione che prende come parametro una stringa IBAN. Se è valida restituisci true. Altrimenti, restituisci false.
