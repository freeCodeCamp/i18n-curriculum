...
Mais cedo você usou o circunflexo (`^`) em classes de caracteres para procurar caracteres que não devem ser capturados, como em `[^thingsThatWillNotBeMatched]`. Quando usados fora de classes de caracteres, o circunflexo serve para buscar a partir do começo de strings.
