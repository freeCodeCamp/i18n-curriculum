...
Ahora, modifique su llamada `removePlant` pasándole el objeto `ballerina` y mire la consola. Verá un error que va a arreglar en el siguiente paso.

# --hints--

Debería registrar en la consola `removePlant(ballerina)`.
