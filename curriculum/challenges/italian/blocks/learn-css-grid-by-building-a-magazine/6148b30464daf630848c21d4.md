...
Dai al tuo selettore `.heading` una proprietà `row-gap` impostata su `1.5rem`.

# --hints--

Il tuo selettore `.heading` dovrebbe avere una proprietà `row-gap` impostata su `1.5rem`.
