...
`To prompt` means to cause or encourage someone to do something or give a response. Por ejemplo:

`The app prompts users to update their settings.` – This means the app reminds or asks users to take an action.

Something `unique` is one-of-a-kind or unlike anything else. Por ejemplo:
