...
Verifica si `cardElement` no es una instancia de `HTMLElement`, y si es así, añade un `return`

# --hints--

Debes añadir otra sentencia `if` con la condición `!(cardElement instanceof HTMLElement)`.
