...
Викличте `getEVAReadyCrew()` зі своїм списком `updatedSquad` і збережіть результат у новій змінній з іменем `EVAReadySquad`. Потім використайте цикл `for`, щоб вивести в консоль `name` кожного астронавта з масиву `EVAReadySquad`.

# --hints--

Ви повинні викликати `getEVAReadyCrew()` з `updatedSquad` і зберегти результат у новій змінній з іменем `EVAReadySquad`.
...
Використайте цикл `for`, щоб ітерувати по масиву `EVAReadySquad` і вивести в консоль `name` кожного астронавта.
