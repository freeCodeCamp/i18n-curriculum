...
**SHA-1** oder **SHA1** ist eine Einweg-Hashfunktion; sie berechnet eine 160-Bit-Nachrichtenzusammenfassung.

SHA-1 wird häufig in Sicherheitsprotokollen verwendet; zum Beispiel nutzen viele HTTPS-Websites RSA mit SHA-1, um ihre Verbindungen zu sichern.

BitTorrent verwendet SHA-1, um Downloads zu überprüfen.

Git und Mercurial verwenden SHA-1-Zusammenfassungen, um Commits zu identifizieren.

Ein US-Regierungsstandard, <a href="https://rosettacode.org/wiki/SHA-1/FIPS-180-1" target="_blank" rel="noopener noreferrer nofollow">FIPS 180-1</a>, definiert SHA-1.

# --instructions--

Schreiben Sie eine Funktion, die die SHA-1-Nachrichtenzusammenfassung für einen gegebenen String zurückgibt.
