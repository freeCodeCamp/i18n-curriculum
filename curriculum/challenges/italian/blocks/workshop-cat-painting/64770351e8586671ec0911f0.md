...
Il posizionamento `sticky` è un ibrido tra il posizionamento `relative` e `fixed`. Permette a un elemento di **attaccarsi** a una posizione specifica all'interno del suo elemento o del viewport, in base alla posizione di scorrimento.
