...
Sasa ongeza `div` yenye `className` ya `form-group`. Ndani yake, ongeza `label` yenye `className` ya `label` na sifa ya kipengele ya `htmlFor` ya `name`. Chini yake ongeza `input` yenye `id` iliyowekwa kuwa `name`, `className` ya `input`, na sifa ya kipengele ya `type` ya `text`.

# --hints--

Unapaswa kuwa na `div` yenye `className` ya `form-group`.
...
`form-group` yako inapaswa kuwa na `label` yenye `className` ya `label` na sifa ya kipengele ya `htmlFor` ya `name`.
...
`form-group` yako inapaswa kuwa na `input` yenye `id` ya `name`, `className` ya `input`, na `type` ya `text`.
