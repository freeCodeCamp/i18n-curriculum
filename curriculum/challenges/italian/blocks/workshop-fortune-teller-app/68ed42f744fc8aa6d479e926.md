...
Ora aggiungi le proprietà rimanenti all'oggetto privato `elements`. Sono: `multipleCard`, `title`, `newReadingBtn`, `fortuneContainer`, `fortuneDescription`, `headerTitle`, `subTitle`, `cardTitle`, `description` e `text`. Assicurati che ogni proprietà usi il tipo `HTMLElement`.

# --hints--

Dovresti avere la proprietà `multipleCard` all'interno della proprietà `elements` assegnata al tipo `HTMLElement`.
...
Dovresti avere la proprietà `title` all'interno della proprietà `elements` assegnata al tipo `HTMLElement`.
...
Dovresti avere la proprietà `newReadingBtn` all'interno della proprietà `elements` assegnata al tipo `HTMLElement`.
...
Dovresti avere la proprietà `fortuneContainer` all'interno della proprietà `elements` assegnata al tipo `HTMLElement`.
...
Dovresti avere la proprietà `fortuneDescription` all'interno della proprietà `elements` assegnata al tipo `HTMLElement`.
...
Dovresti avere la proprietà `headerTitle` all'interno della proprietà `elements` assegnata al tipo `HTMLElement`.
...
Dovresti avere la proprietà `subTitle` all'interno della proprietà `elements` assegnata al tipo `HTMLElement`.
...
Dovresti avere la proprietà `cardTitle` all'interno della proprietà `elements` assegnata al tipo `HTMLElement`.
...
Dovresti avere la proprietà `description` all'interno della proprietà `elements` assegnata al tipo `HTMLElement`.
...
Dovresti avere la proprietà `text` all'interno della proprietà `elements` assegnata al tipo `HTMLElement`.
