...
لا تزال داخل حلقة `while`، زد قيمة `left_array_index` بمقدار 1.

# --hints--

يجب أن تزيد القيمة الحالية لـ `left_array_index` بمقدار 1 داخل حلقة `while`. لاحظ أن الزيادة يجب أن تتم بعد تعيين عنصر الجزء الأيسر إلى المصفوفة المرتبة.
