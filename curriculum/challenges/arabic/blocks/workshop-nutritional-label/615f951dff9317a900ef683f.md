...
أعطِ المحدِّد `.note` حشوًا أيسر وأيمن بقيمة `8px`، مع إزالة الحشو العلوي والسفلي. كما عرّف الخاصية `text-indent` بقيمة `-8px`.

مع هذه التعديلات الأخيرة، يصبح مسمى التغذية الخاص بك مكتملًا!

# --hints--

يجب أن يحتوي المحدِّد `.note` على خاصية `padding` بقيمة `0 8px`.
...
يجب أن يحتوي المحدِّد `.note` على خاصية `text-indent` بقيمة `-8px`.
