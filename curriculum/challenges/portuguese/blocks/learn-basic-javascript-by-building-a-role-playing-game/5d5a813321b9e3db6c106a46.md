...
*Nota*: Para todos os projetos restantes neste currículo, você precisará de um nível básico de conhecimento em HTML e CSS. Se você é novo em HTML e CSS, por favor, faça o [Responsive Web Design Certification](https://www.freecodecamp.org/learn/2022/responsive-web-design/).
