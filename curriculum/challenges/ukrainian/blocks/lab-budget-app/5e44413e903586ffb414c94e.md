...
1. Ви повинні мати функцію поза класом `Category` з назвою `create_spend_chart(categories)`, яка приймає список категорій і повертає рядок із діаграмою у вигляді стовпчиків. Щоб побудувати діаграму:
