...
Esse fundo marrom dificulta a leitura do texto. Altere o elemento da cor de fundo do `body` para  `burlywood` de modo que ele tenha cor, mas que você ainda possa ler o texto.
