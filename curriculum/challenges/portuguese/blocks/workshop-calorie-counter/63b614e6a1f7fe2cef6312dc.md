...
Em programação, prefixar uma variável com `is` ou `has` é uma prática comum para indicar que a variável representa um valor booleano.
...
Mais adiante no projeto, você atualizará o valor de `isError` se o usuário fornecer uma entrada inválida.
