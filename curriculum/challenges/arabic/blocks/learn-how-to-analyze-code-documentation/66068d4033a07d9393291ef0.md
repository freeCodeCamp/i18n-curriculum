...
`Usage examples` تُظهر كيفية استخدام شيء ما.
...
تعني النظر إلى شيء بعناية. يقترح بريان النظر عن كثب إلى وصف الدالة.
...
تعني إعطاء أو توفير. الوثائق تقدم أمثلة على كيفية استخدام الدالة.
...
تُظهر هذه الأمثلة كيفية استخدام شيء ما، مثل الدالة في هذا السياق.
