...
Нарешті, змініть третій аргумент кольору у функції `linear-gradient`, який наразі є чистим синім.

Оновіть функцію `rgb` так, щоб значення для червоного було `162`, значення зеленого — `27`, а значення синього — `27`.

# --hints--

Ваше CSS-правило `.red` має містити властивість `background`, встановлену в `linear-gradient(180deg, rgb(122, 74, 14) 0%, rgb(245, 62, 113) 50%, rgb(162, 27, 27) 100%)`.
