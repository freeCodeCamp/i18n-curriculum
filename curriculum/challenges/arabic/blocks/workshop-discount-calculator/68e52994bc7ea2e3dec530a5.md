...
أخيرًا، أرجع الحد الأدنى من القيم في قائمة `prices` باستخدام الدالة `min()`. هذا سيعطيك أفضل سعر (الأدنى) بعد احتساب جميع الخصومات المطبقة.

# --hints--

يجب أن تُرجع طريقتك `calculate_best_price` الحد الأدنى من القيم في قائمة `prices` باستخدام الدالة `min`.
