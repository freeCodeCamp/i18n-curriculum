...
Тепер оновіть вашу найвнутрішнішу функцію в ланцюжку `addCharacters`, щоб вона неявно повертала результат виклику `charRange()` з `character1` і `character2` як аргументами.

# --hints--

Ваша найвнутрішніша функція має використовувати неявне повернення.
...
Ваша найвнутрішніша функція має повертати результат виклику `charRange()`.
...
Ви маєте передати `character1` як перший аргумент у виклик `charRange()`.
...
Ви маєте передати `character2` як другий аргумент у виклик `charRange()`.
