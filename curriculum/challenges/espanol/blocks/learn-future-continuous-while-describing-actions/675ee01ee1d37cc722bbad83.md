...
`Peak` refers to the busiest or highest point of activity, demand, or usage. Por ejemplo:
...
`Travel times` refers to periods when people are actively moving, often in large numbers. Por ejemplo:
