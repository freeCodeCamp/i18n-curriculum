...
`.newspaper` 요소 안에 `name` 클래스를 가진 요소가 있어야 합니다.
...
`.newspaper` 요소 안에 `date` 클래스를 가진 요소가 있어야 합니다.
...
`.newspaper` 요소 안에 `headline` 클래스를 가진 요소가 있어야 합니다.
...
`.newspaper` 요소 안에 `sub-headline` 클래스를 가진 요소가 있어야 합니다.
...
`.newspaper` 요소 안에 `author` 클래스를 가진 요소가 있어야 합니다.
...
`.newspaper` 요소 안에 각각 `text` 클래스를 가진 두 개 이상의 단락 요소가 있어야 합니다.
