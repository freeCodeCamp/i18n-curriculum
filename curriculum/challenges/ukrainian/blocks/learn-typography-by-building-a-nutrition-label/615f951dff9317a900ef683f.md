...
Додайте селектору `.note` відступи зліва та справа по `8px`, видаливши відступи зверху та знизу. Також встановіть властивість `text-indent` у значення `-8px`.

З цими останніми змінами ваша етикетка харчування буде завершена!

# --hints--

Ваш селектор `.note` повинен мати властивість `padding`, встановлену у `0 8px`.
...
Ваш селектор `.note` повинен мати властивість `text-indent`, встановлену у `-8px`.
