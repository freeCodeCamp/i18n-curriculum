...
`elemValue` という名前の関数を宣言してください。この関数は `num` というパラメータを受け取ります。関数の中身は空にしてください。

# --hints--

`elemValue` 関数の後に `rangeFromString()` 変数を宣言する必要があります。
