...
Ahora necesitamos algo de estilo rápido. Comienza dando al `body` un `background-color` establecido a `#0a0a23`.
...
Tu selector `body` debe tener una propiedad de `background-color` establecida a `#0a0a23`.
