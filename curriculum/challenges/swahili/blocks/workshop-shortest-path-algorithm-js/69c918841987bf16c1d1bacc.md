...
Sasa rudia nodi lengwa ili kuonyesha matokeo kwa kila moja.

Ongeza mzunguko wa `for...of` unaorudia juu ya `targets` ukitumia `nodeNo` kama kigezo cha mzunguko. Acha mwili wa mzunguko huo ukiwa tupu kwa sasa.

# --hints--

Unapaswa kuunda mzunguko wa `for...of` na kigezo `nodeNo` ukirudia juu ya `targets`.
