...
Verwenden Sie dieselbe Interpolationssyntax, um ein zweites `p`-Element mit dem Text `consumedCalories Calories Consumed` und ein drittes mit dem Text `exerciseCalories Calories Burned` hinzuzufügen. Denken Sie daran, Ihre `consumedCalories`- und `exerciseCalories`-Variablen durch die entsprechenden Werte zu ersetzen.

# --hints--

Sie sollten ein zweites `p`-Element zu Ihrem Template-Literal hinzufügen.
...
Ihr zweites `p`-Element sollte in einer neuen Zeile stehen.
...
Ihr zweites `p`-Element sollte den Text `${consumedCalories} Calories Consumed` enthalten.
...
Sie sollten ein drittes `p`-Element zu Ihrem Template-Literal hinzufügen.
...
Ihr drittes `p`-Element sollte den Text `${exerciseCalories} Calories Burned` enthalten.
