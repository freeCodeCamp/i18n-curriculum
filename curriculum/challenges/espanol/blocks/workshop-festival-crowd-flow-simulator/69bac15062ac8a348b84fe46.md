...
Tu función `simulateFestival` debería primero registrar el mensaje `"\n" + timeBlock + " Simulation"`.
...
Tu función `simulateFestival` debería registrar el bloque de tiempo correcto en el mensaje.
