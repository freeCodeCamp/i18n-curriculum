...
title: "Завдання 40: константа Чемпернона"
challengeType: 1
forumTopicId: 302066
...
Ірраціональний десятковий дріб створюється шляхом послідовного з'єднання натуральних чисел:

0.12345678910**1**112131415161718192021...

Можна побачити, що 12-та цифра дробової частини — це 1.

Якщо *d<sub>n</sub>* позначає *n*-ту цифру дробової частини, знайдіть значення наступного виразу.
