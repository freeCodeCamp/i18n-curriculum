...
Majengo ya nyuma yanaanza kuonekana vizuri sana. Unda `div` mpya chini ya kipengele cha `.background-buildings` na uipe darasa la vitu la `foreground-buildings`. Hii itakuwa kontena nyingine kwa majengo zaidi.
...
`div` mpya inapaswa kuwa na darasa la vitu la `foreground-buildings`.
