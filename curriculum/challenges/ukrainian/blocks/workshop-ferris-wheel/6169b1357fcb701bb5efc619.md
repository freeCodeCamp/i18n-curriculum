...
Створіть новий селектор `25%` між вашими селекторами `0%` і `50%`. Надайте цьому новому селектору множину властивостей `background-color` зі значенням `yellow`.
...
Ваш селектор `25%` має бути між селекторами `0%` і `50%`.
