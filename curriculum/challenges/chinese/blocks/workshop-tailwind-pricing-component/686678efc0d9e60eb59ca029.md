...
徽章可以有更好的样式。为此，你将使用一些 Tailwind 渐变类。以下是你如何在 Tailwind 中使用渐变样式：
...
为徽章 `div` 添加类 `bg-gradient-to-r`、`from-fuchsia-500` 和 `to-indigo-500`。同时，添加 `rounded-full`、`px-3`、`py-1`、`text-xs`、`font-bold` 和 `text-white`。

# --hints--

你的 `div` 元素中带有 `Most popular` 文本应具有 `bg-gradient-to-r` 类。
...
你的 `div` 元素中带有文本 `Most popular` 应该具有类 `from-fuchsia-500`。
...
你的 `div` 元素中带有文本 `Most popular` 应该具有 `to-indigo-500` 类。
...
你的 `div` 元素中带有文本 `Most popular` 应该具有类 `rounded-full`。
...
你的 `div` 元素中带有文本 `Most popular` 应该有类 `px-3`。
...
你的 `div` 元素中带有文本 `Most popular` 应该有类 `py-1`。
...
你的 `div` 元素中带有文本 `Most popular` 应该有 `text-xs` 类。
...
你的 `div` 元素中带有文本 `Most popular` 应该有 `font-bold` 类。
...
你的 `div` 元素中带有文本 `Most popular` 应该有 `text-white` 类。
