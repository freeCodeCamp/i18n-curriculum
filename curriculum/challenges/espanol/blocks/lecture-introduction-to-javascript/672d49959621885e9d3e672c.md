...
title: ¿Cómo funcionan de manera diferente `let` y `const` cuando se trata de declaración, asignación y reasignación de variables?
challengeType: 19
...
Consulta el final de la lección donde se discutió esto.
