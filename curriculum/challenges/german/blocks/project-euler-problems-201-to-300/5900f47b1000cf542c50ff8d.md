...
title: 'Aufgabe 271: Modulare Kuben, Teil 1'
challengeType: 1
forumTopicId: 301921
...
Für eine positive Zahl $n$ definieren Sie $S(n)$ als die Summe der ganzen Zahlen $x$, für die gilt: $1 < x < n$ und $x^3 \equiv 1\bmod n$.

Wenn $n = 91$ ist, gibt es 8 mögliche Werte für $x$, nämlich: 9, 16, 22, 29, 53, 74, 79, 81. Somit ist $S(91) = 9 + 16 + 22 + 29 + 53 + 74 + 79 + 81 = 363$.

Finden Sie $S(13\\,082\\,761\\,331\\,670\\,030)$.
