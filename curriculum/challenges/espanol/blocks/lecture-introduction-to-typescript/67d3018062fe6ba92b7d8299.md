...
Ya viste uno en la lección anterior: `string[]`, que representa un arreglo de cadenas. Pero, ¿cómo funciona eso realmente?
...
Finalmente, las funciones también pueden recibir firmas de tipo. En la lección anterior, viste cómo definir el tipo de un parámetro en particular:
