...
同じ`box-shadow`宣言を`.two`に使い、色を`#efb762`から`#8f0401`に変更してください。

# --hints--

`box-shadow`プロパティを`0 0 3px 3px #8f0401`に設定してください。
...
`.two`要素は`box-shadow`が`0 0 3px 3px #8f0401`である必要があります。
