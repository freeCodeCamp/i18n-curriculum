...
Add the anchor text `cat photos` to the anchor element. Esto se convertirá en el texto del enlace.
...
Your anchor (`a`) element's text should be `cat photos`. Asegúrate de poner el texto del enlace entre la etiqueta de apertura y etiqueta de cierre del elemento (`a`).
