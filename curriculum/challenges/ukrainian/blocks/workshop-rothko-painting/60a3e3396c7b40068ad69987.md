...
Ви не завжди повинні використовувати пікселі для задання розміру елемента.

Створіть нове правило `.three` і встановіть його `width` у `91%`.
...
Ви повинні встановити властивість `width` у значення `91%`.
...
Ваш елемент `.three` повинен мати значення `width` рівне `91%`.
