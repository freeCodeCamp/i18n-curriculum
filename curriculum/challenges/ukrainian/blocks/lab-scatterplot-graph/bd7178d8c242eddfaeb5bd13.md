...
1. Атрибути `data-xvalue` елементів `.dot` повинні відповідати порядку наданих даних.
1. Атрибути `data-yvalue` елементів `.dot` повинні відповідати порядку наданих даних.
