...
title: "المشكلة 456: المثلثات التي تحتوي على الأصل II"
challengeType: 1
forumTopicId: 302130
...
لتكن $C(n)$ عدد المثلثات التي رؤوسها في $P_n$ والتي تحتوي الأصل في الداخل.
...
`trianglesContainingOriginTwo()` يجب أن تُرجع `333333208685971500`.
