...
الآن، أعد تحويل الـ `1` التي عدلتها سابقًا إلى `0` لاستعادة تكوين اللوحة الأصلي. ثم، احذف استدعاء `print` الخاص بك.

# --hints--

يجب أن تعيد تحويل العنصر الأول من القائمة الأولى في `puzzle` إلى صفر.
...
يجب ألا يحتوي شفرتك على `print(gameboard.find_empty_cell())`.
