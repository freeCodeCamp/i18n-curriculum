...
Esta frase de tres palabras significa directamente opuesto o enfrentando algo.

# --explanation--

`Right across from` significa directamente enfrente de algo. Por ejemplo:

`The printer is right across from the filing cabinet.` – Esto significa que la impresora está frente al gabinete del otro lado.
