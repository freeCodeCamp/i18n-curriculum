...
Nota: el método `fetch()` usa `GET` como el método `HTTP` predeterminado. Esto significa que no necesitas especificarlo explícitamente para la recuperación básica de datos.
