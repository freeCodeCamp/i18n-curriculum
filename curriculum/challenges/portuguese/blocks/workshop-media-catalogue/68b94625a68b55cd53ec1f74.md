...
Docstrings podem ser acessadas através do atributo `__doc__`, que é definido como `None` por padrão.

Verifique isso imprimindo `movie1.__doc__` e `series1.__doc__`. Note que o atributo `__doc__` não é herdado por nenhuma classe filha.

# --hints--

Você deve imprimir `movie1.__doc__`.
...
Você deve imprimir `series1.__doc__`.
