...
Mkutano wa usawa wa wima kati ya vipengele vyenye umuhimu sawa unaweza kuongeza usomaji wa maandishi yako.

Zungusha maandishi `2/3 cup (55g)` ndani ya kipengele cha `span`.

# --hints--

Unapaswa kuunda kipengele kipya cha `span`.
...
Kipengele chako cha `p` kinapaswa bado kuwa na maandishi `Serving size 2/3 cup (55g)`.
