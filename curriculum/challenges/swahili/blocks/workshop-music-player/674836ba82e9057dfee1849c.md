...
Ifuatayo, tumia sifa ya `classList` na njia ya `add()` kuongeza darasa la vitu la `playing` kwenye kipengele cha `playButton`. Hii itatafuta darasa la vitu `playing` katika faili la CSS na kuliongeza kwenye kipengele cha `playButton`.

Kisha, weka `userData.currentSong` kuwa `song`, na ili kuanza kuimba wimbo, tumia njia ya `play()` kwenye kigezo cha `audio`. `play()` ni njia kutoka kwa API ya sauti ya mtandao kwa ajili ya kucheza faili la mp3.

# --hints--

Unapaswa kuongeza darasa la vitu la `playing` kwenye kipengele cha `playButton` ndani ya kitendakazi chako cha `playSong`.
...
Unapaswa kuweka `userData.currentSong` kuwa `song` ndani ya kitendakazi chako cha `playSong`.
...
Unapaswa kuita njia ya `play()` kwenye kigezo cha `audio` ndani ya kitendakazi chako cha `playSong`.
