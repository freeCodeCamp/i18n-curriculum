...
title: Ändere eine Variable für einen bestimmten Bereich
challengeType: 0
...
Du kannst diese Variablen überschreiben, indem du sie innerhalb eines bestimmten Selektors neu setzt.

# --instructions--

Ändere den Wert von `--penguin-belly` in der Klasse `penguin` auf `white`.
