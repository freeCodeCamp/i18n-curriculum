...
باستخدام صنف `flavor` الجديد كمحدِّد، عيّن قيمة الخاصية `text-align` إلى `left`.

# --hints--

يجب أن يكون لديك محدِّد صنف `flavor`.
...
يجب أن تعيّن الخاصية `text-align` إلى `left`.
...
يجب أن يعيّن محدِّد صنف `flavor` الخاصية `text-align` إلى `left`.
