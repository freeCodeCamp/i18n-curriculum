...
`h1` 태그에 대해 `font-size` 속성을 68픽셀로 설정해야 합니다.
...
`h2` 태그에 대해 `font-size` 속성을 52픽셀로 설정해야 합니다.
...
`h3` 태그에 대해 `font-size` 속성을 40픽셀로 설정해야 합니다.
...
`h4` 태그에 대해 `font-size` 속성을 32픽셀로 설정해야 합니다.
...
`h5` 태그에 대해 `font-size` 속성을 21픽셀로 설정해야 합니다.
...
`h6` 태그에 대해 `font-size` 속성을 14픽셀로 설정해야 합니다.
