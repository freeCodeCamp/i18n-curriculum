...
Тепер обгорніть компонент `PlayerCard` у елемент `main` типу `className` з `main`.

Всередині елемента `main` додайте `div` типу `className` з `layout`. Усередині `layout` додайте два окремі елементи `div` типу `className` з `form-panel` та `preview-panel` відповідно.

# --hints--

Ваш `FootballPlayerCard` має відтворювати елемент `main` з `className` типу `main` всередині `div.page`.
...
Ваш `main.main` має містити `div` з `className` типу `layout`.
...
Ваш `layout` має містити `div` з `className` типу `form-panel`.
...
Ваш `layout` має містити `div` з `className` типу `preview-panel`.
