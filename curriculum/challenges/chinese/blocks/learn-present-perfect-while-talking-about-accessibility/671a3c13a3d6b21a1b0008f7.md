...
`It was a relief to hear that the project was approved.` - `Relief` 描述了在获得关于项目的好消息后感受到的安慰。

`Adjustments` 是指为改进或适应某物而做的小幅更改。例如，

`We made adjustments to the app's layout for better user experience.`— `Adjustments` 指的是为改善用户与应用交互方式所做的更改。
