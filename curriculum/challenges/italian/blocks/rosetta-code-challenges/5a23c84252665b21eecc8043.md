...
Trova soluzioni per il puzzle *somma a cento*.

Aggiungi (inserisci) gli operatori matematici **+** o **─** (più o meno) prima di una qualsiasi delle cifre nella stringa numerica decimale **123456789** in modo che l'espressione matematica risultante dia come somma un valore particolare (in questo caso iconico, **100**).
...
Scrivi una funzione che prenda un numero come parametro. La funzione dovrebbe restituire un array contenente tutte le soluzioni per quel numero. Le soluzioni devono essere stringhe che rappresentano le espressioni. Per esempio: "1+23-456+78-9". Ordina l'array prima di restituirlo.
