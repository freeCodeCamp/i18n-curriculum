...
`Makes sense` significa que algo está claro e é fácil de entender.Por exemplo, se alguém explica por que se atrasou e você entende o motivo, pode dizer, `That makes sense.`
...
Quando precedido por `make` ou `makes`, significa que algo está claro e fácil de entender.
