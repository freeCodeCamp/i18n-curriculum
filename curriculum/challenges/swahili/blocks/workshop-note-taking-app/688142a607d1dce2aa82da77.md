...
Itakuwa vizuri kuona mabadiliko yaliyohaririwa kwenye konsoli.

Ongeza `console.log(currentContent);`.

Ili kujaribu mabadiliko yako, jaribu kuhariri noti kisha bofya nje ya noti hiyo. Sasa unapaswa kuona noti iliyohaririwa kwenye konsoli.

# --hints--

Unapaswa kuongeza `console.log(currentContent);` ndani ya msikilizaji wa tukio, baada ya kuweka thamani `newContent` kwa `currentContent`.
