...
Ukizingatia vitu vya menyu na bei, kuna pengo kubwa kati ya kila mstari.
...
Unapaswa kuweka sifa ya `margin-top` kuwa `5px`.
...
Unapaswa kuweka sifa ya `margin-bottom` kuwa `5px`.
...
Unapaswa kutumia kichaguzi kilichopo cha `.item p`.
...
Vipengele vyako vya `p` vilivyopangwa ndani ya vipengele vyako vya `.item` vinapaswa kuwa na ukingo wa `margin-top` wa `5px`.
...
Vipengele vyako vya `p` vilivyopangwa ndani ya vipengele vyako vya `.item` vinapaswa kuwa na ukingo wa `margin-bottom` wa `5px`.
...
Vipengele vyako vya `p` vilivyopangwa ndani ya vipengele vyako vya `.item` havipaswi kuwa na sifa ya `margin-left` iliyowekwa.
...
Vipengele vyako vya `p` vilivyopangwa ndani ya vipengele vyako vya `.item` havipaswi kuwa na sifa ya `margin-right` iliyowekwa.
