...
В межах запиту `@media` додайте селектор `.keys` та встановіть `width` на `318px`.

# --hints--


Правило `@media` повинне мати селектор `.keys`.
...
Новий селектор `.keys` повинен мати `width` зі значенням `318px`.
