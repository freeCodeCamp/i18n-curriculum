...
Puedes pensar en ellas como estructuras que permiten a los desarrolladores crear funcionalidades más complejas basadas en bloques de construcción más simples que ya están implementados.
...
Las API de navegador exponen datos del navegador. Como desarrollador web, puedes acceder y manipular estos datos utilizando JavaScript.
...
El API DOM, que puede usar para manipular elementos HTML, sus estilos y atributos.  You will learn much more about the DOM in the coming lessons. Es un concepto fundamental en el desarrollo web.
...
Un ejemplo es la API de Google Maps, que puedes usar para mostrar mapas interactivos en tu página web.
...
Las APIs web son herramientas esenciales para construir aplicaciones web modernas que pueden interactuar con varios servicios y fuentes de datos. Al aprender a aprovechar su poder, ampliarás tu conjunto de herramientas para crear sitios web dinámicos y atractivos.
