...
- **Презентаційні HTML-елементи**: елементи, які визначають зовнішній вигляд. Наприклад, застарілі елементи `center`, `big` та `font`.
- **Семантичні HTML-елементи**: елементи, які містять значення і структуру. Наприклад, `header`, `nav`, `figure`.
...
- **Рубінові запасні дужки (елемент `rp`)**: запасний варіант для браузерів, які не підтримують рубінові анотації.
