...
すると、要素に太い境界線を設定した場合に、二辺が交わる箇所に斜めの角ができることがわかります。 この下側の境界線をビルのてっぺんとして使用します。

# --hints--

`.bb2a` の `margin` を `auto` に設定する必要があります。
