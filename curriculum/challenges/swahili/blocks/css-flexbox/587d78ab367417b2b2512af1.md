...
title: Ongeza nguvu za Flex kwenye ingizo la tweet
challengeType: 0
...
Kushoto ni ingizo la tweet litakalotumika kama mfano wa vitendo. Baadhi ya sehemu zingekuwa nzuri zaidi kwa mpangilio tofauti. Changamoto ya mwisho ilionyesha `display: flex`. Hapa utaongeza kwenye sehemu kadhaa za ingizo la tweet kuanza kurekebisha nafasi zao.

# --instructions--

Ongeza sifa ya CSS `display: flex` kwa vitu vyote vifuatavyo - kumbuka kuwa wachaguzi tayari wamewekwa katika CSS:

`header`, `.profile-name` ya kichwa, `.follow-btn` ya kichwa, `h3` na `h4` ya kichwa, `footer`, na `.stats` ya kijachini.

# --hints--

`.follow-btn` yako inapaswa kuonyeshwa kwenye ukurasa. Hakikisha umezimia viendelezi vyovyote kama vile vizuizi vya matangazo.
...
`header` yako inapaswa kuwa na sifa ya `display` iliyowekwa kuwa `flex`.
...
`footer` yako inapaswa kuwa na sifa ya `display` iliyowekwa kuwa `flex`.
...
`h3` yako inapaswa kuwa na sifa ya `display` iliyowekwa kuwa `flex`.
...
`h4` yako inapaswa kuwa na sifa ya `display` iliyowekwa kuwa `flex`.
...
`.profile-name` yako inapaswa kuwa na sifa ya `display` iliyowekwa kuwa `flex`.
...
`.follow-btn` yako inapaswa kuwa na sifa ya `display` iliyowekwa kuwa `flex`.
...
`.stats` yako inapaswa kuwa na sifa ya `display` iliyowekwa kuwa `flex`.
