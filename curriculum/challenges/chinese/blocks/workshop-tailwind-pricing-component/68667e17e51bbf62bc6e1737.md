...
现在你应该为 CTA 添加样式，使其看起来更像一个按钮。

对于背景色和前景色，为它赋值类 `bg-gradient-to-r`、`from-fuchsia-500`、`to-indigo-600`、`text-white`、`hover:from-fuchsia-600` 和 `hover:to-indigo-700`。还为它赋值类 `rounded-md` 和 `block`。

# --hints--

你的锚点元素应具有类 `bg-gradient-to-r`。
...
你的锚点元素应具有类 `hover:from-fuchsia-600`。
...
你的锚点元素应具有类 `hover:to-indigo-700`。
