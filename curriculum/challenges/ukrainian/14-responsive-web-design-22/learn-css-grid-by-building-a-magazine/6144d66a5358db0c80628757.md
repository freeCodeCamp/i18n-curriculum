...
Створіть селектор `html` та надайте йому властивість `font-size` зі значенням `62.5%`. This will set the default font size for your web page to 10px (the browser default is 16px).
