...
Fun Fact: Die meisten, wenn nicht gar alle Flossen, sind nicht von Natur aus rechteckig.

Gib den Ecken des `.arm`-Elements oben-links, oben-rechts und unten-rechts einen Radius von `30%` und den Ecken unten-links einen Radius von `120%`.
