...
Додайте останній вузол, `'D'`, який з’єднаний з `'A'` та `'C'`.

Змініть свій словник, щоб представити цю структуру. Знову використовуйте список, щоб представити кілька з’єднань.

# --hints--

У вашому словнику має бути 4 ключі з іменами `'A'`, `'B'`, `'C'` та `'D'`.
