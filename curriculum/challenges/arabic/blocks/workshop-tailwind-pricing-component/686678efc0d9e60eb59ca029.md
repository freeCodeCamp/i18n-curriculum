...
يمكن تنسيق الشارة بشكل أفضل. لهذا، ستستخدم بعض أصناف التدرج اللوني في Tailwind. إليك كيف تستخدم أنماط التدرج في Tailwind:
...
أضف الأصناف `bg-gradient-to-r`، و`from-fuchsia-500`، و`to-indigo-500` إلى عنصر `div` الخاص بالشارة. وأضف أيضًا `rounded-full`، و`px-3`، و`py-1`، و`text-xs`، و`font-bold`، و`text-white`.

# --hints--

يجب أن يحتوي عنصر `div` الذي يحمل النص `Most popular` على الصنف `bg-gradient-to-r`.
...
يجب أن يحتوي عنصر `div` الذي يحمل النص `Most popular` على الصنف `from-fuchsia-500`.
...
يجب أن يحتوي عنصر `div` الذي يحمل النص `Most popular` على الصنف `to-indigo-500`.
...
يجب أن يحتوي عنصر `div` الذي يحمل النص `Most popular` على الصنف `rounded-full`.
...
يجب أن يحتوي عنصر `div` الذي يحمل النص `Most popular` على الصنف `px-3`.
...
يجب أن يحتوي عنصر `div` الذي يحمل النص `Most popular` على الصنف `py-1`.
...
يجب أن يحتوي عنصر `div` الذي يحمل النص `Most popular` على الصنف `text-xs`.
...
يجب أن يحتوي عنصر `div` الذي يحمل النص `Most popular` على الصنف `font-bold`.
...
يجب أن يحتوي عنصر `div` الذي يحمل النص `Most popular` على الصنف `text-white`.
