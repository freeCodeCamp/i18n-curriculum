...
Eine Taxicab-Zahl (die hier verwendete Definition) ist eine positive ganze Zahl, die auf mehr als eine Weise als Summe von zwei positiven Kubikzahlen ausgedrückt werden kann.

Die erste Taxicab-Zahl ist `1729`, welche ist:

1<sup>3</sup> + 12<sup>3</sup> und

9<sup>3</sup> + 10<sup>3</sup>.

Taxicab-Zahlen sind auch bekannt als:

<ul>
  <li>Taxi-Zahlen</li>
  <li>Taxi-Cab-Zahlen</li>
  <li>Taxi Cab-Zahlen</li>
...
Schreiben Sie eine Funktion, die die niedrigsten `n` Taxicab-Zahlen zurückgibt. Für jede der Taxicab-Zahlen zeigen Sie sowohl die Zahl als auch ihre zusammengesetzten Kubikzahlen an.
...
`taxicabNumbers` sollte ein Array von Zahlen zurückgeben.
