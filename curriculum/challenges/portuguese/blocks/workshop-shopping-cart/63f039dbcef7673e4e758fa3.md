...
Os navegadores possuem uma função embutida `confirm()` que exibe um prompt de confirmação para o usuário. `confirm()` aceita uma string, que é a mensagem exibida para o usuário. Ele retorna `true`, se o usuário confirmar, e `false`, se o usuário cancelar.
