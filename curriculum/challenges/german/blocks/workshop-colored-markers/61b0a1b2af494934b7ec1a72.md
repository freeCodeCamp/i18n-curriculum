...
Super. Ihr roter Marker sieht gut aus. Jetzt müssen Sie nur noch die Kappen und Hüllen zu Ihren anderen Markern hinzufügen.

Fügen Sie sowohl dem grünen als auch dem blauen Marker eine Kappe und eine Hülle hinzu. Sie können einfach die `div`-Elemente vom roten Marker kopieren und in die anderen beiden Marker einfügen.

# --hints--

Ihr grüner Marker `div` sollte zwei `div`-Elemente enthalten.
...
Das Kappen-`div`-Element Ihres grünen Markers sollte vor dem Hüllen-`div`-Element stehen.
...
Ihr blauer Marker `div` sollte zwei `div`-Elemente enthalten.
...
Das Kappen-`div`-Element Ihres blauen Markers sollte vor dem Hüllen-`div`-Element stehen.
