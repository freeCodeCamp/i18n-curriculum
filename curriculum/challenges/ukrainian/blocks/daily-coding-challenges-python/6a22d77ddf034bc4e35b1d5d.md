...
title: "Завдання 356: розв’язувач магічного квадрата"
challengeType: 29
...
Дано сітку 3x3 з одним відсутнім числом (представленим як `0`), поверніть відсутнє число, яке доповнює магічний квадрат, або `"impossible"`, якщо жодне дійсне число не існує.

Магічний квадрат — це сітка, де кожен рядок, стовпець і діагональ дають однакову суму.

# --hints--

`solve_magic_square([[2, 7, 6], [9, 0, 1], [4, 3, 8]])` має повернути `5`.
...
`solve_magic_square([[0, 14, 12], [18, 10, 2], [8, 6, 16]])` має повернути `4`.
...
`solve_magic_square([[12, 17, 16], [19, 0, 10], [14, 13, 18]])` має повернути `"impossible"`.
...
`solve_magic_square([[15, 35, 31], [43, 27, 11], [23, 19, 0]])` має повернути `39`.
...
`solve_magic_square([[26, 41, 14], [47, 35, 0], [32, 29, 44]])` має повернути `"impossible"`.
