...
Per un numero positivo $n$, definiamo $S(n)$ come la somma dei numeri interi $x$, per cui $1 < x < n$ e $x^3 \equiv 1\bmod n$.

Quando $n = 91$, ci sono 8 valori possibili per $x$, cioè: 9, 16, 22, 29, 53, 74, 79, 81. Quindi, $S(91) = 9 + 16 + 22 + 29 + 53 + 74 + 79 + 81 = 363$.
