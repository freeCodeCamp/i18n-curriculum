...
Copia i valori rimanenti a sinistra in `array` assegnando `leftPart[leftArrayIndex]` a `array[sortedIndex]`.

# --hints--

Il corpo del loop dovrebbe assegnare `leftPart[leftArrayIndex]` a `array[sortedIndex]`.
