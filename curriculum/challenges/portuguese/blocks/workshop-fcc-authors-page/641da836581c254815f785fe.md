...
A próxima coisa que você mostrará são os detalhes biográficos sobre o autor. Você pode fazer isso usando a propriedade `bio`.

Adicione um elemento de parágrafo com um atributo `class` de `"bio"`, depois interpolar `bio` dentro do elemento de parágrafo.
