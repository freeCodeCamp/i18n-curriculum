...
Has construido un calculador de trayectoria de proyectiles.

Ahora, para concluir, modifica el código que escribiste fuera de las clases e incorpóralo en una pequeña función de utilidad llamada `projectile_helper` que reciba los valores deseados de velocidad, altura y ángulo, y que imprima en la terminal, en secuencia, los detalles del proyectil, la tabla de coordenadas y el gráfico de la trayectoria.

Llama a `projectile_helper` una vez con los valores que elijas. 

# --hints--

Debes crear `projectile_helper` en el ámbito global.
...
Debes imprimir las cadenas solicitadas en orden. No imprimas otros valores.
...
Debes llamar a la función `projectile_helper` al menos una vez.
...
No debes tener variables ni llamadas a print en el ámbito global.
