...
Retorne `true` se a string fornecida representar um número de telefone válido dos Estados Unidos.

O usuário pode inserir o número no formato que desejar, desde que ele corresponda a um formato válido utilizado nos EUA. Abaixo estão alguns exemplos de formatos aceitos (consulte os testes para ver outras variações possíveis):

<blockquote>555-555-5555<br>(555)555-5555<br>(555) 555-5555<br>555 555 5555<br>5555555555<br>1 555 555 5555</blockquote>

Para este desafio, você receberá uma string como `800-692-7753` ou `8oo-six427676;laskdjf`. Seu objetivo é validar ou rejeitar o número de telefone com base nos formatos válidos apresentados acima.

O código de área é obrigatório. Caso o código do país seja fornecido, ele deve ser obrigatoriamente `1`.

Retorne `true` se a string representar um número de telefone válido dos Estados Unidos. Caso contrário, retorne `false`.
...
`telephoneCheck()`, quando chamado com qualquer número válido, deve retornar `true`.
...
`telephoneCheck()`, quando chamado com um número inválido, deve retornar `false`.
