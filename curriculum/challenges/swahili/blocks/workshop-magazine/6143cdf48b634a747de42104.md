...
Ndani ya kipengele chako cha `.image-wrapper`, mpe kipengele chako cha tatu cha `img` sifa ya `src` yenye thamani `https://cdn.freecodecamp.org/testable-projects-fcc/images/survey-form-background.jpeg`, sifa ya `alt` yenye thamani `four people working on code`, sifa ya `loading` yenye thamani `lazy`, sifa ya `class` iliyowekwa kuwa `image-3`, sifa ya `width` iliyowekwa kuwa `600`, na sifa ya `height` iliyowekwa kuwa `400`.
...
Kipengele chako cha tatu cha `img` kinapaswa kuwa na sifa ya `alt` iliyowekwa kuwa `four people working on code`.
...
Kipengele chako cha tatu cha `img` kinapaswa kuwa na sifa ya `class` iliyowekwa kuwa `image-3`.
