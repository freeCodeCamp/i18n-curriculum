...
Para la última parte del taller, se necesitan algunos cambios en la sección de contacto al final.

El primer cambio sería envolver la sección de contacto dentro de un elemento `footer`. Esto ayudará a los lectores de pantalla a identificar esta sección como el pie de página.

# --hints--

Tu página debe tener un elemento `footer`.
...
Tu elemento `footer` debe contener un elemento `h3` con el texto `Contact Me`.
...
Tu elemento `footer` debe contener un elemento `p` con el texto `Email me at camperbot@blog.io`.
