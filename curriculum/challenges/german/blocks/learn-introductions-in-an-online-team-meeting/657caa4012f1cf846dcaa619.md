...
Ein `database administrator` ist ein fachlich Verantwortlicher für das Verwalten und die Wartung von Datenbanken. They ensure that data is `secure` (safe from unauthorized access) and `efficient` (easily accessible and usable).
