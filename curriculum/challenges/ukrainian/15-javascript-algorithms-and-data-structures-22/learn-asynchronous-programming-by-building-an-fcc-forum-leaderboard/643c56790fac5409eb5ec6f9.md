...
Повернувшись у функцію `showLatestPosts()`, використайте деструктурування, щоб отримати властивості `topic_list` та `users` з об’єкта `data`.

# --hints--

Ви повинні використати `const`, щоб деструктурувати `topic_list` та `users` з об’єкта `data`.
