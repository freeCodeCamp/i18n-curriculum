...
A continuación, crearás un formulario donde los usuarios pueden buscar frutas. Dentro del elemento `#search-container`, crea un elemento `form`.

# --hints--

Debes tener un elemento `form` dentro del elemento `search-container`.
