...
`textContent`、`totalNumberOfItems`、`cartSubTotal`、および `cartTaxes` 要素の `cartTotal` をすべて数値の `0` に設定してください。

# --hints--

`textContent` 要素の `totalNumberOfItems` を `0` に設定してください。
...
`textContent` 要素の `cartSubTotal` を `0` に設定してください。
...
`textContent` 要素の `cartTaxes` を `0` に設定してください。
...
`textContent` 要素の `cartTotal` を `0` に設定してください。
