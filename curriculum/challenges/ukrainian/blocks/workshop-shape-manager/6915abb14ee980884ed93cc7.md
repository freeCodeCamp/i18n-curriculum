...
Всередині циклу встановіть подію `oninput` для кожного елемента `input` у функцію `handleInput`.

На цьому практичне заняття з менеджера форм завершено!

# --hints--

Ви повинні встановити `input.oninput` у функцію `handleInput`.
