...
Simula il turno di notte chiamando `simulateFestival()` con `nightGates` e `"Night"`.

Con questo, le tue simulazioni sono complete!

# --hints--

Dovresti chiamare `simulateFestival()` con `nightGates` e `"Night"`.
