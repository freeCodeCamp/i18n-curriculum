...
Luego, el algoritmo considera el **origen y la importancia**. El CSS puede provenir de diferentes fuentes: los estilos predeterminados del navegador (user-agent), los estilos establecidos por el usuario y los estilos escritos por el autor (tú).
