...
UI (ユーザーインターフェース) 上に曲を表示する関数を作成します。

アロー関数構文を使用して、仮引数 `array` を受け取る `renderSongs` という関数を作成しましょう。

# --hints--

`const` を使用して、空の関数 `renderSongs` を作成してください。
