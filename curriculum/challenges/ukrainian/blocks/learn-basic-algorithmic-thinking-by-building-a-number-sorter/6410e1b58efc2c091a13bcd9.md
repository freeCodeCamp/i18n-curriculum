...
З метою налагодження додайте виклик `console.log()` у внутрішньому циклі. Передайте до нього аргументи `array`, `array[j]` та `array[j+1]`.

# --hints--

Використайте виклик `console.log()` у внутрішньому циклі.
...
Передайте `array[j+1]` як третій аргумент до `console.log()`.
