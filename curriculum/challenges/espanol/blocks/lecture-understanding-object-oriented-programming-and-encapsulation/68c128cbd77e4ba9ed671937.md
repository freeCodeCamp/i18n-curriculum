...
En Python, un decorador es una función que modifica las funcionalidades de otras funciones, o clases, sin cambiar su código original.

Aunque es posible crear decoradores personalizados, esto está fuera del alcance de esta lección. Solo debes saber que para crear una propiedad, defines un método y colocas el decorador `@property` encima. Esto convierte el método en una propiedad, por lo que puede ser accedida como un atributo mientras internamente llama al método decorado.
