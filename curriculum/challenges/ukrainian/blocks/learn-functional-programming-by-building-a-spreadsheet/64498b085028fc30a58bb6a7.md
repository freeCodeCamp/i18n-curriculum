...
Оголосіть функцію `elemValue`, яка приймає один параметр `num`. Функція має бути порожньою.

# --hints--

Ви маєте оголосити змінну `elemValue` після вашої функції `rangeFromString()`.
