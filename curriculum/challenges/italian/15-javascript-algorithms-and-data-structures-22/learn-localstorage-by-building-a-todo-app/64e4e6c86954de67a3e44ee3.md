...
You should assign the `add-or-update-task-btn` element to the variable `addOrUpdateTaskBtn`. Non dimenticare di utilizzare `const` per dichiarare la variabile.
...
You should assign the `cancel-btn` element to the variable `cancelBtn`. Non dimenticare di utilizzare `const` per dichiarare la variabile.
