...
Ora, dovresti aumentare la dimensione del carattere tipografico per tutti gli elementi `label`.

Seleziona l'elemento `label` e imposta la sua `font-size` su `1.2rem`.

# --hints--

Dovresti prendere di mira l'elemento `label`.
