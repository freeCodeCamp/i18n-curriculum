...
Tente selecionar todos os elementos `target` pares e dar a eles as classes `animated` e `shake`. Lembre-se de que **even** refere-se à posição dos elementos considerando um sistema baseado em zero.
