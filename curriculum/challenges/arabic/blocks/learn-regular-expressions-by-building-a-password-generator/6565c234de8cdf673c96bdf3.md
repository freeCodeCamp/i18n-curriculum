...
طالما أن جميع المعلمات في استدعاء الدالة هي معلمات مسماة، فإن ترتيب المعلمات لا يهم.

لتأكيد ذلك، جرّب تغيير ترتيب `length=8` و `nums=1` في استدعاء الدالة الخاص بك.

# --hints--

يجب عليك تغيير ترتيب `length=8` و `nums=1` في استدعاء `generate_password()`.
