...
`To deal with` means to take action to solve or manage a situation or problem. Por exemplo:
...
`Early` in this context means at a time before something becomes more serious or difficult. Por exemplo:
