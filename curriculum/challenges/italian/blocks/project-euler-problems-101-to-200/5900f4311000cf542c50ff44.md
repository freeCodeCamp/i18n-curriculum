...
Data la funzione $f(x) = ⌊{2}^{30.403243784 - x^2}⌋ × {10}^{-9}$ (dove ⌊ ⌋ è la funzione floor), la sequenza $u_n$ è definita da $u_0 = -1$ e $u_{n + 1} = f(u_n)$.

Trova $u_n + u_{n + 1}$ per $n = {10}^{12}$. Fornisci la tua risposta con 9 cifre decimali.
