...
title: 'Problema 210: triangoli con angolo ottuso'
challengeType: 1
forumTopicId: 301852
...
Considera l'insieme $S(r)$ di punti ($x$,$y$) con coordinate intere che soddisfano $|x| + |y| ≤ r$.

Sia $O$ il punto (0,0) e $C$ il punto ($\frac{r}{4}$,$\frac{r}{4}$).

Sia $N(r)$ il numero di punti $B$ in $S(r)$ tali che il triangolo $OBC$ abbia un angolo ottuso, cioè l'angolo più grande $α$ soddisfi $90°<α<180°$.
