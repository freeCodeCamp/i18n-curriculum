...
`#scary-btn`、`#funny-btn`、`#adventure-btn` のボタンを選択し、それぞれ `scaryStoryBtn`、`funnyStoryBtn`、`adventureStoryBtn` という変数に格納してください。

# --hints--

`#scary-btn` メソッドを使って `getElementById` ボタンを選択し、`scaryStoryBtn` 変数に格納してください。
...
`#funny-btn` メソッドを使って `getElementById` ボタンを選択し、`funnyStoryBtn` 変数に格納してください。
...
`#adventure-btn` メソッドを使って `getElementById` ボタンを選択し、`adventureStoryBtn` 変数に格納してください。
