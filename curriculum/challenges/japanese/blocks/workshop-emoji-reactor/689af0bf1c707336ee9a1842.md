...
イベントリスナーのコールバックの内容を置き換えましょう。

`querySelector` を使ってボタン内の `.count` 要素を見つけてください。

そして、ボタンがクリックされたときに `.count` 要素のテキスト内容をログに出力してください。

# --hints--

クリックされたボタン内の `.count` 要素のテキスト内容をログに出力する必要があります。
