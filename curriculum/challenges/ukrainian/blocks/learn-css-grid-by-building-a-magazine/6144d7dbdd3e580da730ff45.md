...
Створіть селектор `body`. Встановіть властивість `font-family` у значення `Baskervville` із запасним варіантом `serif`. Встановіть властивість `color` у значення `linen` та властивість `background-color` у значення `rgb(20, 30, 40)`.
...
Ваш селектор `body` має мати властивість `font-family`, встановлену в `Baskervville` із запасним варіантом `serif`.
...
Ваш селектор `body` має мати властивість `color`, встановлену в `linen`.

```js
assert(new __helpers.CSSHelp(document).getStyle('body')?.color === 'linen');
```

Ваш селектор `body` має мати властивість `background-color`, встановлену в `rgb(20, 30, 40)`.
