...
La tua funzione di callback ha bisogno di quattro parametri. `match`, `arg1`, `operator` e `arg2`.

Non userai il parametro `match`, quindi ricordati di anteporre un prefisso.
...
La tua funzione di callback dovrebbe essere ancora vuota.
