...
Las listas ordenadas comienzan con un elemento de apertura `<ol>`, seguido de cualquier número de elementos `<li>`. Finalmente, las listas ordenadas se cierran con la etiqueta `</ol>`.
