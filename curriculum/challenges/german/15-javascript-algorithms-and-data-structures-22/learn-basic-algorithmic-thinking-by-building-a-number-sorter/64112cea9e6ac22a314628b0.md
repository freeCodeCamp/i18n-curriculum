...
Nachdem deine `for`-Schleife beendet ist, musst du das Array zurückgeben. Wenn du dann erneut auf den `Sort`-Button klickst, solltest du dann die `Output`-Änderung sehen können.

# --hints--

Du solltest das `array` mit `return` zurückgeben.
