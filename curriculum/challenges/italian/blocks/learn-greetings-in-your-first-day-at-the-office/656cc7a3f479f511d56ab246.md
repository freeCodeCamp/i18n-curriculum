...
`Today` si usa per riferirsi al giorno corrente, il giorno che sta succedendo adesso.
...
Sophie usa questa parola per riferirsi al giorno corrente. La prima lettera è maiuscola.
