...
Об’єкт `topic_list` містить масив `topics`, у якому зберігаються останні теми, опубліковані на форумі.

Деструктуруйте масив `topics` з об’єкта `topic_list`.

# --hints--

Ви повинні використати `const` для деструктурування змінної `topics` з об’єкта `topic_list`.
