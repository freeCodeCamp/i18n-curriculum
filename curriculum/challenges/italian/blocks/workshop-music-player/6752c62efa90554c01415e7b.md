...
Crea una funzione chiamata `setPlayerDisplay`. All'interno della funzione, imposta il `textContent` di `playingSong` sul titolo della canzone corrente, se definito. Altrimenti, impostalo su una stringa vuota.

Sotto, imposta il `textContent` di `songArtist` sull'artista della canzone corrente, se definito. Altrimenti, impostalo su una stringa vuota.


# --hints--

Dovresti avere una funzione chiamata `setPlayerDisplay`.

```js
assert.isFunction(setPlayerDisplay);
```

La tua funzione `setPlayerDisplay` dovrebbe impostare il `textContent` di `playingSong` sul titolo della canzone corrente, se definito, o su una stringa vuota.
...
La tua funzione `setPlayerDisplay` dovrebbe impostare il `textContent` di `songArtist` sull'artista della canzone corrente, se definito, o su una stringa vuota.
