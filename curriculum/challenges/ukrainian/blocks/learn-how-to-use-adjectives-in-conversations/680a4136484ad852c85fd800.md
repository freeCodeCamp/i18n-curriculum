...
This word is used to point to something close or something just mentioned. Перша літера є з великою.
...
`This` is a demonstrative word used to refer to something near in time, place, or context. Приклад:
