...
Kwa sasa, ikiwa utaandika katika vipengele vya `input` au `textarea`, hutaweza kuona maandishi. Pia, urefu wao ni mdogo mno kufanya matumizi yake kuwa rahisi.

Rekebisha hili kwa kuweka `color` kuwa `#ffffff`, na kuweka `min-height` kuwa `2em`.
