...
أنشئ صنفًا فرعيًا `Spider` يرث من الصنف `Bug` مع تعيين المعلمة العامة إلى `string`.

# --hints--

يجب أن يكون لديك صنف باسم `Spider`.
...
يجب أن يرث صنف `Spider` من `Bug` مع معلمة نوع `string`.
