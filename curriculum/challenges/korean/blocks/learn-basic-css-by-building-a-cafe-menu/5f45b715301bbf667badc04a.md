...
메뉴 텍스트 `CAMPER CAFE`는 메뉴 하단의 주소 공간과 위쪽 공간이 다릅니다. 이는 브라우저가 `h1` 요소에 기본적으로 위쪽 여백을 설정하기 때문입니다.

`h1` 요소의 위쪽 여백을 `0`로 변경하여 모든 위쪽 여백을 제거하세요.

# --hints--

`margin-top` 속성을 `0`로 설정해야 합니다.
