...
Tengeneza kichaguzi cha `.daily-value p` ili kulenga vipengele vyote vya `p` katika sehemu ya `daily-value`. Toa kichaguzi hiki kipya sifa ya `border-bottom` iwe `1px solid #888989`.
