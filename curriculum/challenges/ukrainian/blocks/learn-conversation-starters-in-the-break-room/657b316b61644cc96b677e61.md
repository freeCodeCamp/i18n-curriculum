...
`Pics` — це коротка форма від `pictures`. Коли ви `take pics`, ви використовуєте свою камеру або мобільний телефон, щоб зробити знімки.

`Lots of` означає велику кількість або велику кількість чогось.
...
Це слово у множині означає зображення, зроблені за допомогою камери. Використовуйте коротку форму.
