...
L'elemento `em` fa sì che il testo sia in corsivo. Dà enfasi al testo anche semanticamente, influenzando anche in questo caso cose come i lettori di schermo. To define an emphasized element you wrap text content in an `<em>` tag.
