...
Aggiungi tre elementi `td` sotto a quello, e assegna loro il seguente testo, in ordine: `$200`, `$300` e `$400`. Dai al terzo elemento `td` un attributo `class` impostato su `current`.
