...
Infine, nel selettore `:root` della media query, ridefinisci tutte e quattro le variabili `--window-color` per usare `#777`. Quando hai finito, ridimensiona la finestra e guarda come passa dal giorno alla notte.

Le variabili si usano principalmente con i colori, ed è così che le hai usate qui. Ma possono avere qualsiasi valore e essere usate su qualsiasi proprietà. Il tuo progetto è fantastico!
