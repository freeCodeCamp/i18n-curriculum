...
Додайте селектор `:root` на початок вашого медіазапиту. Потім перевизначте всі чотири змінні `--building-color`, щоб вони використовували значення `#000` у цьому медіазапиті.

# --hints--

Ви повинні додати селектор `:root` до медіазапиту.
...
Ви повинні додати `--building-color1` зі значенням `#000`.
...
Ви повинні додати `--building-color2` зі значенням `#000`.
...
Ви повинні додати `--building-color3` зі значенням `#000`.
...
Ви повинні додати `--building-color4` зі значенням `#000`.
