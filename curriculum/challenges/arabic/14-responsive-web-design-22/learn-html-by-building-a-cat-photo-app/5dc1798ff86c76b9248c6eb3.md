...
Your `h1` element should have an opening tag. Opening tags تكتب هكذا: `<elementName>`.

```js
assert(document.querySelector('h1'));
```

Your `h1` element should have a closing tag. يجب أن تأتي علامات الغلق بـ `/` بعد رمز `<` مباشرة.
