...
Dentro da `@media` query, adicione um seletor `.keys` e defina `width` como `318px`.

# --hints--


A regra `@media` deve ter um seletor `.keys`.
...
O novo seletor `.keys` deve ter uma `width` de `318px`.
