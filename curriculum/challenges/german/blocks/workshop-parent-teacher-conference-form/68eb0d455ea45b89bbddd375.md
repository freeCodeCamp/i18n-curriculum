...
Jetzt sollten Sie dem Container etwas Innenabstand hinzufügen. Setzen Sie `padding` auf `10px 20px`. So legen Sie einen Innenabstand von `10px` oben und unten sowie `20px` links und rechts fest.
...
Setzen Sie die `padding`-Eigenschaft auf `10px 20px`.
