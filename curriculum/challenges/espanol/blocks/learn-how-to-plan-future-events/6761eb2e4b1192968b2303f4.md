...
Jake says he has been `looking into` their database security, which means he is investigating its current state. He concludes that they `need additional measures`, meaning some security exists, but it's not enough. Por ejemplo:
