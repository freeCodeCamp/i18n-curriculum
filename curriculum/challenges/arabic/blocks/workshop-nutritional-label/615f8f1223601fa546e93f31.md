...
أنشئ العنصر النهائي `p` لقسم `.daily-value`. اجعله يحتوي على النص `Potassium 235mg 6%`. حاذِ نص `6%` إلى اليمين، وأزل الحدود السفلية لعنصر `p`.
...
يجب أن يحتوي عنصر `p` الجديد على خاصية `class` مضبوطة على `no-divider`.
