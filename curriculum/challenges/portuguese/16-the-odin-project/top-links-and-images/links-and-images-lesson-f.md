...
title: Lição F de Links e imagens
challengeType: 15
...
Para exibir uma imagem em HTML, você usa o elemento `<img>`. Unlike the other elements you have encountered, the `<img>` is a void element. Empty, void HTML elements do not need a closing tag.
...
- Em seguida, baixe <a href="https://unsplash.com/photos/Mv9hjnEUHR4/download?force=true&w=640" target="_blank">esta imagem</a> e mova-a para o diretório de imagens que você acabou de criar.
