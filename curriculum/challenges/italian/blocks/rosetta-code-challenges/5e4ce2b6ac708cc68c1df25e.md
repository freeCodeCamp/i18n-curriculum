...
Un certo gioco per bambini consiste nel partire da una parola appartenente a una categoria specifica. Ogni partecipante a turno dice una parola, ma quella parola deve iniziare con l'ultima lettera della parola precedente. Una volta che una parola è stata detta, non può essere ripetuta. Se un giocatore non riesce a dire una parola nella categoria, viene eliminato dal gioco.

Per esempio, con "animali" come categoria,

<pre>Figlio 1: dog
Figlio 2: goldfish
Figlio 1: hippopotamus
Figlio 2: snake
...
</pre>
...
Scrivi una funzione che prende in input un array di parole. La funzione dovrebbe restituire un array di parole in cui la prima lettera di ogni parola è la stessa dell'ultima lettera della parola precedente. Usa solo le parole presenti nell'array di input e, una volta usata una parola, non può essere ripetuta. Le parole nell'array di ritorno devono essere selezionate e ordinate in modo da massimizzare la lunghezza della sequenza.
