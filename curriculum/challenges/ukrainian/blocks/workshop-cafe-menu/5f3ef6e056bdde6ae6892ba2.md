...
Трохи нудно, коли весь текст має однаковий `font-family`. Ви все одно можете зробити більшість тексту `sans-serif` і змінити лише `h1` та `h2` елементи, використовуючи інший селектор.

Стилізуйте одночасно `h1` і `h2` елементи за допомогою одного селектора, щоб текст цих елементів використовував шрифт `Impact`.
