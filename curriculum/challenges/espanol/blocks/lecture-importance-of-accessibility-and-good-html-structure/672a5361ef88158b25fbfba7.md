...
- macOS e iOS tienen Zoom.  You can turn it on on macOS by going to Settings, filter by Accessibility, and then click on "Zoom". Active la opción "Usar accesos directos de teclado para hacer zoom" para habilitarlo.
  - Puedes activarlo en iPhone a través de *Settings > Accessibility > Zoom*.
- Los dispositivos Android tienen Magnificación.  To turn it on, go to *Settings > Special Function > Accessibility> Magnification*. Dado que esto puede variar de un dispositivo a otro, puede buscar "Magnificación" en la página de inicio de configuración para acceder a ello.
- Windows tiene Lupa. Puedes usarla yendo a *Configuración > Facilidad de acceso > Lupa*.
