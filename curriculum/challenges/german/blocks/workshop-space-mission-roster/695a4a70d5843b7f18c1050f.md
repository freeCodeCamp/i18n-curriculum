...
Sortieren Sie das lokale `sorted`-Array direkt, indem Sie Ihre Hilfsfunktion `sortByPriorityDescending()` verwenden.

# --hints--

Sie sollten `sortByPriorityDescending()` mit dem `sorted`-Array aufrufen.
