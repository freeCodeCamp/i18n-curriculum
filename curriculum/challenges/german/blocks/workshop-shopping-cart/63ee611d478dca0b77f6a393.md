...
Sie haben in einer vorherigen Vorlesung gelernt, dass das Schlüsselwort `this` auf die aktuell erstellte Instanz verweist, wie Sie im `Dessert`-Konstruktor gesehen haben. Hier wenden Sie dieselbe Idee auf die `ShoppingCart`-Klasse an.
