...
Ora aggiorna il tuo selettore `h1` in `header h1` per mirare specificamente al tuo elemento `h1` all’interno del nuovo `header`.
...
Non dovresti modificare nessuna proprietà nel selettore.
