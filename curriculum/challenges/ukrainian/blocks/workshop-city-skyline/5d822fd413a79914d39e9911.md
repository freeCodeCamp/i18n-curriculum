...
Гарно виглядає! Перейдемо до будівель на передньому плані! Перетворіть будівлю `.fb1` на три секції, вклавши в неї три нові елементи `div`. Надайте їм класи `fb1a`, `fb1b` та `fb1c` (за таким же порядком).
