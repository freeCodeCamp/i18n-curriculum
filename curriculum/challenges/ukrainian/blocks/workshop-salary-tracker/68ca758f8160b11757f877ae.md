...
Ваша інструкція `if` має порівнювати `Employee._base_salaries[new_level]` з `Employee._base_salaries[self.level]`, щоб перевірити, чи новий рівень має нижчу базову зарплату.
