...
Додайте ще один повторюваний градієнт до цієї будівлі; зробіть його таким самим, як той, який ви щойно додали, але не додавайте напрямок `90deg` та використайте свій колір вікна замість двох кольорів `transparent`.
...
Ви повинні надати другому `repeating-linear-gradient` перший колір `--building-color3` від `0%` до `10%`.
...
Ви повинні надати другому `repeating-linear-gradient` другий колір `--window-color3` від `10%` до `30%`.
