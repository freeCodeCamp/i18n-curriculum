...
Como el texto en el `div` externo es negro por defecto, no es lo suficientemente visible. Así que, añade la clase `text-white` al `div`.

# --hints--

El elemento externo `div` debe tener la clase de utilidad `text-white`.
