...
Оскільки всі сторони меню мають те саме внутрішнє розташування, видаліть всі чотири властивості та використайте єдину властивість `padding` зі значенням `20px`.
...
Встановіть властивість `padding` на `20px`.
