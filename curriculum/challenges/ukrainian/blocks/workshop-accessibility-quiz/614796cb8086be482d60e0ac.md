...
Щодо теми візуальної доступності, контраст між елементами є ключовим фактором. Наприклад, коефіцієнт контрастності між текстом і фоном заголовка має бути не менше 4.5:1.
...
Ваш селектор має цілитися на посилання всередині елементів списку.
...
Ви маєте надати елементам `a` всередині елементів списку властивість `color`.
...
Ви повинні змінити колір лише елементів `a` всередині елементів списку.
