...
Nachdem Sie die Kategorie erhalten haben, geben Sie den folgenden f-String `f'\nExpenses for {category}:'` aus.

# --hints--

Sie sollten `f'\nExpenses for {category}:'` nach der Zuweisung von `category` ausgeben.
