...
Ahora agrega un `div` con el `className` de `form-group`. Dentro de él, agrega un `label` con el `className` de `label` y un atributo `htmlFor` de `name`. Debajo de eso, agrega un `input` con un `id` establecido en `name`, un `className` de `input` y un atributo `type` de `text`.

# --hints--

Deberías tener un `div` con el `className` de `form-group`.
...
Tu `form-group` debe contener un `label` con el `className` de `label` y un atributo `htmlFor` de `name`.
...
Tu `form-group` debe contener un `input` con un `id` de `name`, `className` de `input` y un `type` de `text`.
