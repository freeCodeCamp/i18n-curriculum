...
Останнє, що потрібно буде зробити — додати інструкцію `else if`.

Умова має перевіряти, чи позиція `x` гравця більша або дорівнює позиції `x` контрольної точки та менша або дорівнює позиції `x` контрольної точки плюс `40`.

В тілі інструкції `else if` потрібно буде викликати функцію `showCheckpointScreen` та передати рядок `"You reached a checkpoint!"` як аргумент.

Вітаємо! Ви завершили ігровий проект платформера!

# --hints--

Додайте умову `else if`, щоб перевірити, чи позиція `x` гравця більша або дорівнює позиції `x` контрольної точки та менша або дорівнює позиції `x` контрольної точки плюс `40`.
...
Викличте функцію `showCheckpointScreen` та передайте "You reached a checkpoint!" як аргумент.
