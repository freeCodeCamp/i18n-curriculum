...
Toa `wave` njia nne za kuanzia `10%`, na kuongeza kwa `10%`.

# --hints--

Unapaswa kuongeza `10%` njia kwa `@keyframes wave`.
...
Unapaswa kuongeza `20%` njia kwa `@keyframes wave`.
...
Unapaswa kuongeza `30%` njia kwa `@keyframes wave`.
...
Unapaswa kuongeza `40%` njia kwa `@keyframes wave`.
...
Unapaswa kuwa na njia 4 katika keyframe yako.
