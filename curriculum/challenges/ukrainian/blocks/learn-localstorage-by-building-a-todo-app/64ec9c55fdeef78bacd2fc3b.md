...
Замість того, щоб очищувати поля введення по одному, краще створити функцію, яка буде відповідати за очищення цих полів. Потім ви зможете викликати цю функцію щоразу, коли потрібно буде очистити поля введення.

Використайте стрілковий синтаксис, щоб створити `reset` функцію і призначити її парі фігурних дужок.

# --hints--

Ви повинні використати `const` і стрілковий синтаксис, щоб створити `reset` функцію.
