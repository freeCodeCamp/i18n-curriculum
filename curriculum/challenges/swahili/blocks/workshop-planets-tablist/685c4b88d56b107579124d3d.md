...
Ukitazama HTML, utaona kuwa paneli ya pili na ya tatu zimefichwa. Hii hufanywa kwa kutumia sifa ya kipengele ya `hidden`. Paneli ya kwanza inaonekana kwa chaguo-msingi. Mtumizi anapobofya kichupo, paneli zote zinapaswa kufichwa.

Tumia njia ya `forEach` kuzunguka `panels` na kuweka sifa ya kipengele ya `hidden` kwenye kila paneli kuwa `true`. 

# --hints--

Unapaswa kuzunguka `panels` na kuweka sifa ya kipengele ya `hidden` ya kila paneli kuwa `true`.
