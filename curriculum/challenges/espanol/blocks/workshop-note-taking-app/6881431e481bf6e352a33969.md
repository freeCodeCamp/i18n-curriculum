...
Como se mencionó antes, cuando el usuario edita la nota y luego hace clic fuera de la nota, debería mostrarse un mensaje indicando que la nota fue guardada. 

Para lograr esto, establece `statusEl.textContent` en la cadena `"Note saved successfully!"`.

Ahora, cuando lo pruebes, deberías ver ese mensaje en la pantalla.

# --hints--

Cuando el usuario edita una nota, el mensaje de estado debe actualizarse para indicar que la nota fue guardada.
