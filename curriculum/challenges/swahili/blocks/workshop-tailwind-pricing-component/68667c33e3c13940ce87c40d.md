...
`span` ambayo ina muda pia inahitaji mtindo fulani, kwa hivyo ongeza madarasa ya vitu `text-base`, `font-medium`, na `text-fuchsia-300` kwake.

# --hints--

Kipengele chako cha `span` kinapaswa kuwa na darasa la vitu `text-base`.
...
Kipengele chako cha `span` kinapaswa kuwa na darasa la vitu `font-medium`.
...
Kipengele chako cha `span` kinapaswa kuwa na darasa la vitu `text-fuchsia-300`.
