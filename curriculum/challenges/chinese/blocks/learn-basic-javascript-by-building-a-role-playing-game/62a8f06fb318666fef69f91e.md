...
单词 `"Arg!"` 应当用引号引起来。 除了转义引号之外，还有另一种方法可以在字符串中包含引号。

将字符串 `"The monster screams Arg! as it dies. You gain experience points and find gold."` 周围的双引号更改为单引号 `'`，然后在 `"Arg!"` 周围添加双引号。
