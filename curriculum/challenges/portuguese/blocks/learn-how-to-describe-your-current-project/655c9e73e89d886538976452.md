...
Este verbo significa estar encarregado da equipe. Termina em `-ing`.
...
Este verbo significa criar algo novo. Ele termina em `-ing`.
...
Este verbo significa tentar fazer algo. Termina em `-ing`.
...
Este verbo significa falar com alguém.
