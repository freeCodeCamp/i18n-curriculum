...
今度はCTAをボタンのように見えるようにスタイルを設定しましょう。

背景色と前景色には、クラス`bg-gradient-to-r`、`from-fuchsia-500`、`to-indigo-600`、`text-white`、`hover:from-fuchsia-600`、`hover:to-indigo-700`を代入してください。また、クラス`rounded-md`と`block`も代入してください。

# --hints--

アンカー要素にはクラス`bg-gradient-to-r`を付けてください。
...
アンカー要素にはクラス`from-fuchsia-500`を付けてください。
...
アンカー要素にはクラス`to-indigo-600`を付けてください。
...
アンカー要素にはクラス`text-white`を付けてください。
...
アンカー要素にはクラス`hover:from-fuchsia-600`を付けてください。
...
アンカー要素にはクラス`hover:to-indigo-700`を付けてください。
...
アンカー要素にはクラス`rounded-md`を付けてください。
