...
У цьому практичному занятті ви створите застосунок музичного плеєра, який зможе відтворювати, призупиняти та пропускати пісні зі списку відтворення.

HTML і CSS цього проєкту вже надані, тож ви можете зосередитися на JavaScript.

Почніть із доступу до елементів `#playlist-songs`, `#play` і `#pause` та призначте їх відповідно змінним `playlistSongs`, `playButton` і `pauseButton`.
...
Ви маєте призначити елемент `#playlist-songs` змінній `playlistSongs`. 
...
Ви маєте призначити елемент `#play` змінній `playButton`. 
...
Ви маєте призначити елемент `#pause` змінній `pauseButton`. 
