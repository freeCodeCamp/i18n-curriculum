...
`Keep in mind` means to remember something important when making choices or taking action. It is used when someone wants to stay aware of a detail or fact. 例如：
