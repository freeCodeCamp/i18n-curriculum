...
Crea una declaración `if` para comprobar si el objeto `allCategories` tiene una propiedad de `id`. Recuerda, puedes usar el método `hasOwnProperty()` para esto.

# --hints--

Debes tener una declaración `if` que comprueba si el objeto `allCategories` tiene una propiedad de `id`
