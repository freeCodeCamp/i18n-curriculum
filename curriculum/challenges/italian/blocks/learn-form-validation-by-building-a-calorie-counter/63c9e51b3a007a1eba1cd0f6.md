...
Ora dichiara una variabile `remainingCalories` e assegnale il valore della sottrazione di `consumedCalories` da `budgetCalories` più `exerciseCalories`.

# --hints--

La tua funzione `calculateCalories` dovrebbe avere una variabile `remainingCalories`.
