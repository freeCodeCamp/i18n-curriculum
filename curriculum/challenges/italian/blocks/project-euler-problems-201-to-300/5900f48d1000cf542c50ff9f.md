...
Per ogni numero primo $p$ il numero $N(p,q)$ è definito da $N(p,q) = \sum_{n=0}^q T_n \times p^n$ con $T_n$ generato dal seguente generatore di numeri casuali:
...
Ti viene dato che $NF(3,10000) \bmod 3^{20} = 624\\,955\\,285$.
