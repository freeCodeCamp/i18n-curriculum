...
Послухайте Тома і визначте, чи він використовує прикметник, чи прислівник, пов’язаний із `ethics`.
...
Цей вираз стосується етики. Подумайте, **як** слід використовувати AI у цьому випадку.
