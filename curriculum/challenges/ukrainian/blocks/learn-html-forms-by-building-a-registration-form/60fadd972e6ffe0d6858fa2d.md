...
Встановіть властивість `width` на `100%`.
...
Встановіть властивість `margin-top` на `10px`.
...
Встановіть властивість `margin-bottom` на `0`.
...
Встановіть властивість `margin-left` на `0`.
...
Встановіть властивість `margin-right` на `0`.
