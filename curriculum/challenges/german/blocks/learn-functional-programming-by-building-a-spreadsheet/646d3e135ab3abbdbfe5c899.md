...
Ihre Callback-Funktion benötigt vier Parameter. `match`, `arg1`, `operator` und `arg2`.

Sie werden den Parameter `match` nicht verwenden, also denken Sie daran, ihn mit einem Präfix zu versehen.
...
Ihre Callback-Funktion sollte weiterhin leer sein.
