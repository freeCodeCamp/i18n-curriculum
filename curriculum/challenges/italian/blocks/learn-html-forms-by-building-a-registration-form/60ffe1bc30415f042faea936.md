...
Per far sì che gli elementi `input` e `textarea` si integrino con il tema di sfondo, imposta il loro `background-color` su `#0a0a23`. Poi, assegna loro un bordo `1px`, `solid` con un colore `#0a0a23`.

# --hints--

Dovresti usare un selettore di elementi separati da virgola per selezionare gli elementi `input` e `textarea`.
...
Dovresti dare agli elementi `input` e `textarea` un `background-color` di `#0a0a23`.
...
Dovresti dare agli elementi `input` e `textarea` un bordo `1px`, `solid` con un colore `#0a0a23`.
