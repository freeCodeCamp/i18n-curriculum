...
- macOS e iOS têm ambos o Zoom. Você pode habilitá-lo no macOS indo em Configurações, filtrando por Acessibilidade e clicando em "Zoom". Ative a opção "Usar atalhos de teclado para zoom" para habilitar.
  - Você pode habilitá-lo no iPhone em _Configurações > Acessibilidade > Zoom_.
- Dispositivos Android têm a Ampliação. Para ativar, vá em _Configurações > Função Especial > Acessibilidade > Ampliação_. Como isso pode variar de dispositivo para dispositivo, você pode buscar por "Ampliação" na página inicial das configurações para acessá-la.
- Windows tem o Lupa. Você pode usá-lo indo em _Configurações > Facilidade de Acesso > Lupa_.
- Os ampliadores para sistemas operacionais Linux variam. Pode ser o Zoom ou o Lupa.
...
- iZoom para Windows.
- Zoomify - ampliador de tela para macOS.
