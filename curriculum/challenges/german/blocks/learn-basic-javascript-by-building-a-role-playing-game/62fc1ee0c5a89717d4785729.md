...
Geben Sie Ihrem `#monsterStats`-Element denselben `border` und `padding` wie Ihrem `#stats`-Element. Setzen Sie seine Farbe auf `#ffffff` und geben Sie ihm einen `#c70d0d`-Hintergrund.
...
Ihr `#monsterStats`-Selektor sollte einen `border` von `1px solid #0a0a23` haben.
...
Ihr `#monsterStats`-Selektor sollte einen `5px` von Innenabstand haben.
...
Ihr `#monsterStats`-Selektor sollte einen `color` von `#ffffff` haben.
...
Ihr `#monsterStats`-Selektor sollte einen `background-color` von `#c70d0d` haben.
