...
Present continuous is used for actions happening at the moment of speaking. Ad esempio:
...
Present continuous can be used in negative forms to express that something is not happening. Ad esempio:
