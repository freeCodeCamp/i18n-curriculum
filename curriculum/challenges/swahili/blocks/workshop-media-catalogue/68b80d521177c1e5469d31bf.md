...
Sasa baada ya njia ya `__init__` kukamilika, tengeneza kigezo kinachoitwa `series1` ndani ya sehemu ya `try`. Weka thamani yake kuwa mfano wa `TVSeries` ukitumia hoja unazochagua. Kisha, chapisha `series1` kwenye konsoli.

# --hints--

Unapaswa kuweka thamani ya mfano wa `TVSeries` kwenye kigezo kinachoitwa `series1` ndani ya sehemu ya `try`.
...
Unapaswa kuchapisha `series1` ndani ya sehemu ya `try`.
