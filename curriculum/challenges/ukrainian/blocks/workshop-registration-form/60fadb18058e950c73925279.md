...
Під час розробки корисно бачити `fieldset` кордони за замовчуванням. Однак вони роблять вміст надто розділеним.

Видаліть `border` і додайте `2rem` відступу лише зверху та знизу кожного `fieldset`. Обов’язково видаліть `padding` зліва та справа.
...
Ви повинні додати `padding` відступу `2rem` зверху та знизу кожного `fieldset`.
...
Ви повинні видалити `padding` зліва та справа кожного `fieldset`.
