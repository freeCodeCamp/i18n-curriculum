...
Ora non riusciamo a leggere il testo. Imposta il colore del carattere del `footer` e dell'elemento àncora al suo interno su un colore con un rapporto di contrasto adeguato.

# --hints--

Dovresti usare il selettore `footer, footer a`.
...
Dovresti impostare il `color` su un valore con un rapporto di contrasto di almeno `7:1`. _Suggerimento: ti consiglio `#dfdfe2`_
