...
Então, adicione um `console.log` e faça a chamada da `getShoppingListMsg` função com o `shoppingList` array como argumento dentro do `console.log` para ver a lista atualizada registrada no console.
