...
Papéis de janela definem sub-janelas, como diálogos modais pop-up. Esses papéis incluem `alertdialog` e `dialog`. Note que agora é considerada uma melhor prática usar o elemento HTML `dialog` e seus métodos JavaScript associados em vez de criar um diálogo manualmente.
...
Leitores de tela e outras tecnologias assistivas usam essas informações para ajudar os usuários a entender o conteúdo da sua página e definir expectativas sobre como usá-la, o que ajuda a garantir que todos tenham uma ótima experiência de uso.
...
Qual categoria de papéis ARIA é usada para definir o propósito e o comportamento de sub-janelas, como diálogos modais pop-up?
