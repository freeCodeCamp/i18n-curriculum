...
Китайською числом 70 називають `七十 (qī shí)`.

Числа від 71 до 79 утворюються шляхом додавання цифри одиниць (1–9) після `七十 (qī shí)` (70).
...
Я практикувався вимовляти числа від 70 до 79.
