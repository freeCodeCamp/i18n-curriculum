...
Parece que para um conjunto ótimo dado, $A = \{a_1, a_2, \ldots, a_n\}$, o próximo conjunto ótimo é da forma $B = \{b, a_1 + b, a_2 + b, \ldots, a_n + b\}$, onde b é o elemento "do meio" na linha anterior.

Ao aplicar esta "regra" esperaríamos que o conjunto ótimo para $n = 6$ fosse $A = \{11, 17, 20, 22, 23, 24\}$, com $S(A) = 117$.No entanto, este não é o conjunto ideal, já que apenas aplicamos um algoritmo para fornecer um conjunto quase ideal.O conjunto ótimo para $n = 6$ é $A = \{11, 18, 19, 20, 22, 25\}$, com $S(A) = 115$ e a string correspondente do conjunto: `111819202225`.

Dado que A é uma soma especial ideal para $n = 7$, encontre sua string definida.

**Nota:** Este problema está relacionado ao Problema 105 e ao Problema 106.
