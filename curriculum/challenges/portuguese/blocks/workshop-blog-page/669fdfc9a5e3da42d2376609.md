...
Agora que você adicionou a seção sobre, tente clicar no link `About` para ver a página pular para essa seção.
...
Seu elemento `h2` deve estar dentro do elemento `section`.
