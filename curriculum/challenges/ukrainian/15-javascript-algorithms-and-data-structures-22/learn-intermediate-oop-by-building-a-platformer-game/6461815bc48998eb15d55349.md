...
У цьому проєкті ви вивчатимете принципи об’єктноорієнтованого програмування середнього рівня, створюючи гру-платформер. Вам вже надано всі HTML та CSS.

Почніть із використання `document.getElementById()`, щоб отримати елементи `#start-btn` та `#canvas`.

Зберігайте їх у `const` змінних з іменами `startBtn` та `canvas` відповідно.
...
Отримайте елемент з `id` зі значенням `start-btn`.
...
Використайте метод `document.getElementById()`, щоб отримати елемент `#canvas`.
