...
Тепер створіть функцію `initializeApp` і поки що залиште її порожньою.

Вона ініціалізує весь застосунок після завантаження DOM. Отже, це та функція, яку ви незабаром передасте у подію `DOMContentLoaded`, щоб запустити застосунок.

# --hints--

Ви маєте створити функцію `initializeApp`.
