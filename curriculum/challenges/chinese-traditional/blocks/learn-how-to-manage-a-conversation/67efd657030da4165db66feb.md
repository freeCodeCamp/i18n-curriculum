...
`It's been a while since...` is normally used when a significant amount of time has passed since something happened. It's often used to refer to the last time something occurred, but with a focus on how much time has passed. 例如：
