...
Se clicchi sul pulsante `Load More Authors` dopo aver chiamato la funzione, non funzionerà. Questo perché devi ancora aggiungere l'event listener `click` al pulsante. Sarà la prossima cosa che farai.
