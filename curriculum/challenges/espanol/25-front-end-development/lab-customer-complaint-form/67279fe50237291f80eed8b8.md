...
**Objetivo:** Cumplir con las historias de usuario a continuación y obtener que todas las pruebas pasen para completar el laboratorio.
...
Cuando el formulario se envíe y todos los botones de opción de `#solutions-group` estén en estado desmarcado, debe establecer el color de borde de `#solutions-group` en `red`.
