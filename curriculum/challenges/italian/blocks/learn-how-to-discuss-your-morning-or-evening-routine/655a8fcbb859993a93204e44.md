...
Questa preposizione si usa per introdurre il modo in cui si fa qualcosa.
...
È la forma in gerundio di `listen`, usata qui dopo la congiunzione `or` per descrivere un altro metodo di rilassamento.
