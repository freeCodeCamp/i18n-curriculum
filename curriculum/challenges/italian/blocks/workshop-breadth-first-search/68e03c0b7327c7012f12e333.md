...
Infine, chiama `gen_parentheses` con `3` come argomento per generare tutte e cinque le combinazioni valide di tre coppie di parentesi tonde e stampa il risultato nella console. Con questo il workshop è completo.

# --hints--

Dovresti stampare `gen_parentheses(3)`.
