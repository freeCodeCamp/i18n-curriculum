...
既存の黒と茶色のカラーテーマを維持するために、リンクが訪問済みのときの色を`black`に変更し、リンクが実際にクリックされたときには`brown`を使ってください。

# --hints--

リンクが`color`のときに、`black`プロパティを`visited`に設定してください。
...
リンクが`color`のときに、`brown`プロパティを`active`に設定してください。
