...
أنشئ عنصر `p` آخر أسفل الفاصل الكبير. اجعل نص عنصر `p` هو `Vitamin D 2mcg 10%`.

عنصر `p` يحتوي فقط على نص، يمكنك تغليف النسبة المئوية في عنصر `span` ليُعتبر كيانًا منفصلًا عن بقية النص، ويتم تحريكه إلى اليمين.
...
يجب أن يحتوي عنصر `p` الجديد على النص `Vitamin D 2mcg 10%`.
...
يجب ألا يكون عنصر `span` الخاص بك عريضًا.
