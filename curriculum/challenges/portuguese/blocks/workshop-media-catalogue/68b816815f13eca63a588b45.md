...
Uma docstring é uma string colocada como a primeira declaração em uma classe ou função e é usada para fornecer documentação para essa classe ou função. Docstrings são tipicamente delimitadas por três aspas duplas:
...
Complete sua classe `Movie` adicionando a seguinte docstring a ela: `Parent class representing a movie.`

# --hints--

Você deve adicionar a docstring `Parent class representing a movie.` à sua classe `Movie`.
