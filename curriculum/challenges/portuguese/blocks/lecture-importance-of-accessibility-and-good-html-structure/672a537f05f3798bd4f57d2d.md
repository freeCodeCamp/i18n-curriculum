...
O IBM Equal Access Accessibility Checker é outra ferramenta robusta para melhorar a acessibilidade de conteúdo digital. Com ele, você pode escanear seus sites em busca de problemas de acessibilidade e gerar um relatório detalhado.
...
Ele pode ser usado como uma extensão do Chrome, uma extensão do Firefox ou um pacote npm.
