...
Тепер потрібно визначити властивості, які будуть у всіх помилок.

Всередині класу `Bug` оголосіть властивість з іменем `emoji` типу `T`, використовуючи оператор твердження визначеного присвоєння (`!`). Це повідомляє TypeScript, що властивість буде призначена пізніше.

# --hints--

Ваш клас `Bug` має мати властивість з іменем `emoji`.
...
Ваша властивість `emoji` має мати тип `T`.
...
Ваша властивість `emoji` має використовувати оператор твердження визначеного присвоєння (`!`).
