...
Considere que $d_1$ seja o $1^{o}$ algarismo, $d_2$ seja o $2^{o}$ algarismo, e assim por diante. Desta forma, podemos perceber o seguinte:
...
**Nota:** Números pandigitais que começam com `0` devem ser considerados no resultado.
