...
Wiederhole für die dritten und vierten Wegpunkte das `transform`-Muster erneut.

# --hints--

Du solltest dem `30%`igen Wegpunkt einen `transform` von `rotate(110deg) scaleX(-1)` geben.
...
Du solltest dem `40%`igen Wegpunkt einen `transform` von `rotate(130deg) scaleX(-1)` geben.
