...
Aggiungi `1` al valore di `sortedIndex`.

Nota che l’incremento deve essere fatto dopo aver assegnato l’elemento della parte sinistra all’array ordinato.

# --hints--

Dovresti incrementare il valore corrente di `sortedIndex` di uno all’interno del loop `while`.
