...
Copie y pegue su clase `sky` completa junto con todas sus propiedades y valores en la consulta de medios. Vas a crear otro esquema de color para el horizonte que lo cambie de día a noche.

Nota: Vas a necesitar desplazarte más allá de la región editable para copiar la clase.

# --hints--

No debes eliminar la declaración existente de `.sky`.
...
Debes copiar la declaración existente de `.sky` en la consulta de medios.
