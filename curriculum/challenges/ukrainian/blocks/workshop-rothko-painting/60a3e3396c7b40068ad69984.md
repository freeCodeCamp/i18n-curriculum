...
Вирівняйте елемент `.two` по центру, встановивши його `margin` у `auto`.

# --hints--

Ви повинні встановити властивість `margin` у `auto`.
...
Ваш елемент `.two` має мати значення `margin` рівне `auto`.
