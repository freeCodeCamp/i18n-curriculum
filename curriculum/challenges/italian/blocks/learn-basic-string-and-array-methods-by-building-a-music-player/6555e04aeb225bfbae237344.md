...
Ora, chiama la funzione `setPlayButtonAccessibleText` all'interno della funzione `playSong`.

# --hints--

Dovresti chiamare la funzione `setPlayButtonAccessibleText` all'interno della tua funzione `playSong`.
