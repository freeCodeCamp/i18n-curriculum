...
Ora che sai come consultare gli attributi di un oggetto, rimuovi le chiamate `print` esistenti.

# --hints--

Dovresti rimuovere l'istruzione `print(instrument_1.name)`.
...
Dovresti rimuovere l'istruzione `print(instrument_1.instrument_type)`.
...
Dovresti rimuovere l'istruzione `print(instrument_2.name)`.
...
Dovresti rimuovere l'istruzione `print(instrument_2.instrument_type)`.
