...
Finalmente, crie uma quarta declaração `if` que lance uma `ValueError` com a mensagem `Cannot change to lower level.` quando o salário base do novo nível for menor que o salário base do nível atual.
