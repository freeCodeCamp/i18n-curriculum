...
De manera similar al paso anterior, necesitas asegurarte de que el índice de columna inicial para cada cuadrado 3x3 sea un múltiplo de 3.

Declara una variable `col_start` y asígnale `(col // 3) * 3`.

# --hints--

Debes declarar una variable `col_start` con el valor de `(col // 3) * 3`.
