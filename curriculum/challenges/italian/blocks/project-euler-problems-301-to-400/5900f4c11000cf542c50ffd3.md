...
title: "Problema 341: la sequenza autodescrittiva di Golomb"
challengeType: 1
forumTopicId: 302000
...
La sequenza autodescrittiva di Golomb ($G(n)$) è l'unica sequenza non decrescente di numeri naturali tale che $n$ appare esattamente $G(n)$ volte nella sequenza. I valori di $G(n)$ per i primi $n$ sono
...
Ti viene anche detto che $\sum G(n^3) = 153\\,506\\,976$ per $1 ≤ n &lt; {10}^3$.
