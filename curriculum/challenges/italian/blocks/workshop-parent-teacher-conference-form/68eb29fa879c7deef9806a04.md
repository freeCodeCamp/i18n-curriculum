...
Per assicurarti che il testo inserito negli input e nelle textarea, così come i loro segnaposto, sia visibile, imposta il loro colore.

Seleziona `input, input::placeholder, textarea` e imposta `color` su `whitesmoke`.

# --hints--

Dovresti mirare a `input`, `input::placeholder`, `textarea`.
