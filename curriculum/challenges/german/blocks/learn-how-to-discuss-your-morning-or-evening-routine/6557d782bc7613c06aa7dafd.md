...
The word `never` is an adverb used to mean "not at any time" or "not ever". Es wird oft verwendet um über Dinge zu sprechen, die jemand nicht tut oder getan hat. Hier ein Beispiel:
