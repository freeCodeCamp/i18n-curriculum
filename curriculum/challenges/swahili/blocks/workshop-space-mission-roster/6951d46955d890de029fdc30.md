...
Hapo awali ulikuwa umeongeza wito wa `console.log()` kwenye kitendakazi chako cha `swapCrewMembers` ili kuthibitisha tabia yake, na sasa wito huo hauhitajiki tena. Ili kuzuia terminal kuwa na msongamano katika hatua zijazo, endelea na futa mzunguko wa sasa wa `for` unaoandika kwenye konsoli.

# --hints--

Futa mzunguko wa `for` kutoka kwenye kitendakazi cha `swapCrewMembers`. Unapaswa kufuta sehemu yote ya mzunguko.
