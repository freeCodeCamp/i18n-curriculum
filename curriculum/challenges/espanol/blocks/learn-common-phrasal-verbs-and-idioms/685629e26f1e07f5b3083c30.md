...
`Real-time alerts` are messages or warnings that appear immediately as something happens. Por ejemplo:
...
`Graphics` are images or visual elements used to communicate information. Por ejemplo:
