...
Tu encabezado `header` debería tener la propiedad `display` establecida como `flex`.
...
Tu `footer` debería tener la propiedad `display` establecida como `flex`.
...
Tu `h3` debería tener la propiedad `display` establecida como `flex`.
...
Tu `h4` debería tener la propiedad `display` establecida como `flex`.
...
Tu clase `.profile-name` debería tener la propiedad `display` establecida como `flex`.
...
Tu clase `.follow-btn` debería tener la propiedad `display` establecida como `flex`.
...
Tu clase `.stats` debería tener la propiedad `display` establecida como `flex`.
