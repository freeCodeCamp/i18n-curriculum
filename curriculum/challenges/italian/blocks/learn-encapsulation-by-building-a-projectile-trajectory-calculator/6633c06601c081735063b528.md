...
Hai costruito un calcolatore di traiettoria di un proiettile.

Ora per concludere, modifica il codice che hai scritto all'esterno delle classi e incorporalo in una piccola funzione di utilità chiamata `projectile_helper` che prende in input i valori desiderati di velocità, altezza e angolo e stampa sul terminale in sequenza, i dettagli del proiettile, la tabella delle coordinate e il grafico della traiettoria.

Chiama `projectile_helper` una volta con valori a tua scelta.

# --hints--

Dovresti creare `projectile_helper` nell'ambito globale.
...
Dovresti stampare le stringhe richieste in ordine. Non stampare altri valori.
...
Dovresti chiamare la funzione `projectile_helper` almeno una volta.
...
Non dovresti avere variabili o chiamate di stampa nell'ambito globale.
