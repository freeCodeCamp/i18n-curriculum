...
`source` لمشكلة ما تشير إلى أصل أو سبب المشكلة. في البرمجة، إيجاد الـ `source` للمشكلة ضروري لحلها. على سبيل المثال: `The source of the error was a missing semicolon.`
...
يشير إلى الانتباه لشيء غير معتاد أو غير متوقع في النظام.
...
يشير إلى بذل جهد أو محاولة القيام بشيء ما، في هذه الحالة، إيجاد مصدر المشكلة.
...
يشير إلى أصل أو سبب المشكلة التي تحتاج صوفي إلى تحديدها.
