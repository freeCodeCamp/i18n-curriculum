...
Per quanto riguarda l'accessibilità visiva, il contrasto tra gli elementi è un fattore chiave. Ad esempio, il contrasto tra il testo e lo sfondo di un titolo dovrebbe essere almeno 4.5:1.

Cambia il colore del testo di tutti gli elementi di ancoraggio dentro gli elementi della lista in modo che abbia un rapporto di contrasto di almeno 7:1.
