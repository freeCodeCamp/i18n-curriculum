...
Sasa ndani ya kitendakazi cha `isSelect`, rudisha thamani ya kweli au siyo kweli ikionyesha kama `element` ni mfano wa `HTMLSelectElement`. Tumia kielezi cha `instanceof` kufanya ukaguzi huu.

# --hints--

Kitendakazi chako cha `isSelect` kinapaswa kurudisha `element instanceof HTMLSelectElement`.
