...
`querySelectorAll()` メソッドに文字列 `input[type="text"]` を渡してください。 Remember that you will need to use single quotes for your string, so that you can use double quotes within.
