...
`Specify` means to clearly state or describe something in detail. 例如：

`Please specify the time and place of the meeting.` – This means say exactly when and where the meeting will be.

`What makes it` is a noun clause. A group of words that acts like a noun in the sentence. It explains the reason or cause behind something. 例如：
