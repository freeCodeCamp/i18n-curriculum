...
Maneno haya mawili yanaonyesha lazima — jambo ambalo linapaswa kufanywa.

# --explanation--

`Have to` hutumika kuonyesha lazima — jambo ambalo linapaswa kufanywa. Kwa mfano:

- `We have to submit the report by Friday.` - Inahitajika.

- `You have to wear a seatbelt in the car.` - Ni muhimu kwa usalama.
