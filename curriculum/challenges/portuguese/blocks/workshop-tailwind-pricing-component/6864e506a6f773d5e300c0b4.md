...
Neste ponto, os itens estão muito próximos uns dos outros.Adicione `gap-8` para criar um espaço entre eles e use `mt-16` para empurrá-los um pouco para baixo a partir do topo.

# --hints--

Seu elemento `div` deve ter a classe `gap-8`.
...
Seu elemento `div` deve ter a classe `mt-16`.
