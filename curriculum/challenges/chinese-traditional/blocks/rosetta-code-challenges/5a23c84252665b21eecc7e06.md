...
給定的矩形由 *m* × *n* 個方格組成。如果 *m* 和 *n* 並非同時為奇數，則可以沿著方格邊緣切出一條路徑，使矩形分成兩個連通且形狀相同的部分（將其中一部分旋轉 180° 後）。下方顯示了所有 2 × 2 和 4 × 3 矩形的此類路徑。
