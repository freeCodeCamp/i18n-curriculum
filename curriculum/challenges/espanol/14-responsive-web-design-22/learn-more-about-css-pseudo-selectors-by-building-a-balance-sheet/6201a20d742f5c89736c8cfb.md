...
Debes tener un selector `tr.data th`.

```js
assert(new __helpers.CSSHelp(document).getStyle('tr.data th'));
```

Tu selector `tr.data th` debe tener la propiedad `text-align` establecida en `left`.

```js
assert(new __helpers.CSSHelp(document).getStyle('tr.data th')?.getPropertyValue('text-align') === 'left');
```

Tu selector `tr.data th` debe tener una propiedad `padding-top` establecida en `0.3rem`.

```js
assert(new __helpers.CSSHelp(document).getStyle('tr.data th')?.getPropertyValue('padding-top') === '0.3rem');
```

Tu selector `tr.data th` debe tener una propiedad `padding-left` establecida en `0.5rem`.
