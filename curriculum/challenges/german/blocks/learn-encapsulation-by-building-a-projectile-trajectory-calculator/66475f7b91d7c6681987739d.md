...
Sie haben eine Liste von Listen mit Strings. Verbinden Sie die inneren Listen, um eine Liste von Strings zu erhalten.
...
`create_trajectory()` sollte die korrekte Ausgabe für verschiedene Fälle berechnen.
