...
title: 'Завдання 320: факторіали, кратні величезному цілому числу'
challengeType: 1
forumTopicId: 301977
...
Нехай $N(i)$ — найменше ціле число $n$, таке що $n!$ ділиться на $(i!)^{1234567890}$.
...
`divisibleByHugeInteger()` має повертати `278157919195482660`.
