...
Dovresti dare agli elementi `a` dentro gli elementi lista una proprietà `color`.
...
Dovresti cambiare solo il colore degli elementi `a` dentro gli elementi lista.
