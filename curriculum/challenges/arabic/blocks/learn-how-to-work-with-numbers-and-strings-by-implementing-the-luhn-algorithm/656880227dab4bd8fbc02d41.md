...
أحسنت على إكمال هذا المشروع.

كخطوة نهائية، احذف استدعاء `print` من الدالة `verify_card_number`، وغيّر قيمة `card_number` إلى شيء صالح.

# --hints--

يجب ألا يكون هناك استدعاء `print` داخل الدالة `verify_card_number`.
...
يجب أن تغيّر `card_number` إلى شيء صالح.
