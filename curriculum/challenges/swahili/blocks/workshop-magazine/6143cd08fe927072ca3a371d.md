...
Ndani ya kipengele chako cha `.image-wrapper`, mpe kipengele cha pili cha `img` sifa ya `src` yenye thamani `https://cdn.freecodecamp.org/testable-projects-fcc/images/calc.png`, sifa ya `alt` yenye thamani `image of a calculator project`, sifa ya `loading` iliyowekwa kuwa `lazy`, sifa ya `class` iliyowekwa kuwa `image-2`, sifa ya `width` iliyowekwa kuwa `400`, na sifa ya `height` iliyowekwa kuwa `400`.
...
Kipengele chako cha pili cha `img` kinapaswa kuwa na sifa ya `alt` iliyowekwa kuwa `image of a calculator project`.
...
Kipengele chako cha pili cha `img` kinapaswa kuwa na sifa ya `class` iliyowekwa kuwa `image-2`.
