...
تابع بإضافة `div` مع `className` بقيمة `form-row`. بداخله، أضف عنصرين `div` لكل منهما `className` بقيمة `form-group`.

يجب أن يحتوي أول عنصر `div` على `label` مع `className` بقيمة `label`، و`htmlFor` بقيمة `position`، ونص `Position`، و`input` مع `id` بقيمة `position`، و`className` بقيمة `input`، و`type` بقيمة `text`.

# --hints--

يجب أن يحتوي قسم معلومات اللاعب على `div` مع `className` بقيمة `form-row`.
...
يجب أن يحتوي `div.form-row` على عنصرين `div` لكل منهما `className` بقيمة `form-group`.
...
يجب أن يحتوي أول `form-group` في الصف على `label` مع `className` بقيمة `label` و`htmlFor` بقيمة `position`.
...
يجب أن يحتوي `label` الخاص بالموضع على النص `Position`.
...
يجب أن يحتوي أول `form-group` في الصف على `input` مع `className` بقيمة `input`، و`id` بقيمة `position`، و`type` بقيمة `text`.
