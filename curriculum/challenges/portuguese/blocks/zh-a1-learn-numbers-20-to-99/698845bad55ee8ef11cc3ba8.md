...
Em chinês, o número 70 é chamado de `七十 (qī shí)`.

Os números de 71 a 79 são formados adicionando o dígito das unidades (1–9) após `七十 (qī shí)` (70).
...
Eu pratiquei a pronúncia dos números de 70 a 79.
