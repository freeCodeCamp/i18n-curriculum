...
Geben Sie `.fb1b` eine `width` von `60%` und `height` von `10%`, und `.fb1c` eine `width` von `100%` und `height` von `80%`.

# --hints--

Sie sollten `.fb1b` eine `width` von `60%` geben.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle(".fb1b")?.width, "60%");
```

Sie sollten `.fb1b` eine `height` von `10%` geben.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle(".fb1b")?.height, "10%");
```

Sie sollten `.fb1c` eine `width` von `100%` geben.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle(".fb1c")?.width, "100%");
```

Sie sollten `.fb1c` eine `height` von `80%` geben.
