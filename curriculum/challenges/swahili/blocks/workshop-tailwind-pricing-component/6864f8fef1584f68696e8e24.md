...
Sasa, unapaswa kuhama kwenda kwenye `Start listening` CTA ili kuifanya kuwa kitufe halali.

Weka darasa la vitu la huduma `bg-indigo-100`, `px-4`, `py-2`, `text-center`, `font-semibold`, `text-indigo-700`, na `hover:bg-indigo-200`.

# --hints--

Kipengele chako cha nanga kinapaswa kuwa na darasa la vitu `bg-indigo-100`.
...
Kipengele chako cha nanga kinapaswa kuwa na darasa la vitu `px-4`.
...
Kipengele chako cha nanga kinapaswa kuwa na darasa la vitu `py-2`.
...
Kipengele chako cha nanga kinapaswa kuwa na darasa la vitu `text-center`.
...
Kipengele chako cha nanga kinapaswa kuwa na darasa la vitu `font-semibold`.
...
Kipengele chako cha nanga kinapaswa kuwa na darasa la vitu `text-indigo-700`.
...
Kipengele chako cha nanga kinapaswa kuwa na darasa la vitu `hover:bg-indigo-200`.
