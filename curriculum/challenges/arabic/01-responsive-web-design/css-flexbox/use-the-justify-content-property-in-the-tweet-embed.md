...
title: استخدم خاصية justify-content في تضمين التغريدة
challengeType: 0
...
أضف خاصية الـ CSS و هي `justify-content` الي عنصر `.profile-name` بالـ header وغير القيمة لأي من الخيارات من التحدي الأخير.
