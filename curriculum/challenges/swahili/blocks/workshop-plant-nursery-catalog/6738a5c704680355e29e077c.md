...
Kama ulivyoshajifunza, njia ya `delete` hutumika kuondoa kipengee kutoka kwenye ramani. Sets zina njia ya `delete` ambayo unaweza kuitumia pia kuondoa kipengee kutoka ndani yake.

Wakati mwingine unaweza kuhitaji kuondoa vipengee vyote kutoka kwenye ramani au seti. Njia ya `clear` hufanya kazi hiyo kabisa.

Fanya wito wa njia ya `clear` kwenye `plantsSet` kuondoa vipengee vyote kutoka ndani yake.

# --hints--

Unapaswa kufanya wito wa njia ya `clear` kwenye `plantsSet`.
