...
In the fourth `td` element, add an embedded expression that contains the `views` variable. これにより、投稿の閲覧数が表示されます。

# --hints--

You should add an embedded expression that contains the `views` variable.
