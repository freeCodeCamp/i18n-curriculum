...
The `Simple Past` structure for forming questions starts with `did` + subject + base form of the verb. You use `did` to show the action happened in the past, but keep the main verb (e.g., `find`) in its base form. Приклад:
