...
Il valore in dollari può avere più di una cifra. To match this, the `+` quantifier can be used - this matches one or more consecutive occurrences. Ad esempio, l'espressione regolare `/a+/` corrisponde a uno o più caratteri `a` consecutivi.
