...
أخيرًا، أرجع `secret_codes`، ثم أزل التعليق عن استدعاء الدالة وحدث المعلمة لتصبح `[poem, poem2, poem3]`. الآن تعمل دالتك مع عدة قصائد في آن واحد، ويمكنها استخراج عدة أرقام سرية!

تم إكمال دالة `pin_extractor`.

# --hints--

يجب أن تُرجع الدالة `secret_codes` في النهاية.
...
يجب أن يكون لديك استدعاء الدالة `print(pin_extractor([poem, poem2, poem3]))`.
...
يجب أن تُرجع `pin_extractor([poem, poem2, poem3])` القيمة `['5202', '3346', '50000']`.
...
يجب أن تعمل الدالة بشكل صحيح مع قوائم أخرى من القصائد.
