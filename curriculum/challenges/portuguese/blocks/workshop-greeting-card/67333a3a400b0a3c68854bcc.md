...
Adicione a propriedade `transition` ao seletor `.card-links a` e atribua a ela o valor `background-color 0.3s ease`.

# --hints--

O seletor `.card-links a` deve ter uma propriedade `transition` definida como `background-color 0.3s ease`.
