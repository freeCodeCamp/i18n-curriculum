...
Crea un selettore `hr` e dagli una proprietà `margin` impostata su `1.5rem 0`.

# --hints--

Dovresti avere un selettore `hr`.

```js
assert(new __helpers.CSSHelp(document).getStyle('hr'));
```

Il tuo selettore `hr` dovrebbe avere una proprietà `margin` impostata su `1.5rem 0`.
