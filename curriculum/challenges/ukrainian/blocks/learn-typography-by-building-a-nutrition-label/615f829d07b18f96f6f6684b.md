...
Перевага створення цих роздільників полягає в тому, що ви можете застосувати певні класи для індивідуальної стилізації. Додайте `double-indent` до `class` для останнього `.divider`.
