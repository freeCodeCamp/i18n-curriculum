...
Past tense verbs are used to talk about actions that happened in the past. Some verbs change their form in the past tense, like `say` to `said`. 例えば、次のように記述できます。
...
Another example of irregular verb is `tell`, which becomes `told` in the past tense. 例えば、次のようになります。
