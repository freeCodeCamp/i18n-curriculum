...
`Frustrated` means feeling annoyed, upset, or disappointed because of difficulties or obstacles. 例如：
...
`Access` means the ability to use or connect to something, especially technology or information. 例如：
