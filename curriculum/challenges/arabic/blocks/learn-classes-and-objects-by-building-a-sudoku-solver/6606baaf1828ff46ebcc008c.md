...
`find_empty_cell` تُعيد `(0, 0)`، وهو موقع أول خلية فارغة في لوحة السودوكو.

حوّل أول `0` داخل `puzzle` إلى `1`. سترى في الناتج أن الخلية الفارغة التالية ستُعثر عليها.

# --hints--

يجب تعديل العنصر الأول من القائمة الأولى في `puzzle` إلى `1`.
