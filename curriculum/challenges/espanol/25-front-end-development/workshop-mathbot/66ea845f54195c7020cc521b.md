...
Debe asignar el resultado de generar un valor entre los valores `min` y `max`. Asegúrate de no establecer un valor fijo. Debe utilizar las fórmulas proporcionadas anteriormente.
