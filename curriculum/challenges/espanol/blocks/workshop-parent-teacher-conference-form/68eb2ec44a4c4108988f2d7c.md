...
Debes darle a tus botones de radio personalizados un tamaño y una forma.

Todavía apuntando a `.contact-method-radio-btn`, establece `width` en `20px`, `height` en `20px`, `border-radius` en `50%` y `border` en `2px solid gray`.
...
Establece la propiedad `width` en `20px`.
...
Establece la propiedad `height` en `20px`.
...
Establece la propiedad `border` en `2px solid gray`.
