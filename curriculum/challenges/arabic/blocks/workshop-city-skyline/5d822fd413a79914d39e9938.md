...
أضف إلى الصنف `sky` تدرجًا لونيًا دائريًا `radial-gradient`. استخدم اللون `#ffcf33` من `0%` إلى `20%`، واللون `#ffff66` عند `21%`، واللون `#bbeeff` عند `100%`. سيضيف هذا تدرجًا دائريًا للخلفية ليكون شمسك.
