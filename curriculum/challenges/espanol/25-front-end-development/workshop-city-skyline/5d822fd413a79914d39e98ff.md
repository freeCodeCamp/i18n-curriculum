...
A continuación, elimine el `width` y el `height` de `.bb2a`, y cambie el `border-left` y el `border-right` para usar `5vw` en lugar de `1vw`. El elemento ahora tendrá tamaño cero y los bordes se unirán en el medio.
