...
У вашій функції `elemValue` оголосіть функцію з назвою `inner`, яка приймає параметр `character`.

Потім поверніть вашу функцію `inner`.

# --hints--

Ви повинні оголосити змінну `inner`.
...
Ви повинні використати `const` для оголошення змінної `inner`.
...
Ваша змінна `inner` має бути стрілковою функцією.
...
Ваша функція `inner` має мати `character` як єдиний параметр.
...
Ваша функція `inner` має бути порожньою.
...
Ви повинні явно повернути вашу функцію `inner`.
