...
Іншими словами, вам надано колекцію масивів об’єктів. Предикат `pre` буде властивістю об’єкта і вам потрібно повернути `true`, якщо його значення `truthy` (істинне). Otherwise, return `false`.
