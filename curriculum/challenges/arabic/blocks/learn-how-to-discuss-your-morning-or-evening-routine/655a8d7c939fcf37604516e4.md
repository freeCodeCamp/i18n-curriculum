...
تشير كلمة `Bedtime` إلى الوقت الذي يذهب فيه الشخص عادة إلى السرير. غالبًا ما ترتبط بروتينات تساعد الأشخاص، وخاصة الأطفال، على الاستعداد للنوم. على سبيل المثال:

`Their bedtime is at 8, and they always read for a few minutes before turning off the lights.` - هنا، تعني كلمة `bedtime` الوقت الثابت الذي يذهبون فيه عادة إلى السرير، وتوضح الجملة أيضًا جزءًا من روتينهم الليلي.
...
تشير هذه الكلمة إلى الأطفال ولكن كموضوع للفعل.
