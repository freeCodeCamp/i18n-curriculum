...
Об’єкт `topic_list` містить масив `topics`, який містить останні теми, опубліковані на форумі.

Деструктуруйте масив `topics` з об’єкта `topic_list`.

# --hints--

Ви повинні використати `const`, щоб деструктурувати змінну `topics` з об’єкта `topic_list`.
