...
داخل عنصر `card`، أضف عنصر `div` يحمل `className` بقيمة `card-header`. هذا القسم سيحتوي على تقييم اللاعب، المركز، شارة المستوى، واسم النادي.

# --hints--

يجب أن تضيف عنصر `div` مع `className` يساوي `card-header` داخل عنصر `div` الذي يحمل `className` يساوي `.card`.
