...
Fügen Sie dem `text-gray-300`-Element, das den einzeiligen Vorteil des Plans enthält, die Klasse `p` hinzu.

# --hints--

Ihr `p`-Element sollte die Klasse `text-gray-300` haben.
