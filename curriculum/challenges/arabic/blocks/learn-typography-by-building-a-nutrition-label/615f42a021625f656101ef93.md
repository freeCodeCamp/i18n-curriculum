...
يمكن للمسافة الأفقية بين العناصر ذات الأهمية المتساوية أن تزيد من وضوح نصك.

لفّ النص `2/3 cup (55g)` داخل عنصر `span`.

# --hints--

يجب أن تنشئ عنصر `span` جديدًا.
...
يجب أن يظل عنصر `p` يحتوي على النص `Serving size 2/3 cup (55g)`.
