...
Вам потрібно перевірити вашу нову карировану функцію. Оголосіть змінну `servingsResult` і призначте їй результат коригування від базової кількості 4 до порції 6.

Виведіть цю змінну в консоль.

# --hints--

Ви повинні оголосити змінну `servingsResult`.

```js
assert.isDefined(servingsResult);
```

Ваша змінна `servingsResult` має містити результат виклику `adjustQuantity(4)(6)`.

```js
assert.strictEqual(servingsResult, 24);
```

Ви повинні вивести значення `servingsResult`.
