...
Debes utilizar un selector de elementos separados por comas para seleccionar los elementos `input`, `textarea` y `select`.
...
Debes establecer la propiedad `width` a `100%`.
...
Debes establecer la propiedad `margin-top` a `10px`.
...
Debes establecer la propiedad `margin-bottom` a `0`.
...
Debes establecer la propiedad `margin-left` a `0`.
...
Debes establecer la propiedad `margin-right` a `0`.
