...
title: 'Aufgabe 63: Mächtige Ziffernanzahlen'
challengeType: 1
forumTopicId: 302175
...
Vervollständigen Sie die Funktion so, dass sie zurückgibt, wie viele positive ganze Zahlen die Länge `n` haben und eine `n`-te Potenz sind.
