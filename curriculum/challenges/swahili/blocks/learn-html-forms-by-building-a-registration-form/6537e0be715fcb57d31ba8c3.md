...
Mwishowe badilisha rangi ya maandishi ya kipengele cha kiungo cha `terms and conditions` kuwa `#dfdfe2` kwa kuongeza kichaguzi kipya katika CSS.

Hongera! Umehitimisha sehemu ya mwisho ya mradi wa mazoezi wa _Fomu ya Usajili_.

# --hints--


Unapaswa kumpa kipengele cha `a` `color` ya `#dfdfe2`.
