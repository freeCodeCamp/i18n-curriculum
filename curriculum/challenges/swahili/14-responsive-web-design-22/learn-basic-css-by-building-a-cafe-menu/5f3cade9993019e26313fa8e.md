...
Kwa kuwa sasa unajua inafanya kazi, unaweza kubadilisha vipengee vilivyosalia vya `article` na `p` ili kuendana na seti ya kwanza. Anza kwa kuongeza class `item` kwa vipengele vingine vya `article`.
...
Unapaswa kuwa na vipengele vitano pekee vya `.item`.
