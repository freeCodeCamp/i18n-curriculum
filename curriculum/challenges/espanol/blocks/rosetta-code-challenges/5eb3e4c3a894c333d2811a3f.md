...
`SHA256("Rosetta code")` debe devolver una cadena.

```js
assert(typeof SHA256('Rosetta code') === 'string');
```

`SHA256("Rosetta code")` debe devolver `"764faf5c61ac315f1497f9dfa542713965b785e5cc2f707d6468d7d1124cdfcf"`.
...
`SHA256("implementation")` debe devolver `"da31012c40330e7e21538e7dd57503b16e8a0839159e96137090cccc9910b171"`.
...
`SHA256("algorithm")` debe devolver `"b1eb2ec8ac9f31ff7918231e67f96e6deda83a9ff33ed2c67443f1df81e5ed14"`.
...
`SHA256("language")` debe devolver `"a4ef304ba42a200bafd78b046e0869af9183f6eee5524aead5dcb3a5ab5f8f3f"`.
