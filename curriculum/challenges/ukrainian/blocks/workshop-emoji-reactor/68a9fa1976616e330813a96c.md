...
Тепер зробіть трохи простору, видаліть усі змінні кнопок і `eventListener`, які ви створили для кожної.

# --hints--

Змінна `happyBtn` не повинна існувати.
...
Змінна `confusedBtn` не повинна існувати.
...
Змінна `sadBtn` не повинна існувати.
...
Змінна `lovingBtn` не повинна існувати.
