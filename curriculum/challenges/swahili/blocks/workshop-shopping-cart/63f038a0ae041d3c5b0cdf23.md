...
Kipengele chako cha mwisho ni kuruhusu watumizi kufuta gari lao la ununuzi. Ongeza njia ya `clearCart()` katika darasa la `ShoppingCart`.

# --hints--

Darasa lako la `ShoppingCart` linapaswa kuwa na njia ya `clearCart`.
