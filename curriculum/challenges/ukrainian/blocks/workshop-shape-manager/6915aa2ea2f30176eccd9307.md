...
Використайте подію `oninput` на `shapeTypeSelect` і встановіть її в `handleShapeSelect`. Це змусить функцію запускатися щоразу, коли змінюється вибір форми.

Після цього ви повинні побачити поля введення для кожної форми. Але обчислення ще не працюватимуть, і саме це ви будете налаштовувати далі.

# --hints--

Вам слід встановити `shapeTypeSelect.oninput` у `handleShapeSelect`.
