...
Цікавинка: більшість, якщо не всі, фліпери не є природними прямокутниками.

Задайте верхньо-лівому, верхньо-правому та нижньо-правому кутам елементів `.arm` радіус `30%`, а нижньо-лівому куту — радіус `120%`.

# --hints--

Ви повинні задати `.arm` `border-radius` зі значенням `30% 30% 30% 120%`.
