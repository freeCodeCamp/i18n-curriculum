...
Змініть `background-color` `.three` на `#b20403`.

# --hints--

Ви повинні встановити властивість `background-color` у значення `#b20403`.
...
Ваш елемент `.three` має мати значення `background-color` рівне `#b20403`.
