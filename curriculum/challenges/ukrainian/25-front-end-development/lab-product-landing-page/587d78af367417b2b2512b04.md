...
12. Якщо натиснути на елемент `#submit`, електронна пошта повинна бути надісланою на статистичну сторінку (використовуйте альтернативу URL: `https://www.freecodecamp.com/email-submit`).
...
`#form` повинен мати атрибут `action` зі значенням `https://www.freecodecamp.com/email-submit`.
