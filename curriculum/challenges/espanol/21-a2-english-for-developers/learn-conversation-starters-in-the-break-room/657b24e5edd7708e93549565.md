...
`I’ve played this game before.` - Esta oración también está en el tiempo pretérito perfecto simple, usando la contracción `I've` para `I have`. Al igual que el ejemplo anterior, afirma que la acción de jugar el juego ocurrió en un momento no especificado en el pasado.
