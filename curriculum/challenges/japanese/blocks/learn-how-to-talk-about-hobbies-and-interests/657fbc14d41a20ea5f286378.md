...
`Video games` は、コンピューター、ゲームコンソール、または携帯電話でプレイするゲームで、ボタンやコントローラーを使って画面上の動きを操作します。アドベンチャー、スポーツ、パズルなど、さまざまな種類があります。
...
この用語は、コンソールやコンピューター、その他のデバイスを使ってプレイするデジタルエンターテインメントの一形態を表す際によく使われます。
...
この単語の複数形は、遊び、ルール、そしてしばしば競争を含む活動を指すことが多いです。
