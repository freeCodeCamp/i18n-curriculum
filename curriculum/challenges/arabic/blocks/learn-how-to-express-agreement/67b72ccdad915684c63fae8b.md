...
`thoughts`، `appreciate`، `user-friendly`، `point`، `coming from`، و `prioritized`.
...
هذا يصف تصميم التطبيق، أي أنه سهل الاستخدام والتنقل للمستخدمين. هذه كلمة مركبة. تذكر أن تستخدم `-`.
...
هذا يشير إلى الملاحظة أو المعلمة التي ذكرها جيم حول التطبيق، والتي أقرت ماريا بأنها صحيحة.
...
هذه العبارة المكونة من كلمتين توضح أن ماريا تدرك مصدر ملاحظات جيم. الكلمة الأولى تنتهي بـ `-ing`.
...
هذه الكلمة بصيغة الجمع تشير إلى الأفكار أو الآراء حول عملية تسجيل الدخول.
...
هذه الكلمة تدل على أن ماريا ستتأكد من أن ميزة `Remember Me` ستُعتبر مهمة وسيتم العمل عليها أولًا.
...
هذه الكلمة تعبر عن الامتنان، أي أن ماريا تقدر ملاحظات جيم وتراها مفيدة للتحسين.
