...
أضف عنصرين `span` مع `className` بقيمتي `stat-value` و `stat-label` على التوالي لكل `stat-row`.

# --hints--

يجب أن يحتوي كل `.stat-row` في العمود الثاني `.stat-col` على `span` بفئة `stat-value` و `span` بفئة `stat-label`.
