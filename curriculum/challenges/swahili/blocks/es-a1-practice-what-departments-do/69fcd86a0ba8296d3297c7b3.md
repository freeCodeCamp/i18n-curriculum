...
Katika zoezi hili, utafanya mazoezi ya kutambua idara kutoka kwa vitendo wanavyofanya.

# --instructions--

Sikiliza na ukamilishe sentensi kwa idara sahihi.
...
Idara hii hufundisha timu.

# --explanation--

`El departamento de aprendizaje y desarrollo capacita al equipo` inamaanisha "idara ya Ukuzaji na Mafunzo hufundisha timu".

Zote `apoyar` ("kusaidia") na `capacitar` ("kufundisha") ni vitenzi vya mtu wa tatu wingi vinavyomalizika na `-ar`.

Vinafuata muundo uleule kama `desarrolla`, `verifica`, na `crea` kutoka kwa mazoezi ya awali.
