...
`To be scheduled` means to set a specific date and time for something to happen. In this case, the system update is planned for a specific day and hour. Zum Beispiel:
