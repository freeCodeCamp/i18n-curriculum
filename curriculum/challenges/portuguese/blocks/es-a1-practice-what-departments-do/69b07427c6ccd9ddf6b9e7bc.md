...
Esta tarefa ajuda você a praticar a escuta de informações específicas sobre departamentos de uma empresa e seus funcionários. Foque nos números e nomes dos departamentos mencionados no áudio para responder corretamente à pergunta.
...
Quantos funcionários o departamento de dados e análise tem?
...
Ouça com atenção o número na frase. É menor que vinte.
...
Esse número não é o mencionado no áudio.
...
A resposta correta é `Twelve employees`.

`El departamento de datos y Analítica tiene doce empleados.` - O departamento de dados e análise tem doze funcionários.

Note o padrão consistente ao longo do áudio:

`El departamento de` [nome do departamento] + `tiene` + [número] + `empleados`.
