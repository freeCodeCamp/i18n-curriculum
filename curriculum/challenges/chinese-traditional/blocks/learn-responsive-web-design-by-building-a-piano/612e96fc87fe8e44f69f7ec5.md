...
是時候給按鍵設計樣式了。 在 `#piano` 規則下方，使用 `class` 選擇器定位 `.keys` 元素。 爲新規則賦予 `background-color` 屬性 `#040404`、`width` 屬性 `949px`， 以及 `height` 屬性 `180px`。
