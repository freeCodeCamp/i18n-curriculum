...
يجب أن تعطي `repeating-linear-gradient` الثانية اللون الأول `--building-color3` من `0%` إلى `10%`.
...
يجب أن تعطي التدرج الثاني من نوع `repeating-linear-gradient` اللون الثاني `--window-color3` من `10%` إلى `30%`.
