...
Використайте цикл `for`, щоб вивести в консоль `name` кожного астронавта з масиву `sorted`.

# --hints--

Ви повинні використати цикл `for`, щоб ітерувати по масиву `sorted` і вивести в консоль `name` кожного астронавта.
