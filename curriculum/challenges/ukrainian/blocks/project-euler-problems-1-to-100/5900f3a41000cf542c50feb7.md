...
Гугол ($10^{100}$) — це гігантське число: сто нулів після одиниці; 100^{100}$ є неймовірно великим числом: двісті нулів після одиниці. Незважаючи на такий розмір, сума цифр у кожному числі дорівнює лише 1.
