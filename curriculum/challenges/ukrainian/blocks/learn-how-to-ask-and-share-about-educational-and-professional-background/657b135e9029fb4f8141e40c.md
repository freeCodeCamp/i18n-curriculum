...
Це `past simple` форма дієслова `to be`, яка використовується з `you`, `we` або `they`. Перша літера велика.
...
Це слово означає активну участь у чомусь. Закінчується на `-ed`.
...
Цей термін стосується процесу завершення покупки.
