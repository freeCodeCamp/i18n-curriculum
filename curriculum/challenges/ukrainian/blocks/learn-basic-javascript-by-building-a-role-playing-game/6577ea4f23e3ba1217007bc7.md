...
Нарешті, вам потрібно додати стилі для ваших кнопок. Почніть із встановлення властивості `cursor` у `pointer`. Потім встановіть текстовий `color` у `#0a0a23` та `background-color` у `#feac32`.

Потім встановіть властивість `background-image` у `linear-gradient(#fecc4c, #ffac33)`. Нарешті, встановіть `border` у `3px solid #feac32`.

# --hints--

У вас має бути селектор `button`.
...
Ваш селектор `button` має мати властивість `cursor`, встановлену в `pointer`.
...
Ваш селектор `button` має мати властивість `color`, встановлену в `#0a0a23`.
...
Ваш селектор `button` має мати властивість `background-color`, встановлену в `#feac32`.
...
Ваш селектор `button` має мати властивість `background-image`, встановлену в `linear-gradient(#fecc4c, #ffac33)`.
...
Ваш селектор `button` має мати властивість `border`, встановлену в `3px solid #feac32`.
