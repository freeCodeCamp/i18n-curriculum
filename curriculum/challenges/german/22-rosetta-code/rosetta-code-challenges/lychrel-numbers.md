...
<ol>
  <li>Nimm eine Ganzzahl <code>n₀</code>, größer als Null.</li>
...
Die obere Rekursionsrelation endet, wenn sie auf die meisten Ausgangszahlen `n` = 1, 2, ... angewendet wird, recht schnell in einem Palindrom.
