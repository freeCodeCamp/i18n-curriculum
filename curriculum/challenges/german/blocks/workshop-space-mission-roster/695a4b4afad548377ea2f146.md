...
Verwenden Sie eine `for`-Schleife, um den `name` jedes Astronauten im `sorted`-Array zu protokollieren.

# --hints--

Sie sollten eine `for`-Schleife verwenden, um das `sorted`-Array zu durchlaufen und den `name` jedes Astronauten zu protokollieren.
