...
You should destructure `author`, `image`, `url`, and `bio` as the first parameter of your callback function. Denke daran, sie in geschweifte Klammern zu setzen.
...
You should destructure `index` as the second parameter of your callback function. Er muss außerhalb der geschweiften Klammern stehen, in die du die anderen Parameter gesetzt hast.
