...
1. Ви повинні мати елемент `head`, що містить порожній елемент `meta` з атрибутом `charset`, встановленим у `utf-8`, та `title` з текстом `Travel Agency Page`.
1. Ви повинні мати тег `meta` у вашому елементі `head`, який містить короткий опис вашого вебсайту для SEO.
1. Ви повинні мати елемент `h1` для представлення ваших туристичних напрямків.
1. Під елементом `h1` повинен бути абзац, що знайомить із туристичними можливостями.
1. Ви повинні мати елемент `h2` з текстом `Packages`.
1. Ви повинні мати елемент `p`, який коротко представляє різні пакети.
...
1. Ви повинні мати щонайменше три елементи `figure`, кожен з яких містить елемент посилання та елемент `figcaption`.
1. Три елементи посилання повинні мати елемент `img` з відповідним атрибутом `alt` та атрибутом `src`, встановленим на дійсне зображення як їхній вміст. Ви можете використати `https://cdn.freecodecamp.org/curriculum/labs/colosseo.jpg`, `https://cdn.freecodecamp.org/curriculum/labs/alps.jpg` та `https://cdn.freecodecamp.org/curriculum/labs/sea.jpg`, якщо хочете.
1. Усі п’ять ваших елементів посилання повинні мати атрибут `href` зі значенням `https://www.freecodecamp.org/learn` та атрибут `target` зі значенням `_blank`.
