...
Em uma lição anterior, mencionamos brevemente o GitHub. Tanto o GitHub quanto o GitLab são provedores de controle de versão. Isso significa que são soluções baseadas na nuvem que oferecem armazenamento de projetos com controle de versão em algo chamado "repositórios" e habilitam recursos de colaboração para usar com esses projetos.

Antes de mergulharmos nos recursos que essas plataformas oferecem, precisamos discutir os diferentes tipos de projetos. Muitos projetos são considerados "open-source", o que significa que as pessoas podem ver o código que você publica, propor mudanças, reportar issues e até executar uma versão modificada.
...
Independentemente da abordagem que seu projeto adote, sites como GitHub e GitLab podem elevar muito a colaboração da sua equipe.
