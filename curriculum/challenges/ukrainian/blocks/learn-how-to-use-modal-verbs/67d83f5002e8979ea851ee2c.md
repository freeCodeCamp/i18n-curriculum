...
Цей модальний дієслово виражає сильну рекомендацію або найкращий варіант дії.
...
Цей дієслово означає повідомити або попередити когось про щось важливе.
...
Цей дієслово означає дотримуватися набору кроків або інструкцій.

# --explanation--  

Джейк пропонує дві важливі дії:  

- `Notify the security team.` - `Notify` означає повідомити або попередити когось про важливу подію.

- `Follow our incident response plan.` - `Follow` означає дотримуватися структурованого процесу.
