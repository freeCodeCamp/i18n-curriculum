...
Тепер ви можете видалити цикл, який виводить кожен рядок вихідних даних, і замінити його на `print(graph.create_trajectory())`.

# --hints--

У глобальній області видимості не повинно бути циклу.
...
У вас має бути `print(graph.create_trajectory())`.
