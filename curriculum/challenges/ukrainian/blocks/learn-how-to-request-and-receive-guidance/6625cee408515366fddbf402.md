...
Це слово означає докладати зусиль або намагатися щось зробити.
...
У програмуванні це слово означає колекцію заздалегідь написаного коду для загальних завдань.
...
Це слово використовується, щоб попросити дозволу або перевірити, чи хтось не проти чогось.
