...
Auf kleinen Bildschirmen läuft die ungeordnete Liste in der Navigationsleiste über die rechte Seite des Bildschirms hinaus.

Beheben Sie dies, indem Sie _Flexbox_ verwenden, um den `ul` Inhalt umzubrechen. Setzen Sie dann die folgenden CSS-Eigenschaften, um den Text korrekt auszurichten:
