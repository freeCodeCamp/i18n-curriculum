...
Kipengele chako cha tano cha `div` chenye `className` ya `form-group` kinapaswa kuwa na `input` yenye `className` ya `input`, `id` ya `def` na `type` ya `number`.
...
Kipengele chako cha sita cha `div` chenye `className` ya `form-group` kinapaswa kuwa na `input` yenye `className` ya `input`, `id` ya `phy` na `type` ya `number`.
