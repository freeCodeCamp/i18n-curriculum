...
Usa la proprietà `border-radius` con il valore `80% 80% 100% 100%` per dare al pinguino un corpo leggermente arrotondato.

# --hints--

Dovresti dare a `.penguin-body` una proprietà `border-radius` con il valore `80% 80% 100% 100%`.
