...
`It's hard to say` means that something is difficult to predict or uncertain. Zum Beispiel:

- **Jack:** `Do you think the project will be finished on time?`

- **Tom:** `It's hard to say. It depends on how fast we solve the issues.` - The completion time is uncertain because of possible delays.
