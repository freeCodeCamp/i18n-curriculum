...
Ndani ya mzunguko wa `while`, weka thamani ya `right_part[right_array_index]` kwa `array[sorted_index]`.

# --hints--

Unapaswa kuwa na `array[sorted_index] = right_part[right_array_index]` ndani ya mwili wa mzunguko. Usisahau kuondoa neno kuu la `pass` ndani ya mwili wa mzunguko.
...
Hakuna neno kuu la `pass` linapaswa kuwepo katika mzunguko wa `while`
