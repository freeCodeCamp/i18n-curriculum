...
今はテキストが読みにくくなっています。 `footer` とその中のアンカー要素を選択し、フォントの色を設定して適切なコントラスト比をもたせてください。

# --hints--

`footer, footer a` セレクターを使用する必要があります。
...
`color` の値を、少なくとも `7:1` のコントラスト比をもたせるように設定する必要があります。 _ヒント: `#dfdfe2` をお勧めします_
