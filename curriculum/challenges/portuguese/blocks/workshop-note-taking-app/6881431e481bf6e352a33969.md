...
Como mencionado anteriormente, quando o usuário edita a nota e depois clica fora da nota, deve haver uma mensagem para exibir que a nota foi salva. 

Para realizar isso, defina o `statusEl.textContent` para a string `"Note saved successfully!"`.

Agora, quando você testar, deverá ver essa mensagem exibida na tela.

# --hints--

Quando o usuário edita uma nota, a mensagem de status deve ser atualizada para indicar que a nota foi salva.
