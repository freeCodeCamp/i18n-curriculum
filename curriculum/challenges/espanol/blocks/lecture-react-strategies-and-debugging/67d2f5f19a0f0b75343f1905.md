...
Con los Componentes de Servidor de React, puedes mover todo el componente al servidor y obtener los datos allí sin tener que usar `useState` ni `useEffect`:
