...
2 つ目の `@media` ルールには `#piano` セレクターが必要です。
...
新しい `#piano` セレクターには値が `675px` に設定されている `width` が必要です。
...
2 つ目の `@media` ルールには `.keys` セレクターが必要です。
...
新しい `.keys` セレクターには値が `633px` に設定されている `width` が必要です。
