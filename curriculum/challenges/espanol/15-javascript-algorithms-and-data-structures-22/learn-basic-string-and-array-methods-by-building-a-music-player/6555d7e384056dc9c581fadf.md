...
Para garantizar que la pantalla del reproductor se actualice cada vez que una nueva canción comience a reproducirse, llama a la función `setPlayerDisplay()` dentro de la función `playSong()`.

Ahora deberías ver el título de la canción y el artista aparecer en la pantalla.

# --hints--

Debes llamar a la función `setPlayerDisplay` dentro de tu función `playSong`.
