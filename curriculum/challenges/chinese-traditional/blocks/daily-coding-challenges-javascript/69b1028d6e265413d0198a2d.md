...
給定一個數字陣列，其中只有一個數字不符合某個樣式，請傳回一個新的陣列，將那個不符合樣式的數字修正。
...
例如，給定 `[2, 4, 7, 8, 10]` 傳回 `[2, 4, 6, 8, 10]`。

# --hints--

`fixPrankNumber([2, 4, 7, 8, 10])` 應該傳回 `[2, 4, 6, 8, 10]`。

```js
assert.deepEqual(fixPrankNumber([2, 4, 7, 8, 10]), [2, 4, 6, 8, 10]);
```

`fixPrankNumber([10, 10, 8, 7, 6])` 應該傳回 `[10, 9, 8, 7, 6]`。

```js
assert.deepEqual(fixPrankNumber([10, 10, 8, 7, 6]), [10, 9, 8, 7, 6]);
```

`fixPrankNumber([12, 24, 36, 48, 61, 72, 84, 96])` 應該傳回 `[12, 24, 36, 48, 60, 72, 84, 96]`。

```js
assert.deepEqual(fixPrankNumber([12, 24, 36, 48, 61, 72, 84, 96]), [12, 24, 36, 48, 60, 72, 84, 96]);
```

`fixPrankNumber([4, 1, -2, -5, -8, -5])` 應該傳回 `[4, 1, -2, -5, -8, -11]`。

```js
assert.deepEqual(fixPrankNumber([4, 1, -2, -5, -8, -5]), [4, 1, -2, -5, -8, -11]);
```

`fixPrankNumber([0, 100, 200, 300, 150, 500])` 應該傳回 `[0, 100, 200, 300, 400, 500]`。

```js
assert.deepEqual(fixPrankNumber([0, 100, 200, 300, 150, 500]), [0, 100, 200, 300, 400, 500]);
```

`fixPrankNumber([400, 425, 400, 375, 350, 325, 300])` 應該傳回 `[450, 425, 400, 375, 350, 325, 300]`。

```js
assert.deepEqual(fixPrankNumber([400, 425, 400, 375, 350, 325, 300]), [450, 425, 400, 375, 350, 325, 300]);
```

`fixPrankNumber([-5, 5, 10, 15, 20])` 應該傳回 `[0, 5, 10, 15, 20]`。
