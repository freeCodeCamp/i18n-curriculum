...
Ora devi aggiungere un listener per l'evento sull'elemento `happyBtn`.

Scrivi il listener per l'evento e la sua callback in modo che, quando si clicca il pulsante, l'app registri nella console `Button clicked!`.

# --hints--

Quando si clicca `happyBtn`, `Button clicked!` dovrebbe essere registrato nella console.
