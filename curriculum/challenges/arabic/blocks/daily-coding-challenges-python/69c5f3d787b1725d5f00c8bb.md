...
معطاة سلسلة نصية، أرجع نسخة مضغوطة من السلسلة النصية باستخدام القواعد التالية:

- الظهور الأول للكلمة يبقى دون تغيير.
- الظهورات التالية تُستبدَل بموقع الظهور الأول، حيث تكون الكلمة الأولى في الموقع 1.
- الكلمات مفصولة بمسافة واحدة فقط.

على سبيل المثال، معطاة `"practice makes perfect and perfect practice makes perfect"`، أرجع `"practice makes perfect and 3 1 2 3"`.

# --hints--

`compress("practice makes perfect and perfect practice makes perfect")` يجب أن تُرجع `"practice makes perfect and 3 1 2 3"`.
...
`compress("hello hello hello")` يجب أن تُرجع `"hello 1 1"`.
...
`compress("the cat sat on the mat on which the cat sat")` يجب أن تُرجع `"the cat sat on 1 mat 4 which 1 2 3"`.
...
`compress("the more you know the more you realize you don't know")` يجب أن تُرجع `"the more you know 1 2 3 realize 3 don't 4"`.
