...
Selecione os botões `#scary-btn`, `#funny-btn` e `#adventure-btn` e armazene-os em variáveis chamadas `scaryStoryBtn`, `funnyStoryBtn` e `adventureStoryBtn`.

# --hints--

Você deve selecionar o botão `#scary-btn` usando o método `getElementById` e armazená-lo na variável `scaryStoryBtn`.
...
Você deve selecionar o botão `#funny-btn` usando o método `getElementById` e armazená-lo na variável `funnyStoryBtn`.
...
Você deve selecionar o botão `#adventure-btn` usando o método `getElementById` e armazená-lo na variável `adventureStoryBtn`.
