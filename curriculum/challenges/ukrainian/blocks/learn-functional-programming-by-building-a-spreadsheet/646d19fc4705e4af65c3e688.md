...
Ваша функція `addCharacters` в кінцевому результаті повертає діапазон символів. Ви хочете, щоб вона повертала масив ідентифікаторів клітинок. Приєднайте метод `.map()` до вашого виклику `charRange()`. Поки що не передавайте функцію зворотного виклику.

# --hints--

Ви повинні приєднати `.map()` до вашого виклику `charRange()`.
...
Ви не повинні передавати нічого до вашого виклику `.map()`.
