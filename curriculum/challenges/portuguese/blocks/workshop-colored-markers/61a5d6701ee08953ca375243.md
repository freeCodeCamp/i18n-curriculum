...
E como o segundo argumento de cor, estabeleça a função `hsl` com os valores `223` para matiz, `90%` para saturação e `60%` para luz.

# --hints--

A regra do CSS `.blue` deve ter uma propriedade `background` definida para `linear-gradient(hsl(186, 76%, 16%), hsl(223, 90%, 60%))`.
