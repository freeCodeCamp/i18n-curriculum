...
Далі скажіть формі, як відправляти дані. Додайте атрибут `method` зі значенням `post` та атрибут `action` зі значенням `https://superhero-application-form.freecodecamp.org` до елемента форми.

Тепер відправлення форми надішле її на цю URL-адресу. Ви зробите це на наступному кроці.

# --hints--

Ваш елемент `form` повинен мати атрибут `method`, встановлений у `post`.
...
Ваш елемент `form` повинен мати атрибут `action`, встановлений у `https://superhero-application-form.freecodecamp.org`.
