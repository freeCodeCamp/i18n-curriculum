...
Para testar o código enquanto o escreve, prepare um "ouvinte" de evento no elemento `sortButton`. Deve escutar o evento `"click"` e usar `sortInputArray` como callback.
...
Seu método `.addEventListener()` deve escutar o evento `"click"`.
