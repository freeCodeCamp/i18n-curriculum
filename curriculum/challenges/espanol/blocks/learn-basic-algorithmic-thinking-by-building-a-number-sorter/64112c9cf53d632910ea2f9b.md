...
Después de su bucle mientras, necesita insertar su valor actual. Recuerde que su bucle termina cuando `j` está fuera de los límites del array, o cuando el valor en `j` es menor que su valor actual.

Use el operador de asignación para insertar su valor actual en el índice correcto.

# --hints--

Debería asignar `currValue` al índice `j + 1`.
