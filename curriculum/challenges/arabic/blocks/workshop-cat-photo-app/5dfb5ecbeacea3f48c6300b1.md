...
يجب أن يكون لديك ثلاثة عناصر `li` تحتوي على النصوص `catnip` و`laser pointers` و`lasagna` بأي ترتيب. لقد حذفت بعض النصوص أو يوجد خطأ مطبعي.
...
يجب أن تكون العناصر الثلاثة `li` موجودة بين وسم الافتتاح ووسم الإغلاق للعنصر `ul`.
