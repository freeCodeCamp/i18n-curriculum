...
¡Finalmente! ¡Llegaste al último edificio! Agregue un degradado repetitivo con una dirección de `90deg`. Utilice el color del edificio del `0%` al `10%` y `transparent` del `10%` al `30%`.
