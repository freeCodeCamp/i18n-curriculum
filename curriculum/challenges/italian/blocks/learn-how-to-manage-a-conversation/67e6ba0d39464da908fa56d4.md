...
Questo introduce un argomento o problema per la discussione. Inizia con un verbo seguito da una preposizione.
...
Descrive una breve durata di tempo. Indica come dovrebbe essere la discussione.
...
Significa "in misura maggiore" o "di più" e indica la continuazione di un processo. Qui si usa per riferirsi a più azione o indagine.
...
Descrive qualcosa di serio o estremo. Modifica `bug` e si riferisce alla gravità del problema.
...
Significa affrontare o risolvere un problema. Si riferisce al prendere provvedimenti riguardo al problema menzionato.
...
Si usa per fare una richiesta o suggerimento cortese. Inizia con una frase condizionale che cerca consenso.
...
Si riferisce alla lista principale degli argomenti da discutere.
