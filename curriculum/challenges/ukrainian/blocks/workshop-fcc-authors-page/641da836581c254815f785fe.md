...
Наступне, що ви покажете, — це біографічні дані про автора. Ви можете зробити це, використовуючи властивість `bio`.

Додайте елемент абзацу з атрибутом `class`, значення якого `"bio"`, а потім вставте `bio` всередину елемента абзацу.
...
Ви повинні вставити `bio` у ваш елемент `p`.
