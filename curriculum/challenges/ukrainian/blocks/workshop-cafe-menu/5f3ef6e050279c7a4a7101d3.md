...
Має кращий вигляд. Тепер спробуйте додати такий самий відступ зі значенням `20px` зверху та знизу меню.
...
Встановіть властивість `padding-top` на `20px`.
...
Встановіть властивість `padding-bottom` на `20px`.
