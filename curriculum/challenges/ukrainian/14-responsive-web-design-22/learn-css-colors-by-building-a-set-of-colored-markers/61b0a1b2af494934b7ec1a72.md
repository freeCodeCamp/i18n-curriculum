...
Додайте ковпачок та насадку до зеленого і синього маркерів. You can just copy the `div` elements from the red marker and paste them into the other two markers.
