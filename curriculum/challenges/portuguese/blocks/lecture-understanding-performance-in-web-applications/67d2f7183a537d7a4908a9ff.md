...
Next, we have to minimize HTTP requests. Cada arquivo que seu site solicita aumenta o tempo de carregamento. Reduzir o número de requisições HTTP pode levar a carregamentos de página mais rápidos. Você pode:
