...
Por fim, altere a cor do texto do elemento de link `terms and conditions` para `#dfdfe2` adicionando um novo seletor no CSS.

Bom trabalho! Você completou a parte final do workshop *Registration Form*.
