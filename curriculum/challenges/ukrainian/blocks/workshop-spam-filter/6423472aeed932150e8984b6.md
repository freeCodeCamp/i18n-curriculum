...
Використовуючи той самий синтаксис, оновіть `c`, щоб він відповідав `c`, `{`, `[` і `(`.

# --hints--

Ваш `stockRegex` має використовувати клас символів, щоб відповідати `c`, `{`, `[` і `(`.
...
Ваш `stockRegex` має відповідати `570(k 4l3r7`.

```js
assert.match('570(k 4l3r7', stockRegex);
```

Ваш `stockRegex` має відповідати `sto{k alert`.
