...
Para cualquier entero positivo $N$, sea $T(N)$ el número de conjuntos titánicos $S$ cuyos puntos ($x$, $y$) satisfacen $0 ≤ x$, $y ≤ N$. Se puede verificar que $T(1) = 11$, $T(2) = 494$, $T(4) = 33\,554\,178$, $T(111)\bmod {10}^8 = 13\,500\,401$ y $T({10}^5)\bmod {10}^8 = 63\,259\,062$.
