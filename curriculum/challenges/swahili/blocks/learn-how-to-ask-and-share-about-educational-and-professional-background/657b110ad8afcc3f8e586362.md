...
Wakati wa `Past Simple` hutumika kwa matendo au hali ambazo zimekamilika zamani. Inahusisha kubadilisha vitenzi kuonyesha kuwa kitendo kilitokea kabla ya sasa.

Katika zoezi hili, utafundishwa kutumia fomu ya `Past Simple` ya kitenzi `to be`.
...
Hii ni fomu ya `past simple` ya kitenzi `to be`, inayotumika pamoja na `I`, `he`, `she`, au `it`.
