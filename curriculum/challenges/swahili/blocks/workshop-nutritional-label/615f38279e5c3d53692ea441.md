...
Wazungushe vipengele vyako vya `h1` na `p` ndani ya kipengele cha `div`. Mpe `div` hiyo sifa ya kipengele ya `class` iliyowekwa kuwa `label`.
...
Kipengele chako kipya cha `div` kinapaswa kuwa na sifa ya kipengele ya `class` iliyowekwa kuwa `label`.
