...
Tengeneza kichaguzi cha `.lists` na weka sifa ya `list-style-type` kuwa `none`. Hii itafuta alama za risasi kwenye vitu vya orodha.
...
Kichaguzi chako cha `.lists` kinapaswa kuwa na sifa ya `list-style-type` iliyowekwa kuwa `none`.
