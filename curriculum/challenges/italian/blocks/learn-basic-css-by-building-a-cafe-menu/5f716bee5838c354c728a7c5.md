...
Sotto il dessert che hai appena aggiunto, aggiungi il resto dei dessert e dei prezzi usando altri tre elementi `article`, ciascuno con due elementi `p` annidati. Ogni elemento dovrebbe contenere il testo corretto del dessert e del prezzo, e tutti dovrebbero avere le classi corrette.
...
Dovresti avere quattro elementi `article` nel tuo secondo `section`.
...
Il tuo elemento `section` dovrebbe avere otto elementi `p`.
...
I tuoi elementi `.dessert` dovrebbero contenere il testo `Donut`, `Cherry Pie`, `Cheesecake` e `Cinnamon Roll`.
...
I tuoi nuovi elementi `.price` dovrebbero contenere il testo `1.50`, `2.75`, `3.00` e `2.50`.
