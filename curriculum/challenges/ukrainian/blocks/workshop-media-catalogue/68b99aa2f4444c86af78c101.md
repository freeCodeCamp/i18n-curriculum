...
Відступіть ваш існуючий цикл `for` на один рівень, щоб він запускався, коли в каталозі є фільми. Потім замініть `self.items` на `movies`, щоб ітерувати лише над фільмами.

# --hints--

Вам слід відступити існуючий цикл `for` на один рівень і замінити `self.items` на `movies`, щоб ітерувати лише над фільмами.
