...
Para entender o propósito do pop-up, leia o item `3. Real-Time Alerts for Suspicious Activity`. Alertas em Tempo Real para Atividades Suspeitas` na lista de Linda após a primeira frase.
