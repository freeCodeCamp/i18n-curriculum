...
title: 'Zoezi la 87: Matatu ya namba msingi zenye nguvu'
challengeType: 1
forumTopicId: 302201
...
Nambari ndogo kabisa inayoweza dhihirishwa kama jumla ya mraba wa namba msingi, kibao cha namba msingi, na nguvu ya nne ya namba msingi ni `28`. Kwa kweli, kuna nambari nne tu chini ya hamsini zinazoweza dhihirishwa kwa njia hiyo:
...
Ni nambari ngapi chini ya `n` zinazoweza dhihirishwa kama jumla ya mraba wa namba msingi, kibao cha namba msingi, na nguvu ya nne ya namba msingi?

# --hints--

`primePowerTriples(50)` inapaswa kurudisha nambari.

```js
assert(typeof primePowerTriples(50) === 'number');
```

`primePowerTriples(50)` inapaswa kurudisha `4`.

```js
assert.strictEqual(primePowerTriples(50), 4);
```

`primePowerTriples(10035)` inapaswa kurudisha `684`.

```js
assert.strictEqual(primePowerTriples(10035), 684);
```

`primePowerTriples(500000)` inapaswa kurudisha `18899`.

```js
assert.strictEqual(primePowerTriples(500000), 18899);
```

`primePowerTriples(5000000)` inapaswa kurudisha `138932`.

```js
assert.strictEqual(primePowerTriples(5000000), 138932);
```

`primePowerTriples(50000000)` inapaswa kurudisha `1097343`.
