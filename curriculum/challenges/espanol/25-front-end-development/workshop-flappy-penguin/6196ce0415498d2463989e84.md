...
Para dar el efecto de una cadena montañosa, agrega otra montaña creando un nuevo `div` inmediatamente después de `.left-mountain`, y asigna al nuevo `div` la `class` de `back-mountain`.
