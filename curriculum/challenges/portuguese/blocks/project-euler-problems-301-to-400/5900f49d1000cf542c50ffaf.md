...
Para qualquer inteiro positivo $n$ a função $\text{next_prime}(n)$ retorna o menor primo $p$ tal que $p > n$.
...
Encontre $\sum b(n)$ para $1≤n≤100\,000$.Dê sua resposta $\bmod 1\,234\,567\,891\,011$.
