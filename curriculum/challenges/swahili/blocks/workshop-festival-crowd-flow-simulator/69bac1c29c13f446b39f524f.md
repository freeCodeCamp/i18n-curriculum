...
Sasa unapaswa kutekeleza mzunguko mkuu wa kuiga hali halisi. Mzunguko huu utaweka uhakika kwamba kila lango linashughulikiwa kwa kila alama za kupigia katika kuiga hali halisi hadi alama zote za kupigia zitakapokamilika.

Tengeneza mzunguko tupu wa `while` unaoendelea mradi `tickIndex` ni chini ya `maxTicks`.

# --hints--

Unapaswa kutengeneza mzunguko tupu wa `while` unaoendeshwa na sharti la `(tickIndex < maxTicks)`.
