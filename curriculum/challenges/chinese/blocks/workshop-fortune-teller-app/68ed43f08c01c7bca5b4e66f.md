...
现在，对其余的属性也做同样的操作。使用 `getElement` 函数选择每一个：
...
你应该使用 `multipleCardsBtn` 方法并传入 `getElement` 来访问 `#btn-multiple-cards`。
...
你应该使用 `multipleCard` 方法并传入 `getElement` 来访问 `.multiple_card`。
...
你应该使用 `title` 方法并传入 `getElement` 来访问 `.title`。
...
你应该使用 `newReadingBtn` 方法并传入 `getElement` 来访问 `.btn_reveal`。
...
你应该使用 `fortuneContainer` 方法并传入 `getElement` 来访问 `.fortune_container`。
...
你应该使用 `fortuneDescription` 方法并传入 `getElement` 来访问 `.fortune_description`。
...
你应该使用 `headerTitle` 方法并传入 `getElement` 来访问 `.header_title`。
...
你应该使用 `subTitle` 方法并传入 `getElement` 来访问 `.sub_title`。
...
你应该使用 `cardTitle` 方法并传入 `getElement` 来访问 `.desc_title`。
...
你应该使用 `description` 方法并传入 `getElement` 来访问 `.description`。
...
你应该使用 `text` 方法并传入 `getElement` 来访问 `.text`。
