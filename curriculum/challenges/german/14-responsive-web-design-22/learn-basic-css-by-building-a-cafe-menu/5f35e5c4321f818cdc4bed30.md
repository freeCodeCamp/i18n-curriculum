...
Nun, da es schon gut aussieht, ist es an der Zeit, einige Menüpunkte hinzuzufügen.

Füge ein leeres `article`-Element unter der `Coffee`-Überschrift hinzu. Es wird ein Aroma und Preis für jeden Kaffee, den du derzeit anbietest, enthalten.
