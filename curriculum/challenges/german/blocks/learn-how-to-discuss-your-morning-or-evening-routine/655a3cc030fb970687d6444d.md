...
`Later` is the comparative form of `late`, used to indicate a time or event that is after the expected, usual, or planned time. Komparative werden verwendet, um zwei Dinge zu vergleichen. Hier ein Beispiel:
