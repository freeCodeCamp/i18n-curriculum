...
Termina el bucle `while` eliminando el nodo actual de la lista `unvisited`. Presta atención a la identación.

# --hints--

Debes usar el método `.remove()` para eliminar el nodo actual de `unvisited` después de tu ciclo `for`. 
