...
Fügen Sie zwei weitere `div`-Elemente hinzu, jeweils mit dem `className` von `form-group` innerhalb von `stats-grid`, eines für PAS und das andere für DRI.

Für das von PAS fügen Sie ein `label` mit einem `htmlFor` von `pas` und dem Text `PAS` hinzu, dann eine Eingabe mit einem `id` von `pas` und einem `type` von `number`.

Und für das von DRI fügen Sie ein `label` mit einem `htmlFor` von `dri` und dem Text `DRI` hinzu, dann eine Eingabe mit einem `id` von `dri` und einem `type` von `number`.

# --hints--

Sie sollten zwei weitere `div`-Elemente hinzufügen, jeweils mit dem `className` von `form-group` innerhalb des `div` von `className` von `stats-grid`.
...
Ihr drittes `div`-Element mit dem `className` von `form-group` sollte ein `label` mit einem `htmlFor`-Attribut von `pas`, einem `className` von `label` und einem Text `PAS` haben.
...
Ihr drittes `div`-Element mit dem `className` von `form-group` sollte ein `input` mit einem `className` von `input`, einem `id` von `pas` und einem `type` von `number` haben.
...
Ihr viertes `div`-Element mit dem `className` von `form-group` sollte ein `label` mit einem `htmlFor`-Attribut von `dri`, einem `className` von `label` und einem Text `DRI` haben.
...
Ihr viertes `div`-Element mit dem `className` von `form-group` sollte ein `input` mit einem `className` von `input`, einem `id` von `dri` und einem `type` von `number` haben.
