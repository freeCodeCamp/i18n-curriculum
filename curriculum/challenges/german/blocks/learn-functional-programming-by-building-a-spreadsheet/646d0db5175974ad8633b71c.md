...
Ihre inneren Funktionen können ebenfalls eine Funktion zurückgeben. Verwenden Sie dieselbe Pfeilfunktions-Syntax und aktualisieren Sie Ihre `addCharacters`-Funktion so, dass sie eine dritte Funktion zurückgibt, die einen `num`-Parameter annimmt.

# --hints--

Ihre innere Pfeilfunktion sollte eine weitere Pfeilfunktion mit einem `num`-Parameter zurückgeben.
...
Ihre innerste Pfeilfunktion sollte leer sein.
