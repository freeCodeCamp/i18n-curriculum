...
Трохи нудно, коли весь текст має однаковий `font-family`. Ви все ще можете зробити більшість тексту `sans-serif` і змінити лише елементи `h1` та `h2`, використовуючи інший селектор.

Застосуйте стиль до обох елементів `h1` і `h2` за допомогою одного селектора, щоб текст цих елементів використовував шрифт `Impact`.
...
Ви повинні встановити `font-family` у `Impact`.
