...
Por ejemplo, el elemento `h3` en tu `jQuery Playground` tiene como elemento padre a `<div class="container-fluid">`, que a su vez tiene como elemento padre a `body`.
