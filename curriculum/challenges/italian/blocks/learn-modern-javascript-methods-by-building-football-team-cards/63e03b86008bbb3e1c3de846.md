...
Successivamente, aggiungi `year` e `players` alla tua assegnazione destrutturante.

# --hints--

Dovresti aggiungere i valori `year` e `players` alla tua assegnazione destrutturante.
