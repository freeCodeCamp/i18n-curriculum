...
Wir können nachweisen, dass $E(4) = \frac{1}{2}$ und $E(6) = \frac{5}{9}$.

Finde $E({10}^{18})$. Gib deine Antwort auf vierzehn Dezimalstellen gerundet in der Form 0.abcdefghijklmn an.
