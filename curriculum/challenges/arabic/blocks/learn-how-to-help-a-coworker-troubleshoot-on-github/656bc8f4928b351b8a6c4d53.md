...
`Attach` تعني إضافة شيء إضافي إلى شيء آخر.

`Error messages` هي ملاحظات تخبرك بما حدث بشكل خاطئ في الشفرة. إرفاقها بمشكلة يساعد الآخرين على فهم المشكلة بشكل أفضل.
...
### --feedback--
تعني إضافة شيء إضافي إلى شيء آخر.
...
إضافة رسائل `error` إلى المشكلة يعطي مزيدًا من المعلومات حول ما لا يعمل بشكل صحيح.
