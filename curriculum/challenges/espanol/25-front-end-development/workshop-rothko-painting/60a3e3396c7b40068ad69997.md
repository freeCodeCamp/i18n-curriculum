...
Rotar `.three` en sentido contrario a las manecillas del reloj en 0.2 grados.

Con este último paso, su pintura de Rothko está ahora completa.

# --hints--

Debe establecer la propiedad `transform` a `rotate(-0.2deg)`.
...
El elemento `.three` debe tener un valor de `transform` de `rotate(-0.2deg)`.
