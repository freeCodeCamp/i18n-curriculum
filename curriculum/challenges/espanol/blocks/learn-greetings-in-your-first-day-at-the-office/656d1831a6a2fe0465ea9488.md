...
Para mostrar posesión, normalmente agregas `'s` a un nombre, como en `Sophie's desk`.

Sin embargo, para nombres que terminan en `s`, a menudo solo agregas un apóstrofe `'`.  For example, `James' book`. Significa que el libro pertenece a James.
