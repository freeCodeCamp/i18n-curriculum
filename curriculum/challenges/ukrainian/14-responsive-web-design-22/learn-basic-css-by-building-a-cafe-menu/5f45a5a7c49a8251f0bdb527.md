...
Використовуючи той самий селектор стилю, що і в попередньому кроці, зробіть розмір шрифту товарів та цін більшим, використовуючи значення `18px`.

# --hints--

Ви повинні встановити властивість `font-size` на `18px`.
...
Ваші елементи `p`, вкладені в елементах `.item`, повинні мати `font-size` зі значенням `18px`.
