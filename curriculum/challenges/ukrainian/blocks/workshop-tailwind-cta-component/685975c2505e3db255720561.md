...
Нарешті, кнопки можна краще розташувати з відступами між ними та зверху. Для цього потрібно націлитися на `div` елемент, який обгортає обидва. Тож додайте класи `flex`, `gap-2` і `mt-6` до цього `div`.

З цим ваше практичне заняття з компонентом CTA завершене!

# --hints--

`div` елемент, який обгортає елементи посилання, має мати утилітний клас `flex`.
...
`div` елемент, який обгортає елементи посилання, має мати утилітний клас `gap-2`.
...
`div` елемент, який обгортає елементи посилання, має мати утилітний клас `mt-6`.
