...
Потім, немає великого розділення між іменем та зображенням кожного автора та іншими деталями на картці. Роздільник надасть авторським карткам чітку візуальну ієрархію.

Додайте елемент `div` над біографією автора та дайте йому `class` `"purple-divider"`.
...
Створіть елемент `div` перед елементом `p`.
...
Елемент `div` повинен мати значення `class` зі значенням `"purple-divider"`.
