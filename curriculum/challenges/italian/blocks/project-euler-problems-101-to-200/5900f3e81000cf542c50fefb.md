...
Se calcoliamo $rad(n)$ per $1 ≤ n ≤ 10$, poi li ordiniamo in base a $rad(n)$, e in caso di valori uguali ordiniamo in base a $n$, otteniamo:
...
Sia $E(k)$ il $k$-esimo elemento nella colonna $n$ ordinata; per esempio, $E(4) = 8$ e $E(6) = 9$. Se $rad(n)$ è ordinato per $1 ≤ n ≤ 100000$, trova $E(10000)$.
