...
`addCharacters` restituisce una funzione, quindi dovrai chiamarla. Passa `char1` come argomento.

# --hints--

Dovresti chiamare la tua funzione `addCharacters()` nel metodo `.map()`.
