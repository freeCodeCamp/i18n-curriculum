...
У попередньому проєкті ви навчилися працювати з оператором конкатенації, щоб вставити змінні в рядок, як це:
...
Оновіть рядок `"You now have a new weapon."` на `"You now have a "` після назви нової зброї та не забудьте завершити речення крапкою.


# --hints--

Оновіть присвоєння `text.innerText`, щоб воно починалося з рядка `"You now have a "`.
