...
今は、`#monsterStats` 要素を `display` プロパティで非表示にしてください。他のスタイルは変更しないでください。

# --hints--

`#monsterStats` セレクターがあるはずです。
...
`#monsterStats` セレクターには `display` プロパティで `none` を指定してください。
...
`#monsterStats` セレクターには `border` で `1px solid #0a0a23` を指定してください。
...
`#monsterStats` セレクターにはパディングの `5px` を指定してください。
...
`#monsterStats` セレクターには `color` プロパティで `#ffffff` を指定してください。
...
`#monsterStats` セレクターには `background-color` プロパティで `#c70d0d` を指定してください。
