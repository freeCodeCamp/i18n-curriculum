...
Baada ya tamko lako la `if` lililopo, tengeneza lingine kwa wakati mshahara mpya ni chini ya mshahara wa msingi kwa kiwango cha sasa. Tumia `hasattr(self, '_level')` kuepuka `AttributeError` wakati wa uanzishaji.

Ndani ya tamko la `if`, onyesha `ValueError` yenye ujumbe wa `Salary must be higher than minimum salary $` ikifuatiwa na mshahara wa msingi kwa kiwango cha sasa na nukta.

# --hints--

Unapaswa kuwa na tamko la pili la `if` katika setter yako ya `salary`.
...
Wakati mshahara mpya ni chini ya mshahara wa msingi kwa kiwango cha sasa, unapaswa kuonyesha `ValueError` yenye ujumbe wa `Salary must be higher than minimum salary $` ikifuatiwa na mshahara wa msingi kwa kiwango cha sasa na nukta.
...
Hupaswi kuonyesha kosa lolote wakati `new_salary` ni kubwa kuliko mshahara wa sasa.
