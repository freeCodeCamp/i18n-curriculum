...
استخدم خاصية `border-radius` على المحدِّد `.two` لتعيين انحناء الزوايا العلوية اليسرى والسفلية اليمنى إلى `8px`، وانحناء الزوايا العلوية اليمنى والسفلية اليسرى إلى `10px`.

# --hints--

يجب تعيين خاصية `border-radius` إلى `8px 10px`.
...
يجب أن يحتوي العنصر `.two` على قيمة `border-radius` تساوي `8px 10px`.
