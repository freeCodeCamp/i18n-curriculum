...
Hiyo inaonekana bora zaidi. Sasa jaribu kuongeza padding sawa ya `20px` juu na chini ya menyu.

# --hints--

Hupaswi kuondoa sifa za `padding-left` au `padding-right`.
...
Unapaswa kuweka kipengele cha `padding-top` kuwa `20px`.
...
Unapaswa kuweka kipengele cha `padding-bottom` kuwa `20px`.
...
Kipengele chako cha `.menu` kinapaswa kuwa na `padding-top` ya `20px`.
...
Kipengele chako cha `.menu` kinapaswa kuwa na `padding-bottom` ya `20px`.
