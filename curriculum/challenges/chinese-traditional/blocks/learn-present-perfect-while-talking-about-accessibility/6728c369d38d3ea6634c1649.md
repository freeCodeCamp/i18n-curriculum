...
`Scenarios` refers to different situations or possible events that could occur. 例如：
...
`Consistently` indicates an action or performance remains stable and does not vary, ensuring predictable results. 例如：
