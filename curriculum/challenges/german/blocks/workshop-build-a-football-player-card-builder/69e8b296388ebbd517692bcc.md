...
Wickeln Sie jetzt die `PlayerCard`-Komponente in ein `main`-Element von `className` von `main` ein.

Fügen Sie innerhalb des `main`-Elements `div` von `className` von `layout` hinzu. Innerhalb von `layout` fügen Sie zwei separate `div`-Elemente von `className` von `form-panel` und `preview-panel` hinzu.

# --hints--

Ihre `FootballPlayerCard` sollte ein `main`-Element mit dem `className` von `main` innerhalb von `div.page` rendern.
...
Ihre `main.main` sollte ein `div` mit dem `className` von `layout` enthalten.
...
Ihre `layout` sollte ein `div` mit dem `className` von `form-panel` enthalten.
...
Ihre `layout` sollte ein `div` mit dem `className` von `preview-panel` enthalten.
