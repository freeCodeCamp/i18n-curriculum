...
Ще в межах блоку `else` збільшіть `right_array_index` на `1`.

# --hints--

Ви повинні додати `1` до поточного значення `right_array_index` після вставлення елемента у відсортований масив.
