...
Fügen Sie innerhalb der Klasse eine private `elements`-Eigenschaft als Objekt hinzu. Fügen Sie darin die Eigenschaften `singleCardBtn`, `singleCard` und `multipleCardsBtn` hinzu, die jeweils als `HTMLElement` typisiert sind.

# --hints--

Sie sollten eine `private`-Eigenschaft namens `elements` innerhalb der `Game`-Klasse deklarieren.
...
Ihre private `elements`-Eigenschaft sollte eine `singleCardBtn`-Eigenschaft haben, die als `HTMLElement` typisiert ist.
...
Ihre private `elements`-Eigenschaft sollte eine `multipleCardsBtn`-Eigenschaft haben, die als `HTMLElement` typisiert ist.
...
Ihre private `elements`-Eigenschaft sollte eine `singleCard`-Eigenschaft haben, die als `HTMLElement` typisiert ist.
