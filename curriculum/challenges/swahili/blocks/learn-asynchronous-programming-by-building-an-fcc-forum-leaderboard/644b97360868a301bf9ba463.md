...
Ndani ya usemi wa `if`, vunja `className` na `category` kutoka kwenye kitu cha `allCategories[id]`.

# --hints--

Unapaswa kuvunja `className` na `category` kutoka kwenye kitu cha `allCategories[id]`. Mali hizo zinaweza kuwa katika mpangilio wowote.
