...
对于以下挑战，你将使用一个与之前不同的新建入门项目。你可以在 <a href="https://github.com/freeCodeCamp/boilerplate-bcrypt/" target="_blank" rel="noopener noreferrer nofollow">GitHub</a> 上查找要克隆的新建入门项目。
