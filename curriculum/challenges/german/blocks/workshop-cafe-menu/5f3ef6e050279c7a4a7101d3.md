...
Das sieht besser aus. Versuchen Sie nun, denselben `20px` Innenabstand oben und unten im Menü hinzuzufügen.

# --hints--

Sie sollten die `padding-left` oder `padding-right` Eigenschaften nicht entfernen.
...
Sie sollten die `padding-top` Eigenschaft auf `20px` setzen.
...
Sie sollten die `padding-bottom` Eigenschaft auf `20px` setzen.
...
Ihr `.menu` Element sollte einen `padding-top` von `20px` haben.
...
Ihr `.menu` Element sollte einen `padding-bottom` von `20px` haben.
