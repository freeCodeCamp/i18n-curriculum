...
Fanya `Est. 2020` iwe ya herufi za mviringo kwa kuunda kichaguzi cha darasa la vitu `established` na kumpa sifa ya `font-style` yenye thamani ya `italic`.

# --hints--

Unapaswa kuwa na kichaguzi cha `.established`.
...
Unapaswa kuweka sifa ya `font-style` kuwa `italic`.
...
Kichaguzi chako cha `.established` kinapaswa kuweka sifa ya `font-style` kuwa `italic`.
