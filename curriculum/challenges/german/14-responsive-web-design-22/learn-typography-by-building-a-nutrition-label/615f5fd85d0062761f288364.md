...
Gib deinem `.calories-info span`-Selektor eine `margin` von `-7px -2px`. Dadurch wird dein `230`-Text an die richtige Stelle verschoben.

# --hints--

Dein `.calories-info span`-Selektor sollte eine `margin` auf `-7px -2px` gesetzt haben.
