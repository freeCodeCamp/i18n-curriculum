...
Para garantir que o texto inserido em inputs e textareas, assim como seus placeholders, esteja visível, defina a cor deles.

Selecione `input, input::placeholder, textarea` e defina `color` como `whitesmoke`.

# --hints--

Você deve direcionar `input`, `input::placeholder` e `textarea`.
