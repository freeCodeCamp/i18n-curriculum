...
Поверніться до своєї функції `showLatestPosts()` і використайте деструктуризацію, щоб отримати проп `topic_list` та `users` з об’єкта `data`.

# --hints--

Ви повинні використати `const`, щоб деструктуризувати `topic_list` та `users` з об’єкта `data`.
