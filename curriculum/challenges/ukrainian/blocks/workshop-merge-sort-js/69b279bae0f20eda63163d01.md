...
Після виведення рядка, залогуй сам масив `numbers`, щоб наступним з’явився несортований список.

# --hints--

Ви повинні зробити виклик `console.log(numbers);` після повідомлення `'Unsorted array: '`.
