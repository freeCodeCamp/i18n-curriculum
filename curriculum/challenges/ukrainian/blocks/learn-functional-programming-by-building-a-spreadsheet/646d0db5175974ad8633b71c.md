...
Ваші внутрішні функції також можуть повертати функцію. Використовуючи той самий стрілковий синтаксис, оновіть вашу функцію `addCharacters`, щоб вона повертала третю функцію, яка приймає параметр `num`.

# --hints--

Ваша внутрішня стрілкова функція має повертати іншу стрілкову функцію з параметром `num`.
...
Ваша найвнутрішніша стрілкова функція має бути порожньою.
