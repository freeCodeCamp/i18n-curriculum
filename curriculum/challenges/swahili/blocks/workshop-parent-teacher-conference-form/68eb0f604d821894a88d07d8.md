...
Ili kufanya kontena ionekane zaidi, unapaswa kuongeza `box-shadow` iliyowekwa kuwa `0 5px 15px black`.

Hii inaongeza athari ya kivuli kuzunguka kontena. Thamani hizi zinaelekeza mbali ya usawa, mbali ya wima, mduara wa kuchafua, na rangi kwa mtiririko huo.
...
Unapaswa kuweka sifa ya `box-shadow` kuwa `0 5px 15px black`.
