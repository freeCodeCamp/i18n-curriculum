...
Finalmente, llama a `gen_parentheses` con `3` como argumento para generar las cinco combinaciones válidas de tres pares de paréntesis y muestra el resultado en la consola. Con eso, el taller está completo.

# --hints--

Debes imprimir `gen_parentheses(3)`.
