...
Cuando quieres confirmar información (para decir que algo es cierto), puedes usar el verbo `do`. Hace que tu respuesta sea más contundente. Por ejemplo:

- Pregunta: `Do you like pizza?`

- Respuesta: `Yes, I do.` - Esta respuesta es más contundente que solo `Yes.`

Usas `do` para mostrar que estás seguro.
...
Sophie está confirmando positivamente la pregunta de Tom, por lo que repite el verbo auxiliar usado en la pregunta de Tom.
