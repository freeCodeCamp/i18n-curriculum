...
Всі квадратні корені є періодичними, коли їх записують у вигляді неперервних дробів, і можуть бути записані у формі:

$\\displaystyle \\quad \\quad \\sqrt{N}=a_0+\\frac 1 {a_1+\\frac 1 {a_2+ \\frac 1 {a3+ \\dots}}}$

Наприклад, розглянемо $\\sqrt{23}$:

$\\quad \\quad \\sqrt{23}=4+\\sqrt{23}-4=4+\\frac 1 {\\frac 1 {\\sqrt{23}-4}}=4+\\frac 1 {1+\\frac{\\sqrt{23}-3}7}$

Якщо продовжити, отримаємо таке розкладання:
...
Видно, що послідовність повторюється. Для стислості ми використовуємо позначення $\\sqrt{23}=\[4;(1,3,1,8)]$, щоб вказати, що блок (1,3,1,8) повторюється нескінченно.

Перші десять неперервних дробів (ірраціональних) квадратних коренів:
...
Скільки неперервних дробів для $N \\le n$ мають непарний період?
