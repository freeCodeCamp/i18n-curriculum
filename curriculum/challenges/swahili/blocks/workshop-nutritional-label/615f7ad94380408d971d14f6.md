...
Kichaguzi cha `:not` kinaweza kutumika kuchagua vipengele vyote ambavyo havilingani na sheria ya CSS iliyotolewa.
...
Hapo juu kinachagua vipengele vyote vya `div` bila `id` ya `example`.

Badilisha kichaguzi chako cha `.daily-value p` ili kuondoa vipengele vya `.no-divider`.
...
Hupaswi kubadilisha vigezo katika kichaguzi cha `.daily-value p:not(.no-divider)`.
