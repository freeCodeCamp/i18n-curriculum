...
A cosa si riferisce Tom con `them` nella sua risposta?
...
Tom non si riferisce alle istruzioni condizionali in sé, ma a ciò che queste istruzioni gestiranno.
...
Anche se la gestione degli errori è l'argomento più ampio, Tom si riferisce specificamente a qualcosa all'interno di questo contesto che necessita di gestione.
...
Il riferimento di Tom non riguarda i linguaggi di programmazione, ma un aspetto specifico all'interno del tema della gestione degli errori.
