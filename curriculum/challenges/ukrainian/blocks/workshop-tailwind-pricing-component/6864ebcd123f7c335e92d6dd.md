...
Тепер слід попрацювати з відступами для елементів усередині цього плану.

Додайте утилітарний клас `rounded-xl`, щоб прибрати гострі краї для обведення, `p-8`, щоб збільшити відступ, і `gap-6`, щоб створити простір між вмістом і кнопкою CTA.

# --hints--

Ваш елемент `div` має містити клас `rounded-xl`.
...
Ваш елемент `div` має містити клас `p-8`.
...
Ваш елемент `div` має містити клас `gap-6`.
