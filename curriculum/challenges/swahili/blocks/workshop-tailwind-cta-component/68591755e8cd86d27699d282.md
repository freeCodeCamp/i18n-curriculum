...
Mwishowe, ili kuondoa pembe kali za kipengele cha nje cha `div`, ongeza darasa la vitu `rounded-md`.

# --hints--

Kipengele chako cha nje cha `div` kinapaswa kuwa na darasa la huduma la `rounded-md`.
