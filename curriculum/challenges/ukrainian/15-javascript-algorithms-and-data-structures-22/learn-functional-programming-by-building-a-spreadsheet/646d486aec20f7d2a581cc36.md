...
На жаль, та властивість `children` повертає колекцію елементів, яка є масивоподібна, але не є масивом. Загорніть другий аргумент у `Array.from()`, щоб перетворити його на масив.

# --hints--

Ви повинні обернути свій `document.getElementById('container').children` у `Array.from()`.
