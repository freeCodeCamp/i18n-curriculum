...
Ricorda che la proprietà `grid-column` determina da quale colonna un elemento inizia e a quale colonna finisce. Può capitare di non sapere quante colonne avrà la tua griglia, ma vuoi che un elemento si fermi all'ultima colonna. Per farlo, puoi usare `-1` per la colonna finale.
