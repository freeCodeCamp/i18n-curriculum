...
Un *bead sort* comienza por crear una matriz de ceros cuya longitud es igual al valor del elemento más grande en el arreglo de entrada. La matriz se transforma añadiendo uno a todos los elementos entre el índice cerebroso y el índice indicado por el elemento actual. Este proceso se repite hasta que hayas llenado la matriz.

Interizando sobre la matriz, sumando el número de elementos mayores que cero, luego disminuyendo el valor de cada elemento por uno produce la matriz ordenada.

**Note:** Cada elemento en el array de entrada es único.

Ordena un array de enteros positivos usando el Algoritmo de Ordenación de Bead.
