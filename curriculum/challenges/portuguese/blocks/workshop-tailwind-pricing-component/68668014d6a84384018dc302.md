...
A seguir está o último item de preço, o **Plano Familiar**.

Para começar, dê ao wrapper `div` do plano as classes `bg-gray-100`, `ring-1`, `ring-gray-300`, `p-8` e `rounded-xl`.

# --hints--

Seu elemento wrapper `div` para o plano familiar deve ter a classe `bg-gray-100`.
...
Seu elemento wrapper `div` para o plano familiar deve ter a classe `ring-1`.
...
Seu elemento wrapper `div` para o plano familiar deve ter a classe `ring-gray-300`.
...
Seu elemento wrapper `div` para o plano familiar deve ter a classe `p-8`.
...
Seu elemento wrapper `div` para o plano familiar deve ter a classe `rounded-xl`.
