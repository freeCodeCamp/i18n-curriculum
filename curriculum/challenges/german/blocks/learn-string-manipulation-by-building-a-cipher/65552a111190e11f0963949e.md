...
Löschen Sie das Schlüsselwort `pass` und geben Sie `vigenere(message, key)` aus Ihrer neuen Funktion zurück.

# --hints--

Ihre `encrypt`-Funktion sollte `vigenere(message, key)` zurückgeben. Denken Sie daran, `pass` zu löschen.
