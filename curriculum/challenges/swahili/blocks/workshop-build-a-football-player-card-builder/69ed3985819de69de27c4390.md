...
Sasa sahihisha `FootballPlayerCard` ili ipitisha `defaultPlayer` kwa `PlayerCard` badala ya kitu ndani ya mstari.

# --hints--

Unapaswa kuwa na `defaultPlayer` kama thamani ya kigezo cha `player` kinachopitishwa kwa `PlayerCard`.
