...
As propriedades `averageRating`, `totalIngredients` e `difficultyLevel` de `recipe3` foram preenchidas para você.

Agora, registre o array `recipes` no console para ver todos os seus itens preenchidos com os valores atualizados.

Com isso, seu projeto de rastreador de receitas está completo.

# --hints--

Você deve registrar o array `recipes` no console.
