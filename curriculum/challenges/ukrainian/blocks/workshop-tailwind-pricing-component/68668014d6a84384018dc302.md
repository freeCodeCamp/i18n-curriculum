...
Далі останній пункт у прайсах — **Сімейний план**.

Спочатку додайте обгортку `div` для плану з класами `bg-gray-100`, `ring-1`, `ring-gray-300`, `p-8` і `rounded-xl`.

# --hints--

Ваш елемент-обгортка `div` для сімейного плану має мати клас `bg-gray-100`.
...
Ваш елемент-обгортка `div` для сімейного плану має мати клас `ring-1`.
...
Ваш елемент-обгортка `div` для сімейного плану має мати клас `ring-gray-300`.
...
Ваш елемент-обгортка `div` для сімейного плану має мати клас `p-8`.
...
Ваш елемент-обгортка `div` для сімейного плану має мати клас `rounded-xl`.
