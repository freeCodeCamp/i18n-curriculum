...
Crea una regola `.image-1, .image-3` e imposta la sua proprietà `grid-column` su `1 / -1`. Questo permetterà alla prima e alla terza immagine di estendersi per tutta la larghezza della griglia.
