...
Geuza kila mstatili ili kuzipa muonekano wa kuchora kwa mkono usio kamilifu.

Tumia sifa ya `transform` kwenye kichaguzi cha `.one` ili `rotate` kwa mwelekeo wa kugeuka kinyume cha saa kwa digrii 0.6.
...
Kielemeni chako cha `.one` kinapaswa kuwa na thamani ya `transform` ya `rotate(-0.6deg)`.
