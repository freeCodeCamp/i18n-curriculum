...
Зробіть `Est. 2020` курсивом, створивши селектор класу `established` і задавши йому властивість `font-style` зі значенням `italic`.

# --hints--

У вас має бути селектор `.established`.
...
Ви повинні встановити властивість `font-style` у значення `italic`.
...
Ваш селектор `.established` має встановити властивість `font-style` у значення `italic`.
