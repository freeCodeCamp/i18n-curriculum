...
`These` is used as a noun when referring to multiple things that were mentioned earlier, such as problems, ideas, or tasks. If you use `this`, on the other hand, you are referring to a single previously mentioned item. Zum Beispiel:
