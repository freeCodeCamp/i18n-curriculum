...
Diese Zahl gibt die Uhrzeit am Nachmittag an, zu der ihr Arbeitstag normalerweise endet.
...
Dieses Verb zeigt an, dass sich die Situation je nach bestimmten Faktoren ändern kann. Vergessen Sie nicht die Endung `-s`.
