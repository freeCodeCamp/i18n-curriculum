...
Los navegadores aplican estilos predeterminados a muchos elementos. En el caso de los elementos de entrada, tu capacidad para estilarlos con CSS puede sentirse bastante limitada. Por eso, puede que quieras usar `appearance: none` para ocultar aspectos del elemento predeterminado y crear el tuyo propio. Por ejemplo, esto ocultaría las casillas de verificación predeterminadas de una entrada checkbox, permitiéndote usar indicadores personalizados como una marca verde y una X roja para mostrar el estado. Para una entrada de búsqueda, los navegadores basados en WebKit mostrarán un ícono de búsqueda predeterminado y un botón de cancelar. Ocultarlos te permite crear tus propios indicadores que aparecerán en todos los navegadores.
