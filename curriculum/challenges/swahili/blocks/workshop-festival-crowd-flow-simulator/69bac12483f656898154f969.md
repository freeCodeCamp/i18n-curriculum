...
Tumia mzunguko wa `for...in` kurudia kupitia kila lango katika kitu cha ingizo cha `summary` na andika jumla ya washiriki waliopokelewa.

Kwa kila lango, andika ujumbe kwa muundo huu: `gate + ": " + summary[gate] + " attendees processed"`.

Kwa mfano, kwa kitu cha ingizo cha `summary` kilichoainishwa kama `{ North: 5, East: 3, South: 4, West: 2 }`, unapaswa kuandika:
...
Unapaswa kurudia kupitia kila kipengele katika kitu cha `summary` na kuandika ujumbe ufuatao mara moja kwa kila kipengele: `element + ": " + summary[element] + " attendees processed`.
