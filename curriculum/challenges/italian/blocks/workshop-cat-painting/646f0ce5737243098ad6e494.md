...
L’ultima cosa su cui lavorerai sono i baffi. Saranno 6, quindi tre per ogni lato.

Crea un elemento `div` con la classe `cat-whiskers`.
...
Il tuo elemento div dovrebbe avere la classe `cat-whiskers`.
