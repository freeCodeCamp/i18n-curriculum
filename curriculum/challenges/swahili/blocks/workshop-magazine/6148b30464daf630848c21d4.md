...
Toa kichaguzi chako cha `.heading` sifa ya `row-gap` iliyowekwa kuwa `1.5rem`.

# --hints--

Kichaguzi chako cha `.heading` kinapaswa kuwa na sifa ya `row-gap` iliyowekwa kuwa `1.5rem`.
