...
Tumia kitendakazi chako cha `chunkCrew()` kuunda vipande vya ukubwa wa `3` kutoka kwa safu ya data `EVAReadySquad` na vihifadhi katika kigezo kipya kinachoitwa `EVAChunks`.

# --hints--

Unapaswa kuita `chunkCrew()` kwa `EVAReadySquad` na `3` na kuhifadhi matokeo katika kigezo kipya kinachoitwa `EVAChunks`.
