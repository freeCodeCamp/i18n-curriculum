...
Usa di nuovo il componente `Card` altre due volte con quanto segue:

| Props  | Valori della prima card | Valori della seconda card |
|-------|------------------------------------------------------------|-----------------------------------------------------|
| `name`  | `"Tiffany"` | `"Doug"`|
...
Non dovresti modificare il componente `Card` esistente nel tuo componente `App`.
...
Dovresti usare il componente `Card` come elemento con le props appropriate e i valori della prima card.
...
Dovresti usare il componente `Card` come elemento con le props appropriate e i valori della seconda card.
