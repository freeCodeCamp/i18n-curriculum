...
Ahora envuelve el componente `PlayerCard` en un elemento `main` de `className` de `main`.

Dentro del elemento `main`, agrega `div` de `className` de `layout`. Dentro de `layout`, añade dos elementos `div` separados de `className` de `form-panel` y `preview-panel` respectivamente.

# --hints--

Tu `FootballPlayerCard` debe renderizar un elemento `main` con el `className` de `main` dentro de `div.page`.
...
Tu `main.main` debe contener un `div` con el `className` de `layout`.
...
Tu `layout` debe contener un `div` con el `className` de `form-panel`.
...
Tu `layout` debe contener un `div` con el `className` de `preview-panel`.
