...
まず、ロゴが見えるように`background-color`を`#0a0a23`に変更してください。次に、`aspect-ratio`プロパティを使って、希望のアスペクト比を`35 / 4`に設定します。最後に、全体に`padding`の`0.4rem`を追加してください。
