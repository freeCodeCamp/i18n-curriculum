...
الخصائص الافتراضية لعنصر `hr` تجعله يظهر كخط رفيع رمادي فاتح. يمكنك تغيير ارتفاع الخط بتحديد قيمة لخاصية `height`.

غيّر ارتفاع عنصر `hr` إلى `3px`.

# --hints--

يجب أن تستخدم المحدِّد `hr`.
...
يجب أن تضبط الخاصية `height` على `3px`.
...
يجب أن يكون لعنصر `hr` ارتفاع قدره `3px`.
