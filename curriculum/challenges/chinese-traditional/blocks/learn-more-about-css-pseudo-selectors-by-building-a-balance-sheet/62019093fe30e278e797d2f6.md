...
`[attribute="value"]` 選擇器針對具有特定值的屬性的任何元素。 創建一個 `tr[class="total"]` 選擇器，專門針對具有 `total` 類的 `tr` 元素。 給它一個 `4px double #0a0a23` 的底部邊框，並使字體加粗。
