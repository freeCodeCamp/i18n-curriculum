...
Dovresti dare a `.penguin-head` una proprietà `top` con il valore `--fcc-expected--` invece di `--fcc-actual--`.
...
Dovresti dare a `.penguin-head` una proprietà `left` con il valore `--fcc-expected--` invece di `--fcc-actual--`.
