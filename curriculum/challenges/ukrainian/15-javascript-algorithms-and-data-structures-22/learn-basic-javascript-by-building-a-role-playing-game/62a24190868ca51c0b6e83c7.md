...
Наразі приховайте елемент `#monsterStats` за допомогою властивості `display`. Не змінюйте жодного іншого стилю.
...
Селектор `#monsterStats` повинен мати властивість `display` зі значенням `none`.
