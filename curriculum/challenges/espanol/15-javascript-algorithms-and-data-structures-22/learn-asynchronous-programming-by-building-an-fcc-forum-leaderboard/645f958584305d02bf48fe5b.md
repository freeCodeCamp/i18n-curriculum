...
Al final de tu método `map`, encadena el método `join()`. Para el separador, pasa una cadena vacía.

# --hints--

Debes encadenar el método `join` al método `map` y usar una cadena vacía como separador.
