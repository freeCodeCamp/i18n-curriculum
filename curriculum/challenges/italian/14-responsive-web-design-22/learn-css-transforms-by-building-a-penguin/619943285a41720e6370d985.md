...
Dovresti dare a `.penguin-body` una proprietà `top` con il valore `--fcc-expected--` invece di `--fcc-actual--`.
...
Dovresti dare a `.penguin-body` una proprietà `left` con il valore `--fcc-expected--` invece di `--fcc-actual--`.
