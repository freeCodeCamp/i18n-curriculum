...
Kweli au si kweli: Liu Ming ni mbunifu wa UI kutoka China.
...
Liu Ming ni mbunifu wa UI, lakini anasema wazi kuwa si Mchina.
...
Liu Ming anasema `我不是中国人 (wǒ bù shì zhōng guó rén)，我是新加坡人 (wǒ shì xīn jiā pō rén)`, ambayo ina maana yeye ni Msingapuri, si Mchina.

Pia anasema `我是 (wǒ shì) UI 设计师 (shè jì shī)`, ambayo ina maana yeye ni mbunifu wa UI.

Hivyo, kauli hiyo si kweli.
