...
title: 'Problema 80: espansione decimale della radice quadrata'
challengeType: 1
forumTopicId: 302194
...
È noto che se la radice quadrata di un numero naturale non è un intero, allora è irrazionale. L'espansione decimale di tali radici quadrate è infinita senza alcun pattern ripetuto.

La radice quadrata di due è `1.41421356237309504880...`, e la somma delle cifre decimali delle prime cento cifre decimali è `475`.

Per i primi `n` numeri naturali, trova il totale delle somme delle cifre decimali delle prime cento cifre decimali per tutte le radici quadrate irrazionali.
