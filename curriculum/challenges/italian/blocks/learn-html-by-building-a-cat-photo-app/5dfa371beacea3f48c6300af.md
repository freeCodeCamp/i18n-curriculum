...
L'elemento `h3` subito sopra il tag di chiusura del secondo elemento `section` dovrebbe avere il testo `Things cats love:`. Assicurati di includere i due punti alla fine del testo.
