...
In diesem Dialog verwendet Bob das past continuous, um andauernde Handlungen in der Vergangenheit zu beschreiben.
...
Das Verb ist `to add`. Denken Sie daran, es zu konjugieren.
...
Das Verb ist `to push`. Denken Sie daran, es zu konjugieren.
