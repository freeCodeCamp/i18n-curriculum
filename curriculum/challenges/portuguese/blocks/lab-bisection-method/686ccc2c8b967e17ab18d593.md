...
Sua função `square_root_bisection` deve lançar um `ValueError` com a mensagem `Square root of negative number is not defined in real numbers` quando o número passado para a função for negativo.
...
`square_root_bisection(0)` deve imprimir `The square root of 0 is 0`.
...
`square_root_bisection(0.001, 1e-7, 50)` deve imprimir `The square root of 0.001 is approximately X`, onde `X` é um número entre `0.03162267660168379` e `0.031622876601683794`.
...
`square_root_bisection(0.25, 1e-7, 50)` deve imprimir `The square root of 0.25 is approximately X`, onde `X` é um número entre `0.4999999` e `0.5000001`.
...
`square_root_bisection(1)` deve imprimir `The square root of 1 is 1`.
...
`square_root_bisection(81, 1e-3, 50)` deve imprimir `The square root of 81 is approximately X`, onde `X` é um número entre `8.999` e `9.001`.
...
`square_root_bisection(225, 1e-3, 100)` deve imprimir `The square root of 225 is approximately X`, onde `X` é um número entre `14.999` e `15.001`.
...
`square_root_bisection(225, 1e-5, 100)` deve imprimir `The square root of 225 is approximately X`, onde `X` é um número entre `14.99999` e `15.00001`.
...
`square_root_bisection(225, 1e-7, 100)` deve imprimir `The square root of 225 is approximately X`, onde `X` é um número entre `14.9999999` e `15.0000001`.
...
`square_root_bisection(225, 1e-7, 10)` deve imprimir `Failed to converge within 10 iterations`.
