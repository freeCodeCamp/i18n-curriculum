...
现在是测试你的 `showResults` 函数` 的时候了。 

首先创建一个名为 `rockBtn` 的变量，并将其赋值为 id 为 `rock-btn` 的按钮。

然后，创建一个名为 `paperBtn` 的变量，并将其赋值为 id 为 `paper-btn` 的按钮。

最后，创建一个名为 `scissorsBtn` 的变量，并将其赋值为 id 为 `scissors-btn` 的按钮。

# --hints--

你应该有一个名为 `rockBtn` 的变量。

```js
assert.isNotNull(rockBtn);
```

你的 `rockBtn` 变量应赋值为 id 为 `rock-btn` 的按钮。

```js
assert.equal(rockBtn, document.getElementById("rock-btn"));
```

你应该有一个名为 `paperBtn` 的变量。

```js
assert.isNotNull(paperBtn);
```

你的 `paperBtn` 变量应赋值为 id 为 `paper-btn` 的按钮。

```js
assert.equal(paperBtn, document.getElementById("paper-btn"));
```

你应该有一个名为 `scissorsBtn` 的变量。

```js
assert.isNotNull(scissorsBtn);
```

你的 `scissorsBtn` 变量应赋值为 id 为 `scissors-btn` 的按钮。
