...
Wählen Sie die `#scary-btn`, `#funny-btn` und `#adventure-btn` Buttons aus und speichern Sie sie in Variablen namens `scaryStoryBtn`, `funnyStoryBtn` und `adventureStoryBtn`.

# --hints--

Sie sollten den `#scary-btn` Button mit der `getElementById` Methode auswählen und in der `scaryStoryBtn` Variable speichern.
...
Sie sollten den `#funny-btn` Button mit der `getElementById` Methode auswählen und in der `funnyStoryBtn` Variable speichern.
...
Sie sollten den `#adventure-btn` Button mit der `getElementById` Methode auswählen und in der `adventureStoryBtn` Variable speichern.
