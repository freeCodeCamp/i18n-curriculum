...
سيقوم جيك بما طلبته ليزا. ماذا يمكن أن يقول؟
...
تحتاج ليزا أن يراقب جيك السجلات بنشاط، وليس فقط أن يتحقق منها عند الفرصة.
...
رد جيك طريقة طبيعية ومهنية للاعتراف بالطلب.

`Will do.` طريقة مختصرة وغير رسمية لقول `I will do that`.

`Thanks for your help.` طريقة مهذبة لإظهار التقدير.
