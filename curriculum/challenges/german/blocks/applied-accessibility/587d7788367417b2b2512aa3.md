...
Ähnlich wie `header` und `nav`, verfügt das Element `footer` über eine integrierte Markierung, mit der Hilfsmittel schnell dorthin navigieren können. In erster Linie wird das Footer-Tag für urheberrechtliche Informationen oder weiterführende Links verwendet, die normalerweise am Ende einer Seite zu finden sind.
