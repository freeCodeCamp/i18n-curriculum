...
Pero este código no sería correcto, porque `h3` viene antes que `h2`. 

Mueve el elemento `h2` por encima del `h3` para que sea semánticamente correcto. Para interactuar con el código, necesitarás habilitar el editor interactivo.
