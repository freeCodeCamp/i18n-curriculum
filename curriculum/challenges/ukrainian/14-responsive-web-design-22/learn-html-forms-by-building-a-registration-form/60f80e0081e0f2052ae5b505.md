...
Для браузера важливо уточнювати атрибут типу елемента форми, щоб знати, які дані йому варто очікувати. Якщо `type` не вказано, браузер за замовчуванням використовуватиме `text`.
