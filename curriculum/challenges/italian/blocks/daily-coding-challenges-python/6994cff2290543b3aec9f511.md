...
`insert_into_array([2, 4, 8, 10], 6, 2)` dovrebbe restituire `[2, 4, 6, 8, 10]`.
...
`insert_into_array(["the", "quick", "fox"], "brown", 2)` dovrebbe restituire `["the", "quick", "brown", "fox"]`.
...
`insert_into_array([], 0, 0)` dovrebbe restituire `[0]`.
...
`insert_into_array([0, 1, 1, 2, 3, 8, 13], 5, 5)` dovrebbe restituire `[0, 1, 1, 2, 3, 5, 8, 13]`.
