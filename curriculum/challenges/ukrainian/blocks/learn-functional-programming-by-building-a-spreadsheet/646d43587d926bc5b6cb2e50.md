...
Оголосіть змінну `str2` і призначте їй результат виклику `infixEval()` з `noHigh` та `infix` як аргументами.
...
Ви повинні використати `const` для оголошення змінної `str2`.
...
Ви повинні призначити `str2` результат виклику `infixEval()`.
...
Ви повинні передати `noHigh` як перший аргумент до `infixEval()`.
...
Ви повинні передати `infix` як другий аргумент до `infixEval()`.
