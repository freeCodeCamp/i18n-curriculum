...
A seguir está o elemento *anchor* `<a>` (que requer uma tag de fechamento `</a>`):  
...
Aqui está um <a href="https://www.freecodecamp.org" target="_blank">link para www.freecodecamp.org</a> para você seguir.
...
Seu elemento `a` deve estar dentro de seu novo elemento `p`.
...
Seu elemento `p` deve conter o texto `Ver mais ` (com um espaço após).
...
Seu elemento `a` <em>não</em> deve conter o texto `Ver mais`.
