...
title: Вступ до гнучкого контейнера. Урок №8
challengeType: 15
...
Незалежно від того, який напрямок ви використовуєте, вважайте, що гнучкі контейнери мають 2 осі: головну та перехресну. Якщо змінюється `flex-direction`, то змінюється напрямок цих осей. У більшості випадків `flex-direction: row` розміщує головну вісь горизонтально (зліва направо), а `column` — вертикально (зверху вниз).
