...
عيّن استعلامك إلى متغير `currentProductCountSpan`.

# --hints--

يجب إعلان متغير `currentProductCountSpan`.
...
يجب استخدام `const` لإعلان `currentProductCountSpan`.
...
يجب استخدام `document.getElementById()` للحصول على العنصر المطابق.
...
يجب استخدام قالب نصي لاستعلام قيمة `id`.
...
يجب تعيين قيمة `document.getElementById()` إلى `currentProductCountSpan`.
