...
Sasa, hatuwezi kusoma maandishi. Lenga `footer` na kipengele cha nanga ili kuweka rangi ya fonti kwa rangi ya uwiano wa utofautishaji wa kutosha.
...
Unapaswa kuweka `color` kwa thamani yenye uwiano wa utofautishaji wa angalau `7:1`. _Kidokezo: Ninapendekeza `#dfdfe2`_
