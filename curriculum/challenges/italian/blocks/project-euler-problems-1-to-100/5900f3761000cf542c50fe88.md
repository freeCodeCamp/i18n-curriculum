...
title: 'Problema 9: tripla pitagorica speciale'
challengeType: 1
forumTopicId: 302205
...
Una tripla pitagorica è un insieme di tre numeri naturali, `a` &lt; `b` &lt; `c`, per cui,

<div style='text-align: center;'><var>a</var><sup>2</sup> + <var>b</var><sup>2</sup> = <var>c</var><sup>2</sup></div>

Per esempio, 3<sup>2</sup> + 4<sup>2</sup> = 9 + 16 = 25 = 5<sup>2</sup>.

Esiste esattamente una tripla pitagorica per cui `a` + `b` + `c` = 1000. Trova il prodotto `abc` tale che `a` + `b` + `c` = `n`.
