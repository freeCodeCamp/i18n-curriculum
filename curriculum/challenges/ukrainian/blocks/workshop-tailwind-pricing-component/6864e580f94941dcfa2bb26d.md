...
Тепер слід попрацювати над розміщенням елементів всередині картки для плану.

Для цього встановіть для контейнера відображення сітки та вкажіть кастомний розмір рядка, використовуючи квадратні дужки у вашому класі Tailwind.

Ось як можна задати кастомний рядок сітки, використовуючи дробові одиниці:
...
Додайте зовнішньому `div` для плану утилітарні класи `grid` та `grid-rows-[1fr_auto]`.

# --hints--

Ваш елемент `div` має мати клас `grid`.
...
Ваш елемент `div` має мати клас `grid-rows-[1fr_auto]`.
