...
Окрім `Go Premium` CTA, решта вмісту знаходиться в `div`. Тому CSS сітка — хороший варіант для розташування всього.

Додайте класи `grid`, `grid-rows-[auto_auto_auto_1fr]` і `gap-y-2` до `div`, який обгортає елементи `h2`, `p` і `ul`.

# --hints--

Ваш елемент `div`, який обгортає елементи `h2`, `p` і `ul`, має мати клас `grid`.
...
Ваш елемент `div`, який обгортає елементи `h2`, `p` і `ul`, має мати клас `grid-rows-[auto_auto_auto_1fr]`.
...
Ваш елемент `div`, який обгортає елементи `h2`, `p` і `ul`, має мати клас `gap-y-2`.
