...
Mueve tu función `goTown` encima de tu función `goStore`. A continuación, copia y pega el contenido de la función `goStore` en la función `goTown`.

# --hints--

Tu función `goTown` debe estar antes que tu función `goStore`.
...
Tu función `goTown` debe tener el mismo contenido que tu función `goStore`.
