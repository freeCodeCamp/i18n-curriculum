...
Відцентруйте елемент `.three` на полотні, встановивши його властивість `margin` у значення `auto`.

# --hints--

Ви повинні встановити властивість `margin` у значення `auto`.
...
Ваш елемент `.three` має мати значення ідентифікатора `margin` рівне `auto`.
