...
Dentro da classe, adicione uma propriedade privada `elements` como um objeto. Dentro dela, adicione as propriedades `singleCardBtn`, `singleCard` e `multipleCardsBtn`, cada uma tipada como `HTMLElement`.

# --hints--

Você deve declarar uma propriedade `private` chamada `elements` dentro da classe `Game`.
...
Sua propriedade privada `elements` deve ter uma propriedade `singleCardBtn` tipada como `HTMLElement`.
...
Sua propriedade privada `elements` deve ter uma propriedade `multipleCardsBtn` tipada como `HTMLElement`.
...
Sua propriedade privada `elements` deve ter uma propriedade `singleCard` tipada como `HTMLElement`.
