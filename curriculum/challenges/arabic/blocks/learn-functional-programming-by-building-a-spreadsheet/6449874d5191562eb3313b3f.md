...
أخيرًا، اجعل `rangeRegex` عامًا وحساسًا لحالة الأحرف.

# --hints--

يجب أن يكون `rangeRegex` حساسًا لحالة الأحرف.
...
يجب أن يكون `rangeRegex` عامًا وحساسًا لحالة الأحرف في الوقت نفسه.
