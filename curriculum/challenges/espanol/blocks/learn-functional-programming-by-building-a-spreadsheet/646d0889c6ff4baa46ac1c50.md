...
En tu función `elemValue`, declara una función llamada `inner` que tome un parámetro `character`.

Luego, devuelve tu función `inner`.

# --hints--

Debes declarar una variable `inner`.
...
Debes usar `const` para declarar tu variable `inner`.
...
Tu variable `inner` debe ser una función flecha.
...
Tu función `inner` debe tener `character` como el único parámetro.
...
Tu función `inner` debe estar vacía.
...
Debes devolver explícitamente tu función `inner`.
