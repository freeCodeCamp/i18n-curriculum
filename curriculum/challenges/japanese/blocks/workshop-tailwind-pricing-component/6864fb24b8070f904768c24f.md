...
次の料金カードは**プレミアムプラン**です。

プレミアムプランのラッパー`div`にクラス`bg-gray-950`、`text-white`、`ring-2`、`ring-fuchsia-500`、および`p-8`を付けてください。

# --hints--

プレミアムプランのラッパー`div`要素にはクラス`bg-gray-950`を付ける必要があります。
...
プレミアムプランのラッパー`div`要素にはクラス`text-white`を付ける必要があります。
...
プレミアムプランのラッパー`div`要素にはクラス`ring-2`を付ける必要があります。
...
プレミアムプランのラッパー`div`要素にはクラス`ring-fuchsia-500`を付ける必要があります。
...
プレミアムプランのラッパー`div`要素にはクラス`p-8`を付ける必要があります。
