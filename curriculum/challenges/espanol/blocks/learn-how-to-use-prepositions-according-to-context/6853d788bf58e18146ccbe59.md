...
`Ten developers` is a way to report how many people are currently working on a project. Using numbers helps clearly show available resources. Por ejemplo:

`We have five designers and ten developers for this release.` – This means the team includes those people now.

`On the team` means being part of a group that works together on a project. Por ejemplo:
