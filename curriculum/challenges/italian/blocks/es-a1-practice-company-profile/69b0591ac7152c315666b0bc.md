...
Leggi il dialogo e decidi se la seguente istruzione è vera o falsa.

# --questions--

## --text--

È vero o falso: quando Sebastián chiede `¿Cuál es su sitio web?`, sta chiedendo il sito web dell'azienda.
...
Sebastián sta chiedendo del `sitio web` dell'azienda, che significa "sito web".
