...
Sasa, unahitaji kupata nambari ya kwanza katika maandishi ya `0/10`, kwa njia ambayo itafanya kazi hata kwa `5/10` au `10/10`.

Tafsiri maudhui ya maandishi ya kipengele cha `.count` ili kutoa nambari ya sasa.

Badilisha hesabu kutoka mfuatano wa herufi kuwa nambari.

Badilisha `console.log(countEl.textContent)` ya awali na kumbukumbu yako mpya.

Rekodi hesabu ya sasa kwa muundo huu: `console.log("Current count:", currCount)`.

Kibukizi: kumbuka unaweza kutumia njia ya `split` kugawanya mfuatano wa herufi kuwa safu ya data ndogo ndogo.

# --hints--

Unapaswa kurekodi hesabu ya sasa kama nambari.
...
Unapaswa kurekodi hesabu ya sasa kama nambari kwa njia inayofanya kazi kwa thamani mbalimbali zinazowezekana.
