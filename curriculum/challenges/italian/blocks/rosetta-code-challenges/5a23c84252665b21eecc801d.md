...
title: Dividere una stringa di caratteri in base al cambiamento di carattere
challengeType: 1
forumTopicId: 302322
...
Dividi una stringa di caratteri in stringhe separate da virgole (più uno spazio) basandoti sul cambiamento di carattere (da sinistra a destra). Gli spazi devono essere trattati come qualsiasi altro carattere (anche se sono difficili da mostrare chiaramente). Lo stesso vale per le virgole. Per esempio, la stringa:

<pre>
"gHHH5YY++///\\"
</pre>

dovrebbe essere divisa così:
