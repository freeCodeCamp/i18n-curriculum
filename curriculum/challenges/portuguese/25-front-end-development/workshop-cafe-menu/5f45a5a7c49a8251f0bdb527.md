...
Usando o mesmo seletor de estilo do passo anterior, torne maior o tamanho da fonte dos itens e preços usando um valor de `18px`.

# --hints--

Você deve definir a propriedade `font-size` como `18px`.
...
Os elementos `p` dentro dos elementos da classe `.item` devem ter uma `font-size` de `18px`.
