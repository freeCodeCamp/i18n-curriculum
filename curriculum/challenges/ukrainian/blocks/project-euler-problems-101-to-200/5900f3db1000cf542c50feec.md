...
Зверніть увагу, що D1 D2 відрізняється від D2 D1, оскільки вони закінчуються різними подвоєннями. А ось комбінація S1 T1 D1 не відрізняється від T1 S1 D1. До того ж не потрібно звертати увагу на промахи у комбінаціях; наприклад, D3 еквівалентне 0 D3 та 0 0 D3. Неймовірно, що загалом існує 42336 різних способів закінчення. Скільки різних способів чекауту має гравець з рахунком меншим за 100?
