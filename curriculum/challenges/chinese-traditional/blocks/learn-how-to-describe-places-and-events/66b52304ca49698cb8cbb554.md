...
In the `Present Simple` tense, the third person singular form of verbs usually ends in `-s` or `-es`. 例如：
...
`Concern` means to worry or make someone feel anxious about something. 例如：
