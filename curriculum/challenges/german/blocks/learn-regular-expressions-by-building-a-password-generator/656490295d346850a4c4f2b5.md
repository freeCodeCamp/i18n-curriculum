...
Fügen Sie nach der Schleife eine `return`-Anweisung in Ihre Funktion ein, damit sie die `password`-Variable zurückgibt.

# --hints--

Sie sollten `password` am Ende Ihrer Funktion zurückgeben.
