...
Come passaggio finale, aggiungi un'istruzione `console.log()` con il messaggio: `"Workshop complete! You now know how to use includes() and slice()."`

Congratulazioni! Hai completato il workshop String Inspector.

# --hints--

Dovresti registrare `"Workshop complete! You now know how to use includes() and slice()."` nella console.
