...
1. Você deve ter um elemento `div` com um `id` de `drum-machine` que contenha todos os outros elementos.
...
Algumas amostras de áudio que você pode usar para sua caixa de ritmos podem ser encontradas em `https://cdn.freecodecamp.org/curriculum/drum/<fileName>`, onde `<fileName>` é o seguinte:

| parte da bateria | `fileName` |
| --- | --- |
