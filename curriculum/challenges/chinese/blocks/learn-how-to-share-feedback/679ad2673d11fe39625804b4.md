...
Conditional sentences where both clauses (the `if` clause and the consequence clause) use the `Present Simple` tense describe general truths or habitual actions. 例如：
