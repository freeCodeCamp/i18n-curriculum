...
Markovs Konzepte werden, wegen ihrer einfachen Vorgänge in der Datenmanipulation, beim maschinellen Lernen eingesetzt. Mit einer festgelegten Anzahl von `rules` kannst du gegebene `data` manipulieren um einen gewünschten `output` zu kreieren.

Im Hintergrund haben wir hinzugefügt:

Die `rules` in Form eines verschachtelten Arrays und `data` in Form eines Arrays. Und die gewünschten `outputs`.
...
`markov(["_+1 -> _1+","1+1 -> 11+","1! -> !1",",! -> !+","_! -> _","1*1 -> x,@y","1x -> xX","X, -> 1,1","X1 -> 1X","_x -> _X",",x -> ,X","y1 -> 1y","y_ -> _","1@1 -> x,@y","1@_ -> @_",",@_ -> !_","++ -> +","_1 -> 1","1+_ -> 1","_+_ -> "],"_1111*11111_")` sollte den String `11111111111111111111` zurückgeben.
