...
`As easily` is used to compare the difficulty of two actions or processes. It describes how easy or difficult something is to do in comparison to something else. Наприклад:
