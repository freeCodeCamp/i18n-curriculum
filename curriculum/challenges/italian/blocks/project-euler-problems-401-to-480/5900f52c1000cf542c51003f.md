...
title: 'Problema 448: media del minimo comune multiplo'
challengeType: 1
forumTopicId: 302120
...
La funzione $lcm(a, b)$ indica il minimo comune multiplo di $a$ e $b$.

Sia $A(n)$ la media dei valori di $lcm(n, i)$ per $1 ≤ i ≤ n$.

Ad esempio: $A(2) = \frac{2 + 2}{2} = 2$ e $A(10) = \frac{10 + 10 + 30 + 20 + 10 + 30 + 70 + 40 + 90 + 10}{10} = 32$.
