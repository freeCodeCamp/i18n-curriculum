...
In the next few steps, you will learn how to add new HTML for each song using the <dfn>map()</dfn> method. This method will be explained in more detail in the next step.
