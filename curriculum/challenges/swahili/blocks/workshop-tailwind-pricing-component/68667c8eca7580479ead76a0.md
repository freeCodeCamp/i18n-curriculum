...
Ongeza darasa la vitu `text-gray-300` kwenye kipengele cha `p` ambacho kina faida ya mstari mmoja ya mpango.

# --hints--

Kipengele chako cha `p` kinapaswa kuwa na darasa la vitu `text-gray-300`.
