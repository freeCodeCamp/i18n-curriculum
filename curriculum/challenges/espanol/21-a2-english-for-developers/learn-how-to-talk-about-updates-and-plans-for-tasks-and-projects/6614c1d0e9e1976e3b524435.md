...
Según la response de Bob, ¿qué usarán para la presentación?

## --answers--

Usarán un demo interactivo como sugirió Sarah.

---

Se apegarán al plan original de usar una presentación de diapositivas.

### --feedback--

Bob está de acuerdo con la sugerencia de Sarah de intentar algo diferente, indicando un cambio de la presentación de diapositivas a un demo interactivo.

---

Combinarán tanto una presentación de diapositivas como un demo interactivo.

### --feedback--

Aunque combinar métodos podría ser una posibilidad, la acuerdo de Bob con Sarah sugiere una preferencia por solo el demo interactivo.

---

Todavía no han decidido y lo discutirán más a fondo.

### --feedback--

La sentencia de Bob `That's a great idea` indica acuerdo con la sugerencia de Sarah, implicando que se ha tomado una decisión.
