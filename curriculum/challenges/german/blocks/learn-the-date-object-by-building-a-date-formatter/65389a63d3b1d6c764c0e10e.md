...
Add another `case` with the value `"mm-dd-yyyy-h-mm"`. Setze innerhalb dieses `case` den Textinhalt von `currentDateParagraph` auf leere Template Literale.

Stelle ebenfalls sicher, dass du eine `break`-Anweisung zum Beenden der `switch`-Anweisung einfügst.
