...
Acceda a los elementos `#next` y `#previous` del archivo HTML.

Asígnelos a las variables llamadas `nextButton`, y `previousButton`, respectivamente.

# --hints--

Deberías tener una variable llamada `nextButton`.
...
Deberías tener una variable llamada `previousButton`.
