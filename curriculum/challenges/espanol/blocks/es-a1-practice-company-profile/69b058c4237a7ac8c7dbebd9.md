...
Concéntrate en los detalles de la empresa mencionados en el perfil.
...
Esto es diferente de lo que menciona Sebastián.
...
Este dominio no se menciona en el audio.
...
El `.` ("punto") se conoce como `punto` en español.
