...
صح أم خطأ: ليو مينغ هو مصمم واجهة مستخدم من الصين.
...
ليو مينغ هو مصمم واجهة مستخدم، لكنه يوضح بجلاء أنه ليس صينيًا.
...
يقول ليو مينغ `我不是中国人 (wǒ bù shì zhōng guó rén)，我是新加坡人 (wǒ shì xīn jiā pō rén)`، وهذا يعني أنه سنغافوري، وليس صينيًا.

ويقول أيضًا `我是 (wǒ shì) UI 设计师 (shè jì shī)`، وهذا يعني أنه مصمم واجهة مستخدم.
