...
Veamos cómo el validador detecta un problema real. `catalog[0]` es "From a Buick 8" de Stephen King, que tiene los cuatro campos completos. `catalog[16]` es "Unknown Title", que tiene el campo del autor vacío.
