...
Erstellen Sie außerhalb der Funktionsdefinition ein Array `numbers` mit den folgenden Werten: `[4, 10, 6, 14, 2, 1, 8, 5]`.

# --hints--

Sie sollten ein Array namens `numbers` mit diesen Werten erstellen: `[4, 10, 6, 14, 2, 1, 8, 5]`
