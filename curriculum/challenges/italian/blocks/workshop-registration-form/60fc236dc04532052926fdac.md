...
Se guardi abbastanza da vicino, noterai che gli elementi `.inline` sono troppo alti sulla riga.

Per risolvere questo, imposta la proprietà `vertical-align` su `middle`.
