...
`I'm looking forward to meeting you.` — (з нетерпінням чекаю на зустріч з кимось)

`She's looking forward to traveling next month.`—(вона з нетерпінням чекає на подорож).
...
Прийменник, використаний Браяном після `are`.
...
Він виражає захоплення Браяна від читання майбутніх постів блогу.
