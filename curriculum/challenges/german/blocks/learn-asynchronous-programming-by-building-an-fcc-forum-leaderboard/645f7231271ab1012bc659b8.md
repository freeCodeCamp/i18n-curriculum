...
Prüfen Sie als Nächstes, ob der Benutzer existiert. Fügen Sie eine `if`-Anweisung mit `user` für die Bedingung hinzu.

# --hints--

Sie sollten eine `if`-Anweisung mit der Bedingung von `user` erstellen.
