...
`agreed on`, `mentioned`, `check with you`, `my mistake`, `confused`, `sure` та `totally right`.
...
Це означає попросити когось переконатися, що щось правильне або в порядку.
...
Це означає, що двоє або більше людей разом прийняли рішення.
...
Це означає бути впевненим або певним у чомусь.
...
Це означає не розуміти щось чітко.
...
Це означає, що ви сказали щось швидко або коротко.
...
Спосіб сказати, що ви зробили щось неправильно або припустилися помилки.
