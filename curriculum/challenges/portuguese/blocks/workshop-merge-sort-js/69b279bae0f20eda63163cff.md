...
Fora da definição da função, crie um array `numbers` com os seguintes valores: `[4, 10, 6, 14, 2, 1, 8, 5]`.

# --hints--

Você deve criar um array chamado `numbers` com esses valores: `[4, 10, 6, 14, 2, 1, 8, 5]`
