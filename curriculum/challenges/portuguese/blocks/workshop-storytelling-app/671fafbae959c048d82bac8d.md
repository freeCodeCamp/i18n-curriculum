...
Quando você clicar no `scaryStoryBtn`, o parágrafo `#result` deve exibir a história assustadora `"In the dark woods, a group of friends stumbled upon an old, abandoned cabin. Eles entram na cabine e despertam algo malévolo que estava adormecido por séculos."` with a border color of `#ee4b2b`.
