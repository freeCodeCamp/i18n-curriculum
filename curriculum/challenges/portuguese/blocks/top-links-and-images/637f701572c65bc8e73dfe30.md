...
Para exibir uma imagem em HTML, você usa o elemento `<img>`. Diferente dos outros elementos que você encontrou, `<img>` é um elemento nulo. Os elementos vazios ou nulos do HTML não precisam de uma tag de fechamento.
