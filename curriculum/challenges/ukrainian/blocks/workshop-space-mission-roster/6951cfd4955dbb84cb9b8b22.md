...
Раніше ви додали виклик `console.log()` у вашу функцію `addCrewMember` для перевірки її поведінки, а тепер цей виклик більше не потрібен. Щоб уникнути захаращення терміналу в наступних кроках, видаліть поточний виклик `console.log()`.

# --hints--

Видаліть виклик `console.log()` з вашої функції `addCrewMember`. Потрібно видалити цілу лінію.
