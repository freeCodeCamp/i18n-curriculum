...
Dopo aver registrato l'array non ordinato, chiama la funzione `mergeSort` e passa l'array `numbers` come argomento.

# --hints--

Dovresti chiamare `mergeSort(numbers)` dopo aver registrato l'array non ordinato.
