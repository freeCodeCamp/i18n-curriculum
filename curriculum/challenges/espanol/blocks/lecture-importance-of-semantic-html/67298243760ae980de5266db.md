...
Finalmente, usar los elementos semánticos correctos puede mejorar tu experiencia de desarrollo. En lugar de tener que buscar entre un montón de `div`s para encontrar tu barra de navegación, puedes editar directamente el elemento `nav` y saber qué estás cambiando. A lo largo de esta sección, aprenderás más sobre estos temas, cómo usar elementos semánticos y por qué el HTML semántico es tan importante.
