...
トムのチームミーティングに関する質問をよく聞いてください。

# --questions--

## --text--

ミーティングの文脈でトムは何について質問していますか？
...
ミーティングがどのくらいの頻度で行われるかは尋ねていません。週に一度であることは知っています。
