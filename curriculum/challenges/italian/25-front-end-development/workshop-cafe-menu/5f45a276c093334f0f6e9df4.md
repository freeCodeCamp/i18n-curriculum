...
Utilizza il selettore esistente che si riferisce a tutti gli elementi  `p` annidati in elementi con una classe denominata `item`, e assegna un margine superiore e inferiore di `5px`.
