...
Ndani ya kitendakazi cha `playSong`, fanya wito kwa kitendakazi cha `highlightCurrentSong`.

Baada ya hapo, jaribu kubonyeza vifungo vya udhibiti kuona jinsi kitendakazi cha `highlightCurrentSong` kinavyofanya kazi.

# --hints--

Unapaswa kufanya wito kwa kitendakazi cha `highlightCurrentSong`.
