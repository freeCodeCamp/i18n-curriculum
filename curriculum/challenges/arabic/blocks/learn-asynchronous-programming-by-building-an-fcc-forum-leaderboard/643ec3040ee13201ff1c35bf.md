...
اترك العنصر الثاني `td` فارغًا لأنك ستضيف محتوى إليه لاحقًا.

في العنصر الثالث `td`، أضف التعبير المضمّن التالي: `${posts_count - 1}`.

سيعرض هذا عدد الردود على الموضوع.

# --hints--

يجب أن يحتوي العنصر الثالث `td` على `${posts_count - 1}`.
