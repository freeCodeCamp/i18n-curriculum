...
استخدم نفس المتغير كلون `background-color` في الأصناف `.bb1b` و`.bb1c` و`.bb1d` لملء بقية المبنى.
...
يجب استخدام `var(--building-color1)` لتعيين `background-color` لعنصر `.bb1b`.
...
يجب استخدام `var(--building-color1)` لتعيين `background-color` لعنصر `.bb1c`.
...
يجب استخدام `var(--building-color1)` لتعيين `background-color` لعنصر `.bb1d`.
