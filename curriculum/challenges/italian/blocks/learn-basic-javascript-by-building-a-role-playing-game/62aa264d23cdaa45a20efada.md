...
const locations = [
  {
    ...
    text: "You are in the town square. Vedete un cartello che dice \"Store\"."
  },
  {
    name: "store",
  ...
  {
    name: "grotta",
    "button text": ["Lotta contro la melma", "Lotta contro la bestia zannuta", "Vai alla piazza della città"],
