...
Це означає натиснути праву кнопку миші.
...
У цьому контексті це опція для перегляду детальної інформації про жорсткий диск. Напишіть з великої літери.
...
Описує простір, який ще не використаний і доступний для зберігання даних.
