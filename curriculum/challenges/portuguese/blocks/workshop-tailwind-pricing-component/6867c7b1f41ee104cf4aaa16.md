...
Agora, você usará `grid` para organizar os itens dentro do wrapper `div`.

Adicione as classes `grid`, `grid-rows-[1fr_auto]` e `gap-6` ao `div` wrapper.

# --hints--

Seu elemento wrapper `div` para o plano familiar deve ter a classe `grid`.
...
Seu elemento wrapper `div` para o plano familiar deve ter a classe `grid-rows-[1fr_auto]`.
...
Seu elemento wrapper `div` para o plano familiar deve ter a classe `gap-6`.
