...
Agora, faça o mesmo para o resto das propriedades. Use a função `getElement` para selecionar cada uma:
...
Você deve acessar o `multipleCardsBtn` usando o método `getElement` e passando `#btn-multiple-cards`.
...
Você deve acessar o `multipleCard` usando o método `getElement` e passando `.multiple_card`.
...
Você deve acessar o `title` usando o método `getElement` e passando `.title`.
...
Você deve acessar o `newReadingBtn` usando o método `getElement` e passando `.btn_reveal`.
...
Você deve acessar o `fortuneContainer` usando o método `getElement` e passando `.fortune_container`.
...
Você deve acessar o `fortuneDescription` usando o método `getElement` e passando `.fortune_description`.
...
Você deve acessar o `headerTitle` usando o método `getElement` e passando `.header_title`.
...
Você deve acessar o `subTitle` usando o método `getElement` e passando `.sub_title`.
...
Você deve acessar o `cardTitle` usando o método `getElement` e passando `.desc_title`.
...
Você deve acessar o `description` usando o método `getElement` e passando `.description`.
...
Você deve acessar o `text` usando o método `getElement` e passando `.text`.
