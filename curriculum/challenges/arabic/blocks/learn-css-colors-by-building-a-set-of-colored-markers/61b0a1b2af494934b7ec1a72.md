...
رائع. علامة التحديد الحمراء تبدو جيدة. الآن كل ما عليك فعله هو إضافة الأغطية والأكمام إلى علامات التحديد الأخرى.

أضف غطاءً وكمًا لكل من علامتي التحديد الخضراء والزرقاء. يمكنك فقط نسخ عناصر `div` من علامة التحديد الحمراء ولصقها في العلامتين الأخريين.

# --hints--

يجب أن يحتوي عنصر `div` الخاص بعلامة التحديد الخضراء على عنصرين `div`.
...
يجب أن يكون عنصر `div` الخاص بغطاء علامة التحديد الخضراء قبل عنصر `div` الخاص بالكم.
...
يجب أن يحتوي عنصر `div` الخاص بعلامة التحديد الزرقاء على عنصرين `div`.
...
يجب أن يكون عنصر `div` الخاص بغطاء علامة التحديد الزرقاء قبل عنصر `div` الخاص بالكم.
