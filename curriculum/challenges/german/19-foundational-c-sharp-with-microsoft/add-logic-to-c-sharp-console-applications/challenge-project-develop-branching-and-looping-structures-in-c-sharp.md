...
title: 'Challenge Project - Entwicklung von Verzweigungs- und Schleifenstrukturen in C#'
challengeType: 19
...
Ein Entwickler muss eine Iterations-Anweisung erstellen. Unter welcher Bedingung ist eine `while`-Anweisung eine bessere Wahl als eine `do`-Anweisung?

## --answers--

Wenn die Ausdruckswerte, die von der Iterations-Anweisung ausgewertet werden, vor dem Iterationscode Block unbekannt sind.

---

Wenn die von der Iterationsanweisung ausgewerteten Ausdruckswerte vor dem Iterationscodeblock bekannt sind.

---

Wenn der Entwickler geschachtelte `do`- oder `while`-Schleifen erstellt.
