...
У вас є список списків рядків. Об’єднайте внутрішні списки, щоб отримати список рядків.
...
`create_trajectory()` має обчислювати правильний вихід для різних випадків.
