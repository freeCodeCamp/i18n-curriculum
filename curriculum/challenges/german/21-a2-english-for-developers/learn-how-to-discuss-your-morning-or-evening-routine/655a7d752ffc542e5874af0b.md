...
`Could you pass me that tool, please?` (höfliche Anfrage) `When I first learned programming, I could spend hours debugging without getting tired` (vergangene Fähigkeit)
...
Während `could` für höfliche Anfragen verwendet wird, macht Jake in diesem Kontext keine Anfrage, aber er disskutiert potentielle Ideen.
...
Er bittet sie, einige mögliche Ideen vorzuschlagen
