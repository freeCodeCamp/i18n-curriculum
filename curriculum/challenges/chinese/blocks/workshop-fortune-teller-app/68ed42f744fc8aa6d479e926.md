...
现在为私有 `elements` 对象添加剩余的属性。它们是：`multipleCard`、`title`、`newReadingBtn`、`fortuneContainer`、`fortuneDescription`、`headerTitle`、`subTitle`、`cardTitle`、`description` 和 `text`。确保每个属性都使用 `HTMLElement` 类型。

# --hints--

你应该在 `multipleCard` 属性内有 `elements` 属性，并赋值为 `HTMLElement` 类型。
...
你应该在 `title` 属性内有 `elements` 属性，并赋值为 `HTMLElement` 类型。
...
你应该在 `newReadingBtn` 属性内有 `elements` 属性，并赋值为 `HTMLElement` 类型。
...
你应该在 `fortuneContainer` 属性内有 `elements` 属性，并赋值为 `HTMLElement` 类型。
...
你应该在 `fortuneDescription` 属性内有 `elements` 属性，并赋值为 `HTMLElement` 类型。
...
你应该在 `headerTitle` 属性内有 `elements` 属性，并赋值为 `HTMLElement` 类型。
...
你应该在 `subTitle` 属性内有 `elements` 属性，并赋值为 `HTMLElement` 类型。
...
你应该在 `cardTitle` 属性内有 `elements` 属性，并赋值为 `HTMLElement` 类型。
...
你应该在 `description` 属性内有 `elements` 属性，并赋值为 `HTMLElement` 类型。
...
你应该在 `text` 属性内有 `elements` 属性，并赋值为 `HTMLElement` 类型。
