...
Los ajustes predeterminados de CSS Grid crearán filas adicionales según sea necesario, a diferencia de Flexbox. Asigna al selector `.social-icons` una propiedad `grid-template-columns` establecida en `repeat(5, 1fr)` para organizar los íconos en una sola fila.

# --hints--

Tu selector `.social-icons` debe tener una propiedad `grid-template-columns` establecida en `repeat(5, 1fr)`.
