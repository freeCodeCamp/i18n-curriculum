...
폰트 크기를 사용해 제목, 부제목, 단락 및 기타 요소의 시각적 계층 구조를 만들 수 있습니다.
...
예를 들어, 웹페이지의 메인 제목은 더 큰 폰트를 사용하고, 그 다음 부제목은 더 작은 폰트 크기를 사용하는 식입니다. 이렇게 하면 계층 구조 내 각 요소에 특정 폰트 크기가 부여되어 사용자가 시각적으로 구조를 쉽게 탐색할 수 있습니다.
...
이 두세 개의 폰트를 선택한 후에는 다양한 페이지와 요소에서 일관되게 사용하세요. 이 폰트들은 웹 애플리케이션, 제품, 서비스의 전체 디자인과 일치해야 합니다.
...
폰트 크기를 조절할 수 있는 옵션을 제공하고 가능한 한 복잡한 폰트는 피해야 합니다. 일반적으로 가능한 한 단순한 폰트를 사용하는 것이 좋습니다. 콘텐츠가 읽기 쉬우면 사용자가 더 많이 참여할 가능성이 높아집니다.
...
타이포그래피 작업의 마지막 팁은 다양한 화면 크기와 기기에서 폰트가 올바르게 표시되는지 확인하는 것입니다.
