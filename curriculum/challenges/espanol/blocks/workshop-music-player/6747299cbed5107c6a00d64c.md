...
En lecciones anteriores, aprendiste sobre la <dfn>Web Audio API</dfn> y cómo usarla para reproducir canciones. Todos los navegadores modernos soportan la Web Audio API, que te permite generar y procesar audio en aplicaciones web.
