...
Il testo è di nuovo centrato, quindi il collegamento al file CSS funziona. Aggiungi un altro stile al file che cambi la proprietà `background-color` in `brown` per l'elemento `body`.
...
Il tuo elemento `body` dovrebbe avere uno sfondo `brown`.
