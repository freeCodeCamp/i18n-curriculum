...
Finalmente, para remover as bordas afiadas do elemento externo `div`, adicione a classe `rounded-md`.

# --hints--

Seu elemento externo `div` deve ter a classe utilitária `rounded-md`.
