...
対象のノードを反復して、それぞれの結果を表示してください。

`for...of` ループを追加し、`targets` をループ変数として使いながら `nodeNo` を反復してください。今はループの中身は空のままにしてください。

# --hints--

`for...of` という変数を使い、`nodeNo` を反復する `targets` ループを作成してください。
