...
title: "¿Qué es la API de Geolocalización y cómo funciona el método getCurrentPosition?"
challengeType: 19
...
El objeto position contiene varias propiedades, donde las más comúnmente usadas son `latitude` y `longitude`, pero también puede incluir `altitude`, `accuracy`, `speed`, `heading`, y así sucesivamente.

Una consideración importante al usar geolocalización es la privacidad del usuario. Asegúrate de explicar a tus usuarios por qué necesitas sus datos de ubicación y cómo los usarás.
