...
بالنظر إلى سلسلة نصية لاسم لون في CSS، أنشئ شفرة لون سداسية عشرية (hex) عشوائية تكون السمة الغالبة فيها هي اللون المعطى.
...
يجب أن تُرجع الدالة `generate_hex("yellow")` القيمة `"Invalid color"`.
...
يجب أن تُرجع الدالة `generate_hex("red")` سلسلة نصية مكونة من ستة أحرف.
...
يجب أن تُرجع الدالة `generate_hex("red")` شفرة لون سداسية عشرية صحيحة مكونة من ستة أحرف.
...
يجب أن تُرجع الدالة `generate_hex("red")` شفرة لون سداسية عشرية صحيحة تكون قيمة اللون الأحمر فيها أعلى من بقية الألوان.
...
يجب أن تُرجع استدعاء الدالة `generate_hex("red")` مرتين قيمتين مختلفتين للون السداسي حيث يكون اللون الأحمر هو السائد.
...
يجب أن تُرجع استدعاء الدالة `generate_hex("green")` مرتين قيمتين مختلفتين للون السداسي حيث يكون اللون الأخضر هو السائد.
...
يجب أن تُرجع استدعاء الدالة `generate_hex("blue")` مرتين قيمتين مختلفتين للون السداسي حيث يكون اللون الأزرق هو السائد.
