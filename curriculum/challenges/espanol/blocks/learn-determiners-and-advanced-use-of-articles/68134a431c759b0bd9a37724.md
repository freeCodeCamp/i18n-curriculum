...
¿Qué podría decir Alice para expresar su emoción?
...
Acaban de acordar que tienen pocos testers.
...
Bob está tratando de resolver el problema de no tener suficientes testers trayendo un par de personas más.

Decir `That would be great!` muestra que Alice apoya y está de acuerdo con su plan.
