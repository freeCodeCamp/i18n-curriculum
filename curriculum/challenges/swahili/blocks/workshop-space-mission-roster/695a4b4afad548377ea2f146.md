...
Tumia mzunguko wa `for` kurekodi `name` ya kila mwanadamu wa anga katika safu ya data ya `sorted`.

# --hints--

Unapaswa kutumia mzunguko wa `for` kupita kupitia safu ya data ya `sorted` na kurekodi `name` ya kila mwanadamu wa anga.
