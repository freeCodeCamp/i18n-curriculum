...
`That's great` is a common phrase used to respond positively to good news. It shows approval, excitement, or satisfaction with what was just said. Zum Beispiel:

- **Manager:** `We reached our sales goal this month.` - This person says the company could sell what they expect for the period.

- **Client:** `That's great!` - This shows the speaker is happy and supportive of the achievement.
