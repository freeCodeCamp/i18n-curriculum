...
É hora de testar o sistema completo de desconto! Adicione uma declaração `if` verificando se `__name__ == '__main__'` e mova `product = Product('Wireless Mouse', 50.0)` para dentro dela.
