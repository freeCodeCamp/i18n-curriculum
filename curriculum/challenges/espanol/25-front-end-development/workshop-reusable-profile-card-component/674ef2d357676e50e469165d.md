...
Una vez más, use el componente `Card` dos veces más con lo siguiente:

| Propiedades | Valores del Primer Card                                                               | Valores del Segundo Card                                                                    |
| ----------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| `name`      | `"Tiffany"`                                                                           | `"Doug"`                                                                                    |
...
Con eso, ¡tu proyecto de componente de tarjeta de perfil reutilizable está completo!

# --hints--

No deberías modificar el componente `Card` existente en tu componente `App`.
...
Debes usar el componente `Card` como un elemento con las propiedades apropiadas y los valores del primer card.
...
Debes usar el componente `Card` como un elemento con las propiedades apropiadas y los valores del segundo card.
