...
الآن، داخل النص الحرفي للقالب في الدالة `renderCard`، أنشئ عنصر `div`. داخل عنصر الـ `div`، أضف عنصر `h2` يعرض `drawingType`، وعنصر `figure` بالصنف `card_container ${isReversed ? "reversed-card" : ""}` والخاصية `data-id="${shortName}"`.

# --hints--

يجب أن يكون لديك عنصر `div` داخل النص الحرفي للقالب في الدالة `renderCard`.
...
يجب أن يكون لديك عنصر `h2` يدمج `drawingType` داخل عنصر الـ `div`.
...
يجب أن يكون لديك عنصر `figure` داخل عنصر الـ `div`.
...
يجب أن يحتوي عنصر `figure` على الصنف `card_container` وأن يستخدم ثلاثي لإضافة `reversed-card` بشكل شرطي.
...
يجب أن يحتوي عنصر `figure` على خاصية `data-id` مضبوطة على `${shortName}`.
