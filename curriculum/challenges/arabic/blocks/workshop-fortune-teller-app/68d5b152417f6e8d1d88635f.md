...
هناك المزيد من الخصائص لإضافتها إلى واجهة `Card`. ابدأ بتعيين `value_int` إلى النوع `number`. يجب أن تكون كل الخصائص الأخرى من النوع `string`: `suit`، `type`، `img`، `meaning_up`، `meaning_rev`، و`desc`.

# --hints--

يجب أن تحتوي على خاصية `value_int` بنوع `number`.
...
يجب أن تحتوي على خاصية `suit` بنوع `string`.
...
يجب أن تحتوي على خاصية `type` بنوع `string`.
...
يجب أن تحتوي على خاصية `img` بنوع `string`.
...
يجب أن تحتوي على خاصية `meaning_up` بنوع `string`.
...
يجب أن تحتوي على خاصية `meaning_rev` بنوع `string`.
...
يجب أن تحتوي على خاصية `desc` بنوع `string`.
