...
title: 'Zoezi la 45: Nambari za pembetatu, pentagonal, na hexagonal'
challengeType: 1
forumTopicId: 302122
...
Nambari za pembetatu, pentagonal, na hexagonal huzalishwa kwa kutumia fomula zifuatazo:
...
Inaweza kuthibitishwa kuwa T<sub>285</sub> = P<sub>165</sub> = H<sub>143</sub> = 40755.

Tafuta nambari inayofuata ya pembetatu ambayo pia ni pentagonal na hexagonal.

# --hints--

`triPentaHexa(40756)` inapaswa kurudisha nambari.

```js
assert(typeof triPentaHexa(40756) === 'number');
```

`triPentaHexa(40756)` inapaswa kurudisha 1533776805.
