...
في وظيفة `linear-gradient`، عيّن `gradientDirection` إلى `180deg`.

# --hints--

يجب أن تحتوي قاعدة CSS مسمى `.red` على خاصية `background` بقيمة `linear-gradient(180deg, rgb(255, 0, 0) 75%, rgb(0, 255, 0), rgb(0, 0, 255))`.
