...
Тепер, коли у вас є регулярний вираз для відповідності множенню або діленню, ви можете обчислити цей вираз.

Оголосіть змінну `str2` та присвоїте до неї результат виклику `infixEval` з аргументами `str` та `regex`.
...
Передайте `regex` як другий аргумент до виклику `infixEval`.
