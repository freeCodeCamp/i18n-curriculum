...
Um etwas mehr Platz um die Speisekarte herum zu schaffen, füge `20px` innerhalb des `body`-Elements hinzu, indem du die `padding`-Eigenschaft verwendest.
...
Dein `body`-Element sollte ein `padding` von `20px` haben.
