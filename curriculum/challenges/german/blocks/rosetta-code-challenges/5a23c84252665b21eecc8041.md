...
Berechnen Sie den **n**<sup>ten</sup> Term einer <em>Reihe</em>, also die Summe der ersten **n** Terme der entsprechenden <em>Folge</em>. Umgangssprachlich wird dieser Wert oder sein Grenzwert, wenn **n** gegen unendlich strebt, auch als *Summe der Reihe* bezeichnet, daher der Titel dieser Aufgabe. Für diese Aufgabe verwenden Sie: $S_n = \displaystyle\sum_{k=1}^n \frac{1}{k^2}$.

# --instructions--

Schreiben Sie eine Funktion, die $a$ und $b$ als Parameter nimmt und die Summe der $a^{ten}$ bis $b^{ten}$ Glieder der Folge zurückgibt.
