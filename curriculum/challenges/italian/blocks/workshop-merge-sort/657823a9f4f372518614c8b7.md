...
Sempre all'interno del blocco `else`, incrementa `right_array_index` di `1`.

# --hints--

Dovresti aggiungere `1` al valore corrente di `right_array_index` dopo aver inserito l'elemento nell'array ordinato.
