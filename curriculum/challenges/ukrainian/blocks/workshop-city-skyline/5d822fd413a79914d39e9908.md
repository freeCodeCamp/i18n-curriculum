...
Видаліть властивість і значення `background-color` з `.bb4` і додайте їх до трьох нових розділів `.bb4a`, `.bb4b` і `.bb4c`, щоб заповнені були лише розділи.

# --hints--

Ви повинні видалити `background-color` з `.bb4`.
