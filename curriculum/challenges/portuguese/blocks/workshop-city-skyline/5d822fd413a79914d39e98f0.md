...
Em um módulo anterior você aprendeu que gradientes em CSS são uma forma de transição entre cores ao longo da distância de um elemento.Eles são aplicados à propriedade `background` e a sintaxe tem essa aparência:
