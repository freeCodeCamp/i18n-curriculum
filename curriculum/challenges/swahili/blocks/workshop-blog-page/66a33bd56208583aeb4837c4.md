...
Ndani ya kipengele cha `footer`, ongeza kipengele cha `section` chenye `id` iliyowekwa kuwa `contact`.

Ndani ya kipengele cha `section`, ongeza kipengele cha `h2` chenye maandishi ya `Contact`.

# --hints--

Unapaswa kuwa na kipengele cha `section` ndani ya kipengele chako cha `footer`.
...
Kipengele chako cha `section` kinapaswa kuwa na `id` iliyowekwa kuwa `"contact"`.
...
Unapaswa kuwa na kipengele cha `h2` ndani ya kipengele chako cha `section`.
...
Kipengele chako cha `h2` kinapaswa kuwa na maandishi ya `Contact`.
