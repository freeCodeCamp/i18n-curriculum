...
Verwenden Sie die gleiche Logik, um eine `if`-Anweisung zu erstellen, die ausgeführt wird, wenn die `series`-Liste nicht leer ist. Fügen Sie darin den String `=== TV SERIES ===` (endet mit einem Zeilenumbruch) an den aktuellen Wert von `result` an.

Erstellen Sie dann eine `for`-Schleife, die Enumeration verwendet, um die Elemente der `series`-Liste zur `result`-Variable hinzuzufügen. Beginnen Sie wie zuvor mit der Indexierung der Werte ab `1`.

Damit ist der Media-Katalog-Workshop abgeschlossen.

# --hints--

Sie sollten eine zweite `if`-Anweisung in Ihrer `__str__`-Methode haben.
...
Sie sollten `result += '=== TV SERIES ===\n'` innerhalb Ihrer zweiten `if`-Anweisung haben.
...
Sie sollten eine `for`-Schleife in Ihrer zweiten `if`-Anweisung haben.
...
Wenn `self.items` `TVSeries("Game of Thrones", 2011, "David Benioff & D.B. Weiss", 57, 8, 73)` und `TVSeries("Stranger Things", 2016, "The Duffer Brothers", 50, 4, 34)` enthält, sollte Ihre `__str__`-Methode `Media Catalogue (2 items):\n\n=== TV SERIES ===\n1. Game of Thrones (2011) - 8 seasons, 73 episodes, 57 min avg, David Benioff & D.B. Weiss\n2. Stranger Things (2016) - 4 seasons, 34 episodes, 50 min avg, The Duffer Brothers\n` zurückgeben.
...
Wenn `self.items` `Movie('Barry Lyndon', 1975, 'Stanley Kubrick', 184)`, `Movie('Fahrenheit 451', 1966, 'Francois Truffaut', 112)`, `TVSeries("Game of Thrones", 2011, "David Benioff & D.B. Weiss", 57, 8, 73)` und `TVSeries("Stranger Things", 2016, "The Duffer Brothers", 50, 4, 34)` enthält, sollte Ihre `__str__`-Methode `Media Catalogue (4 items):\n\n=== MOVIES ===\n1. Barry Lyndon (1975) - 184 min, Stanley Kubrick\n2. Fahrenheit 451 (1966) - 112 min, Francois Truffaut\n=== TV SERIES ===\n1. Game of Thrones (2011) - 8 seasons, 73 episodes, 57 min avg, David Benioff & D.B. Weiss\n2. Stranger Things (2016) - 4 seasons, 34 episodes, 50 min avg, The Duffer Brothers\n` zurückgeben.
