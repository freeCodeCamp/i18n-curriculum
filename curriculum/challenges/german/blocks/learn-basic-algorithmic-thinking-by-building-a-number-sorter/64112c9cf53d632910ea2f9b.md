...
Nach Ihrer while-Schleife müssen Sie Ihren aktuellen Wert einfügen. Denken Sie daran, dass Ihre Schleife endet, wenn `j` entweder außerhalb der Array-Grenzen liegt oder wenn der Wert an `j` kleiner als Ihr aktueller Wert ist.

Verwenden Sie den Zuweisungsoperator, um Ihren aktuellen Wert an der richtigen Stelle im Index einzufügen.

# --hints--

Sie sollten `currValue` dem Index `j + 1` zuweisen.
