...
今、テキストが読めません。`footer` とその中のアンカー要素を対象に、十分なコントラスト比のあるフォントカラーを設定してください。

# --hints--

`footer, footer a` セレクターを使うべきです。
...
`color` を少なくとも `7:1` のコントラスト比を持つ値に設定してください。_ヒント: `#dfdfe2` をお勧めします_
