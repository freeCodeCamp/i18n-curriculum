...
给定非负整数 `m` 和 `n`，按排序顺序生成从 `0`（零）到 `n-1` 的整数的所有大小为 `m` 的组合（每个组合都是有序的，整个表也是有序的）。
...
`combinations(4, 6)` 应该返回 `[[0,1,2,3], [0,1,2,4], [0,1,2,5], [0,1,3,4], [0,1,3,5], [0,1,4,5], [0,2,3,4], [0,2,3,5], [0,2,4,5], [0,3,4,5], [1,2,3,4], [1,2,3,5], [1,2,4,5], [1,3,4,5], [2,3,4,5]]`
