...
Sifa ya `border-radius` inakubali hadi thamani nne za kuzungusha pembe za juu-kushoto, juu-kulia, chini-kulia, na chini-kushoto.

Zungusha pembe ya juu-kushoto ya `.three` kwa pikseli 30, ya juu-kulia kwa pikseli 25, ya chini-kulia kwa pikseli 60, na ya chini-kushoto kwa pikseli 12.

# --hints--

Unapaswa kuweka sifa ya `border-radius` kuwa `30px 25px 60px 12px`.
