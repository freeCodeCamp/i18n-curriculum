...
Тепер оголосіть змінну `length` і призначте їй довжину вашого відсортованого масиву, а також змінну `middle`, яка має значення довжини, поділеної на `2`, з відніманням `1`.

# --hints--

Ви повинні оголосити змінну `length` після вашої змінної `sorted`.
...
Ви повинні використати `const` для оголошення вашої змінної `length`.
...
Ви повинні призначити довжину масиву `sorted` вашій змінній `length`.
...
Ви повинні оголосити змінну `middle` після вашої змінної `length`.
...
Ви повинні використати `const` для оголошення вашої змінної `middle`.
...
Ви повинні призначити `middle` значення ділення вашої змінної `length` на `2`.
...
Ви повинні відняти `1` від вашого обчислення `length / 2`.
