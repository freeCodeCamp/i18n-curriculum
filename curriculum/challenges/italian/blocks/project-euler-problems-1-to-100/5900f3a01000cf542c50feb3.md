...
Si può osservare che il numero 125874 e il suo doppio 251748 contengono esattamente le stesse cifre, ma in un ordine diverso.

Trova il più piccolo numero intero positivo che, moltiplicato per i numeri interi $\\{2, 3, \ldots, n\\}$, contenga le stesse cifre.
