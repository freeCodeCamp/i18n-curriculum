...
Нехай $f(n)$ — найбільше додатне ціле число $x$, менше за ${10}^9$, таке, що останні 9 цифр числа $n^x$ утворюють число $x$ (включно з провідними нулями), або нуль, якщо такого цілого числа не існує.
...
`powersWithTrailingDigits()` має повертати `450186511399999`.
