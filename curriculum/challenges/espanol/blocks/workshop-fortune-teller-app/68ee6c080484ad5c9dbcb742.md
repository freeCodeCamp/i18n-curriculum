...
Ahora comenzarás a crear los métodos.

Crea un método llamado `singleCardSelected`. Dentro de él, llama a la función `hideElements` y pasa las siguientes propiedades: `singleCardBtn`, `multipleCardsBtn`, `multipleCard`, `text` y `headerTitle`.

Recuerda que debes acceder a todas ellas usando `this.elements`.

# --hints--

Debes definir un método llamado `singleCardSelected`.
...
Dentro de `singleCardSelected`, debes llamar a la función `hideElements`.
...
Debes pasar `singleCardBtn` a la función `hideElements`.
...
Debes pasar `multipleCardsBtn` a la función `hideElements`.
...
Debes pasar `multipleCard` a la función `hideElements`.
...
Debes pasar `text` a la función `hideElements`.
...
Debes pasar `headerTitle` a la función `hideElements`.
