...
O próximo cartão de preços é o **Plano Premium**.

Dê ao wrapper `div` do plano premium as classes `bg-gray-950`, `text-white`, `ring-2`, `ring-fuchsia-500` e `p-8`.

# --hints--

Seu elemento wrapper `div` para o plano premium deve ter a classe `bg-gray-950`.
...
Seu elemento wrapper `div` para o plano premium deve ter a classe `text-white`.
...
Seu elemento wrapper `div` para o plano premium deve ter a classe `ring-2`.
...
Seu elemento wrapper `div` para o plano premium deve ter a classe `ring-fuchsia-500`.
...
Seu elemento wrapper `div` para o plano premium deve ter a classe `p-8`.
