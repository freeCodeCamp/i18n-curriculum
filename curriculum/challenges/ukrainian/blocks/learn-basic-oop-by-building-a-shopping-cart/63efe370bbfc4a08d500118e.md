...
У функції зворотного виклику `forEach` обгорніть праву частину присвоєння `totalCountPerProduct[dessert.id] || 0` у круглі дужки `()`, щоб забезпечити правильну оцінку, а потім збільшіть значення на одиницю.
...
Ви повинні використовувати оператор присвоєння, щоб оновити значення властивості об’єкта `totalCountPerProduct`, яка відповідає `dessert.id`.
