...
Kichwa cha kadi kimekamilika. Sasa unahitaji kuongeza sehemu ya picha ya mchezaji.

Baada ya kufunga `div` ya `card-header` na bado ndani ya `div` yenye `className` ya `card`, ongeza `div` yenye `className` ya `card-image-wrap`. Acha iwe tupu kwa sasa. Utaiweka picha katika hatua inayofuata.

# --hints--

Unapaswa kuongeza `div` yenye `className` ya `card-image-wrap`.
