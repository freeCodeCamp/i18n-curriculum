...
Це скорочення від `I will`. Софі дає обіцянку або планує дотримуватися цих кроків.
...
Це стосується конкретних речей, у цьому випадку — кроків, згаданих раніше в розмові.
...
Використовується для окремих елементів. Софі планує дотримуватися кроків для кожної функції по черзі.
