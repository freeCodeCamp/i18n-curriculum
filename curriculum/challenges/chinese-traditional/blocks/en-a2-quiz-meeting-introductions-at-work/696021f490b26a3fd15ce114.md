...
聆聽音訊。什麼時候適合這麼說？<!-- (quiz audio) James: Can you briefly introduce yourself? -->
...
`To develop` 意味著製作或創建某些新的東西。

---

`To contribute` 意味著給予或將某物添加到一個專案。

---

`To collaborate` 意思是與他人一起合作。

#### --answer--

`To coordinate` 意思是為某人提供幫助或協助。
...
`BLANK a meeting room available?` 有會議室可用嗎？
...
聆聽音訊。什麼時候適合這麼說？<!-- (quiz audio) James: Let's get started. -->
