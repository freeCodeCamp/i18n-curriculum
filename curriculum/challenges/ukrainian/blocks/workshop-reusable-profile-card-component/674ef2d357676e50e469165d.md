...
Знову використайте компонент `Card` двічі з такими параметрами:

| Пропси  | Значення першої картки | Значення другої картки |
|-------|------------------------------------------------------------|-----------------------------------------------------|
| `name`  | `"Tiffany"` | `"Doug"`|
...
Ви не повинні змінювати існуючий компонент `Card` у вашому компоненті `App`.
...
Використайте компонент `Card` як елемент з відповідними пропсами та значеннями першої картки.
...
Використайте компонент `Card` як елемент з відповідними пропсами та значеннями другої картки.
