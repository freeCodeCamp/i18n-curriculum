...
Cuando el contenedor cambia de tamaño, esta estructura sigue insertando columnas de 60px y estirándolas hasta que puede insertar otra más. **Nota:** Si el contenedor no puede acomodar todos tus elementos en una fila, los moverá a una nueva.
