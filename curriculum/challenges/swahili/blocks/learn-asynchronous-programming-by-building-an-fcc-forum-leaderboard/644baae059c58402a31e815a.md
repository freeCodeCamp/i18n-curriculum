...
Ikiwa `id` haipo katika kitu cha `allCategories`, utahitaji kuonyesha kategoria ya `General`.

Chini ya usemi wako wa `if`, ongeza kifungu cha `else`.

# --hints--

Unapaswa kuwa na kifungu cha `else` chini ya usemi wako wa `if`.
