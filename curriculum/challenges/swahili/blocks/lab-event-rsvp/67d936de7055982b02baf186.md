...
1. Unapaswa kuunda fomu yenye sehemu za jina, barua pepe, idadi ya washiriki, mapendeleo ya chakula, na chaguo la kuonyesha kama unaleta wageni wa ziada.

2. Unapaswa kuwa na sehemu ya ingizo la maandishi ambapo utaingiza jina lako (lazima).

3. Unapaswa kuwa na sehemu ya ingizo la barua pepe ambapo utaingiza anwani yako ya barua pepe (lazima). Fomu inapaswa kuthibitisha muundo ili kuhakikisha ni barua pepe halali.

4. Unapaswa kuwa na sehemu ya ingizo la nambari ambapo utaingiza idadi ya washiriki katika fomu (lazima), na nambari isizidi kuwa chini ya moja.

5. Unapaswa kuwa na sehemu ya ingizo la maandishi ambapo utaingiza mapendeleo yako ya chakula, na taarifa hii ni hiari.

6. Unapaswa kuweza kuchagua au kuondoa alama kwenye kisanduku cha kuchagua kuonyesha kama unaleta wageni wa ziada.

7. Unapaswa kuwa na kitufe kinachowasilisha fomu, na fomu haipaswi kusababisha ukurasa kupakia upya baada ya uwasilishaji.

8. Unapaswa kuona ujumbe wa uthibitisho unaoonyeshwa chini ya fomu baada ya kuwasilisha, ukifuatiwa na maelezo yaliyotolewa (jina, barua pepe, idadi ya washiriki, mapendeleo ya chakula, na wageni wa ziada wa hiari).

Huu ni mfano wa ujumbe baada ya kuwasilisha fomu:
...
Unapaswa kuwa na kipengele kimoja cha `form` kushikilia maudhui yote ya fomu yako.
...
Unapaswa kuwa na vipengele viwili vya `input` vya aina ya `text`.
...
Unapaswa kuwa na kipengele kimoja cha `input` cha aina ya `email`.
...
Unapaswa kuwa na kipengele kimoja cha `input` cha aina ya `number`.
...
Unapaswa kuwa na kipengele kimoja cha `input` cha aina ya `checkbox`.
...
Kipengele kimoja cha `input[type="text"]` kinapaswa kuwa lazima.
...
Kipengele cha `input[type="email"]` kinapaswa kuwa lazima.
...
Kipengele cha `input[type="number"]` kinapaswa kuwa lazima.
...
Kipengele cha `input[type="number"]` hakipaswi kuruhusu thamani chini ya 1.
...
Kubadilisha thamani ya vipengele vya `input[type="text"]` kunapaswa kusasisha hali ya sehemu.
...
Kubadilisha thamani ya vipengele vya `input[type="email"]` kunapaswa kusasisha hali ya sehemu.
...
Kubadilisha thamani ya vipengele vya `input[type="number"]` kunapaswa kusasisha hali ya sehemu.
...
Kubadilisha thamani ya vipengele vya `input[type="checkbox"]` kunapaswa kusasisha hali ya sehemu.
...
Kuwasilisha fomu hakipaswi kusababisha ukurasa kupakia upya.
...
Baada ya uwasilishaji, kunapaswa kuwepo kipengele kwenye ukurasa kinachoonyesha hali ya jina la `input`.
...
Baada ya uwasilishaji, kunapaswa kuwepo kipengele kwenye ukurasa kinachoonyesha hali ya barua pepe ya `input`.
...
Baada ya uwasilishaji, kunapaswa kuwepo kipengele kwenye ukurasa kinachoonyesha hali ya idadi ya washiriki ya `input`.
...
Baada ya uwasilishaji, kunapaswa kuwepo kipengele kwenye ukurasa kinachoonyesha hali ya mapendeleo ya chakula ya `input`.
...
Baada ya uwasilishaji, kunapaswa kuwepo kipengele kwenye ukurasa kinachoonyesha hali ya wageni wa ziada ya `input`.
