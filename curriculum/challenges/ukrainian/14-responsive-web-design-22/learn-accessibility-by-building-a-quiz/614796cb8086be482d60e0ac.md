...
Щодо візуальної контрастності: контраст між елементами є ключовим фактором. Наприклад, контраст між текстом та фоном заголовка має бути принаймні 4.5:1.

Змініть колір шрифту всіх елементів посилання в межах елементів списку на щось з коефіцієнтом контрастності зі співвідношенням не менше 7:1.

# --hints--

Селектор має націлюватися на посилання всередині елементів списку.
...
Надайте елементам `a` всередині елементів списку властивість `color`.
...
Змініть лише колір елементів `a` всередині елементів списку.
