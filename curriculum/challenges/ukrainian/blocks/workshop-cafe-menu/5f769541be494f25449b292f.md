...
Використовуючи ваш новий селектор класу `flavor`, встановіть значення властивості `text-align` у `left`.

# --hints--

У вас має бути селектор класу `flavor`.
...
Ви повинні встановити властивість `text-align` у `left`.
...
Ваш селектор класу `flavor` має встановити властивість `text-align` у `left`.
