...
Em programação, `null` é usado para representar a ausência de um valor.Nesse caso, se o usuário inserir uma entrada inválida, você deve alertá-lo e então retornar `null` para indicar que a função falhou.
