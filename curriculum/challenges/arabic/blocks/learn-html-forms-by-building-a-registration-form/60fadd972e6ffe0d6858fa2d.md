...
اختر كل عناصر `input` و `textarea` و `select`، واجعلها تشغل العرض الكامل لعناصرها الأصلية.

أضف أيضًا `10px` من الـ `margin` إلى أعلى العناصر المختارة. اضبط الهوامش الأخرى على `0`.
