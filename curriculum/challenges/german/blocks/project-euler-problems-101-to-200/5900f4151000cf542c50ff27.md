...
title: 'Aufgabe 168: Zahlrotationen'
challengeType: 1
forumTopicId: 301802
...
Betrachten Sie die Zahl 142857. Wir können diese Zahl nach rechts rotieren, indem wir die letzte Ziffer (7) an den Anfang verschieben, was uns 714285 ergibt.

Es lässt sich überprüfen, dass $714285 = 5 × 142857$ gilt.

Dies zeigt eine ungewöhnliche Eigenschaft von 142857: Sie ist ein Teiler ihrer Rechtsrotation.

Für ganze Zahlen $a$ und $b$ finden Sie die letzten 5 Ziffern der Summe aller ganzen Zahlen $n$, für die $10^a < n < 10^b$ gilt und die diese Eigenschaft besitzen.

# --hints--

`numberRotations(2, 10)` sollte `98311` zurückgeben.

```js
assert.strictEqual(numberRotations(2, 10), 98311);
```

`numberRotations(2, 100)` sollte `59206` zurückgeben.
