...
Ongeza vitu viwili vingine kwenye `instrumentsArr` yako ili wakilishe ala za mbao zilizobaki, klarineti na oboe.

# --hints--

Unapaswa kuwa na `{ category: "woodwinds", instrument: "Clarinet", price: 200 }` ndani ya `instrumentsArr` yako.

```js
assert.deepInclude(instrumentsArr, { category: "woodwinds", instrument: "Clarinet", price: 200 });
```

Unapaswa kuwa na `{ category: "woodwinds", instrument: "Oboe", price: 4000 }` ndani ya `instrumentsArr` yako.

```js
assert.deepInclude(instrumentsArr, { category: "woodwinds", instrument: "Oboe", price: 4000 });
```

Bado unapaswa kuwa na `{ category: "woodwinds", instrument: "Flute", price: 500 }` ndani ya `instrumentsArr` yako.
