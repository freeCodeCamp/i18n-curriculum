...
É a hora de implementar outro algoritmo de ordenação.Desta vez, você implementará uma <dfn>ordenação de seleção</dfn>.A ordenação de seleção (em inglês, Selection Sort) funciona a partir da seleção do valor mínimo de um array, trocando-o de posição posteriormente com o primeiro valor na lista.Em seguida, a ordenação encontra o próximo valor menor e o troca pelo segundo valor do array.Ela seguirá percorrendo o array até que ele esteja completamente ordenado.
