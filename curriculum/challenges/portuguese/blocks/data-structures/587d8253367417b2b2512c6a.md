...
Você também pode criar um <dfn>buffer</dfn> para atribuir a quantidade de dados (em bytes) que deseja que o array ocupe. **Nota**Para criar arrays tipados usando buffers, você precisa atribuir o número de bytes para ser um múltiplo dos bytes listados acima.
