...
Kadi inayofuata ya bei ni **Mpango wa Premium**.

Toa darasa la vitu `div`, `bg-gray-950`, `text-white`, `ring-2`, na `ring-fuchsia-500` kwa kifungashio `p-8` cha mpango wa premium.

# --hints--

Kifungashio chako `div` cha mpango wa premium kinapaswa kuwa na darasa la vitu `bg-gray-950`.
...
Kifungashio chako `div` cha mpango wa premium kinapaswa kuwa na darasa la vitu `text-white`.
...
Kifungashio chako `div` cha mpango wa premium kinapaswa kuwa na darasa la vitu `ring-2`.
...
Kifungashio chako `div` cha mpango wa premium kinapaswa kuwa na darasa la vitu `ring-fuchsia-500`.
...
Kifungashio chako `div` cha mpango wa premium kinapaswa kuwa na darasa la vitu `p-8`.
