...
Para remover parte del espaciado vertical entre el elemento `h1` y el texto `Est. 2020`, cambia el margen inferior (bottom margin) del elemento `h1` a `15px`.

# --hints--

La propiedad `margin-bottom` debe tener un valor dé `15px`.
...
Tu elemento `h1` debe tener un margen inferior (`margin-bottom`) dé `15px`.
