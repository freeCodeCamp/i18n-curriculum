...
`--penguin-skin` 변수는 `penguin-top` 클래스의 `background` 속성에 할당해야 합니다.
...
`--penguin-skin` 변수는 `penguin-bottom` 클래스의 `background` 속성에 할당해야 합니다.
...
`--penguin-skin` 변수는 `right-hand` 클래스의 `background` 속성에 할당해야 합니다.
...
`--penguin-skin` 변수는 `left-hand` 클래스의 `background` 속성에 할당해야 합니다.
