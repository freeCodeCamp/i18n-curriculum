...
Come ultimo passaggio, modifica le stringhe contenute in `details_list` in modo che il testo posto dopo il segno di uguale sia allineato a destra per ogni riga. Il tuo output finale dovrebbe apparire così:
...
Con questo, il progetto è completo!
