...
Lo próximo que mostrarás son los detalles biográficos sobre el autor. Puedes hacer esto con `bio` que destrujiste anteriormente.

Agrega un elemento de párrafo con la `class` `"bio"`, luego interpola `bio` dentro del elemento del párrafo.
