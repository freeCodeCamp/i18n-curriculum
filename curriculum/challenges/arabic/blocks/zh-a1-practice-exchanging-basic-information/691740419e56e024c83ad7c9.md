...
هذه مراجعة للحوار بين وانغ هوا وليو مينغ.

# --instructions--

اكتب الكلمات التالية في المكان الصحيح:

`是的 (shì de)`، `你是 (nǐ shì)`، و`你呢 (nǐ ne)`.
...
هذه العبارة تعني "أنت" وتُستخدم قبل المهنة للسؤال عن وظيفة الشخص.
...
هذه الكلمة تعني "نعم" وتُستخدم لتأكيد الجملة. لا تنس كتابة الرقم 5 في النهاية لمقاطع النغمة المحايدة.
...
هذه العبارة تعني "وأنت؟" وتُستخدم لإعادة السؤال للطرف الآخر. لا تنس كتابة الرقم 5 في النهاية لمقاطع النغمة المحايدة.
