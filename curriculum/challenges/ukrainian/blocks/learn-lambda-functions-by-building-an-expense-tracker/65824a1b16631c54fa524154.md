...
Далі додайте ще один виклик `print()` і передайте рядок `'2. List all expenses'`.

# --hints--

Ви повинні вивести `'2. List all expenses'` у своєму циклі `while` після існуючих викликів `print()`.
