...
Clique no botão `Show Alert` para ver um alerta aparecer na tela. 
...
Interaja com o campo de email na janela de visualização fornecendo um endereço de email falso. Depois clique no botão de reset para ver seu email desaparecer do campo. 
