...
Kabla ya kuanza kuongeza kitendakazi cha kichujio kwenye ukurasa wako, unganisha faili yako ya `script.js` na HTML.

# --hints--

Unapaswa kuwa na kipengele cha `script` chenye sifa ya kipengele ya `src` iliyowekwa kuwa `script.js`.
