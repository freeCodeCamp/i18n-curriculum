...
Створіть правило `.image-1, .image-3` та надайте йому властивість `grid-column` зі значенням `1 / -1`. Це дозволить першому та третьому зображенням охопити всю ширину сітки.
