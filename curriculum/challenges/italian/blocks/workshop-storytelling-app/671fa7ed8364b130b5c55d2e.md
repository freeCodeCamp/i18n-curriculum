...
Seleziona il paragrafo `#result` e archivialo in una variabile chiamata `resultParagraph`. Userai questa variabile per mostrare la storia selezionata.

# --hints--

Dovresti selezionare il paragrafo `#result` usando il metodo `getElementById` e archiviarlo nella variabile `resultParagraph`.
