...
`測速 (cè sù)` is used when you check how fast something runs or responds. It commonly appears in situations like testing a system, a network connection, or a device.
