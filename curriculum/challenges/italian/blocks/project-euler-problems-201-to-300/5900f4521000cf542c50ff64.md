...
Allo stesso modo, troviamo che $88201 = {99}^2 + {280}^2 = {287}^2 + 2 × {54}^2 = {283}^2 + 3 × {52}^2 = {197}^2 + 7 × {84}^2$.

Nel 1747, Euler dimostrò quali numeri sono rappresentabili come somma di due quadrati. Siamo interessati ai numeri $n$ che ammettono rappresentazioni di tutti i seguenti quattro tipi:
...
dove gli $a_k$ e $b_k$ sono numeri interi positivi.

Ci sono 75373 numeri di questo tipo che non superano ${10}^7$.
