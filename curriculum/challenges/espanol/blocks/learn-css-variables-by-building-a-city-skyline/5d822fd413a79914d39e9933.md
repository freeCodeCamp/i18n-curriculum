...
Agregue otro `repeating-linear-gradient` debajo del que acaba de agregar. Dale una dirección de `90deg`, usa el color del edificio desde `0%` hasta `12%` y el color de la ventana desde `12%` hasta `44%`. Esto hará un montón de ventanas rectangulares.

# --hints--

Debe dar a `.fb5` un segundo `repeating-linear-gradient` en la propiedad `background`.
...
Debe dar al segundo `repeating-linear-gradient` una dirección de `90deg`.
...
Debe dar al segundo `repeating-linear-gradient` un primer color de `--building-color2` desde `0%` hasta `12%`.
...
Debe dar al segundo `repeating-linear-gradient` un segundo color de `--window-color2` desde `12%` hasta `44%`.
