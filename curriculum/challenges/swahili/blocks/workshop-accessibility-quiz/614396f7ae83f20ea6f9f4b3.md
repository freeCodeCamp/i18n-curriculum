...
Nakala ya `.sr-only` bado inaonekana. Kuna mtindo wa kawaida wa kuficha maandishi kwa macho ili yasomewe tu na visomaji vya skrini.

Mtindo huu ni kuweka mali zifuatazo za CSS:
...
Tumia hapo juu kufafanua sheria ya CSS ya `.sr-only`.
