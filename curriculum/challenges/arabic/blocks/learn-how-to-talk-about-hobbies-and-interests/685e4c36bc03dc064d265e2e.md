...
`with time`، `since my childhood`، `what kind of`، `a great way to`، `get into`، و`one of these days`.
...
مع مرور الوقت أو بعد فترة من الزمن.
...
تُستخدم للسؤال عن نوع أو فئة شيء ما.
...
طريقة أو فكرة جيدة جدًا لفعل شيء ما.
...
أن تبدأ بالاهتمام بشيء أو تبدأ القيام به.
...
في وقت ما في المستقبل، لكن غير محدد متى.
