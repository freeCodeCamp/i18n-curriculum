...
Вивід стає досить важко читати, тому ви повинні замінити `print(graph.create_trajectory())` на цикл, який друкує кожен рядок окремо.
...
Надрукуйте кожен рядок у `graph.create_trajectory()`.
