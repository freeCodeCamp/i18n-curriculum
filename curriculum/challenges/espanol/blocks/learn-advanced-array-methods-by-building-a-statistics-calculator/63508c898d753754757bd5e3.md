...
Por defecto, el método `.sort()` convierte los elementos de un array en cadenas, luego los ordena alfabéticamente. El método `.sort()` muta el array original. Esto funciona bien para las cadenas, pero no tan bien para los números. Por ejemplo, `10` viene antes de `2` cuando se clasifica como cadenas, pero `2` viene antes de `10` cuando se ordenan como números.
