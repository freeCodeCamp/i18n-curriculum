...
Sasa twende kwenye nambari za hamsini.

Kwa Kihispania, nambari 50 huitwa `cincuenta`.

Nambari kutoka 51 hadi 59 huundwa kwa kutumia neno la thelathini `cincuenta` (50), ikifuatiwa na kiunganishi `y` ("na"), kisha nambari ya vitengo (1-9).
...
Nambari `cincuenta y uno` (51) ni ya kipekee katika safu hii kwa sababu hubadilika kuwa `cincuenta y un` kabla ya nomino ya kiume. Kwa mfano:

`Cincuenta y un años` - Miaka hamsini na moja.
...
Nimefanya mazoezi ya kutamka nambari kutoka 50 hadi 59.
