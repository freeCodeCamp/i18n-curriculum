...
Ifuatayo, tengeneza `label` yenye `className` ya `section` na `column`, pamoja na maandishi ya `How did you get your powers?`. Ndani ya `label`, tengeneza kipengele cha `select`.
...
Kipengele chako cha `label` kinapaswa kuwa na maandishi ya `How did you get your powers?`.
...
Unapaswa kutengeneza kipengele cha `select` ndani ya kipengele chako cha `label`.
