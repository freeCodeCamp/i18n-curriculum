...
Rufen Sie jetzt Ihre `.calculateTotal()`-Methode innerhalb Ihrer `forEach`-Schleife auf.

# --hints--

Sie sollten `cart.calculateTotal()` innerhalb Ihrer `forEach`-Schleife aufrufen.
