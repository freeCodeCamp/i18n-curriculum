...
Sasa ndani ya `showElements`, pita hizi kama hoja: `singleCardBtn`, `multipleCardsBtn`, na `headerTitle`. Kumbuka unazipata kutoka kwa `elements`, na uzipate kwa kutumia neno kuu la `this`.

# --hints--

Unapaswa kupitisha `singleCardBtn` kama hoja ya kwanza kwa kitendakazi cha `showElements`.
...
Unapaswa kupitisha `multipleCardsBtn` kama hoja ya pili kwa kitendakazi cha `showElements`.
...
Unapaswa kupitisha `headerTitle` kama hoja kwa kitendakazi cha `showElements`.
