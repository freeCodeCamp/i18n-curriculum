...
title: Додайте іконки Font Awesome до кнопок
challengeType: 0
forumTopicId: 16638
required:
  - 
...
Font Awesome можна використати у будь-якому застосунку, додавши цей код зверху HTML:

```html
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.1/css/all.css" integrity="sha384-50oBUHEmvpQ+1lW4y57PTFmhCaXp0ML5d60M1M7uH2+nqUivzIebhndOJK28anvf" crossorigin="anonymous">
```

Ми вже додали цей код замість вас.

Спочатку елемент `i` використовували, щоб виділити інші елементи курсивом, але зараз його часто використовують для іконок. Класи Font Awesome можна додати до елемента `i`, щоб перетворити його на іконку. Наприклад:
...
Використайте Font Awesome, щоб додати іконку `thumbs-up` до кнопки вподобання, надавши їй елемент `i` з класами `fas` та `fa-thumbs-up`. Переконайтесь, що текст `Like` залишається біля іконки.

# --hints--

Додайте елемент `i` з класами `fas` та `fa-thumbs-up`.
...
Іконка `fa-thumbs-up` має знаходитись в межах кнопки вподобання.
...
Елемент `i` має бути вкладеним в межах елемента `button`.
...
Елемент іконки повинен мати кінцевий тег.
