...
Unapaswa kuunda kichaguzi kipya cha `25%` katika sheria yako ya `@keyframes cabins`.
...
Kichaguzi chako cha `25%` kinapaswa kuwa na `background-color` iliyowekwa kuwa `yellow`.
