...
Далі виведіть у консоль таке повідомлення: `gate.queue[tickIndex] + " attendees arriving."`.

# --hints--

Ваша функція `handleGateAtTick` має вивести у консоль таке повідомлення: `gate.queue[tickIndex] + " attendees arriving."`.
...
Ваша функція `handleGateAtTick` має вивести правильну кількість відвідувачів залежно від черги на вході у заданий tickIndex.
