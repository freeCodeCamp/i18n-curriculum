...
`span`, який має тривалість, також потребує стилізації, тому додайте до нього класи `text-base`, `font-medium` та `text-fuchsia-300`.
...
Ваш елемент `span` має мати клас `text-fuchsia-300`.
