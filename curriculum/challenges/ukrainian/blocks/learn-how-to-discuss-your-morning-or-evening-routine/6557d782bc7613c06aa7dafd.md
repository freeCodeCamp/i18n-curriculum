...
The word `never` is an adverb used to mean "not at any time" or "not ever". Зазвичай його використовують для того, щоб говорити про те, чого хтось не робить або не робив. Наприклад:
