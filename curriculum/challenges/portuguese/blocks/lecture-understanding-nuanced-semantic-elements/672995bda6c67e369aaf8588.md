...
Listas de descrição são perfeitas para apresentar termos e definições de forma organizada e fácil de ler, como em um glossário ou um dicionário de verdade, onde você pode encontrar palavras com suas definições correspondentes.
...
E finalmente, após cada termo você encontrará um elemento de detalhes da descrição, `dd`, para a descrição ou detalhes associados a esse termo. Neste exemplo, são HyperText Markup Language e Cascading Style Sheets.
...
Toda a lista de descrição está dentro de um elemento de lista de descrição. O primeiro ingrediente, `Flour`, está dentro de um elemento de termo da descrição. Depois, você pode ver a quantidade desse ingrediente que vai precisar: `2 cups`. Isso está dentro de um elemento de detalhes da descrição logo após seu ingrediente correspondente.
