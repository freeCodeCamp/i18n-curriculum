...
في هذه الورشة ستنشئ تطبيق مشغل موسيقى قادر على تشغيل الأغاني وإيقافها مؤقتًا وتخطيها من قائمة التشغيل.

تم توفير HTML وCSS لهذا المشروع لك، حتى تركز على JavaScript.

ابدأ بالوصول إلى العناصر `#playlist-songs` و`#play` و`#pause` وقم بتعيينها إلى المتغيرات `playlistSongs` و`playButton` و`pauseButton` على التوالي.
...
يجب تعيين عنصر `#playlist-songs` إلى المتغير `playlistSongs`.
...
يجب تعيين عنصر `#play` إلى المتغير `playButton`.
...
يجب تعيين عنصر `#pause` إلى المتغير `pauseButton`.
