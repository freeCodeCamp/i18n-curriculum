...
Badilisha sifa ya `background-color` ya `.three` kuwa `#b20403`.

# --hints--

Unapaswa kuweka sifa ya `background-color` kuwa `#b20403`.
...
Kipengele chako cha `.three` kinapaswa kuwa na thamani ya `background-color` ya `#b20403`.
