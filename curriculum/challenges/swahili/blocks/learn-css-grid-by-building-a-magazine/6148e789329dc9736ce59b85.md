...
Tengeneza sheria ya `.image-1, .image-3` na umpe sifa ya `grid-column` iliyowekwa kuwa `1 / -1`. Hii itaruhusu picha ya kwanza na ya tatu kugusa upana mzima wa gridi.
...
Kichaguzi chako cha `.image-1, .image-3` kinapaswa kuwa na sifa ya `grid-column` iliyowekwa kuwa `1 / -1`.
