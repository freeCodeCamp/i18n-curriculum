...
Para finalizar el proyecto, necesitarás ejecutar la función `updateResultsList` cuando se envíe el formulario de receta.

Usa un receptor de eventos para hacerlo, y recuerda que necesitarás prevenir el comportamiento por defecto (o la página se actualizará).

Una vez hecho esto, tómate un tiempo para experimentar con diferentes valores en el formulario antes de pasar al siguiente módulo.

# --hints--

Tu `recipeForm` debería llamar a `updateResultsList` al enviarse.
