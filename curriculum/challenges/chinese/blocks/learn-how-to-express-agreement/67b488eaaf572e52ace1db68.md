...
`Color scheme` refers to the selection of colors used in a design, whether it's for a website, app, or any other visual project. 例如：
...
`Energy` in design refers to the mood or atmosphere created by certain choices. 例如：
