...
title: 'Problema 53: selezioni combinatorie'
challengeType: 1
forumTopicId: 302164
...
Ci sono esattamente dieci modi per selezionare tre elementi da cinque, 12345:

<div style='text-align: center;'>123, 124, 125, 134, 135, 145, 234, 235, 245 e 345</div>

In combinatoria, usiamo la notazione, $\\displaystyle \\binom 5 3 = 10$

In generale, $\\displaystyle \\binom n r = \\dfrac{n!}{r!(n-r)!}$, dove $r \\le n$, $n! = n \\times (n-1) \\times ... \\times 3 \\times 2 \\times 1$, e $0! = 1$.

Solo a partire da $n = 23$, un valore supera il milione: $\\displaystyle \\binom {23} {10} = 1144066$.

Quanti valori, non necessariamente distinti, di $\\displaystyle \\binom n r$ per $1 \\le n \\le 100$, sono maggiori di un milione?
