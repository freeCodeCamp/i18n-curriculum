...
내부 함수도 함수를 반환할 수 있습니다. 같은 화살표 함수 구문을 사용하여 `addCharacters` 함수를 업데이트해 세 번째 함수를 반환하게 하세요. 이 함수는 `num` 매개변수를 받습니다.

# --hints--

내부 화살표 함수는 `num` 매개변수를 가진 또 다른 화살표 함수를 반환해야 합니다.
