...
في موضوع إمكانية الوصول البصري، تُعد نسبة التباين بين العناصر عاملًا أساسيًا. على سبيل المثال، يجب أن تكون نسبة التباين بين النص وخلفية العنوان على الأقل 4.5:1.

غيّر لون الخط لجميع عناصر وسم الرابط داخل عناصر القائمة إلى لون بنسب تباين لا تقل عن 7:1.

# --hints--

يجب أن يستهدف المحدِّد الخاص بك الروابط داخل عناصر القائمة.
...
يجب أن تعطي عناصر `a` داخل عناصر القائمة خاصية `color`.
...
يجب أن تغيّر لون عناصر `a` فقط داخل عناصر القائمة.
...
يجب أن تعطي خاصية `color` تباينًا مع الخلفية لا يقل عن 7:1. _تلميح: سأستخدم `#dfdfe2`_
