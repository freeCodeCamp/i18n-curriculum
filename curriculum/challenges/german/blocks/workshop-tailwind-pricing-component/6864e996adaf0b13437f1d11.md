...
Jetzt sollten Sie mit dem Styling der Elemente für den **Listener-Plan** beginnen.

Geben Sie dem äußeren `div` für den Plan die Klassen `bg-gray-100`, `ring-1`, um eine dicke Umrandung um `div` zu erzeugen, und `ring-gray-300`, um dieser Umrandung eine dunkle Farbe zuzuweisen.

# --hints--

Ihr `div`-Element sollte die Klasse `bg-gray-100` haben.
...
Ihr `div`-Element sollte die Klasse `ring-1` haben.
...
Ihr `div`-Element sollte die Klasse `ring-gray-300` haben.
