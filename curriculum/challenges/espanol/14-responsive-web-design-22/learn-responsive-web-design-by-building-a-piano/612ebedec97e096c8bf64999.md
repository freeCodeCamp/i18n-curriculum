...
Dentro de la consulta `@media`, añade un selector `.keys` y establece el `width` a `318px`.

# --hints--


Tu regla `@media` debe tener un selector `.keys`.
...
Tu nuevo selector `.keys` debe tener un `width` de `318px`.
