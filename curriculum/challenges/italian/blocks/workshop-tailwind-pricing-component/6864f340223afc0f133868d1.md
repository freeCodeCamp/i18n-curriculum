...
Spostandoti sul testo del prezzo all'interno di `p` e `span`, assegna all'elemento `p` le classi `text-4xl`, `font-bold` e `text-gray-900` in modo che il prezzo sia più visibile.
