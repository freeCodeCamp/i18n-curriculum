...
Cambia el valor de la clave `position` por el derivado `Position`.

# --hints--

El campo `PlayerData` de tu interfaz `position` debería usar el tipo `Position` en lugar de `string`.
