...
في موضوع إمكانية الوصول البصري، التباين بين العناصر عامل أساسي. على سبيل المثال، يجب أن تكون نسبة التباين بين النص وخلفية العنوان على الأقل 4.5:1.

غيّر لون الخط لجميع عناصر وسم الرابط داخل عناصر القائمة إلى لون بنسبة تباين لا تقل عن 7:1.
...
يجب أن تغيّر لون عناصر `a` داخل عناصر القائمة فقط.
