...
Modifica tu llamada a `console.log` para registrar el valor seleccionado del menú desplegable. 

Puedes acceder al valor actual de un elemento `select` usando su propiedad `.value`. Por ejemplo:
...
Debes registrar el valor seleccionado del menú desplegable cuando se desencadene un evento `change` en `selectContainer`.
