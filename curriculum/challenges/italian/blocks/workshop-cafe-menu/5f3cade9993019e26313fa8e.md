...
Ora che sai che funziona, puoi modificare gli altri elementi `article` e `p` per farli corrispondere al primo insieme. Inizia aggiungendo la classe `item` agli altri elementi `article`.
