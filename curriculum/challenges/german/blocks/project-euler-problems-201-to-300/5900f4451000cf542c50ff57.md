...
title: 'Aufgabe 216: Untersuchung der Primzahl-Eigenschaft von Zahlen der Form 2n²-1'
challengeType: 1
forumTopicId: 301858
...
Betrachten Sie Zahlen $t(n)$ der Form $t(n) = 2n^2 - 1$ mit $n > 1$.

Die ersten solchen Zahlen sind 7, 17, 31, 49, 71, 97, 127 und 161.
...
Wie viele Zahlen $t(n)$ sind für $n ≤ 50\,000\,000$ Primzahlen?
