...
Дайте вашому span текст `remainingCalories Calorie surplusOrDeficit`, використовуючи інтерполяцію, щоб замінити `remainingCalories` і `surplusOrDeficit` відповідними змінними.
