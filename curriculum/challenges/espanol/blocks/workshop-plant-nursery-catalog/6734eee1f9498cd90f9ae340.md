...
Cuando hay suficientes macetas para vender, necesitas actualizar el catálogo restando las macetas del tamaño especificado. En ese caso, devuelve `Catalog successfully updated.`
...
`sellPlants(ballerina, "small", 25)` debería devolver `Not enough small size pots for Lavandula stoechas 'Ballerina'. Only 10 left.`
