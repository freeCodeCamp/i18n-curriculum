...
在 `stats-grid` 内，添加两个 `div` 元素，每个都有 `className` 为 `form-group`。

对于第一个，添加一个 `label`，它有 `className` 为 `label`，`htmlFor` 为 `pac`，以及文本 `PAC`，然后添加一个输入，具有 `id` 为 `pac`，`className` 为 `input`，和 `type` 为 `number`。

对于第二个，添加 `label`，它有 `htmlFor` 为 `sho`，以及文本 `SHO`，然后添加一个输入，具有 `id` 为 `sho` 和 `type` 为 `number`。

# --hints--

你应该在 `div` 的 `className` 的 `form-group` 内有两个 `div` 元素，每个都有 `className` 为 `stats-grid`。
...
你的第一个 `div` 元素的 `className` 的 `form-group` 应该有一个 `label`，它有 `htmlFor` 属性为 `pac`，`className` 为 `label`，以及文本 `PAC`。
...
你的第一个 `div` 元素的 `className` 的 `form-group` 应该有一个 `input`，它有 `className` 为 `input`，`id` 为 `pac`，以及 `type` 为 `number`。
...
你的第二个 `div` 元素的 `className` 的 `form-group` 应该有一个 `label`，它有 `htmlFor` 属性为 `sho`，`className` 为 `label`，以及文本 `SHO`。
...
你的第二个 `div` 元素的 `className` 的 `form-group` 应该有一个 `input`，它有 `id` 为 `sho`，`className` 为 `input`，以及 `type` 为 `number`。
