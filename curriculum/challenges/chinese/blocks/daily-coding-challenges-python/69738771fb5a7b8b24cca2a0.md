...
`get_sign("2026-01-31")` 应该返回 `"Aquarius"`。
...
`get_sign("2001-06-10")` 应该返回 `"Gemini"`。
...
`get_sign("1985-09-07")` 应该返回 `"Virgo"`。
...
`get_sign("2023-03-19")` 应该返回 `"Pisces"`。
...
`get_sign("2045-11-05")` 应该返回 `"Scorpio"`。
...
`get_sign("1985-12-06")` 应该返回 `"Sagittarius"`。
...
`get_sign("2025-12-30")` 应该返回 `"Capricorn"`。
...
`get_sign("2018-10-08")` 应该返回 `"Libra"`。
...
`get_sign("1958-05-04")` 应该返回 `"Taurus"`。
