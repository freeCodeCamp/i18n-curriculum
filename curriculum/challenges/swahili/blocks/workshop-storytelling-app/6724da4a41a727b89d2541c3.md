...
Sasa kitendakazi cha `displayStory` kinafanya kazi vizuri, ni wakati wa kuongeza utendaji kwa vifungo.

Kabla ya hapo, ondoa wito wa kitendakazi cha `displayStory("scary")`.

# --hints--

Unapaswa kuondoa wito wa kitendakazi cha `displayStory("scary")`.
