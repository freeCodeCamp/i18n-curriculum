...
Dovresti assegnare alla proprietà `box-shadow` il valore `0 0 3px 3px #8f0401`.
...
Il selettore `.two` dovrebbe avere una proprietà `box-shadow` con il valore `0 0 3px 3px #8f0401`.
