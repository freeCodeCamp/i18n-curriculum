...
Далі створіть `label` з `className` `section` і `column`, а також текстом `How did you get your powers?`. Всередині `label` створіть елемент `select`.
...
Ваш елемент `label` має містити текст `How did you get your powers?`.
...
Ви маєте створити елемент `select` всередині вашого елемента `label`.
