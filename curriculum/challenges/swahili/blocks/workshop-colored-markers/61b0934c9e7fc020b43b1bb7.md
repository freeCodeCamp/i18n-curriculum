...
Tengeneza sheria mpya ya CSS ili kulenga darasa la vitu `cap`. Katika sheria mpya, weka sifa ya `width` kuwa `60px`, na `height` kuwa `25px`.

# --hints--

Unapaswa kutumia kichaguzi cha darasa la vitu ili kulenga darasa la vitu `cap`.
