...
1. В межах форми наявний submit `input` з відповідним `id="submit"`
1. Якщо натиснути на елемент `#submit`, емейл надіслано на статистичну сторінку (використовуйте альтернативу URL: `https://www.freecodecamp.com/email-submit`)
