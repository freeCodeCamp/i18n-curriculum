...
En la clase `sky` de la media query, cambia los dos valores de color `#ffcf33` a `#ccc`, el `#ffff66` a `#445` y el `#bbeeff` a `#223`. Luego puedes cambiar el tamaño de tu ventana para ver cómo el fondo cambia de color.
