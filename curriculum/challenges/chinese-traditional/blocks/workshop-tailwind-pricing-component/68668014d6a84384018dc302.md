...
首先，為計畫的外覆 `div` 添加類別 `bg-gray-100`、`ring-1`、`ring-gray-300`、`p-8` 和 `rounded-xl`。

# --hints--

你的家庭方案的外覆 `div` 元素應該有類別 `bg-gray-100`。
...
你的家庭方案的外覆 `div` 元素應該有類別 `ring-gray-300`。
...
你的家庭方案的外包 `div` 元素應該有類別 `rounded-xl`。
