...
Adesso, crea un array per archiviare tutte le canzoni.

Crea un array `allSongs` vuoto.

# --hints--

Dovresti avere una variabile chiamata `allSongs`.

```js
assert.isDefined(allSongs)
```

Dovresti assegnare un array alla tua variabile `allSongs`.
