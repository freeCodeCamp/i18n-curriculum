...
عندما تختار فئة من القائمة المنسدلة، تُصفى بطاقات الآلات الموسيقية وتُعرض بشكل صحيح على الصفحة، لكن عليك التخلص من الفواصل بين البطاقات.

افعل ذلك بضم المصفوفة التي تُرجعها `instrumentCards`. بذلك، يكتمل فلتر الآلات الموسيقية الخاص بك.
...
يجب أن تدمج المصفوفة التي تُرجعها دالة `instrumentCards`. لا تعدل مستمع الحدث الخاص بك.
