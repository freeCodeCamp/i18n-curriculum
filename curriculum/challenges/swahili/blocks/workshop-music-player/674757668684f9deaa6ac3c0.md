...
Bado ukiwa ndani ya kitendakazi cha `playSong`, weka sifa ya `audio.src` sawa na `song.src`. Hii inaeleza kipengele cha sauti mahali pa kupata data ya sauti kwa wimbo ulioteuliwa.

Pia, weka sifa ya `audio.title` sawa na `song.title`. Hii inaeleza kipengele cha sauti nini kiwe kinavyoonyeshwa kama kichwa cha wimbo.

# --hints--

Unapaswa kuweka sifa ya `audio.src` sawa na `song.src` ndani ya kitendakazi chako cha `playSong`.
...
Unapaswa kuweka sifa ya `audio.title` sawa na `song.title` ndani ya kitendakazi chako cha `playSong`.
