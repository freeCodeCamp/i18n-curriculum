...
Outro desafio com SPAs é a navegação e o histórico do navegador. Os usuários esperam que os botões de voltar e avançar funcionem como em sites tradicionais. Isso pode não funcionar adequadamente em SPAs porque, tecnicamente, a URL do app não muda. Como a URL do app não muda, eles não podem marcar nenhuma página específica. Atualizar a página pode reiniciar a aplicação para seu estado inicial, em vez de manter a visualização atual.
