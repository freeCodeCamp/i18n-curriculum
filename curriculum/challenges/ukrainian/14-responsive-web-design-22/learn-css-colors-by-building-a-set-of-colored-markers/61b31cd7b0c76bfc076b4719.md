...
На цьому ваш набір кольорових маркерів готовий! Хороша робота.

# --hints--

Ваше CSS-правило `.blue` повинне мати скорочену властивість `box-shadow` зі значенням `0 0 20px 0 hsla(223, 59%, 31%, 0.8)`.
