...
Aggiungi la classe `text-gray-300` all'elemento `p` che contiene il beneficio del piano in una sola riga.

# --hints--

Il tuo elemento `p` dovrebbe avere la classe `text-gray-300`.
