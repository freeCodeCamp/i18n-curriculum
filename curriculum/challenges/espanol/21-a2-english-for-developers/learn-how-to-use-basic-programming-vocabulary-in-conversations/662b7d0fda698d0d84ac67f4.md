...
The pattern `by` followed by the `-ing` form of a verb is a common way to explain how something is done or achieved. Énfasis en el método o proceso involucrado. Un ejemplo es `You can improve your English by practicing every day.`
...
Esta preposición se utiliza para introducir el método o medio por el cual se hace algo.
...
Esta es la formulario `-ing` de un verbo, que en este contexto se refiere a aplicar una herramienta o método específico para realizar una tarea.
