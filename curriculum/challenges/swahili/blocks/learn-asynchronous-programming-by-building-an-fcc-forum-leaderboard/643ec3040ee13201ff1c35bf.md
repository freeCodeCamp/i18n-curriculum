...
Weka kipengele cha pili cha `td` kuwa tupu kwa sababu utaongeza maudhui baadaye.

Katika kipengele cha tatu cha `td`, ongeza usemi wa kihesabu ulioingizwa ufuatao: `${posts_count - 1}`.

Hii itaonyesha idadi ya majibu kwa mada hiyo.

# --hints--

Unapaswa kuwa na `${posts_count - 1}` ndani ya kipengele cha tatu cha `td`.
