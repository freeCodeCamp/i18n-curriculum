...
Imposta la larghezza degli elementi `section` a `80%` del loro contenitore genitore. Poi, usa i margini per centrare gli elementi `section`, aggiungendo `10px` al margine inferiore.
