...
`To investigate` تعني فحص شيء بعناية، و`to be related to` تعني أن يكون هناك ارتباط أو علاقة بشيء ما. على سبيل المثال:
...
تعني فحص شيء بعناية أو التعمق في البحث عنه. هذا الفعل ينتهي بـ `-ing`
...
تعني وجود ارتباط أو علاقة بشيء ما.
