...
Geben Sie schließlich `secret_codes` zurück, kommentieren Sie dann den Funktionsaufruf aus und aktualisieren Sie das Argument zu `[poem, poem2, poem3]`. Nun funktioniert Ihre Funktion mit mehreren Gedichten gleichzeitig und kann mehrere Pins extrahieren!

Die `pin_extractor`-Funktion ist abgeschlossen.

# --hints--

Die Funktion sollte am Ende `secret_codes` zurückgeben.
...
Sie sollten den Funktionsaufruf `print(pin_extractor([poem, poem2, poem3]))` haben.
...
`pin_extractor([poem, poem2, poem3])` sollte `['5202', '3346', '50000']` zurückgeben.
...
Die Funktion sollte mit anderen Listen von Gedichten korrekt funktionieren.
