...
Erstelle eine neue Funktion mit dem Namen `showAnimation`. Leave the body of the function empty for now.

# --hints--

Du solltest eine Funktion mit dem Namen `showAnimation` erstellen.
