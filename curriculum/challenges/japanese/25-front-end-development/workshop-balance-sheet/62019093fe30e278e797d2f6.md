...
`[attribute="value"]` セレクターは、特定の属性に、特定の値を持つすべての要素を選択します。 `total` クラスを持つ `tr` 要素を選択するため、`tr[class="total"]` セレクターを作成してください。 下端の境界線を `4px double #0a0a23` に設定し、フォントを太字にしてください。
