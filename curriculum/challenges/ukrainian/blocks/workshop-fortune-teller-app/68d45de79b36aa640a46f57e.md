...
Вам потрібен ще один інтерфейс з назвою `Deck`. Цей інтерфейс має містити властивість `cards`, яка є масивом попереднього інтерфейсу.

# --hints--

Ви повинні оголосити інтерфейс з назвою `Deck`.
...
Ваш інтерфейс `Deck` має містити властивість `cards` типу `Card[]`.
