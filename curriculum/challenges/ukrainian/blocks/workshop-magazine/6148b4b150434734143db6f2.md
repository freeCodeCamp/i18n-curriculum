...
Пам’ятайте, що властивість `grid-column` визначає, з якої колонки починається і на якій закінчується елемент. Іноді ви можете не знати, скільки колонок буде у вашій сітці, але хочете, щоб елемент закінчувався на останній колонці. Для цього можна використати `-1` для кінцевої колонки.
