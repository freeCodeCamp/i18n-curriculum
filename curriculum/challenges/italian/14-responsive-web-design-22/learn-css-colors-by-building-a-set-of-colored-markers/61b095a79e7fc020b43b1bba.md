...
Nella stessa funzione `linear-gradient`, utilizza la funzione `rgb` per impostare il secondo argomento di colore sul verde puro.

# --hints--

La regola CSS `.red` dovrebbe avere una proprietà `background` con il valore `linear-gradient(90deg, rgb(255, 0, 0), rgb(0, 255, 0))`.
