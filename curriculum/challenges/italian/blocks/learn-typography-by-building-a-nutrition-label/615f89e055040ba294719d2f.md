...
L'elemento `p` contiene solo testo, puoi racchiudere la percentuale in un elemento `span` così che sia considerata un'entità separata dal resto del testo e venga spostata a destra.
