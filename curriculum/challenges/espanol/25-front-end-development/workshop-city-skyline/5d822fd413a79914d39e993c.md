...
En la clase `sky` de la consulta de medios, cambia los dos valores de color `#ffcf33` a `#ccc`, el `#ffff66` a `#445` y el `#bbeeff` a `#223`. Luego puedes redimensionar tu ventana para ver el fondo cambiar de colores.
