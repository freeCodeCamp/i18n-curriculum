...
Для другого аргумента використайте шістнадцяткові коди кольорів зі значеннями `71` для червоного, `F5` для зеленого та `3E` для синього.

# --hints--

Ваше CSS-правило `.green` повинне мати властивість `background` зі значенням `linear-gradient(180deg, #55680D, #71F53E)`.
