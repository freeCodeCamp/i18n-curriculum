...
Mwishowe, katika kichaguzi cha `:root` cha media query, fafanua upya vigezo vyote vinne vya `--window-color` ili vitumie `#777`. Ukimaliza, badilisha ukubwa wa dirisha na uone inavyobadilika kutoka mchana hadi usiku.

Vigezo hutumika hasa kwa rangi, na ndivyo ulivyovitumia hapa. Lakini vinaweza kupewa thamani yoyote na kutumika kwenye sifa yoyote. Mradi wako unaonekana mzuri!
