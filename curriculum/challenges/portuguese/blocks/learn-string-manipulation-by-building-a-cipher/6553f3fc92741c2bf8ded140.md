...
Dentro do corpo da sua função, renomeie as variáveis `text` e `shift` para `message` e `offset`, respectivamente.

# --hints--

Você deve renomear todas as ocorrências de `text` para `message`.
...
Você deve renomear `shift` para `offset`.
