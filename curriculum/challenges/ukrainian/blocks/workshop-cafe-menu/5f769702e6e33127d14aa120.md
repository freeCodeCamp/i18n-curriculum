...
Тепер вирівняйте текст по `right` для елементів із класом `price`.

# --hints--

У вас має бути селектор класу `price`.
...
Ваш селектор класу `price` має встановити властивість `text-align` у значення `right`.
