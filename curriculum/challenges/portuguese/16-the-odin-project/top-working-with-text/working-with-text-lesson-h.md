...
videoId: kcHKFZBVtf4
title: Lição H de Trabalhando com textos
challengeType: 15
...
Se você preferir criar uma lista de itens onde a ordem importa, por outro lado, como instruções passo a passo para uma receita ou seus 10 programas favoritos de TV, pode usar uma lista ordenada.
...
Assista aos três primeiros minutos do vídeo de Kevin Powell sobre listas ordenadas e não ordenadas acima.
