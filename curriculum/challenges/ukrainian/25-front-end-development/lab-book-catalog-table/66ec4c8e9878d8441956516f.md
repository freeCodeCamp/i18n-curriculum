...
Ви повинні мати один елемент `tr` в межах елемента `thead`.
...
Ви повинні мати один елемент `tbody` в межах елемента `table`.
...
Ви повинні мати один елемент `tfoot` в межах елемента `table`.
