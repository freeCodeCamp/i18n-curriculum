...
بعد ذلك، اجعل نص `h1` مميزًا عن طريق تعيين `class` له بقيمة `text-3xl` لجعله أكبر، و`text-center` لمركزة النص، و`font-semibold` لجعله أكثر عريضًا، و`text-gray-900` لجعله أغمق، و`md:text-5xl` لجعله أكبر على شاشات متوسطة وأكبر.

# --hints--

يجب أن يحتوي عنصر `h1` على الصنف `text-3xl`.
...
يجب أن يحتوي عنصر `h1` على الصنف `text-center`.
...
يجب أن يحتوي عنصر `h1` على الصنف `font-semibold`.
...
يجب أن يحتوي عنصر `h1` على الصنف `text-gray-900`.
...
يجب أن يحتوي عنصر `h1` على الصنف `md:text-5xl`.
