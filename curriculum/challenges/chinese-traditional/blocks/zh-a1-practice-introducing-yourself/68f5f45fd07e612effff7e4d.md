...
Liu Ming says `我是設計師 (wǒ shì shè jì shī)`, which means his job usually involves creating visual concepts and layouts instead of software development, which is what a developer does.
...
`我是設計師 (wǒ shì shè jì shī)` means "I am a designer".
