...
Dentro do `stats-grid`, adicione dois elementos `div` cada um com o `className` de `form-group`.

Para o primeiro, adicione um `label` com o `className` de `label`, um `htmlFor` de `pac` e o texto `PAC`. Em seguida, adicione um input com o `id` de `pac`, um `className` de `input` e um `type` de `number`.

E no segundo, adicione `label` com um `htmlFor` de `sho` e o texto `SHO`, depois uma entrada com um `id` de `sho` e um `type` de `number`.

# --hints--

Você deve ter dois elementos `div` cada um com o `className` de `form-group` dentro do `div` de `className` de `stats-grid`.
...
Seu primeiro elemento `div` de `className` de `form-group` deve ter um `label` com um atributo `htmlFor` de `pac`, um `className` de `label` e um texto `PAC`.
...
Seu primeiro elemento `div` de `className` de `form-group` deve ter um `input` com um `className` de `input`, um `id` de `pac` e um `type` de `number`.
...
Seu segundo elemento `div` de `className` de `form-group` deve ter um `label` com um atributo `htmlFor` de `sho`, um `className` de `label` e um texto `SHO`.
...
Seu segundo elemento `div` de `className` de `form-group` deve ter um `input` com um `id` de `sho`, um `className` de `input` e um `type` de `number`.
