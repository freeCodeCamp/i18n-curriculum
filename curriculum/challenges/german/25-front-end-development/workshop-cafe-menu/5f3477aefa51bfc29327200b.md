...
A separate `styles.css` file has been created for you and the editor view has been switched to that file. Mit den Registerkarten am oberen Rand des Editors kannst du zwischen den Dateien wechseln.
