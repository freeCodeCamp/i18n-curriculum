...
Selecciona el párrafo `#result` y guárdalo en una variable llamada `resultParagraph`. Usarás esta variable para mostrar la historia seleccionada.

# --hints--

Debes seleccionar el párrafo `#result` usando el método `getElementById` y guardarlo en la variable `resultParagraph`.
