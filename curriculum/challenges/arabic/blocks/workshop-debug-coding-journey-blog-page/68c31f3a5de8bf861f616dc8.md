...
في الوقت الحالي، يحتوي قسم الـ `footer` على عنوان `h3`. لكن يجب أن يكون عنوانًا من نوع `h2` للحفاظ على تسلسل عناوين صحيح.

غيّر `h3` إلى `h2`.

# --hints--

يجب أن يحتوي عنصر `footer` على عنصر `h2` بدلاً من عنصر `h3`.
