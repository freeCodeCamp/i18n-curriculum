...
Erstelle das letzte `p`-Element für deinen `.daily-value`-Abschnitt. Gib ihm den Text `Potassium 235mg 6%`. Richte den `6%`-Text nach rechts aus und entferne den unteren Rand des `p`-Elements.
...
Dein neues `p`-Element sollte den Text `Potassium 235mg 6%` enthalten.
