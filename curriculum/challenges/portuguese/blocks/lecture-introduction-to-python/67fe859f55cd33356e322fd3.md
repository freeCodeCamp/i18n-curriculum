...
Qual palavra-chave é usada para definir uma função personalizada em Python?
...
Python usa uma palavra-chave específica para iniciar uma definição de função.
