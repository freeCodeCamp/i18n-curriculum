...
Ora puoi rimuovere il loop che stampa ogni riga dell'output e sostituirlo con `print(graph.create_trajectory())`.

# --hints--

Non dovresti avere un loop nell'ambito globale.
...
Dovresti avere `print(graph.create_trajectory())`.
