...
`After that` is used to show the order of events, meaning the next action or event followed something that happened previously. It helps organize actions in chronological order. Por ejemplo:
