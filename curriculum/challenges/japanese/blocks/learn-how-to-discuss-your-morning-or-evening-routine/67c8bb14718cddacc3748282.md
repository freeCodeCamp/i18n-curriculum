...
`Don't start`, `too much`, `because`, `try to include`, `Don't forget to`, `to not`, `running around`, および `don't get`。
...
これは否定文を作ります。否定の助動詞に続いて基本形の動詞が来ます。
...
これは否定の不定詞句を作ります。助詞に続いて否定の副詞が来ます。
...
これは否定の命令文を作ります。否定の助動詞に続いて基本形の動詞が来ます。
...
これは無秩序に素早く動くことを表します。現在分詞形の動詞に続いて前置詞が来ます。
...
これは提案を作ります。動詞に続いて助詞、そして基本形の動詞が来ます。
...
これはリマインダーや指示を作ります。否定の助動詞に続いて基本形の動詞、そして助詞が来ます。最初の文字は大文字です。
