...
Tumia `getElementById()` kuchagua wimbo unaochezwa kwa sasa: tuma usemi wa template kuambatanisha `id` na `song-`. Weka thamani yake katika kigezo kinachoitwa `songToHighlight`.
...
Unapaswa kuweka thamani ya `getElementById()` katika kigezo cha `songToHighlight`.
