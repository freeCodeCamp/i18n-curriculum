...
Um passende Autoren zu finden, prüfen Sie jeden Katalogeintrag einzeln.

Fügen Sie eine leere `for`-Schleife innerhalb von `findByAuthor` ein, um `catalog` zu durchlaufen. Den Schleifenkörper fügen Sie im nächsten Schritt hinzu.
