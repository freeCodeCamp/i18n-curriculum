...
Em seguida, adicione um `input` com o tipo de `"email"` ao formulário. Este `input` deve ter um atributo `id` definido como o valor de `"email"`. Além disso, defina o atributo `name` com o valor de `"email"`.
