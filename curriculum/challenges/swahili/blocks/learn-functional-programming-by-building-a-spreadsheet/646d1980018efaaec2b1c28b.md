...
Tumia sintaksia ile ile kama kitendakazi chako cha `addCharacters` kusahihisha kitendakazi chako cha `elemValue`. Haipaswi tena kutangaza `inner`, bali inapaswa kurudisha kitendakazi kwa njia isiyo ya moja kwa moja.

# --hints--

Kitendakazi chako cha `elemValue` kinapaswa kutumia kurudisha isiyo ya moja kwa moja.
...
Kitendakazi chako cha `elemValue` kinapaswa kurudisha kwa njia isiyo ya moja kwa moja kitendakazi cha mshale chenye kigezo cha `character`.
...
Kitendakazi chako cha mshale cha ndani kinapaswa kutumia kurudisha isiyo ya moja kwa moja.
...
Kitendakazi chako cha mshale cha ndani kinapaswa kurudisha matokeo ya wito wa `idToText()` kwa `character + num` kama hoja.
