...
Es sieht gut aus. Es ist an der Zeit einige Artikel in die Speisekarte einzufügen. Füge ein leeres `article`-Element unter der `Coffee`-Überschrift hinzu. Es wird ein Aroma und Preis für jeden Kaffee, den du derzeit anbietest, enthalten.
