...
Щоб зробити зображення подібним до блочних елементів, таких як заголовки, створіть селектор типу `img`. Встановіть властивість `display` у значення `block`, а властивості `margin-left` і `margin-right` використайте для горизонтального центрування.

# --hints--

Ви повинні використати селектор `img`.
...
Ви повинні встановити властивість `display` у значення `block`.
...
Ви повинні встановити властивість `margin-left` у значення `auto`.
...
Ви повинні встановити властивість `margin-right` у значення `auto`.
...
Ваш елемент `img` повинен мати ідентифікатор `display` зі значенням `block`.
...
Ваш елемент `img` повинен мати властивості `margin-left` і `margin-right` зі значенням `auto`.
