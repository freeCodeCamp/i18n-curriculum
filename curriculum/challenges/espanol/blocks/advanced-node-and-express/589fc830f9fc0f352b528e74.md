...
`socket.io@~2.3.0` ya ha sido agregado como dependencia, así que requiérelo/instáncialo en tu servidor de la siguiente manera con `http` (viene incorporado con Node.js):
...
Envía tu página cuando creas que está correcta. Si tienes errores, puedes <a href="https://forum.freecodecamp.org/t/advanced-node-and-express/567135#set-up-the-environment-6" target="_blank" rel="noopener noreferrer nofollow">consultar el proyecto completado hasta este punto</a>.
