...
Kihimarisha hutumika katika usemi wa kawaida kubainisha ni mara ngapi herufi inaweza kurudiwa. Kwa mfano, herufi ya `+` inalingana na herufi iliyotangulia mara moja au zaidi:
...
Kwa hiyo ongeza kihimarisha cha `+` kwenye muundo wako wa usemi wa kawaida ili kulinganisha nambari moja au zaidi.

# --hints--

Unapaswa kuongeza kihimarisha cha `+` kwenye muundo wako wa usemi wa kawaida wa sasa `p\d`.
