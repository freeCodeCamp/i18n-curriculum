...
Si te fijas bien, verás que la canción que se está reproduciendo actualmente no está resaltada en la lista de reproducción, por lo que realmente no sabes qué canción está sonando. Puedes solucionar esto creando una función para resaltar cualquier canción que se esté reproduciendo.
