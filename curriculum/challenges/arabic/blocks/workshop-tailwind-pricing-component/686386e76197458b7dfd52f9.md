...
تم توفير بقية شفرة HTML لك. يشمل ذلك بطاقات خطة Premium وخطة Family. لذا، حان الوقت لتنسيق عناصر HTML باستخدام Tailwind CSS.

ابدأ بإعطاء الصفحة بأكملها خلفية رمادية فاتحة قليلًا عن طريق تعيين الصنف `bg-gray-100` لعنصر `body`.

# --hints--

يجب أن يحتوي عنصر body على الصنف `bg-gray-100`.
