...
将 `totalNumberOfItems`、`cartSubTotal`、`cartTaxes` 和 `cartTotal` 元素的 `textContent` 全部设置为数字 `0`。

# --hints--

你应该将 `totalNumberOfItems` 元素的 `textContent` 设置为 `0`。
...
你应该将 `cartSubTotal` 元素的 `textContent` 设置为 `0`。
...
你应该将 `cartTaxes` 元素的 `textContent` 设置为 `0`。
...
你应该将 `cartTotal` 元素的 `textContent` 设置为 `0`。
