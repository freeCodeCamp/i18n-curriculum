...
Após seu dicionário, siga o exemplo acima para acessar a chave `'species'` de `copper` e imprimir o resultado.

# --hints--

Você não deve modificar a atribuição do seu dicionário.
