...
Agora você deve trabalhar no espaçamento dos itens dentro desse plano.

Adicione a classe utilitária `rounded-xl` para remover as bordas afiadas do anel, `p-8` para aumentar o espaçamento interno e `gap-6` para criar espaço entre o conteúdo e o botão CTA.

# --hints--

Seu elemento `div` deve ter a classe `rounded-xl`.
...
Seu elemento `div` deve ter a classe `p-8`.
...
Seu elemento `div` deve ter a classe `gap-6`.
