...
أخيرًا، غيّر لون نص عنصر الرابط `terms and conditions` إلى `#dfdfe2` بإضافة محدِّد جديد في CSS.

عمل رائع! لقد أكملت الجزء النهائي من ورشة عمل _Registration Form_.

# --hints--


يجب أن تعطي العنصر `a` خاصية `color` بالقيمة `#dfdfe2`.
