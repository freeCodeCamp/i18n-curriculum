...
Se puede mostrar que el polínomio $n^4 + 4n^3 + 2n^2 + 5n$ es un multiplo de 6 para cada entero $n$. También puede mostrarse que 6 es el entero más grande que satisface esta propiedad.
...
Encuentra los últimos 9 dígitos de $\sum S(F_k)$ para $2 ≤ k ≤ 1\,234\,567\,890\,123$.
