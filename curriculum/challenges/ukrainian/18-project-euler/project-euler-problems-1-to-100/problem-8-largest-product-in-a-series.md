...
title: 'Завдання 8: найбільший добуток у послідовності'
challengeType: 1
forumTopicId: 302193
...
Чотирма суміжними цифрами у 1000-значному числі, які мають найбільший добуток, є 9 × 9 × 8 × 9 = 5832.
...
Знайдіть `n` суміжних цифр у 1000-значному числі, які мають найбільший добуток. Яке значення має цей добуток?
