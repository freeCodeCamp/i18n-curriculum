...
Questa frase di due parole significa molto vicino o accanto a qualcosa.

# --explanation--

`Next to` significa accanto o molto vicino a qualcosa. Per esempio:

`The printer is next to the desk.` – Questo mostra che la stampante si trova proprio accanto alla scrivania.
