...
Comienza añadiendo contenido al menú. Añade un elemento `main` dentro del elemento `body` existente. Eventualmente contendrá información sobre los precios de los cafés y postres ofrecidos en la cafetería.
