...
حدّث المعلمة في الدالة لتصبح `poems`، ثم أنشئ حلقة `for` حول كل محتوى الدالة الحالي لتكرار `poems` واستخدم `poem` كمتغير للحلقة.

# --hints--

يجب أن تحتوي الدالة `pin_extractor` على معلمة باسم `poems`.
...
يجب أن يكون لديك حلقة `for` تقوم بالتكرار على `poems`.
...
يجب أن تحتوي الحلقة على `poem` كمتغير للحلقة.
...
يجب أن تنقل جسم الدالة الحالي إلى داخل حلقة `for` الجديدة.
