...
The new image does not have an `alt` attribute. 检查开始标签的名称后面是否有空格和/或所有属性名称之前是否有空格。
...
The new image does not have a `src` attribute. 检查开始标签的名称后面是否有空格和/或所有属性名称之前是否有空格。
