...
Verschieben Sie den Preistext innerhalb der `p` und `span` und geben Sie dem `p`-Element die Klassen `text-4xl`, `font-bold` und `text-gray-900`, damit der Preis besser sichtbar ist.
