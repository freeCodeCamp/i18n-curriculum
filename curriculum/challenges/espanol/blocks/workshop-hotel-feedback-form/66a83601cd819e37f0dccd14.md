...
Debajo de su elemento `h1`, agregue un elemento `p`. El texto del elemento `p` debe ser `Thank you for staying with us. Please provide feedback on your recent stay.`
