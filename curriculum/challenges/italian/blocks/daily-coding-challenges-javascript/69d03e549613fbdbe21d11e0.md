...
Dato un array di farmaci e una stringa che rappresenta l'orario attuale, restituisci il prossimo farmaco che devi prendere e quanto tempo manca prima di doverlo prendere.

- Ogni farmaco è nel formato `[name, lastTaken]`, dove `name` è il nome del farmaco e `lastTaken` è l'orario in cui è stato preso l'ultima volta.
- Tutti gli orari forniti saranno nel formato `"HH:MM"` (24 ore).

Usa il seguente schema di assunzione dei farmaci:
...
`medicationReminder([["Deployxitrin", "08:00"], ["Debuggamanizole", "07:00"], ["Mergeflictamine", "10:00"]], "11:00")` dovrebbe restituire `"Debuggamanizole in 2h 0m"`.
...
`medicationReminder([["Deployxitrin", "08:00"], ["Debuggamanizole", "13:00"], ["Mergeflictamine", "14:00"]], "14:55")` dovrebbe restituire `"Deployxitrin in 1h 5m"`.
...
`medicationReminder([["Deployxitrin", "08:00"], ["Debuggamanizole", "13:00"], ["Mergeflictamine", "14:00"]], "17:15")` dovrebbe restituire `"Mergeflictamine in 0h 45m"`.
...
`medicationReminder([["Deployxitrin", "08:00"], ["Debuggamanizole", "07:00"], ["Mergeflictamine", "09:00"]], "12:59")` dovrebbe restituire `"Debuggamanizole in 0h 1m"`.
...
`medicationReminder([["Deployxitrin", "08:00"], ["Debuggamanizole", "21:00"], ["Mergeflictamine", "03:00"]], "06:55")` dovrebbe restituire `"Debuggamanizole in 0h 5m"`.
...
`medicationReminder([["Deployxitrin", "08:00"], ["Debuggamanizole", "07:00"], ["Mergeflictamine", "07:30"]], "08:00")` dovrebbe restituire `"Mergeflictamine in 3h 30m"`.
