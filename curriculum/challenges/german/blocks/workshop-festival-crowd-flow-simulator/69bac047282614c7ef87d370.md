...
Um nachzuverfolgen, wie Teilnehmende sich im System bewegen, geben Sie die folgende Nachricht in der Konsole aus: `overflowAmount + " attendees rerouted to " + gates[nextGateIndex].id`. Sie können entweder String-Verkettung oder Template-Literale verwenden.

# --hints--

Ihre `rerouteOverflow`-Funktion sollte die folgende Nachricht in der Konsole ausgeben `overflowAmount + " attendees rerouted to " + gates[nextGateIndex].id`.
