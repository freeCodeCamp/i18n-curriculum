...
Ifuatayo, ongeza `year` na `players` kwenye mgawo wako wa ufumbuzi wa muundo.

# --hints--

Unapaswa kuongeza thamani za `year` na `players` kwenye mgawo wako wa ufumbuzi wa muundo.
