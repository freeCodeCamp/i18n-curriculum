...
**Nota:** É convenção preceder o nome de uma variável privada com um underscore (`_`). No entanto, essa prática por si só não torna uma variável privada.
...
**Nota:** Ao implementar isso, você acompanhará a temperatura dentro da classe em uma escala, seja Fahrenheit ou Celsius.
