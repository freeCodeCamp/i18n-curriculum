...
الناتج صحيح، `repr` يعطيك السلسلة النصية المطلوبة لإنشاء الكائنات.

الآن أضف تعليقًا للكود على كلا استدعائي `print`.

# --hints--

يجب إضافة تعليق للكود على كلا استدعائي `print()`.
