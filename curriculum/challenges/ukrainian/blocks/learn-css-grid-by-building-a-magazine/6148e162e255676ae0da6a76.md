...
Надайте селектору `.lists` множину властивостей `margin-top` зі значенням `2rem`.

# --hints--

Ваш селектор `.lists` має мати множину властивостей `margin-top` зі значенням `2rem`.
