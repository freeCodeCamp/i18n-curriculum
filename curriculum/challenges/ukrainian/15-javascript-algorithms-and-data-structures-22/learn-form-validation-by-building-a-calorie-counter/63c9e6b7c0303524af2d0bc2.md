...
Надайте span текст `remainingCalories Calorie surplusOrDeficit`, використовуючи інтерполяцію, щоб замінити `remainingCalories` та `surplusOrDeficit` відповідними змінними.

# --hints--

Ваш `span` повинен мати текст `${remainingCalories} Calorie ${surplusOrDeficit}`.
