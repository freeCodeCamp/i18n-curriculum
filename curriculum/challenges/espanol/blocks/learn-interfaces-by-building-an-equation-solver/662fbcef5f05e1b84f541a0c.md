...
Cada objeto ecuación se instanciará pasando tantos argumentos como coeficientes tenga la ecuación, comenzando desde el grado n-ésimo de \\( x \\) hasta el grado cero, incluyendo el posible coeficiente con valor `0`.

Por ejemplo, `LinearEquation(4, 5)` representaría la ecuación \\( 4x + 5 = 0 \\), con `4` siendo el coeficiente del primer grado (el más alto aquí) y `5` el coeficiente del grado cero.
