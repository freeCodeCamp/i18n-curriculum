...
Tengeneza kichaguzi cha `.author-name a:hover` na kipa sifa ya `background-color` ikiwa `#306203`.

Hii itaunda athari ya kupaa kwa kipengele cha `a` ndani ya `.author-name`, ikionyesha rangi ya kijani ya asili ya freeCodeCamp nyuma.
...
Kichaguzi chako cha `.author-name a:hover` kinapaswa kuwa na sifa ya `background-color` ikiwa `#306203`.
