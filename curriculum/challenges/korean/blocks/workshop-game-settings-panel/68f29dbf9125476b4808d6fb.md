...
`.settings-card` 클래스 선택자에 `max-width` 속성을 추가해야 합니다.
...
`.settings-card` 클래스 선택자에 `padding` 속성을 추가해야 합니다.
...
`.settings-card` 클래스 선택자에 `border-radius` 속성을 추가해야 합니다.
...
`.settings-card` 클래스 선택자에 `box-shadow` 속성을 추가해야 합니다.
