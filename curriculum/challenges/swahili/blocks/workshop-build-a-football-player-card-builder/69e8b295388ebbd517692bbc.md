...
Sasa ongeza `div` yenye `className` ya `card-stats`. Ndani yake, ongeza `div` yenye `className` ya `stat-col`. Ndani yake, ongeza vipengele vitatu vya `div` kila kikiwa na `className` ya `stat-row`.
...
Unapaswa kuongeza `div` yenye `className` ya `stat-col` ndani ya `.card-stats`.

```js
assert.exists(document.querySelector('.card-stats > .stat-col'));
```

Unapaswa kuongeza vipengele vitatu vya `div` kila kikiwa na `className` ya `stat-row` ndani ya `.stat-col`.
