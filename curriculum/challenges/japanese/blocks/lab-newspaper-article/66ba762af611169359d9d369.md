...
`.newspaper`要素内に`name`クラスの要素を用意してください。
...
`.newspaper`要素内に`date`クラスの要素を用意してください。
...
`.newspaper`要素内に`headline`クラスの要素を用意してください。
...
`.newspaper`要素内に`sub-headline`クラスの要素を用意してください。
...
`.newspaper`要素内に`author`クラスの要素を用意してください。
...
`.newspaper`要素内に`text`クラスの段落要素を少なくとも2つ用意してください。
