...
1. Атрибути `data-date` елементів `.bar` повинні відповідати порядку наданих даних.
1. Атрибути `data-gdp` елементів `.bar` повинні відповідати порядку наданих даних.
