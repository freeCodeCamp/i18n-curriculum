...
Para el segundo argumento de color, usa un código de color hexadecimal con los valores `71` para el rojo, `F5` para el verde, y `3E` para el azul.

# --hints--

La regla CSS `.green` debe tener una propiedad `background` configurada a `linear-gradient(180deg, #55680D, #71F53E)`.
