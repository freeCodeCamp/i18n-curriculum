...
Para este laboratorio, se te ha proporcionado todo el HTML y CSS. Utilizarás JavaScript para completar el Visualizador de Ordenamiento Burbuja, para que visualice cada paso necesario del algoritmo para ordenar un arreglo de cinco enteros.

Cumple con las historias de usuario a continuación y aprueba todas las pruebas para completar el laboratorio.
...
1. La función `fillArrContainer` debe llenar el elemento pasado como primer argumento con cinco elementos `span` con el texto de un número entero del arreglo pasado como segundo argumento.
...
Tu función `fillArrContainer()` debe llenar el elemento pasado como primer argumento con cinco elementos `span` con el texto de un número entero del arreglo pasado como segundo argumento.
