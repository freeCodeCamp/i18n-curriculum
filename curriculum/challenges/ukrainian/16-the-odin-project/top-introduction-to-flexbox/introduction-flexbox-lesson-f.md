...
title: Вступ до гнучкого контейнера. Урок №6
challengeType: 15
...
`flex-grow` очікує число як значення, і це число використовується як «фактор росту» гнучкого предмета. Коли ви застосували `flex: 1` до кожного елемента div в контейнері, ви повідомили всім елементам div зростати однаково. У результаті всі елементи div мають однаковий розмір. А якщо додати `flex: 2` лише до одного елемента div, він буде в два рази більшим за інших.
