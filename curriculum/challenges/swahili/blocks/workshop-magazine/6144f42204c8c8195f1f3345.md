...
Ili kuongeza nafasi kati ya mistari katika mpangilio wa gridi, unaweza kutumia sifa ya `row-gap`. Toa kichaguzi cha `main` sifa ya `row-gap` yenye thamani ya `3rem`.

# --hints--

Kichaguzi chako cha `main` kinapaswa kuwa na sifa ya `row-gap` yenye thamani ya `3rem`.
