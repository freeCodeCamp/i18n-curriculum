...
Debes tener un selector `table caption`.

```js
assert(new __helpers.CSSHelp(document).getStyle('table caption'));
```

Tu selector `table caption` debe tener una propiedad `color` establecida en `#356eaf`.

```js
assert(new __helpers.CSSHelp(document).getStyle('table caption')?.getPropertyValue('color') === 'rgb(53, 110, 175)');
```

Tu selector `table caption` debe tener una propiedad `font-size` establecida en `1.3em`.

```js
assert(new __helpers.CSSHelp(document).getStyle('table caption')?.getPropertyValue('font-size') === '1.3em');
```

Tu selector `table caption` debe tener una propiedad `font-weight` establecida en `normal`.
