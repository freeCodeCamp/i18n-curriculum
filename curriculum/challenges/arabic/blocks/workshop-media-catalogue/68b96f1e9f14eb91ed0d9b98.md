...
لرؤية استثناءك المخصص أثناء التنفيذ، حوّل السطر `catalogue.add(series2)` إلى `catalogue.add('series2')`.

# --hints--

يجب أن تحوّل السطر `catalogue.add(series2)` إلى `catalogue.add('series2')`.
