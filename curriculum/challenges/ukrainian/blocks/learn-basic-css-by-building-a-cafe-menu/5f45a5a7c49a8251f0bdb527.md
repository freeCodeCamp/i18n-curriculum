...
Використовуючи той самий селектор стилю з попереднього кроку, зробіть розмір шрифту елементів і цін більшим, використовуючи значення `18px`.

# --hints--

Ви повинні встановити властивість `font-size` у значення `18px`.
...
Використовуйте існуючий селектор `.item p`.
...
Ваші елементи `p`, вкладені в елементи `.item`, повинні мати властивість `font-size` зі значенням `18px`.
