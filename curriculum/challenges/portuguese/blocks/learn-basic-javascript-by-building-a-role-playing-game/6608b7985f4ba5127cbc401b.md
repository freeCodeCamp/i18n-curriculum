...
Atualize sua declaração no console para usar a notação de colchetes para acessar a propriedade `"Number of legs"` do objeto `cat`.

Abra o console para ver a saída.

# --hints--

Sua declaração no console agora deve ter o valor de `cat["Number of legs"]`.
