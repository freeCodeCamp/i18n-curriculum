...
Ndani ya kichaguzi cha `.arm.left`, badilisha asili ya kitendakazi cha `transform` iwe kona ya juu kushoto ya mzazi wake.
...
Unapaswa kumpa `.arm.left` `transform-origin` ya `0% 0%` au `top left`.
