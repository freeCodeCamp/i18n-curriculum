...
Na função `defeatMonster`, defina `gold` como `gold` mais o nível do monstro vezes `6.7`. Remember you can get the monster's level by using `monsters[fighting].level`.
