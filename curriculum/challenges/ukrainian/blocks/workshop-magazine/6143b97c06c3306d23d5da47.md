...
У межах вашого елемента `article` створіть елемент `h3` з множиною `class`, встановленою в `list-title`, і текстом `A Brief History`. Нижче створіть елемент `p` з текстом `Of the Curriculum`. Потім створіть елемент `ul` з класом `lists`.
...
Ваші елементи всередині елемента `article` повинні бути в правильному порядку.
...
Ваш новий елемент `h3` повинен мати множину `class`, встановлену в `list-title`.
...
Ваш новий елемент `ul` повинен мати множину `class`, встановлену в `lists`.
