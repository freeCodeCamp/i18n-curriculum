...
Unahitaji kujua ni alama ngapi za kupigia simu inapaswa kuendeshwa. Kumbuka kwamba:

- Kila lango lina safu ya data ya `queue` inayoonyesha idadi ya washiriki wanaowasili katika kila alama ya kupigia.  
- Kwa kuwa milango yote ina idadi sawa ya alama za kupigia, unaweza kutumia tu urefu wa foleni ya lango la kwanza.  

Unda kigezo kinachoitwa `maxTicks` na weka thamani ya `gates[0].queue.length`.

Thamani hii itatumika kudhibiti mzunguko wa simu yako, kuhakikisha kila alama ya kupigia inashughulikiwa kwa milango yote. 

# --hints--

Unapaswa kuunda kigezo kinachoitwa `maxTicks` na weka thamani ya `gates[0].queue.length`.
