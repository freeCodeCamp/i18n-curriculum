...
Deberías usar la sintaxis de literales de plantilla para asignar la cadena `Here is an example of using the length property on the word [subject].` a la variable `strLengthIntro`.
