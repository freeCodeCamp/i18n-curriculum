...
4. O método `add` deve:
    ...
    - Use o valor do hash calculado para armazenar o par chave-valor dentro do dicionário `collection`. 
    - Se várias chaves produzirem o mesmo valor de hash, seus pares chave-valor devem ser armazenados em um dicionário aninhado sob o mesmo valor de hash.
