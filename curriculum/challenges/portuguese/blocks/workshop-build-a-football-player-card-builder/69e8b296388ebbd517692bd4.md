...
O terceiro elemento `div` de `className` de `form-group` deve ter um `label` com o atributo `htmlFor` de `pas`, um `className` de `label` e um texto `PAS`.
...
O terceiro elemento `div` de `className` de `form-group` deve ter um elemento `input` com um `className` de `input`, um `id` de `pas` e um `type` de `number`.
...
O quarto elemento `div` de `className` de `form-group` deve ter um `label` com um atributo `htmlFor` de `dri`, um `className` de `label` e um texto `DRI`.
...
O quarto elemento `div` de `className` de `form-group` deve ter um `input` com um `className` de `input`, um `id` de `dri` e um `type` de `number`.
