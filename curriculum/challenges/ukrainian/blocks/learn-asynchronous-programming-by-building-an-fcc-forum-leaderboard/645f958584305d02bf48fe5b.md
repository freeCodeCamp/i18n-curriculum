...
Наприкінці вашого методу `map` додайте виклик методу `join()`. Для роздільника передайте порожній рядок.

# --hints--

Ви маєте додати виклик методу `join` до методу `map` і використати порожній рядок як роздільник.
