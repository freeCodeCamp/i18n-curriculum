...
Тепер слід перейти до `Start listening` CTA, щоб зробити його справжньою кнопкою.

Призначте йому утилітні класи `bg-indigo-100`, `px-4`, `py-2`, `text-center`, `font-semibold`, `text-indigo-700` і `hover:bg-indigo-200`.

# --hints--

Ваш елемент посилання має мати клас `bg-indigo-100`.
...
Ваш елемент посилання має мати клас `px-4`.
...
Ваш елемент посилання має мати клас `py-2`.
...
Ваш елемент посилання має мати клас `text-center`.
...
Ваш елемент посилання має мати клас `font-semibold`.
...
Ваш елемент посилання має мати клас `text-indigo-700`.
...
Ваш елемент посилання має мати клас `hover:bg-indigo-200`.
