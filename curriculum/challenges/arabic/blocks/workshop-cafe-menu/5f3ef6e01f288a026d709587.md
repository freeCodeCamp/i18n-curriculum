...
يمكنك استخدام عنصر `hr` لعرض فاصل بين أقسام المحتوى المختلفة.
...
أضف أولًا عنصر `hr` بين عنصر `p` الذي يحمل الصنف `established` وأول عنصر `section`.

لاحظ أن عنصر `hr` هو عنصر فارغ.
...
عنصر `hr` هو عنصر فارغ، فلا يجب أن يحتوي على وسم إغلاق `</hr>`.

```js
assert.notMatch(code, /<\/hr>/i);
```

لا تغير عنصر `p` الموجود لديك والذي يحمل الصنف `established`.
...
يجب أن يكون عنصر `hr` بين عنصر `p` وعنصر `section`.
