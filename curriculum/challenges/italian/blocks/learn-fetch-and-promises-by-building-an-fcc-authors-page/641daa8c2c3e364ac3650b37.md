...
Aggiungi un elemento `div` sopra la biografia dell’autore e dagli il `class` `"purple-divider"`.
...
Il tuo elemento `div` dovrebbe avere il set `class` impostato su `"purple-divider"`.
