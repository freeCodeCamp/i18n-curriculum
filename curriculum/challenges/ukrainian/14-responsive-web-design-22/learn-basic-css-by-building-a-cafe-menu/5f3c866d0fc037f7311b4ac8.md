...
Так ближче, але ціна не залишилась в правій частині. Це тому що елементи `inline-block` займають лише ширину свого вмісту. Щоб розділити їх, додайте властивість `width` до селекторів класів `flavor` та `price`, кожен з яких має значення `50%`.
