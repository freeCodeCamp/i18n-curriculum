...
title: 'Aufgabe 41: Pandigitale Primzahl'
challengeType: 1
forumTopicId: 302078
...
Wir sagen, dass eine `n`-stellige Zahl pandigital ist, wenn sie alle Ziffern von 1 bis `n` genau einmal verwendet. Zum Beispiel ist 2143 eine 4-stellige pandigitale Zahl und außerdem eine Primzahl.

Was ist die größte pandigitale Primzahl mit `n` Ziffern, die existiert?
