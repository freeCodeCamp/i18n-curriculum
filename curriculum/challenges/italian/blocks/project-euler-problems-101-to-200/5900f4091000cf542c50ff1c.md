...
title: 'Problema 157: risolvere l’equazione diofantea'
challengeType: 1
forumTopicId: 301788
...
Considera l’equazione diofantea $\frac{1}{a} + \frac{1}{b} = \frac{p}{{10}^n}$ con $a$, $b$, $p$, $n$ numeri interi positivi e $a ≤ b$.
