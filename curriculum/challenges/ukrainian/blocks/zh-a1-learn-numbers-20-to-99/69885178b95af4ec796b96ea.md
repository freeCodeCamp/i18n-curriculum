...
У китайській мові число 80 називається `八十 (bā shí)`.

Числа від 81 до 89 утворюються шляхом додавання цифри одиниць (1–9) після `八十 (bā shí)` (80).
...
Я практикувався у вимові чисел від 80 до 89.
