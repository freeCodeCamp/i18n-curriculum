...
Dentro del elemento `form`, agrega un elemento `label`. Tu elemento `label` debe tener el texto `Search for fruits:` y un atributo `htmlFor` con el valor `"search-input"`.

# --hints--

Debes tener un elemento `label` dentro del elemento `form`.
...
El elemento `label` debe tener un atributo `htmlFor` con el valor `"search-input"`.
...
Tu elemento `label` debe tener el texto `Search for fruits:`.
