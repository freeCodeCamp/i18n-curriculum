...
Це означає відбуватися одночасно з чимось іншим таким чином, що виникає конфлікт.

# --explanation--

`To clash` означає відбуватися одночасно з чимось іншим, через що важко зробити обидва. Наприклад:

`My dentist appointment clashed with our team meeting.` – Це означає, що у людини було дві події одночасно, і вона не могла бути на обох.
