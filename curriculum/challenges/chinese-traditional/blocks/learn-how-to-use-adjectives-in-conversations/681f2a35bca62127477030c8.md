...
`Plug-and-play` means something is ready to use right away, without needing complex installation. 例如：

`The printer was plug-and-play. We just connected it and it worked.` – This means no extra steps were needed.

`User-friendly` means something is designed to be simple and easy for people to use. 例如：
