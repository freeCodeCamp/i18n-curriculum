...
Crea una constante llamada `linkClass` y asígnale un literal de plantilla. Dentro de ese literal de plantilla, añade el valor de `category ${selectedCategory.className}`.
...
Deberías tener el valor de `category ${selectedCategory.className}` dentro del literal de plantilla.
