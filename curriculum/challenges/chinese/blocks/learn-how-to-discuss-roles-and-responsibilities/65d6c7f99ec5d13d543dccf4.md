...
单词 `interview` 用于描述一个会议，在这个会议中有人通过提问来查找某人是否适合某个工作或角色。这是招聘进程中的一个常见步骤。例如，`The company will interview candidates next week` 意味着公司将在下周提问，以确定谁最适合这份工作。
