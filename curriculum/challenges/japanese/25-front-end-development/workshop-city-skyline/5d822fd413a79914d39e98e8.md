...
`.background-buildings` で使用したものと同じ `display`、`align-items`、および `justify-content` プロパティと値を `.foreground-buildings` に追加してください。 この設定により、ここでもフレックスボックスを使用して、各ビルがコンテナーの下端に等間隔で配置されます。
