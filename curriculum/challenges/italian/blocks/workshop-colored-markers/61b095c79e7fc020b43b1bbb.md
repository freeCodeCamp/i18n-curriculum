...
Per il secondo argomento colore, usa un codice colore esadecimale con i valori `71` per il rosso, `F5` per il verde e `3E` per il blu.

# --hints--

La tua regola CSS `.green` dovrebbe avere una proprietà `background` impostata su `linear-gradient(180deg, #55680D, #71F53E)`.
