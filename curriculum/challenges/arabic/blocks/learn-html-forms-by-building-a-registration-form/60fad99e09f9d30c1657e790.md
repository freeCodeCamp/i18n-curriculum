...
وسّط عنصر الـ `form` بإعطائه `margin` بقيمة `0 auto`. ثم حدّد حجمه بعرض أقصى `500px` وعرض أدنى `300px`. ضمن هذا النطاق، اجعله يمتلك `width` بقيمة `60vw`.
