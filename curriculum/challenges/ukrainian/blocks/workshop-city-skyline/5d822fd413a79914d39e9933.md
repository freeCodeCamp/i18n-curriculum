...
Додайте ще один `repeating-linear-gradient` під тим, який ви щойно додали. Дайте йому напрямок `90deg`, використайте свій колір будівлі від `0%` до `12%` і колір вікна від `12%` до `44%`. Це створить багато прямокутних вікон.

# --hints--

Ви повинні дати `.fb5` другу властивість `repeating-linear-gradient` у властивості `background`.
...
Ви повинні дати другому `repeating-linear-gradient` напрямок `90deg`.
...
Ви повинні дати другому `repeating-linear-gradient` перший колір `--building-color2` від `0%` до `12%`.
...
Ви повинні дати другому `repeating-linear-gradient` другий колір `--window-color2` від `12%` до `44%`.
