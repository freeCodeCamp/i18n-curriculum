...
Dentro do elemento `tbody`, adicione quatro elementos `tr`. Dê aos três primeiros o atributo `class` definido como `data` e ao quarto o atributo `class` definido como `total`.
