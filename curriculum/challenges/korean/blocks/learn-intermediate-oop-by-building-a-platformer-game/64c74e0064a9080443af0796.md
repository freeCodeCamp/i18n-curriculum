...
그 아래에 `height` 속성을 추가하고 숫자 `proportionalSize(40)`을 할당하세요. `proportionalSize()`가 화면 크기에 비례하도록 `height` 함수를 사용해야 합니다.

속성에 접근하려면 `this` 키워드를 사용하세요.
...
`proportionalSize(40)` 속성에 `height`을 할당해야 합니다.
