...
Agrega un nuevo selector `#piano` dentro de tu consulta `@media`, y establece el `width` en `358px`.

# --hints--

Tu regla `@media` debe tener un selector `#piano`.
...
Tu nuevo selector `#piano` debe tener un `width` de `358px`.
