...
Ti viene dato un array di oggetti che rappresentano elementi da mettere in uno zaino. Gli oggetti hanno 4 attributi: nome, pezzi (il numero di quell'elemento specifico), peso e valore. Gli elementi devono essere selezionati in modo che il peso totale non superi il peso massimo e il valore sia massimizzato. Tieni presente che ogni elemento può comparire tra 0 e `pieces` volte.

# --instructions--

Scrivi una funzione per risolvere il problema dello zaino. La funzione riceve come parametri l'array di oggetti e il peso massimo. Deve restituire il valore totale massimo possibile.
