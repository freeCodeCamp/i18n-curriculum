...
Inoltre, definiamo $D_{A,B}(n)$ come la $n^{\text{esima}}$ cifra nel primo termine di $F_{A,B}$ che contiene almeno $n$ cifre.

Esempio:

Siano $A = 1\\,415\\,926\\,535$, $B = 8\\,979\\,323\\,846$. Vogliamo trovare $D_{A,B}(35)$, per esempio.
...
Quindi $D_{A,B}(35)$ è la ${35}^{\text{esima}}$ cifra del quinto termine, che è 9.

Ora usiamo per $A$ le prime 100 cifre di $π$ dopo la virgola:
...
e per $B$ le successive cento cifre:
