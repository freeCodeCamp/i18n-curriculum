...
Agrega otro `input` de tipo checkbox con los atributos `id`, `name` y `value` establecidos en `"recommendation"`.
...
Tu `input` de casilla de verificación debe tener un atributo `name` establecido en `"recommendation"`.
