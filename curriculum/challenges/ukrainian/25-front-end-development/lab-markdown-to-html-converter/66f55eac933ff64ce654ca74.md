...
Якщо значенням `#markdown-input` є `# title 1`, то `convertMarkdown()` має повернути `<h1>title 1</h1>`.
...
Якщо значенням `#markdown-input` є `# title 1\n# alternate title`, то `convertMarkdown()` має повернути `<h1>title 1</h1><h1>alternate title</h1>`.
...
Якщо значенням `#markdown-input` є `## title 2`, то `convertMarkdown()` має повернути `<h2>title 2</h2>`.
...
Якщо значенням `#markdown-input` є `## title 2\n## title 2 alt`, то `convertMarkdown()` має повернути `<h2>title 2</h2><h2>title 2 alt</h2>`.
...
Якщо значенням `#markdown-input` є `### title 3`, то `convertMarkdown()` має повернути `<h3>title 3</h3>`.
...
Якщо значенням `#markdown-input` є `### title 3\n### third title`, то `convertMarkdown()` має повернути `<h3>title 3</h3><h3>third title</h3>`.
...
Якщо значенням `#markdown-input` є `**this is bold**`, то `convertMarkdown()` має повернути `<strong>this is bold</strong>`.
...
Якщо значенням `#markdown-input` є `**this is bold**\n**this is also bold**`, то `convertMarkdown()` має повернути `<strong>this is bold</strong><strong>this is also bold</strong>`.
...
Якщо значенням `#markdown-input` є `__this is bold__\n__this is also bold__`, то `convertMarkdown()` має повернути `<strong>this is bold</strong><strong>this is also bold</strong>`.
...
Якщо значенням `#markdown-input` є `*this is italic*`, то `convertMarkdown()` має повернути `<em>this is italic</em>`.
...
Якщо значенням `#markdown-input` є `*this is italic*\n*this is also italic*`, то `convertMarkdown()` має повернути `<em>this is italic</em><em>this is also italic</em>`.
...
Якщо значенням `#markdown-input` є `_this is italic_`, то `convertMarkdown()` має повернути `<em>this is italic</em>`.
...
Якщо значенням `#markdown-input` є `_this is italic_\n_this is also italic_`, то `convertMarkdown()` має повернути `<em>this is italic</em><em>this is also italic</em>`.
...
Якщо значенням `#markdown-input` є `# **title 1**` або `# __title 1__`, то `convertMarkdown()` має повернути `<h1><strong>title 1</strong></h1>`.
...
Якщо значенням `#markdown-input` є `![alt-text](image-source)`, то `convertMarkdown()` має повернути `<img alt="alt-text" src="image-source">`.
...
Якщо значенням `#markdown-input` є `![alt-text](image-source)\n![alt-text-2](image-source-2)`, то `convertMarkdown()` має повернути `<img alt="alt-text" src="image-source"><img alt="alt-text-2" src="image-source-2">`.
...
Якщо значенням `#markdown-input` є `[link text](URL)`, то `convertMarkdown()` має повернути `<a href="URL">link text</a>`.
...
Якщо значенням `#markdown-input` є `[link text](URL)\n[link text 2](URL2)`, то `convertMarkdown()` має повернути `<a href="URL">link text</a><a href="URL2">link text 2</a>`.
...
Якщо значенням `#markdown-input` є `> this is a quote`, то `convertMarkdown()` має повернути `<blockquote>this is a quote</blockquote>`.
...
Якщо значенням `#markdown-input` є `> this is a quote\n> this is another quote`, то `convertMarkdown()` має повернути `<blockquote>this is a quote</blockquote><blockquote>this is another quote</blockquote>`.
...
Якщо значенням `#markdown-input` є `> **this is a *quote***`, то `convertMarkdown()` має повернути `<blockquote><strong>this is a <em>quote</em></strong></blockquote>`.
