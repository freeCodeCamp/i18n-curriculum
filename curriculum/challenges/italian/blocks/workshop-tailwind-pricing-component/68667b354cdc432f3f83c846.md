...
Aggiungi le classi `text-lg`, `font-semibold` e `text-fuchsia-200` all'elemento `h2` del piano premium.
...
Il tuo elemento `h2` dovrebbe avere la classe `text-fuchsia-200`.
