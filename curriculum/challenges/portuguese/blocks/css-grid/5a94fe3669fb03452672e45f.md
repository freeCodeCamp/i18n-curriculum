...
Você também pode repetir múltiplos valores com a função repeat e inserir a função entre outros valores ao definir uma estrutura de grid. Veja como fica:
...
**Nota:** O `1fr 50px` é repetido duas vezes seguido por 20px.
