...
Este verbo pergunta sobre eventos ou atividades atuais no trabalho de Brian. Ele termina em `-ing`.
...
Este substantivo refere-se ao trabalho ou tarefa específica em que Brian está envolvido.
