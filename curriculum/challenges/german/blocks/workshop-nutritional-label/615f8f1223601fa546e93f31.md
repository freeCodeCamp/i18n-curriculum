...
Erstellen Sie das letzte `p`-Element für Ihren `.daily-value`-Abschnitt. Geben Sie ihm den Text `Potassium 235mg 6%`. Richten Sie den `6%`-Text rechtsbündig aus, und entfernen Sie den unteren Rahmen des `p`-Elements.
...
Ihr neues `p`-Element sollte den Text `Potassium 235mg 6%` enthalten.
