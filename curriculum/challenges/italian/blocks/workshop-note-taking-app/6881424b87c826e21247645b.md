...
Una volta ottenuto il contenuto modificato, questo sarà il contenuto corrente.

All'interno del listener dell'evento, assegna `newContent` a `currentContent`.

# --hints--

Dovresti assegnare `newContent` a `currentContent` all'interno del listener dell'evento.
