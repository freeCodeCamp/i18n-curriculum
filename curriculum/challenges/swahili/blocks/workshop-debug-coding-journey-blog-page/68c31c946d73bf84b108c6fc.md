...
Kwa kuwa sehemu yote inayojumuisha machapisho ya blogu inawakilisha maudhui kuu ya ukurasa, inapaswa kufunikwa na kipengele cha `main`. Hii husaidia visomaji vya skrini na teknolojia nyingine za kusaidia kuelewa muundo wa ukurasa vizuri zaidi.
...
Kipengele chako cha `main` kinapaswa kuwa na vipengele vyote vitatu vya `article` ndani yake.
