...
لجعل قدمي البطريق تبدوان أكثر _بطريقية_، قم بتدوير القدم اليسرى بمقدار `80deg`، واليمنى بمقدار `-80deg`.

# --hints--

يجب أن تعطي `.foot.left` خاصية `transform` بقيمة `rotate(80deg)`.
...
يجب أن تعطي `.foot.right` خاصية `transform` بقيمة `rotate(-80deg)`.
