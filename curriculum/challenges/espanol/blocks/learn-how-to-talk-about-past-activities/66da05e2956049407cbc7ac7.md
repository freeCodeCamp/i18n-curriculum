...
`Significant` refers to something large or important enough to be noticed or to have an impact. Por ejemplo:
...
`Drop` means a decrease in amount or level. Por ejemplo:
