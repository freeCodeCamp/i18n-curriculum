...
بالنقر على روابط التنقل (navigation links) يجب أن يقفز نافذة العرض (viewport) إلى القسم ذي الصلة بالرابط. ومع ذلك، يمكن أن يكون هذا القفز مربكًا لبعض المستخدمين.

حدد جميع العناصر، وعيّن `scroll-behavior` ألى `smooth`.
...
يجب عليك إعطاء `*` خاصية `scroll-behavior` بقيمة `smooth`.
