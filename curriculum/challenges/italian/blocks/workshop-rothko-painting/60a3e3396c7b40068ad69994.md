...
Dovresti impostare la proprietà `border-radius` su `30px 25px 60px 12px`.
...
Il tuo elemento `.three` dovrebbe avere un valore `border-radius` di `30px 25px 60px 12px`.
