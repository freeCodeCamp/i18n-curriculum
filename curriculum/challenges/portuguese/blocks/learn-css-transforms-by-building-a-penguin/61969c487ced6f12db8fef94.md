...
Selecione o elemento `.left-mountain` e defina a `width` e a `height` do elemento como `300px`. Então, defina o `background` como um gradiente linear começando em `rgb(203, 241, 228)` e terminando em `rgb(80, 183, 255)`.
