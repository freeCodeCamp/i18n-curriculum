...
Uma vez que os preços à direita têm significativamente menos caracteres, atualize a classe `flavor` com a `width` para `75%` e na classe de preço altere o `width` para `25%`.
