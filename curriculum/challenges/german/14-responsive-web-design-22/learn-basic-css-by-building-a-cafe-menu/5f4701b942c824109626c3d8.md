...
Füge nun die `bottom-line`-Klasse zum zweiten `hr`-Element hinzu, damit die Formatierung angewandt wird.
...
Deine `bottom-line`-Klasse sollte auf dein zweites `hr`-Element angewandt werden.
