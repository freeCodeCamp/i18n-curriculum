...
Перемістіть пропи та значення `display`, `flex-direction` і `align-items` з `.bb1` до нового класу `building-wrap`.

# --hints--

Ви повинні видалити `display` з `.bb1`.
...
Ви повинні видалити `flex-direction` з `.bb1`.
...
Ви повинні видалити `align-items` з `.bb1`.
