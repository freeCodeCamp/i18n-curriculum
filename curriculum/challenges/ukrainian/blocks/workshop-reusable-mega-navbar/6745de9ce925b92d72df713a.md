...
Всередині кожного елемента `li` створіть елемент посилання з атрибутом `href`, встановленим у `#`.

# --hints--

Ви маєте створити новий елемент `a` всередині кожного елемента списку та встановити його атрибут `href` у `#`.
