...
`Synchronization` refers to aligning elements so that they work together at the same time. 例如：
...
`Updated` is past participle of `update`. It means making something current or bringing it to the latest version. 例如：
