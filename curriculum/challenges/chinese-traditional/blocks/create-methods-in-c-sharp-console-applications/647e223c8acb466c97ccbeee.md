...
Complete the <a href="https://learn.microsoft.com/training/modules/create-c-sharp-methods-return-values/" target="_blank" rel="noreferrer">Create C# Methods that Return Values</a> module on Microsoft Learn. 然後，回答下面的問題。
