...
El `font-size` del elemento o del elemento padre.

---

El `font-size` del elemento `root`.
...
El `fontsize` del elemento `figure`.

### --feedback--

Revisa el final de esta lección para la respuesta.
