...
디오판틴 방정식 $\frac{1}{a} + \frac{1}{b} = \frac{p}{{10}^n}$를 고려하세요. 여기서 $a$, $b$, $p$, $n$은 양의 정수이고 $a ≤ b$입니다.

$n = 1$일 때 이 방정식은 아래에 나열된 20개의 해를 가집니다:
...
$1 ≤ n ≤ 9$일 때 이 방정식의 해는 몇 개입니까?

# --hints--

`diophantineEquation()`는 `53490`을 반환해야 합니다.
