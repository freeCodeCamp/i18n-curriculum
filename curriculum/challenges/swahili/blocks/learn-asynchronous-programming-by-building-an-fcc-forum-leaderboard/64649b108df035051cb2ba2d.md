...
Kwa tagi ya nanga ya ufunguzi `a`, weka sifa ya kipengele `target` kuwa `"_blank"`. Kisha, weka sifa ya kipengele `href` kuwa `${forumTopicUrl}${slug}/${id}`. 

Na kwa mabadiliko hayo, mradi wako wa orodha ya viongozi wa jukwaa la freeCodeCamp sasa umekamilika!

# --hints--

Tagi yako ya nanga ya ufunguzi inapaswa kuwa na sifa ya kipengele `target` iliyowekwa kuwa `"_blank"`.
...
Tagi yako ya nanga ya ufunguzi inapaswa kuwa na sifa ya kipengele `href` iliyowekwa kuwa `${forumTopicUrl}${slug}/${id}`.
