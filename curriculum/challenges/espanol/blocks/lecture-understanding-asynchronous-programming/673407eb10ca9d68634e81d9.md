...
El objeto position contiene varias propiedades, donde las más comúnmente usadas son `latitude` y `longitude`, pero también puede incluir `altitude`, `accuracy`, `speed` y `heading`, entre otras.
