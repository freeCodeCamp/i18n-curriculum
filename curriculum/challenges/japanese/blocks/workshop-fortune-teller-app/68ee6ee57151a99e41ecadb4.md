...
今、`showElements` 関数を呼び出し、`multipleCard`、`fortuneContainer`、`text` をプロップとして渡してください。

# --hints--

`showElements` 関数は `multipleCardSelected` メソッドの中で呼び出す必要があります。
...
`text` を `showElements` 関数の引数として渡してください。
