...
Katika warsha hii utaunda programu ya kuimba muziki inayoweza kuimba, kusitisha, na kuruka nyimbo kutoka kwenye orodha ya nyimbo.

HTML na CSS za mradi huu zimekwisha tolewa kwako, hivyo unaweza kuwa makini zaidi na JavaScript.

Anza kwa kupata upatikanaji wa vipengele vya `#playlist-songs`, `#play`, na `#pause` na weka thamani zao katika vigezo `playlistSongs`, `playButton` na `pauseButton`, kwa mtiririko huo.
...
Unapaswa kuweka thamani ya kipengele cha `#playlist-songs` katika kigezo `playlistSongs`. 
...
Unapaswa kuweka thamani ya kipengele cha `#play` katika kigezo `playButton`. 
...
Unapaswa kuweka thamani ya kipengele cha `#pause` katika kigezo `pauseButton`. 
