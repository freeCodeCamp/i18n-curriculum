...
Ви повинні надати `.fb5` другий `repeating-linear-gradient` в властивості `background`.
...
Ви повинні надати другому `repeating-linear-gradient` напрямок `90deg`.
...
Ви повинні надати другому `repeating-linear-gradient` перший колір `--building-color2` від `0%` до `12%`.
...
Ви повинні надати другому `repeating-linear-gradient` другий колір `--window-color2` від `12%` до `44%`.
