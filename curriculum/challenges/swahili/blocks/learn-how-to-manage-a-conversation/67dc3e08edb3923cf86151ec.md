...
- **Noah:** `The meeting is at 3 PM, right?` - This person is affirming something (the time of the meeting) and asking for confirmation.

- **Sarah:** `Yes, that's correct.` - Here, `that` refers to what Noah affirmed (`The meeting is at 3 PM`).
