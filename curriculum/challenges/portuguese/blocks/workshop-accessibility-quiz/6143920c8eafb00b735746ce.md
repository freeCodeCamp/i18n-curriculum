...
Embora você tenha adicionado um `placeholder` ao primeiro elemento `input` em uma lição anterior, isso na verdade não é uma boa prática para acessibilidade; com muita frequência, os usuários confundem o texto do placeholder com um valor real de entrada - eles pensam que já existe um valor no input.
