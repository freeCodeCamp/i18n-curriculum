...
Entfernen Sie jetzt die beiden `print`-Aufrufe aus Ihrem Code.

# --hints--

Sie sollten die `print(movie1.__doc__)`-Zeile löschen.
...
Sie sollten die `print(series1.__doc__)`-Zeile löschen.
