...
`resolution_streak([[10000, 120, 5], [10950, 121, 11]])` 應該傳回 `"決議過程在第 2 天失敗：連續失敗 1 天。"`
...
`resolution_streak([[15000, 110, 8], [12300, 60, 13], [10100, 120, 4], [9000, 125, 4]])` 應該傳回 `"第 3 天決議過程失敗：連續失敗 2 天。"`
...
`resolution_streak([[11600, 76, 13], [12556, 64, 26], [10404, 32, 59], [9999, 44, 124], [7508, 23, 167], [10900, 80, 0]])` 應該傳回 `"第 4 天決議失敗：連續失敗 3 天。"`
...
`resolution_streak([[10500, 75, 15], [11000, 90, 10], [10650, 100, 9], [10200, 60, 10], [10678, 87, 9], [12431, 67, 13], [10444, 107, 19], [10111, 95, 5], [10000, 120, 7], [11980, 101, 8]])` 應該傳回「決議過程順利：連續 10 天。」
