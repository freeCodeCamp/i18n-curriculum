...
Setzen Sie jetzt die `height` für `.one` auf 150 Pixel.

# --hints--

Sie sollten die `height`-Eigenschaft auf `150px` setzen.
...
Ihr `.one`-Element sollte einen `height`-Wert von `150px` haben.
