...
**Objetivo:** Cumprir as histórias de usuário abaixo e fazer com que todos os testes sejam aprovados para completar o laboratório.
...
Os elementos `th` na primeira coluna devem ter a `class` de `time` e conter valores de tempo.
