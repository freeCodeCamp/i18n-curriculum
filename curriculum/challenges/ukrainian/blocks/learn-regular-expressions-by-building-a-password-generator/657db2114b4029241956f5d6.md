...
Змініть оголошення функції так, щоб вона приймала параметри за замовчуванням. Використайте `16` для `length` і `1` для інших обмежень.

# --hints--

Ваша функція має приймати параметри за замовчуванням.
