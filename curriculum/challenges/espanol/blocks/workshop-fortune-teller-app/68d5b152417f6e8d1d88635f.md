...
Hay más propiedades que agregar a la interfaz `Card`. Comienza estableciendo `value_int` con el tipo `number`. Todas las demás propiedades deben ser del tipo `string`: `suit`, `type`, `img`, `meaning_up`, `meaning_rev` y `desc`.

# --hints--

Debes tener una propiedad `value_int` con un tipo `number`.
...
Debes tener una propiedad `suit` con un tipo `string`.
...
Debes tener una propiedad `type` con un tipo `string`.
...
Debes tener una propiedad `img` con un tipo `string`.
...
Debes tener una propiedad `meaning_up` con un tipo `string`.
...
Debes tener una propiedad `meaning_rev` con un tipo `string`.
...
Debes tener una propiedad `desc` con un tipo `string`.
