...
Hoja ya pili kwa njia ya `.replace()` haipaswi kuwa mfuatano wa herufi. Badala yake, unaweza kupitisha kitendakazi cha mwitiko ili kuendesha mantiki tata zaidi kwenye mfuatano wa herufi uliolingana.

Kitendakazi cha mwitiko kinachukua vigezo vichache. Kwanza ni mfuatano wa herufi uliolingana. Pitisha kitendakazi cha mwitiko tupu kwa wito wako wa `.replace()`, na kipa kigezo cha `match`.

# --hints--

Unapaswa kupitisha kitendakazi cha mshale kama hoja ya pili kwa njia yako ya `.replace()`.
...
Kitendakazi chako cha mshale kinapaswa kuchukua kigezo cha `match`.
