...
Um einen Teil des vertikalen Leerraums zwischen dem Element `h1` und dem Text `Est. 2020` zu entfernen, verändere die bottom margin des `h1` zu `15px`.

# --hints--

Du solltest die `margin-bottom`-Eigenschaft auf `15px` setzen.
...
Dein `h1`-Element sollte einen `margin-bottom` von `15px` haben.
