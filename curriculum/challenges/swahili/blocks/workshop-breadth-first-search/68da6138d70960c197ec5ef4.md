...
Kitendakazi chako sasa kimekamilika. Kijaribu tena kwa kuchapisha `gen_parentheses(2)` badala ya `gen_parentheses(1)`.

# --hints--

Unapaswa kuchapisha `gen_parentheses(2)`.
...
Haupaswi kuwa na `print(gen_parentheses(1))` katika msimbo wako
