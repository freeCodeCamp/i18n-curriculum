...
调整 `verify_card_number` 调用，以便如果它返回 `True`，则将 `'VALID!'` 打印到控制台。 否则，打印`'INVALID!'`。

# --hints--

你应该在 `main` 函数中添加 `if verify_card_number(translated_card_number):` 。
