...
線の端に沿った灰色の色に注目してください。これらの端は<dfn>ボーダー</dfn>と呼ばれます。要素の各辺は異なる色にすることも、すべて同じ色にすることもできます。

`hr` 要素のすべての端を、その背景色と同じ色に `border-color` プロパティを使って設定してください。

# --hints--

`border-color` プロパティを `brown` に設定してください。
...
`hr` 要素の `border-color` は `brown` であるべきです。
