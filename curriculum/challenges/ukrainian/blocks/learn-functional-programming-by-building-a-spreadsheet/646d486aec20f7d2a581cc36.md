...
На жаль, ця властивість `children` повертає колекцію елементів, яка схожа на масив, але не є масивом. Обгорніть свій другий аргумент у `Array.from()`, щоб перетворити його на масив.

# --hints--

Ви повинні обгорнути свій `document.getElementById('container').children` у `Array.from()`.
