...
A function call, or invocation, is when we actually use or execute the function. Para llamar a una función, necesitarás referenciar el nombre de la función seguido de un conjunto de paréntesis:
