...
Sempre all'interno del loop `while`, incrementa il valore di `leftArrayIndex` di 1.

# --hints--

Dovresti incrementare il valore corrente di `leftArrayIndex` di `1` dopo aver assegnato l'elemento della parte sinistra all'array ordinato.
