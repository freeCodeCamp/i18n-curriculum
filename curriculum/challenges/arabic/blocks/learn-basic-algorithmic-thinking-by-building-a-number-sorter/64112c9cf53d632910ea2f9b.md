...
بعد حلقة while، تحتاج إلى إدخال القيمة الحالية. تذكر أن الحلقة تنتهي عندما يكون `j` خارج حدود المصفوفة، أو عندما تكون القيمة عند `j` أقل من قيمتك الحالية.

استخدم معامل التعيين لإدخال قيمتك الحالية في الفهرس الصحيح.

# --hints--

يجب تعيين `currValue` إلى الفهرس `j + 1`.
