...
Sentences with the verb `to be` are often used to describe feelings and emotions. In the present simple tense, you use it to talk about how you feel right now. Kwa mfano:
