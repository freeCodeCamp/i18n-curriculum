...
Entfernen Sie die Anführungszeichen um `series2`, um die Zeile wiederherzustellen, die Sie zuvor geändert haben.

# --hints--

Sie sollten `catalogue.add(series2)` in Ihrem Code haben.
