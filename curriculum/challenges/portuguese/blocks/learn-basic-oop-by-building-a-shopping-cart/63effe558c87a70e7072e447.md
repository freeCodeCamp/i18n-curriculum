...
O comportamento do método `addItem` precisa mudar se o produto já estiver no carrinho ou não.Crie um operador ternário que verifique se o produto atual já está no carrinho.Use `undefined` para expressões verdadeiras e falsas para evitar um erro de sintaxe.
...
Você deve usar um operador ternário com sua condição `currentProductCount > 1`.
