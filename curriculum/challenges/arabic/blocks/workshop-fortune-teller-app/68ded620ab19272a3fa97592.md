...
بما أن المشروع يعمل الآن مع عناصر HTML DOM، تحتاج إلى طريقة لعرض الحظ على DOM.

أعلن عن دالة باسم `renderCard` تأخذ أربع معلمات: `drawingType`، `isReversed`، `shortName`، و`img`، وتُرجع قالب نصي.

يجب أن تكون المعلمات `drawingType`، `shortName`، و`img` من نوع `string`، بينما يجب أن تكون `isReversed` من نوع `boolean`. يجب أن تكون الدالة ذات نوع إرجاع `string`.

# --hints--

يجب أن يكون لديك دالة باسم `renderCard`.
...
يجب أن تحتوي دالة `renderCard` على أربع معلمات.
...
يجب أن تكون المعلمة الأولى `drawingType` من نوع `string`.
...
يجب أن تكون المعلمة الثانية `isReversed` من نوع `boolean`.
...
يجب أن تكون المعلمة الثالثة `shortName` من نوع `string`.
...
يجب أن تكون المعلمة الرابعة `img` من نوع `string`.
...
يجب أن تكون دالة `renderCard` ذات نوع إرجاع `string`.
...
يجب أن تُرجع دالة `renderCard` نص قالب.
