...
title: 'Problema 461: quasi pi greco'
challengeType: 1
forumTopicId: 302136
...
Sia `f(k, n)` = $e^\frac{k}{n} - 1$, per tutti i numeri interi non negativi `k`.

Sorprendentemente, `f(6, 200) + f(75, 200) + f(89, 200) + f(226, 200)` = 3.1415926… ≈ π.

In effetti, è la migliore approssimazione di π della forma `f(a, 200) + f(b, 200) + f(c, 200) + f(d, 200)`.
