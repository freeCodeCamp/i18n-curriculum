...
Todos os elementos `img` devem ter um atributo `alt`. O texto do atributo `alt` é usado por leitores de tela para melhorar a acessibilidade e é exibido se a imagem não carregar. 
