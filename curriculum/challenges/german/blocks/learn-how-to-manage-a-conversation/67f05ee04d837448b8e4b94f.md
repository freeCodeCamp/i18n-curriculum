...
`Probably` is used to show that something is likely or expected to happen, but it's not completely certain. It expresses a high level of possibility. Zum Beispiel:
