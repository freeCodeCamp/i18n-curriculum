...
Sasa uko tayari kuanza kupanga mpangilio wa gridi. Katika mafundisho yaliyopita ulijifunza kwamba CSS Grid hutoa mpangilio wa gridi wenye vipimo viwili, unaokuwezesha kuweka vitu katikati kwa usawa na wima huku ukidumisha udhibiti wa kufanya mambo kama vile kuweka vitu juu ya vingine.

Anza kwa kuunda kichaguzi cha `main` na kumnyazia sifa ya `display` iliyowekwa kuwa `grid`.
...
Kichaguzi chako cha `main` kinapaswa kuwa na sifa ya `display` iliyowekwa kuwa `grid`.
