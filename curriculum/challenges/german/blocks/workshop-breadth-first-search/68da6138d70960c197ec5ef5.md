...
Jetzt müssen Sie die Warteschlange nicht mehr ausgeben. Entfernen Sie also `print(queue)` aus Ihrer `while` Schleife.
# --hints--

Sie sollten `print(queue)` nicht in Ihrer `while` Schleife haben.
