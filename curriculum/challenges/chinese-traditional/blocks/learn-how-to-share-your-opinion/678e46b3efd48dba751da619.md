...
`Selection` refers to the range or variety of options available from which you can choose. It's used to describe a large number of items that offer choices. 例如：
...
`Extensions` are additional parts or features that can be added to a software application to enhance or extend its capabilities. 例如：
