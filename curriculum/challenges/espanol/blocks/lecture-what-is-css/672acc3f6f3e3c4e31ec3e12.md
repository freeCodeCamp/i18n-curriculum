...
En esta lección, nos enfocaremos en cómo funciona la propiedad `inline-block` y cómo se diferencia tanto de los elementos inline como de nivel bloque.
...
Pero, si quita la propiedad `display: inline-block`, ni la `height` ni el `width` se aplicarán aunque lo haya definido claramente.
