...
Aparte del CTA `Go Premium`, el resto del contenido está en un `div`. Eso hace que CSS grid sea una buena opción para organizar todo.

Agrega las clases `grid`, `grid-rows-[auto_auto_auto_1fr]` y `gap-y-2` al `div` que envuelve los elementos `h2`, `p` y `ul`.

# --hints--

Tu elemento `div` que envuelve los elementos `h2`, `p` y `ul` debe tener la clase `grid`.
...
Tu elemento `div` que envuelve los elementos `h2`, `p` y `ul` debe tener la clase `grid-rows-[auto_auto_auto_1fr]`.
...
Tu elemento `div` que envuelve los elementos `h2`, `p` y `ul` debe tener la clase `gap-y-2`.
