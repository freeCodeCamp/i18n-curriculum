...
Це скорочення від `I have`, що вказує на те, що Софі щось знайшла або зіштовхнулася з цим.
...
Це скорочення від `cannot`, що показує складність Софі у визначенні проблеми.
