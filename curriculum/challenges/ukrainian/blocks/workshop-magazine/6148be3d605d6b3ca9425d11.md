...
Потрібно також стилізувати підзаголовок. Створіть селектор `.hero-subtitle` і надайте йому властивість `font-size` зі значенням `2.4rem`, властивість `color` зі значенням `orangered` та властивість `text-align` зі значенням `center`.

# --hints--

У вас має бути селектор `.hero-subtitle`.
