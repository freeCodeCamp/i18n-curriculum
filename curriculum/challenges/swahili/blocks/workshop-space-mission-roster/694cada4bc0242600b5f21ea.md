...
Wafanyakazi wengine wa kikosi chako wameundwa katika safu ya data iitwayo `remainingCrew` yenye data zifuatazo:

| id | jina | jukumu | isEVAEligible | kipaumbele |
| -- | ---- | ------ | ------------- | ---------- |
...
Pitia safu ya data ya `remainingCrew` na ongeza kila mwanasayansi wa anga katika `squad` kwa kutumia kitendakazi cha `addCrewMember()`.

# --hints--

Unapaswa kutumia mzunguko wa `for` kufanya wito wa `addCrewMember()` kwa kila mwanasayansi wa anga katika `remainingCrew`.
