...
Тепер настав час вивчити числа в діапазоні 50-х.

Китайською числу 50 відповідає `五十 (wǔ shí)`.

Числа від 51 до 59 утворюються шляхом додавання цифри одиниць (1–9) після `五十 (wǔ shí)` (50).
