...
`getBingoLetter(75)` dovrebbe restituire `"O"`.

```js
assert.equal(getBingoLetter(75), "O");
```

`getBingoLetter(54)` dovrebbe restituire `"G"`.

```js
assert.equal(getBingoLetter(54), "G");
```

`getBingoLetter(25)` dovrebbe restituire `"I"`.

```js
assert.equal(getBingoLetter(25), "I");
```

`getBingoLetter(38)` dovrebbe restituire `"N"`.

```js
assert.equal(getBingoLetter(38), "N");
```

`getBingoLetter(11)` dovrebbe restituire `"B"`.
