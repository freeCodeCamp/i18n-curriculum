...
Drehen Sie `.three` gegen den Uhrzeigersinn um 0,2 Grad.

Mit diesem letzten Schritt ist Ihr Rothko-Gemälde nun fertig.

# --hints--

Sie sollten die `transform`-Eigenschaft auf `rotate(-0.2deg)` setzen.
...
Ihr `.three`-Element sollte einen `transform`-Wert von `rotate(-0.2deg)` haben.
