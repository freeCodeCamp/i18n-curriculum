...
Tu quinto elemento `div` de `className` de `form-group` debe tener un `label` con un atributo `htmlFor` de `def`, un `className` de `label` y un texto `DEF`.
...
Tu quinto elemento `div` de `className` de `form-group` debe tener un `input` con un `className` de `input`, un `id` de `def` y un `type` de `number`.
...
Tu sexto elemento `div` de `className` de `form-group` debe tener un `label` con un atributo `htmlFor` de `phy`, un `className` de `label` y un texto `PHY`.
...
Tu cuarto elemento `div` de `className` de `form-group` debe tener un `input` con un `className` de `input`, un `id` de `phy` y un `type` de `number`.
