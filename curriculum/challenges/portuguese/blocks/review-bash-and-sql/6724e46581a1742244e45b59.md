...
- SQL significa Structured Query Language, uma linguagem para comunicação com bancos de dados relacionais.
...
Essa consulta retornaria todos os usuários porque a condição `OR '1'='1'` é sempre verdadeira, permitindo que invasores contornem as verificações de login.
