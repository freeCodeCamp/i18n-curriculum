...
이 연습 작업은 듣기 이해력을 확인합니다. 회사에 대해 언급된 주요 사실에 포커스하세요.
...
잘 들어보세요. 그 숫자는 독백에서 다른 것을 가리킵니다.
...
독백에서 두 가지 다른 숫자가 언급됩니다. 하나는 직원 수를, 다른 하나는 부서 수를 나타냅니다. 이 세부사항을 이해하는 데 도움이 되는 주요 어휘와 구조를 검토해 봅시다. 예를 들어:

- `Tiene setenta y tres empleados.` - 직원이 일흔세 명 있습니다.
- `Tiene ocho departamentos.` - 부서가 여덟 개 있습니다.

`Tiene`는 소유를 나타내는 동사이며, 독백에 따르면 뒤따르는 숫자가 직원 수 또는 부서 수를 지정합니다.
