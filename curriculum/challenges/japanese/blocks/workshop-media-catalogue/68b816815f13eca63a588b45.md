...
ドキュメンテーション文字列（docstring）は、クラスや関数の最初の文として置かれる文字列で、そのクラスや関数のドキュメントを提供するために使われます。ドキュメンテーション文字列は通常、三重の二重引用符で囲まれます。
...
次のドキュメンテーション文字列を追加して、`Movie` クラスを完成させてください：`Parent class representing a movie.`

# --hints--

`Parent class representing a movie.` のドキュメンテーション文字列を `Movie` クラスに追加してください。
