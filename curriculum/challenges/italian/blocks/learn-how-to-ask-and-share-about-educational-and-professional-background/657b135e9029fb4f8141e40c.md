...
Questa è la forma `past simple` del verbo `to be`, usata con `you`, `we` o `they`. La prima lettera è maiuscola.
...
Questa parola significa partecipare attivamente a qualcosa. Finisce con `-ed`.
...
Questo termine si riferisce al processo di completamento di un acquisto.
