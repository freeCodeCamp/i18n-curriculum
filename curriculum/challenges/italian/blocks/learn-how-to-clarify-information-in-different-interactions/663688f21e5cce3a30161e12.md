...
Quando dici che `run into` una persona, intendi che incontri qualcuno senza aspettartelo. Per esempio, potresti `run into` un amico al negozio senza sapere che sarebbe stato lì. A volte, si usa semplicemente come sinonimo di `meet`.
...
Combinato con `into`, questo verbo indica l'incontrare qualcuno, di solito per caso.
