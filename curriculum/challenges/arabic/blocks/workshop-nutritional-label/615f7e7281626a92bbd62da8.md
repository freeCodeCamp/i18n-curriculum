...
أسفل آخر عنصر `p` لديك، أنشئ عنصر `p` آخر يحتوي على النص `Sodium 160mg 7%`. ضع `Sodium` و`7%` كل منهما في `span` خاص به مع صنف `bold` كما فعلت مع الآخرين.
...
يجب أن يغلف عنصر `span` النص `Sodium 160mg`.
