...
En chino, el número 70 se llama `七十 (qī shí)`.

Los números del 71 al 79 se forman añadiendo el dígito de las unidades (1–9) después de `七十 (qī shí)` (70).
...
He practicado la pronunciación de los números del 70 al 79.
