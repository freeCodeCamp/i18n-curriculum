...
Як тільки ви отримаєте відредагований вміст, він стане поточним вмістом.

Всередині слухача події призначте `newContent` `currentContent`.

# --hints--

Ви повинні призначити `newContent` `currentContent` всередині слухача події.
