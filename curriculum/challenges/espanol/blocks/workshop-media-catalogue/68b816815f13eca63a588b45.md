...
Un docstring es una cadena colocada como la primera declaración en una clase o función, y se usa para proporcionar documentación para esa clase o función. Los docstrings generalmente están encerrados entre triples comillas dobles:
...
Completa tu clase `Movie` agregándole la siguiente docstring: `Parent class representing a movie.`

# --hints--

Debes agregar el docstring `Parent class representing a movie.` a tu clase `Movie`.
