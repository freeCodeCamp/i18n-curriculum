...
All'interno del loop, imposta l'evento `oninput` di ogni elemento `input` sulla funzione `handleInput`.

Con questo, il workshop sul gestore delle forme è completo!

# --hints--

Dovresti impostare `input.oninput` sulla funzione `handleInput`.
