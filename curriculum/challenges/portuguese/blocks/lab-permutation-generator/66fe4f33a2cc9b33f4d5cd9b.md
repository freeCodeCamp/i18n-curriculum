...
2. A função `permuteString` deve receber três parâmetros: uma string, um valor de prefixo e um array vazio para armazenar e retornar os resultados. O valor do prefixo deve ser uma string usada para acumular caracteres para formar uma permutação.
