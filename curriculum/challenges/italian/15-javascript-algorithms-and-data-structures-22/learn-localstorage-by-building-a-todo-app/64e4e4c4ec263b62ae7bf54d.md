...
You should assign the `task-form` element to the variable `taskForm`. Non dimenticare di utilizzare `const` per dichiarare la variabile.
...
You should assign the `confirm-close-dialog` element to the variable `confirmCloseDialog`. Non dimenticare di utilizzare `const` per dichiarare la variabile.
