...
Ora, dovresti trasformare il `Start listening` CTA in un vero pulsante.

Assegna le classi di utilità `bg-indigo-100`, `px-4`, `py-2`, `text-center`, `font-semibold`, `text-indigo-700` e `hover:bg-indigo-200`.

# --hints--

Il tuo elemento àncora dovrebbe avere la classe `bg-indigo-100`.
...
Il tuo elemento àncora dovrebbe avere la classe `text-indigo-700`.
...
Il tuo elemento àncora dovrebbe avere la classe `hover:bg-indigo-200`.
