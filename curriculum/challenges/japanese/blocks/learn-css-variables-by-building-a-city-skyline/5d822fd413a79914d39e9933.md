...
先ほど追加した`repeating-linear-gradient`の下にもう一つ`repeating-linear-gradient`を追加してください。`90deg`方向を与え、`0%`から`12%`までの建物の色と、`12%`から`44%`までの窓の色を使います。これでたくさんの長方形の窓ができます。

# --hints--

`.fb5`に2つ目の`repeating-linear-gradient`を`background`プロパティで与える必要があります。
...
2つ目の`repeating-linear-gradient`に`90deg`の方向を与える必要があります。
...
2つ目の`repeating-linear-gradient`に`0%`から`12%`までの`--building-color2`の最初の色を与える必要があります。
...
2つ目の`repeating-linear-gradient`に`12%`から`44%`までの`--window-color2`の2つ目の色を与える必要があります。
