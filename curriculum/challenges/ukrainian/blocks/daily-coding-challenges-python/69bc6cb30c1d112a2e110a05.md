...
Дано масив цілих чисел. Поверніть новий масив, використовуючи такі правила:

1. Відсортуйте цілі числа за зростанням
2. Потім поміняйте місцями всі значення, індекс яких є кратним 3, зі значенням перед ним.
