...
Il tuo primo elemento `a` dovrebbe avere un `href` impostato su `https://www.facebook.com/freecodecamp`.
...
Il tuo secondo elemento `a` dovrebbe avere un `href` impostato su `https://twitter.com/freecodecamp`.

```js
assert.include(document.querySelector('.social-icons')?.querySelectorAll('a')?.[1]?.getAttribute('href'), 'https://twitter.com/freecodecamp');
```

Il tuo terzo elemento `a` dovrebbe avere un `href` impostato su `https://instagram.com/freecodecamp`.
...
Il tuo quarto elemento `a` dovrebbe avere un `href` impostato su `https://www.linkedin.com/school/free-code-camp`.
...
Il tuo quinto elemento `a` dovrebbe avere un `href` impostato su `https://www.youtube.com/freecodecamp`.
