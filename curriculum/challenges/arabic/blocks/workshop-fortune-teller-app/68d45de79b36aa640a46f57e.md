...
تحتاج إلى واجهة أخرى تُسمى `Deck`. يجب أن تحتوي هذه الواجهة على خاصية `cards`، وهي مصفوفة من الواجهة السابقة.

# --hints--

يجب إعلان واجهة باسم `Deck`.
...
يجب أن تحتوي واجهة `Deck` على خاصية `cards` من النوع `Card[]`.
