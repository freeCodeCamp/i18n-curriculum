...
Нарешті, додайте умову `else`, яка виводить дозволений хід і викликає `make_allowed_move`. Спробуйте визначити правильні аргументи.

# --hints--

Ви повинні додати умову `else`.
...
У вас має бути `print(f'Move {i + 1} allowed between {source} and {target}')` всередині блоку `else`.
...
У вас має бути `make_allowed_move(source, target)` всередині блоку `else`.
