...
يفهم ديفيد وجهة نظر آنا لكنه لا يزال لديه قلق. ماذا قد يقول؟
...
يقر ديفيد بنقطة آنا بدلاً من رفضها تمامًا.
...
`I understand, but...` طريقة مهذبة للاعتراف برأي شخص ما مع طرح قلق أو رأي مختلف. تساعد هذه العبارة في الحفاظ على احترام النقاش وتوازنه. على سبيل المثال:

- **كريس:** `We should release the update today.`

- **توم:** `I understand, but have we tested it enough?` - هذا الشخص يقر بالفكرة لكنه يتساءل عما إذا كانت جاهزة.
