...
Una tripletta di numeri interi positivi ($a$,$b$,$c$) si chiama tripletta di Cardano se soddisfa la condizione:

$$\sqrt[3]{a + b \sqrt{c}} + \sqrt[3]{a - b \sqrt{c}} = 1$$

Per esempio, (2,1,5) è una tripletta di Cardano.

Esistono 149 triplette di Cardano per cui $a + b + c ≤ 1000$.

Trova quante triplette di Cardano esistono tali che $a + b + c ≤ 110\\,000\\,000$.
