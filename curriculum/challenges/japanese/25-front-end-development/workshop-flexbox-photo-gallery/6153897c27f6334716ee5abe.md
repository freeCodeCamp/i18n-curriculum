...
フレックスボックスを使用するには、要素の `display` プロパティを `flex` に設定します。 This will make the element a <em>flex container</em>. Any direct children of a flex container are called <em>flex items</em>.
