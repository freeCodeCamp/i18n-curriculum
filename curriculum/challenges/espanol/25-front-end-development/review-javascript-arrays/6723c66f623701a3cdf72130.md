...
- **Método `indexOf()`**: Este método es útil para encontrar el primer índice de un elemento específico dentro de un arreglo. Si el elemento no se puede encontrar, entonces devolverá -1.
...
- **Método `slice()`**: Este método devuelve una copia superficial de una porción del arreglo en un índice especificado o del arreglo completo. Una copia superficial copiará la referencia al arreglo en lugar de duplicarlo.
