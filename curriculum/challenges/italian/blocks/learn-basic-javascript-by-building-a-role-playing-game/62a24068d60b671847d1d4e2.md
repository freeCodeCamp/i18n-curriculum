...
Ora ci serve un po’ di stile veloce. Inizia dando al `body` un insieme `background-color` impostato su `#0a0a23`.
...
Il tuo selettore `body` dovrebbe avere una proprietà `background-color` impostata su `#0a0a23`.
