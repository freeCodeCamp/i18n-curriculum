...
È il momento di posizionare le cabine intorno alla ruota. Seleziona il primo elemento `.cabin`. Imposta la proprietà `right` su `-8.5%` e la proprietà `top` su `50%`.

# --hints--

Dovresti avere un selettore `.cabin:nth-of-type(1)`.
...
Il tuo selettore `.cabin:nth-of-type(1)` dovrebbe avere una proprietà `right` impostata su `-8.5%`.
...
Il tuo selettore `.cabin:nth-of-type(1)` dovrebbe avere una proprietà `top` impostata su `50%`.
