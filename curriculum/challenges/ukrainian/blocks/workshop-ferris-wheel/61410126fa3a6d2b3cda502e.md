...
Щоб анімація кабіни виглядала як природний коливальний рух, ви можете використати часову функцію `ease-in-out`. Завдяки цьому анімація буде починатися й закінчуватися повільніше, але рухатися швидше в середині циклу.

Замініть `linear` на `ease-in-out` в селекторі `.cabin`.

# --hints--

Ваш селектор `.cabin` повинен мати властивість `animation` зі значенням `cabins 10s ease-in-out infinite`.
