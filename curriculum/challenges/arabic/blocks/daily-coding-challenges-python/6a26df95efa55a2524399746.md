...
title: "تحدٍّ 365: التحدي الأخير: ملء الدلو 3"
challengeType: 29
...
اليوم يُكمل سنة من تحديات البرمجة اليومية. هذا هو التحدي الجديد الأخير في الوقت الحالي. حظًا موفقًا!

معطى شبكة ثنائية الأبعاد من سلاسل نصية لألوان مكونة من حرف واحد ولون هدف، أرجع الحد الأدنى لعدد "نقرات" ملء الفيض اللازمة لجعل الشبكة كلها ذلك اللون.

- كل نقرة تغير لون الخلية التي نُقرت ولون كامل المنطقة المتصلة من الخلايا ذات اللون نفسه (اتجاهات 4).
- يمكن للنقرات استخدام أي لون كخطوة وسيطة، وليس فقط اللون الهدف.

# --hints--

`bucket_fill([["B", "B"], ["B", "B"]], "R")` يجب أن تُرجع `1`.
...
`bucket_fill([["G", "G", "G"], ["G", "G", "G"], ["G", "G", "G"]], "G")` يجب أن تُرجع `0`.
...
`bucket_fill([["P", "P", "Y"], ["Y", "P", "Y"], ["Y", "P", "P"]], "O")` يجب أن تُرجع `2`.
...
`bucket_fill([["G", "Y", "C", "C"], ["Y", "Y", "Y", "B"], ["C", "Y", "B", "B"], ["C", "B", "B", "C"]], "R")` يجب أن تُرجع `4`.
...
`bucket_fill([["G", "G", "O", "O"], ["G", "Y", "B", "Y"], ["B", "Y", "B", "Y"], ["B", "Y", "B", "Y"], ["G", "G", "G", "G"]], "P")` يجب أن تُرجع `5`.
...
`bucket_fill([["R", "G", "R", "G"], ["R", "G", "R", "G"], ["B", "B", "B", "B"], ["B", "B", "B", "B"], ["R", "G", "R", "G"]], "Y")` يجب أن تُرجع `3`.
