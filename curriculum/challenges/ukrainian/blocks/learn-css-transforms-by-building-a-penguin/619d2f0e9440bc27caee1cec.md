...
Цікавинка: більшість, якщо не всі, фліпери за формою не є прямокутниками.

Задайте елементам `.arm` радіус `30%` для верхнього лівого, верхнього правого та нижнього правого кутів, а для нижнього лівого кута — радіус `120%`.

# --hints--

Ви повинні задати `.arm` властивість `border-radius` зі значенням `30% 30% 30% 120%`.
