...
Ukizingatia sintaksia ile ile ya uingizaji wa thamani, ongeza kipengele cha pili cha `p` chenye maandishi `consumedCalories Calories Consumed` na cha tatu chenye maandishi `exerciseCalories Calories Burned`. Kumbuka kubadilisha vigezo vyako vya `consumedCalories` na `exerciseCalories` kwa thamani zinazofaa.

# --hints--

Unapaswa kuongeza kipengele cha pili cha `p` kwenye maandishi yako ya template literal.
...
Kipengele chako cha pili cha `p` kinapaswa kuwa kwenye mstari mpya.
...
Kipengele chako cha pili cha `p` kinapaswa kuwa na maandishi `${consumedCalories} Calories Consumed`.
...
Unapaswa kuongeza kipengele cha tatu cha `p` kwenye maandishi yako ya template literal.
...
Kipengele chako cha tatu cha `p` kinapaswa kuwa na maandishi `${exerciseCalories} Calories Burned`.
