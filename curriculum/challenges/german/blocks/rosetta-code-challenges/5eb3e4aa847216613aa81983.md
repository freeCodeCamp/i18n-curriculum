...
Semiprime-Zahlen sind natürliche Zahlen, die Produkte von genau zwei (möglicherweise gleichen) <a href="https://rosettacode.org/wiki/prime_number" target="_blank" rel="noopener noreferrer nofollow">Primzahlen</a> sind.

<pre>1679  =  23 x 73</pre>

# --instructions--

Schreiben Sie eine Funktion, die true zurückgibt, wenn eine Zahl semiprime ist, oder false, wenn sie es nicht ist.
