...
Verwenden Sie `const` und Destrukturierung, um die Variablen `name` und `price` aus `product` zu extrahieren.

# --hints--

Sie sollten Destrukturierung verwenden, um die Variablen `name` und `price` zu erhalten.
...
Sie sollten `const` verwenden, um die Variablen `name` und `price` zu deklarieren.
...
Sie sollten Destrukturierung verwenden, um die Variablen `name` und `price` aus `product` zu erhalten.
