...
다음 가격 카드가 **프리미엄 플랜**입니다.

프리미엄 플랜의 래퍼 `div`에 클래스 `bg-gray-950`, `text-white`, `ring-2`, `ring-fuchsia-500`, 그리고 `p-8`를 추가하세요.

# --hints--

프리미엄 플랜의 래퍼 `div` 요소에는 클래스 `bg-gray-950`가 있어야 합니다.
...
프리미엄 플랜의 래퍼 `div` 요소에는 클래스 `text-white`가 있어야 합니다.
...
프리미엄 플랜의 래퍼 `div` 요소에는 클래스 `ring-2`가 있어야 합니다.
...
프리미엄 플랜의 래퍼 `div` 요소에는 클래스 `ring-fuchsia-500`가 있어야 합니다.
...
프리미엄 플랜의 래퍼 `div` 요소에는 클래스 `p-8`가 있어야 합니다.
