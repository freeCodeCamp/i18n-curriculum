...
残りのプロパティをプライベートな `elements` オブジェクトに追加してください。追加するプロパティは `multipleCard`、`title`、`newReadingBtn`、`fortuneContainer`、`fortuneDescription`、`headerTitle`、`subTitle`、`cardTitle`、`description`、および `text` です。各プロパティは `HTMLElement` 型を使うようにしてください。

# --hints--

`multipleCard` プロパティが `elements` プロパティの中にあり、`HTMLElement` 型が代入されているはずです。
...
`title` プロパティが `elements` プロパティの中にあり、`HTMLElement` 型が代入されているはずです。
...
`newReadingBtn` プロパティが `elements` プロパティの中にあり、`HTMLElement` 型が代入されているはずです。
...
`fortuneContainer` プロパティが `elements` プロパティの中にあり、`HTMLElement` 型が代入されているはずです。
...
`fortuneDescription` プロパティが `elements` プロパティの中にあり、`HTMLElement` 型が代入されているはずです。
...
`headerTitle` プロパティが `elements` プロパティの中にあり、`HTMLElement` 型が代入されているはずです。
...
`subTitle` プロパティが `elements` プロパティの中にあり、`HTMLElement` 型が代入されているはずです。
...
`cardTitle` プロパティが `elements` プロパティの中にあり、`HTMLElement` 型が代入されているはずです。
...
`description` プロパティが `elements` プロパティの中にあり、`HTMLElement` 型が代入されているはずです。
...
`text` プロパティが `elements` プロパティの中にあり、`HTMLElement` 型が代入されているはずです。
