...
Antes de seguir trabajando en la lógica de BFS, llama a `genParentheses(1)` y muestra el resultado en la consola.

# --hints--

Debes mostrar `genParentheses(1)` en la consola.
