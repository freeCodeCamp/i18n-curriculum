...
`To investigate` означає ретельно досліджувати щось, а `to be related to` означає бути пов’язаним або асоційованим із чимось. Наприклад:
...
Означає ретельно досліджувати або вивчати щось детально. Цей дієслово закінчується на `-ing`
...
Означає мати зв’язок або асоціацію з чимось.
