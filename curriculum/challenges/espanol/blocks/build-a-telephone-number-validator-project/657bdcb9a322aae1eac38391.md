...
**Objetivo:** Construye una app que sea funcionalmente similar a <a href="https://telephone-number-validator.freecodecamp.rocks" target="_blank" rel="noopener noreferrer nofollow">https://telephone-number-validator.freecodecamp.rocks</a>.
...
1. Cuando haces clic en el elemento `#check-btn` sin ingresar un valor en el elemento `#user-input`, debe aparecer una alerta con el texto `"Please provide a phone number"`.
...
1. Cuando `#user-input` contiene `123**&!!asdf#` y se hace clic en `#check-btn`, `#results-div` debería contener el texto `"Invalid US number: 123**&!!asdf#"`.
...
Cuando `#user-input` contiene `123**&!!asdf#` y se hace clic en `#check-btn`, `#results-div` debería contener el texto `"Invalid US number: 123**&!!asdf#"`.
...
Cuando el elemento `#user-input` contiene un número estadounidense válido, y se hace clic en el elemento `#check-btn`, el elemento `#results-div` debe contener el texto `"Valid US number: "`.
