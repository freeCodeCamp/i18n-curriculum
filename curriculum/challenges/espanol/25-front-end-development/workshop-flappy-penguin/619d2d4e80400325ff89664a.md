...
Para mantener el degradado lineal en el lado correcto del brazo izquierdo del pingüino, primero gíralo 130deg, luego invierte el eje x.

# --hints--

Debes dar a `.arm.left` un `transform` de `rotate(130deg) scaleX(-1)`.
