...
تتحقق هذه المهمة من فهمك لكيفية طلب معلومات محددة في الحوار.

# --instructions--

اقرأ الحوار وقرر ما إذا كان البيان التالي صحيحًا أم خطأ.

# --questions--

## --text--

هل هذا صحيح أم خطأ: عندما يسأل Sebastián `¿Cuál es su sitio web?`، فهو يطلب موقع الشركة على الويب.
...
يسأل Sebastián عن `sitio web` الشركة، والتي تعني "موقع الويب".
...
تُستخدم `¿Cuál...?` لطلب معلومات محددة أو تعريف. على سبيل المثال:

- `¿Cuál es tu nombre?` - ما اسمك؟
- `¿Cuál es tu número de teléfono?` - ما رقم هاتفك؟

في الحوار، `¿Cuál es su sitio web?` يطلب معلومة محددة: الموقع الإلكتروني.

`Su` تشير إلى الشركة ("خاصتها"), و`es` فعل للمخاطب المفرد الغائب لأن الموضوع هو `su sitio web`.
