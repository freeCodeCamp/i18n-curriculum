...
Nota: `Weekdays` se refiere a lunes, martes, miércoles, jueves y viernes `Weekend` se refiere a sábado y domingo.

Este ejercicio es un poco diferente. Debes escuchar el audio y entenderlo primero. Después de eso, llena los espacios en blanco con las palabras correctas para completar el resumen de la rutina matutina de Sarah.
...
Indica un tiempo aproximado, no uno específico.
...
Usado para especificar un tiempo.
