...
I numeri ludici sono correlati ai numeri primi perché vengono generati da un setaccio molto simile al setaccio di Eratostene usato per generare i numeri primi.

Il primo numero ludico è 1.

Per generare i numeri ludici successivi crea un array di numeri interi crescenti a partire da 2.
...
<ul>
  <li>Prendi il primo elemento dell'array risultante come prossimo numero ludico <span style='color:blue;font-weight:bold'>2</span>.</li>
  <li>Rimuovi ogni elemento con indice <strong>2<sup>ndo</sup></strong> dall'array (incluso il primo).</li>
...
<ul>
  <li>(Svolgendo qualche iterazione...)</li>
  <li>Prendi il primo elemento dell'array risultante come prossimo numero ludico <span style='color:blue;font-weight:bold'>3</span>.</li>
  <li>Rimuovi ogni elemento con indice <strong>3<sup>rd</sup></strong> dall'array (incluso il primo).</li>
...
<ul>
  <li>Prendi il primo elemento dell'array risultante come prossimo numero ludico <span style='color:blue;font-weight:bold'>5</span>.</li>
  <li>Rimuovi ogni elemento con indice <strong>5<sup>th</sup></strong> dall'array (incluso il primo).</li>
...
<ul>
  <li>Prendi il primo elemento dell'array risultante come prossimo numero ludico <span style='color:blue;font-weight:bold'>7</span>.</li>
  <li>Rimuovi ogni elemento con indice <strong>7<sup>th</sup></strong> dall'array (incluso il primo).</li>
...
<ul>
  <li><big><b> ... </b></big></li>
  <li>Prendi il primo elemento dell'array corrente come prossimo numero ludico <span style='color:blue;font-weight:bold'>L</span>.</li>
  <li>Rimuovi ogni elemento con indice <strong>L<sup>th</sup></strong> dall'array (incluso il primo).</li>
  <li><big><b> ... </b></big></li>
</ul>

# --instructions--

Scrivi una funzione che restituisca tutti i numeri ludici minori o uguali al numero dato.
