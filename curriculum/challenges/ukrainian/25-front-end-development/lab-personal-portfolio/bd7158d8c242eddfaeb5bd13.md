...
1. Портфоліо має містити розділ з привітанням, що має `id` зі значенням `welcome-section`.
2. Розділ з привітанням повинен мати елемент `h1`, який містить текст.
3. Портфоліо має містити розділ з проєктами, що має `id` зі значенням `project-section`.
4. Розділ з проєктами повинен мати принаймні один елемент з `class` зі значенням `project-tile`, в якому знаходиться проєкт.
5. Розділ з проєктами повинен мати принаймні одне посилання на проєкт.
6. Портфоліо має містити навігаційну панель з `id` зі значенням `navbar`.
7. Навігаційна панель повинна мати принаймні одне посилання, яке дозволяє перейти на інші розділи сторінки.
8. Портфоліо має містити посилання з `id` зі значенням `profile-link`, що відкриває ваш профіль на GitHub або freeCodeCamp в новій вкладці.
9. Портфоліо має містити принаймні один медіазапит.
10. Висота розділу з привітанням має дорівнювати висоті вікна перегляду.
11. Навігаційна панель завжди має знаходитись у верхній частині вікна перегляду.

**Примітка:** не забудьте прив’язати таблицю стилів до HTML та застосувати CSS.

# --hints--

Портфоліо має містити розділ з привітанням, що має `id` зі значенням `welcome-section`.
...
В межах елемента `#welcome-section` не може бути порожніх елементів `h1`.
...
Портфоліо має містити розділ з проєктами, що має `id` зі значенням `project-section`.
...
Елемент `#navbar` завжди має знаходитись у верхній частині вікна перегляду.
