...
عند تعديل المستوى، يجب تحديث الراتب أيضًا.

قبل تعيين `self._level`، عرّف `self._salary` على الراتب الأساسي للمستوى الجديد.

# --hints--

يجب تعيين `self._salary` على الراتب الأساسي للمستوى الجديد.
