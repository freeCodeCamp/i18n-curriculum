...
Agora, você sabe que o botão funciona.Remova a instrução `console.log` da função `displayStory`.

# --hints--

Você deve remover a declaração `console.log` da função `displayStory`.
