...
أخيرًا، يمكن تباعد الأزرار بشكل أفضل فيما بينها ومن الأعلى. للقيام بذلك، يجب استهداف عنصر `div` الذي يضمهما معًا. لذا، أضف الأصناف `flex` و `gap-2` و `mt-6` إلى ذلك العنصر `div`.

بهذا، تكتمل ورشة عمل مكوِّن CTA الخاصة بك!

# --hints--

يجب أن يحتوي عنصر `div` الذي يضم عناصر وسم الرابط على الصنف المساعد `flex`.
...
يجب أن يحتوي عنصر `div` الذي يضم عناصر وسم الرابط على الصنف المساعد `gap-2`.
...
يجب أن يحتوي عنصر `div` الذي يضم عناصر وسم الرابط على الصنف المساعد `mt-6`.
