...
`Avoid` means to stay away from something or not do it because it can cause problems. 例如：
...
`Corporate emails` are work-related emails that often have private or sensitive information about the company. 例如：
