...
أخيرًا وليس آخرًا، الخاصية التي ستضيفها هي `allowfullscreen`. كما يوحي الاسم، تسمح بمشاهدة الفيديو في وضع ملء الشاشة.

بهذا، تكتمل ورشة العمل!

# --hints--

يجب أن يحتوي عنصر `iframe` على خاصية `allowfullscreen`.
