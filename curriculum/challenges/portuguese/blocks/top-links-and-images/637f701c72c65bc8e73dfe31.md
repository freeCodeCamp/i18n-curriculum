...
Para ir para o diretório pai você precisa usar dois pontos no caminho relativo assim: `../`. Vamos ver isso na prática, dentro do `body` do arquivo `about.html`, adicione a seguinte imagem abaixo do título que você adicionou antes:
...
É assim que o exemplo do logo do The Odin Project que você usou antes fica com o atributo alt incluído:
