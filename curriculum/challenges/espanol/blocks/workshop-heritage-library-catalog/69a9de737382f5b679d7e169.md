...
Agrega un bucle `for` vacío dentro de `findByAuthor` para iterar sobre `catalog`. Añadirás el cuerpo del bucle en el siguiente paso.

# --hints--

Debes usar un bucle `for` para iterar sobre `catalog`.
