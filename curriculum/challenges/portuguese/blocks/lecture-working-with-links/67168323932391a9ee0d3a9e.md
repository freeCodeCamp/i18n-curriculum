...
Dê uma olhada no link na janela de visualização. Ele deve estar na cor azul padrão que representa o estado padrão. Se você clicar nele, ele ficará roxo. 
...
Clique no link na janela de visualização e você deverá ver que o link visitado muda para a cor marrom.
...
Passe o mouse sobre o link e você verá a cor mudar para vermelho. 
...
Clique em qualquer parte do espaço em branco na janela de visualização e então pressione `tab` no seu teclado. Você deverá ver o link mudar para verde. 
...
Clique no link e você deverá ver o link ficar preto. Isso acontece bem rápido então você pode precisar clicar algumas vezes para ver a mudança de cor. 
