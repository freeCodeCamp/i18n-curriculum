...
الآن، أنشئ دالة `initializeApp` واتركها فارغة في الوقت الحالي.

ستُشغّل هذه الدالة التطبيق بالكامل بمجرد تحميل DOM. إذًا، هي الدالة التي ستمررها قريبًا إلى حدث `DOMContentLoaded` لتشغيل التطبيق.

# --hints--

يجب أن تنشئ دالة `initializeApp`.
