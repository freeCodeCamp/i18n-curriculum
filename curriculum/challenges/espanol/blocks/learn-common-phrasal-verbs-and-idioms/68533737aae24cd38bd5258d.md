...
Este verbo significa crear una primera versión de algo que será revisada o modificada más adelante.

# --explanation--

`To draft something up` significa crear una versión inicial de un documento, plan o propuesta. Por ejemplo:

`She drafted up a new schedule for the support team.` – Esto significa que ella creó una primera versión del horario que puede ser discutida o editada.
