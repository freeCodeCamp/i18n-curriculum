...
Aprieta los edificios nuevamente agregando dos elementos `div` vacíos tanto en la parte superior como en la inferior del elemento `.foreground-buildings`, y uno más entre `.fb2` y `.fb3`.
...
Debe agregar dos elementos `div` como los últimos hijos de `.foreground-buildings`.
...
Debe haber agregado 5 nuevos elementos `div`.
