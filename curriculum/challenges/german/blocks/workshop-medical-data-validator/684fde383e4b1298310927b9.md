...
Quantifizierer werden in regulären Ausdrücken verwendet, um anzugeben, wie oft ein Zeichen wiederholt werden kann. Zum Beispiel entspricht das `+`-Zeichen dem vorherigen Zeichen einmal oder mehrmals:
...
Fügen Sie also einen `+`-Quantifizierer zu Ihrem Regex-Muster hinzu, um eine oder mehrere Ziffern zu erfassen.

# --hints--

Sie sollten den `+`-Quantifizierer zu Ihrem aktuellen Regex-Muster `p\d` hinzufügen.
