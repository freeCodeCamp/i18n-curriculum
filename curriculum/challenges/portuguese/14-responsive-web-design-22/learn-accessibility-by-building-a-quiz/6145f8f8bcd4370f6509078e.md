...
As tags `br` permitirão que cada parte do endereço esteja em sua própria linha e são úteis para a apresentação dos elementos de endereço, `address`, corretamente.
