...
Sei $f(n)$ die größte positive ganze Zahl $x$ kleiner als ${10}^9$, sodass die letzten 9 Ziffern von $n^x$ die Zahl $x$ bilden (einschließlich führender Nullen), oder null, falls keine solche Zahl existiert.
...
Finden Sie $\sum f(n)$ für $2 ≤ n ≤ {10}^6$.
