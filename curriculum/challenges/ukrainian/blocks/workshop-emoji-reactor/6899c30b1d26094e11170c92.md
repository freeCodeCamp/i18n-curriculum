...
Тепер потрібно додати слухача події на елемент `happyBtn`.

Напишіть слухача події та функцію зворотного виклику так, щоб коли натискають на кнопку, застосунок виводив у консоль `Button clicked!`.

# --hints--

Коли натискають на `happyBtn`, у консоль має виводитися `Button clicked!`.
