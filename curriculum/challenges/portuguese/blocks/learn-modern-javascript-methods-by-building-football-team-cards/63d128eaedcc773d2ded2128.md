...
Abaixo desse objeto, crie outro objeto com as seguintes propriedades:
...
O array `myFavoriteFootballTeam.players` deve ter dois valores.
...
O array `myFavoriteFootballTeam.players` deve ter um objeto como sendo o segundo valor.
...
A propriedade `name` deve ser definida como `"Sergio Batista"`.
...
A sua propriedade `position` deve ser definida como `"midfielder"`.
...
A propriedade `number` deve estar definida como `2`.
