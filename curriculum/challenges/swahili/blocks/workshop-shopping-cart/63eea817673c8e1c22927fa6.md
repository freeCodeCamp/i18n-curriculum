...
Tumia `const` na ufumbuzi wa muundo kuchukua vigezo vya `name` na `price` kutoka `product`.

# --hints--

Unapaswa kutumia ufumbuzi wa muundo kupata vigezo vya `name` na `price`.
...
Unapaswa kutumia `const` kutangaza vigezo vya `name` na `price`.
...
Unapaswa kutumia ufumbuzi wa muundo kupata vigezo vya `name` na `price` kutoka `product`.
