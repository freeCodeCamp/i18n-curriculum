...
- **Elementos de nivel de bloque**: Los elementos de nivel de bloque ocupan todo el ancho disponible de forma predeterminada, extendiéndose a lo ancho de su contenedor. Algunos elementos de nivel de bloque comunes son los elementos `div`, `paragraph` y `section`.
