...
Щоб розрізняти різні типи історій, потрібно передати жанр вибраної історії у функцію `displayStory`.

Додайте параметр з назвою `genre` до функції `displayStory`.

# --hints--

Ви повинні додати параметр `genre` до функції `displayStory`.
