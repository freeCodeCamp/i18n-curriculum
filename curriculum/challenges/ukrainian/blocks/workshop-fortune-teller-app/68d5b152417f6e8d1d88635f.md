...
Потрібно додати ще властивостей до інтерфейсу `Card`. Почніть із встановлення `value_int` типом `number`. Усі інші властивості мають бути типу `string`: `suit`, `type`, `img`, `meaning_up`, `meaning_rev` і `desc`.

# --hints--

У вас має бути властивість `value_int` з типом `number`.
...
У вас має бути властивість `suit` з типом `string`.
...
У вас має бути властивість `type` з типом `string`.
...
У вас має бути властивість `img` з типом `string`.
...
У вас має бути властивість `meaning_up` з типом `string`.
...
У вас має бути властивість `meaning_rev` з типом `string`.
...
У вас має бути властивість `desc` з типом `string`.
