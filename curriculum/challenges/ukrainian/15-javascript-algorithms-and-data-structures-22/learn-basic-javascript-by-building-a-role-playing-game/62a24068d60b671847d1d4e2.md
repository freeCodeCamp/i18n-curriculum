...
Тепер нам потрібна швидка стилізація. Для початку надайте `body` властивість `background-color` зі значенням `#0a0a23`.
...
Селектор `body` повинен мати властивість `background-color` зі значенням `#0a0a23`.
