...
圧縮された文字列が与えられたとき、次のルールに従って展開した文字列を返してください。

- 与えられた文字列は、単語と数字がスペースで区切られています。
- 単語はそのままにしてください。
- 数字は、その位置にある単語に置き換えてください。最初の単語は位置1です。

たとえば、`"practice makes perfect and 3 1 2 3"`が与えられたら、`"practice makes perfect and perfect practice makes perfect"`を返してください。
