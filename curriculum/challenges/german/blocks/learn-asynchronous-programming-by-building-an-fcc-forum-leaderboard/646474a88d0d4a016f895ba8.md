...
Für die verbleibenden Schritte fügen Sie die Funktionalität hinzu, um die Benutzer-Avatare anzuzeigen.

Fügen Sie innerhalb des zweiten `td`-Elements ein `div`-Element mit dem Klassennamen `"avatar-container"` hinzu.

# --hints--

Sie sollten ein `div`-Element innerhalb des zweiten `td`-Elements haben.
...
Ihr öffnendes `div`-Tag sollte ein Klassenattribut mit dem Wert `"avatar-container"` haben.
