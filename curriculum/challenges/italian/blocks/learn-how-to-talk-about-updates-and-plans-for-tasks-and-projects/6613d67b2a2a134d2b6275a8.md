...
Indica un piano o una decisione futura, qui riferita all'intenzione di usare Node.js per il back-end.
...
Viene usato qui per prevedere un risultato futuro, suggerendo che scegliere Node.js permetterà di scalare efficacemente l'applicazione.
