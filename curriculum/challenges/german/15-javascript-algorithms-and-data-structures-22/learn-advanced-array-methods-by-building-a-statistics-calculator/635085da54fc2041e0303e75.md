...
Anschließend musst du den Wert von `mean` zurückgeben.

# --hints--

Deine `getMean`-Funktion sollte das `return`-Schlüsselwort verwenden.
...
Deine `getMean`-Funktion sollte den Wert von `mean` zurückgeben.
