...
La tua funzione `simulateFestival` dovrebbe prima registrare il messaggio `"\n" + timeBlock + " Simulation"`.
...
La tua funzione `simulateFestival` dovrebbe registrare il blocco orario corretto nel messaggio.
