...
Cuando ingresaste `<h2 style="color: red;">CatPhotoApp</h2>`, estabas estilizando ese elemento `h2` individual con CSS en línea, que significa Cascading Style Sheets.
