...
Перейдіть до елемента списку, додайте класи `mt-6`, `space-y-2`, `text-sm` і `text-fuchsia-100` до `ul`, щоб розставити елементи списку і зробити їх більш привабливими.

# --hints--

Ваш елемент `ul` має мати клас `mt-6`.
...
Ваш елемент `ul` має мати клас `space-y-2`.
...
Ваш елемент `ul` має мати клас `text-sm`.
...
Ваш елемент `ul` має мати клас `text-fuchsia-100`.
