...
In this lab, you'll build an app that will search for Pokémon by name or ID and display the results to the user. 포켓몬의 데이터와 이미지들을 가지고 오기 위하여 당신은 프리코드캠프의 <a href="https://pokeapi-proxy.freecodecamp.rocks/" target="_blank" rel="noopener noreferrer nofollow">PokéAPI Proxy</a>를 사용할 것입니다.
