...
시각적 접근성 주제에서 요소 간 명암 대비는 중요한 요소입니다. 예를 들어, 제목의 텍스트와 배경 간 명암 대비율은 최소 4.5:1이어야 합니다.

목록 요소 안에 있는 모든 앵커 요소의 폰트 색상을 명암 대비율이 최소 7:1인 색상으로 변경하세요.

# --hints--

선택자는 목록 항목 안의 링크를 대상으로 해야 합니다.
...
목록 항목 안에 있는 `a` 요소에 `color` 속성을 지정해야 합니다.
...
목록 요소 안에 있는 `a` 요소의 색상만 변경해야 합니다.
...
`color` 속성에 배경과 최소 7:1 명암 대비를 주어야 합니다. _힌트: `#dfdfe2`를 사용하면 좋습니다._
