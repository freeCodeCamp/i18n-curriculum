...
داخل الدالة `playSong`، نفذ استدعاء للدالة `highlightCurrentSong`.

بعد ذلك، جرّب أزرار التحكم لترى كيف تعمل الدالة `highlightCurrentSong`.

# --hints--

يجب أن تنفذ استدعاء الدالة `highlightCurrentSong`.
