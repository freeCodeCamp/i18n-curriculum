...
I divisori propri di un numero sono tutti i divisori escluso il numero stesso. Per esempio, i divisori propri di 28 sono 1, 2, 4, 7 e 14. Poiché la somma di questi divisori è uguale a 28, lo chiamiamo numero perfetto.

È interessante notare che la somma dei divisori propri di 220 è 284 e la somma dei divisori propri di 284 è 220, formando una catena di due numeri. Per questo motivo, 220 e 284 sono chiamati coppia amichevole.

Forse meno note sono catene più lunghe. Per esempio, partendo da 12496, si forma una catena di cinque numeri:

$$
  12496 → 14288 → 15472 → 14536 → 14264 \\,(→ 12496 → \cdots)
$$

Poiché questa catena ritorna al punto di partenza, si chiama catena amichevole.

Trova il membro più piccolo della catena amichevole più lunga senza che nessun elemento superi `limit`.
