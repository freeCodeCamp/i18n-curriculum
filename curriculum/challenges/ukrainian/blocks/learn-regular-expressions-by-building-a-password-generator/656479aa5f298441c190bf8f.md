...
Оголосіть функцію `generate_password` і напишіть увесь свій код, крім ліній `import`, всередині тіла функції.

# --hints--

Ви повинні оголосити функцію з іменем `generate_password`.
...
Інструкції імпорту мають залишатися поза межами функції.
...
Чотири оголошення змінних слід перемістити всередину функції.
