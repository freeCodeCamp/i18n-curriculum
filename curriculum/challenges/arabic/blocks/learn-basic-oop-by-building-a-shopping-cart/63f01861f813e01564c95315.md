...
داخل `div` الخاص بك، أضف عنصرين `p`. عيّن نص العنصر الثاني `p` ليكون قيمة المتغير `price`.

# --hints--

يجب أن تضيف عنصرين `p` داخل عنصر `div` الخاص بك.
...
يجب أن يحتوي العنصر الثاني `p` على نص المتغير `price`.
