...
Після того коли цикл `for` завершиться, потрібно повернути масив. Після цього можна буде побачити зміну `Output`, коли знову натиснете кнопку `Sort`.

# --hints--

Ви повинні `return` `array`.
