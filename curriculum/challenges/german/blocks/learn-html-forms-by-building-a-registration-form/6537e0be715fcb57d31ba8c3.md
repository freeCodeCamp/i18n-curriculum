...
Ändern Sie zuletzt die Textfarbe des `terms and conditions`-Link-Elements auf `#dfdfe2`, indem Sie einen neuen Selektor im CSS hinzufügen.

Gut gemacht! Sie haben den letzten Teil des Übungsprojekts _Registrierungsformular_ abgeschlossen.

# --hints--


Sie sollten dem `a`-Element eine `color` von `#dfdfe2` geben.
