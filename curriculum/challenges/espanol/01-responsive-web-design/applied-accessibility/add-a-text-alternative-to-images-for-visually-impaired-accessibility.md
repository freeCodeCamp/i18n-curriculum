...
Un buen texto `alt` le brinda al lector una breve descripción de la imagen. Siempre Debes incluir el atributo `alt` en tus imágenes. De acuerdo con las especificaciones de HTML5, esto ahora se considera obligatorio.
