...
Ouça a declaração do candidato e preencha as palavras que faltam.
...
Este é o tempo passado de `are` usado para sujeitos no plural.
...
Este é o tempo passado de `is` usado para sujeitos ou situações singulares.
