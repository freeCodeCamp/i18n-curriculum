...
Continuando con los elementos `meta`, una definición `viewport` le indica al navegador cómo renderizar la página. Incluir uno mejora la accesibilidad visual en móviles, y mejora el _SEO_ (optimización para motores de búsqueda).
