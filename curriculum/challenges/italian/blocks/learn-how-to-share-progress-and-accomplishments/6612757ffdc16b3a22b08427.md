...
È la forma al passato semplice di `test`, che indica un'azione completata nel passato.
...
È la forma al passato semplice di `find`, usata qui per descrivere la scoperta di bug avvenuta nel passato.
...
È la forma al passato semplice di `fix`, che indica l'azione completata di risolvere i bug trovati.
