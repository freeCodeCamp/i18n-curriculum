...
Seleccione sus `td` elementos con el valor de `class` de `current`, y haga la fuente cursiva.

# --hints--

Debe tener un selector `td.current`.
...
Su selector `td.current` debe tener la propiedad `font-style` establecida en `italic`.
