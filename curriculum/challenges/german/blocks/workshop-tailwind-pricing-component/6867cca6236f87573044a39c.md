...
Das Letzte, was Sie tun werden, ist, die CTA-Schaltfläche für den Familientarif zu gestalten.

Geben Sie ihr die Klassen `block`, `rounded-md`, `bg-indigo-600`, `px-4`, `py-2`, `text-center`, `font-semibold`, `text-white` und `hover:bg-indigo-700`.

Damit ist Ihr Tailwind-Workshop zur Preisgestaltungskomponente abgeschlossen!

# --hints--

Ihr Ankerelement sollte die Klasse `bg-indigo-600` haben.
...
Ihr Ankerelement sollte die Klasse `px-4` haben.
...
Ihr Ankerelement sollte die Klasse `py-2` haben.
...
Ihr Ankerelement sollte die Klasse `text-center` haben.
...
Ihr Ankerelement sollte die Klasse `font-semibold` haben.
...
Ihr Ankerelement sollte die Klasse `hover:bg-indigo-700` haben.
