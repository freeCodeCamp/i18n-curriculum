...
Ili kuondoa nafasi ya wima kati ya kipengele cha `h1` na maandishi ya `Est. 2020`, badilisha ukingo wa chini wa `h1` kuwa `15px`.

# --hints--

Unapaswa kuweka sifa ya `margin-bottom` kuwa `15px`.
...
Kipengele chako cha `h1` kinapaswa kuwa na sifa ya `margin-bottom` ya `15px`.
