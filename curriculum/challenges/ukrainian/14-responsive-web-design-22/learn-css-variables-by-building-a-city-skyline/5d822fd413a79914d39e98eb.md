...
Вимальовується панорама. Заповніть властивість `background-color` будівель переднього плану. Використайте змінну `--building-color1`, щоб заповнити `.fb3` та `.fb4`, `--building-color2` для `.fb5`, `--building-color3` для `.fb2` і `.fb6` та `--building-color4` для `.fb1`.
