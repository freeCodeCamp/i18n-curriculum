...
O tipo de dado list é uma sequência ordenada de elementos que podem ser compostos por strings, números ou até outras listas. O tipo de dado list é uma sequência ordenada de elementos que podem ser compostos por strings, números ou até outras listas.  Lists are mutable and use zero-based indexing, meaning that the first element of the list is at index zero.
