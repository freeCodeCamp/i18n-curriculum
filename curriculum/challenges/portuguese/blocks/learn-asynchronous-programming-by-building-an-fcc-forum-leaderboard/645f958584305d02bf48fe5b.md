...
No final do seu método `map`, encadeie o método `join()`. Para o separador, passe uma string vazia.

# --hints--

Você deve encadear o método `join` ao método `map` e usar uma string vazia como separador.
