...
Ваш новий елемент `p` має містити текст `Total Fat 8g 10%`.
...
Елемент `span`, що обгортає `Total Fat`, має мати множину `class`, встановлену в `bold`.
...
Елемент `span`, що обгортає `10%`, має мати множину `class`, встановлену в `bold`.
