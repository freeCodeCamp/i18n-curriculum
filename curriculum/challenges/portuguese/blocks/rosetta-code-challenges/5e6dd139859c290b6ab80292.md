...
O problema da subsequência crescente mais longa é encontrar uma subsequência de uma sequência dada na qual os elementos da subsequência estejam em ordem crescente, do menor para o maior, e na qual a subsequência seja o mais longa possível. Um exemplo:
