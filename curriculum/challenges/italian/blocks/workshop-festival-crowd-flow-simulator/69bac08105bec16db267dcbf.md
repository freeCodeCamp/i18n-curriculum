...
Successivamente, registra il seguente messaggio nella console: `gate.queue[tickIndex] + " attendees arriving."`.

# --hints--

La tua funzione `handleGateAtTick` dovrebbe registrare il seguente messaggio nella console: `gate.queue[tickIndex] + " attendees arriving."`.
...
La tua funzione `handleGateAtTick` dovrebbe registrare il numero corretto di partecipanti in base alla coda del cancello all'indice tickIndex fornito.
