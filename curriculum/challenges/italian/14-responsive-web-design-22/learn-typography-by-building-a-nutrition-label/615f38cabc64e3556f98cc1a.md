...
Crea un selettore `.label` e assegnagli una proprietà `border` con il valore `2px solid black`.
...
Il selettore `.label` dovrebbe avere una proprietà `border` con il valore `2px solid black`.
