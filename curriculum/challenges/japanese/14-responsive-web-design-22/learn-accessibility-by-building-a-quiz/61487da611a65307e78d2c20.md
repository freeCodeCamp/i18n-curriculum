...
小さい画面では、ナビゲーションバー内の順序なしリストが画面の右側にはみ出してしまいます。

_フレックスボックス_ を使用して `ul` のコンテンツを折り返すことで、これを修正してください。 次に、以下の CSS プロパティを設定してテキストを正しく整列させてください:
