...
Додайте умову `else`, яка призначає числу `0` швидкість `x` гравця.

# --hints--

Ви повинні додати інструкцію `else` у вашу функцію `animate`.

```js
assert.match(animate.toString(), /\}\s*else\s*\{/);
```

Ваша інструкція `else` має йти після інструкції `else if`.
...
Ви повинні включити умову `else`, яка призначає числу `0` швидкість `x` гравця.
