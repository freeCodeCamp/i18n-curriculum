...
Ndani ya njia ya `initializeEventListeners`, ungana na mshughulikiaji wa tukio la `click` kwenye `singleCardBtn`. Ndani ya mshughulikiaji wa tukio, fanya wito wa njia ya `singleCardSelected`. kumbuka kupata `singleCardBtn` kutoka `elements`.
