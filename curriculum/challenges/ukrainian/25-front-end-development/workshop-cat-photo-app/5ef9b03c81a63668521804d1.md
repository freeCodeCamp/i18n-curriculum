...
Після елемента `figure` додайте ще один елемент `h3` з таким текстом:

`Top 3 things cats hate:`

# --hints--

Одразу над кінцевим тегом другого елемента `section` має бути елемент `h3`. Переконайтеся, що він має початковий та кінцевий теги.
...
Над новим елементом `h3` має бути `figure`. Можливо, ви випадково видалили елемент `figure`.
