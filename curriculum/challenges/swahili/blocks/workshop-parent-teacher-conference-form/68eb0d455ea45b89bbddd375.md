...
Sasa, unapaswa kuongeza nafasi ya ndani kwenye kontena. Weka `padding` kuwa `10px 20px`. Kwa njia hii, unaweka nafasi ya ndani ya `10px` juu na chini, na `20px` kushoto na kulia.
...
Weka sifa ya `padding` kuwa `10px 20px`.
