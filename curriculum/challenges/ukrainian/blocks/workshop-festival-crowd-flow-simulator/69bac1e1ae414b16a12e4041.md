...
Нарешті, ви можете запустити свої симуляції.

Почніть із ранкової зміни. Викличте `simulateFestival()` з `morningGates` та `"Morning"`.

# --hints--

Ви повинні викликати `simulateFestival()` з `morningGates` та `"Morning"`.
