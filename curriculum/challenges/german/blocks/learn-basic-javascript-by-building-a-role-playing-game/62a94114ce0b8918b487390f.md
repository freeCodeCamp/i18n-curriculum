...
Füge ein weiteres Objekt im `locations`-Array hinzu. Alles sollte wie beim `lose`-Objekt sein, außer dass der `name` `"win"` und der `text` `"You defeat the dragon! DU GEWINNST DAS SPIEL!"` lauten sollte. &#x1F389;"</code>.
