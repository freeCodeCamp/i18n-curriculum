...
Katika moduli iliyopita, ulijifunza kwamba unaweza kujenga makosa yako maalum kwa kurithi kutoka darasa la vitu la `Exception` lililo ndani:
...
Tengeneza darasa la vitu linaloitwa `MediaError`. Lifanye lirithi kutoka darasa la vitu la `Exception` na uliongeze maandishi ya maelezo (docstring) yanayosema `Custom exception for media-related errors.`.

# --hints--

Unapaswa kutengeneza darasa la vitu linaloitwa `MediaError`.
...
Darasa lako la vitu la `MediaError` linapaswa kurithi kutoka `Exception`.
...
Unapaswa kuongeza maandishi ya maelezo (docstring) `Custom exception for media-related errors.` kwenye darasa lako la vitu la `MediaError`.
