...
Questo post del blog conterrà un paio di paragrafi con testo <dfn>lorem ipsum</dfn>.

Il lorem ipsum è comunemente usato nello sviluppo web come testo segnaposto. È utile quando vuoi concentrarti sulla creazione della struttura base delle tue pagine web senza doverti preoccupare ancora del contenuto vero e proprio.

Ecco un esempio di utilizzo del lorem ipsum:
...
Dovresti avere due elementi paragrafo all’interno dell’elemento `article`.
...
Il tuo primo elemento paragrafo dovrebbe contenere testo lorem ipsum. Controlla bene che non ci siano errori di ortografia o punteggiatura.
...
Il tuo secondo elemento paragrafo dovrebbe contenere testo lorem ipsum. Controlla bene che non ci siano errori di ortografia o punteggiatura.
