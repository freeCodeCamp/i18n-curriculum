...
Unaweza kuipa menyu yako nafasi kati ya yaliyomo na kando na sifa mbalimbali za `padding`.

Ipe class ya `menu` `padding-left` na `padding-right` yenye thamani sawa `20px`.
