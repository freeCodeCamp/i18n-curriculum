...
`input[type="checkbox"]` セレクターに `border-radius` プロパティを追加してください。
...
`input[type="checkbox"]` セレクターに `background-color` プロパティを追加してください。
...
`input[type="checkbox"]` セレクターに `transition` プロパティを追加してください。
