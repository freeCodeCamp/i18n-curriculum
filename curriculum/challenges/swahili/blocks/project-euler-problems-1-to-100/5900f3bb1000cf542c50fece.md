...
title: 'Changamoto 79: Utoaji wa msimbo wa siri'
challengeType: 1
forumTopicId: 302192
...
Njia ya usalama inayotumika sana kwa benki mtandaoni ni kumuomba mtumizi herufi tatu za nasibu kutoka kwa msimbo wa siri. Kwa mfano, ikiwa msimbo wa siri ulikuwa `531278`, wanaweza kuomba herufi ya 2, 3, na 5; jibu linalotarajiwa litakuwa: `317`.
...
`passcodeDerivation(keylog1)` inapaswa kurudisha `531278`.
...
`passcodeDerivation(keylog3)` inapaswa kurudisha `73162890`.
