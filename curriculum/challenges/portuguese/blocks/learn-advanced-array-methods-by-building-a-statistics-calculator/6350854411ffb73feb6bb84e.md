...
O método `reduce()` utiliza um segundo argumento como valor inicial do acumulador.Sem um segundo parâmetro, o método `.reduce()` usa o primeiro elemento do array como o acumulador, o que pode levar a resultados inesperados.
