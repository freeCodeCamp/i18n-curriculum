...
Щоб елементи `input` і `textarea` гармонійно поєднувалися з фоновою темою, встановіть їхній `background-color` у `#0a0a23`. Потім додайте їм `1px`, `solid` кордон кольору `#0a0a23`.

# --hints--

Ви повинні використати селектор елементів, розділених комою, щоб вибрати елементи `input` і `textarea`.
...
Ви повинні надати елементам `input` і `textarea` `background-color` зі значенням `#0a0a23`.
...
Ви повинні надати елементам `input` і `textarea` `1px`, `solid` кордон кольору `#0a0a23`.
