...
`addCharacters` повертає функцію, тож вам потрібно її викликати. Передайте `char1` як аргумент.

# --hints--

Ви маєте викликати свою функцію `addCharacters()` у методі `.map()`.
...
Ви маєте передати `char1` як аргумент у виклик `addCharacters()`.
