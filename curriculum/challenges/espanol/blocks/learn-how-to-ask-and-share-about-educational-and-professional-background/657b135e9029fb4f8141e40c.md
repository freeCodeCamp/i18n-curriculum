...
Esta es la forma `past simple` del verbo `to be`, usada con `you`, `we` o `they`. La primera letra está en mayúscula.
...
Esta palabra significa participar activamente en algo. Termina en `-ed`.
