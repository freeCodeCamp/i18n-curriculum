...
Debes añadir un segundo elemento `p` a tu elemento `footer`.
...
Tu nuevo elemento `p` debe tener el texto `123 Free Code Camp Drive`. Asegúrate de que su nuevo elemento viene después del elemento ya existente.
