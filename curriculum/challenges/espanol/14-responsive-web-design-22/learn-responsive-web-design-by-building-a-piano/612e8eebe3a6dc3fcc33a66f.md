...
Ahora apunta a tu elemento `#piano` con un selector de `id`. Establecer la propiedad `background-color` a `#00471b`, la propiedad `width` a `992px` y la propiedad `height` a `290px`.
