...
**目标：** 构建一个功能上类似于 <a href="https://cash-register.freecodecamp.rocks" target="_blank" rel="noopener noreferrer nofollow">https://cash-register.freecodecamp.rocks</a> 的应用程序。
...
当 `price` 为 `19.5` 时，`#cash` 元素的值为 `20`，`cid` 的值为 `[["PENNY", 1.01], ["NICKEL", 2.05], ["DIME", 3.1], ["QUARTER", 4.25], ["ONE", 90], ["FIVE", 55], ["TEN", 20], ["TWENTY", 60], ["ONE HUNDRED", 100]]`，当 `#purchase-btn` 元素被点击后，`#change-due` 元素的值应该是 `"Status: OPEN QUARTER: $0.5"`。
...
当 `price` 为 `3.26` 时，`#cash` 元素的值为 `100`，`cid` 的值为 `[["PENNY", 1.01], ["NICKEL", 2.05], ["DIME", 3.1], ["QUARTER", 4.25], ["ONE", 90], ["FIVE", 55], ["TEN", 20], ["TWENTY", 60], ["ONE HUNDRED", 100]]`，当 `#purchase-btn` 元素被点击后，`#change-due` 元素的值应该是 `"Status: OPEN TWENTY: $60 TEN: $20 FIVE: $15 ONE: $1 QUARTER: $0.5 DIME: $0.2 PENNY: $0.04"`。
...
当 `price` 为 `19.5` 时，`#cash` 元素的值为 `20`， `cid` 的值为 `[["PENNY", 0.01], ["NICKEL", 0], ["DIME", 0], ["QUARTER", 0], ["ONE", 1], ["FIVE", 0], ["TEN", 0], ["TWENTY", 0], ["ONE HUNDRED", 0]]`，当 `#purchase-btn` 元素被点击后，`#change-due` 元素的值应该是 `"Status: INSUFFICIENT_FUNDS"`。
...
当 `price` 为 `19.5` 时，`#cash` 元素的值为 `20`， `cid` 的值为 `[["PENNY", 0.5], ["NICKEL", 0], ["DIME", 0], ["QUARTER", 0], ["ONE", 0], ["FIVE", 0], ["TEN", 0], ["TWENTY", 0], ["ONE HUNDRED", 0]]`，当 `#purchase-btn` 元素被点击后，`#change-due` 元素的值应该是 `"Status: CLOSED PENNY: $0.5"`。
