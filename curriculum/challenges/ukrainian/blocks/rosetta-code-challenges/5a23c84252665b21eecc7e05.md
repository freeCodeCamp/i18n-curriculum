...
**CUSIP** — це дев’ятисимвольний алфавітно-цифровий код, який ідентифікує фінансовий інструмент Північної Америки з метою полегшення клірингу та розрахунків за угодами. CUSIP було прийнято як американський національний стандарт за Accredited Standards X9.6.

# --instructions--

Напишіть функцію, яка приймає рядок як параметр і перевіряє, чи є цей рядок дійсним CUSIP.
...
`isCusip("037833100")` має повертати булеве значення.
