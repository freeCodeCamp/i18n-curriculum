...
Nella frase di Bob, a chi si riferisce il pronome `us`?
...
`Us` non si riferisce a una singola persona come Alice.
...
`Us` non si riferisce direttamente al pubblico che ascolta la conversazione.
...
`Us` si riferisce a persone, non a oggetti o progetti.
