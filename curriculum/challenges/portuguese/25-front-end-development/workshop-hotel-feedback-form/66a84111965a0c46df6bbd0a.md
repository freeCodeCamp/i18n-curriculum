...
Abaixo do elemento `legend`, adicione um elemento `label` com o texto `Name*:`. Para o atributo `for`, defina-o com o valor `"full-name"`.
...
O elemento `label` deve ter o texto `Name*:`.
