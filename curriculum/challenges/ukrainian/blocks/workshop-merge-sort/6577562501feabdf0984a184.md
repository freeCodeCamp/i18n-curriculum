...
Після призначення елемента в `left_part` відсортованому масиву, збільшіть `left_array_index` на `1`.

# --hints--

Ви повинні додати `1` до поточного значення `left_array_index` після вставлення елемента у відсортований масив.
