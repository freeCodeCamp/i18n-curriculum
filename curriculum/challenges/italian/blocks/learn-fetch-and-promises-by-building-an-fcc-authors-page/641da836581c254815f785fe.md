...
La prossima cosa che mostrerai sono i dettagli biografici dell'autore. Puoi farlo con `bio`, che hai destrutturato precedentemente.
...
Dovresti interpolare `bio` nell'elemento `p`.
