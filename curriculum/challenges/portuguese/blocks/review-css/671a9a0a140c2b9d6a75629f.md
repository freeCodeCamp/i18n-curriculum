...
- **`width` Property**: This property specifies the width of an element.Se você não especificar uma largura, o padrão será definido como `auto`.Isso significa que o elemento ocupará toda a largura do seu contêiner pai.
