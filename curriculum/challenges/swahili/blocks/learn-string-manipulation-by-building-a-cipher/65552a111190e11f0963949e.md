...
Futa neno kuu la `pass`, na rudisha `vigenere(message, key)` kutoka kwenye kitendakazi chako kipya.

# --hints--

Kitendakazi chako cha `encrypt` kinapaswa kurudisha `vigenere(message, key)`. Kumbuka kufuta `pass`.
