...
Adicione os eixos x e y ao gráfico para obter a seguinte saída:
...
Os símbolos estão disponíveis como `x_axis_tick` e `y_axis_tick`.

# --hints--

O método deve retornar a saída correta.
...
O método deve retornar a saída correta para diferentes instâncias.
