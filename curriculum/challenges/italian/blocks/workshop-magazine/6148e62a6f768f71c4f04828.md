...
Dai al selettore `.image-wrapper` una proprietà `place-items` impostata su `center`.

# --hints--

Il selettore `.image-wrapper` dovrebbe avere una proprietà `place-items` impostata su `center`.
