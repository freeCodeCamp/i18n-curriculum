...
Всередині елемента `div` створіть елемент `h2` і вставте проп `name` як його текст.

Також, всередині `div` створіть абзац з `className` `card-title`, щоб вставити проп `title`, і ще один абзац, щоб вставити проп `bio`.
...
Ваш елемент `h2` має мати `{name}` як текстовий вміст.
...
Ви повинні створити тег `p` з `className` `card-title` всередині вашого елемента `div`.
...
Ваш елемент `p` з `className` `card-title` має мати `{title}` як текстовий вміст.
...
Ви повинні створити ще один елемент `p` з `{bio}` як текстом.
