...
Sasa utaanza kufanya kazi kwenye njia ya `initializeEventListeners()`. Kwanza, ipe aina ya kurudisha `void`.

# --hints--

Njia yako ya `initializeEventListeners` inapaswa kuwa na aina ya kurudisha `void`.
