...
Ahora estás listo para comenzar a juntar el diseño de la cuadrícula. En los vídeos de la lección anterior aprendiste que CSS Grid ofrece un diseño basado en cuadrícula bidimensional, permitiéndote centrar elementos horizontal y verticalmente mientras mantienes el control para hacer cosas como superponer elementos.

Comienza creando un selector `main` y dándole una propiedad `display` establecida como `grid`.
...
Tu selector `main` debe tener una propiedad `display` establecida como `grid`.
