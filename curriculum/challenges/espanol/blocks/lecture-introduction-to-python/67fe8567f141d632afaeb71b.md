...
La mejor manera de instalar Python en Windows y Mac es descargar el instalador desde el sitio web oficial de Python. También revisaremos cómo ejecutar Python en Linux más adelante en esta lección.
