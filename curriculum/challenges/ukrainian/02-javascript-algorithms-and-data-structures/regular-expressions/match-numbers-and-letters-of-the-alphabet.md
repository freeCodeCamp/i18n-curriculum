...
Створіть регулярний вираз, який збігається з діапазоном літер від `h` до `s` та діапазоном чисел від `2` до `6`. Не забудьте включити відповідні прапорці у регулярному виразі.
