...
Umejenga kalkuleta ya mwelekeo wa mradi.

Sasa kumalizia, badilisha msimbo uliouandika nje ya madarasa, na uingize katika kitendakazi kidogo kinachoitwa `projectile_helper` kinachopokea thamani zinazotakiwa za kasi, urefu na pembe na kuchapisha kwenye terminal kwa mfululizo, maelezo ya mradi, jedwali la kuratibu na mchoro wa mwelekeo.

Fanya wito wa `projectile_helper` mara moja kwa thamani unazotaka.

# --hints--

Unapaswa kuunda `projectile_helper` katika wigo wa ulimwengu.
...
Unapaswa kuchapisha mfuatano wa herufi ulioombwa kwa mpangilio. Usichapishe thamani nyingine.
...
Unapaswa kuita kitendakazi cha `projectile_helper` angalau mara moja.
...
Hupaswi kuwa na vigezo wala wito wa chapisho katika wigo wa ulimwengu.
