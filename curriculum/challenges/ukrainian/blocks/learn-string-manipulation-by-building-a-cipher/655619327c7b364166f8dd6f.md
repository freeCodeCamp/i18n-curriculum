...
Якщо ви хочете додати до рядка `alphabet` додаткові символи, наприклад цифри або спеціальні символи, вам доведеться вручну змінити правий операнд операції за модулем.

Замініть `26` на `len(alphabet)`, щоб уникнути цієї проблеми.

# --hints--

Вам слід змінити значення `new_index`, замінивши `26` на `len(alphabet)`.
