...
title: Erstelle einen Bootstrap Button
challengeType: 0
forumTopicId: 16811
...
Du sollst ein neues `button` Element mit dem Text `Like` erstellen.
...
Dein neuer Button soll zwei Klassen besitzen: `btn` und `btn-default`.
