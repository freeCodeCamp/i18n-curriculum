...
داخل عنصر `footer`، أضف عنصر `section` مع تعيين `id` إلى `contact`.

داخل عنصر `section`، أضف عنصر `h2` مع النص `Contact`.

# --hints--

يجب أن يكون لديك عنصر `section` داخل عنصر `footer`.
...
يجب أن يحتوي عنصر `section` على خاصية `id` مضبوطة على القيمة `"contact"`.
...
يجب أن يكون لديك عنصر `h2` داخل عنصر `section`.
...
يجب أن يحتوي عنصر `h2` على النص `Contact`.
