...
Sie erhalten ein Array von Objekten, die Gegenstände darstellen, die in einen Rucksack gelegt werden sollen. Die Objekte haben 4 Attribute: Name, Stückzahl (die Anzahl des jeweiligen Gegenstands), Gewicht und Wert. Die Gegenstände müssen so ausgewählt werden, dass das Gesamtgewicht das maximale Gewicht nicht überschreitet und der Wert maximiert wird. Beachten Sie, dass jeder Gegenstand zwischen 0 und `pieces` Mal vorkommen kann.

# --instructions--

Schreiben Sie eine Funktion, um das Rucksackproblem zu lösen. Die Funktion erhält das Array von Objekten und das maximale Gewicht als Parameter. Sie soll den maximal möglichen Gesamtwert zurückgeben.
