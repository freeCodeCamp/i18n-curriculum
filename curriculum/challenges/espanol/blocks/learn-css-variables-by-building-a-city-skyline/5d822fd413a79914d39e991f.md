...
Mueve la propiedad y valor `background-color` de `.fb2` a `.fb2b` para colorear solo la sección y no el contenedor.

# --hints--

Debe eliminar la propiedad `background-color` de `.fb2`.
