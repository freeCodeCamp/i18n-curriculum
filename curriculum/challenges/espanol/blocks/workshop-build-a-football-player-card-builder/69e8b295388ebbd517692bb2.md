...
Dentro del componente `FootballPlayerCard`, elimina el `h1` y devuelve el componente `PlayerCard`.

# --hints--

El `FootballPlayerCard` debe renderizar el componente `PlayerCard`.
