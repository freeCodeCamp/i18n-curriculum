...
Gib dann der `textarea` Platzhaltertext, der eine Beispielantwort beschreibt.
...
Du solltest der `textarea` ein `placeholder`-Attribut mit einem Text, der eine Beispielantwort beschreibt, zuweisen.
