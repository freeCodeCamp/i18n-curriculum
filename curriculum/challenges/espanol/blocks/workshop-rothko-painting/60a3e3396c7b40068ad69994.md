...
Redondea la esquina superior-izquierda de `.three` en 30 píxeles, la superior-derecha en 25 píxeles, la inferior-derecha en 60 píxeles y la inferior-izquierda en 12 píxeles.

# --hints--

Debe configurar la propiedad `border-radius` en `30px 25px 60px 12px`.
...
Su elemento `.three` debe tener un valor de `border-radius` de `30px 25px 60px 12px`.
