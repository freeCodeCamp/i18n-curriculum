...
Redondea la cresta, al dar a las esquinas inferiores del pseudo-elemento un radio de `100%`, dejando las esquinas superiores en `0%`.
...
Debe dar a `.penguin-body::before` un `border-radius` de `0% 0% 100% 100%`.
