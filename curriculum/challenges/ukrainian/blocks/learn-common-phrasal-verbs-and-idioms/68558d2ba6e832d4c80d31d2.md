...
- Person 1: `Let's move the meeting to 10 a.m.` – Ця людина пропонує змінити розклад.

- Person 2: `I like that.` – Це означає, що мовник підтримує або погоджується з пропозицією.
