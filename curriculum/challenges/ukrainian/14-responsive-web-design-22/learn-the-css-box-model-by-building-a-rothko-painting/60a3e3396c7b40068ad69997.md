...
Поверніть елемент `.three` проти годинникової стрілки на 0,2 градуса.

На цьому етапі картина Ротко завершена.

# --hints--

Встановіть властивість `transform` на `rotate(-0.2deg)`.
...
Елемент `.three` повинен мати `transform` зі значенням `rotate(-0.2deg)`.
