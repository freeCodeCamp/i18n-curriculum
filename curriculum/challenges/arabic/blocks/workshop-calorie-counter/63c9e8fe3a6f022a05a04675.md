...
باستخدام نفس صيغة الاستيفاء، أضف عنصر `p` ثانيًا بالنص `consumedCalories Calories Consumed` وعنصر ثالث بالنص `exerciseCalories Calories Burned`. تذكر استبدال متغيرات `consumedCalories` و`exerciseCalories` بالقيم المناسبة.

# --hints--

يجب إضافة عنصر `p` ثاني إلى النص الحرفي للقالب.
...
يجب أن يكون عنصر `p` الثاني في سطر جديد.
...
يجب أن يحتوي عنصر `p` الثاني على النص `${consumedCalories} Calories Consumed`.
...
يجب إضافة عنصر `p` ثالث إلى النص الحرفي للقالب.
...
يجب أن يحتوي عنصر `p` الثالث على النص `${exerciseCalories} Calories Burned`.
