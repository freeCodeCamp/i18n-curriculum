...
Створіть підклас `Spider`, який розширює клас `Bug` з параметром типу, встановленим у `string`.

# --hints--

У вас має бути клас із назвою `Spider`.
...
Ваш клас `Spider` має розширювати `Bug`.
...
Ваш клас `Spider` має розширювати `Bug` з аргументом типу `string`.
