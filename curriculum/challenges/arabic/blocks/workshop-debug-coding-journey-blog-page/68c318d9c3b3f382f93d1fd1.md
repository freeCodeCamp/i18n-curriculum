...
أسفل العنوان الرئيسي للصفحة، يوجد قسم تنقل يحتوي على روابط لكل منشور في المدونة.

يجب أن يُغلف هذا القسم بعنصر `nav` للدلالة على وظيفته كعلامة تنقل.

# --hints--

يجب أن تحتوي صفحتك على عنصر `nav`.
...
يجب أن يكون `<h2>Navigation</h2>` داخل عنصر `nav`.
...
يجب أن تكون عناصر `li` داخل عنصر `ul`.
...
لا يجب إضافة أي عناصر `ul` أو `li` أو `h2` إضافية.
