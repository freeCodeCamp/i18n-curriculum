...
Додайте відступ зверху та зліва для елементів `.info`, а інші значення встановіть у `0`.
