...
Ndani ya njia ya `calculate_best_price`, tengeneza orodha iitwayo `prices` yenye `product.price`. Hii inahakikisha kwamba ikiwa hakuna punguzo lolote linalotumika, mteja atalipa bei kamili.

# --hints--

Ndani ya `calculate_best_price`, unapaswa kutengeneza orodha iitwayo `prices` yenye `product.price`.
