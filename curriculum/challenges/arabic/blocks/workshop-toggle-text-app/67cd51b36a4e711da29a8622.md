...
لتبديل مستوى الظهور للنص، يجب أولًا إنشاء دالة تكون مسؤولة عن هذا السلوك.

ابدأ بإنشاء دالة جديدة تُسمى `handleToggleVisibility`.

# --hints--

يجب أن يكون لديك دالة `handleToggleVisibility`.
