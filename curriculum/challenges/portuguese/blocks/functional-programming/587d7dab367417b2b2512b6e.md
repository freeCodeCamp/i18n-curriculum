...
O método `every` funciona com arrays para verificar se *todos* os elementos passam em um teste específico. Ele retorna um booleano: `true` se todos os valores atendem ao critério e `false` caso contrário.
