...
2. Al instanciarse, un nuevo objeto `GameCharacter` debe tener los siguientes atributos:
...
7. Define un método llamado `level_up` que:
...
8. Define un método `__str__` que devuelva una cadena formateada que incluya:
