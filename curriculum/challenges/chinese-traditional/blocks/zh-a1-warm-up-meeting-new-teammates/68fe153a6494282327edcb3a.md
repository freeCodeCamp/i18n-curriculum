...
`請問 (qǐng wèn)` literally means "may I ask". It's a polite way to start a question and similar to saying "excuse me" or "please" before asking a question in English. You use it when you want to be respectful or formal. For example:

`請問 (qǐng wèn)，你叫什麼名字 (nǐ jiào shén me míng zì)？` - Excuse me, what is your name?
