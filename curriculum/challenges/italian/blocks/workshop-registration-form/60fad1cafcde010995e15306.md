...
Con gli invii di moduli, è utile e buona pratica fornire a ogni elemento inviabile un attributo `name`. Questo attributo serve a identificare l'elemento nell'invio del modulo.
