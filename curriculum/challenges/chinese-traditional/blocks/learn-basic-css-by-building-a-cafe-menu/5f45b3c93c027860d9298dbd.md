...
當滑鼠暫留在聯結上時，你會使用看起來像 `a:hover { propertyName: propertyValue; }` 的 <dfn>偽選擇器</dfn> 來更改該聯結的屬性。

當使用者暫留在頁腳的 `Visit our website` 聯結上時，將其顏色更改為 `brown`。
