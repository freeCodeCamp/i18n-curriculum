...
Majengo yamepangwa kwa umbali mkubwa sana. Yasukumie pamoja kwa kuongeza vipengele viwili tupu vya `div` juu ya kipengele cha `.background-buildings`, viwili zaidi chini yake, na kimoja kati ya `.bb3` na `.bb4`. Hivi vitakuwa vipengele vilivyopangwa kwa usawa ndani ya kontena, na kusababisha majengo kusogezwa karibu na katikati.
...
Unapaswa kuongeza kipengele kipya kimoja cha `div` kati ya vipengele vya `.bb3` na `.bb4`.
...
Unapaswa kuongeza vipengele vitano vipya vya `div`.
