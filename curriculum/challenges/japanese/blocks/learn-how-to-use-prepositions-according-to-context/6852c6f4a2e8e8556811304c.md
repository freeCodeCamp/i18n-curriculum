...
なぜボブは入口、廊下、ロビーにサインを追加することを提案しているのでしょうか？

## --answers--

最初の週に人々が自分の部署を見つけやすくするため。

---

オフィスをよりプロフェッショナルに見せるため。
...
メールにはコーヒーマシンについての記述はありません。

---

プライベートミーティングルームにラベルを付けるため。

### --feedback--

ミーティングルームのラベルについては話されていません。
...
ボブは人々が`at key points like the entrance, hallway, and lobby`しやすくするために`find their departments during the first week`のサインを追加することを提案しています。これは明らかに案内を改善するためです。
