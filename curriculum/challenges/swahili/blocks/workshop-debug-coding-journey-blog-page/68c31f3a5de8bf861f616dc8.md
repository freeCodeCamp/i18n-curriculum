...
Kwa sasa sehemu ya `footer` ina kichwa cha sehemu cha `h3`. Lakini inapaswa kuwa kichwa cha sehemu cha `h2` ili kudumisha mpangilio sahihi wa vichwa vya sehemu.

Badilisha `h3` kuwa `h2`.

# --hints--

Kipengele chako cha `footer` kinapaswa kuwa na kipengele cha `h2` badala ya kipengele cha `h3`.
