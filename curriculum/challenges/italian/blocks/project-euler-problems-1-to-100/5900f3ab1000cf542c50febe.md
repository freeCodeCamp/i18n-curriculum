...
title: 'Problema 63: conteggi potenti di cifre'
challengeType: 1
forumTopicId: 302175
...
Il numero di 5 cifre, 16807 = 7<sup>5</sup>, è anche una potenza quinta. Allo stesso modo, il numero di 9 cifre, 134217728 = 8<sup>9</sup>, è una potenza nona.

Completa la funzione in modo che restituisca quanti numeri interi positivi hanno lunghezza `n` e sono una potenza `n`.
