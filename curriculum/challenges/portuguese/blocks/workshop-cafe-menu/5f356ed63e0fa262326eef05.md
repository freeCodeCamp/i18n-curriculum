...
Agora, use o seletor `#menu` existente para definir a cor de fundo do elemento `div` para que seja `burlywood`.
...
O elemento `#menu` deve ter um fundo de cor amadeirada.
