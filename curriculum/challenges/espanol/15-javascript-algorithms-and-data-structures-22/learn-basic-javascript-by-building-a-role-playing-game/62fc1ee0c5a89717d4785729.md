...
Dale a tu elemento `#monsterStats` el mismo `border` y `padding` que a tu elemento `#stats`. Establece tu color a `#ffffff` y dale un color de fondo `#c70d0d`.
...
Tu selector `#monsterStats` debe tener un `border` de `1px solid #0a0a23`.
...
Tu selector `#monsterStats` debe tener `5px` de padding.
...
Tu selector `#monsterStats` debe tener un `color` de `#ffffff`.
...
Tu selector `#monsterStats` debe tener un `background-color` de `#c70d0d`.
