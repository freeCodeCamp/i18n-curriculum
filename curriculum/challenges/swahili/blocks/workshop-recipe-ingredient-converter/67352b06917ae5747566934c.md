...
Mwishowe, sahihisha kitendakazi chako cha ndani kurudisha kitendakazi cha tatu. Kitendakazi hiki cha tatu pia kinapaswa kupokea hoja moja iitwayo `quantity`, na kuwa na mwili tupu.

# --hints--

Kitendakazi chako cha pili kinapaswa kurudisha kitendakazi kingine.

```js
assert.isFunction(convertQuantity()());
```

Kitendakazi chako cha ndani kabisa kinapaswa kuwa na kigezo `quantity`.

```js
assert.match(convertQuantity()()?.toString(), /\(quantity\)/);
```

Kitendakazi chako cha ndani kabisa kinapaswa kuwa tupu.
