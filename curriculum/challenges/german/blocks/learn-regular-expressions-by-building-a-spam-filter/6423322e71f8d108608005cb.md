...
Aktualisiere nun das `o`-Zeichen, damit es mit `o` und `0` (der Ziffer) übereinstimmt.

# --hints--

Deine `freeRegex` sollte eine Zeichenklasse verwenden, um mit `o` oder `0` übereinzustimmen.
...
Deine `freeRegex` sollte mit `fr33 m0n3y` übereinstimmen.
