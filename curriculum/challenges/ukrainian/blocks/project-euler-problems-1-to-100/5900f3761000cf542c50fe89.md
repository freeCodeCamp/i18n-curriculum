...
Сума простих чисел менших за 10 дорівнює 2 + 3 + 5 + 7 = 17.

Знайдіть суму всіх простих чисел менших за `n`.

# --hints--

`primeSummation(17)` має повертати число.

```js
assert.isNumber(primeSummation(17));
```

`primeSummation(17)` має повертати 41.

```js
assert.strictEqual(primeSummation(17), 41);
```

`primeSummation(2001)` має повертати 277050.

```js
assert.strictEqual(primeSummation(2001), 277050);
```

`primeSummation(140759)` має повертати 873608362.

```js
assert.strictEqual(primeSummation(140759), 873608362);
```

`primeSummation(2000000)` має повертати 142913828922.
