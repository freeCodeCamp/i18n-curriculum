...
- **Declaración de variables**: Para declarar una variable, comience con el nombre de la variable seguido del operador de asignación (`=`) y luego el valor. Esto puede ser un número, cadena, booleano, etc. Aquí hay algunos ejemplos:
