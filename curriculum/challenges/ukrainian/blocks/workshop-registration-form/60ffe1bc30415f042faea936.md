...
Використайте селектор елементів, розділених комою, щоб вибрати елементи `input` і `textarea`.
...
Дайте елементам `input` і `textarea` `background-color` зі значенням `#0a0a23`.
...
Додайте елементам `input` і `textarea` `1px`, `solid` кордон кольору `#0a0a23`.
