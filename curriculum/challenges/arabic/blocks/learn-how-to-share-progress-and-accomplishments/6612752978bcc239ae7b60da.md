...
هذا هو التصريف الماضي البسيط للفعل `work`، ويُستخدم للدلالة على فعل اكتمل في الماضي.
...
هذا هو التصريف الماضي البسيط للفعل `design`، ويُستخدم لوصف فعل إنشاء شيء ما بعد إتمامه.
...
هذا هو التصريف الماضي البسيط للفعل `present`، ويُستخدم للدلالة على فعل عرض أو تقديم شيء تم إنجازه بالفعل.
