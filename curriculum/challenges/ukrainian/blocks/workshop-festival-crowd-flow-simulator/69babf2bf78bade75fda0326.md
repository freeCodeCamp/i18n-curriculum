...
Далі вам потрібен спосіб відстежувати, скільки учасників пройшло через ворота під час тіку. Створіть змінну з іменем `processed` і ініціалізуйте її значенням `0`.

# --hints--

Ви повинні створити змінну з іменем `processed` і призначити їй значення `0`.
