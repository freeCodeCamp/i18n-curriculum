...
Converta o número fornecido em seu equivalente em algarismos romanos.

Os algarismos romanos utilizam combinações específicas de letras para representar valores numéricos, conforme a tabela a seguir:
...
Ao realizar a conversão, utilize apenas letras maiúsculas para representar os números romanos.
