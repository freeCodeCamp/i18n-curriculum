...
Chagua tu vipengele vya `.inline`, na uwape `width` ya `unset`. Hii itafuta sheria ya awali iliyoweka vipengele vyote vya `input` kuwa `width: 100%`.
...
Unapaswa kuwapa vipengele vya `.inline` `width` ya `unset`.
