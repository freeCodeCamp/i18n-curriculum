...
- **Métodos estáticos**: Estos métodos se usan a menudo para funciones de utilidad que no necesitan acceso al estado específico de un objeto. Se definen dentro de las clases para encapsular funcionalidad relacionada. Los métodos estáticos también son útiles para implementar métodos "factory". Un método de fábrica es un método que defines además del constructor para crear objetos basados en criterios específicos.
