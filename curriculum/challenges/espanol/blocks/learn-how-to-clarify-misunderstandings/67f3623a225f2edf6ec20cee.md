...
`Supposed to be` means something was expected or planned to happen. Por ejemplo:

`The new feature was supposed to be ready by last week.` — This means it was planned to be ready last week.

`Coming later` means that something is planned to happen in the future. Por ejemplo:
