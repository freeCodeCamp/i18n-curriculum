...
Agrega un `linear-gradient` a `.bb1d` con `orange` como primer color, `--building-color1` como segundo, y `--window-color1` como tercero. Recuerda usar el gradiente en la propiedad `background`.
