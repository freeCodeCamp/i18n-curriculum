...
`If you sleep well, you will feel refreshed.` - A condição é `sleep well` e o resultado é `feel refreshed`. Isso significa que sentir-se revigorado depende de dormir bem.
...
Correr de manhã leva ao relaxamento depois.
