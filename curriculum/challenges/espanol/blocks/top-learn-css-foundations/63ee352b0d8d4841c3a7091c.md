...
Tanto nuestros selectores `.read` y `.unread` comparten las declaraciones `color: white;` y `background-color: black;`, pero por lo demás tienen varias de sus propias declaraciones únicas. Para reducir la repetición, puedes agrupar estos dos selectores juntos como una lista separada por comas:
