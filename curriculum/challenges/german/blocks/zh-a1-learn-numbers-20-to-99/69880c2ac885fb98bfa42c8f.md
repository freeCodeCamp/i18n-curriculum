...
Kommen wir zu den Zahlen in den 60ern.

Auf Chinesisch wird die Zahl 60 `六十 (liù shí)` genannt.

Die Zahlen von 61 bis 69 werden gebildet, indem man die chinesische Bezeichnung für die Einerstelle (1–9) an `六十 (liù shí)` (60) anhängt.
