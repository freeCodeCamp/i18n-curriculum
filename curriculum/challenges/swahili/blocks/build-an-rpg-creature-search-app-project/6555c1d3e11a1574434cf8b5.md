...
Katika mradi huu, utafanya programu itakayotafuta viumbe kutoka mchezo wa RPG kwa jina au nambari ya kitambulisho na kuonyesha matokeo kwa mtumizi. Ili kupata data za viumbe na picha, utatumia API ya viumbe wa RPG ya freeCodeCamp <a href="https://rpg-creature-api.freecodecamp.rocks/" target="_blank" rel="noopener noreferrer nofollow">RPG Creature API</a>.
...
Wakati kipengele cha `#search-input` kinapokuwa na thamani ya `Red` na kipengele cha `#search-button` kinapobofyanwa, onyo linapaswa kuonekana lenye maandishi ya `"Creature not found"`.
...
Wakati kipengele cha `#search-input` kinapokuwa na jina la mnyama lisilo halali na kipengele cha `#search-button` kinapobofyanwa, onyo linapaswa kuonekana lenye maandishi ya `"Creature not found"`.
...
Wakati kitufe cha utafutaji kinapobofyanwa, programu inapaswa kutuma ombi la fetch kwa kiishio sahihi kwa jina la mnyama au kitambulisho.
