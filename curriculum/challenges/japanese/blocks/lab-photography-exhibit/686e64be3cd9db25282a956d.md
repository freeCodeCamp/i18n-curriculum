...
このラボでは、Tailwind CSSのユーティリティクラスを使って写真展のレイアウトを作成します。

画像には、以下のURLを使ってもかまいません：
...
1. `main-container`というクラスを持つ要素が必要です。
2. `.main-container`要素には、以下のTailwind CSSユーティリティクラスも必要です：
   - CSSグリッドコンテナを作成するための正しいユーティリティクラス。
   - グリッド内の列数を定義するユーティリティクラス。固定列数を使うユーティリティクラスを使用してください。例：`grid-cols-<number>`。
   - グリッドアイテムの行と列の間隔を設定するユーティリティクラス。
3. `.main-container`要素の中には、`card`というクラスを持つ要素が少なくとも3つ必要です。
4. `.card`要素それぞれには、以下のTailwind CSSユーティリティクラスも必要です：
   - お好みの丸みのあるボーダーを設定するユーティリティクラス。
   - お好みのパディングを設定するユーティリティクラス。`p-<number>`の形式を使ってください。
5. `.card`要素の中には、以下の要素が必要です：
   - `src`および`alt`属性を持つ画像要素。
   - `subheading`というクラスを持つ要素。
   - `description`というクラスを持つ要素。
6. 画像要素それぞれには、お好みの丸みのあるボーダーを設定するユーティリティクラスが必要です。
7. `.subheading`要素それぞれには、フォントの太さとサイズを設定するユーティリティクラスを使ってください。
8. `.description`要素それぞれには、フォントサイズを設定するユーティリティクラスを使ってください。

# --hints--

`main-container`というクラスを持つ要素が必要です。

```js
assert.exists(document.querySelector(".main-container"));
```

`.main-container`要素には、CSSグリッドコンテナを作成するための正しいTailwind CSSユーティリティクラスを使ってください。
...
`.main-container`要素には、グリッド内の列数を定義するユーティリティクラスを使ってください。
...
`.main-container`要素には、グリッドアイテムの行と列の間隔を設定するユーティリティクラスを使ってください。
...
`.main-container`要素の中には、`card`というクラスを持つ要素が少なくとも3つ必要です。
...
`.card`要素それぞれには、丸みのあるボーダーを設定するユーティリティクラスが必要です。
...
`.card`要素それぞれには、パディングを設定するユーティリティクラスが必要です。
...
`.card`要素それぞれには、画像要素が含まれている必要があります。
...
`.card`要素それぞれには、`subheading`というクラスを持つ要素が含まれている必要があります。
...
`.subheading`要素それぞれには、テキストコンテンツが必要です。
...
`.card`要素それぞれには、`description`というクラスを持つ要素が含まれている必要があります。
...
`.description`要素それぞれには、テキストコンテンツが必要です。
...
`img`要素それぞれには、丸みのあるボーダーを設定するユーティリティクラスが必要です。
...
`.subheading`要素それぞれには、フォントの太さを設定するユーティリティクラスを使ってください。
...
`.subheading`要素それぞれには、フォントサイズを設定するユーティリティクラスを使ってください。
...
`.description`要素それぞれには、フォントサイズを設定するユーティリティクラスを使ってください。
