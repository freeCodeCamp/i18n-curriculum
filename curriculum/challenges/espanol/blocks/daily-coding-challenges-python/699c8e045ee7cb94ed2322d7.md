...
`get_pi_decimal(5)` debería devolver `9`.
...
`get_pi_decimal(10)` debería devolver `5`.
...
`get_pi_decimal(22)` debería devolver `6`.
...
`get_pi_decimal(39)` debería devolver `7`.
...
`get_pi_decimal(76)` debería devolver `2`.
...
`get_pi_decimal(384)` debería devolver `4`.
...
`get_pi_decimal(601)` debería devolver `0`.
...
`get_pi_decimal(1000)` debería devolver `9`.
