...
Adicione as classes `text-4xl`, `font-bold` e `text-white` ao elemento `p` que contém o texto do preço para torná-lo mais visível.
...
Seu elemento `p` deve ter a classe `text-white`.
