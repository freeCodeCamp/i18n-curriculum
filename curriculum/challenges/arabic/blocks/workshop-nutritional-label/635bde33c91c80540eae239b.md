...
يجب محاذاة النص `% Daily Value *` إلى اليمين. أنشئ محدِّد `.right` واستخدم خاصية `justify-content` لتحقيق ذلك.

# --hints--

يجب أن يكون لديك محدِّد `.right`.
...
يجب أن يحتوي محدِّد `.right` على خاصية `justify-content` مضبوطة على `flex-end`.
