...
最後に、ファミリープランのCTAボタンのスタイルを設定します。

クラス`block`、`rounded-md`、`bg-indigo-600`、`px-4`、`py-2`、`text-center`、`font-semibold`、`text-white`、および`hover:bg-indigo-700`を付けてください。

これでTailwindの価格表示コンポーネントのワークショップは完了です！

# --hints--

アンカー要素にはクラス`bg-indigo-600`を付けてください。
...
アンカー要素にはクラス`text-center`を付けてください。
...
アンカー要素にはクラス`font-semibold`を付けてください。
...
アンカー要素にはクラス`hover:bg-indigo-700`を付けてください。
