...
Finalmente, en el selector `:root` de la consulta de medios, redefine las cuatro variables `--window-color` para usar `#777`. Cuando termines, cambia el tamaño de la ventana y observa cómo pasa de día a noche.

Las variables se utilizan principalmente con colores, y así las utilizaste aquí. Pero pueden tener cualquier valor y utilizarse en cualquier propiedad. ¡Tu proyecto se ve genial!

# --hints--

Debes agregar `--window-color1` con un valor de `#777`.
...
Debes agregar `--window-color2` con un valor de `#777`.
...
Debes agregar `--window-color3` con un valor de `#777`.
...
Debes agregar `--window-color4` con un valor de `#777`.
