...
title: 'Aufgabe 87: Primzahl-Potenz-Dreier'
challengeType: 1
forumTopicId: 302201
...
Die kleinste Zahl, die sich als Summe aus einem Quadrat einer Primzahl, einer Kubikzahl einer Primzahl und einer vierten Potenz einer Primzahl ausdrücken lässt, ist `28`. Tatsächlich gibt es genau vier Zahlen unter fünfzig, die sich auf diese Weise ausdrücken lassen:
...
Wie viele Zahlen unter `n` lassen sich als Summe aus einem Quadrat einer Primzahl, einer Kubikzahl einer Primzahl und einer vierten Potenz einer Primzahl ausdrücken?
