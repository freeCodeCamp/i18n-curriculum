...
Use la misma declaración `box-shadow` para `.two`, pero cambie el color de `#efb762` a `#8f0401`.
...
Su elemento `.two` debe tener un valor de `box-shadow` de `0 0 3px 3px #8f0401`.
