...
title: 'Aufgabe 32: Pandigitale Produkte'
challengeType: 1
forumTopicId: 301976
...
Wir sagen, dass eine `n`-stellige Zahl pandigital ist, wenn sie alle Ziffern von 1 bis `n` genau einmal verwendet; zum Beispiel ist die 5-stellige Zahl 15234 pandigital von 1 bis 5.

Das Produkt 7254 ist ungewöhnlich, da die Gleichung 39 × 186 = 7254, bestehend aus Multiplikand, Multiplikator und Produkt, pandigital von 1 bis 9 ist.

Finden Sie die Summe aller Produkte, deren Multiplikand/Mulitplikator/Produkt-Identität als pandigital von 1 bis `n` geschrieben werden kann.

**Hinweis:** Einige Produkte können auf mehr als eine Weise erhalten werden, stellen Sie also sicher, dass Sie jedes nur einmal in Ihre Summe aufnehmen.
