...
Множини та карти мають кілька методів з однаковими назвами та призначенням. Наприклад, ви можете використовувати метод `has` для множини, щоб перевірити, чи містить вона певний елемент.

Використайте метод `has`, щоб перевірити, чи об’єкт `ballerina` міститься у вашій `plantsSet`, і виведіть результат у консоль.

# --hints--

Ви повинні вивести `plantsSet.has(ballerina)` у консоль.
