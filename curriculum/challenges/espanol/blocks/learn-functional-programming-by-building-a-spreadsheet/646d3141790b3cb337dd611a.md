...
Dale a tu función callback cuatro parámetros más para que coincidan con esos grupos de captura: `char1`, `num1`, `char2` y `num2`. `char` será la abreviatura de `character`.
