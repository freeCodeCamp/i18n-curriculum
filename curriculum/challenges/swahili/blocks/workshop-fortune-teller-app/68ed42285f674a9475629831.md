...
Ndani ya darasa la vitu, ongeza sifa binafsi ya `elements` kama kitu. Ndani yake, ongeza sifa `singleCardBtn`, `singleCard`, na `multipleCardsBtn`, kila moja ikiwa na aina ya `HTMLElement`.

# --hints--

Unapaswa kutangaza sifa ya `private` yenye jina `elements` ndani ya darasa la vitu la `Game`.
...
Sifa yako binafsi ya `elements` inapaswa kuwa na sifa ya `singleCardBtn` yenye aina ya `HTMLElement`.
...
Sifa yako binafsi ya `elements` inapaswa kuwa na sifa ya `multipleCardsBtn` yenye aina ya `HTMLElement`.
...
Sifa yako binafsi ya `elements` inapaswa kuwa na sifa ya `singleCard` yenye aina ya `HTMLElement`.
