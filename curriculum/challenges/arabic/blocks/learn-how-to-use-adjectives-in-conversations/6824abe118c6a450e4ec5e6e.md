...
أرسلت جيسيكا بريدًا إلكترونيًا إلى الفريق في اليوم التالي، تلخص فيه محادثتها مع جيمس حول الإصدار الجديد من البرنامج.
...
ماذا تقول جيسيكا عن أداء البرنامج على الأجهزة المختلفة؟

## --answers--

يجب على المستخدمين تعديل الإعدادات يدويًا لكل جهاز.

### --feedback--

تقول جيسيكا إنه يعيد تغيير الحجم `by itself`، أي تلقائيًا.

---

يعمل بشكل صحيح فقط على الشاشات الكبيرة.

### --feedback--

تقول إنه يعمل جيدًا على أجهزة مختلفة، وليس فقط على الكبيرة.

---

يتكيف جيدًا مع أحجام الشاشات والأجهزة المختلفة.

---

الإصدار الجديد غير متوافق بعد مع الهواتف.

### --feedback--

لا يوجد ذكر لأي مشاكل في توافق الأجهزة.
...
تكتب جيسيكا أن البرنامج `adjusts well to different screen sizes and devices` و`resizes by itself`.

هذا يعني أنه يعمل جيدًا عبر الأجهزة دون جهد من المستخدم.
