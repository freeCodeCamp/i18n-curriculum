...
你現在有三個樣式完全相同的類型選擇器。 You can add the same group of styles to many elements by creating a list of selectors. Each selector is separated with commas like this:
