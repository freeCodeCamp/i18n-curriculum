...
Para este laboratorio, se le ha proporcionado todo el HTML y CSS. Usarás JavaScript para completar la aplicación del Administrador de Marcadores para que pueda almacenar una colección de marcadores en el almacenamiento local y leer datos de él.

Cumplir con las historias de usuario a continuación y pasar todas las pruebas para completar el laboratorio.
