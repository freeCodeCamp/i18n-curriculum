...
Ви можете надати вашому меню деякий простір між вмістом і сторонами з допомогою різних властивостей `padding`.

Класу `menu` надайте `padding-left` та `padding-right` з однаковим значенням `20px`.

# --hints--

Ви повинні встановити властивість `padding-left` на `20px`.
...
Ви повинні встановити властивість `padding-right` на `20px`.
...
Ваш елемент `.menu` повинен мати `padding-left` зі значенням `20px`.
...
Ваш елемент `.menu` повинен мати `padding-right` зі значенням `20px`.
