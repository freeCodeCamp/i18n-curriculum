...
title: استخدام خاصية align-items في تضمين التغريدة
challengeType: 0
...
قدّم التحدٍّ الأخير خاصية `align-items` وأعطى مثالًا عليها. يمكن تطبيق هذه الخاصية على بعض عناصر تضمين التغريدة لمحاذاة العناصر المرنة داخلها.

# --instructions--

أضف خاصية CSS `align-items` إلى عنصر `.follow-btn` في القسم العلوي. عيّن القيمة إلى `center`.

# --hints--

يجب أن يُعرض عنصر `.follow-btn` على الصفحة. تأكد من تعطيل أي إضافات مثل حاصرات الإعلانات.
...
يجب أن يحتوي عنصر `.follow-btn` على خاصية `align-items` بقيمة `center`.
