...
Ili kufanya sehemu ya kwanza ionekane vizuri zaidi, lenga tu vipengele vya `input` ndani ya vipengele vya `.info` na uweke `width` kuwa `50%`, na maandishi upande wa kushoto.
...
Unapaswa kuvipa vipengele vya `input` `width` ya `50%`.
...
Unapaswa kukipa kipengele cha `input` `text-align` ya `left`.
