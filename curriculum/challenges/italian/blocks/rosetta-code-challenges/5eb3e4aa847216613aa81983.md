...
I numeri semiprimi sono numeri naturali che sono prodotti di esattamente due numeri <a href="https://rosettacode.org/wiki/prime_number" target="_blank" rel="noopener noreferrer nofollow">primi</a> (eventualmente uguali).

<pre>1679  =  23 x 73</pre>

# --instructions--

Scrivi una funzione che restituisca true se un numero è semiprimo, o false se non lo è.
