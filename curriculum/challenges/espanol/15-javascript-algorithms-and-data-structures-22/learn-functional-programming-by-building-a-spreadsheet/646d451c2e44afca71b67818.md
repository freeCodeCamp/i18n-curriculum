...
Declara una función `apply` que tome un parámetro `fn` y un parámetro `args`.

# --hints--

Debes declarar una variable `apply`.
...
Debes usar `const` para declarar tu variable `apply`.
...
Tu variable `apply` debe ser asignada a una función de flecha.
...
Tu función `apply` debe tener `fn` como su primer parámetro.
...
Tu función `apply` debe tener `args` como su segundo parámetro.
...
Tu función `apply` debe estar vacía.
