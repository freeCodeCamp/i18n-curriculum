...
Подібно до сортування бульбашкою, сортування вибором має ітерувати над масивом. Для цього оголосіть цикл `for`.
...
Цикл `for` має ініціалізувати змінну `i` значенням `0`.
...
Цикл `for` повинен мати порожнє тіло.
