...
The verb `monitor` means to watch or check something, especially in a business or technical setting. 例如：
...
`Closely` means to do something in a careful or detailed way. 例如：
