...
Для відкриваючого тегу `a` встановіть атрибут `target` зі значенням `"_blank"`. Потім встановіть атрибут `href` зі значенням `${forumTopicUrl}${slug}/${id}`.

І з цими змінами ваш проєкт рейтингу форуму freeCodeCamp тепер завершено!

# --hints--

Ваш відкриваючий тег посилання повинен мати атрибут `target`, встановлений у `"_blank"`.
...
Ваш відкриваючий тег посилання повинен мати атрибут `href`, встановлений у `${forumTopicUrl}${slug}/${id}`.
