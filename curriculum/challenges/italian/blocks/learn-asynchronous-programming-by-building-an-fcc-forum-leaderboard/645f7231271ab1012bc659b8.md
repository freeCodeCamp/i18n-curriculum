...
Successivamente, verifica se l'utente esiste. Aggiungi un'istruzione `if` con `user` per la condizione.

# --hints--

Dovresti creare un'istruzione `if` con la condizione di `user`.
