...
Às vezes, você quer que todos os itens no seu grid possuam o mesmo alinhamento.Você pode usar as propriedades aprendidas anteriormente e alinhá-los individualmente ou pode alinhá-los todos de uma vez horizontalmente usando a propriedade `justify-items` em seu grid container.Esta propriedade pode aceitar todos os mesmos valores que você aprendeu nos dois desafios anteriores, a diferença é que ela moverá **todos** os itens em nossa grade para o alinhamento desejado.
