...
Kwa hivyo, piano yako imemalizika!

# --hints--

Sheria yako ya pili ya `@media` inapaswa kuwa na kichaguzi cha `#piano`.
...
Kichaguzi chako kipya cha `#piano` kinapaswa kuwa na `width` ya `675px`.
...
Sheria yako ya pili ya `@media` inapaswa kuwa na kichaguzi cha `.keys`.
...
Kichaguzi chako kipya cha `.keys` kinapaswa kuwa na `width` ya `633px`.
