...
Toa chaguzi nyingine za menyu kwa kuchapisha mfuatano huu wa herufi tatu katika mzunguko wako wa `while`: `'3. Show total expenses'`, `'4. Filter expenses by category'`, na `'5. Exit'`. Endelea kuongeza wito za `print()` kwa mpangilio.

# --hints--

Unapaswa kuwa na `print('3. Show total expenses')` katika mzunguko wako wa `while`.
...
Unapaswa kuwa na `print('4. Filter expenses by category')` katika mzunguko wako wa `while`.
...
Unapaswa kuwa na `print('5. Exit')` katika mzunguko wako wa `while`.
