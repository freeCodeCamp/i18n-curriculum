...
Si el `id` no está en el objeto `allCategories`, necesitará mostrar la categoría `General`.

Debajo de tu declaración `if`, añade una cláusula `else`. 

# --hints--

Debes tener una cláusula `else` debajo de tu proposición `if`.
