...
بالنسبة لخاصية `border-left`، قم بتغيير قيمة أسلوب border من `solid` إلى `double`.

# --hints--

قاعدة CSS مسمى `.sleeve`، يجب أن تحتوي علي خاصية `border-left` مع القيمة `10px double black`.
