...
Створіть новий селектор `.left-container p`, встановивши поле зверху та знизу в `-5px`, а поле зліва та справа в `-2px`. Також встановіть `font-size` у `2em` і `font-weight` у `700`.
