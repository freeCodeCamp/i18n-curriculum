...
Unahitaji pia kuanza kufuta HTML. Weka sifa ya `innerHTML` ya `productsContainer` kurudi kuwa mfuatano wa herufi tupu.

# --hints--

Katika tamko lako la `if`, unapaswa kuweka sifa ya `innerHTML` ya `productsContainer` kurudi kuwa mfuatano wa herufi tupu.
