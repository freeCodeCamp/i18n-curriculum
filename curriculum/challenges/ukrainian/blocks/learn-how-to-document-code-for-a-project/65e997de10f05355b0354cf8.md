...
To `reference` something means to mention it or bring attention to it. Наприклад, `In her essay, she references several scientific studies`.

`Related` means connected or having a relationship with something. Наприклад, `The two problems are related`.
