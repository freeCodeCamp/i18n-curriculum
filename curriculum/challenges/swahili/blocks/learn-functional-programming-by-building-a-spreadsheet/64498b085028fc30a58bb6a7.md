...
Tangaza kitendakazi `elemValue` kinachopokea kigezo `num`. Kitendakazi hicho kinapaswa kuwa tupu.

# --hints--

Unapaswa kutangaza tofauti `elemValue` baada ya kitendakazi chako `rangeFromString()`.
