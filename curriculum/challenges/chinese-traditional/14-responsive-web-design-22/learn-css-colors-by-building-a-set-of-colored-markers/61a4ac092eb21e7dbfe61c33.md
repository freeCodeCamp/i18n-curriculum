...
更新 `rgb` 函數，使 red 的值爲 `245`，green 的值爲 `62`，blue 的值爲 `113`。

# --hints--

你的 `.red` CSS 規則應該有一個 `background` 屬性值爲 `linear-gradient(180deg, rgb(122, 74, 14) 0%, rgb(245, 62, 113) 50%, rgb(0, 0, 255) 100%)`。
