...
¿Cuáles son las salidas de las dos sentencias `console.log` en el código JavaScript a continuación?
...
No hay diferencia; ambas sentencias `console.log` mostrarán el mismo resultado.
