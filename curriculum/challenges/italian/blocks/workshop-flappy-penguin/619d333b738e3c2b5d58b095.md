...
All'interno del secondo waypoint, ruota verso `130deg` e mantieni la scala del braccio sinistro.

# --hints--

Dovresti dare al waypoint `20%` un `transform` di `rotate(130deg) scaleX(-1)`.
