...
Щоб зробити перший розділ більш рядковим, націльтеся лише на `input` елементи всередині `.info` елементів, встановіть їм `width` у `50%` і вирівняйте текст по лівому краю.
