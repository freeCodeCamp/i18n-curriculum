...
Du solltest der Media Query einen `:root`-Selektor hinzufügen.
...
Du solltest `--building-color1` mit einem Wert von `#000` hinzufügen.
...
Du solltest `--building-color2` mit einem Wert von `#000` hinzufügen.
...
Du solltest `--building-color3` mit einem Wert von `#000` hinzufügen.
...
Du solltest `--building-color4` mit einem Wert von `#000` hinzufügen.
