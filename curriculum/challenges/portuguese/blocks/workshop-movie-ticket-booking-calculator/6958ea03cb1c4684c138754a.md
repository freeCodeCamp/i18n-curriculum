...
Dentro do corpo da última declaração `if`, abaixo da linha `print('Service charges:', service_charges)`, calcule o preço final do ingresso e armazene-o em uma variável chamada `final_price`.
