...
Використайте стрілковий синтаксис, щоб створити функцію `addOrUpdateTask`. Потім перемістіть змінну `dataArrIndex`, об’єкт `taskObj` і інструкцію `if` у функцію `addOrUpdateTask`.

# --hints--

Ви повинні використати `const` і стрілковий синтаксис, щоб створити функцію `addOrUpdateTask`.
