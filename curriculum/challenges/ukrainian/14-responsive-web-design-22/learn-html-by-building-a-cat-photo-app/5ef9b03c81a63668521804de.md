...
Both radio buttons should have a `name` attribute. Перевірте, чи є пробіл після назви початкового теґа та/або є пробіли перед усіма назвами атрибутів.
...
Both radio buttons should have a `type` attribute. Перевірте, чи є пробіл після назви початкового тега та/або є пробіли перед усіма назвами атрибутів.
...
Both radio buttons should have a `name` attribute with the value `indoor-outdoor`. Ви або не написали значення, або маєте друкарську помилку. Пам'ятайте, що значення атрибутів повинні бути в лапках.
