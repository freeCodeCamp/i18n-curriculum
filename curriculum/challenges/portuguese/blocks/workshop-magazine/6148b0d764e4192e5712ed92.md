...
Para controle adicional sobre o layout do conteúdo, você pode ter um CSS Grid em um CSS Grid.

Defina a propriedade `display` do seletor `.heading` como `grid`.

# --hints--

O seletor `.heading` deve ter a propriedade `display` definida como `grid`.
