...
Селектор `[attribute="value"]` націлює будь-який елемент, який має атрибут з певним значенням. Створіть селектор `tr[class="total"]`, щоб націлити конкретно елементи `tr` з класом `total`. Надайте йому нижній кордон зі значенням `4px double #0a0a23` та зробіть шрифт жирним.
