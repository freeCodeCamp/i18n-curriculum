...
الآن يجب أن تعمل على تحديد موضع العناصر داخل البطاقة الخاصة بالخطة.

للقيام بذلك، عرّف الحاوية لتستخدم عرض الشبكة وحدد حجم صف مخصص باستخدام الأقواس المربعة في صنف Tailwind الخاص بك.

إليك كيف يمكنك تحديد صف شبكة مخصص باستخدام وحدات الكسر:
...
أعطِ العنصر الخارجي `div` الخاص بالخطة أصناف الأدوات `grid` و `grid-rows-[1fr_auto]`.

# --hints--

يجب أن يحتوي عنصر `div` الخاص بك على الصنف `grid`.
...
يجب أن يحتوي عنصر `div` الخاص بك على الصنف `grid-rows-[1fr_auto]`.
