...
Цей новий елемент `p` потрібно зсунути. Надайте йому `class` зі значенням `indent`.

# --hints--

Ваш елемент `p` з текстом `Saturated Fat 1g 5%` повинен мати атрибут `class` зі значенням `indent`.
