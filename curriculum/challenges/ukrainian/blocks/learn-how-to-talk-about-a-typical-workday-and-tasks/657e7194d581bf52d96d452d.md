...
Використання правильних прийменників у контексті щоденних рутин є важливим для чіткого спілкування.

`At` використовується для позначення конкретного часу. Наприклад, `I start work at 9:00`.

`After` використовується для послідовностей дій. Наприклад, `I have lunch after the meeting`.

`To` використовується для вказівки напрямку або призначення. Наприклад, `I go to the office by bus`.

# --instructions--

Прослухайте аудіо, щоб зрозуміти контекст. Напишіть правильні прийменники, щоб доповнити речення про ранкову рутину Сари.
...
Цей прийменник використовується для вказівки конкретного часу.
...
Цей прийменник використовується для послідовностей дій.
...
Цей прийменник вказує напрямок або призначення.
