...
Sasa unaweza kuanza kujenga orodha yako. Tumia `addCrewMember()` kuongeza `firstAstronaut` kwenye `squad` yako.

# --hints--

Unapaswa kuita `addCrewMember()` na `squad` na `firstAstronaut`.
