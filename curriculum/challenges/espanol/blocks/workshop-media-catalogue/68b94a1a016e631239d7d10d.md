...
Volviendo a la clase `MediaCatalogue`, añade un docstring que diga `A catalogue that can store different types of media items.`

# --hints--

Debes agregar el docstring `A catalogue that can store different types of media items.` a tu clase `MediaCatalogue`.
