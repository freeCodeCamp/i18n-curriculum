...
**Exemplos de Saídas:** `-3 Hold` ou `5 Bet`

**Dica** NÃO redefina `count` para 0 quando o valor for 7, 8 ou 9. NÃO retorne um array. NÃO inclua aspas (simples ou duplas) na saída.
