...
Використовуючи той самий селектор стилю з попереднього кроку, збільшіть розмір шрифту елементів і цін, використовуючи значення `18px`.

# --hints--

Ви повинні встановити властивість `font-size` у `18px`.
