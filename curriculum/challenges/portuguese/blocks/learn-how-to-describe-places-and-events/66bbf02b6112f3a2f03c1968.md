...
Em `The Live Preview isn't showing in Visual Studio Code. Isn't it supposed to support that feature?`, `it` se refere ao `Visual Studio Code` porque Tom está falando sobre o programa e sua capacidade de suportar um recurso.
