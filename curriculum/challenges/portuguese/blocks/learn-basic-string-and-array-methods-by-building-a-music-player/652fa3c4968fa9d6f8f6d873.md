...
Em seguida, crie um array para armazenar todas as músicas.

Crie um array vazio `allSongs`.

# --hints--

Você deve ter uma variável chamada `allSongs`.

```js
assert.isDefined(allSongs)
```

Você deve atribuir um array à sua variável `allSongs`.
