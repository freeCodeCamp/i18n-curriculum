...
Перш ніж ви почнете занурюватися в саму таблицю, наразі елементи `span` виділені жирним шрифтом. Створіть селектор `span:not(.sr-only)` та надайте йому властивість `font-weight` зі значенням `normal`.
...
Ваш селектор `span:not(.sr-only)` повинен мати властивість `font-weight` зі значенням `normal`.
