...
1. Você deve ter outro elemento `div` com um atributo `class` com o valor `social-media`. Dentro deste elemento, deve haver um elemento `h2` com o texto `Connect with me`.
