...
title: "Changamoto 365: Changamoto ya Mwisho: Kujaza Mzigo 3"
challengeType: 29
...
Leo ni mwaka mmoja wa changamoto za kila siku za uandishi wa programu. Hii ni mpya ya mwisho kwa sasa. Bahati njema!

Ukizingatia gridi ya pande mbili yenye mfuatano wa herufi moja za rangi na rangi lengwa, rudisha idadi ya kiwango cha chini ya "clicks" za kujaza mafuriko zinazohitajika kufanya gridi yote kuwa rangi hiyo.

- Kila click hubadilisha rangi ya seli iliyobofyiwa na eneo lote la seli zinazounganishwa za rangi ile ile (mwelekeo wa mwelekeo 4).
- Clicks zinaweza kutumia rangi yoyote kama hatua ya kati, si lazima rangi lengwa tu.

# --hints--

`bucket_fill([["B", "B"], ["B", "B"]], "R")` inapaswa kurudisha `1`.
...
`bucket_fill([["G", "G", "G"], ["G", "G", "G"], ["G", "G", "G"]], "G")` inapaswa kurudisha `0`.
...
`bucket_fill([["P", "P", "Y"], ["Y", "P", "Y"], ["Y", "P", "P"]], "O")` inapaswa kurudisha `2`.
...
`bucket_fill([["G", "Y", "C", "C"], ["Y", "Y", "Y", "B"], ["C", "Y", "B", "B"], ["C", "B", "B", "C"]], "R")` inapaswa kurudisha `4`.
...
`bucket_fill([["G", "G", "O", "O"], ["G", "Y", "B", "Y"], ["B", "Y", "B", "Y"], ["B", "Y", "B", "Y"], ["G", "G", "G", "G"]], "P")` inapaswa kurudisha `5`.
...
`bucket_fill([["R", "G", "R", "G"], ["R", "G", "R", "G"], ["B", "B", "B", "B"], ["B", "B", "B", "B"], ["R", "G", "R", "G"]], "Y")` inapaswa kurudisha `3`.
