...
Use o caractere til (`~`) para prefixar a versão de `@freecodecamp/example` nas suas dependências e permitir que o npm a atualize para qualquer nova versão *patch*.
