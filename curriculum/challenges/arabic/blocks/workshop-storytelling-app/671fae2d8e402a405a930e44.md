...
أضف مستمع حدث لحدث `click` إلى `scaryStoryBtn` ومرر له الدالة `displayStory`. ثم، انقر على الزر الخاص بك وشاهد النتيجة في وحدة التحكم.

# --hints--

يجب أن تضيف مستمع حدث لحدث `click` إلى `scaryStoryBtn` مع تمرير الدالة `displayStory` له.
