...
Ni wakati wa kuweka vyumba karibu na gurudumu. Chagua kipengele cha kwanza cha `.cabin`. Weka sifa ya `right` kuwa `-8.5%` na sifa ya `top` kuwa `50%`.

# --hints--

Unapaswa kuwa na kichaguzi cha `.cabin:nth-of-type(1)`.
...
Kichaguzi chako cha `.cabin:nth-of-type(1)` kinapaswa kuwa na sifa ya `right` iliyowekwa kuwa `-8.5%`.
...
Kichaguzi chako cha `.cabin:nth-of-type(1)` kinapaswa kuwa na sifa ya `top` iliyowekwa kuwa `50%`.
