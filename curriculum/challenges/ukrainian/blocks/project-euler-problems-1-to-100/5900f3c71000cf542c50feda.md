...
Точки ${P}(x_1, y_1)$ та ${Q}(x_2, y_2)$ побудовані на цілих координатах і з’єднані з початком координат, ${O}(0, 0)$, утворюючи ${\Delta}OPQ$.
...
Існує рівно чотирнадцять трикутників із прямим кутом, які можна утворити, коли кожна координата лежить між 0 та 2 включно; тобто, $0 ≤ x_1, y_1, x_2, y_2 ≤ 2$.
...
Якщо $0 ≤ x_1, y_1, x_2, y_2 ≤ limit$, скільки прямокутних трикутників можна утворити?
