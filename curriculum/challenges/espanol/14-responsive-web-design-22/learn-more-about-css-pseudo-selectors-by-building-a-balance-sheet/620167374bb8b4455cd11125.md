...
Debes tener un selector `#years`.

```js
assert(new __helpers.CSSHelp(document).getStyle('#years'));
```

Tu selector `#years` debe tener una propiedad `display` establecida en `flex`.

```js
assert(new __helpers.CSSHelp(document).getStyle('#years')?.getPropertyValue('display') === 'flex');
```

Tu selector `#years` debe tener una propiedad `justify-content` establecida en `flex-end`.

```js
assert(new __helpers.CSSHelp(document).getStyle('#years')?.getPropertyValue('justify-content') === 'flex-end');
```

Tu selector `#years` debe tener una propiedad `position` establecida en `sticky`.

```js
assert(new __helpers.CSSHelp(document).getStyle('#years')?.getPropertyValue('position') === 'sticky');
```

Tu selector `#years` debe tener una propiedad `top` establecida en `0`.
