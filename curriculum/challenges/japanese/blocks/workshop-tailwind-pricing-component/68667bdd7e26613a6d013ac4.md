...
価格のテキストがある `text-4xl` 要素に、クラス `font-bold`、`text-white`、`p` を追加して、より目立つようにしてください。

# --hints--

`p` 要素にはクラス `text-4xl` を付けてください。
