...
Перевірте, чи `cardElement` не є екземпляром `HTMLElement`, і якщо так, додайте `return`

# --hints--

Ви повинні додати ще одну інструкцію `if` з умовою `!(cardElement instanceof HTMLElement)`.
