...
Ласкаво просимо до проєкту «Реєстраційна форма»! Для початку додайте оголошення `!DOCTYPE html` у верхній частині документа, щоб браузер знав, який тип документа він читає.
