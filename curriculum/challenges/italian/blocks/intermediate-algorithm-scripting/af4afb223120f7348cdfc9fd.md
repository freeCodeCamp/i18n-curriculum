...
title: Calcola il periodo orbitale
challengeType: 1
forumTopicId: 16021
...
Secondo la terza legge di Keplero, il periodo orbitale $T$ di due masse puntiformi che orbitano l’una attorno all’altra su un’orbita circolare o ellittica è:
...
- $M$ è la massa del corpo più massiccio.

Restituisci un nuovo array che trasformi l’altitudine media degli elementi nel loro periodo orbitale (in secondi).

L’array conterrà oggetti nel formato `{name: 'name', avgAlt: avgAlt}`.

I valori devono essere arrotondati all’intero più vicino. Il corpo attorno al quale orbitano è la Terra.
