...
У попередньому уроці ви дізналися про функцію `round()`, яка приймає два аргументи: число, яке потрібно округлити, і кількість десяткових знаків, які слід зберегти. Ось приклад:
