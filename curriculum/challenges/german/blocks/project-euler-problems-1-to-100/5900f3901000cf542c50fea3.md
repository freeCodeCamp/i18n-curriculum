...
title: 'Aufgabe 36: Doppelbasige palindromische Zahlen'
challengeType: 1
forumTopicId: 302020
...
Die Dezimalzahl 585 = 1001001001<sub>2</sub> (binär) ist in beiden Zahlensystemen palindromisch.

Finden Sie die Summe aller Zahlen, die kleiner als `n` sind, wobei 1000 ≤ `n` ≤ 1000000 gilt, und die sowohl in Basis 10 als auch in Basis 2 palindromisch sind.

(Beachten Sie bitte, dass die palindromische Zahl in keinem der beiden Zahlensysteme führende Nullen enthalten darf.)
