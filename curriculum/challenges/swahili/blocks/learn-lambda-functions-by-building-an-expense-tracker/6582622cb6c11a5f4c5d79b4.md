...
Bado ndani ya kifungu cha `elif`, pitisha mzunguko wa `expenses_from_category` kwa wito wa `print_expenses`.

# --hints--

Unapaswa kuita `print_expenses()` ukipitisha `expenses_from_category` kama hoja katika kifungu chako cha `elif`.
...
Wito wako wa `print_expenses()` unapaswa kuja baada ya kigezo cha `expenses_from_category`.
