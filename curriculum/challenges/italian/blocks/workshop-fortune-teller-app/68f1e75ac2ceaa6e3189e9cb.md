...
Controlla se `cardElement` non è un'istanza di `HTMLElement` e, in tal caso, aggiungi un `return`

# --hints--

Dovresti aggiungere un'altra istruzione `if` con la condizione `!(cardElement instanceof HTMLElement)`.
