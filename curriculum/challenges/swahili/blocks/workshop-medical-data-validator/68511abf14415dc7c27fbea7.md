...
Ifuatayo, ongeza ufunguo wa `medications` kwenye kamusi ya `constraints`. Kwa thamani yake tumia `isinstance` kuthibitisha kuwa `medications` ni orodha.

# --hints--

Kamusi yako ya `constraints` inapaswa kuwa na ufunguo wa `medications`.
...
Ufunguo wa `medications` wa kamusi yako ya `constraints` unapaswa kuwa na thamani ya `isinstance(medications, list)`.
