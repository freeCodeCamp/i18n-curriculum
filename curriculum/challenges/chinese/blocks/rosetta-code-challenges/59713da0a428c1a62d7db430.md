...
<a href="https://rosettacode.org/wiki/Cramer%27s_rule" target="_blank" rel="noopener noreferrer nofollow">克莱姆法则</a> 是一种通过使用由系数和右侧值的子集形成的矩阵行列式来求解线性方程组的方程。
...
`cramersRule([[2, -1, 5, 1], [3, 2, 2, -6], [1, 3, 3, -1], [5, -2, -3, 3]], [-3, -32, -47, 49])` 应该返回 `[2, -12, -4, 1]`。
