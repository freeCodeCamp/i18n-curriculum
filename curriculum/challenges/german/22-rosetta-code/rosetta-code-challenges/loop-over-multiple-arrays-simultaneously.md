...
Überschleife mehrere Anordnungen und erstelle eine neue Anordnung, dessen $i^{th}$-Element die Verkettung der $i^{th}$-Elemente jedes der angegebenen Anordnung ist.
