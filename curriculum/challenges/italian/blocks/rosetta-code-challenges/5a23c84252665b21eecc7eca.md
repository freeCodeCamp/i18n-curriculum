...
<ul>
  <li>È 1, oppure</li>
  <li>La rappresentazione decimale del suo quadrato può essere divisa una volta in due parti costituite da numeri interi positivi che sommati danno il numero originale.</li>
</ul>

Nota che una divisione che produce una parte composta solo da 0 non è valida, poiché 0 non è considerato positivo.

Esempi di numeri di Kaprekar:

<ul>
  <li><code>2223</code> è un numero di Kaprekar, perché <code>2223 * 2223 = 4941729</code>, <code>4941729</code> può essere diviso in <code>494</code> e <code>1729</code>, e <code>494 + 1729 = 2223</code></li>
  <li>La serie dei numeri di Kaprekar è nota come A006886, e inizia con <code>1, 9, 45, 55, ...</code></li>
</ul>

# --instructions--

Scrivi una funzione che prende un numero $n$, una base $bs$, e restituisce true se il numero è un numero di Kaprekar per la base data. Altrimenti, la funzione restituisce false.
