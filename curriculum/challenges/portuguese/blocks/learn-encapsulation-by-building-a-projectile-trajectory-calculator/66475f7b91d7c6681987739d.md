...
Você tem uma lista de listas de strings.Una as listas internas para ter uma lista de strings.
...
`create_trajectory()` deve calcular a saída correta para diferentes instâncias.
