...
Kurudi kwenye darasa la `MediaCatalogue`, ongeza docstring inayosema `A catalogue that can store different types of media items.`

# --hints--

Unapaswa kuongeza docstring `A catalogue that can store different types of media items.` kwenye darasa lako la `MediaCatalogue`.
