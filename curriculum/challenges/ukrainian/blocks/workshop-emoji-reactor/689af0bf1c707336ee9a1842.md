...
Тепер замініть вміст функції зворотного виклику слухача події.

Використайте `querySelector`, щоб знайти елемент `.count` всередині кнопки.

Потім виведіть у консоль текстовий вміст елемента `.count`, коли на кнопку натискають.

# --hints--

Ви повинні вивести у консоль текстовий вміст елемента `.count` всередині натиснутої кнопки.
