...
Dentro del método `map`, desestructura las siguientes propiedades del objeto `item`:
...
Debes desestructurar las propiedades `id`, `title`, `views`, `posts_count`, `slug`, `posters`, `category_id`, `bumped_at` del objeto `item`.
