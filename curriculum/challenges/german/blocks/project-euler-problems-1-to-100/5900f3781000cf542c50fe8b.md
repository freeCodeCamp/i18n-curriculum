...
title: 'Aufgabe 12: Dreieckszahl mit vielen Teilern'
challengeType: 1
forumTopicId: 301746
...
Die Folge der Dreieckszahlen entsteht durch das Addieren der natürlichen Zahlen. Die 7. Dreieckszahl wäre also 1 + 2 + 3 + 4 + 5 + 6 + 7 = 28. Die ersten zehn Glieder lauten:

<div style='text-align: center;'>1, 3, 6, 10, 15, 21, 28, 36, 45, 55, ...</div>

Listen wir die Teiler der ersten sieben Dreieckszahlen auf:
...
Wir sehen, dass 28 die erste Dreieckszahl ist, die mehr als fünf Teiler hat.

Wie lautet der Wert der ersten Dreieckszahl, die mehr als `n` Teiler hat?
