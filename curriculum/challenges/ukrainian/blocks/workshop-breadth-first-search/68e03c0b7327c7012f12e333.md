...
Нарешті, викличте `gen_parentheses` з `3` як аргументом, щоб згенерувати всі п’ять дійсних комбінацій трьох пар круглих дужок і виведіть результат у консоль. На цьому практичне заняття завершене.

# --hints--

Ви повинні вивести `gen_parentheses(3)`.
