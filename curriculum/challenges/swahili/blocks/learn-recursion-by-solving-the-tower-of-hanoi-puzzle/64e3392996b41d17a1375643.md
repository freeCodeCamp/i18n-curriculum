...
Kabla ya kuongeza kipengele cha mwisho kwenye lengwa, ongeza maoni yanayosema `move the nth disk from source to target`.

# --hints--

Unapaswa kuongeza maoni yenye maandishi yaliyotolewa kabla ya `rods[target].append(rods[source].pop())`.
