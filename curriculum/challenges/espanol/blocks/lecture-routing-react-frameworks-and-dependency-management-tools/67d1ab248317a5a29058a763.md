...
En una lección anterior, se te presentó brevemente un gestor de paquetes popular llamado npm.
...
Como recuerdas de las lecciones anteriores, esto creará todo el código estándar necesario para lanzar una nueva aplicación React. Antes de que puedas lanzar la aplicación, necesitarás instalar las dependencias ejecutando `npm install` o `npm i` para abreviar.
...
Durante la mayor parte de esta lección, nos hemos centrado en npm. Pero hay otros gestores de paquetes como yarn y pnpm. Entonces, ¿qué gestor de paquetes deberías usar para tu proyecto?
...
¿Cuál de los siguientes NO se menciona en la lección como un ejemplo de un gestor de paquetes popular para JavaScript?
...
Consulta el último minuto de la lección donde se discutió esto.
