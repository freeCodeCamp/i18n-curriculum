...
Usando um seletor de classe, dê ao seu elemento `.cat-left-inner-ear` uma borda esquerda e direita de `20px solid transparent` cada. Também dê a ele uma borda inferior de `40px solid #3b3b4f`.
