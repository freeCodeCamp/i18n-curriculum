...
Your `h1` element should have an opening tag. Tagi za ufunguzi zina sintaksia hii: `<elementName>`.

```js
assert(document.querySelector('h1'));
```

Your `h1` element should have a closing tag. Tagi za kufunga zina `/` mara baada ya herufi ya `<`.
