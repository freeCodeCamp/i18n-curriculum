...
Dopo l'attributo `href`, imposta l'attributo `class` sul valore costante chiamato `linkClass`.

Dopo l'attributo `class`, imposta l'attributo `target` su `"_blank"`.

Infine, inserisci la costante `linkText` tra i tag àncora per mostrare il testo nel collegamento.

# --hints--

Dovresti avere un attributo `class` dopo l'attributo `href`.
...
Dovresti impostare il valore dell'attributo `class` sulla costante chiamata `linkClass`.
...
Dovresti avere un attributo `target` dopo l'attributo `class`.
...
Dovresti impostare il valore dell'attributo `target` su `"_blank"`.
...
Dovresti inserire la costante `linkText` tra i tag àncora.
