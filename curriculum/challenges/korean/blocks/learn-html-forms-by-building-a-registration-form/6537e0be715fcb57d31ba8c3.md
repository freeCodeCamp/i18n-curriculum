...
마지막으로 CSS에 새 선택자를 추가해 `terms and conditions` 링크 요소의 텍스트 색상을 `#dfdfe2`으로 변경하세요.

잘했어요! _Registration Form_ 연습 프로젝트의 마지막 부분을 완료했습니다.

# --hints--


`a` 요소에 `color` 값을 가진 `#dfdfe2`를 지정하세요.
