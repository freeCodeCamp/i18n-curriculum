...
Scrivi una funzione per generare un array di caratteri ASCII minuscoli per un intervallo dato. Per esempio, dato l'intervallo `['a', 'd']`, la funzione dovrebbe restituire `['a', 'b', 'c', 'd']`.
