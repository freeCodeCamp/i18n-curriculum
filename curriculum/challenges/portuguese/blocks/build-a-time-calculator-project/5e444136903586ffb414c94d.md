...
Tempo esperado para terminar com `'(next day)'` quando for o próximo dia.
...
Chamar `add_time('2:59 AM', '24:00')` deve retornar `'2:59 AM (next day)'`.
...
Chamar `add_time('11:59 PM', '24:05')` deve retornar `'12:04 AM (2 days later)'`.
...
Chamar `add_time('8:16 PM', '466:02')` deve retornar `'6:18 AM (20 days later)'`.
