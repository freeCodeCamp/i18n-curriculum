...
Geben Sie Ihrem dritten `.image-wrapper`-Element innerhalb Ihres `img`-Elements ein `src` von `https://cdn.freecodecamp.org/testable-projects-fcc/images/survey-form-background.jpeg`, ein `alt` von `four people working on code`, ein `loading`-Attribut von `lazy`, ein `class`, das auf `image-3` gesetzt ist, ein `width`-Attribut, das auf `600` gesetzt ist, und ein `height`-Attribut, das auf `400` gesetzt ist.

# --hints--

Ihr drittes `img`-Element sollte ein `src` haben, das auf `https://cdn.freecodecamp.org/testable-projects-fcc/images/survey-form-background.jpeg` gesetzt ist.
...
Ihr drittes `img`-Element sollte ein `alt` haben, das auf `four people working on code` gesetzt ist.
...
Ihr drittes `img`-Element sollte ein `loading`-Attribut haben, das auf `lazy` gesetzt ist.
...
Ihr drittes `img`-Element sollte ein `class` haben, das auf `image-3` gesetzt ist.
...
Ihr drittes `img`-Element sollte ein `width`-Attribut haben, das auf `600` gesetzt ist.
...
Ihr drittes `img`-Element sollte ein `height`-Attribut haben, das auf `400` gesetzt ist.
