...
En este ejemplo, la propiedad CSS `color` se usa para establecer el color del texto a `blue`. Al envolver este fragmento de código dentro de etiquetas `<code>`, se comunica al navegador que el texto es un fragmento de código en línea.
...
Revisa el comienzo de la lección para ver los ejemplos mostrados en la página.
