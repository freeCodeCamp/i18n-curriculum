...
Em combinatória, usamos a notação, $\displaystyle \binom 5 3 = 10$

Em geral, $\displaystyle \binom n r = \dfrac{n!}{r!(n-r)!}$, onde $r \le n$, $n! = n \times (n-1) \times ... \times 3 \times 2 \times 1$ e $0! = 1$.

Só quando $n = 23$ um valor ultrapassa um milhão: $\displaystyle \binom {23} {10} = 1144066$.

Quantos valores, não necessariamente distintos, de $\displaystyle \binom n r$ para $1 \le n \le 100$, são maiores que um milhão?
