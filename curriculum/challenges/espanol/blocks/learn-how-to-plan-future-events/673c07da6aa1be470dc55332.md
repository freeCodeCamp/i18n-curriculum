...
It is used to indicate the future in this structure. La primer letra se escribe en mayúscula.
...
This sentence uses the structure `Will + subject + verb` to ask about a planned event in the future. This structure is common in formal questions about future arrangements. Por ejemplo:
