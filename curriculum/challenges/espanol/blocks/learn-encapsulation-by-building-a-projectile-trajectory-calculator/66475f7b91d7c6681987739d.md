...
Tienes una lista de listas de cadenas. Une las listas internas para tener una lista de cadenas.
...
`create_trajectory()` debería calcular la salida correcta para diferentes instancias.
