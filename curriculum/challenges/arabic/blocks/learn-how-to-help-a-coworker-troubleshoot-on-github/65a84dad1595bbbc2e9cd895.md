...
غالبًا ما يستخدم الأشخاص `have already` للحديث عن شيء فعلوه قبل الآن، و`have never` للحديث عن شيء لم يفعلوه في أي وقت سابق. هيا نتدرب على استخدام هاتين العبارتين.
...
`Have already` تُستخدم للحديث عن شيء تم فعله قبل هذه اللحظة. هنا، تقول سارة إنها جربت بعض الأمور بالفعل، أي أنها قامت بها قبل الآن.
