...
Додайте ті самі властивості `display`, `align-items` і `justify-content` зі значеннями до `.foreground-buildings`, які ви використали для `.background-buildings`. Знову це використає гнучкий контейнер, щоб рівномірно розподілити будівлі по низу їхнього контейнера.
