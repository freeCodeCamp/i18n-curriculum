...
Listas não ordenadas são criadas usando o elemento `<ul>` e cada item dentro da lista é criado usando o elemento de item de lista `<li>`.
...
Listas ordenadas são criadas usando o elemento `<ol>`. Cada item individual nelas é novamente criado usando o elemento de item de lista `<li>`. No entanto, cada item da lista em uma lista ordenada começa com um número:
