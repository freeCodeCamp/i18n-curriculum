...
Usar las preposiciones correctas en el contexto de las rutinas diarias es esencial para una comunicación clara.

`At` se usa para horas específicas. Por ejemplo, `I start work at 9:00`.

`After` se usa para secuencias de acciones. Por ejemplo, `I have lunch after the meeting`.

`To` se usa para indicar dirección o destino. Por ejemplo, `I go to the office by bus`.

# --instructions--

Escucha el audio para entender el contexto. Escribe las preposiciones correctas para completar las oraciones sobre la rutina matutina de Sarah.
...
Esta preposición se usa para secuencias de acciones.
...
Esta preposición indica dirección o destino.
