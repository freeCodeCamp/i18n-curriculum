...
Dati i numeri interi positivi $x$, $y$ e $z$, che sono termini consecutivi di una progressione aritmetica, il valore minimo del numero intero positivo $n$ per cui l'equazione $x^2 − y^2 − z^2 = n$ ha esattamente due soluzioni è $n = 27$:
