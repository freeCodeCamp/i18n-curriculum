...
`weapons[currentWeaponIndex]` هو كائن. استخدم ترميز النقطة للحصول على الخاصية `name` لذلك الكائن.

# --hints--

يجب تحديث `newWeapon` ليحمل قيمة `weapons[currentWeaponIndex].name`.
