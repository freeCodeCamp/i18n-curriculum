...
`That's it for now` means that everything that needed to be done or said is complete for the moment. It leaves open the possibility that more may happen later. Por ejemplo:
