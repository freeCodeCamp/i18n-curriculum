...
Ihre letzte Funktion besteht darin, den Nutzenden zu ermöglichen, ihren Warenkorb zu löschen. Fügen Sie eine `clearCart()`-Methode zu Ihrer `ShoppingCart`-Klasse hinzu.

# --hints--

Ihre `ShoppingCart`-Klasse sollte eine `clearCart`-Methode enthalten.
