...
debería volver`studentMsg([92, 88, 12, 77, 57, 100, 67, 38, 97, 89], 37)` debería devolver el siguiente mensaje: `"Class average: 71.7. Your grade: F. You failed the course."`.

```js
assert.strictEqual(studentMsg([92, 88, 12, 77, 57, 100, 67, 38, 97, 89], 37), "Class average: 71.7. Your grade: F. You failed the course.");
```

`studentMsg([56, 23, 89, 42, 75, 11, 68, 34, 91, 19], 100)` debe devolver el siguiente mensaje: `Class average: 50.8`. Your grade: A++. You passed the course."</code>.
