...
أخفي عنصر `#monsterStats` الآن باستخدام خاصية `display`. لا تغيّر أي من التنسيقات الأخرى.

# --hints--

يجب أن يكون لديك محدِّد `#monsterStats`.
...
يجب أن يحتوي محدِّد `#monsterStats` على خاصية `display` بقيمة `none`.
...
يجب أن يحتوي محدِّد `#monsterStats` على حدود (`border`) بقيمة `1px solid #0a0a23`.
...
يجب أن يحتوي محدِّد `#monsterStats` على حشو بمقدار `5px`.
...
يجب أن يحتوي محدِّد `#monsterStats` على خاصية `color` بقيمة `#ffffff`.
...
يجب أن يحتوي محدِّد `#monsterStats` على خاصية `background-color` بقيمة `#c70d0d`.
