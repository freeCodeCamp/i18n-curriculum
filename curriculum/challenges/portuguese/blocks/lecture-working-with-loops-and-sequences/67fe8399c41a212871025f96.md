...
O tipo de dado list é uma sequência ordenada de elementos que podem ser compostos por strings, números ou até outras listas. Semelhante ao JavaScript, listas são mutáveis e usam indexação baseada em zero, o que significa que o primeiro elemento da lista está no índice zero.
