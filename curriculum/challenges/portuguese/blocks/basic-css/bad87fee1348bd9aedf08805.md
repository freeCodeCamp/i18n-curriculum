...
Quando você digitou `<h2 style="color: red;">CatPhotoApp</h2>`, estava estilizando aquele elemento `h2` individual com CSS inline, que significa Cascading Style Sheets.
