...
Adicione `1` ao valor de `sortedIndex`.

Note que o incremento deve ser feito depois de atribuir o elemento da parte esquerda ao array ordenado.

# --hints--

Você deve incrementar o valor atual de `sortedIndex` em um dentro do loop `while`.
