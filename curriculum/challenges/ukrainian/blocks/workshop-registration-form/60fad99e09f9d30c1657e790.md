...
Вирівняйте елемент `form` по центру, задавши йому `margin` зі значенням `0 auto`. Потім зафіксуйте його розмір, встановивши максимальну ширину `500px` і мінімальну ширину `300px`. У межах цього діапазону дозвольте йому мати `width` зі значенням `60vw`.
