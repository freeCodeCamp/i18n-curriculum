...
Для останньої частини практичного заняття потрібно внести кілька змін у розділ контактів внизу.

Першою зміною буде обгорнути розділ контактів у елемент `footer`. Це допоможе читачам екрана ідентифікувати цей розділ як нижній колонтитул сторінки.

# --hints--

На вашій сторінці має бути елемент `footer`.
...
Ваш елемент `footer` має містити елемент `h3` з текстом `Contact Me`.
...
Ваш елемент `footer` має містити елемент `p` з текстом `Email me at camperbot@blog.io`.
