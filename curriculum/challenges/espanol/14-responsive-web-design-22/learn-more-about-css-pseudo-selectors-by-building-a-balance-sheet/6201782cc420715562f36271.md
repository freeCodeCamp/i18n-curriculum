...
Debes tener un selector `#years span[class]`.

```js
assert(new __helpers.CSSHelp(document).getStyle('#years span[class]'));
```

Tu selector `#years span[class]` debe tener una propiedad `font-weight` establecida en `bold`.

```js
assert(new __helpers.CSSHelp(document).getStyle('#years span[class]')?.getPropertyValue('font-weight') === 'bold');
```

Tu selector `#years span[class]` debe tener una propiedad `width` establecida en `4.5rem`.

```js
assert(new __helpers.CSSHelp(document).getStyle('#years span[class]')?.getPropertyValue('width') === '4.5rem');
```

Tu selector `#years span[class]` debe tener una propiedad `text-align` establecida en `right`.
