...
A continuación, necesitarás una función para cuando se envíe el formulario. Define una función `handleSubmit` que acepte un objeto evento, `e`, y llame a `e.preventDefault()`.

# --hints--

Debes definir una función `handleSubmit` con un parámetro `e`.
...
Debes llamar a `e.preventDefault()` dentro de la función `handleSubmit()`.
