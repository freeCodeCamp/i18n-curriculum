...
Partendo dalla cima del triangolo qui sotto e spostandosi verso numeri adiacenti nella riga sottostante, la somma massima dall’alto verso il basso è 23.
...
Trova la somma massima dall’alto verso il basso del triangolo qui sotto:
...
**NOTA:** Poiché ci sono solo 16384 rotte, è possibile risolvere questo problema provando ogni rotta. Tuttavia, il problema 67 è la stessa sfida con un triangolo di cento righe; non può essere risolto con la forza bruta e richiede un metodo intelligente! ;o)
