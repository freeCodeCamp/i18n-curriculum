...
You need to construct the HTML string that will be displayed in the `output` element. Comience asignando un literal de plantilla vacío a la propiedad `innerHTML` del elemento `output` en una nueva línea al final de la función.
