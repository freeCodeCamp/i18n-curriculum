...
Ahora deberías estilizar el CTA para que se vea más como un botón.

Para los colores de fondo y primer plano, asígnale las clases `bg-gradient-to-r`, `from-fuchsia-500`, `to-indigo-600`, `text-white`, `hover:from-fuchsia-600` y `hover:to-indigo-700`. También asígnale las clases `rounded-md` y `block`.

# --hints--

Tu elemento anchor debe tener la clase `bg-gradient-to-r`.
...
Tu elemento anchor debe tener la clase `from-fuchsia-500`.
...
Tu elemento anchor debe tener la clase `to-indigo-600`.
...
Tu elemento anchor debe tener la clase `text-white`.
...
Tu elemento anchor debe tener la clase `hover:from-fuchsia-600`.
...
Tu elemento anchor debe tener la clase `hover:to-indigo-700`.
...
Tu elemento anchor debe tener la clase `rounded-md`.
...
Tu elemento anchor debe tener la clase `block`.
