...
Tu botón de radio debe tener un atributo `id` con el valor `indoor`. Probablemente no has añadido el valor o tienes un error tipográfico. Recuerda que los valores de los atributos deben estar entre comillas.
