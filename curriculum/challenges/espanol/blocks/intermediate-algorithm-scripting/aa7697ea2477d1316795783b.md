...
\- Si una palabra comienza con una consonante, toma la primera consonante o grupo consonántico, muévelo al final de la palabra y añade `ay`.

\- Si una palabra comienza con una vocal, solo agrega `way` al final.
...
Debe manejar palabras donde la primera vocal aparece en medio de la palabra. `translatePigLatin("schwartz")` debería devolver la cadena `artzschway`.
