...
¡Adelante, al siguiente edificio! Anidar dos elementos `div` dentro de `.fb2` y dales clases de `fb2a` y `fb2b`, en ese orden.
...
Debe darle al primer nuevo `div` una clase de `fb2a`.
...
Debe darle al segundo nuevo `div` una clase de `fb2b`.
