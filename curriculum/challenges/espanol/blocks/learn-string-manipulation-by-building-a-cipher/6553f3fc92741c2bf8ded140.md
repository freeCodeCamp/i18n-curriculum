...
Dentro del cuerpo de tu función, renombra las variables `text` y `shift` a `message` y `offset` respectivamente.

# --hints--

Debes renombrar todas las ocurrencias de `text` a `message`.
...
Debes renombrar `shift` a `offset`.
