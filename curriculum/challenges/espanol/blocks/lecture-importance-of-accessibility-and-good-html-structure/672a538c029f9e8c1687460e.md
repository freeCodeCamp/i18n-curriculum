...
Anteriormente aprendiste sobre la estructura adecuada de niveles de encabezado. Ahora, aprenderás cómo una buena estructura de encabezados afecta la accesibilidad.
...
- Usa los títulos en una jerarquía que refleje una organización clara. Por ejemplo, el título de la página debe ser un `h1`, las secciones principales deben introducirse con títulos `h2`, las subsecciones con `h3` y así sucesivamente hasta `h6`.
- No saltes de `h1` a `h3`, ni de `h2` a `h4`, y así sucesivamente.
- Usa textos claros y descriptivos que resuman el contenido que sigue a cada título.
- No uses un título en aislamiento; debe seguirle contenido.
- Usa títulos apropiados cuando sea necesario en lugar de formatear texto para que parezca un título.
