...
Per vedere la tua eccezione personalizzata in azione, trasforma la riga `catalogue.add(series2)` in `catalogue.add('series2')`.

# --hints--

Dovresti trasformare la riga `catalogue.add(series2)` in `catalogue.add('series2')`.
