...
Crea el elemento final `p` para el apartado `.daily-value`. Dale el texto `Potassium 235mg 6%`. Alinea el texto `6%` a la derecha y elimina el borde inferior del elemento `p`.
