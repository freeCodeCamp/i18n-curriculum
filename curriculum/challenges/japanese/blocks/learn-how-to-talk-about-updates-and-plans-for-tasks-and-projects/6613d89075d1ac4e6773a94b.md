...
対話に基づいて、現在の証拠に基づく`going to`の正しい使い方を示している文はどれですか？
...
この文は、将来の可能性のある行動に`will`を使っていますが、現在の証拠に基づく決定の意味が欠けています。
...
ここでは、現在の状況に基づく未来の行動に`will`が使われていますが、チームの現在の専門知識に基づく決定のようなので`going to`の方が適切です。
...
この文は、即興の決定（`will`）に`calling the designer`を使っており適切ですが、現在の証拠に基づく`going to`の使い方は示していません。
