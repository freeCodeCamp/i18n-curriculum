...
Sasa, unapaswa kuhamia kwenye kupamba vipengele vya **mpango wa msikilizaji**.

Toa darasa la `div`, `bg-gray-100` kwa `ring-1` ya nje ya mpango ili kuunda mstari mnene kuzunguka `div`, na `ring-gray-300` kuweka rangi ya giza kwa mstari huo.

# --hints--

Kipengele chako cha `div` kinapaswa kuwa na darasa la `bg-gray-100`.
...
Kipengele chako cha `div` kinapaswa kuwa na darasa la `ring-1`.
...
Kipengele chako cha `div` kinapaswa kuwa na darasa la `ring-gray-300`.
