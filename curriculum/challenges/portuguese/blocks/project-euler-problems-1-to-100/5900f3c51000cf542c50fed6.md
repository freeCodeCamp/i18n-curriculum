...
Um número natural, `N`, que pode ser escrito como a soma e o produto de um conjunto dado de pelo menos dois números naturais, $\{a_1, a_2, \ldots , a_k\}$, é chamado de número produto-soma: $N = a_1 + a_2 + \cdots + a_k = a_1 × a_2 × \cdots × a_k$.
...
De fato, como o conjunto completo de números mínimos produto-soma para 2 ≤ `k` ≤ 12 é $\{4, 6, 8, 12, 15, 16\}$, a soma é `61`.
