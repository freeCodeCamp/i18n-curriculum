...
`get_mood("rock", 111)` は `"happy"` を返すべきです。
...
`get_mood("electronic", 74)` は `"focus"` を返すべきです。
...
`get_mood("classical", 180)` は `"happy"` を返すべきです。
...
`get_mood("rock", 155)` は `"hype"` を返すべきです。
...
`get_mood("electronic", 90)` は `"happy"` を返すべきです。
...
`get_mood("classical", 67)` は `"focus"` を返すべきです。
...
`get_mood("pop", 100)` は `"happy"` を返すべきです。
...
`get_mood("electronic", 135)` は `"hype"` を返すべきです。
