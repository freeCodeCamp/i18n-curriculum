...
Kagua kama `cardElement` si mfano wa `HTMLElement`, na ikiwa ni hivyo, ongeza `return`

# --hints--

Unapaswa kuongeza tamko lingine la `if` lenye sharti la `!(cardElement instanceof HTMLElement)`.
