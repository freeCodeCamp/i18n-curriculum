...
Kopieren Sie die verbleibenden linken Werte in `array`, indem Sie `leftPart[leftArrayIndex]` `array[sortedIndex]` zuweisen.

# --hints--

Der Schleifenkörper sollte `leftPart[leftArrayIndex]` `array[sortedIndex]` zuweisen.
