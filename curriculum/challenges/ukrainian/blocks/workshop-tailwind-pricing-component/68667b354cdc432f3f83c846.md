...
Додайте класи `text-lg`, `font-semibold` та `text-fuchsia-200` до елемента `h2` преміум-плану.

# --hints--

Ваш елемент `h2` має мати клас `text-lg`.
...
Ваш елемент `h2` має мати клас `font-semibold`.
...
Ваш елемент `h2` має мати клас `text-fuchsia-200`.
