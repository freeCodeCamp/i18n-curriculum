...
- **Operaciones aritméticas como suma, resta, multiplicación, división y otras**. Para suma, se llama a `__add__()`, a `__sub__()` para la resta, a `__mul__()` para la multiplicación y a `__truediv__()` para la división.
