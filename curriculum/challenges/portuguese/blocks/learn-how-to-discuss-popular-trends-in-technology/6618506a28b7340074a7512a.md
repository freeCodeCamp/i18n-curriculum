...
Preencha os espaços em branco com as expressões apropriadas.
...
IA quando usada para conversar com seres humanos.Use a forma plural.
...
Pessoa que compra bens ou serviços de uma loja ou empresa.
...
Um sinônimo para `autonomous`.Usado para carros que não precisam de direção manual.
