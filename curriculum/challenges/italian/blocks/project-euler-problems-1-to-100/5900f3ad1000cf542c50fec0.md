...
La frazione continua infinita può essere scritta, $\\sqrt{2} = \[1; (2)]$ dove 2 si ripete *all'infinito*. In modo simile, $\\sqrt{23} = \[4; (1, 3, 1, 8)]$. Si scopre che la sequenza di valori parziali delle frazioni continue per le radici quadrate fornisce le migliori approssimazioni razionali. Consideriamo i convergenti per $\\sqrt{2}$.
...
Quindi la sequenza dei primi dieci convergenti per $\\sqrt{2}$ è:

$1, \\dfrac{3}{2}, \\dfrac{7}{5}, \\dfrac{17}{12}, \\dfrac{41}{29}, \\dfrac{99}{70}, \\dfrac{239}{169}, \\dfrac{577}{408}, \\dfrac{1393}{985}, \\dfrac{3363}{2378}, ...$

La cosa più sorprendente è che la costante matematica importante, $e = \[2; 1, 2, 1, 1, 4, 1, 1, 6, 1, ... , 1, 2k, 1, ...]$. I primi dieci termini nella sequenza dei convergenti per `e` sono:

$2, 3, \\dfrac{8}{3}, \\dfrac{11}{4}, \\dfrac{19}{7}, \\dfrac{87}{32}, \\dfrac{106}{39}, \\dfrac{193}{71}, \\dfrac{1264}{465}, \\dfrac{1457}{536}, ...$

La somma delle cifre nel numeratore del 10<sup>mo</sup> convergente è $1 + 4 + 5 + 7 = 17$.

Trova la somma delle cifre nel numeratore del `n`<sup>mo</sup> convergente della frazione continua per `e`.
