...
Per rendere il tuo progetto simile a una rivista stampata, assegna al selettore `.text` una proprietà `text-align` impostata su `justify`.

# --hints--

Il selettore `.text` dovrebbe avere una proprietà `text-align` impostata su `justify`.
