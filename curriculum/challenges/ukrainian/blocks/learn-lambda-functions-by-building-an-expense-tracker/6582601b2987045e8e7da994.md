...
Після вашого виклику `print()` потрібно відфільтрувати витрати та вивести відфільтрований список. Оголосіть змінну `expenses_from_category` і призначте їй виклик `filter_expenses_by_category`, передаючи `expenses` і `category` як аргумент.

# --hints--

Ви повинні оголосити змінну з ім’ям `expenses_from_category` у вашій умові `elif`.
...
Ви повинні викликати `filter_expenses_by_category()`, передаючи `expenses` і `category` як аргументи, і призначити це вашій змінній `expenses_from_category`.
...
Ваша змінна `expenses_from_category` має йти після виклику `print()`.
