...
title: 'Problema 50: somma consecutiva di numeri primi'
challengeType: 1
forumTopicId: 302161
...
Il numero primo 41 può essere scritto come somma di sei numeri primi consecutivi:

<div style='text-align: center;'>41 = 2 + 3 + 5 + 7 + 11 + 13</div>

Questa è la somma più lunga di numeri primi consecutivi che dà come risultato un numero primo sotto cento.

La somma più lunga di numeri primi consecutivi sotto mille che dà come risultato un numero primo contiene 21 termini ed è uguale a 953.

Quale numero primo, sotto il milione, può essere scritto come somma del maggior numero di numeri primi consecutivi?
