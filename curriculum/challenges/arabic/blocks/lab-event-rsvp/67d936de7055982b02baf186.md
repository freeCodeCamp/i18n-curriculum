...
1. يجب إنشاء نموذج يحتوي على حقول للاسم، البريد الإلكتروني، عدد الحضور، التفضيلات الغذائية، وخيار للإشارة إلى ما إذا كنت ستصطحب ضيوفًا إضافيين.

2. يجب أن يكون لديك حقل إدخال نصي تدخل فيه اسمك (إلزامي).

3. يجب أن يكون لديك حقل إدخال بريد إلكتروني تدخل فيه عنوان بريدك الإلكتروني (إلزامي). يجب أن يتحقق النموذج من صحة التنسيق لضمان أنه بريد إلكتروني صحيح.

4. يجب أن يكون لديك حقل إدخال رقم تدخل فيه عدد الحضور في النموذج (إلزامي)، ويجب ألا يقل العدد عن واحد.

5. يجب أن يكون لديك حقل إدخال نصي تدخل فيه تفضيلاتك الغذائية، وهذه المعلومة اختيارية.

6. يجب أن تتمكن من تحديد أو إلغاء تحديد مربع اختيار للإشارة إلى ما إذا كنت ستصطحب ضيوفًا إضافيين.

7. يجب أن يكون لديك زر لإرسال النموذج، ويجب ألا يتسبب الإرسال في إعادة تحميل الصفحة.

8. يجب أن ترى رسالة تأكيد معروضة أسفل النموذج بعد الإرسال، تليها التفاصيل المقدمة (الاسم، البريد الإلكتروني، عدد الحضور، التفضيلات الغذائية، والضيوف الإضافيون الاختياريون).

إليك رسالة نموذجية بعد إرسال النموذج:
...
يجب أن يكون لديك عنصر `form` واحد يحتوي كل محتوى النموذج.
...
يجب أن يكون لديك عنصران `input` من النوع `text`.
...
يجب أن يكون لديك عنصر `input` واحد من النوع `email`.
...
يجب أن يكون لديك عنصر `input` واحد من النوع `number`.
...
يجب أن يكون لديك عنصر `input` واحد من النوع `checkbox`.
...
يجب أن يكون أحد عناصر `input[type="text"]` إلزاميًا.
...
يجب أن يكون عنصر `input[type="email"]` إلزاميًا.
...
يجب أن يكون عنصر `input[type="number"]` إلزاميًا.
...
يجب ألا يقبل عنصر `input[type="number"]` قيمًا أقل من 1.
...
يجب أن يؤدي تغيير قيمة عناصر `input[type="text"]` إلى تحديث حالة المكوِّن.
...
يجب أن يؤدي تغيير قيمة عناصر `input[type="email"]` إلى تحديث حالة المكوِّن.
...
يجب أن يؤدي تغيير قيمة عناصر `input[type="number"]` إلى تحديث حالة المكوِّن.
...
يجب أن يؤدي تغيير قيمة عناصر `input[type="checkbox"]` إلى تحديث حالة المكوِّن.
...
يجب ألا يؤدي إرسال النموذج إلى إعادة تحميل الصفحة.
...
بعد الإرسال، يجب أن يكون هناك عنصر في الصفحة يشير إلى حالة حقل إدخال الاسم `input`.
...
بعد الإرسال، يجب أن يكون هناك عنصر في الصفحة يشير إلى حالة حقل إدخال البريد الإلكتروني `input`.
...
بعد الإرسال، يجب أن يكون هناك عنصر في الصفحة يشير إلى حالة حقل إدخال عدد الحضور `input`.
...
بعد الإرسال، يجب أن يكون هناك عنصر في الصفحة يشير إلى حالة حقل إدخال التفضيلات الغذائية `input`.
...
بعد الإرسال، يجب أن يكون هناك عنصر في الصفحة يشير إلى حالة حقل إدخال الضيوف الإضافيين `input`.
