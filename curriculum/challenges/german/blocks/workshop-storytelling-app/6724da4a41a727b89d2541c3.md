...
Da die `displayStory` Funktion jetzt korrekt funktioniert, ist es Zeit, die Funktionalität zu den Buttons hinzuzufügen.

Entfernen Sie vorher den `displayStory("scary")` Funktionsaufruf.

# --hints--

Sie sollten den `displayStory("scary")` Funktionsaufruf entfernen.
