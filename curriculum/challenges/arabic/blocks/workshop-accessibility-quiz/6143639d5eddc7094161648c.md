...
سيأخذ هذا القسم اسم الطالب، وعنوان البريد الإلكتروني، وتاريخ الميلاد. أعطِ عناصر `label` خاصيات `for` مناسبة، بالإضافة إلى محتوى نصي. ثم اربط عناصر `input` بعناصر `label` المقابلة.
