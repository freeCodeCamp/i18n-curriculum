...
الآن ستتدرب على ما تعلمته حول الأسئلة الشائعة بالإسبانية من خلال إكمال هذه الحوارات بين Ángela وSebastián.

# --instructions--

استمع إلى الصوت وأكمل الحوار بصيغ الأفعال الصحيحة.
...
تُستخدم هذه الصيغة لطرح الأسئلة غير الرسمية مع الضمير `tú` ("أنت").
...
تُستخدم هذه الصيغة لتقديم اسم الشهرة.
...
تُستخدم هذه الصيغة لذكر اسم الشخص نفسه.

# --explanation--

يحتوي هذا الحوار على الكلمات `llamas` و`llaman` و`llamo`. ثلاث صيغ مختلفة من فعل `llamar` ("ينادي") تُستخدم أثناء التعارف.
