...
Ahora tienes algo que se parece a un edificio. Estás listo para crear tu primera variable.  In previous lessons you learned that variable declarations begin with two dashes (`-`) and are given a name and a value like this: `--variable-name: value;`. En la regla de la clase `bb1`, cree una variable denominada `--building-color1` y asígnele un valor de `#999`.
