...
Використовуючи той самий синтаксис селектора, націльте елементи `th` в рядках таблиці, де `class` є `total`. Вирівняйте текст за лівим краєм та надайте йому відступ зі значенням `0.5rem 0 0.25rem 0.5rem`.
