...
Katika kipengele cha nne cha `td`, ongeza usemi wa kihesabu uliyoingizwa unaoonyesha tofauti ya `views`. Hii itaonyesha idadi ya maoni ambayo chapisho lina.

# --hints--

Unapaswa kuongeza usemi wa kihesabu uliyoingizwa unaoonyesha tofauti ya `views`.
