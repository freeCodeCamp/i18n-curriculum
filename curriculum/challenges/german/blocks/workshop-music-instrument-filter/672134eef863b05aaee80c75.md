...
Um die Filterfunktionalität zu implementieren, benötigen Sie eine Funktion. Deklarieren Sie eine leere Funktion namens `instrumentCards`, die einen einzelnen Parameter entgegennimmt.

# --hints--

Sie sollten eine Funktion namens `instrumentCards` haben.

```js
assert.isFunction(instrumentCards);
```

Ihre `instrumentCards`-Funktion sollte einen einzelnen Parameter entgegennehmen.
