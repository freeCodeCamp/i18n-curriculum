...
Em seguida, você precisa de uma forma de acompanhar quantos participantes são processados pelo portão durante o tick. Crie uma variável chamada `processed` e inicialize-a com `0`.

# --hints--

Você deve criar uma variável chamada `processed` e atribuir a ela um valor de `0`.
