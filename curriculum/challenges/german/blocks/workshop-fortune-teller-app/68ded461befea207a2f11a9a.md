...
Verwenden Sie innerhalb der Funktion `Math.random()` und `Math.floor()`, um ein zufälliges Glück aus dem `items`-Array auszuwählen.
Vergessen Sie nicht, das ausgewählte Glück zurückzugeben.
