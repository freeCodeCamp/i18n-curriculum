...
自己参照数列を生成する方法はいくつかあります。 特によく知られた例の 1 つである<a href="https://rosettacode.org/wiki/Look-and-say_sequence" target="_blank" rel="noopener noreferrer nofollow">読み上げ数列</a>は、正の整数から始め、次いで隣接する同じ数字のまとまりを数え上げ、連結することにより、次の項を生成します。
