...
Uma URL absoluta é um endereço completo usado para acessar um recurso. Ela inclui o protocolo (que pode ser `http`, `https` ou `file`) e o nome do domínio se o recurso estiver na web. Aqui está um exemplo de uma URL absoluta que faz link para o logo do freeCodeCamp:
...
- Use uma URL absoluta ao fazer link para um recurso hospedado em um site externo.
