...
Verdadero o falso: Liu Ming es un diseñador de UI de China.
...
Liu Ming es un diseñador de UI, pero él claramente dice que no es chino.
...
Liu Ming dice `我不是中国人 (wǒ bù shì zhōng guó rén)，我是新加坡人 (wǒ shì xīn jiā pō rén)`, lo que significa que es singapurense, no chino.  

Él también dice `我是 (wǒ shì) UI 设计师 (shè jì shī)`, que significa que es un diseñador de UI.
