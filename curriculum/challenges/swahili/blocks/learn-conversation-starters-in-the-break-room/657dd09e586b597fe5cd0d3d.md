...
`They're` ni kifupisho cha `they are`.

Kwa mfano, `They are in the office` ni sawa na `They're in the office`, na maana yake ni kwamba watu wako ndani ya ofisi.
...
Maria anatumia kifupisho hiki kusema kwamba mbuga ni nzuri kwa ajili ya kupumzika. Herufi ya kwanza imeandikwa kwa herufi kubwa.
