...
Для додаткового контролю над макетом вашого вмісту ви можете створити сітку CSS всередині іншої сітки CSS.

Встановіть властивість `display` для селектора `.heading` у значення `grid`.

# --hints--

Ваш селектор `.heading` має мати властивість `display`, встановлену в `grid`.
