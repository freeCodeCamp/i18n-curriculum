...
بعد ذلك، أنشئ صنفًا فرعيًا باسم `Bee` يرث من الصنف `Bug` مع تعيين المعلمة العامة إلى `string`.

# --hints--

يجب أن يكون لديك صنف باسم `Bee`.
...
يجب أن يرث صنف `Bee` من `Bug` مع معلمة نوع `string`.
