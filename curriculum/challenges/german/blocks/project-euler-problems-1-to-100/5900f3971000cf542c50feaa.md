...
title: 'Aufgabe 43: Teilstring-Divisibilität'
challengeType: 1
forumTopicId: 302100
...
Die Zahl 1406357289 ist eine pandigitale Zahl von 0 bis 9, weil sie aus jeder der Ziffern 0 bis 9 in einer bestimmten Reihenfolge besteht, aber sie besitzt auch eine ziemlich interessante Teilstring-Divisibilitätseigenschaft.

Sei $d_1$ die erste Ziffer, $d_2$ die zweite Ziffer und so weiter. Auf diese Weise stellen wir Folgendes fest:
...
Finden Sie die Summe aller pandigitalen Zahlen von 0 bis `n`, deren Teilstrings `n - 2` dieser Divisibilitätseigenschaften erfüllen.
