...
In questa sfida, devi trovare le stringhe che sono le più lunghe tra quelle date.

# --instructions--

Scrivi una funzione che prende un array di stringhe e restituisce le stringhe che hanno una lunghezza uguale alla lunghezza più lunga.
