...
Tornando alla classe `MediaCatalogue`, aggiungi una docstring che dica `A catalogue that can store different types of media items.`

# --hints--

Dovresti aggiungere la docstring `A catalogue that can store different types of media items.` alla tua classe `MediaCatalogue`.
