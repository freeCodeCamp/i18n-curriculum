...
Como você precisa comparar elementos, você precisará usar um laço `for` aninhado. Este loop deve iterar por cada elemento no array *exceto* o último. Use `j` como sua variável de iteração do laço interno.
...
Seu loop interno `for` deve iterar por cada elemento no array *exceto* o último.
