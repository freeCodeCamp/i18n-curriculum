...
Використайте те саме оголошення `box-shadow` для `.two`, але змініть колір з `#efb762` на `#8f0401`.

# --hints--

Ви повинні встановити властивість `box-shadow` у значення `0 0 3px 3px #8f0401`.
...
Ваш елемент `.two` має мати значення ідентифікатора `box-shadow` рівне `0 0 3px 3px #8f0401`.
