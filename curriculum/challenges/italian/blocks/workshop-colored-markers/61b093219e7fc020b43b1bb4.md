...
Hai già impostato l'opacità del corpo con il nome di un colore e la proprietà `opacity`, ma puoi aggiungere un canale alfa alle altre proprietà di colore CSS.
