...
Ваш масив `allSongs` має містити об’єкт із властивістю `id`, встановленою в число `0`.

```js
assert.strictEqual(allSongs[0].id, 0);
```

Ваш масив `allSongs` має містити об’єкт із властивістю `title`, встановленою в рядок `"Scratching The Surface"`.

```js
assert.equal(allSongs[0].title, "Scratching The Surface");
```

Ваш масив `allSongs` має містити об’єкт із властивістю `artist`, встановленою в рядок `"Quincy Larson"`.

```js
assert.equal(allSongs[0].artist, "Quincy Larson");
```

Ваш масив `allSongs` має містити об’єкт із властивістю `duration`, встановленою в рядок `"4:25"`.

```js
assert.equal(allSongs[0].duration, "4:25");
```

Ваш масив `allSongs` має містити об’єкт із властивістю `src`, встановленою в рядок `"https://cdn.freecodecamp.org/curriculum/js-music-player/scratching-the-surface.mp3"`.
