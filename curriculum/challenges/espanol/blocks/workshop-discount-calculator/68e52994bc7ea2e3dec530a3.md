...
Dentro del método `calculate_best_price`, crea una lista llamada `prices` que contenga `product.price`. Esto asegura que si no se aplican descuentos, el cliente pague el precio completo.

# --hints--

Dentro de `calculate_best_price`, debes crear una lista llamada `prices` que contenga `product.price`.
