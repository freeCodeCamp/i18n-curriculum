...
Ora sai che il pulsante funziona. Rimuovi l'istruzione `console.log` dalla funzione `displayStory`.

# --hints--

Dovresti rimuovere l'istruzione `console.log` dalla funzione `displayStory`.
