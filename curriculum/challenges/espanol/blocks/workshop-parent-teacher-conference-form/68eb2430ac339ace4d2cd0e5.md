...
Ahora, debes aumentar el tamaño de fuente para todos los elementos `label`.

Selecciona el elemento `label` y establece su `font-size` en `1.2rem`.

# --hints--

Debes apuntar al elemento `label`.
