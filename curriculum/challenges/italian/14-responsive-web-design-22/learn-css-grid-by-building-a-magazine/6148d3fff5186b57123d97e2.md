...
Crea un selettore `.quote::before` e assegna alla proprietà `content` il valore `"` seguito da uno spazio.

Poi, crea un selettore `.quote::after` e assegna alla proprietà `content` il valore `"` preceduto da uno spazio.
