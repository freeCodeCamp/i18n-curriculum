...
Dai al selettore `.text-with-images` una proprietà `margin-bottom` impostata su `3rem`.

# --hints--

Il tuo selettore `.text-with-images` dovrebbe avere una proprietà `margin-bottom` impostata su `3rem`.
