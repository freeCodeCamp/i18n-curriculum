...
天际线正在汇合。 填充前景建筑物的 `background-color` 属性。 使用你的 `--building-color1` 变量填充 `.fb3` 和 `.fb4`、`--building-color2` 变量填充 `.fb5`、`--building-color3` 变量填充 `.fb2` 和 `.fb6`、`--building-color4` 变量填充 `.fb1`。
