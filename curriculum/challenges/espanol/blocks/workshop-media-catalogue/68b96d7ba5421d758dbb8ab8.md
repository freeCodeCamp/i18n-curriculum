...
Crea otra cláusula `except` que capture `MediaError as e`. Dentro del bloque `except`, usa una f-string para imprimir `Media Error:` seguido de un espacio y el mensaje de error.

# --hints--

Debes tener una cláusula `except` que capture `MediaError as e`.
...
Debes usar una f-string para imprimir `Media Error:` seguido de un espacio y el mensaje de error dentro de tu nuevo bloque `except`.
