...
Dé la clase `sky` un `radial-gradient`. Use `#ffcf33` desde `0%` hasta `20%`, `#ffff66` en `21%`, y `#bbeeff` en `100%`. Esto añadirá un degradado circular al fondo que será el sol.

# --hints--

Debe dar a `.sky` un `radial-gradient` en la propiedad `background`.
...
Debe dar al `radial-gradient` un segundo color de `#ffff66` en `21%`.
...
Debe dar al `radial-gradient` un tercer color de `#bbeeff` en `100%`.
