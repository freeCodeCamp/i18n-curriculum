...
Якщо ширина екрана невелика, то `h1` не переносить текстовий вміст як треба. Вирівняйте текст елемента `h1` за центром.
...
Ви повинні лише змінити значення `padding-top`.
