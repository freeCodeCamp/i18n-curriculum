...
`Sure thing.` is an informal and friendly way to say `Of course` or `I'll do it`. It shows that the speaker agrees to the request without hesitation. Por ejemplo:
