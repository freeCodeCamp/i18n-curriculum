...
Proporcione al `wave` cuatro puntos de referencia comenzando en `10%`, y incrementando en `10%`.

# --hints--

Debe agregar un punto de referencia del `10%` para `@keyframes wave`.
...
Debe agregar un punto de referencia del `20%` para `@keyframes wave`.
...
Debe agregar un punto de referencia del `30%` para `@keyframes wave`.
...
Debe agregar un punto de referencia del `40%` para `@keyframes wave`.
...
Debe tener 4 puntos de referencia en su fotograma clave.
