...
Una volta fatto ciò, apri la console e prova a cliccare i pulsanti del tuo progetto.

# --hints--

Dovresti assegnare il riferimento della funzione <0>goStore</0> a <0>button1.onclick</0>. Assicurati di non chiamare la funzione.
...
Dovresti assegnare il riferimento della funzione <0>goCave</0> a <0>button2.onclick</0>. Assicurati di non chiamare la funzione.
...
Dovresti assegnare il riferimento della funzione <0>fightDragon</0> a <0>button3.onclick</0>. Assicurati di non chiamare la funzione.
