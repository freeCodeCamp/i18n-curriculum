...
Punguza kivuli cha mzunguko wako wa `for` kwa kiwango kimoja ili uendeshwe tu wakati katalogi ina filamu ndani yake. Kisha, badilisha `self.items` na `movies` ili upite juu ya filamu tu.

# --hints--

Unapaswa kupunguza kivuli cha mzunguko uliopo wa `for` kwa kiwango kimoja na kubadilisha `self.items` na `movies` ili upite juu ya filamu tu.
...
Wakati `self.items` ina `Movie('Barry Lyndon', 1975, 'Stanley Kubrick', 184)` na `Movie('Fahrenheit 451', 1966, 'Francois Truffaut', 112)`, njia yako ya `__str__` inapaswa kurudisha `Media Catalogue (2 items):\n\n=== MOVIES ===\n1. Barry Lyndon (1975) - 184 min, Stanley Kubrick\n2. Fahrenheit 451 (1966) - 112 min, Francois Truffaut\n`.
