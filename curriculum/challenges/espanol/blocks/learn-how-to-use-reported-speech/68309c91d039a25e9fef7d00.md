...
`Then` at the end of a sentence is used to show a conclusion, suggestion, or result that follows from something just mentioned. It often gives the idea of a result or consequence. Por ejemplo:
