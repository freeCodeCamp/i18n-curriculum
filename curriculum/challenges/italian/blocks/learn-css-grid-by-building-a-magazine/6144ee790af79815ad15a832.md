...
Inizia creando un selettore `main` e dandogli una proprietà `display` impostata su `grid`.
...
Il selettore `main` dovrebbe avere una proprietà `display` impostata su `grid`.
