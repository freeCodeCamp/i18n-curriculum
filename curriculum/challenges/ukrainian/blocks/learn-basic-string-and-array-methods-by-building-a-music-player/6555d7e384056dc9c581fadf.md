...
Щоб забезпечити оновлення відображення гравця щоразу, коли починає грати нова пісня, викличте функцію `setPlayerDisplay()` всередині функції `playSong()`.

Тепер ви повинні побачити назву пісні та виконавця на екрані.

# --hints--

Ви повинні викликати функцію `setPlayerDisplay` всередині вашої функції `playSong`.
