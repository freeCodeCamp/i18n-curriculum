...
Щоб зробити лапи пінгвіна більш схожими на пінгвінячі, поверніть ліву лапу на `80deg`, а праву — на `-80deg`.

# --hints--

Ви маєте надати `.foot.left` властивість `transform` зі значенням `rotate(80deg)`.
...
Ви маєте надати `.foot.right` властивість `transform` зі значенням `rotate(-80deg)`.
