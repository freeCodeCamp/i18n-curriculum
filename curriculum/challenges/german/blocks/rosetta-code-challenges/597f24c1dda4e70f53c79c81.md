...
Schreiben Sie eine Funktion, um die <code>n<sup>te</sup></code> Fibonacci-Zahl zu erzeugen.

Die <code>n<sup>te</sup></code> Fibonacci-Zahl wird definiert durch:

<code>F<sub>n</sub> = F<sub>n-1</sub> + F<sub>n-2</sub></code>

Die ersten beiden Glieder der Folge sind 0 und 1.

Daher lautet die Folge: 0, 1, 1, 2, 3, 5, 8, 13...
