...
In England besteht die Währung aus Pfund, £, und Pence, p, und es gibt acht Münzen im allgemeinen Umlauf:

<div style='margin-left: 4em;'>1p, 2p, 5p, 10p, 20p, 50p, £1 (100p) und £2 (200p).</div>

Es ist möglich, £2 auf folgende Weise zu bilden:

<div style='margin-left: 4em;'>1×£1 + 1×50p + 2×20p + 1×5p + 1×2p + 3×1p</div>

Wie viele verschiedene Möglichkeiten gibt es, `n` Pence mit beliebig vielen Münzen zu bilden?
