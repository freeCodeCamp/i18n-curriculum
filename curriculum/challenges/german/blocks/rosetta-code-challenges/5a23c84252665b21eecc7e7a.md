...
Schreibe eine Funktion, die ein Array von ASCII-Kleinbuchstaben für einen bestimmten Bereich erzeugt. Zum Beispiel: der Bereich `['a', 'd']` sollte die Funktion `['a', 'b', 'c', 'd']` zurückgeben.
