...
Тепер настав час встановити вибрану вкладку як активну.

Використайте метод `setAttribute` на `tab`, щоб встановити атрибут `aria-selected` у значення `"true"`.

# --hints--

Коли натискають на `tab`, атрибут `aria-selected` натиснутої вкладки має бути встановлений у `"true"`.
