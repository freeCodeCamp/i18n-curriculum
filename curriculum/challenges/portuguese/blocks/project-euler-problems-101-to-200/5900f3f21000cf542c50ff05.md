...
De fato, com exceção de $p_1 = 3$ e $p_2 = 5$, para todo par de primos consecutivos, $p_2 > p_1$, existem valores de $n$ para os quais os últimos dígitos são formados por $p_1$ e $n$ é divisível por $p_2$.Considere $S$ o menor destes valores de $n$.
