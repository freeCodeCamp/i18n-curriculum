...
يدعم تطبيق العراف عرض عدة بطاقات، لذا تحتاج إلى طريقة تساعد في عرض عدة بطاقات. أعلن عن طريقة باسم `multipleCardSelected`.

داخل الطريقة، استدعِ الدالة `hideElements` ومرر الخصائص `singleCard`، `singleCardBtn`، `multipleCardsBtn`، و`headerTitle`. لا تنسَ أنه يجب عليك الوصول إليها من `this.elements`.

# --hints--

يجب أن تعلن عن طريقة `multipleCardSelected`.
...
يجب أن تستدعي الدالة `hideElements` داخل طريقة `multipleCardSelected`.
...
يجب أن تمرر `singleCard` كأول معلمة إلى الدالة `hideElements`.
...
يجب أن تمرر `singleCardBtn` كمعلمة إلى الدالة `hideElements`.
...
يجب أن تمرر `multipleCardsBtn` كمعلمة إلى الدالة `hideElements`.
...
يجب أن تمرر `headerTitle` كمعلمة إلى الدالة `hideElements`.
