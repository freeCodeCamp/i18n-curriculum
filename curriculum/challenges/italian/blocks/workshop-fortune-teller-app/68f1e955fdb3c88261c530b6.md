...
Aggiungi un'istruzione `if` per verificare se `foundCard` esiste prima di aggiornare gli elementi con i suoi dati o blocco di contenuto.

# --hints--

Dovresti dichiarare un'istruzione `if` con la condizione `foundCard`.
