...
Ndani ya mzunguko wa `for`, tangaza kigezo `row_str` na uweke thamani ya orodha inayojirudia inayorudia kwenye `row` na kubadilisha kila kipengee `i` katika `row` kuwa mfuatano wa herufi. Tumia kitendakazi cha `str()` kwa ajili hiyo.

# --hints--

Unapaswa kutangaza kigezo `row_str`.
...
Unapaswa kuweka thamani ya orodha inayojirudia inayorudia kwenye `row` kwa kigezo `row_str`.
...
Orodha inayojirudia iliyopewa thamani kigezo `row_str` inapaswa kutumia `i` kama kigezo cha kurudia.
...
Orodha inayojirudia iliyopewa thamani kigezo `row_str` inapaswa kuita `str()` kwa kila kipengee `i` katika `row`.
