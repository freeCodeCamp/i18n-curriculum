...
メディアクエリの`sky`クラスで、2つの`#ffcf33`の色の値を`#ccc`に、`#ffff66`を`#445`に、`#bbeeff`を`#223`に変更してください。そうすれば、ウィンドウのサイズを変更すると背景の色が変わるのが見えます。

# --hints--

最初の色の値を`#ffcf33`から`#ccc`に変更してください。
...
2番目の色の値を`#ffff66`から`#445`に変更してください。
...
3番目の色の値を`#bbeeff`から`#223`に変更してください。
