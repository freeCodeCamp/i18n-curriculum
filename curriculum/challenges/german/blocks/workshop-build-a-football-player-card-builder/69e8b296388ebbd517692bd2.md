...
Der Abschnitt Player Info ist jetzt fertig. Fügen Sie nach dem schließenden `div` des Player Info-Abschnitts und noch innerhalb von `form-panel` ein neues `div` hinzu. Fügen Sie darin ein `p`-Element mit dem `className` von `form-section-title` und dem Text `Player Stats` ein. Dann fügen Sie ein `div` mit dem `className` von `stats-grid` hinzu. Lassen Sie das Statistikraster vorerst leer.

# --hints--

Ihr `div.form-panel` sollte einen zweiten `div` für den Abschnitt Player Stats enthalten.
...
Der Abschnitt Player Stats sollte ein `p` mit dem `className` von `form-section-title` und dem Text `Player Stats` enthalten.
...
Der Abschnitt Player Stats sollte ein `div` mit dem `className` von `stats-grid` enthalten.
