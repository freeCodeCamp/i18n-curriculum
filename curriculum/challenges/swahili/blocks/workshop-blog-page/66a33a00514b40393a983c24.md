...
Kwa chapisho la tatu la blogi, utahitaji kuongeza kipengele kingine cha `article`.

Ndani ya kipengele cha `article`, ongeza kipengele cha `h3` chenye maandishi ya `Mr. Whiskers' First Birthday Party`.

Chini ya kipengele chako cha `h3`, ongeza aya mbili za maandishi ya lorem ipsum.

# --hints--

Unapaswa kuwa na kipengele cha tatu cha `article` ndani ya kipengele chako cha `section` na `id` imewekwa kuwa `posts`.
...
Unapaswa kuwa na kipengele cha `h3` ndani ya kipengele cha `article` chenye maandishi ya `Mr. Whiskers' First Birthday Party`.
