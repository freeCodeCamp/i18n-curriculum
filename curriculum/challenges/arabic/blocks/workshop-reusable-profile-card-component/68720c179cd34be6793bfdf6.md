...
بينما يعمل تطبيقك كما هو متوقع، عادةً لا تضيف مكونات `Card` متعددة يدويًا بهذه الطريقة.

احذف مكونات `<Card />` الثلاثة داخل عنصر `<div className="flex-container">`. في الخطوات التالية، ستنشئ مصفوفة من البيانات وتستخدم الدالة `map()` لعرض مكونات `Card`، وهي الطريقة الأكثر شيوعًا في React.

# --hints--

يجب حذف مكونات `<Card />` الثلاثة من شفرتك.
