...
Du solltest die Wörter `See more` vor dem Ankerelement haben. Stelle sicher, dass das Leerzeichen nach dem letzten Wort eingefügt ist.

```js
assert.match(code, /See more <a href=/)
```

Du solltest die Wörter `in our gallery` nach dem Ankerelement haben. Stelle sicher, dass das Leerzeichen vor dem ersten Wort eingefügt ist.
