...
첫 번째 `label`에 해당 `input` 요소의 `id`와 일치하는 `for` 속성을 부여하세요.
...
두 번째 `label`에 해당 `input` 요소의 `id`와 일치하는 `for` 속성을 부여하세요.
...
세 번째 `label`에 해당 `input` 요소의 `id`와 일치하는 `for` 속성을 부여하세요.
...
네 번째 `label`에 해당 `input` 요소의 `id`와 일치하는 `for` 속성을 부여하세요.
