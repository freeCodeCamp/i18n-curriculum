...
Present continuous is used for actions happening at the moment of speaking. 举个例子：
...
Present continuous can be used in negative forms to express that something is not happening. 例如：
