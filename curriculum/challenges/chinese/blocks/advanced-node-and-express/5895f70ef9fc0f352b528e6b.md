...
这将创建一个带有类 `center` 和 id `welcome` 的 `h2` 元素，包含文本 `Welcome, `，后跟用户名。
...
当你认为页面已经正确时提交。如果遇到误差，你可以<a href="https://forum.freecodecamp.org/t/advanced-node-and-express/567135#how-to-put-a-profile-together-9" target="_blank" rel="noopener noreferrer nofollow">查看到目前为止完成的项目</a>。
