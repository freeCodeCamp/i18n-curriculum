...
Ваш рукав виглядає добре, але він виглядав би ще краще, якби був розташований ближче до правої сторони маркера. Один зі способів зробити це — додати ще один елемент перед рукавом, щоб зсунути його вправо.

Додайте новий `div` з класом `cap` перед елементом рукава `div`.

# --hints--

Ваш новий елемент `div` має бути всередині червоного маркера `div`.
...
Ваш новий елемент `div` має мати клас `cap`.
...
Ваш ковпачок `div` має бути перед рукавом `div`.
