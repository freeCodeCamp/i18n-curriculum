...
這樣看起來比較好。現在試著為你的選單的上下方添加相同的 `20px` 內距。

# --hints--

你不應該移除 `padding-left` 或 `padding-right` 屬性。
...
你的 `.menu` 元素應該有 `padding-top` 為 `20px`。
...
你的 `.menu` 元素應該有 `padding-bottom` 為 `20px`。
