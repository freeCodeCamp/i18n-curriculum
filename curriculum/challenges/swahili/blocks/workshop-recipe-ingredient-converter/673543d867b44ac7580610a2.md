...
Katika hatua hii, utaimaliza kitendakazi cha `updateResultsList`.

Sasa rudia kupitia safu ya data ya `units`. Kwa kila thamani, angalia kama haifanani na kitengo cha sasa (`unitToConvert.value`).

Kama hali ni kweli, badilisha kitengo kilichopo kuwa kitengo cha sasa na ongeza kipengee kipya cha orodha kwenye `resultList` kwa muundo:

`ingredient: quantity unit`

Kwa mfano, kama ingizo ni `flour`, `5`, na `gram`, matokeo yanapaswa kuwa:
...
Unapobofya kitufe, kitendakazi chako cha `updateResultsList` kinapaswa kusahihisha DOM ipasavyo.
