...
Para dar uma cor a `hr`, você precisa ajustar a propriedade `border`.Dê ao seletor de `hr` uma `border` definida como `1px solid rgba(120, 120, 120, 0.6)`.

# --hints--

O elemento `hr` deve ter a propriedade `border` definida como `1px solid rgba(120, 120, 120, 0.6)`.
