...
Sua função está agora completa. Teste-a novamente imprimindo `gen_parentheses(2)` em vez de `gen_parentheses(1)`.

# --hints--

Você deve imprimir `gen_parentheses(2)`.
...
Você não deve ter `print(gen_parentheses(1))` no seu código
