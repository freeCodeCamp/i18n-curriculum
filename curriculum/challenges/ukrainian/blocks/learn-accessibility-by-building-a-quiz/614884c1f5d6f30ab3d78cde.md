...
Ви маєте використати селектор `.formrow`, щоб націлити `.formrow` елементи.

```js
assert.exists(new __helpers.CSSHelp(document).getStyle('.formrow'));
```

Ви маєте додати `.formrow` поле з `margin-top` не менше ніж `1px`.
...
Ви маєте додати `.formrow` `padding-top` `0`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.formrow')?.paddingTop, '0px');
```

Ви маєте додати `.formrow` `padding-right` не менше ніж `1px`.
...
Ви маєте додати `.formrow` `padding-bottom` `0`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.formrow')?.paddingBottom, '0px');
```

Ви маєте додати `.formrow` `padding-left` не менше ніж `1px`.
...
Ви маєте використати селектор `input`, щоб націлити `input` елементи.

```js
assert.exists(new __helpers.CSSHelp(document).getStyle('input'));
```

Ви маєте додати `input` `font-size` більший за `13px`.
