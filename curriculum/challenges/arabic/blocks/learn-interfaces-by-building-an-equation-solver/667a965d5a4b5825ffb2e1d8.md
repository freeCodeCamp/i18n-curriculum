...
عدّل السلاسل النصية الموجودة داخل `details_list` لمحاذاة القيم الرقمية للانحدار والاعتراض إلى اليمين. يجب أن يكون الناتج النهائي بهذا الشكل:
...
لاحظ أن خيار المحاذاة والعرض يجب أن يوضعا بين النقطتين والفاصل الخاص بدقة التنسيق.

# --hints--

يجب أن تُرجع الدالة `solver` سلسلة نصية مختلفة.
