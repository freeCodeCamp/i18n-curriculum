...
Aggiungi un listener per l'evento `"click"` all'elemento `pauseButton`, poi passa `pauseSong` come secondo argomento del listener. Questa è la funzione che il listener eseguirà.

Prova la tua app cliccando prima sul pulsante play e poi su quello pausa. Dovresti vedere che tutto funziona come previsto.
