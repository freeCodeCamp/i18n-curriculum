...
استخدم دالتك `chunkCrew()` لإنشاء قطع بحجم `3` من مصفوفة `EVAReadySquad` وخزنها في متغير جديد اسمه `EVAChunks`.

# --hints--

يجب استدعاء `chunkCrew()` مع `EVAReadySquad` و `3` وتخزين النتيجة في متغير جديد اسمه `EVAChunks`.
