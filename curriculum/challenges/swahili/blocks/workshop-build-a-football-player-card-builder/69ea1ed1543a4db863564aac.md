...
Badilisha thamani ya funguo ya `position` kuwa `Position` iliyotokana.

# --hints--

Sehemu ya `PlayerData` ya kiolesura chako cha `position` inapaswa kutumia aina ya `Position` badala ya `string`.
