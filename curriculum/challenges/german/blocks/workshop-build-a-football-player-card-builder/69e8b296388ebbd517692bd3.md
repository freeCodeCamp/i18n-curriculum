...
Für das erste fügen Sie ein `label` mit dem `className` von `label`, ein `htmlFor` von `pac` und den Text `PAC` hinzu, dann eine Eingabe mit einem `id` von `pac`, einem `className` von `input` und einem `type` von `number`.
...
Ihr erstes `div`-Element von `className` von `form-group` sollte ein `label` mit einem `htmlFor`-Attribut von `pac`, einem `className` von `label` und einem Text `PAC` haben.
...
Ihr erstes `div`-Element von `className` von `form-group` sollte ein `input` mit einem `className` von `input`, einem `id` von `pac` und einem `type` von `number` haben.
...
Ihr zweites `div`-Element von `className` von `form-group` sollte ein `label` mit einem `htmlFor`-Attribut von `sho`, einem `className` von `label` und einem Text `SHO` haben.
...
Ihr zweites `div`-Element von `className` von `form-group` sollte ein `input` mit einem `id` von `sho`, einem `className` von `input` und einem `type` von `number` haben.
