...
`Pounds` son una unidad de peso utilizada para medir cuán pesado es algo. Por ejemplo, si una bolsa de manzanas pesa `2 pounds` (para aquellos que usan el sistema métrico, aproximadamente 1 `kilogram`), significa que las manzanas son tan pesadas como eso.
