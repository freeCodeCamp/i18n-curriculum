...
Після циклу while, потрібно вставити ваше поточне значення. Пам’ятайте, що цикл закінчується, коли `j` або виходить за межі масиву, або коли значення `j` менше за поточне значення.

Використайте оператор присвоєння, щоб вставити поточне значення в правильний індекс.

# --hints--

Призначте `currValue` індексу `j + 1`.
