...
Se você quiser atribuir a fonte visualmente, pode adicionar um elemento de citação, `cite`, fora do elemento de citação em bloco. Isso é diferente do atributo `cite`. O elemento de citação é um elemento HTML que você pode usar para marcar o título de uma obra criativa referenciada, como um livro, artigo, música, filme, site ou artigo de pesquisa. Aqui está um exemplo:
