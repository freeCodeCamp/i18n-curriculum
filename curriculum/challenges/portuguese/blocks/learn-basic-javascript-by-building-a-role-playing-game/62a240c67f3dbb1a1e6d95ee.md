...
Seu seletor `#game` deve ter um `background-color` de `#ffffff`.
...
Seu seletor `#game` deve ter uma `color` de `#ffffff`.
...
Seu seletor `#game` deve ter um `margin-top` definido como `30px`.
...
Seu seletor `#game` deve ter um `margin-left` definido como `auto`.
...
Seu seletor `#game` deve ter um `margin-right` definido como `auto`.
...
Seu seletor `#game` deve ter um `margin-bottom` definido como `0px`.
