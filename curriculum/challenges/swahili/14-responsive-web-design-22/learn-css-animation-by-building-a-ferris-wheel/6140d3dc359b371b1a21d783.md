...
Kichaguzi chako cha `.cabin:nth-of-type(1)` kinafaa kuwa na sifa ya `right` iliyowekwa kuwa `-8.5%`.
...
Kichaguzi chako cha `.cabin:nth-of-type(1)` kinafaa kuwa na sifa ya `top` iliyowekwa kuwa `50%`.
