...
Змініть `background-color` елемента `.three` на `#b20403`.

# --hints--

Ви повинні встановити властивість `background-color` на `#b20403`.
...
Ваш елемент `.three` повинен мати `background-color` зі значенням `#b20403`.
