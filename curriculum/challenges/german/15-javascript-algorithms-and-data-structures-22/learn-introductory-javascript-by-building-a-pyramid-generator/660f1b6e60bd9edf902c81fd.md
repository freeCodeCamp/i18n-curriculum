...
Wenn du einer Variable einen neuen wert zuweist, kannst du vor der Zuweisung zum vorherigen Wert referenzieren. Damit kannst du zum Beispiel drei zu einer bestehenden Zahl hinzufügen. For example, `bees = bees + 3` would increase the value of `bees` by three.
