...
الآن لننتقل إلى الأعداد في الخمسينيات.

في الإسبانية، يُسمى الرقم 50 بـ `cincuenta`.

تُكوَّن الأعداد من 51 إلى 59 باستخدام كلمة العشرات `cincuenta` (50)، تليها أداة العطف `y` ("و"), ثم رقم الآحاد (1-9).
...
الرقم `cincuenta y uno` (51) فريد في هذه المجموعة لأنه يصبح `cincuenta y un` قبل الاسم المذكر. على سبيل المثال:

`Cincuenta y un años` - واحد وخمسون سنة.
...
تدرّبت على نطق الأعداد من 50 إلى 59.
