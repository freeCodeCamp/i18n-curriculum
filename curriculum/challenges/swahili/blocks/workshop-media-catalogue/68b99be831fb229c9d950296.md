...
Kwa kutumia mantiki ile ile, tengeneza tamko la `if` linalotekelezwa wakati orodha ya `series` si tupu. Ndani yake, ungana mfuatano wa herufi `=== TV SERIES ===` (unaomalizika na tabia ya kuingia mstari mpya) na thamani ya sasa ya `result`.

Kisha, tengeneza mzunguko wa `for` unaotumia kuorodhesha ili kuongeza vitu vilivyomo kwenye orodha ya `series` kwenye kigezo cha `result`. Kama ulivyofanya awali, anza kuhesabu kielezo cha thamani kuanzia `1`.

Kwa hivyo, warsha ya katalogi ya vyombo vya habari imekamilika.

# --hints--

Unapaswa kuwa na tamko la `if` la pili ndani ya njia yako ya `__str__`.
...
Unapaswa kuwa na `result += '=== TV SERIES ===\n'` ndani ya tamko lako la pili la `if`.
...
Unapaswa kuwa na mzunguko wa `for` ndani ya tamko lako la pili la `if`.
...
Wakati `self.items` inajumuisha `Movie('Dances with Wolves', 1990, 'Kevin Costner', 224)` na `Movie('Annie Hall', 1977, 'Woody Allen', 93)`, njia yako ya `__str__` inapaswa kurudisha `Media Catalogue (2 items):\n\n=== MOVIES ===\n1. Dances with Wolves (1990) - 224 min, Kevin Costner\n2. Annie Hall (1977) - 93 min, Woody Allen\n`.
...
Wakati `self.items` inajumuisha `TVSeries("Game of Thrones", 2011, "David Benioff & D.B. Weiss", 57, 8, 73)` na `TVSeries("Stranger Things", 2016, "The Duffer Brothers", 50, 4, 34)`, njia yako ya `__str__` inapaswa kurudisha `Media Catalogue (2 items):\n\n=== TV SERIES ===\n1. Game of Thrones (2011) - 8 seasons, 73 episodes, 57 min avg, David Benioff & D.B. Weiss\n2. Stranger Things (2016) - 4 seasons, 34 episodes, 50 min avg, The Duffer Brothers\n`.
...
Wakati `self.items` inajumuisha `Movie('Barry Lyndon', 1975, 'Stanley Kubrick', 184)`, `Movie('Fahrenheit 451', 1966, 'Francois Truffaut', 112)`, `TVSeries("Game of Thrones", 2011, "David Benioff & D.B. Weiss", 57, 8, 73)` na `TVSeries("Stranger Things", 2016, "The Duffer Brothers", 50, 4, 34)` njia yako ya `__str__` inapaswa kurudisha `Media Catalogue (4 items):\n\n=== MOVIES ===\n1. Barry Lyndon (1975) - 184 min, Stanley Kubrick\n2. Fahrenheit 451 (1966) - 112 min, Francois Truffaut\n=== TV SERIES ===\n1. Game of Thrones (2011) - 8 seasons, 73 episodes, 57 min avg, David Benioff & D.B. Weiss\n2. Stranger Things (2016) - 4 seasons, 34 episodes, 50 min avg, The Duffer Brothers\n`.
