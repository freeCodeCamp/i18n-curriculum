...
作為最後一步，為你的程式碼添加一個帶有訊息 `"Workshop complete! You now know how to use includes() and slice()."` 的 `console.log()` 述語。

恭喜！你已完成 String Inspector 工作坊。

# --hints--

你應該將 `"Workshop complete! You now know how to use includes() and slice()."` 記錄到主控台。
