...
**Nota:** Para este desafio, você precisa adicionar novos elementos HTML à página, portanto, não pode depender de `textContent`. Em vez disso, você precisa usar `innerHTML`, o que pode tornar um site vulnerável a ataques de scripts entre sites.
