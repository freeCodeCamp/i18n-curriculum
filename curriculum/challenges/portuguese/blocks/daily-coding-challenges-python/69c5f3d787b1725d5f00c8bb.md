...
title: "Desafio 257: compressor de palavras"
challengeType: 29
...
Dada uma string, retorne uma versão comprimida da string usando as seguintes regras:

- A primeira ocorrência de uma palavra permanece inalterada.
- Ocorrências subsequentes são substituídas pela posição da primeira ocorrência, onde a primeira palavra está na posição 1.
- As palavras são separadas por um único espaço.

Por exemplo, dada `"practice makes perfect and perfect practice makes perfect"`, retorne `"practice makes perfect and 3 1 2 3"`.

# --hints--

`compress("practice makes perfect and perfect practice makes perfect")` deve retornar `"practice makes perfect and 3 1 2 3"`.
...
`compress("hello hello hello")` deve retornar `"hello 1 1"`.
...
`compress("the cat sat on the mat on which the cat sat")` deve retornar `"the cat sat on 1 mat 4 which 1 2 3"`.
...
`compress("the more you know the more you realize you don't know")` deve retornar `"the more you know 1 2 3 realize 3 don't 4"`.
