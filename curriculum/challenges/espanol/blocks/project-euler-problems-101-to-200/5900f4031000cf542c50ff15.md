...
En un arreglo triangular de enteros positivos y negativos, deseamos encontrar un sub-triángulo tal que la suma de los números que contiene sea la más pequeña posible.
...
$$\begin{align}
  t := & \\ 0\\\\
  \text{para}\\ & k = 1\\ \text{hasta}\\ k = 500500:\\\\
  & t := (615949 × t + 797807)\\ \text{módulo}\\ 2^{20}\\\\
  & s_k := t − 219\\\\
\end{align}$$
