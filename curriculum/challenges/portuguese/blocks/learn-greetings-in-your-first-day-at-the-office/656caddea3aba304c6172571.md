...
`Ergonomic` refere-se ao design de produtos destinados a proporcionar conforto ideal e evitar estresse ou lesão.
...
Esta palavra está relacionada ao conforto e design no local de trabalho, especialmente usada para prevenir tensões ou lesões.
