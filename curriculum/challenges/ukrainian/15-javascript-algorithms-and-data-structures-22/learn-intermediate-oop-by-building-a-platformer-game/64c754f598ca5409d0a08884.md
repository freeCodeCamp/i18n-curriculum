...
Ви повинні мати об’єкт із властивістю `x` зі значенням `500` та властивістю `y` зі значенням `proportionalSize(450)`. You are using the `proportionalSize()` function here to make sure the `y` value is proportional to the screen size.
