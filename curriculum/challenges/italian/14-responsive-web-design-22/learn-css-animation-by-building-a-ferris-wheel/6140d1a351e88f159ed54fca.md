...
Il selettore `.line:nth-of-type(3)` dovrebbe avere una proprietà `transform` con il valore `rotate(120deg)`.
...
Il selettore `.line:nth-of-type(4)` dovrebbe avere una proprietà `transform` con il valore `rotate(180deg)`.
...
Il selettore `.line:nth-of-type(5)` dovrebbe avere una proprietà `transform` con il valore `rotate(240deg)`.
...
Il selettore `.line:nth-of-type(6)` dovrebbe avere una proprietà `transform` con il valore `rotate(300deg)`.
