...
title: 'Aufgabe 350: Einschränkung des kleinsten größten und des größten kleinsten'
challengeType: 1
forumTopicId: 302010
...
Das kleinste gemeinsame Vielfache, oder $lcm$, einer Liste ist die kleinste natürliche Zahl, die durch jeden Eintrag der Liste teilbar ist. Beispiele: $lcm(2, 6, 4) = 12$, $lcm(10, 6, 15, 6) = 30$ und $lcm(11) = 11$.

Sei $f(G, L, N)$ die Anzahl der Listen der Größe $N$ mit $gcd ≥ G$ und $lcm ≤ L$. Zum Beispiel:
...
Finden Sie $f({10}^6, {10}^{12}, {10}^{18})\bmod {101}^4$.
