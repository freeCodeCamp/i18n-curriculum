...
Agora você deve estilizar o CTA para que pareça mais com um botão.

Para as cores de fundo e primeiro plano, atribua as classes `bg-gradient-to-r`, `from-fuchsia-500`, `to-indigo-600`, `text-white`, `hover:from-fuchsia-600` e `hover:to-indigo-700`. Também atribua a ele as classes `rounded-md` e `block`.

# --hints--

Seu elemento anchor deve ter a classe `bg-gradient-to-r`.
...
Seu elemento anchor deve ter a classe `from-fuchsia-500`.
...
Seu elemento anchor deve ter a classe `to-indigo-600`.
...
Seu elemento anchor deve ter a classe `text-white`.
...
Seu elemento anchor deve ter a classe `hover:from-fuchsia-600`.
...
Seu elemento anchor deve ter a classe `hover:to-indigo-700`.
...
Seu elemento anchor deve ter a classe `rounded-md`.
...
Seu elemento anchor deve ter a classe `block`.
