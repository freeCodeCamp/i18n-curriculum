...
Створіть селектор `.lists` і встановіть властивість `list-style-type` у значення `none`. Це позбавить елементи списку маркерів.
...
Ваш селектор `.lists` має мати властивість `list-style-type`, встановлену в `none`.
