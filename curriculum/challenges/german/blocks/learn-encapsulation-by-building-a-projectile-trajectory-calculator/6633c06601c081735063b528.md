...
Sie haben einen Rechner für die Flugbahn eines Projektils erstellt.

Zum Abschluss ändern Sie den Code, den Sie außerhalb der Klassen geschrieben haben, und integrieren ihn in eine kleine Hilfsfunktion namens `projectile_helper`, die die gewünschten Werte für Geschwindigkeit, Höhe und Winkel entgegennimmt und nacheinander die Details des Projektils, die Tabelle der Koordinaten und die Grafik der Flugbahn im Terminal ausgibt.

Rufen Sie `projectile_helper` einmal mit Werten Ihrer Wahl auf.

# --hints--

Sie sollten `projectile_helper` im globalen Gültigkeitsbereich erstellen.
...
Sie sollten die angeforderten Strings in der richtigen Reihenfolge ausgeben. Geben Sie keine anderen Werte aus.
...
Sie sollten die Funktion `projectile_helper` mindestens einmal aufrufen.
...
Sie sollten keine Variablen oder Ausgaben im globalen Gültigkeitsbereich haben.
