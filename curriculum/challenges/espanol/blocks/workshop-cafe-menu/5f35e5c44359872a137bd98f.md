...
Dado que el producto principal a la venta en el café es el café, podrías usar una imagen de granos de café como fondo de la página.

Elimina el comentario y sus contenidos dentro del selector de tipo `body`. Después de eso, añade una propiedad `background-image` y establece su valor como `url(https://cdn.freecodecamp.org/curriculum/css-cafe/beans.jpg)`.
