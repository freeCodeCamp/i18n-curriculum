...
Rudia kwa nambari kamili chanya zenye nambari hata na chapisha kila moja kwenye konsoli.

# --hints--

Unapaswa kuwa na mzunguko wa `for` juu ya `even_digits` ndani ya kitendakazi cha `verify_card_number`.
