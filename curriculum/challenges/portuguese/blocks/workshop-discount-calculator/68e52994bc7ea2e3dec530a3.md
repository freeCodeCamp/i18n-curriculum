...
Dentro do método `calculate_best_price`, crie uma lista chamada `prices` contendo `product.price`. Isso garante que, se nenhum desconto for aplicado, o cliente pague o preço cheio.

# --hints--

Dentro de `calculate_best_price`, você deve criar uma lista chamada `prices` contendo `product.price`.
