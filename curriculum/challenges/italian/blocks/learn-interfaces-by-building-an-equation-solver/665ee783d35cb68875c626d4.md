...
Ora, rimuovi entrambe le chiamate `print(lin_eq.solve())` e `print(lin_eq.analyze())` dal tuo codice.

# --hints--

Dovresti rimuovere entrambe le chiamate `print(lin_eq.solve())` e `print(lin_eq.analyze())`.
