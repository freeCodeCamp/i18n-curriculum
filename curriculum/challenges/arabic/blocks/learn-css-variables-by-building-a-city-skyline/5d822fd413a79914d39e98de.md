...
أنشئ متغيرًا جديدًا أسفل متغير `--building-color1`. سمِّ المتغير الجديد `--building-color2` وأعطه القيمة `#66cc99`. ثم اجعله `background-color` لعنصر `.bb2`.
...
يجب إعطاء `--building-color2` القيمة `#66cc99` داخل صنف `.bb1`.
