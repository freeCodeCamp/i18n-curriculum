...
Il quinto elemento `div` di `className` di `form-group` dovrebbe avere un `label` con un attributo `htmlFor` di `def`, un `className` di `label` e un testo `DEF`.
...
Il quinto elemento `div` di `className` di `form-group` dovrebbe avere un `input` con un `className` di `input`, un `id` di `def` e un `type` di `number`.
...
Il sesto elemento `div` di `className` di `form-group` dovrebbe avere un `label` con un attributo `htmlFor` di `phy`, un `className` di `label` e un testo `PHY`.
...
Il sesto elemento `div` di `className` di `form-group` dovrebbe avere un `input` con un `className` di `input`, un `id` di `phy` e un `type` di `number`.
