...
Продовжуйте, додавши `div` з `className` з `form-row`. Всередині нього додайте два елементи `div` з `className` `form-group` кожен.

Перший елемент `div` має мати `label` з `className` з `label`, атрибут `htmlFor` зі значенням `position`, текстовий `Position` і `input` з `id` `position`, `className` `input` і `type` `text`.

# --hints--

Ваш розділ Player Info має містити `div` з `className` `form-row`.
...
Ваш `div.form-row` має містити два елементи `div`, кожен з `className` `form-group`.
...
Ваш перший `form-group` у рядку має мати `label` з `className` `label` і `htmlFor` `position`.
...
Ваш позиційний `label` має містити текст `Position`.
...
Ваш перший `form-group` у рядку має мати `input` з `className` `input`, `id` `position` і `type` `text`.
