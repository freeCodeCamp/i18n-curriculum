...
Dentro de tu elemento `.image-wrapper`, dale a tu tercer elemento `img` un `src` de `https://cdn.freecodecamp.org/testable-projects-fcc/images/survey-form-background.jpeg`, un `alt` de `cuatro personas trabajando en código`, un atributo `loading` de `lazy`, una `class` establecida a `image-3`, un atributo `width` establecido a `600` y un atributo `height` establecido a `400`.

# --hints--

Tu tercer elemento `img` debe tener un `src` establecido a `https://cdn.freecodecamp.org/testable-projects-fcc/images/survey-form-background.jpeg`.
...
Tu tercer elemento `img` debe tener un `alt` establecido a `cuatro personas trabajando en código`.
...
Tu tercer elemento `img` debe tener un atributo `loading` establecido a `lazy`.
...
Tu tercer elemento `img` debe tener una `class` establecida a `image-3`.
...
Tu tercer elemento `img` debe tener un atributo `width` establecido a `600`.
...
Tu tercer elemento `img` debe tener un atributo `height` establecido a `400`.
