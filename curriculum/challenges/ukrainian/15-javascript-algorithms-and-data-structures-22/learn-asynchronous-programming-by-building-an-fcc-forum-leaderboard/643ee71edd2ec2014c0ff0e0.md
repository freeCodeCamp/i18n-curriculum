...
У четвертий елемент `td` додайте вбудований вираз, який містить змінну `views`. Тут буде показано кількість переглядів публікації.

# --hints--

Додайте вбудований вираз, який містить змінну `views`.
