...
Debes darle a `.bb1a` un `width` de `70%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.bb1a')?.width, '70%');
```

Debes darle a `.bb1a` un `height` de `10%`.
...
Debes darle a `.bb1b` un `width` de `80%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.bb1b')?.width, '80%');
```

Debes darle a `.bb1b` un `height` de `10%`.
...
Debes darle a `.bb1c` un `width` de `90%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.bb1c')?.width, '90%');
```

Debes darle a `.bb1c` un `height` de `10%`.
...
Debes darle a `.bb1d` un `width` de `100%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.bb1d')?.width, '100%');
```

Debes darle a `.bb1d` un `height` de `70%`.
