...
你的第三个 `img` 元素应该有一个 `src` 值为 `https://cdn.freecodecamp.org/testable-projects-fcc/images/survey-form-background.jpeg`。
...
你的第三个 `img` 元素应该有一个 `loading` 属性值为 `lazy`。
