...
Actualiza tu declaración de consola para usar notación de corchetes para acceder a la propiedad `"Number of legs"` del objeto `cat`.

Abre la consola para ver el resultado.

# --hints--

Tu declaración de consola ahora debería tener el valor de `cat["Number of legs"]`.
