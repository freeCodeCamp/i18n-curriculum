...
`Every month` means something happens once per month, regularly. Por ejemplo:
...
`Every two weeks` means something happens once every two weeks, or twice a month. Por ejemplo:
...
`Vigilant` means being watchful and careful to avoid risks or problems. Por ejemplo:
