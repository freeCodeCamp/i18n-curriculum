...
给定你的登录 `Log` 数组，确定你是否达到了你的数字的戒断目标。

每个日志都是格式为 `"YYYY-MM-DD HH:mm:ss"` 的字串。

如果以下两个语句都为真，则你已达到你的数字的戒断目标：
...
`digital_detox(["2026-02-01 08:00:00", "2026-02-01 12:30:00"])` 应该返回 `True`。
...
`digital_detox(["2026-02-01 04:00:00", "2026-02-01 07:30:00"])` 应返回 `False`。
...
`digital_detox(["2026-01-31 08:21:30", "2026-01-31 14:30:00", "2026-02-01 08:00:00", "2026-02-01 12:30:00"])` 应该返回 `True`。
...
`digital_detox(["2026-01-31 10:40:21", "2026-01-31 15:19:41", "2026-01-31 21:49:50", "2026-02-01 09:30:00"])` 应该返回 `False`。
...
`digital_detox(["2026-02-05 10:00:00", "2026-02-01 09:00:00", "2026-02-03 22:15:00", "2026-02-02 12:10:00", "2026-02-02 07:15:00", "2026-02-04 09:45:00", "2026-02-01 16:50:00", "2026-02-03 09:30:00"])` 应该返回 `True`。
...
`digital_detox(["2026-02-05 10:00:00", "2026-02-01 09:00:00", "2026-02-03 22:15:00", "2026-02-02 12:10:00", "2026-02-02 07:15:00", "2026-02-04 01:45:00", "2026-02-01 16:50:00", "2026-02-03 09:30:00"])` 应该返回 `False`。
