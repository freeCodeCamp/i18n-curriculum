...
داخل عنصر `div`، نفذ استدعاء الدالة `avatars` ومرر المعلمتين `posters` و `users`.

الآن يجب أن ترى الصور الرمزية معروضة على الصفحة.

# --hints--

يجب أن تنفذ استدعاء الدالة المسماة `avatars`.
...
يجب أن يحتوي استدعاء الدالة على المعلمتين `posters` و `users`.
