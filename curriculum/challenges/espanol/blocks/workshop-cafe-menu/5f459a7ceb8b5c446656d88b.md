...
Observa el color gris a lo largo de los bordes de la línea. Esos bordes son conocidos como <dfn>border</dfn>. Cada lado de un elemento puede tener un color diferente o todos pueden ser iguales.

Haz que todos los bordes del elemento `hr` tengan el mismo color que el fondo; utilizando la propiedad `border-color`.

# --hints--

Debes de darle a la propiedad `border-color` el valor `brown` (café).
...
Tu elemento `hr` debe tener un color de borde (`border-color`) café (`brown`).
