...
En el diálogo, Tom utiliza `It's` como una contracción de `It` y `is`. Esta contracción se utiliza a menudo en el inglés hablado para expresar sentimientos u opiniones sobre algo. Haremos esto en el siguiente desafío.
