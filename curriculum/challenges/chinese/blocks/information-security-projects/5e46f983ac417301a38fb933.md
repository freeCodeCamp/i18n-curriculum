...
你将使用我们的 Ona 公式化代码<a href="https://app.ona.com/?autostart=true#https://github.com/freeCodeCamp/boilerplate-SHA-1-password-cracker" target="_blank" rel="noopener noreferrer nofollow">在此项目中工作</a>。
...
- <a href="https://www.freecodecamp.org/news/learn-python-basics-in-depth-video-course/" target="_blank" rel="noopener noreferrer nofollow">深入学习 Python 基础</a>（4 小时）

- <a href="https://www.freecodecamp.org/news/intermediate-python-course/" target="_blank" rel="noopener noreferrer nofollow">中级 Python 课程</a>（6 小时）
...
`hashlib` 库已为你导入。你应该考虑在你的代码中使用它。<a href="https://docs.python.org/3/library/hashlib.html" target="_blank" rel="noopener noreferrer nofollow">在这里了解更多关于 "hashlib" 的信息</a>。
