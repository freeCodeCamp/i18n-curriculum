...
Come hai fatto prima per il metodo `__eq__`, crea un'istruzione `if` che verifichi se `self` e `other` non appartengono alla stessa classe e restituisca `NotImplemented`.
