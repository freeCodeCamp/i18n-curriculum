...
Додайте елементу `#text` `background-color` зі значенням `#0a0a23`, `color` зі значенням `#ffffff` та `10px` відступів з усіх боків.

# --hints--

У вас має бути селектор `#text`.
...
Ваш елемент `#text` має мати `background-color` зі значенням `#0a0a23`.
...
Ваш елемент `#text` має мати `color` зі значенням `#ffffff`.
...
Ваш елемент `#text` має мати `10px` відступів з усіх боків.
