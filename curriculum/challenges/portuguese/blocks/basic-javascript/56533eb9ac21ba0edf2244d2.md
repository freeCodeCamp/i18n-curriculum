...
O operador de desigualdade (`!=`) é o oposto do operador de igualdade.Desigualdade significa que duas coisas não são iguais.O operador de desigualdade retorna `false` quando o operador de igualdade retornaria `true` e *vice-versa*.Tal como o operador de igualdade, o operador de desigualdade converterá os tipos de dados de valores enquanto compara.
