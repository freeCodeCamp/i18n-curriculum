...
Después de los tres elementos `p` dentro de su elemento `.text`, cree un elemento `blockquote`. Dentro de eso, agregue un elemento `hr`, un elemento `p` con `class` establecido en `quote`, y un segundo elemento `hr`.

Dale al elemento `.quote` el texto `The entire curriculum should be a series of projects`.
...
Tu nuevo elemento `p` debe tener el texto `The entire curriculum should be a series of projects`.
