...
Usando sintaxis de propagación, acabamos de lograr una operación que habría sido más compleja y verbosa si hubiéramos utilizado métodos tradicionales.
...
La función `spreadOut` debe utilizar sintaxis de propagación
