...
接下来，将红色的颜色停止点设置为 `0%`，将绿色的颜色停止点设置为 `50%`，将蓝色的颜色停止点设置为 `100%`。

# --hints--

你的 `.red` CSS 规则应该有一个设置为 `linear-gradient(180deg, rgb(255, 0, 0) 0%, rgb(0, 255, 0) 50%, rgb(0, 0, 255) 100%)` 的 `background` 属性。
