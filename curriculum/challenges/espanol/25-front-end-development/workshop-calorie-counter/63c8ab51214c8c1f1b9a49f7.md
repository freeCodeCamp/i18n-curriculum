...
En tu nueva función, declara una variable `calories` y asígnale el valor `0`. Usa `let` para declarar la variable, ya que la reasignarás más tarde.
...
Tu variable `calories` debería ser asignada con el valor `0`.
