...
املأ الفراغات بالتعبيرات المناسبة.
...
الذكاء الاصطناعي عند استخدامه للدردشة مع البشر. استخدم صيغة الجمع.
...
الشخص الذي يشتري السلع أو الخدمات من متجر أو عمل تجاري.
...
مرادف لـ `autonomous`. يُستخدم للسيارات التي لا تحتاج إلى قيادة يدوية.
