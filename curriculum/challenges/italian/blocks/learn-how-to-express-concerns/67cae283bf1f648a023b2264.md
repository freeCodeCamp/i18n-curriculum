...
Questo significa non avere abbastanza di qualcosa che serve.

# --explanation--

`To be short on something` significa non averne abbastanza, causando difficoltà. Per esempio:

`We're short on time, so we need to finish quickly.` - Questo significa che non c'è abbastanza tempo per completare tutto.
