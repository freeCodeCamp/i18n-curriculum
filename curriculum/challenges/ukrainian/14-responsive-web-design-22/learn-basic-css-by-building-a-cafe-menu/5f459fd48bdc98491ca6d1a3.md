...
Додайте ще один елемент `hr` між елементом `main` та елементом `footer`.

# --hints--

Ви повинні додати другий елемент `hr`.

```js
assert.lengthOf(document.querySelectorAll('hr'), 2);
```

Ваш новий елемент `hr` повинен бути між елементом `main` та елементом `footer`.
