...
بينما عناصر `ul`/`li` ممتازة لتوفير نقاط للقوائم، فإن أزرار الاختيار الخاصة بك لا تحتاجها. يمكنك التحكم في شكل النقاط باستخدام خاصية `list-style`. على سبيل المثال، يمكنك تحويل النقاط إلى دوائر كما يلي:
...
أزل التنسيق الافتراضي لعناصر `.answers-list` بتعيين نمطها إلى `none`، وأزل الحشو من قائمة غير مرتبة.

# --hints--

يجب أن تستخدم المحدد `.answers-list`.
