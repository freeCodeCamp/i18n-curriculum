...
이제 CTA를 버튼처럼 보이도록 스타일링하세요.

배경색과 전경색에는 `bg-gradient-to-r`, `from-fuchsia-500`, `to-indigo-600`, `text-white`, `hover:from-fuchsia-600`, `hover:to-indigo-700` 클래스를 할당하세요. 또한 `rounded-md`와 `block` 클래스를 할당하세요.

# --hints--

앵커 요소에는 `bg-gradient-to-r` 클래스를 할당해야 합니다.
...
앵커 요소에는 `from-fuchsia-500` 클래스를 할당해야 합니다.
...
앵커 요소에는 `to-indigo-600` 클래스를 할당해야 합니다.
...
앵커 요소에는 `text-white` 클래스를 할당해야 합니다.
...
앵커 요소에는 `hover:from-fuchsia-600` 클래스를 할당해야 합니다.
...
앵커 요소에는 `hover:to-indigo-700` 클래스를 할당해야 합니다.
...
앵커 요소에는 `rounded-md` 클래스를 할당해야 합니다.
