...
أنشئ متغيرًا جديدًا تحت المتغيرات الأخرى باسم `--building-color3` وأعطه القيمة `#cc6699`. ثم استخدمه كـ `background-color` للصنف `.bb3` وأعطه قيمة النظام البديل `pink`.
