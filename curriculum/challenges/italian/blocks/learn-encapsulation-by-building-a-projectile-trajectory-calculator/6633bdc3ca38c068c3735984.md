...
Aggiungi gli assi x e y al grafico per ottenere il seguente output:
...
I simboli sono disponibili come `x_axis_tick` e `y_axis_tick`.

# --hints--

Il metodo dovrebbe restituire l'output corretto.
...
Il metodo dovrebbe restituire l'output corretto per istanze diverse.
