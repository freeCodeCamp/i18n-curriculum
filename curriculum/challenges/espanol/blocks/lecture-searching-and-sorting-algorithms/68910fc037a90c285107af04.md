...
El paradigma divide y vencerás en la informática es una técnica para descomponer recursivamente problemas en subproblemas más pequeños. Uno de los aspectos clave de esta técnica es la recursión, que ocurre cuando una función se llama a sí misma repetidamente hasta que se alcanza un caso base. En esta lección, veremos el algoritmo merge sort para entender mejor cómo funciona la técnica divide y vencerás.
