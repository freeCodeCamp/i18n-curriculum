...
Dentro do loop, defina o evento `oninput` de cada elemento `input` para a função `handleInput`.

Com isso, a oficina do gerenciador de formas está completa!

# --hints--

Você deve definir `input.oninput` para a função `handleInput`.
