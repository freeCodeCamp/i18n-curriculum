...
El principio fundamental del diseño adaptable es la adaptabilidad: la capacidad de un sitio web para ajustar su diseño y contenido según el tamaño de la pantalla y las capacidades del dispositivo en el que se visualiza.

El diseño adaptable normalmente se basa en tres componentes principales:
...
- Además, las media queries permiten a los desarrolladores aplicar diferentes estilos basados en las características del dispositivo, principalmente en el ancho del viewport. Aprenderás más sobre media queries en lecciones futuras.
...
En lecciones anteriores aprendiste cómo trabajar con Flexbox y en lecciones futuras aprenderás cómo trabajar con CSS Grid. Pero por ahora, aquí tienes una breve introducción a CSS Grid.
