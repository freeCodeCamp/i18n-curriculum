...
Sasa panga maandishi kulingana na `right` kwa vitu vyenye darasa la vitu la `price`.

# --hints--

Unapaswa kuwa na kichaguzi cha darasa la vitu la `price`.
...
Kichaguzi chako cha darasa la vitu la `price` kinapaswa kuweka sifa ya `text-align` kuwa `right`.
