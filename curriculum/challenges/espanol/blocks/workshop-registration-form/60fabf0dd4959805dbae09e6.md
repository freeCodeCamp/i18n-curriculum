...
Agrega otro `label` después del primero, con el texto `Input your age (years): `. Luego, anida un `input` con el `type` de `number`.
...
Debes darle al `label` el texto `Input your age (years): `.
