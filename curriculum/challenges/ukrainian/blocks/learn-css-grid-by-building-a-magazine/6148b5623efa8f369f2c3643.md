...
Дайте селектору `.hero` множину властивостей `position` зі значенням `relative`.

# --hints--

Ваш селектор `.hero` має мати множину властивостей `position` зі значенням `relative`.
