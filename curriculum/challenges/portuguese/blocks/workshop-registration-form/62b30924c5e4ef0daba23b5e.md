...
A borda do último elemento `fieldset` parece um pouco fora de lugar. 

Nas lições anteriores, você aprendeu como trabalhar com a pseudo-classe CSS `last-of-type` assim: 
