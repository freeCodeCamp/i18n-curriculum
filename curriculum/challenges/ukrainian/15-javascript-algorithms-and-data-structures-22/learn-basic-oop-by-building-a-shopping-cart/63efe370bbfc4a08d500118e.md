...
Тепер у вас є маленька помилка. Коли ви намагаєтеся використовувати властивість об’єкта, а властивості не існує, ви отримуєте `undefined`. Це означає, що якщо десерт ще не присутній в об’єкті `totalCountPerProduct`, ви намагаєтеся додати `1` до `undefined`, що призводить до `NaN`.

Щоб виправити це, ви можете використати оператор `||`, щоб встановити значення на `0`, якщо воно не існує. Згорніть правий `totalCountPerProduct[dessert.id]` у дужки та додайте `|| 0` до кінця виразу.

# --hints--

Загорніть `totalCountPerProduct[dessert.id]` справа у дужки.
...
Ви повинні використовувати `0` як резервне значення.
...
Ви все ще повинні додати `1` до значення.
