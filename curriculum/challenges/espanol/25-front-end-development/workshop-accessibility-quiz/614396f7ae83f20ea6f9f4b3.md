...
El texto `.sr-only` todavía es visible. Existe un patrón común para ocultar visualmente texto solo para que lo lean los lectores de pantalla.

Este patrón es establecer las siguientes propiedades CSS:
