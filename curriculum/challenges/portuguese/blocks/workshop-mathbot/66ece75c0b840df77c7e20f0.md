...
Para a última etapa do workshop, você irá registrar a mensagem `"It was fun learning about the different Math methods with you!"` no console.

E com essa última alteração, você concluiu o workshop MathBot! 

# --hints--

Você deve registrar a mensagem `"It was fun learning about the different Math methods with you!"` no console.
