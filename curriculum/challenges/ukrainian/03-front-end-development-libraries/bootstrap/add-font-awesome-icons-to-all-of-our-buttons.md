...
title: Додайте іконки Font Awesome до всіх кнопок
challengeType: 0
forumTopicId: 16637
required:
  - 
...
Використайте Font Awesome, щоб додати іконку `info-circle` до кнопки з інформацією та іконку `trash` до кнопки видалення.

**Примітка:** ви можете використати елемент `i` або `span`, щоб виконати це завдання.

# --hints--

Додайте `<i class="fas fa-info-circle"></i>` в межах кнопки `info`.
...
Додайте `<i class="fas fa-trash"></i>` в межах кнопки `delete`.
...
Кожен елемент `i` повинен мати кінцевий тег, а `<i class="fas fa-thumbs-up"></i>` має знаходитись в межах кнопки `like`.
