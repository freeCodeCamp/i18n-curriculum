...
أزل الآن الأسطر التالية من أسفل شفرتك:
...
يجب ألا تحتوي شفرتك على السطر `print(product)`.
...
يجب ألا تحتوي شفرتك على السطر `discount = PercentageDiscount(10)`.
...
يجب ألا تحتوي شفرتك على السطر `print(discount.apply_discount(product))`.
...
يجب ألا تحتوي شفرتك على السطر `fixed_discount = FixedAmountDiscount(5)`.
...
يجب ألا تحتوي شفرتك على السطر `print(fixed_discount.apply_discount(product))`.
