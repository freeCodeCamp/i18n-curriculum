...
`Look forward to` expresses enthusiasm, not indifference. Gleichgültigkeit würde einen Mangel an Interesse implizieren, was hier nicht der Fall ist.
...
`Look forward to` expresses eagerness, not avoidance. Vermeidung würde den Wunsch suggerieren, dass man sich fernhalten möchte, im Gegensatz zu der Bedeutung, sich auf etwas zu freuen.
...
`Look forward to` expresses anticipation, not unawareness. Unwissenheit würde einen Mangel an Wissen über etwas suggerieren, was nicht mit der positiven Erwartung übereinstimmt, die ausgedrückt wurde.
