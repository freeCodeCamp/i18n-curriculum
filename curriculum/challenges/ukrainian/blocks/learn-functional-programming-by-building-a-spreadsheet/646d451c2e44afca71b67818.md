...
Оголосіть `apply` функцію, яка приймає `fn` і `args` параметри.

# --hints--

Ви повинні оголосити змінну `apply`.
...
Ви повинні використати `const` для оголошення змінної `apply`.
...
Вашій змінній `apply` має бути призначена стрілкова функція.
...
Ваша функція `apply` має мати `fn` як перший параметр.
...
Ваша функція `apply` має мати `args` як другий параметр.
...
Ваша функція `apply` має бути порожньою.
