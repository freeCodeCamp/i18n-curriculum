...
All'interno del primo waypoint, ruota verso `110deg` e mantieni la scala del braccio sinistro.

# --hints--

Dovresti dare al waypoint `10%` un `transform` di `rotate(110deg) scaleX(-1)`.
