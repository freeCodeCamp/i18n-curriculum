...
¿Cómo debería la estructura de estilo del estado de error relacionarse con la estructura de estilo del estado de enfoque?

#### --distractors--

Deben ser idénticos para mantener la consistencia.

---

El estado de error debe ser menos visible para evitar alarmar a los usuarios.

---

El estado de error debe estar animado mientras que el estado de enfoque debe ser estático.

#### --answer--

El estado de error debe ser distinto del estado de enfoque.
