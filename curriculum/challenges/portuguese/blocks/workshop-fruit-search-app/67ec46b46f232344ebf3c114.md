...
Em seguida, você criará um formulário onde os usuários podem buscar por frutas. Dentro do elemento `#search-container`, crie um elemento `form`.

# --hints--

Você deve ter um elemento `form` dentro do elemento `search-container`.
