...
Обгорніть ваші елементи `h1` і `p` в елемент `div`. Дайте цьому `div` атрибут `class` зі значенням `label`.
...
Ваш новий елемент `div` повинен мати атрибут `class` зі значенням `label`.
