...
Ändere die Stapelebene des `.penguin-head`-Elements, so dass es vor dem `.penguin-body`-Element erscheint.
...
Du solltest dem `.penguin-head`-Element einen `z-index` von `1` geben.
