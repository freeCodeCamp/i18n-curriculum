...
`rgb_to_hex("rgb(255, 255, 255)")` deve retornar `"#ffffff"`.
...
`rgb_to_hex("rgb(1, 11, 111)")` deve retornar `"#010b6f"`.
...
`rgb_to_hex("rgb(173, 216, 230)")` deve retornar `"#add8e6"`.
...
`rgb_to_hex("rgb(79, 123, 201)")` deve retornar `"#4f7bc9"`.
