...
Declara una variable `isCartCleared` y asígnale el valor de llamar a `confirm()` con la cadena `"Are you sure you want to clear all items from your shopping cart?"`.
...
Debes pasar la cadena `Are you sure you want to clear all items from your shopping cart?` a la función `confirm()`.
