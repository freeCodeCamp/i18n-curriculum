...
Use o elemento `.divider` existente como um exemplo para adicionar um novo divisor após o elemento `p`.

# --hints--

Você deve criar um `div` dentro do elemento `.daily-value`.
...
O novo `div` deve vir após o elemento `p`.
