...
Ora sostituisci il contenuto della callback del listener dell'evento.

Usa `querySelector` per trovare l'elemento `.count` all'interno del pulsante.

Poi registra il contenuto testuale dell'elemento `.count` quando il pulsante viene cliccato.

# --hints--

Dovresti registrare il contenuto testuale dell'elemento `.count` all'interno del pulsante cliccato.
