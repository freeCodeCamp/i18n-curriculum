...
Створіть функцію з іменем `setPlayerDisplay`. Усередині функції встановіть `textContent` для `playingSong` на назву поточної пісні, якщо вона визначена. Інакше встановіть порожній рядок.

Нижче встановіть `textContent` для `songArtist` на виконавця поточної пісні, якщо він визначений. Інакше встановіть порожній рядок.


# --hints--

У вас має бути функція з іменем `setPlayerDisplay`.

```js
assert.isFunction(setPlayerDisplay);
```

Ваша функція `setPlayerDisplay` має встановити `textContent` для `playingSong` на назву поточної пісні, якщо вона визначена, або на порожній рядок.
...
Ваша функція `setPlayerDisplay` має встановити `textContent` для `songArtist` на виконавця поточної пісні, якщо він визначений, або на порожній рядок.
