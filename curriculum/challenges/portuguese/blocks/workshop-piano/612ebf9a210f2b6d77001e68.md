...
Agora adicione um seletor `.logo` à query `@media` e defina a propriedade `width` como `150px`.

# --hints--

A `@media` deve ter um seletor `.logo`.
...
O novo seletor `.logo` deve ter um `width` de `150px`.
