...
- Clona <a href="https://github.com/freeCodeCamp/boilerplate-npm/" target="_blank" rel="noopener noreferrer nofollow">este repositorio de GitHub</a> y completa estos desafíos localmente, usando <a href="https://www.freecodecamp.org/news/how-to-run-the-freecodecamp-backend-challenges-locally/" target="_blank" rel="noopener noreferrer nofollow">esta guía</a> para configurar Node.js, npm y ejecutar los proyectos backend en tu máquina.
