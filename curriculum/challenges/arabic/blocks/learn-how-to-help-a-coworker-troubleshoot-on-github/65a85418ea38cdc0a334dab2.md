...
`To roll back` تعني العودة إلى حالة أو إصدار / نسخة أقدم من شيء ما. على سبيل المثال:

`If the new app is not working, try rolling back to the old version.`

`previous version` تعني شكل أو إصدار / نسخة أقدم من شيء ما، مثل إصدار أقدم من برنامج. لنستخدمها في نفس الجملة أعلاه:
...
تعني العودة إلى حالة سابقة. حاولت سارة الرجوع إلى إصدار / نسخة أقدم من الشفرة. هذا الفعل يُستخدم مع `-ing`.
...
تشير إلى شكل أو إصدار / نسخة أقدم. عادت سارة إلى إصدار / نسخة أقدم من الشفرة.
