...
Всередині елемента `form` додайте елемент `label`. Ваш елемент `label` має містити текст `Search for fruits:` і атрибут `htmlFor` зі значенням `"search-input"`.

# --hints--

У вас має бути елемент `label` всередині елемента `form`.
...
Елемент `label` повинен мати атрибут `htmlFor` зі значенням `"search-input"`.
...
Ваш елемент `label` має містити текст `Search for fruits:`.
