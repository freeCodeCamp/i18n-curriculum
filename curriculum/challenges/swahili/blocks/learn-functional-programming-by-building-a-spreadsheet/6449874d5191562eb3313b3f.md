...
Mwishowe, fanya `rangeRegex` yako iwe ya kimataifa na isiyojali herufi kubwa au ndogo.

# --hints--

`rangeRegex` yako inapaswa kuwa isiyojali herufi kubwa au ndogo.
...
`rangeRegex` yako inapaswa kuwa ya kimataifa.
...
`rangeRegex` yako inapaswa kuwa ya kimataifa na isiyojali herufi kubwa au ndogo.
