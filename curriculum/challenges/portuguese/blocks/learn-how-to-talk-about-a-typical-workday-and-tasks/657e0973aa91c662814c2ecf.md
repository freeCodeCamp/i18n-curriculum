...
O verbo `review` significa examinar algo, como uma lista ou um plano.

O verbo `prioritize` significa decidir quais tarefas são mais importantes para fazer primeiro.
