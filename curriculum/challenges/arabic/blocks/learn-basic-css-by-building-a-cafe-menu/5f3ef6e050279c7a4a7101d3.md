...
هذا أفضل. الآن جرّب إضافة نفس حشو `20px` إلى أعلى وأسفل القائمة.

# --hints--

لا يجب إزالة خاصيتي `padding-left` أو `padding-right`.
...
يجب تعيين خاصية `padding-top` إلى `20px`.
...
يجب تعيين خاصية `padding-bottom` إلى `20px`.
...
يجب أن يحتوي عنصر `.menu` على `padding-top` بقيمة `20px`.
...
يجب أن يحتوي عنصر `.menu` على `padding-bottom` بقيمة `20px`.
