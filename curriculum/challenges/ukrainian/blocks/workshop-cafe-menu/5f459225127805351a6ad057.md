...
Змініть колір фону елемента `hr` на `brown`, щоб він відповідав кольору кавових зерен.

# --hints--

Ви повинні встановити значення властивості `background-color` на `brown`.
...
Ваш елемент `hr` має мати ідентифікатор `background-color` зі значенням `brown`.
