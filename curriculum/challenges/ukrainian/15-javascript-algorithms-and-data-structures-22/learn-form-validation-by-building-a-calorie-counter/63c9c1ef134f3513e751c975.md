...
Дотримуючись того самого шаблону, оголосіть змінні для вхідних даних `number` в елементах `#dinner`, `#snacks` та `#exercise`. Присвойте їм відповідні виклики `getCaloriesFromInputs`.
...
Викличте `getCaloriesFromInputs` з `dinnerNumberInputs` як аргумент.

```js
assert.match(calculateCalories.toString(), /getCaloriesFromInputs\s*\(\s*dinnerNumberInputs\s*\)/);
```

Ви повинні призначити результат `getCaloriesFromInputs` до `dinnerCalories`.
...
Викличте `getCaloriesFromInputs` з `snacksNumberInputs` як аргумент.

```js
assert.match(calculateCalories.toString(), /getCaloriesFromInputs\s*\(\s*snacksNumberInputs\s*\)/);
```

Ви повинні призначити результат `getCaloriesFromInputs` до `snacksCalories`.
...
Викличте `getCaloriesFromInputs` з `exerciseNumberInputs` як аргумент.

```js
assert.match(calculateCalories.toString(), /getCaloriesFromInputs\s*\(\s*exerciseNumberInputs\s*\)/);
```

Ви повинні призначити результат `getCaloriesFromInputs` до `exerciseCalories`.
