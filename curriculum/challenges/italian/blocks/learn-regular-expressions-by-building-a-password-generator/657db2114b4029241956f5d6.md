...
Modifica la dichiarazione della tua funzione per accettare parametri predefiniti. Usa `16` per il `length` e `1` per le altre condizioni.

# --hints--

La tua funzione dovrebbe accettare parametri predefiniti.
