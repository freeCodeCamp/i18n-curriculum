...
Geben Sie `wave` vier Wegpunkte, beginnend bei `10%` und jeweils um `10%` erhöht.

# --hints--

Sie sollten einen `10%` Wegpunkt für `@keyframes wave` hinzufügen.
...
Sie sollten einen `20%` Wegpunkt für `@keyframes wave` hinzufügen.
...
Sie sollten einen `30%` Wegpunkt für `@keyframes wave` hinzufügen.
...
Sie sollten einen `40%` Wegpunkt für `@keyframes wave` hinzufügen.
...
Sie sollten 4 Wegpunkte in Ihrem Keyframe haben.
