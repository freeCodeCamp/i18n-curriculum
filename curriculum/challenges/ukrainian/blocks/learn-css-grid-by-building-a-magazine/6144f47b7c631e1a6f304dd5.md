...
У вашому журналі буде три основні розділи. Ви вже встановили загальний макет у правилі `main`, але можете налаштувати розташування в дочірніх правилах.

Один із варіантів — властивість `grid-column`, яка є скороченням для `grid-column-start` та `grid-column-end`. Властивість `grid-column` вказує елементу сітки, з якої лінії сітки починатися і на якій закінчуватися.
...
У вас має бути селектор `.heading`.
