...
Completa il setter stampando `'{name}' promoted to '{new_level}'.` all'interno del tuo metodo. Sostituisci `{name}` e `{new_level}` con il nome del dipendente e il nuovo livello, rispettivamente.

# --hints--

Dovresti stampare `'{name}' promoted to '{new_level}'.` dove `{name}` e `{new_level}` devono essere sostituiti con il nome del dipendente e il nuovo livello, rispettivamente.
