...
Ora inizierai a lavorare sul metodo `initializeEventListeners()`. Per prima cosa, assegna il tipo di ritorno `void`.

# --hints--

Il tuo metodo `initializeEventListeners` dovrebbe avere un tipo di ritorno `void`.
