...
Внутрішні функції також можуть повертати функцію. Використовуючи той самий стрілковий синтаксис, оновіть функцію `addCharacters`, щоб вона повернтала третю функцію, яка приймає параметр `num`.

# --hints--

Внутрішня стрілкова функція має повернути ще одну стрілкову функцію з параметром `num`.
...
Найбільш внутрішня стрілкова функція має бути порожньою.
