...
`is_valid_schema({"username": "alice", "posts": 10, "verified": False})` dovrebbe restituire `True`.
...
`is_valid_schema({"username": "carol", "posts": 15, "verified": True, "followers": 25})` dovrebbe restituire `True`.
...
`is_valid_schema({"username": "frank", "posts": "21", "verified": True})` dovrebbe restituire `False`.
...
`is_valid_schema({"username": "sam", "posts": 17, "verified": "false"})` dovrebbe restituire `False`.
...
`is_valid_schema({"username": "bill", "verified": True})` dovrebbe restituire `False`.
...
`is_valid_schema({"username": "fred", "verified": True})` dovrebbe restituire `False`.
...
`is_valid_schema({"username": 5, "posts": 10, "verified": True})` dovrebbe restituire `False`.
