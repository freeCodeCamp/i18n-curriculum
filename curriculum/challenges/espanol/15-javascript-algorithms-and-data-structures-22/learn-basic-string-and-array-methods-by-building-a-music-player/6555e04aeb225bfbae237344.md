...
Ahora, llama a la función `setPlayButtonAccessibleText` dentro de la función `playSong`.

# --hints--

Debes llamar a la función `setPlayButtonAccessibleText` dentro de tu función `playSong`.
