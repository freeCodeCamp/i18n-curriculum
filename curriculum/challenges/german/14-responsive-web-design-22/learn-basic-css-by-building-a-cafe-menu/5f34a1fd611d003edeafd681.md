...
Der braune Hintergrund erschwert das Lesen des Textes. Verändere die Hintergrundfarbe des `body`-Elements, damit es `burlywood` entspricht. Somit hat es etwas Farbe, aber man kann den Text immer noch lesen.
...
Dein `body`-Element sollte einen `burlywood`-Hintergrund haben.
