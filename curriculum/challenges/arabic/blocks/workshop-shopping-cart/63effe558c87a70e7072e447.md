...
يجب تغيير سلوك طريقة `addItem` إذا كان المنتج موجودًا بالفعل في عربة التسوق أم لا. أنشئ معاملًا ثلاثيًا يتحقق مما إذا كان المنتج الحالي موجودًا بالفعل في العربة. استخدم `undefined` لكل من التعبيرات الصحيحة والخاطئة لتجنب حدوث خطأ نحوي.

# --hints--

يجب التحقق مما إذا كانت قيمة `currentProductCount` أكبر من `1`.
...
يجب استخدام معامل ثلاثي مع شرط `currentProductCount > 1`.
...
يجب استخدام `undefined` كتعبير صحيح.
...
يجب استخدام `undefined` كتعبير خاطئ.
