...
Tu elemento `head` debe tener una etiqueta de apertura. Las etiquetas de apertura tienen la siguiente sintaxis: `<elementName>`.
...
Tu elemento `head` debe ir arriba de la etiqueta de apertura del elemento `body`. Lo has colocado en otro lugar.
