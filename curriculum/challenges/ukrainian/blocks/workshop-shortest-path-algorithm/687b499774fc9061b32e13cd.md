...
Наприкінці вашої функції поверніть обчислені дані, щоб їх можна було використати поза межами функції.

Поверніть як список найкоротших `distances` від `start_node` до всіх інших вузлів, так і список `paths`, які ведуть до кожного вузла.

# --hints--

У кінці вашої функції має бути інструкція `return`.
...
Ви маєте повернути і `distances`, і `paths`.
