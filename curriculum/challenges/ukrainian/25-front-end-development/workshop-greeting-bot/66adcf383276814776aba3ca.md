...
You should use string concatenation to join the string `"My favorite subject is "` with the `favoriteSubject` variable followed by a period. Пам’ятайте про пробіли.
