...
Como o texto no `div` externo é preto padrão, não é fácil o suficiente de ver.Então, adicione a classe `text-white` ao `div`.

# --hints--

Seu elemento externo `div` deve ter a classe utilitária `text-white`.
