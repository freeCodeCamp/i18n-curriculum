...
باستخدام نفس المنطق، أنشئ جملة `if` تعمل عندما لا تكون قائمة `series` فارغة. داخلها، أضف السلسلة النصية `=== TV SERIES ===` (تنتهي بحرف سطر جديد) إلى القيمة الحالية لـ `result`.

ثم، أنشئ حلقة `for` تستخدم التعداد لإضافة العناصر في قائمة `series` إلى المتغير `result`. كما فعلت سابقًا، ابدأ ترقيم القيم من `1`.

بهذا، تكتمل ورشة عمل فهرس الوسائط.

# --hints--

يجب أن يكون لديك جملة `if` ثانية في دالتك `__str__`.
...
يجب أن تحتوي جملة `if` الثانية على `result += '=== TV SERIES ===\n'`.
...
يجب أن تحتوي جملة `if` الثانية على حلقة `for`.
...
عندما تحتوي `self.items` على `Movie('Dances with Wolves', 1990, 'Kevin Costner', 224)` و `Movie('Annie Hall', 1977, 'Woody Allen', 93)`، يجب أن تُرجع دالة `__str__` القيمة `Media Catalogue (2 items):\n\n=== MOVIES ===\n1. Dances with Wolves (1990) - 224 min, Kevin Costner\n2. Annie Hall (1977) - 93 min, Woody Allen\n`.
...
عندما تحتوي `self.items` على `TVSeries("Game of Thrones", 2011, "David Benioff & D.B. Weiss", 57, 8, 73)` و `TVSeries("Stranger Things", 2016, "The Duffer Brothers", 50, 4, 34)`، يجب أن تُرجع دالة `__str__` القيمة `Media Catalogue (2 items):\n\n=== TV SERIES ===\n1. Game of Thrones (2011) - 8 seasons, 73 episodes, 57 min avg, David Benioff & D.B. Weiss\n2. Stranger Things (2016) - 4 seasons, 34 episodes, 50 min avg, The Duffer Brothers\n`.
...
عندما تحتوي `self.items` على `Movie('Barry Lyndon', 1975, 'Stanley Kubrick', 184)`, `Movie('Fahrenheit 451', 1966, 'Francois Truffaut', 112)`, `TVSeries("Game of Thrones", 2011, "David Benioff & D.B. Weiss", 57, 8, 73)` و `TVSeries("Stranger Things", 2016, "The Duffer Brothers", 50, 4, 34)`، يجب أن تُرجع دالة `__str__` القيمة `Media Catalogue (4 items):\n\n=== MOVIES ===\n1. Barry Lyndon (1975) - 184 min, Stanley Kubrick\n2. Fahrenheit 451 (1966) - 112 min, Francois Truffaut\n=== TV SERIES ===\n1. Game of Thrones (2011) - 8 seasons, 73 episodes, 57 min avg, David Benioff & D.B. Weiss\n2. Stranger Things (2016) - 4 seasons, 34 episodes, 50 min avg, The Duffer Brothers\n`.
