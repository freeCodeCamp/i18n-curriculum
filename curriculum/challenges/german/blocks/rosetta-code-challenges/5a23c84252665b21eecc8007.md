...
title: Sortieralgorithmen/gnome sort
challengeType: 1
forumTopicId: 302314
...
Gnome sort ist ein Sortieralgorithmus, der dem <a href="https://rosettacode.org/wiki/Insertion_sort" target="_blank" rel="noopener noreferrer nofollow">Insertion sort</a> ähnelt, außer dass das Verschieben eines Elements an seine richtige Stelle durch eine Reihe von Vertauschungen erfolgt, wie beim <a href="https://rosettacode.org/wiki/Bubble" target="_blank" rel="noopener noreferrer nofollow">Bubble Sort</a>.
...
Schreiben Sie eine Funktion, die den obigen Pseudocode implementiert. Die Funktion soll das sortierte Array zurückgeben.
