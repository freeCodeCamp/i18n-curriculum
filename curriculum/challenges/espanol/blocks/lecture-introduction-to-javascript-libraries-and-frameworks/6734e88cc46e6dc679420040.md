...
title: Qué es Vite y cómo se puede usar para configurar un nuevo proyecto React
challengeType: 19
...
A diferencia de trabajar con proyectos pequeños de HTML, CSS y JavaScript puros, comenzar un nuevo proyecto de React incluye algunos pasos adicionales para asegurar que todo funcione correctamente. En lugar de intentar configurar todas las configuraciones necesarias por ti mismo, existen herramientas que harán eso por ti.
...
Para crear un nuevo proyecto con Vite, necesitarás usar la línea de comandos. Si usas una máquina con Windows, puedes usar el Símbolo del sistema o Windows PowerShell. Si usas una Mac, puedes usar la app Terminal.

En caso de que no tengas Node.js instalado, que es necesario para que npm funcione, aquí tienes un enlace a la página oficial de Node.js: https://nodejs.org. Sigue las instrucciones de instalación y luego regresa aquí para continuar con la instalación de React.
...
Revisa la sección final donde se discutió esto.
