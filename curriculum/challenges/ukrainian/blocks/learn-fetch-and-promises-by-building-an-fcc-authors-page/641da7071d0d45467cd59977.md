...
Тепер потрібно показати інформацію про автора. Спочатку покажіть ім’я автора.

Створіть тег `h2` з `class` `"author-name"`. Потім вставте `author` всередину тегу `h2`. Це ім’я автора.
...
Ваш елемент `h2` має мати клас, встановлений у `"author-name"`
...
Ви повинні вставити `author` у ваш тег `h2`, щоб показати імена авторів
