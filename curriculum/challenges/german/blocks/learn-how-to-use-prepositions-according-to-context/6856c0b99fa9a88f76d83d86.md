...
Maria sagt, die neuen Ressourcen sind für `the next milestone` und um `support the upcoming user interface work` zu `support the upcoming user interface work`. Das zeigt, dass das Ziel ist, das Team zu stärken, um die nächste Phase abzuschließen.
