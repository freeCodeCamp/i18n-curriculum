...
Du solltest eine Anweisung haben, die prüft, ob die linke Taste gedrückt wurde und ob `isCheckpointCollisionDetectionActive` true ist.
...
Du solltest eine `forEach`-Schleife hinzufügen, die das `platforms`-Array durchläuft.
