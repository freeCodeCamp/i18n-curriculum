...
Скопіюйте залишкові ліві значення у `array`, призначивши `leftPart[leftArrayIndex]` `array[sortedIndex]`.

# --hints--

Тіло циклу має призначати `leftPart[leftArrayIndex]` `array[sortedIndex]`.
