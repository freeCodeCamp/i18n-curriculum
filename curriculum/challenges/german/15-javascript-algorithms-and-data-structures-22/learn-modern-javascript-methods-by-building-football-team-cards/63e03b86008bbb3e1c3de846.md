...
Als Nächstes fügst du das `year` und die `players` zu deiner Destrukturierungszuweisung hinzu.

# --hints--

Du solltest die `year`- und `players`-Werte zu deiner Destrukturierungszuweisung hinzufügen.
