...
Sasa tunahitaji mtindo wa haraka. Anza kwa kumpa `body` `background-color` iliyowekwa kuwa `#0a0a23`.
...
Kichaguzi chako cha `body` kinapaswa kuwa na sifa ya `background-color` iliyowekwa kuwa `#0a0a23`.
