...
بدلاً من ذلك، يمكنك التكرار على كائن الخريطة الخاص بك باستخدام طريقة `entries`، التي تُرجع مكرر خريطة يحتوي على أزواج المفتاح-القيمة.

عدّل دالة `displayCatalog` لتكرار المدخلات في خريطة `catalog` وسجل كل مدخل في وحدة التحكم.

# --hints--

يجب أن تستدعي دالة `displayCatalog` طريقة `entries` على `catalog`.
