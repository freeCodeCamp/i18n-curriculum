...
`Handle` in this context means to take care of or manage a task, issue, or responsibility. Por exemplo:

 `He handled the situation professionally.` - Meaning he took care of the problem as a professional.

When a verb follows a preposition, like `for`, it is used in the `-ing` form. Por exemplo:
