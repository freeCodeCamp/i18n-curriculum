...
Ora che hai la struttura base dell'app, è il momento di aggiungere alcuni elementi e far funzionare la ricerca.

Crea un array e assegnalo a una variabile chiamata `items`. All'interno dell'array, aggiungi le stringhe `Apples`, `Bananas`, `Strawberries`, `Blueberries`, `Mangoes`, `Pineapple`, `Lettuce`, `Broccoli`, `Paper Towels` e `Dish Soap`. Questa sarà la lista degli elementi che verranno mostrati nell'app.
...
Il tuo array `items` dovrebbe contenere le stringhe `Apples`, `Bananas`, `Strawberries`, `Blueberries`, `Mangoes`, `Pineapple`, `Lettuce`, `Broccoli`, `Paper Towels` e `Dish Soap`.
