...
title: 'Problema 385: ellissi all’interno di triangoli'
challengeType: 1
forumTopicId: 302049
...
Per ogni triangolo $T$ nel piano, si può dimostrare che esiste un’unica ellisse con area massima che è completamente all’interno di $T$.
...
-   i fuochi<sup>1</sup> dell’ellisse con area massima all’interno di $T$ sono $(\sqrt{13}, 0)$ e $(-\sqrt{13}, 0)$.

Sia $A(n)$ la somma delle aree di tutti questi triangoli.

Per esempio, se $n = 8$, ci sono due triangoli di questo tipo. I loro vertici sono (-4,-3), (-4,3), (8,0) e (4,3), (4,-3), (-8,0), e l’area di ciascun triangolo è 36. Quindi $A(8) = 36 + 36 = 72$.

Si può verificare che $A(10) = 252$, $A(100) = 34\\,632$ e $A(1000) = 3\\,529\\,008$.

Trova $A(1\\,000\\,000\\,000)$.

<sup>1</sup>I fuochi (plurale di fuoco) di un’ellisse sono due punti $A$ e $B$ tali che per ogni punto $P$ sul bordo dell’ellisse, $AP + PB$ è costante.
