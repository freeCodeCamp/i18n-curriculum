...
No momento a seção `footer` tem um título `h3`. Mas deveria ser um título `h2` para manter uma hierarquia de títulos adequada. 

Altere o `h3` para um `h2`.

# --hints--

Seu elemento `footer` deve conter um elemento `h2` em vez de um elemento `h3`.
