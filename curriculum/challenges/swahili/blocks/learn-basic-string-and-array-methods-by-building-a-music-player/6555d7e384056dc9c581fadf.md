...
Ili kuhakikisha onyesho la mchezaji linasasishwa kila wakati wimbo mpya unaanza kuchezwa, fanya wito wa kitendakazi cha `setPlayerDisplay()` ndani ya kitendakazi cha `playSong()`.

Sasa unapaswa kuona kichwa cha wimbo na msanii wakionekana kwenye onyesho.

# --hints--

Unapaswa kufanya wito wa kitendakazi cha `setPlayerDisplay` ndani ya kitendakazi chako cha `playSong`.
