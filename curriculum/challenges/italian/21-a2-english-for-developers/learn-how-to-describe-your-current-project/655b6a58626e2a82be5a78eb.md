...
To `steal` means to take something that doesn't belong to you without permission. Ad esempio:
...
`Identity` refers to who a person is, including their name, date of birth, and other personal information. Ad esempio:
