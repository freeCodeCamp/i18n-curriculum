...
Kwanza, tengeneza nakala ya kina ya safu ya data ya ingizo `crew` kwa kutumia `slice()` na weka thamani yake katika kigezo kinachoitwa `sorted`.

# --hints--

Unapaswa kutumia njia ya `slice()` kunakili safu ya data ya ingizo `crew` katika kigezo kipya kinachoitwa `sorted`.
