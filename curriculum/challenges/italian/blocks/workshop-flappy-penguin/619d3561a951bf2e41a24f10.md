...
Indicalo agli utenti, dando all'elemento attivo una proprietà `cursor` (cursore) con il valore `not-allowed` (non permesso).

# --hints--

Dovresti dare a `.penguin:active` una proprietà `cursor` con il valore `not-allowed`.
