...
`apply` 함수를 선언하고 `fn`과 `args` 매개변수를 받으세요.
...
`apply` 함수의 첫 번째 매개변수는 `fn`이어야 합니다.
...
`apply` 함수의 두 번째 매개변수는 `args`이어야 합니다.
