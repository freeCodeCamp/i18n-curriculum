...
새로운 `bb1-window` 클래스를 `.bb1a`, `.bb1b`, `.bb1c` 요소에 추가하세요. 그러면 그 요소들에 그라디언트가 적용됩니다.
...
`bb1-window` 요소에 `.bb1a` 클래스를 추가하세요.
...
`bb1-window` 요소에 `.bb1b` 클래스를 추가하세요.
...
`bb1-window` 요소에 `.bb1c` 클래스를 추가하세요.
