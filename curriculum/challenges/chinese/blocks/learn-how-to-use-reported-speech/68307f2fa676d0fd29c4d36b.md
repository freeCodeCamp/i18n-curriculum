...
`Was there` is the interrogative (question) form of `There was`, which is used to ask if something existed or happened in the past. It inverts the subject and verb to form a question. 例如：
