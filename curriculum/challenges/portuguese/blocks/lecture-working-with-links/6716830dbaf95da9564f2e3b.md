...
Um ponto único indica o diretório atual, e dois pontos indicam o diretório pai. Você normalmente verá um ponto único usado para garantir que o caminho seja reconhecido como um caminho relativo. Lembre-se de que você aprendeu sobre caminhos relativos versus absolutos em uma lição anterior.

Dois pontos, no entanto, são mais comumente usados para acessar arquivos fora do diretório de trabalho atual.
