...
12. Quando você clicar no elemento `#submit`, o email deve ser enviado para uma página estática (use esta URL simulada: `https://www.freecodecamp.org/email-submit`).
...
Seu `#form` deve ter um atributo `action` com o valor `https://www.freecodecamp.org/email-submit`.
