...
Dentro del elemento `main`, crea un formulario con tres elementos `section` anidados. Luego, haz que el formulario envíe a `https://freecodecamp.org/practice-project/accessibility-quiz`, utilizando el método correcto.
