...
Ein Reisender wird umgeleitet und muss einen ungeplanten Zwischenstopp an einem Ort einlegen, der sich als Shangri-La herausstellt. Er entscheidet sich zu gehen und darf so viele der dort verfügbaren Gegenstände mitnehmen, wie er möchte, solange sie in seinen Rucksack passen und er sie tragen kann.

Er weiß, dass er insgesamt nicht mehr als ein bestimmtes maximales Gewicht tragen kann; und dass das Fassungsvermögen seines Rucksacks ein begrenztes Volumen hat.

Direkt über den Strichcodes der Gegenstände findet er deren Gewicht und Volumen. Er holt seine aktuelle Ausgabe einer Finanzzeitung hervor und ermittelt den Wert jedes Gegenstands.

Er kann nur ganze Einheiten eines Gegenstands mitnehmen, aber es gibt von jedem Gegenstand viel mehr, als er jemals tragen könnte.

# --instructions--

Schreiben Sie eine Funktion, die ein Array von Objekten, das maximale Gewicht und das maximale Volumen als Parameter erhält. Jedes Objekt hat 4 Attribute: name, value, weight und volume. Die Funktion soll den maximalen Wert der Gegenstände zurückgeben, die der Reisende mitnehmen kann.
