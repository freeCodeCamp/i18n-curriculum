...
Considere $f(n)$ como o número de maneiras de escolher $n$ cartas com um subconjunto de 4 cartas que é um Badugi.Por exemplo, existem $2\,598\,960$ maneiras de escolher cinco cartas de um baralho padrão de 52 cartas, das quais $514\,800$ contêm um subconjunto de 4 cartas que é um Badugi, então $f(5) = 514800$.
