...
Seu primeiro elemento `span` deve conter o texto `Monster Name: `.Certifique-se de que o espaçamento está correto.
...
Seu segundo elemento `span` deve ter o texto `Health: ` .Certifique-se de que o espaçamento está correto.
