...
残りのプロパティについても同様に行ってください。`getElement` 関数を使ってそれぞれを選択してください。
...
`multipleCardsBtn` にアクセスするには、`getElement` メソッドを使い、`#btn-multiple-cards` を渡してください。
...
`multipleCard` にアクセスするには、`getElement` メソッドを使い、`.multiple_card` を渡してください。
...
`title` にアクセスするには、`getElement` メソッドを使い、`.title` を渡してください。
...
`newReadingBtn` にアクセスするには、`getElement` メソッドを使い、`.btn_reveal` を渡してください。
...
`fortuneContainer` にアクセスするには、`getElement` メソッドを使い、`.fortune_container` を渡してください。
...
`fortuneDescription` にアクセスするには、`getElement` メソッドを使い、`.fortune_description` を渡してください。
...
`headerTitle` にアクセスするには、`getElement` メソッドを使い、`.header_title` を渡してください。
...
`subTitle` にアクセスするには、`getElement` メソッドを使い、`.sub_title` を渡してください。
...
`cardTitle` にアクセスするには、`getElement` メソッドを使い、`.desc_title` を渡してください。
...
`description` にアクセスするには、`getElement` メソッドを使い、`.description` を渡してください。
...
`text` にアクセスするには、`getElement` メソッドを使い、`.text` を渡してください。
