...
Тепер, щоб завершити, змініть код, який ви написали поза класами, і включіть його у невелику службову функцію під назвою `projectile_helper`, яка приймає бажані значення для швидкості, висоти та кута й послідовно друкує на терміналі, деталі снаряда, таблицю координат та графік траєкторії.

Викличте `projectile_helper` один раз зі значеннями на ваш вибір.

# --hints--

Створіть `projectile_helper` у глобальній області.
...
Надрукуйте запитані рядки за порядком. Не друкуйте інші значення.
...
Викличте функцію `projectile_helper` принаймні один раз.
...
Ви не повинні мати змінні або виклики друку в глобальній області.
