...
This phrase of two words is used to ask about the frequency of an action, or how many times something should be done. La primer letra se escribe en mayúscula.

# --explanation--

`How often` is used to ask about the frequency of an action, meaning how many times or at what intervals it should be repeated. Por ejemplo:
