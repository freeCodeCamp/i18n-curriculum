...
Наприкінці рядка, перед фінальною лапкою, додайте символ екранування нового рядка `\n`. Це змусить наступну частину, яку ви додасте до `text.innerText`, з’явитися на новому рядку.
