...
Em conversas do dia a dia, você pode usar uma estrutura onde você começa com uma afirmação, e então usa `mas` para mostrar contraste.Isto pode ser especialmente útil quando você quer mostrar como você transformou desafios em oportunidades de aprendizado.

Por exemplo, você pode dizer, `eu não tinha muita experiência nessa área, mas aprendi muito sobre constância no meu antigo trabalho.`
