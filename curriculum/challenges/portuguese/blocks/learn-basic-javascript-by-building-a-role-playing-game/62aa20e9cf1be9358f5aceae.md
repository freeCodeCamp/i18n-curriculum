...
Você deve adicionar o texto `" You miss."` ao final de `text.innerText`.Lembre-se de usar a atribuição composta e certifique-se de que haja um espaço antes da palavra `You`.
