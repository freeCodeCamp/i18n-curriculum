...
Dato l'insieme {1,2,..., $n$}, definiamo $f(n, k)$ come il numero dei suoi sottoinsiemi di $k$ elementi con somma dispari degli elementi. Per esempio, $f(5,3) = 4$, poiché l'insieme {1,2,3,4,5} ha quattro sottoinsiemi di 3 elementi con somma dispari degli elementi, cioè: {1,2,4}, {1,3,5}, {2,3,4} e {2,4,5}.

Quando tutti e tre i valori $n$, $k$ e $f(n, k)$ sono dispari, diciamo che formano una tripletta dispari $[n, k, f(n, k)]$.
