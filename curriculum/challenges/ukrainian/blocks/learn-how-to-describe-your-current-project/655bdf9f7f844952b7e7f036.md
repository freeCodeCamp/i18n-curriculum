...
Чому Сара згадує картинки у своїй відповіді Бобу?

## --answers--

Щоб висловити зацікавленість у застосуванні методу Боба.

### --feedback--

Сара визнає метод Боба, але не проявляє бажання його змінювати.

---

Щоб показати, що ідея Боба з картинками хороша, але їй подобається її спосіб роботи.

---

Тому що вона хоче робити те, що робить Боб.
...
Щоб вказати, що метод Боба менш приємний.

### --feedback--

Сара не порівнює задоволення чи веселощі, вона просто говорить про різні способи роботи.
