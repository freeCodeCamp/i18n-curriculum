...
Incredibilmente, `f(6, 200) + f(75, 200) + f(89, 200) + f(226, 200)` = 3.1415926… ≈ π.

In effetti, è la migliore approssimazione della forma `f(a, 200) + f(b, 200) + f(c, 200) + f(d, 200)`.

Sia `almostPi(n)` = a<sup>2</sup> + b<sup>2</sup> + c<sup>2</sup> + d<sup>2</sup> per a, b, c, d che minimizzano l'errore: $\lvert f(a,n) + f(b,n) + f(c,n) + f(d,n) - \Pi\rvert$
