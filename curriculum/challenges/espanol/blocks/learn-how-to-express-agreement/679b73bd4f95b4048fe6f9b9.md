...
A `sketch` is a rough drawing used to plan or visualize an idea. Por ejemplo:
...
A `wireframe` is a simple outline or blueprint of a digital design, showing structure without details. Por ejemplo:
