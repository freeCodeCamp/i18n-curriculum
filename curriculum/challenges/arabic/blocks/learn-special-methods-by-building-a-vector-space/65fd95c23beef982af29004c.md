...
تريد مقارنة متجهين فقط عندما ينتميان إلى نفس الصنف. لذلك، أنشئ جملة `if` تتحقق مما إذا كان `self` و `other` لا ينتميان إلى نفس الصنف وأرجع `NotImplemented` في هذه الحالة.
# --hints--
...
يجب أن ترجع `NotImplemented` من جسم جملة `if`.
