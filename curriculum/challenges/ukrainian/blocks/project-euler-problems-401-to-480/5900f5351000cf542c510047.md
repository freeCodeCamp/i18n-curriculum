...
title: 'Завдання 456: трикутники, що містять початок координат II'
challengeType: 1
forumTopicId: 302130
...
Нехай $C(n)$ — це кількість трикутників, вершини яких належать $P_n$ і які містять початок координат всередині.
...
`trianglesContainingOriginTwo()` має повертати `333333208685971500`.
