...
현재 `instrumentCards` 함수는 악기 객체가 담긴 배열을 반환하므로, 악기 카드를 페이지에 표시하려면 몇 가지 단계를 더 거쳐야 합니다.

함수를 수정하여 `instruments` 배열의 각 객체에 해당하는 악기 카드를 표시하는 HTML 코드를 포함한 문자열 배열을 반환하게 하세요. 문자열은 `<div class="card"><h2>[instrument]</h2><p>$[price]</p></div>` 형식을 가져야 합니다.
...
`instrumentCards("all")`는 악기 카드를 나타내는 문자열 배열을 반환해야 하며, 각 문자열은 `<div class="card"><h2>[instrument]</h2><p>$[price]</p></div>` 형식을 가져야 합니다.
...
`instrumentCards("woodwinds")`는 악기 카드를 나타내는 문자열 배열을 반환해야 하며, 각 문자열은 `<div class="card"><h2>[instrument]</h2><p>$[price]</p></div>` 형식을 가져야 합니다.
...
`instrumentCards("brass")`는 악기 카드를 나타내는 문자열 배열을 반환해야 하며, 각 문자열은 `<div class="card"><h2>[instrument]</h2><p>$[price]</p></div>` 형식을 가져야 합니다.
...
`instrumentCards("percussion")`는 악기 카드를 나타내는 문자열 배열을 반환해야 하며, 각 문자열은 `<div class="card"><h2>[instrument]</h2><p>$[price]</p></div>` 형식을 가져야 합니다.
...
`instrumentCards("all")`는 페이지에 있는 모든 악기에 대한 악기 카드를 나타내는 10개의 문자열이 담긴 배열을 반환해야 합니다.
...
`instrumentCards("woodwinds")`는 페이지에 있는 목관악기에 대한 악기 카드를 나타내는 3개의 문자열이 담긴 배열을 반환해야 합니다.
...
`instrumentCards("brass")`는 페이지에 있는 금관악기에 대한 악기 카드를 나타내는 3개의 문자열이 담긴 배열을 반환해야 합니다.
...
`instrumentCards("percussion")`는 페이지에 있는 타악기에 대한 악기 카드를 나타내는 4개의 문자열이 담긴 배열을 반환해야 합니다.
