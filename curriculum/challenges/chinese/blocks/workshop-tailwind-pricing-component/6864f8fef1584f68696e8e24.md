...
现在，你应该移动到 `Start listening` CTA，使其成为一个合适的按钮。

为它赋值实用类 `bg-indigo-100`、`px-4`、`py-2`、`text-center`、`font-semibold`、`text-indigo-700` 和 `hover:bg-indigo-200`。

# --hints--

你的锚点元素应具有类 `bg-indigo-100`。
...
你的锚点元素应具有类 `hover:bg-indigo-200`。
