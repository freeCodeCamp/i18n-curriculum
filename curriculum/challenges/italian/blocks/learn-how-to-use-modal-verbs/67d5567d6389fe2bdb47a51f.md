...
Queste tre parole chiedono se ci sono altre azioni richieste.

# --explanation--

`Need to do` si usa per chiedere se qualcosa è necessario. Mark vuole assicurarsi che non ci siano altre responsabilità da completare.
