...
У класі `sky` медіазапиту змініть два значення кольору `#ffcf33` на `#ccc`, `#ffff66` на `#445`, а `#bbeeff` на `#223`. Потім ви можете змінити розмір вікна, щоб побачити як змінюється фон.

# --hints--

Ви повинні змінити значення першого кольору з `#ffcf33` на `#ccc`.
...
Ви повинні змінити значення другого кольору з `#ffff66` на `#445`.
...
Ви повинні змінити значення третього кольору з `#bbeeff` на `#223`.
