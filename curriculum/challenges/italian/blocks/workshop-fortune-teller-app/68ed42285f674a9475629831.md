...
All'interno della classe, aggiungi una proprietà privata `elements` come oggetto. Al suo interno, aggiungi le proprietà `singleCardBtn`, `singleCard` e `multipleCardsBtn`, ciascuna tipizzata come `HTMLElement`.

# --hints--

Dovresti dichiarare una proprietà `private` chiamata `elements` all'interno della classe `Game`.
...
La tua proprietà privata `elements` dovrebbe avere una proprietà `singleCardBtn` tipizzata come `HTMLElement`.
...
La tua proprietà privata `elements` dovrebbe avere una proprietà `multipleCardsBtn` tipizzata come `HTMLElement`.
...
La tua proprietà privata `elements` dovrebbe avere una proprietà `singleCard` tipizzata come `HTMLElement`.
