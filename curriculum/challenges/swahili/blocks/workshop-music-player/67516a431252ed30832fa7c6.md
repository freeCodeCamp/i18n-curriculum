...
Sasa, tumia mtaalamu wa **OR** kuongeza kigezo cha `start` kama sharti la pili kwenye usemi wa `if` baada ya `userData.currentSong === null`. 


# --hints--

Unapaswa kutumia mtaalamu wa **OR** kuongeza kigezo cha `start` kama sharti la pili kwenye usemi wa `if` baada ya `userData.currentSong === null`. 
