...
Es hora de trabajar en el oído interno derecho. Usando un selector de clase, da a tu elemento `.cat-right-inner-ear` un borde izquierdo y derecho de `20px solid transparent`. Además, dale un borde inferior de `40px solid #3b3b4f`.
