...
بالتركيز على عناصر القائمة والأسعار، هناك فجوة كبيرة إلى حد ما بين كل سطر وآخر.

استخدم المحدد الموجود الذي يستهدف كل عناصر `p` المسكنة داخل العناصر التي تحمل الصنف المسمى `item` واضبط هامشها العلوي والسفلي إلى `5px`.

# --hints--

يجب ضبط خاصية `margin-top` إلى `5px`.
...
يجب ضبط خاصية `margin-bottom` إلى `5px`.
...
يجب استخدام المحدد الموجود `.item p`.
...
عناصر `p` المسكنة داخل عناصر `.item` يجب أن يكون لها `margin-top` بقيمة `5px`.
...
عناصر `p` المسكنة داخل عناصر `.item` يجب أن يكون لها `margin-bottom` بقيمة `5px`.
...
عناصر `p` المسكنة داخل عناصر `.item` يجب ألا يكون لها `margin-left` مضبوطًا.
...
عناصر `p` المسكنة داخل عناصر `.item` يجب ألا يكون لها `margin-right` مضبوطًا.
