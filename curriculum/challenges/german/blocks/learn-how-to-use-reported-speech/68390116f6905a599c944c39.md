...
`If only` is used at the beginning of a sentence to express a wish or regret about something that didn't happen in the past. It shows that the speaker wishes the situation had been different. Zum Beispiel:
