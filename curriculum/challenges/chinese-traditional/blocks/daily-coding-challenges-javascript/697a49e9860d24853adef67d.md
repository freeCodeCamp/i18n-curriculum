...
`calculateStartDelays([120, 110, 125])` 應該傳回 `[8, 23, 0]`。

```js
assert.deepEqual(calculateStartDelays([120, 110, 125]), [8, 23, 0]);
```

`calculateStartDelays([118, 125, 122, 120])` 應該傳回 `[11, 0, 5, 8]`。

```js
assert.deepEqual(calculateStartDelays([118, 125, 122, 120]), [11, 0, 5, 8]);
```

`calculateStartDelays([100, 105, 95, 110, 120, 115, 108])` 應該傳回 `[30, 23, 38, 15, 0, 8, 18]`。

```js
assert.deepEqual(calculateStartDelays([100, 105, 95, 110, 120, 115, 108]), [30, 23, 38, 15, 0, 8, 18]);
```

`calculateStartDelays([130, 125, 128, 120, 118, 122, 127, 115, 132, 124])` 應該傳回 `[3, 11, 6, 18, 21, 15, 8, 26, 0, 12]`。
