...
This expresses a desire or wish for something to happen. Usa la forma `-ing`.
...
`To hope` means to want something to happen or to be true. Por ejemplo:

`I hope we can finish the task by Friday.` – This shows a desire to complete the task soon.

`To discuss` means to talk about something seriously or in detail, often to make a decision. Por ejemplo:
