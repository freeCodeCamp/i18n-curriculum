...
Adicione outro `label` após o primeiro, com o texto `Input your age (years): `. Em seguida, aninhe um elemento `input` com `type` definido como `number`.
...
Você deve dar ao `label` o texto `Input your age (years): ` .
