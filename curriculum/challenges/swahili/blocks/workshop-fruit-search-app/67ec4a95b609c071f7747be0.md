...
Ndani ya kipengele cha `form`, ongeza kipengele cha `label`. Kipengele chako cha `label` kinapaswa kuwa na maandishi ya `Search for fruits:` na sifa ya `htmlFor` yenye thamani ya `"search-input"`.

# --hints--

Unapaswa kuwa na kipengele cha `label` ndani ya kipengele cha `form`.
...
Kipengele cha `label` kinapaswa kuwa na sifa ya `htmlFor` yenye thamani ya `"search-input"`.
...
Kipengele chako cha `label` kinapaswa kuwa na maandishi ya `Search for fruits:`.
