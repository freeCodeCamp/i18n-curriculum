...
Neste exemplo, temos a marcação HTML para um container de grade:
...
Então estamos usando a função `repeat()` para definir a primeira e a terceira colunas com 20 pixels e a segunda e a quarta colunas com uma unidade fracionária.
