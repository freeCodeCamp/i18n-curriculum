...
Sikiliza na ukamilishe kila sentensi kwa idara sahihi.
...
`El departamento de aprendizaje y desarrollo capacita al equipo.` — Idara ya Ukuzaji na Mafunzo hufundisha timu.

Zote `apoyar` (kusaidia) na `capacitar` (kufundisha) ni vitenzi vya mtu wa tatu wingi la `-ar`.

Zikiendana na mtindo wa `desarrolla`, `verifica`, na `crea` kutoka kwa mazoezi ya awali.
