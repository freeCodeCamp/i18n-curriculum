...
Kumbuka kuwa sifa ya `grid-column` inaamua ni nguzo gani kipengele huanzia na kuishia. Kuna wakati ambapo hujui ni nguzo ngapi gridi yako itakuwa nazo, lakini unataka kipengele kimalize kwenye nguzo ya mwisho. Ili kufanya hivyo, unaweza kutumia `-1` kwa nguzo ya mwisho.

Tengeneza kichaguzi cha `.hero` na kipa sifa ya `grid-column` iliyowekwa kuwa `1 / -1`. Hii itaeleza kipengele kupanua kwa upana wote wa gridi.
...
Kichaguzi chako cha `.hero` kinapaswa kuwa na sifa ya `grid-column` iliyowekwa kuwa `1 / -1`.
