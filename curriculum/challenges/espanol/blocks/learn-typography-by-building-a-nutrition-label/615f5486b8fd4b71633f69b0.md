...
Debajo de su elemento `.small-text`, cree un nuevo elemento `p` con el texto `Calories`. También debajo del elemento `.left-container`, cree un nuevo elemento `span` con el texto `230`.
