...
Your `h1` element should have an opening tag. I tag di apertura hanno questa sintassi: `<nomeElemento>`.

```js
assert(document.querySelector('h1'));
```

Your `h1` element should have a closing tag. I tag di chiusura hanno un carattere `/` subito dopo il carattere `<`.
