...
Ili kuunda nafasi kidogo zaidi karibu na menyu, ongeza `20px` ya nafasi ndani ya kipengele cha `body` kwa kutumia sifa ya `padding`.
...
Kipengele chako cha `body` kinapaswa kuwa na `padding` ya `20px`.
