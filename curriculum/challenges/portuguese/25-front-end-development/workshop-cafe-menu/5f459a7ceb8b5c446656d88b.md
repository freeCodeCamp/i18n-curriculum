...
Observe a cor cinza ao longo das arestas da linha. Essas arestas são conhecidas como <dfn>bordas</dfn>. Cada lado de um elemento pode ter uma cor diferente ou eles podem ser todos iguais.

Faça com que todas as bordas do elemento `hr` sejam da mesma cor que o fundo dele usando a propriedade `border-color`.

# --hints--

Você deve definir o valor da propriedade `border-color` para `brown`.
...
O elemento `hr` deve ter a `border-color` com o valor de `brown`.
