...
Ви маєте створити новий елемент `p` і `div` у кінці вашого елемента `.daily-value`.
...
Ваш новий елемент `p` має мати атрибут `class`, встановлений у `indent no-divider`.
...
Ваш новий елемент `div` має мати атрибут `class`, встановлений у `divider`.
