...
`Asking around` refers to inquiring with different people to gather information or opinions. 例如：
...
`Would` is used to ask about possibilities, preferences, or to make polite suggestions. In this case, Bob is using it to confirm whether his idea is a good one. 例如：
