...
Цей блоговий запис міститиме кілька абзаців із текстом <dfn>lorem ipsum</dfn>.

Lorem ipsum зазвичай використовується в розробці вебсторінок як заповнювач тексту. Це корисно, коли ви хочете зосередитися на створенні базової структури своїх вебсторінок і поки що не турбуватися про фактичний вміст.
...
Під вашим `h3` елементом додайте два абзаци з текстом lorem ipsum.

# --hints--

У вас має бути два елементи абзацу всередині `article` елемента.
...
Ваш перший елемент абзацу має містити текст lorem ipsum. Перевірте орфографію та пунктуацію.
...
Ваш другий елемент абзацу має містити текст lorem ipsum. Перевірте орфографію та пунктуацію.
...
Ваші абзаци мають йти після `h3` елемента.
