...
Il selettore `.cabin:nth-of-type(1)` dovrebbe avere una proprietà `right` impostata a `-8.5%`.
...
Il selettore `.cabin:nth-of-type(1)` dovrebbe avere una proprietà `top` impostata al `50%`.
