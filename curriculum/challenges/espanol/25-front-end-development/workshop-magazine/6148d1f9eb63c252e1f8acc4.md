...
Para darle color al `hr`, necesitas ajustar la propiedad `border`. Dale al selector `hr` una propiedad `border` establecida en `1px solid rgba(120, 120, 120, 0.6)`.

# --hints--

Tu `hr` debe tener una propiedad `border` establecida en `1px solid rgba(120, 120, 120, 0.6)`.
