...
title: 'Problema 157: Resolviendo la ecuación diofántica'
challengeType: 1
forumTopicId: 301788
...
Considera la ecuación diofántica $\frac{1}{a} + \frac{1}{b} = \frac{p}{{10}^n}$ con $a$, $b$, $p$, $n$ enteros positivos y $a ≤ b$.
...
`diophantineEquation()` debería devolver `53490`.
