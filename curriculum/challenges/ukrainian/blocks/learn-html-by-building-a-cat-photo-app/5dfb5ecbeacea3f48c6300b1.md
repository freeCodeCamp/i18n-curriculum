...
У вас має бути три елементи `li`. Кожен елемент `li` повинен мати свій відкриваючий і кінцевий тег.
...
Три елементи `li` мають бути розташовані між відкриваючим і кінцевим тегами елемента `ul`.
