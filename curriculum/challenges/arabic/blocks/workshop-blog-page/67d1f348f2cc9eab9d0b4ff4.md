...
بنفس الطريقة، يجب أن يتمكن المستخدمون من نقر عنوان البريد الإلكتروني وإرسال رسالة من عميل البريد الإلكتروني الافتراضي لديهم.

إليك كيف تجعل عناوين البريد الإلكتروني قابلة للنقر:

```html
<a href="mailto:contact@company.com">contact@company.com</a>
```

في هذه الخطوة النهائية، غلف النص `fake@email.com` في عنصر وسم الرابط واستخدم `mailto:` لجعله عنوان بريد إلكتروني قابل للنقر.

وبهذه التغييرات، أصبحت صفحة مدونتك مكتملة الآن.

# --hints--

يجب أن تغلف النص `fake@email.com` في عنصر `a`.
...
يجب أن يحتوي عنصر `a` على خاصية `href`.
...
يجب تعيين خاصية `href` لعنصر `a` الجديد إلى `mailto:fake@email.com`.
