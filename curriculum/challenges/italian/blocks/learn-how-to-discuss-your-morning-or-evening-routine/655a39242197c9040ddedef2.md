...
The imperative form is used to give orders, instructions, or advice. Positive commands usually start with the verb in its base form, and negative commands start with `don't` or `do not`. This form is common when telling someone what to do or not to do. Per esempio:
