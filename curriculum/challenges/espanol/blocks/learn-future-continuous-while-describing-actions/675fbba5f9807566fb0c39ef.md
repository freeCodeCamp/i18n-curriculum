...
`Job aids` are tools or materials, such as guides or checklists, that help employees do their work more effectively. Por ejemplo:
...
`Security tips` are pieces of advice or recommendations to help people protect systems, data, and devices from risks. Por ejemplo:
