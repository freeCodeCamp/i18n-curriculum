...
مارك سعيد بتعليق سارة. ماذا يجب أن يجيب ليُعبّر عن ذلك؟
...
هذا الرد لا يتفق تمامًا مع تعليق سارة. يشير إلى أن الشفرة لا تزال تحتاج إلى تحسينات.
...
`I'm glad you think so` يُظهر الموافقة على تعليق سارة الإيجابي ويُقرّ بمدحها للشفرة النظيفة والتعليقات المفيدة.
