...
Dopo aver assegnato l'indice `left_part` all'array ordinato, incrementa `left_array_index` di `1`.

# --hints--

Dovresti aggiungere `1` al valore corrente di `left_array_index`.
