...
Щоб підвищити доступність сторінки, можна використовувати атрибут `role`, який вказує призначення елемента на сторінці для допоміжних технологій. Атрибут `role` є частиною _Ініціативи веб-доступності_ (WAI) і приймає заздалегідь визначені значення.

Надайте кожному з елементів `section` роль `region`.
