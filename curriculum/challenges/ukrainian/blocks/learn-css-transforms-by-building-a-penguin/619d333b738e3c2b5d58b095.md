...
У межах другого контрольного пункту поверніться до `130deg` і збережіть масштабування лівої руки.

# --hints--

Ви повинні надати контрольному пункту `20%` `transform` зі значенням `rotate(130deg) scaleX(-1)`.
