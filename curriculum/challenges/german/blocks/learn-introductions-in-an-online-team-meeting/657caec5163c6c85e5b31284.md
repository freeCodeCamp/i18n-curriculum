...
`He's` kann eine Kurzform für `he has` oder `he is` sein. You can understand which one it is by looking at the context:
...
Das zu verstehen hilft dir, genau zu wissen was jemand meint wenn er sagt `he's`.
