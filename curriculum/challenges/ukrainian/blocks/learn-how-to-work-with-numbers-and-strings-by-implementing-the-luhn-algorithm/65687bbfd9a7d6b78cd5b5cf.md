...
Пройдіться циклом по парних цифрах і виведіть кожну в консоль.

# --hints--

Ви маєте мати `for` цикл по `even_digits` всередині функції `verify_card_number`.
...
Ви маєте мати `--fcc-expected--` всередині циклу `for`.
