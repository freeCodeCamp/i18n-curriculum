...
Badilisha wito lako la `console.log` ili uandike thamani iliyochaguliwa kutoka kwenye menyu ya kushuka.

Unaweza kupata thamani ya sasa ya kipengele cha `select` kwa kutumia sifa yake ya `.value`. Kwa mfano:
...
Unapaswa kuandika thamani iliyochaguliwa kutoka kwenye menyu ya kushuka wakati tukio la `change` linapotokea kwenye `selectContainer`.
