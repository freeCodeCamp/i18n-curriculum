...
Abbiamo aggiunto in background:

The `rules` in the form of nested array, and the `data` in the form of array, too. E gli `outputs` desiderati.
...
Usando l'Algoritmo di Markov, cambia i `data` negli `outputs` desiderati usando le `rules` fornite.
