...
يمكن لدوالك الداخلية أيضًا إرجاع دالة. باستخدام نفس صيغة الدالة السهمية، حدّث دالة `addCharacters` لتُرجع دالة ثالثة تأخذ معلمة `num`.

# --hints--

يجب أن تُرجع دالتك السهمية الداخلية دالة سهمية أخرى تحتوي على معلمة `num`.
...
يجب أن تكون الدالة السهمية الداخلية الأعمق فارغة.
