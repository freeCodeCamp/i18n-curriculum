...
Puoi sovrascrivere questo comportamento con la proprietà `grid-auto-columns`. Imposta la proprietà `.social-icons` del selettore `grid-auto-columns` su `1fr`.

# --hints--

Il tuo selettore `.social-icons` dovrebbe avere una proprietà `grid-auto-columns` impostata su `1fr`.
