...
¿Qué hace `width=device-width` en la etiqueta `<meta name="viewport">`?
...
¿Por qué generalmente se recomienda evitar usar `user-scalable=no` en la etiqueta `<meta name="viewport">`?
