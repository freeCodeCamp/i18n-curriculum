...
Altere a cor de fundo do elemento `hr` para `brown` de modo que combine com a cor dos grãos de café.
...
O elemento `hr` deve ter a `background-color` com o valor de `brown`.
