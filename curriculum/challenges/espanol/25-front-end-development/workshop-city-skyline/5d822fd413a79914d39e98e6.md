...
Anide seis elementos `div` dentro de `.foreground-buildings` y asígneles las clases de `fb1` a `fb6` en ese orden. `"fb"` significa "foreground building". Estos serán seis edificios más para el primer plano.
