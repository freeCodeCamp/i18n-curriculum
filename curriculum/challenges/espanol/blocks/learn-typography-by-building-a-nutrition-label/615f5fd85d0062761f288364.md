...
Dale a tu selector `.calories-info span` un `margin` configurado en `-7px -2px`. Esto moverá tu texto `230` al lugar correcto.

# --hints--

Tu selector `.calories-info span` debe tener un `margin` configurado en `-7px -2px`.
