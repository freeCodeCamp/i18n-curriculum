...
`infixToFunction[operator]` повертає функцію. Викличте цю функцію безпосередньо, передаючи `arg1` і `arg2` як аргументи.

# --hints--

Ваша функція зворотного виклику має повертати результат виклику `infixToFunction[operator]`.
...
Ви маєте передати `arg1` як перший аргумент у виклик `infixToFunction[operator]`.
...
Ви маєте передати `arg2` як другий аргумент у виклик `infixToFunction[operator]`.
