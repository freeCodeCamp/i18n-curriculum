...
Dieses Wort, das auf `-ing` endet, bedeutet, etwas zu beobachten oder Zeuge von etwas zu sein.
...
Dieses Wort endet ebenfalls auf `-ing` und wird verwendet, um den Zustand oder die Beschaffenheit von etwas zu beschreiben.
