...
Curiosità: la maggior parte, se non tutti, i flipper non sono naturalmente rettangolari.

Dai agli angoli in alto a sinistra, in alto a destra e in basso a destra degli elementi `.arm` un raggio di `30%`, e all'angolo in basso a sinistra un raggio di `120%`.

# --hints--

Dovresti dare a `.arm` un `border-radius` di `30% 30% 30% 120%`.
