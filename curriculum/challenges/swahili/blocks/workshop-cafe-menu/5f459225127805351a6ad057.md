...
Badilisha rangi ya nyuma ya kipengele cha `hr` kuwa `brown` ili iendane na rangi ya maharagwe ya kahawa.

# --hints--

Unapaswa kuweka thamani ya sifa ya `background-color` kuwa `brown`.
...
Kipengele chako cha `hr` kinapaswa kuwa na sifa ya `background-color` ya `brown`.
