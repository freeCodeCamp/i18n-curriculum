...
Agora você pode estilizar o layout da sua grade.CSS Grid é similar ao Flexbox, na medida em que possui uma propriedade especial para os elementos pai quanto para os elementos filhos. 
...
A seção `main` deve ter a propriedade `grid-template-columns` definida como `1fr 94rem 1fr`.
