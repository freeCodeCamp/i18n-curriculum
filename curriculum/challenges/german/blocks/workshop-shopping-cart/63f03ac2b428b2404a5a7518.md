...
Sie müssen auch beginnen, das HTML zu löschen. Setzen Sie die `innerHTML`-Eigenschaft von `productsContainer` wieder auf einen leeren String.

# --hints--

In Ihrer `if`-Anweisung sollten Sie die `innerHTML`-Eigenschaft von `productsContainer` wieder auf einen leeren String setzen.
