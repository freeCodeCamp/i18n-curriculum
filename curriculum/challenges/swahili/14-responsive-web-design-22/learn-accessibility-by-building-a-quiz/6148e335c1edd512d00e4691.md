...
Kubofya viungo vya kusogeza kunapaswa kuruka hadi sehemu husika. Walakini, kuruka huku kunaweza kuwakatisha tamaa watumiaji wengine.

Chagua vipengele vyote, na uweke `scroll-behavior` kuwa `smooth`.
...
Unapaswa kuipa `*` `scroll-behavior` ya `smooth`.
