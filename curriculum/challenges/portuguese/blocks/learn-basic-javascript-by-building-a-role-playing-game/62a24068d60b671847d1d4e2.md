...
Agora, precisamos de um estilo rápido.Comece atribuindo ao `body` uma `background-color` definida como `#0a0a23`.
...
O seletor `body` deve ter uma propriedade `background-color` definida como `#0a0a23`.
