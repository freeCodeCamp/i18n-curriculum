...
لإعطاء عناصر الـ `fieldset` بعض الفصل، اخترها وأعطها `border-bottom` بقيمة `3px solid #3b3b4f`.

# --hints--

يجب أن تعطي عناصر الـ `fieldset` `border-bottom` بقيمة `3px solid #3b3b4f`.
