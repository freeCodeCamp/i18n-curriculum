...
Додайте ті самі властивості й значення `display`, `align-items` та `justify-content` до `.foreground-buildings`, що ви використовували в `.background-buildings`. Знову ж таки, це використовуватиме Flexbox для рівномірного розміщення будівель внизу контейнера.
