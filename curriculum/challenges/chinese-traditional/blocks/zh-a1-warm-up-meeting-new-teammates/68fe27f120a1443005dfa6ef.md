...
`什麼 (shén me)` means "what". It's commonly used to ask for unknown information, such as a name, an object, or an action. For example:

`你叫什麼名字 (nǐ jiào shén me míng zi)？` – What's your name?
