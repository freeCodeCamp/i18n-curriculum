...
Ahora comenzarás a trabajar en el método `initializeEventListeners()`. Primero, asígnale el tipo de retorno `void`.

# --hints--

Tu método `initializeEventListeners` debe tener un tipo de retorno `void`.
