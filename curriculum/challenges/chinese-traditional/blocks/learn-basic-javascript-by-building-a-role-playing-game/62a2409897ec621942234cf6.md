...
為 `#text` 元素設定 `background-color` 為 `#0a0a23`、`color` 為 `#ffffff`，並在所有邊緣添加 `10px` 的內距。
...
你的 `#text` 元素應該有 `background-color` 為 `#0a0a23`。
