...
Mwisho wa njia yako ya `map`, ungana na njia ya `join()`. Kwa kitenzi cha kutenganisha, tumia mfuatano wa herufi tupu.

# --hints--

Unapaswa kuunganisha njia ya `join` na njia ya `map` na kutumia mfuatano wa herufi tupu kama kitenzi cha kutenganisha.
