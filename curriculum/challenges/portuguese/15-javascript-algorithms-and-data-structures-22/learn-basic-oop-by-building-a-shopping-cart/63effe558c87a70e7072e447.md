...
The behavior of the `addItem` method needs to change if the product is already in the cart or not. Crie um operador ternário que verifique se o produto atual já está no carrinho. Use `undefined` para expressões verdadeiras e falsas para evitar um erro de sintaxe.
