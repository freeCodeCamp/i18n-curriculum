...
لتتبع أي علامة دقيقة تُعالَج حاليًا أثناء المحاكاة، أنشئ متغيرًا باسم `tickIndex` وقم بتعيين قيمة ابتدائية له تساوي `0`.

سيُستخدم هذا المتغير للتكرار عبر جميع العلامات الدقيقة في محاكاةك وضمان معالجة كل بوابة بالترتيب الصحيح.

# --hints--

يجب أن تنشئ متغيرًا باسم `tickIndex` وتعيّن له قيمة `0`.
