...
Agora você está pronto para começar a montar o layout de grade. Nas lições anteriores, você aprendeu que o CSS Grid oferece um layout baseado em grade bidimensional, permitindo que você centralize os itens horizontal e verticalmente enquanto ainda mantém o controle para fazer coisas como sobrepor elementos.
