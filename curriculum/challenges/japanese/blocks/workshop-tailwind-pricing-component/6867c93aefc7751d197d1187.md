...
次に、計画の`h2`をターゲットにして、`text-lg`、`font-semibold`、`text-indigo-600`のクラスを代入してください。

# --hints--

あなたの`h2`要素は`text-lg`のクラスを持っている必要があります。
...
あなたの`h2`要素は`font-semibold`のクラスを持っている必要があります。
...
あなたの`h2`要素は`text-indigo-600`のクラスを持っている必要があります。
