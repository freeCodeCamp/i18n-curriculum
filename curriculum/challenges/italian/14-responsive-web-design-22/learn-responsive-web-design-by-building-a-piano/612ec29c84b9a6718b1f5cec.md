...
La seconda regola `@media` dovrebbe avere un selettore `#piano`.
...
Il nuovo selettore `#piano` dovrebbe avere una proprietà `width` di `675px`.
...
La seconda regola `@media` dovrebbe avere un selettore `.keys`.
...
Il nuovo selettore `.keys` dovrebbe avere una proprietà `width` di `633px`.
