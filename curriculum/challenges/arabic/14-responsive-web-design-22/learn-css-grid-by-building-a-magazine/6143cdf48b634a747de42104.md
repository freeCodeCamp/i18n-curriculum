...
يجب أن يكون لعنصر `img` الثالث الخاص بك سمة `src` بقيمة `https://cdn.freecodecamp.org/testable-projects-fcc/images/survey-form-background.jpeg`.
