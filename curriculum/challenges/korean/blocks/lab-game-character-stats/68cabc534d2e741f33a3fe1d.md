...
`GameCharacter` 클래스에 `__init__` 메서드가 있어야 합니다.
...
`GameCharacter` 클래스에 `name` 메서드가 있어야 합니다.
...
`GameCharacter` 클래스에 `health` 메서드가 있어야 합니다.
...
`GameCharacter` 클래스에 `mana` 메서드가 있어야 합니다.
...
`GameCharacter` 클래스에 `level` 메서드가 있어야 합니다.
...
`GameCharacter` 클래스에 `level_up` 메서드가 있어야 합니다.
...
`GameCharacter` 클래스에 `__str__` 메서드가 있어야 합니다.
