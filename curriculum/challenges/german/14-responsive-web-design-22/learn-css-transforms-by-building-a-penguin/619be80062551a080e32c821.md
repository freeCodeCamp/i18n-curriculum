...
Runde den Gipfel ab, indem du den unteren Pseudo-Element-Ecken einen Radius von `100%` gibst, während du die oberen Ecken bei `0%` belässt.
...
Du solltest `.penguin-body::before` eine `border-radius` von `0% 0% 100% 100%` geben.
