...
Якщо ви натиснете на радіокнопки, можете помітити, що обидва елементи в одному наборі полів true/false можна вибрати одночасно.

Згрупуйте відповідні елементи так, щоб можна було вибрати лише один елемент із пари одночасно.
...
Ви повинні надати другому `input` атрибут `name`, який співпадає з атрибутом `name` першого `input`.
...
Ви повинні надати четвертому `input` атрибут `name`, який співпадає з атрибутом `name` третього `input`.
...
Ви повинні надати різні атрибути `name` першому `input` та третьому `input`.
