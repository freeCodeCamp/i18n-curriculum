...
Ще в умові `elif` передайте ітератор `expenses_from_category` у виклик `print_expenses`.

# --hints--

Ви повинні викликати `print_expenses()`, передаючи `expenses_from_category` як аргумент у вашій умові `elif`.
...
Ваш виклик `print_expenses()` має йти після змінної `expenses_from_category`.
