...
Você pode dar ao seu menu um pouco mais de espaço entre o conteúdo e os lados com várias propriedades `padding`.

Dê à classe `menu` um `padding-left` e um `padding-right` com o mesmo valor de `20px`.

# --hints--

Você deve definir a propriedade `padding-left` para `20px`.
...
Você deve definir a propriedade `padding-right` para `20px`.
...
O elemento `.menu` deve ter um `padding-left` com o valor de `20px`.
...
O elemento `.menu` deve ter um `padding-right` com o valor de `20px`.
