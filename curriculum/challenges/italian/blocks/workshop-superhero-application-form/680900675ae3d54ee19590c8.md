...
Successivamente, crea un `label` con il `className` di `section` e `column`, e il testo `How did you get your powers?`. All'interno del `label`, crea un elemento `select`.

# --hints--

Dovresti creare un elemento `label` con un `className` di `section` e `column`.
...
Il tuo elemento `label` dovrebbe contenere il testo `How did you get your powers?`.
...
Dovresti creare un elemento `select` all'interno del tuo elemento `label`.
