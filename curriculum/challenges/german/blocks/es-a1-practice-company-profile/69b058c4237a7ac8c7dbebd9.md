...
Konzentrieren Sie sich auf die im Profil genannten Firmendetails.
...
Dies entspricht nicht dem, was Sebastián erwähnt.
...
Der `.` („Punkt“) wird auf Spanisch als `punto` bezeichnet.
