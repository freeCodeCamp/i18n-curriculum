...
Un **CUSIP** è un codice alfanumerico di nove caratteri che identifica un titolo finanziario nordamericano per facilitare la compensazione e il regolamento delle operazioni. Il CUSIP è stato adottato come standard nazionale americano secondo gli standard accreditati X9.6.

# --instructions--

Scrivi una funzione che prenda una stringa come parametro e verifichi se la stringa è un CUSIP valido.
