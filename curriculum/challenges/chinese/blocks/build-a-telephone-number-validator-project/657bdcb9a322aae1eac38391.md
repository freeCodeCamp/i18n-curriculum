...
**目标：** 构建一个功能上类似于 <a href="https://telephone-number-validator.freecodecamp.rocks" target="_blank" rel="noopener noreferrer nofollow">https://telephone-number-validator.freecodecamp.rocks</a> 的应用。
...
1. 当 `#user-input` 包含 `123**&!!asdf#` 并且点击 `#check-btn` 时，`#results-div` 应该包含文本 `"Invalid US number: 123**&!!asdf#"`。
...
当 `#user-input` 包含 `123**&!!asdf#` 并且点击 `#check-btn` 时，`#results-div` 应该包含文本 `"Invalid US number: 123**&!!asdf#"`。
