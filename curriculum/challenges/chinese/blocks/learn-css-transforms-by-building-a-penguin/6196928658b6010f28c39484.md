...
将 `.ground` 元素的 `background` 设置为顺时针 90 度的线性渐变，从 `rgb(88, 175, 236)` 开始到 `rgb(182, 255, 255)` 结束。

# --hints--

你应该将 `.ground` 的 `background` 设置为 `linear-gradient(90deg, rgb(88, 175, 236), rgb(182, 255, 255))`。
