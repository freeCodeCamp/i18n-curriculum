...
Você precisará determinar se a tarefa que está sendo adicionada ao array `taskData` já existe ou não. Se a tarefa não existir, você irá adicioná-la ao array. Se existir, você irá atualizá-lo. Para realizar isso, você pode usar o método <dfn>findIndex()</dfn>.
