...
En este ejemplo, estamos haciendo una solicitud `GET` a `https://api.example.com/data`. Esto devuelve datos que deben convertirse al formato JSON antes de poder usarlos. 

Por defecto, la API Fetch usa el método `GET` para obtener datos. Esto se cubrirá en la siguiente lección, junto con otros métodos comunes de solicitud HTTP.
