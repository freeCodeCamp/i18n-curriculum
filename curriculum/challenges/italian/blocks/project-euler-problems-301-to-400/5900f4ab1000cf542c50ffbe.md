...
Esistono solo cinque sequenze di lunghezza 2 che soddisfano queste condizioni, cioè: {2,4}, {2,5}, {2,6}, {2,7} e {2,8}. Ci sono 293 sequenze di lunghezza 5; tre esempi sono: {2,5,11,25,55}, {2,6,14,36,88}, {2,8,22,64,181}.

Sia $t(n)$ il numero di tali sequenze di lunghezza $n$. Ti viene dato che $t(10) = 86195$ e $t(20) = 5227991891$.

Trova $t({10}^{10})$ e fornisci la risposta modulo $10^9$.
