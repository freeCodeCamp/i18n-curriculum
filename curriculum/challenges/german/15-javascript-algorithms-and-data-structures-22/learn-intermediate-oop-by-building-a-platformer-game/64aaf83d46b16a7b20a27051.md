...
Du solltest die Punktnotation verwenden, um auf die `style`-Eigenschaft von `canvas` zuzugreifen.
...
Du solltest die Punktnotation verwenden, um auf die `style`-Eigenschaft von `startScreen` zuzugreifen.
