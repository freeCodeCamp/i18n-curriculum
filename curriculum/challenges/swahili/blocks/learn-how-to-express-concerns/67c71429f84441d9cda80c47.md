...
Hii inamaanisha kusema kwa kifupi jambo bila kuingia katika maelezo mengi.

# --explanation--

`To mention` inamaanisha kuanzisha mada katika mazungumzo bila kutoa maelezo mengi. Kwa mfano:

`She mentioned a new project, but she didn't explain it yet.` - Hii inamaanisha alizungumzia mradi mpya kwa kifupi lakini hakutoa taarifa zaidi.
