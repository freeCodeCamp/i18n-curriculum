...
Para crear un archivo en Windows usando el Explorador, puedes hacer clic en la opción "Nuevo" en la parte superior izquierda. Esto te mostrará una lista de los diferentes tipos de archivos que puedes crear. 
...
El proceso de crear carpetas es exactamente el mismo.  Click the "New" button at the top left and then select the "Folder" option or right-click on an empty spot and go to "New." Then, select the "Folder" option. Verás una nueva carpeta vacía en tu ubicación actual.
...
Hay muchas formas de abrir TextEdit. Una de ellas es ir a Launchpad. Luego, busca una aplicación donde puedas crear el tipo de archivo que te interesa.  In this case, that would be "TextEdit." Click on the icon to open the app.

Una vez que estés dentro de la app, deberías ver una opción para guardar tu archivo en el menú File. Este menú está ubicado en la parte superior izquierda, junto al ícono del menú Apple.
...
To create a new folder, you should go to the location where you want to create that new folder and right-click on an empty spot. Verás una lista de opciones. La primera opción es "Nueva carpeta."
