...
**Nota:** Existem várias opções de unidades relativas que estão vinculadas ao tamanho da janela de visualização. Elas serão abordadas na seção Princípios de Web Design Responsivo.
