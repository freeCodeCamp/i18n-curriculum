...
Bogosort eine Liste von Zahlen.

Bogosort mischt eine Sammlung einfach zufällig, bis sie sortiert ist.

„Bogosort“ ist ein pervers ineffizienter Algorithmus, der nur als Insiderwitz verwendet wird.

Seine durchschnittliche Laufzeit ist O(n!), weil die Wahrscheinlichkeit, dass eine beliebige zufällige Mischung einer Menge in sortierter Reihenfolge endet, etwa eins zu *n* Fakultät beträgt, und der schlimmste Fall ist unendlich, da es keine Garantie gibt, dass ein zufälliges Mischen jemals eine sortierte Folge erzeugt.

Sein bester Fall ist O(n), da ein einziger Durchlauf durch die Elemente ausreichen kann, um sie zu ordnen.
