...
Unahitaji njia ya kupata jumla ya vitu vilivyoko kwenye kikapu. Njia bora zaidi ya kufanya hivyo ni kuongeza njia nyingine kwenye darasa la `ShoppingCart` badala ya kupata upatikanaji wa safu ya data ya `items` moja kwa moja.

Ongeza njia ya `getCounts` kwenye darasa la `ShoppingCart`. Inapaswa kurudisha idadi ya vitu vilivyoko kwenye safu ya data ya `items`.

# --hints--

Darasa lako la `ShoppingCart` linapaswa kuwa na njia ya `getCounts`.
...
Njia yako ya `getCounts` inapaswa kurudisha idadi ya vitu vilivyoko kwenye safu ya data ya `items`.
