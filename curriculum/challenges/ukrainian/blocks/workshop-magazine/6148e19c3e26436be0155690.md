...
Створіть правило `.lists li`, щоб націлитися на елементи списку всередині вашого елемента `.lists`. Надайте йому множину властивостей `margin-bottom` зі значенням `1.5rem`.
