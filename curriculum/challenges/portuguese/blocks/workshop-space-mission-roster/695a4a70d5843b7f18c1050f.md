...
Ordene diretamente o `array` local `sorted` usando sua função auxiliar `sortByPriorityDescending()`.

# --hints--

Você deve invocar `sortByPriorityDescending()` com o array `sorted`.
