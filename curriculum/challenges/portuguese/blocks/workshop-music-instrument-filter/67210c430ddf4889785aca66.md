...
Antes de começar a adicionar a funcionalidade de filtro à sua página, vincule seu arquivo `script.js` ao HTML.

# --hints--

Você deve ter um elemento `script` com o atributo `src` definido como `script.js`.
