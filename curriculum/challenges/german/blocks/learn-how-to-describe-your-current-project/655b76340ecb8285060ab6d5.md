...
Welcher Satz beschreibt korrekt, was Sophie und James gerade in ihren Projekten tun?
...
Diese Option verwendet fälschlicherweise die `present simple`-Zeitform für Sophie und die `past simple`-Zeitform für James. Sie spiegeln nicht die kontinuierliche, andauernde Natur ihrer aktuellen Tätigkeiten wider.
...
Diese Option verwendet fälschlicherweise die `past simple`-Zeitform für Sophies Handlung und die `present simple` für James' Handlung, was nicht mit den laufenden und aktuellen Tätigkeiten übereinstimmt, an denen sie beteiligt sind.
...
Diese Option suggeriert fälschlicherweise eine zukünftige Handlung für Sophie und eine Verlaufsform der Vergangenheit für James, was nicht zum Gespräch passt.
