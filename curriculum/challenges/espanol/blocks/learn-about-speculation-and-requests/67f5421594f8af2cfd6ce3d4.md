...
This two-word phrase refers to methods or actions that are commonly accepted as the best way to do something. Usa el formulario plural.

# --explanation--

`Best practices` are the most effective ways to complete a task. Por ejemplo:
