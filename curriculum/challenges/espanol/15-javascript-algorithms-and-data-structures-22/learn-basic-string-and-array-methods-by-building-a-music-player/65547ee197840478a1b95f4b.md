...
Prueba tu aplicación haciendo primero clic en el botón de reproducir seguido por el botón siguiente. Deberías ver que todo funciona como se espera.
...
Tu oyente de eventos debería escuchar un evento `"click"`.
