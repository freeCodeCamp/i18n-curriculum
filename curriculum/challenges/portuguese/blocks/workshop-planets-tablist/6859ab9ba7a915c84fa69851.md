...
Para o segundo elemento `tabpanel`, adicione o atributo `id` com o valor `"panel-saturn"` e um atributo `aria-labelledby` com o valor `"tab-saturn"`.

Para o terceiro elemento `tabpanel`, adicione o atributo `id` com o valor `"panel-mars"` e um atributo `aria-labelledby` com o valor `"tab-mars"`.
