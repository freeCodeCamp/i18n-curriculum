...
title: Ambito globale vs. locale nelle funzioni
challengeType: 1
forumTopicId: 18194
...
È possibile avere sia variabili <dfn>locali</dfn> sia <dfn>globali</dfn> con lo stesso nome. Quando succede, la variabile locale ha la precedenza su quella globale.
...
Non dovresti modificare il valore della variabile globale `outerWear`.
