...
`He's` може бути короткою формою для `he has` або `he is`. You can understand which one it is by looking at the context:
...
Розуміння цього допомагає вам точно знати, що хтось має на увазі, коли каже `he's`.
