...
为无障碍考虑，提供了听力障碍学习者可用的文本记录；建议仅在需要时使用。
...
听音频。这个问题问的是什么？<!-- (quiz audio) Sophie: Do you have any tips on how to have a healthy morning routine? -->
...
听音频。这个句子的主要意思是什么？<!-- (quiz audio) Expert: If you start the day feeling relaxed, you may have a more productive day. -->
