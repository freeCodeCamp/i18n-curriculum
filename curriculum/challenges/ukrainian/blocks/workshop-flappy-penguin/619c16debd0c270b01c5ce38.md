...
Зробіть так, щоб верхні кути елементів `.face` мали радіус `70%`, а нижні кути — радіус `60%`.

# --hints--

Ви повинні надати `.face` властивість `border-radius` зі значенням `70% 70% 60% 60%`.
