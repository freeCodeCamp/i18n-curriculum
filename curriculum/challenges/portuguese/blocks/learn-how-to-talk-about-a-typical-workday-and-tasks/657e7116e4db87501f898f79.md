...
Nesta tarefa, concentre-se na conjugação verbal na terceira pessoa do singular ao descrever a rotina de outra pessoa.

Nota: `head to` significa ir ou se mover em direção a um lugar. 

# --instructions--

Ouça o áudio para entender o contexto. Escreva as formas corretas dos verbos para completar as frases sobre a rotina matinal de Sarah, focando na conjugação da terceira pessoa do singular.
...
Esta é uma forma do verbo `wake`, usada com `he`, `she` ou `it`.
...
Esta é uma forma do verbo `get`, usada com `he`, `she` ou `it`.
...
Esta é uma forma do verbo `have`, usada com `he`, `she` ou `it`.
...
Esta é uma forma do verbo `head`, usada com `he`, `she` ou `it`.
