...
Tatizo kwa sasa ni kwamba mara tu onyesho la awali linaonyesha upya au unapoonyesha upya ukurasa, kila kitu unachoongeza kwa kadi ya mchezaji hupotea.

Kuhifadhi ingizo zote katika localstorage kutaizuia hili. Ili kuanza na hilo, tengeneza thabiti ya `STORAGE_KEY` yenye mfuatano wa herufi `football_player_card` kama thamani yake.

# --hints--

Unapaswa kutangaza mabadiliko ya `STORAGE_KEY`.
...
`STORAGE_KEY` yako inapaswa kuwa na mfuatano wa herufi `football_player_card` kama thamani yake.
