...
Використайте тернарний оператор, щоб перетворити ваш виклик `.hasOwnProperty()` на умову. Якщо об’єкт має властивість, поверніть результат виклику `apply` з аргументами `fn` та `args`. В іншому випадку поверніть `match`.

# --hints--

Функція зворотного виклику повинна використовувати тернарний синтаксис.
...
Якщо потрійна умова дійсна, функція зворотного виклику має повернути результат виклику `apply()`.
...
Якщо трійковий хибний, поверніть `match`.
