...
`FootballPlayerCard` наразі відтворює лише саму картку. Щоб створити повну сторінку, додайте елемент `div` з `className` `page`.

Всередині цього `div` додайте елемент `header` типу `className` з `header`. Усередині `header` додайте `div` типу `className` з `header-inner`. Усередині елемента `header-inner` додайте два абзаци тексту `Football Card Builder` та `Customize your player card` відповідно. Абзаци також повинні мати `className` `header-title` та `header-subtitle` кожен.

Після закриваючого елемента `header`, але все ще всередині `div` з `className` `page`, розмістіть компонент `PlayerCard` з його пропом як тимчасовим заповнювачем, доки не буде додано основний макет.

# --hints--

Ваш `FootballPlayerCard` має відтворювати `div` з `className` `page`.
...
Ваш `div` з `className` `page` має містити елемент `header` з `className` `header`.
...
Ваш `header` має містити `div` з `className` `header-inner`.
...
Ваш елемент `header-inner` має містити `p` з `className` `header-title` і текст `Football Card Builder`.
...
Ваш елемент `header-inner` має містити `p` з `className` `header-subtitle` і текст `Customize your player card`.
...
Ваш компонент `PlayerCard` має бути відтворений всередині `div.page`.
