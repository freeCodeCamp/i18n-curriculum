...
Se você está usando seu computador para o currículo de espanhol, precisará garantir que ele esteja pronto para digitar acentos e caracteres especiais como o `ñ`. Configurar isso é rápido, seja você usar Windows ou Mac. Leva apenas alguns minutos.
