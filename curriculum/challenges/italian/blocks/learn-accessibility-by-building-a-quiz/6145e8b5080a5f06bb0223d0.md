...
Dovresti dare al secondo `label` il testo `False`.
...
Dovresti dare al quarto `label` il testo `False`.
...
Dovresti dare al primo `input` un `value` che corrisponda al contenuto testuale `label`.
...
Dovresti dare al secondo `input` un `value` che corrisponda al contenuto testuale `label`.
...
Dovresti dare al terzo `input` un `value` che corrisponda al contenuto testuale `label`.
...
Dovresti dare al quarto `input` un `value` che corrisponda al contenuto testuale `label`.
