...
将 `address` 元素中的所有文本水平居中，并添加一些内边距。
...
你应该给 `address` 添加至少 `1px` 的 `padding-right`。
...
你应该给 `address` 添加至少 `1px` 的 `padding-bottom`。
...
你应该给 `address` 添加至少 `1px` 的 `padding-left`。
