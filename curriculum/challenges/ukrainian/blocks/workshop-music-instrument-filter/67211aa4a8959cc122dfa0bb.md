...
Змініть свій виклик `console.log`, щоб виводити в консоль вибране значення з випадаючого списку.

Ви можете отримати доступ до поточного значення елемента `select` за допомогою його властивості `.value`. Наприклад:
...
Ви повинні виводити вибране значення з випадаючого списку, коли на `change` спрацьовує подія `selectContainer`.
