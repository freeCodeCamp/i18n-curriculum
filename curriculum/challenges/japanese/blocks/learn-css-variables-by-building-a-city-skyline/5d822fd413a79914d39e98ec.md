...
`div` 要素の上下にそれぞれ空の `.foreground-buildings` 要素を2つずつ追加し、`.fb2` と `.fb3` の間にもう1つ追加して、建物を再び詰めてください。

# --hints--

`div` の最初の子要素として `.foreground-buildings` 要素を2つ追加してください。
...
`div` と `.fb2` の間に `.fb3` 要素を1つ追加してください。
...
`div` の最後の子要素として `.foreground-buildings` 要素を2つ追加してください。
