...
8. 在 `video` 元素內部，應該有一個 `source` 元素，帶有指向視頻文件的 `src` 屬性和 `type` 屬性。 你可以使用此視頻文件：`https://cdn.freecodecamp.org/curriculum/labs/What is the map method and how does it work.mp4`
