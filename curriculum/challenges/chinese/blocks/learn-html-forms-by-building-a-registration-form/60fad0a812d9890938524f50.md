...
为了让学员知道在他们的简历中应该写些什么，使用了 `placeholder` 属性。 `placeholder` 接受一个文本值，该值在用户开始键入之前一直显示。

给 `textarea` 添加一个 `placeholder`，值为 `I like coding on the beach...`。

# --hints--

你应该给 `textarea` 添加一个 `placeholder` 属性。
