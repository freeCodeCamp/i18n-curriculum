...
- `.keys()` devuelve un nuevo objeto iterador de mapa que contiene todas las claves en el orden de inserción
- `.values()` devuelve un nuevo objeto iterador de mapa que contiene todos los valores en el orden de inserción
- `.entries()` devuelve un nuevo objeto iterador de mapa que contiene todos los pares clave, valor en el orden de inserción
