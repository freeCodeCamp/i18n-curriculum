...
Começaremos em `i = 0` e repetiremos enquanto `i < 10`.Incrementaremos `i` em 2 a cada iteração com `i += 2`.
...
Adicione os números ímpares de 1 a 9 em `myArray` usando um loop `for`.
