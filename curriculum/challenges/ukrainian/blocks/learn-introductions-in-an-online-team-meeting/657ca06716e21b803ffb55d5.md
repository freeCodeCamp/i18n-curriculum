...
У реченні Боба, до кого відноситься займенник `her`?
...
`Her` не використовується для позначення групи, як-от команда.
...
`Her` не використовується для Боба.
