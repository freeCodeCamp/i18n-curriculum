...
في الوحدات السابقة، تعلمت كيف تقوم بالتكرار خلال `NodeList` بهذه الطريقة:
...
استخدم طريقة `forEach` للتكرار خلال `tabs`. للدالة الاستدعاء الراجع، استخدم الدالة السهمية التي تأخذ معلمة واحدة، `tab`.

# --hints--

يجب أن يكون لديك `tabs.forEach(tab => {})` في شفرتك.
