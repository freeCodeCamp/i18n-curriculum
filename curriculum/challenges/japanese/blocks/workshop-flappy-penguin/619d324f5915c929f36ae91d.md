...
`wave` に、`10%` から始まり `10%` ずつ増加する4つのウェイポイントを与えてください。

# --hints--

`10%` のために `@keyframes wave` のウェイポイントを追加してください。
...
`20%` のために `@keyframes wave` のウェイポイントを追加してください。
...
`30%` のために `@keyframes wave` のウェイポイントを追加してください。
...
`40%` のために `@keyframes wave` のウェイポイントを追加してください。
