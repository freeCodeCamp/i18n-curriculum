...
title: Somma di tutti i numeri dispari di Fibonacci
challengeType: 1
forumTopicId: 16084
...
Dato un numero intero positivo `num`, restituisci la somma di tutti i numeri dispari di Fibonacci che sono minori o uguali a `num`.

I primi due numeri della sequenza di Fibonacci sono 0 e 1. Ogni numero successivo nella sequenza è la somma dei due numeri precedenti. I primi sette numeri della sequenza di Fibonacci sono 0, 1, 1, 2, 3, 5 e 8.
