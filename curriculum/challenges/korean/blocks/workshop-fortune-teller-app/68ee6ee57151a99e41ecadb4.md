...
이제 `showElements` 함수를 호출하고 `multipleCard`, `fortuneContainer`, `text`를 프로프로 전달하세요.

# --hints--

`showElements` 메서드 안에서 `multipleCardSelected` 함수를 호출해야 합니다.
...
`text` 함수에 인수로 `showElements`를 전달해야 합니다.
