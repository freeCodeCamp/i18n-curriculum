...
Tumia mzunguko wa `for` kurekodi `name` ya kila mwananga katika safu ya data ya `updatedCrew`. Baada ya mzunguko, rudisha safu ya data ya `updatedCrew` ili ukamilishe kitendakazi chako cha `swapCrewMembers`.

# --hints--

Unapaswa kutumia mzunguko wa `for` kurudia kupitia safu ya data ya `updatedCrew` na kurekodi `name` ya kila mwananga.
...
Unapaswa kurudisha safu ya data ya `updatedCrew` baada ya kurekodi majina ya wananga wake.
