...
Практикуйте вибір правильної форми дієслова для однини відділу.
...
`Verifican` — це форма для `ellos/ellas`, але `el departamento` є в однині.
...
`El departamento de control de calidad verifica el software.` — Відділ контролю якості перевіряє програмне забезпечення.

Підмет `el departamento` є в однині, тому йому потрібна дієслівна форма в однині `verifica`. 
