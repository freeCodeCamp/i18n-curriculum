...
Simulieren Sie die Nachtschicht, indem Sie `simulateFestival()` mit `nightGates` und `"Night"` aufrufen.

Damit sind Ihre Simulationen abgeschlossen!

# --hints--

Sie sollten `simulateFestival()` mit `nightGates` und `"Night"` aufrufen.
