...
Ein gegebenes Rechteck besteht aus *m* × *n* Quadraten. Wenn *m* und *n* nicht beide ungerade sind, ist es möglich, einen Pfad entlang der Quadratkanten durch das Rechteck zu schneiden, sodass das Rechteck in zwei zusammenhängende Teile mit derselben Form geteilt wird (nachdem eines der Teile um 180° gedreht wurde). Alle solchen Pfade für 2 × 2 und 4 × 3 Rechtecke sind unten dargestellt.
...
<div style="width: 100%; text-align: center;">
  <svg xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink" width="520" height="170" aria-hidden="true" alt="Diagram showing the possible paths for 2 by 2 and 4 by 3 rectangles">
    <style>
.diagram-g { Füllung: keine; Strich: #ccc }
      .diagram-s, .diagram-s2 { Füllung: #bff; Strich: schwarz; Füll-Deckkraft: .4 }
      .diagram-s2 { Füllung: #fbf }
      .diagram-d { Strich: schwarz; Füllung: keine}
    </style>
    <defs>
      <g id="diagram-m">
        <g id="diagram-h4">
...
Schreiben Sie eine Funktion, die die Anzahl der verschiedenen Möglichkeiten berechnet, ein *m* × *n* Rechteck zuzuschneiden.
