...
Щоб завершити підготовку до вашої космічної місії, зробіть виклик `printCrewSummary()` з вашим масивом `updatedSquad`!

# --hints--

Ви маєте викликати вашу функцію `printCrewSummary()` з `updatedSquad`.
