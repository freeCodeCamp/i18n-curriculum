...
Auf zum nächsten Bauelement! Es ist das grüne Element im Vordergrund. Gib ihm einen `repeating-linear-gradient` mit deiner Gebäudefarbe von `0%` zu `5%`, und `transparent` von `5%` zu `10%`.

# --hints--

Du solltest `.fb5` eine `background`-Eigenschaft zuweisen.
