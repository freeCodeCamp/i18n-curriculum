...
В функції `linear-gradient` встановіть `gradientDirection` на `180deg`.

# --hints--

Ваше CSS-правило `.red` повинне мати властивість `background` зі значенням `linear-gradient(180deg, rgb(255, 0, 0) 75%, rgb(0, 255, 0), rgb(0, 0, 255))`.
