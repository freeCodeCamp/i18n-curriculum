...
Geuza maandishi ya yaliyopo ya `freeCodeCamp.org` kuwa kiungo kwa kuifunga katika kipengele cha nanga (`a`). Sifa ya `href` inapaswa kuwekwa kuwa `https://www.freecodecamp.org`.
