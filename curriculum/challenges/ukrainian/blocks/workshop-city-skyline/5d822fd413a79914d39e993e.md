...
Нарешті, у селекторі `:root` медіазапиту перевизначте всі чотири змінні `--window-color`, щоб вони використовували `#777`. Коли закінчите, змініть розмір вікна і спостерігайте, як воно переходить від дня до ночі.

Змінні здебільшого використовують для кольорів, і саме так ви їх тут застосували. Але їм можна присвоїти будь-яке значення і використовувати в будь-якій властивості. Ваш проєкт виглядає чудово!

# --hints--

Ви повинні додати `--window-color1` зі значенням `#777`.
...
Ви повинні додати `--window-color2` зі значенням `#777`.
...
Ви повинні додати `--window-color3` зі значенням `#777`.
...
Ви повинні додати `--window-color4` зі значенням `#777`.
