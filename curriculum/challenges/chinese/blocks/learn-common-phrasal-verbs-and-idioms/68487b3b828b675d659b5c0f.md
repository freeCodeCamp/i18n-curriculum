...
A `clause` is a section or part of a legal or formal document, like a policy or contract. 例如：
...
`In-office days` refers to the days employees are required to be physically present at their workplace. 例如：
