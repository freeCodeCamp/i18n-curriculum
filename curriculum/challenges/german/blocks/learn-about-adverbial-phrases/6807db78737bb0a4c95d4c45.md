...
A `feature` is a specific part or function of a product, especially in apps or software. `Features` are what make a product useful or interesting. Zum Beispiel:
