...
Всередині першого елемента `td` додайте вставлений вираз `${}`. Усередині цього виразу викличте функцію `forumCategory` з аргументом `category_id`.

Тепер ви повинні побачити категорію, що відображається під кожною темою допису.

# --hints--

Ви повинні викликати функцію `forumCategory` з аргументом `category_id`
