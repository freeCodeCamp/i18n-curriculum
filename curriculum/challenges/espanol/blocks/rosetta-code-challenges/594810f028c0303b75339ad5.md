...
En la estricta <a href="https://www.freecodecamp.org/news/the-principles-of-functional-programming/" target="_blank" rel="noopener noreferrer nofollow">programación funcional</a> y el cálculo lambda, las funciones (expresiones lambda) no tienen estado y solo pueden referirse a los argumentos de funciones que las contienen. Esto descarta la definición habitual de una función recursiva en la que una función está asociada con el estado de una variable y el estado de esta variable se usa en el cuerpo de la función.
