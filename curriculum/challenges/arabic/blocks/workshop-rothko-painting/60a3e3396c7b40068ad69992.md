...
زوايا كل مستطيل لا تزال حادة جدًا.

قُم بتدوير كل زاوية من عنصر `.one` بمقدار 9 بكسلات، باستخدام خاصية `border-radius`.

# --hints--

يجب أن تضبط خاصية `border-radius` على القيمة `9px`.
...
يجب أن يحتوي عنصر `.one` على قيمة `border-radius` تساوي `9px`.
