...
Abaixo do seu elemento `legend`, adicione um `input` do tipo checkbox com os atributos `id` e `value` definidos como `"ads"` e o atributo `name` definido como `"choice"`.
