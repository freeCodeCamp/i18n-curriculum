...
Os valores RGB podem variar de 0 a 255. O valor alpha pode variar de 1, que é totalmente opaco ou uma cor sólida, até 0, que é totalmente transparente ou claro. `rgba()` é ótimo para usar neste caso, pois permite ajustar a opacidade. Isso significa que você não precisa eliminar completamente o fundo.
