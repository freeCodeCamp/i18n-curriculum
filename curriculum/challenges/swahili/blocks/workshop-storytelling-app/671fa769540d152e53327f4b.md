...
Chagua vifungo vya `#scary-btn`, `#funny-btn`, na `#adventure-btn` na vihifadhi katika vigezo vinavyoitwa `scaryStoryBtn`, `funnyStoryBtn`, na `adventureStoryBtn`.

# --hints--

Unapaswa kuchagua kitufe cha `#scary-btn` kwa kutumia njia ya `getElementById` na kuikumbatia katika kigezo cha `scaryStoryBtn`.
...
Unapaswa kuchagua kitufe cha `#funny-btn` kwa kutumia njia ya `getElementById` na kuikumbatia katika kigezo cha `funnyStoryBtn`.
...
Unapaswa kuchagua kitufe cha `#adventure-btn` kwa kutumia njia ya `getElementById` na kuikumbatia katika kigezo cha `adventureStoryBtn`.
