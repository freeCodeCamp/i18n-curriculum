...
In dieser Phrase `simple and quick meals`, sind `simple` (beschreibt Leichtigkeit) und `quick` (beschreibt Geschwindigkeit) Adjektive. The order is flexible because they belong to different categories (opinion and speed).
