...
أول شيء يجب فعله هو التحقق مما إذا كانت مصفوفة `items` فارغة. إذا كانت كذلك، اعرض `alert` للمستخدم بالنص `Your shopping cart is already empty`، ثم ارجع من الدالة.
...
يجب أن تعيد جملة `if` التحكم من الدالة.
