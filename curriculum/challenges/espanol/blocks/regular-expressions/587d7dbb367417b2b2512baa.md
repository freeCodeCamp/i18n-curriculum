...
Podrías usar `/row row row/`, pero ¿qué pasa si no sabes la palabra específica repetida? <dfn>Los grupos de captura</dfn> pueden usarse para encontrar subcadenas repetidas.
