...
Надайте селектору `.text-with-images` множину властивостей `margin-bottom` зі значенням `3rem`.

# --hints--

Ваш селектор `.text-with-images` має мати множину властивостей `margin-bottom` зі значенням `3rem`.
