...
Ci sono altre proprietà da aggiungere all'interfaccia `Card`. Inizia impostando `value_int` con il tipo `number`. Tutte le altre proprietà dovrebbero essere di tipo `string`: `suit`, `type`, `img`, `meaning_up`, `meaning_rev` e `desc`.

# --hints--

Dovresti avere una proprietà `value_int` con un tipo `number`.
...
Dovresti avere una proprietà `suit` con un tipo `string`.
...
Dovresti avere una proprietà `type` con un tipo `string`.
...
Dovresti avere una proprietà `img` con un tipo `string`.
...
Dovresti avere una proprietà `meaning_up` con un tipo `string`.
...
Dovresti avere una proprietà `meaning_rev` con un tipo `string`.
...
Dovresti avere una proprietà `desc` con un tipo `string`.
