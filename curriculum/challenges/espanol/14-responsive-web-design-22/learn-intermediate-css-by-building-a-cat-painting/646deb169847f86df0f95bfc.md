...
Debes tener un selector `.cat-right-inner-eye`.

```js
assert(new __helpers.CSSHelp(document).getStyle('.cat-right-inner-eye'))
```

Tu selector `.cat-right-inner-eye` debe tener un `width` establecido en `10px`.

```js
assert(new __helpers.CSSHelp(document).getStyle('.cat-right-inner-eye')?.width === '10px')
```

Tu selector `.cat-right-inner-eye` debe tener un `height` establecido en `20px`.

```js
assert(new __helpers.CSSHelp(document).getStyle('.cat-right-inner-eye')?.height === '20px')
```

Tu selector `.cat-right-inner-eye` debe tener un `background-color` establecido en `#fff`.
