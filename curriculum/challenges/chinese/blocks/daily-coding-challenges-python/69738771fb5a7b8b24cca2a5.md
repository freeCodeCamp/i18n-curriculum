...
`count_change([25, 10, 5, 1])` 应该返回 `"$0.41"`。
...
`count_change([25, 10, 5, 1, 25, 10, 25, 1, 1, 10, 5, 25])` 应该返回 `"$1.43"`。
...
`count_change([100, 25, 100, 1000, 5, 500, 2000, 25])` 应该返回 `"$37.55"`。
...
`count_change([10, 5, 1, 10, 1, 25, 1, 1, 5, 1, 10])` 应该返回 `"$0.70"`。
...
`count_change([25, 25, 25, 25])` 应该返回 `"$1.00"`。
