...
Per l'ultimo passaggio del workshop, devi registrare il messaggio `"It was fun learning about the different Math methods with you!"` nella console.

E con quest'ultima modifica, hai completato il workshop MathBot!

# --hints--

Dovresti registrare il messaggio `"It was fun learning about the different Math methods with you!"` nella console.
