...
Додайте ще два елементи `div`, кожен з атрибутом `className` зі значенням `form-group` всередині `stats-grid`, один для PAS, інший для DRI.

Для елемента PAS додайте `label` з атрибутом `htmlFor` зі значенням `pas` і текстом `PAS`, потім input з атрибутом `id` зі значенням `pas` і атрибутом `type` зі значенням `number`.

Для елемента DRI додайте `label` з атрибутом `htmlFor` зі значенням `dri` і текстом `DRI`, потім input з атрибутом `id` зі значенням `dri` і атрибутом `type` зі значенням `number`.

# --hints--

Ви повинні додати ще два елементи `div`, кожен з атрибутом `className` зі значенням `form-group` всередині `div` елемента `className` елемента `stats-grid`.
...
Ваш третій елемент `div` типу `className` елемента `form-group` повинен мати `label` з атрибутом `htmlFor` зі значенням `pas`, `className` типу `label` і текст `PAS`.
...
Ваш третій елемент `div` типу `className` елемента `form-group` повинен мати `input` з атрибутом `className` зі значенням `input`, `id` зі значенням `pas` і `type` зі значенням `number`.
...
Ваш четвертий елемент `div` типу `className` елемента `form-group` повинен мати `label` з атрибутом `htmlFor` зі значенням `dri`, `className` типу `label` і текст `DRI`.
...
Ваш четвертий елемент `div` типу `className` елемента `form-group` повинен мати `input` з атрибутом `className` зі значенням `input`, `id` зі значенням `dri` і `type` зі значенням `number`.
