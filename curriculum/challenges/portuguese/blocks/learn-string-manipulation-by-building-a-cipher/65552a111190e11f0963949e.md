...
Delete a palavra-chave `pass` e retorne `vigenere(message, key)` da sua nova função.

# --hints--

Sua função `encrypt` deve retornar `vigenere(message, key)`. Lembre-se de deletar `pass`.
