...
النص `.sr-only` لا يزال مرئيًا. هناك نمط شائع لإخفاء النص بصريًا ليقرأه قارئ الشاشة فقط.

هذا النمط يتطلب تعيين خصائص CSS التالية:
