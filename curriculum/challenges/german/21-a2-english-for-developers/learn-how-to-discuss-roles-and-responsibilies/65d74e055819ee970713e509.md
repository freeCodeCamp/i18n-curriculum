...
# --description--
 ...
 Wenn du etwas ausdrücken musst, was verboten oder ein starker Vorschlag ist, etwas nicht zu tun, kannst du `mustn't` (Kontraktion von `mustn't`) verwenden, um einen negativen Satz zu bilden.
