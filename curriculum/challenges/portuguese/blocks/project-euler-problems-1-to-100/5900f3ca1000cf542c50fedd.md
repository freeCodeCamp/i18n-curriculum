...
Devemos definir um <dfn>triângulo quase equilátero</dfn> como sendo um triângulo para os quais dois lados são iguais e o terceiro é, no máximo, uma unidade maior ou menor.
