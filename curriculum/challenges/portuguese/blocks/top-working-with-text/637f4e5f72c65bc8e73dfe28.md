...
Existem 6 níveis diferentes de títulos começando de `<h1>` até `<h6>`.O número dentro de uma tag de título representa o nível desse título.O título maior e mais importante é `h1`, enquanto `h6` é o menor título, de nível mais baixo.

Os títulos são definidos do mesmo modo que os parágrafos.Por exemplo, para criar um título `h1`, envolvemos nosso texto do título em uma tag `<h1>`.
...
Existem 5 níveis diferentes de títulos. `h5` é o menor e menos importante título e `h1` é o maior e mais importante título.

---

Existem 6 níveis diferentes de títulos. `h6` é o título maior e mais importante e `h1` é o título menor e menos importante.

---

Existem 6 níveis diferentes de títulos. `h1` é o título maior e mais importante e `h6` é o título menor e menos importante.
