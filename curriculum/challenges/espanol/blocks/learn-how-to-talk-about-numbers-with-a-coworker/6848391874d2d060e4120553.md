...
`Initial setup` means the first steps in a project — preparing systems, tools, and access before real work starts. Por ejemplo:

`The initial setup of the system took one day.` — The beginning part of installing the system took a day.

`Early development` refers to the beginning of the building process, often including prototypes or base functionality. Por ejemplo:
