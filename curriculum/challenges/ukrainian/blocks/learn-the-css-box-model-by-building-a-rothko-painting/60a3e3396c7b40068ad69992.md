...
Кути кожного прямокутника все ще надто гострі.

Заокругліть кожен кут елемента `.one` на 9 пікселів, використовуючи властивість `border-radius`.

# --hints--

Ви повинні встановити властивість `border-radius` у значення `9px`.
...
Ваш елемент `.one` має мати значення `border-radius` рівне `9px`.
