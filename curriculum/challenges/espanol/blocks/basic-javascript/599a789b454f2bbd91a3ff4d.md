...
`3 == '3'` devuelve `true` porque JavaScript realiza una conversión de tipo de cadena a número. `3 === '3'` devuelve `false` porque los tipos son diferentes y no se realiza conversión de tipo.
