...
Substitua o nome do jogador codificado diretamente `PELE` dentro de `card-name` por `player.name`.

# --hints--

Você deve substituir o `PELE` codificado diretamente por `player.name` dentro de `.card-name`.
