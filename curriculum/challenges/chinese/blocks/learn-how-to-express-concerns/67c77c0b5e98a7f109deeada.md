...
`I don't think it's an option` has the same meaning as `I think it's not an option`. Both indicate that you do not believe something is a possible choice. 例如：
