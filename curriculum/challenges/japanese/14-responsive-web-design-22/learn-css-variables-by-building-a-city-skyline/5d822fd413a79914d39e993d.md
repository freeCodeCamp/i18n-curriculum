...
メディアクエリに `:root` セレクターを追加する必要があります。
...
値が `#000` の `--building-color1` を追加する必要があります。
...
値が `#000` の `--building-color2` を追加する必要があります。
...
値が `#000` の `--building-color3` を追加する必要があります。
...
値が `#000` の `--building-color4` を追加する必要があります。
