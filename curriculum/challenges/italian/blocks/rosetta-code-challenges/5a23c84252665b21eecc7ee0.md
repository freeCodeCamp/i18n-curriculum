...
I **fattoriali sinistri**, $ !n $, possono riferirsi sia ai *subfattoriali* sia alle *somme di fattoriali*. La stessa notazione può essere usata in modo confuso per le due definizioni diverse. A volte, i *subfattoriali* (noti anche come *derangements*) possono usare una qualsiasi delle seguenti notazioni:
...
(Non è visivamente ovvio, ma l’ultimo esempio usa un punto esclamativo capovolto.) In questa attività useremo questa formula per il **fattoriale sinistro**:
...
Scrivi una funzione per calcolare il fattoriale sinistro di un numero dato.
