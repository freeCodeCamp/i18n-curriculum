...
`Does` is used as an auxiliary verb to form questions in the `Present Simple` tense for `he`, `she` and `it`. It is often used to ask for opinions or confirm something. 例如：
