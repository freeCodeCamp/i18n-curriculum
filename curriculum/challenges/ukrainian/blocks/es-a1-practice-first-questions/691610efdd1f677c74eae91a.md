...
Це слово завершує ввічливу фразу "Приємно познайомитись".
...
Ці два слова разом — назва країни в Центральній Америці.
...
У цьому діалозі є слова `gusto`, `El Salvador` та `guatemalteco` (у такому порядку).
