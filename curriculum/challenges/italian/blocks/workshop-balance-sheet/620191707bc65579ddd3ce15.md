...
Il selettore `tr[class="total"] th` dovrebbe avere una proprietà `text-align` con il valore `left`.
...
Il selettore `tr[class="total"] th` dovrebbe avere una proprietà `padding` impostata su `0.5rem 0 0.25rem 0.5rem`.
