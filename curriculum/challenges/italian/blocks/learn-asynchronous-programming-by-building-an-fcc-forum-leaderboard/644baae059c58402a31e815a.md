...
Se il `id` non è nell'oggetto `allCategories`, dovrai mostrare la categoria `General`.

Sotto la tua istruzione `if`, aggiungi una clausola `else`. 

# --hints--

Dovresti avere una clausola `else` sotto la tua istruzione `if`.
