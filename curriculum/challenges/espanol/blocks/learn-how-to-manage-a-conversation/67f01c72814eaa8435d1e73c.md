...
`To hear` means to listen to something or to receive information. It is an irregular verb, and its past form is `heard`. Por ejemplo:

`I heard some interesting news this morning.` – This means that the speaker received or listened to some news earlier.

`To request` means to ask for something formally, often in a professional or polite manner. Por ejemplo:
