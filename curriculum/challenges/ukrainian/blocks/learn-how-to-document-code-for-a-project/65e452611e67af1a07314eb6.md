...
Це слово використовується, щоб запитати про метод або спосіб, як щось слід зробити.
...
Це означає писати пояснення та коментарі в коді, щоб зробити код легшим для розуміння іншими або для майбутнього референсу.
