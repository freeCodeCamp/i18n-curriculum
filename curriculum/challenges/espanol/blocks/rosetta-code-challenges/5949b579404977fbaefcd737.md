...
Dos enteros $N$ y $M$ se dicen pares amigables si $N \neq M$ y la suma de los divisores propios de $N$ ($\mathrm{sum}(\mathrm{propDivs}(N))$) $= M$ así como $\mathrm{sum}(\mathrm{propDivs}(M)) = N$.
