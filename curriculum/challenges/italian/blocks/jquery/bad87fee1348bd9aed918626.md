...
Allo stesso modo in cui puoi aggiungere classi a un elemento con la funzione `addClass()` di jQuery, puoi rimuoverle con la funzione `removeClass()` di jQuery.

Ecco come farlo per un pulsante specifico:
...
Dovresti usare jQuery solo per rimuovere questa classe dall'elemento.
