...
Kijenzi cha `Set` pia kinakubali kitu kinachoweza kurudiwa kama hoja yake na huunda seti kutoka kwake:
...
Ili kukamilisha warsha hii, badilisha `displayPlantsSet` yako ili irudishe seti ya majina ya kawaida ya mimea ya kipekee katika orodha yako.

Ili kufanikisha hili, tengeneza safu ya data inayojumuisha `commonName` ya kila kitu cha mmea kilichohifadhiwa kama ufunguo wa ramani ya `catalog`. Pitia safu hiyo kwa kijenzi cha `Set` na rudisha seti kutoka kwenye kitendakazi.

# --hints--

Kitendakazi chako cha `displayPlantsSet` kinapaswa kurudisha seti inayojumuisha `commonName` ya kila mmea katika orodha yako.
