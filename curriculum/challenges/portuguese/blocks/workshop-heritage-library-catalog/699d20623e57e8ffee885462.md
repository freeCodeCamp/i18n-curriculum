...
Vamos ver o validador detectar um problema real. `catalog[0]` é "From a Buick 8" de Stephen King, que tem todos os quatro campos preenchidos. `catalog[16]` é "Unknown Title", que tem o campo do autor em branco.
