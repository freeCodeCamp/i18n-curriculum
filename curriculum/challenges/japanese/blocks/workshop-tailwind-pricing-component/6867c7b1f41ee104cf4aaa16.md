...
これから、`grid` を使ってラッパー `div` 内のアイテムを並べます。

ラッパー `grid` にクラス `grid-rows-[1fr_auto]`、`gap-6`、`div` を追加してください。

# --hints--

ファミリープラン用のラッパー `div` 要素にはクラス `grid` を付けてください。
...
ファミリープラン用のラッパー `div` 要素にはクラス `grid-rows-[1fr_auto]` を付けてください。
...
ファミリープラン用のラッパー `div` 要素にはクラス `gap-6` を付けてください。
