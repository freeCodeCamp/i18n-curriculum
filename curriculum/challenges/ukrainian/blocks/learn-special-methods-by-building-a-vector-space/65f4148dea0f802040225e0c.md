...
Видаліть існуючі виклики `print`. Потім, як ви робили раніше для `v1`, виведіть `v2` та значення, яке повертає `v2.norm()`.

# --hints--

У вашому коді не повинно бути `print(v1)` та `print(v1.norm())`.
...
Ви маєте вивести `v2` та `v2.norm()`.
