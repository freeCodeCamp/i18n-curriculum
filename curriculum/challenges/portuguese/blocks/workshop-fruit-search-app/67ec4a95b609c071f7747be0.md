...
Dentro do elemento `form`, adicione um elemento `label`.Seu elemento `label` deve ter o texto `Search for fruits:` e um atributo `htmlFor` com o valor `"search-input"`.

# --hints--

Você deve ter um elemento `label` dentro do elemento `form`.
...
O elemento `label` deve ter um atributo `htmlFor` com o valor `"search-input"`.
...
Seu elemento `label` deve ter o texto `Search for fruits:`.
