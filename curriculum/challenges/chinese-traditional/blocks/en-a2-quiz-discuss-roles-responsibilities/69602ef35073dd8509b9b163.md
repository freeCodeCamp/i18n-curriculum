...
為了無障礙考量，提供了聽障學習者可用的文字稿；建議僅在需要時使用。
...
聆聽音訊。什麼時候適合這麼說？<!-- (quiz audio) Sophie: Ten years? That's impressive! -->
