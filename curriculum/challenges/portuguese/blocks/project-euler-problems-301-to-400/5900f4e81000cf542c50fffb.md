...
Pode-se verificar que $C(1, 1) = 1$, $C(2, 2) = 4$, $C(3, 4) = 2415$ e $C(9, 12) = 2.5720\mathrm{e}\,46$ (em notação científica arredondada para 5 dígitos significativos).
...
Ao dar sua resposta, use letra minúscula para separar a mantissa e o expoente.Por exemplo, se a resposta for 1234567891011 então o formato da resposta seria a string `1.2346e12`.
