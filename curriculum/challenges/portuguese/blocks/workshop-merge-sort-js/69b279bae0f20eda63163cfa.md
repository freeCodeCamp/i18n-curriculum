...
Copie os valores restantes da esquerda para `array` atribuindo `leftPart[leftArrayIndex]` a `array[sortedIndex]`.

# --hints--

O corpo do loop deve atribuir `leftPart[leftArrayIndex]` a `array[sortedIndex]`.
