...
Dato due insiemi *A* e *B*, calcola $(A \\setminus B) \\cup (B \\setminus A).$ Cioè, elenca gli elementi che sono in *A* o in *B* ma non in entrambi. Questo insieme si chiama differenza simmetrica di *A* e *B*. In altre parole: $(A \\cup B) \\setminus (A \\cap B)$ (l'insieme degli elementi che sono in almeno uno tra *A* o *B* meno l'insieme degli elementi che sono in entrambi *A* e *B*).

Esempio:

Per gli insiemi `A = [1, 2, 3]`, e `B = [1, 3, 4]`, la differenza simmetrica di *A* e *B* è `[2, 4]`.
