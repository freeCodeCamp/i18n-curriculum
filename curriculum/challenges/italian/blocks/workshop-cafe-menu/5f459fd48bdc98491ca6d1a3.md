...
Vai avanti e aggiungi un altro elemento `hr` tra l'elemento `main` e l'elemento `footer`.
...
Il tuo nuovo elemento `hr` dovrebbe essere tra l'elemento `main` e l'elemento `footer`.
