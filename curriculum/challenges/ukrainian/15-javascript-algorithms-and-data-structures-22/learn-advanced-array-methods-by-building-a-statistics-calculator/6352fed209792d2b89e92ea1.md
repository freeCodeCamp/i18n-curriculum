...
Останній крок в обчислення дисперсії — поділити суму квадратів різниць на кількість чисел.

Поділіть виклик `.reduce()` на довжину масиву (в оголошенні `variance`). Потім поверніть `variance`.

# --hints--

Вам потрібно поділити результат виклику `.reduce()` на довжину масиву.
