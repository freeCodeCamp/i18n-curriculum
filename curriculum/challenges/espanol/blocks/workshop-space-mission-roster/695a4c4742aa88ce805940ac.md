...
Para completar la preparación para tu misión espacial, llama a `printCrewSummary()` con tu arreglo `updatedSquad`.

# --hints--

Debes llamar a tu función `printCrewSummary()` con `updatedSquad`.
