...
Por fim, e se houver um erro e os dados do autor falharem ao carregar? Então você precisa mostrar um erro na interface do usuário. É exatamente para isso que o método `.catch()` serve – para o tratamento dos erros.
