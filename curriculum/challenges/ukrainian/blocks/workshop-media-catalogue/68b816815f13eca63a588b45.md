...
Докстрінг — це рядок, розміщений як перша інструкція в класі або функції, який використовується для надання документації цьому класу або функції. Докстрінги зазвичай беруть у потрійні подвійні лапки:
...
Завершіть свій клас `Movie`, додавши до нього наступний докстрінг: `Parent class representing a movie.`

# --hints--

Ви повинні додати докстрінг `Parent class representing a movie.` до свого класу `Movie`.
