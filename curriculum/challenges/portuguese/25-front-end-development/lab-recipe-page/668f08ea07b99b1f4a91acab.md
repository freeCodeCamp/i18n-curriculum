...
1. Você deve ter uma lista ordenada (elemento `ol`) com pelo menos quatro itens de lista que listam as etapas da receita em ordem, abaixo do segundo elemento `h2`.
...
Você deve ter um elemento `html` com o atributo `lang` definido como `en`.
