...
Create a `getTotalPages` function with a single parameter, accepting an array with book objects. La función debe devolver el número total de páginas de los libros del array pasado a la función.
