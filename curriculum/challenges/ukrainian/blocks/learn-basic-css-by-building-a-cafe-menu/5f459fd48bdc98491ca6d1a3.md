...
Додайте ще один `hr` елемент між `main` елементом і `footer` елементом.

# --hints--

Ви маєте додати другий `hr` елемент.

```js
assert.lengthOf(document.querySelectorAll('hr'), 2);
```

Ваш новий `hr` елемент має бути між `main` елементом і `footer` елементом.
