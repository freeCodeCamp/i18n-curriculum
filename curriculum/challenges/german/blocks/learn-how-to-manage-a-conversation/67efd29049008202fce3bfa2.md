...
`I wanted to` is a polite way to express a desire or intention. When starting a request, it shows that you are thinking about what the other person might do or respond to. Zum Beispiel:
