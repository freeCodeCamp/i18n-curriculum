...
Majarida mara nyingi hutumia maandishi yaliyo sawa pande zote katika maudhui yao yaliyochapishwa ili kupanga mpangilio na kudhibiti mtiririko wa maudhui yao. Ingawa hii hufanya kazi katika maandishi yaliyochapishwa, maandishi yaliyo sawa pande zote kwenye tovuti yanaweza kuwa tatizo la ufikikaji, kwa mfano kuleta changamoto kwa watu wenye dyslexia.

Ili kufanya mradi wako uonekane kama jarida lililochapishwa, mpe kichaguzi cha `.text` sifa ya `text-align` iliyowekwa kuwa `justify`.

# --hints--

Kichaguzi chako cha `.text` kinapaswa kuwa na sifa ya `text-align` iliyowekwa kuwa `justify`.
