...
Toa kichaguzi cha `.text-with-images` sifa ya `margin-bottom` iliyowekwa kuwa `3rem`.

# --hints--

Kichaguzi chako cha `.text-with-images` kinapaswa kuwa na sifa ya `margin-bottom` iliyowekwa kuwa `3rem`.
