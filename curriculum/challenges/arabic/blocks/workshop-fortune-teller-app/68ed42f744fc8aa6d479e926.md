...
أضف الآن الخصائص المتبقية إلى كائن `elements` الخاص. وهي: `multipleCard`، `title`، `newReadingBtn`، `fortuneContainer`، `fortuneDescription`، `headerTitle`، `subTitle`، `cardTitle`، `description`، و`text`. تأكد من أن كل خاصية تستخدم نوع `HTMLElement`.

# --hints--

يجب أن تكون الخاصية `multipleCard` داخل خاصية `elements` مُعيَّنة بنوع `HTMLElement`.
...
يجب أن تكون الخاصية `title` داخل خاصية `elements` مُعيَّنة بنوع `HTMLElement`.
...
يجب أن تكون الخاصية `newReadingBtn` داخل خاصية `elements` مُعيَّنة بنوع `HTMLElement`.
...
يجب أن تكون الخاصية `fortuneContainer` داخل خاصية `elements` مُعيَّنة بنوع `HTMLElement`.
...
يجب أن تكون الخاصية `fortuneDescription` داخل خاصية `elements` مُعيَّنة بنوع `HTMLElement`.
...
يجب أن تكون الخاصية `headerTitle` داخل خاصية `elements` مُعيَّنة بنوع `HTMLElement`.
...
يجب أن تكون الخاصية `subTitle` داخل خاصية `elements` مُعيَّنة بنوع `HTMLElement`.
...
يجب أن تكون الخاصية `cardTitle` داخل خاصية `elements` مُعيَّنة بنوع `HTMLElement`.
...
يجب أن تكون الخاصية `description` داخل خاصية `elements` مُعيَّنة بنوع `HTMLElement`.
...
يجب أن تكون الخاصية `text` داخل خاصية `elements` مُعيَّنة بنوع `HTMLElement`.
