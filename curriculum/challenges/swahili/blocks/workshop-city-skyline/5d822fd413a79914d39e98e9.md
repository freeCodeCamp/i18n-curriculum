...
Unapaswa kuboresha msimbo wako. Hamisha sifa na thamani za `position` na `top` kutoka `.foreground-buildings` kwenda `.background-buildings`. Kisha chagua `.background-buildings` na `.foreground-buildings` pamoja hapo, kwa ufanisi ukitumia mitindo hiyo kwa vipengele vyote viwili. Unaweza kutumia koma (`,`) kutenganisha wachaguzi kama hivi: `selector1, selector2`.

# --hints--

Haupaswi kuondoa tamko la `.foreground-buildings`.
...
Unapaswa kuongeza sifa ya `position` ya `absolute` kwa `.background-buildings, .foreground-buildings`.
...
Unapaswa kuongeza sifa ya `top` ya `0` kwa `.background-buildings, .foreground-buildings`.
...
Unapaswa kutumia koma kutumia wachaguzi wa `.foreground-buildings` na `.background-buildings` katika tamko moja la mtindo.
