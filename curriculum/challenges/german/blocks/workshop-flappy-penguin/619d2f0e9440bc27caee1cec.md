...
Interessante Tatsache: Die meisten, wenn nicht alle, Flipper sind von Natur aus keine Rechtecke.

Geben Sie den `.arm`-Elementen für die obere linke, obere rechte und untere rechte Ecke einen Radius von `30%` und für die untere linke Ecke einen Radius von `120%`.

# --hints--

Sie sollten `.arm` einen `border-radius` von `30% 30% 30% 120%` geben.
