...
Fuera de la definición de la función, crea un arreglo `numbers` con los siguientes valores: `[4, 10, 6, 14, 2, 1, 8, 5]`.

# --hints--

Debes crear un arreglo llamado `numbers` con estos valores: `[4, 10, 6, 14, 2, 1, 8, 5]`
