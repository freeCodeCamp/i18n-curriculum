...
Тепер алгоритм автоматичного розміщення запрацює, коли ви додасте новий елемент іконки. Однак ширина нового стовпчика за алгоритмом становить `auto` за замовчуванням, що не відповідатиме поточним стовпчикам.

Це можна змінити за допомогою властивості `grid-auto-columns`. Надайте селектору `.social-icons` властивість `grid-auto-columns` зі значенням `1fr`.

# --hints--

Селектор `.social-icons` повинен мати властивість `grid-auto-columns` зі значенням `1fr`.
