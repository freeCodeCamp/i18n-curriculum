...
غيّر خاصية `margin` لتشمل مساحة `1em` في الأعلى والأسفل، وأترك margins اليمنى واليسرى بقيمة `auto`. ثم حدد width كما وصف بالأعلى.

# --hints--

لا يجب عليك تغيير خاصية `width`. استخدم خاصية `min-width`.
...
يجب عليك استخدام خاصية `margin` الموجودة لتضمينها `1em` في الأعلى والأسفل.
