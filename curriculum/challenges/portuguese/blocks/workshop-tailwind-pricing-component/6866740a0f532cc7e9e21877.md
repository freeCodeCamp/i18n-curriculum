...
Agora vamos para o selo `Most popular`. Você precisa colocá-lo no canto superior direito do cartão, então pode usar algumas das classes utilitárias de posicionamento do Tailwind para fazer isso.
