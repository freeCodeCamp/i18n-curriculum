...
Dovresti dare al selettore `.fb1` un `width` di `10%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.fb1')?.width, '10%');
```

Dovresti dare al selettore `.fb1` un `height` di `60%`.
...
Dovresti dare al selettore `.fb2` un `width` di `10%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.fb2')?.width, '10%');
```

Dovresti dare al selettore `.fb2` un `height` di `40%`.
...
Dovresti dare al selettore `.fb3` un `width` di `10%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.fb3')?.width, '10%');
```

Dovresti dare al selettore `.fb3` un `height` di `35%`.
...
Dovresti dare al selettore `.fb4` un `width` di `8%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.fb4')?.width, '8%');
```

Dovresti dare al selettore `.fb4` un `height` di `45%`.
...
Dovresti dare al selettore `.fb5` un `width` di `10%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.fb5')?.width, '10%');
```

Dovresti dare al selettore `.fb5` un `height` di `33%`.
...
Dovresti dare al selettore `.fb6` un `width` di `9%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.fb6')?.width, '9%');
```

Dovresti dare al selettore `.fb6` un `height` di `38%`.
