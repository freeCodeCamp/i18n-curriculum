...
Щоб змусити елементи `input` та `textarea` зливатися з фоновою темою, встановіть `background-color` на `#0a0a23`. Потім надайте їм кордон `1px`, `solid` кольору `#0a0a23`.

# --hints--

Використайте селектор елементів, розділений комами, щоб вибрати елементи `input` та `textarea`.
...
Надайте елементам `input` та `textarea` властивість `background-color` зі значенням `#0a0a23`.
...
Надайте елементам `input` та `textarea` кордон `1px`, `solid` з кольором `#0a0a23`.
