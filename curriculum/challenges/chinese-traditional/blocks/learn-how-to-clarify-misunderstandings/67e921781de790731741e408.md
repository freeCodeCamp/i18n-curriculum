...
`Clarifying` means explaining something in a way that removes confusion. It helps someone better understand a concept or situation. 例如：
...
`Abstraction` refers to simplifying something by showing only the essential features and hiding the complex internal workings. 例如：
