...
Dovresti assegnare alla proprietà `box-shadow` il valore `0 0 5px 5px #b20403`.
...
Il selettore `.three` dovrebbe avere una proprietà `box-shadow` con il valore `0 0 5px 5px #b20403`.
