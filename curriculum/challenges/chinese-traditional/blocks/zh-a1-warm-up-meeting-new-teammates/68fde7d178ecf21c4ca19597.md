...
<!-- (Audio) Wang Hua: 你好 (nǐ hǎo)，我是王華 (wǒ shì wáng huá)。 -->
...
The phrase `我是 (wǒ shì)` is used to introduce one's name. For example, `我是王華 (wǒ shì wáng huá)` means "I am Wang Hua".
