...
Anteriormente habías agregado una llamada a `console.log()` en tu función `addCrewMember` para validar su comportamiento, y ahora la llamada ya no es necesaria. Para evitar que el terminal se llene de información en los siguientes pasos, elimina la llamada actual a `console.log()`.

# --hints--

Elimina la llamada a `console.log()` de tu función `addCrewMember`. Debes borrar toda la línea.
