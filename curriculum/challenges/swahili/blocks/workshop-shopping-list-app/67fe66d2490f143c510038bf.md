...
Kisha, katika kipengele cha kisanduku cha kuchagua `input`, ongeza sifa ya kipengele `checked` na uiweke kuwa `isChecked`. Ingawa si lazima kabisa kuweka sifa ya kipengele `checked`, ni desturi nzuri kuhakikisha kila kisanduku cha kuchagua kinaonyesha hali ya sasa ya safu ya data `selectedItems`.

# --hints--

Unapaswa kuongeza sifa ya kipengele `checked` katika kipengele cha kisanduku cha kuchagua `input`.
...
Unapaswa kuweka sifa ya kipengele `checked` kuwa `isChecked`.
