...
`get_mood("rock", 111)` inapaswa kurudisha `"happy"`.
...
`get_mood("electronic", 74)` inapaswa kurudisha `"focus"`.
...
`get_mood("classical", 180)` inapaswa kurudisha `"happy"`.
...
`get_mood("rock", 155)` inapaswa kurudisha `"hype"`.
...
`get_mood("electronic", 90)` inapaswa kurudisha `"happy"`.
...
`get_mood("classical", 67)` inapaswa kurudisha `"focus"`.
...
`get_mood("pop", 100)` inapaswa kurudisha `"happy"`.
...
`get_mood("electronic", 135)` inapaswa kurudisha `"hype"`.
