...
Виберіть свої `td` елементи зі значенням `class` `current` і зробіть шрифт курсивним.

# --hints--

Ви повинні мати `td.current` селектор.
...
Ваш `td.current` селектор має мати властивість `font-style`, встановлену в `italic`.
