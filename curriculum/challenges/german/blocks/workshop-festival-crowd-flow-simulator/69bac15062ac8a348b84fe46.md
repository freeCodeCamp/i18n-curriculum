...
Geben Sie zuerst die folgende Nachricht in der Konsole aus: `"\n" + timeBlock + " Simulation"`.

# --hints--

Ihre `simulateFestival`-Funktion sollte zuerst die Nachricht `"\n" + timeBlock + " Simulation"` ausgeben.
...
Ihre `simulateFestival`-Funktion sollte den korrekten Zeitabschnitt in der Nachricht ausgeben.
