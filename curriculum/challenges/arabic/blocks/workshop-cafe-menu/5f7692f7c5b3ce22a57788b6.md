...
لإكمال التنسيق، أضف أسماء الأصناف المناسبة `flavor` و `price` إلى جميع عناصر `p` المتبقية.
...
عناصر `.flavor` يجب أن تكون عناصر `p` التي تحتوي على النصوص `French Vanilla`، `Caramel Macchiato`، `Pumpkin Spice`، `Hazelnut`، و `Mocha`.
...
عناصر `.price` يجب أن تكون عناصر `p` التي تحتوي على النصوص `3.00`، `3.75`، `3.50`، `4.00`، و `4.50`.
