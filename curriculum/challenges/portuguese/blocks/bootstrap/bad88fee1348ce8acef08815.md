...
Coloque os botões `Like`, `Info` e `Delete` lado a lado, aninhando os três dentro de um único elemento `<div class="row">`, e cada um deles dentro de um elemento `<div class="col-xs-4">`.
