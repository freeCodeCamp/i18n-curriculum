...
Оновіть консольну інструкцію, щоб використовувати позначення в дужках для доступу до властивості `"Number of legs"` об’єкта `cat`.

Відкрийте консоль, щоб побачити вихідні дані.

# --hints--

Консольна інструкція тепер повинна мати значення `cat["Number of legs"]`.
