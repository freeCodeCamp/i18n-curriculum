...
Ви маєте знайти значення `budgetCalories - consumedCalories + exerciseCalories`.
...
Ви маєте призначити значення `budgetCalories - consumedCalories + exerciseCalories` змінній `remainingCalories`.
