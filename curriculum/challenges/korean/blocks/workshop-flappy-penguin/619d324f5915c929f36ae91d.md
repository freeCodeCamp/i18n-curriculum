...
`wave`에 `10%`에서 시작하여 `10%`만큼 증가하는 4개의 웨이포인트를 지정하세요.

# --hints--

`10%`에 대해 `@keyframes wave` 웨이포인트를 추가하세요.
...
`20%`에 대해 `@keyframes wave` 웨이포인트를 추가하세요.
...
`30%`에 대해 `@keyframes wave` 웨이포인트를 추가하세요.
...
`40%`에 대해 `@keyframes wave` 웨이포인트를 추가하세요.
