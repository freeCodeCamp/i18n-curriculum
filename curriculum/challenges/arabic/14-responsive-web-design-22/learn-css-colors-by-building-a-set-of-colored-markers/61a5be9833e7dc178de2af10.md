...
في نفس وظيفة `linear-gradient`، أضف لون من وحدة hex مع القيم `11` للأحمر، `6C` للخضراء، و `31` للأزرق كحجة للون الثالث.

# --hints--

قاعدة CSS لـ `.green` يجب أن تحتوي علي خاصية `background` بالقيمة `linear-gradient(180deg, #55680D, #71F53E, #116C31)`.
