...
1. Dentro del elemento `nav`, debe tener una lista desordenada con dos elementos que contengan enlaces a diferentes secciones de la página. El primer elemento debe tener el texto `Próximos Eventos`, y el segundo elemento debe tener el texto `Eventos Pasados`.
...
1. Dentro de la sección `#upcoming-events`, debe tener:
   ...
   - Un elemento `h2` con el texto `Próximos Eventos`.
...
El texto del primer elemento en la lista desordenada debe ser `Próximos Eventos`.
...
El texto del segundo elemento en la lista desordenada debe ser `Eventos Pasados`.
...
Dentro de la sección `#upcoming-events`, debe tener un elemento `h2` con el texto `Próximos Eventos`.
...
Dentro de la sección `#past-events`, debe tener un elemento `h2` con el texto `Eventos Pasados`.
