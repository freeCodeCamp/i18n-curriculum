...
الميزة الأخيرة هي السماح للمستخدمين بمسح سلة التسوق الخاصة بهم. أضف طريقة `clearCart()` إلى صنف `ShoppingCart` الخاص بك.

# --hints--

يجب أن يحتوي صنف `ShoppingCart` الخاص بك على طريقة `clearCart`.
