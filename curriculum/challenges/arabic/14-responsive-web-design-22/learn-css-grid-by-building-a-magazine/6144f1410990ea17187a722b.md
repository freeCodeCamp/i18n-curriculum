...
في هذه الحالة، عنصر parent الخاص بك هو العنصر `main`. عيِّن المحتوى ليكون له تخطيط من ثلاثة أعمدة عن طريق إضافة خاصية `grid-template-columns` بقيمة `1fr 94rem 1fr`. سيؤدي هذا إلى إنشاء ثلاثة أعمدة حيث العمود الأوسط هو `94rem`، والعمودان الأول والأخير كلاهما جزء واحد من المساحة المتبقية في الـ grid container.

# --hints--

يجب أن يحتوي قسم `main` على خاصية `grid-template-columns` تم تعيينها إلى `1fr 94rem 1fr`.
