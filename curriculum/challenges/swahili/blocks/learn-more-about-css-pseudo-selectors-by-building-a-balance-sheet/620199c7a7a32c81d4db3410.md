...
Toa athari ya kupaa kwa vipengele vyako vya `tr.total` ambayo hubadilisha rangi ya nyuma kuwa `#99c9ff`.
...
Kichaguzi chako cha `tr.total:hover` kinapaswa kuwa na sifa ya `background-color` iliyowekwa kuwa `#99c9ff`.
