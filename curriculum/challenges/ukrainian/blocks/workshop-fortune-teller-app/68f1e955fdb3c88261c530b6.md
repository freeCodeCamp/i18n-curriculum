...
Додайте інструкцію `if`, щоб перевірити, чи існує `foundCard`, перш ніж оновлювати елементи його даними або вмістом.

# --hints--

Ви повинні оголосити інструкцію `if` з умовою `foundCard`.
