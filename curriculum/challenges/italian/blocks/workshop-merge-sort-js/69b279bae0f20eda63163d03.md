...
Ora che `numbers` è ordinato, stampa `'Sorted array: '` nella console seguito dall'array `numbers`.

Con questo, l'algoritmo di merge sort è completo.

# --hints--

Dovresti stampare `'Sorted array: '` nella console.
...
Dovresti stampare l'array `numbers` nella console dopo aver stampato `'Sorted array: '`.
