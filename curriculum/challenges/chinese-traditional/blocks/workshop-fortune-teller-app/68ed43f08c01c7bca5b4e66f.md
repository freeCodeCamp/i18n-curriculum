...
現在，對其餘的屬性也做相同的操作。使用 `getElement` 函式來選取每一個：
...
你應該使用 `multipleCardsBtn` 方法並傳入 `getElement` 來存取 `#btn-multiple-cards`。
...
你應該使用 `multipleCard` 方法並傳入 `getElement` 來存取 `.multiple_card`。
...
你應該使用 `title` 方法並傳入 `getElement` 來存取 `.title`。
...
你應該使用 `newReadingBtn` 方法並傳入 `getElement` 來存取 `.btn_reveal`。
...
你應該使用 `fortuneContainer` 方法並傳入 `getElement` 來存取 `.fortune_container`。
...
你應該使用 `fortuneDescription` 方法並傳入 `getElement` 來存取 `.fortune_description`。
...
你應該使用 `headerTitle` 方法並傳入 `getElement` 來存取 `.header_title`。
...
你應該使用 `subTitle` 方法並傳入 `getElement` 來存取 `.sub_title`。
...
你應該使用 `cardTitle` 方法並傳入 `getElement` 來存取 `.desc_title`。
...
你應該使用 `description` 方法並傳入 `getElement` 來存取 `.description`。
...
你應該使用 `text` 方法並傳入 `getElement` 來存取 `.text`。
