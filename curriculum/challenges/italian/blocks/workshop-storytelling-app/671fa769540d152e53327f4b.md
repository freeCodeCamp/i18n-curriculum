...
Seleziona i pulsanti `#scary-btn`, `#funny-btn` e `#adventure-btn` e archiviali in variabili chiamate `scaryStoryBtn`, `funnyStoryBtn` e `adventureStoryBtn`.

# --hints--

Dovresti selezionare il pulsante `#scary-btn` usando il metodo `getElementById` e archiviarlo nella variabile `scaryStoryBtn`.
...
Dovresti selezionare il pulsante `#funny-btn` usando il metodo `getElementById` e archiviarlo nella variabile `funnyStoryBtn`.
...
Dovresti selezionare il pulsante `#adventure-btn` usando il metodo `getElementById` e archiviarlo nella variabile `adventureStoryBtn`.
