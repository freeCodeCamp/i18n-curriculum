...
La segunda condición en este ejemplo verifica si `a.name > b.name`. Si es así, la función devuelve `1`, que ordena la primera fruta después de la segunda fruta.
