...
Como etapa final, adicione uma instrução `console.log()` com a mensagem: `"Workshop complete! You now know how to use includes() and slice()."`

Parabéns! Você completou o workshop String Inspector.

# --hints--

Você deve registrar `"Workshop complete! You now know how to use includes() and slice()."` no console.
