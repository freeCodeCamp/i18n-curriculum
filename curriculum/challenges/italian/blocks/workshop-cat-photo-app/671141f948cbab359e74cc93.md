...
Dovresti aggiungere un elemento `p` intorno a `See more <a href="https://freecatphotoapp.com">cat photos</a> in our gallery.`.
...
Dovresti avere ancora l'elemento di ancoraggio all'interno del nuovo paragrafo.
