...
Machen Sie Ihre `rangeRegex` schließlich global und case-insensitive.

# --hints--

Ihre `rangeRegex` sollte case-insensitive sein.
...
Ihre `rangeRegex` sollte global sein.
...
Ihre `rangeRegex` sollte sowohl global als auch case-insensitive sein.
