...
`Performance` refers to how well something functions, especially in terms of speed and efficiency. 例如：
...
`Faster` is the comparative form of `fast`, meaning something moves or operates at a higher speed than another. 例如：
