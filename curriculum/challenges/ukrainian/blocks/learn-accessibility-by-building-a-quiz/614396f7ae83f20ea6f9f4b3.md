...
Текст `.sr-only` все ще видно. Існує загальний шаблон, щоб візуально приховати текст, залишаючи його доступним лише для читачів екрана.

Цей шаблон полягає у встановленні таких CSS-властивостей:
...
Використайте наведене вище, щоб визначити CSS-правило `.sr-only`.
...
Ви повинні надати `.sr-only` властивість `clip-path` зі значенням `inset(50%)`.
