...
У межах запиту `@media` додайте селектор `.keys` і встановіть множину `width` у `318px`.

# --hints--


Ваше правило `@media` має містити селектор `.keys`.
...
Ваш новий селектор `.keys` має мати множину `width` зі значенням `318px`.
