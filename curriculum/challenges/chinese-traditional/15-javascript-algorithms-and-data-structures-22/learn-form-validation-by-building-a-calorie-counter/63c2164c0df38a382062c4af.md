...
將字符串 `input[type="text"]` 傳遞給 `querySelectorAll()` 方法。 Remember that if you use single quotes for your string, you must also use double quotes within it (or vice-versa).
