...
Declara una variable `breakfastNumberInputs` y dale el valor de llamar `document.querySelectorAll()` con el selector `#breakfast input[type='number']`. This will return any `number` inputs that are in the `#breakfast` element.
