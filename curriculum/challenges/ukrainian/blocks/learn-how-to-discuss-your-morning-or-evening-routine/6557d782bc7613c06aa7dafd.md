...
Слово `never` - це прислівник, який використовується в значенні `not at any time` або `not ever`. Зазвичай його використовують для того, щоб говорити про те, чого хтось не робить або не робив. Наприклад:
