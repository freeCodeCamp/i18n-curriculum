...
Para obtener el elemento con la prioridad más alta (en este caso, el valor más pequeño), debes llamar a `heappop()`:
...
Si ya tienes una lista y quieres transformarla en un heap, puedes llamar a `heapify()`, pasando la lista como argumento:
