...
Sasa unaweza kuondoa mzunguko wa kuchapisha kila safu ya matokeo, na kuubadilisha na `print(graph.create_trajectory())`.

# --hints--

Haupaswi kuwa na mzunguko katika wigo wa jumla.
...
Unapaswa kuwa na `print(graph.create_trajectory())`.
