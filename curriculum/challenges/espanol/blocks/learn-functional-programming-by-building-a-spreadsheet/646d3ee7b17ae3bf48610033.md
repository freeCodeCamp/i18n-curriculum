...
`infixToFunction[operator]` devuelve una función. Llama a esa función directamente, pasando `arg1` y `arg2` como los argumentos.

# --hints--

Tu función de devolución de llamada debería devolver el resultado de llamar a `infixToFunction[operator]`.
...
Deberías pasar `arg1` como el primer argumento a tu llamada a `infixToFunction[operator]`.
...
Deberías pasar `arg2` como el segundo argumento a tu llamada a `infixToFunction[operator]`.
