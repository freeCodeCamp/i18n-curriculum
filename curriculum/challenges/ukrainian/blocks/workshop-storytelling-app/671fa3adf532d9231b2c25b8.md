...
Під елементом `.btn-container` має бути елемент `p` з ідентифікатором `id` `result`. Саме тут буде відображатися історія.

# --hints--

У вас має бути елемент `p` з ідентифікатором `id` `result`.
