...
على الشاشات الصغيرة، تتجاوز القائمة غير المرتبة في شريط التنقل الجانب الأيمن من الشاشة.

صحح هذا باستخدام _Flexbox_ لتغليف محتوى `ul`. ثم عرّف خصائص CSS التالية لمحاذاة النص بشكل صحيح:
