...
Ongeza `repeating-linear-gradient` kwenye `.fb1c` chini ya ile iliyopo; tumia `--building-color4` kutoka `0%` hadi `10%` na `--window-color4` kutoka `10%` hadi `90%`. Hii itajaza nyuma ya mchanganyiko wa rangi uliouongeza mwisho.
...
Unapaswa kuwa na koma (`,`) baada ya `repeating-linear-gradient` ya kwanza.
