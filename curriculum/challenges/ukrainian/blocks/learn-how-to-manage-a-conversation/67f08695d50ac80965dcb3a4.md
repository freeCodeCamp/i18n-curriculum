...
За словами Браяна, яку тему Сара підняла наприкінці?
...
У цьому реченні немає згадки про термін.

---

Проблеми з оновленнями програмного забезпечення.

### --feedback--

Це обговорювалося раніше, а не наприкінці.
...
Проблеми командної комунікації.

### --feedback--

Це не згадується в повідомленні.
...
Використання `Finally` показує, що Браян завершує своє повідомлення. Саме тут він згадує останнє, про що Сара з ним говорила. Знайдіть речення, що починається з `Finally`, прочитайте його і дайте відповідь на це запитання відповідно до того, що ви дізналися.
