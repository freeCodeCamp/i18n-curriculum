...
次に、`Start listening` のCTAを適切なボタンにしてください。

ユーティリティクラス `bg-indigo-100`、`px-4`、`py-2`、`text-center`、`font-semibold`、`text-indigo-700`、`hover:bg-indigo-200` を代入してください。

# --hints--

アンカー要素にはクラス `bg-indigo-100` を付けてください。
...
アンカー要素にはクラス `text-indigo-700` を付けてください。
...
アンカー要素にはクラス `hover:bg-indigo-200` を付けてください。
