...
Було б добре бачити відредаговані зміни у консолі.

Додайте `console.log(currentContent);`.

Щоб перевірити свої зміни, спробуйте відредагувати нотатку, а потім натиснути поза нею. Тепер ви повинні побачити відредаговану нотатку у консолі.

# --hints--

Ви повинні додати `console.log(currentContent);` всередині слухача подій, після призначення `newContent` `currentContent`.
