...
Zum Schluss musst du deine JavaScript-Datei mit deinem HTML verknüpfen. Erstelle ein `script`-Element, um dies zu tun.
...
Dein `script`-Element sollte das `src` auf `./script.js` gesetzt haben.
