...
غالبًا ما تستخدم المجلات النص المحاذي في محتواها المطبوع لتنظيم تخطيطها والتحكم في تدفق المحتوى. بينما ينجح هذا في الشكل المطبوع، قد يشكل النص المحاذي على مواقع الويب مشكلة في إمكانية الوصول، مثلًا يسبب تحديات للأشخاص الذين يعانون من عسر القراءة.

لجعل مشروعك يبدو كمجلة مطبوعة، امنح محدِّد `.text` خاصية `text-align` بقيمة `justify`.

# --hints--

يجب أن يحتوي محدِّد `.text` على خاصية `text-align` بقيمة `justify`.
