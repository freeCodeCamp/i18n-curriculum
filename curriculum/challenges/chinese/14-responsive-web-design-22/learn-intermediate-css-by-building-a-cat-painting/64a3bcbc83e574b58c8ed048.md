...
正如你在前一步中所做的那样，使用后代选择器来选中你的 `.cat-whiskers-right` 元素中的三个 `div` 元素。 请将其 `width` 设为 `40px`、`height` 设为 `1px`、`background-color` 设为 `#000`。
