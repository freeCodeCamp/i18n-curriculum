...
بمجرد حصولك على المحتوى المعدل، سيصبح ذلك هو المحتوى الحالي.

داخل مستمع الحدث، قم بتعيين `newContent` إلى `currentContent`.

# --hints--

يجب تعيين `newContent` إلى `currentContent` داخل مستمع الحدث.
