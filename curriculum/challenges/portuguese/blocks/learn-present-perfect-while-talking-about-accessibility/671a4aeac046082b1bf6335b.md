...
No desenvolvimento de software, `accessibility` refere-se a projetar aplicativos de forma que todos, incluindo pessoas com deficiências, possam usar facilmente. Exemplos incluem adicionar comandos de voz, leitores de tela ou recursos como navegação por teclado para usuários com mobilidade limitada.
