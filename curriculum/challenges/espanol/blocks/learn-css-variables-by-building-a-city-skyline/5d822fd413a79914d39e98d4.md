...
Debe darle a `.bb1a` un `width` de `70%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.bb1a')?.width, '70%');
```

Debe darle a `.bb1a` una `height` de `10%`.
...
Debe darle a `.bb1b` un `width` de `80%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.bb1b')?.width, '80%');
```

Debe darle a `.bb1b` una `height` de `10%`.
...
Debe darle a `.bb1c` un `width` de `90%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.bb1c')?.width, '90%');
```

Debe darle a `.bb1c` una `height` de `10%`.
...
Debe darle a `.bb1d` un `width` de `100%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.bb1d')?.width, '100%');
```

Debe darle a `.bb1d` una `height` de `70%`.
