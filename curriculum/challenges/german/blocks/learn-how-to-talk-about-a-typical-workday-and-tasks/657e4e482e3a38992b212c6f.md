...
A `policy` (im Plural, `policies`) ist ein Prinzip oder eine Regel, um Entscheidungen zu treffen und rationale Ergebnisse zu erzielen. Richtinien werde oft von einer Organisation verabschiedet, um Mitarbeiter zu leiten. For example:
