...
Faça com que o `header` ocupe toda a largura de seu contêiner pai, defina sua `height` como `50px` e defina a `background-color` para `#1b1b32`. Então, defina o `display` para usar *Flexbox*.
