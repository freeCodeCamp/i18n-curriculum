...
Rellena el espacio en blanco con palabras correctas.
...
Este es el tiempo pasado del `to be`, usado aquí para un sujeto singular.
...
Este es el tiempo pasado del `learn`, indicando la adquisición de conocimiento o habilidades en el pasado.
