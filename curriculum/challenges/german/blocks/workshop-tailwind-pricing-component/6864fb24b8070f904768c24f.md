...
Die nächste Preiskarte ist der **Premium-Plan**.

Geben Sie dem Wrapper `div` des Premium-Plans die Klassen `bg-gray-950`, `text-white`, `ring-2`, `ring-fuchsia-500` und `p-8`.

# --hints--

Ihr Wrapper-`div`-Element für den Premium-Plan sollte die Klasse `bg-gray-950` haben.
...
Ihr Wrapper-`div`-Element für den Premium-Plan sollte die Klasse `text-white` haben.
...
Ihr Wrapper-`div`-Element für den Premium-Plan sollte die Klasse `ring-2` haben.
...
Ihr Wrapper-`div`-Element für den Premium-Plan sollte die Klasse `ring-fuchsia-500` haben.
...
Ihr Wrapper-`div`-Element für den Premium-Plan sollte die Klasse `p-8` haben.
