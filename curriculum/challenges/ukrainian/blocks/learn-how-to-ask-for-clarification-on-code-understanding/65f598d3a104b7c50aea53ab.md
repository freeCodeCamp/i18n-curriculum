...
`Large` означає щось велике за розміром або кількістю, як у `large data sets`, які містять багато даних. `Small` — це протилежне, означає менше за розміром або кількістю.
...
У цьому контексті це використовується для опису розміру множин даних — мається на увазі, що вони містять значну кількість даних.
