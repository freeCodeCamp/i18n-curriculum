...
작은 화면에서 내비게이션 바의 순서 없는 목록이 화면 오른쪽을 넘칩니다.

_Flexbox_를 사용해 `ul` 내용을 감싸서 이 문제를 고치세요. 그런 다음, 텍스트를 올바르게 정렬하려면 다음 CSS 속성을 설정하세요.
