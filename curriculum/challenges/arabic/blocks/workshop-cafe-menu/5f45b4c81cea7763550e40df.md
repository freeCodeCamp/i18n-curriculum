...
للحفاظ على نظام الألوان الأسود والبني الحالي، غيّر اللون عند زيارة الرابط إلى `black` واستخدم `brown` عند النقر الفعلي على الرابط.

# --hints--

يجب تعيين خاصية `color` إلى `black` عندما يكون الرابط `visited`.
...
يجب تعيين خاصية `color` إلى `brown` عندما يكون الرابط `active`.
