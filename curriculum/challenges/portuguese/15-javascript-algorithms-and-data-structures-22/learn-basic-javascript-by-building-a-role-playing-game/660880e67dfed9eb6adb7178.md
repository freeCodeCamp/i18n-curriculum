...
Antes de poder começar a criar o array `locations`, você precisará aprender sobre <dfn>objetos</dfn>. Objects are an important data type in JavaScript. The next few steps will be dedicated to learning about them so you will better understand how to apply them in your project.
