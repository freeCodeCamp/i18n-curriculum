...
1. Wenn das `#text-input` Element den Text `A man, a plan, a canal. Panama` and the `#check-btn` element is clicked, the `#result` element should contain the text `A man, a plan, a canal. Panama is a palindrome`.
...
1. Wenn das `#text-input`-Element einen Text `1 eye for of 1 eye.` enthält und das `#check-btn`-Element angeklickt wird, sollte das `#result`-Element den Text `1 eye for od 1 eye. is not a palindrome` enthalten. is not a palindrome</code>.
...
Wenn das `#text-input` Element den Text `A man, a plan, a canal. Panama` and the `#check-btn` element is clicked, the `#result` element should contain the text `A man, a plan, a canal. Panama is a palindrome`.
