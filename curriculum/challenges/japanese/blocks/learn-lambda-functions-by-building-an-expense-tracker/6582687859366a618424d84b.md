...
プログラムを終了する方法を提供するには、別の`elif`節を使って、`choice`が文字列`'5'`と等しいかどうかを確認してください。

新しい`elif`節の中で、プログラムが実行を終了していることを示すために文字列`'Exiting the program.'`を出力してください。

# --hints--

`elif`かどうかを確認する`choice == '5'`節を作成してください。
...
新しい`'Exiting the program.'`節で`elif`を出力してください。
