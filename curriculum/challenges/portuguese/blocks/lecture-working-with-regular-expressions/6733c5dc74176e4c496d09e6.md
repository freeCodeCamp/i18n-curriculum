...
Lembre-se de que `RegExp.prototype.test` apenas confirma se uma string corresponde à expressão regular. Vamos usar nosso lookbehind negativo com `String.prototype.match` para ver como as assertivas afetam isso:
