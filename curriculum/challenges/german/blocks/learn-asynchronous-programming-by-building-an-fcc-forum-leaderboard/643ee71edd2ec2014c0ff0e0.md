...
Fügen Sie im vierten `td`-Element einen eingebetteten Ausdruck hinzu, der die `views`-Variable enthält. Dadurch wird die Anzahl der Aufrufe des Beitrags angezeigt.

# --hints--

Sie sollten einen eingebetteten Ausdruck hinzufügen, der die `views`-Variable enthält.
