...
A continuación, crea una función `loadPlayer` que tenga `PlayerData` como tipo de retorno. Dentro, añade una sintaxis `try...catch` con `error` como parámetro del bloque `catch`. Deja todo lo demás vacío por ahora.

# --hints--

Debes crear una función llamada `loadPlayer`.
...
Tu función `loadPlayer` debe tener un tipo de retorno `PlayerData`.
...
Tu función `loadPlayer` debe contener un bloque `try...catch`.
