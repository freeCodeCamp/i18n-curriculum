...
Dado un mapeo entre los artículos, y los artículos de los que dependen, una clasificación topológica ordena los artículos de modo que ningún elemento precede a un artículo del que dependa. Hay dos algoritmos populares para la clasificación topológica: el tipo topológico de Kahn (1962) y la búsqueda en profundidad.

# --instructions--

Escriba una función que devolverá una lista con orden de compilación válido de librerías a partir de sus dependencias.

- Supongamos que los nombres de las bibliotecas son palabras únicas.
