...
Cuando usas el valor `absolute` para la propiedad `position`, el elemento sale del flujo normal del documento, y luego su posición es determinada por las propiedades `top`, `right`, `bottom`, y `left`.
