...
O método `some` funciona com arrays para verificar se *qualquer* elemento passa em um teste específico. Ele retorna um booleano: `true` se pelo menos um valor atende ao critério e `false` caso contrário.
