...
Proprio come hai fatto con i pulsanti, crea variabili per i seguenti `id` e usa `querySelector()` per assegnare loro l'elemento come valore:

`text`, `xpText`, `healthText`, `goldText`, `monsterStats` e `monsterName`.

Ricorda di dichiararle con la parola chiave `const` e di nominare le variabili in modo che corrispondano ai `id`.
...
La tua variabile `text` dovrebbe avere il valore del tuo elemento `#text`.
...
La tua variabile `xpText` dovrebbe avere il valore del tuo elemento `#xpText`.
...
La tua variabile `healthText` dovrebbe avere il valore del tuo elemento `#healthText`.
...
La tua variabile `goldText` dovrebbe avere il valore del tuo elemento `#goldText`.
...
La tua variabile `monsterStats` dovrebbe avere il valore del tuo elemento `#monsterStats`.
...
La tua variabile `monsterName` dovrebbe avere il valore del tuo elemento `#monsterName`.
