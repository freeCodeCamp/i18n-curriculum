...
Necesitas otra interfaz llamada `Deck`. Esta interfaz debe tener una propiedad `cards`, que es un arreglo de la interfaz anterior.

# --hints--

Debes declarar una interfaz llamada `Deck`.
...
Tu interfaz `Deck` debe tener una propiedad `cards` de tipo `Card[]`.
