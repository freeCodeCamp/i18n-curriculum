...
코드에 `discount = PercentageDiscount(10)` 줄이 없어야 합니다.
...
코드에 `print(discount.apply_discount(product))` 줄이 없어야 합니다.
...
코드에 `fixed_discount = FixedAmountDiscount(5)` 줄이 없어야 합니다.
...
코드에 `print(fixed_discount.apply_discount(product))` 줄이 없어야 합니다.
