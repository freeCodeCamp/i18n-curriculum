...
Nei passaggi successivi, aggiungerai la funzionalità per mostrare gli avatar degli utenti.

All'interno del secondo elemento `td`, aggiungi un elemento `div` con un nome di classe `"avatar-container"`.

# --hints--

Dovresti avere un elemento `div` all'interno del secondo elemento `td`.
...
Il tuo tag di apertura `div` dovrebbe avere un attributo class con il valore `"avatar-container"`.
