...
في هذه المهمة، ستتدرب على تحديد الأقسام بناءً على مهامها.
...
هذا القسم يدعم الموظفين.

# --explanation--

`Recursos humanos` تعني "الموارد البشرية".

يقول سيباستيان `el departamento de recursos humanos apoya a los empleados`، أي "قسم الموارد البشرية يدعم الموظفين".
