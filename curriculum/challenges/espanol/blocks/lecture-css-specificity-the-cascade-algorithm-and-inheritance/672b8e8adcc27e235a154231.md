...
En este ejemplo, todos los elementos `p` tendrán el color de texto establecido en `blue`.
...
Todos los párrafos en la página con la clase `para` tendrán el color de texto establecido en `red` en lugar de `blue` porque los selectores de clase tienen una especificidad mayor que los selectores de tipo.
