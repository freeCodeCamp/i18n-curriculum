...
Wenn Sie sagen, dass Sie etwas `as a hobby` tun, bedeutet das, dass Sie dies regelmäßig zum Vergnügen tun, nicht beruflich oder aus Verpflichtung. Zum Beispiel:

`I build mobile apps as a hobby.` – Das bedeutet, Sie entwickeln Apps zum Spaß, nicht als Ihren Beruf.
...
Dieses Wort zeigt eine Tätigkeit an, die aus Freude ausgeübt wird, nicht als Beruf.
