...
Baada ya tamko la `if`, chapisha mfuatano wa herufi `Valid format.`. Kisha rudisha `True`.

# --hints--

Unapaswa kuchapisha `Valid format.` baada ya tamko lako la `if`.
...
Unapaswa kurudisha `True` baada ya wito wako wa `print()`.
