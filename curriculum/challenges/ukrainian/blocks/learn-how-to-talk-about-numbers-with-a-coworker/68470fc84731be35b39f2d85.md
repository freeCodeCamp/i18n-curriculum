...
Як довго триватиме фаза бета-тестування?
...
Зосередьтеся на реченні, яке починається з `Finally, in the last phase...`.

Jessica зазначає, що остання фаза (бета-тестування та виправлення) триватиме два тижні, щоб мати достатньо часу для вирішення будь-яких критичних проблем.
