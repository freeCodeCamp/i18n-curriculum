...
O elemento `footer` deve ter uma tag de abertura.As tags de abertura possuem a seguinte sintaxe: `<elementName>`.
...
Seu elemento `footer` deve estar abaixo da tag de fechamento do elemento `main`. Você o colocou em outro lugar.
