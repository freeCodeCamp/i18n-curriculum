...
Intervalos são separados por dois-pontos.Após os dois grupos de captura, `rangeRegex` deve procurar pelos dois-pontos.

# --hints--

Você deve adicionar dois-pontos após o segundo grupo de captura.
