...
Baada ya sifa ya kipengele `href`, weka sifa ya kipengele `class` kuwa thabiti iitwayo `linkClass`. 

Baada ya sifa ya kipengele `class`, weka sifa ya kipengele `target` kuwa `"_blank"`. 

Mwishowe, weka thabiti `linkText` kati ya lebo za tagi ya nanga ili kuonyesha maandishi kwenye kiungo.

# --hints--

Unapaswa kuwa na sifa ya kipengele `class` baada ya sifa ya kipengele `href`.
...
Unapaswa kuweka thamani ya sifa ya kipengele `class` kuwa thabiti iitwayo `linkClass`.
...
Unapaswa kuwa na sifa ya kipengele `target` baada ya sifa ya kipengele `class`.
...
Unapaswa kuweka thamani ya sifa ya kipengele `target` kuwa `"_blank"`.
...
Unapaswa kutumia kuweka thabiti `linkText` kati ya lebo za tagi ya nanga.
