...
Als Nächstes folgt der letzte Preisplan, der **Familienplan**.

Beginnen Sie damit, dem Wrapper `div` für den Plan die Klassen `bg-gray-100`, `ring-1`, `ring-gray-300`, `p-8` und `rounded-xl` zu geben.

# --hints--

Ihr Wrapper-`div`-Element für den Familienplan sollte die Klasse `bg-gray-100` haben.
...
Ihr Wrapper-`div`-Element für den Familienplan sollte die Klasse `ring-1` haben.
...
Ihr Wrapper-`div`-Element für den Familienplan sollte die Klasse `ring-gray-300` haben.
...
Ihr Wrapper-`div`-Element für den Familienplan sollte die Klasse `p-8` haben.
...
Ihr Wrapper-`div`-Element für den Familienplan sollte die Klasse `rounded-xl` haben.
