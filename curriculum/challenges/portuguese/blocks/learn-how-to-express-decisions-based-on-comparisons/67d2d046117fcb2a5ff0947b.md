...
This word describes something that grabs attention or makes someone curious. Ele termina com `-ing`.
...
`Interesting` means something captures attention or creates curiosity. Por exemplo:
