...
Crie um elemento `div` abaixo do elemento `header` e dê a ele um atributo `class` definido como `divider large`.
...
O novo elemento `div` deve ter o atributo `class` definido como `divider large`.
