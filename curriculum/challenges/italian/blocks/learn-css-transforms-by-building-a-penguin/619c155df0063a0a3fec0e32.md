...
Dovresti dare a `.face` una proprietà `width` con il valore `--fcc-expected--`, invece di `--fcc-actual--`.
...
Dovresti dare a `.face` una proprietà `height` con il valore `--fcc-expected--`, invece di `--fcc-actual--`.
...
Dovresti dare a `.face` una proprietà `background-color` con il valore `--fcc-expected--` invece di `--fcc-actual--`.
