...
Lascia vuoto il secondo elemento `td` perché aggiungerai contenuto in seguito.

Nel terzo elemento `td`, aggiungi la seguente espressione incorporata: `${posts_count - 1}`.

Questo mostrerà il numero di risposte all'argomento.

# --hints--

Dovresti avere `${posts_count - 1}` all'interno del terzo elemento `td`.
