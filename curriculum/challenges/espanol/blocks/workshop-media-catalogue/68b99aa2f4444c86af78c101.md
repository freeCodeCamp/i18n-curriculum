...
Indenta tu `for` loop` existente un nivel para que se ejecute cuando el catálogo tenga películas. Luego, reemplaza `self.items` con `movies` para iterar solo sobre las películas.
