...
Використайте цикл `for...in` для ітерування по кожних воротах у вхідному об’єкті `summary` і виведіть загальну кількість оброблених відвідувачів.

Для кожних воріт виведіть повідомлення у такому форматі: `gate + ": " + summary[gate] + " attendees processed"`.

Наприклад, для вхідного об’єкта `summary`, визначеного як `{ North: 5, East: 3, South: 4, West: 2 }`, ви повинні вивести:
...
Ви повинні ітерувати по кожному елементу в об’єкті `summary` і виводити наступне повідомлення один раз на кожен елемент: `element + ": " + summary[element] + " attendees processed`.
