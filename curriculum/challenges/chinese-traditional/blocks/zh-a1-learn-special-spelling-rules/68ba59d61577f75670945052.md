...
`語音 (yǔ yīn)` refers to technologies and features related to human speech, such as voice messaging, speech input, and audio-based user interfaces.
