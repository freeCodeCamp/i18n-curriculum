...
يمكنك الآن تنسيق تخطيط الشبكة الخاصة بك. تشبه شبكة CSS Grid خاصية Flexbox في وجود خاصية مخصصة لكل من العنصر الأب والابن.

في هذه الحالة، العنصر الأب هو عنصر `main`. اجعل المحتوى يتبع تخطيطًا بثلاثة أعمدة بإضافة خاصية `grid-template-columns` بقيمة `1fr 94rem 1fr`. هذا سيُنشئ ثلاثة أعمدة حيث يكون العمود الأوسط بعرض `94rem`، والعمودان الأول والأخير كل منهما كسر واحد من المساحة المتبقية في حاوية الشبكة.
