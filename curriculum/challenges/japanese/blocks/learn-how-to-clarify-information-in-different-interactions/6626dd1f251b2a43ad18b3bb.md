...
英語では、他の人を誰かに説明するときに、その人の服装について言及することもよくあります。服装は日によって変わるため、通常は動詞`to be`と`-ing`形の別の動詞、動詞`to wear`を組み合わせて、その時点でその人が身に着けている服を表現します。例：`He's wearing jeans and a T-shirt.`
...
これは、その人がその瞬間に身に着けているものを表す動詞です。`-ing`形を使ってください。
