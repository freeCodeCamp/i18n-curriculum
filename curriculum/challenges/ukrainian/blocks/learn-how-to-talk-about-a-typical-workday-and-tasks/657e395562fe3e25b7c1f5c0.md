...
`Danger` — це ситуація, коли з вами може статися щось погане або ви ризикуєте своїм життям. You can say that in situations like these, you are `in danger`. For example:
