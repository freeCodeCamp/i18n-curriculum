...
`get_mood("rock", 111)` має повернути `"happy"`.
...
`get_mood("electronic", 74)` має повернути `"focus"`.
...
`get_mood("classical", 180)` має повернути `"happy"`.
...
`get_mood("rock", 155)` має повернути `"hype"`.
...
`get_mood("electronic", 90)` має повернути `"happy"`.
...
`get_mood("classical", 67)` має повернути `"focus"`.
...
`get_mood("pop", 100)` має повернути `"happy"`.
...
`get_mood("electronic", 135)` має повернути `"hype"`.
