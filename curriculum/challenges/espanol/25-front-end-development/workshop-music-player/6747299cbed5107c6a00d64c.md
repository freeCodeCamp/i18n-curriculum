...
In the previous lecture, you learned about the <dfn>Web Audio API</dfn> and how to use it to play songs. Todos los navegadores modernos soportan la API de Audio Web, que permite generar y procesar audio en aplicaciones web.
