...
Docstring은 기본적으로 `__doc__`로 설정된 `None` 속성을 통해 접근할 수 있습니다.

`movie1.__doc__`와 `series1.__doc__`를 출력하여 확인하세요. `__doc__` 속성은 어떤 자식 클래스도 상속받지 않는다는 점에 유의하세요.

# --hints--

`movie1.__doc__`를 출력하세요.
