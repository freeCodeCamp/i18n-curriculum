...
Erstellen Sie einen `.text`-Selektor und geben Sie ihm eine `grid-column`-Eigenschaft mit dem Wert `2 / 3`.
...
Ihr `.text`-Selektor sollte eine `grid-column`-Eigenschaft mit dem Wert `2 / 3` haben.
