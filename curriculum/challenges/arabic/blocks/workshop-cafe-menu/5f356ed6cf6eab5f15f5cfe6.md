...
يُستخدم عنصر `div` بشكل رئيسي لأغراض تصميم التخطيط، على عكس عناصر المحتوى الأخرى التي استخدمتها حتى الآن. أضف عنصر `div` داخل عنصر `body` ثم انقل كل العناصر الأخرى داخل الـ `div` الجديد.
...
يجب أن تنقل كل العناصر الأخرى داخل الـ `div` الجديد.
