...
`declare`, `programming`, `languages`, `assignment operator` und `variables`.
...
Anweisungen schreiben, denen ein Computer folgen kann.
...
Namen, die Informationen wie Zahlen oder Text in einem Programm speichern.
...
Spezielle Systeme wie Python oder JavaScript, die zum Schreiben von Code verwendet werden.
...
Eine Variable erstellen und ihr in einem Programm einen Namen geben.
...
Ein Symbol (meistens `=`), das verwendet wird, um einer Variable einen Wert zuzuweisen.
