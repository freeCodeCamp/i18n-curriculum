...
Somit ist, $S = 1234567891011121314151617181920212223242\ldots$

Es ist leicht zu erkennen, dass jede Zahl unendlich oft in $S$ vorkommt.

Nennen wir $f(n)$ die Anfangsposition des $n^{\text{th}}$-Vorkommens von $n$ in $S$. Zum Beispiel, $f(1) = 1$, $f(5) = 81$, $f(12) = 271$ und $f(7780) = 111\\,111\,365$.

Finde $\sum f(3^k) für 1 ≤ k ≤ 13$.
