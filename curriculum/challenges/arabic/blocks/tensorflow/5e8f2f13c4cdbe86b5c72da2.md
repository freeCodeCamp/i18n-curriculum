...
title: "معالجة اللغة الطبيعية باستخدام الشبكات العصبية المتكررة (RNNs): تدريب النموذج"
challengeType: 11
videoId: hEUiK7j9UI8
bilibiliIds:
  aid: 250542136
...
املأ الفراغات أدناه لحفظ نقاط التحقق الخاصة بنموذجك في الدليل `./checkpoints` واستدعاء أحدث نقطة تحقق للتدريب:
