...
在这个项目中，你将构建一个应用程序，通过名称或 ID 查找 RPG 游戏中的生物，并将结果显示给用户。为了获取生物的数据和图像，你将使用 freeCodeCamp 的 <a href="https://rpg-creature-api.freecodecamp.rocks/" target="_blank" rel="noopener noreferrer nofollow">RPG Creature API</a>。
