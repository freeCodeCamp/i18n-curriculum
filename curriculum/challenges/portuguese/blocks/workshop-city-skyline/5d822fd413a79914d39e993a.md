...
No módulo anterior você aprendeu que media queries podem ser usadas para alterar estilos com base em certas condições, e elas se parecem com isto:
...
Você deve adicionar uma media query vazia, com `max-width: 1000px`.
