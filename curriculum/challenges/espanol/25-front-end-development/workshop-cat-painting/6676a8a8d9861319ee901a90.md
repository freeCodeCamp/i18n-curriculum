...
Usando un selector de clase, da al elemento `.cat-left-ear` un borde izquierdo y derecho de `35px solid transparent` cada uno. Además, establece el borde inferior en `70px solid #5e5e5e`.
