...
Para criar um pouco mais de espaço ao redor do menu, adicione `20px` de espaço interno ao elemento `body` usando a propriedade `padding`.
...
O elemento `body` deve ter um `padding` de `20px`.
