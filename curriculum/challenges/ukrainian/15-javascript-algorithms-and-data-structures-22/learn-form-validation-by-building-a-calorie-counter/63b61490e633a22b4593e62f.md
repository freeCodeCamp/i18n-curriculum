...
За тим самим шаблоном призначте елемент `#add-entry` до `addEntryButton`, елемент `#clear` до `clearButton` та елемент `#output` до `output`.
...
Ви повинні призначити елемент `#add-entry` до `addEntryButton`.
...
Ви повинні призначити елемент `#clear` до `clearButton`.
...
Ви повинні призначити елемент `#output` до `output`.
