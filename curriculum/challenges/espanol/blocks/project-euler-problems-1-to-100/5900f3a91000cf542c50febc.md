...
title: 'Problema 61: Números figurados cíclicos'
challengeType: 1
forumTopicId: 302173
...
Los números triangulares, cuadrados, pentagonales, hexagonales, heptagonales y octagonales son todos números figurados (poligonales) y se generan mediante las siguientes fórmulas:

| Tipo de Número | Fórmula                      | Secuencia              |
| -------------- | ---------------------------- | --------------------- |
| Triángulo       | $P_3(n) = \frac{n(n+1)}{2}$  | 1, 3, 6, 10, 15, ...  |
