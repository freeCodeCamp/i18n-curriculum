...
Tu llamada necesita cuatro parámetros. `coincidencia`, `argumento1`, `operador` y `argumento2`.

No estarás usando el parámetro `coincidencia`, así que recuerda poner un prefijo a este.
...
Tu función de llamada debe seguir vacía.
