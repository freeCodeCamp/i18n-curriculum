...
Actualiza tu declaración de consola para usar notación de corchetes para acceder a la propiedad `"Número de patas"` del objeto `cat`.

Abre la consola para ver la salida.

# --hints--

Tu declaración de consola ahora debería tener el valor de `cat["Número de patas"]`.
