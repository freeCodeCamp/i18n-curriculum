...
Setze in der `else`-Anweisung `text.innerText` gleich `"You do not have enough gold to buy health."`.

# --hints--

Deine `buyHealth`-Funktion sollte `text.innerText` gleich `"You do not have enough gold to buy health."` setzen.
