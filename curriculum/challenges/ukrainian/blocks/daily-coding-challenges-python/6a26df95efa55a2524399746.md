...
title: "Завдання 365: Останнє завдання: Заповнення відром 3"
challengeType: 29
...
Сьогодні минає рік щоденних завдань з програмування. Це поки що останнє нове завдання. Успіхів!

Дано двовимірну сітку з рядків, що містять по одній літері кольору, та цільовий колір. Поверніть мінімальну кількість "натискань" для заливки, необхідних, щоб зробити всю сітку цього кольору.

- Кожне натиснення змінює колір клітинки, на яку натиснули, та всі суміжні клітинки того ж кольору (у 4 напрямках).
- Натискання можуть використовувати будь-який колір як проміжний крок, а не лише цільовий колір.

# --hints--

`bucket_fill([["B", "B"], ["B", "B"]], "R")` має повернути `1`.
...
`bucket_fill([["G", "G", "G"], ["G", "G", "G"], ["G", "G", "G"]], "G")` має повернути `0`.
...
`bucket_fill([["P", "P", "Y"], ["Y", "P", "Y"], ["Y", "P", "P"]], "O")` має повернути `2`.
...
`bucket_fill([["G", "Y", "C", "C"], ["Y", "Y", "Y", "B"], ["C", "Y", "B", "B"], ["C", "B", "B", "C"]], "R")` має повернути `4`.
...
`bucket_fill([["G", "G", "O", "O"], ["G", "Y", "B", "Y"], ["B", "Y", "B", "Y"], ["B", "Y", "B", "Y"], ["G", "G", "G", "G"]], "P")` має повернути `5`.
...
`bucket_fill([["R", "G", "R", "G"], ["R", "G", "R", "G"], ["B", "B", "B", "B"], ["B", "B", "B", "B"], ["R", "G", "R", "G"]], "Y")` має повернути `3`.
