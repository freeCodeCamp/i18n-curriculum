...
Outro bom exemplo de registro tardio é o YouTube. O YouTube é uma plataforma de compartilhamento de vídeos com milhões de vídeos sobre tudo, desde tecnologia, cultura pop e jogos. Se alguém visita o YouTube, pode assistir a quantos vídeos quiser sem precisar fazer login ou se registrar. No entanto, se quiser curtir, comentar ou se inscrever em um canal, precisará se registrar.
