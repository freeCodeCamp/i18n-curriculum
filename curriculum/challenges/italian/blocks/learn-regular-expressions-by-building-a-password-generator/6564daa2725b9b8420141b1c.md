...
Ora, trasforma i quattro pattern della lista `constraints` in stringhe raw.

# --hints--

Dovresti trasformare le quattro stringhe all'interno della lista `constraints` in stringhe raw.
