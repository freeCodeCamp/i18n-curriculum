...
Katika darasa la vitu la media query `sky`, badilisha thamani mbili za rangi za `#ffcf33` kuwa `#ccc`, `#ffff66` kuwa `#445`, na `#bbeeff` kuwa `#223`. Kisha unaweza kubadilisha ukubwa wa dirisha lako kuona rangi ya mandharinyuma ikibadilika.

# --hints--

Unapaswa kubadilisha thamani ya kwanza ya rangi kutoka `#ffcf33` hadi `#ccc`.
...
Unapaswa kubadilisha thamani ya pili ya rangi kutoka `#ffff66` hadi `#445`.
...
Unapaswa kubadilisha thamani ya tatu ya rangi kutoka `#bbeeff` hadi `#223`.
