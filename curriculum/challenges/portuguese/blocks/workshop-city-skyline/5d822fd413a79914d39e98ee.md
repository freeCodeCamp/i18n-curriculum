...
Você deve adicionar o comentário `BACKGROUND BUILDINGS - "bb" stands for "background building"` acima do seletor `.bb1`.

```js
assert.match(code, /\/\*\s*BACKGROUND BUILDINGS - "bb" stands for "background building"\s*\*\//gi);
```

Você deve adicionar o comentário `FOREGROUND BUILDINGS - "fb" stands for "foreground building"` acima do seletor `.fb1`.
