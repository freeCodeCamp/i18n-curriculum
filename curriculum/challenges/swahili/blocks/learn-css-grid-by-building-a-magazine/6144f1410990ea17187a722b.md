...
Sasa unaweza kupamba mpangilio wa gridi yako. CSS Grid ni sawa na Flexbox kwa kuwa ina sifa maalum kwa vipengele vya mzazi na vile vya mtoto.

Katika kesi hii, kipengele chako cha mzazi ni kipengele cha `main`. Weka maudhui ya kuwa na mpangilio wa safu tatu kwa kuongeza sifa ya `grid-template-columns` yenye thamani ya `1fr 94rem 1fr`. Hii itaunda safu tatu ambapo safu ya katikati ni pana `94rem`, na safu ya kwanza na ya mwisho zote ni sehemu 1 ya nafasi iliyobaki katika chombo cha gridi.
