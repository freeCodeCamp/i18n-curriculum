...
你的第五個 `className` 為 `form-group` 的 `div` 元素應該有一個 `label`，其具有 `htmlFor` 屬性為 `def`、`className` 為 `label`，以及文字 `DEF`。
...
你的第五個 `className` 為 `form-group` 的 `div` 元素應該有一個 `input`，其具有 `className` 為 `input`、`id` 為 `def`，以及 `type` 為 `number`。
...
你的第六個 `className` 為 `form-group` 的 `div` 元素應該有一個 `label`，其具有 `htmlFor` 屬性為 `phy`、`className` 為 `label`，以及文字 `PHY`。
...
你的第六個 `className` 為 `form-group` 的 `div` 元素應該有一個 `input`，其具有 `className` 為 `input`、`id` 為 `phy`，以及 `type` 為 `number`。
