...
As próximas três expansões são $\frac {99}{70}$, $\frac {239}{169}$ e $\frac {577}{408}$, mas a oitava expansão, $\frac {1393}{985}$, é o primeiro exemplo onde o número de dígitos no numerador excede o número de dígitos no denominador.
