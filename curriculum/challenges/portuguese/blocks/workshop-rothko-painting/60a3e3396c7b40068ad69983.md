...
Defina a `background-color` do elemento `.two` como `#8f0401`.

# --hints--

Você deve definir o valor da propriedade `background-color` como `#8f0401`.
...
O elemento `.two` deve ter uma `background-color` com o valor de `#8f0401`.
