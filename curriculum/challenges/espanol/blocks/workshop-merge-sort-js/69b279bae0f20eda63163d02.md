...
Después de mostrar el array sin ordenar, llama a la función `mergeSort` y pásale el array `numbers` como argumento.

# --hints--

Debes llamar a `mergeSort(numbers)` después de mostrar el array sin ordenar.
