...
Зрештою, навігаційна доступність може бути покращена завдяки забезпеченню швидких команд.

Атрибут `accesskey` приймає розділений пробілами список ключів доступу. Наприклад:

```html
<button type="submit" accesskey="s">Submit</button>
```

Надайте кожному з навігаційних посилань однолітерний ключ доступу.

_Примітка: не завжди рекомендовано використовувати ключі доступу, але вони можуть бути корисними_

Хороша робота. Ви завершили практичний проєкт _ вікторина «Доступність»_.
