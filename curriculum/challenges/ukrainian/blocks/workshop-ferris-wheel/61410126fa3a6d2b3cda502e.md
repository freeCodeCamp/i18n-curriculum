...
Щоб анімація вашої кабіни виглядала більш природним коливальним рухом, ви можете використати функцію часу `ease-in-out`. Ця настройка змусить анімацію починатися і закінчуватися повільніше, але рухатися швидше в середині циклу.

Замініть `linear` на `ease-in-out` у селекторі `.cabin`.

# --hints--

Ваш селектор `.cabin` має мати властивість `animation`, встановлену в `cabins 10s ease-in-out infinite`.
