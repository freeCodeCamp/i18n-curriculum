...
Para hacer que los elementos `input` y `textarea` se integren con el tema de fondo, establecer su `background-color` a `#0a0a23`. Luego, darles un borde de `1px`, `solid` con un color de `#0a0a23`.

# --hints--

Debes usar un selector de elementos separado por comas para seleccionar los elementos `input` y `textarea`.
...
Debes dar a los elementos `input` y `textarea` un `background-color` de `#0a0a23`.
...
Debes dar a los elementos `input` y `textarea` un borde de `1px`, `solid` con un color de `#0a0a23`.
