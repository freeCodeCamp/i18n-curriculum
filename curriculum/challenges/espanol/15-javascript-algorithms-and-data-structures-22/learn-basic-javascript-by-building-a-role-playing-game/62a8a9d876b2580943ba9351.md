...
Tu arreglo (`array`) contendrá diferentes ubicaciones como, **store**, **cave** y **town square** (tienda, cueva y plaza). Cada ubicación será representada como un objeto.

Dentro tu arreglo de ubicaciones, añade un objeto. Inside that object add a key called `name` with a value of `"town square"`.
