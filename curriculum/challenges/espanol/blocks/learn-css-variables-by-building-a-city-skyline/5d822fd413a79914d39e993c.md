...
En la clase `sky` de la consulta de medios, cambie los dos valores de color `#ffcf33` a `#ccc`, el `#ffff66</code > a <code>#445`, y `#bbeeff` a `#223`. Luego puede cambiar el tamaño de su ventana para ver los colores de cambio de fondo.

# --hints--

Debes cambiar los primeros valores de color de `#ffcf33` a `#ccc`.
...
Debes cambiar el segundo valor de color de `#ffff66` a `#445`.
...
Debes cambiar el tercer valor de color de `#bbeeff` a `#223`.
