...
Це слово використовується для створення заперечної інструкції.
...
- Person 2: `Not yet. I'm still reading the instructions.` - Ця людина готується встановити нове програмне забезпечення.
