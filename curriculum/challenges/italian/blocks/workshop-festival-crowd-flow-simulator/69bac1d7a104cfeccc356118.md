...
Per completare la tua funzione `simulateFestival`, mostra un riepilogo dei risultati della simulazione. Chiama `printSummary()` con il tuo oggetto locale `throughputSummary`.

# --hints--

Dovresti chiamare `printSummary()` con `throughputSummary`.
