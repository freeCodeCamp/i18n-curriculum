...
Ifuatayo ni kipengele cha mwisho cha bei, **Mpango wa Familia**.

Kuanza, mpe kifungashio `div` kwa mpango huo madarasa ya `bg-gray-100`, `ring-1`, `ring-gray-300`, `p-8`, na `rounded-xl`.

# --hints--

Kifungashio chako `div` kwa mpango wa familia kinapaswa kuwa na darasa la `bg-gray-100`.
...
Kifungashio chako `div` kwa mpango wa familia kinapaswa kuwa na darasa la `ring-1`.
...
Kifungashio chako `div` kwa mpango wa familia kinapaswa kuwa na darasa la `ring-gray-300`.
...
Kifungashio chako `div` kwa mpango wa familia kinapaswa kuwa na darasa la `p-8`.
...
Kifungashio chako `div` kwa mpango wa familia kinapaswa kuwa na darasa la `rounded-xl`.
