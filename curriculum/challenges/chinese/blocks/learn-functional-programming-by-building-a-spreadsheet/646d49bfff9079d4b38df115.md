...
添加一个 `has2` 属性，用于返回 `nums` 数组的值中是否有 `2`，以及一个 `increment` 属性，用于返回 `nums` 的值每次增加一。

# --hints--

你的 `spreadsheetFunctions` 对象应该具有 `has2` 属性。
