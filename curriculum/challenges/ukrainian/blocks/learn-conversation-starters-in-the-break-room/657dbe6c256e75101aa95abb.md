...
Коли ви хочете підтвердити інформацію (сказати, що щось є правдою), ви можете використати дієслово `do`. Воно робить вашу відповідь сильнішою. Наприклад:

- Питання: `Do you like pizza?`

- Відповідь: `Yes, I do.` — ця відповідь сильніша, ніж просто `Yes.`

Ви використовуєте `do`, щоб показати, що ви впевнені.
...
Софі підтверджує питання Тома позитивно, тому вона повторює допоміжне дієслово, яке використане в питанні Тома.
