...
La tipografía es el arte y la técnica de organizar el tipo para comunicar efectivamente. Involucra dar formato al texto y seleccionar fuentes apropiadas. En esta lección, aprenderás las mejores prácticas para usar la tipografía de manera que mejore la legibilidad, la jerarquía y la accesibilidad.
...
<img src="https://cdn.freecodecamp.org/curriculum/lecture-transcripts/what-are-some-best-practices-for-working-with-typography-in-your-designs-1.png" alt="Tres niveles de jerarquía de texto: 'Heading' en serif grande, negrita, 'Subheading' en serif mediano, negrita, y 'Text' en peso regular pequeño" />

Puedes usar el tamaño de fuente para crear una jerarquía visual en los encabezados, subtítulos, párrafos y otros elementos.

<img src="https://cdn.freecodecamp.org/curriculum/lecture-transcripts/what-are-some-best-practices-for-working-with-typography-in-your-designs-2.png" alt="Página de inicio de freeCodeCamp mostrando 'Learn to code — for free.', 'Build projects.', y 'Earn certifications.' en texto progresivamente más pequeño, con un botón 'Get started (it's free)' abajo" />
...
<img src="https://cdn.freecodecamp.org/curriculum/lecture-transcripts/what-are-some-best-practices-for-working-with-typography-in-your-designs-3.png" alt="Sección de tipografía de la guía de estilo de freeCodeCamp sobre fondo oscuro, listando Hack-ZeroSlash como la fuente monospace principal, Lato como la fuente proporcional principal, y SaxMono como la fuente del logo" />

Una vez que elijas estas dos o tres fuentes, úsalas consistentemente a través de diferentes páginas y elementos. Estas fuentes deben ser consistentes con el diseño general de tu aplicación web, producto o servicio.

<img src="https://cdn.freecodecamp.org/curriculum/lecture-transcripts/what-are-some-best-practices-for-working-with-typography-in-your-designs-4.png" alt="Dos versiones del mismo texto lado a lado: la versión superior tiene una marca de verificación verde y buen espacio en blanco entre líneas, mientras que la inferior tiene una X roja y texto apretado y mal espaciado" />

También debes utilizar espacio en blanco para crear un balance visual y mejorar la legibilidad.

<img src="https://cdn.freecodecamp.org/curriculum/lecture-transcripts/what-are-some-best-practices-for-working-with-typography-in-your-designs-5.png" alt="Página de documentación de comprensión de WCAG 2.1 mostrando Understanding SC 1.4.3: Contrast (Minimum) (Level AA), con explicaciones de los requisitos de relación de contraste para texto grande y pequeño" />
...
También debes proporcionar opciones para ajustar el tamaño de la fuente y evitar fuentes complejas tanto como sea posible. Como regla general, debes usar fuentes simples siempre que sea posible. Si tu contenido es fácil de leer, los usuarios tienen más probabilidades de interactuar con él.

<img src="https://cdn.freecodecamp.org/curriculum/lecture-transcripts/what-are-some-best-practices-for-working-with-typography-in-your-designs-6.png" alt="Herramientas de desarrollo del navegador abiertas junto a la página de inicio de freeCodeCamp en modo responsivo, mostrando estilos CSS aplicados a los elementos de encabezado de la página" />

Un consejo final para trabajar con tipografía es asegurarte de que tus fuentes se muestren correctamente en diferentes tamaños de pantalla y dispositivos.
