...
1. Коли елемент `#text-input` містить лише літеру `A`, а елемент `#check-btn` натискається, елемент `#result` повинен містити текст `A is a palindrome`.
1. Коли елемент `#text-input` містить текст `eye`, а елемент `#check-btn` натискається, елемент `#result` повинен містити текст `eye is a palindrome`.
1. Коли елемент `#text-input` містить текст `_eye`, а елемент `#check-btn` натискається, елемент `#result` повинен містити текст `_eye is a palindrome`.
1. Коли елемент `#text-input` містить текст `race car`, а елемент `#check-btn` натискається, елемент `#result` повинен містити текст `race car is a palindrome`.
1. Коли елемент `#text-input` містить текст `not a palindrome`, а елемент `#check-btn` натискається, елемент `#result` повинен містити текст `not a palindrome is not a palindrome`.
...
1. Коли елемент `#text-input` містить текст `never odd or even`, а елемент `#check-btn` натискається, елемент `#result` повинен містити текст `never odd or even is a palindrome`.
1. Коли елемент `#text-input` містить текст `nope`, а елемент `#check-btn` натискається, елемент `#result` повинен містити текст `nope is not a palindrome`.
1. Коли елемент `#text-input` містить текст `almostomla`, а елемент `#check-btn` натискається, елемент `#result` повинен містити текст `almostomla is not a palindrome`.
1. Коли елемент `#text-input` містить текст `My age is 0, 0 si ega ym.`, а елемент `#check-btn` натискається, елемент `#result` повинен містити текст `My age is 0, 0 si ega ym. is a palindrome`.
...
1. Коли елемент `#text-input` містить текст `0_0 (: /-\ :) 0-0`, а елемент `#check-btn` натискається, елемент `#result` повинен містити текст `0_0 (: /-\ :) 0-0 is a palindrome`.
1. Коли елемент `#text-input` містить текст `five|\_/|four`, а елемент `#check-btn` натискається, елемент `#result` повинен містити текст `five|\_/|four is not a palindrome`.

Виконайте історії користувачів та пройдіть всі тести нижче, щоб завершити цей проєкт. Додайте власний стиль. Щасливого програмування!
...
У вас має бути елемент `div`, `span` або `p` з атрибутом `id` зі значенням `"result"`.
...
Коли елемент `#text-input` містить лише літеру `A` і натискається елемент `#check-btn`, елемент `#result` має містити текст `A is a palindrome`.
...
Коли елемент `#text-input` містить текст `eye` і натискається елемент `#check-btn`, елемент `#result` має містити текст `eye is a palindrome`.
...
Коли елемент `#text-input` містить текст `_eye` і натискається елемент `#check-btn`, елемент `#result` має містити текст `_eye is a palindrome`.
...
Коли елемент `#text-input` містить текст `race car` і натискається елемент `#check-btn`, елемент `#result` має містити текст `race car is a palindrome`.
...
Коли елемент `#text-input` містить текст `not a palindrome` і натискається елемент `#check-btn`, елемент `#result` має містити текст `not a palindrome is not a palindrome`.
...
Коли елемент `#text-input` містить текст `never odd or even` і натискається елемент `#check-btn`, елемент `#result` має містити текст `never odd or even is a palindrome`.
...
Коли елемент `#text-input` містить текст `nope` і натискається елемент `#check-btn`, елемент `#result` має містити текст `nope is not a palindrome`.
...
Коли елемент `#text-input` містить текст `almostomla` і натискається елемент `#check-btn`, елемент `#result` має містити текст `almostomla is not a palindrome`.
...
Коли елемент `#text-input` містить текст `My age is 0, 0 si ega ym.` і натискається елемент `#check-btn`, елемент `#result` має містити текст `My age is 0, 0 si ega ym. is a palindrome`.
...
Коли елемент `#text-input` містить текст `0_0 (: /-\ :) 0-0` і натискається елемент `#check-btn`, елемент `#result` має містити текст `0_0 (: /-\ :) 0-0 is a palindrome`.
...
Коли елемент `#text-input` містить текст `five|_/|four` і натискається елемент `#check-btn`, елемент `#result` має містити текст `five|_/|four is not a palindrome`.
