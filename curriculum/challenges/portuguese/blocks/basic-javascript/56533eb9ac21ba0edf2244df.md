...
Escreva uma instrução switch para definir `answer` para os seguintes intervalos: `1-3` - `Baixo``4-6` - `Médio``7-9` - `Alto`

**Nota:** Você precisará ter uma declaração `case` para cada número no intervalo.
