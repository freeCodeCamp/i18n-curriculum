...
`age` haipaswi kuwa nambari kamili tu, inapaswa kuwa nambari kamili chanya inayolingana au kubwa kuliko `18`.

Kutumia kigeuzi cha `and`, ongeza usemi wa kihesabu wa pili kwenye thamani ya funguo ya `age` ili kukagua hilo.

# --hints--

Funguo ya `age` katika kamusi yako ya `constraints` inapaswa kuwa na thamani ya `isinstance(age, int) and age >= 18`.
