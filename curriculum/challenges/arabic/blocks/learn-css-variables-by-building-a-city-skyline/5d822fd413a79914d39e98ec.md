...
اضغط المباني معًا مرة أخرى بإضافة عنصرين فارغين من نوع `div` داخل كل من أعلى وأسفل عنصر `.foreground-buildings`، وعنصر واحد إضافي بين `.fb2` و `.fb3`.

# --hints--

يجب إضافة عنصرين من نوع `div` كأول أبناء لعنصر `.foreground-buildings`.
...
يجب إضافة عنصر واحد من نوع `div` بين `.fb2` و `.fb3`.
...
يجب إضافة عنصرين من نوع `div` كآخر أبناء لعنصر `.foreground-buildings`.
...
يجب أن تكون قد أضفت 5 عناصر جديدة من نوع `div`.
