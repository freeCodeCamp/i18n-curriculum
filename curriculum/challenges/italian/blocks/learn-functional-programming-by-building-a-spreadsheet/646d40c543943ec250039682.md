...
Ora che hai un'espressione regolare per riconoscere moltiplicazione o divisione, puoi valutare quell'espressione.

Dichiara una variabile `str2` e assegnale il risultato della chiamata a `infixEval` con `str` e `regex` come argomenti.
...
Dovresti passare `regex` come secondo argomento alla tua chiamata `infixEval`.
