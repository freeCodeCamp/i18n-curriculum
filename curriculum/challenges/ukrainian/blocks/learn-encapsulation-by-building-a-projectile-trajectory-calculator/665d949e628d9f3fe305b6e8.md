...
Вихідні дані стають досить складними для читання, тому слід замінити `print(graph.create_trajectory())` на цикл, який виводить кожен рядок окремо.

# --hints--

Видаліть виклик `print(graph.create_trajectory())`.
...
У вас має бути цикл, який ітерує `graph.create_trajectory()`.
...
Виводьте кожен рядок у `graph.create_trajectory()`.
