...
Katika warsha hii, utaendelea kufanya mazoezi ya kutumia TypeScript kwa kujenga programu ya kutabiri hatima.

Anza kwa kutangaza interface iitwayo `Card`. Ndani ya interface ya `Card`, ongeza sifa zifuatazo: `name`, `name_short` na `value`. Sifa za `name` na `name_short` zinapaswa kuwa na aina zilizowekwa kuwa `string` na `value` inapaswa kuwa na aina ya muungano iliyowekwa kuwa `string | number`.

# --hints--

Unapaswa kutangaza interface iitwayo `Card`.
...
Interface yako ya `Card` inapaswa kuwa na sifa ya `name` yenye aina ya `string`.
...
Interface yako ya `Card` inapaswa kuwa na sifa ya `name_short` yenye aina ya `string`.
...
Interface yako ya `Card` inapaswa kuwa na sifa ya `value` yenye aina ya muungano wa `string` na `number`.
