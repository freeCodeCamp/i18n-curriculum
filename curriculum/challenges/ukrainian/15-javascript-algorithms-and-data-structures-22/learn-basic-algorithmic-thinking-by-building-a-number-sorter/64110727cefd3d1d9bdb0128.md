...
Наостанку після того коли зовнішній цикл завершиться, потрібно повернути масив. Коли ви це зробите ви зможете побачити зміну `Output`, коли знову натиснете кнопку `Sort`.

# --hints--

Ви повинні `return` `array` після завершення зовнішнього циклу.
