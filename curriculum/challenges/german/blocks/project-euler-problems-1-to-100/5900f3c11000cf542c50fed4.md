...
title: 'Aufgabe 85: Rechtecke zählen'
challengeType: 1
forumTopicId: 302199
...
Durch genaues Zählen ist zu erkennen, dass ein rechteckiges Raster mit den Maßen 3 mal 2 achtzehn Rechtecke enthält:
...
Obwohl es möglicherweise kein rechteckiges Raster gibt, das genau `n` Rechtecke enthält, finden Sie die Fläche des Rasters mit der nächstliegenden Lösung.
