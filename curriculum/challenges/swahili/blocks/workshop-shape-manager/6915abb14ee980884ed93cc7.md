...
Ndani ya mzunguko, weka tukio la `oninput` la kila kipengele cha `input` kuwa kitendakazi cha `handleInput`.

Kwa hiyo, warsha ya msimamizi wa maumbo imekamilika!

# --hints--

Unapaswa kuweka `input.oninput` kuwa kitendakazi cha `handleInput`.
