...
علامة الصح في كل `span` في بداية عنصر القائمة هي للزينة. أضف `aria-hidden` إلى هذه العناصر `span` لإخفائها عن قارئ الشاشة.

أيضًا، عيّن الصنفين `text-green-700` و `mr-2` لكل عنصر من عناصر `span`.

# --hints--

يجب أن تحتوي عناصر `span` الاثنين على الخاصية `aria-hidden`.
...
يجب أن تحتوي عناصر `span` الاثنين على الصنف `text-green-700`.
...
يجب أن تحتوي عناصر `span` الاثنين على الصنف `mr-2`.
