...
Para gerenciar as informações da música atual e acompanhar seu tempo de reprodução, crie as propriedades `currentSong` e `songCurrentTime`.Defina os valores para `null` e `0` respectivamente.

# --hints--

Você não deve modificar o objeto `userData` existente e seu conteúdo.
