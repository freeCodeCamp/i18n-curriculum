...
4. Deberías crear una función `removeLastLunch` que reciba un array como argumento. La función debería:
   ...
   - Si el array está vacío, registra la cadena `"No lunches to remove."` en la consola.
   - Devuelve el array actualizado.
...
6. Deberías crear una función `getRandomLunch` que reciba un array como argumento. La función debería:
   ...
   - Si el array está vacío, registra la cadena `"No lunches available."` en la consola.
...
7. Deberías crear una función `showLunchMenu` que reciba un array como argumento y:
   ...
   - Si el array está vacío, registra la cadena `"The menu is empty."` en la consola.
...
`addLunchToEnd(lunches, "Tacos")` debería registrar la cadena `"Tacos added to the end of the lunch menu."` en la consola.
...
`addLunchToStart(lunches, "Sushi")` debería registrar la cadena `"Sushi added to the start of the lunch menu."` en la consola.
...
Cuando el array de entrada está vacío, la función `removeLastLunch` debería registrar la cadena `"No lunches to remove."` en la consola.
...
`removeLastLunch(["Stew", "Soup", "Toast"])` debería registrar la cadena `"Toast removed from the end of the lunch menu."` en la consola.
...
Cuando el array de entrada está vacío, la función `removeFirstLunch` debería registrar la cadena `"No lunches to remove."` en la consola.
...
`removeFirstLunch(["Salad", "Eggs", "Cheese"])` debería registrar la cadena `"Salad removed from the start of the lunch menu."` en la consola.
...
Cuando el array de entrada está vacío, la función `getRandomLunch` debería registrar la cadena `"No lunches available."` en la consola.
...
Cuando el array de entrada está vacío, la función `showLunchMenu` debería registrar la cadena `"The menu is empty."` en la consola.
...
`showLunchMenu(["Greens", "Corns", "Beans"])` debería registrar `"Menu items: Greens, Corns, Beans"` en la consola.
...
`showLunchMenu(["Pizza", "Burger", "Fries", "Salad"])` debería registrar `"Menu items: Pizza, Burger, Fries, Salad"` en la consola.
