...
زوّد خيارات القائمة الأخرى بطباعة السلاسل النصية الثلاث التالية في حلقة `while` الخاصة بك: `'3. Show total expenses'`، `'4. Filter expenses by category'`، و `'5. Exit'`. استمر في إضافة استدعاءات `print()` بالترتيب.

# --hints--

يجب أن تحتوي حلقة `while` على `print('3. Show total expenses')`.
...
يجب أن تحتوي حلقة `while` على `print('4. Filter expenses by category')`.
...
يجب أن تحتوي حلقة `while` على `print('5. Exit')`.
