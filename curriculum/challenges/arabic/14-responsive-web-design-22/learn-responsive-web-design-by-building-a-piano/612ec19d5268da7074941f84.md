...
على سبيل المثال، تستهدف media query عرض ما بين 500px و 1000px سيكون كما يلي:
...
أضف قاعدة أخرى `@media` لتطبيق إذا كانت نافذة المتصفح أعرض من `769px` ولكن أصغر من `1199px`.
...
يجب أن يحتوي query تسمى `@media` على `min-width` من `769px` و `max-width` من `1199px`.
