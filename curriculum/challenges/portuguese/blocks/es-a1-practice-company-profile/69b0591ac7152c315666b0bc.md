...
É verdadeiro ou falso: Quando Sebastián pergunta `¿Cuál es su sitio web?`, ele está pedindo o site da empresa.
...
Sebastián está perguntando sobre o `sitio web` da empresa, que significa "site".
...
`Su` se refere à empresa ("seu"), e `es` está na terceira pessoa do singular porque o sujeito é `su sitio web`.
