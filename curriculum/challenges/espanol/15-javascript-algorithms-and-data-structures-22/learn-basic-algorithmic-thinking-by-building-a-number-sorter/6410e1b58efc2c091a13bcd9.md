...
Para fines de depuración, añade una llamada `console.log()` en tu bucle interior. Pasa los argumentos `array`, `array[j]`y `array[j+1]`.

# --hints--

Debes usar una llamada `console.log()` en tu bucle interior.
...
Debe pasar `array[j+1]` como tercer argumento a `console.log()`.
