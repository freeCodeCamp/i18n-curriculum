...
Тепер настав час попрацювати над функцією обчислення координат траєкторії! Створіть метод класу `Projectile` під назвою `__calculate_y_coordinate`, він повинен мати параметр `x`, окрім `self`.
