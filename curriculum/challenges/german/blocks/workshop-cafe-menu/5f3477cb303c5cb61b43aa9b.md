...
Der Text ist wieder zentriert und der Link zur CSS-Datei funktioniert. Füge der Datei einen weiteren Stil hinzu, der die `background-color`-Eigenschaft für das `body`-Element auf `brown` setzt.
