...
Fügen Sie als Nächstes die `year` und `players` zu Ihrer Destrukturierungszuweisung hinzu.

# --hints--

Sie sollten die Werte `year` und `players` zu Ihrer Destrukturierungszuweisung hinzufügen.
