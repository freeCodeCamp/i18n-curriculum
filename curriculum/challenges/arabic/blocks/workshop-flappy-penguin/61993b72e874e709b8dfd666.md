...
استهدف العنصر `.penguin-head`، وأعطه `width` نصف عرض العنصر الأصل، و`height` بنسبة `45%`. ثم عيّن `background` إلى تدرج لوني خطي بزاوية `45deg` يبدأ من `gray` وينتهي عند `rgb(239, 240, 228)`.
