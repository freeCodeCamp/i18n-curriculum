...
A função deve retornar o \( n^{th} \) valor do gerador filtrado.

Por exemplo, para \(n=7\), a função deve retornar 81, pois a sequência seria 4, 9, 16, 25, 36, 49 e 81.Aqui, 64 é removido da sequência por ser um cubo.
