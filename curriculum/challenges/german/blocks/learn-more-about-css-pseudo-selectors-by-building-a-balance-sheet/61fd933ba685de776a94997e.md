...
Innerhalb des ersten `tr` fügen Sie ein `th`-Element mit dem Text `Loans The outstanding balance on our startup loan.` hinzu. Wickeln Sie diesen Text, außer `Loans `, in ein `span`-Element mit dem `class`, das auf `description` gesetzt ist.
