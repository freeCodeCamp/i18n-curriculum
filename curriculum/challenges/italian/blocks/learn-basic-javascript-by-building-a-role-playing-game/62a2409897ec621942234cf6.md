...
Dai all'elemento `#text` un `background-color` di `#0a0a23`, un `color` di `#ffffff` e `10px` di spaziatura interna su tutti i lati.
...
Il tuo elemento `#text` dovrebbe avere un `background-color` di `#0a0a23`.
...
Il tuo elemento `#text` dovrebbe avere un `color` di `#ffffff`.
...
Il tuo elemento `#text` dovrebbe avere `10px` di spaziatura interna su tutti i lati.
