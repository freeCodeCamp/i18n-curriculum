...
title: 'Problema 43: divisibilità di sotto-stringhe'
challengeType: 1
forumTopicId: 302100
...
Il numero 1406357289 è un numero pandigitale da 0 a 9 perché è composto da ciascuna delle cifre da 0 a 9 in un certo ordine, ma ha anche una proprietà di divisibilità di sotto-stringhe piuttosto interessante.

Sia $d_1$ la prima cifra, $d_2$ la seconda cifra, e così via. In questo modo, notiamo quanto segue:
