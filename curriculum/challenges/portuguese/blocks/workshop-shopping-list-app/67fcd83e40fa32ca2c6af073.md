...
Agora que você tem a estrutura básica do app, é hora de adicionar alguns itens e fazer a funcionalidade de busca funcionar.

Crie um array e atribua-o a uma variável chamada `items`.Dentro do array, adicione as strings `Apples`, `Bananas`, `Strawberries`, `Blueberries`, `Mangoes`, `Pineapple`, `Lettuce`, `Broccoli`, `Paper Towels` e `Dish Soap`.Esta será a lista de itens que serão exibidos no app.
...
Seu array `items` deve conter as strings `Apples`, `Bananas`, `Strawberries`, `Blueberries`, `Mangoes`, `Pineapple`, `Lettuce`, `Broccoli`, `Paper Towels` e `Dish Soap`.
