...
Ви можете писати цитований текст безпосередньо всередині елемента блочного цитування, як ви зробили в першому `section` елементі. Або ж можете обгорнути його в один або кілька абзаців. Це корисно, коли текст має кілька абзаців, але ви хочете зберегти їх у межах одного елемента блочного цитування.

Ось приклад із двома абзацами:
...
У другому розділі, всередині існуючого елемента блочного цитування, додайте чотири `p` елементи з такими текстами, у такому порядку:
...
У вас має бути чотири `p` елементи, вкладені всередину `blockquote` елемента у другому розділі.
...
Ваш перший `p` елемент має містити текст `So much of getting a job is who you know.`
...
Ваш другий `p` елемент має містити текст `It's OK to be an introvert, but you do need to push your boundaries.`
...
Ваш третій `p` елемент має містити текст `Create GitHub, Twitter, LinkedIn, and Discord accounts.`
...
Ваш четвертий `p` елемент має містити текст `Go to tech meetups and conferences. Travel if you have to.`
