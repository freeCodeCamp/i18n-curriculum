...
Hii ni mpangilio wa maneno kwa taarifa, si swali.
...
`Is` si fomu sahihi ya `to be` kwa mhusika `you`.
...
Chaguo hili lina maneno yaliyopangwa mchanganyiko ambayo hayaundaji swali sahihi.
