...
- 第二個 `.cabin` 應該有 `right` 屬性 `17%`、`top` 屬性 `93.5%`。
- 第三個 `.cabin` 應該有 `right` 屬性 `67%`、`top` 屬性 `93.5%`。
- 第四個 `.cabin` 應該有 `left` 屬性 `-8.5%`、`top` 屬性 `50%`。
- 第五個 `.cabin` 應該有 `left` 屬性 `17%`、`top` 屬性 `7%`。
- 第六個 `.cabin` 應該有 `right` 屬性 `17%`、`top` 屬性 `7%`。
...
你的 `.cabin:nth-of-type(2)` 選擇器應該有一個 `right` 屬性，設置爲 `17%`。

```js
assert(new __helpers.CSSHelp(document).getStyle('.cabin:nth-of-type(2)')?.right === '17%');
```

你的 `.cabin:nth-of-type(2)` 選擇器應該有一個 `top` 屬性，設置爲 `93.5%`。
...
你的 `.cabin:nth-of-type(3)` 選擇器應該有一個 `right` 屬性，設置爲 `67%`。

```js
assert(new __helpers.CSSHelp(document).getStyle('.cabin:nth-of-type(3)')?.right === '67%');
```

你的 `.cabin:nth-of-type(3)` 選擇器應該有一個 `top` 屬性，設置爲 `93.5%`。
...
你的 `.cabin:nth-of-type(4)` 選擇器應該有一個 `left` 屬性，設置爲 `-8.5%`。

```js
assert(new __helpers.CSSHelp(document).getStyle('.cabin:nth-of-type(4)')?.left === '-8.5%');
```

你的 `.cabin:nth-of-type(4)` 選擇器應該有一個 `top` 屬性，設置爲 `50%`。
...
你的 `.cabin:nth-of-type(5)` 選擇器應該有一個 `left` 屬性，設置爲 `17%`。

```js
assert(new __helpers.CSSHelp(document).getStyle('.cabin:nth-of-type(5)')?.left === '17%');
```

你的 `.cabin:nth-of-type(5)` 選擇器應該有一個 `top` 屬性，設置爲 `7%`。
...
你的 `.cabin:nth-of-type(6)` 選擇器應該有一個 `right` 屬性，設置爲 `17%`。
...
你的 `.cabin:nth-of-type(6)` 選擇器應該有一個 `top` 屬性，設置爲 `7%`。
