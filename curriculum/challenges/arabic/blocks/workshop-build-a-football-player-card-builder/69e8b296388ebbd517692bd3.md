...
داخل `stats-grid`، أضف عنصرين `div` كل منهما يحمل `className` بقيمة `form-group`.

بالنسبة للأول، أضف `label` يحمل `className` بقيمة `label`، و`htmlFor` بقيمة `pac`، والنص `PAC`، ثم أضف مُدخَلًا بـ `id` بقيمة `pac`، و`className` بقيمة `input`، و`type` بقيمة `number`.

وبالنسبة للثاني، أضف `label` بـ `htmlFor` بقيمة `sho` والنص `SHO`، ثم أضف مُدخَلًا بـ `id` بقيمة `sho` و`type` بقيمة `number`.

# --hints--

يجب أن يكون لديك عنصران `div` كل منهما يحمل `className` بقيمة `form-group` داخل عنصر `div` الذي يحمل `className` بقيمة `stats-grid`.
...
يجب أن يحتوي أول عنصر `div` بـ `className` بقيمة `form-group` على `label` يحمل خاصية `htmlFor` بقيمة `pac`، و`className` بقيمة `label`، والنص `PAC`.
...
يجب أن يحتوي أول عنصر `div` مع `className` بقيمة `form-group` على عنصر `input` مع `className` بقيمة `input`، و`id` بقيمة `pac`، و`type` بقيمة `number`.
...
يجب أن يحتوي ثاني عنصر `div` بـ `className` بقيمة `form-group` على `label` يحمل خاصية `htmlFor` بقيمة `sho`، و`className` بقيمة `label`، والنص `SHO`.
...
يجب أن يحتوي العنصر الثاني من نوع `div` الذي يحمل `className` بقيمة `form-group` على `input` يحمل `id` بقيمة `sho`، و`className` بقيمة `input`، و`type` بقيمة `number`.
