...
title: 'Problema 303: multipli con cifre piccole'
challengeType: 1
forumTopicId: 301957
...
Per un numero intero positivo $n$, definisci $f(n)$ come il multiplo positivo più piccolo di $n$ che, scritto in base 10, usa solo cifre $≤ 2$.

Quindi $f(2) = 2$, $f(3) = 12$, $f(7) = 21$, $f(42) = 210$, $f(89) = 1\\,121\\,222$.
