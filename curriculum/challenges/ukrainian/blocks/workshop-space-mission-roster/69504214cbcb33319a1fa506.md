...
Використайте свою функцію `chunkCrew()`, щоб створити шматки розміром `3` з вашого масиву `EVAReadySquad` і збережіть їх у новій змінній з іменем `EVAChunks`.

# --hints--

Ви повинні викликати `chunkCrew()` з `EVAReadySquad` і `3` та зберегти результат у новій змінній з іменем `EVAChunks`.
