...
El horizonte se está juntando. Rellena la propiedad `background-color` de los edificios en primer plano. Utilice la variable `--building-color1` para completar `.fb3` y `.fb4`, `--building-color2` para `.fb5`, `--building-color3` para `.fb2` y `.fb6`, y `--building-color4` para `.fb1`.
