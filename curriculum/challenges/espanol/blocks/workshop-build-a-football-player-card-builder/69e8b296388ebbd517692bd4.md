...
Agrega dos elementos `div` más, cada uno con el `className` de `form-group` dentro de `stats-grid`, uno para PAS y otro para DRI.

Para el de PAS, agrega un `label` con un `htmlFor` de `pas` y el texto `PAS`, luego un input con un `id` de `pas` y un `type` de `number`.

Y para el de DRI, agrega un `label` con un `htmlFor` de `dri` y el texto `DRI`, luego un input con un `id` de `dri` y un `type` de `number`.

# --hints--

Debes agregar dos elementos `div` más, cada uno con el `className` de `form-group` dentro del `div` de `className` de `stats-grid`.
...
Tu tercer elemento `div` de `className` de `form-group` debería tener un `label` con un atributo `htmlFor` de `pas`, un `className` de `label` y el texto `PAS`.
...
Tu tercer elemento `div` de `className` de `form-group` debería tener un `input` con un `className` de `input`, un `id` de `pas` y un `type` de `number`.
...
Tu cuarto elemento `div` de `className` de `form-group` debería tener un `label` con un atributo `htmlFor` de `dri`, un `className` de `label` y el texto `DRI`.
...
Tu cuarto elemento `div` de `className` de `form-group` debería tener un `input` con un `className` de `input`, un `id` de `dri` y un `type` de `number`.
