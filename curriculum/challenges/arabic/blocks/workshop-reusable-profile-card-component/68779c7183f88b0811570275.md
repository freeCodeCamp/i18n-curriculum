...
أضف كائنين إضافيين إلى مصفوفة `profiles` — واحد لـ Tiffany وآخر لـ Doug:
...
يجب أن تبقى منطق `map()` الخاص بك دون تغيير والآن يعرض البطاقات الثلاث كلها.

بهذا، يكتمل مشروع مكوِّن بطاقة الملف الشخصي القابل لإعادة الاستخدام!

# --hints--

يجب أن تعرض بالضبط ثلاثة مكوِّنات `Card`.
