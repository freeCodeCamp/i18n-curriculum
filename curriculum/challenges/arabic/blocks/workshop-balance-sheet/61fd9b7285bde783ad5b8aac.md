...
داخل `tbody`، أضف `tr` مع تعيين `class` إلى `total`. ضمنه، أضف `th` مع النص `Total Net Worth`، ولفّ `Net Worth` داخل `span` مع تعيين `class` إلى `sr-only`.

ثم أضف ثلاثة عناصر `td`، مع تعيين `class` للثالث إلى `current`، وإعطاء كل منها النص التالي: `$-171`، `$136`، `$334`.

# --hints--

يجب أن يحتوي عنصر `tbody` على عنصر `tr` واحد.
...
يجب أن يحتوي عنصر `tr` على `class` معين إلى `total`.
...
يجب أن يحتوي عنصر `tr` على عنصر `th`.
...
يجب أن يحتوي عنصر `th` على النص `Total Net Worth`.
...
يجب أن تلف النص `Net Worth` داخل عنصر `span`.
...
يجب أن يحتوي عنصر `span` على الخاصية `class` مع تعيينها إلى `sr-only`.
...
يجب أن يحتوي أول عنصر `td` على النص `$-171`.
...
يجب أن يحتوي ثاني عنصر `td` على النص `$136`.
...
يجب أن يحتوي ثالث عنصر `td` على النص `$334`.
...
يجب أن يحتوي ثالث عنصر `td` على `class` معين إلى `current`.
