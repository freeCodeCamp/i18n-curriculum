...
Всередині функції `getEVAReadyCrew` викличте `sortByPriorityDescending()` з локальним масивом `eligible`, щоб його було відсортовано перед поверненням.

# --hints--

Ви повинні викликати `sortByPriorityDescending()` з локальним масивом `eligible`.
