...
У цьому завданні ви практикуватиметеся у визначенні відділів за діями, які вони виконують.

# --instructions--

Прослухайте та доповніть кожне речення правильним відділом.
...
`El departamento de aprendizaje y desarrollo capacita al equipo.` — відділ навчання та розвитку навчає команду.

Обидва `apoyar` (підтримувати) і `capacitar` (навчати) є дієсловами третьої особи однини `-ar`.

За тим самим шаблоном, що й `desarrolla`, `verifica` і `crea` з попередніх завдань.
