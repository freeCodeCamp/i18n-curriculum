...
Crea tres nuevos elementos de lista dentro de tu elemento `ul.sub-menu`.

# --hints--

Deberías crear tres nuevos elementos de lista dentro de tu elemento `ul` con el `className` de `sub-menu`.
