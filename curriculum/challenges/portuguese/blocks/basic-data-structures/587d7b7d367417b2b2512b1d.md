...
**NOTA:** Objetos não mantêm uma ordenação das chaves armazenadas como os arrays fazem; portanto, a posição de uma chave em um objeto, ou a ordem relativa em que ela aparece, é irrelevante ao referenciar ou acessar essa chave.
