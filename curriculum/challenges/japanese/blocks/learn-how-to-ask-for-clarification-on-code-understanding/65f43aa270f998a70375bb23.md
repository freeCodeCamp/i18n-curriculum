...
`figure out` とは、問題を理解したり解決策を見つけたりすることを意味し、多くの場合、考えたり調査したりした後に行います。

たとえば、`I need to figure out how to fix this bug` は話者がこのバグをどう解決するか考えたり調査したりするつもりであることを意味します。
