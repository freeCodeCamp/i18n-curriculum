...
Erstelle nun eine `goCave`-Funktion, die `"Going to cave."` auf der Konsole ausgibt.

# --hints--

Du solltest das `function`-Schlüsselwort verwenden, um `goCave` zu deklarieren.
...
Deine `console.log("Going to cave.");`-Zeile sollte sich in deiner `goCave`-Funktion befinden.
