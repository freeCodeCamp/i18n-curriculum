...
`To investigate` significa examinar algo con cuidado, y `to be related to` significa estar conectado o asociado con algo. Por ejemplo:
...
Significa examinar o investigar algo en detalle con cuidado. Estos verbos terminan con `-ing`
...
Significa tener una conexión o asociación con algo.
