...
Далі встановіть зупинку кольору для червоного на `0%`, зупинку кольору для зеленого на `50%` і зупинку кольору для синього на `100%`.

# --hints--

Ваше правило CSS `.red` має містити властивість `background`, встановлену на `linear-gradient(180deg, rgb(255, 0, 0) 0%, rgb(0, 255, 0) 50%, rgb(0, 0, 255) 100%)`.
