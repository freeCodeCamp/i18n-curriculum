...
L'ultima cosa che farai è definire lo stile del pulsante CTA per il piano famiglia.

Assegna le classi `block`, `rounded-md`, `bg-indigo-600`, `px-4`, `py-2`, `text-center`, `font-semibold`, `text-white` e `hover:bg-indigo-700`.

Con questo, il tuo workshop sul componente di pricing con Tailwind è completo!

# --hints--

Il tuo elemento àncora dovrebbe avere la classe `bg-indigo-600`.
...
Il tuo elemento àncora dovrebbe avere la classe `px-4`.
...
Il tuo elemento àncora dovrebbe avere la classe `py-2`.
...
Il tuo elemento àncora dovrebbe avere la classe `text-center`.
...
Il tuo elemento àncora dovrebbe avere la classe `text-white`.
...
Il tuo elemento àncora dovrebbe avere la classe `font-semibold`.
...
Il tuo elemento àncora dovrebbe avere la classe `hover:bg-indigo-700`.
...
Il tuo elemento àncora dovrebbe avere la classe `rounded-md`.
...
Il tuo elemento àncora dovrebbe avere la classe `block`.
