...
حدّث الآن دالتك الأعمق في سلسلة `addCharacters` لتُعيد ضمنيًا نتيجة استدعاء `charRange()` مع `character1` و`character2` كمعلمتين.

# --hints--

يجب أن تستخدم دالتك الأعمق إرجاعًا ضمنيًا.
...
يجب أن تُعيد دالتك الأعمق نتيجة استدعاء `charRange()`.
...
يجب أن تمرر `character1` كالمعلمة الأولى في استدعاء `charRange()`.
...
يجب أن تمرر `character2` كالمعلمة الثانية في استدعاء `charRange()`.
