...
En el cuarto elemento `td`, añade una expresión incrustada que contenga la variable `views`. Esto mostrará el número de vistas que tiene la publicación.

# --hints--

Debes añadir una expresión incrustada que contenga la variable `views`.
