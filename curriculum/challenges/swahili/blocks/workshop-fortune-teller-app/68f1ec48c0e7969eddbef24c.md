...
Mwishowe, ndani ya `hideElements`, pita hoja `singleCard`, `multipleCard`, `fortuneContainer`, na `fortuneDescription`. Kumbuka kuzichukua kutoka kwa vipengele.

Kwa hayo, programu yako ya Kutabiri Hatima imekamilika!

# --hints--

Unapaswa kupitisha `singleCard` kama hoja ya kwanza kwa `hideElements`.
...
Unapaswa kupitisha `multipleCard` kama hoja kwa `hideElements`.
...
Unapaswa kupitisha `fortuneContainer` kama hoja kwa `hideElements`.
...
Unapaswa kupitisha `fortuneDescription` kama hoja kwa `hideElements`.
