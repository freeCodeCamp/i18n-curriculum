...
Tengeneza kitendakazi kinachoitwa `setPlayerDisplay`. Ndani ya kitendakazi hicho, weka `textContent` ya `playingSong` kuwa kichwa cha wimbo wa sasa, ikiwa kimefafanuliwa. Vinginevyo, weka kuwa mfuatano wa herufi tupu.

Chini ya hapo, weka `textContent` ya `songArtist` kuwa msanii wa wimbo wa sasa, ikiwa kimefafanuliwa. Vinginevyo, weka kuwa mfuatano wa herufi tupu.


# --hints--

Unapaswa kuwa na kitendakazi kinachoitwa `setPlayerDisplay`.

```js
assert.isFunction(setPlayerDisplay);
```

Kitendakazi chako cha `setPlayerDisplay` kinapaswa kuweka `textContent` ya `playingSong` kuwa kichwa cha wimbo wa sasa, ikiwa kimefafanuliwa, au kuwa mfuatano wa herufi tupu.
...
Kitendakazi chako cha `setPlayerDisplay` kinapaswa kuweka `textContent` ya `songArtist` kuwa msanii wa wimbo wa sasa, ikiwa kimefafanuliwa, au kuwa mfuatano wa herufi tupu.
