...
`That way` is used to explain the result or benefit of a decision or action. Por ejemplo:
...
`While` is used to indicate that two things are happening at the same time. Por ejemplo:
