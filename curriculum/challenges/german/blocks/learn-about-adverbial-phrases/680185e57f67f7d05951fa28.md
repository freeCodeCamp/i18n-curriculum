...
`How about` followed by a verb in the `-ing` form is a common way to make a suggestion. It introduces an idea in a friendly and informal way. The verb that follows is in the gerund form because it acts like a noun in the sentence. Zum Beispiel:
