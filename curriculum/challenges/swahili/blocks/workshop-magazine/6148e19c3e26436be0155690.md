...
Tengeneza sheria ya `.lists li` ili kulenga vitu vya orodha ndani ya kipengele chako cha `.lists`. Ipe sifa ya `margin-bottom` yenye thamani ya `1.5rem`.
...
Kichaguzi chako cha `.lists li` kinapaswa kuwa na sifa ya `margin-bottom` yenye thamani ya `1.5rem`.
