...
Першому елементу `option` надайте атрибут `value` зі значенням `""` і текст `Select an option`. Другому елементу `option` надайте атрибут `value` зі значенням `yes` і текст `Yes`. Третьому елементу `option` надайте атрибут `value` зі значенням `no` і текст `No`.
...
Ви повинні надати першому елементу `option` атрибут `value` зі значенням `""`.
...
Ви повинні надати другому елементу `option` атрибут `value` зі значенням `yes`.
...
Ви повинні надати третьому елементу `option` атрибут `value` зі значенням `no`.
