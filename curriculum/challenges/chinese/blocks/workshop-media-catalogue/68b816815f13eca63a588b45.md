...
文档字符串是放置在类或函数中的第一个语句的字串，用于为该类或函数提供文档说明。文档字符串通常用三重双引号括起来：
...
通过为你的 `Movie` 类添加以下文档字符串来完成它：`Parent class representing a movie.`

# --hints--

你应该为你的 `Movie` 类添加文档字串 `Parent class representing a movie.`。
