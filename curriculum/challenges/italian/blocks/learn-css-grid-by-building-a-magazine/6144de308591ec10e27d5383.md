...
Crea un selettore `h1` e imposta la proprietà `font-family` su `Anton` con il fallback `sans-serif`.
...
Il tuo selettore `h1` dovrebbe avere una proprietà `font-family` impostata su `Anton` con il fallback `sans-serif`.
