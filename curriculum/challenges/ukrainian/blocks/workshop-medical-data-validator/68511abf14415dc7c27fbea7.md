...
Далі додайте ключ `medications` до словника `constraints`. Для його значення використайте `isinstance`, щоб перевірити, що `medications` є списком.

# --hints--

Ваш словник `constraints` має містити ключ `medications`.
...
Ключ `medications` вашого словника `constraints` має мати значення `isinstance(medications, list)`.
