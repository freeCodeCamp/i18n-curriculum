...
`I can do that.` in this context does not express **possibility** but rather **willingness or agreement** to complete the task. You can use it to confirm that you will do what another person asks. Por ejemplo:
