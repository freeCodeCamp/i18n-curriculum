...
Como etapa final, remova a chamada `print` da função `verify_card_number` e altere o `card_number` de volta para algo válido.

# --hints--

Você não deve ter uma chamada `print` dentro da função `verify_card_number`.
...
Você deve alterar `card_number` de volta para algo válido.
