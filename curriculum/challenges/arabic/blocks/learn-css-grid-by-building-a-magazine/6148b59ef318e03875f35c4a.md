...
تُخبر خاصية `object-fit` المتصفح بكيفية وضع العنصر داخل الحاوية. في هذه الحالة، ستجعل قيمة `cover` الصورة تملأ الحاوية، مع اقتصاصها حسب الحاجة لتجنب تغيير نسبة العرض إلى الارتفاع.
