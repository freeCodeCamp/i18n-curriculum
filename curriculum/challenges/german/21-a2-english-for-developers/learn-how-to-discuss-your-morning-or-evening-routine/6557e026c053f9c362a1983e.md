...
Höre dir James Aussage an und identifiziere die Verwendung des Verbs mit `-ing`.
...
Verwende das Gerundium des Verbs `to be`
...
Verwende das Gerundium des Verbs `to come`
