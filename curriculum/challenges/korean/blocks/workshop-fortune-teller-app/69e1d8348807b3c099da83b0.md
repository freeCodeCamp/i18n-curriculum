...
지금까지 진행한 내용을 테스트하세요. `Game` 클래스로 인스턴스를 만들고 `game` 변수에 할당하세요.

이 시점에서 Single Card Reading과 Three Card Spread 버튼을 클릭하면 카드가 보이는 것을 확인할 수 있습니다.
