...
Debajo del elemento `.btn-container`, debes tener un elemento `p` con el `id` de `result`. Aquí es donde se mostrará el relato.

# --hints--

Debes tener un elemento `p` con el `id` de `result`.
