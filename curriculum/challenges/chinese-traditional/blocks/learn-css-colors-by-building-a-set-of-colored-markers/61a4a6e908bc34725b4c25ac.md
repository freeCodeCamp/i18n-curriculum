...
接下來，將紅色的顏色停止點設置爲 `0%`，將綠色的顏色停止點設置爲 `50%`，將藍色的顏色停止點設置爲 `100%`。

# --hints--

你的 `.red` CSS 規則應該有一個設置爲 `linear-gradient(180deg, rgb(255, 0, 0) 0%, rgb(0, 255, 0) 50%, rgb(0, 0, 255) 100%)` 的 `background` 屬性。
