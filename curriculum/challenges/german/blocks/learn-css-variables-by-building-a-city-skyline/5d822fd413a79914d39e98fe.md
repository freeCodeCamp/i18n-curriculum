...
Erstelle und füge die folgenden Eigenschaften zu `.bb2a` hinzu:
...
Nachdem du diese hinzugefügt hast, kannst du sehen, wie ein dicker Rand eines Elements einige Winkel ergibt, an denen sich zwei Seiten treffen. Du wirst den unteren Rand als den Anfang des Bauelements verwenden.

# --hints--

Du solltest `.bb2a` eine `margin` von `auto` geben.
...
Du solltest `.bb2a` eine `height` von `5vw` geben.
