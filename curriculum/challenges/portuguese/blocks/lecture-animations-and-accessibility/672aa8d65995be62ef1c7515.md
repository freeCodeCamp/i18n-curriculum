...
Para aplicar essa animação a um elemento, você usa a propriedade `animation`. Este exemplo também repete a animação infinitamente para que você possa vê-la em ação:
