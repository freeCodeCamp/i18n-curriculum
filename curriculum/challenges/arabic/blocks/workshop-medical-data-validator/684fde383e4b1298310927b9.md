...
يُستخدم المحدد الكمي في التعبيرات النمطية لتحديد عدد مرات تكرار الحرف. على سبيل المثال، الحرف `+` يطابق الحرف السابق مرة واحدة أو أكثر:
...
لذا أضف المحدد الكمي `+` إلى نمط التعبير النمطي الخاص بك لمطابقة رقم واحد أو أكثر.

# --hints--

يجب أن تضيف المحدد الكمي `+` إلى نمط التعبير النمطي الحالي `p\d`.
