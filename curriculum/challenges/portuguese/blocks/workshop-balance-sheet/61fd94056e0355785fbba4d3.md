...
Dentro do segundo `tr`, adicione o elemento `th` com o texto `Expenses Annual anticipated expenses, such as payroll.`. Envolva esse texto, exceto `Expenses `, dentro de um elemento `span` com a `class` definida como `description`.
...
Seu elemento `th` deve conter o texto `Expenses Annual anticipated expenses, such as payroll.`
