...
`[23, 65, 98, 5, 13].myMap(item => item * 2)` debería ser igual a `[46, 130, 196, 10, 26]`.
...
`["naomi", "quincy", "camperbot"].myMap(element => element.toUpperCase())` debería devolver `["NAOMI", "QUINCY", "CAMPERBOT"]`.
