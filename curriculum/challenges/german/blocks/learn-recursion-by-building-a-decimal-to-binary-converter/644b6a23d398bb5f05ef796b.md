...
Zur Erinnerung: Eine `while`-Schleife wird verwendet, um einen Codeblock auszuführen, solange die Bedingung `true` ist, und die Bedingung wird vor der Ausführung des Codeblocks überprüft. Hier ein Beispiel:
