...
title: Gaußsche Eliminationsmethode
challengeType: 1
forumTopicId: 302272
...
Schreiben Sie eine Funktion, um \\(Ax = b\\) mit der gaußschen Eliminationsmethode und anschließendem Rückwärtseinsetzen zu lösen.

\\(A\\) ist eine \\(n \\times n\\) Matrix. Außerdem sind \\(x\\) und \\(b\\) Vektoren der Größe \\(n\\) mal 1.

Zur Verbesserung der Genauigkeit verwenden Sie bitte partielle Pivotisierung und Skalierung.
