...
`className`が`form-group`の3番目の`div`要素には、`htmlFor`属性が`pas`、`className`が`label`、テキストが`PAS`の`label`があるはずです。
...
`className`が`form-group`の3番目の`div`要素には、`className`が`input`、`id`が`pas`、`type`が`number`の`input`があるはずです。
...
`className`が`form-group`の4番目の`div`要素には、`htmlFor`属性が`dri`、`className`が`label`、テキストが`DRI`の`label`があるはずです。
...
`className`が`form-group`の4番目の`div`要素には、`className`が`input`、`id`が`dri`、`type`が`number`の`input`があるはずです。
