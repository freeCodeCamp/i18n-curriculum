...
Ora, dovresti aggiungere un po' di spaziatura interna al contenitore. Imposta `padding` su `10px 20px`. In questo modo, imposti una spaziatura interna di `10px` sopra e sotto, e di `20px` a sinistra e a destra.
...
Imposta la proprietà `padding` su `10px 20px`.
