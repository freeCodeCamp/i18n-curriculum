...
Cuando el `box-sizing` de un elemento se establece en `content-box`, ¿a qué parte del modelo de caja se aplican el `width` y la `height`?
...
Cuando el `box-sizing` de un elemento se establece en `border-box`, ¿a qué partes del modelo de caja CSS no se aplican el `width` y la `height`?
...
¿Cuál es el valor base de la función CSS `brightness()` desde el cual comienza el aumento de brillo?
...
Elimina la saturación del color mientras mantiene la estructura tonal del elemento.
