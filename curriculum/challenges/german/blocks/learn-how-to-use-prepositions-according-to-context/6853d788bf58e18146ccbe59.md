...
`Ten developers` is a way to report how many people are currently working on a project. Using numbers helps clearly show available resources. Zum Beispiel:
