...
`address`, `briefly`, `bring up`, `further`, `If you don't mind`, `main agenda`, та `severe`.
...
Це вводить тему або проблему для обговорення. Починається з дієслова, за яким іде прийменник.
...
Це описує короткий проміжок часу. Вказує, яким має бути обговорення.
...
Це означає «у більшій мірі» або «більше» і вказує на продовження процесу. Тут використовується, щоб позначити більше дії або розслідування.
...
Це описує щось серйозне або крайне. Модифікує `bug` і стосується серйозності проблеми.
...
Це означає впоратися з проблемою або розв’язати її. Вказує на вжиття заходів щодо згаданої проблеми.
...
Це використовується для ввічливого прохання або пропозиції. Починається з умовної фрази, яка шукає згоду.
...
Це стосується основного списку тем для обговорення.
