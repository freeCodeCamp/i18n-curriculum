...
A função `idToText`, no momento, retorna um elemento `input`.Atualize-a para que retorne o `value` daquele elemento `input`.

# --hints--

Você deve retornar a propriedade `value` do valor de retorno do método `.find()`.
