...
La interfaz del `Navegador` proporciona información sobre el entorno del navegador, como la cadena de agente de usuario, la plataforma y la versión del navegador. Una cadena del agente de usuario es una cadena de texto que identifica el navegador y el sistema operativo que se está utilizando.
...
La interfaz de `Ventana` representa la ventana del navegador que contiene el documento DOM. Proporciona métodos y propiedades para interactuar con la ventana del navegador, como cambiar el tamaño de la ventana, abrir nuevas ventanas y navegar a diferentes URLs.
