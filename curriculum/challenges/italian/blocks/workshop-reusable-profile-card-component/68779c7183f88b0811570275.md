...
Aggiungi altri due oggetti all'array `profiles` — uno per Tiffany e uno per Doug:
...
La tua logica `map()` dovrebbe rimanere invariata e ora renderizzare tutte e tre le schede.

Con questo, il tuo progetto del componente riutilizzabile della scheda profilo è completo!

# --hints--

Dovresti renderizzare esattamente tre componenti `Card`.
