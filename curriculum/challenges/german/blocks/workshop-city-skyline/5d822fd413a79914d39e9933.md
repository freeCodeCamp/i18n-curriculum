...
Fügen Sie unter dem gerade hinzugefügten einen weiteren `repeating-linear-gradient` ein. Geben Sie ihm eine Richtung von `90deg`, verwenden Sie Ihre Gebäude-Farbe von `0%` bis `12%` und die Fensterfarbe von `12%` bis `44%`. So entstehen viele rechteckige Fenster.
