...
You now have three type selectors with the same styling. Você pode adicionar o mesmo grupo de estilos a muitos elementos, criando uma lista de seletores. Cada seletor é separado por vírgulas assim:
