...
Sasa ni wakati wa kuhamisha msimbo kutoka kwenye kitendakazi cha `move()` kwenda kwenye kitendakazi cha `make_allowed_move()`. Hamisha msimbo uliopangwa ndani ya tamko la kwanza la `if` (isipokuwa wito wa kwanza wa `print()`) kwenda kwenye kitendakazi chako kipya. Lipa makini kwa mwinuko wa mstari.
Usisahau kuondoa neno kuu la `pass`.

# --hints--

Unapaswa kuhamisha msimbo uliopangwa ndani ya tamko la kwanza la `if` (isipokuwa wito wa kwanza wa `print()`) kwenda kwenye kitendakazi chako kipya.
