...
Коли ширина екрану маленька, `h1` не переносить свій текстовий вміст так, як має. Вирівняйте текст елемента `h1` по центру.

Потім додайте `main` відступ так, щоб заголовок розділу `Student Info` був повністю видимим.
