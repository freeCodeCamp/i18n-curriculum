...
7. O usuário não deve conseguir inserir mais de `50` caracteres no elemento `textarea`. When the character count reaches `50`, any extra input should be automatically trimmed and the text `Character Count: 50/50` should be displayed in `red`.
