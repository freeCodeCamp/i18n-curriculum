...
Assim é melhor.Agora, deixe o fundo agradável para os olhos, alterando o `background-color` de `body` para `#1b1b32`.Em seguida, para ver o texto, altere a `color` para `#f5f6f7`.
