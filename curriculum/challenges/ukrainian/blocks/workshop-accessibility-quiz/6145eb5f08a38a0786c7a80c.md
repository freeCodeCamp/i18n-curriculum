...
Об’єднайте відповідні елементи так, щоб можна було вибрати лише один елемент із пари одночасно.
...
Ви повинні надати різні атрибути `name` першому `input` і третьому `input`.
