...
Innerhalb des vierten `td` Elements, aktualisieren Sie den aktuellen Wert, um stattdessen die `viewCount` Funktion mit der `views` Variabel als Argument aufzurufen.

# --hints--

Sie sollten die `viewCount` Funktion aufrufen und in der `views` Variabel als Argument übergeben.
