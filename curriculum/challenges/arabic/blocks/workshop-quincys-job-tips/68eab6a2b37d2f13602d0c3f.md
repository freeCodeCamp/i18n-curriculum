...
يمكنك كتابة النص المقتبس مباشرة داخل عنصر الاقتباس المضمّن، كما فعلت في أول عنصر `section`. بدلاً من ذلك، يمكنك تغليفه داخل عنصر أو أكثر من عناصر الفقرة. هذا مفيد عندما يحتوي النص على عدة فقرات، لكنك تريد إبقاؤها داخل نفس عنصر الاقتباس المضمّن.

إليك مثالًا يحتوي على فقرتين:
...
في القسم الثاني، داخل عنصر الاقتباس المضمّن الموجود، أضف أربعة عناصر `p` بالنصوص التالية، بالترتيب:
...
يجب أن يكون لديك أربعة عناصر `p` متسكنة داخل عنصر `blockquote` داخل القسم الثاني.
...
يجب أن يحتوي أول عنصر `p` على النص `So much of getting a job is who you know.`
...
يجب أن يحتوي ثاني عنصر `p` على النص `It's OK to be an introvert, but you do need to push your boundaries.`
...
يجب أن يحتوي ثالث عنصر `p` على النص `Create GitHub, Twitter, LinkedIn, and Discord accounts.`
...
يجب أن يحتوي العنصر `p` الرابع على النص `Go to tech meetups and conferences. Travel if you have to.`
