...
In a previous module you learned that gradients in CSS are a way to transition between colors across the distance of an element. Вони застосовуються до властивості `background`, а синтаксис виглядає ось так:
