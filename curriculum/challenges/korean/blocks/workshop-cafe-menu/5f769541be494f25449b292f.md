...
새로운 `flavor` 클래스를 선택자로 사용하여 `text-align` 속성 값을 `left`로 설정하세요.

# --hints--

`flavor` 클래스 선택자가 있어야 합니다.
...
`text-align` 속성을 `left`로 설정해야 합니다.
...
`flavor` 클래스 선택자가 `text-align` 속성을 `left`로 설정해야 합니다.
