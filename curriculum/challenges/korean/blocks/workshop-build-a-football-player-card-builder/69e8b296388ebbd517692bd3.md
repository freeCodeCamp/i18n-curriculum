...
첫 번째에는 `label`의 `className`, `pac`의 `htmlFor`, 텍스트 `PAC`를 가진 `label`를 추가한 다음, `pac`의 `id`, `input`의 `className`, `number`의 `type`를 가진 input를 추가하세요.
...
`form-group`의 `className`를 가진 첫 번째 `div` 요소에는 `pac`의 `htmlFor` 속성, `label`의 `className`, 텍스트 `PAC`를 가진 `label`가 있어야 합니다.
...
`form-group`의 `className`를 가진 첫 번째 `div` 요소에는 `input`의 `className`, `pac`의 `id`, `number`의 `type`를 가진 `input`가 있어야 합니다.
...
`form-group`의 `className`를 가진 두 번째 `div` 요소에는 `sho`의 `htmlFor` 속성, `label`의 `className`, 텍스트 `SHO`를 가진 `label`가 있어야 합니다.
...
`form-group`의 `className`를 가진 두 번째 `div` 요소에는 `sho`의 `id`, `input`의 `className`, `number`의 `type`를 가진 `input`가 있어야 합니다.
