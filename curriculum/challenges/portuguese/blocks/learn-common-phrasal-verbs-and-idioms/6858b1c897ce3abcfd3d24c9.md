...
Para encontrar a resposta correta, veja o item `1. Tooltips and Visual Indicators for Password Strength`. Dicas de ferramenta e Indicadores Visuais para Força da Senha` e leia a primeira frase desse parágrafo para poder responder corretamente a esta pergunta.
