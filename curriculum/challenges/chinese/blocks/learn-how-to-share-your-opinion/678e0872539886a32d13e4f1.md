...
`Lightweight` describes something that doesn't require much in terms of resources or power, making it easy to run, fast, and efficient. 例如：
...
`Features` are specific functions or tools that a product or software offers to users. 例如：
