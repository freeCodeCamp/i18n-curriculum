...
**Nota:** Al igual que en <a href="/learn/javascript-algorithms-and-data-structures/basic-javascript/storing-values-with-the-assignment-operator" target="_blank" rel="noopener noreferrer nofollow">Almacenar valores con el operador de asignación</a>, todas las llamadas a funciones se resolverán antes de que se ejecute el `return`, por lo que podemos `return` el valor de la función `Math.random()`.
