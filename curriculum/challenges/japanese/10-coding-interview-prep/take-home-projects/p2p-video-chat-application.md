...
**ユーザーストーリー:** ルーム名を入力して、もしその名前のルームが以前から存在していなかったならば、ルームが作成されます。
...
**ユーザーストーリー:** マイクやウェブカメラへのアクセスをサイトに許可しないということを選択できます。 許可しないことを選択した場合、または他のドライバの問題が発生した場合は、これらが必要ですというエラーメッセージが表示されます。
