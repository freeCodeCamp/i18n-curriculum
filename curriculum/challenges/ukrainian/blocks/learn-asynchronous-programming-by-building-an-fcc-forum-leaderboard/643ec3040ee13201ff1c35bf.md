...
Залиште другий елемент `td` порожнім, бо пізніше ви додасте в нього вміст.

У третьому елементі `td` додайте такий вставлений вираз: `${posts_count - 1}`.

Це відобразить число відповідей на тему.

# --hints--

У вас має бути `${posts_count - 1}` всередині третього елемента `td`.
