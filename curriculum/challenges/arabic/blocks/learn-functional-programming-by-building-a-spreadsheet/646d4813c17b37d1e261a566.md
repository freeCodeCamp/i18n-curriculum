...
يمكنك الحصول بسرعة على كل الخلايا من صفحتك عبر جلب عنصر `#container` بواسطة `id` الخاص به ثم الوصول إلى خاصية `children` للنتيجة. مرر ذلك إلى استدعاء `evalFormula()` كالمعلمة الثانية.

# --hints--

للمعلمة الثانية في استدعاء `evalFormula()`، يجب استدعاء طريقة `.getElementById()` لكائن `document`.
...
يجب تمرير `container` كمعلمة لاستدعاء `.getElementById()` الخاص بك.
...
يجب الوصول إلى خاصية `children` لنتيجة استدعاء `.getElementById()` الخاص بك.
