...
이제 나머지 속성들을 private `elements` 객체에 추가하세요. 이들은 `multipleCard`, `title`, `newReadingBtn`, `fortuneContainer`, `fortuneDescription`, `headerTitle`, `subTitle`, `cardTitle`, `description`, 그리고 `text`입니다. 각 속성이 `HTMLElement` 타입을 사용하도록 하세요.

# --hints--

`multipleCard` 속성이 `elements` 속성 안에 있고 `HTMLElement` 타입이 할당되어 있어야 합니다.
...
`title` 속성이 `elements` 속성 안에 있고 `HTMLElement` 타입이 할당되어 있어야 합니다.
...
`newReadingBtn` 속성이 `elements` 속성 안에 있고 `HTMLElement` 타입이 할당되어 있어야 합니다.
...
`fortuneContainer` 속성이 `elements` 속성 안에 있고 `HTMLElement` 타입이 할당되어 있어야 합니다.
...
`fortuneDescription` 속성이 `elements` 속성 안에 있고 `HTMLElement` 타입이 할당되어 있어야 합니다.
...
`headerTitle` 속성이 `elements` 속성 안에 있고 `HTMLElement` 타입이 할당되어 있어야 합니다.
...
`subTitle` 속성이 `elements` 속성 안에 있고 `HTMLElement` 타입이 할당되어 있어야 합니다.
...
`cardTitle` 속성이 `elements` 속성 안에 있고 `HTMLElement` 타입이 할당되어 있어야 합니다.
...
`description` 속성이 `elements` 속성 안에 있고 `HTMLElement` 타입이 할당되어 있어야 합니다.
...
`text` 속성이 `elements` 속성 안에 있고 `HTMLElement` 타입이 할당되어 있어야 합니다.
