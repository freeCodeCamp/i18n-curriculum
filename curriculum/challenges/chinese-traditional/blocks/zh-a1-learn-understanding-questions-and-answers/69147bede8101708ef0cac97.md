...
Liu Ming says `是的 (shì de)`, which means "yes", to give a positive answer, and then says `我是 (wǒ shì) UI 設計師 (shè jì shī)`, which means "I am a UI designer" to confirm his profession.
