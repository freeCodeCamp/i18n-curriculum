...
Kitendakazi chako cha `idToText` kwa sasa kinarudisha kipengele cha `input`. Kisahihishe kirudishe `value` ya kipengele hicho cha `input`.

# --hints--

Unapaswa kurudisha sifa ya `value` ya thamani ya return ya njia ya `.find()`.
