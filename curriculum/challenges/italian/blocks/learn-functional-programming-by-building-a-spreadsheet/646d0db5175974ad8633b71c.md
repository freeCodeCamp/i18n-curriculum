...
Le tue funzioni interne possono anche restituire una funzione. Usando la stessa sintassi della funzione freccia, aggiorna la tua funzione `addCharacters` per restituire una terza funzione che prende un parametro `num`.

# --hints--

La tua funzione freccia interna dovrebbe restituire un'altra funzione freccia con un parametro `num`.
...
La tua funzione freccia più interna dovrebbe essere vuota.
