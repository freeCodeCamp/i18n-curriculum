...
Ndani ya kitendakazi cha `playSong`, fanya wito wa kitendakazi cha `highlightCurrentSong`.

Baada ya hapo, jaribu kubonyeza vifungo vya udhibiti ili kuona jinsi kitendakazi cha `highlightCurrentSong` kinavyofanya kazi.

# --hints--

Unapaswa kufanya wito wa `highlightCurrentSong` ndani ya kitendakazi cha `playSong`.
