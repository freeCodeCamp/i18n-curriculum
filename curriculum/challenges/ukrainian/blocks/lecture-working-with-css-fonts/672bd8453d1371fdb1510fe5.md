...
Ви можете налаштувати розмір шрифту тексту попереднього перегляду за допомогою синього повзунка, розташованого поруч із полем для введення тексту.
...
Коли будете готові додати шрифт до свого проєкту, натисніть на синю кнопку "Get font" зверху. Вас перенаправить на сторінку з підсумком, де ви побачите шрифти, які наразі вибрані. Можна вибрати кілька шрифтів одночасно.
...
Якщо ви оберете варіант `@import`, вам потрібно буде додати це правило до свого CSS-файлу.
...
Ще один чудовий варіант — Font Squirrel, де можна знайти та скачати кастомні шрифти, які ви уявляєте для свого дизайну.
...
Якщо ви шукаєте шрифт і натискаєте на результат, побачите більше деталей про шрифт, включно з зразками, тест-драйвом, гліфами та Webfont kit.
...
Також можна побачити приклади різних стилів і варіацій шрифту, як-от thin, light, medium, bold і black.
...
Натиснення кнопки "Download @font-face Kit" завантажить стиснутий (zip) файл. Якщо розпакувати його, ви знайдете папку "web fonts", ліцензію у вигляді текстового файлу та HTML-файл з інструкціями, як використовувати вебшрифти.
...
У папці вебшрифтів будуть усі файли шрифтів, які потрібні для вашого проєкту. Вони згруповані у відповідні папки для різних стилів шрифту.
