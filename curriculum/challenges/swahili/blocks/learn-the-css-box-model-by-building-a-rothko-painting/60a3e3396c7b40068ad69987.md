...
Hauhitaji kila wakati kutumia piksela unapopima ukubwa wa kipengee.

Tengeneza sheria mpya, `.three`, na weka `width` yake kuwa `91%`.
...
Kipengee chako cha `.three` kinapaswa kuwa na thamani ya `width` ya `91%`.
