...
El horizonte está tomando forma. Complete la propiedad `background-color` de los edificios del primer plano. Utilice su variable `--building-color1` para llenar `.fb3` y `.fb4`, `--building-color2` para `.fb5`, `--building-color3` para `.fb2` y `.fb6`, y `--building-color4` para `.fb1`.
