...
Lo pseudo-selettore `:not` può essere usato per selezionare tutti gli elementi che non corrispondono alla regola CSS specificata.
...
Non dovresti cambiare le proprietà nel selettore `.daily-value p:not(.no-divider)`.
