...
Яка головна мета стратегії для наступної кампанії в соціальних мережах?
...
Зосередитися лише на Європі для наступної кампанії.

### --feedback--

Стратегія не має на меті зосередитися на Європі.

---

Зменшити бюджет для наступної кампанії.

### --feedback--

Хоча керування бюджетом важливе, стратегія не зосереджена на його зменшенні.

---

Запустити ту саму кампанію знову без змін.

### --feedback--

Стратегія пропонує покращення, особливо в регіонах, де результати були не дуже хороші.
...
Перший рядок під заголовком вказує, на чому потрібно зосередитися для наступної кампанії. Решта стратегії містить детальну інформацію, але загальна ідея знаходиться саме в цьому рядку, і саме там ви знайдете правильну відповідь на це запитання.
