...
Implementa operazioni base elemento per elemento tra matrici e tra scalari e matrici.
...
<ul>
  ...
  <li>divisione</li>
  <li>esponenziazione</li>
</ul>

Il primo parametro sarà l’operazione da eseguire, per esempio, "m_add" per l’addizione tra matrici e "s_add" per l’addizione scalare. Il secondo e il terzo parametro saranno le matrici su cui eseguire le operazioni.
