...
CRUD é usado ao trabalhar com bancos de dados, a interface do usuário e APIs RESTful. APIs RESTful são um conjunto de convenções para construir serviços web que permitem ao cliente interagir com um banco de dados ou sistema back-end realizando operações CRUD por meio de métodos HTTP padrão.
