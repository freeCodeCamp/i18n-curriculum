...
Відрегулюйте виклик `verify_card_number` так, щоб якщо він повертає `True`, вивести `'VALID!'` у консоль. Інакше вивести `'INVALID!'`.

# --hints--

Ви повинні мати `if verify_card_number(translated_card_number):` всередині функції `main`.
...
Ви повинні мати `print('VALID!')` всередині інструкції `if`.
...
Ви повинні мати `print('INVALID!')` всередині умови `else`.
