...
Quando você seleciona uma categoria no menu suspenso, os cartões do instrumento são corretamente filtrados e exibidos na página, mas você precisa se livrar dessas vírgulas entre os cartões.

Faça isso juntando o array retornado por `instrumentCards`.Com isso, seu filtro de instrumento musical está completo.
...
Você deve unir o array retornado pela função `instrumentCards`.Não modifique seu event listener.
