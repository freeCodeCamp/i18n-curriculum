...
Da der gesamte Abschnitt mit den Blogbeiträgen den Hauptinhalt der Seite darstellt, sollte er in ein `main`-Element eingeschlossen werden. Das hilft Screenreadern und anderen unterstützenden Technologien, die Struktur der Seite besser zu verstehen.
...
Ihr `main`-Element sollte alle drei `article`-Elemente enthalten.
