...
Der Ausdruck `only if` wird verwendet, um eine Bedingung zu schaffen, damit etwas passiert. Es ist als würde man sagen `this will happen if that happens.` Es ist als würde man eine Vereinbarung treffen, bei der eine Aktion von einer anderen abhängig ist.
