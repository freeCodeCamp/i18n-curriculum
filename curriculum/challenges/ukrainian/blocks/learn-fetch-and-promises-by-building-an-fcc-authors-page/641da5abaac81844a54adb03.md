...
Тепер ви створите функцію для заповнення інтерфейсу даними автора. Ви викличете цю функцію всередині другого методу `.then()`.

Створіть порожню стрілкову функцію з ім’ям `displayAuthors`, яка прийматиме `authors` як параметр.
...
Ви повинні використати `const` для створення порожньої функції з ім’ям `displayAuthors`.
...
Ваша функція `displayAuthors` має використовувати стрілковий синтаксис.
...
Ваша функція `displayAuthors` має бути порожньою.
