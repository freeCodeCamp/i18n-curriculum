...
Щоб текст цитати виділявся більше, надайте селектору `.quote` множину властивостей `font-family` зі значенням `Raleway` та запасним варіантом `sans-serif`.

# --hints--

Ваш селектор `.quote` має мати множину властивостей `font-family` зі значенням `Raleway` та запасним варіантом `sans-serif`.
