...
Текст знову вирівняний по центру, тож посилання на CSS-файл працює. Додайте до файлу ще один стиль, який змінює властивість `background-color` на `brown` для елемента `body`.
...
Ви повинні встановити властивість `background-color` у значення `brown`.
...
Ваш елемент `body` має мати фон `brown`.
