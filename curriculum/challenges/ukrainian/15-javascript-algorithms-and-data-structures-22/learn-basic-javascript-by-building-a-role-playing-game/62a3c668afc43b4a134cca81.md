...
У попередньому проєкті ви навчилися створювати функцію ось так:
...
Створіть порожню функцію під назвою `goStore`.

# --hints--

Оголосіть `goStore` за допомогою ключового слова `function`.
