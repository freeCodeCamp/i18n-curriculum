...
`mile_pace(3, "24:00")` dovrebbe restituire `"08:00"`.
...
`mile_pace(1, "06:45")` dovrebbe restituire `"06:45"`.
...
`mile_pace(2, "07:00")` dovrebbe restituire `"03:30"`.
...
`mile_pace(26.2, "120:35")` dovrebbe restituire `"04:36"`.
