...
- **Liam:** `Was the report submitted on time?` - This person is asking about the handing in of a report.

- **Maria:** `It was.` – This is a full, polite affirmative response without the need of starting with `Yes`.
