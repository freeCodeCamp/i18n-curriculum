...
Badilisha `background-color` ya turubai ya kuchora kuwa `#4d0f00`.

# --hints--

Unapaswa kuweka sifa ya `background-color` kuwa `#4d0f00`.
...
Kipengele chako cha `.canvas` kinapaswa kuwa na `background-color` ya `#4d0f00`.
