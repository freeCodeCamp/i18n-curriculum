...
O atributo `src` da `img` deve ter um valor de `"https://cdn.freecodecamp.org/curriculum/css-photo-gallery/1.jpg"` e o texto `alt` deve ter um valor de `"a cat peacefully sleeping"`.
