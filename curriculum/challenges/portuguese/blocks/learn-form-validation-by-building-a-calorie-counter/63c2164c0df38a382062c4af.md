...
Cada entrada terá um input de texto para o nome da entrada e um input numérico para as calorias. Para obter uma contagem do número de entradas, você pode consultar por inputs de texto.

Passe a string `input[type="text"]` para o método `querySelectorAll()`. Lembre-se de que se você usar aspas simples para sua string, também deve usar aspas duplas dentro dela (ou vice-versa).
