...
`To come up` means that something appears, happens, or needs attention — often unexpectedly. It's commonly used when talking about new issues, tasks, or situations. 例:
