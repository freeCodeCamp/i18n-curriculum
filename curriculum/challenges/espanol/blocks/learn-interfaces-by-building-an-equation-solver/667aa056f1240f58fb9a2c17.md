...
Como último paso, modifica las cadenas contenidas en `details_list` para que el texto colocado después del signo igual esté alineado a la derecha en cada línea. Tu resultado final debería verse así:
...
¡Con eso, el proyecto está completo!
