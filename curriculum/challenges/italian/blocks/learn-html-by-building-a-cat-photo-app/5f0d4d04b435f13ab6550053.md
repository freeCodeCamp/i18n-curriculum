...
Hai eliminato il secondo elemento `fieldset` oppure manca il tag di apertura o il tag di chiusura.
...
Il tuo elemento `legend` dovrebbe avere un tag di apertura. I tag di apertura hanno questa sintassi: `<elementName>`.
...
L'elemento `legend` dovrebbe contenere il testo `What's your cat's personality?`. Hai omesso il testo oppure c'è un errore di battitura.
