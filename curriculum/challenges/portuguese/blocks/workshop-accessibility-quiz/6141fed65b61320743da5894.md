...
Para aumentar a acessibilidade da página, o atributo `role` pode ser usado para indicar para tecnologias assistivas a finalidade por trás de um elemento na página. O atributo `role` é parte da *Web Accessibility Initiative* (WAI) e aceita valores predefinidos.
