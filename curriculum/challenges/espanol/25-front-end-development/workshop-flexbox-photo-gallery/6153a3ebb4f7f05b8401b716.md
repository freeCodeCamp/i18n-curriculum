...
El atributo de imagen `alt` debe describir el contenido de la imagen. Los lectores de pantalla anuncian el texto alternativo en lugar de las imágenes. Si la imagen no puede ser cargada, este texto se presenta en lugar de la imagen.

Para completar el proyecto, agregue un atributo `alt` a todas sus nueve imágenes de gatos para describirlas. Use un valor de al menos cinco caracteres de largo para cada uno.


# --hints--

Los nueve elementos de `img` deben tener un atributo `alt` con texto que describa cada imagen, usando al menos `5` letras para cada descripción.
