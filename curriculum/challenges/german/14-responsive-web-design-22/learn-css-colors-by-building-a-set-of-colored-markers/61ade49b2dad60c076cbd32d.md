...
Ändere für die zusammenfassende `border-left`-Eigenschaft den Wert des Randstils von `solid` zu `double`.

# --hints--

Deine `.sleeve`-CSS-Regel sollte eine zusammenfassende `border-left`-Eigenschaft und den Wert `10px double black` enthalten.
