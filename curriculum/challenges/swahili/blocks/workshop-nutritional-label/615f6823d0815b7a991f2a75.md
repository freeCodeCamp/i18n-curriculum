...
Tumia kipengele chako kilichopo cha `.divider` kama mfano kuongeza kigawanyo kipya baada ya kipengele cha `p`.
...
`div` mpya inapaswa kuja baada ya kipengele chako cha `p`.
