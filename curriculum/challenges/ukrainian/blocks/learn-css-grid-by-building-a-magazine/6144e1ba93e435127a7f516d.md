...
Створіть селектор `h2, h3, h4, h5, h6`. Надайте йому множину властивостей `font-family`, встановлену в `Raleway` із запасним варіантом `sans-serif`.

# --hints--

У вас має бути селектор `h2, h3, h4, h5, h6`.

```js
assert(new __helpers.CSSHelp(document).getStyle('h2, h3, h4, h5, h6'));
```

Ваш селектор `h2, h3, h4, h5, h6` має мати множину властивостей `font-family`, встановлену в `Raleway` із запасним варіантом `sans-serif`.
