...
7 + 13 = 20 → Índices 0 + 3 = 39 + 11 = 20 → Índices 1 + 2 = 33 + 3 = 6 → Retorna `6`

</div>

# --hints--

`pairwise([1, 4, 2, 3, 0, 5], 7)` debería devolver 11.
