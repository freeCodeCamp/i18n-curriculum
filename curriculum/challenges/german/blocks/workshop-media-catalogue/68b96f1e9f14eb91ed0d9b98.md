...
Um Ihre benutzerdefinierte Ausnahme in Aktion zu sehen, ändern Sie die Zeile `catalogue.add(series2)` in `catalogue.add('series2')`.

# --hints--

Sie sollten die Zeile `catalogue.add(series2)` in `catalogue.add('series2')` ändern.
