...
`Complicated` en realidad significa lo contrario: indica dificultad o complejidad.
...
Un problema `complicated` típicamente toma más tiempo para arreglar debido a su complejidad.
