...
Data una stringa di data in EST, restituisci la data fornita come stringa con 12 ore aggiunte all'orario. Il fuso orario deve essere mantenuto.

Esempio di input: `"March 6 2009 7:30pm EST"`
...
Deve gestire il cambio di giorno. `add12Hours("March 6 2009 7:30pm EST")` dovrebbe restituire `"March 7 2009 7:30am EST"`

```js
assert(add12Hours('March 6 2009 7:30pm EST') === 'March 7 2009 7:30am EST');
```

Deve gestire il cambio di mese negli anni bisestili. `add12Hours("February 29 2004 9:15pm EST")` dovrebbe restituire `"March 1 2004 9:15am EST"`

```js
assert(add12Hours('February 29 2004 9:15pm EST') === 'March 1 2004 9:15am EST');
```

Deve gestire il cambio di mese negli anni comuni. `add12Hours("February 28 1999 3:15pm EST")` dovrebbe restituire `"March 1 1999 3:15am EST"`

```js
assert(add12Hours('February 28 1999 3:15pm EST') === 'March 1 1999 3:15am EST');
```

Deve gestire il cambio di anno. `add12Hours("December 31 2020 1:45pm EST")` dovrebbe restituire `"January 1 2021 1:45am EST"`
