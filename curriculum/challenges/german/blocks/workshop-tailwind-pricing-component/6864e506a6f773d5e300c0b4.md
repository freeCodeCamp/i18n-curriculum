...
Die Elemente sind jetzt zu nah beieinander. Fügen Sie `gap-8` hinzu, um etwas Abstand zwischen ihnen zu schaffen, und verwenden Sie `mt-16`, um sie etwas vom oberen Rand nach unten zu schieben.

# --hints--

Ihr `div`-Element sollte die Klasse `gap-8` haben.
...
Ihr `div`-Element sollte die Klasse `mt-16` haben.
