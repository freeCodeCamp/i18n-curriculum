...
Before you start diving in to the table itself, your `span` elements are currently bolded. Створіть селектор `span:not(.sr-only)` та надайте йому властивість `font-weight` зі значенням `normal`.
