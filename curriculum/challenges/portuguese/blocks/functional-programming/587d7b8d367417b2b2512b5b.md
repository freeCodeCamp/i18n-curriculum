...
1) Funções isoladas - não há dependência do estado do programa, o que inclui variáveis globais que estão sujeitas a alterações

2) Funções puras - a mesma entrada sempre produz a mesma saída
