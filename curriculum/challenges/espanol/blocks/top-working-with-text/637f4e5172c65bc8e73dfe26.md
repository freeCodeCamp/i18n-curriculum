...
Las listas ordenadas se crean usando el elemento `<ol>`. Cada ítem individual en ellas se crea nuevamente usando el elemento de ítem de lista `<li>`. Sin embargo, cada ítem de lista en una lista ordenada comienza con un número en su lugar:
