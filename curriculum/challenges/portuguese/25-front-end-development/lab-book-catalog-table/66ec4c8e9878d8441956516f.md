...
1. A linha no elemento de rodapé da tabela deve ter um elemento de dados de tabela que abranja quatro colunas e que tenha o texto `Total Books: [number of books in your table]`.
