...
Entfernen Sie außerdem die `.box`-CSS-Regel und deren Deklarationen, da Sie diese nicht mehr benötigen.

# --hints--

Sie sollten die `.box`-CSS-Regel und alle ihre Werte entfernen.
