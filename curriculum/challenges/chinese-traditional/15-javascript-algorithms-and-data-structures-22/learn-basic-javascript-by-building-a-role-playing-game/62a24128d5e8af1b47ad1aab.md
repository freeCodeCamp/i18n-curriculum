...
使用選擇器列表（`selector1, selector2`）爲 `#controls` 和 `#stats` 元素提供 `1px solid #0a0a23` 的 `border`、`#0a0a23` 的文本顏色和 `5px` 的 `padding`。
