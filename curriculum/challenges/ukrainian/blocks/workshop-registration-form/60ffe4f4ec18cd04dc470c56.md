...
Перемістіть властивість і значення `min-height`, щоб усі три типи елементів мали однакове значення `min-height`, а елемент `select` все ще мав білий фон.
...
Ви повинні надати селектору `input, textarea, select` `min-height` зі значенням `2em`.
