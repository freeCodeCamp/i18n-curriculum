...
Vivyo hivyo, watumizi wanapaswa kuwa na uwezo wa kubofya anwani ya barua pepe na kutuma barua pepe kutoka kwa mteja wao wa barua pepe wa chaguo-msingi.

Hapa ni jinsi unavyoweza kufanya anwani za barua pepe ziwe zinazoweza kubofywa:

```html
<a href="mailto:contact@company.com">contact@company.com</a>
```

Kwa hatua hii ya mwisho, zungusha maandishi `fake@email.com` katika kipengele cha nanga na tumia `mailto:` kuifanya kuwa anwani ya barua pepe inayoweza kubofywa.

Na kwa mabadiliko hayo, ukurasa wako wa blogu sasa umekamilika.

# --hints--

Unapaswa kuzungusha maandishi `fake@email.com` katika kipengele cha `a`.
...
Kipengele chako cha `a` kinapaswa kuwa na sifa ya `href`.
...
Sifa ya `href` kwa kipengele chako kipya cha `a` inapaswa kuwekwa kuwa `mailto:fake@email.com`.
