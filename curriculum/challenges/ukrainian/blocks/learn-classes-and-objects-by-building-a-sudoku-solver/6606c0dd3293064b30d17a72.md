...
Чудово! `7` відсутній у першому рядку судоку, і метод каже, що `7` є допустимим вибором для цього рядка.

Тепер видаліть виклик `print`.

# --hints--

У вашому коді не повинно бути `print(gameboard.valid_in_row(0, 7))`.
