...
将 `:root` 选择器添加到媒体查询的顶部。 然后重新定义所有四个 `--building-color` 变量，值为 `#000`。

# --hints--

你应该在媒体查询中添加一个 `:root` 选择器。
