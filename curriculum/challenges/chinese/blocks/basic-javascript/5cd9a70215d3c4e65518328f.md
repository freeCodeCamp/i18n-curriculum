...
在<a href="/learn/javascript-algorithms-and-data-structures/basic-javascript/replace-loops-using-recursion" target="_blank" rel="noopener noreferrer nofollow">之前的挑战</a>中，你学习了如何使用递归来替代 `for` 循环。现在，让我们来看一个更复杂的函数，它返回一个从 `1` 开始到传入函数的数字的连续整数数组。
