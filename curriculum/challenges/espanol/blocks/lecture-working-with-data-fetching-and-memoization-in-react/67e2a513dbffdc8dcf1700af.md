...
Para hacer esto, podemos modificar la función `addTask` con un estado pendiente y simular un retraso de unos segundos antes de marcar la tarea como completada. `setTimeout()` es ideal para esto:
