...
Ifuatayo, tengeneza darasa la vitu dogo linaloitwa `Bee` ambalo linaongeza darasa la vitu `Bug` na kigezo cha aina ya jumla kikiwa `string`.

# --hints--

Unapaswa kuwa na darasa la vitu linaloitwa `Bee`.
...
Darasa lako la vitu `Bee` linapaswa kuongeza `Bug`.
...
Darasa lako la vitu `Bee` linapaswa kuongeza `Bug` na hoja ya aina `string`.
