...
A continuación, crea un arreglo vacío llamado `allSongs` para almacenar todas las canciones.

# --hints--

Deberías tener una variable llamada `allSongs`.

```js
assert.isDefined(allSongs)
```

Deberías asignar un arreglo a tu variable `allSongs`.
