...
Typography ya vipengele vya kichwa cha sehemu (mfano `h1`, `h2`) imewekwa kwa thamani za chaguo-msingi za vivinjari vya watumiaji.

Ongeza vichaguzi viwili vipya vya aina (`h1` na `h2`). Tumia sifa ya `font-size` kwa vyote viwili, lakini tumia thamani ya `40px` kwa `h1` na `30px` kwa `h2`.
...
Kipengele chako cha `h1` kinapaswa kuwa na sifa ya `font-size` yenye thamani ya `40px`.
...
Kipengele chako cha `h2` kinapaswa kuwa na sifa ya `font-size` yenye thamani ya `30px`.
