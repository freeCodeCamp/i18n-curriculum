...
これは、最初に行われて、より完全なものを計画したり準備したりするためのものを意味します。

# --explanation--

`Preliminary` は、より完全または最終的なものを準備するために最初に行われることを表します。例えば：

`We shared a preliminary version of the report for early review.` – これは、報告書を完成させる前にフィードバックを得るために初期の草案が配られたことを意味します。
