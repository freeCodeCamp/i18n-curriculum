...
Dentro do método `initializeEventListeners`, anexe um listener de evento `click` ao `singleCardBtn`. Dentro do manipulador do evento, faça a chamada do método `singleCardSelected`. Lembre-se de obter o `singleCardBtn` a partir de `elements`.
