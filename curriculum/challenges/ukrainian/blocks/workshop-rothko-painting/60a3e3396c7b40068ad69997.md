...
Поверніть `.three` фішку проти годинникової стрілки на 0.2 градуса.

З цим фінальним кроком ваша картина в стилі Ротко тепер завершена.

# --hints--

Ви повинні встановити властивість `transform` у `rotate(-0.2deg)`.
...
Ваш `.three` елемент має мати значення `transform` рівне `rotate(-0.2deg)`.
