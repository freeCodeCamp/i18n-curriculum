...
Calcola il **n**<sup>esimo</sup> termine di una <em>serie</em>, cioè la somma dei primi **n** termini della corrispondente <em>sequenza</em>. In modo informale questo valore, o il suo limite quando **n** tende all'infinito, è anche chiamato *somma della serie*, da cui il titolo di questa attività. Per questa attività, usa: $S_n = \displaystyle\sum_{k=1}^n \frac{1}{k^2}$.

# --instructions--

Scrivi una funzione che prenda $a$ e $b$ come parametri e restituisca la somma dei membri dal $a^{esimo}$ al $b^{esimo}$ della sequenza.
