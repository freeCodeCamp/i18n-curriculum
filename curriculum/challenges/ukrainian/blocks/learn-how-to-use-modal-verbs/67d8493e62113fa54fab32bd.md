...
This phrase is used to express gratitude for a specific action or support. Перша літера є з великою.

# --explanation--

`Thanks for` is commonly used to thank someone for something they did. It is followed by a noun or a verb in the `-ing` form (gerund). Наприклад:
