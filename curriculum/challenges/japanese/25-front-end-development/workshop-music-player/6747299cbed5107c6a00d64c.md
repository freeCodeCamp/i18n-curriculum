...
In the previous lecture, you learned about the <dfn>Web Audio API</dfn> and how to use it to play songs. 主要な最新のブラウザーはすべて Web Audio API をサポートしており、ウェブアプリケーション内で音声を生成および処理できます。
