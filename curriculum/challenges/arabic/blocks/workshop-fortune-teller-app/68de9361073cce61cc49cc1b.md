...
في محاضرة سابقة، تعلمت أن استنتاج النوع هو قدرة TypeScript على تحديد وتعيين الأنواع تلقائيًا للمتغيرات، وقيم إرجاع الدوال، والتعابير بناءً على استخدامها والسياق المحيط بها.

في TypeScript، تجعل الأنواع العامة الدوال، والصنف، والأنواع أكثر مرونة. تتيح الأنواع العامة إنشاء متغيرات نوع، مما يلغي الحاجة لتعريف الأنواع صراحةً في كل مرة. هذا يمكّن نفس الدالة من العمل بأمان مع أنواع مختلفة.

إليك مثالًا بسيطًا على الأنواع العامة:
...
يمكن للدوال استخدام نوعين عامين أو أكثر. يُستخدم `T` كاصطلاح، ويمكن إضافة متغيرات نوع إضافية مثل `S` حسب الحاجة.
...
أنشئ دالة `getElement` تأخذ `selector` من النوع `string` كمعلمة. يجب أن تأخذ أيضًا نوعًا عامًا `T` يمتد من `HTMLElement`، وأن يكون نوع الإرجاع `T`.

# --hints--

يجب أن تكون لديك دالة سهمية باسم `getElement`.
...
يجب أن تأخذ دالة `getElement` معلمة باسم `selector` من النوع `string`.
...
يجب أن يمتد النوع العام `T` من النوع `HTMLElement`.
...
يجب أن يكون لنوع إرجاع دالة `getElement` النوع `T`.
