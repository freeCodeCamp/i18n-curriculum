...
Потім використайте `id` під назвою `"sport"` із документа HTML та збережіть його в `const` змінній під назвою `typeOfSport`. Під цією змінною призначте `id` зі значенням `"year"` `const` змінній під назвою `worldCupYear`.

# --hints--

Ви повинні використати метод `document.getElementById()`, щоб отримати елемент `#sport`.
...
Ви повинні використати метод `document.getElementById()`, щоб отримати елемент `#year`.
