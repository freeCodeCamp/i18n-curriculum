...
У четвертому елементі `td` оновіть поточне значення, щоб натомість викликати функцію `viewCount` зі змінною `views` як аргумент.

# --hints--

Викличте функцію `viewCount` та передайте змінну `views` як аргумент.
