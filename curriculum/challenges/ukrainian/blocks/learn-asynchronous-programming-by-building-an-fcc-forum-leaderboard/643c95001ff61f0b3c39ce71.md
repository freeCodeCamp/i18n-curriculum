...
Всередині методу `map` деструктуруйте такі пропи з об’єкта `item`:
...
Ви маєте деструктурувати пропи `id`, `title`, `views`, `posts_count`, `slug`, `posters`, `category_id`, `bumped_at` з об’єкта `item`.
