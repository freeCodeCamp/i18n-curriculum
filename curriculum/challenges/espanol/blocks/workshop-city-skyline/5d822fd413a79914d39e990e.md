...
Dé a la clase `bb4-window` un `width` de `18%`, un `height` de `90%` y agregue su variable de `--window-color4` como el `background-color`.

# --hints--

Debe dar a `.bb4-window` un `width` de `18%`.
