...
أنشئ حلقة `while` فارغة تستمر طالما هناك حضور ينتظرون (`currentTickQueue > 0`) والبوابة لا تزال لديها سعة متبقية (`processed < gate.capacity`).

# --hints--

يجب أن يكون شرط حلقة `while` هو `currentTickQueue > 0` و `processed < gate.capacity`.
