...
Над другим викликом `move` додайте останній коментар із текстом `move the n - 1 disks that we left on auxiliary onto target`.

# --hints--

Ви повинні додати коментар, використовуючи наданий текст.
