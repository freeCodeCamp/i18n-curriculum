...
Додайте ще один `repeating-linear-gradient` під тим, який ви щойно додали. Дайте йому напрям `90deg`, використайте свій колір будівлі від `0%` до `12%` і колір вікна від `12%` до `44%`. Це створить багато прямокутних вікон.
...
Ви повинні дати другому `repeating-linear-gradient` напрям `90deg`.
