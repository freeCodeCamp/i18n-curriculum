...
Dentro del elemento `div`, llama a la función `avatars` y pasa los argumentos `posters` y `users`.

Ahora debes ver los avatares mostrados en la página.

# --hints--

Debes llamar a la función llamada `avatars`.
...
La llamada a tu función debe tener los argumentos `posters` y `users`.
