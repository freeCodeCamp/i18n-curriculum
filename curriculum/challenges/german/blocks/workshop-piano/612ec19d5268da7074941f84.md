...
Mit logischen Operatoren können komplexere Media Queries erstellt werden. Der logische `and`-Operator wird verwendet, um zwei Media Query-Bedingungen zu verwenden.
