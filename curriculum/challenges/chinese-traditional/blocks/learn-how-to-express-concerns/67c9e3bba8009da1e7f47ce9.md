...
Maria uses **reported speech** after `they said` to share what the team previously stated. In reported speech, verbs often shift to a past form, but `Present Continuous` (`are putting`) remains continuous (`they're already putting in extra hours`). 例如：
