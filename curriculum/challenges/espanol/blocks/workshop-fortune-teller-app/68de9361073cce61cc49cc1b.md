  ...
  <body>
    <main id="main_container">
      <header>
        <h1>Mystic Tarot</h1>
        <h6>
          Descubre la sabiduría de las cartas y desvela los misterios de tu camino
        </h6>
      </header>
      <div id="btn_title_container">
        <div class="title_wrapper">
          <h2 class="header_title">Elige tu lectura</h2>
        </div>
      ...
      <section class="fortune_container hidden">
        ...
        <h2 class="hidden text">Haz clic en la carta y revela la fortuna</h2>
        <div class="multiple_card hidden"></div>
        <div class="fortune_description hidden">
          <h2 class="title"></h2>
          <h5 class="sub_title"></h5>
          <div class="description_wrapper">
            <span class="desc_title">Descripción:</span>
            <p class="description"></p>
          </div>
        </div>
        <button class="btn_reveal">Nueva lectura</button>
      </section>
    </main>
