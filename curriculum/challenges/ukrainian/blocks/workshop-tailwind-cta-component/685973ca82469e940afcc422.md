...
Щоб завершити стилізацію кнопок, додайте утилітарний клас `font-semibold` до кожного елемента `a`, щоб їхній текст став жирнішим. Також додайте клас `rounded`, щоб прибрати гострі краї на кнопках.

# --hints--

Ваш перший елемент посилання має мати утилітарний клас `font-semibold`.
...
Ваш перший елемент посилання має мати утилітарний клас `rounded`.
...
Ваш другий елемент посилання має мати утилітарний клас `font-semibold`.
...
Ваш другий елемент посилання має мати утилітарний клас `rounded`.
