...
Verwenden Sie nun den **ODER**-Operator, um den `start`-Parameter als zweite Bedingung zur `if`-Anweisung nach `userData.currentSong === null` hinzuzufügen.


# --hints--

Sie sollten den **ODER**-Operator verwenden, um den `start`-Parameter als zweite Bedingung zur `if`-Anweisung nach `userData.currentSong === null` hinzuzufügen.
