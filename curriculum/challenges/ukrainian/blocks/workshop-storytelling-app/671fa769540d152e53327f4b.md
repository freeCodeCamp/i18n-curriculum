...
Виберіть кнопки `#scary-btn`, `#funny-btn` і `#adventure-btn` та збережіть їх у змінних з іменами `scaryStoryBtn`, `funnyStoryBtn` і `adventureStoryBtn`.

# --hints--

Ви повинні вибрати кнопку `#scary-btn` за допомогою методу `getElementById` і зберегти її у змінній `scaryStoryBtn`.
...
Ви повинні вибрати кнопку `#funny-btn` за допомогою методу `getElementById` і зберегти її у змінній `funnyStoryBtn`.
...
Ви повинні вибрати кнопку `#adventure-btn` за допомогою методу `getElementById` і зберегти її у змінній `adventureStoryBtn`.
