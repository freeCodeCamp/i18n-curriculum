...
`urgent updates`، `go straight`، `as well`، `keep it`، `quick shower`، `balanced`، و`don't do`.
...
هذه تُكوّن جملة نفي. تبدأ بفعل مساعد في صيغة النفي متبوعًا بالفعل الأساسي.
...
هذه تصف حركة مباشرة. تبدأ بفعل متبوعًا بحال.
...
هذه تصف روتين استحمام قصير. تبدأ بصفة متبوعة باسم.
...
هذا يعني "الحفاظ على شيء بطريقة معينة". يبدأ بفعل متبوعًا بضمير.
...
هذا يشير إلى معلومات جديدة مهمة. يبدأ بصفة متبوعة باسم جمع.
...
هذا يعني "أيضًا" أو "بالإضافة إلى ذلك". يبدأ بحال متبوعًا بآخر.
