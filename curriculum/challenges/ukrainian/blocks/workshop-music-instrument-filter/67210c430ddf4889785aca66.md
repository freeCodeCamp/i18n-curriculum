...
Перед тим як почати додавати функціонал фільтрації на вашу сторінку, підключіть свій файл `script.js` до HTML.

# --hints--

У вас має бути елемент `script` з атрибутом `src`, встановленим у `script.js`.
