...
Додайте осі x та y до графіка, щоб отримати такий вихід:
...
Символи доступні як `x_axis_tick` та `y_axis_tick`.

# --hints--

Метод має повертати правильний вихід.
...
Метод має повертати правильний вихід для різних екземплярів.
