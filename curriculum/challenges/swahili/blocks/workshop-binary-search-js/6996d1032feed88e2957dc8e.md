...
Unaweza kuona kuwa wito wa mwisho unachapisha safu tupu. Ili kubainisha zaidi kuwa thamani haipo katika safu iliyotafutwa, sasisha kauli ya `return` ili irudishe safu yenye vipengele viwili: safu tupu na mfuatano wa herufi `Value not found`.

# --hints--

Unapaswa kusasisha tamko la `return` ili lirudishe `[], 'Value not found'`.
