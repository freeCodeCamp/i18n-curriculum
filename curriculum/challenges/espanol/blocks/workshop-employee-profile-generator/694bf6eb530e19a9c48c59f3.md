...
Luego, crea una variable `experience_info`. Asígnale una cadena formada al concatenar `'Experience: '`, la variable `experience_years` (convertida a cadena) y `' years'`, usando el operador `+`. Imprime el resultado en la terminal.
