...
| Performance API        | Melhor Para                                           |
| :--------------------- | :------------------------------------------------- |
| `performance.now()`    | Temporização precisa de funções e scripts            |
| Performance Timing API | Medir o desempenho completo de carregamento da página             |
| Performance Observer   | Monitorar em tempo real as interações e renderização |
