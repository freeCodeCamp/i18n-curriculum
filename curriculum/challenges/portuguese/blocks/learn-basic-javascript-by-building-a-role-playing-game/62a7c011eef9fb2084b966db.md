...
Mova a função `goTown` para antes da função `goStore`.Em seguida, copie e cole o conteúdo da função `goStore` na função `goTown`.

# --hints--

A função `goTown` deve vir antes da função `goStore`.
...
A função `goTown` deve ter o mesmo conteúdo que a função `goStore`.
