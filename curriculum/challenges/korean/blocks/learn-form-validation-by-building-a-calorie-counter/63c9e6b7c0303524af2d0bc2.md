...
보간을 사용해 `remainingCalories Calorie surplusOrDeficit`과 `remainingCalories`를 적절한 변수로 바꾸어 span에 `surplusOrDeficit` 텍스트를 넣으세요.

# --hints--

`span`에 `${remainingCalories} Calorie ${surplusOrDeficit}` 텍스트가 있어야 합니다.
