...
Нехай $S(n, m) = \sum φ(n × i)$ для $1 ≤ i ≤ m$. ($φ$ — функція Ейлера)

Відомо, що $S(510\\,510, {10}^6) = 45\\,480\\,596\\,821\\,125\\,120$.

Знайдіть $S(510\\,510, {10}^{11})$. Наведіть останні 9 цифр вашої відповіді.
