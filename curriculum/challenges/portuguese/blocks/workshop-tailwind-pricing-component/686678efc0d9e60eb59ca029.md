...
O badge pode ser estilizado melhor. Para isso, você usará algumas classes de gradiente do Tailwind. Aqui está como você pode usar estilos de gradiente no Tailwind:
