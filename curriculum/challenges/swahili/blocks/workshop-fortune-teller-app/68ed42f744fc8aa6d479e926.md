...
Sasa ongeza sifa zilizobaki kwenye kitu binafsi cha `elements`. Ni hizi: `multipleCard`, `title`, `newReadingBtn`, `fortuneContainer`, `fortuneDescription`, `headerTitle`, `subTitle`, `cardTitle`, `description`, na `text`. Hakikisha kila sifa inatumia aina ya `HTMLElement`.

# --hints--

Unapaswa kuwa na sifa ya `multipleCard` ndani ya sifa ya `elements` imepewa aina ya `HTMLElement`.
...
Unapaswa kuwa na sifa ya `title` ndani ya sifa ya `elements` imepewa aina ya `HTMLElement`.
...
Unapaswa kuwa na sifa ya `newReadingBtn` ndani ya sifa ya `elements` imepewa aina ya `HTMLElement`.
...
Unapaswa kuwa na sifa ya `fortuneContainer` ndani ya sifa ya `elements` imepewa aina ya `HTMLElement`.
...
Unapaswa kuwa na sifa ya `fortuneDescription` ndani ya sifa ya `elements` imepewa aina ya `HTMLElement`.
...
Unapaswa kuwa na sifa ya `headerTitle` ndani ya sifa ya `elements` imepewa aina ya `HTMLElement`.
...
Unapaswa kuwa na sifa ya `subTitle` ndani ya sifa ya `elements` imepewa aina ya `HTMLElement`.
...
Unapaswa kuwa na sifa ya `cardTitle` ndani ya sifa ya `elements` imepewa aina ya `HTMLElement`.
...
Unapaswa kuwa na sifa ya `description` ndani ya sifa ya `elements` imepewa aina ya `HTMLElement`.
...
Unapaswa kuwa na sifa ya `text` ndani ya sifa ya `elements` imepewa aina ya `HTMLElement`.
