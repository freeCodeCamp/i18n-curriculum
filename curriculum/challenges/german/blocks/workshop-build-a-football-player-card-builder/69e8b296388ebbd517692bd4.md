...
Ihr drittes `div`-Element von `className` von `form-group` sollte ein `label` mit einem `htmlFor`-Attribut von `pas`, einem `className` von `label` und einem Text `PAS` haben.
...
Ihr drittes `div`-Element von `className` von `form-group` sollte ein `input` mit einem `className` von `input`, ein `id` von `pas` und ein `type` von `number` haben.
...
Ihr viertes `div`-Element von `className` von `form-group` sollte ein `label` mit einem `htmlFor`-Attribut von `dri`, einem `className` von `label` und einem Text `DRI` haben.
...
Ihr viertes `div`-Element von `className` von `form-group` sollte ein `input` mit einem `className` von `input`, ein `id` von `dri` und ein `type` von `number` haben.
