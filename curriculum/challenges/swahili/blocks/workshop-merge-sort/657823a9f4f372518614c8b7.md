...
Bado ukiwa ndani ya `else` block, ongeza `right_array_index` kwa `1`.

# --hints--

Unapaswa kuongeza `1` kwenye thamani ya sasa ya `right_array_index` baada ya kuingiza kipengele kwenye safu ya data iliyopangwa.
