...
Ahora, convierte los cuatro patrones de la lista `constraints` en cadenas sin procesar.

# --hints--

Debes convertir las cuatro cadenas dentro de la lista `constraints` en cadenas raw.
