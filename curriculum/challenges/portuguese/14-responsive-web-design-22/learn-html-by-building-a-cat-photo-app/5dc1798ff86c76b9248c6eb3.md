...
Your `h1` element's text should be `CatPhotoApp`. Você omitiu o texto ou tem um erro de digitação.
...
Your `h2` element's text should be `Cat Photos`. Coloque apenas o texto `Cat Photos` entre as tags de abertura e de fechamento de `h2`.
