...
Juu ya wito wa pili wa `move`, ongeza maoni ya mwisho ukisema `move the n - 1 disks that we left on auxiliary onto target`.

# --hints--

Unapaswa kuongeza maoni ukitumia maandishi yaliyotolewa.
