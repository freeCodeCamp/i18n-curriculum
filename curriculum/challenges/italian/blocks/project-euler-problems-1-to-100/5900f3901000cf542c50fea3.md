...
title: 'Problema 36: palindromi a doppia base'
challengeType: 1
forumTopicId: 302020
...
Il numero decimale 585 = 1001001001<sub>2</sub> (binario) è palindromo in entrambe le basi.

Trova la somma di tutti i numeri, minori di `n`, con 1000 ≤ `n` ≤ 1000000, che sono palindromi in base 10 e base 2.

(Si noti che il numero palindromo, in entrambe le basi, non può includere zeri iniziali.)
