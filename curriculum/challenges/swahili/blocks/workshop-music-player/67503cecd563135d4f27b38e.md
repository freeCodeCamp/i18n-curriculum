...
Sasa ni wakati wa kujaribu kitendakazi cha `playNextSong`.

Ongeza msikilizaji wa tukio la `"click"` kwenye kipengele cha `nextButton`, kisha pita `playNextSong` kama hoja ya pili ya msikilizaji wako wa tukio. Huu ndio kitendakazi ambacho msikilizaji wa tukio utaendesha.

Jaribu programu yako kwa kubofya kwanza kitufe cha kucheza kisha kitufe cha kuendelea. Unapaswa kuona kuwa kila kitu kinafanya kazi kama inavyotarajiwa.

# --hints--

Unapaswa kuita njia ya `addEventListener()` kwenye kigezo chako cha `nextButton`.
...
Unapaswa kupitisha `playNextSong` kama hoja ya pili ya njia yako ya `addEventListener`.
