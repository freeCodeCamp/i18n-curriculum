...
لأغراض تصحيح الأخطاء، أضف استدعاء `console.log()` في الحلقة الداخلية. مرر له المعلمات `array`، `array[j]`، و `array[j+1]`.

# --hints--

يجب استخدام استدعاء `console.log()` في الحلقة الداخلية.
...
يجب تمرير `array` كالمعلمة الأولى إلى `console.log()`.
...
يجب تمرير `array[j]` كالمعلمة الثانية إلى `console.log()`.
...
يجب تمرير `array[j+1]` كالمعلمة الثالثة إلى `console.log()`.
