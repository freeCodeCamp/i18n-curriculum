...
title: Telefonnummern-Validator
challengeType: 5
...
Geben Sie `true` zurück, wenn der übergebene String wie eine gültige US-Telefonnummer aussieht.

Der Benutzer kann das Formularfeld beliebig ausfüllen, solange es das Format einer gültigen US-Nummer hat. Die folgenden Beispiele zeigen gültige Formate für US-Nummern (siehe die Tests unten für weitere Varianten):

<blockquote>555-555-5555<br>(555)555-5555<br>(555) 555-5555<br>555 555 5555<br>5555555555<br>1 555 555 5555</blockquote>

Für diese Aufgabe erhalten Sie einen String wie `800-692-7753` oder `8oo-six427676;laskdjf`. Ihre Aufgabe ist es, die US-Telefonnummer basierend auf einer beliebigen Kombination der oben angegebenen Formate zu validieren oder abzulehnen. Die Vorwahl ist erforderlich. Wenn die Landesvorwahl angegeben ist, müssen Sie bestätigen, dass die Landesvorwahl `1` ist. Geben Sie `true` zurück, wenn der String eine gültige US-Telefonnummer ist; andernfalls geben Sie `false` zurück.
...
`telephoneCheck()`, wenn mit einer gültigen Nummer aufgerufen, sollte `true` zurückgeben.
...
`telephoneCheck()`, wenn mit einer ungültigen Nummer aufgerufen, sollte `false` zurückgeben.
