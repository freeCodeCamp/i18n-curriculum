...
Você deve ter um `<ol>` com os passos conforme os itens da lista `<li>`.
...
As tags de âncora ligadas às receitas devem ter um atributo `href` com o valor definido como `#`.
