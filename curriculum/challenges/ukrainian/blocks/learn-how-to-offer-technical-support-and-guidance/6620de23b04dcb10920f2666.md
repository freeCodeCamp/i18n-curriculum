...
Чому Сара наголошує на включенні коментарів у код?
...
Коментарі в коді не впливають на швидкість виконання коду. Вони призначені для розуміння людьми.
...
Хоча коментарі корисні, вони не є обов’язковими у всіх мовах програмування.
...
Коментарі допомагають зрозуміти код, але безпосередньо не запобігають помилкам у коді.
