...
Primeiro, registre a seguinte mensagem no console: `"\nProcessing " + gate.id + "..."`.

# --hints--

Sua função `handleGateAtTick` deve primeiro registrar a seguinte mensagem no console, `"\nProcessing " + gate.id + "..."`.
...
Sua função `handleGateAtTick` deve registrar o id correto do portão na mensagem.
