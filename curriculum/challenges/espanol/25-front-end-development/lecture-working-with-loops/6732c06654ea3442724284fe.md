...
En vídeos de conferencias anteriores, aprendiste a trabajar con bucles `for`, bucles `for...in` y bucles `for...of`. En esta conferencia, aprenderás sobre el bucle `while` y el bucle `do...while`.
