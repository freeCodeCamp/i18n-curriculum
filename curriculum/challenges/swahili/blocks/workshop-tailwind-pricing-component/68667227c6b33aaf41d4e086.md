...
Ili kuweka vitu katika kadi mahali pake, unahitaji tena madarasa la gridi. Weka madarasa ya huduma `grid`, `grid-rows-[1fr_auto]`, na `gap-6` kwenye kifungashio `div`.

Pia, ondoa pembe kali kwa kutumia darasa `rounded-xl`.

# --hints--

Kifungashio chako `div` kwa mpango wa premium kinapaswa kuwa na darasa `grid`.
...
Kifungashio chako `div` kwa mpango wa premium kinapaswa kuwa na darasa `grid-rows-[1fr_auto]`.
...
Kifungashio chako `div` kwa mpango wa premium kinapaswa kuwa na darasa `gap-6`.
...
Kifungashio chako `div` kwa mpango wa premium kinapaswa kuwa na darasa `rounded-xl`.
