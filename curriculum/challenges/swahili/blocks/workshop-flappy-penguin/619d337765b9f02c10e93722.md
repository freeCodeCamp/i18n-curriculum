...
Kwa njia ya tatu na ya nne, rudia muundo wa `transform` mara moja zaidi.

# --hints--

Unapaswa kumpa njia ya `30%` `transform` ya `rotate(110deg) scaleX(-1)`.
...
Unapaswa kumpa njia ya `40%` `transform` ya `rotate(130deg) scaleX(-1)`.
