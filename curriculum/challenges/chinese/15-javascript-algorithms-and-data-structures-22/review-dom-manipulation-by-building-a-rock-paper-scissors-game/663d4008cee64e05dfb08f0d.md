...
完成 `showResults` 函数。 `playerScoreSpanElement` 和 `computerScoreSpanElement` 应该更新以显示玩家和电脑的最新得分。

`roundResultsMsg` 也应该更新为该轮比赛的结果。

**提示：**

- 记得你学过如何使用 `innerText` 属性来更新元素的文本内容。
- 你可以使用 `getRoundResults` 函数来获取比赛结果。
