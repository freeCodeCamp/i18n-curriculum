...
يجب عليك إعطاء `.fb6` وظيفية `repeating-linear-gradient` ثانية في خاصية `background`.
...
يجب عليك إضافة `repeating-linear-gradient` يحمل المتغير الأول `--building-color3` كقيمة للون, يبدأ من `0%` وينتهي في `10%`.
...
يجب عليك إضافة `repeating-linear-gradient` يحمل المتغير الثاني `--window-color3` كقيمة للون, يبدأ من `10%` وينتهي في `30%`.
