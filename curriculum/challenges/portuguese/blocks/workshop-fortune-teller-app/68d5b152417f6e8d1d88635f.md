...
Há mais propriedades para adicionar à interface `Card`. Comece definindo `value_int` com o tipo `number`. Todas as outras propriedades devem ser do tipo `string`: `suit`, `type`, `img`, `meaning_up`, `meaning_rev` e `desc`.

# --hints--

Você deve ter uma propriedade `value_int` com o tipo `number`.
...
Você deve ter uma propriedade `suit` com o tipo `string`.
...
Você deve ter uma propriedade `type` com o tipo `string`.
...
Você deve ter uma propriedade `img` com o tipo `string`.
...
Você deve ter uma propriedade `meaning_up` com o tipo `string`.
...
Você deve ter uma propriedade `meaning_rev` com o tipo `string`.
...
Você deve ter uma propriedade `desc` com o tipo `string`.
