...
Ndani ya `tr` ya pili, ongeza kipengele cha `th` chenye maandishi `Expenses Annual anticipated expenses, such as payroll.`. Zungusha maandishi hayo, isipokuwa `Expenses `, ndani ya kipengele cha `span` chenye sifa ya `class` iliyowekwa kuwa `description`.

Ongeza vipengele vitatu vya `td` chini ya hapo, na uwape maandishi yafuatayo kwa mpangilio: `$200`, `$300`, na `$400`. Toa kipengele cha tatu cha `td` sifa ya `class` iliyowekwa kuwa `current`.
...
Kipengele chako cha `th` kinapaswa kuwa na maandishi ya `Expenses Annual anticipated expenses, such as payroll.`.
...
Unapaswa kuzungusha maandishi ya `Annual anticipated expenses, such as payroll.` ndani ya kipengele cha `span`.
