...
Your `main` element's opening tag should be below the `body` element's opening tag. Вони знаходяться в неправильному порядку.
...
Your `main` element's opening tag should be above the `h1` element. Вони знаходяться в неправильному порядку.
...
Your `main` element's closing tag should be below the `p` element. Вони знаходяться в неправильному порядку.
