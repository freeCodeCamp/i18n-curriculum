...
Neste workshop, você praticará o uso de formulários HTML construindo um Formulário de Feedback de Hotel.

Comece adicionando o `<!DOCTYPE html>` seguido por um elemento `html` com um atributo `lang` igual a `en`.

Dentro do seu elemento `html`, adicione um elemento `head`.
