...
Ten en cuenta que `getUserMedia()` devuelve una Promise, lo que significa que necesitarás una función callback para consumir el stream, o usar la sintaxis async/await. Aprenderás más sobre Promises y programación asíncrona en lecciones futuras. 
...
Vale la pena destacar que esta API no ofrece acceso a la captura de pantalla. Aprenderás sobre esa API en la siguiente lección.
