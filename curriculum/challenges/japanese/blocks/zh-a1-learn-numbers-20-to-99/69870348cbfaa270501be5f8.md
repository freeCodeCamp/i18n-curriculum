...
11から19までの数字は、`十 (shí)`（10）の後に1から9までの一の位の数字を付けて作られることがわかりました。同じルールが21から29までの数字にも当てはまります。

中国語で20は`二十 (èr shí)`と呼ばれます。

21から29までの数字を作るには、`二十 (èr shí)`（20）に一の位の数字（1から9）を直接付け加えます。
