...
Se hai più condizioni da gestire, puoi concatenare le istruzioni `if` con le istruzioni `else if`.
...
Dovresti avere parentesi graffe di apertura e chiusura per ogni blocco di codice `if else`.
