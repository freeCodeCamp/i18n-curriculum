...
Por fim, em `head`, o elemento `title` é útil para que os leitores de tela entendam o conteúdo de uma página. Além disso, é uma parte importante do *SEO*.
...
Tente ser mais descritivo com seu elemento `title`. *Dica: Pelo menos 15 caracteres*
