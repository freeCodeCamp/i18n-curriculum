...
Elencando l'insieme delle frazioni proprie ridotte per `d` ≤ `limit` in ordine crescente di grandezza, trova il numeratore della frazione immediatamente a sinistra di $\frac{3}{7}$.
