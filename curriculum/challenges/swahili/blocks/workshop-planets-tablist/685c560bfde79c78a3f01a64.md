...
Kwa kuwa `associatedPanel` ni `id`, hiyo itakuwezesha kufanya hoja ya utafutaji kwenye hati na kupata kipengele cha paneli kinacholingana. 

Unda kigezo kipya kinachoitwa `panel` na weka thamani yake kuwa `document.getElementById(associatedPanel)`. 

# --hints--

Unapaswa kuwa na kigezo kinachoitwa `panel` kinachoshikilia kipengele cha paneli kinachohusiana na kichupo kilichobofyiwa.
