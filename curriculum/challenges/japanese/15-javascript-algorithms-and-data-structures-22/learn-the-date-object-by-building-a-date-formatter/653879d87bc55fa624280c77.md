...
`.getElementById()` メソッドを使用して `#date-options` の要素を取得し、`const` を使用して `dateOptionsSelectElement` という名前の変数に代入してください。

# --hints--

`const` を使用して `dateOptionsSelectElement` という変数を宣言してください。
