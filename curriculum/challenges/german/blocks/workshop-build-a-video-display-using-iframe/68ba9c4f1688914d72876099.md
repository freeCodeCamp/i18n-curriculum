...
Zu guter Letzt fügen Sie das Attribut `allowfullscreen` hinzu. Wie der Name schon sagt, ermöglicht es, das Video im Vollbildmodus anzusehen.

Damit ist der Workshop abgeschlossen!

# --hints--

Ihr `iframe`-Element sollte ein `allowfullscreen`-Attribut haben.
