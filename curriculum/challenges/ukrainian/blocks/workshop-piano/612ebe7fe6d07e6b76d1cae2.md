...
Додайте новий `#piano` селектор у вашому `@media` запиті та встановіть `width` у `358px`.

# --hints--

Ваше правило `@media` має містити `#piano` селектор.
...
Ваш новий `#piano` селектор має мати `width` зі значенням `358px`.
