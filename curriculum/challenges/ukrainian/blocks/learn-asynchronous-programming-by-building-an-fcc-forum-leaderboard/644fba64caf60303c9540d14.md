...
Після атрибута `href` встановіть атрибут `class` до константи під назвою `linkClass`.

Після атрибута `class` встановіть атрибут `target` на `"_blank"`.

Наприкінці, розмістіть константу `linkText` між тегами прив’язки, щоб показати текст у посиланні.

# --hints--

Ви повинні мати атрибут `class` після атрибута `href`.
...
Встановіть значення атрибута `class` на константу під назвою `linkClass`.
...
Ви повинні мати атрибут `target` після атрибута `class`.
...
Встановіть значення атрибута `target` на `"_blank"`.
...
Використайте константу `linkText` між тегами прив’язки.
