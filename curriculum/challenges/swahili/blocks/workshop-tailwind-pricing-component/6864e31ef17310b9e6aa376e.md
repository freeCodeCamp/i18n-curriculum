...
Vipande vya gridi viko karibu sana na kingo za kushoto na kulia za ukurasa, kwa hivyo unapaswa kufanya kazi kwenye nafasi kati yao.

Weka darasa la `max-w-6xl` kwa `div` ili kuweka upana thabiti wa `72rem` na kuzuia vipande visiene mbali sana kwenye ukurasa.

Kwa kuwa hilo litasukuma vyote kushoto, ongeza `mx-auto` kwa `div` ili kuweka vipande katikati kwa usawa wa usawa.

# --hints--

Kipengele chako cha `div` kinapaswa kuwa na darasa la `max-w-6xl`.
...
Kipengele chako cha `div` kinapaswa kuwa na darasa la `mx-auto`.
