...
Ifuatayo, andika ujumbe ufuatao kwenye konsoli: `gate.queue[tickIndex] + " attendees arriving."`.

# --hints--

Kitendakazi chako cha `handleGateAtTick` kinapaswa kuandika ujumbe ufuatao kwenye konsoli: `gate.queue[tickIndex] + " attendees arriving."`.
...
Kitendakazi chako cha `handleGateAtTick` kinapaswa kuandika idadi sahihi ya washiriki kulingana na foleni ya lango kwa kielezo cha tickIndex kilichotolewa.
