...
`Guess` is used when you're uncertain about something, but you still form an opinion or make a suggestion. Por ejemplo:
...
`Consider` means to think carefully about something, often before making a decision. Por ejemplo:
