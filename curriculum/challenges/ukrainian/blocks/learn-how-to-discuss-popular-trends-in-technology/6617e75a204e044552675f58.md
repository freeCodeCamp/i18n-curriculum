...
У цьому завданні ви попрактикуєтеся у тому, що вивчили в попередніх завданнях. Прослухайте діалог і виберіть правильну відповідь.

# --questions--

## --text--

Яка відповідь найкраще описує AI?
...
Обговорення не про небо. Пам’ятайте, цей урок про штучний інтелект.
...
У розмові згадують розумні машини, але не лише для автоматизованої взаємодії. Шукайте ширше поняття.
...
Концепція передового винаходу не згадується в обговоренні. Подумайте про конкретний тип інтелекту.
