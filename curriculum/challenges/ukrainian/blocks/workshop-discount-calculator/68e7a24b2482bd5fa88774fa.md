...
Тепер видаліть наступні лінії знизу вашого коду:
...
У вашому коді не повинно бути лінії `print(product)`.
...
У вашому коді не повинно бути лінії `discount = PercentageDiscount(10)`.
...
У вашому коді не повинно бути лінії `print(discount.apply_discount(product))`.
...
У вашому коді не повинно бути лінії `fixed_discount = FixedAmountDiscount(5)`.
...
У вашому коді не повинно бути лінії `print(fixed_discount.apply_discount(product))`.
