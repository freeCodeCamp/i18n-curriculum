...
Ni wakati wa kufanya kazi kwenye kipengele cha `div` kinachozunguka kadi tatu za bei. Ili kupanga kadi hizo, unaweza kutumia madarasa ya zana ya grid ya Tailwind CSS.

Hivi ndivyo unavyoweza kuweka thamani ya onyesho la `grid` kwa kipengele kwa kutumia Tailwind:
...
Weka darasa la `grid` kwa kipengele cha `div` kinachozunguka kadi za bei.

# --hints--

Kipengele chako cha `div` kinapaswa kuwa na darasa la `grid`.
