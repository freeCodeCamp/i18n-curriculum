...
Le docstring possono essere consultate tramite l'attributo `__doc__`, che è impostato su `None` per impostazione predefinita.

Verificalo stampando `movie1.__doc__` e `series1.__doc__`. Nota che l'attributo `__doc__` non viene ereditato da nessuna classe figlio.

# --hints--

Dovresti stampare `movie1.__doc__`.
...
Dovresti stampare `series1.__doc__`.
