...
title: Schriftgröße eines Elements ändern
challengeType: 0
...
Innerhalb des gleichen `<style>`-Tags, das auch deine `red-text` Klasse enthält, erstelle einen Eintrag für `p`-Elemente und setze `font-size` auf 16 Pixel (`16px`).
