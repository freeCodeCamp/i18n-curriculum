...
**目标：** 构建一个功能上类似于此的应用程序：<a href="https://choropleth-map.freecodecamp.rocks" target="_blank" rel="noopener noreferrer nofollow">https://choropleth-map.freecodecamp.rocks</a>。
...
- **美国教育数据：**`https://cdn.freecodecamp.org/testable-projects-fcc/data/choropleth_map/for_user_education.json`
- **美国县级数据：**`https://cdn.freecodecamp.org/testable-projects-fcc/data/choropleth_map/counties.json`
