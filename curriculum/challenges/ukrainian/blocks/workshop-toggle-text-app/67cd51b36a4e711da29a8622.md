...
Щоб переключати видимість тексту, спочатку потрібно створити функцію, яка буде відповідати за цю поведінку.

Почніть зі створення нової функції з назвою `handleToggleVisibility`. 

# --hints--

У вас має бути функція `handleToggleVisibility`.
