...
На маленьких екранах неупорядкований список в навігаційній панелі перекриває праву частину екрану.

Виправте це з допомогою _Flexbox_, щоб перенести вміст `ul`. Потім встановіть наступні властивості CSS, щоб правильно вирівняти текст:
