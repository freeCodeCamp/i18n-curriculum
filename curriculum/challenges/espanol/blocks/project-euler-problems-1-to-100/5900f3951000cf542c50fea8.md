...
title: 'Problema 41: primo pandigital'
challengeType: 1
forumTopicId: 302078
...
¿Cuál es el mayor primo pandigital de dígitos de longitud `n` que existe?

# --hints--

`pandigitalPrime(4)` debería devolver un número.

```js
assert(typeof pandigitalPrime(4) === 'number');
```

`pandigitalPrime(4)` debería devolver 4231.

```js
assert(pandigitalPrime(4) == 4231);
```

`pandigitalPrime(7)` debería devolver 7652413.
