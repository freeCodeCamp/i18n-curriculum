...
Щоб досягти ефекту "спливання", потрібно перевірити, чи є поточний елемент більшим за наступний. Ви можете зробити це, отримуючи доступ до `array` за `j` та `j+1`.

Створіть умову `if`, яка перевіряє, чи є поточний елемент більшим за наступний.

# --hints--

Ви не повинні видаляти вашу інструкцію `console.log`.
...
Ви повинні використовувати інструкцію `if` у вашому вкладеному циклі.
...
Ваша інструкція `if` має перевіряти, чи `array[j]` більший за `array[j+1]`.
