...
بعد ذلك، استخدم استيفاء السلسلة النصية لتعيين خاصية `id` إلى الخاصية `inputVal` للكائن الحالي `obj`.

# --hints--

يجب أن تستخدم استيفاء السلسلة النصية لتعيين خاصية `id` إلى الخاصية `inputVal` في `obj`.
