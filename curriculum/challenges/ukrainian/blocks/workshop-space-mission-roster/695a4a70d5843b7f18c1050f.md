...
Безпосередньо відсортуйте локальний масив `sorted`, використовуючи вашу допоміжну функцію `sortByPriorityDescending()`.

# --hints--

Ви маєте викликати `sortByPriorityDescending()` з масивом `sorted`.
