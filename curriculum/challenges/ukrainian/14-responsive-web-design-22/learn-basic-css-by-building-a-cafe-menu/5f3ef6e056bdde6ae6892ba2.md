...
Трішки нудно, якщо всі тексти мають однаковий `font-family`. Ви можете мати більшу частину тексту `sans-serif` і зробити різними лише елементи `h1` та `h2`, використовуючи інший селектор.

Стилізуйте обидва елементи `h1` та `h2` за допомогою одного селектора, щоб текст цих елементів використовував шрифт `Impact`.
