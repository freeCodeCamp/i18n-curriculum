...
調整 `verify_card_number` 呼叫，使其如果傳回 `True`，則在主控台列印 `'VALID!'`。否則，列印 `'INVALID!'`。

# --hints--

你應該在 `main` 函式中包含 `if verify_card_number(translated_card_number):`。
