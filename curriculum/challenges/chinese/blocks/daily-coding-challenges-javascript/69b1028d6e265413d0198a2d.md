...
给定一个数字数组，其中所有数字除了一个都遵循某种模式，返回一个新数组，将那个不符合模式的数字修正。
...
例如，给定 `[2, 4, 7, 8, 10]`，返回 `[2, 4, 6, 8, 10]`。

# --hints--

`fixPrankNumber([2, 4, 7, 8, 10])` 应该返回 `[2, 4, 6, 8, 10]`。

```js
assert.deepEqual(fixPrankNumber([2, 4, 7, 8, 10]), [2, 4, 6, 8, 10]);
```

`fixPrankNumber([10, 10, 8, 7, 6])` 应该返回 `[10, 9, 8, 7, 6]`。

```js
assert.deepEqual(fixPrankNumber([10, 10, 8, 7, 6]), [10, 9, 8, 7, 6]);
```

`fixPrankNumber([12, 24, 36, 48, 61, 72, 84, 96])` 应该返回 `[12, 24, 36, 48, 60, 72, 84, 96]`。

```js
assert.deepEqual(fixPrankNumber([12, 24, 36, 48, 61, 72, 84, 96]), [12, 24, 36, 48, 60, 72, 84, 96]);
```

`fixPrankNumber([4, 1, -2, -5, -8, -5])` 应该返回 `[4, 1, -2, -5, -8, -11]`。

```js
assert.deepEqual(fixPrankNumber([4, 1, -2, -5, -8, -5]), [4, 1, -2, -5, -8, -11]);
```

`fixPrankNumber([0, 100, 200, 300, 150, 500])` 应该返回 `[0, 100, 200, 300, 400, 500]`。

```js
assert.deepEqual(fixPrankNumber([0, 100, 200, 300, 150, 500]), [0, 100, 200, 300, 400, 500]);
```

`fixPrankNumber([400, 425, 400, 375, 350, 325, 300])` 应该返回 `[450, 425, 400, 375, 350, 325, 300]`。

```js
assert.deepEqual(fixPrankNumber([400, 425, 400, 375, 350, 325, 300]), [450, 425, 400, 375, 350, 325, 300]);
```

`fixPrankNumber([-5, 5, 10, 15, 20])` 应该返回 `[0, 5, 10, 15, 20]`。
