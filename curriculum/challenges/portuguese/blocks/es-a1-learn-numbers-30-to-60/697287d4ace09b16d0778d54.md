...
Agora vamos para os números na casa dos 50.

Em espanhol, o número 50 é chamado de `cincuenta`.

Números de 51 a 59 são formados usando a palavra das dezenas `cincuenta` (50), seguida da conjunção `y` ("and") e depois o dígito das unidades (1-9).
...
O número `cincuenta y uno` (51) é único nesta faixa porque se torna `cincuenta y un` antes de um substantivo masculino. Por exemplo:

`Cincuenta y un años` - Cinquenta e um anos.
...
Eu pratiquei pronunciar os números de 50 a 59.
