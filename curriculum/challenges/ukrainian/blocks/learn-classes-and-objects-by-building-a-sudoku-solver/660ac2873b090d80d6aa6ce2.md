...
Тепер створіть цикл `for`, щоб ітерувати над рядками на дошці. Використовуйте `row` як змінну циклу.

# --hints--

Ви повинні створити цикл `for`, який ітерує над `self.board`.
...
Використовуйте `row` як змінну циклу.
