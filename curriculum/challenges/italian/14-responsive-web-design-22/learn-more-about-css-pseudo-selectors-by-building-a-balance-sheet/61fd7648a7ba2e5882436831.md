...
L'elemento `tbody` dovrebbe avere quattro elementi `tr`.
...
I primi tre elementi `tr` dovrebbero avere l'attributo `class` con il valore `data`.
...
Il quarto elemento `tr` dovrebbe avere l'attributo `class` con il valore `total`.
