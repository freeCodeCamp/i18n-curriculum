...
L'algoritmo Lempel-Ziv-Welch (LZW) fornisce una compressione dati senza perdita.

# --instructions--

Scrivi una funzione che prende due parametri. Il primo parametro è un booleano dove `true` indica comprimi e `false` indica decomprimi. Il secondo parametro è una stringa o un array da elaborare. Se è una stringa da comprimere, restituisci un array di numeri. Se è un array di numeri da decomprimere, restituisci una stringa.
