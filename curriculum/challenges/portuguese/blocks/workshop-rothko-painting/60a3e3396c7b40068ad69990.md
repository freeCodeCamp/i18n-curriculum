...
Use a mesma declaração de `box-shadow` para `.two`, mas altere a cor de `#efb762` para `#8f0401`.

# --hints--

Você deve definir a propriedade `box-shadow` como `0 0 3px 3px #8f0401`.
...
O elemento `.two` deve ter um valor de `box-shadow` de `0 0 3px 3px #8f0401`.
