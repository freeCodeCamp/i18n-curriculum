...
تتجمع أفق المدينة. املأ خاصية `background-color` للمباني الأمامية. استخدم المتغير `--building-color1` لملء `.fb3` و `.fb4`، و`--building-color2` لـ `.fb5`، و`--building-color3` لـ `.fb2` و `.fb6`، و`--building-color4` لـ `.fb1`.
