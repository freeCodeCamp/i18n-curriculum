...
На останньому кроці змініть рядки, що містяться в `details_list`, так, щоб текст, розміщений після знака «дорівнює», був вирівняний по правому краю для кожної лінії. Ваш фінальний вихідний вміст має виглядати так:
