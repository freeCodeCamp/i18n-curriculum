...
Crea un'istruzione `if` che verifichi se `self` e `other` non appartengono alla stessa classe e restituisca `NotImplemented`.

# --hints--

Dovresti creare un'istruzione `if` che controlli se `self` e `other` non appartengono alla stessa classe.
