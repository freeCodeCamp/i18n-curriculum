...
Richtig oder falsch: Liu Ming ist ein UI-Designer aus China.
...
Liu Ming ist ein UI-Designer, aber er sagt deutlich, dass er nicht Chinese ist.
...
Liu Ming sagt `我不是中国人 (wǒ bù shì zhōng guó rén)，我是新加坡人 (wǒ shì xīn jiā pō rén)`, was bedeutet, dass er Singapurer ist, nicht Chinese.

Er sagt auch `我是 (wǒ shì) UI 设计师 (shè jì shī)`, was bedeutet, dass er ein UI-Designer ist.
