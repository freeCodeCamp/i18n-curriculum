...
Unapaswa kuongeza class ya `price` kwenye kipengele chako cha `p`.
...
Unapaswa kuwa na kipengele kimoja pekee kilicho na class ya `price`.
...
Class yako ya `price` inapaswa kuwa kwenye kipengele cha `p` chenye maandishi `3.00`.
