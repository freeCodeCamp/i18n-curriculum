...
Crie uma função `resetGame` que realize o seguinte:
...
Tente testar o jogo jogando algumas rodadas até que um dos jogadores alcance `3` pontos. Em seguida, clique no botão `"Play again?"` para ver se o jogo reinicia corretamente.
