...
Ongeza sifa ya `transition` kwa kichaguzi cha `.card-links a` na uipe thamani ya `background-color 0.3s ease`.

# --hints--

Kichaguzi cha `.card-links a` kinapaswa kuwa na sifa ya `transition` iliyowekwa kuwa `background-color 0.3s ease`.
