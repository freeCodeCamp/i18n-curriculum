...
Це форма минулого простого часу від `test`, що вказує на дію, яка була завершена в минулому.
...
Це форма минулого простого часу від `find`, яка тут використовується для опису виявлення помилок, що сталося в минулому.
...
Це форма минулого простого часу від `fix`, що вказує на завершену дію з усунення знайдених помилок.
