...
Dies ist das Verb `to be`, das mit `you` verwendet wird. Es ist das erste Wort in einer Frage, daher wird es großgeschrieben.
...
Diese Präposition wird mit dem Verb `to be` verwendet, um auszudrücken, dass jemand etwas mag oder daran interessiert ist.
