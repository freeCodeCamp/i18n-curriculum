...
title: Використовуйте властивість align-items у вставці твіта
challengeType: 0
...
Останнє завдання познайомило з властивістю `align-items` і навело приклад. Цю властивість можна застосувати до кількох елементів вставки твіта, щоб вирівняти гнучкі елементи всередині них.

# --instructions--

Додайте CSS-властивість `align-items` до `.follow-btn` елемента заголовка. Встановіть значення `center`.

# --hints--

Ваш `.follow-btn` має відтворюватися на сторінці. Обов’язково вимкніть усі розширення, такі як блокувальники реклами.
