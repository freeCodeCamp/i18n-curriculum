...
Перейдіть до `h2` всередині **плану слухача**, додайте йому утилітарний клас `text-lg`, щоб зробити його більшим, `font-semibold`, щоб зробити його жирнішим, і `text-indigo-600`, щоб надати йому гарний індиговий колір.

# --hints--

Ваш `h2` елемент має мати клас `text-lg`.
...
Ваш `h2` елемент має мати клас `font-semibold`.
...
Ваш `h2` елемент має мати клас `text-indigo-600`.
