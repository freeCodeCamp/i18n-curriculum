...
Per il primo, aggiungi un `label` con il `className` di `label`, un `htmlFor` di `pac` e il testo `PAC`, poi un input con un `id` di `pac`, un `className` di `input` e un `type` di `number`.
...
Il primo elemento `div` di `className` di `form-group` dovrebbe avere un `label` con un attributo `htmlFor` di `pac`, un `className` di `label` e un testo `PAC`.
...
Il primo elemento `div` di `className` di `form-group` dovrebbe avere un `input` con un `className` di `input`, un `id` di `pac` e un `type` di `number`.
...
Il secondo elemento `div` di `className` di `form-group` dovrebbe avere un `label` con un attributo `htmlFor` di `sho`, un `className` di `label` e un testo `SHO`.
...
Il secondo elemento `div` di `className` di `form-group` dovrebbe avere un `input` con un `id` di `sho`, un `className` di `input` e un `type` di `number`.
