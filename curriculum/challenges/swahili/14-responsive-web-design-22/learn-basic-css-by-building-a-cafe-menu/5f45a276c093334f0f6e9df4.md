...
Kwa kuzingatia vitu vya menyu na bei, kuna pengo kubwa kati ya kila mstari.
...
Unapaswa kutumia kichaguzi cha `.item p` kilichopo.
...
Vipengele vyako vya `p` vilivyowekwa katika vipengee vyako vya `.item` vinapaswa kuwa na `margin-top` ya `5px`.
...
Vipengele vyako vya `p` vilivyowekwa katika vipengee vyako `.item` vinapaswa kuwa na `margin-bottom` ya `5px`.
