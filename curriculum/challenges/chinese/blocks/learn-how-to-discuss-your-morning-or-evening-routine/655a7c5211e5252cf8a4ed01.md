...
The modal verb `can` is used to express ability, possibility, or to ask permission. It's a very common verb in everyday conversation. 例如：

- `I can speak three languages.` - Here, `can` shows ability.

- `Can I borrow your pen?` - Here, `can` asks for permission.

`Tough` means something is difficult or challenging. People often use it to describe hard situations or tasks. 例如：
