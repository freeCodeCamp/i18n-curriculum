...
لقد أنشأت حاسبة لمسار المقذوف.

لإنهاء الأمر، عدل الشفرة التي كتبتها خارج الأصناف، وادمجها في دالة مساعدة صغيرة تسمى `projectile_helper` تستقبل القيم المطلوبة للسرعة والارتفاع والزاوية، وتطبع على الطرفية بالتتابع تفاصيل المقذوف، وجدول الإحداثيات، ورسم المسار البياني.

استدعِ `projectile_helper` مرة واحدة مع القيم التي تختارها.

# --hints--

يجب أن تنشئ `projectile_helper` في النطاق العام.
...
يجب أن تطبع السلاسل النصية المطلوبة بالترتيب. لا تطبع قيمًا أخرى.
...
يجب أن تستدعي دالة `projectile_helper` مرة واحدة على الأقل.
...
يجب ألا يكون لديك متغيرات أو استدعاءات طباعة في النطاق العام.
