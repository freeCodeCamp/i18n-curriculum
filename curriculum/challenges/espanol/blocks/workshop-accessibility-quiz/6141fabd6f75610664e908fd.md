...
Dentro del elemento `main`, crea un formulario que contenga tres elementos `section`. Luego, haz que el formulario se envíe a `https://freecodecamp.org/practice-project/accessibility-quiz` usando el método correcto.
