...
`Not yet` is a common short answer used to say that something hasn't happened or been decided at this moment in time, but it may happen in the future. It's often used when something is expected but not confirmed. Zum Beispiel:

- **Steve:** `Have they sent the report?` - This person is asking if the other has already received a report.

- **Sophie:** `Not yet.` – This means the report hasn't been sent, but it might be sent soon.
