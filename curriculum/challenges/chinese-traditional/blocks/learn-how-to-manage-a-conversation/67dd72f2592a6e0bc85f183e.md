...
`What do you think about...` is often used to make a polite suggestion, not just to ask for an opinion. It invites the other person to respond or give input on a possible plan. 例如：
