...
title: 'Problema 356: radici più grandi di polinomi cubici'
challengeType: 1
forumTopicId: 302016
...
Sia $a_n$ la radice reale più grande di un polinomio $g(x) = x^3 - 2^n \times x^2 + n$.

Per esempio, $a_2 = 3.86619826\ldots$

Trova le ultime otto cifre di $\displaystyle\sum_{i = 1}^{30} \lfloor {a_i}^{987654321}\rfloor$.

**Nota:** $\lfloor a\rfloor$ indica la funzione floor.
