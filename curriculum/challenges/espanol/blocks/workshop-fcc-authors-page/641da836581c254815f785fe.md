...
Lo próximo que mostrarás son los detalles biográficos sobre el autor. Puedes hacer esto utilizando la propiedad `bio`.

Agrega un elemento de párrafo con un atributo `class` de `"bio"`, luego interpola `bio` dentro del elemento de párrafo.
...
Debes interpolar `bio` en tu elemento `p`.
