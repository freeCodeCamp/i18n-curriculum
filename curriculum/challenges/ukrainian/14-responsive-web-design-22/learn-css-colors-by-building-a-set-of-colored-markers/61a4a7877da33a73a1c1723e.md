...
В першому аргументі, який зараз чистий червоний, оновіть функцію `rgb` таким чином, що значення червоного буде `122`, зеленого – `74` та синього – `14`.

# --hints--

Ваше CSS-правило `.red` повинне мати властивість `background` зі значенням `linear-gradient(180deg, rgb(122, 74, 14) 0%, rgb(0, 255, 0) 50%, rgb(0, 0, 255) 100%)`.
