...
title: 'Problema 401: somma dei quadrati dei divisori'
challengeType: 1
forumTopicId: 302069
...
Sia $\Sigma_2$ la funzione sommatoria di $\sigma_2$, cioè $\Sigma_2(n) = \sum \sigma_2(i)$ per $i=1$ fino a $n$. I primi 6 valori di $\Sigma_2$ sono: 1, 6, 16, 37, 63 e 113.
