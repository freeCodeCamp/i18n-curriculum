...
Використання правильних прийменників у контексті повсякденних справ є важливим для чіткого спілкування.

`At` використовується для певного часу, `after` для послідовності дій, а `to` для вказівки напрямку або пункту призначення.

# --instructions--

Послухайте аудіо, щоб зрозуміти контекст. Виберіть правильні прийменники, щоб закінчити речення про ранковий розпорядок Сари.
...
Використовується для визначення часу.
...
Вказує напрямок або кінцевий результат.
