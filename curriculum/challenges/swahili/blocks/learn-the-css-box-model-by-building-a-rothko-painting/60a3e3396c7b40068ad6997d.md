...
Tumia vizingiti kuweka kipengele cha `.one` kwenye turubai ya kuchora.

Ongeza sifa fupi ya `margin` yenye kizingiti cha wima cha `20px` na kizingiti cha usawa cha `auto`.
