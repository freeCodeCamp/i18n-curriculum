...
**Pista:** El método [Math.random](https://developer.mozilla.org/es/docs/Web/JavaScript/Reference/Global_Objects/Math/random) devuelve un número aleatorio que es mayor o igual a 0 y menor que 1. Piensa en cómo puedes usar esto para devolver condicionalmente una de las múltiples opciones.
...
**Sugerencia:** Usa el método [prompt](https://developer.mozilla.org/es/docs/Web/API/Window/prompt) para obtener la entrada del usuario.
