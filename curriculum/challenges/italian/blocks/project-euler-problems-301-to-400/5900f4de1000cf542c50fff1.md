...
Definiamo un triangolo geometrico come un triangolo con lati interi $a ≤ b ≤ c$ tali che i suoi lati formino una progressione geometrica, cioè $b^2 = a \times c$.

Un esempio di tale triangolo geometrico è il triangolo con lati $a = 144$, $b = 156$ e $c = 169$.

Esistono $861\\,805$ triangoli geometrici con $\text{perimetro} ≤ {10}^6$.
