...
Agora, vamos passar para as watch expressions. As watch expressions permitem que você monitore os valores de variáveis ou expressões enquanto o código é executado, mesmo que estejam fora do escopo atual.
