...
Debes asignar la concatenación de `alphabet[shift:]` y la primera porción faltante de `alphabet` a la variable `shifted_alphabet`. Usa `shift` para especificar dónde detener el corte.
