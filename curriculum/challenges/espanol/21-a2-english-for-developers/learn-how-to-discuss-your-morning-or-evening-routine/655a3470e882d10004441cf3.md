...
La palabra `tempting` es un adjetivo que describe algo atractivo o tentador, a menudo haciendo que alguien quiera hacerlo o tenerlo. Por ejemplo:

`The idea of sleeping in is tempting` (sugiere que la idea es atractiva)
...
Describe algo que es atractivo o tentador, en este caso, pulsar el botón de repetición.
