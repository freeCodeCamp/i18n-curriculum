...
Anida dos nuevos elementos `div` dentro de `.bb2`, asígnales las clases `bb2a` y `bb2b`, en ese orden. Estas serán dos secciones para este edificio.

# --hints--

Debes agregar dos elementos `div` a `.bb2`.
