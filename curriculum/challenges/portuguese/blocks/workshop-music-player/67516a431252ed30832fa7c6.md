...
Agora, use o operador **OR** para adicionar o parâmetro `start` como uma segunda condição à declaração `if` após `userData.currentSong === null`. 


# --hints--

Você deve usar o operador **OR** para adicionar o parâmetro `start` como uma segunda condição à declaração `if` após `userData.currentSong === null`. 
