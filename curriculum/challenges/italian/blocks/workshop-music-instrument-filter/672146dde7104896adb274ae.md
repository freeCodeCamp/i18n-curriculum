...
Quando selezioni una categoria dal menu a discesa, le schede degli strumenti vengono filtrate e visualizzate correttamente sulla pagina, ma devi eliminare quelle virgole tra le schede.

Fallo unendo l'array restituito da `instrumentCards`. Così il filtro per gli strumenti musicali sarà completo.
...
Dovresti unire l'array restituito dalla funzione `instrumentCards`. Non modificare il tuo event listener.
