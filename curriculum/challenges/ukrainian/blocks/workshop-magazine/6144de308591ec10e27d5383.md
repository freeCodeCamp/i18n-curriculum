...
Створіть селектор `h1` і встановіть властивість `font-family` у значення `Anton` із запасним варіантом `sans-serif`.
...
Ваш селектор `h1` повинен мати властивість `font-family`, встановлену в `Anton` із запасним варіантом `sans-serif`.
