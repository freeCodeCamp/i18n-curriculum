...
Para destacar o container, você deve adicionar um `box-shadow` definido como `0 5px 15px black`. 

Isso adiciona um efeito de sombra ao redor do container. Os valores controlam respectivamente o deslocamento horizontal, deslocamento vertical, raio de desfoque e cor.
...
Você deve definir a propriedade `box-shadow` para `0 5px 15px black`.
