...
Código ISBNLongitudMensajeEjemplo de salida
|-----------|--------|---------| ------------- |
VálidoVálido| `Valid ISBN Code.` | `1530051126,10` |
Número inválidoVálido| `Invalid ISBN Code.` | `1530051125,10` |
No coincide con la longitud especificada o está en blancoVálidoEl `ISBN-10 code` debe tener 10 dígitos. o el `ISBN-13 code` debe tener 13 dígitos., dependiendo de la longitud que ingresaste.`9781530051120,10` o `1530051126,13`
Contiene caracteres no numéricos (excepto el dígito de verificación)Válido| `Invalid character was found.` | `15-0051126,10` |
CualquierNúmero inválido| `Length should be 10 or 13.` | `1530051126,9` |
CualquierContiene caracteres no numéricos o está en blanco| `Length must be a number.` | `1530051125,A` |
No separado por comasNo separado por comas| `Enter comma-separated values.` | `1530051125` |
