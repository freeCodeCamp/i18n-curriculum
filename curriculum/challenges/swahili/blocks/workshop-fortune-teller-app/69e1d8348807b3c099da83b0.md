...
Unapaswa kujaribu maendeleo yako hadi sasa. Unda mfano wa darasa la vitu la `Game` na uweke thamani yake katika mabadiliko ya `game`.

Kwa sasa, utaona kwamba unaweza kuona kadi wakati unabofya vifungo vya Single Card Reading na Three Card Spread.

# --hints--

Unapaswa kutangaza mabadiliko unaoitwa `game`.
...
Mabadiliko yako ya `game` yanapaswa kuanzishwa na `new Game()`.
