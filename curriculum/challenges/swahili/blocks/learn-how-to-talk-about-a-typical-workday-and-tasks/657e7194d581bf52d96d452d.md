...
Kutumia viunganishi sahihi katika muktadha wa ratiba za kila siku ni muhimu kwa mawasiliano wazi.

`At` hutumika kwa nyakati maalum. Kwa mfano, `I start work at 9:00`.

`After` hutumika kwa mfululizo wa vitendo. Kwa mfano, `I have lunch after the meeting`.

`To` hutumika kuonyesha mwelekeo au mahali pa kwenda. Kwa mfano, `I go to the office by bus`.

# --instructions--

Sikiliza sauti ili kuelewa muktadha. Andika viunganishi sahihi ili ukamilishe sentensi kuhusu ratiba ya asubuhi ya Sarah.
...
Kiunganishi hiki hutumika kwa kuonyesha wakati maalum.
...
Kiunganishi hiki hutumika kwa mfululizo wa vitendo.
...
Kiunganishi hiki kinaonyesha mwelekeo au mahali pa kwenda.
