...
Індекс рівноваги послідовності — це індекс у цій послідовності, для якого сума елементів з меншими індексами дорівнює сумі елементів з більшими індексами.

Наприклад, у послідовності $A$:
...
`6` також є індексом рівноваги, тому що:
...
`7` не є індексом рівноваги, тому що це не дійсний індекс послідовності $A$.

# --instructions--

Напишіть функцію, яка, отримуючи послідовність, повертає її індекси рівноваги (якщо такі є).

Припустіть, що послідовність може бути дуже довгою.
