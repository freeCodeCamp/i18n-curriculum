...
Listas ordenadas começam com um elemento `<ol>` de abertura, seguido por qualquer número de elementos `<li>`. Finalmente, listas ordenadas são fechadas com a tag `</ol>`.
