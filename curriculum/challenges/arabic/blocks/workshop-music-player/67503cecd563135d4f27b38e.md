...
حان الوقت الآن لاختبار الدالة `playNextSong`.

أضف مستمع حدث `"click"` إلى عنصر `nextButton`، ثم مرر `playNextSong` كالمعلمة الثانية لمستمع الحدث الخاص بك. هذه هي الدالة التي سيُنفذها مستمع الحدث.

اختبر تطبيقك بالنقر أولًا على زر التشغيل ثم على زر التالي. يجب أن ترى أن كل شيء يعمل كما هو متوقع.

# --hints--

يجب أن تستدعي الطريقة `addEventListener()` على المتغير `nextButton` الخاص بك.
...
يجب أن تمرر `playNextSong` كالمعلمة الثانية لطريقة `addEventListener`.
