...
- **经理：** `The client wants a more modern UI.`

- **UI/UX 设计师：** `Exactly. That's why we're redesigning the dashboard with a cleaner layout.` ——这里，`exactly` 用来强烈认同该语句并强调 UI 重新设计的原因。
