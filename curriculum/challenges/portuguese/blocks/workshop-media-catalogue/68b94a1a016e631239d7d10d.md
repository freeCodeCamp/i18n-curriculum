...
Voltando para a classe `MediaCatalogue`, adicione uma docstring dizendo `A catalogue that can store different types of media items.`

# --hints--

Você deve adicionar a docstring `A catalogue that can store different types of media items.` à sua classe `MediaCatalogue`.
