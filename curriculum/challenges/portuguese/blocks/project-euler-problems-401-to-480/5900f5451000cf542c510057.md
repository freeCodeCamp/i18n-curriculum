...
Há $N$ assentos em uma fila. $N$ pessoas chegam uma após a outra para ocupar os assentos de acordo com as seguintes regras:

1. Nenhuma pessoa se senta ao lado de outra.
1. A primeira pessoa escolhe qualquer assento.
1. Cada pessoa subsequente escolhe o assento mais distante de qualquer outra pessoa já sentada, desde que isso não viole a regra 1. Se houver mais de uma opção que satisfaça essa condição, então a pessoa escolhe a opção mais à esquerda.

Observe que devido à regra 1, alguns assentos certamente ficarão desocupados e o número máximo de pessoas que podem ser acomodadas é menor que $N$ (para $N > 1$).
