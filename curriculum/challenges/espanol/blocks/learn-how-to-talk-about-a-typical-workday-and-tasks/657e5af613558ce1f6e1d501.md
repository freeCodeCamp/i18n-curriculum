...
Un `security incident` es un evento que puede ser perjudicial para la seguridad o protección de una empresa u organización. For example, `A security incident like a stolen password needs to be reported immediately`.
