...
現在，你應該移動到 `Start listening` CTA，使其成為一個適當的按鈕。

為它指定工具類別 `bg-indigo-100`、`px-4`、`py-2`、`text-center`、`font-semibold`、`text-indigo-700` 和 `hover:bg-indigo-200`。

# --hints--

你的錨點元素應該有 `bg-indigo-100` 類別。
...
你的錨點元素應該有 `hover:bg-indigo-200` 類別。
