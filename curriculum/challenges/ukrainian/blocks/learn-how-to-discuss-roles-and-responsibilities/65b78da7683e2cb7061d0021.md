...
Описуючи речі як `very positive`, вона натякає, що вони важливі, а не неважливі.
...
Софі насправді описує речі як `very positive`, а не від’ємні.

---

Їх сказали дуже давно.

### --feedback--

Використання `just` вказує, що речі сказали нещодавно, а не дуже давно.

---

Вони дуже позитивні і були сказані нещодавно.
