...
回到 `MediaCatalogue` 类，为它添加一个文档字串，内容为 `A catalogue that can store different types of media items.`

# --hints--

你应该为你的 `MediaCatalogue` 类添加文档字串 `A catalogue that can store different types of media items.`。
