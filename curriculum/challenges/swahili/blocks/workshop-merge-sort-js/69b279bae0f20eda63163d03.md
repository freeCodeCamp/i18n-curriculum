...
Sasa baada ya `numbers` kupangwa, andika `'Sorted array: '` kwenye konsoli ikifuatiwa na safu ya data ya `numbers`.

Kwa hivyo, algoriti ya kupanga kwa njia ya unganisho (merge sort) imekamilika.

# --hints--

Unapaswa kuandika `'Sorted array: '` kwenye konsoli.
...
Unapaswa kuandika safu ya data ya `numbers` kwenye konsoli baada ya kuandika `'Sorted array: '`.
