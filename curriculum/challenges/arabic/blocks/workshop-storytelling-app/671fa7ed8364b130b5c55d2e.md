...
اختر فقرة `#result` وخزنها في متغير اسمه `resultParagraph`. ستستخدم هذا المتغير لعرض القصة المختارة.

# --hints--

يجب أن تختار فقرة `#result` باستخدام طريقة `getElementById` وتخزنها في المتغير `resultParagraph`.
