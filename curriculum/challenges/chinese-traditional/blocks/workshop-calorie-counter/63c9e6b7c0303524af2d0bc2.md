...
爲你的 span 文本 `remainingCalories Calorie surplusOrDeficit`，使用插值將 `remainingCalories` 和 `surplusOrDeficit` 替換爲適當的變量。

# --hints--

你的 `span` 應該包含文本 `${remainingCalories} Calorie ${surplusOrDeficit}`。
