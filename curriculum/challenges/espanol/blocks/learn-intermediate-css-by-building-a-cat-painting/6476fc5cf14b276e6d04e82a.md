...
Usa un selector de clase para dar a tu elemento `.box` un ancho de `200px`, una altura de `600px` y un color de fondo de `#000`. Además, dale una `position` de `absolute`, un `top` de `800px` y un `left` de `650px`.
