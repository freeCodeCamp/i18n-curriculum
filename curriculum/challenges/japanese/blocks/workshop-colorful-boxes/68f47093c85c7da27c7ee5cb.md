...
`.box4` セレクターを作成し、`background` プロパティを値 `#4caf50` で追加してください。

次に、`order` セレクターに `3` プロパティを値 `.box4` で追加してください。`box3` クラスのボックスの後ろにこのボックスが移動するのが見えます。
