...
Потім створіть новий селектор, який націлюється на елементи списку навігації, щоб коли курсор наводиться на них, змінювався фон і колір тексту, а курсор ставав вказівником.
...
Ви повинні задати елементам `li` при наведенні `background-color` зі значенням `#dfdfe2`.
...
Ви повинні задати елементам `li` при наведенні `color` зі значенням `#1b1b32`.
...
Ви повинні задати елементам `li` при наведенні `cursor` зі значенням `pointer`.
