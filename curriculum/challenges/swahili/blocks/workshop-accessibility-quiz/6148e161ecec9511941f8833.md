...
Sasa, hatuwezi kusoma maandishi. Lenga `footer` na kipengele cha nanga ndani yake ili kuweka rangi ya fonti kuwa rangi yenye uwiano wa utofauti wa rangi unaofaa.

# --hints--

Unapaswa kutumia kichaguzi cha `footer, footer a`.
...
Unapaswa kuweka `color` kwa thamani yenye uwiano wa utofauti wa rangi wa angalau `7:1`. _Kidokezo: Ninapendekeza `#dfdfe2`_
