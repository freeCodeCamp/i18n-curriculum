...
現在，你應該開始為 **Listener plan** 的元素設計樣式。

為計劃的外層 `div` 指定類別 `bg-gray-100`、`ring-1` 以在 `div` 周圍創建粗邊框，並指定 `ring-gray-300` 以為該邊框指定深色。

# --hints--

你的 `div` 元素應該有 `bg-gray-100` 類別。
