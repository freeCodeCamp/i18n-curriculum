...
`There's always` is often used to talk about something negative that happens repeatedly or never seems to stop - no matter what you do, it seems the negative event keeps happening. 例如：
