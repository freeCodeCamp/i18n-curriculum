...
title: Відтворіть зображення з джерел даних
challengeType: 6
forumTopicId: 18265
...
Додайте код до тегу `img`, щоб використати властивості `imageLink` та `altText`.

# --hints--

Використайте властивість `imageLink`, щоб відтворити зображення.

```js
assert(code.match(/val\.imageLink/g));
```

Використайте `altText` до значень атрибута `alt` для зображень.
