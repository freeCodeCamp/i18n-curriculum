...
У цьому завданні ви створите статистичний калькулятор, який приймає набір чисел та повертає середнє значення, медіану, моду, стандартне відхилення та дисперсію.
