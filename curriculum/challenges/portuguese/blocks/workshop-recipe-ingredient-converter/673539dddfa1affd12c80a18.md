...
Vamos testar sua nova função curried. Declare uma variável `servingsResult` e atribua a ela o resultado do ajuste de uma quantidade base de 4 para uma porção de 6.
