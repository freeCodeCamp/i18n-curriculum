...
Tu primer elemento `article` debe tener elementos `p` con los textos `French Vanilla` y `3.00`.
...
Tu segundo elemento `article` debe tener elementos `p` con los textos `Caramel Macchiato` y `3.75`.
...
Tu tercer elemento `article` debe tener elementos `p` con los textos `Pumpkin Spice` y `3.50`.
...
Tu cuarto elemento `article` debe tener elementos `p` con los textos `Hazelnut` y `4.00`.
...
Tu quinto elemento `article` debe tener elementos `p` con los textos `Mocha` y `4.50`.
