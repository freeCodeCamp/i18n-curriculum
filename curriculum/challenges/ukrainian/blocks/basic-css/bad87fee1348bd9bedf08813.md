...
title: додати кордони навколо ваших елементів
challengeType: 0
...
CSS кордони мають властивості, такі як `style`, `color` і `width`.

Наприклад, якщо ми хочемо створити червоний кордон товщиною 5 пікселів навколо HTML-елемента, ми можемо використати цей клас:
...
Створіть клас з назвою `thick-green-border`. Цей клас має додати 10px, суцільний, зелений кордон навколо HTML-елемента. Застосуйте цей клас до фото вашого кота.

Пам’ятайте, що ви можете застосовувати кілька класів до елемента, використовуючи його атрибут `class`, розділяючи імена класів пробілом. Наприклад:
...
Ваше зображення має мати стиль кордону `solid`.
...
Кордон навколо вашого елемента `img` має бути зеленим.
