...
Sasa unapaswa kupamba CTA ili ionekane zaidi kama kitufe.

Kwa rangi ya nyuma na mbele, weka darasa la vitu `bg-gradient-to-r`, `from-fuchsia-500`, `to-indigo-600`, `text-white`, `hover:from-fuchsia-600`, na `hover:to-indigo-700`. Pia weka darasa la vitu `rounded-md` na `block`.

# --hints--

Kipengele chako cha nanga kinapaswa kuwa na darasa la vitu `bg-gradient-to-r`.
...
Kipengele chako cha nanga kinapaswa kuwa na darasa la vitu `from-fuchsia-500`.
...
Kipengele chako cha nanga kinapaswa kuwa na darasa la vitu `to-indigo-600`.
...
Kipengele chako cha nanga kinapaswa kuwa na darasa la vitu `text-white`.
...
Kipengele chako cha nanga kinapaswa kuwa na darasa la vitu `hover:from-fuchsia-600`.
...
Kipengele chako cha nanga kinapaswa kuwa na darasa la vitu `hover:to-indigo-700`.
...
Kipengele chako cha nanga kinapaswa kuwa na darasa la vitu `rounded-md`.
...
Kipengele chako cha nanga kinapaswa kuwa na darasa la vitu `block`.
