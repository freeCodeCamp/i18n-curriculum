...
Kama hatua ya mwisho, ongeza tamko la `console.log()` lenye ujumbe: `"Workshop complete! You now know how to use includes() and slice()."`

Hongera! Umehitimisha warsha ya mkaguzi wa mfuatano wa herufi.

# --hints--

Unapaswa kuandika `"Workshop complete! You now know how to use includes() and slice()."` kwenye konsoli.
