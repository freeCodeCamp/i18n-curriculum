...
Настав час попрацювати з елементом `div`, який обгортає три картки з цінами. Щоб розташувати картки, ви можете використати утиліти сітки Tailwind CSS.

Ось як призначити елементу відображення `grid` за допомогою Tailwind:
...
Призначте клас `grid` елементу `div`, який обгортає картки з цінами.
