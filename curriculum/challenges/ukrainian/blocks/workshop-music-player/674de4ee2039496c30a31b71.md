...
Ваша функція `playSong` має встановити властивість `currentTime` об’єкта `audio` у значення, збережене в `userData.songCurrentTime`, коли відтворюється поточна пісня.
