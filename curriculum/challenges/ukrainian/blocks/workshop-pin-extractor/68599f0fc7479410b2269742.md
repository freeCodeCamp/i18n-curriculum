...
Оновіть аргумент функції на `poems`, потім створіть цикл `for` навколо всього поточного вмісту функції, який ітерує `poems` і використовує `poem` як змінну циклу.

# --hints--

Функція `pin_extractor` має мати параметр з іменем `poems`.
...
У вас має бути цикл `for`, який ітерує `poems`.
...
Цикл має мати `poem` як змінну циклу.
...
Потрібно перемістити існуюче тіло функції всередину нового циклу `for`.
