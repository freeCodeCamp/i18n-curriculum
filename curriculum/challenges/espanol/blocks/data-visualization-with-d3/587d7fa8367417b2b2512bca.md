...
1. Agrega espacio entre cada barra para separarlas visualmente, lo cual se hace añadiendo un margen al CSS de la clase `bar`

2. Aumenta la altura de las barras para mostrar mejor la diferencia en los valores, lo cual se hace multiplicando el valor por un número para escalar la altura
