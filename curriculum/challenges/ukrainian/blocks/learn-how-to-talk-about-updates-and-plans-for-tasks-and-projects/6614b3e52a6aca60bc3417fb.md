...
Чи пропонує Браян замінити маркетинг у соціальних мережах на маркетинг електронною поштою?
...
Браян використовує `also` у своїй інструкції, що вказує на додавання, а не заміну.
...
Економічність не є підставою для альтернативного вибору; Браян додає, а не замінює стратегію соціальних мереж.
...
Пропозиція Браяна не означає, що він вважає маркетинг у соціальних мережах неефективним; він пропонує додаткову стратегію.
