...
The callback function should have a parameter for each capture group in the regular expression. Nel tuo caso, `rangeRegex` ha quattro gruppi di acquisizione: la prima lettera, il primo numero, la seconda lettera e il secondo numero.

Dai alla funzione callback altri quattro parametri corrispondenti a quei gruppi di acquisizione: `char1`, `num1`, `char2` e `num2`. `char` è l'abbreviazione di `character`.
