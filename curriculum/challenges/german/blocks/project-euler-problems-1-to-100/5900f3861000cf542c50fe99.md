...
title: 'Aufgabe 26: Reziproke Zyklen'
challengeType: 1
forumTopicId: 301908
...
Ein Einheitsbruch enthält 1 im Zähler. Die Dezimaldarstellung der Einheitsbrüche mit Nennern von 2 bis 10 ist gegeben:
...
Dabei bedeutet 0.1(6) 0,166666..., und hat einen 1-stelligen periodischen Zyklus. Man sieht, dass <sup>1</sup>/<sub>7</sub> einen 6-stelligen periodischen Zyklus hat.

Finden Sie den Wert von `d` &lt; `n`, für den <sup>1</sup>/<sub>d</sub> den längsten periodischen Zyklus im Dezimalbruchteil enthält.
