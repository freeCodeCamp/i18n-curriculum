...
`Not very` + adjective is often used to soften a negative description. Instead of directly saying something was `bad` or `ineffective`, speakers might say `not very effective` to sound more polite or less harsh. Zum Beispiel:
