...
Ili maandishi ya nukuu yaonekane zaidi, mpe kichaguzi cha `.quote` sifa ya `font-family` iliyowekwa kuwa `Raleway` na njia mbadala ya `sans-serif`.

# --hints--

Kichaguzi chako cha `.quote` kinapaswa kuwa na sifa ya `font-family` iliyowekwa kuwa `Raleway` na njia mbadala ya `sans-serif`.
