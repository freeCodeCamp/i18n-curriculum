...
Weka sifa ya `innerText` ya `outputValueNode` kuwa `num`.

# --hints--

Unapaswa kutumia `innerText` kuweka maandishi ya `outputValueNode`.
...
Unapaswa kutumia `innerText` kuweka maandishi ya `outputValueNode` kuwa `num`.
