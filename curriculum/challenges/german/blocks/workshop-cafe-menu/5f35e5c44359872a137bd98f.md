...
Lösche den Kommentar und seinen Inhalt innerhalb des `body` Typ-Selektors. Füge jetzt eine `background-image`-Eigenschaft hinzu und setze deren Wert auf `url(https://cdn.freecodecamp.org/curriculum/css-cafe/beans.jpg)`.
