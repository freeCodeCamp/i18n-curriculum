...
Як перший крок цієї нової функції створіть локальну копію координат, але де всі значення округлені до цілих чисел. Збережіть цю нову версію координат у змінній під назвою `rounded_coords` та поверніть цю змінну.
