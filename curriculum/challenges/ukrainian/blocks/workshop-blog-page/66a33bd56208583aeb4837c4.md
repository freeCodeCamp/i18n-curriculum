...
Всередині елемента `footer` додайте елемент `section` з множиною `id`, встановленою на `contact`.

Всередині елемента `section` додайте елемент `h2` з текстом `Contact`.

# --hints--

У вашому елементі `section` має бути елемент `footer`.
...
Ваш елемент `section` має мати множину `id`, встановлену на `"contact"`.
...
У вашому елементі `h2` має бути елемент `section`.
...
Ваш елемент `h2` має містити текст `Contact`.
