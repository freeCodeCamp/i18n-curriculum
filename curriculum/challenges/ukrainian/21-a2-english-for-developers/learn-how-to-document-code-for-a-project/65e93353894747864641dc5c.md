...
The preposition `on` is often used to indicate the subject or topic of something, like what to comment `on` in a project. Наприклад, `The report focused on the project's progress`.
