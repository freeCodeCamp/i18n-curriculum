...
Após o último elemento `p`, crie outro elemento `p` e dê a ele o texto `Sodium 160mg 7%`.Coloque `Sodium` e `7%` cada um em seu próprio `span`, com uma classe `bold` assim como você fez com os outros.

Em seguida, adicione outro elemento `span` ao redor de `Sodium 160mg` para o alinhamento correto.
...
Um elemento `span` deve encapsular o texto `Sodium 160mg`.
