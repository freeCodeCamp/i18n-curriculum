...
Programu ya mtabiri inasaidia kuonyesha kadi nyingi, kwa hivyo unahitaji kuwa na njia inayoweza kusaidia kuonyesha kadi nyingi. Tangaza njia iitwayo `multipleCardSelected`.

Ndani ya njia hiyo, fanya wito wa kitendakazi cha `hideElements` na pita vigezo `singleCard`, `singleCardBtn`, `multipleCardsBtn`, na `headerTitle`. Usisahau lazima upate upatikanaji wake kutoka `this.elements`.

# --hints--

Unapaswa kutangaza njia ya `multipleCardSelected`.
...
Unapaswa kufanya wito wa kitendakazi cha `hideElements` ndani ya njia ya `multipleCardSelected`.
...
Unapaswa kupita `singleCard` kama hoja ya kwanza kwa kitendakazi cha `hideElements`.
...
Unapaswa kupita `singleCardBtn` kama hoja kwa kitendakazi cha `hideElements`.
...
Unapaswa kupita `multipleCardsBtn` kama hoja kwa kitendakazi cha `hideElements`.
...
Unapaswa kupita `headerTitle` kama hoja kwa kitendakazi cha `hideElements`.
