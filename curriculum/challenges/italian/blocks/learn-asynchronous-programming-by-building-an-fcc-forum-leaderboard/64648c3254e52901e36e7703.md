...
All'interno dell'elemento `div`, chiama la funzione `avatars` e passa gli argomenti `posters` e `users`.

Ora dovresti vedere gli avatar visualizzati sulla pagina.

# --hints--

Dovresti chiamare la funzione chiamata `avatars`.
...
La tua chiamata alla funzione dovrebbe avere gli argomenti `posters` e `users`.
