...
A `suspicious email` is an email that looks untrustworthy or dangerous. It could be part of a `phishing attack`, where someone tries to steal information. 例如：
