...
En el tema de la accesibilidad visual, el contraste entre elementos es un factor clave. Por ejemplo, el contraste entre el texto y el fondo de un encabezado debe ser al menos de 4.5:1.

Cambia el color de fuente de todos los elementos de enlace dentro de los elementos de lista a algo con una relación de contraste de al menos 7:1.

# --hints--

Tu selector debe apuntar a los enlaces dentro de los elementos de lista.
...
Debes dar a los elementos `a` dentro de los elementos de lista una propiedad `color`.
...
Solo debes cambiar el color de los elementos `a` dentro de los elementos de lista.
...
Debes dar a la propiedad `color` un contraste con el fondo de al menos 7:1. _Sugerencia: Yo usaría `#dfdfe2`_
