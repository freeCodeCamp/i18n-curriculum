...
Per ogni intero positivo $n$ la funzione $\text{next_prime}(n)$ restituisce il più piccolo numero primo $p$ tale che $p > n$.
...
Trova $\sum b(n)$ per $1≤n≤100\\,000$. Fornisci la tua risposta $\bmod 1\\,234\\,567\\,891\\,011$.
