...
Ángela y Sebastián están hablando sobre sus profesiones.
...
Esta es la conjugación en segunda persona (`tu`) del verbo `dedicarse`.
...
Este sustantivo significa "analyst".

# --explanation--

Este diálogo incluye las palabras `dedicas`, `representante` y `analista`.
