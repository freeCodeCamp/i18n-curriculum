...
Dovrai testare la tua nuova funzione curried. Dichiara una variabile `servingsResult` e assegnale il risultato di un adattamento da una quantità base di 4 a una porzione di 6.
