...
Un `interview` es una conversación donde alguien realiza preguntas para obtener información.

Un `infographic` es una imagen visual como un gráfico o diagrama usado para representar información.
...
Una imagen visual como un gráfico o diagrama. Amy usa los interactivos.
...
Las personas que leen el contenido de Amy.
