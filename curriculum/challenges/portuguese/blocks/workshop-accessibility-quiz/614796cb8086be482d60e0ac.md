...
O seletor deve direcionar os links nos itens da lista.
...
Você deve atribuir aos elementos `a` nos itens da lista uma propriedade `color`.
...
Você só deve alterar a cor dos elementos `a` nos elementos da lista.
...
You should give the `color` property a contrast with the background of at least 7:1. _Dica: eu usaria `#dfdfe2`_
