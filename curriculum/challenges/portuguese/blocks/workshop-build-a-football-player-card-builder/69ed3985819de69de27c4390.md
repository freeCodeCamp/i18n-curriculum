...
Agora atualize `FootballPlayerCard` para passar `defaultPlayer` para `PlayerCard` em vez do objeto inline.

# --hints--

Você deve ter `defaultPlayer` como o valor da prop `player` passada para `PlayerCard`.
