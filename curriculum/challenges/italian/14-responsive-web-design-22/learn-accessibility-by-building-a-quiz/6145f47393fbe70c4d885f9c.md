...
Dovresti dare a `textarea` un attributo `rows` con un numero.
...
Dovresti dare a `textarea` un attributo `cols` con un numero.
...
Dovresti dare all'elemento `textarea` un attributo `placeholder` con un testo che descrive una risposta di esempio.
