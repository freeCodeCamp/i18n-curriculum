...
Створіть цикл `for`, щоб ітерувати над `targets_to_print` і вивести наступний f-рядок: `f'\n{start}-{node} distance: {distances[node]}\nPath: {" -> ".join(paths[node])}'`.

# --hints--

Ви повинні створити цикл `for`, щоб ітерувати над `targets_to_print`. Використовуйте `node` як змінну циклу.
...
Ви повинні вивести наданий рядок всередині вашого нового циклу `for`.
