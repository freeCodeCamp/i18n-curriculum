...
¿Cómo debería responder Brian para mostrar que entiende el punto de Sarah?  
...
Esta respuesta mostraría desacuerdo.  
...
`That makes sense` se usa comúnmente para mostrar comprensión y acuerdo con la explicación de alguien.

Dado que Sarah está explicando las compensaciones entre `building in-house` y `outsourcing`, esta respuesta reconoce que su razonamiento es lógico.
