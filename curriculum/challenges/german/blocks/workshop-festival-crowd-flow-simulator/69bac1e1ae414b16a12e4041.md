...
Schließlich können Sie Ihre Simulationen ausführen.

Beginnen Sie mit der Frühschicht. Rufen Sie `simulateFestival()` mit `morningGates` und `"Morning"` auf.

# --hints--

Sie sollten `simulateFestival()` mit `morningGates` und `"Morning"` aufrufen.
