...
Напишіть функцію, яка приймає два вектори (масиви) як вхідні дані та обчислює їхній векторний добуток. Функція має повернути `null`, якщо вхідні дані недійсні (наприклад, надано вектори різної довжини).
