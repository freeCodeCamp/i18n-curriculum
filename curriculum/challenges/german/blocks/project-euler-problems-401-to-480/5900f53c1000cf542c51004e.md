...
title: 'Problem 463: Eine seltsame Rekursionsvorschrift'
challengeType: 1
forumTopicId: 302138
...
Die Funktion $f$ ist für alle positiven ganzen Zahlen wie folgt definiert:
...
Die Funktion $S(n)$ ist definiert als $\sum_{i=1}^{n} f(i)$.

$S(8) = 22$ und $S(100) = 3604$.

Finden Sie $S(3^{37})$. Geben Sie die letzten 9 Ziffern Ihrer Antwort an.
