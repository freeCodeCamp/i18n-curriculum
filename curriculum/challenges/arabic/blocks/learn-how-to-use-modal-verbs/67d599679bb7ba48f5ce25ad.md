...
جيمس غير متأكد مما هو الأكثر احتمالًا. ماذا سيقول؟
...
جيمس غير متأكد، لذلك لن يُدلي بتنبؤ قوي كهذا.
...
تعني عبارة `It's hard to say` أن الأمر صعب التنبؤ به أو غير مؤكد. على سبيل المثال:

- **جاك:** `Do you think the project will be finished on time?`

- **توم:** `It's hard to say. It depends on how fast we solve the issues.` - وقت الإنجاز غير مؤكد بسبب التأخيرات المحتملة.

يستخدم جيمس هذه العبارة لأنه لا يعرف بالتأكيد ما سيحدث، لكنه يقترح نتائج محتملة.
