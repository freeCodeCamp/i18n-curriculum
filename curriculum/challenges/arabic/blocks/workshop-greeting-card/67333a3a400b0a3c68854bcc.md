...
أضف خاصية `transition` إلى المحدِّد `.card-links a` وأعطها القيمة `background-color 0.3s ease`.

# --hints--

يجب أن يحتوي المحدِّد `.card-links a` على خاصية `transition` مضبوطة على `background-color 0.3s ease`.
