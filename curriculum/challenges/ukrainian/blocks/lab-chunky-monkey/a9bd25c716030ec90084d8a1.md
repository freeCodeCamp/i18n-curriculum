...
title: реалізувати алгоритм chunky monkey
challengeType: 26
...
1. Напишіть функцію з іменем `chunkArrayInGroups`, яка приймає масив як перший аргумент і число як другий аргумент. Функція має розбити масив на менші масиви довжиною, що дорівнює другому аргументу, і повернути їх у вигляді двовимірного масиву.
