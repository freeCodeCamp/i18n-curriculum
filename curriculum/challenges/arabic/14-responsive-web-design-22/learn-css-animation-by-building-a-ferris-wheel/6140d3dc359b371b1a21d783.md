...
يجب أن يكون لديك منتقي `.cabin:nth-of-type(1)`.
...
يجب أن يكون لمنتقي `.cabin:nth-of-type(1)` خاصية `right` محددة إلى `-8.5%`.
...
يجب أن يكون لمنتقي `.cabin:nth-of-type(1)` خاصية `top` محددة إلى `50%`.
