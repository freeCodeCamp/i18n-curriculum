...
Para as etapas restantes, você adicionará a funcionalidade para exibir os avatares dos usuários.

Dentro do segundo elemento `td`, adicione um elemento `div` com o nome da classe `"avatar-container"`.

# --hints--

Você deve ter um elemento `div` dentro do segundo elemento `td`.
...
Sua tag de abertura `div` deve ter um atributo class com o valor `"avatar-container"`.
