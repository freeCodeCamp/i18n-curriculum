...
Важливо розуміти, що говорять люди.

Note: `Weekdays` refer to Monday, Tuesday, Wednesday, Thursday, and Friday `Weekend` refers to Saturday and Sunday.

Ця вправа трохи відрізняється. Ви повинні спочатку прослухати аудіо та зрозуміти його суть. Після цього заповніть пропуски правильними словами, щоб завершити підсумок ранкового розпорядку Сари.
...
Вказує приблизний час, а не конкретний.
