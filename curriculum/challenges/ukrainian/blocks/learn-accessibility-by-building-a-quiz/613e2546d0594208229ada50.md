...
`img` має посилатися на `https://cdn.freecodecamp.org/platform/universal/fcc_primary.svg`, мати атрибут `id` зі значенням `logo` і містити текст `alt` з `freeCodeCamp`.
