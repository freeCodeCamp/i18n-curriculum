...
الآن، عندما يقفز اللاعب إلى الأعلى، من الممكن أن يتجاوز ارتفاع اللوحة.

لإصلاح ذلك، تحتاج إلى إضافة شرط يمنع اللاعب من السقوط بعد ارتفاع اللوحة.

أنشئ جملة `if` فارغة تتحقق مما إذا كان مجموع موضع اللاعب في المحور `y`، والارتفاع، والسرعة في المحور `y` أقل من أو يساوي ارتفاع اللوحة.

# --hints--

يجب أن تحتوي طريقة `update()` على جملة `if`.
...
يجب أن يتحقق شرط جملة `if` مما إذا كان مجموع موضع اللاعب في المحور `y`، والارتفاع، والسرعة في المحور `y` أقل من أو يساوي ارتفاع اللوحة.
