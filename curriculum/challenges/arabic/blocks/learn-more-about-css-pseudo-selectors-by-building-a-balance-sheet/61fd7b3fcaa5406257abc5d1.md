...
حان الوقت للانتقال إلى الجدول الثاني. ابدأ بإضافة عنصر `caption` واضبطه على `Liabilities`. ثم أضف عناصر `thead` و `tbody`.

# --hints--

يجب أن يحتوي عنصر `table` الثاني على عنصر `caption`.
