...
- **Atributo `tabindex`**: Usado para hacer elementos enfocables y definir el orden relativo en el que deben ser navegados usando el teclado. Es importante nunca usar el atributo `tabindex` con un valor mayor a 0. En su lugar, debes utilizar un valor de 0 o -1.
