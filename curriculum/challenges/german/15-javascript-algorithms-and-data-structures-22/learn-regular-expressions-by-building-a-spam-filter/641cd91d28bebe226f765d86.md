...
Hänge einen Event-Listener an deinen `checkMessageButton` an, der auf das `click`-Ereignis wartet. Gib ihm eine leere Callback-Funktion.

# --hints--

Du solltest `.addEventListener()` auf deinem `checkMessageButton`-Element aufrufen.
...
Deine `.addEventListener()`-Methode sollte eine leere Callback-Funktion haben.
