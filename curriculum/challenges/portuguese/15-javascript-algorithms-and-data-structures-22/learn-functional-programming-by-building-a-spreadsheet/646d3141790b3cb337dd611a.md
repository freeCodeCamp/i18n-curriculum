...
The callback function should have a parameter for each capture group in the regular expression. Nesse caso, `rangeRegex` tem quatro grupos de captura: a primeira letra, o primeiro número, a segunda letra e o segundo número.

Dê à função de callback mais quatro parâmetros para corresponder a esses grupos de captura: `char1`, `num1`, `char2` e `num2`. `char` será a abreviação de `character`.
