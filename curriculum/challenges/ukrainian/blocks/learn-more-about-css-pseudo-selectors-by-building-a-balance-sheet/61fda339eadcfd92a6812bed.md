...
Селектор `span[class~="sr-only"]` вибере будь-який елемент `span`, чий `class` *містить* `sr-only`. Створіть такий селектор та надайте йому властивість `border` зі значенням `0`.
