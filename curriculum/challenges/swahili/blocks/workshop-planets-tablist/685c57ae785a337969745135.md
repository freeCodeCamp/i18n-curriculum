...
Kwa hatua ya mwisho, unahitaji kufanya paneli ionekane wakati kichupo chake kinabofyanwa. Unaweza kufanya hivi kwa kuweka sifa ya `hidden` ya `panel` kuwa `false`.

Bofya kwenye chochote cha vichupo, na unapaswa kuona maudhui ya paneli inayohusiana ikionyeshwa.

Na kwa mabadiliko hayo ya mwisho, warsha yako imekamilika!

# --hints--

Wakati kichupo kinapobofyanwa, unapaswa kuweka sifa ya `hidden` ya paneli kuwa `false`.
