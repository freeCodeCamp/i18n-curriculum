...
Neste exemplo, a variável `count` armazena o número de repetições. Isso pode ser útil quando o número de repetições depende da entrada do usuário ou de outros valores dinâmicos no seu programa.
