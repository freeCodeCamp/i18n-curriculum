...
Usualmente se escribe en la parte superior de la hoja de estilo CSS.  The asterisk selector is a wildcard selector that matches all HTML elements, so they will have a default margin of zero and a default padding of zero on all four sides. Esto te dará un punto de partida y luego podrás personalizarlos en selectores CSS más específicos más abajo en la hoja de estilo.
