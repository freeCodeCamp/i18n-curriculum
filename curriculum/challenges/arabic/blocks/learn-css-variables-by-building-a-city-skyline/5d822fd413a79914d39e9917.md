...
أضف `repeating-linear-gradient` إلى `.fb1c` تحت التدرج الموجود؛ استخدم `--building-color4` من `0%` إلى `10%` و`--window-color4` من `10%` إلى `90%`. هذا سيملأ خلف التدرج الذي أضفته سابقًا.
