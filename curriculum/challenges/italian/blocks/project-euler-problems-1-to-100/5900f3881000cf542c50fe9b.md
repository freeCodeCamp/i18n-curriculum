...
title: 'Problema 28: diagonali della spirale numerica'
challengeType: 1
forumTopicId: 301930
...
Partendo dal numero 1 e muovendosi verso destra in senso orario, si forma una spirale 5 per 5 come segue:
...
Si può verificare che la somma dei numeri sulle diagonali è 101.

Qual è la somma dei numeri sulle diagonali in una spirale `n` per `n` formata nello stesso modo?
