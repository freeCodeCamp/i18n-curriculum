...
Тепер додайте колір до `#years`. Встановіть текст на `#fff`, а фон на `#0a0a23`.

# --hints--

Ваш `#years` повинен мати властивість `color` зі значенням `#fff`.

```js
assert(new __helpers.CSSHelp(document).getStyle('#years')?.getPropertyValue('color') === 'rgb(255, 255, 255)');
```

Ваш `#years` повинен мати властивість `background-color` зі значенням `#0a0a23`.
