...
<html lang="en">
  ...
  <body>
    <div id="game">
      ...
      <div id="text">
        Welcome to Dragon Repeller. You must defeat the dragon that is preventing people from leaving the town. Du befindest dich auf dem Stadtplatz. Wohin willst du gehen? Verwende die Schaltflächen oben.
      </div>
    </div>
