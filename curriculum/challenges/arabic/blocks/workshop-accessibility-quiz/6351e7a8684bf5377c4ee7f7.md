...
على الرغم من أن ذلك غير مطلوب لعناصر `label` التي تحتوي على `input` مسكن، إلا أنه من الأفضل ربط `label` بشكل صريح مع عنصر `input` المقابل له.

الآن، أضف خاصية `for` إلى كل من عناصر `label` الأربعة لربط كل `label` بعنصر `input` الخاص به من نوع الراديو.
...
يجب أن تعطي أول `label` خاصية `for` تطابق `id` لعنصر `input` الخاص به.
...
يجب أن تعطي ثاني `label` خاصية `for` تطابق `id` لعنصر `input` الخاص به.
...
يجب أن تعطي ثالث `label` خاصية `for` تطابق `id` لعنصر `input` الخاص به.
...
يجب أن تعطي رابع `label` خاصية `for` تطابق `id` لعنصر `input` الخاص به.
