...
يمكنك تجاوز هذا باستخدام خاصية `grid-auto-columns`. أضف إلى محدِّد `.social-icons` خاصية `grid-auto-columns` بقيمة `1fr`.

# --hints--

يجب أن يحتوي محدِّد `.social-icons` على خاصية `grid-auto-columns` بقيمة `1fr`.
