...
A `policy` is a rule or guideline used by a group or organization. A `remote work policy`, for instance, would be the set of rules about working at any place outside the office. Por exemplo:
