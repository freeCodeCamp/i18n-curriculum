...
Matokeo yanazidi kuwa magumu kusoma, kwa hivyo unapaswa kubadilisha `print(graph.create_trajectory())` na mzunguko unaochapisha kila safu kwa tofauti. 

# --hints--

Ondoa wito la `print(graph.create_trajectory())`.
...
Unapaswa kuwa na mzunguko unaorudia juu ya `graph.create_trajectory()`.
...
Unapaswa kuchapisha kila safu katika `graph.create_trajectory()`.
