...
Debes incrementar el valor actual de `sorted_index` en `1` dentro del bucle `while`. Ten en cuenta que se debe realizar el incremento después de asignar el elemento de la parte derecha al arreglo ordenado.
