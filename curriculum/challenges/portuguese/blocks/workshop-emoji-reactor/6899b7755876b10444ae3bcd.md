...
Agora é hora de vincular o arquivo JavaScript.

Adicione um elemento `script` logo antes da tag de fechamento do elemento `body` com o atributo e valor corretos para vincular o arquivo `script.js`.
...
O elemento `script` deve ter um `src` de `./script.js`.
