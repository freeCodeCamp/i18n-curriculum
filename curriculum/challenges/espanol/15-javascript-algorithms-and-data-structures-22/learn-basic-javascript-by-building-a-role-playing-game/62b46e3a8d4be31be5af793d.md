...
Para solucionar esto, mueva su `script` elemento fuera del elemento `head`, y colóquelo al final de su elemento `body` (justo antes de la etiqueta de cierre `</body>`).
