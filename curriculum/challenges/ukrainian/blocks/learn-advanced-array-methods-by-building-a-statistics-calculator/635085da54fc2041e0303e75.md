...
Нарешті, потрібно повернути значення `mean`.

# --hints--

Ваша функція `getMean` має використовувати ключове слово `return`.
...
Ваша функція `getMean` має повертати значення `mean`.
...
Ваша інструкція `return` має бути після оголошення змінної `mean`.
