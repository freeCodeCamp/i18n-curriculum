...
Remueva el margen de su elemento de `body`, establezca el `font-family` en `sans-serif` y asígnele un `background-color` con el valor `#f5f6f7`.


# --hints--

Debe tener un selector de `body`.
