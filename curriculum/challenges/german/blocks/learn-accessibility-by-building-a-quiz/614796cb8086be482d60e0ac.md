...
Zum Thema visuelle Barrierefreiheit ist der Kontrast zwischen Elementen ein entscheidender Faktor. Zum Beispiel sollte das Kontrastverhältnis zwischen dem Text und dem Hintergrund einer Überschrift mindestens 4,5:1 betragen.

Ändern Sie die Schriftfarbe aller Ankerelemente innerhalb der Listenelemente in eine Farbe mit einem Kontrastverhältnis von mindestens 7:1.

# --hints--

Ihr Selektor sollte Links innerhalb von Listenelementen ansprechen.
...
Sie sollten den `a` Elementen innerhalb von Listenelementen eine `color` Eigenschaft geben.
...
Sie sollten nur die Farbe von `a` Elementen innerhalb von Listenelementen ändern.
...
Sie sollten der `color` Eigenschaft einen Kontrast zum Hintergrund von mindestens 7:1 geben. _Hinweis: Ich würde `#dfdfe2` verwenden_
