...
Tangaza kitendakazi cha `apply` kinachopokea kigezo cha `fn` na `args`.

# --hints--

Unapaswa kutangaza variable ya `apply`.
...
Unapaswa kutumia `const` kutangaza variable yako ya `apply`.
...
Variable yako ya `apply` inapaswa kupewa thamani ya kitendakazi cha mshale.
...
Kitendakazi chako cha `apply` kinapaswa kuwa na `fn` kama kigezo chake cha kwanza.
...
Kitendakazi chako cha `apply` kinapaswa kuwa na `args` kama kigezo chake cha pili.
...
Kitendakazi chako cha `apply` kinapaswa kuwa tupu.
