...
title: 'Aufgabe 40: Champernownes Konstante'
challengeType: 1
forumTopicId: 302066
...
Eine irrationale Dezimalzahl wird gebildet, indem die positiven ganzen Zahlen aneinandergereiht werden:

0.12345678910**1**112131415161718192021...

Man erkennt, dass die 12.<sup>te</sup> Ziffer des Bruchteils eine 1 ist.

Wenn *d<sub>n</sub>* die *n*<sup>te</sup> Ziffer des Bruchteils darstellt, finden Sie den Wert des folgenden Ausdrucks.
