...
title: Algoritmi di ordinamento/ordinamento stooge
challengeType: 1
forumTopicId: 302318
...
Scrivi una funzione per eseguire l'ordinamento Stooge su un array di numeri interi. La funzione dovrebbe restituire un array ordinato.

L'algoritmo di ordinamento Stooge è il seguente:

<pre><b>algoritmo</b> stoogesort(<b>array</b> L, i = 0, j = <b>lunghezza</b>(L)-1)
  <b>se</b> L[j] &#x3C; L[i] <b>allora</b>
    L[i] <b>↔</b> L[j]
  <b>se</b> j - i > 1 <b>allora</b>
    t <b>:=</b> (j - i + 1)/3
    stoogesort(L, i , j-t)
    stoogesort(L, i+t, j )
    stoogesort(L, i , j-t)
