...
Agora o algoritmo de autoposicionamento será exibido quando você adicionar um novo elemento de ícone.No entanto, o algoritmo tem `auto` como padrão para a largura da nova coluna, o que não corresponde às colunas atuais.
...
O seletor `.social-icons` deve ter a propriedade `grid-auto-columns` definida como `1fr`.
