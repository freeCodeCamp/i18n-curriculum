...
`A tight squeeze` literally means a small space where something barely fits. In this context, however, it is a metaphor meaning something is difficult to accomplish in a short amount of time. Por ejemplo:
