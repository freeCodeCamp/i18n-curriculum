...
Sasa huna haja ya kuandika rekodi ya foleni tena. Kwa hivyo ondoa `console.log(queue)` kutoka kwenye mzunguko wako wa `while`.

# --hints--

Haupaswi kuwa na `console.log(queue)` katika mzunguko wako wa `while`.
