...
Aktualisiere die `rgb`-Funktion, so dass der Wert für Rot `162`, der Wert für Grün `27` und der Wert für Blau `27` ist.

# --hints--

Deine `.red` CSS-Regel sollte die `background`-Eigenschaft auf `linear-gradient(180deg, rgb(122, 74, 14) 0%, rgb(245, 62, 113) 50%, rgb(162, 27, 27) 100%)` gesetzt haben.
