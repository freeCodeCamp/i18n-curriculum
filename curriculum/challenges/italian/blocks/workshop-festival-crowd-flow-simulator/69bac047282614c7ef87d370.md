...
Per aiutare a tracciare come i partecipanti si muovono nel sistema, registra il seguente messaggio nella console: `overflowAmount + " attendees rerouted to " + gates[nextGateIndex].id`. Puoi usare sia la concatenazione di stringhe sia i template literal.

# --hints--

La tua funzione `rerouteOverflow` dovrebbe registrare il seguente messaggio nella console `overflowAmount + " attendees rerouted to " + gates[nextGateIndex].id`.
