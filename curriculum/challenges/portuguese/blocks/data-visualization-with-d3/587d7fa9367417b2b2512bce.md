...
**Nota:** Cada barra tem uma largura de 25, então aumentar cada valor de `x` em 30 adiciona algum espaço entre as barras. Qualquer valor superior a 25 poderia servir neste exemplo.
