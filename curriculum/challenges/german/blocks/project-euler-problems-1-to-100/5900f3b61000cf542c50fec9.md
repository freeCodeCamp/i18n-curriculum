...
title: 'Aufgabe 74: Fakultätsketten von Ziffern'
challengeType: 1
forumTopicId: 302187
...
Die Zahl 145 ist bekannt für die Eigenschaft, dass die Summe der Fakultät ihrer Ziffern gleich 145 ist:

$$1! + 4! + 5! = 1 + 24 + 120 = 145$$

Weniger bekannt ist vielleicht die Zahl 169, da sie die längste Kette von Zahlen erzeugt, die wieder auf 169 zurückführt; es stellt sich heraus, dass es nur drei solche Schleifen gibt:
...
Es ist nicht schwer zu beweisen, dass JEDER Startwert schließlich in einer Schleife hängen bleibt. Zum Beispiel:
...
Beginnt man mit 69, entsteht eine Kette von fünf nicht wiederholenden Gliedern, aber die längste nicht wiederholende Kette mit einem Startwert unter einer Million hat sechzig Glieder.

Wie viele Ketten mit einem Startwert unter `n` enthalten genau sechzig nicht wiederholende Glieder?
...
`digitFactorialChains(1000000)` sollte `402` zurückgeben.
