...
Gib den Benutzern dies an, indem du dem aktiven Element eine `cursor`-Eigenschaft mit `not-allowed` als Wert gibst.

# --hints--

Du solltest `.penguin:active` eine `cursor`-Eigenschaft von `not-allowed` haben.
