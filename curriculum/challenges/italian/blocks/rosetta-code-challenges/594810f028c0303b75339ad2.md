...
Un vettore è definito come avente tre dimensioni ed è rappresentato da una raccolta ordinata di tre numeri: (X, Y, Z).

# --instructions--

Scrivi una funzione che prenda due vettori (array) come input e calcoli il loro prodotto vettoriale. La tua funzione dovrebbe restituire `null` in caso di input non validi, come vettori di lunghezze diverse.
