...
الآن، افعل الشيء نفسه لبقية الخصائص. استخدم الدالة `getElement` لاختيار كل واحدة منها:
...
يجب الوصول إلى `multipleCardsBtn` باستخدام طريقة `getElement` وتمرير `#btn-multiple-cards`.
...
يجب الوصول إلى `multipleCard` باستخدام طريقة `getElement` وتمرير `.multiple_card`.
...
يجب الوصول إلى `title` باستخدام طريقة `getElement` وتمرير `.title`.
...
يجب الوصول إلى `newReadingBtn` باستخدام طريقة `getElement` وتمرير `.btn_reveal`.
...
يجب الوصول إلى `fortuneContainer` باستخدام طريقة `getElement` وتمرير `.fortune_container`.
...
يجب الوصول إلى `fortuneDescription` باستخدام طريقة `getElement` وتمرير `.fortune_description`.
...
يجب الوصول إلى `headerTitle` باستخدام طريقة `getElement` وتمرير `.header_title`.
...
يجب الوصول إلى `subTitle` باستخدام طريقة `getElement` وتمرير `.sub_title`.
...
يجب الوصول إلى `cardTitle` باستخدام طريقة `getElement` وتمرير `.desc_title`.
...
يجب الوصول إلى `description` باستخدام طريقة `getElement` وتمرير `.description`.
...
يجب الوصول إلى `text` باستخدام طريقة `getElement` وتمرير `.text`.
