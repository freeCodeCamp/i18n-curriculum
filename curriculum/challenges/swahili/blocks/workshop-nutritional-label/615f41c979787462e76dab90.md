...
Darasa lako jipya halijapata mtindo wowote bado. Unda kichaguzi cha `.bold` na kipa sifa ya `font-weight` iliyowekwa kuwa `800` ili kufanya maandishi kuwa herufi nzito.

Endelea na ondoa sifa ya `font-weight` kutoka kwa kichaguzi chako cha `h1` pia.
...
Kichaguzi chako cha `.bold` kinapaswa kuwa na sifa ya `font-weight` iliyowekwa kuwa `800`.
