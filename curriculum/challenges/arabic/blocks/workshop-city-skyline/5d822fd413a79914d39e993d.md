...
أضف محدِّد `:root` إلى أعلى استعلام الوسائط الخاص بك. ثم أعد تعريف جميع المتغيرات الأربعة `--building-color` لاستخدام القيمة `#000` هناك.

# --hints--

يجب أن تضيف محدِّد `:root` إلى استعلام الوسائط.
...
يجب أن تضيف `--building-color1` بقيمة `#000`.
...
يجب أن تضيف `--building-color2` بقيمة `#000`.
...
يجب أن تضيف `--building-color3` بقيمة `#000`.
...
يجب أن تضيف `--building-color4` بقيمة `#000`.
