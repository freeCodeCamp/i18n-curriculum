...
Agora, você deve passar para o CTA `Start listening` para transformá-lo em um botão adequado.

Atribua a ele as classes utilitárias `bg-indigo-100`, `px-4`, `py-2`, `text-center`, `font-semibold`, `text-indigo-700` e `hover:bg-indigo-200`.

# --hints--

Seu elemento anchor deve ter a classe `bg-indigo-100`.
...
Seu elemento anchor deve ter a classe `text-indigo-700`.
...
Seu elemento anchor deve ter a classe `hover:bg-indigo-200`.
