...
Docstrings zinaweza kufikiliwa kupitia sifa ya kipengele `__doc__`, ambayo imewekwa kuwa `None` kwa chaguo-msingi.

Thibitisha kwa kuchapisha `movie1.__doc__` na `series1.__doc__`. Kumbuka kuwa sifa ya kipengele `__doc__` haipatikani kwa darasa lolote la watoto.

# --hints--

Unapaswa kuchapisha `movie1.__doc__`.
...
Unapaswa kuchapisha `series1.__doc__`.
