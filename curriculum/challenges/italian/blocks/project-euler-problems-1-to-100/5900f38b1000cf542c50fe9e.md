...
In Inghilterra la valuta è composta da sterline, £, e pence, p, e ci sono otto monete in circolazione generale:

<div style='margin-left: 4em;'>1p, 2p, 5p, 10p, 20p, 50p, £1 (100p) e £2 (200p).</div>

È possibile ottenere £2 nel modo seguente:

<div style='margin-left: 4em;'>1×£1 + 1×50p + 2×20p + 1×5p + 1×2p + 3×1p</div>

Quante diverse combinazioni si possono ottenere per `n` pence usando un numero qualsiasi di monete?
