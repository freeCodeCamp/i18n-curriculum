...
`However` is used to introduce a contrast or different idea. Por ejemplo:
...
`Bonuses` are extra payments given to employees as rewards for good work. Por ejemplo:
