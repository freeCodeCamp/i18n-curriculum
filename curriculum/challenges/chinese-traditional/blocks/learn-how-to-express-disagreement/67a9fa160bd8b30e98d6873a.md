...
In this dialogue, Anna does not think using the stipend for office furniture is a good idea. She uses `I don't think so, Bob` to express her disagreement. 這是另一個示例：
