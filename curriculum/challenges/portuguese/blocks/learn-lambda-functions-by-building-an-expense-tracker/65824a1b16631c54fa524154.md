...
Em seguida, adicione outra chamada `print()` e passe a string `'2. List all expenses'`

# --hints--

Você deve imprimir `'2. List all expenses'` em seu loop `while` após as chamadas existentes de `print()`.
