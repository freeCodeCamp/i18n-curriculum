...
`Going to` shows that Maria is talking about something planned or decided for the future. Por ejemplo:

`I'm going to visit the headquarters tomorrow.` - it means the visit is planned.

`Inform` means to give information or notify someone. Por ejemplo:
