...
У цьому завданні ви потренуєтеся визначати відділи за діями, які вони виконують.

# --instructions--

Прослухайте та доповніть речення правильним відділом.
...
Цей відділ навчає команду.

# --explanation--

`El departamento de aprendizaje y desarrollo capacita al equipo` означає "відділ навчання та розвитку навчає команду".

Обидва `apoyar` ("to support") і `capacitar` ("to train") — це дієслова в третій особі однини, які закінчуються на `-ar`.

Вони слідують тому ж шаблону, що й `desarrolla`, `verifica` та `crea` з попередніх завдань.
