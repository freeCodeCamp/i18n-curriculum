...
title: "Usa jQuery per modificare l'intera pagina"
challengeType: 6
forumTopicId: 18361
required:
...
Abbiamo finito di giocare con il nostro playground jQuery. Smontiamolo!

jQuery può prendere di mira anche l'elemento `body`.

Ecco come faremmo svanire l'intero body: `$("body").addClass("animated fadeOut");`
