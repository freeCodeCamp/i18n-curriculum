...
No debes cambiar la propiedad `width`. Utiliza la propiedad `min-width`.
...
Debes utilizar la propiedad `margin` existente para incluir `1em` a la parte superior e inferior.
