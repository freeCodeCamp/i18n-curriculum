...
`Honestly` at the beginning of a sentence is used to express a sincere, truthful, or direct opinion. It often signals that the speaker is sharing their real thoughts, even if they might not be positive. Por ejemplo:
