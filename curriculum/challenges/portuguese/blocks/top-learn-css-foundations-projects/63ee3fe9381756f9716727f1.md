...
1. Você deve definir um tamanho de fonte de `28px` usando uma lista de seletores.
1. Você deve ter uma lista de fontes contendo `Helvetica` e `Times New Roman` com `sans-serif` como fallback na lista de seletores.
1. Você deve ver um nome de classe exclusivo em cada elemento.
1. Você deve ter uma lista de seletores para estilos que ambos os elementos compartilham.
...
Você deve definir o `font-size` para ambos os elementos como `28px` usando uma lista de seletores.
...
Você deve ter um nome de classe único em cada elemento.
...
Você deve ter uma lista de seletores para estilos que ambos os elementos compartilham.
...
Você deve ter uma lista de fontes contendo `Helvetica` e `Times New Roman` com `sans-serif` como fallback na lista de seletores.
