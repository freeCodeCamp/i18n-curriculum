...
Use um `for` loop para registrar o `name` de cada astronauta no `sorted` array.

# --hints--

Você deve usar um `for` loop para iterar através do `sorted` array e registrar o `name` de cada astronauta.
