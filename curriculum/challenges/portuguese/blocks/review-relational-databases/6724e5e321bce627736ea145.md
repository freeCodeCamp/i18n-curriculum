...
- **Operadores de atribuição**: Modifique variáveis usando operadores de atribuição aritmética.
  ...
  - `%=` (módulo e atribuir): Atribuir variável ao resto
...
- **Números aleatórios**: Gere valores aleatórios usando a variável `$RANDOM`.
  ...
  - Use o operador modulo para limitar o intervalo: `$RANDOM % 75`
...
- **Operador de módulo**: Use `%` para obter o resto das operações de divisão.
