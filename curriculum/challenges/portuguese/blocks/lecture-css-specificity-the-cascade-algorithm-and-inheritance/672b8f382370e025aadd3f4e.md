...
No entanto, é importante lembrar que a herança funciona apenas em uma direção, do pai para o filho. Se você sobrescrever um estilo em um elemento filho, isso não afetará o elemento pai.
