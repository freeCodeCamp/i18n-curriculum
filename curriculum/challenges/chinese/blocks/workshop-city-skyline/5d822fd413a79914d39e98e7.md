...
为这六个新元素赋予以下 `width` 和 `height` 值：`.fb1` 为 `10%` 和 `60%`，`.fb2` 为 `10%` 和 `40%`，`.fb3` 为 `10%` 和 `35%`，`.fb4` 为 `8%` 和 `45%`，`.fb5` 为 `10%` 和 `33%`，`.fb6` 为 `9%` 和 `38%`。
