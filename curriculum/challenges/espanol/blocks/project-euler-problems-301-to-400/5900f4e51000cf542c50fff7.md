...
$P(\text{el segundo jugador gana}) = \frac{7}{12} > \frac{1}{2}$
...
$P(\text{el segundo jugador gana}) = \frac{25}{36} > \frac{1}{2}$

Así que, sea cual sea el dado que el primer jugador escoja, el segundo jugador puede elegir otro dado y tener más de un 50% de probabilidades de ganar. Un conjunto de dados que tienen esta propiedad se llama un conjunto no transitorio de dados.

Queremos investigar cuántos conjuntos de dados no transitorios existen. Asumiremos las siguientes condiciones:
