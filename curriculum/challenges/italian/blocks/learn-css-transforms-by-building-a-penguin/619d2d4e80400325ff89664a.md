...
Per mantenere il gradiente lineare sul lato corretto del braccio sinistro del pinguino, ruotalo prima di `130deg` e poi inverti l'asse x.

# --hints--

Dovresti dare a `.arm.left` un `transform` di `rotate(130deg) scaleX(-1)`.
