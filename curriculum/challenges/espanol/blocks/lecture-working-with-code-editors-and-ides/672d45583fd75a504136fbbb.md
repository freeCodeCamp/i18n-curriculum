...
La lección menciona una posible fuente de confusión al buscar VS Code.
...
La lección describe varias formas de instalar VS Code en Mac, pero no se menciona un método común para la instalación de software.
...
La lección proporciona un comando específico para Homebrew.
