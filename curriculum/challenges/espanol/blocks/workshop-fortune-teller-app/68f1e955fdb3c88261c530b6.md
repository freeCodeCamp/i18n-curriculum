...
Agrega una sentencia `if` para verificar si `foundCard` existe antes de actualizar los elementos con sus datos o contenido.

# --hints--

Debes declarar una sentencia `if` con la condición `foundCard`.
