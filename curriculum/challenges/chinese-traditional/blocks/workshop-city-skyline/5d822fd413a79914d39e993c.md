...
在媒體查詢的 `sky` 類別中，將兩個 `#ffcf33` 顏色值改為 `#ccc`，將 `#ffff66` 改為 `#445`，並將 `#bbeeff` 改為 `#223`。然後你可以調整你的視窗大小以查看背景顏色變化。

# --hints--

你應該將第一個顏色值從 `#ffcf33` 改為 `#ccc`。
