...
`get_mood("rock", 111)` debería devolver `"happy"`.
...
`get_mood("electronic", 74)` debería devolver `"focus"`.
...
`get_mood("classical", 180)` debería devolver `"happy"`.
...
`get_mood("rock", 155)` debería devolver `"hype"`.
...
`get_mood("electronic", 90)` debería devolver `"happy"`.
...
`get_mood("classical", 67)` debería devolver `"focus"`.
...
`get_mood("pop", 100)` debería devolver `"happy"`.
...
`get_mood("electronic", 135)` debería devolver `"hype"`.
