...
Ahora completa la clase `TVSeries` agregando el docstring `Child class representing an entire TV series.`.

# --hints--

Debes agregar el docstring `Child class representing an entire TV series.` a tu clase `TVSeries`.
