...
تبدو القائمة جيدة، ولكن بخلاف صورة خلفية حبوب البن، إنها في الأساس مجرد نص.

تحت عنوان `Coffee`، أضف صورة باستخدام الرابط `https://cdn.freecodecamp.org/curriculum/css-cafe/coffee.jpg`. أعطِ الصورة قيمة `alt` بـ `coffee icon`.
