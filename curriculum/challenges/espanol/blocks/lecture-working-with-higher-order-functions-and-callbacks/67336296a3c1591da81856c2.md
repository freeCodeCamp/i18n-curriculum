...
Muchos métodos integrados para arreglos en JavaScript, como `map()`, `filter()` y `reduce()`, son funciones de orden superior. Estos métodos toman una función como argumento y la aplican a los elementos del arreglo de diferentes maneras.  You will learn more about these methods in future lessons.
