...
Властивість `place-items` можна використовувати, щоб одночасно встановити значення `align-items` і `justify-items`. Властивість `place-items` приймає одне або два значення. Якщо задано одне значення, воно використовується для властивостей `align-items` і `justify-items`. Якщо задано два значення, перше використовується для властивості `align-items`, а друге — для властивості `justify-items`.
