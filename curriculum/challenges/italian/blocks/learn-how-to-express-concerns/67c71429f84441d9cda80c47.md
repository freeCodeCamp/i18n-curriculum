...
Questo significa dire qualcosa brevemente senza entrare nei dettagli.

# --explanation--

`To mention` significa introdurre un argomento nella conversazione senza fornire molti dettagli. Per esempio:

`She mentioned a new project, but she didn't explain it yet.` - Questo significa che ha parlato brevemente di un nuovo progetto ma non ha fornito ulteriori informazioni.
