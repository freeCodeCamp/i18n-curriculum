...
Debes asignar el elemento `#player-song-title` a la variable `playingSong`. No olvides utilizar `const` para declarar la variable.
...
Debes asignar el elemento `#player-song-artist` a la variable `songArtist`. No olvides utilizar `const` para declarar la variable.
