...
Las propiedades `averageRating`, `totalIngredients` y `difficultyLevel` de `recipe3` han sido completadas para usted.

Ahora, registre el arreglo `recipes` en la consola para ver todos sus elementos llenos con los valores actualizados.

Con eso, su proyecto de seguimiento de recetas está completo.

# --hints--

Debe registrar el arreglo `recipes` en la consola.
