...
الآن، يجب أن تنتقل إلى زر الدعوة إلى الإجراء `Start listening` لجعله زرًا صحيحًا.

عيّن له أصناف الأدوات `bg-indigo-100`، `px-4`، `py-2`، `text-center`، `font-semibold`، `text-indigo-700`، و `hover:bg-indigo-200`.

# --hints--

يجب أن يحتوي عنصر وسم الرابط على الصنف `bg-indigo-100`.
...
يجب أن يحتوي عنصر وسم الرابط على الصنف `text-indigo-700`.
...
يجب أن يحتوي عنصر وسم الرابط على الصنف `hover:bg-indigo-200`.
