...
論理演算子を使用すると、もっと複雑なメディアクエリを作ることができます。 `and` 論理演算子は、2 つのメディア条件を指定する場合に使用します。

たとえば、500px ～1000px の間の表示幅をターゲットとするメディアクエリは次のようになります:
...
ブラウザーのウインドウの幅が `769px` 以上 `1199px` 以下である場合に適用される `@media` ルールを追加してください。
