...
Ndani ya kipengele cha button katika kitendakazi cha `renderSongs`, ongeza sifa ya kipengele ya `onclick`. Kwa thamani, fanya wito wa kitendakazi cha `deleteSong` na uingize `song.id`.

# --hints--

Unapaswa kuongeza sifa ya kipengele ya `onclick` kwenye kitufe cha futa na upitishe `"deleteSong(${song.id})"`.
