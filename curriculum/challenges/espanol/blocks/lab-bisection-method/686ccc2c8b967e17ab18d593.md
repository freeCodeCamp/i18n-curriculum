...
1. Debes definir una función llamada `square_root_bisection` con tres parámetros:
...
1. La función `square_root_bisection` debe:
    ...
    - Si ningún valor cumple la condición de tolerancia, imprime un mensaje de error: `Failed to converge within [maximum] iterations` y devuelve `None`.
