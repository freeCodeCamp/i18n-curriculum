...
Ora, rimuovi le seguenti righe dalla fine del tuo codice:
...
Non dovresti avere la riga `print(product)` nel tuo codice.
...
Non dovresti avere la riga `discount = PercentageDiscount(10)` nel tuo codice.
...
Non dovresti avere la riga `print(discount.apply_discount(product))` nel tuo codice.
...
Non dovresti avere la riga `fixed_discount = FixedAmountDiscount(5)` nel tuo codice.
...
Non dovresti avere la riga `print(fixed_discount.apply_discount(product))` nel tuo codice.
