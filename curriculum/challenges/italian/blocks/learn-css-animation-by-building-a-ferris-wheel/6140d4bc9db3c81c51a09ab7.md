...
Continuando il pattern, seleziona i seguenti elementi `.cabin` e applica loro le regole specifiche:

- Il secondo `.cabin` dovrebbe avere la proprietà `right` impostata su `17%` e la proprietà `top` impostata su `93.5%`.
- Il terzo `.cabin` dovrebbe avere la proprietà `right` impostata su `67%` e la proprietà `top` impostata su `93.5%`.
- Il quarto `.cabin` dovrebbe avere la proprietà `left` impostata su `-8.5%` e la proprietà `top` impostata su `50%`.
- Il quinto `.cabin` dovrebbe avere la proprietà `left` impostata su `17%` e la proprietà `top` impostata su `7%`.
- Il sesto `.cabin` dovrebbe avere la proprietà `right` impostata su `17%` e la proprietà `top` impostata su `7%`.
...
Il tuo selettore `.cabin:nth-of-type(2)` dovrebbe avere una proprietà `right` impostata su `17%`.

```js
assert(new __helpers.CSSHelp(document).getStyle('.cabin:nth-of-type(2)')?.right === '17%');
```

Il tuo selettore `.cabin:nth-of-type(2)` dovrebbe avere una proprietà `top` impostata su `93.5%`.
...
Il tuo selettore `.cabin:nth-of-type(3)` dovrebbe avere una proprietà `right` impostata su `67%`.

```js
assert(new __helpers.CSSHelp(document).getStyle('.cabin:nth-of-type(3)')?.right === '67%');
```

Il tuo selettore `.cabin:nth-of-type(3)` dovrebbe avere una proprietà `top` impostata su `93.5%`.
...
Il tuo selettore `.cabin:nth-of-type(4)` dovrebbe avere una proprietà `left` impostata su `-8.5%`.

```js
assert(new __helpers.CSSHelp(document).getStyle('.cabin:nth-of-type(4)')?.left === '-8.5%');
```

Il tuo selettore `.cabin:nth-of-type(4)` dovrebbe avere una proprietà `top` impostata su `50%`.
...
Il tuo selettore `.cabin:nth-of-type(5)` dovrebbe avere una proprietà `left` impostata su `17%`.

```js
assert(new __helpers.CSSHelp(document).getStyle('.cabin:nth-of-type(5)')?.left === '17%');
```

Il tuo selettore `.cabin:nth-of-type(5)` dovrebbe avere una proprietà `top` impostata su `7%`.
...
Il tuo selettore `.cabin:nth-of-type(6)` dovrebbe avere una proprietà `right` impostata su `17%`.
...
Il tuo selettore `.cabin:nth-of-type(6)` dovrebbe avere una proprietà `top` impostata su `7%`.
