...
Ili kumalizia mtindo wa vitufe, ongeza darasa la vitu la huduma `font-semibold` kwa kila kipengele cha nanga `a` ili maandishi yao yawe na herufi nzito zaidi. Pia, ongeza darasa la vitu `rounded` kuondoa pembe kali kwenye vitufe.

# --hints--

Kipengele chako cha kwanza cha nanga kinapaswa kuwa na darasa la vitu la huduma `font-semibold`.
...
Kipengele chako cha kwanza cha nanga kinapaswa kuwa na darasa la vitu la huduma `rounded`.
...
Kipengele chako cha pili cha nanga kinapaswa kuwa na darasa la vitu la huduma `font-semibold`.
...
Kipengele chako cha pili cha nanga kinapaswa kuwa na darasa la vitu la huduma `rounded`.
