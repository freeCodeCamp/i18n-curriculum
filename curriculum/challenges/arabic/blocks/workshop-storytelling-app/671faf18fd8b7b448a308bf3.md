...
لتمييز الأنواع المختلفة من القصص، يجب تمرير نوع القصة المختارة إلى دالة `displayStory`.

أضف معلمة تسمى `genre` إلى دالة `displayStory`.

# --hints--

يجب إضافة المعلمة `genre` إلى دالة `displayStory`.
