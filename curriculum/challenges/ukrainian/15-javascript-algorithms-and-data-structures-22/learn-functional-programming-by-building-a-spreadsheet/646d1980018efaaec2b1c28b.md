...
Використайте той самий синтаксис, що й у функції `addCharacters`, щоб оновити функцію `elemValue`. Вона більше не повинна оголошувати `inner`, але має повернути функцію неявно.

# --hints--

Функція `elemValue` має використати неявне повернення.
...
Функція `elemValue` за замовчуванням має повернути стрілкову функцію, з параметром `character`.
...
Внутрішня стрілкова функція має використовувати неявне повернення.
...
Внутрішна стрілкова функція повинна повернути результат виклику `idToText()` з `character + num` як аргументом.
