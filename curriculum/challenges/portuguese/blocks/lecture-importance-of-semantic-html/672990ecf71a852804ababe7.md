...
Altere o tamanho de 5 para 7 para ver o aumento da fonte.
...
Adicione tags `center` ao redor do `<p>Another example text.</p>` para vê-lo centralizado na página.
...
Adicione tags `big` ao redor do `Some other text` e veja as mudanças na janela de visualização.
...
Adicione um `<a href="#">Products</a>` dentro do `nav` e veja as mudanças na janela de visualização.
