...
Додайте ще один об’єкт до масиву `animationData`. Новий об’єкт повинен мати властивості `inputVal` та `addElDelay` зі значеннями `1` та `2000` відповідно. Пам’ятайте, що масив `animationData` слід розглядати як стек та додати новий об’єкт у верхню частину стека.

# --hints--

Масив `animationData` повинен мати довжину `3`.
