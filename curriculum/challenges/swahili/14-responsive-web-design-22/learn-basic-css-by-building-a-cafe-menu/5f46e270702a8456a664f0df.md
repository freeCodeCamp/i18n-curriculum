...
Ili kuondoa baadhi ya nafasi wima kati ya kipengele cha `h1` na maandishi `Est. 2020`, badilisha ukingo wa chini wa `h1` kuwa `15px`.
...
Kipengele chako cha `h1` kinapaswa kuwa na `margin-bottom` ya `15px`.
