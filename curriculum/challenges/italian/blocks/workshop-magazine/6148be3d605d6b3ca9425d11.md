...
Anche il sottotitolo deve essere stilizzato. Crea un selettore `.hero-subtitle` e dagli una proprietà `font-size` impostata su `2.4rem`, una proprietà `color` impostata su `orangered` e una proprietà `text-align` impostata su `center`.
