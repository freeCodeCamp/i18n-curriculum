...
Tengeneza kichaguzi cha `h1`, na weka sifa ya `font-family` kuwa `Anton` kwa njia mbadala ya `sans-serif`.
...
Kichaguzi chako cha `h1` kinapaswa kuwa na sifa ya `font-family` iliyowekwa kuwa `Anton` kwa njia mbadala ya `sans-serif`.
