...
Negative Fragen sind ein Weg, jemanden zu bitten etwas zu tun oder eine Aktion auf höfliche oder ermutigende Weise, vorzuschlagen,. Sie beginnen oft mit `why`, gefolgt von einer negativen Form wie `don't`. For example:
