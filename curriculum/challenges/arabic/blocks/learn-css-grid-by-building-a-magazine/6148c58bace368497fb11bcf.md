...
تمامًا مثل Flexbox، مع CSS Grid يمكنك محاذاة محتوى عناصر شبكي باستخدام `align-items` و `justify-items`. تقوم `align-items` بمحاذاة العناصر الفرعية على محور العمود، وتقوم `justify-items` بمحاذاة العناصر الفرعية على محور الصف.

أعطِ المحدِّد `.social-icons` خاصية `align-items` بقيمة `center`.
