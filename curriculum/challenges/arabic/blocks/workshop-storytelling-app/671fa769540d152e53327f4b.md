...
اختر الأزرار `#scary-btn`، و`#funny-btn`، و`#adventure-btn` واحفظها في متغيرات باسم `scaryStoryBtn`، و`funnyStoryBtn`، و`adventureStoryBtn`.

# --hints--

اختر الزر `#scary-btn` باستخدام طريقة `getElementById` واحفظه في المتغير `scaryStoryBtn`.
...
اختر الزر `#funny-btn` باستخدام طريقة `getElementById` واحفظه في المتغير `funnyStoryBtn`.
...
اختر الزر `#adventure-btn` باستخدام طريقة `getElementById` واحفظه في المتغير `adventureStoryBtn`.
