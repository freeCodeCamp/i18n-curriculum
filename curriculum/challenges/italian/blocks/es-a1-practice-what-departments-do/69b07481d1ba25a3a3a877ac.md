...
Esercitati a scegliere la forma corretta del verbo per un dipartimento singolare.
...
`Verifican` è la forma per `ellos/ellas`, ma `el departamento` è singolare.
...
`El departamento de control de calidad verifica el software.` - Il dipartimento di controllo qualità verifica il software.
