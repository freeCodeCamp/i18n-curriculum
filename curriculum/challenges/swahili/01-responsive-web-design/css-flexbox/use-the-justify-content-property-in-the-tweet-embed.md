...
title: Tumia Sifa ya justify-content katika Upachikaji wa Tweet
challengeType: 0
...
Ongeza kipengele cha CSS `justify-content` kwenye kipengele cha kichwa cha `.profile-name` na uweke thamani kwa chaguo zozote kutoka kwa changamoto ya mwisho.
...
Kipengele cha `.profile-name` kinafaa kuwa na kipengele cha `justify-content` kilichowekwa kwa thamani zozote kati ya hizi: `center`, `flex-start< /code>, <code>flex-end`, `space-between`, `space-around`, au `space-evenly`.
