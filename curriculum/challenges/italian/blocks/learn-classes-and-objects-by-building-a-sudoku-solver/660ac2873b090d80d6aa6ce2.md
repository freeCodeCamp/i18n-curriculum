...
Ora, crea un loop `for` per iterare sulle righe della board. Usa `row` come variabile del loop.

# --hints--

Dovresti creare un loop `for` che itera su `self.board`.
...
Dovresti usare `row` come variabile del loop.
