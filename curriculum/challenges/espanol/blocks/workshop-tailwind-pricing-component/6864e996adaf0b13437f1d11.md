...
Ahora, debes pasar a estilizar los elementos para el **Listener plan**.

Asigna al `div` externo del plan las clases `bg-gray-100`, `ring-1` para crear un contorno grueso alrededor del `div`, y `ring-gray-300` para asignar un color oscuro a ese contorno.

# --hints--

Tu elemento `div` debe tener la clase `bg-gray-100`.
...
Tu elemento `div` debe tener la clase `ring-1`.
...
Tu elemento `div` debe tener la clase `ring-gray-300`.
