...
Sasa, ondoa wito zote mbili za `print(lin_eq.solve())` na `print(lin_eq.analyze())` kutoka kwenye msimbo wako.

# --hints--

Unapaswa kuondoa wito zote mbili za `print(lin_eq.solve())` na `print(lin_eq.analyze())`.
