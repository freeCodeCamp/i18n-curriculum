...
A continuación, no hay mucha separación entre el nombre e imagen de cada autor y el resto de los detalles en la tarjeta. Un divisor dará a las tarjetas de autor una jerarquía visual clara.
...
Tu elemento `div` debe tener la `class` establecida en `"purple-divider"`.
