...
In questo dialogo, Bob usa il past continuous per descrivere azioni in corso nel passato.
...
Il verbo è `to add`. Ricorda di coniugarlo.
...
Il verbo è `to push`. Ricorda di coniugarlo.
