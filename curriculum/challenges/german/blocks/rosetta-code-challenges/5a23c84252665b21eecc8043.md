...
Finden Sie Lösungen für das *Summe zu hundert* Rätsel.

Fügen Sie die mathematischen Operatoren **+** oder **─** (Plus oder Minus) vor beliebigen Ziffern in der dezimalen Zahlenfolge **123456789** ein, sodass der resultierende mathematische Ausdruck eine bestimmte Summe ergibt (in diesem ikonischen Fall **100**).
...
Schreiben Sie eine Funktion, die eine Zahl als Parameter entgegennimmt. Die Funktion soll ein Array mit allen Lösungen für die angegebene Zahl zurückgeben. Die Lösungen sollen Strings sein, die die Ausdrücke darstellen. Zum Beispiel: "1+23-456+78-9". Sortieren Sie das Array vor der Rückgabe.
