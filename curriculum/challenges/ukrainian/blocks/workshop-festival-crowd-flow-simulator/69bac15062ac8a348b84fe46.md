...
Спочатку виведіть у консоль наступне повідомлення: `"\n" + timeBlock + " Simulation"`.

# --hints--

Ваша функція `simulateFestival` спочатку має вивести повідомлення `"\n" + timeBlock + " Simulation"`.
...
Ваша функція `simulateFestival` має виводити правильний часовий блок у повідомленні.
