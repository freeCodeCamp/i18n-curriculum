...
Ramani na Seti zinashiriki njia chache ambazo zina jina na kusudi sawa. Kwa mfano unaweza kutumia njia ya `has` kwenye seti ili kuangalia kama ina kipengele fulani.

Tumia njia ya `has` kuangalia kama kitu cha `ballerina` kiko ndani ya `plantsSet` yako na andika matokeo kwenye konsoli.

# --hints--

Unapaswa kuandika `plantsSet.has(ballerina)` kwenye konsoli.
