...
The verb `monitor` means to watch or check something, especially in a business or technical setting. Por ejemplo:
...
`Closely` means to do something in a careful or detailed way. Por ejemplo:
