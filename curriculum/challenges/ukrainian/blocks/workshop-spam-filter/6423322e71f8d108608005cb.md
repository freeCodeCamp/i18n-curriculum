...
Тепер оновіть свій `o` символ, щоб він відповідав `o` і `0` (цифрі).

# --hints--

Ваш `freeRegex` має використовувати клас символів, щоб відповідати `o` і `0`.
...
Ваш `freeRegex` має відповідати `fr33 m0n3y`.
