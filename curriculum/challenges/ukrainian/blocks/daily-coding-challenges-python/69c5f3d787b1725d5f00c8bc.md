...
title: "Завдання 258: Розпаковувач слів"
challengeType: 29
...
Дано стиснутий рядок, поверніть розпаковану версію, використовуючи такі правила:

- Даний рядок складається зі слів і чисел, розділених пробілами.
- Залиште слова без змін.
- Замініть числа словом на відповідній позиції, де перше слово має позицію 1.

Наприклад, для `"practice makes perfect and 3 1 2 3"` поверніть `"practice makes perfect and perfect practice makes perfect"`.

# --hints--

`decompress("practice makes perfect and 3 1 2 3")` має повернути `"practice makes perfect and perfect practice makes perfect"`.
...
`decompress("hello 1 1")` має повернути `"hello hello hello"`.
...
`decompress("the cat sat on 1 mat 4 which 1 2 3")` має повернути `"the cat sat on the mat on which the cat sat"`.
...
`decompress("the more you know 1 2 3 realize 3 don't 4")` має повернути `"the more you know the more you realize you don't know"`.
