...
title: 'Problema 74: catene di fattoriali delle cifre'
challengeType: 1
forumTopicId: 302187
...
Il numero 145 è noto per la proprietà che la somma del fattoriale delle sue cifre è uguale a 145:

$$1! + 4! + 5! = 1 + 24 + 120 = 145$$

Forse meno noto è il 169, perché produce la catena più lunga di numeri che ritornano a 169; si scopre che esistono solo tre loop di questo tipo:
...
Non è difficile dimostrare che OGNI numero di partenza finirà per bloccarsi in un loop. Per esempio,
...
Partire da 69 produce una catena di cinque termini non ripetuti, ma la catena non ripetuta più lunga con un numero di partenza sotto un milione è di sessanta termini.

Quante catene, con un numero di partenza sotto `n`, contengono esattamente sessanta termini non ripetuti?
