...
Cree un nuevo selector `.left-container p` configurando el margen superior e inferior en `-5px`, y el margen izquierdo y derecho en `-2px`. También establece `font-size` a `2em` y `font-weight` a `700`.
