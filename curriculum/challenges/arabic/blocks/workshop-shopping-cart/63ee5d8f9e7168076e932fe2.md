...
بعد عنصر `h2`، أنشئ عنصرين `p`. أعطِ الأول `class` باسم `dessert-price`، وضع النص علامة الدولار `"$"` متبوعة بقيمة المتغير `price`. أعطِ الثاني `class` باسم `product-category`، والنص `"Category: "` متبوعًا بقيمة المتغير `category`.

# --hints--

يجب أن تنشئ عنصرين `p`.
...
يجب أن تأتي عناصر `p` بعد عنصر `h2`.
