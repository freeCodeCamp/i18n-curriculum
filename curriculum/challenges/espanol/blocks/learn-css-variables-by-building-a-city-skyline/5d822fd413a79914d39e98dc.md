...
Los edificios están actualmente apilados uno encima del otro. Alinea los edificios convirtiendo el elemento `.background-buildings` en un contenedor flex. Utiliza las propiedades `align-items` y `justify-content` para distribuir uniformemente los edificios en la parte inferior del elemento.
