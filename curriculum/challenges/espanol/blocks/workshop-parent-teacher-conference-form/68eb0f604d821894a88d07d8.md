...
Para que el contenedor destaque, debes agregar un `box-shadow` configurado en `0 5px 15px black`. 

Esto añade un efecto de sombra alrededor del contenedor. Los valores controlan el desplazamiento horizontal, desplazamiento vertical, radio de desenfoque y color respectivamente.
...
Debes establecer la propiedad `box-shadow` en `0 5px 15px black`.
