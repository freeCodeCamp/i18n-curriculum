...
Dentro del cuarto elemento `td`, actualiza su valor actual para que llame a la función `viewCount` con la variable `views` como argumento.

# --hints--

Debes llamar a la función `viewCount` y pasar como argumento en la variable `views`.
