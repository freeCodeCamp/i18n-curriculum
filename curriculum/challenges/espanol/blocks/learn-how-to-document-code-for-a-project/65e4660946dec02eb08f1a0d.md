...
Aunque se puede incluir información de contacto, el propósito principal de un archivo `README` es dar instrucciones e información sobre el proyecto, no solo detalles de contacto.
...
Un registro de cambios, a menudo llamado changelog, generalmente está separado de un archivo `README`. El archivo `README` se centra en introducir y explicar el proyecto.
