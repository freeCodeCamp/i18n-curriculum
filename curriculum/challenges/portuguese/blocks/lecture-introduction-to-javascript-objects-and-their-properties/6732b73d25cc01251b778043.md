...
Tipos de dados primitivos são a forma mais simples de dados em JavaScript.  They include number, bigint, string, boolean, `null`, `undefined`, and symbol. Esses tipos são chamados de "primitivos" porque representam valores únicos e não são objetos.
