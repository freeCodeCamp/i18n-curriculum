...
# --hints--
Chamar `add_time('3:30 PM', '2:12')` deve retornar `'5:42 PM'`.
...
Chamar `add_time('11:55 AM', '3:12')` deve retornar `'3:07 PM'`.
...
Tempo esperado para terminar com `'(próximo dia)'` quando for o próximo dia.
...
Período esperado para mudar de `AM` para `PM` às `12:00`.
...
Chamar `add_time('2:59 AM', '24:00')` deve retornar `'2:59 AM (dia seguinte)'`.
...
Chamar `add_time('11:59 PM', '24:05')` deve retornar `'12:04 AM (2 dias depois)'`.
...
Chamar `add_time('8:16 PM', '466:02')` deve retornar `'6:18 AM (20 dias depois)'`.
...
Esperava adicionar `0:00` para retornar o tempo inicial.
...
Chamar `add_time('3:30 PM', '2:12', 'Monday')` deve retornar `'5:42 PM, Monday'`.
...
Chamar `add_time('2:59 AM', '24:00', 'saturDay')` deve retornar `'2:59 AM, Sunday (next day)'`.
...
Chamar `add_time('11:59 PM', '24:05', 'Wednesday')` deve retornar `'12:04 AM, Friday (2 days later)'`.
...
Chamar `add_time('8:16 PM', '466:02', 'tuesday')` deve retornar `'6:18 AM, Monday (20 days later)'`.
