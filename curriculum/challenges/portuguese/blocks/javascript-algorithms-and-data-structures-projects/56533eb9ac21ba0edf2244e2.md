...
Um uso moderno comum é a cifra <a href="https://www.freecodecamp.org/news/how-to-code-the-caesar-cipher-an-introduction-to-basic-encryption-3bf77b4e19f7/" target="_blank" rel="noopener noreferrer nofollow">ROT13</a>, onde os valores das letras são deslocados em 13 posições. Da seguinte forma: `A ↔ N`, `B ↔ O` e assim por diante.

Escreva uma função que receba uma string codificada em <a href="https://www.freecodecamp.org/news/how-to-code-the-caesar-cipher-an-introduction-to-basic-encryption-3bf77b4e19f7/" target="_blank" rel="noopener noreferrer nofollow">ROT13</a> como entrada e retorne uma string decodificada.
