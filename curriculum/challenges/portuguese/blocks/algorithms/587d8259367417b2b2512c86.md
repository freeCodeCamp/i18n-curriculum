...
**Instruções:** Escreva uma função `insertionSort` que receba um array de inteiros como entrada e retorne um array desses inteiros em ordem crescente, do menor para o maior.
