...
Видаліть `orange` із градієнта `.bb1d` та змініть `80%` на `50%`. This will make `--building-color1` solid for the top half, and then transition to `--window-color1` for the bottom half.
