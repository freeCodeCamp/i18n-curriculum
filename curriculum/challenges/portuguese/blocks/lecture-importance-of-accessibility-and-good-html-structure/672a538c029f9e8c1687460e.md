...
- Use textos claros e descritivos que resumam o conteúdo que segue cada título.
- Não use um título isolado; algum conteúdo deve seguir o título.
- Use títulos apropriados quando necessário em vez de formatar texto para parecer títulos.
- Cada página deve ter um único elemento `h1` representando o tema ou título principal.
