...
你的 `.red` CSS 规则应该有一个 `background` 属性，设置为 `linear-gradient(rgb(122, 74, 14), rgb(245, 62, 113), rgb(162, 27, 27))`。
...
你的 `.green` CSS 规则应该有一个 `background` 属性，设置为 `linear-gradient(#55680D, #71F53E, #116C31)`。
