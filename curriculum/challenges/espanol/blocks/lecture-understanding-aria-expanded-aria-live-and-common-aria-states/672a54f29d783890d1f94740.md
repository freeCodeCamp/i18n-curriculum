...
El estado `aria-haspopup` se usa para indicar que el botón de menú `File` abrirá un menú emergente al ser activado. Los usuarios de lectores de pantalla pueden escuchar esta información adicional cuando navegan al botón.
