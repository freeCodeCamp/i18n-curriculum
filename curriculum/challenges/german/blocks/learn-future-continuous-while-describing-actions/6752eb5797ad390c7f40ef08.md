...
`I'll`, `joining`, `monitoring`, `testing`, `be` und `going`.
...
Dieses Wort ist Teil der `Future Continuous`-Zeitform.
...
Dieses Wort beschreibt Brians laufende Handlung, das System während der Wartung zu überprüfen.
...
Dieses Wort zeigt Jessicas Plan, an der Wartung teilzunehmen.
...
Dieses Wort beschreibt die Handlung, die Serverlast während der Wartung zu bewerten.
...
Dieses Wort ist Teil der `Simple Future`-Zeitform und beschreibt die Pläne der anderen Entwickler, Stresstests durchzuführen.
...
Diese Kontraktion bezieht sich auf Jessicas Absicht, eine Benachrichtigung an die Benutzer zu senden.
