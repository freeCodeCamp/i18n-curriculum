...
title: Rimuovere i codici di controllo e i caratteri estesi da una stringa
challengeType: 1
forumTopicId: 302327
...
L’attività consiste nel rimuovere i codici di controllo e i caratteri estesi da una stringa. La soluzione dovrebbe mostrare come ottenere ciascuno dei seguenti risultati: una stringa con i codici di controllo e i caratteri estesi rimossi. Nell’ASCII, i codici di controllo hanno codici decimali da 0 a 31 e 127. Su un sistema basato su ASCII, se si rimuovono i codici di controllo, la stringa risultante avrà tutti i suoi caratteri nell’intervallo da 32 a 126 decimale nella tabella ASCII. Su un sistema non basato su ASCII, consideriamo caratteri che non hanno un glifo corrispondente nella tabella ASCII (nell’intervallo ASCII da 32 a 126 decimale) come caratteri estesi ai fini di questa attività.
