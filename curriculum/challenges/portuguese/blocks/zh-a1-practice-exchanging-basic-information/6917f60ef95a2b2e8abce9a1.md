...
Verdadeiro ou falso: Liu Ming é um designer de UI da China.
...
Liu Ming é um designer de UI, mas ele deixa claro que não é chinês.
...
Liu Ming says `我不是中国人 (wǒ bù shì zhōng guó rén)，我是新加坡人 (wǒ shì xīn jiā pō rén)`, que significa que ele é singapurense, não chinês.  

Ele também diz `我是 (wǒ shì) UI 设计师 (shè jì shī)`, que significa que ele é um designer de UI.
