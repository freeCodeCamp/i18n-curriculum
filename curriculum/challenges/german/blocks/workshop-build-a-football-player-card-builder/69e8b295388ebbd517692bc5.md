...
Ersetzen Sie den fest codierten Vereinsnamen von `Santos FC` in `card-club` durch `player.club`.

# --hints--

Sie sollten den fest codierten `Santos FC` durch `player.club` in `.card-club` ersetzen.
