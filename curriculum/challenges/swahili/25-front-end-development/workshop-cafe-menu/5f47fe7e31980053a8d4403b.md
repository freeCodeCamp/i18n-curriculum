...
Kuna njia rahisi, ongeza ukingo hasi wa juu kwa vipengele vya `img` ili kuvivuta kutoka kwa nafasi zao za sasa. Thamani hasi huundwa kwa kutumia `-` mbele ya thamani. To complete this workshop, go ahead and use a negative top margin of `25px` in the `img` type selector.
