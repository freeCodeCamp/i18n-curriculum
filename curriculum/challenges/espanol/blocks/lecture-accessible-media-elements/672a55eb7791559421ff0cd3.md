...
Un video no se trata solo de imágenes sino también de audio, por lo que lo primero que debe considerar es agregar descripciones o subtítulos a su contenido de video.

Las descripciones proporcionan la versión de texto de las palabras habladas y los sonidos no verbales importantes, como música o risas, sincronizados con el video. 
...
Para agregar descripciones o subtítulos a su contenido de video o audio, puede usar el elemento `track` dentro de su elemento `video` o `audio`:
...
Si está publicando videos en una plataforma de intercambio de videos como YouTube o Vimeo, disponen de descripciones y transcripciones automáticas para videos. Pero si no está satisfecho, puede usar servicios como veed.io, Rev, Amara y Descript.
...
¿En qué se diferencian las descripciones de los subtítulos en el contenido de video?

## --answers--

Las descripciones proporcionan traducciones para hablantes no nativos.
...
Las descripciones incluyen palabras habladas y sonidos no verbales, mientras que los subtítulos son para espectadores que no entienden el idioma.

---

Los subtítulos incluyen tanto palabras habladas como sonidos no verbales, mientras que las descripciones son solo para traducciones.
...
Los subtítulos se sincronizan con el video, pero las descripciones no.
...
¿Cómo puede agregar descripciones o subtítulos directamente a su contenido de video o audio en HTML?
...
Busque la etiqueta HTML específica diseñada para manejar descripciones y subtítulos.
