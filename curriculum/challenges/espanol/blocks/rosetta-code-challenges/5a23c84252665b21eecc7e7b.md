...
Un generador es una entidad ejecutable (como una función o procedimiento) que contiene código que produce una secuencia de valores. una a la vez, para que cada vez que llame al generador, se proporcione el siguiente valor en la secuencia.
...
Por ejemplo, para \(n=7\), la función debería devolver 81 ya que la secuencia sería 4, 9, 16, 25, 36, 49, 81. Aquí 64 se filtra, porque es un cubo.
