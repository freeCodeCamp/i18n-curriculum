...
將 `totalNumberOfItems`、`cartSubTotal`、`cartTaxes` 和 `cartTotal` 元素的 `textContent` 全部設置爲數字 `0`。

# --hints--

你應該將 `totalNumberOfItems` 元素的 `textContent` 設置爲 `0`。
...
你應該將 `cartSubTotal` 元素的 `textContent` 設置爲 `0`。
...
你應該將 `cartTaxes` 元素的 `textContent` 設置爲 `0`。
...
你應該將 `cartTotal` 元素的 `textContent` 設置爲 `0`。
