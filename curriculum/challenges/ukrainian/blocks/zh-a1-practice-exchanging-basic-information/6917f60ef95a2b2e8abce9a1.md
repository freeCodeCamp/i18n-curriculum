...
Правда чи хиба: Liu Ming — дизайнер інтерфейсів користувача з Китаю.
...
Liu Ming — дизайнер інтерфейсів користувача, але він чітко каже, що не є китайцем.
...
Liu Ming каже `我不是中国人 (wǒ bù shì zhōng guó rén)，我是新加坡人 (wǒ shì xīn jiā pō rén)`, що означає, що він сингапурець, а не китаєць.

Він також каже `我是 (wǒ shì) UI 设计师 (shè jì shī)`, що означає, що він дизайнер інтерфейсів користувача.

Отже, твердження є хибним.
