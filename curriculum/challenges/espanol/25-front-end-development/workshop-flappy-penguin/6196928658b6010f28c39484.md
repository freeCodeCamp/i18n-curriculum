...
Dé al elemento `.ground` un `background` con un degradado lineal a 90 grados en sentido horario, comenzando en `rgb(88, 175, 236)` y terminando en `rgb(182, 255, 255)`.
