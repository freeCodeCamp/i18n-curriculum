...
`n`桁の数が、1から`n`までのすべての数字をちょうど一度ずつ使っている場合、その数をパンデジタルと呼びます。例えば、2143は4桁のパンデジタルであり、素数でもあります。

存在する中で最大の`n`桁のパンデジタル素数はいくつでしょうか？
...
`pandigitalPrime(7)`は7652413を返す必要があります。
