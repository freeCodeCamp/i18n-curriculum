...
أخيرًا، يمكنك تشغيل محاكياتك.

ابدأ بنوبة الصباح. قم باستدعاء `simulateFestival()` مع `morningGates` و`"Morning"`.

# --hints--

يجب أن تستدعي `simulateFestival()` مع `morningGates` و`"Morning"`.
