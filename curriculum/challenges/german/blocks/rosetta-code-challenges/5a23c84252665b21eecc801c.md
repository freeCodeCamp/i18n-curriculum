...
Erzeugen Sie ein Spiral-Array. Ein *Spiral-Array* ist eine quadratische Anordnung der ersten N<sup>2</sup> natürlichen Zahlen, bei der die Zahlen nacheinander an den Rändern des Arrays entlanglaufen und sich spiralförmig nach innen bewegen. Zum Beispiel erzeugen Sie bei Eingabe von **5** dieses Array:
