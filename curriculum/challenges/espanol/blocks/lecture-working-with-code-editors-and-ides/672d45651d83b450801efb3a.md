...
Primero necesitarás instalar la extensión *Servidor en Vivo*, que está disponible gratis en el marketplace.

Haz clic en la pestaña de extensiones en la esquina izquierda y escribe `Live Server` en la barra de búsqueda.

Una vez que hayas instalado esto, deberías ver un botón de `Go live` en tu barra de estado. Asegúrate de tener tu archivo HTML abierto y luego haz clic en él.
