...
`Exactly` is an adverb used to show full agreement or correctness with what someone else has said. `Exact`, on the other hand, is an adjective meaning precise or correct in detail. Zum Beispiel:
