...
`audits`, `incidents`, `overall`, `phishing`, `summary`, `vulnerabilities`, و `within`.
...
هذا يصف نوعًا من الهجمات الإلكترونية حيث يخدع المهاجمون المستخدمين للكشف عن معلومات حساسة.
...
هذه حرف جر يشير إلى حدوث شيء داخل إطار زمني معين.
...
هذه الاسم الجمع يشير إلى أحداث أو وقائع، خاصة تلك التي تنطوي على مشاكل أو مخاطر.
...
هذه الاسم الجمع يشير إلى عمليات تفتيش أو تقييمات رسمية، غالبًا ما تُستخدم في سياق مراجعة الأنظمة أو الأمن.
...
هذه الصفة تُستخدم لتلخيص الانطباع العام أو الكلي لشيء ما.
...
هذا الاسم يشير إلى بيان موجز يعرض النقاط الرئيسية.
...
هذه الاسم الجمع يشير إلى نقاط ضعف في النظام يمكن استغلالها.
