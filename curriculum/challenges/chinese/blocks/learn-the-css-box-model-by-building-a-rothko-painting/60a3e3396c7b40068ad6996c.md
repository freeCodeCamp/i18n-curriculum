...
更改 `<img>` 中的 `src` 属性，把 `https://cdn.freecodecamp.org/curriculum/css-box-model/diagram-1.png` 修改为 `https://cdn.freecodecamp.org/curriculum/css-box-model/diagram-2.png`。
