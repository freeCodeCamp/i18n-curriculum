...
Nachdem Ihre `for`-Schleife beendet ist, müssen Sie das Array zurückgeben. Sie sollten dann die `Output`-Änderung sehen können, wenn Sie erneut auf die `Sort`-Schaltfläche klicken.

# --hints--

Sie sollten `return` das `array`.
