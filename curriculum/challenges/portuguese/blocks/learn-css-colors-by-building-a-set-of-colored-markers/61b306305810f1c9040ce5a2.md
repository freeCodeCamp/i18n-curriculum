...
Como você pode ver, você adicionou uma sombra vermelha simples de 5 pixels à direita e 5 pixels para baixo em torno de seu marcador.
...
Atualize os valores para a propriedade `box-shadow`, e definir `offsetX` para `-5px` e `offsetY` para `-5px`.
