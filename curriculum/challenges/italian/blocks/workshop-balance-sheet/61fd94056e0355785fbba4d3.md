...
All'interno del secondo `tr`, aggiungi un elemento `th` con il testo `Expenses Annual anticipated expenses, such as payroll.`. Avvolgi quel testo, tranne `Expenses `, all'interno di un elemento `span` con l'attributo `class` impostato su `description`.

Aggiungi tre elementi `td` sotto di quello, e assegna loro il seguente testo, in ordine: `$200`, `$300` e `$400`. Dai al terzo elemento `td` un attributo `class` impostato su `current`.
...
Il tuo elemento `th` dovrebbe avere il testo `Expenses Annual anticipated expenses, such as payroll.`
...
Dovresti avvolgere il testo `Annual anticipated expenses, such as payroll.` in un elemento `span`.
...
Il tuo primo elemento `td` dovrebbe avere il testo `$200`.
...
Il tuo secondo elemento `td` dovrebbe avere il testo `$300`.
...
Il tuo terzo elemento `td` dovrebbe avere il testo `$400`.
