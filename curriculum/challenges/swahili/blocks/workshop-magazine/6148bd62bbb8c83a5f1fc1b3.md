...
Unda kichaguzi cha `.hero-title` na kipa sifa ya `text-align` iliyowekwa kuwa `center`, sifa ya `color` iliyowekwa kuwa `orangered` na sifa ya `font-size` iliyowekwa kuwa `8rem`.
...
Kichaguzi chako cha `.hero-title` kinapaswa kuwa na sifa ya `text-align` iliyowekwa kuwa `center`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.hero-title')?.textAlign, 'center');
```

Kichaguzi chako cha `.hero-title` kinapaswa kuwa na sifa ya `color` iliyowekwa kuwa `orangered`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.hero-title')?.color, 'orangered');
```

Kichaguzi chako cha `.hero-title` kinapaswa kuwa na sifa ya `font-size` iliyowekwa kuwa `8rem`.
