...
最初の `label` に、その `input` 要素の `id` と一致する `for` 属性を付けてください。
...
2番目の `label` に、その `input` 要素の `id` と一致する `for` 属性を付けてください。
...
3番目の `label` に、その `input` 要素の `id` と一致する `for` 属性を付けてください。
...
4番目の `label` に、その `input` 要素の `id` と一致する `for` 属性を付けてください。
