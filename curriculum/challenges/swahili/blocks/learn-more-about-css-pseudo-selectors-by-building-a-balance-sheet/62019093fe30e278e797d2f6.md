...
Kichaguzi cha `[attribute="value"]` kinawalenga vipengele vyovyote vyenye sifa ya kipengele yenye thamani maalum. Unda kichaguzi cha `tr[class="total"]` ili kulenga hasa vipengele vyako vya `tr` vyenye darasa la vitu la `total`. Kipa mpaka wa chini wa `4px double #0a0a23` na fanya fonti iwe herufi nzito.
...
Kichaguzi chako cha `tr[class="total"]` kinapaswa kuwa na sifa ya `border-bottom` iliyowekwa kuwa `4px double #0a0a23`.
