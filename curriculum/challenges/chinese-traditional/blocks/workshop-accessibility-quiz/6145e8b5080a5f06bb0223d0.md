...
你應該給第一個 `input` 一個與 `label` 文字內容相符的 `value`。
...
你應該給第二個 `input` 一個與 `label` 文字內容相符的 `value`。
...
你應該給第三個 `input` 一個與 `label` 文字內容相符的 `value`。
...
你應該給第四個 `input` 一個與 `label` 文字內容相符的 `value`。
