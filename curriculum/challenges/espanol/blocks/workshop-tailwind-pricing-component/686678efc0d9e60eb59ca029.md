...
La insignia puede tener un mejor estilo. Para esto, usarás algunas clases de gradiente de Tailwind. Aquí te mostramos cómo puedes usar estilos de gradiente en Tailwind:
...
Agrega las clases `bg-gradient-to-r`, `from-fuchsia-500` y `to-indigo-500` al `div` del badge. También, agrega `rounded-full`, `px-3`, `py-1`, `text-xs`, `font-bold` y `text-white`.

# --hints--

Tu elemento `div` con el texto `Most popular` debe tener la clase `bg-gradient-to-r`.
...
Tu elemento `div` con el texto `Most popular` debe tener la clase `from-fuchsia-500`.
...
Tu elemento `div` con el texto `Most popular` debe tener la clase `to-indigo-500`.
...
Tu elemento `div` con el texto `Most popular` debe tener la clase `rounded-full`.
...
Tu elemento `div` con el texto `Most popular` debe tener la clase `px-3`.
...
Tu elemento `div` con el texto `Most popular` debe tener la clase `py-1`.
...
Tu elemento `div` con el texto `Most popular` debe tener la clase `text-xs`.
...
Tu elemento `div` con el texto `Most popular` debe tener la clase `font-bold`.
...
Tu elemento `div` con el texto `Most popular` debe tener la clase `text-white`.
