...
Дайте вашому `#monsterStats` елементу ті самі `border` та `padding`, що й вашому `#stats` елементу. Встановіть його колір на `#ffffff` і додайте `#c70d0d` фон.

# --hints--

Ви повинні мати `#monsterStats` селектор.
...
Ваш `#monsterStats` селектор повинен мати `border` зі значенням `1px solid #0a0a23`.
...
Ваш `#monsterStats` селектор повинен мати `5px` відступ.
...
Ваш `#monsterStats` селектор повинен мати `color` зі значенням `#ffffff`.
...
Ваш `#monsterStats` селектор повинен мати `background-color` зі значенням `#c70d0d`.
