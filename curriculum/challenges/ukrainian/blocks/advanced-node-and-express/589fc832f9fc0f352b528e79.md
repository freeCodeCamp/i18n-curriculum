...
Настав час дозволити клієнтам надсилати повідомлення чату на сервер, щоб надіслати його всім клієнтам! У файлі `client.js` ви бачите, що вже існує блок коду який обробляє момент коли форма повідомлення відправляється.
...
Тепер чат повинен бути повністю функціональним і спроможним відправляти повідомлення між усіма клієнтами!

Відправте свою сторінку коли впевнились, що все правильно. Якщо у вас виникають помилки, ви можете <a href="https://forum.freecodecamp.org/t/advanced-node-and-express/567135#send-and-display-chat-messages-11" target="_blank" rel="noopener noreferrer nofollow">переглянути проєкт, завершений до цього моменту</a>.
