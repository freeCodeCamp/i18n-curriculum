...
Залишок HTML уже надано для вас. Це включає картки преміум- та сімейного планів. Тож настав час стилізувати HTML-елементи за допомогою Tailwind CSS.

Почніть із того, що надайте всій сторінці трохи сірий фон, призначивши елементу `body` клас `bg-gray-100`.

# --hints--

Ваш елемент body має мати клас `bg-gray-100`.
