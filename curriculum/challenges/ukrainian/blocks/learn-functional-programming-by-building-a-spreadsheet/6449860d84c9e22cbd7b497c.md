...
Діапазони розділяються двокрапкою. Після ваших двох груп захоплення ваш `rangeRegex` має шукати двокрапку.

# --hints--

Ви повинні додати двокрапку після другої групи захоплення.
