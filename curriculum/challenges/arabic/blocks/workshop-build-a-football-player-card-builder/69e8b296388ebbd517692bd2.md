...
أصبح قسم معلومات اللاعب مكتملًا الآن. بعد إغلاق `div` الخاص بقسم معلومات اللاعب ولا تزال داخل `form-panel`، أضف `div` جديدًا. بداخله، أضف عنصر `p` مع `className` باسم `form-section-title` والنص `Player Stats`. ثم أضف `div` مع `className` باسم `stats-grid`. اترك شبكة الإحصائيات فارغة في الوقت الحالي.

# --hints--

يجب أن يحتوي `div.form-panel` على `div` ثاني لقسم إحصائيات اللاعب.
...
يجب أن يحتوي قسم إحصائيات اللاعب على عنصر `p` مع `className` باسم `form-section-title` والنص `Player Stats`.
...
يجب أن يحتوي قسم إحصائيات اللاعب على `div` مع `className` باسم `stats-grid`.
