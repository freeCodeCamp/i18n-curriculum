...
Um programa FRACTRAN é uma lista ordenada de frações positivas $P = (f_1, f_2, \ldots, f_m)$, junto com uma entrada inicial inteira positiva $n$.
...
Começando com $n=2$, este programa FRACTRAN vai mudar $n$ para $15=2\times (\frac{15}{2})$, depois $825=15\times (\frac{55}{1})$, gerando a seguinte sequência de inteiros:
