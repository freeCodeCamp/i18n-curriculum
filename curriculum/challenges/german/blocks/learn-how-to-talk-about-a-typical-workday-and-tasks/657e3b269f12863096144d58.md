...
`Have to` ist ein Ausdruck, der verwendet wird, um Notwendigkeit oder Verpflichtung auszudrücken, besonders im Arbeitskontext. Zum Beispiel:

`You have to wear a helmet on the construction site.` – Das bedeutet, dass das Tragen eines Helms eine notwendige Sicherheitsregel ist.
...
Diese beiden Wörter werden verwendet, um eine notwendige Handlung anzuzeigen.
