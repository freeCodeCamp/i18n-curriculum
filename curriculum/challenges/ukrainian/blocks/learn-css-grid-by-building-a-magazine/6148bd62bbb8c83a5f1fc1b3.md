...
Створіть селектор `.hero-title` і надайте йому множину властивостей: `text-align` зі значенням `center`, `color` зі значенням `orangered` та `font-size` зі значенням `8rem`.

# --hints--

У вас має бути селектор `.hero-title`.
