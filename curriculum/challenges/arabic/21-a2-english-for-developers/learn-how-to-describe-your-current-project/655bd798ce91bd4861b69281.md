...
Present continuous is used for actions happening at the moment of speaking. على سبيل المثال:
...
Present continuous can be used in negative forms to express that something is not happening. على سبيل المثال:
