...
Esta tarefa verifica sua compreensão sobre como informações específicas são solicitadas no diálogo.

# --instructions--

Leia o diálogo e decida se a seguinte declaração é verdadeira ou falsa.

# --questions--

## --text--

É verdadeiro ou falso: Quando Sebastián pergunta `¿Cuál es su sitio web?`, ele está pedindo o endereço do site da empresa.
...
Revise que tipo de informação `¿Cuál...?` é usada para solicitar neste contexto.
...
`¿Cuál...?` é usado para pedir informações específicas ou identificação. Por exemplo:

- `¿Cuál es tu nombre?` - Qual é o seu nome?

- `¿Cuál es tu número de teléfono?` - Qual é o seu número de telefone?

No diálogo, `¿Cuál es su sitio web?` pede uma informação específica: o site.

`Su` se refere à empresa (dela), e `es` está na terceira pessoa do singular porque o sujeito é `su sitio web`.
