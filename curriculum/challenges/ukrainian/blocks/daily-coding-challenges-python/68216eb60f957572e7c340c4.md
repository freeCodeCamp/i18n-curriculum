...
За заданою кількістю пройдених миль і часом у `"MM:SS"` (хвилини:секунди), який знадобився, щоб пробігти ці милі, поверніть рядок із середнім часом, який знадобився, щоб пробігти кожну милю, у форматі `"MM:SS"`.

- Додайте провідні нулі, якщо це потрібно.

# --hints--

`mile_pace(3, "24:00")` має повернути `"08:00"`.
...
`mile_pace(1, "06:45")` має повернути `"06:45"`.
...
`mile_pace(2, "07:00")` має повернути `"03:30"`.
...
`mile_pace(26.2, "120:35")` має повернути `"04:36"`.
