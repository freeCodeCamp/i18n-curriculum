...
Раніше ви додали виклик `console.log()` у вашу функцію `swapCrewMembers` для перевірки її роботи, а тепер цей виклик більше не потрібен. Щоб уникнути захаращення терміналу в наступних кроках, видаліть поточний цикл `for`, який виводить у консоль.

# --hints--

Видаліть цикл `for` з функції `swapCrewMembers`. Потрібно видалити весь блок циклу.
