...
For example, if someone says `我很開心認識你 (wǒ hěn kāi xīn rèn shì nǐ)` meaning "I am very happy to meet you", responding with `我也是 (wǒ yě shì)` indicates that you also feel happy to meet them.
