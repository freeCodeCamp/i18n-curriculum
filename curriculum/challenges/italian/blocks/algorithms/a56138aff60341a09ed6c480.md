...
Confronta e aggiorna l'inventario archiviato in un array 2D con un secondo array 2D di una nuova consegna. Aggiorna le quantità degli elementi esistenti nell'inventario (in `arr1`). Se un elemento non viene trovato, aggiungi il nuovo elemento e la quantità nell'array dell'inventario. L'array dell'inventario restituito dovrebbe essere in ordine alfabetico per elemento.

# --hints--

La funzione `updateInventory` dovrebbe restituire un array.
...
`updateInventory([[21, "Bowling Ball"], [2, "Dirty Sock"], [1, "Hair Pin"], [5, "Microphone"]], [[2, "Hair Pin"], [3, "Half-Eaten Apple"], [67, "Bowling Ball"], [7, "Toothpaste"]])` dovrebbe restituire un array con lunghezza 6.
