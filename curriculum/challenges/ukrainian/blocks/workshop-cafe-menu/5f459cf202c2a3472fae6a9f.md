...
Помітили, що ширина лінії виглядає більшою? За замовчування значення властивості `border-width` становить `1px` для всіх кордонів елементів `hr`. При зміні кордону на такий же колір, що і фон, загальна висота лінії становить `5px` (`3px` з додаванням ширини верхнього та нижнього кордонів зі значенням `1px`).
