...
Agrega un `linear-gradient` a `.bb1d` con `orange` como el primer color, `--building-color1` como el segundo y `--window-color1` como el tercero. Recuerda usar el degradado en la propiedad `background`.
