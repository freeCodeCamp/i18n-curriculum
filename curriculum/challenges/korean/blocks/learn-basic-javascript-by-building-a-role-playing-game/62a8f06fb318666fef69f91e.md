...
단어 `"Arg!"`는 큰따옴표로 감싸야 합니다. 문자열 안에 큰따옴표를 포함하는 방법으로는 이스케이프 처리 외에 또 다른 방법이 있습니다.

문자열 `"The monster screams Arg! as it dies. You gain experience points and find gold."`을 감싸고 있는 큰따옴표를 작은따옴표 `'`로 바꾸고, `"Arg!"`에는 큰따옴표를 추가하세요.

# --hints--

문자열을 감쌀 때는 작은따옴표를 사용하세요.
