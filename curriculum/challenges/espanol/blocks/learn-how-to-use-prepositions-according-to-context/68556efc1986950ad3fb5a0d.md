...
`Thorough` means done with great care and attention to detail. Por ejemplo:

`She gave the code a thorough review.` – This means she looked at it very carefully.

`Coverage` refers to how much of something is included, tested, or handled. Por ejemplo:
