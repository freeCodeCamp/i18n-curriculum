...
Você estará <a href="https://app.ona.com/?autostart=true#https://github.com/freeCodeCamp/boilerplate-SHA-1-password-cracker" target="_blank" rel="noopener noreferrer nofollow">trabalhando neste projeto com nosso código inicial Ona</a>.
...
A biblioteca `hashlib` foi importada para você. Você deve considerar usá-lo em seu código. <a href="https://docs.python.org/3/library/hashlib.html" target="_blank" rel="noopener noreferrer nofollow">Saiba mais sobre "hashlib" aqui</a>.

## Desenvolvimento

Escreva seu código em `password_cracker.py`. Para o desenvolvimento, você pode usar `main.py` para testar o seu código.
