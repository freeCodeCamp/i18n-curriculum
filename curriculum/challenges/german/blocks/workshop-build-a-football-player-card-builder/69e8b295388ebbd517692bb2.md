...
Entfernen Sie innerhalb der `FootballPlayerCard`-Komponente das `h1` und geben Sie die `PlayerCard`-Komponente zurück.

# --hints--

Die `FootballPlayerCard` sollte die `PlayerCard`-Komponente rendern.
