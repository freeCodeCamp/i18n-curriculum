...
Ahora, añade un `div` con la clase `img-loader`. Después, crea un elemento `img` y asígnale una URL condicional para la imagen usando `{img ? ${CDN_URL}/${img} : LOCAL_DEFAULT_IMG}`.
