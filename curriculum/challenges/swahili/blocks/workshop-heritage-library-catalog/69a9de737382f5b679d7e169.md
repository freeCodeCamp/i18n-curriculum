...
Ili kupata waandishi wanaolingana, angalia kila kipengee cha katalogi moja baada ya nyingine.

Ongeza mzunguko tupu wa `for` ndani ya `findByAuthor` ili rudia juu ya `catalog`. Utajumuisha mwili wa mzunguko katika hatua inayofuata.
