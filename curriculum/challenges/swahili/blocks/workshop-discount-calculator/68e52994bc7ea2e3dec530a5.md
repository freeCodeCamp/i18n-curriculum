...
Mwishowe, rudisha kiwango cha chini kutoka kwenye orodha ya `prices` kwa kutumia kitendakazi cha `min()`. Hii itakupa bei bora (chini kabisa) baada ya kuzingatia punguzo zote zinazotumika.

# --hints--

Njia yako ya `calculate_best_price` inapaswa kurudisha kiwango cha chini kutoka kwenye orodha ya `prices` kwa kutumia kitendakazi cha `min`.
