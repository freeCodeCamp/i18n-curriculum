...
Функція Ейлера, ${\phi}(n)$ (іноді її називають функцією фі), використовується для визначення кількості чисел менших за `n`, які є взаємно простими з `n`. Наприклад, оскільки 1, 2, 4, 5, 7 і 8 — усі менші за дев’ять і взаємно прості з дев’ятьма, то ${\phi}(9) = 6$.

<div style='margin-left: 4em;'>

| $n$ | $\text{Взаємно прості}$ | $\displaystyle{\phi}(n)$ | $\displaystyle\frac{n}{{\phi}(n)}$ |
| --- | ------------------------- | ------------------------ | ---------------------------------- |
| 2   | 1                         | 1                        | 2                                  |
| 3   | 1,2                       | 2                        | 1.5                                |
| 4   | 1,3                       | 2                        | 2                                  |
...
Можна побачити, що `n` = 6 дає максимум $\displaystyle\frac{n}{{\phi}(n)}$ для `n` ≤ 10.
