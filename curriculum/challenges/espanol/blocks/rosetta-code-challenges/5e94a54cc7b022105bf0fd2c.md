...
Escribe una función para contar las ocurrencias de cada palabra y devolver las n palabras más comunes junto con el número de sus ocurrencias en orden decreciente de frecuencia.

La función debe devolver un arreglo 2D con cada uno de los elementos en la siguiente forma: `[word, freq]`. `word` debe ser la versión en minúsculas de la palabra y `freq` el número que indica la cantidad.
