...
Fügen Sie dem `text-lg`-Element des Premium-Plans die Klassen `font-semibold`, `text-fuchsia-200` und `h2` hinzu.
...
Ihr `h2`-Element sollte die Klasse `text-fuchsia-200` haben.
