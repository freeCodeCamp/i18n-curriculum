...
Kitendakazi chako cha `simulateFestival` kinapaswa kwanza kuandika ujumbe `"\n" + timeBlock + " Simulation"`.
...
Kitendakazi chako cha `simulateFestival` kinapaswa kuandika sehemu sahihi ya wakati katika ujumbe.
