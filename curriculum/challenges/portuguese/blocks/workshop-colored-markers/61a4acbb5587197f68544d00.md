...
Agora, modifique o terceiro argumento de cores na função `linear-gradient`, que atualmente é puro azul.

Atualize a função `rgb` para que o valor para vermelho seja `162`, o valor do verde `27` e o valor de azul `27`.

# --hints--

A regra do CSS `.red` deve ter uma propriedade `background` definida para `linear-gradient(180deg, rgb(122, 74, 14) 0%, rgb(245, 62, 113) 50%, rgb(162, 27, 27) 100%)`.
