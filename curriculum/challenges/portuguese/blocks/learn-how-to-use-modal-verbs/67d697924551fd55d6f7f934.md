...
Essas duas palavras mostram necessidade — algo que deve ser feito.

# --explanation--

`Have to` é usado para mostrar necessidade — algo que deve ser feito.Por exemplo:

- `We have to submit the report by Friday.` - É necessário.

- `You have to wear a seatbelt in the car.` - É necessário para a segurança.
