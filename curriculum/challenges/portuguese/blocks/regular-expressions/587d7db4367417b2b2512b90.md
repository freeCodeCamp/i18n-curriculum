...
Você pode também procurar por mais de dois padrões com este operador. É possível fazer isso ao adicionar mais instâncias do operador `OR` seguido do padrão desejado: `/yes|no|maybe/`.
