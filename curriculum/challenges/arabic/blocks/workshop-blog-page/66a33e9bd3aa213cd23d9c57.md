...
في هذه الخطوة، تحتاج إلى إضافة رقم الهاتف وعنوان البريد الإلكتروني لمؤلف المدونة.

داخل عنصر `address`، أضف عنصر فقرة يحتوي على النص `Phone: 555-555-5555`.

أسفل عنصر الفقرة هذا، أضف عنصر فقرة آخر يحتوي على النص `Email: fake@email.com`.

# --hints--

يجب أن يكون لديك عنصران `p` داخل عنصر `address` الخاص بك.
...
يجب أن يحتوي أول عنصر `p` على النص `Phone: 555-555-5555`.
...
يجب أن يحتوي ثاني عنصر `p` على النص `Email: fake@email.com`.
