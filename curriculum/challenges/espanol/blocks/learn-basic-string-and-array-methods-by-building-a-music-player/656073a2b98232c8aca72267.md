...
Para manejar la información de la canción actual y rastrear su tiempo de reproducción, crea propiedades `currentSong` y `songCurrentTime`. Establezca los valores en `null` y `0`, respectivamente.

# --hints--

No debes modificar el objeto `userData` existente y su contenido.
