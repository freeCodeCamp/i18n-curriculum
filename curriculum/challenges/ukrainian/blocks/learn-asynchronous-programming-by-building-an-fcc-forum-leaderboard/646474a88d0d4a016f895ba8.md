...
Для наступних кроків ви додасте функціональність для відображення аватарок користувачів.

Всередині другого `td` елемента додайте `div` елемент з класом `"avatar-container"`.

# --hints--

У вас має бути `div` елемент всередині другого `td` елемента.
...
Ваш відкриваючий тег `div` повинен мати атрибут класу зі значенням `"avatar-container"`.
