...
Denke daran, dass der Inkrement-Operator `++` verwendet werden kann, um den Wert einer Variable um `1` zu erhöhen. Es gibt auch einen <dfn>decrement operator</dfn> `--`, der verwendet werden kann, um den Wert einer Variable um `1` zu senken. Zum Beispiel :
...
Du solltest den Dekrement-Operator verwenden.
