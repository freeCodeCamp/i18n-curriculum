...
Recuerda que `RegExp.prototype.test` solo confirma si una cadena coincide con la expresión regular. Usemos nuestro lookbehind negativo con `String.prototype.match` para ver cómo afectan las afirmaciones:
