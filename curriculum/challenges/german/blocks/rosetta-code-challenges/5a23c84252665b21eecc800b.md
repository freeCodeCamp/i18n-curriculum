...
title: Sortieralgorithmen/Pancake-Sortierung
challengeType: 1
forumTopicId: 302315
...
Schreiben Sie eine Funktion, die ein Array von ganzen Zahlen (beliebiger Größe) mit Pancake-Sortierung in aufsteigender Reihenfolge sortiert. Die Funktion soll das sortierte Array zurückgeben.

Kurz gesagt: Anstatt einzelne Elemente zu sortieren, ist die einzige erlaubte Operation, ein Ende der Liste „umzuklappen“, so wie hier:
...
Es darf nur ein Ende der Liste umgeklappt werden; dies sollte das untere Ende sein, aber das obere Ende ist auch in Ordnung, wenn es einfacher zu programmieren ist oder besser funktioniert. Es **muss** jedoch dasselbe Ende für die gesamte Lösung sein. (Das umgeklappte Ende darf nicht beliebig gewechselt werden.)
...
`pancakeSort([25, 32, 12, 7, 20])` sollte ein Array zurückgeben.
