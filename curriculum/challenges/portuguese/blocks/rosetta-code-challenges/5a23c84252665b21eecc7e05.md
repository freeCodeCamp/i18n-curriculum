...
Um **CUSIP** é um código alfanumérico de nove caracteres que identifica um título financeiro norte-americano para fins de facilitar a compensação e liquidação de negociações. O CUSIP foi adotado como um Padrão Nacional Americano segundo as Accredited Standards X9.6.
