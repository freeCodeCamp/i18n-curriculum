...
Зрештою, в селекторі `:root` медіазапиту перевизначте всі чотири змінні `--window-color`, щоб вони використовували `#777`. Коли ви закінчите, змініть розмір вікна та спостерігайте, як воно змінюється з дня на ніч.

Змінні в основному використовуються з кольорами, і саме так ви їх використали тут. Але їм можна надати будь-яке значення і використовувати на будь-якій властивості. Ваш проєкт має чудовий вигляд!

# --hints--

Додайте `--window-color1` зі значенням `#777`.
...
Додайте `--window-color2` зі значенням `#777`.
...
Додайте `--window-color3` зі значенням `#777`.
...
Додайте `--window-color4` зі значенням `#777`.
