...
**Nota:** Certifique-se de não modificar os `className`s dos botões. Lembre-se também de adicionar as ligações necessárias para os métodos recém-criados no construtor.
