...
Щоб текст, введений у поля введення та текстові області, а також їхні заповнювачі були видимі, встановіть їхній колір.

Виберіть `input, input::placeholder, textarea` і встановіть `color` у `whitesmoke`.

# --hints--

Ви повинні націлитися на `input`, `input::placeholder`, `textarea`.
