...
Devuelve `false` sin mostrar ningún mensaje de error al usuario.
...
¿Qué acción no provoca que se verifique un formulario HTML en busca de errores?
...
¿Qué significa cuando `patternMismatch` es `true`?
...
El valor no coincide con el atributo `pattern`.

### --question--

#### --text--

¿Qué sucede si se llama a `reportValidity()`, pero un campo no pasa la validación?
...
¿Qué acción activa la validación integrada del formulario en el navegador?
