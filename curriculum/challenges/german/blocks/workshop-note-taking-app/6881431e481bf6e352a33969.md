...
Wie bereits erwähnt, sollte eine Nachricht angezeigt werden, dass die Notiz gespeichert wurde, wenn der Benutzer die Notiz bearbeitet und dann außerhalb der Notiz klickt.

Um dies zu erreichen, setzen Sie den `statusEl.textContent` auf den String `"Note saved successfully!"`.

Wenn Sie es jetzt testen, sollten Sie diese Nachricht auf dem Bildschirm sehen.

# --hints--

Wenn der Benutzer eine Notiz bearbeitet, sollte die Statusmeldung aktualisiert werden, um anzuzeigen, dass die Notiz gespeichert wurde.
