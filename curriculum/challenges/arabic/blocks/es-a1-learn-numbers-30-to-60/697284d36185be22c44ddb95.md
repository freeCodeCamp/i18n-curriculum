...
الآن بعد أن تعرفت على الأعداد في الثلاثينيات، لننتقل إلى الأربعينيات.

في الإسبانية، يُسمى الرقم 40 بـ `cuarenta`.

تُكوَّن الأعداد من 41 إلى 49 باستخدام كلمة العشرات `cuarenta` (40)، تليها أداة العطف `y` ("و"), ثم رقم الآحاد (1-9).
...
العدد `cuarenta y uno` (41) فريد في هذه المجموعة لأنه يتحول إلى `cuarenta y un` قبل الاسم المذكر. على سبيل المثال:

`Cuarenta y un años` - واحد وأربعون سنة.

# --instructions--

استمع إلى الصوت وتدرّب على نطق هذه الأعداد.

# --assignment--

تدرّبت على نطق الأعداد من 40 إلى 49.
