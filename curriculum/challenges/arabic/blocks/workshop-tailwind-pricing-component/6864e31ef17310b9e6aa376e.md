...
عناصر الشبكة قريبة جدًا من الحواف اليسرى واليمنى للصفحة، لذا يجب عليك العمل على التباعد.

عيّن الصنف `max-w-6xl` إلى العنصر `div` لتحديد عرض ثابت بقيمة `72rem` ومنع العناصر من الامتداد بعيدًا عبر الصفحة.

بما أن ذلك سيدفع جميعها إلى اليسار، أضف `mx-auto` إلى العنصر `div` لمركزة العناصر أفقيًا.

# --hints--

يجب أن يحتوي العنصر `div` على الصنف `max-w-6xl`.
...
يجب أن يحتوي العنصر `div` على الصنف `mx-auto`.
