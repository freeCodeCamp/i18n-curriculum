...
يجب أن يكون لعنصر `img` الثاني الخاص بك سمة `src` بقيمة `https://cdn.freecodecamp.org/testable-projects-fcc/images/calc.png`.
