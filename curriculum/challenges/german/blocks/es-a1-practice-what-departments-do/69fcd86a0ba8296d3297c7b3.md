...
In dieser Aufgabe üben Sie, Abteilungen anhand der Tätigkeiten zu erkennen, die sie ausführen.

# --instructions--

Hören Sie zu und ergänzen Sie den Satz mit der richtigen Abteilung.
...
Diese Abteilung schult das Team.

# --explanation--

`El departamento de aprendizaje y desarrollo capacita al equipo` bedeutet „die Abteilung für Lernen und Entwicklung schult das Team“.

Sowohl `apoyar` („unterstützen“) als auch `capacitar` („schulen“) sind Verben in der dritten Person Singular, die auf `-ar` enden.

Sie folgen dem gleichen Muster wie `desarrolla`, `verifica` und `crea` aus früheren Aufgaben.
