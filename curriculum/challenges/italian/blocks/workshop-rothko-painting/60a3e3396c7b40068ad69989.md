...
Cambia la `background-color` di `.three` in `#b20403`.

# --hints--

Dovresti impostare la proprietà `background-color` su `#b20403`.
...
Il tuo elemento `.three` dovrebbe avere un valore `background-color` di `#b20403`.
