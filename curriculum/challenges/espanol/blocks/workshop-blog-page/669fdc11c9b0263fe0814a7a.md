...
Para el primer elemento ancla, el texto debe ser `About` y el valor del atributo `href` debe ser `"#about"`. El símbolo de almohadilla delante de `about` representa un nombre de `id`, que se añadirá más adelante en el proyecto.
