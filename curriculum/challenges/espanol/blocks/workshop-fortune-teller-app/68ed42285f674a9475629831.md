...
Dentro de la clase, añade una propiedad privada `elements` como un objeto. Dentro de ella, agrega las propiedades `singleCardBtn`, `singleCard` y `multipleCardsBtn`, cada una tipada como `HTMLElement`.

# --hints--

Debes declarar una propiedad `private` llamada `elements` dentro de la clase `Game`.
...
Tu propiedad privada `elements` debe tener una propiedad `singleCardBtn` tipada como `HTMLElement`.
...
Tu propiedad privada `elements` debe tener una propiedad `multipleCardsBtn` tipada como `HTMLElement`.
...
Tu propiedad privada `elements` debe tener una propiedad `singleCard` tipada como `HTMLElement`.
