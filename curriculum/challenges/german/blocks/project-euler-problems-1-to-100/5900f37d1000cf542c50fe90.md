...
title: 'Problem 17: Anzahl der Buchstaben in ausgeschriebenen Zahlen'
challengeType: 1
forumTopicId: 301804
...
Wenn die Zahlen von 1 bis 5 ausgeschrieben werden: one, two, three, four, five, dann werden insgesamt 3 + 3 + 5 + 4 + 4 = 19 Buchstaben verwendet.

Wenn alle Zahlen von 1 bis einschließlich `limit` ausgeschrieben werden, wie viele Buchstaben würden dann insgesamt verwendet?

**Hinweis:** Zählen Sie keine Leerzeichen oder Bindestriche mit. Zum Beispiel enthält 342 (three hundred and forty-two) 23 Buchstaben und 115 (one hundred and fifteen) enthält 20 Buchstaben. Die Verwendung von „and“ beim Ausschreiben von Zahlen entspricht der britischen Schreibweise.
