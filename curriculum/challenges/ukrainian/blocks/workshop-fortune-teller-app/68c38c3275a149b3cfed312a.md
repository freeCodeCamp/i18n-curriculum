...
У цьому практичному занятті ви продовжите практикуватися з TypeScript, створюючи застосунок для ворожіння.

Почніть з оголошення інтерфейсу з іменем `Card`. Всередині інтерфейсу `Card` додайте такі властивості: `name`, `name_short` та `value`. Властивості `name` і `name_short` мають мати тип `string`, а `value` — об’єднаний тип `string | number`.

# --hints--

Ви повинні оголосити інтерфейс з іменем `Card`.
...
Ваш інтерфейс `Card` має містити властивість `name` типу `string`.
...
Ваш інтерфейс `Card` має містити властивість `name_short` типу `string`.
...
Ваш інтерфейс `Card` має містити властивість `value` з об’єднаним типом `string` та `number`.
