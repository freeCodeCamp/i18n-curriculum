...
Ahora, dentro de la función `isSelect`, devuelve un booleano que indique si `element` es una instancia de `HTMLSelectElement`. Usa el operador `instanceof` para realizar esta comprobación.

# --hints--

Tu función `isSelect` debe devolver `element instanceof HTMLSelectElement`.
