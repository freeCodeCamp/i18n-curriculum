...
macOS y iOS tienen integrado VoiceOver. Puedes habilitarlo en tu computadora presionando `CMD + F5`. Puedes acceder a él en iPhones a través de Configuración.
...
Linux tiene *Orca* para el entorno de escritorio y *Hablar* para el terminal de Linux.
...
Piensa en el software de lector de pantalla que Apple crea y mantiene.
...
Fíjate en aquellos con discapacidades no relacionadas con la visión.
