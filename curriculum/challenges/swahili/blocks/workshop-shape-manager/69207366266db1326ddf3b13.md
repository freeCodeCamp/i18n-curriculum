...
Ongeza tukio la `DOMContentLoaded` kwenye hati kuu na pita `initializeApp` kama kitendakazi cha mwitiko cha kuendesha. Hii inahakikisha uanzishaji wote hufanyika tu baada ya DOM kupakiwa kikamilifu.

# --hints--

Unapaswa kuongeza tukio la `DOMContentLoaded` kwenye `document` kuu.

```js
assert.match(code, /document\.addEventListener\(["']DOMContentLoaded["']/)
```

Unapaswa kurejea `initializeApp` kama kitendakazi cha kuendesha katika msikilizaji wako wa tukio.
