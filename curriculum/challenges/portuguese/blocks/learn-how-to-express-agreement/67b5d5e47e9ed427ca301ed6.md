...
This word refers to users who have already visited or used the system before. Ele termina com `-ing`.
...
`Returning` refers to someone or something that is coming back. Por exemplo:
