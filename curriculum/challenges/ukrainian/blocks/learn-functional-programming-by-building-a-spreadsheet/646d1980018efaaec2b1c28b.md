...
Використайте той самий синтаксис, що й у вашій функції `addCharacters`, щоб оновити вашу функцію `elemValue`. Вона більше не повинна оголошувати `inner`, а має повертати функцію неявно.

# --hints--

Ваша функція `elemValue` має використовувати неявне повернення.
...
Ваша функція `elemValue` має неявно повертати стрілкову функцію з параметром `character`.
...
Ваша внутрішня стрілкова функція має використовувати неявне повернення.
...
Ваша внутрішня стрілкова функція має повертати результат виклику `idToText()` з аргументом `character + num`.
