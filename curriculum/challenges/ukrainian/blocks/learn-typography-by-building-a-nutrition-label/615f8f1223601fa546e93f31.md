...
Створіть фінальний `p` елемент для вашого `.daily-value` розділу. Додайте йому текст `Potassium 235mg 6%`. Вирівняйте текст `6%` по правому краю та видаліть нижній кордон елемента `p`.
