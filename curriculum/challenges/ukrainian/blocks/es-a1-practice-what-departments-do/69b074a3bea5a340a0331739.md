...
У цьому завданні ви практикуватиметеся у визначенні відділів за їхніми завданнями.
...
Цей відділ підтримує працівників.

# --explanation--

`Recursos humanos` означає "Відділ кадрів".

Себастьян каже `el departamento de recursos humanos apoya a los empleados`, що означає "Відділ кадрів підтримує працівників".
