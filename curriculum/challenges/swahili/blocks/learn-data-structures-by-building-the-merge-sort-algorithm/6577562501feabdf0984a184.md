...
Baada ya kuweka thamani ya kielezo cha `left_part` katika safu ya data iliyopangwa, ongeza `left_array_index` kwa `1`.

# --hints--

Unapaswa kuongeza `1` kwenye thamani ya sasa ya `left_array_index`.
