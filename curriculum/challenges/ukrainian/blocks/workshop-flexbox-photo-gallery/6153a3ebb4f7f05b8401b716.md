...
Атрибут `alt` для зображення має описувати вміст зображення. Читачі екрана оголошують альтернативний текст замість зображень. Якщо зображення не вдається завантажити, цей текст відображається замість зображення.

Щоб завершити проєкт, додайте атрибут `alt` до всіх дев’яти ваших зображень котів, щоб описати їх. Використовуйте значення довжиною щонайменше п’ять символів для кожного.


# --hints--

Усі дев’ять ваших елементів `img` мають мати атрибут `alt` з текстом, що описує кожне зображення, причому кожен опис має містити щонайменше `5` літер.
