...
给 `span[class~="sr-only"]` 选择器中的每个属性一个 `!important` 关键字。 不要更改任何值。

# --hints--

你的 `span[class~="sr-only"]` 选择器应该将 `border` 属性设置为 `0 !important`。
...
你的 `span[class~="sr-only"]` 选择器应该将 `clip` 属性设置为 `rect(1px, 1px, 1px, 1px) !important`。
...
你的 `span[class~="sr-only"]` 选择器应该将 `clip-path` 属性设置为 `inset(50%) !important` 。
...
你的 `span[class~="sr-only"]` 选择器应该将 `height` 属性设置为 `1px !important`。
...
你的 `span[class~="sr-only"]` 选择器应该将 `width` 属性设置为 `1px !important`。
...
你的 `span[class~="sr-only"]` 选择器应该将 `position` 属性设置为 `absolute !important`。
...
你的 `span[class~="sr-only"]` 选择器应该将 `overflow` 属性设置为 `hidden !important`。
...
你的 `span[class~="sr-only"]` 选择器应该将 `white-space` 属性设置为 `nowrap !important`。
...
你的 `span[class~="sr-only"]` 选择器应该将 `padding` 属性设置为 `0 !important`。
...
你的 `span[class~="sr-only"]` 选择器应该将 `margin` 属性设置为 `-1px !important`。
