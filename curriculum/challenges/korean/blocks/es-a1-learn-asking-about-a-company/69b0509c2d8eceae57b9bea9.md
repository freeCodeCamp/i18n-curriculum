...
주어가 회사처럼 단수 명사일 때, 스페인어는 **3인칭 단수** 동사 형태를 사용합니다. 예를 들어:

- `La empresa tiene...` - 회사는 가지고 있습니다... (3인칭 단수)
- `El equipo trabaja...` - 팀은 일합니다... (3인칭 단수)
- `La compañía está...` - 회사는 입니다... (3인칭 단수)
...
`La empresa tiene setenta y tres empleados.` - 회사는 73명의 직원을 가지고 있습니다.
