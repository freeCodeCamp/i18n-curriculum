...
Los trackballs reducen el movimiento físico que el usuario necesita para la navegación, haciéndolos ideales para usuarios con problemas de movilidad.  
Además, si necesitas alta precisión y tienes espacio limitado en el escritorio, un trackball es más ideal que un mouse tradicional.

Un joystick es un dispositivo apuntador diseñado principalmente para juegos y ciertas aplicaciones industriales como el control de maquinaria. Consiste en una palanca que pivota hacia arriba, abajo, izquierda y derecha, y a menudo incluye botones adicionales para diversas acciones.
...
Dispositivo señalador que proporciona control preciso en los juegos. Revisa la parte central de la lección donde se discutió esto.
