...
Ersetzen Sie nun den Inhalt des Callback der Ereignislistener.

Verwenden Sie `querySelector`, um das `.count`-Element innerhalb des Buttons zu finden.

Protokollieren Sie dann den Textinhalt des `.count`-Elements, wenn auf den Button geklickt wird.

# --hints--

Sie sollten den Textinhalt des `.count`-Elements innerhalb des angeklickten Buttons protokollieren.
