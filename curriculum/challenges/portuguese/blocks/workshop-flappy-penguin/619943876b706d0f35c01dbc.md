...
Altere a ordem de empilhamento do elemento `.penguin-head` de modo que apareça abaixo do elemento `.penguin-body`.
...
Você deve dar ao elemento `.penguin-head` uma `z-index` de `1`.
