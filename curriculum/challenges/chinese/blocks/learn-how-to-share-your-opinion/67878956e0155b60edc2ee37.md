...
`Web design` is the process of planning and creating websites. It includes layout, colors, fonts, and how the website looks and works. 例如：
...
`Animations` are effects or images that move on a screen to make something more interesting or interactive. 例如：
