...
Unaweza kutoa nafasi kidogo kati ya menyu yako na maudhui pamoja na pande kwa kutumia sifa mbalimbali za `padding`.

Toa darasa la `menu` `padding-left` na `padding-right` zenye thamani sawa ya `20px`.

# --hints--

Unapaswa kuweka sifa ya `padding-left` kuwa `20px`.
...
Unapaswa kuweka sifa ya `padding-right` kuwa `20px`.
