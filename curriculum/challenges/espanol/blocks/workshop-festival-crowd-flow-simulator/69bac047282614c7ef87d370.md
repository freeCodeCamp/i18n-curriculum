...
Para ayudar a rastrear cómo se mueven los asistentes por el sistema, registra el siguiente mensaje en la consola: `overflowAmount + " attendees rerouted to " + gates[nextGateIndex].id`. Puedes usar concatenación de cadenas o plantillas literales.

# --hints--

Tu función `rerouteOverflow` debe registrar el siguiente mensaje en la consola `overflowAmount + " attendees rerouted to " + gates[nextGateIndex].id`.
