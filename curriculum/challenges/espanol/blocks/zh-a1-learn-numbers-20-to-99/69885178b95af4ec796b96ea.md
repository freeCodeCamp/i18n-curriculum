...
En chino, el número 80 se llama `八十 (bā shí)`.

Los números del 81 al 89 se forman añadiendo el dígito de las unidades (1–9) después de `八十 (bā shí)` (80).
...
He practicado la pronunciación de los números del 80 al 89.
