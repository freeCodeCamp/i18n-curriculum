...
Всі елементи `img` повинні мати атрибут `alt`. The `alt` attribute's text is used for screen readers to improve accessibility and is displayed if the image fails to load.
