...
Bereiche werden durch einen Doppelpunkt getrennt. Nach Ihren zwei Erfassungsgruppen sollte Ihr `rangeRegex` nach einem Doppelpunkt suchen.

# --hints--

Sie sollten nach Ihrer zweiten Erfassungsgruppe einen Doppelpunkt hinzufügen.
