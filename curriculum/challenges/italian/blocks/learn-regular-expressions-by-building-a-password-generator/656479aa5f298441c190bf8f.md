...
Dichiara una funzione `generate_password` e scrivi tutto il tuo codice tranne le righe `import` all’interno del corpo della funzione.

# --hints--

Dovresti dichiarare una funzione chiamata `generate_password`.
...
Le istruzioni di importazione devono rimanere all’esterno della funzione.
...
Le quattro dichiarazioni di variabili devono essere spostate all’interno della funzione.
