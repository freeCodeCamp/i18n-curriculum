...
Тепер потрібно отримати перше число в тексті `0/10`, так, щоб це працювало навіть для `5/10` або `10/10`.

Проаналізуйте вміст тексту елемента `.count`, щоб витягти поточне число.

Перетворіть лічильник із рядка на число.

Замініть попередній `console.log(countEl.textContent)` на ваш новий лог.

Виведіть у консоль поточний лічильник у форматі: `console.log("Current count:", currCount)`.

Підказка: пам’ятайте, що можна використати метод `split`, щоб розділити рядок на масив підрядків.

# --hints--

Ви повинні вивести в консоль поточний лічильник як число.
...
Ви повинні вивести в консоль поточний лічильник як число так, щоб це працювало для різних можливих значень.
