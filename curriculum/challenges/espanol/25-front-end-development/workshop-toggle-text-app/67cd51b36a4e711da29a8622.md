...
Para alternar la visibilidad del texto, primero necesitarás crear una función que será responsable de ese comportamiento.

Comienza por crear una nueva función llamada `handleToggleVisibility`.

# --hints--

Debes tener una función `handleToggleVisibility`.
