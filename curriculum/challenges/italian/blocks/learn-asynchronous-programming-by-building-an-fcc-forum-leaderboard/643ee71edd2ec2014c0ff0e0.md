...
Nel quarto elemento `td`, aggiungi un’espressione incorporata che contenga la variabile `views`. Questo mostrerà il numero di visualizzazioni del post.

# --hints--

Dovresti aggiungere un’espressione incorporata che contenga la variabile `views`.
