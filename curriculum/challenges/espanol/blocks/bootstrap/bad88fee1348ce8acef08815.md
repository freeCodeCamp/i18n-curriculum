...
Coloca los botones `Like`, `Info` y `Delete` uno al lado del otro anidando los tres dentro de un solo elemento `<div class="row">`, y luego cada uno dentro de un elemento `<div class="col-xs-4">`.
