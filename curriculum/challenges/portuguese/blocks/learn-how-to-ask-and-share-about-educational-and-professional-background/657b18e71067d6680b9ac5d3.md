...
O verbo `redesign` significa projetar algo novamente ou de forma diferente. É frequentemente usado no contexto de melhorar ou atualizar o design de um produto, serviço ou estrutura existente.
...
Para alterar ou melhorar um design existente.

---

Para copiar um design.
