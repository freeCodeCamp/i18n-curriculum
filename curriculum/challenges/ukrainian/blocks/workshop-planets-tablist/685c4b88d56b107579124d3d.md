...
Якщо подивитися на HTML, ви побачите, що другий і третій панелі приховані. Це зроблено за допомогою атрибута `hidden`. Перша панель видима за замовчуванням. Коли користувач натискає на вкладку, усі панелі мають бути приховані.

Використайте метод `forEach`, щоб пройтися циклом по множині `panels` і встановити атрибут `hidden` на кожній панелі в значення `true`.

# --hints--

Ви маєте пройтися циклом по множині `panels` і встановити атрибут `hidden` кожної панелі в значення `true`.
