...
Agregue un selector `:root` en la parte superior de la consulta de medios. Luego redefina las cuatro variables de `--building-color` para usar el valor `#000` allí.
