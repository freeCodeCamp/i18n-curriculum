...
`To be familiar`某事物就是至少知道一點關於該主題的知識。如果你問某人 `are you familiar with this?`，你是在問他們是否知道它。範例：`I have never seen this soda before. It's delicious. Are you familiar with it?`（你是在問對方是否以前知道和／或嘗過那款汽水）。
