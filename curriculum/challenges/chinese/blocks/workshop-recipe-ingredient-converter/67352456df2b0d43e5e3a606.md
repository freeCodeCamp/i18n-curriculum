...
为你的 `conversionTable` 添加一个 `gram` 属性，并赋值一个对象，该对象的 `cup` 属性设置为 `1/240`，`ounce` 属性设置为 `0.0353`，`teaspoon` 属性设置为 `0.2`。

# --hints--

你的 `conversionTable` 应该有一个 `gram` 属性。
