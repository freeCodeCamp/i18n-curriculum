...
Machen Sie nun dasselbe für die restlichen Eigenschaften. Verwenden Sie die `getElement` Funktion, um jede einzelne auszuwählen:

| Eigenschaft | Selektor | 
| ---------- | ---------- |
...
Sie sollten auf die `multipleCardsBtn` zugreifen, indem Sie die `getElement` Methode verwenden und `#btn-multiple-cards` übergeben.
...
Sie sollten auf die `multipleCard` zugreifen, indem Sie die `getElement` Methode verwenden und `.multiple_card` übergeben.
...
Sie sollten auf die `title` zugreifen, indem Sie die `getElement` Methode verwenden und `.title` übergeben.
...
Sie sollten auf die `newReadingBtn` zugreifen, indem Sie die `getElement` Methode verwenden und `.btn_reveal` übergeben.
...
Sie sollten auf die `fortuneContainer` zugreifen, indem Sie die `getElement` Methode verwenden und `.fortune_container` übergeben.
...
Sie sollten auf die `fortuneDescription` zugreifen, indem Sie die `getElement` Methode verwenden und `.fortune_description` übergeben.
...
Sie sollten auf die `headerTitle` zugreifen, indem Sie die `getElement` Methode verwenden und `.header_title` übergeben.
...
Sie sollten auf die `subTitle` zugreifen, indem Sie die `getElement` Methode verwenden und `.sub_title` übergeben.
...
Sie sollten auf die `cardTitle` zugreifen, indem Sie die `getElement` Methode verwenden und `.desc_title` übergeben.
...
Sie sollten auf die `description` zugreifen, indem Sie die `getElement` Methode verwenden und `.description` übergeben.
...
Sie sollten auf die `text` zugreifen, indem Sie die `getElement` Methode verwenden und `.text` übergeben.
