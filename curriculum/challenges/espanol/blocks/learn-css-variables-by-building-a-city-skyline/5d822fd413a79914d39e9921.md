...
Para el siguiente edificio, anidar cuatro elementos `div` dentro de `.fb3` con clases de `fb3a`, `fb3b`, `fb3a` de nuevo, y `fb3b` de nuevo, en ese orden. Este edificio tendrá cuatro secciones, las dos superiores serán casi iguales a las dos inferiores.
