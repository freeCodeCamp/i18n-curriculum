...
هذا هو صيغة `past simple` من الفعل `to be`، تُستخدم مع `you`، `we`، أو `they`. الحرف الأول مكتوب بحرف كبير.
...
تعني هذه الكلمة المشاركة الفعالة في شيء ما. تنتهي بـ `-ed`.
...
تشير هذه المصطلح إلى عملية إتمام الشراء.
