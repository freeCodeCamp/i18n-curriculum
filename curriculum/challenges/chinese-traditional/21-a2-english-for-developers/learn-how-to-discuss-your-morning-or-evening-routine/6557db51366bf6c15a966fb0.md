...
When a verb follows a preposition, it often takes the `-ing` form, known as a gerund. Gerunds are verbs acting as nouns. This rule is common in many English expressions. 舉個例子：
