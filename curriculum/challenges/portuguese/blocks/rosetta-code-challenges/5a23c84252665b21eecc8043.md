...
Encontre soluções para o quebra-cabeça *sum to one hundred*.

Adicione (insira) os operadores matemáticos **+** ou **─** (mais ou menos) antes de qualquer um dos dígitos na string numérica decimal **123456789** de modo que a expressão matemática resultante some um valor específico (neste caso icônico, **100**).
