...
Всередині інструкції `if` деструктуруйте `className` і `category` з об’єкта `allCategories[id]`.

# --hints--

Ви повинні деструктурувати `className` і `category` з об’єкта `allCategories[id]`. Пропи можуть бути в будь-якому порядку.
