...
في سؤال Jake، انتبه إلى صيغة الفعل التي تلي حرف الجر واستخدامها في الجملة.
...
إنها صيغة المصدر المستمر للفعل `go`، تُستخدم هنا بعد حرف الجر `before` لوصف النشاط قبل النوم.
