...
Nella classe `sky` della media query, cambia i due valori di colore `#ffcf33` in `#ccc`, `#ffff66` in `#445` e `#bbeeff` in `#223`. Poi puoi ridimensionare la finestra per vedere il cambio di colore dello sfondo.

# --hints--

Dovresti cambiare i primi valori di colore da `#ffcf33` a `#ccc`.
...
Dovresti cambiare il secondo valore di colore da `#ffff66` a `#445`.
...
Dovresti cambiare il terzo valore di colore da `#bbeeff` a `#223`.
