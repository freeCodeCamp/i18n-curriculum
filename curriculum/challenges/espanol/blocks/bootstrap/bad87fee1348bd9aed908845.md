...
Puedes agregar el ícono `fa-paper-plane` de Font Awesome añadiendo `<i class="fa fa-paper-plane"></i>` dentro de tu elemento `button` de envío.
...
Debes agregar un `<i class="fa fa-paper-plane"></i>` dentro de tu elemento `button` de envío.
