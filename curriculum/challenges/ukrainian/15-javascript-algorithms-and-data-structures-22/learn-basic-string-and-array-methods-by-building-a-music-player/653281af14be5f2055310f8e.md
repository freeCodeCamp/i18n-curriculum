...
Ваш музичний плеєр повинен відстежувати пісні, поточну пісню, що відтворюється, та час поточної пісні. Щоб це зробити, вам потрібно буде створити об’єкт для зберігання цієї інформації.

Почніть з використання ключового слова `let`, щоб оголосити нову змінну під назвою `userData` та призначте до неї порожній об’єкт.
...
Призначте порожній об’єкт до змінної `userData`.
