...
Vediamo il validatore individuare un problema reale. `catalog[0]` è "From a Buick 8" di Stephen King, che ha tutti e quattro i campi compilati. `catalog[16]` è "Unknown Title", che ha il campo autore vuoto.
