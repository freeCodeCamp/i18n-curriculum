...
You should have a checkpoint detection rule that checks for the following: `player.position.x - player.width <= checkpoint.position.x - checkpoint.width + player.width * 0.9`.
