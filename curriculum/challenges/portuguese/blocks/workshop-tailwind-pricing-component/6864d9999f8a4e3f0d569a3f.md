...
Em seguida, torne o texto `h1` distinguível atribuindo a ele uma `class` definida como `text-3xl` para deixá-lo maior, `text-center` para centralizá-lo, `font-semibold` para deixá-lo mais negrito, `text-gray-900` para deixá-lo mais escuro e `md:text-5xl` para deixá-lo maior em tamanhos de tela médios e maiores.

# --hints--

Seu elemento `h1` deve ter a classe `text-3xl`.
...
Seu elemento `h1` deve ter a classe `text-center`.
...
Seu elemento `h1` deve ter a classe `font-semibold`.
...
Seu elemento `h1` deve ter a classe `text-gray-900`.
...
Seu elemento `h1` deve ter a classe `md:text-5xl`.
