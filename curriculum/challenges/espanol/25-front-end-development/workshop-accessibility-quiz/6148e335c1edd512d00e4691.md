...
Al hacer clic en los enlaces de navegación se debe saltar a la sección relevante. Sin embargo, este salto puede desorientar a algunos usuarios.
...
Debes dar a `*` un `scroll-behavior` de `smooth`.
