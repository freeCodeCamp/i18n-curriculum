...
Aggiungi altri due elementi `div` ciascuno con il `className` di `form-group` all'interno di `stats-grid`, uno per PAS e l'altro per DRI.

Per quello di PAS, aggiungi un `label` con un `htmlFor` di `pas` e il testo `PAS`, poi un input con un `id` di `pas` e un `type` di `number`.

E per quello di DRI, aggiungi un `label` con un `htmlFor` di `dri` e il testo `DRI`, poi un input con un `id` di `dri` e un `type` di `number`.

# --hints--

Dovresti aggiungere altri due elementi `div` ciascuno con il `className` di `form-group` all'interno del `div` di `className` di `stats-grid`.
...
Il tuo terzo elemento `div` di `className` di `form-group` dovrebbe avere un `label` con un attributo `htmlFor` di `pas`, un `className` di `label` e un testo `PAS`.
...
Il tuo terzo elemento `div` di `className` di `form-group` dovrebbe avere un `input` con un `className` di `input`, un `id` di `pas` e un `type` di `number`.
...
Il tuo quarto elemento `div` di `className` di `form-group` dovrebbe avere un `label` con un attributo `htmlFor` di `dri`, un `className` di `label` e un testo `DRI`.
...
Il tuo quarto elemento `div` di `className` di `form-group` dovrebbe avere un `input` con un `className` di `input`, un `id` di `dri` e un `type` di `number`.
