...
Тепер ви почнете працювати над методом `initializeEventListeners()`. Спочатку вкажіть для нього тип повернення `void`.

# --hints--

Ваш метод `initializeEventListeners` має мати тип повернення `void`.
