...
Em projetos anteriores, você aprendeu como adicionar e remover classes de um elemento com `el.classList.add()` e `el.classList.remove()`.Outro método para usar com a propriedade `classList` é o método `toggle`.
