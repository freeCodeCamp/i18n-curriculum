...
Створіть ще одну умову `except`, яка ловить `MediaError as e`. Усередині блоку `except` використайте f-рядок, щоб вивести `Media Error:`, після чого пробіл і повідомлення про помилку.

# --hints--

У вас має бути умова `except`, яка ловить `MediaError as e`.
...
Усередині нового блоку `Media Error:` використайте f-рядок, щоб вивести `except`, після чого пробіл і повідомлення про помилку.
