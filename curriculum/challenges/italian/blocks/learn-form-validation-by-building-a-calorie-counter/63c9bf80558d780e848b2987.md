...
Declare a `breakfastNumberInputs` variable, and give it the value of calling `document.querySelectorAll()` with the selector `#breakfast input[type='number']`. Restituirà qualsiasi input di tipo `number` presente nell'elemento `#breakfast`.
