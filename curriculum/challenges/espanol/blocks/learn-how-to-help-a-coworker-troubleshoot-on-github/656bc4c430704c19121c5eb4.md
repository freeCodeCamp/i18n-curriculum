...
En este diálogo, Bob usa el tiempo pasado continuo para describir acciones en curso en el pasado.
...
El verbo es `to add`. Recuerda conjugarlo.
...
El verbo es `to push`. Recuerda conjugarlo.
