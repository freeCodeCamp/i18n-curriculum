...
Establece la propiedad `innerText` de `outputValueNode` a `num`.

# --hints--

Debes usar `innerText` para establecer el texto de `outputValueNode`.
...
Debes usar `innerText` para establecer el texto de `outputValueNode` a `num`.
