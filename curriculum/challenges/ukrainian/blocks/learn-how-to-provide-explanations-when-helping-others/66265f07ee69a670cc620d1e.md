...
Це стосується процесу запуску або налаштування чогось для використання.
...
Це означає налаштування або конфігурування параметрів системи чи програмного забезпечення.
...
Це включає підготовку або підготовку чогось до першого використання.
