...
У цьому завданні заповніть пропуски правильними дієсловами у минулому часі. Прослухайте речення і зверніть увагу на контекст, щоб обрати правильні слова.
