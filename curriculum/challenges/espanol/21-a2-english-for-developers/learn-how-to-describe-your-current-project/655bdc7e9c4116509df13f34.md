...
To `use` significa poner algo a un propósito particular.
...
Se refiere al acto de utilizar algo para un propósito. Usa `-ing`
...
Algo que te ayuda a hacer un trabajo. Usa el formulario plural.
