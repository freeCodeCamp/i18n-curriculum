...
Hören Sie sich den Audio an und ergänzen Sie den Dialog mit den richtigen Wörtern.
...
Dieses Wort vervollständigt die höfliche Wendung „Freut mich, Sie kennenzulernen“.
...
Diese zwei Wörter zusammen sind der Name eines Landes in Mittelamerika.
...
Dies ist die männliche Form der Nationalität einer Person aus Guatemala.

# --explanation--

Dieser Dialog enthält die Wörter `gusto`, `El Salvador` und `guatemalteco` (in dieser Reihenfolge).
