...
Ili kumaliza kitendakazi chako cha `simulateFestival`, onyesha muhtasari wa matokeo ya majaribio. Fanya wito kwa `printSummary()` ukiwa na kitu chako cha `throughputSummary` cha eneo lako.

# --hints--

Unapaswa kufanya wito kwa `printSummary()` ukiwa na `throughputSummary`.
