...
Що підказує підпис функції про саму функцію?

## --answers--

Як довго функція виконуватиметься

### --feedback--

Підпис не повідомляє про час виконання функції.
...
Підпис не дає інформації про зовнішній вигляд функції в коді.

---

Ім’я функції, параметри та тип повернення
...
Підпис показує деталі функції, а не інформацію про її автора.
