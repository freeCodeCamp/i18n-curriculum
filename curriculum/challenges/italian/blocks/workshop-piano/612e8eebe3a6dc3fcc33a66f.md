...
Ora seleziona il tuo elemento `#piano` con un selettore `id`. Imposta la sua proprietà `background-color` su `#00471b`, la proprietà `width` su `992px` e la proprietà `height` su `290px`.
