...
Para adicionar espaço entre as linhas no layout de grade, você pode usar a propriedade `row-gap`. Dê ao seletor `main` a propriedade `row-gap` definida como `3rem`.

# --hints--

O seletor `main` deve ter a propriedade `row-gap` de `3rem`.
