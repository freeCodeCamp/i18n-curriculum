...
Після отримання фактичного індексу створіть оператор if, щоб перевірити, чи `actual_index` менше за 0 або більше або дорівнює довжині списку `self.emails`. Якщо так, виведіть повідомлення `Invalid email number.\n` і використайте `return`, щоб вийти з методу.
...
Якщо індекс недійсний, ви повинні вивести повідомлення `Invalid email number.\n` і використати `return`, щоб вийти з методу.
