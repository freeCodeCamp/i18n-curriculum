...
Weka sifa ya `background-color` ya `.one` kuwa `#efb762`.

# --hints--

Unapaswa kuweka sifa ya `background-color` kuwa `#efb762`.
...
Kipengele chako cha `.one` kinapaswa kuwa na thamani ya `background-color` ya `#efb762`.
