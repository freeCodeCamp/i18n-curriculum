...
Njia yako ya `calculateTaxes` inapaswa kurudisha thamani ya `taxRate` (gawanywa kwa 100, kubadilisha kuwa asilimia) iliyozidishwa na kigezo cha `amount`.

Kwa uwazi, zungusha hesabu ya `taxRate / 100` katika mabano ya kawaida.

# --hints--

Unapaswa kugawanya `taxRate` kwa 100 katika njia yako ya `calculateTaxes`. Kumbuka kutumia neno kuu la `this`.
...
Unapaswa kuzungusha hesabu ya `this.taxRate / 100` katika mabano ya kawaida.
...
Unapaswa kuzidisha kigezo cha `amount` na `taxRate` iliyogawanywa kwa 100 katika njia yako ya `calculateTaxes`.
