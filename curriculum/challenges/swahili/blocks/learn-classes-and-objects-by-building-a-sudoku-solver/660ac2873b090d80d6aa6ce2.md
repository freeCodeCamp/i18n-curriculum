...
Sasa, tengeneza mzunguko wa `for` kurudia juu ya safu katika ubao. Tumia `row` kama kigezo cha mzunguko.

# --hints--

Unapaswa kutengeneza mzunguko wa `for` unaorudia juu ya `self.board`.
...
Unapaswa kutumia `row` kama kigezo cha mzunguko.
