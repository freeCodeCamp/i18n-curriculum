...
`Lightweight` describes something that doesn't require much in terms of resources or power, making it easy to run, fast, and efficient. Por ejemplo:
...
`Features` are specific functions or tools that a product or software offers to users. Por ejemplo:
