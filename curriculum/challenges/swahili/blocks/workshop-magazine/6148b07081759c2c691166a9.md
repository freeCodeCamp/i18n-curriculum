...
Unda kichaguzi cha `.text` na umpe sifa ya `grid-column` iliyowekwa kuwa `2 / 3`.
...
Kichaguzi chako cha `.text` kinapaswa kuwa na sifa ya `grid-column` iliyowekwa kuwa `2 / 3`.
