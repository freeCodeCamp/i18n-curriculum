...
1. 각각 앵커 요소와 `figcaption` 요소를 포함하는 최소 세 개의 `figure` 요소가 있어야 합니다.
1. 세 개의 앵커 요소는 적절한 `img` 속성을 가진 `alt` 요소와 유효한 이미지가 설정된 `src` 속성을 가진 `img` 요소를 포함해야 합니다. 원한다면 `https://cdn.freecodecamp.org/curriculum/labs/colosseo.jpg`, `https://cdn.freecodecamp.org/curriculum/labs/alps.jpg`, `https://cdn.freecodecamp.org/curriculum/labs/sea.jpg`을 사용할 수 있습니다.
