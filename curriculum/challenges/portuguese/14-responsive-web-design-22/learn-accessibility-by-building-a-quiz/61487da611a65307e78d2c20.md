...
Em telas pequenas, a lista não ordenada na barra de navegação transborda do lado direito da tela.

Corrija isso usando o _Flexbox_ para encapsular o conteúdo do `ul`. Em seguida, defina as seguintes propriedades CSS para alinhar corretamente o texto:
