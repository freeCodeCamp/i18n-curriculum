...
المستطيلات صغيرة جدًا وحوافها لا تمتلك النعومة التي تشبه لوحة فنية.

زد المساحة ونعّم حواف `.one` بتعيين `box-shadow` إلى `0 0 3px 3px #efb762`.

# --hints--

يجب تعيين خاصية `box-shadow` إلى `0 0 3px 3px #efb762`.
...
يجب أن يحتوي عنصر `.one` على قيمة `box-shadow` تساوي `0 0 3px 3px #efb762`.
