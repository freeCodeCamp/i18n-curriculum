...
Ángela e Sebastián estão falando sobre suas profissões.
...
Esta é a conjugação na segunda pessoa (`tu`) do verbo `dedicarse`.
...
Este substantivo significa "analyst".

# --explanation--

Este diálogo inclui as palavras `dedicas`, `representante` e `analista`.
