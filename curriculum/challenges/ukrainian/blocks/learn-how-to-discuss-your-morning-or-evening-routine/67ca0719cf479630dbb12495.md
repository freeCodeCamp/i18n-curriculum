...
`yourself`, `keep up`, `Is it true`, `look for`, `in the evening`, `take`, і `hang out`.  
...
Це формує `yes`/`no` питання, яке просить підтвердження. Починається з дієслова, за яким іде займенник, а потім прикметник.  
...
Це вказує на час доби. Починається з прийменника, за яким іде означений артикль, а потім іменник.  
...
Це означає "записатися або брати участь у класі чи уроці".  
...
Це означає "шукати або прагнути чогось". Починається з дієслова, за яким іде прийменник.  
...
Це описує проведення часу невимушено з друзями. Починається з дієслова, за яким іде прийменник.  
...
Це означає "підтримувати той самий темп або рівень, що й хтось або щось інше". Починається з дієслова, за яким іде прийменник.  
...
Це зворотній займенник, який відноситься до мовця.
