...
考慮丟番圖方程式 $\frac{1}{a} + \frac{1}{b} = \frac{p}{{10}^n}$，其中 $a$、$b$、$p$、$n$ 為正整數且 $a ≤ b$。

當 $n = 1$ 時，這個方程式有 20 個解法，列在下方：
...
對於 $1 ≤ n ≤ 9$，這個方程式有多少個解法？

# --hints--

`diophantineEquation()` 應該傳回 `53490`。
