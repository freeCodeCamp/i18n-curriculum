...
З натисканням на навігаційні посилання, вюпорт повинен перестрибувати на відповідну секцію. Однак цей стрибок може дезорієнтувати деяких користувачів.

Виберіть всі елементи та встановіть `scroll-behavior` на `smooth`.
