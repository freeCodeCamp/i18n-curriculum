...
استخدم نفس إعلان `box-shadow` لعنصر `.two`، لكن غيّر اللون من `#efb762` إلى `#8f0401`.

# --hints--

يجب تعيين خاصية `box-shadow` إلى `0 0 3px 3px #8f0401`.
...
يجب أن يحتوي عنصر `.two` على قيمة `box-shadow` تساوي `0 0 3px 3px #8f0401`.
