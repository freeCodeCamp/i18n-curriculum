...
Спочатку виведіть у консоль таке повідомлення: `"\nProcessing " + gate.id + "..."`.

# --hints--

Ваша функція `handleGateAtTick` спочатку має вивести у консоль таке повідомлення, `"\nProcessing " + gate.id + "..."`.
...
Ваша функція `handleGateAtTick` має вивести правильний ідентифікатор воріт у повідомленні.
