...
Дайте елементам `label` текст так, щоб `input` стояв перед текстом. Потім дайте елементам `input` `value`, що відповідає тексту.
...
Ви повинні надати першому `input` `value`, що відповідає текстовому вмісту `label`.
...
Ви повинні надати другому `input` `value`, що відповідає текстовому вмісту `label`.
...
Ви повинні надати третьому `input` `value`, що відповідає текстовому вмісту `label`.
...
Ви повинні надати четвертому `input` `value`, що відповідає текстовому вмісту `label`.
