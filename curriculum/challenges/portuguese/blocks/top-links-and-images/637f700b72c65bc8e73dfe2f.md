...
Para exibir uma imagem em HTML, você usa o elemento `<img>`.  Unlike the other elements you have encountered, the `<img>` is a void element. Os elementos vazios ou nulos do HTML não precisam de uma tag de fechamento.
...
- Em seguida, faça o download <a href="https://unsplash.com/photos/Mv9hjnEUHR4/download?force=true&w=640" target="_blank">desta imagem</a> e mova-a para o diretório images que você acabou de criar.
...
Para ir para o diretório pai você precisa usar dois pontos no caminho relativo assim: `../`. Vamos ver isso na prática, dentro do `body` do arquivo `about.html`, adicione a seguinte imagem abaixo do título que você adicionou anteriormente:
...
É assim que o exemplo do logo do The Odin Project que você usou antes fica com um atributo alt incluído:
...
Leia sobre os <a href="https://www.freecodecamp.org/news/image-file-types-picture-format-extensions-jpeg-gif-png-svg-tiff/" target="_blank">quatro principais formatos de imagem</a> que podem ser usados na web.
