...
title: "Desafio 279: cadeia mais longa de dominós"
challengeType: 28
...
Dado um array 2D representando um conjunto de dominós, retorne a cadeia válida mais longa.

- Cada dominó é um par de números de 0 a 6, por exemplo `[3, 2]`.
- Uma cadeia é válida quando o segundo número de cada dominó corresponde ao primeiro número do próximo.
- O primeiro número do primeiro dominó e o segundo número do último não precisam corresponder a nada.
- Qualquer dominó pode ser invertido, então `[3, 2]` pode ser jogado como `[2, 3]`.
- Sempre existe exatamente uma cadeia válida mais longa.

Por exemplo, dado `[[1, 2], [4, 5], [2, 3]]`, retorne `[[1, 2], [2, 3]]`.

# --hints--

`getLongestChain([[1, 2], [4, 5], [2, 3]])` deve retornar `[[1, 2], [2, 3]]`.
...
`getLongestChain([[2, 1], [4, 3], [5, 3]])` deve retornar `[[4, 3], [3, 5]]`.
...
`getLongestChain([[1, 2], [3, 4], [2, 3], [4, 0]])` deve retornar `[[1, 2], [2, 3], [3, 4], [4, 0]]`.
...
`getLongestChain([[6, 6], [6, 1], [1, 1], [0, 3], [2, 3], [4, 1], [5, 6]])` deve retornar `[[4, 1], [1, 1], [1, 6], [6, 6], [6, 5]]`.
...
`getLongestChain([[0, 4], [3, 3], [0, 3], [5, 6], [4, 5], [4, 2], [5, 5], [1, 2], [4, 4]])` deve retornar `[[3, 3], [3, 0], [0, 4], [4, 4], [4, 5], [5, 5], [5, 6]]`.
