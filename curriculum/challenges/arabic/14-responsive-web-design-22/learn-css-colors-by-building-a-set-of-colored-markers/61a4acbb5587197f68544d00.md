...
حدّث وظيفة `rgb` بحيث تكون قيمة الأحمر `162`، قيمة اللون الأخضر هي `27`، وقيمة اللون الأزرق هي `27`.

# --hints--

يجب أن تحتوي قاعدة CSS مسمى `.red` على خاصية `background` بقيمة `linear-gradient(180deg, rgb(122, 74, 14) 0%, rgb(245, 62, 113) 50%, rgb(162, 27, 27) 100%)`.
