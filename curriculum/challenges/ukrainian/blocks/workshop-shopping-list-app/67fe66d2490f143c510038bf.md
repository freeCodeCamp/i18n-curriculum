...
Потім у прапорці `input` додайте атрибут `checked` і встановіть його в `isChecked`. Хоча встановлювати атрибут `checked` не є строго необхідним, це добра практика, щоб кожен прапорець відображав поточний стан масиву `selectedItems`.

# --hints--

Ви повинні додати атрибут `checked` до прапорця `input`.
...
Ви повинні встановити атрибут `checked` у `isChecked`.
