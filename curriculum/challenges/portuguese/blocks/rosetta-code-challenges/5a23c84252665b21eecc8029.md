...
Implemente funções para criptografar e descriptografar uma mensagem usando o método **straddling checkerboard**.
...
A saída da função `straddle()` deve ser uma série de algarismos decimais.Números devem ser criptografados inserindo o caractere de escape antes de cada dígito, depois incluindo o dígito <em>não criptografado</em>.
