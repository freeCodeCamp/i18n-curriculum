...
Para ir ao diretório pai você precisa usar dois pontos no caminho relativo assim: `../`. Vamos ver isso na prática, dentro do `body` do arquivo `about.html`, adicione a seguinte imagem abaixo do título que você adicionou antes:
