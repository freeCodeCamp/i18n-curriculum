...
Chagua vipengele vyako vya `td` kwa vigezo vya `class` zenye thamani ya `current`, na fanya fonti iwe ya italiki.
...
Kichaguzi chako cha `td.current` kinapaswa kuwa na sifa ya `font-style` iliyowekwa kuwa `italic`.
