...
Além disso, como mencionamos no passo 1 que estamos considerando apenas números positivos, devemos adicionar uma terceira condição na declaração `if` para verificar se o número é menor que 0 (ou seja, números negativos)
