...
Dovresti aggiungere `--building-color1` con il valore `#000`.
...
Dovresti aggiungere `--building-color2` con il valore `#000`.
...
Dovresti aggiungere `--building-color3` con il valore `#000`.
...
Dovresti aggiungere `--building-color4` con il valore `#000`.
