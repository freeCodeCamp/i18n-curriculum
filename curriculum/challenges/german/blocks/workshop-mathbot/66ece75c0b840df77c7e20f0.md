...
Für den letzten Schritt des Workshops geben Sie die Nachricht `"It was fun learning about the different Math methods with you!"` in der Konsole aus.

Und mit dieser letzten Änderung haben Sie den MathBot-Workshop abgeschlossen!
...
Sie sollten die Nachricht `"It was fun learning about the different Math methods with you!"` in der Konsole ausgeben.
