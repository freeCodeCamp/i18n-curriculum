...
La salida es correcta, `repr` te está dando la cadena necesaria para instanciar los objetos.

Ahora comenta ambas llamadas a `print`.

# --hints--

Debes comentar ambas llamadas a `print()`.
