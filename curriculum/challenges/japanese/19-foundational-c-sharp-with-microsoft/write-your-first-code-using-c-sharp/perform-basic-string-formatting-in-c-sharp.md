...
1. <a href="https://learn.microsoft.com/training/modules/csharp-basic-formatting/" target="_blank" rel="noreferrer">https://learn.microsoft.com/training/modules/csharp-basic-formatting/</a> へ移動し、「C# で基本的な文字列を書式設定する (Perform Basic String Formatting in C#)」モジュール内のすべてのタスクを完了してください。 これは、Microsoft Learn のトロフィー「C# を使用して最初のコードを書く」を獲得し、認定試験の受験資格を得るために**必須**となります。
...
変数 `value` が文字列だとすると、文字列補間を正しく使用しているコードは次のうちどれですか？
