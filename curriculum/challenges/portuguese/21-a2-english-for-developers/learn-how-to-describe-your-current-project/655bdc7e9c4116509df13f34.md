...
`Use` significa usar algo para um propósito.
...
Refere-se ao ato de utilizar algo para um propósito. Use o `-ing`
...
Algo que ajuda você a realizar um trabalho. Use a forma plural.
