...
Un elemento usado para incrustar sonido en el documento.
...
¿Cuál de los siguientes elementos se usa para transmitir una sensación de urgencia, seriedad o gran importancia?
...
Añade controles de reproducción integrados como reproducir, pausar y ajuste de volumen.
...
Tanto `<img>` como `<img/>` son aceptables en HTML moderno.
...
Para transmitir énfasis de estrés haciendo el texto en cursiva.
