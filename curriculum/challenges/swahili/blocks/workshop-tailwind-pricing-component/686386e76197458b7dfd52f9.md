...
Sehemu nyingine ya HTML imetolewa tayari kwako. Hii ni pamoja na kadi za mpango wa premium na familia. Hivyo, ni wakati wa kupamba vipengele vya HTML kwa kutumia Tailwind CSS.

Anza kwa kutoa rangi ya kijivu kidogo kwa ukurasa mzima kwa kuweka darasa la `bg-gray-100` kwenye kipengele cha `body`.

# --hints--

Kipengele chako cha body kinapaswa kuwa na darasa la `bg-gray-100`.
