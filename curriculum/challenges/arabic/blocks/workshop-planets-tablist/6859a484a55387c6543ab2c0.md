...
حان الوقت الآن لإضافة الحقائق عن كل كوكب. داخل العنصر الأول `p`، أضف النص التالي:
...
داخل العنصر الثاني `p`، أضف النص التالي:
...
داخل العنصر الثالث `p`، أضف النص التالي:
...
يجب أن يحتوي العنصر الأول `p` على الحقائق عن الأرض. تأكد من أن نصك يطابق الوصف المقدم.
...
يجب أن يحتوي العنصر الثاني `p` على الحقائق عن زحل. تأكد من أن نصك يطابق الوصف المقدم.
...
يجب أن يحتوي العنصر الثالث `p` على الحقائق عن المريخ. تأكد من أن نصك يطابق الوصف المقدم.
