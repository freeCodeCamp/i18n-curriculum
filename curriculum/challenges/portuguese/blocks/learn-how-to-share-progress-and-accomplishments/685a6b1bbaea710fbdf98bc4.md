...
`last month`, `a while since`, `next phase`, `good news`, `yesterday` e `green light`.
...
Uma forma de dizer que já faz algum tempo desde que algo aconteceu.
...
A parte ou etapa seguinte em um plano ou projeto.
