...
Para implementar este cifrado, necesitas crear una nueva versión del alfabeto que comience en la posición indicada por el desplazamiento. Como aprendiste en una lección anterior, puedes extraer una parte de una cadena usando la segmentación de cadenas:
