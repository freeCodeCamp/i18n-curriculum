...
title: 'Problema 97: grande numero primo non di Mersenne'
challengeType: 1
forumTopicId: 302214
...
Il primo numero primo noto con più di un milione di cifre è stato scoperto nel 1999, ed è un numero primo di Mersenne della forma $2^{6972593} − 1$; contiene esattamente 2.098.960 cifre. Successivamente sono stati trovati altri numeri primi di Mersenne, della forma $2^p − 1$, con un numero di cifre ancora maggiore.

Tuttavia, nel 2004 è stato scoperto un enorme numero primo non di Mersenne che contiene 2.357.207 cifre: $28433 × 2^{7830457} + 1$.

Trova le ultime dieci cifre di quel numero primo non di Mersenne nella forma $multiplier × 2^{power} + 1$.
