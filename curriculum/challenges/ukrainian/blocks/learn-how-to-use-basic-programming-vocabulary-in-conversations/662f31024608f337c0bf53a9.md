...
Наскільки добре Том знає `object-oriented programming`?

## --answers--

Том знає про це багато і постійно це використовує.

### --feedback--

Том сказав, що не знає багато і ніколи не використовував це у своєму коді.

---

Том знає дещо, але ще не пробував це використовувати.

---

Том знає про це багато, але не використовував.

### --feedback--

Том згадує, що розуміє базові поняття, як класи та методи, але не використовував їх, тож він знає трохи, але не багато.

---

Том нічого про це не знає.

### --feedback--

Том щось знає, бо говорить про класи та методи, отже він не зовсім незнайомий з цим.
