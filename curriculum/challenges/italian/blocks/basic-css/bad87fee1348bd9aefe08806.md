...
title: definire lo stile di più elementi con una classe css
challengeType: 0
...
Le classi ti permettono di definire lo stile CSS uguale per più elementi HTML. Puoi vedere questo applicando la tua classe `red-text` al primo elemento `p`.
...
Il tuo primo elemento `p` dovrebbe essere rosso.
