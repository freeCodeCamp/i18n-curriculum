...
Torniamo allo styling della pagina. Seleziona gli elementi della lista all'interno della barra di navigazione e assegna loro i seguenti stili:
...
Dovresti dare agli elementi `li` una proprietà `color` del valore di `#dfdfe2`.
...
Dovresti dare agli elementi `li` una proprietà `margin` del valore di `0 0.2rem`.
...
Dovresti dare agli elementi `li` una proprietà `display` con il valore `block`.
