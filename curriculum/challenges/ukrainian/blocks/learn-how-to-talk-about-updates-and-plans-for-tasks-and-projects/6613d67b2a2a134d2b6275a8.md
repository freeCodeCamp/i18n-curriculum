...
Це вказує на майбутній план або рішення, тут йдеться про намір використати Node.js для бекенду.
...
Тут це використовується для прогнозування майбутнього результату, припускаючи, що вибір Node.js дозволить ефективно масштабувати застосунок.
