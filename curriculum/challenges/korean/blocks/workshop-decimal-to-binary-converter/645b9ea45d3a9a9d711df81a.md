...
마지막으로, 숫자 입력의 값을 빈 문자열로 설정해 지우세요. 이렇게 하면 여러 숫자를 연속으로 변환할 때 이전 숫자를 삭제하지 않고도 다음 숫자를 입력할 수 있습니다.

`value`의 `numberInput` 속성을 빈 문자열로 설정하세요.

# --hints--

`value`의 `numberInput` 속성을 빈 문자열로 설정해야 합니다.
