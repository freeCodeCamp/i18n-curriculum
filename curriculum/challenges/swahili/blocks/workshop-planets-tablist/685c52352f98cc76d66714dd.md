...
Sasa ni wakati wa kuweka kichupo kilichobofyiwa kuchaguliwa.

Tumia njia ya `setAttribute` kwenye `tab` kuweka sifa ya kipengele ya `aria-selected` kuwa `"true"`. 

# --hints--

Wakati `tab` inabofyiwa, sifa ya kipengele ya `aria-selected` ya kichupo kilichobofyiwa inapaswa kuwekwa kuwa `"true"`.
