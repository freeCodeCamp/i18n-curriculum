...
$N$ фішок розміщені в ряд та пронумеровані зліва направо від 1 до $N$.

Кожна фішка має чорну і білу сторону. Спочатку всі фішки перевернуті білою стороною вгору.

При кожному перевертанні випадково вибираються два, не обов’язково різні, цілі числа $A$ та $B$ між 1 та $N$ (включно). Перевертаються усі фішки з номерами від $A$ до $B$ (включно).
...
Нехай $E(N, M)$ буде очікуваною кількістю фішок, які будуть перевернуті білою стороною вгору після $M$ перевертань. Можна довести, що $E(3, 1) = \frac{10}{9}$, $E(3, 2) = \frac{5}{3}$, $E(10, 4) ≈ 5.157$ та $E(100, 10) ≈ 51.893$.
