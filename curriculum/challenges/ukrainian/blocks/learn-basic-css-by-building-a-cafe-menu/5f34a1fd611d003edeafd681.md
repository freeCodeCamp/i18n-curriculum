...
Цей коричневий фон ускладнює читання тексту. Змініть колір фону елемента `body` на `burlywood`, щоб фон мав колір, але текст залишався читабельним.

# --hints--

Ви повинні встановити властивість `background-color` у значення `burlywood`.
...
Ваш елемент `body` має мати фон `burlywood`.
