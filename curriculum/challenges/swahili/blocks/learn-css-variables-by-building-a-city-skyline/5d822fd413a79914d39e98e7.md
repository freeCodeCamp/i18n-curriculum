...
Toa vipengele vipya sita thamani hizi za `width` na `height`: `10%` na `60%` kwa `.fb1`, `10%` na `40%` kwa `.fb2`, `10%` na `35%` kwa `.fb3`, `8%` na `45%` kwa `.fb4`, `10%` na `33%` kwa `.fb5`, na `9%` na `38%` kwa `.fb6`.
...
Unapaswa kumpa kichaguzi cha `.fb1` `width` ya `10%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.fb1')?.width, '10%');
```

Unapaswa kumpa kichaguzi cha `.fb1` `height` ya `60%`.
...
Unapaswa kumpa kichaguzi cha `.fb2` `width` ya `10%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.fb2')?.width, '10%');
```

Unapaswa kumpa kichaguzi cha `.fb2` `height` ya `40%`.
...
Unapaswa kumpa kichaguzi cha `.fb3` `width` ya `10%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.fb3')?.width, '10%');
```

Unapaswa kumpa kichaguzi cha `.fb3` `height` ya `35%`.
...
Unapaswa kumpa kichaguzi cha `.fb4` `width` ya `8%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.fb4')?.width, '8%');
```

Unapaswa kumpa kichaguzi cha `.fb4` `height` ya `45%`.
...
Unapaswa kumpa kichaguzi cha `.fb5` `width` ya `10%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.fb5')?.width, '10%');
```

Unapaswa kumpa kichaguzi cha `.fb5` `height` ya `33%`.
...
Unapaswa kumpa kichaguzi cha `.fb6` `width` ya `9%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.fb6')?.width, '9%');
```

Unapaswa kumpa kichaguzi cha `.fb6` `height` ya `38%`.
