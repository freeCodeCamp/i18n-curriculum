...
`colleague` は、特に職場や正式な場面で一緒に働く人のことです。`Colleagues` は問題を解決するために協力することがよくあります。例えば、`My colleague helped me fix the bug in the code`。
