...
قم بتدوير `.three` عكس اتجاه عقارب الساعة بمقدار 0.2 درجة.

مع هذه الخطوة النهائية، أصبحت لوحة روثكو مكتملة الآن.

# --hints--

يجب أن تضبط خاصية `transform` على `rotate(-0.2deg)`.
...
يجب أن تحتوي العنصر `.three` على قيمة `transform` تساوي `rotate(-0.2deg)`.
