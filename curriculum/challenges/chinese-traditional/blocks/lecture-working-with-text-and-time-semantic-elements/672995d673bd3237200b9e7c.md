...
通常，添加該屬性後，縮寫元素的樣式會發生變化。 具體樣式取決於瀏覽器。 有些瀏覽器可能會顯示虛線下劃線，而有些瀏覽器則會將內容轉換爲小寫，甚至指定某些默認樣式，如虛線下劃線。 When the user hovers over the abbreviation with the mouse, the full form is displayed as a tooltip.
