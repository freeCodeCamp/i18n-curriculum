...
Seu segundo objeto no array `products` deve ter uma propriedade `name` definida como `French Macaron`.
...
Seu segundo objeto no array `products` deve ter uma propriedade `category` definida como `Macaron`.
...
Seu sétimo objeto no array `products` deve ter uma propriedade `name` definida como `Chocolate Macarons (4 Pack)`.
...
Seu sétimo objeto no array `products` deve ter uma propriedade `category` definida como `Macaron`.
...
Seu décimo primeiro objeto no array `products` deve ter uma propriedade `name` definida como `Vanilla Macarons (5 Pack)`.
...
Seu décimo primeiro objeto no array `products` deve ter uma propriedade `category` definida como `Macaron`.
