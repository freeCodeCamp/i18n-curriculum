...
Вашій функції зворотного виклику потрібно чотири параметри. `match`, `arg1`, `operator` і `arg2`.

Ви не будете використовувати параметр `match`, тому не забудьте додати префікс.
...
Ваша функція зворотного виклику має залишатися порожньою.
