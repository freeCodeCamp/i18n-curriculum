...
De vuelta a tu función `showLatestPosts()`, usa la desestructuración para obtener las propiedades `topic_list` y `users` del objeto `data`.

# --hints--

Debes usar `const` para desestructurar `topic_list` y `users` del objeto `data`.
