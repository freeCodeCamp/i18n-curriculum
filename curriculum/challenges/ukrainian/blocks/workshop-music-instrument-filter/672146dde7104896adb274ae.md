...
Коли ви вибираєте категорію з випадаючого меню, картки інструментів правильно фільтруються і відображаються на сторінці, але потрібно позбутися ком між картками.

Зробіть це, об’єднавши масив, який повертає `instrumentCards`. Таким чином ваш фільтр музичних інструментів буде завершено.
...
Ви маєте об’єднати масив, який повертає функція `instrumentCards`. Не змінюйте свій обробник подій.
