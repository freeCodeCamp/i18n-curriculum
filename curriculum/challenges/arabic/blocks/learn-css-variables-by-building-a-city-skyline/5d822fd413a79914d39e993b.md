...
انسخ والصق صنف `sky` كاملًا مع كل خصائصه وقيمه داخل استعلام الوسائط. ستصنع نظام ألوان آخر لأفق المدينة يغيره من النهار إلى الليل.

ملاحظة: ستحتاج إلى التمرير بعد المنطقة القابلة للتحرير لنسخ الصنف.

# --hints--

لا يجب حذف الإعلان الحالي لـ `.sky`.
...
يجب نسخ الإعلان الحالي لـ `.sky` داخل استعلام الوسائط.
