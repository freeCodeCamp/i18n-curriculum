...
أيقونة القلب شبه جاهزة. فقط عليك تلوينها باللون الأحمر.
لفعل ذلك، عيّن خاصية `fill` في عنصر `svg` إلى `red`.

تهانينا على إتمام هذه الورشة!

# --hints--

يجب أن تحتوي على خاصية `fill` في عنصر `svg` الخاص بك.
...
يجب أن تعرّف خاصية `fill` إلى `red`.
