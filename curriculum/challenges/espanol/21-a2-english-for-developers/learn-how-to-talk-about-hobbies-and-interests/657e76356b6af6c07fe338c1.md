...
En el tiempo presente perfecto, `for` y `since` se usan para discutir la duración del tiempo y los puntos de inicio. `For` indica cuánto tiempo ha estado ocurriendo algo. `Since` indica cuándo comenzó algo.
...
Esta preposición expresa la duración de una acción o situación en este contexto.
