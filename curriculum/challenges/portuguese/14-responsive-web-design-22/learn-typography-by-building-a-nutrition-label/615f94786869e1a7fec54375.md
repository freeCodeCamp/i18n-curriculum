...
Crie um seletor `.note` e defina o tamanho da fonte como `0.6rem`. Também defina as margens superiores e inferiores como `5px`, removendo as margens da esquerda e direita.
