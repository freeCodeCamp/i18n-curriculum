...
Gire `.three` no sentido anti-horário em 0,2 graus.

Com este último passo, a pintura Rothko está completa.

# --hints--

Você deve definir a propriedade `transform` como `rotate(-0.2deg)`.
...
O elemento `.three` deve ter um valor de `transform` de `rotate(-0.2deg)`.
