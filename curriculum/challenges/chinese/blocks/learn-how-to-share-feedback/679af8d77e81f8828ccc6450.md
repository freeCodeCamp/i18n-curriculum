...
`Perhaps` is used to indicate uncertainty or to suggest something without being definite. 例如：
...
`To make sure` means to ensure that something happens or is done correctly. 例如：
