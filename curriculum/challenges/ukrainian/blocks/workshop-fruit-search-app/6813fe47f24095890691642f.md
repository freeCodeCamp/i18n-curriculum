...
Далі вам потрібна функція для обробки відправлення форми. Визначте `handleSubmit` функцію, яка приймає об’єкт події `e` і викликає `e.preventDefault()`.

# --hints--

Ви маєте визначити `handleSubmit` функцію з параметром `e`.
...
Ви маєте викликати `e.preventDefault()` всередині функції `handleSubmit()`.
