...
Verwende die `border-radius`-Eigenschaft mit einem Wert von `80% 80% 100% 100%`, um dem Pinguin einen leicht runden Körper zu geben.

# --hints--

Du solltest `.penguin-body` einen `border-radius` von `80% 80% 100% 100%` geben.
