...
1. 最初の `section` 要素は、値 `upcoming-events` の `id` 属性を持つ必要があります。
...
1. 2番目の `section` 要素は、値 `past-events` の `id` 属性を持つ必要があります。
...
最初の `section` 要素は、値 `upcoming-events` の `id` 属性を持つ必要があります。
...
2番目の `section` 要素は、値 `past-events` の `id` 属性を持つ必要があります。
