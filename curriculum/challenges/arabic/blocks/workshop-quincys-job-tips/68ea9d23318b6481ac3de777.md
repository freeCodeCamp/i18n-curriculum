...
تمامًا مثل عنصر الاقتباس المضمَّن، يمكنك أيضًا إضافة خاصية `cite` إلى عنصر الاقتباس الكتلي.

إليك مثال على عنصر اقتباس كتلي مع خاصية `cite`:
...
الآن، أضف خاصية `cite` إلى عنصر الاقتباس الكتلي مع عنوان URL `https://www.freecodecamp.org/news/learn-to-code-book/`.
...
يجب أن تكون قيمة الخاصية `cite` هي `https://www.freecodecamp.org/news/learn-to-code-book/`.
