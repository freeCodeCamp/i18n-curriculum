...
No quarto elemento `td`, adicione uma expressão embutida que contenha a variável `views`.Isto exibirá o número de visualizações que o post possui.

# --hints--

Você deve adicionar uma expressão embutida que contenha a variável `views`.
