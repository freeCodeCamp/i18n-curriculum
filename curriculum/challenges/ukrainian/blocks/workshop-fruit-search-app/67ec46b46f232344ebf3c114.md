...
Далі ви створите форму, де користувачі зможуть шукати фрукти. Всередині елемента `#search-container` створіть елемент `form`.

# --hints--

У вас має бути елемент `form` всередині елемента `search-container`.
