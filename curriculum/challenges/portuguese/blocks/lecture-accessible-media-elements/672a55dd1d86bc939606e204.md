...
Aqui estão alguns exemplos de bons textos de link para casos de uso específicos, comparados a outros menos úteis.
Vamos supor que você queira criar um link para uma página que forneça detalhes sobre um evento assim:
