...
jQuery se tornou muito popular no início dos anos 2010 e foi amplamente usado para simplificar a manipulação do DOM, o tratamento de eventos, animações, efeitos e muito mais. Essa biblioteca também oferecia um ecossistema rico de plugins, o que facilitava a criação de componentes web comuns como seletores de data, sliders e diálogos modais.
...
Por que jQuery foi uma biblioteca popular no início dos anos 2010?
...
Revise a seção inicial onde as bibliotecas JavaScript foram discutidas pela primeira vez.
