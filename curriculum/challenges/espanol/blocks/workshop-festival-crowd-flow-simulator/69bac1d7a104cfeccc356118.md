...
Para completar tu función `simulateFestival`, muestra un resumen de los resultados de la simulación. Llama a `printSummary()` con tu objeto local `throughputSummary`.

# --hints--

Debes llamar a `printSummary()` con `throughputSummary`.
