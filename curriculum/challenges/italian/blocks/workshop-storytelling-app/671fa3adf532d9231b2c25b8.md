...
Sotto l'elemento `.btn-container` dovresti avere un elemento `p` con il `id` di `result`. Qui verrà mostrata la storia.

# --hints--

Dovresti avere un elemento `p` con il `id` di `result`.
