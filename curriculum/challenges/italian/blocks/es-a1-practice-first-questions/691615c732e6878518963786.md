...
Ángela e Sebastián parlano delle loro professioni.
...
Questa è la coniugazione alla seconda persona (`tu`) del verbo `dedicarse`.
...
Questa parola significa "rappresentante".
...
Questo sostantivo significa "analista".

# --explanation--

Questo dialogo include le parole `dedicas`, `representante` e `analista`.
