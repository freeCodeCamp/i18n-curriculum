...
title: 'Aufgabe 94: Fast gleichseitige Dreiecke'
challengeType: 1
forumTopicId: 302211
...
Es ist leicht zu beweisen, dass es kein gleichseitiges Dreieck mit ganzzahligen Seitenlängen und ganzzahliger Fläche gibt. Das fast gleichseitige Dreieck 5-5-6 hat jedoch eine Fläche von 12 Flächeneinheiten.

Wir definieren ein <dfn>fast gleichseitiges Dreieck</dfn> als ein Dreieck, bei dem zwei Seiten gleich lang sind und die dritte Seite sich um höchstens eine Einheit unterscheidet.

Finden Sie die Summe der Umfänge aller fast gleichseitigen Dreiecke mit ganzzahligen Seitenlängen und Fläche, deren Umfänge `limit` nicht überschreiten.
