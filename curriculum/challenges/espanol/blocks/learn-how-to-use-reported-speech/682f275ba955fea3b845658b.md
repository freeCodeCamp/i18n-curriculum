...
In **reported speech**, `to explain` is used when someone gives a reason or makes something clear. Por ejemplo:
...
A `system component` is a part or piece of a larger system, usually in computers or networks. Por ejemplo:
