...
Щоб перша секція виглядала більш вбудованою, націльте тільки елементи `input` в межах елементів `.info`, встановіть `width` на `50%` та вирівняйте текст за лівим краєм.
