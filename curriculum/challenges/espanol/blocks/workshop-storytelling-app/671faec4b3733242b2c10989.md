...
Ahora, sabes que el botón funciona. Elimina la instrucción `console.log` de la función `displayStory`.

# --hints--

Debes eliminar la instrucción `console.log` de la función `displayStory`.
