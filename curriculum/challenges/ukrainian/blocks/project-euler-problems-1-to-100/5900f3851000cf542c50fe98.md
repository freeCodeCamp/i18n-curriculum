...
title: 'Завдання 25: число Фібоначчі з 1000 цифр'
challengeType: 1
forumTopicId: 301897
...
<div style='padding-left: 4em;'>F<sub>n</sub> = F<sub>n−1</sub> + F<sub>n−2</sub>, де F<sub>1</sub> = 1 та F<sub>2</sub> = 1.</div>

Отже, перші 12 членів будуть:
...
12-й член, F<sub>12</sub>, — це перший член, який містить три цифри.

Який індекс першого члена послідовності Фібоначчі, що містить `n` цифр?
