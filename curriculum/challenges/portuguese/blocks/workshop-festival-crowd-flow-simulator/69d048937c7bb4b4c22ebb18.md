...
Dentro do seu loop `while`, você deve decrementar `currentTickQueue` usando o operador de decremento `--` e incrementar `processed` usando o operador de incremento `++`.
