...
Журнали часто використовують вирівняний текст у своєму надрукованому вмісті, щоб структурувати макет і контролювати потік вмісту. Хоча це працює у друкованій формі, вирівняний текст на вебсайтах може створювати проблеми з доступністю, наприклад, викликати труднощі у людей з дислексією.

Щоб ваш проєкт виглядав як надрукований журнал, надайте селектору `.text` властивість `text-align` зі значенням `justify`.

# --hints--

Ваш селектор `.text` має мати властивість `text-align` зі значенням `justify`.
