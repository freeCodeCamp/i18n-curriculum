...
`#scary-btn`, `#funny-btn`, 그리고 `#adventure-btn` 버튼을 선택하고 `scaryStoryBtn`, `funnyStoryBtn`, `adventureStoryBtn`라는 변수에 저장하세요.

# --hints--

`#scary-btn` 버튼을 `getElementById` 메서드를 사용해 선택하고 `scaryStoryBtn` 변수에 저장하세요.
...
`#funny-btn` 버튼을 `getElementById` 메서드를 사용해 선택하고 `funnyStoryBtn` 변수에 저장하세요.
...
`#adventure-btn` 버튼을 `getElementById` 메서드를 사용해 선택하고 `adventureStoryBtn` 변수에 저장하세요.
