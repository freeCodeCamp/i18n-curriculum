...
Зараз у розділі `footer` є заголовок `h3`. Але він має бути заголовком `h2`, щоб зберегти правильну ієрархію заголовків.

Змініть `h3` на `h2`.

# --hints--

Ваш елемент `footer` має містити елемент `h2` замість елемента `h3`.
