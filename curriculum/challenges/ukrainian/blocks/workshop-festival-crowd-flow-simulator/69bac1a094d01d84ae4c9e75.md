...
Щоб відстежувати, яка поділка зараз обробляється під час симуляції, створіть змінну з іменем `tickIndex` і призначте їй ініціальне значення `0`.  

Ця змінна буде використовуватися для циклу через усі поділки у вашій симуляції та забезпечить обробку кожних воріт у правильному порядку.

# --hints--

Ви повинні створити змінну з іменем `tickIndex` і призначити їй значення `0`.
