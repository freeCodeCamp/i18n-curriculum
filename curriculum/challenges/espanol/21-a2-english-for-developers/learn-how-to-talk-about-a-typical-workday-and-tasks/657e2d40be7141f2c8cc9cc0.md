...
Revise la tabla de adverbios a continuación.

| Adverbio    | Significado                 |
| ----------- | --------------------------- |
| `Always`    | Algo sucede todo el tiempo. |
| `Usually`   | Algo sucede ocasionalmente. |
| `Sometimes` | Algo sucede ocasionalmente. |
| `Often`     | Algo sucede frecuentemente. |
| `Rarely`    | Algo sucede rara vez.       |
| `Never`     | Algo no ocurre para nada.   |
...
Un adverbio que significa que algo sucede frecuentemente.
