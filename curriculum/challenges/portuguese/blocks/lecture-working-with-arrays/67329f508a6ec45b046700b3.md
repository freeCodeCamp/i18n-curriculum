...
Arrays em JavaScript têm uma propriedade especial `length` que retorna o número de elementos no array. Você pode acessar essa propriedade usando a propriedade `length`. Por exemplo:
