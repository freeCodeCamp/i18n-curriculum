...
Як останній крок, змініть рядки, що містяться в `details_list`, щоб текст, розміщений після знака рівності, був вирівняний за правим краєм для кожного рядка. Ваш кінцевий вивід має виглядати так:
