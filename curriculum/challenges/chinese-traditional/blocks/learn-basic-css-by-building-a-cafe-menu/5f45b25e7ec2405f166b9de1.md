...
當連結實際被造訪時，你會使用看起來像 `a:visited { propertyName: propertyValue; }` 的 <dfn>偽選擇器</dfn> 來變更該連結的屬性。

當使用者已造訪該聯結時，將頁腳 `Visit our website` 聯結的顏色更改為 `grey`。

# --hints--

你應該使用 `a:visited` 偽選擇器。
