...
A `NodeList` is an array-like object, which means you can iterate through it and it shares some common methods with an array. Para a função `getCaloriesFromInputs`, tanto um array quanto uma `NodeList` funcionarão como argumento.
