...
Turudi kwenye ukurasa wa kuweka mtindo. Chagua vipengele vya orodha ndani ya upau wa kusogeza, na uvipe mitindo ifuatayo:
...
Unapaswa kutumia kichaguzi cha `nav li` au `nav > ul > li`.
...
Unapaswa kuvipa vipengele vya `li` `color` ya `#dfdfe2`.
...
Unapaswa kuvipa vipengele vya `li` `margin` ya `0 0.2rem`.
...
Unapaswa kuvipa vipengele vya `li` `padding` ya `0.2rem`.
...
Unapaswa kuvipa vipengele vya `li` `display` ya `block`.
