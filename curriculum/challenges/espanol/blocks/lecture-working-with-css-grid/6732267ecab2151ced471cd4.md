...
En las lecciones anteriores, hablamos un poco sobre cómo crear espacio entre los elementos de la cuadrícula. Pero en esta lección, profundizaremos más en detalle sobre cómo usar las propiedades `row-gap`, `column-gap` y `gap` en un diseño de cuadrícula.
...
Si deseas usar un atajo para crear espacios entre filas y columnas, puedes usar la propiedad `gap`. Esta es la sintáxis básica:
...
¿Qué pasa si usas el valor `normal` para la propiedad `column-gap` en un diseño de cuadrícula?
...
Revisa el final de la lección donde se discute la propiedad correcta.
