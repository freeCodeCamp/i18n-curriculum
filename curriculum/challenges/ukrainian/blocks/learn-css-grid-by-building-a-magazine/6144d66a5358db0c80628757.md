...
Створіть селектор `html` і надайте йому множину властивостей `font-size`, встановлену в `62.5%`. Це встановить шрифт за замовчуванням для вашої вебсторінки на 10px (браузер за замовчуванням використовує 16px).

Це полегшить вам роботу з одиницями `rem` пізніше, оскільки `2rem` буде дорівнювати 20px.

# --hints--

Ви маєте створити селектор `html`.

```js
assert(new __helpers.CSSHelp(document).getStyle('html'));
```

Ваш селектор `html` повинен мати множину властивостей `font-size`, встановлену в `62.5%`.
