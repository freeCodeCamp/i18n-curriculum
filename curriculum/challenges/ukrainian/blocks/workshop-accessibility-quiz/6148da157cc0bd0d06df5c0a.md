...
Щоб вирівняти блоки введення один з одним, створіть новий набір правил, який націлюється на всі елементи `input` і `label` всередині елемента `.info`, і встановіть властивість `display` у значення `inline-block`.
...
Ви повинні задати елементам `input` і `label` властивість `display` зі значенням `inline-block`.
