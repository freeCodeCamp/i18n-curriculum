...
Katika zoezi hili, utafanya mazoezi ya kutambua idara kulingana na majukumu yao.
...
Idara hii inasaidia wafanyakazi.

# --explanation--

`Recursos humanos` inamaanisha "Rasilimali Watu".

Sebastián anasema `el departamento de recursos humanos apoya a los empleados`, ambayo inamaanisha "Idara ya Rasilimali Watu inasaidia wafanyakazi".
