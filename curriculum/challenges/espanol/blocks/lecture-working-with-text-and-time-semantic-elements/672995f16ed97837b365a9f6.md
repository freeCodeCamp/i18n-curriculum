...
Aquí tienes un ejemplo que usa el elemento `time` para representar las veinte horas, o las ocho de la noche.
...
El valor para el atributo `datetime` debe ser un año válido, mes válido, hora válida, fecha local, fecha global o cadena de duración válida.
