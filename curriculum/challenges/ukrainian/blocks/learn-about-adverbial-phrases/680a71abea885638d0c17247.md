...
Яка основна причина почати з невеликої групи користувачів?

## --answers--

Щоб заощадити гроші на витратах сервера.

### --feedback--

Витрати не згадуються як причина в плані.

---

Щоб протестувати функцію з користувачами, які говорять різними мовами.

### --feedback--

Мова користувачів не є частиною цього тестового плану.

---

Щоб протестувати функцію перед повним запуском.

---

Щоб навчити користувачів, як користуватися інструментом чату.

### --feedback--

Навчання користувачів не є частиною початкових кроків впровадження.
...
Перевірте пункт 4 у плані Джеймса, той, що каже `Start Small`. Саме там Джеймс пропонує невелику групу користувачів для ініціальних тестів. Саме там ви можете знайти відповідь на це запитання.
