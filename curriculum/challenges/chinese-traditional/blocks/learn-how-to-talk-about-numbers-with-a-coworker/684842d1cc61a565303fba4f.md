...
`Make sure to` is used to express responsibility or promise which means the speaker will definitely do something. 例如：

`Make sure to save your work before closing.` — Don't forget to save before you shut the program.

`As needed` means doing something only when it becomes necessary. 例如：
