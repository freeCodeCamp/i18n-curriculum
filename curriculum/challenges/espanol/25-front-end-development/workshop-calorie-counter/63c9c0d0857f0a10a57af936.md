...
Siguiendo el mismo patrón, consulta tus entradas de `number` en los elementos `#dinner`, `#snacks` y `#exercise`. Asígnalos a variables siguiendo el esquema de nombres de los dos anteriores.
