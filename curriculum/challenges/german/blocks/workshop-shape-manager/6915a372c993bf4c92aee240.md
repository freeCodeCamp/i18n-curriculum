...
Erstellen Sie jetzt eine `initializeApp`-Funktion und lassen Sie sie vorerst leer.

Diese Funktion wird die gesamte App initialisieren, sobald das DOM geladen ist. Sie ist also die Funktion, die Sie bald in ein `DOMContentLoaded`-Ereignis übergeben, damit die App funktioniert.

# --hints--

Sie sollten eine `initializeApp`-Funktion erstellen.
