...
خطوتك النهائية هي جعل زر المسح يعمل. أضف مستمع حدث `click` إلى `clearCartBtn`. يمكنك تمرير `cart.clearCart` مباشرة كاستدعاء راجع.
...
وبذلك، تكتمل ورشة عمل عربة التسوق!
