...
Em D3, existem escalas para ajudar a plotar dados. `scales` são funções que dizem ao programa como mapear um conjunto de pontos de dados brutos para os pixels do SVG.
