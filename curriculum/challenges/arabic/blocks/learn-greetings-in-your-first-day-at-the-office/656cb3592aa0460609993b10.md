...
تُستخدم كلمة `Someone` للإشارة إلى فرد أو شخص غير محدد دون ذكر من هو بالضبط.

# --questions--

## --text--

من تعني صوفي بـ `someone`؟
...
هي تتحدث عن توم لكنها لا تذكر اسمه مباشرة.
