...
Anza chini ya jozi iliyopo ya kahawa/bei, ongeza kahawa na bei zifuatazo kwa kutumia vipengele vya `article` vyenye vipengele viwili vilivyopangwa ndani vya `p` ndani ya kila kimoja.
...
Kama ilivyokuwa awali, maandishi ya kipengele cha kwanza cha `p` yanapaswa kuwa ladha ya kahawa na maandishi ya kipengele cha pili cha `p` yanapaswa kuwa bei.
...
Kila kipengele cha `article` kinapaswa kuwa na vipengele viwili vya `p`.
