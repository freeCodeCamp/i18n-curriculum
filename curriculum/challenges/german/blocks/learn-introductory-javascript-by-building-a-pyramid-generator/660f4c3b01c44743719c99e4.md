...
Da Sie nur eins von `i` subtrahieren, können Sie den <dfn>Dekrementoperator</dfn> `--` verwenden.

Ersetzen Sie Ihre Subtraktionszuweisung durch den Dekrementoperator.

# --hints--

Ihre `for`-Schleife sollte keine Subtraktionszuweisung verwenden.
...
Ihre `for`-Schleife sollte den Dekrementoperator verwenden.
