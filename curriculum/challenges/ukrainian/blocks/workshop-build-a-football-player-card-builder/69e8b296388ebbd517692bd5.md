...
Ваш п’ятий `div` елемент `className` `form-group` має містити `label` з `htmlFor` атрибутом `def`, `className` `label` і текст `DEF`.
...
Ваш п’ятий `div` елемент `className` `form-group` має містити `input` з `className` `input`, `id` `def` і `type` `number`.
...
Ваш шостий `div` елемент `className` `form-group` має містити `label` з `htmlFor` атрибутом `phy`, `className` `label` і текст `PHY`.
...
Ваш четвертий `div` елемент `className` `form-group` має містити `input` з `className` `input`, `id` `phy` і `type` `number`.
