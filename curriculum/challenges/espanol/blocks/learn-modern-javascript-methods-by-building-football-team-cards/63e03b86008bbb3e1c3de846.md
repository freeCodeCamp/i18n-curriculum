...
A continuación, agrega el `year` y los `players` a tu asignación de desestructuración. 

# --hints--

Debes agregar los valores de `year` y `players` a tu asignación de desestructuración.
