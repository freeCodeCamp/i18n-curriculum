...
Dopo il DRI `form-group`, aggiungi altri due elementi `div` ciascuno con il `className` di `form-group` dentro `stats-grid`, uno per DEF e l'altro per PHY.

Per quello di DEF, aggiungi un `label` con un `htmlFor` di `def` e il testo `DEF`, poi un input con un `id` di `def` e un `type` di `number`.

E per quello di PHY, aggiungi un'etichetta con un `htmlFor` di `phy` e il testo `PHY`, poi un input con un `id` di `phy` e un `type` di `number`.

# --hints--

Dovresti aggiungere un altro insieme di due elementi `div` ciascuno con il `className` di `form-group` dentro il `div` di `className` di `stats-grid`.
...
Il tuo quinto elemento `div` di `className` di `form-group` dovrebbe avere un `label` con un attributo `htmlFor` di `def`, un `className` di `label` e un testo `DEF`.
...
Il tuo quinto elemento `div` di `className` di `form-group` dovrebbe avere un `input` con un `className` di `input`, un `id` di `def` e un `type` di `number`.
...
Il tuo sesto elemento `div` di `className` di `form-group` dovrebbe avere un `label` con un attributo `htmlFor` di `phy`, un `className` di `label` e un testo `PHY`.
...
Il tuo quarto elemento `div` di `className` di `form-group` dovrebbe avere un `input` con un `className` di `input`, un `id` di `phy` e un `type` di `number`.
