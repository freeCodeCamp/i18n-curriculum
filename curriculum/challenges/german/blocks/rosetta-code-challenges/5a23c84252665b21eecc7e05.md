...
Ein **CUSIP** ist ein neunstelliger alphanumerischer Code, der ein nordamerikanisches Finanzinstrument zur Erleichterung der Abwicklung und Abrechnung von Handelsgeschäften identifiziert. Der CUSIP wurde als amerikanischer Nationalstandard unter Accredited Standards X9.6 übernommen.

# --instructions--

Schreiben Sie eine Funktion, die einen String als Parameter erhält und überprüft, ob der String ein gültiger CUSIP ist.
