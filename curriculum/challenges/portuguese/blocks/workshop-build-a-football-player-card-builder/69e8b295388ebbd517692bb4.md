...
Dentro da div `card`, adicione um `div` com o `className` de `card-header`. Esta seção vai conter a avaliação do jogador, posição, distintivo de categoria e nome do clube.

# --hints--

Você deve adicionar um `div` com o `className` de `card-header` dentro do `div` com `className` de `.card`.
