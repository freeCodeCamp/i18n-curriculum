...
Debe utilizar notación de punto para acceder a la propiedad `id` de `dessert`.
...
Debe usar notación de corchetes para acceder a la propiedad de `totalCountPerProduct` que corresponde a `dessert.id`.
