...
Dentro de tu `thead`, crea un elemento `tr`. Dentro de eso, agrega un elemento `td` y tres elementos `th`. Dentro de cada uno de los elementos `th`, agrega un elemento `span` con el `class` establecido en `sr-only` y el siguiente texto, en ese orden: `2019`, `2020` y `2021`.
