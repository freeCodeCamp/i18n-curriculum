...
- **Figma**: Esta ferramenta baseada na nuvem é especializada em design de interface do usuário e experiência do usuário (UI / UX). Ela permite que equipes de design e desenvolvimento colaborem de qualquer lugar, oferecendo recursos embutidos como design vetorial, layout automático, sistema de comentários e feedback, entre outros.
- **Sketch**: Esta é uma ferramenta de design popular usada por sua interface intuitiva e simplicidade, tornando-a ideal para desenvolvedores que querem criar protótipos rapidamente. Também é amplamente usada por designers para tarefas como criação de interfaces, ícones e layouts web.
- **Adobe XD**: Esta é uma ferramenta de design vetorial e prototipagem para UI/UX, conhecida por sua integração perfeita com outros apps da Adobe como Photoshop, Illustrator e After Effects.
- **Canva**: Esta ferramenta permite criar uma ampla variedade de conteúdos visuais, incluindo cartazes, fotos de capa, apresentações, vídeos curtos e mais. Seu design simples e fácil de usar a torna ideal para iniciantes.
...
- **Fontes web safe**: 
  - Fontes sans-serif são comumente usadas para desenvolvimento web porque não têm pequenas "perninhas" ou linhas no final dos caracteres, facilitando a leitura na tela. Alguns exemplos de fontes sans-serif web safe são: Arial, Verdana e Trebuchet MS.
  - Em contraste, fontes serif têm pequenas "perninhas" no final dos caracteres, sendo comumente usadas para impressão tradicional. Fontes serif web safe incluem: Times New Roman e Georgia.
