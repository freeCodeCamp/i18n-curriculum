...
Use o seletor existente para ter em foco todos os elementos `p` dentro de elementos com a classe definida como `item`, defina a margem superior e inferior para que seja `5px`.
