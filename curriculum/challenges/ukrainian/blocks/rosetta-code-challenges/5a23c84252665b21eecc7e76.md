...
Реалізуйте один або кілька алгоритмів для обчислення гамма-функції (тільки в дійсній області).
