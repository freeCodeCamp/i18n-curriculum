...
歡迎！現在你將學習從 30 到 39 的數字。

在西班牙語中，數字 30 稱為 `treinta`。

31 到 39 的數字是由十位數字 `treinta`（30）組成，接著是連接詞 `y`（"and"），然後是個位數字（1-9）。
...
數字 `treinta y uno` (31) 在這個範圍中是獨特的，因為它在陽性名詞前會變成 `treinta y un`。例如：
