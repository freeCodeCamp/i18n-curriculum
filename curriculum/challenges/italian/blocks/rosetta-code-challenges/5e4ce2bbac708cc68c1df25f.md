...
Data una stringa, calcola la frequenza di ogni carattere.

Tutti i caratteri devono essere conteggiati. Questo include lettere minuscole e maiuscole, cifre, spazi bianchi, caratteri speciali o qualsiasi altro carattere distinto.

# --instructions--

Scrivi una funzione per contare le occorrenze di ogni carattere in una stringa data.

La funzione deve restituire un array 2D con ciascuno degli elementi nella forma seguente: `['char', freq]`. Il carattere deve essere una stringa di lunghezza 1, e la frequenza è un numero che indica il conteggio.
