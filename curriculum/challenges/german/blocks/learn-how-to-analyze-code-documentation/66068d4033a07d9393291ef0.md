...
`Usage examples` zeigen, wie etwas verwendet wird.
...
Es bedeutet, etwas genau anzuschauen. Brian schlägt vor, die Beschreibung der Funktion genau zu betrachten.
...
Es bedeutet, etwas klarzumachen.
...
Es bedeutet, etwas zu geben oder bereitzustellen. Die Dokumentation gibt Beispiele, wie man die Funktion verwendet.
...
Diese Beispiele zeigen, wie man etwas verwendet, wie in diesem Fall die Funktion.
