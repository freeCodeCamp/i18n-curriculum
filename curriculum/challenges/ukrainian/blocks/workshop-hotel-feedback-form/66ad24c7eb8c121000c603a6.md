...
Щоб прапорець був встановлений за замовчуванням, ви можете додати атрибут `checked`.
...
Додайте атрибут `checked` до прапорця з ідентифікатором `id` зі значенням `"reputation"`, щоб він був встановлений за замовчуванням.

# --hints--

Ваш прапорець з ідентифікатором `id` `"reputation"` повинен мати атрибут `checked`.
