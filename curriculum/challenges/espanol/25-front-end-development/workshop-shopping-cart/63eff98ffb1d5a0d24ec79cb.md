...
Aún no has escrito el código para generar el HTML, pero si un producto ya ha sido añadido al carrito del usuario, entonces habrá un elemento coincidente que necesitarás.

Usa `.getElementById()` para obtener el elemento coincidente - estarás estableciendo el valor de `id` a `product-count-for-id${product.id}`, así que usa un literal de plantilla para consultar ese valor.
