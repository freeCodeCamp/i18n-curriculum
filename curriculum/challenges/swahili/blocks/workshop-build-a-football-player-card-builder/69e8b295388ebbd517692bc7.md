...
Badilisha jina la mchezaji lililowekwa moja kwa moja `PELE` ndani ya `card-name` na `player.name`.

# --hints--

Unapaswa kubadilisha `PELE` lililowekwa moja kwa moja na `player.name` ndani ya `.card-name`.
