...
title: 'Завдання 157: розв’язання діофантового рівняння'
challengeType: 1
forumTopicId: 301788
...
Розглянемо діофантове рівняння $\frac{1}{a} + \frac{1}{b} = \frac{p}{{10}^n}$, де $a$, $b$, $p$, $n$ — натуральні числа, і $a ≤ b$.

Для $n = 1$ це рівняння має 20 розв’язків, наведених нижче:
...
Скільки розв’язків має це рівняння для $1 ≤ n ≤ 9$?
