...
Es gibt weitere Eigenschaften, die dem `Card`-Interface hinzugefügt werden sollen. Beginnen Sie damit, `value_int` auf den Typ `number` zu setzen. Alle anderen Eigenschaften sollten vom Typ `string` sein: `suit`, `type`, `img`, `meaning_up`, `meaning_rev` und `desc`.

# --hints--

Sie sollten eine Eigenschaft `value_int` mit dem Typ `number` haben.
...
Sie sollten eine Eigenschaft `suit` mit dem Typ `string` haben.
...
Sie sollten eine Eigenschaft `type` mit dem Typ `string` haben.
...
Sie sollten eine Eigenschaft `img` mit dem Typ `string` haben.
...
Sie sollten eine Eigenschaft `meaning_up` mit dem Typ `string` haben.
...
Sie sollten eine Eigenschaft `meaning_rev` mit dem Typ `string` haben.
...
Sie sollten eine Eigenschaft `desc` mit dem Typ `string` haben.
