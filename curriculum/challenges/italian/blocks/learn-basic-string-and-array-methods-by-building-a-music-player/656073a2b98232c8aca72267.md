...
Per gestire le informazioni della canzone attuale e tracciare il suo tempo di riproduzione, crea una proprietà `currentSong` e una `songCurrentTime`. Imposta i valori rispettivamente su `null` e `0`.

# --hints--

Non dovresti modificare l'oggetto `userData` esistente e il suo contenuto.
