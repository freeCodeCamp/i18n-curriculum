...
`GameCharacter`クラスに`__init__`メソッドを作成してください。
...
`GameCharacter`クラスに`name`メソッドを作成してください。
...
`GameCharacter`クラスに`health`メソッドを作成してください。
...
`GameCharacter`クラスに`mana`メソッドを作成してください。
...
`GameCharacter`クラスに`level`メソッドを作成してください。
...
`GameCharacter`クラスに`level_up`メソッドを作成してください。
...
`GameCharacter`クラスに`__str__`メソッドを作成してください。
