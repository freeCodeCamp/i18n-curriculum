...
Unataka kontena la `.foreground-buildings` liwe moja kwa moja juu ya kipengele cha `.background-buildings`. Mpe `width` na `height` ya `100%`, weka `position` kuwa `absolute`, na `top` kuwa `0`. Hii italifanya iwe na ukubwa sawa na mwili na kuhamisha mwanzo wake hadi kona ya juu kushoto.
