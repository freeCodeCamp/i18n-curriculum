...
Sophie capisce cosa sta dicendo James. Cosa direbbe?
...
Capisce, quindi non esprimerebbe confusione.
...
`That makes sense` si usa quando capisci qualcosa e la trovi logica. Per esempio:

- Persona 1: `If we want to speed up development, we need more people on the team.`

- Persona 2: `That makes sense. More people will help us finish the project faster.` - Questa persona è d'accordo perché aggiungere più membri al team può aumentare la produttività.
