...
Надайте селектору `.note` лівий та правий відступ зі значенням `8px`, видаливши верхній та нижній відступи. Також встановіть властивість `text-indent` на `-8px`.

З останніми змінами ваша етикетка готова!

# --hints--

Селектор `.note` повинен мати властивість `padding` зі значенням `0 8px`.
...
Селектор `.note` повинен мати властивість `text-indent` зі значенням `-8px`.
