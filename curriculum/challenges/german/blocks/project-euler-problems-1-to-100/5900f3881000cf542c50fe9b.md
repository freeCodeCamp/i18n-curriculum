...
title: 'Aufgabe 28: Diagonalen in einer Zahlenspirale'
challengeType: 1
forumTopicId: 301930
...
Ausgehend von der Zahl 1 und mit einer Bewegung nach rechts im Uhrzeigersinn wird eine 5 mal 5 große Spirale wie folgt gebildet:
...
Es lässt sich überprüfen, dass die Summe der Zahlen auf den Diagonalen 101 beträgt.

Wie groß ist die Summe der Zahlen auf den Diagonalen in einer `n` mal `n` großen Spirale, die auf dieselbe Weise gebildet wird?
