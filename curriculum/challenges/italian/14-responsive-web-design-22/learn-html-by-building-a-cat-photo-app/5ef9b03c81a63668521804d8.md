...
L'elemento `input` ti permette di raccogliere dati da un modulo web in vari modi. Like `img` elements, `input` elements are a <dfn>void element</dfn> and do not need closing tags.
