...
`Outside` indica l’area o lo spazio che non si trova all’interno di un edificio o di una stanza specifica.

Nel contesto del dialogo, Sophie dice di aver visto Tom scattare foto nell’area che non è dentro l’edificio.
...
Questa parola indica l’area che non si trova dentro un edificio; all’aria aperta.
