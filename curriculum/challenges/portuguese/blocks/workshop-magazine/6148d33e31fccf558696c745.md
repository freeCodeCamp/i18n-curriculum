...
Para fazer com que o texto da citação se destaque mais, dê ao seletor `.quote` uma propriedade `font-family` definida como `Raleway` com `sans-serif` como alternativa.

# --hints--

O seletor `.quote` deve ter a propriedade `font-family` definida como `Raleway` com `sans-serif` de alternativa.
