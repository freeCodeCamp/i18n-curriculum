...
Next, you need to calculate the remainder of `input` divided by `2`. You can do this by using the <dfn>remainder operator</dfn> (`%`), which returns the remainder of the division of two numbers. 例えば、次のように記述します。
