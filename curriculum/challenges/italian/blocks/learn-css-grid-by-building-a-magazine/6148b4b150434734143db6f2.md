...
Crea una regola `.hero` e imposta la proprietà `grid-column` su `1 / -1`. In questo modo, l'elemento coprirà l'intera larghezza della griglia.
...
Il selettore `.hero` dovrebbe avere una proprietà `grid-column` impostata su `1 / -1`.
