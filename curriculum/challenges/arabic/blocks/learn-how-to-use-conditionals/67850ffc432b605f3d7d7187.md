...
ما أفضل إجابة قصيرة على سؤال ليزا؟
...
تضيف هذه الإجابة تعقيدًا لكنها لا ترد مباشرة على سؤال الوسم الذي يطلب التأكيد.
...
تُستخدم أسئلة الوسم مثل `wouldn't it?` للتأكيد أو لدعوة الموافقة. الرد الإيجابي مثل `Yes, it would` يوافق على التأثير الافتراضي الذي وصفته ليزا.
