...
- macOS y iOS tienen Zoom. Puedes habilitarlo en macOS yendo a Configuración, filtrando por Accesibilidad y luego haciendo clic en "Zoom". Activa la opción "Usar atajos de teclado para hacer zoom" para habilitarlo.
  - Puedes habilitarlo en iPhone a través de _Configuración > Accesibilidad > Zoom_.
- Los dispositivos Android tienen Magnificación. Para activarla, ve a _Configuración > Función especial > Accesibilidad > Magnificación_. Como esto puede variar según el dispositivo, puedes buscar "Magnificación" en la página principal de configuración para acceder a ella.
- Windows tiene Lupa. Puedes usarla yendo a _Configuración > Facilidad de acceso > Lupa_.
- Los magnificadores para sistemas operativos Linux varían. Son Zoom o Lupa.

Además de los que vienen integrados en los sistemas operativos, algunos magnificadores de pantalla de terceros útiles son:

- ZoomText para Windows.
- ClaroView para macOS y Windows.
- iZoom para Windows.
- Zoomify - magnificador de pantalla para macOS.
- LunarPlus para Windows.
- Loupe para macOS.
