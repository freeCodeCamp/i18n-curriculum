...
Dado que `associatedPanel` es un `id`, eso te permitirá consultar el documento y encontrar el elemento de panel correspondiente. 

Crea una nueva variable llamada `panel` y asígnale el valor de `document.getElementById(associatedPanel)`. 

# --hints--

Deberías tener una variable llamada `panel` que contiene el elemento del panel asociado con la pestaña clickeada.
