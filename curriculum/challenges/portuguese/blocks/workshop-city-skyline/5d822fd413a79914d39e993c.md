...
Você deve alterar os valores da primeira cor de `#ffcf33` para `#ccc`.
...
Você deve alterar os valores da segunda cor de `#ffff66` para `#445`.
...
Você deve alterar os valores da terceira cor de `#bbeeff` para `#223`.
