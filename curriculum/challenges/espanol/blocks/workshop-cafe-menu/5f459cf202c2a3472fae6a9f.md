...
Cambia la propiedad `height` del `hr` a `2px`, para que la altura total sea `4px`.

# --hints--

La propiedad `height` debe tener el valor `2px`.
...
Tu elemento `hr` debe tener una altura (`height`) dé `2px`.
