...
Цитата насправді не є цитатою без відповідних лапок. Ви можете додати їх за допомогою CSS-псевдоселекторів.

Створіть селектор `.quote::before` та встановіть властивість `content` на `"`, додавши пробіл після.

Також створіть селектор `.quote::after` та встановіть властивість `content` на `"`, додавши пробіл після.

# --hints--

Ви повинні мати селектор `.quote::before`.
