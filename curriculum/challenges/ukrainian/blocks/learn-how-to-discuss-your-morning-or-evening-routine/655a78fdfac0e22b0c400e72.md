...
Це минулий час від `say`, який тут використовується, щоб показати, що Софі вже раніше це згадувала.
...
Це слово описує щось, що не є простим. Воно закінчується на `-ed`.
...
Це означає безперервну або повторювану дію дітей, які активно рухаються. Закінчується на `-ing`.
