...
الشيء التالي الذي ستعرضه هو التفاصيل البيوغرافية عن المؤلف. يمكنك فعل ذلك باستخدام `bio` التي فككتها سابقًا.

أضف عنصر فقرة مع `class` `"bio"`، ثم أدرج `bio` داخل عنصر الفقرة.
