...
Kwa sasa, ficha kipengele chako cha `#monsterStats` kwa kutumia sifa ya `display`. Usibadilishe mtindo mwingine wowote.

# --hints--

Unapaswa kuwa na kichaguzi cha `#monsterStats`.
...
Kichaguzi chako cha `#monsterStats` kinapaswa kuwa na sifa ya `display` yenye thamani ya `none`.
...
Kichaguzi chako cha `#monsterStats` kinapaswa kuwa na `border` yenye thamani ya `1px solid #0a0a23`.
...
Kichaguzi chako cha `#monsterStats` kinapaswa kuwa na `5px` ya nafasi ya ndani.
...
Kichaguzi chako cha `#monsterStats` kinapaswa kuwa na sifa ya `color` yenye thamani ya `#ffffff`.
...
Kichaguzi chako cha `#monsterStats` kinapaswa kuwa na sifa ya `background-color` yenye thamani ya `#c70d0d`.
