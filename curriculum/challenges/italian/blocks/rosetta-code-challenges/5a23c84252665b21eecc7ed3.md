...
title: Problema dello zaino continuo
challengeType: 1
forumTopicId: 323654
...
Un ladro svaligia una macelleria, dove può scegliere tra alcuni elementi.

Il ladro conosce i pesi e i prezzi di ogni elemento. Poiché ha uno zaino con un limite massimo di peso che può trasportare, vuole selezionare gli elementi in modo da massimizzare il suo profitto. Può tagliare gli elementi; l'elemento ha un prezzo ridotto dopo il taglio proporzionale al prezzo originale in base al rapporto delle masse. Questo significa: metà di un elemento ha metà del prezzo originale.

# --instructions--

Scrivi una funzione che prende un array di oggetti che rappresentano gli elementi disponibili nel negozio. Ogni oggetto ha 3 attributi: name, weight e value. La funzione prende anche il peso massimo come parametro. La funzione dovrebbe restituire il valore massimo possibile, e il peso totale degli elementi selezionati non deve superare il peso massimo.
