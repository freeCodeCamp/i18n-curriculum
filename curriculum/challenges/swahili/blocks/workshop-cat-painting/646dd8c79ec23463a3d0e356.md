...
Ni wakati wa kufanya kazi kwenye sikio la ndani la kulia. Kwa kutumia kichaguzi cha darasa la vitu, mpe kipengele chako cha `.cat-right-inner-ear` mpaka wa kushoto na wa kulia wa `20px solid transparent`. Pia, mpe mpaka wa chini wa `40px solid #3b3b4f`.
...
Kichaguzi chako cha `.cat-right-inner-ear` kinapaswa kuwa na sifa ya `border-left` iliyowekwa kuwa `20px solid transparent`.
