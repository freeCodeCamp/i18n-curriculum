...
Um den vertikalen Abstand zwischen dem `h1`-Element und dem Text `Est. 2020` zu verringern, ändern Sie den unteren Außenabstand des `h1` auf `15px`.

# --hints--

Sie sollten die `margin-bottom`-Eigenschaft auf `15px` setzen.
...
Ihr `h1`-Element sollte einen `margin-bottom` von `15px` haben.
