...
`I’ve played this game before.` - Dieser Satz ist ebenfalls in der Perfekt Form, mit Verwendung der Abkürzung `I've` für `I have` wird benutzt. Wie im vorigen Beispiel, wird besagt, dass die Handlung das Spiel zu spielen, zu einer unbestimmten Zeit in der Vergangenheit passierte.
