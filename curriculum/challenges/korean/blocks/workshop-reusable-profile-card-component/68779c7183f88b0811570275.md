...
`profiles` 배열에 두 개의 객체를 더 추가하세요 — 하나는 Tiffany용, 다른 하나는 Doug용입니다:
...
`map()` 로직은 변경하지 말고 이제 세 개의 카드 모두를 렌더링하세요.

이로써 재사용 가능한 프로필 카드 컴포넌트 프로젝트가 완료됩니다!

# --hints--

정확히 세 개의 `Card` 컴포넌트를 렌더링해야 합니다.
