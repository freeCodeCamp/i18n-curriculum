...
**Nota:** Como a propriedade `constructor` pode ser sobrescrita (o que será abordado nos próximos dois desafios) geralmente é melhor usar o método `instanceof` para verificar o tipo de um objeto.
...
`joinDogFraternity` deve utilizar a propriedade `constructor`.
