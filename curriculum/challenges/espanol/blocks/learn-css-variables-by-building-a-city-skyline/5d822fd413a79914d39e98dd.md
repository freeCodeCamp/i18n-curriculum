...
Los edificios están demasiado espaciados. Agréguenlos juntos añadiendo dos elementos `div` vacíos en la parte superior del elemento `.background-buildings`, dos más en la parte inferior y uno más entre `.bb3` y `.bb4`. Estos serán añadidos como elementos uniformemente espaciados en el contenedor, moviendo efectivamente los edificios más cerca al centro.
...
Debes agregar un nuevo elemento `div` entre los elementos `.bb3` y `.bb4`.
