...
Всередині об’єкта headCoach додайте властивість із ключем `coachName` та рядковим значенням `"Carlos Bilardo"`. Під цією властивістю додайте інший ключ під назвою `matches` з числовим значенням `7`.

# --hints--

Об’єкт `headCoach` повинен мати властивість `coachName`.
...
Об’єкт `headCoach` повинен мати властивість `matches`.
