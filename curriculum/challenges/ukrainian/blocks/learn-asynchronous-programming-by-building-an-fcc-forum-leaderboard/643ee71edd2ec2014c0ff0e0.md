...
У четвертому елементі `td` додайте вставлений вираз, який містить змінну `views`. Це відобразить число переглядів, які має пост.

# --hints--

Ви маєте додати вставлений вираз, який містить змінну `views`.
