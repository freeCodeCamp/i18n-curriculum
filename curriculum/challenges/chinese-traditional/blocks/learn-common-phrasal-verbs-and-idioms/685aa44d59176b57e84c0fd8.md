...
`Do we want to...` is just a polite and collaborative way to ask about making a decision or plan. You're not asking others if you want something to happen. 例如：
...
`To open something up` means to allow access or participation, especially to a larger group. 例如：
