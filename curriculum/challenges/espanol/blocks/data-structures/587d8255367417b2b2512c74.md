...
El `enqueue` debe aceptar elementos con el formato mostrado arriba (`['human', 1]`) donde `1` representa la prioridad. `dequeue` y `front` deben devolver solo el nombre del elemento, no su prioridad.
