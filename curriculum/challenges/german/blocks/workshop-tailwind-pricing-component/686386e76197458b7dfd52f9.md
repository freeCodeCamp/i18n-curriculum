...
Der restliche HTML-Code wurde für Sie bereitgestellt. Das umfasst die Karten für den Premium- und den Familienplan. Jetzt ist es an der Zeit, die HTML-Elemente mit Tailwind CSS zu gestalten.

Beginnen Sie damit, der gesamten Seite einen leicht grauen Hintergrund zu geben, indem Sie dem `body`-Element die Klasse `bg-gray-100` zuweisen.

# --hints--

Ihr Body-Element sollte die Klasse `bg-gray-100` haben.
