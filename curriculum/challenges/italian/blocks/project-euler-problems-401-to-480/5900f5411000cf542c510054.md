...
title: 'Problema 468: divisori lisci dei coefficienti binomiali'
challengeType: 1
forumTopicId: 302143
...
Un numero intero si dice B-liscio se nessuno dei suoi fattori primi è maggiore di $B$.

Sia $SB(n)$ il più grande divisore B-liscio di $n$.
...
Definisci $F(n) = \displaystyle\sum_{B = 1}^n \sum_{r = 0}^n S_B(\displaystyle\binom{n}{r})$. Qui, $\displaystyle\binom{n}{r}$ indica il coefficiente binomiale.
