...
`extract_content('<p>hello world</p>')` dovrebbe restituire `"hello world"`.
...
`extract_content('<p>hello <span>world</span></p>')` dovrebbe restituire `"hello world"`.
...
`extract_content('<a href="example.com">Click me</a>')` dovrebbe restituire `"Click me"`.
...
`extract_content('<p><button onClick="learnToCode()">Learn</button> to <code>code<code> <br/>for <strong>free</strong> <br/>on <a href="https://freecodecamp.org/" target="_blank"><span class="highlight">freecodecamp</span>.org</a>')` dovrebbe restituire `"Learn to code for free on freecodecamp.org"`.
