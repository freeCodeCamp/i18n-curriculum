...
Toa kitendakazi cha kutafuta jozi ya pointi mbili zilizo karibu zaidi kati ya seti ya pointi zilizotolewa katika vipimo viwili.
...
`getClosestPair` inapaswa kuwa kitendakazi.
...
`getClosestPair(points1).pair` inapaswa kuwa `[ { x: 7.46489, y: 4.6268 }, { x: 7.46911, y: 4.71611 } ]`.
...
`getClosestPair(points2).distance` inapaswa kuwa `65.06919393998976`.

```js
assert.equal(getClosestPair2_().distance, answer2.distance);
```

`getClosestPair(points2).pair` inapaswa kuwa `[ { x: 37134, y: 1963 }, { x: 37181, y: 2008 } ]`.
...
`getClosestPair(points3).distance` inapaswa kuwa `6754.625082119658`.

```js
assert.equal(getClosestPair3_().distance, answer3.distance);
```

`getClosestPair(points3).pair` inapaswa kuwa `[ { x: 46817, y: 64975 }, { x: 48953, y: 58567 } ]`.
