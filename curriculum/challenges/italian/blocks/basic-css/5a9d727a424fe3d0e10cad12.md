...
title: Usa una variabile CSS personalizzata
challengeType: 0
...
Dopo aver creato la tua variabile, puoi assegnarne il valore ad altre proprietà CSS facendo riferimento al nome che le hai dato.

```css
background: var(--penguin-skin);
```

Questo cambierà lo sfondo di qualunque elemento tu stia definendo come obiettivo in grigio perché questo è il valore della variabile `--penguin-skin`. Nota che gli stili non verranno applicati a meno che i nomi delle variabili non corrispondano esattamente.
