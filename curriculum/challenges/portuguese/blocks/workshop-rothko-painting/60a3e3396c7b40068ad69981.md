...
Crie uma regra de CSS que use o seletor `.two` e defina a `width` como 475 pixels.

# --hints--

Você deve ter um seletor `.two`.
...
Você deve definir a propriedade `width` como `475px`.
...
O elemento `.two` deve ter um valor de `width` de `475px`.
