...
Existe uma sequência de ações que você pode seguir para reproduzir o bug. Você pode buscá-las na seção `Steps to Reproduce`. Leia esses passos e você será capaz de responder corretamente a esta pergunta.
