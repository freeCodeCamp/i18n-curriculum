...
إليك مثال على تحويل صورة إلى رابط:
...
حوّل الصورة إلى رابط عن طريق إحاطتها بالوسوم اللازمة للعنصر. استخدم `https://freecatphotoapp.com` كقيمة خاصية `href` لوسم الرابط.

# --hints--

يجب أن يكون لديك عنصر `img` بقيمة خاصية `src` تساوي `https://cdn.freecodecamp.org/curriculum/cat-photo-app/relaxing-cat.jpg`. ربما حذفته عن طريق الخطأ.
...
يجب أن تضيف وسم إغلاق واحد فقط لوسم الرابط (`a`). يرجى حذف أي إضافات زائدة.
...
يجب أن يكون عنصر `img` مسكنًا داخل عنصر وسم الرابط (`a`). يجب أن يكون كامل عنصر `img` داخل وسوم البداية والإغلاق لوسم الرابط (`a`).
