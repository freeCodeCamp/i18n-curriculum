...
Dai al primo elemento `option` un attributo `value` con valore `""` e il testo `Select an option`. Dai al secondo elemento `option` un attributo `value` con valore `yes` e il testo `Yes`. Dai al terzo elemento `option` un attributo `value` con valore `no` e il testo `No`.
