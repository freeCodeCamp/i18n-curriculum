...
في العنصر الرابع `td`، أضف تعبيرًا مضمنًا يحتوي على المتغير `views`. سيُظهر هذا عدد المشاهدات التي حصل عليها المنشور.

# --hints--

يجب أن تضيف تعبيرًا مضمنًا يحتوي على المتغير `views`.
