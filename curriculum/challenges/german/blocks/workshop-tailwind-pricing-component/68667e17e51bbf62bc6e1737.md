...
Jetzt sollten Sie den CTA so gestalten, dass er mehr wie ein Button aussieht.

Für die Hintergrund- und Vordergrundfarben weisen Sie ihm die Klassen `bg-gradient-to-r`, `from-fuchsia-500`, `to-indigo-600`, `text-white`, `hover:from-fuchsia-600` und `hover:to-indigo-700` zu. Weisen Sie ihm außerdem die Klassen `rounded-md` und `block` zu.

# --hints--

Ihr Ankerelement sollte die Klasse `bg-gradient-to-r` haben.
...
Ihr Ankerelement sollte die Klasse `from-fuchsia-500` haben.
...
Ihr Ankerelement sollte die Klasse `to-indigo-600` haben.
...
Ihr Ankerelement sollte die Klasse `text-white` haben.
...
Ihr Ankerelement sollte die Klasse `hover:from-fuchsia-600` haben.
...
Ihr Ankerelement sollte die Klasse `hover:to-indigo-700` haben.
...
Ihr Ankerelement sollte die Klasse `rounded-md` haben.
...
Ihr Ankerelement sollte die Klasse `block` haben.
