...
Ви додали виклик `console.log()` у свій скрипт, щоб перевірити масив `EVAChunks`, і тепер цей виклик більше не потрібен. Щоб термінал залишався чистим для наступних кроків, видаліть блок `for loop`, який виводить дані з `EVAChunks`.

# --hints--

Вам слід видалити блок `for loop`, який виводить дані з `EVAChunks`. Видаліть увесь блок, що містить обидва цикли.
