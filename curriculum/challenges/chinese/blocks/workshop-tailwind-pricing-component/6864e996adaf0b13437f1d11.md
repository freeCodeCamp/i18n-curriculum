...
现在，你应该开始为 **Listener plan** 的元素添加样式。

为计划的外部 `div` 添加类 `bg-gray-100`、`ring-1` 以创建围绕该 `div` 的粗边框，以及 `ring-gray-300` 以赋值该边框的深色。

# --hints--

你的 `div` 元素应具有 `bg-gray-100` 类。
