...
حان الوقت الآن لاختبار زر الإيقاف المؤقت.

أضف مستمع حدث `"click"` إلى عنصر `pauseButton`، ثم مرر `pauseSong` كالمعلمة الثانية لمستمع الحدث. هذه هي الدالة التي سينفذها مستمع الحدث.

اختبر تطبيقك بالنقر أولاً على زر التشغيل ثم على زر الإيقاف المؤقت. يجب أن ترى أن كل شيء يعمل كما هو متوقع.

# --hints--

يجب أن تستدعي الطريقة `addEventListener()` على متغير `pauseButton` الخاص بك.
...
يجب أن تمرر `pauseSong` كالمعلمة الثانية لطريقة `addEventListener` الخاصة بك.
