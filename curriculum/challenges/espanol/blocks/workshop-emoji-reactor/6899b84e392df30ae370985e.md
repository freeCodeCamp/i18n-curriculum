...
Ahora, en el archivo JavaScript, crea una variable `happyBtn`.

Usa `querySelector` para almacenar una referencia al elemento `#happy-btn` en la variable `happyBtn`.

# --hints--

Debes tener una variable llamada `happyBtn`.

```js
assert.exists(happyBtn);
```

La variable `happyBtn` debe contener una referencia al elemento `#happy-btn`.
