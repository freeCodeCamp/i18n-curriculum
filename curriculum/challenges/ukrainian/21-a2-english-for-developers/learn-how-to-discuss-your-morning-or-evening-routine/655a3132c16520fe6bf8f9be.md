...
`Multiple times` means many times or on several occasions. It's used to indicate that an action or event happens repeatedly. Наприклад:
...
Що означає `hitting the snooze button multiple times` в контексті будильника?
