...
You now have three type selectors with the exact same styling. Ви можете додати таку ж групу стилів до багатьох елементів, створюючи список селекторів. Кожен селектор розділений комами, ось так:
