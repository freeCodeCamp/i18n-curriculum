...
Під вашим елементом `.heading` створіть новий елемент `section` з множиною `class`, встановленою на `text`. Усередині нього створіть елемент `p` з множиною `class`, встановленою на `first-paragraph`, і наступним текстом:
...
Ви маєте створити новий елемент `p` всередині вашого елемента `.text`.
