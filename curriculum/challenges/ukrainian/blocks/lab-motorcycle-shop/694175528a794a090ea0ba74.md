...
title: Лабораторна робота магазин мотоциклів
challengeType: 25
...
Для цієї лабораторної роботи вам надали весь HTML і CSS. Ви будете використовувати TypeScript, щоб завершити функціональність сторінки магазину мотоциклів.

**Мета:** Виконайте наведені нижче історії користувача та пройдіть усі тести, щоб завершити лабораторну роботу.

**Історії користувача:**

1. Ви повинні створити `type`, який називається `Category` і складається з таких можливих значень: `'Sport'`, `'Cruiser'`, `'Touring'`, `'Dirt'`, `'Adventure'`, `'Naked'`, `'Electric'`.
2. Ви повинні створити `interface`, який називається `Motorcycle` і має такі властивості: `id` типу `string`, `name` типу `string`, `manufacturer` типу `string`, `category` типу `Category`, `price` типу `number`, `image_url` типу `string`, властивість `created_at` типу `Date`, `description` типу `string` та рік типу `number`.
3. Ви повинні створити функцію з назвою `fetchMotorcycles`, яка повертає `Promise`, що розв’язується у масив об’єктів `Motorcycle`.
4. Ви повинні завантажити дані `Motorcycle` з кінцевої точки `https://cdn.freecodecamp.org/curriculum/labs/data/motorcycles.json`.
5. Ви повинні створити функцію з назвою `renderMotorcycleCard`, яка приймає один об’єкт `Motorcycle` як параметр і повертає рядок, що містить відформатований HTML для картки мотоцикла.
   1. Функція `renderMotorCycleCard` повинна приймати параметр з назвою `motorcycle` типу `Motorcycle`.
   2. Функція `renderMotorCycleCard` повинна повертати тип `string`.
   3. Кожен компонент картки мотоцикла повинен мати елемент `img` з дійсним зображенням і класом `motorcycle-card-image-container`.
   4. Кожен компонент картки мотоцикла повинен мати елемент з класом `motorcycle-card-year-badge`, який відображає рік у простому тексті.
   5. Кожен компонент картки мотоцикла повинен мати елемент з класом `motorcycle-card-title`, який відображає назву мотоцикла у простому тексті.
   6. Кожен компонент картки мотоцикла повинен мати елемент з класом `motorcycle-card-manufacturer`, який відображає назву виробника мотоцикла у простому тексті.
   7. Кожен компонент картки мотоцикла повинен мати елемент з класом `motorcycle-card-category`, який відображає категорію мотоцикла у простому тексті.
   8. Кожен компонент картки мотоцикла повинен мати елемент з класом `motorcycle-card-description`, який відображає опис мотоцикла у простому тексті.
   9. Кожен компонент картки мотоцикла повинен мати елемент з класом `motorcycle-card-price`, який відображає ціну мотоцикла у простому тексті.
   10. Кожен компонент картки мотоцикла повинен мати елемент з класом `motorcycle-card-engine`, який відображає потужність кожного двигуна.
6. Ви повинні мати клас з назвою `MotorcycleGalleryApp`.
   1. Клас повинен мати масив `private` з назвою `allMotorcycles`, який статично типізований як масив об’єктів `Motorcycle`.
   2. Цей клас повинен мати функцію з назвою `renderMotorcycles`, яка відтворює еквівалентні компоненти карток мотоциклів змінної `allMotorcycles` всередині елемента з ідентифікатором `motorcycle-grid`.
7. Кількість відображених елементів `Motorcycle` повинна бути вказана всередині елемента з ідентифікатором `results-number`.
8. Фільтр повинен оновлюватися на подію `input`.

# --hints--

Ви повинні мати `type` з назвою `Category`.
...
Ваш тип `Category` повинен бути встановлений як об’єднання правильних значень.
...
Ви повинні мати `interface` з назвою `Motorcycle`.
...
Ви повинні мати всі вказані властивості в інтерфейсі `Motorcycle`.
...
Ви повинні мати функцію з назвою `fetchMotorcycles`.

```js
assert.isFunction(fetchMotorcycles);
```

Ви повинні використовувати кінцеву точку `https://cdn.freecodecamp.org/curriculum/labs/data/motorcycles.json`.
...
Ви повинні повертати проміс з 25 об’єктів `Motorcycle` з `fetchMotorcycles`.
...
Ви повинні мати функцію з назвою `renderMotorcycleCard`.

```js
assert.isFunction(renderMotorcycleCard);
```

Функція `renderMotorcycle` повинна приймати статично типізований параметр `Motorcycle`.
...
Функція `renderMotorcycleCard` повинна явно повертати тип `string`.
...
Функція `renderMotorcycleCard` повинна повертати `string`.
...
Ви повинні мати клас з назвою `MotorcycleGalleryApp`.
...
`MotorcycleGalleryApp` повинен мати масив з назвою `allMotorcycles`.
...
Властивість `allMotorcycles` повинна бути `private`.
...
Властивість `allMotorcycles` повинна бути статично типізована як `Motorcycle[]`.
...
`MotorcycleGalleryApp` повинен мати функцію з назвою `renderMotorcycles`.
...
Функція `renderMotorcycles` повинна відтворювати 25 елементів з класом `motorcycle-card-image-container`.
...
Функція `renderMotorcycles` повинна відтворювати 25 елементів з класом `motorcycle-card-year-badge`.
...
Функція `renderMotorcycles` повинна відтворювати 25 елементів з класом `motorcycle-card-title`.
...
Функція `renderMotorcycles` повинна відтворювати 25 елементів з класом `motorcycle-card-manufacturer`.
...
Функція `renderMotorcycles` повинна відтворювати 25 елементів з класом `motorcycle-card-category`.
...
Функція `renderMotorcycles` повинна відтворювати 25 елементів з класом `motorcycle-card-description`.
...
Функція `renderMotorcycles` повинна відтворювати 25 елементів з класом `motorcycle-card-price`.
...
Функція `renderMotorcycles` повинна відтворювати 25 елементів з класом `motorcycle-card-engine`.
