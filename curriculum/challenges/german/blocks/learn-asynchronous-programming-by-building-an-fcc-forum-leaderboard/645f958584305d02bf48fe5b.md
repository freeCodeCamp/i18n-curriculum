...
Fügen Sie am Ende Ihrer `map`-Methode die `join()`-Methode an. Übergeben Sie für den Trenner einen leeren String.

# --hints--

Sie sollten die `join`-Methode an die `map`-Methode anhängen und für den Trenner einen leeren String verwenden.
