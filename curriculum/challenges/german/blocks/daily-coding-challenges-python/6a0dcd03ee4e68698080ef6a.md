...
Gegeben ist ein HTML-String. Geben Sie den reinen Textinhalt zurück, wobei alle Tags entfernt sind.

# --hints--

`extract_content('<p>hello world</p>')` sollte `"hello world"` zurückgeben.
...
`extract_content('<p>hello <span>world</span></p>')` sollte `"hello world"` zurückgeben.
...
`extract_content('<a href="example.com">Click me</a>')` sollte `"Click me"` zurückgeben.
...
`extract_content('<p><button onClick="learnToCode()">Learn</button> to <code>code<code> <br/>for <strong>free</strong> <br/>on <a href="https://freecodecamp.org/" target="_blank"><span class="highlight">freecodecamp</span>.org</a>')` sollte `"Learn to code for free on freecodecamp.org"` zurückgeben.
