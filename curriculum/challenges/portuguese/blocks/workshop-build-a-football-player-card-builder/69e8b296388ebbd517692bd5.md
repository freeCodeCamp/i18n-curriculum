...
Após o DRI `form-group`, adicione mais dois elementos `div`, cada um com o `className` de `form-group` dentro de `stats-grid`, um para DEF e outro para PHY.

Para o de DEF, adicione um `label` com um `htmlFor` de `def` e o texto `DEF`, depois uma entrada com um `id` de `def` e um `type` de `number`.

E para o de PHY, adicione um rótulo com um `htmlFor` de `phy` e o texto `PHY`, depois uma entrada com um `id` de `phy` e um `type` de `number`.

# --hints--

Você deve adicionar outro conjunto de dois elementos `div`, cada um com o `className` de `form-group` dentro do `div` de `className` de `stats-grid`.
...
Seu quinto elemento `div` de `className` de `form-group` deve ter um `label` com um atributo `htmlFor` de `def`, um `className` de `label` e um texto `DEF`.
...
Seu quinto elemento `div` de `className` de `form-group` deve ter um `input` com um `className` de `input`, um `id` de `def` e um `type` de `number`.
...
Seu sexto elemento `div` de `className` de `form-group` deve ter um `label` com um atributo `htmlFor` de `phy`, um `className` de `label` e um texto `PHY`.
...
Seu quarto elemento `div` de `className` de `form-group` deve ter um `input` com um `className` de `input`, um `id` de `phy` e um `type` de `number`.
