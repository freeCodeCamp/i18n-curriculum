...
بعد أن خزنت المهمة في مصفوفة `taskData`، يجب أن تعرض المهمة على الصفحة بالتكرار عبرها.
...
يجب أن تستخدم `{id, title, date, description}` كمعلمات مفككة لدالة الاستدعاء الراجعة في `forEach()`.
