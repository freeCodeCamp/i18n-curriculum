...
All'interno della query `@media`, aggiungi un selettore `.keys` e imposta il `width` su `318px`.

# --hints--


La tua regola `@media` dovrebbe avere un selettore `.keys`.
...
Il tuo nuovo selettore `.keys` dovrebbe avere un `width` di `318px`.
