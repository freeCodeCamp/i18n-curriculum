...
To `coordinate` means to arrange for things to work together effectively. Zum Beispiel, `She coordinates the team's meetings` bedeutet, sie arrangiert die Meetings, damit jeder daran teilnehmen kann.
