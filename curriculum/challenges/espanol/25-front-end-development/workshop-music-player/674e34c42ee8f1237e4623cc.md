...
Agregue un bloque `else`. Dentro del bloque `else`, llame a la función `playSong` con el `id` de la canción que se reproduce actualmente como argumento.

Esto asegura que la canción que se está reproduciendo actualmente continúe cuando se hace clic en el botón de reproducir.
