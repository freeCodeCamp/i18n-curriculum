...
Hamishe kwenye `h2` ndani ya **mpango wa Listener**, mpe darasa la huduma `text-lg` ili kuifanya kubwa zaidi, `font-semibold` ili kuifanya iwe na herufi nzito zaidi, na `text-indigo-600` ili kuipatia rangi nzuri ya indigo.

# --hints--

Kipengele chako cha `h2` kinapaswa kuwa na darasa la `text-lg`.
...
Kipengele chako cha `h2` kinapaswa kuwa na darasa la `font-semibold`.
...
Kipengele chako cha `h2` kinapaswa kuwa na darasa la `text-indigo-600`.
