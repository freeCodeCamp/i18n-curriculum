...
Überprüfen Sie die folgende Tabelle der Adverbien.

| Adverb       | Bedeutung                        |
| ------------ | --------------------------------- |
| `Always`     | Etwas passiert die ganze Zeit.   |
| `Usually`    | Etwas passiert gelegentlich.      |
| `Sometimes`  | Etwas passiert gelegentlich.      |
| `Often`      | Etwas passiert häufig.            |
| `Rarely`     | Etwas passiert selten.            |
| `Never`      | Etwas passiert überhaupt nicht.  |
...
Dieses Adverb bedeutet, dass etwas häufig passiert.
