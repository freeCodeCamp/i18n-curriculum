...
Para ver el nuevo resultado, haga clic en el botón `"Añadir nueva tarea"`. Luego añade un título de `WALK DOG` y haz clic en el botón `"Añadir tarea"`. Open up the console to see the result of `['walk', 'dog']`.
