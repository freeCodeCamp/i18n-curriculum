...
Dados dois conjuntos *A* e *B*, calcule $(A \setminus B) \cup (B \setminus A).$ Ou seja, enumere os itens que estão em *A* ou *B* mas não em ambos.Este conjunto é chamado de diferença simétrica de *A* e *B*.Em outras palavras: $(A \cup B) \setminus (A \cap B)$ (o conjunto de itens que estão em pelo menos um dos conjuntos *A* ou *B* menos o conjunto de itens que estão em ambos os conjuntos *A* e *B*).
