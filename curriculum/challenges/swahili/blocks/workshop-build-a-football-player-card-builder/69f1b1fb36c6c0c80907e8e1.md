...
Ndani ya kipengele cha `preview-panel`, ongeza kipengele cha `p` cha `className` cha `preview-label` na maandishi ya `Live Preview`, kipengele kingine cha `p` cha `className` cha `preview-hint` na maandishi ya `Updates as you type`, na `div` yenye `className` iliyowekwa kuwa template literal `preview-box tier-${getPlayerTier(player.overallRating)}`.

Ndani ya `div` ya mwisho, hamisha sehemu ya `PlayerCard` na vigezo vyake.

# --hints--

Kipengele chako cha `div.preview-panel` kinapaswa kuwa na `p` yenye `className` ya `preview-label` na maandishi ya `Live Preview`.
...
`div.preview-panel` yako inapaswa kuwa na `p` yenye `className` ya `preview-hint` na maandishi ya `Updates as you type`.
...
`div.preview-panel` yako inapaswa kuwa na `div` yenye `className` ya `preview-box` na daraja la mabadiliko la `className` lililo na kiambishi awali cha `tier-`.
...
`PlayerCard` inapaswa kuonyeshwa ndani ya kipengele cha `div` chenye `className` ya `preview-box`.
