...
Подібно до гнучкого контейнера, за допомогою CSS сітки ви можете вирівнювати вміст елементів сітки за допомогою `align-items` та `justify-items`. `align-items` вирівнюватиме дочірні елементи вздовж осі стовпців, а `justify-items` — вздовж осі рядків.

Додайте селектору `.social-icons` властивість `align-items` зі значенням `center`.

# --hints--

Ваш селектор `.social-icons` має мати властивість `align-items` зі значенням `center`.
