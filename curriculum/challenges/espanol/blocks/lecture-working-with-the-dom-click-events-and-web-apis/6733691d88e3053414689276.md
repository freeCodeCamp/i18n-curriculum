...
title: ¿Qué son los manejadores de eventos en línea, y por qué es una mejor práctica usar `addEventListener()` en su lugar?
challengeType: 19
...
En las lecciones anteriores, aprendiste cómo trabajar con eventos usando el método `addEventListener()`. Pero hay otra forma, no recomendada, de trabajar con eventos en JavaScript.
