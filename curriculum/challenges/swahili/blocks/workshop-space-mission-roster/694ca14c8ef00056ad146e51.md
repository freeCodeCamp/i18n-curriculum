...
Sukuma kitu cha `astronaut` ndani ya safu ya data ya `crew` na andika `Added ${astronaut.name} as ${astronaut.role}` kwenye konsoli. Unaweza kutumia herufi za kiolezo au kuunganisha mfuatano wa herufi kwa ujumbe wa kuandika.

# --hints--

Unapaswa kusukuma `astronaut` ndani ya safu ya data ya `crew`.
