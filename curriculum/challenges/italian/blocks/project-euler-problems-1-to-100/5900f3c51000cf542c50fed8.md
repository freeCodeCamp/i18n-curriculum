...
title: 'Problema 87: triple di potenze di numeri primi'
challengeType: 1
forumTopicId: 302201
...
Il numero più piccolo esprimibile come somma di un quadrato primo, un cubo primo e una quarta potenza di un numero primo è `28`. In effetti, ci sono esattamente quattro numeri sotto cinquanta che possono essere espressi in questo modo:
...
Quanti numeri sotto `n` possono essere espressi come somma di un quadrato primo, un cubo primo e una quarta potenza di un numero primo?
