...
En la próxima lección, veremos cómo lanzar mensajes de error dentro del contexto del bloque `try`/`catch`, que se usa para manejar excepciones de manera elegante en JavaScript.
