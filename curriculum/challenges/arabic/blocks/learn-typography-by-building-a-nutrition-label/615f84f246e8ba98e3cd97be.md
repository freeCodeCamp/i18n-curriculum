...
أسفل عنصر `.double-indent` الخاص بك، أضف عنصر `p` جديدًا يحتوي على النص `Includes 10g Added Sugars 20%`. يجب أن يكون عنصر `p` الجديد مزدوج المسافة البادئة أيضًا، وألا يحتوي على حدود سفلية. استخدم عنصر `span` لجعل `20%` عريضًا ومحاذيًا إلى اليمين.
