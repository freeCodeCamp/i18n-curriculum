...
La familia `SHA-2` es una alternativa más fuerte a `SHA-1`. La principal diferencia entre ellos es la longitud del hash. 
...
Detalles de la implementación de investigación y escribir una función que tome una cadena como parámetro y devuelva un hash usando `SHA-256`

# --hints--

`SHA256` debe ser una función.

```js
assert(typeof SHA256 === 'function');
```

`SHA256("código Rosetta")` debe devolver una cadena.

```js
assert(typeof SHA256('Rosetta code') === 'string');
```

`SHA256("Código Rosetta")` debe devolver `"764faf5c61ac315f1497f9dfa542713965b785e5cc2f707d6468d7d1124cdfcf"`.
...
`SHA256("SHA-256 Hash")` debe devolver `"bee8c0cabdcf8c7835f40217dd35a8b0dba9134520e633f1c57285f35ca7ee3e"`.
...
`SHA256("implementación")` debe devolver `"da31012c40330e7e21538e7dd57503b16e8a0839159e96137090cccc9910b171"`.
...
`SHA256("algoritmo")` debe devolver `"b1eb2ec8ac9f31ff7918231e67f96e6deda83a9ff33ed2c67443f1df81e5ed14"`.
...
`SHA256("idioma")` debe devolver `"a4ef304ba42a200bafd78b046e0869af9183f6eee5524aead5dcb3a5ab5f8f3f"`.
