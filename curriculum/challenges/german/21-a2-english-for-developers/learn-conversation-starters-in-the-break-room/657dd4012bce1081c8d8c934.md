...
Das Wort `any` wird oft in Fragen verwendet, um zu fragen ob etwas existiert oder verfügbar ist, ohne eine Menge anzugeben. It's useful when you don't know if there is something or how much there is and you want to find out.

Zum Beispiel: `Are there any updates?`
