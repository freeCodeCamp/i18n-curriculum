...
Verstecken Sie vorerst Ihr `#monsterStats`-Element mit der `display`-Eigenschaft. Ändern Sie keine der anderen Stilregeln.

# --hints--

Sie sollten einen `#monsterStats`-Selektor haben.
...
Ihr `#monsterStats`-Selektor sollte eine `display`-Eigenschaft mit dem Wert `none` haben.
...
Ihr `#monsterStats`-Selektor sollte eine `border` mit dem Wert `1px solid #0a0a23` haben.
...
Ihr `#monsterStats`-Selektor sollte eine `5px` mit dem Wert Innenabstand haben.
...
Ihr `#monsterStats`-Selektor sollte eine `color` mit dem Wert `#ffffff` haben.
...
Ihr `#monsterStats`-Selektor sollte eine `background-color` mit dem Wert `#c70d0d` haben.
