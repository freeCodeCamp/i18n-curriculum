...
يحتوي كائن `topic_list` على مصفوفة `topics` التي تضم أحدث المواضيع المنشورة في المنتدى.

فكك مصفوفة `topics` من كائن `topic_list`.

# --hints--

يجب استخدام `const` لفك المتغير `topics` من كائن `topic_list`.
