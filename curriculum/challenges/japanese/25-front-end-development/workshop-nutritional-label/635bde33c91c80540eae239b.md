...
`% Daily Value *` というテキストを右揃えにしましょう。 Create a `.right` selector and use the `justify-content` property to do it.
...
`.right` セレクターの `justify-content` プロパティを `flex-end` に設定してください。
