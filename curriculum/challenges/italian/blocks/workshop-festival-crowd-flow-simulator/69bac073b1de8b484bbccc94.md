...
Per prima cosa, registra il seguente messaggio nella console: `"\nProcessing " + gate.id + "..."`.

# --hints--

La tua funzione `handleGateAtTick` dovrebbe prima registrare il seguente messaggio nella console, `"\nProcessing " + gate.id + "..."`.
...
La tua funzione `handleGateAtTick` dovrebbe registrare l'id del gate corretto nel messaggio.
