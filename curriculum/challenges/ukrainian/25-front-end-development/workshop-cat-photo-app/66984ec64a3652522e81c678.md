...
Елемент посилання (`a`) повинен мати атрибут `href` зі значенням `https://www.freecodecamp.org`. You may have omitted the attribute/value, or have a typo.
...
The link's text should be `freeCodeCamp.org`. Ви або не написали текст, або маєте друкарську помилку.
