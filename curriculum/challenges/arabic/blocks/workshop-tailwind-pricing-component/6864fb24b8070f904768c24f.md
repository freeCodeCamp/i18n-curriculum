...
بطاقة التسعير التالية هي **الخطة المميزة**.

أضف إلى عنصر `div` الحاوي للخطة المميزة الأصناف `bg-gray-950`، `text-white`، `ring-2`، `ring-fuchsia-500`، و`p-8`.

# --hints--

يجب أن يحتوي عنصر `div` الحاوي للخطة المميزة على الصنف `bg-gray-950`.
...
يجب أن يحتوي عنصر `div` الحاوي للخطة المميزة على الصنف `text-white`.
...
يجب أن يحتوي عنصر `div` الحاوي للخطة المميزة على الصنف `ring-2`.
...
يجب أن يحتوي عنصر `div` الحاوي للخطة المميزة على الصنف `ring-fuchsia-500`.
...
يجب أن يحتوي عنصر `div` الحاوي للخطة المميزة على الصنف `p-8`.
