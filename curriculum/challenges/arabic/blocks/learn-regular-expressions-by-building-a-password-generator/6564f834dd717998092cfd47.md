...
بعد تعليقك الجديد، اكتب حلقة `for` للتكرار على قائمة `constraints`. استخدم `constraint` و `pattern` كمتغيرات للحلقة.

# --hints--

يجب أن تكتب حلقة `for` للتكرار على قائمة `constraints`.
...
يجب أن تستخدم حلقة `for` الخاصة بك `constraint` و `pattern` كمتغيرات للحلقة للتكرار على قائمة `constraints`.
