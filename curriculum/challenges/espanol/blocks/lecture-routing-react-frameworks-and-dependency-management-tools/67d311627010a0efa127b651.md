...
En lecciones anteriores, aprendiste que React es una aplicación de una sola página. Las aplicaciones de una sola página son aplicaciones que contienen un archivo HTML y usan JavaScript para actualizar dinámicamente cualquier contenido en la página.
...
Esto significa que el camino de la ruta hija se agregará al camino de la ruta padre. Entonces, en este ejemplo, el `path` para los productos de tendencia será `products/trending`.
...
Revisa el comienzo de la lección donde se habló de React Router.
...
Revisa el último minuto de la lección donde se discutió esto.
