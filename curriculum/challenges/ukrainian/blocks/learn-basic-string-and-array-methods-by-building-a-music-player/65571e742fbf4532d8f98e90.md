...
Вам потрібно перемалювати пісні, виділити її та встановити доступний текст кнопки відтворення, оскільки список пісень зміниться.

Викличте функцію `renderSongs` та передайте масив `userData?.songs` як аргумент, це відобразить змінений список відтворення.

Після цього викличте функцію `highlightCurrentSong`, щоб виділити поточну пісню, якщо така є, та функцію `setPlayButtonAccessibleText`, щоб оновити доступний текст кнопки відтворення.

# --hints--

Не змінюйте наявну функцію `deleteSong` та її вміст.
