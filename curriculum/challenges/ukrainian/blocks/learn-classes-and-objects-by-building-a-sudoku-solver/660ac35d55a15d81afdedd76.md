...
Всередині циклу `for` оголосіть змінну `row_str` і призначте їй спискове включення, яке ітерує `row` і перетворює кожен елемент `i` у `row` на рядок. Для цього використовуйте функцію `str()`.

# --hints--

Ви повинні оголосити змінну `row_str`.
...
Ви повинні призначити спискове включення, яке ітерує `row`, змінній `row_str`.
...
Спискове включення, призначене змінній `row_str`, має використовувати `i` як змінну ітерації.
...
Спискове включення, призначене змінній `row_str`, має викликати `str()` для кожного елемента `i` у `row`.
