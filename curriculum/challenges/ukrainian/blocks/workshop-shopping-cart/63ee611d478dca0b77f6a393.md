...
Ви дізналися на попередній лекції, що ключове слово `this` посилається на поточний екземпляр, який створюється, як ви бачили в конструкторі `Dessert`. Тут ви застосуєте ту саму ідею до класу `ShoppingCart`.
...
У своєму конструкторі використайте ключове слово `this`, щоб встановити властивість `items` у порожній масив. Також встановіть властивість `total` у `0`, а властивість `taxRate` у `8.25`.

# --hints--

Ви повинні використати ключове слово `this`, щоб встановити властивість `items` вашого класу у порожній масив.
