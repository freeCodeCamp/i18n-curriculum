...
Tangaza variable ya `currValue` na weka thamani yake kuwa ile iliyo `array[i]`. Kisha, tangaza variable ya `j` na weka thamani `i - 1`. Variable yako ya `j` inapaswa kuwa inaweza kuwekwa thamani tena.

# --hints--

Unapaswa kutangaza variable ya `currValue` na `const`.
...
Unapaswa kuweka thamani `currValue` kuwa ile iliyo `array[i]`.
...
Unapaswa kutangaza variable ya `j` na `let`.
...
Unapaswa kuweka thamani `j` kuwa thamani ya `i - 1`.
