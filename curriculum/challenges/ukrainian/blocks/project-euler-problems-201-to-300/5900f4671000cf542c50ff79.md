...
Нехай $S = \\{2, 3, 5, \ldots, 4999\\}$ — множина простих чисел менших за 5000.

Знайдіть кількість підмножин множини $S$, сума елементів яких є простим числом.

Введіть 16 правих цифр вашої відповіді.
