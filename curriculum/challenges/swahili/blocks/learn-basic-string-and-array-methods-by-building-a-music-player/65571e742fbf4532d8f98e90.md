...
Unahitaji kuonyesha tena nyimbo, zionyeshe kwa kuangazia na kuweka maandishi ya upatikanaji ya kitufe cha kucheza kwa sababu orodha ya nyimbo itabadilika.

Fanya wito wa kitendakazi cha `renderSongs` na upitie safu ya data ya `userData?.songs` kama hoja, hii itaonyesha orodha ya nyimbo iliyobadilishwa.

Baada ya hapo, fanya wito wa kitendakazi cha `highlightCurrentSong` kuangazia wimbo wa sasa ikiwa upo, na pia kitendakazi cha `setPlayButtonAccessibleText` kusahihisha maandishi ya upatikanaji ya kitufe cha kucheza.

# --hints--

Haupaswi kubadilisha kitendakazi cha `deleteSong` kilichopo na yaliyomo ndani yake.
...
Unapaswa kufanya wito wa kitendakazi cha `renderSongs` ukiambatanisha na `userData?.songs`.
