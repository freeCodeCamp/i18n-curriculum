...
Lenga kipengele cha `.penguin` wakati kiko hai, na ongeza ukubwa wake kwa `50%` katika vipimo vyote viwili.
...
Unapaswa kumpa `.penguin:active` `transform` ya `scale(1.5)`.
