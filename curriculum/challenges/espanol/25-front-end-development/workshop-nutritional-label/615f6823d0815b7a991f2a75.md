...
Usa tu elemento existente `.divider` como ejemplo para añadir un nuevo divisor después del elemento `p`.

# --hints--

Debes crear un nuevo `div` dentro de tu elemento `.daily-value`.
...
Tu nuevo `div` debe estar después de tu elemento `p`.
