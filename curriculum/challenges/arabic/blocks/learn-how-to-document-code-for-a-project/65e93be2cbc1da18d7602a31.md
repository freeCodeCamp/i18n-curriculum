...
`comments`، `clarify`، `comment on`، `describe`، `double slashes`، و`parts of`.
...
ملاحظات في الشفرة تشرح ما تفعله. يتجاوزها الكمبيوتر.
...
كتابة `//` تبدأ تعليقًا في العديد من لغات البرمجة.
...
شرح ما هو الشيء أو ما الذي يفعله.
...
كتابة ملاحظة أو إبداء رأيك حول شيء ما.
...
أقسام أو أجزاء مختلفة من شيء ما.
