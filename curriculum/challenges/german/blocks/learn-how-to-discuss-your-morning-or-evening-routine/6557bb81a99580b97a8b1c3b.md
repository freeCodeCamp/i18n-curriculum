...
Dieses Wort ist das Gegenteil von `before`.
...
Es ist ein Getränk aus Obst oder Gemüse.
...
Dieses Verb wird verwendet, um das Aufrechterhalten oder Fortsetzen eines Zustands auszudrücken.
...
Diese Präposition wird mit `keep` verwendet, um das Aufrechterhalten eines hohen Energieniveaus zu bedeuten.
