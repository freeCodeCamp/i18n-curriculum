...
Додайте новий селектор `#piano` до запиту `@media` та встановіть `width` на `358px`.

# --hints--

Ваше правило `@media` повинне мати селектор `#piano`.
...
Ваш новий селектор `#piano` повинен мати `width` зі значенням `358px`.
