...
title: Iterare su più array contemporaneamente
challengeType: 1
forumTopicId: 385279
...
Itera su più array e crea un nuovo array il cui elemento $i^{esimo}$ è la concatenazione dell'elemento $i^{esimo}$ di ciascuno degli array dati.

Per questo esempio, se ti viene dato questo array di array:
...
Scrivi una funzione che prende un array di array come parametro e restituisce un array di stringhe che soddisfa la descrizione data.
