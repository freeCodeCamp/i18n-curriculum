...
Jetzt wissen Sie, dass der Button funktioniert. Entfernen Sie die `console.log`-Anweisung aus der `displayStory`-Funktion.

# --hints--

Sie sollten die `console.log`-Anweisung aus der `displayStory`-Funktion entfernen.
