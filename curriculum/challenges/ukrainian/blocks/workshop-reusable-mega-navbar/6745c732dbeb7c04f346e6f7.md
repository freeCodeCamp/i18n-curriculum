...
Створіть елемент `ul` всередині елемента `nav`. Усередині цього елемента `ul` створіть три елементи списку.

# --hints--

Ви повинні створити елемент `ul` всередині вашого елемента `nav`.

```js
assert.exists(document.querySelector('nav ul'));
```

Ви повинні створити три елементи `li` всередині вашого елемента `ul`.
