...
미디어 쿼리 상단에 `:root` 선택자를 추가하세요. 그런 다음 네 개의 `--building-color` 변수를 모두 거기서 `#000` 값을 사용하도록 재정의하세요.

# --hints--

미디어 쿼리에 `:root` 선택자를 추가해야 합니다.
...
값이 `--building-color1`인 `#000`를 추가해야 합니다.
...
값이 `--building-color2`인 `#000`를 추가해야 합니다.
...
값이 `--building-color3`인 `#000`를 추가해야 합니다.
...
값이 `--building-color4`인 `#000`를 추가해야 합니다.
