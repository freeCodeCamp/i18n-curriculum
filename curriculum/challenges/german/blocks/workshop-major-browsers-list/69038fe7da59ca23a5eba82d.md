...
Der letzte Browser, den Sie zur Liste hinzufügen, ist der Arc-Browser.

Fügen Sie ein weiteres `dt`-Element hinzu, das den Text `Arc` enthält.
...
Mit dieser letzten Ergänzung ist Ihre Browserliste vollständig!

# --hints--

Sie sollten fünf `dt`-Elemente in Ihrem Code haben.
...
Ihr fünftes `dt`-Element sollte den Text `Arc` enthalten.
...
Sie sollten fünf `dd`-Elemente in Ihrem Code haben.
...
Ihr fünftes `dd`-Element sollte den Text `This is a free Chromium based web browser first released in 2023 by The Browser Company.` enthalten.
