...
title: 'Aufgabe 78: Münzpartitionen'
challengeType: 1
forumTopicId: 302191
...
Sei ${p}(n)$ die Anzahl der verschiedenen Möglichkeiten, wie `n` Münzen in Haufen aufgeteilt werden können. Zum Beispiel können fünf Münzen genau auf sieben verschiedene Arten in Haufen aufgeteilt werden, also gilt ${p}(5) = 7$.
...
Finden Sie den kleinsten Wert von `n`, für den ${p}(n)$ durch `divisor` teilbar ist.
