...
- Особа 1: `We should use a new programming language for this project.`

- Особа 2: `I see your perspective, but switching languages might slow us down.` — ця людина розуміє ідею, але вказує на можливий недолік.
