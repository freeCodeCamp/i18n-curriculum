...
Você estava usando a função `rgb` para definir cores. Para adicionar um canal alfa a uma cor `rgb`, use a função `rgba`.
...
Você também pode usar um canal alfa às cores com `hsl` e `hex`. Você verá como fazer isso em breve.
