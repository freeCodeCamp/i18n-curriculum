...
可以驗證 T<sub>285</sub> = P<sub>165</sub> = H<sub>143</sub> = 40755。

尋找下一個同時為五邊形數和六邊形數的三角形數。

# --hints--

`triPentaHexa(40756)` 應該傳回一個數字。

```js
assert(typeof triPentaHexa(40756) === 'number');
```

`triPentaHexa(40756)` 應該傳回 1533776805。
