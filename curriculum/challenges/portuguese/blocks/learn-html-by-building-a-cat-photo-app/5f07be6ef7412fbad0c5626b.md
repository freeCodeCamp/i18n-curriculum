...
Faça com que os elementos `h2`, `p` e âncora (`a`) fiquem aninhados em um elemento `section`.
...
O elemento `h2`, os elementos `p` e o elemento de âncora (`a`) devem estar entre as tags de abertura e fechamento do elemento `section`.
