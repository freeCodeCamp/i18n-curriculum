...
Reemplaza el nombre de club codificado como `Santos FC` en `card-club` por `player.club`.

# --hints--

Debes reemplazar el `Santos FC` codificado por `player.club` en `.card-club`.
