...
`best way`, `more control`, `choices`, `work best`, `balance`, `take longer`, і `depends on`.
...
Це іменник у множині, що позначає різні варіанти, доступні у процесі прийняття рішення.  
...
Ця двослівна фраза складається з дієслова та прислівника, що запитує, який варіант є найефективнішим.  
...
Ця двослівна фраза складається з прикметника та іменника, що позначає найефективніший метод.  
...
Ця двослівна фраза складається з дієслова та порівняльного прикметника, що означає потребу в більшому часі.  
...
Ця двослівна фраза складається з порівняльного прикметника та іменника, що означає посилений контроль або повноваження.  
...
Ця двослівна фраза включає дієслово та прийменник, що вказує на те, що вибір залежить від певних факторів.  
...
Це дієслово означає знайти компроміс між двома підходами.
