...
Gegeben sind nicht-negative ganze Zahlen `m` und `n`. Erzeugen Sie alle Kombinationen der Größe `m` aus den ganzen Zahlen von `0` (null) bis `n-1` in sortierter Reihenfolge (jede Kombination ist sortiert und die gesamte Tabelle ist sortiert).
...
`combinations(3, 5)` sollte `[[0, 1, 2], [0, 1, 3], [0, 1, 4], [0, 2, 3], [0, 2, 4], [0, 3, 4], [1, 2, 3], [1, 2, 4], [1, 3, 4], [2, 3, 4]]` zurückgeben.

```js
assert.deepEqual(combinations(testInput1[0], testInput1[1]), testOutput1);
```

`combinations(4, 6)` sollte `[[0,1,2,3], [0,1,2,4], [0,1,2,5], [0,1,3,4], [0,1,3,5], [0,1,4,5], [0,2,3,4], [0,2,3,5], [0,2,4,5], [0,3,4,5], [1,2,3,4], [1,2,3,5], [1,2,4,5], [1,3,4,5], [2,3,4,5]]` zurückgeben.
