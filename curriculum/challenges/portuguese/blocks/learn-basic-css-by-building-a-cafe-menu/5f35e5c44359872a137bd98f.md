...
Exclua o comentário e o conteúdo dentro do seletor do tipo `body`. Em seguida, adicione a propriedade `background-image` e defina seu valor como `url(https://cdn.freecodecamp.org/curriculum/css-cafe/beans.jpg)`.
