...
Ongeza kichaguzi kipya cha `#piano` ndani ya hoja yako ya utafutaji ya `@media`, na weka `width` kuwa `358px`.

# --hints--

Sera yako ya `@media` inapaswa kuwa na kichaguzi cha `#piano`.
...
Kichaguzi chako kipya cha `#piano` kinapaswa kuwa na `width` ya `358px`.
