...
Por ejemplo, si quieres hacer que un campo de texto sea obligatorio, solo tienes que agregar el atributo `required` dentro de tu elemento `input`, así: `<input type="text" required>`
