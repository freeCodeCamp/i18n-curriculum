...
Agora, você deve passar para a estilização dos elementos para o **Listener plan**.

Dê ao `div` externo do plano as classes `bg-gray-100`, `ring-1` para criar um contorno grosso ao redor do `div` e `ring-gray-300` para atribuir uma cor escura a esse contorno.

# --hints--

Seu elemento `div` deve ter a classe `bg-gray-100`.
...
Seu elemento `div` deve ter a classe `ring-1`.
...
Seu elemento `div` deve ter a classe `ring-gray-300`.
