...
Для третьої та четвертої контрольних точок повторіть шаблон `transform` ще раз.

# --hints--

Ви повинні надати контрольній точці `30%` ідентифікатор `transform` зі значенням `rotate(110deg) scaleX(-1)`.
...
Ви повинні надати контрольній точці `40%` ідентифікатор `transform` зі значенням `rotate(130deg) scaleX(-1)`.
