...
أسفل آخر عنصر `p` لديك، أضف عنصر `p` آخر يحتوي على النص `Dietary Fiber 4g`. أعطِ عنصر الـ `p` الـ `class` اللازمة لعمل مسافة بادئة وإزالة الحدود الفاصلة. ثم أنشئ فاصلًا أسفل ذلك العنصر `p`.
...
يجب أن يكون خاصية `class` لعنصر `p` الجديد مضبوطة على `indent no-divider`.
...
يجب أن يكون خاصية `class` لعنصر `div` الجديد مضبوطة على `divider`.
