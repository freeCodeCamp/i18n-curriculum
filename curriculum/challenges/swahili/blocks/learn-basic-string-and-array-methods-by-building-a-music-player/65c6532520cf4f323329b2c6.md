...
Hivi sasa mpangilio wa nyimbo bado haujabadilika. Hii ni kwa sababu masasisho uliyofanya kwa kutumia njia ya `sort` hayatatokea hadi kitendakazi cha `sortSongs` kitapigiwa wito.

Badilisha kitendakazi chako cha `renderSongs` ili kipige wito kitendakazi cha `sortSongs`.

Sasa unapaswa kuona nyimbo zikiwa zimepangwa kwa mpangilio wa alfabeti.

# --hints--

Unapaswa kuwa na `renderSongs(sortSongs())`.
