...
خلفية اللون البني تجعل قراءة النص صعبة. غيّر لون الخلفية لعنصر `body` إلى `burlywood` ليكون له لون، ولكن لا يزال بإمكانك قراءة النص.

# --hints--

يجب تعيين خاصية `background-color` إلى `burlywood`.
...
يجب أن يكون لعنصر `body` خلفية بلون `burlywood`.
