...
Es una buena práctica permitir que los usuarios agreguen notas o inquietudes adicionales.

Debajo de tu tercer elemento `fieldset`, agrega un nuevo elemento `fieldset`. Dentro, agrega un elemento `legend` con el texto `Additional Notes`.


# --hints--

Deberías tener un total de 4 elementos `fieldset` en esta página.
...
Debes agregar un elemento `fieldset` debajo del tercer elemento `fieldset`.
...
El nuevo elemento `fieldset` debe contener un elemento `legend`.
...
El elemento `legend` debe tener el texto `Additional Notes`.
