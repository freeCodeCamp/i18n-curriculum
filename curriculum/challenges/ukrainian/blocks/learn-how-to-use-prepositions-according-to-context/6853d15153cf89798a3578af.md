...
Цей двослівний вираз означає організований або впорядкований правильно. Перше слово закінчується на `-ed`.
...
Цей двослівний вираз означає, що щось відбувається у правильний або запланований час.

# --explanation--

`Lined up` означає впорядкований або підготовлений у правильному порядку чи позиції. Наприклад:

`We have all the speakers lined up for the conference.` – Це означає, що все заплановано і підтверджено.

`On time` означає не запізнюється і відбувається у правильний або очікуваний час. Наприклад:

`The train arrived on time despite the heavy rain.` – Це означає, що це прибуло за розкладом.
