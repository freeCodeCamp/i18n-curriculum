...
`getAverage([10, 20, 30, 40, 55, 65, 75, 83])` має повернути `47.25`.

```js
assert.strictEqual(getAverage([10, 20, 30, 40, 55, 65, 75, 83]), 47.25);
```

`getAverage([10, 20, 30, 40, 50, 60, 70, 97])` має повернути `47.125`.
...
`studentMsg([12, 22, 32, 42, 52, 62, 72, 92], 85)` має повернути таке повідомлення: `"Class average: 48.25. Your grade: B. You passed the course."`.

```js
assert.strictEqual(studentMsg([12, 22, 32, 42, 52, 62, 72, 92], 85), "Class average: 48.25. Your grade: B. You passed the course.");
```

`studentMsg([15, 25, 35, 45, 55, 60, 70, 60], 75)` має повернути таке повідомлення: `"Class average: 45.625. Your grade: C. You passed the course."`.
