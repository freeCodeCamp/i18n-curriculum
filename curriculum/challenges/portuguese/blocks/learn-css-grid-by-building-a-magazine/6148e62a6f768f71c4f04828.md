...
A propriedade `place-items` pode ser usada para definir os valores de `align-items` e `justify-items` ao mesmo tempo. A propriedade `place-items` recebe um ou dois valores. Se um valor for fornecido, ele é usado para as propriedades `align-items` e `justify-items`. Se forem fornecidos dois valores, o primeiro valor é usado para a propriedade `align-items` e o segundo valor é usado para a propriedade `justify-items`.

Dê ao seletor `.image-wrapper` uma propriedade `place-items` definida como `center`.

# --hints--

O seletor `.image-wrapper` deve ter a propriedade `place-items` definida como `center`.
