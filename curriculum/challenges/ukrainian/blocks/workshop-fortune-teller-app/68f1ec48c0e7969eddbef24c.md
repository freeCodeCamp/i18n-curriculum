...
Нарешті, всередині `hideElements` передайте аргументи `singleCard`, `multipleCard`, `fortuneContainer` і `fortuneDescription`. Не забудьте отримати їх із елементів.

З цим ваш застосунок для ворожіння готовий!

# --hints--

Ви повинні передати `singleCard` як перший аргумент у `hideElements`.
...
Ви повинні передати `multipleCard` як аргумент у `hideElements`.
...
Ви повинні передати `fortuneContainer` як аргумент у `hideElements`.
...
Ви повинні передати `fortuneDescription` як аргумент у `hideElements`.
