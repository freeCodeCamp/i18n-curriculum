...
Debes llamar `document.querySelectorAll()` con `#dinner input[type='number']`.
...
Debes llamar `document.querySelectorAll()` con `#snacks input[type='number']`.
...
Debes llamar `document.querySelectorAll()` con `#exercise input[type='number']`.
