...
Tu selector `#years` debe tener una propiedad `margin` establecida en `0 -2px`.
...
Tu selector `#years` debe tener una propiedad `padding` establecida en `0.5rem calc(1.25rem + 2px) 0.5rem 0`.
