...
Нарешті, вкладіть елемент `span`, що містить текст `Cholesterol`, разом із текстом `0mg` у додатковий елемент `span` для вирівнювання.
...
Ваш `Cholesterol` `span` має мати атрибут `class`, встановлений у `bold`.
...
Ваш `0%` `span` має мати атрибут `class`, встановлений у `bold`.
...
Ваш `Cholesterol` `span` і ваш текст `0mg` мають бути обгорнуті у `span`.
