...
تُقدم هذه العبارة حقيقة استخدام Git للتحكم في الإصدارات في تصريح صوفي.
...
تُستخدم هذه الكلمة للسؤال عن الطريقة أو العملية لتوثيق تغييرات الشفرة في Git.
...
تشير هذه الكلمة إلى التوقيت، في هذه الحالة، للسؤال عن لحظة إجراء التحديثات أو الإصلاحات لتوثيق التغييرات.
