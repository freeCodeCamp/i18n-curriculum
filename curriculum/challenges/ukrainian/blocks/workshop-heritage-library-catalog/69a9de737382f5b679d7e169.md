...
Щоб знайти відповідних авторів, перевіряйте кожен запис у каталозі по черзі.

Додайте порожній `for` цикл всередину `findByAuthor`, щоб ітерувати над `catalog`. Тіло циклу ви додасте на наступному кроці.

# --hints--

Ви повинні використовувати `for` цикл, щоб ітерувати над `catalog`.
