...
Elementsペインでは、ページのHTML構造全体を確認できます。このペイン内の任意の要素をクリックすると、その特定の要素を選択できます。または、左側に表示されている青くハイライトされたアイコンをクリックし、ページ上の任意の要素にカーソルを合わせることもできます。
...
要素が選択されると、Stylesタブには現在適用されているすべてのスタイルと、上書きされているスタイル（テキストに取り消し線が引かれていることで示されます）が表示されます。例えば、インスペクターを使って<a href="https://www.theodinproject.com/" target="_blank">The Odin Projectのホームページ</a>にある「Your Career in Web Development Starts Here」というヘッダーをクリックすると、右側にその要素に現在影響を与えているすべてのスタイルが以下のように表示されます。
...
Stylesペインで、要素が選択されているときにどんな情報を確認できますか？
