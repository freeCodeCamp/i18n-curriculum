...
- **`for...in` Bucle**: Este tipo de bucle se usa mejor cuando necesitas iterar sobre las propiedades de un objeto. Este bucle iterará sobre todas las propiedades enumerables de un objeto, incluidas las propiedades heredadas y las no numéricas.
