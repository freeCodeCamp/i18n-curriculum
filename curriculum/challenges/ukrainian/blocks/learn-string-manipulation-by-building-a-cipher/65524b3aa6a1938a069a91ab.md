...
Далі виведіть `new_char` і подивіться на вихідні дані.

# --hints--

Ви повинні вивести вашу змінну `new_char`.

```js
assert.match(code, /print\s*\(\s*new_char\s*\)/)
```

Ви повинні вивести вашу змінну `new_char` наприкінці тіла циклу.
