...
Всередині вашого `div` додайте два елементи `p`. Встановіть текст другого елемента `p` рівним значенню змінної `price`.

# --hints--

Ви повинні додати два елементи `p` всередину вашого елемента `div`.
...
Другий елемент `p` має містити текст змінної `price`.
