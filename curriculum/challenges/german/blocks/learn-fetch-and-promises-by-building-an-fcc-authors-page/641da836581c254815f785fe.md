...
Als Nächstes zeigen Sie biografische Details über den Autor. Das können Sie mit `bio` machen, das Sie zuvor destrukturiert haben.

Fügen Sie ein Absatz-Element mit `class` `"bio"` hinzu und interpolieren Sie dann `bio` innerhalb des Absatz-Elements.
