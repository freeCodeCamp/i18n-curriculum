...
Em seguida, clone-o para o seu computador local da mesma forma que faria com seu próprio repositório, usando SSH ou o CLI do GitHub.

Agora, vamos dar uma olhada nos remotos que seu clone local tem configurados. Abra um terminal no diretório do repositório local e execute `git remote -v` para obter uma lista completa. Deve ser algo assim:
