...
Sarah agrees with Mark. What would be the best reply to what Mark is saying?
...
Why is `yeah, it is` wrong? Because `it is` talks about the state of the BIOS, not what it can do. 這是一個示例：
