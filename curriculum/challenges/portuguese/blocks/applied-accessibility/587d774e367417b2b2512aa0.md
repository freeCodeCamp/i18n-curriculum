...
`article` é outro dos novos elementos do HTML5 que adicionam significado semântico à sua marcação. `article` é um elemento de seção e é usado para envolver conteúdo independente e autocontido.A tag funciona bem com resumos de postagens de blog, postagens de fóruns ou artigos de notícias.
