...
`Object-oriented programming` (OOP) es un paradigma de programación basado en el concepto de `objects`, que pueden contener datos y código: datos en la forma de campos (a menudo conocidos como atributos o propiedades), y código, en la forma de procedimientos (a menudo conocidos como métodos).
