...
Questo sostantivo indica quanto bene qualcosa funziona o opera, come la velocità e l'efficienza di un software.

# --explanation--

`Performance` descrive quanto efficientemente un sistema o un software funziona. Per esempio:
