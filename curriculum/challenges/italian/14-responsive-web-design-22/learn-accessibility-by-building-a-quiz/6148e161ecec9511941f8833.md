...
Adesso non possiamo leggere il testo. Seleziona l'elemento `footer` e l'elemento di ancoraggio al suo interno per impostare il carattere su un colore di un adeguato rapporto di contrasto.

# --hints--

Dovresti utilizzare il selettore `footer, footer a`.
...
Dovresti impostare la proprietà `color` su un valore con un rapporto di contrasto di almeno `7:1`. _Suggerimento: potresti usare `#dfdfe2`_
