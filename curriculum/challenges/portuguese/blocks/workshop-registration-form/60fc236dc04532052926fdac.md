...
Se você olhar de perto, notará que os elementos `.inline` estão altos demais na linha.

Para evitar isso, defina a propriedade `vertical-align` como `middle`.

# --hints--

Você deve definir a propriedade `vertical-align` como `middle` para todos os elementos `.inline`.
