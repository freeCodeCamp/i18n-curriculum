...
Ili kipengele cha localStorage kifanye kazi hatimaye, badilisha uanzishaji wa hali kutoka `defaultPlayer` kwenda `loadPlayer`. Hii inahakikisha hali inaanza na data yoyote iliyohifadhiwa inayopatikana.

Sasa jaribu kipengele cha localstorage. Kila kitu unachokiingiza kinapaswa kubaki baada ya onyesho kuonyesha upya au ukiongeza ukurasa tena.

Pia unaweza kubadilisha picha `src` unganisha na `https://cdn.freecodecamp.org/curriculum/typescript/tsx-workshop/maradona.png` ili kuona picha ikibadilika kwa wakati halisi. Hakikisha tu unabadilisha jina la mchezaji kuwa Maradona.

Kwa hayo, mradi wako wa muundaji wa kadi za wachezaji wa mpira wa miguu umekamilika!

# --hints--

`useState` yako inapaswa kuanzishwa na `loadPlayer` badala ya `defaultPlayer`.
