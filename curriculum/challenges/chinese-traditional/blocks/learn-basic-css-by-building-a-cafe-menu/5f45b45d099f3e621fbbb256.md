...
當聯結實際被點擊時，你會使用看起來像 `a:active { propertyName: propertyValue; }` 的 <dfn>偽選擇器</dfn> 來更改該聯結的屬性。

當點擊 `Visit our website` 聯結時，將頁腳的顏色更改為 `white`。
