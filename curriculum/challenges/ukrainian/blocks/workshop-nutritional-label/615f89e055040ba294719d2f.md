...
Створіть ще один елемент `p` під вашим великим роздільником. Дайте елементу `p` текст `Vitamin D 2mcg 10%`.

Елемент `p` містить лише текст, ви можете обгорнути відсоток у елемент `span`, щоб він вважався окремою сутністю від решти тексту і був розміщений праворуч.
