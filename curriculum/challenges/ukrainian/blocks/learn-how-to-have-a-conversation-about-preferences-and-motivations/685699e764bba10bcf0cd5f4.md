...
`Dealing with`, `demotivated`, `frustrating`, `support`, `for no reason`, `instead of`, і `annoys`.
...
Це означає відчуття, що ви більше не хочете щось робити.
...
Ця фраза означає вибір однієї речі, а не іншої.
...
Це означає зробити щось, щоб виправити або впоратися з ситуацією.
...
Це означає, що щось відбувається без чіткої або відомої причини.
...
Цей дієслово означає трохи роздратувати або засмутити когось.
...
Це описує щось, що змушує вас почуватися засмученим, бо все йде не так, як ви хочете.
...
Як дієслово, це означає допомагати або показувати, що ви погоджуєтеся з кимось або чимось.
