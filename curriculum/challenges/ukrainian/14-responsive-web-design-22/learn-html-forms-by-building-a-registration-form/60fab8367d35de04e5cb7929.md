...
Додайте текст `I accept the terms and conditions` одразу після елемента `input` до `label`. Потім прив’яжіть текст `terms and conditions` до такого розташування:
