...
爲 `#text` 元素指定 `background-color` 爲 `#0a0a23`、`color` 爲 `#ffffff`，並且在其所有邊上指定 `10px` 的內邊距。
...
你的 `#text` 元素應該具有 `#0a0a23` 的 `background-color`。
