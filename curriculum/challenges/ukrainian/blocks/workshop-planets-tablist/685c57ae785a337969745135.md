...
Для останнього кроку потрібно зробити панель видимою, коли натискають на пов’язану з нею вкладку. Ви можете зробити це, встановивши властивість `hidden` у `panel` в значення `false`.

Натисніть на будь-яку з вкладок, і ви повинні побачити відповідний вміст панелі.

І з цією останньою зміною ваше практичне заняття завершене!

# --hints--

Коли натискають на вкладку, слід встановити властивість `hidden` панелі в значення `false`.
