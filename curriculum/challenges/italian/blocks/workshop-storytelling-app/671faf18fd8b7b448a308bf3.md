...
Per distinguere tra i diversi tipi di storie, dovrai passare il genere della storia selezionata alla funzione `displayStory`.

Aggiungi un parametro chiamato `genre` alla funzione `displayStory`.

# --hints--

Dovresti aggiungere il parametro `genre` alla funzione `displayStory`.
