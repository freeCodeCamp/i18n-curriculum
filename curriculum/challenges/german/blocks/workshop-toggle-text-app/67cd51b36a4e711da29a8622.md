...
Um die Sichtbarkeit des Texts umzuschalten, müssen Sie zuerst eine Funktion erstellen, die für dieses Verhalten verantwortlich ist.

Beginnen Sie damit, eine neue Funktion namens `handleToggleVisibility` zu erstellen.

# --hints--

Sie sollten eine `handleToggleVisibility`-Funktion haben.
