...
Jambo linalofuata utakaloonyesha ni maelezo ya wasifu kuhusu mwandishi. Unaweza kufanya hivi kwa `bio` uliyoyavunjia awali.

Ongeza kipengele cha aya chenye `class` `"bio"`, kisha weka `bio` ndani ya kipengele cha aya.
