...
Ahora encadena el método filter a tu última llamada a `Object.keys()`. The callback function should return whether the value of `counts[el]` is equal to your `counts[highest]`.
