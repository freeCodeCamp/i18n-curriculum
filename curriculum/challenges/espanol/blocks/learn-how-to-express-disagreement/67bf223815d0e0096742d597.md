...
`Last discussion` means the most recent conversation. Por ejemplo:
...
`Stipend` is a fixed sum of money given regularly, often for work-related expenses. Por ejemplo:
