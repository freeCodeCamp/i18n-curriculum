...
Елемент `p` містить лише текст, ви можете обгорнути відсоток у елемент `span`, щоб він вважався окремою сутністю від решти тексту і був розташований праворуч.
...
Ваш новий елемент `p` повинен містити елемент `span`.
