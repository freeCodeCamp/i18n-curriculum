...
为你的 span 文本 `remainingCalories Calorie surplusOrDeficit`，使用插值将 `remainingCalories` 和 `surplusOrDeficit` 替换为适当的变量。

# --hints--

你的 `span` 应该包含文本 `${remainingCalories} Calorie ${surplusOrDeficit}`。
