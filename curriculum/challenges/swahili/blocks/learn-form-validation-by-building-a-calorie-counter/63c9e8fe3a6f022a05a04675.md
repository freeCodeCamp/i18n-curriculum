...
Ukizingatia sintaksia ile ile ya uingizaji wa thamani, ongeza kipengele cha `p` cha pili chenye maandishi `consumedCalories Calories Consumed` na cha tatu chenye maandishi `exerciseCalories Calories Burned`. Kumbuka kubadilisha vigezo vyako vya `consumedCalories` na `exerciseCalories` kwa thamani zinazofaa.

# --hints--

Unapaswa kuongeza kipengele cha `p` cha pili kwenye maandishi yako ya template literal.
...
Kipengele chako cha `p` cha pili kinapaswa kuwa na maandishi `${consumedCalories} Calories Consumed`.
...
Unapaswa kuongeza kipengele cha `p` cha tatu kwenye maandishi yako ya template literal.
...
Kipengele chako cha `p` cha tatu kinapaswa kuwa na maandishi `${exerciseCalories} Calories Burned`.
