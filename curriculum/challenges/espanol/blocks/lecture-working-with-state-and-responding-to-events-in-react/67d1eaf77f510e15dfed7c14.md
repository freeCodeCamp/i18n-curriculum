...
El estado es uno de los fundamentos más importantes de React y otros frameworks de front-end. Es como el cerebro de un componente, lo que significa que contiene información que puede cambiar con el tiempo y controla cómo se comportan y se ven los componentes.
...
Revisa el final de la lección donde se discutió la respuesta.
