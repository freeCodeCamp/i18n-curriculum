...
Altere a propriedade `margin` para que inclua `1em` nas partes superior e inferior e, ao mesmo tempo, deixe as margens esquerda e direita definidas como `auto`.Em seguida, defina a largura conforme descrito acima.
