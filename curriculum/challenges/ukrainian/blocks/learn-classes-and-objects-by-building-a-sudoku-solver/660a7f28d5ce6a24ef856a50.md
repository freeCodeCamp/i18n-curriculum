...
Тепер змініть дошку на місці, отримавши доступ до клітинки за заданим рядком і стовпцем і призначивши їй значення `guess`.

# --hints--

Ви повинні призначити `guess` значенню `self.board[row][col]`.
