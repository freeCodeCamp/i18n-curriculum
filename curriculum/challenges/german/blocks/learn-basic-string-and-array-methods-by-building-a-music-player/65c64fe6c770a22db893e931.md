...
Beggine, indem du eine Arrow-Funktion namens `sortSongs` erstellst.

# --hints--

Du solltest eine Funktion namens `sortSongs` haben.

```js
assert.isFunction(sortSongs);
```

Deine `sortSongs`-Funktion sollte eine Arrow-Funktion-Syntax verwenden.
