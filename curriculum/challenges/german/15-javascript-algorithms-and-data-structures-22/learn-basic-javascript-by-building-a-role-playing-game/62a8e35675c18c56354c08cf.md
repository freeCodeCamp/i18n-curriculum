...
Jetzt kannst du die `attack`-Funktion erstellen. Aktualisiere zuerst die `text` Nachricht, so dass sie `"The <monster name> attacks."` lautet, indem du `<monster name>` mit dem Namen des Monsters ersetzt. Denke daran, dass du dafür den Verkettungsoperator verwenden kannst.
