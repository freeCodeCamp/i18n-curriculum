...
Dato due array, crea un oggetto hash in cui gli elementi di un array (le chiavi) sono collegati agli elementi dell'altro (i valori).
...
L'oggetto hash creato dagli array sopra sarà `{1: "a", 2: "b", 3: "c"}`.
