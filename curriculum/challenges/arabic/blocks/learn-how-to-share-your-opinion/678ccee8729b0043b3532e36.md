...
ماذا يقترح كوينسي لارسون على المبتدئين أن يفعلوا أولاً؟

## --answers--

ركز على تعلم JavaScript أولاً.
...
بينما يذكر كوينسي Python، إلا أنه لا يوصي بالبدء بها.
...
كوينسي لا يقترح تعلم عدة لغات في نفس الوقت.

---

انتظر حتى وقت لاحق لتعلم البرمجة.

### --feedback--

كوينسي يشجع المبتدئين على بدء تعلم البرمجة، وخاصة JavaScript، فورًا.
...
ابحث عن الكلمات المفتاحية التي تظهر توصية كوينسي للمبتدئين.

`Best language to start with` – هذه العبارة تشير إلى اختياره للمبتدئين.

`Focus on` – هذا يشير إلى أولوية واضحة.

`Before learning other languages` – هذا يؤكد ما يعتقد أنه يجب أن يأتي أولاً.
