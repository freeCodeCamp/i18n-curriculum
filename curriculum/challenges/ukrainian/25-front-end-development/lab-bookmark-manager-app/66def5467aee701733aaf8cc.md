...
1. Ви повинні мати функцію `getBookmarks`, яка повертає масив `bookmarks`, збережений у локальному сховищі. Якщо ключ `bookmarks` ще не встановлено, функція `getBookmarks` має повернути порожній масив.
...
1. Якщо одна або кілька закладок у локальному сховищі мають вибрану категорію, додайте перемикач з атрибутами `id` та `value`, встановленими на назву закладки до внутрішнього HTML `#category-list` для кожної з цих закладок.
...
1. Коли ви натискаєте `#close-list-button`, ви повинні запустити функцію, щоб приховати `#bookmark-list-section` та відобразити основну секцію.
1. Коли ви натискаєте `#delete-bookmark-button`, ви повинні видалити закладку, що відповідає вибраному перемикачу, з локального сховища та оновити показаний список закладок.
...
Коли ви натискаєте `#view-category-button`, змініть внутрішній HTML `#category-list`, додавши перемикач з атрибутами `id` та `value`, встановленими на назву закладки для кожної закладки у вибраній категорії.
...
Коли ви натискаєте `#delete-bookmark-button`, видалити закладку, що відповідає вибраному перемикачу, з локального сховища та оновити показаний список закладок.
