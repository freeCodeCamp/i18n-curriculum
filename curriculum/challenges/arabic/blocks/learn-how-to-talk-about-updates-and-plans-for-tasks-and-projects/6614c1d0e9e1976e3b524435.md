...
بناءً على استجابة بوب، ماذا سيستخدمون في العرض التقديمي؟

## --answers--

سيستخدمون عرضًا تفاعليًا كما اقترحت سارة.

---

سيتمسكون بالخطة الأصلية باستخدام مجموعة شرائح.

### --feedback--

بوب يوافق على اقتراح سارة بتجربة شيء مختلف، مما يشير إلى التحول من مجموعة الشرائح إلى العرض التفاعلي.

---

سيجمعون بين مجموعة شرائح وعرض تفاعلي.

### --feedback--

رغم أن الجمع بين الطريقتين ممكن، إلا أن موافقة بوب على سارة تشير إلى تفضيل العرض التفاعلي فقط.

---

لم يقرروا بعد وسيواصلون النقاش.

### --feedback--

تصريح بوب `That's a great idea` يدل على موافقته على اقتراح سارة، مما يعني اتخاذ قرار.
