...
Це стосується того, хто ви є. Включає такі речі, як ваше ім’я, звідки ви родом і так далі.
...
Це слово означає перевірку, щоб переконатися, що щось є правдивим або правильним.
