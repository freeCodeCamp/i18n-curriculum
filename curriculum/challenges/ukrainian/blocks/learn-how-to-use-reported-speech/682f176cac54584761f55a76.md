...
Це означає включити або додати щось як частину більшого цілого.

# --explanation--

`To incorporate` означає включити щось, щоб воно стало частиною більшої системи або плану. Наприклад:

`The developer incorporated user feedback to improve the app's design.` – Це означає, що відгук було використано як частину змін у дизайні.
