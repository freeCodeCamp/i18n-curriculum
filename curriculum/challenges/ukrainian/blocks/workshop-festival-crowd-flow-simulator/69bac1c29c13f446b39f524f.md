...
Тепер ви маєте реалізувати головний цикл симуляції. Цей цикл забезпечить обробку кожних воріт на кожній поділці симуляції, доки всі поділки не будуть виконані.

Створіть порожній `while` цикл, який триватиме, поки `tickIndex` менше за `maxTicks`.

# --hints--

Вам слід створити порожній `while` цикл з умовою `(tickIndex < maxTicks)`.
