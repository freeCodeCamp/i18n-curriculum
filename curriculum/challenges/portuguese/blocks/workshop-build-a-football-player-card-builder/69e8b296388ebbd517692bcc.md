...
Agora envolva o componente `PlayerCard` em um elemento `main` de `className` de `main`.

Dentro do elemento `main`, adicione `div` de `className` de `layout`. Dentro de `layout`, adicione dois elementos `div` separados de `className` de `form-panel` e `preview-panel`, respectivamente.

# --hints--

Seu `FootballPlayerCard` deve renderizar um elemento `main` com o `className` de `main` dentro de `div.page`.
...
Seu `main.main` deve conter um `div` com o `className` de `layout`.
...
Seu `layout` deve conter um `div` com o `className` de `form-panel`.
...
Seu `layout` deve conter um `div` com o `className` de `preview-panel`.
