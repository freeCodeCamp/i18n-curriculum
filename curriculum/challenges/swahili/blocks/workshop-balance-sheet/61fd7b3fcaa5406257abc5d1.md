...
Ni wakati wa kuendelea na jedwali lako la pili. Anza kwa kulipa kipengele cha `caption` thamani ya `Liabilities`. Kisha ongeza `thead` na `tbody`.
...
Kipengele chako cha `caption` kinapaswa kuwa na maandishi ya `Liabilities`.
...
Kipengele chako cha `thead` kinapaswa kuwa chini kabisa ya kipengele chako cha `caption`.
...
Kipengele chako cha `tbody` kinapaswa kuwa chini kabisa ya kipengele chako cha `thead`.
