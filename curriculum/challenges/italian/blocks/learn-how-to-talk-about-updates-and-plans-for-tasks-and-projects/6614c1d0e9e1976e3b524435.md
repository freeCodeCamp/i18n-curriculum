...
In base alla risposta di Bob, cosa useranno per la presentazione?

## --answers--

Useranno una demo interattiva come suggerito da Sarah.

---

Rimarranno sul piano originale di usare una presentazione con slide.

### --feedback--

Bob è d'accordo con il suggerimento di Sarah di provare qualcosa di diverso, indicando un passaggio dalla presentazione con slide a una demo interattiva.

---

Combineranno sia una presentazione con slide sia una demo interattiva.

### --feedback--

Anche se combinare i metodi potrebbe essere una possibilità, l'accordo di Bob con Sarah suggerisce una preferenza per la sola demo interattiva.

---

Non hanno ancora deciso e ne discuteranno ulteriormente.

### --feedback--

L'affermazione di Bob `That's a great idea` indica accordo con il suggerimento di Sarah, implicando che la decisione è stata presa.
