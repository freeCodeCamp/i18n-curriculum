...
O valor em dólares pode ter mais de um algarismo. To match this, the `+` quantifier can be used - this matches one or more consecutive occurrences. Por exemplo, a expressão regular `/a+/` corresponde a um ou mais caracteres `a` consecutivos.
