...
1. Anexe um triângulo retângulo ao lado oposto à base, com a hipotenusa coincidindo com esse lado e com os lados na proporção 3-4-5. Observe que o lado menor do triângulo deve estar do lado 'right' em relação à base (veja a animação).
