...
Cuando los elementos HTML se colocan un nivel por debajo de otro, se les llama <dfn>children</dfn> de ese elemento. Por ejemplo, los elementos button en este desafío con el texto `#target1`, `#target2` y `#target3` son todos children del elemento `<div class="well" id="left-well">`.
