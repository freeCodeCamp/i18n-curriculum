...
У циклі `while` призначте `right_part[right_array_index]` `array[sorted_index]`.

# --hints--

У тілі циклу має бути `array[sorted_index] = right_part[right_array_index]`. Не забудьте видалити ключове слово `pass` у тілі циклу.
...
У циклі `pass` не повинно бути ключового слова `while`.
