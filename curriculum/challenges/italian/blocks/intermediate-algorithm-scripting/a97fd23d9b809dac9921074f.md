...
Crea una funzione che sommi due argomenti. Se viene fornito solo uno, allora restituisci una funzione che si aspetta un argomento e restituisce la somma.

Per esempio, `addTogether(2, 3)` dovrebbe restituire `5`, e `addTogether(2)` dovrebbe restituire una funzione.

Chiamando questa funzione restituita con un singolo argomento, otterrai la somma:
...
Se uno dei due argomenti non è un numero valido, restituisci undefined.
