...
Щоб користувач не надсилав форму, коли потрібна інформація відсутня, потрібно додати атрибут `required` до елемента `input`.
...
Немає потреби встановлювати значення для атрибута `required`. Замість цього, просто додайте слово `required` до елемента `input`, переконавшись, що між ним та іншими атрибутами є пробіл.
