...
Para usá-lo, dê a um elemento uma propriedade `display` de `flex`.Isso fará com que o elemento seja um <em>flex container</em>.Quaisquer filhos diretos de um contêiner flex são chamados de <em>flex items</em>.
