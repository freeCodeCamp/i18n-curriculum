...
Weka tamko lako la `password` la mabadiliko na mzunguko unaofuata wa `for` ndani ya mzunguko wa `while`. Tumia `True` kama sharti la mzunguko wako mpya.

# --hints--

Unapaswa kuunda mzunguko wa `while True` unaozunguka tamko lako la `password` lililopo na mzunguko wa `for`.
