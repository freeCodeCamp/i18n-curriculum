...
Це слово використовується, щоб висловити радість або задоволення чимось. Перша літера велика.
...
Цей дієслово вказує на володіння або переживання чогось.
...
Цей дієслово описує дію приєднання до групи.
...
Це слово додає наголос і може вводити виняток або протиставлення.
