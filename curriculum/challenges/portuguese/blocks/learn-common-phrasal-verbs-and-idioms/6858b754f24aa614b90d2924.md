...
Para encontrar a resposta correta, concentre-se no item `2. Custom Security Questions for Password Recovery`. Perguntas de Segurança Personalizadas para Recuperação de Senha` na lista da Linda.
