...
Modifique sua chamada `console.log` para registrar o valor selecionado no dropdown. 

Você pode acessar o valor atual de um elemento `select` usando sua propriedade `.value`. Por exemplo:
...
Você deve registrar o valor selecionado do dropdown quando um evento `change` for acionado em `selectContainer`.
