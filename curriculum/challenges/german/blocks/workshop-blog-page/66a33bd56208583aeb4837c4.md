...
Fügen Sie innerhalb des `footer`-Elements ein `section`-Element mit einem `id` hinzu, das auf `contact` gesetzt ist.

Fügen Sie innerhalb des `section`-Elements ein `h2`-Element mit dem Text von `Contact` hinzu.

# --hints--

Sie sollten ein `section`-Element innerhalb Ihres `footer`-Elements haben.
...
Ihr `section`-Element sollte ein `id` mit dem Wert `"contact"` haben.
...
Sie sollten ein `h2`-Element innerhalb Ihres `section`-Elements haben.
...
Ihr `h2`-Element sollte den Text von `Contact` enthalten.
