...
أنت الآن جاهز لبدء تجميع تخطيط الشبكة. توفر شبكة CSS تخطيطًا ثنائي الأبعاد قائمًا على الشبكة، مما يسمح لك بمحاذاة العناصر أفقيًا وعموديًا مع الاحتفاظ بالتحكم في أشياء مثل تداخل العناصر.
