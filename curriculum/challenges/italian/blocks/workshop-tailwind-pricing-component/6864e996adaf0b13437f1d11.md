...
Ora dovresti passare a stilizzare gli elementi per il **piano Listener**.

Assegna all'elemento esterno `div` per il piano le classi `bg-gray-100`, `ring-1` per creare un contorno spesso attorno a `div`, e `ring-gray-300` per assegnare un colore scuro a quel contorno.

# --hints--

Il tuo elemento `div` dovrebbe avere la classe `bg-gray-100`.
...
Il tuo elemento `div` dovrebbe avere la classe `ring-1`.
...
Il tuo elemento `div` dovrebbe avere la classe `ring-gray-300`.
