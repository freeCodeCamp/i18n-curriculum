...
Tengeneza kigezo cha `CDN_URL` na ukiseti kwa `https://cdn.freecodecamp.org/curriculum/typescript/tarot-app`. Pia tengeneza kigezo cha `defaultImg` chenye thamani ya `new URL("default.svg", import.meta.url)`, na kigezo cha `LOCAL_DEFAULT_IMG` chenye thamani ya `defaultImg`.
...
Kigezo chako cha `defaultImg` kinapaswa kusetwa kwa `new URL("default.svg", import.meta.url)`.
