...
Ця будівля матиме ще один трикутник зверху. Надайте верхній секції властивості `border-top` зі значенням `5vh solid transparent` та `border-left` зі значенням `8vw`, `solid` і яка використовує змінну кольору будівлі як колір.
