...
Después del último elemento `.divider`, cree un elemento `p` y asigne el texto `Total Fat 8g 10%`. Luego, envuelva el texto `Total Fat` en un elemento `span`, el texto `10%` en otro, y asígneles a cada uno una clase de `bold`.
