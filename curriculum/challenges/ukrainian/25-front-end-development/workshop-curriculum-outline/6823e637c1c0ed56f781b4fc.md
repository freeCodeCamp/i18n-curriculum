...
JavaScript робить вебсторінку інтерактивною: ця мова дозволяє повідомити, що робити, якщо хтось натисне на кнопку, надішле форму чи виконає іншу дію.

Це останній крок практичного заняття. Додайте по ще одному елементу `h3` та `p` з описом мови JavaScript.
