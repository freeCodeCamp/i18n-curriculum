...
Ahora reemplaza el contenido del callback del event listener.

Usa `querySelector` para encontrar el elemento `.count` dentro del botón.

Luego registra el contenido de texto del elemento `.count` cuando se haga clic en el botón.

# --hints--

Debes registrar el contenido de texto del elemento `.count` dentro del botón que se hizo clic.
