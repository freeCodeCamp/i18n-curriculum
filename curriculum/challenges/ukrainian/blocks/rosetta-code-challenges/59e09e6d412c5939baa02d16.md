...
title: Виконати алгоритм Маркова
challengeType: 1
forumTopicId: 302260
...
Концепції Маркова використовуються в машинному навчанні через простий підхід до маніпуляції даними. За допомогою заданої кількості `rules` ви можете маніпулювати наданим `data`, щоб створити бажаний `output`.

Ми додали у фоновому режимі:

`rules` у вигляді вкладеного масиву, а також `data` у вигляді масиву. І бажаний `outputs`.
...
Використовуючи алгоритм Маркова, змініть `data` на бажаний `outputs`, використовуючи наданий `rules`.
...
`markov(["_+1 -> _1+","1+1 -> 11+","1! -> !1",",! -> !+","_! -> _","1*1 -> x,@y","1x -> xX","X, -> 1,1","X1 -> 1X","_x -> _X",",x -> ,X","y1 -> 1y","y_ -> _","1@1 -> x,@y","1@_ -> @_",",@_ -> !_","++ -> +","_1 -> 1","1+_ -> 1","_+_ -> "],"_1111*11111_")` має повертати рядок `11111111111111111111`.
