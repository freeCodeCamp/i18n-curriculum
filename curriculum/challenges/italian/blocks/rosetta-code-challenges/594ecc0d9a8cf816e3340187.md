...
Un numero taxicab (la definizione usata qui) è un intero positivo che può essere espresso come somma di due cubi positivi in più di un modo.

Il primo numero taxicab è `1729`, che è:

1<sup>3</sup> + 12<sup>3</sup> e

9<sup>3</sup> + 10<sup>3</sup>.

I numeri taxicab sono anche conosciuti come:

<ul>
  <li>numeri taxi</li>
  <li>numeri taxi-cab</li>
  <li>numeri taxi cab</li>
  <li>numeri Hardy-Ramanujan</li>
</ul>

# --instructions--

Scrivi una funzione che restituisca i `n` numeri taxicab più bassi. Per ciascuno di questi numeri taxicab, mostra il numero stesso e i suoi cubi costituenti.
...
`taxicabNumbers(39)` i numeri risultanti da 20 a 29 dovrebbero essere [314496,320264,327763,373464,402597,439101,443889,513000,513856].
