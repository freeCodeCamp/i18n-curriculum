...
Comienza creando una función llamada `displayAuthors` que tome un parámetro `authors`. Luego, tu función debe recorrer el arreglo `authors` y agregar una tarjeta para cada autor al elemento `authorContainer`. 
