...
Prueba esto llamando a la función `displayStory` con el género `scary`. El color del borde debe ser `#ee4b2b` y la historia debe ser `"En el bosque oscuro, un grupo de amigos se encontró con una cabaña vieja y abandonada. "`. Entraron a la cabaña y despertaron algo malévolo que había estado dormido durante siglos.
...
Cuando llames a `displayStory("scary")`, la historia mostrada debe ser `"En el bosque oscuro, un grupo de amigos se encontró con una cabaña vieja y abandonada. "`. Entraron a la cabaña y despertaron algo malévolo que había estado dormido durante siglos.
