...
هذا يعني عدم وجود ما يكفي من شيء مطلوب.

# --explanation--

تعني عبارة `To be short on something` عدم وجود ما يكفي منه، مما يسبب صعوبات. على سبيل المثال:

`We're short on time, so we need to finish quickly.` - هذا يعني أن الوقت غير كافٍ لإكمال كل شيء.
