...
Reemplaza el nombre de jugador codificado `PELE` dentro de `card-name` por `player.name`.

# --hints--

Debes reemplazar el `PELE` codificado por `player.name` dentro de `.card-name`.
