...
Додайте кожному елементу `th` елемент `span` з класом `sr-only` і таким текстом, у такому порядку: `2019`, `2020` та `2021`.
...
Кожен із нових елементів `span` має мати атрибут `class` зі значенням `sr-only`.
