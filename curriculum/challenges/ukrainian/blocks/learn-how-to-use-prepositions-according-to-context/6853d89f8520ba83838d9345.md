...
Ця фраза з трьох слів означає «зараз» або «на даний момент».

# --explanation--

`At the moment` означає «на даний час». Наприклад:

`We don't need more testers at the moment.` – це означає, що зараз більше тестувальників не потрібно.
