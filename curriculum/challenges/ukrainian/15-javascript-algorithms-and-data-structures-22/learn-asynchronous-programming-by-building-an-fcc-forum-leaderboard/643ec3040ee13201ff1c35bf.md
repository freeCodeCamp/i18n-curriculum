...
Залиште другий елемент `td` порожнім, оскільки ви додасте до нього вміст пізніше.

У третьому елементі `td` додайте наступний вбудований вираз: `${posts_count - 1}`.

Це відобразить кількість відповідей на тему.

# --hints--

Третій елемент `td` повинен містити `${posts_count - 1}`.
