...
Katika kipengele chako cha kwanza cha `p`, ongeza kipengele cha `span`. Mpe `span` darasa la vitu la `product-count` na `id` ya `product-count-for-id${id}`. Kisha, baada ya span, mpe kipengele chako cha `p` maandishi ya mabadiliko ya `name`.

# --hints--

Kipengele chako cha kwanza cha `p` kinapaswa kuwa na kipengele cha `span`.
...
Kipengele chako cha `span` kinapaswa kuwa na `class` ya `product-count`.
...
Kipengele chako cha `span` kinapaswa kuwa na `id` ya `product-count-for-id${id}`.
...
Kipengele chako cha kwanza cha `p` kinapaswa kuwa na maandishi ya mabadiliko ya `name`. Hii inapaswa kuwa nje ya span.
