...
Usa el método `app.get()` para servir la cadena "Hello Express" a las solicitudes GET que coincidan con la ruta `/` (raíz). Asegúrate de que tu código funcione revisando los registros.
