...
Mantenha o segundo elemento `td` vazio porque você adicionará conteúdo a ele mais tarde. 

No terceiro elemento `td`, adicione a seguinte expressão embutida: `${posts_count - 1}`.

Isto exibirá o número de respostas ao tópico.

# --hints--

Você deve ter `${posts_count - 1}` dentro do terceiro elemento `td`.
