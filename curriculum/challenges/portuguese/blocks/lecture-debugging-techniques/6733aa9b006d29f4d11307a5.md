...
Um `RangeError` acontece quando seu código tenta usar um valor que está fora do intervalo que o JavaScript pode manipular. Aqui está um exemplo de atribuir um valor inválido ao comprimento de um array:
