...
Finalmente, calcula la `altura` del elemento `.ground` para que sea la altura de la ventana gráfica menos la altura del elemento `.penguin`.

¡Felicidades! Has completado el Taller de Flappy Penguin.

# --hints--

Debe dar a `.ground` una `altura` de `calc(100vh - 300px)`.
