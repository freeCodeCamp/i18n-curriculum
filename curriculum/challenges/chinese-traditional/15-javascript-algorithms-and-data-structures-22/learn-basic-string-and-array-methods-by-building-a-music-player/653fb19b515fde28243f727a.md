...
要在 UI（用戶界面）中顯示歌曲，你需要創建一個函數。

使用箭頭函數語法創建一個 `renderSongs` 函數，該函數以 `array` 作爲其參數。

# --hints--

你應該使用 `const` 創建一個名爲 `renderSongs` 的空函數。
