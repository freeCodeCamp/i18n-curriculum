...
بعد ذلك، ستنشئ نموذجًا يمكن للمستخدمين من خلاله البحث عن الفواكه. داخل عنصر `#search-container`، أنشئ عنصر `form`.

# --hints--

يجب أن يحتوي عنصر `search-container` على عنصر `form` بداخله.
