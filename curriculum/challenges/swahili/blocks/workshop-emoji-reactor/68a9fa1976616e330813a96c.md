...
Sasa tengeneza nafasi, ondoa vigezo vyote vya button na `eventListener` ulizotengeneza kwa kila moja.

# --hints--

Kigezo cha `happyBtn` hakipaswi kuwepo.
...
Kigezo cha `confusedBtn` hakipaswi kuwepo.
...
Kigezo cha `sadBtn` hakipaswi kuwepo.
...
Kigezo cha `lovingBtn` hakipaswi kuwepo.
