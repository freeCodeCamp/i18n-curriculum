...
Para asegurar que el texto ingresado en inputs y textareas, así como sus placeholders, sea visible, establece su color.

Selecciona `input, input::placeholder, textarea` y establece `color` en `whitesmoke`.

# --hints--

Debes apuntar a `input`, `input::placeholder`, `textarea`.
