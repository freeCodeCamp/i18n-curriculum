...
Атрибут зображення `alt` має описувати зображення. Читачі екрана повідомляють альтернативний текст замість зображень. Якщо зображення не завантажено, замість нього з’являється цей текст.

Щоб завершити проєкт, додайте атрибут `alt` до всіх дев’яти зображень котів, щоб описати їх. Використайте щонайменше п’ять символів для кожного значення.


# --hints--

Всі дев’ять ваших елементів `img` повинні мати атрибут `alt` з текстом, що описує кожне зображення, причому кожен опис повинен містити щонайменше `5` літер.
