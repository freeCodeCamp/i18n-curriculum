...
Adicione outro `input` do tipo checkbox com os atributos `id`, `name` e `value` definidos como `"recommendation"`.
...
Sua `input` de checkbox deve ter um atributo `name` definido como `"recommendation"`.
