...
<a href="https://www.freecodecamp.org/news/html-elements-explained-what-are-html-tags/#em-element" target="_blank" rel="noopener noreferrer nofollow">Consulta nuestro artículo de noticias sobre &lt;em&gt;</a> para aprender la diferencia entre `<i>` y `<em>` y sus usos.

Ten en cuenta que, aunque la etiqueta `<i>` se ha utilizado tradicionalmente para enfatizar texto, desde entonces se ha adoptado para usarse como etiqueta para íconos. La etiqueta `<em>` ahora es ampliamente aceptada como la etiqueta para énfasis. Cualquiera de las dos funcionará para este desafío.
