...
Weka `background-color` ya kipengele cha `.two` kuwa `#8f0401`.

# --hints--

Unapaswa kuweka sifa ya `background-color` kuwa `#8f0401`.
...
Kipengele chako cha `.two` kinapaswa kuwa na thamani ya `background-color` ya `#8f0401`.
