...
This word is used to show agreement or willingness to help. La primer letra se escribe en mayúscula.
...
`Sure` is a word used to show agreement or permission. Por ejemplo:

`Sure, I can help you with that.` – This means the speaker agrees or is willing to help.

`What` is a question word used to ask for information. Por ejemplo:

`What is your name?` – This means the speaker wants to know a specific detail.

`Choices` refers to the different options available. Por ejemplo:
