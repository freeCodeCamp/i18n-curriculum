...
Declare uma variável `regex` e atribua a ela o valor a partir do exemplo acima. In future steps, you will update this regex pattern to match specific characters needed for the calorie counter.
