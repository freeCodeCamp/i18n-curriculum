...
最后，修改 `linear-gradient` 函数中的第三个颜色参数，目前是纯蓝色。

更新 `rgb` 函数，红色的值为 `162`，绿色的值为 `27`，蓝色的值为 `27`。

# --hints--

你的 `.red` CSS 规则应该有一个 `background` 属性，设置为 `linear-gradient(180deg, rgb(122, 74, 14) 0%, rgb(245, 62, 113) 50%, rgb(162, 27, 27) 100%)`。
