...
Coloque o texto `Est. 2020` em itálico, criando um seletor de classe chamado `established` e atribua-lhe a propriedade `font-style` com o valor `italic`.

# --hints--

Você deve usar um seletor `.established`.
...
Você deve definir a propriedade `font-style` para `italic`.
...
O seletor `.established` deve definir a propriedade `font-style` para `italic`.
