...
Vamos considerar um botão de call-to-action (CTA). CTAs são usados para incentivar os usuários a realizar uma ação específica, como se inscrever em uma newsletter ou fazer uma compra.
...
- **Macro** espaço em branco é o espaço entre elementos maiores como imagens, blocos de texto e botões.
- **Ativo** espaço em branco é o espaço criado intencionalmente para ajudar a guiar o olhar do usuário e chamar atenção para certos elementos na página.
- **Passivo** espaço em branco é o espaço que sobra depois que todos os elementos em uma página foram posicionados.
- **Micro** espaço em branco é o espaço entre caracteres individuais em uma linha de texto.
