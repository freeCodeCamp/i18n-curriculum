...
بعد إنشاء المتغير، يمكنك تعيين قيمته إلى خصائص CSS أخرى بالإشارة إلى الاسم الذي أعطيته له.

```css
background: var(--penguin-skin);
```

سيغير هذا خلفية أي عنصر تستهدفه إلى اللون الرمادي لأن هذه هي قيمة المتغير `--penguin-skin`. لاحظ أن الأنماط لن تُطبق إلا إذا كانت أسماء المتغيرات مطابقة تمامًا.

# --instructions--

طبّق المتغير `--penguin-skin` على خاصية `background` في الأصناف `penguin-top` و`penguin-bottom` و`right-hand` و`left-hand`.

# --hints--

يجب تطبيق المتغير `--penguin-skin` على خاصية `background` في الصنف `penguin-top`.
...
يجب تطبيق المتغير `--penguin-skin` على خاصية `background` في الصنف `penguin-bottom`.
...
يجب تطبيق المتغير `--penguin-skin` على خاصية `background` في الصنف `right-hand`.
...
يجب تطبيق المتغير `--penguin-skin` على خاصية `background` في الصنف `left-hand`.
