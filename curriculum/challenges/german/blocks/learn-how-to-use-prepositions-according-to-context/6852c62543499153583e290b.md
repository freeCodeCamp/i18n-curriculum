...
Was schlägt Bob vor, nachdem die Teamleiter den Plan bestätigt haben?

## --answers--

Beginnen Sie sofort damit, die Teams an ihre neuen Plätze zu verlegen.

### --feedback--

Der nächste Schritt betrifft die Kommunikation, nicht das Umziehen.

---

Bitten Sie die Kunden um weiteres Feedback.

### --feedback--

Kunden werden nicht erwähnt; dies ist ein interner Layout-Plan.

---

Senden Sie den endgültigen Plan und den Zeitplan an alle Mitarbeitenden.

---

Beginnen Sie mit dem Bau im neuen Büro.

### --feedback--

Es wird kein Bau erwähnt.
...
Bob sagt, dass sie, sobald die Teamleiter die Platzierungen bestätigt haben, `send out the final layout and timeline to all staff` können. Das zeigt, dass Kommunikation der nächste Schritt ist.

Konzentrieren Sie sich auf den Satz, der mit `Once confirmed` beginnt.
