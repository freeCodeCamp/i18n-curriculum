...
Sasa unahitaji kuonyesha taarifa fulani kuhusu mwandishi. Kwanza, onyesha jina la mwandishi.

Tengeneza lebo ya `h2` yenye `class` `"author-name"`. Kisha, weka `author` ndani ya lebo ya `h2`. Hii ni jina la mwandishi.
...
Kipengele chako cha `h2` kinapaswa kuwa na darasa la vitu lililowekwa kuwa `"author-name"`
...
Unapaswa kuweka `author` ndani ya lebo yako ya `h2` ili kuonyesha majina ya waandishi
