...
Повертаючись до класу `MediaCatalogue`, додайте до нього докстрінг із текстом `A catalogue that can store different types of media items.`

# --hints--

Ви повинні додати докстрінг `A catalogue that can store different types of media items.` до свого класу `MediaCatalogue`.
