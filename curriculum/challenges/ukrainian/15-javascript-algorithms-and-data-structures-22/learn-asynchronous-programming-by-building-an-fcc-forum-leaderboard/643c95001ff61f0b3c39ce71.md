...
В межах методу `map` деструктуруйте такі властивості з об’єкта `item`:
...
Деструктуруйте властивості `id`, `title`, `views`, `posts_count`, `slug`, `posters`, `category_id`, `bumped_at` з об’єкта `item`.
