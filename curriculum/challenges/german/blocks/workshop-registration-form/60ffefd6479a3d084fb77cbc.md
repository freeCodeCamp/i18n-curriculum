...
Machen Sie das `input` für die Allgemeinen Geschäftsbedingungen `inline`, indem Sie die passende Klasse im HTML hinzufügen.


# --hints--

Sie sollten dem `input` die Klasse `inline` geben.
