...
Dentro de la consulta `@media`, agregue un selector `.keys` y establezca el `ancho` en `318px`.

# --hints--


Su regla `@media` debe tener un selector `.keys`.
...
Su nuevo selector `.keys` debe tener un `ancho` de `318px`.
