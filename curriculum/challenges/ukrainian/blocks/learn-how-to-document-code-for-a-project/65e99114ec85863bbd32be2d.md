...
У вислові Софі вводиться факт про використання Git для контролю версій.
...
Це слово використовується, щоб запитати про метод або процес документування змін у коді в Git.
...
Це слово стосується часу, у цьому випадку запитує про момент внесення оновлень або виправлень для документування змін.
