...
A good way to test that everything is working is to log the `value` attribute of `numberInput` to the console. Zur Erinnerung: Du kannst auf das `value`-Attribut eines Elements zugreifen, indem du die Punkt- oder Klammer-Notation verwendest.
