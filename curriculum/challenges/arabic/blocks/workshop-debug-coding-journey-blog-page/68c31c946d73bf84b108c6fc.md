...
بما أن القسم الكامل الذي يحتوي على منشورات المدونة يمثل المحتوى الرئيسي للصفحة، يجب تغليفه بعنصر `main`. هذا يساعد قارئ الشاشة والتقنيات المساعدة الأخرى على فهم بنية الصفحة بشكل أفضل.
...
يجب أن يحتوي عنصر `main` على جميع عناصر `article` الثلاثة.
