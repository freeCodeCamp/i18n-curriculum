...
Тепер настав час протестувати вашу функцію.

Додайте `console.log()` під вашою функцією `getBooksByAuthor()`.

Всередині `console.log()` викличте функцію `getBooksByAuthor()` з аргументами `library` та `"Arvid Kahl"`.

Тепер у консолі ви повинні побачити всі книги цього конкретного автора.

# --hints--

У вас має бути `console.log(getBooksByAuthor(library, "Arvid Kahl"))`.
