...
Спочатку використайте метод `document.getElementById()`, щоб вибрати елемент з id `animation-container` та призначте його до змінної під назвою `animationContainer`.

# --hints--

Використайте метод `document.getElementById()`, щоб отримати елемент `#animation-container`.
