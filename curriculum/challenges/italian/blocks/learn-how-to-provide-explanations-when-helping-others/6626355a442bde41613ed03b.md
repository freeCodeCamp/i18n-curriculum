...
Si riferisce all'azione di cliccare con il tasto destro del mouse.
...
In questo contesto, è un'opzione per visualizzare informazioni dettagliate sull'hard disk. Scrivila con la lettera maiuscola.
...
Descrive lo spazio che non è ancora utilizzato e che è libero per memorizzare dati.
