...
Wechseln Sie zum `h2` innerhalb des **Listener-Plans** und geben Sie ihm die Utility-Klasse `text-lg`, um es größer zu machen, `font-semibold`, um es fetter zu machen, und `text-indigo-600`, um ihm eine schöne indigoblaue Farbe zu verleihen.

# --hints--

Ihr `h2`-Element sollte die Klasse `text-lg` haben.
...
Ihr `h2`-Element sollte die Klasse `font-semibold` haben.
...
Ihr `h2`-Element sollte die Klasse `text-indigo-600` haben.
