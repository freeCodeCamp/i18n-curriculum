...
title: 'Aufgabe 79: Ableitung des Zugangscodes'
challengeType: 1
forumTopicId: 302192
...
Eine gängige Sicherheitsmethode beim Online-Banking besteht darin, den Benutzer nach drei zufälligen Zeichen eines Zugangscodes zu fragen. Wenn der Zugangscode zum Beispiel `531278` lautet, könnten sie nach dem 2., 3. und 5. Zeichen fragen; die erwartete Antwort wäre: `317`.

Die Arrays `keylog1`, `keylog2` und `keylog3` enthalten fünfzig erfolgreiche Anmeldeversuche.

Da die drei Zeichen immer in der Reihenfolge abgefragt werden, analysieren Sie das Array, um den kürzestmöglichen geheimen Zugangscode unbekannter Länge zu bestimmen.
