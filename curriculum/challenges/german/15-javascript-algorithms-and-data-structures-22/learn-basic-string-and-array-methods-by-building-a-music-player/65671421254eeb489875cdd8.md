...
Innerhalb der Rückruffunktion, verwende die `removeAttribute()` Methode, um das `"aria-current"` Attribut zu entfernen. Dadurch wird das Attribut für jeden der Songs entfernt.
