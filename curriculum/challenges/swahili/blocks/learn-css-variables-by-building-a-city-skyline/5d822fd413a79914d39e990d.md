...
Panga ndani vipengele vinne vipya vya `div` ndani ya `.bb4c`, uwape wote darasa la `bb4-window`. Hivi vitakuwa madirisha ya jengo hili.
...
Unapaswa kumpa kila `div` mpya darasa la `bb4-window`.
