...
Fügen Sie dem `profiles`-Array zwei weitere Objekte hinzu – eines für Tiffany und eines für Doug:
...
Ihre `map()`-Logik sollte unverändert bleiben und jetzt alle drei Karten rendern.

Damit ist Ihr wiederverwendbares Profilkarten-Komponenten-Projekt abgeschlossen!

# --hints--

Sie sollten genau drei `Card`-Komponenten rendern.
