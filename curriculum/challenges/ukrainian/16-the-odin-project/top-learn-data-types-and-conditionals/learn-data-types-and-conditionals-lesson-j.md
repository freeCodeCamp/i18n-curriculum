...
title: Вивчіть типи даних та умови. Урок №10
challengeType: 15
...
Вам потрібно написати інструкцію `if`, яка перевіряє наступні умови у вебзастосунку, щоб відтворити `Welcome!` для користувача:
