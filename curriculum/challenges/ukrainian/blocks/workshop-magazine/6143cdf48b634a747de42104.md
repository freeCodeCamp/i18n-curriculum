...
У межах вашого `.image-wrapper` елемента надайте третьому `img` елементу `src` зі значенням `https://cdn.freecodecamp.org/testable-projects-fcc/images/survey-form-background.jpeg`, `alt` зі значенням `four people working on code`, атрибут `loading` зі значенням `lazy`, множину `class`, встановлену на `image-3`, атрибут `width`, встановлений на `600`, і атрибут `height`, встановлений на `400`.

# --hints--

Ваш третій `img` елемент має мати `src`, встановлений на `https://cdn.freecodecamp.org/testable-projects-fcc/images/survey-form-background.jpeg`.
...
Ваш третій `img` елемент має мати атрибут `alt`, встановлений на `four people working on code`.
...
Ваш третій `img` елемент має мати атрибут `loading`, встановлений на `lazy`.
...
Ваш третій `img` елемент має мати `class`, встановлений на `image-3`.
...
Ваш третій `img` елемент має мати атрибут `width`, встановлений на `600`.
...
Ваш третій `img` елемент має мати атрибут `height`, встановлений на `400`.
