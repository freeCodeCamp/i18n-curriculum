...
Дотримуючись найкращих практик для вхідних даних форми, надайте кожному `input` відповідний `type` та атрибут `name`. Потім надайте першому `input` атрибут `placeholder`.
