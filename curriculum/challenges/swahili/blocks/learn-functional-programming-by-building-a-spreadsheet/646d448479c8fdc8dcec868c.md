...
Tangaza kigezo cha `functionCall`, na weka thamani yake usemi wa kawaida huu: `/([a-z0-9]*)\(([0-9., ]*)\)(?!.*\()/i`

Usemi huu utaangalia wito za kitendakazi kama `sum(1, 4)`.

# --hints--

Unapaswa kutangaza kigezo cha `functionCall`.
...
Unapaswa kutumia `const` kutangaza kigezo chako cha `functionCall`.
...
Unapaswa kuweka thamani ya `functionCall` kuwa usemi wa kawaida uliotolewa.
