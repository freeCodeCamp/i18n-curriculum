...
Використовуйте лише один елемент `h1` на сторінці та розмістіть заголовки меншої важливості під заголовками вищої важливості.
...
Your `h2` element's text should be `Cat Photos`. Розмістіть текст `Cat Photos` між початковими та кінцевими тегами `h2`.
