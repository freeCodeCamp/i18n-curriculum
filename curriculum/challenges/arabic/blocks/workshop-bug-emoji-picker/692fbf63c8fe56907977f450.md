...
بعد ذلك، عرّف كائنًا باسم `bugMap` من النوع `Record<string, Bug<string>>` وقم بتعيينه إلى كائن فارغ في الوقت الحالي.

# --hints--

يجب أن يكون لديك ثابت باسم `bugMap`.
...
يجب أن يحتوي `bugMap` على توضيح نوع من `Record<string, Bug<string>>`.
...
يجب تهيئة `bugMap` إلى كائن فارغ.
