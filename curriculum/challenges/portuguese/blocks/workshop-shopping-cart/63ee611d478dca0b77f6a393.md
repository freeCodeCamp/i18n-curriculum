...
Você aprendeu em uma palestra anterior que a palavra-chave `this` se refere à instância atual que está sendo construída, como viu no construtor `Dessert`. Aqui, você aplicará a mesma ideia na classe `ShoppingCart`.
...
No seu construtor, use a palavra-chave `this` para definir a propriedade `items` como um array vazio. Também defina a propriedade `total` como `0` e a propriedade `taxRate` como `8.25`.

# --hints--

Você deve usar a palavra-chave `this` para definir a propriedade `items` da sua classe como um array vazio.
...
Você deve usar a palavra-chave `this` para definir a propriedade `total` da sua classe como `0`.
...
Você deve usar a palavra-chave `this` para definir a propriedade `taxRate` da sua classe como `8.25`.
