...
Ili kuboresha uzoefu wa mtumizi, utataka kuboresha nambari ya simu ili watumizi wabofye na kuanzisha wito.

Hivi ndivyo unavyoweza kufanya nambari za simu ziwe zinazoweza kubofywa:

```html
<a href="tel:2345678912">234-567-8912</a>
```

Zungusha maandishi `555-555-5555` katika kipengele cha nanga na tumia `tel:` ili kuifanya iwe nambari ya simu inayoweza kubofywa.

# --hints--

Unapaswa kuzungusha maandishi `555-555-5555` katika kipengele cha `a`.
...
Kipengele chako cha `a` kinapaswa kuwa na sifa ya kipengele ya `href`.
...
Sifa ya kipengele `href` kwa kipengele chako kipya cha `a` inapaswa kuwekwa kuwa `tel:5555555555`.
