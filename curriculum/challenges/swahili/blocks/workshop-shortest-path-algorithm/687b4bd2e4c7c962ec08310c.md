...
Sasa utaonyesha kuwa kitendakazi chako kinafanya kazi. Mwishoni mwa programu yako, fanya wito wa kitendakazi chako `shortest_path` ukiwa na `adj_matrix` na `start_node` ya `0` pamoja na `target_node` ya `5` kama hoja.

Kwa hiyo, algoriti ya njia fupi imekamilika!

# --hints--

Unapaswa kufanya wito wa kitendakazi `shortest_path` ukiwa na hoja tatu: `adj_matrix`, `0`, na `5`.
