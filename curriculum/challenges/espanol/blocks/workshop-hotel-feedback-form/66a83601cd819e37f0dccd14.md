...
Debajo de su elemento `h1`, agregue un elemento `p`. El texto del elemento <code>p` debe ser `Thank you for staying with us. Please provide feedback on your recent stay.`
...
Su elemento de párrafo debe tener el texto <code>Thank you for staying with us. Please provide feedback on your recent stay.`
