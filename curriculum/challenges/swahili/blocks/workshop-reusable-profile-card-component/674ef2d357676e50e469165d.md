...
Tena, tumia sehemu ya `Card` mara mbili zaidi na yafuatayo:

| Vigezo  | Thamani za Kadi ya Kwanza | Thamani za Kadi ya Pili |
|-------|------------------------------------------------------------|-----------------------------------------------------|
| `name`  | `"Tiffany"` | `"Doug"`|
...
Haupasi kubadilisha sehemu ya `Card` iliyopo ndani ya sehemu yako ya `App`.
...
Unapaswa kutumia sehemu ya `Card` kama kipengele chenye vigezo vinavyofaa na thamani za kadi ya kwanza.
...
Unapaswa kutumia sehemu ya `Card` kama kipengele chenye vigezo vinavyofaa na thamani za kadi ya pili.
