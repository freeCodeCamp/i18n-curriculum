...
Dai all'elemento `.ground` un `background` con un gradiente lineare inclinato di 90 gradi in senso orario, che parte da `rgb(88, 175, 236)` e termina a `rgb(182, 255, 255)`.

# --hints--

Dovresti dare a `.ground` un `background` di `linear-gradient(90deg, rgb(88, 175, 236), rgb(182, 255, 255))`.
