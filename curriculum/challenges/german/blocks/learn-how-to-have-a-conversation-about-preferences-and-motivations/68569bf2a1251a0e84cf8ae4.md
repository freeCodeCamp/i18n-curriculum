...
`enthusiasm`, `passion`, `the most`, `gadgets`, `these days` und `connected`.
...
Kleine elektronische Geräte wie Telefone oder Smartwatches.
...
Ein starkes Gefühl von Aufregung und Interesse an etwas.
...
Das bedeutet, in Kontakt oder Kommunikation mit anderen zu sein.
...
Wird verwendet, um das höchste Niveau oder die größte Menge von etwas zu zeigen.
...
Das bedeutet jetzt oder in der Gegenwart.
...
Eine starke Liebe oder Interesse daran, etwas zu tun.
