...
استبدل الآن محتوى استدعاء راجع مستمع الحدث.

استخدم `querySelector` للعثور على عنصر `.count` داخل الزر.

ثم سجّل محتوى النص لعنصر `.count` عند نقر الزر.

# --hints--

يجب أن تسجل محتوى النص لعنصر `.count` داخل الزر الذي تم النقر عليه.
