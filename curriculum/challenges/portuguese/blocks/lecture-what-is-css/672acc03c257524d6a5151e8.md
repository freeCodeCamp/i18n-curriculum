...
A propriedade `width` especifica a largura de um elemento. Se você não especificar uma largura, o padrão será definido como `auto`. Isso significa que o elemento ocupará toda a largura do seu contêiner pai.
