...
Всередині функції `playSong` встановіть властивість `audio.src` рівною `song.src`. Це вказує аудіоелементу, де знайти аудіодані для вибраної пісні.

Також встановіть властивість `audio.title` рівною `song.title`. Це вказує аудіоелементу, що відображати як назву пісні.

# --hints--

Ви не повинні змінювати існуючу функцію `playSong` та її вміст.
...
Ви повинні встановити `audio.src` у `song.src`.
...
Ви повинні встановити `audio.title` у `song.title`.
