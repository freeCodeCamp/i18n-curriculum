...
Оголосіть змінну `currValue` і призначте їй значення `array[i]`. Потім оголосіть змінну `j` і призначте їй `i - 1`. Ваша змінна `j` має бути такою, що її можна переназначати.

# --hints--

Ви маєте оголосити змінну `currValue` за допомогою `const`.
...
Ви маєте призначити `currValue` значення `array[i]`.
...
Ви маєте оголосити змінну `j` за допомогою `let`.
...
Ви маєте призначити `j` значення `i - 1`.
