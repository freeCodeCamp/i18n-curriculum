...
title: crea un pulsante bootstrap
challengeType: 0
forumTopicId: 16811
...
Bootstrap ha i suoi stili per gli elementi `button`, che sono molto più belli di quelli HTML semplici.

Crea un nuovo elemento `button` sotto la tua grande foto del gattino. Dagli le classi `btn` e `btn-default`, oltre al testo `Like`.
