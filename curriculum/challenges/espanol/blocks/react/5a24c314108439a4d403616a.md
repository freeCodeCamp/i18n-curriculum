...
Esto unirá todos los elementos del arreglo `colors` en una cadena separada por comas y producirá: `<p>green, blue, red</p>`. Más adelante, aprenderemos sobre otros métodos comunes para renderizar arreglos de datos en React.
