...
يشرح جيك سبب زيارته لسارة. هو هناك ليسلمها شيئًا تحتاج إليه، سيسمح لها بوصول إلى بعض المساحات.
...
هذه الكلمة تدل على أن الشيء يخصك.
...
هذا الاسم يعني القدرة على الدخول إلى شيء أو استخدامه.
...
هذا الاسم يعني جسمًا بلاستيكيًا صغيرًا يُستخدم للتعريف أو الدخول.
