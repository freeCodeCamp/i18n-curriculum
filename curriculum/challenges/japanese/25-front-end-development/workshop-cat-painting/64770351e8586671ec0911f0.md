...
**Note**: To see how `sticky` works, you have to place a couple of texts before and after your `.cat-head` `div` element. その状態でページ下部へスクロールしていくと、`.cat-head` の要素が上端にくっ付いて残るのがわかります。
