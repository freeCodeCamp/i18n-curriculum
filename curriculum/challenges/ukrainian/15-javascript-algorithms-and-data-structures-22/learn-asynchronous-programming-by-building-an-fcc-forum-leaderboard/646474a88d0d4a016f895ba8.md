...
Для решти кроків ви додасте функціональність показу аватарів користувачів.

В межах другого елемента `td` додайте елемент `div` з назвою класу `"avatar-container"`.

# --hints--

Другий елемент `td` повинен містити елемент `div`.
...
Початковий тег `div` повинен мати атрибут class зі значенням `"avatar-container"`.
