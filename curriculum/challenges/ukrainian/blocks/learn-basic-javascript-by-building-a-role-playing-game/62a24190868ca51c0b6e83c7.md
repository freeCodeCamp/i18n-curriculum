...
Поки що сховайте свій `#monsterStats` елемент за допомогою властивості `display`. Не змінюйте жодних інших стилів.

# --hints--

У вас має бути селектор `#monsterStats`.
...
Ваш селектор `#monsterStats` має мати властивість `display` зі значенням `none`.
...
Ваш селектор `#monsterStats` має мати `border` зі значенням `1px solid #0a0a23`.
...
Ваш селектор `#monsterStats` має мати `5px` відступу.
...
Ваш селектор `#monsterStats` має мати властивість `color` зі значенням `#ffffff`.
...
Ваш селектор `#monsterStats` має мати властивість `background-color` зі значенням `#c70d0d`.
