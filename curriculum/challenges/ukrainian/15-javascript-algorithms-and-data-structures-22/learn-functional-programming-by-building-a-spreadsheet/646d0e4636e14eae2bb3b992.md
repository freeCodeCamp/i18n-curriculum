...
Тепер оновіть найглибшу функцію в ланцюжку `addCharacters`, щоб неявно повернути результат виклику `charRange()` з `character1` та `character2` як аргументами.

# --hints--

Найбільш внутрішня функція має використовувати неявне повернення.
...
Найглибша функція має повернути результат виклику `charRange()`.
...
Передайте `character1` як перший аргумент до виклику `charRange()`.
...
Передайте `character2` як другий аргумент до виклику `charRange()`.
