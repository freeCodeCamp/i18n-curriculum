...
Bado ndani ya darasa la `Bug`, tangaza sifa iitwayo `emojiElement` yenye aina ya `HTMLParagraphElement`. Sifa hii itahifadhi rejea kwa kipengele cha aya cha HTML ambacho hitilafu ya emoji itaonyeshwa.

# --hints--

Darasa lako la `Bug` linapaswa kuwa na sifa iitwayo `emojiElement`.
...
Sifa yako ya `emojiElement` inapaswa kuwa na aina ya `HTMLParagraphElement`.
...
Sifa yako ya `emojiElement` inapaswa kutumia kielezi cha uthibitisho wa mgawo wa thamani (`!`).
