...
Panga mtindo wa maandishi ndani ya kipengele chako cha `#years` kwa kuunda kichaguzi cha `#years span[class]`. Sintaksia ya `span[class]` itawalenga vipengele vyovyote vya `span` ambavyo vina sifa ya kipengele ya `class` iliyowekwa, bila kujali thamani ya sifa hiyo.

Toa fonti ya `bold` kwa kichaguzi chako kipya, upana wa `4.5rem`, na maandishi yakawekwa upande wa kulia.
