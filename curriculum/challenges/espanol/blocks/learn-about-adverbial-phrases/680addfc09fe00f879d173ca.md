...
`To reach the target` means to successfully achieve a planned goal or result, especially one that has been set in advance. This is often used in business, marketing, or sales. Por ejemplo:
