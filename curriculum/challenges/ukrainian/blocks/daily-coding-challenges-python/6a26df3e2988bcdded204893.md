...
`get_food_chain([["cat", "mouse"]])` має повернути `["cat", "mouse"]`.
...
`get_food_chain([["wolf", "deer"], ["deer", "grass"]])` має повернути `["wolf", "deer", "grass"]`.
...
`get_food_chain([["hawk", "snake"], ["snake", "frog"], ["frog", "fly"]])` має повернути `["hawk", "snake", "frog", "fly"]`.
...
`get_food_chain([["rabbit", "grass"], ["fox", "rabbit"], ["eagle", "fox"]])` має повернути `["eagle", "fox", "rabbit", "grass"]`.
...
`get_food_chain([["seal", "salmon"], ["herring", "shrimp"], ["orca", "seal"], ["shrimp", "plankton"], ["salmon", "herring"]])` має повернути `["orca", "seal", "salmon", "herring", "shrimp", "plankton"]`.
