...
Cree una nueva variable debajo de las otras llamadas `--building-color3` y asígnale un valor de `#cc6699`. Luego úsela como el `background-color` de la clase `.bb3` y déle un valor de respaldo de `pink`.

# --hints--

Debe definir una nueva variable de propiedad llamada `--building-color3`.
...
Debe establecer el `background-color` usando la variable `--building-color3` con un respaldo de `pink`.
