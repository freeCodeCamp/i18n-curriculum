...
Como o estilo do estado de erro deve se relacionar com o estilo do estado de foco?

#### --distractors--

Eles devem ser idênticos para consistência.

---

O estado de erro deve ser menos visível para evitar alarmar os usuários.

---

O estado de erro deve ser animado enquanto o estado de foco deve ser estático.

#### --answer--

O estado de erro deve ser distinto do estado de foco.
