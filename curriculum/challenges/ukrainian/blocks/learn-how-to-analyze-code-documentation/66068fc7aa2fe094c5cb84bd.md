...
Скорочена форма `I will`. Софі обіцяє, що дотримуватиметься кроків.
...
Займенник, який вказує на конкретні речі (у цьому випадку кроки, згадані раніше).
...
Використовується для окремих предметів. Софі планує дотримуватись кроків для кожної функції.
