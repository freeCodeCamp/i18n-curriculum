...
接下来，添加另一个复选框 `input`，其 `id` 和 `value` 属性设置为 `"location"`，`name` 属性设置为 `"choice"`。

此 `label` 元素的文本为 `Location`， `for` 属性应设置为 `"location"`。

在那个 `label` 元素下，添加另一个复选框 `input`，其 `id` 和 `value` 属性设置为 `"reputation"`，`name` 属性设置为 `"choice"`。
...
你的第三个复选框 `input` 应该有一个 `name` 属性设置为 `"choice"`。
...
你的第四个复选框 `input` 应该有一个 `name` 属性设置为 `"choice"`。
