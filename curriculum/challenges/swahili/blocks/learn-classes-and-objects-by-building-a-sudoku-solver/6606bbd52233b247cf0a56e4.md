...
Sasa, geuza `1` uliyobadilisha awali kurudi kuwa `0` ili kurejesha mpangilio wa awali wa bodi. Kisha, futa wito wako wa `print`.

# --hints--

Unapaswa kugeuza kipengee cha kwanza cha orodha ya kwanza ya `puzzle` kurudi kuwa sifuri.
...
Haupaswi kuwa na `print(gameboard.find_empty_cell())` katika msimbo wako.
