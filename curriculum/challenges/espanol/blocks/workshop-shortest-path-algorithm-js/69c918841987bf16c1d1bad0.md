...
La función debe devolver los datos calculados para que quienes la llamen puedan usarlos de forma programática.

Después del ciclo `for...of`, agrega una instrucción `return` que devuelva un arreglo que contenga `distances` y `paths`, en ese orden.

# --hints--

Debes devolver `[distances, paths]` después del ciclo `for...of`.
