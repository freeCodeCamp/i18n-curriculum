...
Katika kitendakazi chako cha `elemValue`, ulitangaza waziwazi kitendakazi kinachoitwa `inner` na ukarudisha. Hata hivyo, kwa sababu unatumia sintaksia ya mshale, unaweza kurudisha kitendakazi moja kwa moja bila ya kuvitangaza. Kwa mfano:

```js
const curry = soup => veggies => {};
```

`curry` ni kitendakazi kinachopokea kigezo cha `soup` na kurudisha kitendakazi kinachopokea kigezo cha `veggies`. Kwa kutumia sintaksia hii, sasisha kitendakazi chako cha `addCharacters` kurudisha kitendakazi tupu kinachopokea kigezo cha `character2`.

# --hints--

Kitendakazi chako cha `addCharacters` kinapaswa kutumia kurudisha moja kwa moja.
...
Kitendakazi chako cha `addCharacters` kinapaswa kurudisha kitendakazi cha mshale chenye kigezo cha `character2`.
...
Kitendakazi chako cha mshale cha ndani kinapaswa kuwa tupu.
