...
بعد استدعاء `print()`، استدعِ الدالة `print_expenses` لعرض جميع المصاريف التي أُضيفت حتى الآن. مرر قائمة `expenses` كمعلمة.

# --hints--

يجب استدعاء الدالة `print_expenses()` داخل بند `elif` الخاص بك.
...
يجب تمرير قائمة `expenses` كمعلمة عند استدعاء الدالة `print_expenses()`.
