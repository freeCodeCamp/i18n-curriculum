...
Para cada inteiro $p > 1$ coprimo com 10 existe um multiplicador positivo de divisibilidade $m &lt; p$ que preserva a divisibilidade por $p$ para a seguinte função em qualquer inteiro positivo, $n$:
