...
Para inteiros $a$ e $b$, definimos $D(a, b)$ como o domínio delimitado pela parábola $y = x^2$ e a reta $y = ax + b: D(a, b) = \{ (x, y) | x^2 ≤ y ≤ ax + b \}$.
...
Podemos verificar que $S(5) = 344$ e $S(100) = 26\,709\,528$.
