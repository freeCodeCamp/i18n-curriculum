...
Você deve adicionar um seletor de `:root` à media query.
...
Você deve dar a `--building-color1` um valor de `#000`.
...
Você deve dar a `--building-color2` um valor de `#000`.
...
Você deve dar a `--building-color3` um valor de `#000`.
...
Você deve dar a `--building-color4` um valor de `#000`.
