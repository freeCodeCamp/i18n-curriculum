...
残りのステップでは、ユーザーのアバターを表示する機能を追加します。

2番目の`td`要素の中に、クラス名が`div`の`"avatar-container"`要素を追加してください。

# --hints--

2番目の`div`要素の中に`td`要素があるはずです。
...
開始タグの`div`には、クラス属性として`"avatar-container"`の値が設定されている必要があります。
