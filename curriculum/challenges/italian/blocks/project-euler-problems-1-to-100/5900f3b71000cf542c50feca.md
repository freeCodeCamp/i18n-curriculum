...
title: 'Problema 75: triangoli rettangoli con lati interi unici'
challengeType: 1
forumTopicId: 302188
...
Si scopre che 12 cm è la lunghezza minima di filo che può essere piegato per formare un triangolo rettangolo con lati interi in esattamente un modo, ma ci sono molti altri esempi.
...
Al contrario, alcune lunghezze di filo, come 20 cm, non possono essere piegate per formare un triangolo rettangolo con lati interi, e altre lunghezze permettono di trovare più di una soluzione; per esempio, usando 120 cm è possibile formare esattamente tre triangoli rettangoli con lati interi diversi.

<div style='margin-left: 4em;'>
  <strong>120 cm:</strong> (30,40,50), (20,48,52), (24,45,51)<br><br>
</div>

Dato che L è la lunghezza del filo, per quanti valori di L ≤ `n` si può formare esattamente un triangolo rettangolo con lati interi?
