...
Puedes añadir imágenes a tu sitio web utilizando el elemento `img`. Los elementos `img` tienen una etiqueta de apertura sin una etiqueta de cierre. Un elemento sin etiqueta de cierre se conoce como <dfn>void element</dfn>.
