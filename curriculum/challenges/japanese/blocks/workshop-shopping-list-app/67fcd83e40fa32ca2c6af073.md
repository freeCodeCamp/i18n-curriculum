...
アプリの基本構造ができたので、アイテムを追加して検索機能を動かしましょう。

配列を作成し、変数`items`に代入してください。配列の中には文字列`Apples`、`Bananas`、`Strawberries`、`Blueberries`、`Mangoes`、`Pineapple`、`Lettuce`、`Broccoli`、`Paper Towels`、`Dish Soap`を追加してください。これがアプリに表示されるアイテムのリストになります。
...
`items`配列には文字列`Apples`、`Bananas`、`Strawberries`、`Blueberries`、`Mangoes`、`Pineapple`、`Lettuce`、`Broccoli`、`Paper Towels`、`Dish Soap`を含めてください。
