...
`Collaborating` means working with others to achieve a common goal. It is often used in teamwork or project-based work. 例如：
...
`Implement` means to put a plan or decision into action. 例如：
...
`Front-end design` refers to the part of a website or app that users interact with directly. 例如：
