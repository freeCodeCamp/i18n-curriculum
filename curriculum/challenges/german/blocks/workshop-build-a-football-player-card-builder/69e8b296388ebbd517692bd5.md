...
Ihr fünftes `div`-Element von `className` von `form-group` sollte ein `label` mit einem `htmlFor`-Attribut von `def`, ein `className` von `label` und einen Text `DEF` haben.
...
Ihr fünftes `div`-Element von `className` von `form-group` sollte ein `input` mit einem `className` von `input`, ein `id` von `def` und ein `type` von `number` haben.
...
Ihr sechstes `div`-Element von `className` von `form-group` sollte ein `label` mit einem `htmlFor`-Attribut von `phy`, ein `className` von `label` und einen Text `PHY` haben.
...
Ihr viertes `div`-Element von `className` von `form-group` sollte ein `input` mit einem `className` von `input`, ein `id` von `phy` und ein `type` von `number` haben.
