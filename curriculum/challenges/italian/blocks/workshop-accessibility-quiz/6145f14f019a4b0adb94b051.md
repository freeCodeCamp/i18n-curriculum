...
Dovresti dare al primo elemento `option` un contenuto testuale `Select an option`.
...
Dovresti dare al secondo elemento `option` un contenuto testuale `Yes`.
...
Dovresti dare al terzo elemento `option` un contenuto testuale `No`.
