...
Додайте слухача події `"click"` до елемента `nextButton`, а потім передайте `playNextSong` як другий аргумент вашого слухача події. Це функція, яку слухач події виконуватиме.
