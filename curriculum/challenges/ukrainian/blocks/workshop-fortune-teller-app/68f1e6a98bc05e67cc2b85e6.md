...
Оголосіть змінну з іменем `cardElement` і використайте клас `card_container`, щоб отримати елемент. Використайте селектор `closest`, щоб отримати його з `target`.

# --hints--

Ви повинні оголосити змінну з іменем `cardElement` всередині `showFortune`.
...
Ваш `cardElement` має використовувати `target?.closest`, щоб знайти `.card_container`.
...
Ви повинні передати `.card_container` як аргумент до `closest`.
