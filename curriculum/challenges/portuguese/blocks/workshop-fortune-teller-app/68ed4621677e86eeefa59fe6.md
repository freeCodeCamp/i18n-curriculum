...
Agora você vai começar a trabalhar no método `initializeEventListeners()`. Primeiro, dê a ele o tipo de retorno `void`.

# --hints--

Seu método `initializeEventListeners` deve ter um tipo de retorno `void`.
