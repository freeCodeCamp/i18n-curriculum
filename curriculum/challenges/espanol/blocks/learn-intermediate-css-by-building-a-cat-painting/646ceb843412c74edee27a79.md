...
Tu selector `.cat-right-ear` debe tener una propiedad `height` establecida en `100px`. No olvides agregar un punto y coma.

```js
assert.strictEqual(new __helpers.CSSHelp(document).getStyle('.cat-right-ear')?.height, '100px')
```

Tu selector `.cat-right-ear` debe tener una propiedad `width` establecida en `100px`. No olvides agregar un punto y coma.

```js
assert.strictEqual(new __helpers.CSSHelp(document).getStyle('.cat-right-ear')?.width, '100px')
```

Tu selector `.cat-right-ear` debe tener una propiedad `background-color` establecida en `white`. No olvides agregar un punto y coma.

```js
assert.strictEqual(new __helpers.CSSHelp(document).getStyle('.cat-right-ear')?.backgroundColor, 'white')
```

Tu selector `.cat-right-ear` debe tener una propiedad `border-left` establecida en `35px solid blue`. No olvides agregar un punto y coma.

```js
assert.strictEqual(new __helpers.CSSHelp(document).getStyle('.cat-right-ear')?.borderLeft, '35px solid blue')
```

Tu selector `.cat-right-ear` debe tener la propiedad `border-right` establecida en `35px solid blue`. No olvides agregar un punto y coma.

```js
assert.strictEqual(new __helpers.CSSHelp(document).getStyle('.cat-right-ear')?.borderRight, '35px solid blue')
```

Tu selector `.cat-right-ear` debería tener la propiedad `border-top` establecida en `35px solid red`. No olvides agregar un punto y coma.
