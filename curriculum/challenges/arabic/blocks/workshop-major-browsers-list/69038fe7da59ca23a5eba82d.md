...
المتصفح الأخير الذي ستضيفه إلى القائمة سيكون لمتصفح Arc.

أضف عنصر `dt` آخر يحتوي على النص `Arc`.
...
مع هذه الإضافة الأخيرة، تصبح قائمة المتصفحات مكتملة!

# --hints--

يجب أن يكون لديك خمسة عناصر `dt` في شفرتك.
...
يجب أن يحتوي عنصر `dt` الخامس على النص `Arc`.
...
يجب أن يكون لديك خمسة عناصر `dd` في شفرتك.
...
يجب أن يحتوي عنصر `dd` الخامس على النص `This is a free Chromium based web browser first released in 2023 by The Browser Company.`.
