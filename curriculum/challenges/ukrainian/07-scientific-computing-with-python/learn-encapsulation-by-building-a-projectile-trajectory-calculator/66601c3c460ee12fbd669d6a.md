...
Тепер ви можете видалити цикл для друку кожного рядка виводу та замінити його на `print(graph.create_trajectory())`.

# --hints--

Ви не повинні мати циклу в глобальній області.
