...
`+=` 연산자를 사용해 `" Your <weapon> breaks."`의 끝에 `Your` 앞에 공백을 넣은 `text.innerText`을 더하세요. `<weapon>` 배열의 마지막 항목으로 `inventory`를 대체하는데, `inventory.pop()`를 사용하면 배열의 마지막 항목을 제거하고 반환하여 문자열에 나타나게 됩니다.

# --hints--

`text.innerText`을 수정하려면 복합 대입 연산자를 사용하세요.
