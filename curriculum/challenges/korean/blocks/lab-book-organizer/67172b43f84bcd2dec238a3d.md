...
4. `sortByYear` 함수는 첫 번째 책의 `releaseYear`가 두 번째 책의 releaseYear보다 작으면 `-1`를 반환해야 합니다.

5. `sortByYear` 함수는 첫 번째 책의 `releaseYear`가 두 번째 책의 releaseYear보다 크면 `1`를 반환해야 합니다.
...
`sortByYear` 함수는 `book1` 객체의 `releaseYear`가 `book2` 객체의 `releaseYear`보다 작으면 `-1`를, `book1` 객체의 releaseYear가 `book2` 객체의 releaseYear보다 크면 `1`를, 그 외 모든 경우에는 `0`를 반환해야 합니다.
