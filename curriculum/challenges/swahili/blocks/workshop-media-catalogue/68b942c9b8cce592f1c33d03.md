...
Sasa kamilisha darasa la `TVSeries` kwa kuongeza docstring ya `Child class representing an entire TV series.`

# --hints--

Unapaswa kuongeza docstring ya `Child class representing an entire TV series.` katika darasa lako la `TVSeries`.
