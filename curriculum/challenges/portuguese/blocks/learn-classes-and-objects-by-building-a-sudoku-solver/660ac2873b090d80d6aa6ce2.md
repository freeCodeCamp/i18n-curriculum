...
Agora, crie um loop `for` para iterar sobre as linhas no tabuleiro.Use `row` como a variável do loop.

# --hints--

Você deve criar um loop `for` que itere sobre `self.board`.
...
Você deve usar `row` como a variável do loop.
