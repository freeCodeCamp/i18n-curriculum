...
انتقل إلى العنصر `h2` داخل **خطة المستمع**، وأضف له صنف الأدوات `text-lg` ليصبح أكبر، و`font-semibold` ليصبح عريضًا أكثر، و`text-indigo-600` ليحصل على لون نيلي جميل.

# --hints--

يجب أن يحتوي عنصر `h2` على الصنف `text-lg`.
...
يجب أن يحتوي عنصر `h2` على الصنف `font-semibold`.
...
يجب أن يحتوي عنصر `h2` على الصنف `text-indigo-600`.
