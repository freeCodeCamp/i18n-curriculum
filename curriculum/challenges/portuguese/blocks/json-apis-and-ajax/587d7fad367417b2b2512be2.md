...
O código deve usar o método `document.getElementsByClassName` para selecionar o elemento com ac 
classe `message` e definir o `textContent` como a string mencionada.
