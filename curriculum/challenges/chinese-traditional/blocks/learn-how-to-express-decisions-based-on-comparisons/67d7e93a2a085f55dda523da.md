...
`On the other hand` is used to introduce an alternative perspective, often comparing pros and cons. 例如：
...
`Reliable` means something or someone can be trusted to perform well consistently. 例如：
