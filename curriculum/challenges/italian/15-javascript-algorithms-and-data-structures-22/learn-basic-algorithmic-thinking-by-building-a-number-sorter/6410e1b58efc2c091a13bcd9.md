...
Per poter eseguire il debug, aggiungi una chiamata `console.log()` nel loop interno. Passale gli argomenti `array`, `array[j]` e `array[j+1]`.

# --hints--

Dovresti usare una chiamata `console.log()` nel loop interno.
