...
Fügen Sie im vierten `td` Element einen eingebetteten Ausdruck hinzu, der die `views` Variabel enthält. Dies zeigt die Anzahl der Aufrufe an, die der Beitrag hat.

# --hints--

Sie sollten einen eingebetteten Ausdruck hinzufügen, der die `views` Variabel enthält.
