...
بعد ذلك، أخبر النموذج كيف يُرسل. أضف خاصية `method` بقيمة `post` وخاصية `action` بقيمة `https://superhero-application-form.freecodecamp.org` إلى عنصر النموذج.

الآن، إرسال النموذج سيرسله إلى ذلك العنوان. ستفعل ذلك في الخطوة التالية.

# --hints--

يجب أن يحتوي عنصر `form` على خاصية `method` مضبوطة على `post`.
...
يجب أن يحتوي عنصر `form` على خاصية `action` مضبوطة على `https://superhero-application-form.freecodecamp.org`.
