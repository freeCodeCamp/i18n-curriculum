...
Tengeneza kichaguzi cha `h2, h3, h4, h5, h6`. Mpe sifa ya `font-family` iliyowekwa kuwa `Raleway` na njia mbadala ya `sans-serif`.
...
Kichaguzi chako cha `h2, h3, h4, h5, h6` kinapaswa kuwa na sifa ya `font-family` iliyowekwa kuwa `Raleway` na njia mbadala ya `sans-serif`.
