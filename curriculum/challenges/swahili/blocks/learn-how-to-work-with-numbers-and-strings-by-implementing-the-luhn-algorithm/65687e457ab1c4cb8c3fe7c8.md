...
Badilisha wito la `verify_card_number` ili kama linarudisha `True`, chapisha `'VALID!'` kwenye konsoli. Vinginevyo, chapisha `'INVALID!'`.

# --hints--

Unapaswa kuwa na `if verify_card_number(translated_card_number):` ndani ya kitendakazi cha `main`.
...
Unapaswa kuwa na `print('VALID!')` ndani ya kifungu cha `if`.
...
Unapaswa kuwa na `print('INVALID!')` ndani ya kifungu cha `else`.
