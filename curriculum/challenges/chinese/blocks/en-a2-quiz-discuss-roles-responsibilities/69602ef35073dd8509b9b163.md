...
为了无障碍考虑，我们为有听力障碍的学习者提供了文字记录；建议仅在需要时使用。
...
听音频。什么时候说那句话合适？<!-- (quiz audio) Sophie: Ten years? That's impressive! -->
