...
Ci sono linee guida specifiche per la crittografia dei dati. Cosa direbbe Jessica?
...
La risposta dovrebbe affermare che esistono linee guida, non che la crittografia sia opzionale.
...
La risposta corretta conferma che esistono linee guida specifiche per la crittografia dei dati.

La frase `must be encrypted` indica che la crittografia è un requisito.
