...
Kuna sifa zaidi za kuongeza kwenye kiolesura cha `Card`. Anza kwa kuweka `value_int` kuwa aina ya `number`. Sifa zote zingine zinapaswa kuwa za aina ya `string`: `suit`, `type`, `img`, `meaning_up`, `meaning_rev`, na `desc`.

# --hints--

Unapaswa kuwa na sifa ya `value_int` yenye aina ya `number`.
...
Unapaswa kuwa na sifa ya `suit` yenye aina ya `string`.
...
Unapaswa kuwa na sifa ya `type` yenye aina ya `string`.
...
Unapaswa kuwa na sifa ya `img` yenye aina ya `string`.
...
Unapaswa kuwa na sifa ya `meaning_up` yenye aina ya `string`.
...
Unapaswa kuwa na sifa ya `meaning_rev` yenye aina ya `string`.
...
Unapaswa kuwa na sifa ya `desc` yenye aina ya `string`.
