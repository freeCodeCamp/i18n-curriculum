...
| Performance API        | Mejor para                                           |
| :--------------------- | :------------------------------------------------- |
| `performance.now()`    | Cronometraje preciso de funciones y scripts            |
| Performance Timing API | Medición del rendimiento de carga completa de páginas              |
| Performance Observer   | Monitoreo en tiempo real de interacciones y renderizado |
