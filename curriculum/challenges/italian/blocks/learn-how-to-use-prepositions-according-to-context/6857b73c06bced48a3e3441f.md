...
Questa frase di tre parole significa direttamente di fronte o opposto a qualcosa.

# --explanation--

`Right across from` significa direttamente di fronte a qualcosa. Per esempio:

`The printer is right across from the filing cabinet.` – Questo significa che la stampante è di fronte all'armadietto dall'altra parte.
