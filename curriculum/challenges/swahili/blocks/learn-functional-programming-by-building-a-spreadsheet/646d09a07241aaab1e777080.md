...
Katika kitendakazi chako cha `inner`, rudisha matokeo ya wito wa `idToText` ukiwa na `character + num` kama hoja.

# --hints--

Kitendakazi chako cha `inner` kinapaswa kutumia rudisho wazi.
...
Kitendakazi chako cha `inner` kinapaswa kurudisha matokeo ya wito wa kitendakazi chako cha `idToText`.
...
Unapaswa kupitisha `character + num` kama hoja kwa kitendakazi chako cha `idToText`.
