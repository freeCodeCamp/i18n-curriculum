...
Sasa, weka thamani `span` ndani ya kipengele cha `p` darasa la vitu `text-base`, `font-medium`, na `text-gray-500`.

# --hints--

`span` ndani ya kipengele chako cha `p` inapaswa kuwa na darasa la vitu `text-base`.
...
`span` ndani ya kipengele chako cha `p` inapaswa kuwa na darasa la vitu `font-medium`.
...
`span` ndani ya kipengele cha `p` inapaswa kuwa na darasa la vitu `text-gray-500`.
