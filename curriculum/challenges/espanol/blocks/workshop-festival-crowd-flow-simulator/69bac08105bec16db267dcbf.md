...
Tu función `handleGateAtTick` debe registrar el siguiente mensaje en la consola: `gate.queue[tickIndex] + " attendees arriving."`.
...
Tu función `handleGateAtTick` debe registrar el número correcto de asistentes según la fila en la puerta en el tickIndex dado.
