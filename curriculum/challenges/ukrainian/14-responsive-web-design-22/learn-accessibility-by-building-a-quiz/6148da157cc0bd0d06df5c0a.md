...
Щоб вирівняти поля введення одне з одним, створіть новий набір правил, який націлює усі елементи `input` та `label` в межах елементу `.info` і встановлює властивість `display` на `inline-block`.

Також вирівняйте текст елемента `label` за правим краєм.
...
Надайте елементам `input` та `label` властивість `display` зі значенням `inline-block`.
...
Надайте елементу `label` властивість `text-align` зі значенням `right`.
