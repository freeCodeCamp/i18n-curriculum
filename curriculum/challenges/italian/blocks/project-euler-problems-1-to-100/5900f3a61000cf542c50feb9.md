...
Partendo da 1 e procedendo a spirale in senso antiorario nel modo seguente, si forma una spirale quadrata con lato di lunghezza 7.
...
È interessante notare che i quadrati dispari si trovano lungo la diagonale in basso a destra, ma ciò che è ancora più interessante è che 8 dei 13 numeri presenti su entrambe le diagonali sono primi; cioè, un rapporto di 8/13 ≈ 62%.

Se si aggiunge un nuovo strato completo attorno alla spirale sopra, si formerà una spirale quadrata con lato di lunghezza 9. Se questo processo continua, qual è la lunghezza del lato della spirale quadrata per cui la percentuale di numeri primi lungo entrambe le diagonali scende per la prima volta sotto `percent`?
