...
title: Prueba Luhn de números de tarjeta de crédito
challengeType: 1
forumTopicId: 385284
...
La prueba Luhn es utilizada por algunas compañías de tarjetas de crédito para distinguir números de tarjeta de crédito válidos de lo que podría ser una selección aleatoria de dígitos.

Las empresas que usan números de tarjeta de crédito que pueden ser validados por la prueba de Luhn tienen números que pasan la siguiente prueba:
...
Por ejemplo, si el número de prueba es 49927398716:
...
Escribe una función que valide un número con la prueba de Luhn. Devuelve true si es un número válido. De lo contrario, devuelve false.

# --hints--

`luhnTest` debería ser una función.

```js
assert(typeof luhnTest === 'function');
```

`luhnTest("4111111111111111")` debería devolver un booleano.

```js
assert(typeof luhnTest('4111111111111111') === 'boolean');
```

`luhnTest("4111111111111111")` debería devolver `true`.

```js
assert.equal(luhnTest('4111111111111111'), true);
```

`luhnTest("4111111111111112")` debería devolver `false`.

```js
assert.equal(luhnTest('4111111111111112'), false);
```

`luhnTest("49927398716")` debería devolver `true`.

```js
assert.equal(luhnTest('49927398716'), true);
```

`luhnTest("49927398717")` debería devolver `false`.

```js
assert.equal(luhnTest('49927398717'), false);
```

`luhnTest("1234567812345678")` debería devolver `false`.

```js
assert.equal(luhnTest('1234567812345678'), false);
```

`luhnTest("1234567812345670")` debería devolver `true`.
