...
الآن عليك إضافة مستمع حدث على العنصر `happyBtn`.

اكتب مستمع الحدث واستدعاءه الراجع بحيث عند نقر الزر يسجل التطبيق في وحدة التحكم `Button clicked!`.

# --hints--

عند نقر `happyBtn` يجب تسجيل `Button clicked!` في وحدة التحكم.
