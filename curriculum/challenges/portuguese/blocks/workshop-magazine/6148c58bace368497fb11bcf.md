...
Assim como no Flexbox, com o CSS Grid você pode alinhar o conteúdo dos itens da grade com `align-items` e `justify-items`. `align-items` alinhará os elementos filhos ao longo do eixo da coluna e `justify-items` alinhará os elementos filhos ao longo do eixo da linha.

Dê ao seletor `.social-icons` a propriedade `align-items` definida com `center`.

# --hints--

O seletor `.social-icons` deve ter uma propriedade `align-items` definida com `center`.
