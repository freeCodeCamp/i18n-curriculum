...
Dê ao seletor `.text-with-images` uma propriedade `margin-bottom` definida como `3rem`.

# --hints--

O seletor `.text-with-images` deve ter a propriedade `margin-bottom` definida como `3rem`.
