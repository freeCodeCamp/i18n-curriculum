...
Su schermi piccoli, la lista non ordinata nella barra di navigazione esce dal lato destro dello schermo.

Risolvi questo problema usando _Flexbox_ per far andare a capo il contenuto `ul`. Poi, imposta le seguenti proprietà CSS per allineare correttamente il testo:
