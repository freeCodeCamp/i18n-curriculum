...
Usando lo stesso selettore di stile del passaggio precedente, aumenta la dimensione del carattere tipografico degli elementi e dei prezzi impostando un valore di `18px`.

# --hints--

Dovresti impostare la proprietà `font-size` su `18px`.
...
I tuoi elementi `p` annidati negli elementi `.item` dovrebbero avere una `font-size` di `18px`.
