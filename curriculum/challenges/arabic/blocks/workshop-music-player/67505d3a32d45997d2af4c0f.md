...
أنشئ دالة باسم `playPreviousSong`. داخل دالتك الجديدة، استخدم القيمة التي تُرجعها الدالة `getPreviousSong` لتحديد الأغنية التي ستُشغلها. عندما تكون `getPreviousSong()` تساوي `undefined`، شغّل أول أغنية في قائمة التشغيل. وإلا، شغّل الأغنية التي تسبق الأغنية الحالية المشغلة.

# --hints--

يجب أن يكون لديك دالة باسم `playPreviousSong`.

```js
assert.isFunction(playPreviousSong);
```

يجب أن تُشغل دالة `playPreviousSong` الأغنية التي تسبق الأغنية الحالية المشغلة في قائمة التشغيل.
...
عندما تكون `getPreviousSong()` تساوي `undefined`، يجب أن تُشغل دالة `playPreviousSong` أول أغنية في قائمة التشغيل.
