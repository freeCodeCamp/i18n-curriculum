...
title: Tumia sifa ya justify-content katika ingizo la tweet
challengeType: 0
...
Changamoto ya mwisho ilionyesha mfano wa sifa ya `justify-content`. Kwa ingizo la tweet, sifa hii inaweza kutumika kupanga vitu katika kipengele cha `.profile-name`.

# --instructions--

Ongeza sifa ya CSS `justify-content` kwenye kipengele cha `.profile-name` cha kichwa na weka thamani kwa mojawapo ya chaguzi kutoka changamoto ya mwisho.
...
Kipengele cha `.profile-name` kinapaswa kuwa na sifa ya `justify-content` ikiwa na mojawapo ya hizi thamani: `center`, `flex-start`, `flex-end`, `space-between`, `space-around`, au `space-evenly`.
