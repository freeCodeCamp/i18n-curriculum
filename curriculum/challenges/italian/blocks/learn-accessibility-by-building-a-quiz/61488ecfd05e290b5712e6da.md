...
Per far sembrare la prima sezione più in linea, seleziona solo gli elementi `input` all’interno degli elementi `.info`, imposta il loro `width` su `50%` e allinea il loro testo a sinistra.
