...
<abbr title="Stock Exchange Daily Official List">SEDOL</abbr> é uma lista de números de identificação de valores mobiliários emitidos pela London Stock Exchange.

Para cada lista numérica de <abbr title="Stock Exchange Daily Official List">SEDOL</abbr>s de 6 dígitos, calcule e anexe o dígito de verificação. Ou seja, dada a string de entrada à esquerda, sua função deve retornar a string correspondente à direita:
