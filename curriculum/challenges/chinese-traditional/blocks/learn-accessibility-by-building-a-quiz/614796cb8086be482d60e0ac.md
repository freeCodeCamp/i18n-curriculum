...
在視覺存取性主題中，元素之間的對比度是關鍵因素。 例如，標題的文字與背景之間的對比度應至少為 4.5:1。

將所有 `list` 元素內的錨點元素的字型顏色更改為對比度比率至少為 7:1 的顏色。
...
你應該為 `color` 屬性與背景提供至少 7:1 的對比度。*提示：我會使用 `#dfdfe2`*
