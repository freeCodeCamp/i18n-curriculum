...
Agora que você está atualizando as variáveis `gold` e `health`, você precisa mostrar esses novos valores na tela do jogo. You have retrieved the `healthText` and `goldText` elements in a prior step.
