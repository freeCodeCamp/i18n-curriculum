...
`你是中國人 (nǐ shì zhōng guó rén)。` is a declarative sentence, which means "You are Chinese". Adding `嗎 (ma)` at the end turns it into a question, which means "Are you Chinese?"
