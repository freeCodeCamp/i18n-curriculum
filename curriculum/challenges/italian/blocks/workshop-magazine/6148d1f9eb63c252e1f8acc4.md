...
Per dare un colore al `hr`, devi modificare la proprietà `border`. Dai al selettore `hr` una proprietà `border` impostata su `1px solid rgba(120, 120, 120, 0.6)`.

# --hints--

La tua `hr` dovrebbe avere una proprietà `border` impostata su `1px solid rgba(120, 120, 120, 0.6)`.
