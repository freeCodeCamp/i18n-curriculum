...
`troubleshoot`, `any issues`, `a bit lost`, `learn from`, `approach`, `walk through`, `core concepts`, y `trouble with`.
...
Sintiendo confusión o sin estar seguro de qué hacer a continuación.
...
Tener dificultad para entender o hacer algo.
...
Para explicar algo paso a paso.
...
Cualquier problema o cosa que no esté funcionando.
...
Para comenzar a tratar una tarea o problema.
...
Las ideas más importantes y básicas que necesitas para entender un tema.
...
Adquirir conocimiento o habilidades estudiando o experimentando algo.
