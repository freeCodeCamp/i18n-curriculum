...
Тепер ви використаєте `grid`, щоб упорядкувати елементи всередині обгортки `div`.

Додайте класи `grid`, `grid-rows-[1fr_auto]` і `gap-6` до обгортки `div`.

# --hints--

Ваш елемент-обгортка `div` для сімейного плану має мати клас `grid`.
...
Ваш елемент-обгортка `div` для сімейного плану має мати клас `grid-rows-[1fr_auto]`.
...
Ваш елемент-обгортка `div` для сімейного плану має мати клас `gap-6`.
