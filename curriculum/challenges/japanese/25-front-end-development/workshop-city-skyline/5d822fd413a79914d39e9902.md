...
最後に、`.bb2a` の `border-bottom` プロパティについて `1vw` を `5vh` に変更し、色の `#000` を `--building-color2` 変数に変更してください。 だいぶ良くなってきました！ このプロジェクトのどの時点でも、最初にすべての要素に追加した `border` プロパティをコメントアウトまたは削除することにより、最終的に境界線を削除したときビルがどのように見えるか確認できます。
