...
Questo è tutto quello che puoi fare per ora con la funzione calculate. È ora di scrivere la logica per la media.
...
La funzione `getMean` dovrebbe prendere un singolo parametro `array`.
