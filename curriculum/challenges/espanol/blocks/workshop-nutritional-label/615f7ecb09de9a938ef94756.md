...
Un elemento `span` debe envolver el texto `Total Carbohydrate 37g`.
...
Un elemento `span` debe envolver el texto `Total Carbohydrate`.
...
El elemento `span` alrededor de `Total Carbohydrate` debe tener el atributo `class` establecido en `bold`.
...
El elemento `span` alrededor de `13%` debe tener el atributo `class` establecido en `bold`.
