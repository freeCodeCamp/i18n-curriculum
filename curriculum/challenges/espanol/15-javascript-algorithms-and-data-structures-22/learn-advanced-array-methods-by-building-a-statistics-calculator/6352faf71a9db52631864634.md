...
El siguiente paso es calcular qué tan lejos está cada elemento de la media. Declara una variable `differences`, y asígnale el valor de `array.map()`. For the callback, return the value of `el` minus `mean`.
