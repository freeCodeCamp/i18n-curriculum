...
Probemos tu nueva función curried. Declara una variable `servingsResult` y asígnale el resultado de ajustar desde una cantidad base de 4 a una porción de 6.
