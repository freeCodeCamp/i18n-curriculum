...
`back-end development`، `biweekly meetings`، `daily huddle meetings`، `keep track of`، `redundancy`، `the day before`، و `twice a week`.
...
هذه تصف اجتماعات فريق قصيرة ومنتظمة. تبدأ بصفة، تليها اسم، ثم اسم جمع آخر.
...
هذه تشير إلى مساحة محددة في هندسة البرمجيات. تبدأ بصفة تصف التركيز التقني، تليها اسم يصف العملية.
...
هذه العبارة المكونة من ثلاث كلمات تشير إلى اليوم السابق. تبدأ بأداة تعريف، تليها اسم، ثم حرف جر.
...
هذه تشير إلى التكرار أو الازدواجية غير الضرورية.
...
هذه العبارة المكونة من ثلاث كلمات تشير إلى التكرار. تبدأ بحال، تليها أداة تعريف، ثم اسم.
...
هذه تصف حدثًا متكررًا يحدث مرتين في الأسبوع. تبدأ بصفة، تليها اسم جمع.
...
هذه العبارة المكونة من ثلاث كلمات تعني مراقبة أو متابعة التقدم. تبدأ بفعل، تليها اسم، ثم حرف جر.
