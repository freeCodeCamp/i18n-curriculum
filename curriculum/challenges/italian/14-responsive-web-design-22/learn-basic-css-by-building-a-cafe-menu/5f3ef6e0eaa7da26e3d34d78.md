...
Puoi dare al menu uno spazio tra il contenuto e i lati usando varie proprietà `padding`.

Assegna lo stesso valore di `20px` alle proprietà `padding-left` e `padding-right` della classe `menu`.

# --hints--

Dovresti assegnare alla proprietà `padding-left` il valore `20px`.
...
Dovresti assegnare alla proprietà `padding-right` il valore `20px`.
...
L'elemento `.menu` dovrebbe avere un `padding-left` con il valore `20px`.
...
L'elemento `.menu` dovrebbe avere un `padding-right` con il valore `20px`.
