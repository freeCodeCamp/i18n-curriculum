...
За замовчуванням інші вкладки не повинні бути вибраними. Ви можете зробити це, додавши атрибут `aria-selected` до другого та третього елементів `button` і встановивши їхні значення в `"false"`.

# --hints--

Ваш другий елемент `button` має мати атрибут `aria-selected`.
...
Ваш другий елемент `button` має мати атрибут `aria-selected`, встановлений у `"false"`.
...
Ваш третій елемент `button` має мати атрибут `aria-selected`.
...
Ваш третій елемент `button` має мати атрибут `aria-selected`, встановлений у `"false"`.
