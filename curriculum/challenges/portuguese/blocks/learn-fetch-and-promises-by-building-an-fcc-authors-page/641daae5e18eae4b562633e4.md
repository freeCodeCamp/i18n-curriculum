...
Por fim, e se houver um erro e os dados do autor falharem ao carregar? Então, precisamos mostrar um erro na interface do usuário. É exatamente para isso que o método `.catch()` serve – para o tratamento dos erros.
