...
Hören Sie zu und ergänzen Sie jeden Satz mit der richtigen Abteilung.
...
`El departamento de aprendizaje y desarrollo capacita al equipo.` – Die Abteilung Learning and Development schult das Team.

Sowohl `apoyar` (to support) als auch `capacitar` (to train) sind Verben der dritten Person Singular im `-ar`.
