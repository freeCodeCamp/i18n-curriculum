...
Kitendakazi chako cha mwitiko kinahitaji vigezo vinne. `match`, `arg1`, `operator`, na `arg2`.

Hutatumia kigezo cha `match`, kwa hivyo kumbuka kuiweka kiambishi awali.
...
Kitendakazi chako cha mwitiko kinapaswa bado kuwa tupu.
