...
معلومة ممتعة: معظم الزعانف، إن لم تكن كلها، ليست مستطيلة الشكل طبيعيًا.

امنح زوايا `.arm` العلوية اليسرى والعلوية اليمنى والسفلية اليمنى انحناء زاوية بنسبة `30%`، والزواية السفلية اليسرى انحناء زاوية بنسبة `120%`.

# --hints--

يجب أن تعطي عناصر `.arm` انحناء الزوايا (`border-radius`) بقيمة `30% 30% 30% 120%`.
