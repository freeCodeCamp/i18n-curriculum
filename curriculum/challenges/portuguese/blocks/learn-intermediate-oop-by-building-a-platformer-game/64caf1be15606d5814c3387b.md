...
Adicione outra expressão booleana que verifique se a posição `y` do jogador mais a altura do jogador é maior ou igual à posição `y` da plataforma.

Abaixo disso, adicione outra expressão booleana que verifica se a posição `y` do jogador é menor ou igual à soma da posição `y` da plataforma mais a altura da plataforma.

# --hints--

Você não deve alterar o array `platformDetectionRules` existente e seu conteúdo.
...
Você deve ter uma expressão booleana que verifica se a posição `y` do jogador mais a altura do jogador é maior ou igual à posição `y` da plataforma.
...
Você deve ter uma expressão booleana que verifica se a posição `y` do jogador é menor ou igual à soma da posição `y` da plataforma mais a altura da plataforma.
