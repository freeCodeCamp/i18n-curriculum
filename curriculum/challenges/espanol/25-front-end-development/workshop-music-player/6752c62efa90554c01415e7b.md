...
Cree una función llamada `setPlayerDisplay`. Dentro de la función, establezca el `textContent` de `playingSong` al título de la canción actual, si está definido. De lo contrario, configúrelo en una cadena vacía.

Debajo de eso, establezca el `textContent` de `songArtist` al artista de la canción actual, si está definido. De lo contrario, configúrelo en una cadena vacía.


# --hints--

Debería tener una función llamada `setPlayerDisplay`.

```js
assert.isFunction(setPlayerDisplay);
```

Su función `setPlayerDisplay` debería establecer el `textContent` de `playingSong` al título de la canción actual, si está definido, o a una cadena vacía.
...
Su función `setPlayerDisplay` debería establecer el `textContent` de `songArtist` al artista de la canción actual, si está definido, o a una cadena vacía.
