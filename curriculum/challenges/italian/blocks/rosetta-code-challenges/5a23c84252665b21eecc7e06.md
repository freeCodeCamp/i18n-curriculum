...
Un rettangolo dato è formato da *m* × *n* quadrati. Se *m* e *n* non sono entrambi dispari, allora è possibile tagliare un percorso attraverso il rettangolo lungo i bordi dei quadrati in modo che il rettangolo si divida in due pezzi connessi della stessa forma (dopo aver ruotato uno dei pezzi di 180°). Tutti questi percorsi per rettangoli 2 × 2 e 4 × 3 sono mostrati qui sotto.
...
Scrivi una funzione che calcoli il numero di modi diversi per tagliare un rettangolo *m* × *n*.
