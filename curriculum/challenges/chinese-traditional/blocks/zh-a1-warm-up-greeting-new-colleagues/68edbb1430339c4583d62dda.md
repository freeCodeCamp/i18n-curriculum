...
Liu Ming is saying `設計師 (shè jì shī)`, which means "designer". It refers to someone who creates appealing visual concepts through layout, color, and form. For example:

`我是設計師 (wǒ shì shè jì shī)。` - I am a designer.
