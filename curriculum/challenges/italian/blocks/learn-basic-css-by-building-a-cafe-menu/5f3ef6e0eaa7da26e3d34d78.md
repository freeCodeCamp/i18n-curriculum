...
Puoi dare un po' di spazio al tuo menu tra il contenuto e i lati con varie proprietà `padding`.

Dai alla classe `menu` una `padding-left` e una `padding-right` con lo stesso valore `20px`.

# --hints--

Dovresti impostare la proprietà `padding-left` su `20px`.
...
Dovresti impostare la proprietà `padding-right` su `20px`.
...
Il tuo elemento `.menu` dovrebbe avere un `padding-left` di `20px`.
...
Il tuo elemento `.menu` dovrebbe avere un `padding-right` di `20px`.
