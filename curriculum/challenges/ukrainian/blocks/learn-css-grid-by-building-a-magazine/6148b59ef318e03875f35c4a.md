...
Властивість `object-fit` вказує браузеру, як розташувати елемент у межах його контейнера. У цьому випадку `cover` змусить зображення заповнити контейнер, обрізаючи його за потреби, щоб не змінювати співвідношення сторін.
