...
Після DRI `form-group` додайте ще два `div` елементи, кожен з `className` `form-group` всередині `stats-grid`, один для DEF, інший для PHY.

Для DEF додайте `label` з `htmlFor` `def` і текстом `DEF`, потім input з `id` `def` і `type` `number`.

А для PHY додайте label з `htmlFor` `phy` і текстом `PHY`, потім input з `id` `phy` і `type` `number`.

# --hints--

Ви маєте додати ще один множину з двох `div` елементів, кожен з `className` `form-group` всередині `div` `className` `stats-grid`.
...
Ваш п'ятий елемент `div` з `className` `form-group` має містити `label` з атрибутом `htmlFor` зі значенням `def`, `className` `label` і текстом `DEF`.
...
Ваш п'ятий елемент `div` з `className` `form-group` має містити `input` з `className` `input`, `id` `def` і `type` `number`.
...
Ваш шостий елемент `div` з `className` `form-group` має містити `label` з атрибутом `htmlFor` зі значенням `phy`, `className` `label` і текстом `PHY`.
...
Ваш шостий елемент `div` з `className` `form-group` має містити `input` з `className` `input`, `id` `phy` і `type` `number`.
