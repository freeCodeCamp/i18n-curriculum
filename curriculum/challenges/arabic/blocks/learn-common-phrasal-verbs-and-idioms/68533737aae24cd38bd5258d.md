...
هذا الفعل يعني إنشاء نسخة أولية من شيء ما ستُراجع أو تُعدل لاحقًا.

# --explanation--

`To draft something up` يعني إنشاء نسخة أولية من وثيقة أو خطة أو اقتراح. على سبيل المثال:

`She drafted up a new schedule for the support team.` – هذا يعني أنها أنشأت نسخة أولية من الجدول يمكن مناقشتها أو تعديلها.
