...
Ora, userai `grid` per disporre gli elementi all'interno del contenitore `div`.

Aggiungi le classi `grid`, `grid-rows-[1fr_auto]` e `gap-6` al contenitore `div`.

# --hints--

Il tuo elemento contenitore `div` per il piano famiglia dovrebbe avere la classe `grid`.
...
Il tuo elemento contenitore `div` per il piano famiglia dovrebbe avere la classe `grid-rows-[1fr_auto]`.
...
Il tuo elemento contenitore `div` per il piano famiglia dovrebbe avere la classe `gap-6`.
