...
Тепер перетворіть `1`, який ви раніше змінили, назад у `0`, щоб відновити початкову конфігурацію дошки. Потім видаліть свій виклик `print`.

# --hints--

Ви маєте перетворити перший елемент першого списку `puzzle` назад у нуль.
...
У вашому коді не має бути `print(gameboard.find_empty_cell())`.
