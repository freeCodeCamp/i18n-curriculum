...
Il modo più semplice è aggiungere un margine superiore negativo agli elementi `img` per alzarli rispetto alle loro posizioni attuali. I valori negativi vengono creati utilizzando un `-` davanti al valore. To complete this workshop, go ahead and use a negative top margin of `25px` in the `img` type selector.
