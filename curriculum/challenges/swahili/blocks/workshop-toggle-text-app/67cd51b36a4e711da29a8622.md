...
Ili kubadili uonekano wa maandishi, utahitaji kwanza kuunda kitendakazi kitakachohusika na tabia hiyo.

Anza kwa kuunda kitendakazi kipya kinachoitwa `handleToggleVisibility`.

# --hints--

Unapaswa kuwa na kitendakazi cha `handleToggleVisibility`.
