...
Brian fala sobre suas experiências passadas na faculdade estudando tecnologia da informação.Eles usam vários verbos no passado para descrever suas atividades e sentimentos.Preste atenção em como eles conjugam esses verbos.
...
O tempo passado de `is`, usado aqui para descrever a natureza dos estudos deles.
...
Este verbo no passado mostra os sentimentos fortemente positivos de Brian sobre sua experiência.
...
Neste contexto, significa `had the opportunity to`.É usado para descrever as oportunidades que Brian teve em seu trabalho anterior.
