...
Зрештою, потрібно додати деякі стилі для кнопок. Для початку встановіть властивість `cursor` на `pointer`. Потім встановіть колір тексту (`color`) на `#0a0a23`, а `background-color` на `#feac32`.

Потім встановіть властивість `background-image` на `linear-gradient(#fecc4c, #ffac33)`. В кінці встановіть `border` на `3px solid #feac32`.

# --hints--

Ви повинні мати селектор `button`.
...
Селектор `button` повинен мати властивість `cursor` зі значенням `pointer`.
...
Селектор `button` повинен мати властивість `color` зі значенням `#0a0a23`.
...
Селектор `button` повинен мати властивість `background-color` зі значенням `#feac32`.
...
Селектор `button` повинен мати властивість `background-image` зі значенням `linear-gradient(#fecc4c, #ffac33)`.
...
Селектор `button` повинен мати властивість `border` зі значенням `3px solid #feac32`.
