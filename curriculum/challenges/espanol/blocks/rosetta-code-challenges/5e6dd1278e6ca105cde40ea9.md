...
La **longest common subsequence** (or **LCS**) de grupos A y B es el grupo de elementos más largos desde A y B que son comunes entre dos grupos y en el mismo orden que cada grupo. Por ejemplo, las secuencias `1234` y `1224533324` tienen un LCS de `1234`:
