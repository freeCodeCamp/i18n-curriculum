...
O HTML5 apresenta tags HTML mais descritivas. Esses elementos incluem `main`, `header`, `footer`, `nav`, `video`, `article`, `section` e outros.
...
**Nota:** Muitos dos novos elementos do HTML5 e seus benefícios são abordados na seção de Acessibilidade Aplicada.
