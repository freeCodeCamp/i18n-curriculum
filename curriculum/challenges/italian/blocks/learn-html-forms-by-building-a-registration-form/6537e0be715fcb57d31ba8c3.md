...
Infine, cambia il colore del testo dell'elemento link `terms and conditions` in `#dfdfe2` aggiungendo un nuovo selettore nel CSS.

Ben fatto! Hai completato l'ultima parte del progetto di pratica _Modulo di registrazione_.

# --hints--


Dovresti dare all'elemento `a` un `color` di `#dfdfe2`.
