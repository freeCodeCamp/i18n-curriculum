...
¿Cómo agregar/eliminar elementos del medio de un arreglo?
...
En este ejemplo, para crear una copia del arreglo `original` sin modificarlo, usamos el operador de propagación (`...`). El operador de propagación creará una copia superficial de los elementos del arreglo `original` en un nuevo arreglo.  Aprenderás más sobre esto en futuros videos de la lección.
