...
Kwenye skrini ndogo, orodha isiyopangwa katika upau wa kusogeza hufurika upande wa kulia wa skrini.

Rekebisha hili kwa kutumia _Flexbox_ kufunga maudhui ya `ul`. Kisha, weka sifa zifuatazo za CSS ili kusawazisha maandishi kwa usahihi:
