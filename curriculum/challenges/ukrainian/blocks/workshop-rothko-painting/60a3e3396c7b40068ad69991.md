...
Ви повинні встановити властивість `box-shadow` у `0 0 5px 5px #b20403`.
...
Ваш елемент `.three` має мати значення ідентифікатора `box-shadow` рівне `0 0 5px 5px #b20403`.
