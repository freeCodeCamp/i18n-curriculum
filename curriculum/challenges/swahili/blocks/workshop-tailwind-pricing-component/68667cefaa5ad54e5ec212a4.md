...
Hamishe kwenye kipengele cha orodha, ongeza madarasa la vitu `mt-6`, `space-y-2`, `text-sm`, na `text-fuchsia-100` kwenye `ul` ili kuweka nafasi kati ya vitu vya orodha na kuifanya ionekane kuvutia zaidi.

# --hints--

Kipengele chako cha `ul` kinapaswa kuwa na darasa la vitu `mt-6`.
...
Kipengele chako cha `ul` kinapaswa kuwa na darasa la vitu `space-y-2`.
...
Kipengele chako cha `ul` kinapaswa kuwa na darasa la vitu `text-sm`.
...
Kipengele chako cha `ul` kinapaswa kuwa na darasa la vitu `text-fuchsia-100`.
