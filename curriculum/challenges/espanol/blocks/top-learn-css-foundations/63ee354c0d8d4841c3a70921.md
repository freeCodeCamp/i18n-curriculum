...
Lo primero que debes notar es que no hay selectores aquí, ya que los estilos se están agregando directamente a la etiqueta de apertura `<div>`. A continuación, tienes el atributo `style`, con su valor dentro del par de comillas siendo las declaraciones.
