...
Haz las letras del texto `Est. 2020` itálicas creando un selector de clase `established` y dándole la propiedad `font-style` con el valor `italic`.

# --hints--

Debes tener un selector `.established`.
...
La propiedad `font-style` debe tener el valor `italic`.
...
Tu selector `.established` debe darle a la propiedad `font-style` el valor `italic`.
