...
title: 'Завдання 75: Унікальні цілі прямокутні трикутники'
challengeType: 1
forumTopicId: 302188
...
Виявляється, що 12 см — це найменша довжина дроту, яку можна зігнути так, щоб утворити прямокутний трикутник з цілими сторонами рівно одним способом, але існує багато інших прикладів.
...
Натомість деякі довжини дроту, наприклад 20 см, не можна зігнути так, щоб утворити прямокутний трикутник з цілими сторонами, а інші довжини дозволяють знайти більше ніж одне рішення; наприклад, використовуючи 120 см, можна утворити рівно три різні прямокутні трикутники з цілими сторонами.

<div style='margin-left: 4em;'>
  <strong>120 см:</strong> (30,40,50), (20,48,52), (24,45,51)<br><br>
</div>

Якщо L — довжина дроту, для скількох значень L ≤ `n` можна утворити рівно один прямокутний трикутник з цілими сторонами?
