...
title: 'Aufgabe 64: Quadratwurzeln mit ungerader Periode'
challengeType: 1
forumTopicId: 302176
...
Alle Quadratwurzeln sind periodisch, wenn sie als Kettenbrüche geschrieben werden, und können in der Form dargestellt werden:

$\\displaystyle \\quad \\quad \\sqrt{N}=a_0+\\frac 1 {a_1+\\frac 1 {a_2+ \\frac 1 {a3+ \\dots}}}$

Betrachten wir zum Beispiel $\\sqrt{23}$:

$\\quad \\quad \\sqrt{23}=4+\\sqrt{23}-4=4+\\frac 1 {\\frac 1 {\\sqrt{23}-4}}=4+\\frac 1 {1+\\frac{\\sqrt{23}-3}7}$

Wenn wir weitermachen, erhalten wir die folgende Entwicklung:
...
Man sieht, dass sich die Folge wiederholt. Zur Kürze verwenden wir die Notation $\\sqrt{23}=\[4;(1,3,1,8)]$, um anzuzeigen, dass der Block (1,3,1,8) unendlich oft wiederholt wird.
...
Genau vier Kettenbrüche für $N \\le 13$ haben eine ungerade Periode.
