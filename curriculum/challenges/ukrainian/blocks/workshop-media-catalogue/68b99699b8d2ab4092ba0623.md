...
Після інструкції `if` у вашому методі `__str__` створіть дві змінні з іменами `movies` та `series` і призначте їм виклик методу `get_movies` та виклик методу `get_tv_series` відповідно.

# --hints--

У вашому методі `movies` має бути змінна з іменем `__str__`.
...
Ви призначаєте `self.get_movies()` змінній `movies`.
...
У вашому методі `series` має бути змінна з іменем `__str__`.
...
Ви призначаєте `self.get_tv_series()` змінній `series`.
