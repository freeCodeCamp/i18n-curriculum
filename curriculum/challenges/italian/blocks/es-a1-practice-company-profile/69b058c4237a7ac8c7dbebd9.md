...
Concentrati sui dettagli dell'azienda menzionati nel profilo.
...
Questo è diverso da quello che menziona Sebastián.
...
Questo dominio non è menzionato nell'audio.
...
Il `.` ("punto") in spagnolo si chiama `punto`.
