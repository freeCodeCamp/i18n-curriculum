...
Kwanza, andika ujumbe ufuatao kwenye konsoli: `"\nProcessing " + gate.id + "..."`.

# --hints--

Kitendakazi chako cha `handleGateAtTick` kinapaswa kwanza kuandika ujumbe ufuatao kwenye konsoli, `"\nProcessing " + gate.id + "..."`.
...
Kitendakazi chako cha `handleGateAtTick` kinapaswa kuandika nambari sahihi ya lango katika ujumbe.
