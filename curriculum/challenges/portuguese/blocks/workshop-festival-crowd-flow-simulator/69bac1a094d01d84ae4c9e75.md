...
Para acompanhar qual tick está sendo processado durante a simulação, crie uma variável chamada `tickIndex` e atribua a ela um valor inicial de `0`.

Essa variável será usada para fazer loop por todos os ticks da sua simulação e garantir que cada porta seja processada na ordem correta.

# --hints--

Você deve criar uma variável chamada `tickIndex` e atribuir a ela um valor de `0`.
