...
Il selettore `span[class~="sr-only"]` dovrebbe avere una proprietà `position` con il valore `absolute`.
...
Il selettore `span[class~="sr-only"]` dovrebbe avere una proprietà `padding` con il valore `0`.
...
Il selettore `span[class~="sr-only"]` dovrebbe avere una proprietà `margin` con il valore `-1px`.
