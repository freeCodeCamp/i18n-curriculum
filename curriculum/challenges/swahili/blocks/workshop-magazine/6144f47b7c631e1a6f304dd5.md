...
Jarida lako litakuwa na sehemu kuu tatu. Tayari umeweka mpangilio wa jumla katika sheria ya `main`, lakini unaweza kurekebisha nafasi katika sheria za watoto.

Chaguo moja ni sifa ya `grid-column`, ambayo ni kifupi cha `grid-column-start` na `grid-column-end`. Sifa ya `grid-column` inaeleza kipande cha gridi kuanzia mstari gani wa gridi na kuishia mstari gani.

Tengeneza sheria ya `.heading` na weka sifa ya `grid-column` kuwa `2 / 3`. Hii itaeleza kipengele cha `.heading` kuanza mstari wa gridi wa 2 na kuishia mstari wa gridi wa 3.
...
Kichaguzi chako cha `.heading` kinapaswa kuwa na sifa ya `grid-column` iliyowekwa kuwa `2 / 3`.
