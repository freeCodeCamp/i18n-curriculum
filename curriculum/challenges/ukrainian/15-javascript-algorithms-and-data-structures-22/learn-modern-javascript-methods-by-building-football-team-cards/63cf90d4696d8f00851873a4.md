...
Під властивістю `team` додайте чотири пари властивостей ключ-значення.

1. Ключ під назвою `sport` та рядкове значення `"Football"`.
2. Ключ під назвою `year` та числове значення `1986`.
3. Ключ під назвою `isWorldCupWinner` та булеве значення `true`.
4. Новий ключ під назвою `headCoach` зі значенням порожнього об’єкта.

# --hints--

Об’єкт `myFavoriteFootballTeam` повинен мати властивість `sport`.
...
Об’єкт `myFavoriteFootballTeam` повинен мати властивість `year`.
...
Об’єкт `myFavoriteFootballTeam` повинен мати властивість `isWorldCupWinner`.
...
Об’єкт `myFavoriteFootballTeam` повинен мати властивість `headCoach`.

```js
assert.property(myFavoriteFootballTeam, 'headCoach');
```

Значення `headCoach` повинне бути об’єктом.

```js
assert.isObject(myFavoriteFootballTeam.headCoach)
```

Значення `headCoach` повинне бути порожнім об’єктом.
