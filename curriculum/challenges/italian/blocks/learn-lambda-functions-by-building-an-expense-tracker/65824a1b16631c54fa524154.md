...
Poi, aggiungi un'altra chiamata `print()` e passa la stringa `'2. List all expenses'`.

# --hints--

Dovresti stampare `'2. List all expenses'` nel tuo loop `while` dopo le chiamate `print()` esistenti.
