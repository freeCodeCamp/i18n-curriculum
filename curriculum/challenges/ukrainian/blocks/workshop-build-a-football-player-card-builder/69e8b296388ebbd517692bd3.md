...
Всередині `stats-grid` додайте два елементи `div`, кожен з атрибутом `className` зі значенням `form-group`.

Для першого додайте `label` з атрибутом `className` зі значенням `label`, `htmlFor` зі значенням `pac` та текстом `PAC`, потім input з атрибутом `id` зі значенням `pac`, `className` зі значенням `input` та `type` зі значенням `number`.

Для другого додайте `label` з атрибутом `htmlFor` зі значенням `sho` та текстом `SHO`, потім input з атрибутом `id` зі значенням `sho` та `type` зі значенням `number`.

# --hints--

У вас має бути два елементи `div`, кожен з атрибутом `className` зі значенням `form-group` всередині `div` `className` `stats-grid`.
...
Перший елемент `div` `className` `form-group` повинен містити `label` з атрибутом `htmlFor` зі значенням `pac`, `className` зі значенням `label` та текст `PAC`.
...
Перший елемент `div` `className` `form-group` повинен містити `input` з атрибутом `className` зі значенням `input`, `id` зі значенням `pac` та `type` зі значенням `number`.
...
Другий елемент `div` `className` `form-group` повинен містити `label` з атрибутом `htmlFor` зі значенням `sho`, `className` зі значенням `label` та текст `SHO`.
...
Другий елемент `div` `className` `form-group` повинен містити `input` з атрибутом `id` зі значенням `sho`, `className` зі значенням `input` та `type` зі значенням `number`.
