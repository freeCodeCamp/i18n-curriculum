...
تُستخدم هذه الكلمة للتأكيد في العبارات الإيجابية. تنتهي بـ `-es`.
...
هذا الفعل يعني أن تملك أو تحتفظ بشيء ما.

# --explanation--

يُستخدم التعبير `Does have` لإضافة التأكيد، مما يجعل العبارة أقوى. على سبيل المثال:

`He does have experience in cybersecurity.` - هذا يؤكد أن الشخص لديه خبرة فعلًا.
