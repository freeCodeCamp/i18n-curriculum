...
Infine, devi collegare il tuo file JavaScript al tuo HTML. Crea un elemento `script` per farlo.
...
Il tuo elemento `script` dovrebbe avere l'insieme `src` impostato su `./script.js`.
