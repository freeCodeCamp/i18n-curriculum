...
У `.frame` встановіть її `width` на 500 пікселів.

# --hints--

Ви повинні встановити властивість `width` у значення `500px`.
...
Ваш елемент `.frame` має мати `width` зі значенням `500px`.
