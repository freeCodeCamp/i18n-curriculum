...
- **Consultas de Medios y Operadores Lógicos**: El operador `and` se utiliza para combinar múltiples funciones de medios, mientras que `not` y `only` se pueden utilizar para negar o aislar consultas de medios.
