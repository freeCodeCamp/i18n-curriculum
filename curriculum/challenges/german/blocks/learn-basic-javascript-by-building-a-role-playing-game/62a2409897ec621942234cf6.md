...
Geben Sie dem `#text`-Element einen `background-color` von `#0a0a23`, einen `color` von `#ffffff` und `10px` Innenabstand auf allen Seiten.

# --hints--

Sie sollten einen `#text`-Selektor haben.
...
Ihr `#text`-Element sollte einen `background-color` von `#0a0a23` haben.
...
Ihr `#text`-Element sollte einen `color` von `#ffffff` haben.
...
Ihr `#text`-Element sollte `10px` Innenabstand auf allen Seiten haben.
