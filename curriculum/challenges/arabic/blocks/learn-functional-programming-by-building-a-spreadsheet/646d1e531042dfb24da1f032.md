...
المعلمة الثانية لطريقة `.replace()` لا يجب أن تكون سلسلة نصية. يمكنك بدلاً من ذلك تمرير دالة استدعاء راجع لتشغيل منطق أكثر تعقيدًا على السلسلة النصية المطابقة.

تأخذ دالة الاستدعاء الراجع عدة معلمات. الأولى هي السلسلة النصية المطابقة. مرر دالة استدعاء راجع فارغة إلى استدعاء `.replace()`، وامنحها معلمة `match`.

# --hints--

يجب أن تمرر دالة سهمية كالمعلمة الثانية لطريقة `.replace()`.
...
يجب أن تأخذ دالتك السهمية معلمة `match`.
