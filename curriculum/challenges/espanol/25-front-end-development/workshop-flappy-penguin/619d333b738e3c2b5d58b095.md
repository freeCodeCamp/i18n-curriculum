...
Dentro del segundo punto de referencia, gira a `130deg` y retén la escala del brazo izquierdo.

# --hints--

Debe dar al punto de referencia del `20%` un `transform` de `rotate(130deg) scaleX(-1)`.
