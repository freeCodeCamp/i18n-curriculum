...
También dentro del objeto `recipe1`, crea una propiedad `ingredients` con un arreglo como valor. El arreglo debe contener `spaghetti`, `Parmesan cheese`, `pancetta` y `black pepper`.
...
El valor de arreglo de tu propiedad `ingredients` debe contener `spaghetti`, `Parmesan cheese`, `pancetta` y `black pepper`.
