...
Selecione o parágrafo `#result` e armazene-o em uma variável chamada `resultParagraph`.Você usará essa variável para exibir a história selecionada.

# --hints--

Você deve selecionar o parágrafo `#result` usando o método `getElementById` e armazená-lo na variável `resultParagraph`.
