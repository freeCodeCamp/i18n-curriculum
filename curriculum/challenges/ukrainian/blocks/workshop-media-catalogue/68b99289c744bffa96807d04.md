...
Наразі фільми та серіали відображаються разом, коли ви виводите каталог. У наступних кроках ви подбаєте про фільтрацію елементів у дві категорії для окремого відображення.
