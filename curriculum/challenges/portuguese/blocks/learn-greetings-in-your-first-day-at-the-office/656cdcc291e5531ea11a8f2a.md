...
The general rule for making something possessive in English is to add an apostrophe and the letter `s` (`'s`) to the end. Por exemplo, se uma mesa pertence a Sophie, você diz `Sophie's desk`.
