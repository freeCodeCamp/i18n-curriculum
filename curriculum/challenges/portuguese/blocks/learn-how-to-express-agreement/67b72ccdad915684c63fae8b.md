...
Isto descreve o design do app, significando que é fácil para os usuários navegar e usar.Esta é uma palavra composta.Lembre-se de usar `-`.
...
Isto se refere ao argumento ou observação que Jim fez sobre o app, que Maria reconhece como válido.
...
Esta frase de duas palavras mostra que Maria entende a origem do feedback de Jim. A primeira palavra termina com `-ing`.
...
Esta palavra no plural refere-se a ideias ou opiniões sobre o processo de login.
...
Esta palavra indica que Maria garantirá que o recurso `Remember Me` seja tratado como importante e trabalhado primeiro.
...
Esta palavra demonstra gratidão, significando que Maria valoriza o feedback de Jim e o vê como útil para melhoria.
