...
Per posizionare gli elementi nella card, ti servono di nuovo le classi di griglia. Assegna le classi di utilità `grid`, `grid-rows-[1fr_auto]` e `gap-6` al contenitore `div`.

Inoltre, rimuovi gli angoli netti con la classe `rounded-xl`.

# --hints--

Il tuo elemento contenitore `div` per il piano premium dovrebbe avere la classe `grid`.
...
Il tuo elemento contenitore `div` per il piano premium dovrebbe avere la classe `grid-rows-[1fr_auto]`.
...
Il tuo elemento contenitore `div` per il piano premium dovrebbe avere la classe `gap-6`.
...
Il tuo elemento contenitore `div` per il piano premium dovrebbe avere la classe `rounded-xl`.
