...
1. Acesse <a href="https://learn.microsoft.com/training/modules/csharp-readable-code/" target="_blank" rel="noreferrer">https://learn.microsoft.com/training/modules/csharp-readable-code/</a> e complete todas as tarefas do módulo "Criar Código Legível com Convenções, Espaçamento e Comentários em C#". Isso é **obrigatório** para conquistar o troféu "Criar e Executar Aplicações Simples de Console em C#" no Microsoft Learn e se qualificar para o exame de certificação.
1. Quando terminar, volte e responda corretamente à pergunta abaixo.

# --assignment--

Complete o módulo <a href="https://learn.microsoft.com/training/modules/csharp-readable-code/" target="_blank" rel="noreferrer">Criar Código Legível com Convenções, Espaçamento e Comentários em C#</a> no Microsoft Learn.Em seguida, responda a pergunta abaixo.
