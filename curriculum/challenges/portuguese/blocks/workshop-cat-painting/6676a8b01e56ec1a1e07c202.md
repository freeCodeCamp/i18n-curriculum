...
Observe que agora você tem um quadrado branco com bordas grossas.As bordas têm arestas diagonais que podem ser usadas para criar triângulos.Você vai precisar deles para criar as orelhas do seu gato.
