...
Katika mfano, ikiwa `a.name` ni sawa na `b.name`, basi kitendakazi kinarudisha `0`. Hii ina maana hakuna kinachobadilika na mpangilio wa `a` na `b` unabaki ule ule.
...
Chini ya tamko zako za `if`, rudisha nambari `0` ili kuacha mpangilio wa vipengele viwili visibadilike.

# --hints--

Unapaswa kurudisha nambari `0` chini ya tamko zako za `if`.
