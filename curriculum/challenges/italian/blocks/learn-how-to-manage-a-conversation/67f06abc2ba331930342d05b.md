...
`To be scheduled` means that something has been arranged or planned to take place at a certain time in the future. It is often used in work, school, or event planning. Per esempio:
