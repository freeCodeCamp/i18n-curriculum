...
Chagua aya ya `#result` na uhifadhi katika kigezo kinachoitwa `resultParagraph`. Utatumia kigezo hiki kuonyesha hadithi iliyochaguliwa.

# --hints--

Unapaswa kuchagua aya ya `#result` kwa kutumia njia ya `getElementById` na kuihifadhi katika kigezo cha `resultParagraph`.
