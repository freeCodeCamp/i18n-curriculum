...
In den `goTown`- und `goStore`-Funktionen gibt es Wiederholungen. Repetition in your code is a sign that you need another function.
...
Du solltest mit dem `function`-Schlüsselwort `update` deklarieren.
