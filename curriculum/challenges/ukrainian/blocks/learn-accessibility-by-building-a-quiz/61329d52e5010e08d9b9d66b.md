...
Ще одним важливим елементом `meta` для доступності та SEO є визначення `description`. Значення атрибута `content` використовується пошуковими системами для надання опису вашої сторінки.
...
Значення атрибута `content` не повинно перевищувати 165 символів. _Це максимальна довжина опису за версією Google._
