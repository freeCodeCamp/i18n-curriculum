...
Die Speisekarte sieht gut aus, aber abgesehen vom Hintergrundbild mit den Kaffeebohnen besteht sie hauptsächlich nur aus Text.

Füge unter `Coffee`-Überschrift ein Bild mit der URL `https://cdn.freecodecamp.org/curriculum/css-cafe/coffee.jpg` hinzu. Gib dem Bild einen `alt`-Wert von `coffee icon`.

# --hints--

Du solltest ein `<img>`-Tag haben.
...
Dein `img`-Element sollte ein `src`-Attribut von `https://cdn.freecodecamp.org/curriculum/css-cafe/coffee.jpg` haben.
