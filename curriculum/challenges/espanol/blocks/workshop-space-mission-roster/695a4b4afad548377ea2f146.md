...
Usa un ciclo `for` para registrar el `name` de cada astronauta en el arreglo `sorted`.

# --hints--

Debes usar un ciclo `for` para iterar a través del arreglo `sorted` y registrar el `name` de cada astronauta.
