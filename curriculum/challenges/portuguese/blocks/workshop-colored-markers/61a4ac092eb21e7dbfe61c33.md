...
Agora, modifique o segundo argumento de cores na função `linear-gradient`, que atualmente é puro verde.

Atualize a função `rgb` para que o valor para vermelho seja `245`, o valor do verde é `62` e o valor de azul `113`.

# --hints--

A regra do CSS `.red` deve ter uma propriedade `background` definida para `linear-gradient(180deg, rgb(122, 74, 14) 0%, rgb(245, 62, 113) 50%, rgb(0, 0, 255) 100%)`.
