...
أنشئ قاعدة CSS جديدة باستخدام المحدِّد `.two` واضبط خاصية `width` على 475 بكسل.

# --hints--

يجب أن يكون لديك محدِّد `.two`.
...
يجب ضبط خاصية `width` على القيمة `475px`.
...
يجب أن يحتوي عنصر `.two` على قيمة `width` تساوي `475px`.
