...
`Looks better` means something appears more attractive or visually pleasing. 例如：

`The updated login screen looks better with the new icons.` – The design is improved and more appealing.

`Works better` means something performs more efficiently or is easier to use. 例如：
