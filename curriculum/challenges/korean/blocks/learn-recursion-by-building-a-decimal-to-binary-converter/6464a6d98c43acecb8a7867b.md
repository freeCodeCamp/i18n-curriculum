...
스택 맨 위에 있는 애니메이션 객체에 `msg` 속성이 있어야 합니다.
...
`msg` 속성의 값을 `"decimalToBinary(1) returns '1' (base case) and gives that value to the stack below. Then it pops off the stack."`으로 설정해야 합니다.
