...
Du solltest das dritte Element in deinem `locations`-Array an `update` übergeben.
...
Du solltest die `console.log`-Anweisung nicht in deiner `goCave`-Funktion haben.
