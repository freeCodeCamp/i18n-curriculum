...
A che ora Sophie di solito inizia la sua giornata lavorativa?

## --answers--

Di solito inizia alle `8:30 PM`.

### --feedback--

Ricorda, `PM` è per orari pomeridiani e serali, non per la mattina.

---

Non inizia mai prima delle `8:30 AM`.

### --feedback--

Non dice che non inizia mai prima delle `8:30`.

---

Di solito inizia alle `8:30 AM`.

---

Di solito inizia alle `9:00 PM`.

### --feedback--

`PM` non è l'orario corretto per un inizio tipico mattutino, e `9:00` non è l'orario menzionato.
