...
Schreiben Sie eine Funktion, die ein Array (erstes Argument) in Gruppen der Länge `size` (zweites Argument) aufteilt und diese als zweidimensionales Array zurückgibt.
