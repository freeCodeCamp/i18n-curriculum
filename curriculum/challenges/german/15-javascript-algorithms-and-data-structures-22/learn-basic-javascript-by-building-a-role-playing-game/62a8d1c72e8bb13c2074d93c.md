...
The `currentWeaponIndex` variable is the index of the `weapons` array, but array indexing starts at zero. Der Index des letzten Elements in einem Array ist einen Wert kleiner als die Länge des Arrays.
