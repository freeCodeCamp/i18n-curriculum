...
All'interno della funzione `playSong`, chiama la funzione `highlightCurrentSong`.

Dopodiché, prova a usare i pulsanti di controllo per vedere come funziona la funzione `highlightCurrentSong`.

# --hints--

Dovresti chiamare `highlightCurrentSong` all'interno della funzione `playSong`.
