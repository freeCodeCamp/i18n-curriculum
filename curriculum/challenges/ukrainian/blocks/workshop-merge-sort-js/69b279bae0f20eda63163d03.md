...
Тепер, коли `numbers` відсортований, виведіть `'Sorted array: '` у консоль, а потім масив `numbers`.

На цьому алгоритм сортування злиттям завершено.

# --hints--

Ви повинні вивести `'Sorted array: '` у консоль.
...
Ви повинні вивести масив `numbers` у консоль після виведення `'Sorted array: '`.
