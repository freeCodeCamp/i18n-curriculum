...
A função deve retornar os dados calculados para que as chamadas possam usá-los programaticamente.

Após o loop `for...of`, adicione uma declaração `return` que retorne um array contendo `distances` e `paths`, nessa ordem.

# --hints--

Você deve retornar `[distances, paths]` após o loop `for...of`.
