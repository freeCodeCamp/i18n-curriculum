...
Тепер створіть властивість `-`, яка є функцією, яка приймає параметри `x` та `y` та неявно повертає результат віднімання `y` від `x`.
...
Функція `-` має повернути результат віднімання `y` від `x`.
