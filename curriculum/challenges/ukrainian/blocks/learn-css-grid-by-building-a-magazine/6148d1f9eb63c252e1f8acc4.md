...
Щоб надати `hr` колір, потрібно налаштувати властивість `border`. Додайте селектору `hr` множину властивостей `border`, встановлену в `1px solid rgba(120, 120, 120, 0.6)`.

# --hints--

Ваш `hr` має мати властивість `border`, встановлену в `1px solid rgba(120, 120, 120, 0.6)`.
