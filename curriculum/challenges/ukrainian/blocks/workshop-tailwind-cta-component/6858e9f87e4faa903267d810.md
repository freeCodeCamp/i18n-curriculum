...
Оскільки текст у зовнішньому `div` за замовчуванням чорний, його недостатньо добре видно. Тож додайте клас `text-white` до `div`.

# --hints--

Ваш зовнішній елемент `div` має містити утилітарний клас `text-white`.
