...
1. Cuando se use el menú desplegable para seleccionar una de las posiciones, solo deberían mostrarse los jugadores de esa posición. Si se selecciona la opción `"Todos los Jugadores"`, entonces todos los jugadores deberían mostrarse en la página.
...
Cuando se seleccione la opción `Todos los Jugadores`, deberían mostrarse todos los jugadores dentro de `#player-cards`.
...
Cuando se seleccione la opción `Posición Delantero`, sólo deberían mostrarse los jugadores delanteros dentro de `#player-cards`.
...
Cuando se seleccione la opción `Posición Centrocampista`, sólo deberían mostrarse los jugadores centrocampistas dentro de `#player-cards`.
...
Cuando se seleccione la opción `Posición Defensor`, sólo deberían mostrarse los jugadores defensores dentro de `#player-cards`.
...
Cuando se seleccione la opción `Posición Portero`, sólo deberían mostrarse los jugadores porteros.
