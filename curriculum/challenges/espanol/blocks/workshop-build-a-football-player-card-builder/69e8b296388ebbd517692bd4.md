...
Tu tercer elemento `div` de `className` de `form-group` debe tener un `label` con un atributo `htmlFor` de `pas`, un `className` de `label` y un texto `PAS`.
...
Tu tercer elemento `div` de `className` de `form-group` debe tener un `input` con un `className` de `input`, un `id` de `pas` y un `type` de `number`.
...
Tu cuarto elemento `div` de `className` de `form-group` debe tener un `label` con un atributo `htmlFor` de `dri`, un `className` de `label` y un texto `DRI`.
...
Tu cuarto elemento `div` de `className` de `form-group` debe tener un `input` con un `className` de `input`, un `id` de `dri` y un `type` de `number`.
