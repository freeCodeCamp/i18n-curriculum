...
Fanya maandishi ya `Est. 2020` kuwa na muundo wa italiki kwa kuunda kiteuzi cha class ya `established` na kuipa `font-style` yenye thamani ya `italic`.
...
Unapaswa kuweka `font-style` kuwa `italic`.
...
Kichaguzi chako cha `.established` kinafaa kuweka `font-style` kuwa `italic`.
