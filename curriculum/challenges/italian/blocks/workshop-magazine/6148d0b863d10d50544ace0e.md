...
L'altro testo è stato spostato fuori posto. Riportalo in posizione impostando al selettore `.first-paragraph::first-letter` una proprietà `float` con valore `left` e una proprietà `margin-right` con valore `1rem`.
