...
一些作者的简介比其他作者的简介长得多。  To give the cards a uniform look, you can extract the first 50 characters of each one and replace the rest with an ellipsis `"..."`. 否则，你可以展示整个简介。
