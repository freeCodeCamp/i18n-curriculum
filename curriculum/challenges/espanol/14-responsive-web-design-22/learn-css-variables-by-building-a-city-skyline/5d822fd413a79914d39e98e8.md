...
Add the same `display`, `align-items`, and `justify-content` properties and values to `.foreground-buildings` that you used on `.background-buildings`. Una vez más, esto usará Flexbox para espaciar uniformemente los edificios en la parte inferior de su contenedor.
