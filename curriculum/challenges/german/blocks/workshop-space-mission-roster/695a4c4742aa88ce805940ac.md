...
Um die Vorbereitung für Ihre Weltraummission abzuschließen, rufen Sie `printCrewSummary()` mit Ihrem `updatedSquad`-Array auf!

# --hints--

Sie sollten Ihre `printCrewSummary()`-Funktion mit `updatedSquad` aufrufen.
