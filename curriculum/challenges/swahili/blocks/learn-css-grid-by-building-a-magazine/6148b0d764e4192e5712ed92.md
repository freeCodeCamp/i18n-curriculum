...
Kwa udhibiti zaidi juu ya mpangilio wa maudhui yako, unaweza kuwa na CSS Grid ndani ya CSS Grid.

Weka sifa ya `display` ya kichaguzi chako cha `.heading` kuwa `grid`.

# --hints--

Kichaguzi chako cha `.heading` kinapaswa kuwa na sifa ya `display` iliyowekwa kuwa `grid`.
