...
Коли ви хочете представити одну людину іншій, ви можете використати фразу `Let me introduce you to [name]` (`name` — це ім'я людини). Наприклад, `Let me introduce you to Daniel`.
...
Цей дієслово означає назвати чи показати когось іншим уперше.
