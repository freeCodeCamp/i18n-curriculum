...
A separate `styles.css` file has been created for you and the editor view has been switched to that file. Você pode alternar a visualização dos arquivos nas abas na parte superior do editor.
