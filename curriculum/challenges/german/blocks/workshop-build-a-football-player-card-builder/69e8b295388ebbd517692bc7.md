...
Ersetzen Sie den fest codierten Spielernamen `PELE` innerhalb von `card-name` durch `player.name`.

# --hints--

Sie sollten den fest codierten `PELE` durch `player.name` innerhalb von `.card-name` ersetzen.
