...
أخيرًا، نفذ استدعاء `gen_parentheses` مع `3` كمعلمته لتوليد جميع التركيبات الخمسة الصحيحة لثلاثة أزواج من الأقواس العادية واطبع النتيجة في وحدة التحكم. بذلك تكتمل ورشة العمل.

# --hints--

يجب أن تطبع `gen_parentheses(3)`.
