...
Tu diccionario `constraints` debe tener una clave `last_visit_id`.
...
La clave `last_visit_id` de tu diccionario `constraints` debe tener el valor de `isinstance(last_visit_id, str)`.
