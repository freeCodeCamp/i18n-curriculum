...
A continuación está el último elemento de precios, el **Plan Familiar**.

Para comenzar, dale al `div` contenedor del plan las clases `bg-gray-100`, `ring-1`, `ring-gray-300`, `p-8` y `rounded-xl`.

# --hints--

Tu elemento `div` contenedor para el plan familiar debe tener la clase `bg-gray-100`.
...
El elemento `div` contenedor para el plan familiar debe tener la clase `ring-1`.
...
El elemento `div` contenedor para el plan familiar debe tener la clase `ring-gray-300`.
...
El elemento `div` contenedor para el plan familiar debe tener la clase `p-8`.
...
El elemento `div` contenedor para el plan familiar debe tener la clase `rounded-xl`.
