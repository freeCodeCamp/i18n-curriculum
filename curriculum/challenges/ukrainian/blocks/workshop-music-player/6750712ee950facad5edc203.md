...
Якщо трохи погратися зі своїм плеєром, ви помітите кілька помилок. По-перше, коли ви відтворюєте пісню, ставите її на паузу, а потім натискаєте кнопку попередньої або наступної пісні, пісня не починається з початку.

Щоб почати це виправляти, додайте другий параметр з іменем `start` до вашої функції `playSong`. Задайте йому значення за замовчуванням `true`.

# --hints--

Ваша функція `playSong` має мати другий параметр з іменем `start` зі значенням за замовчуванням `true`.
