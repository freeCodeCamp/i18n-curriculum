...
داخل قائمة المعلمات في دالة الاستدعاء الراجع لطريقة `map`، فكّك جميع الخصائص الخمسة للكائنات في `arr` باستخدام التفكيك.

# --hints--

يجب عليك فكّ جميع الخصائص الخمسة للكائنات في `arr` باستخدام التفكيك.
