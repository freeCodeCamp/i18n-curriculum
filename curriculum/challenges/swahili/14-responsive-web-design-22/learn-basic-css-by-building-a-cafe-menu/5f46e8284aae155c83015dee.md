...
Menyu inaonekana nzuri, lakini zaidi ya picha ya mandhari nyuma ya kahawa, ni maandishi tu.

Chini ya kichwa cha `Coffee`, ongeza picha kwa kutumia url `https://cdn.freecodecamp.org/curriculum/css-cafe/coffee.jpg`. Ipe picha thamani ya `alt` ya `coffee icon`.
