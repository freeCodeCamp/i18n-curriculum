...
Unataka kulinganisha vekta mbili, tu wakati zinapotoka katika darasa la vitu moja. Kwa hiyo tengeneza usemi wa `if` unaothibitisha kama `self` na `other` hazitoki katika darasa la vitu moja na rudisha `NotImplemented` katika hali hiyo.
# --hints--

Unapaswa kutengeneza usemi wa `if` unaothibitisha kama `self` na `other` hazitoki katika darasa la vitu moja.
...
Unapaswa kurudisha `NotImplemented` kutoka mwili wa `if`.
