...
Drehen Sie innerhalb des zweiten Wegpunkts zu `130deg` und behalten Sie die Skalierung des linken Arms bei.

# --hints--

Sie sollten dem `20%`-Wegpunkt eine `transform` von `rotate(130deg) scaleX(-1)` geben.
