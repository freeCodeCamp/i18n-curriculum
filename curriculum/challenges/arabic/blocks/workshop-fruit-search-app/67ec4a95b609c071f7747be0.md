...
داخل عنصر `form`، أضف عنصر `label`. يجب أن يحتوي عنصر `label` على النص `Search for fruits:` وعلى خاصية `htmlFor` بقيمة `"search-input"`.

# --hints--

يجب أن يكون لديك عنصر `label` داخل عنصر `form`.
...
يجب أن يحتوي عنصر `label` على خاصية `htmlFor` بقيمة `"search-input"`.
...
يجب أن يحتوي عنصر `label` على النص `Search for fruits:`.
