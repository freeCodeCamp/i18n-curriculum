...
لجعل حركة الكابينة تبدو أكثر طبيعية كحركة تأرجح، يمكنك استخدام دالة التوقيت `ease-in-out`. هذا الإعداد يجعل الحركة تبدأ وتنتهي بسرعة أبطأ، لكنها تتحرك بسرعة أكبر في منتصف الدورة.
