...
워크숍의 마지막 단계에서는 메시지 `"It was fun learning about the different Math methods with you!"`를 콘솔에 출력하세요.

이 마지막 변경으로 MathBot 워크숍을 완료했습니다!

# --hints--

메시지 `"It was fun learning about the different Math methods with you!"`를 콘솔에 출력해야 합니다.
