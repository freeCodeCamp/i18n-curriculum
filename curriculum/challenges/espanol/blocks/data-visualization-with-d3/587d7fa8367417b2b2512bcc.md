...
El siguiente paso es crear una forma para poner en el área `svg`. Hay una serie de formas compatibles en SVG, como rectángulos y círculos. Se utilizan para mostrar datos.  For example, a rectangle (`<rect>`) SVG shape could create a bar in a bar chart.
