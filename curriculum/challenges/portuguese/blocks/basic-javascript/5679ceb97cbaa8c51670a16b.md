...
Você deve se lembrar que, em <a href="/learn/javascript-algorithms-and-data-structures/basic-javascript/comparison-with-the-equality-operator" target="_blank" rel="noopener noreferrer nofollow">Comparação com o operador de igualdade</a>, todos os operadores de comparação retornam um valor booleano `true` ou `false`.
