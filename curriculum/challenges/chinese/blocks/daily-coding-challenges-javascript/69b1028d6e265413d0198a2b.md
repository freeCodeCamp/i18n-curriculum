...
给定一个日期字串，返回未来 9 个月的日期。

- 给定的字串和返回的字串格式为 `"YYYY-MM-DD"`。
- 如果未来 9 个月的月份没有原始的日期数字，则返回该月的最后一天。

# --hints--

`getDueDate("2025-03-30")` 应该返回 `"2025-12-30"`。

```js
assert.equal(getDueDate("2025-03-30"), "2025-12-30");
```

`getDueDate("2025-04-27")` 应该返回 `"2026-01-27"`。

```js
assert.equal(getDueDate("2025-04-27"), "2026-01-27");
```

`getDueDate("2025-05-29")` 应该返回 `"2026-02-28"`。

```js
assert.equal(getDueDate("2025-05-29"), "2026-02-28");
```

`getDueDate("2026-06-30")` 应该返回 `"2027-03-30"`。

```js
assert.equal(getDueDate("2026-06-30"), "2027-03-30");
```

`getDueDate("2026-10-11")` 应该返回 `"2027-07-11"`。
