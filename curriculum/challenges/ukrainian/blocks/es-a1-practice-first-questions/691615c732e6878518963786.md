...
Ángela та Sebastián розмовляють про свої професії.
...
Це друга особа дієвідміни (`tu`) дієслова `dedicarse`.
...
Цей іменник означає «аналітик».

# --explanation--

У цьому діалозі є слова `dedicas`, `representante` та `analista`.
