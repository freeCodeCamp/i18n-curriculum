...
`yourself`، `keep up`، `Is it true`، `look for`، `in the evening`، `take`، و`hang out`.
...
هذا يُكوّن سؤالًا من نوع `yes`/`no` يُستخدم لطلب التأكيد. يبدأ بفعل، يليه ضمير، ثم صفة.
...
هذا يحدد وقتًا من اليوم. يبدأ بحرف جر ثم أداة تعريف ثم اسم.
...
هذا يعني "التسجيل في درس أو المشاركة فيه".
...
هذا يعني "البحث أو محاولة إيجاد شيء ما". يبدأ بفعل ثم حرف جر.
...
هذا يصف قضاء الوقت مع الأصدقاء بشكل غير رسمي. يبدأ بفعل ثم حرف جر.
...
هذا يعني "مواكبة نفس الوتيرة أو المستوى مع شخص أو شيء آخر". يبدأ بفعل ثم حرف جر.
...
هذا ضمير انعكاسي يشير إلى المتكلم نفسه.
