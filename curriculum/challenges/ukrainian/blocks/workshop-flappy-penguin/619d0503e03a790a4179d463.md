...
Ви повинні задати `.chin` властивість `top` зі значенням `--fcc-expected--`, але знайшли `--fcc-actual--`.
...
Ви повинні задати `.chin` властивість `left` зі значенням `--fcc-expected--`, але знайшли `--fcc-actual--`.
