...
Aquí tienes un ejemplo con un formulario que tiene algunos campos de entrada obligatorios:
...
Aquí tienes un ejemplo de una etiqueta y un elemento de entrada deshabilitado.

En el CSS, estamos apuntando a ese elemento deshabilitado y dándole un color de fondo `lightgray` y cambiando el cursor a `not-allowed`.
