...
Gnome 排序是一种排序算法，类似于 <a href="https://rosettacode.org/wiki/Insertion_sort" target="_blank" rel="noopener noreferrer nofollow">插入排序</a>，但将元素移动到其正确位置是通过一系列交换完成的，类似于 <a href="https://rosettacode.org/wiki/Bubble" target="_blank" rel="noopener noreferrer nofollow">冒泡排序</a>。
