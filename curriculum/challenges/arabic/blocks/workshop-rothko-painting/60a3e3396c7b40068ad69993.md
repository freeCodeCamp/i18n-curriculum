...
استخدم خاصية `border-radius` على المحدِّد `.two`، لتعيين انحناء الزوايا العلوية اليسرى والسفلية اليمنى إلى `8px`، والانحناء العلوي الأيمن والسفلي الأيسر إلى `10px`.
...
يجب أن يحتوي عنصر `.two` على قيمة `border-radius` تساوي `8px 10px`.
