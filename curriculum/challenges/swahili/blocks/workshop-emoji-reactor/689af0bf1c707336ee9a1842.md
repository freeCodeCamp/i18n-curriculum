...
Sasa badilisha yaliyomo ya wito wa kurudisha wa msikilizaji wa tukio.

Tumia `querySelector` kutafuta kipengele cha `.count` ndani ya kitufe.

Kisha andika yaliyomo ya maandishi ya kipengele cha `.count` wakati kitufe kinapobofyanwa.

# --hints--

Unapaswa kuandika yaliyomo ya maandishi ya kipengele cha `.count` ndani ya kitufe kilichobofyanwa.
