...
Dopo il loop, aggiungi un'istruzione `return` alla tua funzione in modo che restituisca la variabile `password`.

# --hints--

Dovresti restituire `password` alla fine della tua funzione.
