...
Fato divertido: a maioria, se não todas as nadadeiras não são retângulos naturais.

Dê aos elementos `.arm` cantos superiores da esquerda, da direita e inferior da direita um raio de `30%` e ao canto inferior esquerdo um raio de `120%`.

# --hints--

Você deve dar a `.arm` uma `border-radius` de `30% 30% 30% 120%`.
