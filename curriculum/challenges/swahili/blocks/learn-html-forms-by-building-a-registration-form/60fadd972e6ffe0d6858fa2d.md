...
Itakuwa vizuri zaidi kuwa na maandishi ya `label` yakiwa juu ya vipengele vya fomu.

Chagua vipengele vyote vya `input`, `textarea`, na `select`, na vifanye kuchukua upana mzima wa vipengele vya mzazi wake.

Pia, ongeza `10px` ya `margin` juu ya vipengele vilivyochaguliwa. Weka vingine vikingo kuwa `0`.

# --hints--

Unapaswa kutumia kichaguzi cha vipengele kilichotenganishwa kwa koma kuchagua vipengele vya `input`, `textarea`, na `select`.
