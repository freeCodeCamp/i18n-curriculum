...
CRUD is used when working with databases, the UI, and RESTful APIs. RESTful APIs are a set of conventions for building web services that allow the client to interact with a database or back-end system by performing CRUD operations through standard HTTP methods.
...
You will learn more about RESTful APIs and HTTP in future lessons, but here is a quick break down of how CRUD maps to the different HTTP methods.
