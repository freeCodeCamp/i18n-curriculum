...
Деякі дієслова в англійській мові відмінюються. Тобто вони змінюють форму відповідно до особи. For most verbs, when you talk about another person like `he`, `she`, or `it`, you add an `-s` or `-es` to the verb.
...
Щоб заперечити, ви можете використати `doesn't` та початкову форму дієслова. You do not add `-s` or `-es` to the main verb because `does` is already conjugated (`do+es`).
