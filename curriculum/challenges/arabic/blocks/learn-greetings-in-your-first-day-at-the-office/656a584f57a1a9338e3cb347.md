...
تُستخدم كلمات مثل `your` و`my` للدلالة على الملكية. تشير `Your` إلى شيء يخص الشخص الذي تتحدث إليه، بينما تشير `my` إلى شيء يخصك أنت.
...
تشير هذه الكلمة إلى شيء يخص توم (المستمع).
...
تشير هذه الكلمة إلى شيء يخص صوفي (المتحدثة).
