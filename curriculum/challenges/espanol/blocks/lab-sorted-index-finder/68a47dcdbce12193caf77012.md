...
**Consejo:** El método `findIndex` es un método incorporado de arrays en JavaScript. Toma una función callback y devuelve el índice del primer elemento que cumple la condición. Tanto `findIndex` como `sort` son funciones de orden superior.
