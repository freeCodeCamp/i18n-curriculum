...
これらの区切りを作成する利点は、それぞれに特定のクラスを適用して個別にスタイルを設定できることです。最後の`double-indent`に`class`を`.divider`へ追加してください。

# --hints--

最後の`.divider`要素には、既存の値を削除せずに`double-indent`を`class`に追加してください。
