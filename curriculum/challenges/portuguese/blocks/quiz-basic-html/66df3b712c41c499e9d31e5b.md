...
Atributos booleanos só podem ser usados com caixas de seleção, enquanto atributos regulares são usados com botões de rádio.
...
Especifica a URL da fonte do arquivo de áudio.

#### --answer--

Ele adiciona controles de reprodução embutidos como play, pause e ajuste de volume.
...
Para transmitir ênfase de estresse deixando o texto em itálico.
