...
Come hai già imparato, il metodo `delete` serve per rimuovere una voce da una mappa. Gli insiemi hanno un metodo `delete` che puoi usare per rimuovere un elemento anche da loro.

A volte potrebbe servirti rimuovere tutti gli elementi da una mappa o da un insieme. Il metodo `clear` fa proprio questo lavoro.

Chiama il metodo `clear` su `plantsSet` per rimuovere tutti gli elementi da esso.

# --hints--

Dovresti chiamare il metodo `clear` su `plantsSet`.
