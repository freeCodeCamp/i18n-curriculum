...
爲這六個新元素賦予以下 `width` 和 `height` 值：`.fb1` 爲 `10%` 和 `60%`，`.fb2` 爲 `10%` 和 `40%`，`.fb3` 爲 `10%` 和 `35%`，`.fb4` 爲 `8%` 和 `45%`，`.fb5` 爲 `10%` 和 `33%`，`.fb6` 爲 `9%` 和 `38%`。
