...
Algunas muestras de audio que puedes usar para tu caja de ritmos se pueden encontrar en `https://cdn.freecodecamp.org/curriculum/drum/<fileName>`, donde `<fileName>` es el siguiente:

| parte de la batería | `fileName` |
| --- | --- |
...
Cada `.drum-pad` debe ser un elemento `button`.
