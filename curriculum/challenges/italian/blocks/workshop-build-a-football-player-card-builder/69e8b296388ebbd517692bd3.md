...
All'interno del `stats-grid`, aggiungi due elementi `div` ciascuno con l'attributo `className` impostato su `form-group`.

Per il primo, aggiungi un `label` con l'attributo `className` impostato su `label`, un `htmlFor` con `pac`, e il testo `PAC`, poi un input con un attributo `id` impostato su `pac`, un `className` impostato su `input` e un `type` impostato su `number`.

E per il secondo, aggiungi `label` con un attributo `htmlFor` impostato su `sho` e il testo `SHO`, poi un input con un attributo `id` impostato su `sho` e un `type` impostato su `number`.

# --hints--

Dovresti avere due elementi `div` ciascuno con l'attributo `className` impostato su `form-group` all'interno del `div` di `className` di `stats-grid`.
...
Il tuo primo elemento `div` di `className` di `form-group` dovrebbe avere un `label` con un attributo `htmlFor` impostato su `pac`, un `className` impostato su `label`, e un testo `PAC`.
...
Il tuo primo elemento `div` di `className` di `form-group` dovrebbe avere un `input` con un attributo `className` impostato su `input`, un `id` impostato su `pac` e un `type` impostato su `number`.
...
Il tuo secondo elemento `div` di `className` di `form-group` dovrebbe avere un `label` con un attributo `htmlFor` impostato su `sho`, un `className` impostato su `label`, e un testo `SHO`.
...
Il tuo secondo elemento `div` di `className` di `form-group` dovrebbe avere un `input` con un attributo `id` impostato su `sho`, un `className` impostato su `input`, e un `type` impostato su `number`.
