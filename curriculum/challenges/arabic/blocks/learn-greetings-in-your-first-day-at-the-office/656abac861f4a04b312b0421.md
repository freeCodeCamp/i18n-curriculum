...
اسم الإشارة `these` يُشير إلى عناصر أو تفاصيل محددة قريبة في السياق أو المكان. يُستخدم لتأكيد أو توضيح أمر يُناقش حاليًا.
...
فكر في اسم إشارة يمكن استخدامه لتسليط الضوء على تفاصيل أو عناصر محددة يجري الحديث عنها، خاصة عندما تكون قريبة في السياق أو الموقع.
