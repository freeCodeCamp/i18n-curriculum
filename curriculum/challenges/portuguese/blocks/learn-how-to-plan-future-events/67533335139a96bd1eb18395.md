...
Sarah quer **concordar** com Jake. O que ela deveria dizer?
...
Esta opção discorda de Jake, então não está alinhada com Sarah querendo concordar.
...
A frase `That sounds like a good plan` mostra concordância com as ações propostas por Jake. Sarah então adiciona uma pergunta de acompanhamento sobre os prazos do projeto, que continua a discussão.
