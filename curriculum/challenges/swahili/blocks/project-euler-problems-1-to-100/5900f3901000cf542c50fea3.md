...
Tafuta jumla ya nambari zote, chini ya `n`, ambapo 1000 ≤ `n` ≤ 1000000, ambazo ni palindromu katika msingi wa 10 na msingi wa 2.

(Tafadhali kumbuka kuwa nambari palindromu, katika msingi wowote, haiwezi kuwa na sifuri zinazoongoza.)
...
`doubleBasePalindromes(50000)` inapaswa kurudisha 105795.
...
`doubleBasePalindromes(1000000)` inapaswa kurudisha 872187.
