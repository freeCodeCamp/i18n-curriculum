...
Kitu kinachofuata cha kupamba ni maandishi ya bei, ikiwa ni pamoja na `span` ndani yake. Toa darasa la `p` kwa kipengele cha bei lenye madarasa `text-4xl`, `font-bold`, na `text-gray-900`.

# --hints--

Kipengele chako cha `p` kinapaswa kuwa na darasa la `text-4xl`.
...
Kipengele chako cha `p` kinapaswa kuwa na darasa la `font-bold`.
...
Kipengele chako cha `p` kinapaswa kuwa na darasa la `text-gray-900`.
