...
Toda la lista de descripción está dentro de un elemento de lista de descripción. El primer ingrediente, `Flour`, está dentro de un elemento de término de descripción. Luego, puedes ver cuánto de este ingrediente necesitarás: `2 cups`. Esto está dentro de un elemento de detalles de descripción justo después de su ingrediente correspondiente.

Y la misma estructura se repite para `Sugar`. En este caso, la receta solo tiene dos ingredientes, pero si hubiera más, la misma estructura podría repetirse en toda la lista de descripción.
