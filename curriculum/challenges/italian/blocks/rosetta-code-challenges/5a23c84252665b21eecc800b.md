...
title: Algoritmi di ordinamento/ordinamento pancake
challengeType: 1
forumTopicId: 302315
...
Scrivi una funzione per ordinare un array di numeri interi (di qualsiasi dimensione comoda) in ordine crescente usando l'ordinamento pancake. La funzione dovrebbe restituire l'array ordinato.

In breve, invece di ordinare singoli elementi, l'unica operazione consentita è "capovolgere" un'estremità della lista, come segue:
...
Si può capovolgere solo un'estremità della lista; dovrebbe essere l'estremità bassa, ma va bene anche quella alta se è più semplice da codificare o funziona meglio, però **deve** essere la stessa estremità per tutta la soluzione. (L'estremità capovolta non può essere cambiata arbitrariamente.)
