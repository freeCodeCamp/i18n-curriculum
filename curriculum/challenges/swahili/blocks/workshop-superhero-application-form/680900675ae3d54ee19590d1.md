...
Ifuatayo, waambie fomu jinsi ya kuwasilisha. Ongeza sifa ya kipengele ya `method` yenye thamani ya `post` na sifa ya kipengele ya `action` yenye thamani ya `https://superhero-application-form.freecodecamp.org` kwenye kipengele cha fomu.

Sasa, kuwasilisha fomu kutaituma kwa URL hiyo. Utayafanya hayo katika hatua inayofuata.
...
Kipengele chako cha `form` kinapaswa kuwa na sifa ya kipengele ya `action` iliyowekwa kuwa `https://superhero-application-form.freecodecamp.org`.
