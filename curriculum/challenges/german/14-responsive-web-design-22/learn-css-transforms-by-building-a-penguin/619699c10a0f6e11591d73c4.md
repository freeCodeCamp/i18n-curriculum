...
Du solltest `.penguin` eine `margin` von `--fcc-expected--` zuweisen, aber es wurde `--fcc-actual--` gefunden.
...
Du solltest `.penguin` eine `margin-top` von `--fcc-expected--` zuweisen, aber es wurde `--fcc-actual--` gefunden.
