...
Andererseits, wird `any` in Fragen oder negativen Sätzen verwendet und meint einen, einige oder alle. For example, `Can any student answer the question?` asks if there is at least one student who can answer.
