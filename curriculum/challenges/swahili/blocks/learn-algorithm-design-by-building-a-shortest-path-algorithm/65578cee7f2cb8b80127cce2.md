...
Kabla ya wito la `print`, tengeneza mzunguko wa `while` unaoendelea wakati `unvisited` haijajaa. Tumia neno kuu la `pass` kujaza mwili wa mzunguko.

# --hints--

Unapaswa kuwa na mzunguko wa `while` unaotekelezwa wakati `unvisited` haijajaa. Usisahau neno kuu la `pass`.
