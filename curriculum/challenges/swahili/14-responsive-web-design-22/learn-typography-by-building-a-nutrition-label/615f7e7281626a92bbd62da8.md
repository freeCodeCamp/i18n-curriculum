...
Baada ya kipengele chako cha `p` cha mwisho, unda kipengele kingine cha `p` chenye maandishi `Sodium 160mg 7%`. Put `Sodium` and `7%` each in their own `span` with a class of a `bold` like you did with the others.
...
Kipengele cha `span` kinafaa kufungia maandishi `Sodium 160mg`.
