...
`Job aids` are tools or materials, such as guides or checklists, that help employees do their work more effectively. 例如：
...
`Security tips` are pieces of advice or recommendations to help people protect systems, data, and devices from risks. 例如：
