...
Ukizingatia kichaguzi cha mtindo uleule katika hatua iliyopita, fanya ukubwa wa fonti wa vitu na bei kuwa mkubwa zaidi kwa kutumia thamani ya `18px`.

# --hints--

Unapaswa kuweka sifa ya `font-size` kuwa `18px`.
...
Vitu vyako vya `p` vilivyopangwa ndani ya vitu vya `.item` vinapaswa kuwa na `font-size` ya `18px`.
