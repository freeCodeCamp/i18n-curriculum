...
Usando el operador `and`, agrega una segunda expresión para verificar el valor de la clave `age`.

# --hints--


La clave `age` de tu diccionario `constraints` debe tener el valor de `isinstance(age, int) and age >= 18`.
