...
Usa la stessa dichiarazione `box-shadow` per `.two`, ma cambia il colore da `#efb762` a `#8f0401`.

# --hints--

Dovresti impostare la proprietà `box-shadow` su `0 0 3px 3px #8f0401`.
...
Il tuo elemento `.two` dovrebbe avere un valore `box-shadow` di `0 0 3px 3px #8f0401`.
