...
title: 如何處理像 SSH 和 GPG 金鑰這類的安全需求？
challengeType: 19
...
GPG，或稱 GNU Privacy Guard，金鑰通常用來簽署檔案或提交。其他人可以使用你的公開 GPG 金鑰來驗證該檔案的簽名是否來自你的金鑰，並確認檔案內容未被修改或竄改。SSH，或稱 Secure SHell，金鑰通常用來透過 `ssh` 工具驗證遠端連線到伺服器。不過，正如你在本課程中會學到的，你也可以使用 SSH 金鑰來簽署提交。
