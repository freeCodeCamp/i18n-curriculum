...
Щоб видалити частину вертикального проміжку між елементом `h1` та текстом `Est. 2020`, змініть нижнє поле `h1` на `15px`.

# --hints--

Встановіть властивість `margin-bottom` на `15px`.
...
Елемент `h1` повинен мати `margin-bottom` зі значенням `15px`.
