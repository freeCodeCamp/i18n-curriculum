...
حان الوقت الآن لتنفيذ وظيفة العد الفعلية.

بدلاً من تسجيل العدد الحالي فقط، يجب زيادة العدد وتحديث العرض.

احذف `console.log`.

تحقق مما إذا كان الرقم الأول الحالي داخل `.count` هو 10 بالفعل (النص هو `10/10`)، وإذا كان كذلك، فلا تفعل شيئًا.

إذا كان الرقم أقل من 10، زد العدد الحالي بمقدار 1 وحدث نص عنصر `.count`. على سبيل المثال، إذا كان العدد الحالي 2، يجب زيادته إلى 3 ويصبح نص عنصر `.count` هو `3/10`.

# --hints--

عند نقر الزر، يجب أن يزيد العدد من 0 إلى 1.
...
عند نقر الزر عدة مرات، يجب أن يزيد العدد بشكل صحيح.
...
عندما يكون العدد بالفعل 10، لا يجب أن يزيد النقر العدد أكثر.
