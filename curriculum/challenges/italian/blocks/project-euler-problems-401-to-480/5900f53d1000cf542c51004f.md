...
- $μ(n) = (-1)^{ω(n)}$ se $n$ è libero da quadrati (dove $ω(n)$ è il numero di fattori primi distinti di $n$)
- $μ(n) = 0$ se $n$ non è libero da quadrati.

Sia $P(a, b)$ il numero di numeri interi $n$ nell'intervallo $[a, b]$ tali che $μ(n) = 1$.

Sia $N(a, b)$ il numero di numeri interi $n$ nell'intervallo $[a, b]$ tali che $μ(n) = -1$.

Per esempio, $P(2, 10) = 2$ e $N(2, 10) = 4$.

Sia $C(n)$ il numero di coppie di numeri interi $(a, b)$ tali che:
