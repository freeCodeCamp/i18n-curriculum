...
Ahora, elimina las siguientes líneas desde el final de tu código:
...
No debes tener la línea `print(product)` en tu código.
...
No deberías tener la línea `discount = PercentageDiscount(10)` en tu código.
...
No deberías tener la línea `print(discount.apply_discount(product))` en tu código.
...
No deberías tener la línea `fixed_discount = FixedAmountDiscount(5)` en tu código.
...
No deberías tener la línea `print(fixed_discount.apply_discount(product))` en tu código.
