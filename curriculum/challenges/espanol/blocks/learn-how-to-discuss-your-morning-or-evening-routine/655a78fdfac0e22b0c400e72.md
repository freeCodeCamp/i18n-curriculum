...
Es el tiempo pasado de `say`, usado aquí para indicar lo que Sophie ha mencionado anteriormente.
...
Esta palabra describe algo que no es simple. Termina con `-ed`.
