...
Далі змініть два `#999` з `.bb2a` на `transparent`. Це зробить лівий і правий кордони невидимими.

# --hints--

Ви повинні змінити `border-left`, щоб використовувати `transparent`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle(".bb2a")?.borderLeft, "5vw solid transparent");
```

Ви повинні змінити `border-right`, щоб використовувати `transparent`.
