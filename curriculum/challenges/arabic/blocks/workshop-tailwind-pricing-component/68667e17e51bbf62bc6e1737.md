...
الآن يجب أن تُنسق زر الدعوة إلى الإجراء (CTA) ليبدو أكثر كزر.

لألوان الخلفية والواجهة، عيّن له الأصناف `bg-gradient-to-r`، و`from-fuchsia-500`، و`to-indigo-600`، و`text-white`، و`hover:from-fuchsia-600`، و`hover:to-indigo-700`. عيّن له أيضًا الأصناف `rounded-md` و`block`.

# --hints--

يجب أن يحتوي عنصر وسم الرابط على الصنف `bg-gradient-to-r`.
...
يجب أن يحتوي عنصر وسم الرابط على الصنف `from-fuchsia-500`.
...
يجب أن يحتوي عنصر وسم الرابط على الصنف `to-indigo-600`.
...
يجب أن يحتوي عنصر وسم الرابط على الصنف `text-white`.
...
يجب أن يحتوي عنصر وسم الرابط على الصنف `hover:from-fuchsia-600`.
...
يجب أن يحتوي عنصر وسم الرابط على الصنف `hover:to-indigo-700`.
...
يجب أن يحتوي عنصر وسم الرابط على الصنف `rounded-md`.
...
يجب أن يحتوي عنصر وسم الرابط على الصنف `block`.
