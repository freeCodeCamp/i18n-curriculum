...
Знову щільно розмістіть будівлі, додавши по два порожні `div` елементи всередині верхньої та нижньої частини `.foreground-buildings` елемента, а також ще один між `.fb2` і `.fb3`.

# --hints--

Ви повинні додати два `div` елементи як перші дочірні елементи `.foreground-buildings`.
...
Ви повинні додати один `div` елемент між `.fb2` і `.fb3`.
...
Ви повинні додати два `div` елементи як останні дочірні елементи `.foreground-buildings`.
...
Ви повинні були додати 5 нових `div` елементів.
