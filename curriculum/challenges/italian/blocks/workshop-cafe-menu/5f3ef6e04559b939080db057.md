...
Poiché tutti i lati `4` del menu hanno la stessa spaziatura interna, rimuovi le quattro proprietà e usa una singola proprietà `padding` con il valore `20px`.
...
Dovresti impostare la proprietà `padding` su `20px`.
...
Il tuo elemento `.menu` dovrebbe avere un valore `padding` di `20px`.
