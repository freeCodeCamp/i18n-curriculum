...
Центр управління попросив вас поміняти місцями двох астронавтів у вашому масиві `squad`, а саме членів із індексами `2` та `5`. Використайте вашу функцію `swapCrewMembers()` для виконання обміну і збережіть результат у новій змінній з ім’ям `updatedSquad`.

# --hints--

Ви повинні використати `swapCrewMembers()` для обміну членів `squad` з індексами `2` та `5` і зберегти отриманий масив у новій змінній з ім’ям `updatedSquad`.
