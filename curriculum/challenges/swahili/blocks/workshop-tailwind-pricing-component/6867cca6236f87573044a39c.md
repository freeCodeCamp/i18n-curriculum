...
Jambo la mwisho utakalofanya ni kupamba kitufe cha CTA kwa mpango wa familia.

Mpe madarasa `block`, `rounded-md`, `bg-indigo-600`, `px-4`, `py-2`, `text-center`, `font-semibold`, `text-white`, na `hover:bg-indigo-700`.

Kwa hayo, warsha yako ya sehemu ya bei ya Tailwind itakuwa imekamilika!

# --hints--

Kipengele chako cha nanga kinapaswa kuwa na darasa la `bg-indigo-600`.
...
Kipengele chako cha nanga kinapaswa kuwa na darasa la `px-4`.
...
Kipengele chako cha nanga kinapaswa kuwa na darasa la `py-2`.
...
Kipengele chako cha nanga kinapaswa kuwa na darasa la `text-center`.
...
Kipengele chako cha nanga kinapaswa kuwa na darasa la `text-white`.
...
Kipengele chako cha nanga kinapaswa kuwa na darasa la `font-semibold`.
...
Kipengele chako cha nanga kinapaswa kuwa na darasa la `hover:bg-indigo-700`.
...
Kipengele chako cha nanga kinapaswa kuwa na darasa la `rounded-md`.
...
Kipengele chako cha nanga kinapaswa kuwa na darasa la `block`.
