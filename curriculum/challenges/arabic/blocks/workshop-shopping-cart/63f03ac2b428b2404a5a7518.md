...
تحتاج أيضًا إلى البدء في مسح الـ HTML. عِد خاصية `innerHTML` في `productsContainer` إلى سلسلة نصية فارغة.

# --hints--

في جملة `if` الخاصة بك، يجب أن تعِد خاصية `innerHTML` في `productsContainer` إلى سلسلة نصية فارغة.
