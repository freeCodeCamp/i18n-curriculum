...
لاحظ كيف يظهر النص `8g` في المنتصف في المعاينة. قم بالتسكين لعُنصر `span` الذي يحتوي على النص `Total Fat` مع النص `8g` داخل عنصر `span` إضافي للمحاذاة.

# --hints--

يجب أن يكون لديك عنصر `span` حول الشفرة `<span class="bold">Total Fat</span> 8g`.
