...
Por fim, após os elementos `p`, crie um elemento `button`. Dê a ele um `id` definido com o valor da variável `id`, uma `class` de `btn add-to-cart-btn` e use `"Add to cart"` para o texto.
...
Seu elemento `button` deve ter o texto `"Add to cart"`.
