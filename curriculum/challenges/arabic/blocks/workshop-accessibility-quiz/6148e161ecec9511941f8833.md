...
لا يمكننا الآن قراءة النص. استهدف `footer` وعنصر وسم الرابط داخلها لتعيين لون الخط إلى لون بنسب تباين كافية.
...
يجب أن تعيّن `color` إلى قيمة بنسب تباين لا تقل عن `7:1`. _تلميح: أقترح `#dfdfe2`_
