...
This is the contraction for `I will`. La primer letra se escribe en mayúscula.

# --explanation--

`I'll` is the contraction for `I will`. It is commonly used to express decisions made at the moment of speaking or to indicate future actions. Por ejemplo:
