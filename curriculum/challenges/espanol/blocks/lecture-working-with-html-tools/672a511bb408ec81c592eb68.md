...
Para abrir las herramientas de desarrollador en tu navegador, puedes hacer clic derecho en la página y seleccionar `Inspect`.

También puedes usar `Control Shift I` en tu teclado PC o `Command Option I` en tu Mac.

Cuando abres las herramientas de desarrollador en Google Chrome, verás una serie de pestañas. La primera pestaña se llama pestaña `Elements`. Esta pestaña te muestra la estructura HTML de la página en la que estás.

La segunda pestaña se llama pestaña `Console`. Esta pestaña te muestra cualquier error que pueda estar ocurriendo en la página.
