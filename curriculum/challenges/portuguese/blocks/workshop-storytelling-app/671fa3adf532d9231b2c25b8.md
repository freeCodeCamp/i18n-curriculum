...
Abaixo do elemento `.btn-container`, você deve ter um elemento `p` com o `id` `result`. Aqui é onde a história será exibida.

# --hints--

Você deve ter um elemento `p` com o `id` `result`.
