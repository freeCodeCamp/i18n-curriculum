...
例如，10! = 10 × 9 × ... × 3 × 2 × 1 = 3628800，且数字 10! 中各位数字之和为 3 + 6 + 2 + 8 + 8 + 0 + 0 = 27。

求 `n`! 的各位数字之和！

# --hints--

`sumFactorialDigits(10)`应该返回216。

```js
assert.isNumber(sumFactorialDigits(10));
```

`sumFactorialDigits(10)`应该返回432。

```js
assert.strictEqual(sumFactorialDigits(10), 27);
```

`sumFactorialDigits(25)`应该返回648。

```js
assert.strictEqual(sumFactorialDigits(25), 72);
```

`sumFactorialDigits(50)`应该返回27。

```js
assert.strictEqual(sumFactorialDigits(50), 216);
```

`sumFactorialDigits(75)` 应该返回 432。

```js
assert.strictEqual(sumFactorialDigits(75), 432);
```

`sumFactorialDigits(100)` 应该返回 648。
