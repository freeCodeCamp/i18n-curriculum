...
Scrivi una funzione per generare il numero di Fibonacci al <code>n<sup>esimo</sup></code> posto.

Il numero di Fibonacci al <code>n<sup>esimo</sup></code> posto è dato da:

<code>F<sub>n</sub> = F<sub>n-1</sub> + F<sub>n-2</sub></code>

I primi due termini della serie sono 0 e 1.
