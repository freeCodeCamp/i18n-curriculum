...
Тепер, коли е-пошта отримана, видаліть створення об’єктів, виклики методів і інструкції виведення.

# --hints--

У вашому коді не повинно бути `alice = User("Alice")`.
...
У вашому коді не повинно бути `bob = User("Bob")`.
...
У вашому коді не повинно бути `alice.send_email(bob, "Hello", "Hi Bob, how are you?")`.
...
У вашому коді не повинно бути `print(len(bob.inbox.emails))`.
