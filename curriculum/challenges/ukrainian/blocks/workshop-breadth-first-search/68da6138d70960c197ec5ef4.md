...
Ваша функція тепер завершена. Перевірте її знову, вивівши `gen_parentheses(2)` замість `gen_parentheses(1)`.

# --hints--

Ви повинні вивести `gen_parentheses(2)`.
...
У вашому коді не повинно бути `print(gen_parentheses(1))`.
