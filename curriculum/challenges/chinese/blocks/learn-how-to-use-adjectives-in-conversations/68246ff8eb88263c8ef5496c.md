...
`Made sure` means to take action to confirm that something is true or functioning correctly. 例如：

`They made sure the software was ready before launch.` – They checked everything worked properly.

`As` is used to describe something happening at the same time as another action. 例如：
