...
Щоб прибрати частину вертикального простору між елементом `h1` і текстом `Est. 2020`, змініть нижнє поле `h1` на `15px`.

# --hints--

Ви повинні встановити властивість `margin-bottom` у значення `15px`.
...
Ваш елемент `h1` має мати поле `margin-bottom` зі значенням `15px`.
