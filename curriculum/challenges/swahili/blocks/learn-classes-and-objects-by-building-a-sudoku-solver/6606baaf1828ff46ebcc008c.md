...
`find_empty_cell` inarudisha `(0, 0)`, ambayo ni nafasi ya seli tupu ya kwanza kwenye ubao wa sudoku.

Badilisha `0` ya kwanza ndani ya `puzzle` kuwa `1`. Utaona kwenye matokeo kwamba seli inayofuata tupu itapatikana.

# --hints--

Unapaswa kubadilisha kipengee cha kwanza cha orodha ya kwanza ndani ya `puzzle` kuwa `1`.
