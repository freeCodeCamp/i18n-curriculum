...
Jetzt können Sie die Schleife zum Ausgeben jeder Zeile der Ausgabe entfernen und durch `print(graph.create_trajectory())` ersetzen.

# --hints--

Sie sollten keine Schleife im globalen Gültigkeitsbereich haben.
...
Sie sollten `print(graph.create_trajectory())` haben.
