...
title: 'المشكلة 185: لعبة Number Mind'
challengeType: 1
forumTopicId: 301821
...
لعبة Number Mind هي نسخة من اللعبة المعروفة Master Mind.

بدلًا من الدبابيس الملونة، عليك تخمين متتالية سرية من الأرقام. بعد كل تخمين، يُخبرك فقط بعدد الأماكن التي خمّنت فيها الرقم الصحيح. فإذا كانت المتتالية 1234 وخمّنت 2036، سيُخبرك بأن لديك رقمًا صحيحًا واحدًا؛ لكن لن يُخبرك بأن لديك رقمًا آخر في المكان الخطأ.

على سبيل المثال، بالنظر إلى التخمينات التالية لمتتالية سرية مكونة من 5 أرقام،
...
المتتالية الصحيحة 39542 فريدة من نوعها.

استنادًا إلى التخمينات التالية،
...
اعثر على المتتالية السرية الفريدة المكونة من 16 رقمًا.

# --hints--

`numberMind()` يجب أن تُعيد `4640261571849533`.
