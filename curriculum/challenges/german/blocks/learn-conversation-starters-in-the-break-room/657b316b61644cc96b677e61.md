...
`Pics` ist eine Kurzform von `pictures`. Wenn Sie `take pics`, verwenden Sie Ihre Kamera oder Ihr Handy, um Bilder aufzunehmen.

`Lots of` bedeutet eine große Menge oder eine große Anzahl von etwas.
...
Dieses Wort im Plural bezieht sich auf mit einer Kamera gemachte Bilder. Verwenden Sie eine Kurzform.
