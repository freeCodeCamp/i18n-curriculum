...
8. Dentro del elemento `ul`, debes tener múltiples elementos `li`, cada uno conteniendo un elemento `strong` con el nombre del actor seguido del nombre del personaje correspondiente precedido por el texto `as`. (por ejemplo, `James Holloway as Ethan Carter`).
...
Dentro del segundo elemento `p`, deberías tener un elemento `strong` con el texto `Movie Rating: `.
...
Cada `li` debe contener un elemento `strong` para el nombre del actor seguido del nombre del personaje correspondiente precedido por el texto `as`. (por ejemplo, `James Holloway as Ethan Carter`).
