...
Cuando seleccionas una categoría del menú desplegable, las tarjetas de instrumentos se filtran y muestran correctamente en la página, pero tienes que eliminar esas comas entre las tarjetas.

Hazlo uniendo el array devuelto por `instrumentCards`. Con eso, tu filtro de instrumento musical está completo.
...
Debes unir el array devuelto por la función `instrumentCards`. No modifiques tu escucha de eventos.
