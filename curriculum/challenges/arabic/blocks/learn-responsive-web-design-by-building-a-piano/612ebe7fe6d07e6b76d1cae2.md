...
أضف محدِّد `#piano` جديد داخل استعلام `@media`، واضبط الخاصية `width` على `358px`.

# --hints--

يجب أن يحتوي قاعدة `@media` على محدِّد `#piano`.
...
يجب أن يكون لمحدِّد `#piano` الجديد خاصية `width` بقيمة `358px`.
