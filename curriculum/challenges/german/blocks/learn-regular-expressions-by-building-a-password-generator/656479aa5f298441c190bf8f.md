...
Deklarieren Sie eine `generate_password`-Funktion und schreiben Sie Ihren gesamten Code außer den `import`-Zeilen in den Funktionskörper.

# --hints--

Sie sollten eine Funktion mit dem Namen `generate_password` deklarieren.
...
Die Import-Anweisungen sollten weiterhin außerhalb der Funktion stehen.
...
Die vier Variablendeklarationen sollten in die Funktion verschoben werden.
