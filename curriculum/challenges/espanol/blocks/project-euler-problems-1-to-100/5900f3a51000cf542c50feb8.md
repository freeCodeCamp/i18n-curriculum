...
title: 'Problema 57: Raíces cuadradas convergentes'
challengeType: 1
forumTopicId: 302168
...
Es posible mostrar que la raíz de dos puede ser expresada como una fracción continua infinita.
...
Las siguientes tres expansiones son $\frac {99}{70}$, $\frac {239}{169}$ y $\frac {577}{408}$, pero la octava expansión, $\frac {1393}{985}$, es el primer ejemplo donde la cantidad de dígitos en el numerador supera la cantidad de dígitos en el denominador.
