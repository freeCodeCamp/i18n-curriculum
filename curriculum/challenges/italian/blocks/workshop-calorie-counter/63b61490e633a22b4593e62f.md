...
Seguendo lo stesso pattern, assegna il tuo elemento `#add-entry` a `addEntryButton`, il tuo elemento `#clear` a `clearButton` e il tuo elemento `#output` a `output`.
...
Dovresti usare `document.getElementById()` per ottenere l'elemento `#add-entry`.
...
Dovresti usare `document.getElementById()` per ottenere l'elemento `#clear`.
...
Dovresti usare `document.getElementById()` per ottenere l'elemento `#output`.
