...
Die Punkte ${P}(x_1, y_1)$ und ${Q}(x_2, y_2)$ sind an ganzzahligen Koordinaten eingezeichnet und werden mit dem Ursprung ${O}(0, 0)$ verbunden, um das Dreieck ${\Delta}OPQ$ zu bilden.
...
Es gibt genau vierzehn Dreiecke mit einem rechten Winkel, die gebildet werden können, wenn jede Koordinate zwischen 0 und 2 inklusive liegt; das heißt, $0 ≤ x_1, y_1, x_2, y_2 ≤ 2$.
...
Gegeben, dass $0 ≤ x_1, y_1, x_2, y_2 ≤ limit$ gilt, wie viele rechtwinklige Dreiecke können gebildet werden?
