...
الآن بعد أن استهدفت العنصر الصحيح، يمكنك تحديث نصه بعد التأخير الذي حددته سابقًا.

عيّن خاصية `textContent` للعنصر المستهدف مساوية لخاصية `msg` للكائن الحالي باستخدام تسلسل الخصائص مباشرة على طريقة `.getElementById()`.

# --hints--

يجب أن تسلسل `.textContent` مع طريقة `.getElementById()`.
...
يجب أن تعيّن خاصية `textContent` للعنصر المستهدف مساوية لخاصية `msg` للكائن الحالي.
