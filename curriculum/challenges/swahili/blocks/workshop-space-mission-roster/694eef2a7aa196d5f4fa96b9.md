...
Fanya wito kwa `getEVAReadyCrew()` ukiwa na orodha yako ya `updatedSquad` na hifadhi matokeo katika kigezo kipya kinachoitwa `EVAReadySquad`. Kisha, tumia mzunguko wa `for` kupita kupitia safu ya data ya `name` na andika `EVAReadySquad` ya kila mwananga angani.

# --hints--

Unapaswa kuita `getEVAReadyCrew()` ukiwa na `updatedSquad` na kuhifadhi matokeo katika kigezo kipya kinachoitwa `EVAReadySquad`.
...
Unapaswa kutumia mzunguko wa `for` kupita kupitia safu ya data ya `EVAReadySquad` na kuandika `name` ya kila mwananga angani.
