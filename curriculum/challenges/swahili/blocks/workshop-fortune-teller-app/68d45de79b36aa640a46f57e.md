...
Unahitaji kiolesura kingine kinachoitwa `Deck`. Kiolesura hiki kinapaswa kuwa na sifa ya `cards`, ambayo ni safu ya data ya kiolesura kilichotangazwa awali.

# --hints--

Unapaswa kutangaza kiolesura kinachoitwa `Deck`.
...
Kiolesura chako cha `Deck` kinapaswa kuwa na sifa ya `cards` ya aina ya `Card[]`.
