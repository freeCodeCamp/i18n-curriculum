...
Перемістіть свою функцію `goTown` вище функції `goStore`. Потім скопіюйте та вставте вміст функції `goStore` до функції `goTown`.

# --hints--

Ваша функція `goTown` повинна йти перед функцією `goStore`.
...
Ваша функція `goTown` повинна мати такий самий вміст, що й ваша функція `goStore`.
