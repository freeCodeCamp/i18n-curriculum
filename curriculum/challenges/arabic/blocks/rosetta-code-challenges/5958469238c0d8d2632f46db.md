...
بالنظر إلى أعداد صحيحة غير سالبة `m` و `n`، أنشئ جميع التوافيق بحجم `m` من الأعداد الصحيحة من `0` (صفر) إلى `n-1` بترتيب مرتب (كل تركيبة مرتبة والجدول بأكمله مرتب).
...
يجب أن تُرجع `combinations(3, 5)` القيمة `[[0, 1, 2], [0, 1, 3], [0, 1, 4], [0, 2, 3], [0, 2, 4], [0, 3, 4], [1, 2, 3], [1, 2, 4], [1, 3, 4], [2, 3, 4]]`.

```js
assert.deepEqual(combinations(testInput1[0], testInput1[1]), testOutput1);
```

يجب أن تُرجع `combinations(4, 6)` القيمة `[[0,1,2,3], [0,1,2,4], [0,1,2,5], [0,1,3,4], [0,1,3,5], [0,1,4,5], [0,2,3,4], [0,2,3,5], [0,2,4,5], [0,3,4,5], [1,2,3,4], [1,2,3,5], [1,2,4,5], [1,3,4,5], [2,3,4,5]]`
