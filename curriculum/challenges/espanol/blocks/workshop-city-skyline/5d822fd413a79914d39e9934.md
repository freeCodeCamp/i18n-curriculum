...
Debes agregar un `repeating-linear-gradient` a `.fb6` en la propiedad `background`.
...
Debes darle al `repeating-linear-gradient` un segundo color de `transparent` desde `10%` hasta `30%`.
