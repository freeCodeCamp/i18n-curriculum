...
`socket.io@~2.3.0` 已作为依赖添加，因此请在你的服务器中使用 `http`（Node.js 内置）按如下方式 require/实例化它：
...
当你认为页面已经正确时提交。如果你遇到误差，可以<a href="https://forum.freecodecamp.org/t/advanced-node-and-express/567135#set-up-the-environment-6" target="_blank" rel="noopener noreferrer nofollow">查看到目前为止完成的项目</a>。
