...
الإعدادات الافتراضية لـ CSS Grid ستُنشئ صفوفًا إضافية حسب الحاجة، على عكس Flexbox. أعطِ المحدِّد `.social-icons` خاصية `grid-template-columns` بقيمة `repeat(5, 1fr)` لترتيب الأيقونات في صف واحد.
