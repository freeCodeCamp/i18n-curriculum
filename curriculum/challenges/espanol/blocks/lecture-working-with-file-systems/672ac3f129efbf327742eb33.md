...
Another way to search for files that you have recently opened is to open Finder by clicking on the Finder icon in the Dock. Luego, ve a "Recientes" en la barra lateral de Finder. Ahí encontrarás todos los archivos que has visto recientemente.
