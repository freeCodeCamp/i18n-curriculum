...
غيّر المعلمة الأولى المستخدمة لإنشاء `quadr_eq` إلى `-11`. بهذه الطريقة، سيكون المميز للمعادلة موجبًا.

# --hints--

يجب أن تغيّر المعلمة الأولى المستخدمة لإنشاء `quadr_eq` إلى `-11`.
