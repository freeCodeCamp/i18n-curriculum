...
Додайте ще два об’єкти до масиву `profiles` — один для Tiffany і один для Doug:
...
Ваша логіка `map()` має залишитися без змін і тепер відтворювати всі три картки.

Отже, ваш проєкт багаторазового компонента картки профілю завершено!

# --hints--

Ви маєте відтворити рівно три компоненти `Card`.
