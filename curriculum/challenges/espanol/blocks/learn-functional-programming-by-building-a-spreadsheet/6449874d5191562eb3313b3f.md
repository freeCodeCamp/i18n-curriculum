...
Finalmente, haz que tu `rangeRegex` sea global y no distinga entre mayúsculas y minúsculas.

# --hints--

Tu `rangeRegex` no debería distinguir entre mayúsculas y minúsculas.
...
Tu `rangeRegex` debería ser global.
...
Tu `rangeRegex` debería ser tanto global como no distinguir entre mayúsculas y minúsculas.
