...
title: ¿Qué es la API de `HTMLMediaElement` y cómo funciona?
challengeType: 19
...
Ya has explorado algunos de los métodos en una lección anterior sobre el elemento `Audio`, como `play()` y `pause()`. Estos mismos métodos también están disponibles en los elementos de video.
