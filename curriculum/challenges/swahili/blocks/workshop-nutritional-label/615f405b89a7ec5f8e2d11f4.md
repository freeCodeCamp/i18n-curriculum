...
Tengeneza kichaguzi kwa `.divider` mpya na weka sifa ya `border-bottom` kuwa `1px solid #888989`. Pia mpe ukingo wa juu na chini wa `2px`. Haipaswi kuwa na ukingo wa kushoto wala kulia.

# --hints--

Unapaswa kutengeneza kichaguzi cha `.divider`.
...
Kichaguzi chako cha `.divider` kinapaswa kuwa na sifa ya `margin` iliyowekwa kuwa `2px 0`.
