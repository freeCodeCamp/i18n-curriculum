...
Haz que el `header` ocupe todo el ancho de tu contenedor principal, establece su `height` a `50px` y el `background-color` a `#1b1b32`. Then, set the `display` to use _Flexbox_.
