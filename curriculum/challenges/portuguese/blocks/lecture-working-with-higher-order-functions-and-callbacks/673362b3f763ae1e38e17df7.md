...
Neste exemplo, o método `filter` aplica uma função de callback a cada elemento do array `numbers`. A callback verifica se cada número é par usando o operador de resto (`%`).
