...
Ora inizierai a lavorare sul `JavaScript`. Per farlo, inizia collegando il file `script.js` al tuo HTML.

Crea un elemento `script` con il suo attributo `src` che punta al file `script.js`. Per esempio: 
...
Dovresti creare un elemento `script`.
