...
Agora você pode remover o loop para imprimir cada linha da saída e substituí-lo por `print(graph.create_trajectory())`.

# --hints--

Você não deve ter um loop no escopo global.
...
Você deve usar `print(graph.create_trajectory())`.
