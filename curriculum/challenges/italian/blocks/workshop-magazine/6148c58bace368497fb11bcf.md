...
Proprio come con Flexbox, con CSS Grid puoi allineare il contenuto degli elementi griglia usando `align-items` e `justify-items`. `align-items` allineerà gli elementi figli lungo l'asse delle colonne, e `justify-items` allineerà gli elementi figli lungo l'asse delle righe.

Dai al selettore `.social-icons` una proprietà `align-items` impostata su `center`.

# --hints--

Il tuo selettore `.social-icons` dovrebbe avere una proprietà `align-items` impostata su `center`.
