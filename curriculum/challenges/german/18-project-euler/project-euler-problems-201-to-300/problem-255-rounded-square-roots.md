...
Wir definieren die gerundete Quadratwurzel einer positiven Integer $n$ als die Quadratwurzel von $n$, gerundet auf die nächste Integer.
...
Die Anzahl der erforderlichen Iterationen ist bei dieser Methode erstaunlich gering. Zum Beispiel können wir die gerundete Quadratwurzel einer 5-stelligen Integer ($10\\.000 ≤ n ≤ 99\\.999$) mit durchschnittlich 3,2102888889 Iterationen finden (der Durchschnittswert wurde auf 10 Dezimalstellen gerundet).
