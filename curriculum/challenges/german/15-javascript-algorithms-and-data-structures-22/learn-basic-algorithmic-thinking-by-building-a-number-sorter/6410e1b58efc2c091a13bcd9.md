...
Du solltest einen `console.log()`-Aufruf in deiner inneren Schleife verwenden.
...
Du solltest `array` als erstes Argument `console.log()` übergeben.
...
Du solltest `array[j+1]` als drittes Argument `console.log()` übergeben.
