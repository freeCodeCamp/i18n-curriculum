...
Baada ya mzunguko wako wa while, unahitaji kuweka thamani yako ya sasa. Kumbuka kuwa mzunguko wako unakoma wakati `j` iko nje ya mipaka ya safu ya data, au wakati thamani katika `j` ni ndogo kuliko thamani yako ya sasa.

Tumia opereta ya mgawo kuweka thamani yako ya sasa katika kielezo sahihi.

# --hints--

Unapaswa kuweka `currValue` katika kielezo `j + 1`.
