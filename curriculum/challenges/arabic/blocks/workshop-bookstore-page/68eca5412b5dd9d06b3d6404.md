...
أسفل عنصر `h2` في البطاقة الثانية، أضف عنصر `p` يحتوي على هذا النص:
...
يجب أن يكون لديك عنصر `p` مسكن داخل العنصر الثاني الذي يحمل صنف `card`.
...
يجب أن يكون نص عنصر `p` في بطاقتك الثانية هو `This is the story of Dave as he learns to cook everything from pancakes to pasta, one recipe at a time.`
...
يجب أن يكون عنصر `p` في بطاقتك الثانية أسفل عنصر `h2`.
