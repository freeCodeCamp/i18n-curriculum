...
`getMood("rock", 111)` dovrebbe restituire `"happy"`.

```js
assert.equal(getMood("rock", 111), "happy");
```

`getMood("electronic", 74)` dovrebbe restituire `"focus"`.

```js
assert.equal(getMood("electronic", 74), "focus");
```

`getMood("classical", 180)` dovrebbe restituire `"happy"`.

```js
assert.equal(getMood("classical", 180), "happy");
```

`getMood("rock", 155)` dovrebbe restituire `"hype"`.

```js
assert.equal(getMood("rock", 155), "hype");
```

`getMood("electronic", 90)` dovrebbe restituire `"happy"`.

```js
assert.equal(getMood("electronic", 90), "happy");
```

`getMood("classical", 67)` dovrebbe restituire `"focus"`.

```js
assert.equal(getMood("classical", 67), "focus");
```

`getMood("pop", 100)` dovrebbe restituire `"happy"`.

```js
assert.equal(getMood("pop", 100), "happy");
```

`getMood("electronic", 135)` dovrebbe restituire `"hype"`.
