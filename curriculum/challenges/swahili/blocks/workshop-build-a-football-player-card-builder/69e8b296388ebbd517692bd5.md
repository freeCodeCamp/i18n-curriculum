...
Baada ya DRI `form-group`, ongeza vipengele viwili zaidi vya `div` kila kikiwa na `className` ya `form-group` ndani ya `stats-grid`, kimoja kwa DEF na kingine kwa PHY.

Kwa ile ya DEF, ongeza `label` yenye `htmlFor` ya `def` na maandishi ya `DEF`, kisha ingizo lenye `id` ya `def` na `type` ya `number`.

Na kwa ile ya PHY, ongeza lebo yenye `htmlFor` ya `phy` na maandishi ya `PHY`, kisha ingizo lenye `id` ya `phy` na `type` ya `number`.

# --hints--

Unapaswa kuongeza seti nyingine ya vipengele viwili vya `div` kila kikiwa na `className` ya `form-group` ndani ya `div` ya `className` ya `stats-grid`.
...
Kipengele chako cha tano cha `div` cha `className` cha `form-group` kinapaswa kuwa na `label` yenye sifa ya kipengele `htmlFor` ya `def`, `className` ya `label`, na maandishi ya `DEF`.
...
Kipengele chako cha tano cha `div` cha `className` cha `form-group` kinapaswa kuwa na `input` yenye `className` ya `input`, `id` ya `def` na `type` ya `number`.
...
Kipengele chako cha sita cha `div` cha `className` cha `form-group` kinapaswa kuwa na `label` yenye sifa ya kipengele `htmlFor` ya `phy`, `className` ya `label`, na maandishi ya `PHY`.
...
Kipengele chako cha nne cha `div` cha `className` cha `form-group` kinapaswa kuwa na `input` yenye `className` ya `input`, `id` ya `phy` na `type` ya `number`.
