...
Оновіть присвоєння `text.innerText`, щоб воно дорівнювало `text` об'єкта `location`. Але замість дужкової нотації використайте <dfn>крапкову нотацію</dfn>.

Ось приклад отримання доступу до властивості `name` об’єкту під назвою `person`:
