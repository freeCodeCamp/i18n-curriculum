...
Nella domanda di Jake, presta attenzione alla forma del verbo che segue la preposizione e al suo uso nella frase.
...
È la forma in gerundio del verbo `go`, usata qui dopo la preposizione `before` per descrivere l’attività prima di dormire.
