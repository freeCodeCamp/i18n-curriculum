...
在媒体查询的 `sky` 类中，将两个 `#ffcf33` 颜色值更改为 `#ccc`，将 `#ffff66` 更改为 `#445`，将 `#bbeeff` 更改为 `#223`。 然后你可以调整窗口大小以查看背景颜色的变化。

# --hints--

你应该将第一个颜色值从 `#ffcf33` 更改为 `#ccc`。
