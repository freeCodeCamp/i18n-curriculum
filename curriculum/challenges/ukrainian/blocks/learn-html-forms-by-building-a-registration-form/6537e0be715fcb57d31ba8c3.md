...
Нарешті змініть колір тексту елемента зв’язку `terms and conditions` на `#dfdfe2`, додавши новий селектор у CSS.

Відмінна робота! Ви завершили фінальну частину практичного проєкту _Registration Form_.

# --hints--


Ви повинні надати елементу `a` `color` зі значенням `#dfdfe2`.
