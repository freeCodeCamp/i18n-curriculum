...
Você então atribui os rótulos a itens específicos da grade usando a propriedade grid-area. Ou seja, esses rótulos nomeados também são chamados de "nomes de área da grade".
