...
Оскільки весь розділ, що містить пости блогу, представляє основний вміст сторінки, його слід обгорнути в елемент `main`. Це допомагає читачам екрана та іншим допоміжним технологіям краще розуміти структуру сторінки.
...
Ваш елемент `main` має містити всі три елементи `article`.
