...
다음은 마지막 가격 항목인 **가족 요금제**입니다.

먼저, 요금제 래퍼 `div`에 클래스 `bg-gray-100`, `ring-1`, `ring-gray-300`, `p-8`, `rounded-xl`를 지정하세요.

# --hints--

가족 요금제 래퍼 `div` 요소에는 클래스 `bg-gray-100`가 있어야 합니다.
...
가족 요금제 래퍼 `div` 요소에는 클래스 `ring-1`가 있어야 합니다.
...
가족 요금제 래퍼 `div` 요소에는 클래스 `ring-gray-300`가 있어야 합니다.
...
가족 요금제 래퍼 `div` 요소에는 클래스 `p-8`가 있어야 합니다.
...
가족 요금제 래퍼 `div` 요소에는 클래스 `rounded-xl`가 있어야 합니다.
