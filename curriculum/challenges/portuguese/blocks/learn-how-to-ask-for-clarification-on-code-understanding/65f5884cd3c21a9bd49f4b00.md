...
É uma contração de `I have`, indicando algo que Sophie encontrou ou experimentou.
...
É uma contração de `cannot`, mostrando a dificuldade de Sophie em identificar o problema.
