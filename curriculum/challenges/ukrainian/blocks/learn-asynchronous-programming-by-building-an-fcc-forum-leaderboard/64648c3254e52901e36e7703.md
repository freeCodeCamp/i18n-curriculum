...
Всередині елемента `div` викличте функцію `avatars` і передайте аргументи `posters` та `users`.

Тепер ви повинні побачити аватари, які відображаються на сторінці.

# --hints--

Ви повинні викликати функцію з назвою `avatars`.
...
Ваш виклик функції має містити аргументи `posters` та `users`.
