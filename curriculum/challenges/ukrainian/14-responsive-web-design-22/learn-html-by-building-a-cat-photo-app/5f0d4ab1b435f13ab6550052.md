...
Ваш новий елемент `fieldset` повинен мати початковий теґ. Початкові теги мають такий синтаксис: `<elementName>`.
...
Новий елемент `fieldset` повинен мати кінцевий тег. Кінцеві теги мають `/` одразу після символу `<`.
