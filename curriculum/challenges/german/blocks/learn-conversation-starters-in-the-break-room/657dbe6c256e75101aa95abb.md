...
Wenn Sie Informationen bestätigen möchten (um zu sagen, dass etwas wahr ist), können Sie das Verb `do` verwenden. Es macht Ihre Antwort stärker. Zum Beispiel:

- Frage: `Do you like pizza?`

- Antwort: `Yes, I do.` – Diese Antwort ist stärker als nur `Yes.`

Sie verwenden `do`, um zu zeigen, dass Sie sich sicher sind.
...
Sophie bestätigt Toms Frage positiv, deshalb wiederholt sie das Hilfsverb, das in Toms Frage verwendet wurde.
