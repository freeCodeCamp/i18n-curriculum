...
Для додаткового контролю над макетом вашого вмісту ви можете мати CSS-сітку всередині іншої CSS-сітки.

Встановіть властивість `display` вашого селектора `.heading` у значення `grid`.
