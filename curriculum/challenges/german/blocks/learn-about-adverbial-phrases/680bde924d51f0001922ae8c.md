...
`To be based on something` means that an idea, plan, or decision uses that thing as its foundation or starting point. It shows what influences or shapes the final choice. Zum Beispiel:
