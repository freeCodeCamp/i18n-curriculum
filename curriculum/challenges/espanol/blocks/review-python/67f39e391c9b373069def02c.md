...
- **Declaración de variables**: Para declarar una variable, debes comenzar con el nombre de la variable seguido por el operador de asignación (`=`) y luego el valor. Esto puede ser un número, cadena, booleano, etc. Aquí hay algunos ejemplos:
...
The start position represents the index where the extraction should begin. La posición de parada es donde debe terminar el segmento. Esta posición no es inclusiva. La posición de paso representa el intervalo para el incremento en la segmentación. Aquí hay algunos ejemplos:
