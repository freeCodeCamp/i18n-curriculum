...
Badilisha jina la klabu lililowekwa moja kwa moja la `Santos FC` katika `card-club` na `player.club`.

# --hints--

Unapaswa kubadilisha `Santos FC` lililowekwa moja kwa moja na `player.club` katika `.card-club`.
