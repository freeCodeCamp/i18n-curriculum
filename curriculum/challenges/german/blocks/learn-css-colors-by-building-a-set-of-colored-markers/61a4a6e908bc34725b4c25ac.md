...
Legen Sie als Nächstes den Farbstopp für Rot auf `0%`, den Farbstopp für Grün auf `50%` und den Farbstopp für Blau auf `100%` fest.

# --hints--

Ihre `.red`-CSS-Regel sollte eine `background`-Eigenschaft mit dem Wert `linear-gradient(180deg, rgb(255, 0, 0) 0%, rgb(0, 255, 0) 50%, rgb(0, 0, 255) 100%)` enthalten.
