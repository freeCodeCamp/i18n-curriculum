...
`Guess` is used when you're uncertain about something, but you still form an opinion or make a suggestion. 例如：
...
`Consider` means to think carefully about something, often before making a decision. 例如：
