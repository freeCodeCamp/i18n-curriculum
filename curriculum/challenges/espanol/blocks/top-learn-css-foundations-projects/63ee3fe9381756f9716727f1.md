...
1. Debes establecer un tamaño de fuente de `28px` usando una lista de selectores.
1. Debes tener una lista de fuentes que contenga `Helvetica` y `Times New Roman` con `sans-serif` como respaldo en la lista del selector.
1. Debes ver un nombre de clase único en cada elemento.
1. Debes tener una lista de selectores para estilos que ambos elementos compartan.
...
Debes establecer el `font-size` para ambos elementos a `28px` usando una lista de selectores.
...
Debes tener un nombre de clase único en cada elemento.
...
Debes tener una lista de selectores para los estilos que ambos elementos comparten.
...
Debes tener una lista de fuentes que contenga `Helvetica` y `Times New Roman` con `sans-serif` como respaldo en la lista del selector.
