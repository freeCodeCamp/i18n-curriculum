...
Un `colleague` es alguien con quien trabajas, especialmente en un entorno profesional o formal. Los `colleagues` a menudo colaboran para resolver problemas. Por ejemplo, `My colleague helped me fix the bug in the code`.
