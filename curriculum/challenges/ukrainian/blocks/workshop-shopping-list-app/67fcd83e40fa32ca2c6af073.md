...
Тепер, коли у вас є базова структура застосунку, настав час додати кілька елементів і запустити функціонал пошуку.

Створіть масив і призначте його змінній з ім’ям `items`. Усередині масиву додайте рядки `Apples`, `Bananas`, `Strawberries`, `Blueberries`, `Mangoes`, `Pineapple`, `Lettuce`, `Broccoli`, `Paper Towels` та `Dish Soap`. Це буде список елементів, які відображатимуться у застосунку.
...
Ваш масив `items` має містити рядки `Apples`, `Bananas`, `Strawberries`, `Blueberries`, `Mangoes`, `Pineapple`, `Lettuce`, `Broccoli`, `Paper Towels` та `Dish Soap`.
