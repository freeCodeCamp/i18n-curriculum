...
Mara tu unapopata maudhui yaliyohaririwa, hayo sasa yatakuwa maudhui ya sasa.

Ndani ya msikilizaji wa tukio, weka thamani ya `newContent` kwa `currentContent`.

# --hints--

Unapaswa kuweka thamani ya `newContent` kwa `currentContent` ndani ya msikilizaji wa tukio.
