...
Ifuatayo, tengeneza safu ya data kuhifadhi nyimbo zote.

Tengeneza safu ya data tupu `allSongs`.

# --hints--

Unapaswa kuwa na kigezo kinachoitwa `allSongs`.

```js
assert.isDefined(allSongs)
```

Unapaswa weka thamani ya safu ya data kwenye kigezo chako cha `allSongs`.
