...
This word describes something that is already present or currently in use. Es endet mit `-ing`.
...
`Existing` refers to something that already exists. Zum Beispiel:
