...
Створіть селектор `html` і надайте йому властивість `font-size` зі значенням `62.5%`. Це встановить за замовчуванням розмір шрифту для вашої вебсторінки на 10px (за замовчуванням у браузера 16px).

Це полегшить вам роботу з одиницями `rem` пізніше, оскільки `2rem` дорівнюватиме 20px.
