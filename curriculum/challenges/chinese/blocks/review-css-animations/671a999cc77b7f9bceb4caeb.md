...
- **`prefers-reduced-motion` 媒体查询**：动画的主要无障碍问题之一是它们可能会给某些用户带来不适，甚至是身体伤害。 患有前庭失调症或运动敏感症的人在屏幕上看到某些类型的运动时可能会感到头晕、恶心或头痛。 通过 `prefers-reduced-motion` 媒体查询，网络开发人员可以在系统级别检测用户是否请求最小化动画或运动效果。
