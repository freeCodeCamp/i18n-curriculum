...
الآن تحتاج إلى دفع `product` إلى مصفوفة `items` الخاصة بالعربة. تذكر استخدام الكلمة المفتاحية `this`.

# --hints--

يجب عليك استدعاء طريقة `push` على مصفوفة `items`.
...
تذكر أنك تحتاج إلى استخدام الكلمة المفتاحية `this` للوصول إلى مصفوفة `items`.
...
يجب عليك `push` المتغير `product` إلى مصفوفة `items`.
