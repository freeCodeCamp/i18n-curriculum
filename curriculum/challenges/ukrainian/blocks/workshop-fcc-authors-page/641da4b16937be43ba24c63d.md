...
Ви повинні додати параметр `data` до другого методу `.then()`.
...
Другий метод `.then()` має використовувати синтаксис стрілкової функції.
...
Другий метод `.then()` має містити фігурні дужки.
...
Другий метод `.then()` має виводити у консоль `data`.
