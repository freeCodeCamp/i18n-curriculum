...
Los edificios de fondo comienzan a verse bastante bien. Cree un nuevo `div` debajo del elemento `.background-buildings` y asígnele una clase de `foreground-buildings`. Este será otro contenedor para más edificios.
...
Su nuevo `div` debe tener una clase de `foreground edings`.
