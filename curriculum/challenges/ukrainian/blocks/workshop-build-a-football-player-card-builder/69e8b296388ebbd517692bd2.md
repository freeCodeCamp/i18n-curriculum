...
Розділ інформації про гравця тепер завершено. Після закриваючого `div` розділу інформації про гравця і все ще всередині `form-panel`, додайте новий `div`. Всередині нього додайте елемент `p` з `className` `form-section-title` та текстом `Player Stats`. Потім додайте `div` з `className` `stats-grid`. Поки що залиште сітку статистики порожньою.

# --hints--

Ваш `div.form-panel` має містити другий `div` для розділу статистики гравця.
...
Розділ статистики гравця має містити `p` з `className` `form-section-title` та текстом `Player Stats`.
...
Розділ статистики гравця має містити `div` з `className` `stats-grid`.
