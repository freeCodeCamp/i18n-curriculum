...
Finalmente, en la propiedad `border-bottom` de `.bb2a`, cambie `1vw` a `5vh` y cambie el color `#000` a su variable `--building-color2`. ¡Ahí tienes, ahora se ve bien! En cualquier momento durante este proyecto, puede comentar o eliminar la propiedad `border` que agregó al principio para ver cómo se verán los edificios cuando se elimine al final.
