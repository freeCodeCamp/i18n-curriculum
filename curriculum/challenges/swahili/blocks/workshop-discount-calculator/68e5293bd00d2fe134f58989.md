...
Sasa tekeleza njia ya `apply_discount` kwa ajili ya `FixedAmountDiscount`. Njia hii inapaswa kutoa kiasi kilichowekwa kutoka kwa bei ya bidhaa na kurudisha bei mpya.

# --hints--

Darasa lako la `FixedAmountDiscount` linapaswa kuwa na njia ya `apply_discount`.
...
Njia yako ya `apply_discount` inapaswa kurudisha `product.price - self.amount`.
