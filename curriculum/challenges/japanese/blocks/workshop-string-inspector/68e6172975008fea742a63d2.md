...
最後のステップとして、メッセージ `console.log()` を含む `"Workshop complete! You now know how to use includes() and slice()."` 文を追加してください。

おめでとうございます！String Inspector ワークショップを完了しました。

# --hints--

`"Workshop complete! You now know how to use includes() and slice()."` をコンソールにログ出力してください。
