...
Geralmente é escrito no topo da folha de estilos CSS.  The asterisk selector is a wildcard selector that matches all HTML elements, so they will have a default margin of zero and a default padding of zero on all four sides. Isso lhe dará um ponto de partida e então você poderá personalizá-los em seletores CSS mais específicos mais adiante na folha de estilo.
