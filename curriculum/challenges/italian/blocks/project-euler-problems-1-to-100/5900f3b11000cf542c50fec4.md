...
title: 'Problema 69: massimo toziente'
challengeType: 1
forumTopicId: 302181
...
La funzione toziente di Euler, ${\phi}(n)$ (a volte chiamata funzione phi), serve a determinare il numero di numeri minori di `n` che sono relativamente primi a `n`. Per esempio, poiché 1, 2, 4, 5, 7 e 8 sono tutti minori di nove e relativamente primi a nove, ${\phi}(9) = 6$.

<div style='margin-left: 4em;'>

| $n$ | $\text{Relativamente primi}$ | $\displaystyle{\phi}(n)$ | $\displaystyle\frac{n}{{\phi}(n)}$ |
| --- | ----------------------------- | ------------------------ | ---------------------------------- |
| 2   | 1                             | 1                        | 2                                  |
| 3   | 1,2                           | 2                        | 1.5                                |
| 4   | 1,3                           | 2                        | 2                                  |
...
Si può vedere che `n` = 6 produce un massimo $\displaystyle\frac{n}{{\phi}(n)}$ per `n` ≤ 10.

Trova il valore di `n` ≤ `limit` per cui $\displaystyle\frac{n}{{\phi(n)}}$ è massimo.
