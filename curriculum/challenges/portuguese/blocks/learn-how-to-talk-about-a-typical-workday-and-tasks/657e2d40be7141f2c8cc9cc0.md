...
Revise a tabela de advérbios abaixo.

| Advérbio       | Significado                           |
| ------------ | --------------------------------- |
| `Always`     | Algo que acontece toda a hora.   |
| `Usually`    | Algo que acontece ocasionalmente.   |
| `Sometimes`  | Algo que acontece ocasionalmente.   |
| `Often`      | Algo que acontece frequentemente.     |
| `Rarely`     | Algo que acontece pouco.         |
| `Never`      | Algo que jamais acontece. |
...
Este advérbio significa que algo acontece frequentemente.
