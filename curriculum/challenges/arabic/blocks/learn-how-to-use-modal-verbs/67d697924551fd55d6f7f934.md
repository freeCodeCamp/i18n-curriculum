...
هاتان الكلمتان تُظهران الضرورة — شيء يجب القيام به.

# --explanation--

`Have to` تُستخدم لإظهار الضرورة — شيء يجب القيام به. على سبيل المثال:

- `We have to submit the report by Friday.` - هذا مطلوب.

- `You have to wear a seatbelt in the car.` - هذا ضروري للسلامة.
