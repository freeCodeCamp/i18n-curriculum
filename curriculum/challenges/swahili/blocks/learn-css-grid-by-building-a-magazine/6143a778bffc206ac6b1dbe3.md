...
Unda kipengele cha mwisho cha `p` mwishoni mwa kipengele chako cha `.text` na kimpatie maandishi yafuatayo:
...
Unapaswa kuongeza kipengele cha sita cha `p` kwenye kipengele cha `.text`.
