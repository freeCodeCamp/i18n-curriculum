...
title: تنسيق عدة عناصر باستخدام صنف CSS
challengeType: 0
...
تسمح الأصناف باستخدام نفس أنماط CSS على عدة عناصر HTML. يمكنك رؤية ذلك بتطبيق صنف `red-text` على أول عنصر `p`.
...
يجب أن يكون أول عنصر `p` باللون الأحمر.
...
يجب ألا يكون العنصران الثاني والثالث `p` باللون الأحمر.
...
يجب أن يحتوي أول عنصر `p` على الصنف `red-text`.
