...
`their own tasks`، `this week`، `each part`، `any plans`، `many features`، `a few weeks`، و `this project`.
...
هذه العبارة توضح أن كل مطوِّر لديه مسؤوليات محددة.
...
هذه العبارة تعني أن هناك العديد من الأجزاء أو الوظائف التي لا تزال بحاجة إلى الإنشاء.
...
هذه العبارة تعني عددًا قليلاً من الأسابيع، أي ليس منذ وقت طويل.
...
تُستخدم هذه العبارة للسؤال عما إذا كانت هناك أفكار أو استراتيجيات وُضعت بالفعل.
...
هذه العبارة تشير إلى المشروع المحدد الذي يناقشونه حاليًا.
...
هذه العبارة تشير إلى الأسبوع الحالي الذي هم فيه.
...
هذه العبارة تركز على كل قسم بشكل منفصل.
