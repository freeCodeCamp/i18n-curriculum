...
الآن بعد أن أصبحت دالة `displayStory` تعمل بشكل صحيح، حان الوقت لإضافة الوظائف إلى الأزرار.

قبل ذلك، احذف استدعاء الدالة `displayStory("scary")`.

# --hints--

يجب حذف استدعاء الدالة `displayStory("scary")`.
