...
Sasa unahitaji kuongeza msikilizaji wa tukio kwenye kipengele cha `happyBtn`.

Andika msikilizaji wa tukio na wito wake wa kurudisha ili wakati kitufe kinapobofyanwa programu iandike kwenye konsoli `Button clicked!`.

# --hints--

Wakati `happyBtn` inapobofyanwa, `Button clicked!` inapaswa kuandikwa kwenye konsoli.
