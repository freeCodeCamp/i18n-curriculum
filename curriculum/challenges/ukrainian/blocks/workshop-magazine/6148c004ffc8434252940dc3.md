...
Створіть селектор `.social-icons`. Надайте йому множину властивостей `display`, встановлену в `grid`, і множину властивостей `font-size`, встановлену в `3rem`.
...
Ваш селектор `.social-icons` повинен мати властивість `display`, встановлену в `grid`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.social-icons')?.display, 'grid');
```

Ваш селектор `.social-icons` повинен мати властивість `font-size`, встановлену в `3rem`.
