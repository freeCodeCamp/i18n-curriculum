...
En este ejemplo, la sentencia `debugger` está colocada al inicio de la función `calculateTotalPrice`. Cuando se llama a la función, la ejecución de la función se pausará.
