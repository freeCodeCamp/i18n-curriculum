...
Коли ви перепризначаєте змінну, ви можете використовувати змінну для посилання на попереднє значення перед перепризначенням. Це дозволяє вам робити такі дії, як додавати три до наявного числа. Наприклад, `bees = bees + 3;` збільшить значення `bees` на три.
