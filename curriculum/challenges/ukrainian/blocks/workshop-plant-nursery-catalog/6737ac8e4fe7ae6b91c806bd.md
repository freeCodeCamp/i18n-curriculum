...
Ще в межах своєї функції додайте об’єкт `prettyPolly` до своєї множини.

# --hints--

Ви маєте використати метод `add`, щоб додати об’єкт `prettyPolly` до своєї множини всередині функції `displayPlantsSet`.
