...
あと少しで完成です。 最後のピースに取り掛かりましょう。

ユーザーが投稿のタイトルをクリックすると、[freeCodeCamp forum](https://forum.freecodecamp.org/) 上の実際の投稿に遷移するようにします。

まず、最初の `td` 要素の中にある段落要素を、アンカー要素に変更してください。
