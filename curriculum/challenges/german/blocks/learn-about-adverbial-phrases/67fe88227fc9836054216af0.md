...
`Biweekly` means occurring either once every two weeks or twice a week. It can, thus, describe something that happens twice a week (Bob's idea) or twice a month. Zum Beispiel:
