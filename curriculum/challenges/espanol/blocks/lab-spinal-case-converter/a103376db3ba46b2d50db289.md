...
3. La función `spinalCase` debe devolver la cadena en formato spinal case. Por ejemplo, si el argumento es `ProductLanding page`, la función debe devolver `product-landing-page`.
