...
أنشئ عنصر `p` آخر بعد آخر `.divider` لديك، وأضف له النص `Total Sugars 12g`. عيّن لهذا العنصر `p` قيم `class` اللازمة لإزاحته وإزالة الحدود السفلية. ثم أنشئ `.divider` آخر أسفل عنصر `p` الجديد.
