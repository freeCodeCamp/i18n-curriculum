...
Tangaza kigezo `tax` na weka thamani yake kwa wito wa njia yako mpya ya `.calculateTaxes()`, ukipitisha `subTotal` kama hoja.

# --hints--

Tumia `const` kutangaza kigezo kinachoitwa `tax`.
...
Weka thamani ya wito wa njia yako mpya ya `.calculateTaxes()`, ukipitisha `subTotal` kama hoja, kwa kigezo cha `tax`. Kumbuka kutumia neno kuu la `this`.
