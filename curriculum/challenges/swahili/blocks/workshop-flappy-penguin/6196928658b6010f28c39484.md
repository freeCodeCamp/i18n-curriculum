...
Toa kipengele cha `.ground` `background` yenye mwelekeo wa mviringo wa mstari kwa pembe ya digrii 90 kuelekea saa, kuanzia `rgb(88, 175, 236)` na kumalizika `rgb(182, 255, 255)`.

# --hints--

Unapaswa kutoa `.ground` `background` ya `linear-gradient(90deg, rgb(88, 175, 236), rgb(182, 255, 255))`.
