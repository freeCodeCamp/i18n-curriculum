...
Al principio de tu cuerpo de función, crea una declaración `if`. Por ahora, usa `True` como la condición, y dentro del cuerpo de la declaración `if` devuelve la cadena `Shift must be an integer value.`.
