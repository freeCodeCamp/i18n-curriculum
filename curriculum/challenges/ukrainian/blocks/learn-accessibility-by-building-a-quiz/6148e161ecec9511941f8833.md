...
Зараз ми не можемо прочитати текст. Задайте `footer` і елементу посилання всередині нього колір шрифту з достатнім коефіцієнтом контрастності.
...
Ви повинні задати `color` значення з коефіцієнтом контрастності не менше ніж `7:1`. _Підказка: я пропоную `#dfdfe2`_
