...
Adicione um espaço entre os elementos `.inline` e o texto `label`, definindo uma `margin` direita de `0.5em`. Também, defina todas as outras margens como `0`.
...
Você deve dar aos elementos `.inline` uma `margin-bottom` de `0`.
