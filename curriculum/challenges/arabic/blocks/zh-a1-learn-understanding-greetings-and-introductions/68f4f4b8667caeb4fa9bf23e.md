...
هذه الكلمة تعني "بيانات"، وتشير إلى الحقائق والإحصاءات التي تُجمع للتحليل.

# --explanation--

`数据 (shù jù)` تعني "بيانات". تشير إلى الحقائق أو الإحصاءات أو المعلومات التي تُستخدم كأساس للحساب أو الاستنتاج أو التحليل.
