...
Преміум-картка з цінами має бути найбільш помітною на сторінці. Також це єдина картка, яка матиме значок `Most popular`. Щоб зробити цю картку та її значок помітнішими, ви можете використати відносне позиціювання та класи масштабування Tailwind.

Ось як можна збільшити елемент за допомогою масштабування в Tailwind CSS:
...
Позиціювання ви налаштуєте на наступних кроках. Наразі призначте клас `scale-105` обгортці `div`, щоб зробити її трохи більшою за інші картки з цінами.

# --hints--

Ваш елемент-обгортка `div` для преміум-плану має мати клас `scale-105`.
