...
Елемент `.text` не є CSS-сіткою, але ви можете створювати стовпчики в елементі без використання сітки за допомогою властивості `column-width`.

Надайте селектору `.text` властивість `column-width` зі значенням `25rem`.

# --hints--

Ваш селектор `.text` повинен мати властивість `column-width` зі значенням `25rem`.
