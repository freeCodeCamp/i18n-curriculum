...
It is used to indicate the future in this structure. Перша літера є з великою.
...
This sentence uses the structure `Will + subject + verb` to ask about a planned event in the future. This structure is common in formal questions about future arrangements. Наприклад:
