...
Después de la lista ordenada, agrega otro elemento `figure`.
...
Debería haber un elemento `figure` justo encima de la etiqueta de cierre del segundo elemento `section`.
