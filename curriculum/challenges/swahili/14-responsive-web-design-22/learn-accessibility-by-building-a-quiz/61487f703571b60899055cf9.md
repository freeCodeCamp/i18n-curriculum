...
Weka upana wa vipengele vya `section` kuwa `80%` ya kontena kuu. Kisha, tumia pambizo ili kuweka kipengee cha `section` katikati, ukiongeza `10px` kwenye ukingo wa chini.

Pia, hakikisha vipengele vya `section` haviwezi kuwa kubwa kuliko `600px` kwa upana.
