...
أضف الآن `div` مع `className` بقيمة `form-group`. بداخله، أضف `label` مع `className` بقيمة `label` و`htmlFor` خاصية بقيمة `name`. تحت ذلك، أضف `input` مع `id` محدد إلى `name`، و`className` بقيمة `input`، و`type` خاصية بقيمة `text`.

# --hints--

يجب أن يكون لديك `div` مع `className` بقيمة `form-group`.
...
يجب أن يحتوي `form-group` على `label` مع `className` بقيمة `label` و`htmlFor` خاصية بقيمة `name`.
...
يجب أن يحتوي `form-group` على `input` مع `id` بقيمة `name`، و`className` بقيمة `input`، و`type` بقيمة `text`.
