...
Katika sentensi ya Bob, anarejelea nani kwa kitenzi `us`?
...
`Us` haimaanishi mtu mmoja kama Alice.
...
`Us` haimaanishi moja kwa moja hadhira inayosikiliza mazungumzo.
...
`Us` inahusu watu, si vitu au miradi.
