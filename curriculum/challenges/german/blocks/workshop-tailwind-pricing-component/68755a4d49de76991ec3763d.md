...
Weisen Sie nun dem `span` innerhalb des `p`-Elements die Klassen `text-base`, `font-medium` und `text-gray-500` zu.

# --hints--

Das `span` innerhalb Ihres `p`-Elements sollte die Klasse `text-base` haben.
...
Das `span` innerhalb Ihres `p`-Elements sollte die Klasse `font-medium` haben.
...
Das `span` innerhalb Ihres `p`-Elements sollte die Klasse `text-gray-500` haben.
