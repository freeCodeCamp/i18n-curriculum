...
Esta tarefa prática verifica sua compreensão auditiva. Preste atenção ao tipo de empresa que está sendo descrita.
...
Marketing não é mencionado como a principal área.
...
Finanças não são referenciadas no monólogo.
...
Design não é descrito como o tipo principal de empresa.
