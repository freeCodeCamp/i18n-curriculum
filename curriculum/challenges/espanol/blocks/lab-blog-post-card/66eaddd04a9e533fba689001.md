...
4. Debes establecer el color de fondo del elemento `body` a un valor distinto de blanco.
5. Deberías aplicar los siguientes estilos al elemento `.blog-post-card`:
    - Un fondo blanco.
    - Esquinas redondeadas.
    - Un ancho de tu elección.
    - La alineación del texto de tu elección.
6. El elemento `.post-img` debería estilizarse para que la imagen llene todo el ancho de la tarjeta y tenga un borde inferior.
7. El elemento `.post-content` debería estilizarse para que haya relleno dentro de la tarjeta.
8. Los elementos `.post-title` y `.post-excerpt` deberían tener un color de texto diferente al predeterminado y márgenes en todos los lados.
9. El elemento `.read-more` debería estilizarse como un botón y tener:
...
El elemento `body` debe tener un color de fondo diferente al blanco.
