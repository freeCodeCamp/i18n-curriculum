...
Encadeamento de métodos é uma técnica de programação que permite chamar múltiplos métodos no mesmo objeto em uma única linha de código.Esta técnica pode tornar seu código mais legível e conciso, especialmente ao realizar uma série de operações no mesmo objeto.
