...
Antes de tu llamada recursiva, añade un comentario que diga `move n - 1 disks from source to auxiliary, so they are out of the way`.

# --hints--

Debes agregar un comentario con el texto proporcionado antes de tu llamada recursiva.
