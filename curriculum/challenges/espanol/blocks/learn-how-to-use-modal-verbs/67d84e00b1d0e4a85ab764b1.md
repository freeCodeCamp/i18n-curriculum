...
`targeted attack`, `have`, `might`, `firewall`, `need to`, `critical systems`, y `incident response plan`.
...
Esta frase de dos palabras expresa necesidad.
...
Es una herramienta de seguridad que bloquea el acceso no autorizado a una red.
...
Esta frase de dos palabras significa un ciberataque deliberado dirigido a una organización específica.
...
Esta frase de dos palabras significa las partes más importantes de la red de una empresa que deben mantenerse seguras.
...
Esta frase de tres palabras significa un proceso estructurado para manejar brechas de seguridad.
...
Es una parte de la frase que expresa obligación o necesidad.
