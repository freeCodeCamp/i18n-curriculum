...
Hatua zilizobaki za warsha zitahusisha kuongeza msimbo wa kuonyesha ujumbe wa kumbuka umehifadhiwa kwa njia ya mabadiliko na kurekodi kumbuka za sasa kwenye konsoli.

Anza kwa kuunda kigezo kinachoitwa `noteEl` na ukaweke thamani ya matokeo ya hoja ya utafutaji ya hati kwa kipengele chenye `id` ya `note`.

Kisha unda kigezo kingine kinachoitwa `statusEl` na ukaweke thamani ya matokeo ya hoja ya utafutaji ya hati kwa kipengele chenye `id` ya `status`.

# --hints--

Unapaswa kuwa na kigezo cha `noteEl` na ukaweke thamani ya matokeo ya hoja ya utafutaji ya hati kwa kipengele chenye `id` ya `note`.

```js
assert.equal(noteEl, document.getElementById("note"));
``` 

Unapaswa kuwa na kigezo cha `statusEl` na ukaweke thamani ya matokeo ya hoja ya utafutaji ya hati kwa kipengele chenye `id` ya `status`.
