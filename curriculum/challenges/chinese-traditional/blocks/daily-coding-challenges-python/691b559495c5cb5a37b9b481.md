...
`most_frequent([2, 3, 5, 2, 6, 3, 2, 7, 2, 9])` 應該傳回 `2`。
...
`most_frequent([True, False, "False", "True", False])` 應該傳回 `False`。
...
`most_frequent([40, 20, 70, 30, 10, 40, 10, 50, 40, 60])` 應該傳回 `40`。
