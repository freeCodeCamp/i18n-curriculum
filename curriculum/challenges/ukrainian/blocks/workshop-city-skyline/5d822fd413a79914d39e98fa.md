...
Створіть нову змінну властивості в `:root` з назвою `window-color2` та значенням `#8cd9b3`. Вона буде використовуватися як вторинний колір для цієї будівлі.

# --hints--

Ви повинні створити нову змінну властивості з назвою `window-color2` всередині `:root`.
