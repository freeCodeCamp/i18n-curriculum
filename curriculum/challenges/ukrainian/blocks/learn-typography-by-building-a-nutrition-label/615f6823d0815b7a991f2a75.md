...
Використайте свій існуючий `.divider` елемент як приклад, щоб додати новий роздільник після `p` елемента.

# --hints--

Ви повинні створити новий `div` всередині свого `.daily-value` елемента.
...
Ваш новий `div` має йти після вашого `p` елемента.
