...
In questa attività, eserciterai a identificare i reparti in base alle loro attività.
...
Questo reparto supporta i dipendenti.

# --explanation--

`Recursos humanos` significa "Risorse umane".

Sebastián dice `el departamento de recursos humanos apoya a los empleados`, che significa "Il reparto risorse umane supporta i dipendenti".
