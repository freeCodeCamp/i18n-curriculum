...
Adesso aggiungi la classe `bottom-line` al secondo elemento `hr` in modo da applicare lo stile.
...
La classe `bottom-line` dovrebbe essere applicata al secondo elemento `hr`.
