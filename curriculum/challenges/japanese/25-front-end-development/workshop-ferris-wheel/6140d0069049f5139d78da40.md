...
`transform-origin` プロパティは、CSS の座標変換の中心となる点を設定するために使われます。 For example, when you apply a `rotate` transformation (as you'll do later in this project), the `transform-origin` determines around which point the element is rotated.
