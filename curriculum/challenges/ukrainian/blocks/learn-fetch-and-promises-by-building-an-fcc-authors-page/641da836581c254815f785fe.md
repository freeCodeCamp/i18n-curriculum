...
Наступне, що ви покажете, — це біографічні дані про автора. Ви можете зробити це за допомогою `bio`, який ви деструктурували раніше.

Додайте елемент абзацу з `class` `"bio"`, а потім вставте `bio` всередину елемента абзацу.
