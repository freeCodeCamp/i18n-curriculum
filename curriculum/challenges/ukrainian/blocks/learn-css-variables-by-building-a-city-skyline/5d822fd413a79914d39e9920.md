...
Додайте `border-bottom` зі значенням `10vh solid var(--building-color3)` та `border-left` й `border-right` зі значенням `1vw solid transparent` до `.fb2a`. Цього разу трюк з кордоном створить форму в вигляді трапеції.
