...
Du solltest die Komponentenzuordnung mit `text.innerText` verwenden.
...
Du solltest den Verkettungsoperator verwenden, um die aktuelle Waffe zum String hinzuzufügen. You can get the current weapon with `weapons[currentWeaponIndex].name`.
