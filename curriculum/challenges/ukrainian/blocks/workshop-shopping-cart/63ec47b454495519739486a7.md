...
Вам потрібно відобразити доступні продукти у вашому HTML. Почніть із використання оператора додавання з присвоєнням, щоб додати порожній рядок шаблону до властивості `innerHTML` змінної `dessertCards`.
...
Ви повинні додати порожній рядок шаблону до властивості `innerHTML`.
