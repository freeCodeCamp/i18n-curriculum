...
هناك طريقة أسهل، ببساطة إضافة margin top سلبي إلى عناصر `img` لسحبها من مواقعها الحالية. يتم إنشاء القيم السلبية باستخدام `-` أمام القيمة. To complete this workshop, go ahead and use a negative top margin of `25px` in the `img` type selector.
