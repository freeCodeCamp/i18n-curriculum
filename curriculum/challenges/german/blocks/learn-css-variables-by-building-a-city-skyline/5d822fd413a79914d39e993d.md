...
Fügen Sie ganz oben in Ihrer Media Query einen `:root`-Selektor hinzu. Definieren Sie dann alle vier `--building-color`-Variablen neu, damit sie dort den Wert `#000` verwenden.

# --hints--

Sie sollten einen `:root`-Selektor zur Media Query hinzufügen.
...
Sie sollten `--building-color1` mit dem Wert `#000` hinzufügen.
...
Sie sollten `--building-color2` mit dem Wert `#000` hinzufügen.
...
Sie sollten `--building-color3` mit dem Wert `#000` hinzufügen.
...
Sie sollten `--building-color4` mit dem Wert `#000` hinzufügen.
