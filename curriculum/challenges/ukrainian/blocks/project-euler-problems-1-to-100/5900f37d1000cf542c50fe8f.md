...
2<sup>15</sup> = 32768, а сума його цифр дорівнює 3 + 2 + 7 + 6 + 8 = 26.

Яка сума цифр числа 2<sup><code>exponent</code></sup>?

# --hints--

`powerDigitSum(15)` має повертати число.

```js
assert.isNumber(powerDigitSum(15));
```

`powerDigitSum(15)` має повертати 26.

```js
assert.strictEqual(powerDigitSum(15), 26);
```

`powerDigitSum(128)` має повертати 166.

```js
assert.strictEqual(powerDigitSum(128), 166);
```

`powerDigitSum(1000)` має повертати 1366.
