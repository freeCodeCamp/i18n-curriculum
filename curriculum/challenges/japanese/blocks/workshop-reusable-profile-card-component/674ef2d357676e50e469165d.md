...
もう一度、`Card` コンポーネントを次の内容で2回使ってください。

| プロップス  | 1枚目のカードの値 | 2枚目のカードの値 |
|-------|------------------------------------------------------------|-----------------------------------------------------|
| `name`  | `"Tiffany"` | `"Doug"`|
...
既存の `Card` コンポーネントは `App` コンポーネント内で変更しないでください。
...
適切なプロップスと1枚目のカードの値を使って、`Card` コンポーネントを要素として使ってください。
...
適切なプロップスと2枚目のカードの値を使って、`Card` コンポーネントを要素として使ってください。
