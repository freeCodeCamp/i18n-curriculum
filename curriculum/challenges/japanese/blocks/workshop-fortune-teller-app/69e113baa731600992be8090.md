...
`CDN_URL` という変数を作成し、`https://cdn.freecodecamp.org/curriculum/typescript/tarot-app` に設定してください。また、`defaultImg` という変数を作成し、値を `new URL("default.svg", import.meta.url)` に設定してください。さらに、`LOCAL_DEFAULT_IMG` という変数を作成し、値を `defaultImg` に設定してください。
...
`defaultImg` 変数は `new URL("default.svg", import.meta.url)` に設定してください。
