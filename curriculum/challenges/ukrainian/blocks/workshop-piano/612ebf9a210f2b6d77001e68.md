...
Тепер додайте `.logo` селектор до `@media` запиту і встановіть властивість `width` у `150px`.

# --hints--

Ваше правило `@media` має містити селектор `.logo`.
...
Ваш новий селектор `.logo` має мати `width` зі значенням `150px`.
