...
Rudi ndani ya kitendakazi cha `getEVAReadyCrew`, fanya wito wa `sortByPriorityDescending()` ukitumia safu ya data ya `eligible` ya ndani ili ipangwe kabla haijarudishwa.

# --hints--

Unapaswa kufanya wito wa `sortByPriorityDescending()` ukitumia safu ya data ya `eligible` ya ndani.
