...
이제 나머지 속성에도 똑같이 하세요. 각 속성을 선택하려면 `getElement` 함수를 사용하세요:
...
`multipleCardsBtn`에 접근하려면 `getElement` 메서드를 사용하고 `#btn-multiple-cards`를 전달하세요.
...
`multipleCard`에 접근하려면 `getElement` 메서드를 사용하고 `.multiple_card`를 전달하세요.
...
`title`에 접근하려면 `getElement` 메서드를 사용하고 `.title`를 전달하세요.
...
`newReadingBtn`에 접근하려면 `getElement` 메서드를 사용하고 `.btn_reveal`를 전달하세요.
...
`fortuneContainer`에 접근하려면 `getElement` 메서드를 사용하고 `.fortune_container`를 전달하세요.
...
`fortuneDescription`에 접근하려면 `getElement` 메서드를 사용하고 `.fortune_description`를 전달하세요.
...
`headerTitle`에 접근하려면 `getElement` 메서드를 사용하고 `.header_title`를 전달하세요.
...
`subTitle`에 접근하려면 `getElement` 메서드를 사용하고 `.sub_title`를 전달하세요.
...
`cardTitle`에 접근하려면 `getElement` 메서드를 사용하고 `.desc_title`를 전달하세요.
...
`description`에 접근하려면 `getElement` 메서드를 사용하고 `.description`를 전달하세요.
...
`text`에 접근하려면 `getElement` 메서드를 사용하고 `.text`를 전달하세요.
