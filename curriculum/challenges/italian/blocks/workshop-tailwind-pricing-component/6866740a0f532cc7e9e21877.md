...
Passiamo al badge `Most popular`. Devi posizionarlo nell'angolo in alto a destra della card, quindi puoi usare alcune delle classi di utilità per il posizionamento di Tailwind per farlo.
