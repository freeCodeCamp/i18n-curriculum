...
Target the `.back-mountain` element, and set its `width` and `height` to `300px`. Luego, establece el `background` en un degradado lineal que comienza en `rgb(203, 241, 228)` y termina en`rgb(47, 170, 255)`.
