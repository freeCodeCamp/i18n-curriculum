...
複数の配列をループして、与えられたそれぞれの配列の$i^{th}$要素を連結した新しい配列を作成してください。

この例では、次の配列の配列が与えられた場合：
...
配列の配列をパラメータとして受け取り、指定された説明を満たす文字列の配列を返す関数を書いてください。

# --hints--

`loopSimult`は関数である必要があります。
