...
هذا يعني شيئًا يأتي أولًا ويُستخدم للتخطيط أو التحضير لشيء أكثر اكتمالًا.

# --explanation--

`Preliminary` تصف شيئًا يحدث في البداية للتحضير لشيء أكثر اكتمالًا أو نهائيًا. على سبيل المثال:

`We shared a preliminary version of the report for early review.` – هذا يعني أنه تم تقديم مسودة مبكرة للحصول على ملاحظات قبل إنهاء التقرير.
