...
Ndani ya kipengele cha nne cha `td`, sasisha thamani ya sasa ili badala yake iite kitendakazi cha `viewCount` kwa kutumia tofauti ya `views` kama hoja.

# --hints--

Unapaswa kuita kitendakazi cha `viewCount` na kupitisha tofauti ya `views` kama hoja.
