...
Встановіть ширину елементів `section` на `80%` від їхнього батьківського контейнера. Потім використайте поля, щоб центровано розмістити елементи `section`, додавши `10px` до нижнього поля.

Також переконайтеся, що елементи `section` не можуть бути ширшими за `600px`.
