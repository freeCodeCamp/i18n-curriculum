...
下一个定价卡是 **Premium Plan**。

为高级计划的包装器 `div` 添加类 `bg-gray-950`、`text-white`、`ring-2`、`ring-fuchsia-500` 和 `p-8`。

# --hints--

你的高级计划的包装器 `div` 元素应具有类 `bg-gray-950`。
...
你的高级计划的包装器 `div` 元素应具有类 `text-white`。
...
你的高级计划的包装器 `div` 元素应具有类 `ring-fuchsia-500`。
