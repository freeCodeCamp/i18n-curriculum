...
`Flexibility` — це здатність легко адаптуватися і змінюватися, коли ситуації або обставини відрізняються від очікуваних. Це означає вміти коригувати свої плани, дії чи думки за потреби без труднощів.
...
Здатність змінювати плани або умови за потреби.
