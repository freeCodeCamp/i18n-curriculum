...
Щоб лінійний градієнт залишався на правильній стороні лівої руки пінгвіна, спочатку обертайте її на `130deg`, а потім інвертуйте вісь x.

# --hints--

Ви маєте надати `.arm.left` `transform` зі значенням `rotate(130deg) scaleX(-1)`.
