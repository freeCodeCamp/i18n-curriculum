...
Sotto il dessert che hai appena aggiunto, aggiungi il resto dei dessert e dei prezzi usando altri tre elementi `article`, ciascuno con due elementi `p` annidati. Ogni elemento deve contenere il testo corretto del dessert e del prezzo, e tutti devono avere le classi corrette.
...
I tuoi elementi `.dessert` dovrebbero contenere i testi `Donut`, `Cherry Pie`, `Cheesecake` e `Cinnamon Roll`.
...
I tuoi nuovi elementi `.price` dovrebbero contenere i testi `1.50`, `2.75`, `3.00` e `2.50`.
