...
Als Nächstes wirst du biografische Angaben zum Autor aufführen. Du kannst dies mit `bio` machen, was du vorher destrukturiert hast.
...
Du solltest `bio` in dein `p`-Element interpolieren.
