...
2 つの `div` 要素を `.foreground-buildings` の最初の子要素として追加する必要があります。
...
`.fb2` と `.fb3` の間に `div` 要素を 1 つ追加する必要があります。
...
2 つの `div` 要素を `.foreground-buildings` の最後の子要素として追加する必要があります。
