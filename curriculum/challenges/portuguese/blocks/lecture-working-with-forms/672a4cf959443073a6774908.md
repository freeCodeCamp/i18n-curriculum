...
Clique em qualquer parte do espaço em branco na janela de visualização e depois pressione a tecla `tab` para ver o estado de foco. Para ver as pré-visualizações, você precisará ativar o editor interativo.
...
Ative o editor interativo e tente clicar no campo de entrada de email e você notará que ele não receberá mais foco.
...
Ative o editor interativo e tente editar o valor atual de `example@email.com` na janela de visualização e você perceberá que não é possível.
