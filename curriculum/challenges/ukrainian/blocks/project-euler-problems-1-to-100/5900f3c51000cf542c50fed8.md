...
title: 'Завдання 87: трійки простих степенів'
challengeType: 1
forumTopicId: 302201
...
Найменше число, яке можна подати у вигляді суми квадрата простого числа, куба простого числа та четвертого степеня простого числа, дорівнює `28`. Насправді існує рівно чотири числа менше п’ятдесяти, які можна подати таким чином:
...
Скільки чисел менше за `n` можна подати у вигляді суми квадрата простого числа, куба простого числа та четвертого степеня простого числа?
