...
在 Microsoft Learn 上完成 <a href="https://learn.microsoft.com/training/modules/csharp-do-while/" target="_blank" rel="noreferrer">使用 C# 中的 `do`-`while` 和 `while` 語句爲代碼添加循環邏輯</a> 模塊。 然後，回答下面的問題。
