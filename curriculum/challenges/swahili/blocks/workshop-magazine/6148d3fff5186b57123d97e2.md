...
Nukuu si nukuu halali bila alama sahihi za nukuu. Unaweza kuongeza hizi kwa kutumia vichaguzi bandia vya CSS.

Unda kichaguzi cha `.quote::before` na weka sifa ya `content` kuwa `"` ikiwa na nafasi inayofuata.

Pia, unda kichaguzi cha `.quote::after` na weka sifa ya `content` kuwa `"` ikiwa na nafasi inayotangulia.
...
Kichaguzi chako cha `.quote::before` kinapaswa kuwa na sifa ya `content` iliyowekwa kuwa `'" '`.
...
Kichaguzi chako cha `.quote::after` kinapaswa kuwa na sifa ya `content` iliyowekwa kuwa `' "'`.
