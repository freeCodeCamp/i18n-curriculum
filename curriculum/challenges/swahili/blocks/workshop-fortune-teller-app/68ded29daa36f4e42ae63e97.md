...
Malizia kitendakazi kwa kutumia njia ya safu ya data ya `forEach` kurudia juu ya hoja ya vipengele. Ndani ya kitendakazi cha mwitiko, ongeza darasa la hidden kwa kila kipengele kwa kutumia njia ya `.add()` ya `classList`.

# --hints--

Unapaswa kuwa na njia ya `forEach` iliyounganishwa na kigezo cha `elements`.
...
Njia yako ya forEach inapaswa kuchukua kigezo cha wito wa kurudisha.
...
Ndani ya njia ya forEach, unapaswa kuongeza darasa la hidden kwa kutumia njia ya `classList.add`.
