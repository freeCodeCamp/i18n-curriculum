...
Jetzt können Sie damit beginnen, Ihre Liste zu erstellen. Verwenden Sie `addCrewMember()`, um das `firstAstronaut` zu Ihrem `squad` hinzuzufügen.

# --hints--

Sie sollten `addCrewMember()` mit `squad` und `firstAstronaut` aufrufen.
