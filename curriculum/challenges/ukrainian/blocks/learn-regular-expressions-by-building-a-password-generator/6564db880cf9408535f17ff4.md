...
Клас символів `\d` є скороченням для `[0-9]`. Замініть цей клас символів на скорочення всередині вашого першого кортежа обмежень.

# --hints--

Вам слід перетворити клас `[0-9]` на `\d`.
