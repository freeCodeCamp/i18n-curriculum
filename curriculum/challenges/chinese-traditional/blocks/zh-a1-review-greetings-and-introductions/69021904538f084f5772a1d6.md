...
The neutral tone is the fifth tone in Chinese, marked by no tone mark. It's pronounced with a light and short sound. For example, in `你們 (nǐ men)`, the syllable `men` is in neutral tone.
