...
`Not for now` means that there's nothing more to say or do at the present time, but it doesn't close the door to discussing more in the future. It's a polite way to pause or end a conversation. Por ejemplo:
