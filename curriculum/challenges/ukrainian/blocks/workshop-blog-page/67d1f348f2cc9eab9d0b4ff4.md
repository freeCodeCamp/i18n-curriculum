...
Так само користувачі повинні мати змогу натиснути на адресу е-пошти та надіслати лист зі свого клієнта е-пошти за замовчуванням.

Ось як можна зробити адреси е-пошти активними:

```html
<a href="mailto:contact@company.com">contact@company.com</a>
```

Для цього фінального кроку обгорніть текст `fake@email.com` у елемент посилання та використайте `mailto:`, щоб зробити його активною адресою е-пошти.

І з цими змінами ваша сторінка блогу тепер завершена.

# --hints--

Ви повинні обгорнути текст `fake@email.com` у елемент `a`.
...
Ваш елемент `a` має мати атрибут `href`.
...
Атрибут `href` для вашого нового елемента `a` має бути встановлений у `mailto:fake@email.com`.
