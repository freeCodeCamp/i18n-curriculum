...
Ще в межах циклу `while` збільшіть значення `left_array_index` на 1.

# --hints--

Ви маєте збільшити поточне значення `left_array_index` на 1 у межах циклу `while`. Зверніть увагу, що збільшення має відбуватися після призначення елемента лівої частини до відсортованого масиву.
