...
Що Сара пропонує зробити у своїй відповіді Браяну?
...
Сара пропонує пояснити та повторити код, а не переписувати його.
...
Сара сама пропонує допомогу, а не радить звертатися до інших.
...
Вона вирішує проблему, пропонуючи разом пройтися по коду.
