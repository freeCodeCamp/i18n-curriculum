...
title: 'Problema 337: sequenze a scalini del toziente'
challengeType: 1
forumTopicId: 301995
...
Sia $\\{a_1, a_2, \ldots, a_n\\}$ una sequenza di numeri interi di lunghezza $n$ tale che:

- $a_1 = 6$
- per ogni $1 ≤ i &lt; n$ : $φ(a_i) &lt; φ(a_{i + 1}) &lt; a_i &lt; a_{i + 1}$

$φ$ indica la funzione toziente di Eulero.

Sia $S(N)$ il numero di tali sequenze con $a_n ≤ N$.

Per esempio, $S(10) = 4$: {6}, {6, 8}, {6, 8, 9} e {6, 10}.

Possiamo verificare che $S(100) = 482\\,073\\,668$ e $S(10\\,000)\bmod {10}^8 = 73\\,808\\,307$.
