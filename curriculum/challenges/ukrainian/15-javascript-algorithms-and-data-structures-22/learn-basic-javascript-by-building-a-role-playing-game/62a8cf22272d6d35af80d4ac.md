...
Ще на початку проєкту ви створили масив `inventory`. Додайте `newWeapon` в кінець масиву `inventory`, використовуючи метод `push()`.

У попередньому проєкті ви навчилися працювати з методом `push` ось так:
...
Використайте метод `push` на `inventory`.
