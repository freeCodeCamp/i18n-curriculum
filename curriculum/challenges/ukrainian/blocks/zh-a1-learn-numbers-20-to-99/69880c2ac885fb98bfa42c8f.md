...
Перейдемо до чисел у діапазоні 60-х.

Китайською числу 60 відповідає `六十 (liù shí)`.

Числа від 61 до 69 утворюються додаванням китайського позначення цифри одиниць (1–9) після `六十 (liù shí)` (60).
...
Я практикувався у вимові чисел від 60 до 69.
