...
title: 'Aufgabe 72: Brüche zählen'
challengeType: 1
forumTopicId: 302185
...
Wenn wir die Menge der gekürzten echten Brüche für `d` ≤ 8 der Größe nach aufsteigend auflisten, erhalten wir:

$$\frac{1}{8}, \frac{1}{7}, \frac{1}{6}, \frac{1}{5}, \frac{1}{4}, \frac{2}{7}, \frac{1}{3}, \frac{3}{8}, \frac{2}{5}, \frac{3}{7}, \frac{1}{2}, \frac{4}{7}, \frac{3}{5}, \frac{5}{8}, \frac{2}{3}, \frac{5}{7}, \frac{3}{4}, \frac{4}{5}, \frac{5}{6}, \frac{6}{7}, \frac{7}{8}$$

Man sieht, dass diese Menge `21` Elemente enthält.

Wie viele Elemente wären in der Menge der gekürzten echten Brüche für `d` ≤ `limit` enthalten?
