...
Ifuatayo, weka kituo cha rangi kwa nyekundu kuwa `0%`, kituo cha rangi kwa kijani kuwa `50%`, na kituo cha rangi kwa buluu kuwa `100%`.

# --hints--

Kanuni yako ya `.red` ya CSS inapaswa kuwa na sifa ya `background` iliyowekwa kuwa `linear-gradient(180deg, rgb(255, 0, 0) 0%, rgb(0, 255, 0) 50%, rgb(0, 0, 255) 100%)`.
