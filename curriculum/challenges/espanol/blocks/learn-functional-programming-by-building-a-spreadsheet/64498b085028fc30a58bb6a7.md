...
Declare una función `elemValue` que tome un parámetro `num`. La función debe estar vacía.

# --hints--

Debes declarar una variable `elemValue` después de tu función `rangeFromString()`.
