...
Centre el elemento `.three` en el lienzo configurando su `margin` a `auto`.

# --hints--

Debe configurar la propiedad `margin` a `auto`.
...
El elemento `.three` debe tener un valor de `margin` de `auto`.
