...
Avvicina di nuovo gli edifici aggiungendo due elementi `div` vuoti sia nella parte superiore sia in quella inferiore dell'elemento `.foreground-buildings`, e un altro tra `.fb2` e `.fb3`.
...
Dovresti aggiungere un elemento `div` tra `.fb2` e `.fb3`.
...
Dovresti aver aggiunto 5 nuovi elementi `div`.
