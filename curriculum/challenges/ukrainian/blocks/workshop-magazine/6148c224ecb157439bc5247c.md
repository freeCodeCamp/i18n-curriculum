...
Заводські налаштування для CSS сітки створюють додаткові рядки за потреби, на відміну від гнучкого контейнера. Додайте селектору `.social-icons` множину властивостей `grid-template-columns` зі значенням `repeat(5, 1fr)`, щоб розташувати іконки в одному рядку.

# --hints--

Ваш селектор `.social-icons` має мати множину властивостей `grid-template-columns` зі значенням `repeat(5, 1fr)`.
