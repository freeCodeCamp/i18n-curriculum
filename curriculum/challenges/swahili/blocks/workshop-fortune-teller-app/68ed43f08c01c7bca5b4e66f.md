...
Sasa, fanya vivyo hivyo kwa sifa zote zilizobaki. Tumia kitendakazi cha `getElement` kuchagua kila moja:
...
Unapaswa kupata upatikanaji wa `multipleCardsBtn` kwa kutumia njia ya `getElement` na kupitisha `#btn-multiple-cards`.
...
Unapaswa kupata upatikanaji wa `multipleCard` kwa kutumia njia ya `getElement` na kupitisha `.multiple_card`.
...
Unapaswa kupata upatikanaji wa `title` kwa kutumia njia ya `getElement` na kupitisha `.title`.
...
Unapaswa kupata upatikanaji wa `newReadingBtn` kwa kutumia njia ya `getElement` na kupitisha `.btn_reveal`.
...
Unapaswa kupata upatikanaji wa `fortuneContainer` kwa kutumia njia ya `getElement` na kupitisha `.fortune_container`.
...
Unapaswa kupata upatikanaji wa `fortuneDescription` kwa kutumia njia ya `getElement` na kupitisha `.fortune_description`.
...
Unapaswa kupata upatikanaji wa `headerTitle` kwa kutumia njia ya `getElement` na kupitisha `.header_title`.
...
Unapaswa kupata upatikanaji wa `subTitle` kwa kutumia njia ya `getElement` na kupitisha `.sub_title`.
...
Unapaswa kupata upatikanaji wa `cardTitle` kwa kutumia njia ya `getElement` na kupitisha `.desc_title`.
...
Unapaswa kupata upatikanaji wa `description` kwa kutumia njia ya `getElement` na kupitisha `.description`.
...
Unapaswa kupata upatikanaji wa `text` kwa kutumia njia ya `getElement` na kupitisha `.text`.
