...
Ili kukamilisha maandalizi ya misheni yako ya anga, fanya wito kwa `printCrewSummary()` ukiwa na safu ya data yako ya `updatedSquad`!

# --hints--

Unapaswa kufanya wito kwa kitendakazi chako cha `printCrewSummary()` ukiwa na `updatedSquad`.
