...
# --hints--
Aufruf `add_time('3:30 PM', '2:12')` sollte `'5:42 PM'` zurückgeben.
...
Aufruf `add_time('11:55 AM', '3:12')` sollte `'3:07 PM'` zurückgeben.
...
Aufruf `add_time('2:59 AM', '24:00')` sollte `'2:59 AM (next day)'` zurückgeben.
...
Aufruf `add_time('11:59 PM', '24:05')` sollte `'12:04 AM (2 days later)'` zurückgeben.
...
Aufruf `add_time('8:16 PM', '466:02')` sollte `'6:18 AM (20 days later)'` zurückgeben.
...
Aufruf `add_time('3:30 PM', '2:12', 'Monday')` sollte `'5:42 PM, Monday'` zurückgeben.
...
Aufruf `add_time('2:59 AM', '24:00', 'saturDay')` sollte `'2:59 AM, Sunday (next day)'` zurückgeben.
...
Aufruf `add_time('11:59 PM', '24:05', 'Wednesday')` sollte `'12:04 AM, Friday (2 days later)'` zurückgeben.
...
Aufruf `add_time('8:16 PM', '466:02', 'tuesday')` sollte `'6:18 AM, Monday (20 days later)'` zurückgeben.
