...
`Makes sense` ina maana kwamba jambo fulani ni wazi na rahisi kueleweka. Kwa mfano, ikiwa mtu anaeleza kwanini alichelewa na unaelewa sababu yake, unaweza kusema, `That makes sense.`
...
Ikiambatana na `make` au `makes`, ina maana kwamba jambo fulani ni wazi na rahisi kueleweka.
