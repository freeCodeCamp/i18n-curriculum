...
- `開發者 (kāi fā zhě)` – Developer

- `設計師 (shè jì shī)` – Designer

- `數據分析師 (shù jù fēn xī shī)` – Data analyst
...
**Rule**: 3rd Tone + 3rd Tone → 2nd Tone + 3rd Tone. For examples:

`你好 (nǐ hǎo)` pronounced as `ní hǎo`.

### Neutral Tone

The neutral tone is the fifth tone in Chinese, marked by no tone mark. It's pronounced with a light and short sound. For examples, in `你們 (nǐ men)`, the syllable `men` is in neutral tone.
