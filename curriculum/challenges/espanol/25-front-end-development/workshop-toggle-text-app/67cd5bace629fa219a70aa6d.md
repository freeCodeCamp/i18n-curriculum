...
En los videos de lecciones anteriores, aprendiste sobre el Sistema de Eventos Sintéticos de React y cómo trabajar con atributos como `onClick` y `onSubmit`.
