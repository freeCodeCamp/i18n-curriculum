...
У поєднанні з `to` одразу після нього, це дієслово, яке виражає обов’язок або необхідність.
...
Вираз, що означає перевагу або схильність до чогось чи когось або проти них.
