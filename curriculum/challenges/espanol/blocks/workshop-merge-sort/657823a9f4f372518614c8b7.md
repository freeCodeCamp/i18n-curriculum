...
Aún dentro del bloque `else`, incrementar `right_array_index` por `1`.

# --hints--

Debe agregar `1` al valor actual de `right_array_index` después de insertar el elemento en el arreglo ordenado.
