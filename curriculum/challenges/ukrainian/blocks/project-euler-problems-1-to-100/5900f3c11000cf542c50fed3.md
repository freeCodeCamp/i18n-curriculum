...
title: 'Завдання 84: ймовірність у монополії'
challengeType: 1
forumTopicId: 302198
...
У грі *Монополія* стандартне ігрове поле організоване таким чином:
...
Гравець починає на клітинці GO і додає значення двох шестигранних кубиків, щоб визначити, на скільки клітинок рухатися за годинниковою стрілкою. Без додаткових правил ми очікували б, що кожна клітинка відвідуватиметься з однаковою ймовірністю: 2,5%. Однак потрапляння на G2J (перейти до в’язниці), CC (спільнота) і CH (шанс) змінює цей розподіл.

Окрім G2J і однієї карти з кожної колоди CC і CH, які наказують гравцю йти безпосередньо до в’язниці, якщо гравець кидає три послідовні подвійні, він не рухається на результат третього кидка. Замість цього він одразу йде до в’язниці.

На початку гри колоди CC і CH тасуються. Коли гравець потрапляє на CC або CH, він бере карту з верхньої частини відповідної колоди і, виконавши інструкції, повертає її в низ колоди. У кожній колоді шістнадцять карт, але для цієї задачі нас цікавлять лише карти, що наказують рух; будь-які інші інструкції ігноруються, і гравець залишається на клітинці CC/CH.

<ul>
  <li>Спільнота (2/16 карт):</li>
  <ol>
    <li>Рухатися до GO</li>
    <li>Йти до в’язниці</li>
  </ol>
  ...
  <ol>
    <li>Рухатися до GO</li>
    <li>Йти до в’язниці</li>
    <li>Рухатися до C1</li>
    <li>Рухатися до E3</li>
    <li>Рухатися до H2</li>
    <li>Рухатися до R1</li>
    <li>Рухатися до наступної R (залізнична компанія)</li>
    <li>Рухатися до наступної R</li>
    <li>Рухатися до наступної U (комунальна компанія)</li>
    <li>Повернутися на 3 клітинки назад.</li>
  </ol>
</ul>

Суть цієї задачі — ймовірність потрапляння на певну клітинку. Тобто ймовірність завершити хід на цій клітинці. З цієї причини має бути зрозуміло, що, за винятком G2J, для якої ймовірність завершення на ній дорівнює нулю, клітинки CH матимуть найнижчі ймовірності, оскільки 5/8 карт наказують рухатися на іншу клітинку, і саме фінальна клітинка, на якій гравець завершує хід, нас цікавить. Ми не розрізнятимемо «просто відвідування» і перебування у в’язниці, а також ігноруватимемо правило про необхідність подвійного кидка, щоб «вийти з в’язниці», припускаючи, що гравець платить, щоб вийти у свій наступний хід.

Починаючи з GO і нумеруючи клітинки послідовно від 00 до 39, ми можемо об’єднати ці двозначні числа у рядки, що відповідають множинам клітинок.

Статистично доведено, що трійка найпопулярніших клітинок, у порядку спадання, це JAIL (6,24%) = клітинка 10, E3 (3,18%) = клітинка 24 і GO (3,09%) = клітинка 00. Отже, ці три найпопулярніші клітинки можна подати шістизначним модальним рядком `102400`.

Якщо замість двох шестигранних кубиків використовувати два `n`-гранних кубики, знайдіть шістизначний модальний рядок.
