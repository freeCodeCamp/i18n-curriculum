...
Ora, usa l'operatore **OR** per aggiungere il parametro `start` come seconda condizione all'istruzione `if` dopo `userData.currentSong === null`. 


# --hints--

Dovresti usare l'operatore **OR** per aggiungere il parametro `start` come seconda condizione all'istruzione `if` dopo `userData.currentSong === null`. 
