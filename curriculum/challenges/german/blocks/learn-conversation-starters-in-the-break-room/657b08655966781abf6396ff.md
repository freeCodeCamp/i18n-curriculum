...
Dies ist die Wortstellung für eine Aussage, nicht für eine Frage.
...
`Is` ist nicht die korrekte Form von `to be` für das Subjekt `you`.
...
Diese Option enthält Wörter in einer gemischten Reihenfolge, die keine korrekte Frage bildet.
