...
Ora, crea una funzione `initializeApp` e lasciala vuota per ora.

Questa inizializzerà l'intera app una volta che il DOM sarà caricato. Quindi, è la funzione che presto passerai a un evento `DOMContentLoaded` per far funzionare l'app.

# --hints--

Dovresti creare una funzione `initializeApp`.
