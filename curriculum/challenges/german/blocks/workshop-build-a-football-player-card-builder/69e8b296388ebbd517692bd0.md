...
Fügen Sie nach dem `form-row` ein `div` mit dem `className` von `form-group` hinzu. Darin fügen Sie ein `label`-Element mit dem `className` von `label`, einem `htmlFor` von `club` und dem Text `Club` ein. Dann fügen Sie ein Eingabeelement mit einem `id` von `club`, einem `className` von `input` und einem `type` von `text` hinzu.
...
Ihr `div.form-group` sollte ein `label` mit einem `htmlFor`-Attribut von `club`, einem `className` von `label` und dem Text `Club` haben.
...
Ihr Club `form-group` sollte ein `input` mit einem `id` von `club`, einem `className` von `input` und einem `type` von `text` enthalten.
