...
Se ha proporcionado una imagen predeterminada para la tarjeta y la URL para hacer una solicitud a la API, solo necesitas algunas variables para guardarlas.

Crea una variable `CDN_URL` y asígnale el valor `https://cdn.freecodecamp.org/curriculum/typescript/tarot-app`. También crea una variable `defaultImg` con el valor `new URL("default.svg", CDN_URL + "/")` y una variable `LOCAL_DEFAULT_IMG` con el valor `defaultImg`.

# --hints--

Debes crear una variable llamada `CDN_URL`.
...
Tu variable `CDN_URL` debe asignarse a `"https://cdn.freecodecamp.org/curriculum/typescript/tarot-app"`.
...
Debes crear una variable llamada `defaultImg`.
...
Tu variable `defaultImg` debe estar asignada a `new URL("default.svg", CDN_URL + "/")`.
...
Debes crear una variable llamada `LOCAL_DEFAULT_IMG`.
...
Tu variable `LOCAL_DEFAULT_IMG` debe asignarse a `defaultImg`.
