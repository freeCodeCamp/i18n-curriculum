...
У вашій новій функції оголосіть змінну `calories` і призначте їй значення `0`. Використовуйте `let` для оголошення, оскільки пізніше ви будете переназначати її.
