...
Chini ya kitu hicho, tengeneza kitu kipya chenye sifa zifuatazo:
...
Safu yako ya `myFavoriteFootballTeam.players` inapaswa kuwa na thamani mbili.
...
Safu yako ya `myFavoriteFootballTeam.players` inapaswa kuwa na kitu kama thamani ya pili.
...
Sifa yako ya `name` inapaswa kuwekwa kuwa `"Sergio Batista"`.
...
Sifa yako ya `position` inapaswa kuwekwa kuwa `"midfielder"`.
...
Sifa yako ya `number` inapaswa kuwekwa kuwa `2`.
