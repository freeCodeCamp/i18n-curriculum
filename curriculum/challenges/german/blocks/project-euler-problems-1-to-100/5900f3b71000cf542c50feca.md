...
title: 'Problem 75: Singuläre ganzzahlige rechtwinklige Dreiecke'
challengeType: 1
forumTopicId: 302188
...
Es stellt sich heraus, dass 12 cm die kleinste Drahtlänge ist, die genau auf eine Weise zu einem rechtwinkligen Dreieck mit ganzzahligen Seiten gebogen werden kann, aber es gibt viele weitere Beispiele.
...
Im Gegensatz dazu können einige Drahtlängen, wie 20 cm, nicht zu einem rechtwinkligen Dreieck mit ganzzahligen Seiten gebogen werden, und andere Längen erlauben mehr als eine Lösung; zum Beispiel ist es mit 120 cm möglich, genau drei verschiedene rechtwinklige Dreiecke mit ganzzahligen Seiten zu formen.

<div style='margin-left: 4em;'>
  <strong>120 cm:</strong> (30,40,50), (20,48,52), (24,45,51)<br><br>
</div>

Angenommen, L ist die Länge des Drahts, für wie viele Werte von L ≤ `n` kann genau ein rechtwinkliges Dreieck mit ganzzahligen Seiten gebildet werden?
