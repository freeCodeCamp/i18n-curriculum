...
`on`، `behind`، `on the left`، `central`، `across`، `at`، و`next to`.
...
هذه حرف جر يُستخدم لوصف موضوع أو تركيز شيء ما.
...
هذا حرف جر يشير إلى نقطة أو موقع محدد.
...
هذه العبارة المكونة من كلمتين تتضمن حرف جر وتشير إلى شيء بجانب أو مجاور لشيء آخر.
...
هذا حرف جر يعني مقابل أو على الجانب الآخر من شيء ما.
...
هذه العبارة المكونة من ثلاث كلمات تتضمن حرف جر، أداة تعريف، واتجاه. تصف موقعًا في الفضاء.
...
هذا حرف جر يصف شيئًا يقع في خلفية شيء آخر.
...
هذه صفة تعني موقعًا في المركز أو الوسط.
