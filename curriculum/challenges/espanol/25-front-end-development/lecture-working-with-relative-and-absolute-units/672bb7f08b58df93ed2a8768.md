...
¿Qué son las `em`s y `rem`s en CSS y cuándo deberías usarlas?
...
Revisa el comienzo de este video para la respuesta.
...
Revisa el final de este video para la respuesta.
