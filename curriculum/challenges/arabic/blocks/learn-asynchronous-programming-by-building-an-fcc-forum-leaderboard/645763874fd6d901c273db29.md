...
داخل العنصر الأول `td`، أضف تعبيرًا مضمنًا `${}`. داخل ذلك التعبير، استدعِ الدالة `forumCategory` مع المعلمة `category_id`.

الآن، يجب أن ترى فئة معروضة تحت كل موضوع منشور.

# --hints--

يجب أن تستدعي الدالة `forumCategory` مع المعلمة `category_id`
