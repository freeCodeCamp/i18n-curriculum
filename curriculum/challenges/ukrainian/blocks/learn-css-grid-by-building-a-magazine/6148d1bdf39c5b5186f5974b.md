...
Створіть селектор `hr` і надайте йому множину властивостей `margin`, встановлену в `1.5rem 0`.

# --hints--

У вас має бути селектор `hr`.

```js
assert(new __helpers.CSSHelp(document).getStyle('hr'));
```

Ваш селектор `hr` повинен мати множину властивостей `margin`, встановлену в `1.5rem 0`.
