...
当数组中有三个相同的数字时，你的 `getHighestDuplicates` 函数应更新 `Three of a Kind` 单选选项，内容为 `, score = ` 和骰子的总和。
...
当数组中有四个相同的数字时，你的 `getHighestDuplicates` 函数还应更新 `Three of a Kind` 单选选项，内容为 `, score = ` 和骰子的总和。
