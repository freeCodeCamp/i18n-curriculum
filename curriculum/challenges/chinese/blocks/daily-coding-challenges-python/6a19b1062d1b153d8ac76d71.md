...
`get_mood("electronic", 74)` 应该返回 `"focus"`。
...
`get_mood("classical", 180)` 应该返回 `"happy"`。
...
`get_mood("electronic", 90)` 应该返回 `"happy"`。
...
`get_mood("classical", 67)` 应该返回 `"focus"`。
...
`get_mood("electronic", 135)` 应该返回 `"hype"`。
