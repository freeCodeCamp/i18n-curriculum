...
1. A função `convertMarkdown` deve converter imagens em elementos `img`. Uma imagem em markdown é indicada por `![alt-text](image-source)`, onde `alt-text` é o valor do atributo `alt` e `image-source` é o valor do atributo `src`.
1. A função `convertMarkdown` deve converter links em elementos de âncora. Um link em markdown é indicado por `[link text](URL)`, onde `link text` é o texto a ser incluído dentro das tags de âncora e `URL` é o valor do atributo `href`.
...
Quando o valor de `#markdown-input` for `# title 1`, `convertMarkdown()` deve retornar `<h1>title 1</h1>`.
...
Quando o valor de `#markdown-input` for `# title 1`, `<h1>title 1</h1>` deve ser exibido dentro de `#html-output`.
...
Quando o valor de `#markdown-input` for `# title 1`, um elemento `h1` com o texto `title 1` deve ser adicionado como filho de `#preview`.
...
Quando o valor de `#markdown-input` for `# title 1` seguido por `# alternate title` em uma nova linha, `convertMarkdown()` deve retornar `<h1>title 1</h1><h1>alternate title</h1>`.
...
Quando o valor de `#markdown-input` for `## title 2`, `convertMarkdown()` deve retornar `<h2>title 2</h2>`.
...
Quando o valor de `#markdown-input` for `## title 2`, `<h2>title 2</h2>` deve ser exibido dentro de `#html-output`.
...
Quando o valor de `#markdown-input` for `## title 2`, um elemento `h2` com o texto `title 2` deve ser adicionado como filho de `#preview`.
...
Quando o valor de `#markdown-input` for `## title 2` seguido por `## title 2 alt` em uma nova linha, `convertMarkdown()` deve retornar `<h2>title 2</h2><h2>title 2 alt</h2>`.
...
Quando o valor de `#markdown-input` for `### title 3`, `convertMarkdown()` deve retornar `<h3>title 3</h3>`.
...
Quando o valor de `#markdown-input` for `### title 3`, `<h3>title 3</h3>` deve ser exibido dentro de `#html-output`.
...
Quando o valor de `#markdown-input` for `### title 3` seguido de `### third title` em uma nova linha, `convertMarkdown()` deve retornar `<h3>title 3</h3><h3>third title</h3>`.
...
Quando o valor de `#markdown-input` for `**this is bold**`, `convertMarkdown()` deve retornar `<strong>this is bold</strong>`.
...
Quando o valor de `#markdown-input` for `**this is bold**`, `<strong>this is bold</strong>` deve ser exibido dentro de `#html-output`.
...
Quando o valor de `#markdown-input` for `**this is bold**`, um elemento `strong` com o texto `this is bold` deve ser adicionado como filho de `#preview`.
...
Quando o valor de `#markdown-input` for `**this is bold**` seguido por `**this is also bold**` em uma nova linha, `convertMarkdown()` deve retornar `<strong>this is bold</strong><strong>this is also bold</strong>`.
...
Quando o valor de `#markdown-input` for `__this is bold__`, `<strong>this is bold</strong>` deve ser exibido dentro de `#html-output`.
...
Quando o valor de `#markdown-input` for `__this is bold__`, um elemento `strong` com o texto `this is bold` deve ser adicionado como filho de `#preview`.
...
Quando o valor de `#markdown-input` for `__this is bold__` seguido por `__this is also bold__` em uma nova linha, `convertMarkdown()` deve retornar `<strong>this is bold</strong><strong>this is also bold</strong>`.
...
Quando o valor de `#markdown-input` for `*this is italic*`, `convertMarkdown()` deve retornar `<em>this is italic</em>`.
...
Quando o valor de `#markdown-input` for `*this is italic*`, `<em>this is italic</em>` deve ser exibido dentro de `#html-output`.
...
Quando o valor de `#markdown-input` for `*this is italic*`, um elemento `em` com o texto `this is italic` deve ser adicionado como filho de `#preview`.
...
Quando o valor de `#markdown-input` for `*this is italic*` seguido por `*this is also italic*` em uma nova linha, `convertMarkdown()` deve retornar `<em>this is italic</em><em>this is also italic</em>`.
...
Quando o valor de `#markdown-input` for `_this is italic_`, `convertMarkdown()` deve retornar `<em>this is italic</em>`.
...
Quando o valor de `#markdown-input` for `_this is italic_`, `<em>this is italic</em>` deve ser exibido dentro de `#html-output`.
...
Quando o valor de `#markdown-input` for `_this is italic_`, um elemento `em` com o texto `this is italic` deve ser adicionado como filho de `#preview`.
...
Quando o valor de `#markdown-input` for `_this is italic_` seguido por `_this is also italic_` em uma nova linha, `convertMarkdown()` deve retornar `<em>this is italic</em><em>this is also italic</em>`.
...
Quando o valor de `#markdown-input` for `> this is a quote`, `convertMarkdown()` deve retornar `<blockquote>this is a quote</blockquote>`.
...
Quando o valor de `#markdown-input` for `> this is a quote`, `<blockquote>this is a quote</blockquote>` deve ser exibido dentro de `#html-output`.
...
Quando o valor de `#markdown-input` for `> this is a quote` seguido por `> this is another quote` em uma nova linha, `convertMarkdown()` deve retornar `<blockquote>this is a quote</blockquote><blockquote>this is another quote</blockquote>`.
...
Quando o valor de `#markdown-input` for `> **this is a *quote***`, `<blockquote><strong>this is a <em>quote</em></strong></blockquote>` deve ser exibido dentro de `#html-output`.
