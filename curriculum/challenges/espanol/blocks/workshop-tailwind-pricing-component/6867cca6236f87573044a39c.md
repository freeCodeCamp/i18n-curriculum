...
Lo último que harás es darle estilo al botón CTA para el plan familiar.

Asígnale las clases `block`, `rounded-md`, `bg-indigo-600`, `px-4`, `py-2`, `text-center`, `font-semibold`, `text-white` y `hover:bg-indigo-700`.

¡Con eso, tu taller del componente de precios de Tailwind está completo!

# --hints--

Tu elemento anchor debe tener la clase `bg-indigo-600`.
...
Tu elemento anchor debe tener la clase `px-4`.
...
Tu elemento anchor debe tener la clase `py-2`.
...
Tu elemento anchor debe tener la clase `text-center`.
...
Tu elemento anchor debe tener la clase `font-semibold`.
...
Tu elemento anchor debe tener la clase `hover:bg-indigo-700`.
