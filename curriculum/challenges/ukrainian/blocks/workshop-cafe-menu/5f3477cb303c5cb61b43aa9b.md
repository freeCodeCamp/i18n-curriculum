...
Текст знову вирівняний по центру, отже посилання на CSS-файл працює. Додайте до файлу ще один стиль, який змінює властивість `background-color` на `brown` для елемента `body`.
...
Встановіть властивість `background-color` у значення `brown`.
