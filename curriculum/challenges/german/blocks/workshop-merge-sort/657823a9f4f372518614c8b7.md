...
Bleiben Sie weiterhin im `else`-Block und erhöhen Sie `right_array_index` um `1`.

# --hints--

Sie sollten `1` zum aktuellen Wert von `right_array_index` hinzufügen, nachdem Sie das Element in das sortierte Array eingefügt haben.
