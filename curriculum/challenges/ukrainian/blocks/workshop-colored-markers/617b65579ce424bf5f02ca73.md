...
В цьому проєкті ви працюватимете з моделлю RGB. This means colors start as black and change as different levels of red, green, and blue are introduced. Це легко побачити з допомогою CSS-функції `rgb`.
