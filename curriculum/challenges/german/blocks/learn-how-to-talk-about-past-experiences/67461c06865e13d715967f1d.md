...
`Anything` is used in questions to ask if something happened, existed, or was present. It is neutral and does not assume the existence of anything specific. Zum Beispiel:
...
In affirmative sentences, use `something` to indicate the existence of a thing. Zum Beispiel:
