...
Examples: `Did you see him last week?` (I am asking if you saw another person in a specific moment in time - `last week` - use the Simple Past). `Have you seen him?` (I'm asking if you saw the person, regardless of when it happened - use the Present Perfect).
