...
Aqui está um exemplo mostrando um elemento `button` sem estilo e um com estilo. 
...
Tente ajustar o tamanho da janela de visualização para ver como o layout se adapta ao tamanho da tela.
