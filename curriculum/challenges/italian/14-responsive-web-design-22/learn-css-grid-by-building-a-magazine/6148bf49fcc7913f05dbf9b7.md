...
Questo cambierà il colore al passaggio del mouse solo per l'elemento `a` all'interno di `.author-name`, mostrando il verde originale di freeCodeCamp sullo sfondo.
...
Il selettore `.author-name a:hover` dovrebbe avere una proprietà `background-color` impostata su `#306203`.
