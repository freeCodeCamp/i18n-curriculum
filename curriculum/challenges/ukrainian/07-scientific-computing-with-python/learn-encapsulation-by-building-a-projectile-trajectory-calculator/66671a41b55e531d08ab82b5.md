...
Метод `__str__` безпосередньо посилається на атрибути класу, але тепер, коли ви створили геттери, краще використати їх для отримання цих значень.

Відредагуйте метод `__str__`, щоб більше не посилатися на атрибути, а використати геттери.
...
Не посилайтеся на приватні властивості безпосередньо.
