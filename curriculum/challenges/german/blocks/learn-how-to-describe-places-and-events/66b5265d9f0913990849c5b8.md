...
`Touch on` doesn't mean to avoid a topic.
...
`To touch on` can mean to briefly mention or deal with a topic. It is often used when covering a subject without going into much detail. Zum Beispiel:
