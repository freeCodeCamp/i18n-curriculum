...
Цей дієслово означає отримувати або здобувати щось.
...
Цей вираз вказує на можливість бути корисним або вигідним.

# --explanation--

Речення використовує `First Conditional`, побудовану так:

`If` + `Present Simple` час, `might` + інфінітив.

У цьому контексті:

`If they get new investors` — це умова (можлива дія).

`It might help` — це результат (можлива користь від дії).
