...
Como `associatedPanel` é um `id`, isso permitirá que você consulte o documento e encontre o elemento de painel correspondente. 

Crie uma nova variável chamada `panel` e atribua a ela o valor de `document.getElementById(associatedPanel)`. 

# --hints--

Você deve ter uma variável chamada `panel` que contém o elemento do painel associado à aba clicada.
