...
Спробуйте встановити `margin` на від’ємне значення, як це зроблено для червоного блоку.

Змініть `margin` синього блоку на `-15px`, щоб він повністю заповнив горизонтальну ширину жовтого блоку, який його оточує.
