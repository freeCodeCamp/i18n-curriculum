...
Após registrar o array não ordenado, faça a chamada da função `mergeSort` e passe o array `numbers` como argumento.

# --hints--

Você deve chamar `mergeSort(numbers)` depois de registrar o array não ordenado.
