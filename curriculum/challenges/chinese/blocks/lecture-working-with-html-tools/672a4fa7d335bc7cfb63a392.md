...
当你访问网站 [`validator.w3.org`](https://validator.w3.org/) 时，你可以点击 `Validate by Direct Input` 按钮并粘贴你的 HTML 代码。

单击 `Check` 按钮后，结果列表将显示需要修复的错误。

你可以使用的另一个超文本标记语言验证器是 [`jsonformatter.org`](https://jsonformatter.org/)。
