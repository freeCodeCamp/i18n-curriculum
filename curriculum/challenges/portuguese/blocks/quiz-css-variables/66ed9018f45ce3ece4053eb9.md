...
O navegador aceita o valor mas o ignora durante o layout.

---

O navegador lança um erro em tempo de execução.

---

O navegador converte o valor para um comprimento válido automaticamente.

#### --answer--

O navegador recorre ao valor inicial da propriedade.
