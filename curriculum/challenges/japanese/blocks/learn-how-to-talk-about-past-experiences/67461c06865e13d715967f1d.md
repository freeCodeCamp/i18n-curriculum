...
`Anything` is used in questions to ask if something happened, existed, or was present. It is neutral and does not assume the existence of anything specific. 例:
