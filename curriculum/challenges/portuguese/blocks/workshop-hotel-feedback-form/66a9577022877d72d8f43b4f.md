...
Seu elemento `legend` deve conter o texto `Why did you choose to stay at our hotel? (Check all that apply)`. Verifique novamente erros ortográficos e problemas de espaçamento.
