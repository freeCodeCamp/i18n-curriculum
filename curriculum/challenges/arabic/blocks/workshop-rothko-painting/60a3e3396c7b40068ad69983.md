...
عيّن `background-color` للعنصر `.two` إلى `#8f0401`.

# --hints--

يجب أن تعيّن خاصية `background-color` إلى `#8f0401`.
...
يجب أن يحتوي العنصر `.two` على قيمة `background-color` تساوي `#8f0401`.
