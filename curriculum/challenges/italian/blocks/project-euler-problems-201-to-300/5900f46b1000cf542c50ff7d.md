...
Definisci $f(n)$ come la somma dei fattoriali delle cifre di $n$. Per esempio, $f(342) = 3! + 4! + 2! = 32$.

Definisci $sf(n)$ come la somma delle cifre di $f(n)$. Quindi $sf(342) = 3 + 2 = 5$.

Definisci $g(i)$ come il più piccolo intero positivo $n$ tale che $sf(n) = i$. Anche se $sf(342)$ è 5, $sf(25)$ è anch’esso 5, e si può verificare che $g(5)$ è 25.

Definisci $sg(i)$ come la somma delle cifre di $g(i)$. Quindi $sg(5) = 2 + 5 = 7$.

Inoltre, si può verificare che $g(20)$ è 267 e che $\sum sg(i)$ per $1 ≤ i ≤ 20$ è 156.
