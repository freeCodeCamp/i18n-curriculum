...
You should create a `for` loop to iterate over the tuples items in the `graph[current]` list. Verwenden Sie zwei Iterationsvariablen und vergessen Sie nicht, das Schlüsselwort `pass` hinzuzufügen.
