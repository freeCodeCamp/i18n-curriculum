...
`yourself`, `keep up`, `Is it true`, `look for`, `in the evening`, `take` und `hang out`.  
...
Dies bildet eine `yes`/`no`-Frage, die um Bestätigung bittet. Sie beginnt mit einem Verb, gefolgt von einem Pronomen und dann einem Adjektiv.  
...
Dies gibt eine Tageszeit an. Es beginnt mit einer Präposition, gefolgt von einem bestimmten Artikel und dann einem Substantiv.  
...
Dies bedeutet „sich für eine Klasse oder Lektion anmelden oder daran teilnehmen“.  
...
Dies bedeutet „nach etwas suchen oder etwas suchen“. Es beginnt mit einem Verb, gefolgt von einer Präposition.  
...
Dies beschreibt, Zeit entspannt mit Freunden zu verbringen. Es beginnt mit einem Verb, gefolgt von einer Präposition.  
...
Dies bedeutet „das gleiche Tempo oder Niveau wie jemand oder etwas anderes beibehalten“. Es beginnt mit einem Verb, gefolgt von einer Präposition.  
...
Dies ist ein reflexives Pronomen, das auf die sprechende Person zurückverweist.
