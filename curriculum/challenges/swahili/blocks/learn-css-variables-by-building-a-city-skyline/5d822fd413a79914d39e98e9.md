...
Ili kuanza kuboresha msimbo wako, kwanza hamisha sifa na thamani za `position` na `top` kutoka `.foreground-buildings` kwenda `.background-buildings`, kisha badilisha kichaguzi kilichopo cha `.background-buildings` ili pia kilenga `.foreground-buildings`, ili mitindo itumike kwa vyote viwili. Unaweza kutumia koma (`,`) kutenganisha vichaguzi kama hivi: `selector1, selector2`.
...
Unapaswa kutumia koma ili kutumia vichaguzi vya `.foreground-buildings` na `.background-buildings` katika tamko moja la mtindo.
...
Haupaswi kuwa na kichaguzi tofauti cha `.background-buildings`.
