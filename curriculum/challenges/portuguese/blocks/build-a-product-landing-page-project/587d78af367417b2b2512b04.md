...
**Objetivo:** Construir um aplicativo que seja funcionalmente semelhante a <a href="https://product-landing-page.freecodecamp.rocks" target="_blank" rel="noopener noreferrer nofollow">https://product-landing-page.freecodecamp.rocks</a>. **Não copie este projeto de demonstração**.
