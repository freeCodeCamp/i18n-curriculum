...
14. Селектор `.earth` повинен мати колір фону та `border-radius` рівний `50%`.

15. Селектор `.moon` повинен мати колір фону та `border-radius` рівний `50%`.
...
Селектор `.earth` повинен мати `border-radius` рівний `50%`.
...
Селектор `.moon` повинен мати `border-radius` рівний `50%`.
