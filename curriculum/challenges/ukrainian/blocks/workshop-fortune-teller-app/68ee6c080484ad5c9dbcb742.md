...
Тепер ви почнете створювати методи.

Створіть метод з назвою `singleCardSelected`. Усередині нього викличте функцію `hideElements` і передайте такі пропи: `singleCardBtn`, `multipleCardsBtn`, `multipleCard`, `text` і `headerTitle`.

Пам’ятайте, що ви повинні отримувати доступ до всіх них за допомогою `this.elements`.

# --hints--

Ви маєте визначити метод з назвою `singleCardSelected`.
...
Всередині `singleCardSelected` ви маєте викликати функцію `hideElements`.
...
Ви маєте передати `singleCardBtn` у функцію `hideElements`.
...
Ви маєте передати `multipleCardsBtn` у функцію `hideElements`.
...
Ви маєте передати `multipleCard` у функцію `hideElements`.
...
Ви маєте передати `text` у функцію `hideElements`.
...
Ви маєте передати `headerTitle` у функцію `hideElements`.
