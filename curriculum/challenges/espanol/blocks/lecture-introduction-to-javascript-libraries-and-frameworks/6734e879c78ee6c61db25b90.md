...
La razón por la que recibes ese mensaje de error es porque múltiples elementos hermanos deben estar envueltos en un elemento padre. Aunque podrías envolver los elementos `h1` y `p` en un simple `div`, hay otra forma de evitar el error.
