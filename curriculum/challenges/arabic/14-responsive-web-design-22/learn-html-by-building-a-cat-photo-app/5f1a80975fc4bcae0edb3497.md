...
يجب تعيين سمة `value` الخاصة بزر راديو `Indoor` إلى `indoor`. إما أنك حذفت القيمة أو لديك خطأ إملائي. تذكر أن تحيط قيمة السمة بعلامات اقتباس.
...
يجب تعيين سمة `value` الخاصة بزر راديو `Outdoor` إلى `outdoor`. إما أنك حذفت القيمة أو لديك خطأ إملائي. تذكر أن تحيط قيمة السمة بعلامات اقتباس.
