...
- **Нижній індекс (елемент `sub`)** представляє текст з нижнім індексом. Common use cases for the subscript element include chemical formulas, footnotes, and variable subscripts.
