...
Створіть елемент `div` з класом `task`. Використайте шаблонні рядки, щоб встановити атрибут `id` елемента `div` у значення `id`, яке ви деструктурували з даних завдання.

# --hints--

Ви маєте створити елемент `div` з класом `task`.
...
Ваш елемент `div` повинен мати атрибут `id` зі значенням `${id}`.
