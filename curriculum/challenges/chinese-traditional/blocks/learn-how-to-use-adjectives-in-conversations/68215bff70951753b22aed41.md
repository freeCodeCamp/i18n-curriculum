...
`Make a note of` means to record or remember something important for later use. 例如：

`She made a note of the client's suggestion.` – This means she wrote it down or kept it in mind to act on it.

`Feedback` means responses, comments, or advice given to help someone improve. 例如：
