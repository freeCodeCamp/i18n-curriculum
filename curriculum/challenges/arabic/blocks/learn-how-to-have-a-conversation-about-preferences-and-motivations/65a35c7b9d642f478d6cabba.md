...
استمع إلى استجابة Brian لـ Lisa واملأ الكلمة الناقصة التي تُظهر موافقته القوية على أهمية الاستقرار المالي.
...
يُستخدم هذا الظرف لتأكيد صحة أو أهمية بيان، ويُظهر موافقة أو اعتقادًا قويًا. ينتهي بـ `ly`.
