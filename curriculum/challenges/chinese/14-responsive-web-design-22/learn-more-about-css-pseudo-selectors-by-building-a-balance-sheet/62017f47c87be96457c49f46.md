...
`span[class~="sr-only"]` 选择器应该将 `border` 属性设置为 `0 !important`。
...
`span[class~="sr-only"]` 选择器应该将 `clip` 属性设置为 `rect(1px, 1px, 1px, 1px) !important`。
...
`span[class~="sr-only"]` 选择器应该将 `clip-path` 属性设置为 `inset(50%) !important` .
