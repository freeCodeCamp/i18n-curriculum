...
Começando abaixo do par de cafés e preço existente, adicione os seguintes preços e café usando elementos `do artigo` com dois elementos aninhados `p` dentro de cada:
