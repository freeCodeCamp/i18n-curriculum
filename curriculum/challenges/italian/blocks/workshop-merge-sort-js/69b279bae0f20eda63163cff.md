...
Fuori dalla definizione della funzione, crea un array `numbers` con i seguenti valori: `[4, 10, 6, 14, 2, 1, 8, 5]`.

# --hints--

Dovresti creare un array chiamato `numbers` con questi valori: `[4, 10, 6, 14, 2, 1, 8, 5]`
