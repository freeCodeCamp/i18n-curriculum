...
Dovresti testare i tuoi progressi finora. Crea un'istanza della classe `Game` e assegnala a una variabile `game`.

A questo punto, vedrai che puoi vedere le carte quando clicchi i pulsanti Single Card Reading e
Three Card Spread.

# --hints--

Dovresti dichiarare una variabile chiamata `game`.
...
La tua variabile `game` dovrebbe essere inizializzata con `new Game()`.
