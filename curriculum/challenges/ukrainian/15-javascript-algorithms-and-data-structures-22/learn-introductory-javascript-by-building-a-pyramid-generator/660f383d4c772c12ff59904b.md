...
Ви можете передавати повні вирази як аргумент. Функція отримає результат обчислення цього виразу. Наприклад, ці два виклики функцій дадуть однаковий результат:
