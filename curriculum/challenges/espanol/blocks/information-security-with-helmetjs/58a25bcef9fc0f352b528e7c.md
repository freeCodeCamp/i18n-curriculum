...
Para los siguientes desafíos, trabajarás con un nuevo proyecto inicial que es diferente al anterior. Puedes encontrar el nuevo proyecto inicial para clonar en <a href="https://github.com/freeCodeCamp/boilerplate-bcrypt/" target="_blank" rel="noopener noreferrer nofollow">GitHub</a>.
