...
順序が重要でないアイテムのリスト、例えばどの順番で買ってもよい買い物リストを作りたい場合は、番号なしリストを使うことができます。
...
一方で、順序が重要なアイテムのリスト、例えばレシピの手順やお気に入りのテレビ番組トップ10のようなリストを作りたい場合は、番号付きリストを使うことができます。
