...
Dois inteiros $N$ e $M$ são chamados de pares amigáveis se $N \neq M$ e a soma dos divisores próprios de $N$ ($\mathrm{sum}(\mathrm{propDivs}(N))$) $= M$ assim como $\mathrm{sum}(\mathrm{propDivs}(M)) = N$.

**Exemplo:**

**1184** e **1210** são um par amigável, com divisores próprios:
...
A soma dos divisores para o primeiro valor, **1184**, é **1210** e a soma dos divisores para o segundo valor, **1210**, é **1184**.
