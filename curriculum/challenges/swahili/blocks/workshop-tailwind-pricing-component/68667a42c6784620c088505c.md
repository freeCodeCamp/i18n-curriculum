...
Mbali na `Go Premium` CTA, yaliyomo yote yamewekwa ndani ya `div`. Hii inafanya CSS grid kuwa chaguo nzuri kupanga kila kitu.

Ongeza madarasa `grid`, `grid-rows-[auto_auto_auto_1fr]`, na `gap-y-2` kwenye `div` inayozunguka vipengele vya `h2`, `p`, na `ul`.

# --hints--

Kipengele chako cha `div` kinachozunguka vipengele vya `h2`, `p`, na `ul` kinapaswa kuwa na darasa la `grid`.
...
Kipengele chako cha `div` kinachozunguka vipengele vya `h2`, `p`, na `ul` kinapaswa kuwa na darasa la `grid-rows-[auto_auto_auto_1fr]`.
...
Kipengele chako cha `div` kinachozunguka vipengele vya `h2`, `p`, na `ul` kinapaswa kuwa na darasa la `gap-y-2`.
