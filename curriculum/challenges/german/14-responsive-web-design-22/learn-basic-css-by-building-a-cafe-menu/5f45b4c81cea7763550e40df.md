...
Um das bestehende Farbschema zu erhalten, das du bereits verwendet hast (schwarz und braun), ändere die Farbe für den Fall, dass der Link besucht wird zu `black` und verwende `brown` für den Fall, dass der Link tatsächlich angeklickt wird.

# --hints--

Du solltest die `color`-Eigenschaft auf `black` setzen, wenn der Link besucht wird - `visited`.
