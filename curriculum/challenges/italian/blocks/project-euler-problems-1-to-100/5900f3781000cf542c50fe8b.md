...
La sequenza dei numeri triangolari si genera sommando i numeri naturali. Quindi il settimo numero triangolare sarebbe 1 + 2 + 3 + 4 + 5 + 6 + 7 = 28. I primi dieci termini sarebbero:

<div style='text-align: center;'>1, 3, 6, 10, 15, 21, 28, 36, 45, 55, ...</div>

Elenchiamo i divisori dei primi sette numeri triangolari:
...
Qual è il valore del primo numero triangolare ad avere più di `n` divisori?
