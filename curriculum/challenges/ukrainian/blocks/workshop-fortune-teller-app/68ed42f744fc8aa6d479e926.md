...
Тепер додайте решту властивостей до приватного об’єкта `elements`. Це: `multipleCard`, `title`, `newReadingBtn`, `fortuneContainer`, `fortuneDescription`, `headerTitle`, `subTitle`, `cardTitle`, `description` і `text`. Переконайтеся, що кожна властивість використовує тип `HTMLElement`.

# --hints--

У вас має бути властивість `multipleCard` всередині властивості `elements`, призначена типу `HTMLElement`.
...
У вас має бути властивість `title` всередині властивості `elements`, призначена типу `HTMLElement`.
...
У вас має бути властивість `newReadingBtn` всередині властивості `elements`, призначена типу `HTMLElement`.
...
У вас має бути властивість `fortuneContainer` всередині властивості `elements`, призначена типу `HTMLElement`.
...
У вас має бути властивість `fortuneDescription` всередині властивості `elements`, призначена типу `HTMLElement`.
...
У вас має бути властивість `headerTitle` всередині властивості `elements`, призначена типу `HTMLElement`.
...
У вас має бути властивість `subTitle` всередині властивості `elements`, призначена типу `HTMLElement`.
...
У вас має бути властивість `cardTitle` всередині властивості `elements`, призначена типу `HTMLElement`.
...
У вас має бути властивість `description` всередині властивості `elements`, призначена типу `HTMLElement`.
...
У вас має бути властивість `text` всередині властивості `elements`, призначена типу `HTMLElement`.
