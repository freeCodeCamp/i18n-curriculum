...
title: 'Aufgabe 56: Mächtige Quersumme'
challengeType: 1
forumTopicId: 302167
...
Eine Googol-Zahl ($10^{100}$) ist eine riesige Zahl: eine Eins gefolgt von einhundert Nullen; $100^{100}$ ist fast unvorstellbar groß: eine Eins gefolgt von zweihundert Nullen. Trotz ihrer Größe ist die Quersumme der Ziffern in jeder Zahl nur 1.

Betrachtet man natürliche Zahlen der Form $a^b$, wobei `a`, `b` &lt; `n` gilt, wie groß ist die maximale Quersumme?
