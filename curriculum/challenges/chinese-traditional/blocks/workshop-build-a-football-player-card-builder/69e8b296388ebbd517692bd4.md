...
你的第三個 `className` 為 `form-group` 的 `div` 元素應該有一個 `label`，其具有 `htmlFor` 屬性為 `pas`、`className` 為 `label`，以及文字 `PAS`。
...
你的第三個 `className` 為 `form-group` 的 `div` 元素應該有一個 `input`，其具有 `className` 為 `input`、`id` 為 `pas`，以及 `type` 為 `number`。
...
你的第四個 `className` 為 `form-group` 的 `div` 元素應該有一個 `label`，其具有 `htmlFor` 屬性為 `dri`、`className` 為 `label`，以及文字 `DRI`。
...
你的第四個 `className` 為 `form-group` 的 `div` 元素應該有一個 `input`，其具有 `className` 為 `input`、`id` 為 `dri`，以及 `type` 為 `number`。
