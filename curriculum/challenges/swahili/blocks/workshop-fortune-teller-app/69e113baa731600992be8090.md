...
Picha ya chaguo-msingi kwa kadi na URL ya kufanya ombi la API vimetolewa, unahitaji tu baadhi ya vigezo kuviweka ndani.

Unda kigezo cha `CDN_URL` na usitishe thamani yake kuwa `https://cdn.freecodecamp.org/curriculum/typescript/tarot-app`. Pia unda kigezo cha `defaultImg` chenye thamani `new URL("default.svg", CDN_URL + "/")`, na kigezo cha `LOCAL_DEFAULT_IMG` chenye thamani `defaultImg`.

# --hints--

Unapaswa kutengeneza kigezo kinachoitwa `CDN_URL`.
...
Kigezo chako cha `CDN_URL` kinapaswa kusetwa kwa `"https://cdn.freecodecamp.org/curriculum/typescript/tarot-app"`.
...
Unapaswa kutengeneza kigezo kinachoitwa `defaultImg`.
...
Kigezo chako cha `defaultImg` kinapaswa kusetwa kuwa `new URL("default.svg", CDN_URL + "/")`.
...
Unapaswa kutengeneza kigezo kinachoitwa `LOCAL_DEFAULT_IMG`.
...
Kigezo chako cha `LOCAL_DEFAULT_IMG` kinapaswa kusetwa kwa `defaultImg`.
