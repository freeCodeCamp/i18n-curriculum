...
Ваш третій елемент `div` з `className` `form-group` має містити `label` з атрибутом `htmlFor` зі значенням `pas`, `className` `label` і текстом `PAS`.
...
Ваш третій елемент `div` з `className` `form-group` має містити `input` з `className` `input`, `id` `pas` і `type` `number`.
...
Ваш четвертий елемент `div` з `className` `form-group` має містити `label` з атрибутом `htmlFor` зі значенням `dri`, `className` `label` і текстом `DRI`.
...
Ваш четвертий елемент `div` з `className` `form-group` має містити `input` з `className` `input`, `id` `dri` і `type` `number`.
