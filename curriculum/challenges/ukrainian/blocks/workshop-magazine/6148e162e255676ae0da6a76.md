...
Дайте селектору `.lists` множину властивостей `margin-top`, встановлену в `2rem`.

# --hints--

Ваш селектор `.lists` має мати множину властивостей `margin-top`, встановлену в `2rem`.
