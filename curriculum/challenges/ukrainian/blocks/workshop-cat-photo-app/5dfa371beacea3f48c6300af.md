...
Повинен бути елемент `h2` з текстом `Cat Lists` над останнім елементом `h3`, який вкладений у останній розділ `section`. Можливо, ви випадково видалили елемент `h2`.
