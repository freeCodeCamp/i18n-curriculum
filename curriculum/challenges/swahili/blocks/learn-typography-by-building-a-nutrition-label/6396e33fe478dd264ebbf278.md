...
Unda kichaguzi kipya cha `.calories-info` na kipa sifa ya `display` iliyowekwa kuwa `flex`. Pia kipa sifa ya `justify-content` iliyowekwa kuwa `space-between` na sifa ya `align-items` iliyowekwa kuwa `flex-end`.
