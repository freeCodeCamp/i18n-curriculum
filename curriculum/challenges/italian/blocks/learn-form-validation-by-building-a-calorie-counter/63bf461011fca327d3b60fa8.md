...
Dichiara una variabile `regex` e assegnale il valore dell'esempio qui sopra. In future steps, you will update this regex pattern to match specific characters needed for the calorie counter.
