...
Надайте селектору `.text-with-images` властивість `margin-bottom` зі значенням `3rem`.

# --hints--

Селектор `.text-with-images` повинен мати властивість `margin-bottom` зі значенням `3rem`.
