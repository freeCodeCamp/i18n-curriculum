...
Тепер додайте `div` з `className` `form-group`. Всередині нього додайте `label` з `className` `label` та атрибут `htmlFor` зі значенням `name`. Під цим додайте `input` з множиною `id`, встановленою на `name`, `className` `input` та атрибут `type` зі значенням `text`.

# --hints--

У вас має бути `div` з `className` `form-group`.
...
Ваш `form-group` має містити `label` з `className` `label` та атрибут `htmlFor` зі значенням `name`.
...
Ваш `form-group` має містити `input` з `id` `name`, `className` `input` та `type` `text`.
