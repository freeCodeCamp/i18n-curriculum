...
Вивід правильний, `repr` надає вам рядок, необхідний для створення екземплярів об’єктів.

Тепер закоментуйте обидва виклики `print`.

# --hints--

Закоментуйте обидва виклики `print()`.
