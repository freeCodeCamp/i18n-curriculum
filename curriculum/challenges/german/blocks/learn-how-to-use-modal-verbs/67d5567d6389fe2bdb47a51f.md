...
Diese drei Wörter fragen, ob weitere erforderliche Handlungen notwendig sind.

# --explanation--

`Need to do` wird verwendet, um zu fragen, ob etwas notwendig ist. Mark stellt sicher, dass es keine weiteren Aufgaben gibt, die er erledigen muss.
