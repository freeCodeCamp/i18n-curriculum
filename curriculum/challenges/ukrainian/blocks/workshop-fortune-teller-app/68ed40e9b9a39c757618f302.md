...
Тепер вам потрібен головний клас, який допоможе динамічно відтворювати інтерфейс у DOM.

Створіть клас з назвою `Game`. Усередині нього додайте властивість з назвою `cards` типу `Card[]`, а поки що ініціалізуйте її порожнім масивом.

# --hints--

У вас має бути клас з назвою `Game`.
...
У класі `cards` має бути властивість `Game`.
...
Ваша властивість `cards` має мати тип `Card[]`.
...
Ваша властивість cards має бути встановлена як порожній `array`.
