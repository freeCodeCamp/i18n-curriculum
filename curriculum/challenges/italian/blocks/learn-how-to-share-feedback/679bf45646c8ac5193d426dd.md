...
Dove e come si terrà il corso?

## --answers--

In presenza, presso l'azienda del team

### --feedback--

Il corso ha una struttura diversa.

---

Online e puoi seguirlo quando vuoi.

### --feedback--

Nella brochure c’è una data specifica che indica quando si svolge la lezione.
...
Nella brochure è indicato che questo corso non è in presenza.

---

Online in date specifiche
...
Alla fine della brochure, troverai le righe `Next Session` e `Location`. Controlla quelle righe per poter rispondere correttamente a questa domanda.
