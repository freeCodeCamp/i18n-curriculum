...
Доброю практикою є дозволити користувачам додавати додаткові нотатки або зауваження.

Під вашим третім елементом `fieldset` додайте новий елемент `fieldset`. Всередині додайте елемент `legend` з текстом `Additional Notes`.


# --hints--

Усього на цій сторінці має бути 4 елементи `fieldset`.
...
Ви маєте додати елемент `fieldset` під третім елементом `fieldset`.
...
Новий елемент `fieldset` повинен містити елемент `legend`.
...
Елемент `legend` має містити текст `Additional Notes`.
