...
Conforme descrito no <a href="https://design-style-guide.freecodecamp.org/" target="_blank" rel="noopener noreferrer nofollow">freeCodeCamp Style Guide</a>, o logo deve manter uma proporção de aspecto de `35 / 4` e ter espaçamento ao redor do texto.
