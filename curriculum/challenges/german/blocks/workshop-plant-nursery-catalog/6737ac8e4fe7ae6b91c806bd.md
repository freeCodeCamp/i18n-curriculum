...
Fügen Sie innerhalb Ihrer Funktion weiterhin das `prettyPolly`-Objekt zu Ihrem Set hinzu.

# --hints--

Sie sollten die `add`-Methode verwenden, um das `prettyPolly`-Objekt innerhalb der `displayPlantsSet`-Funktion zu Ihrem Set hinzuzufügen.
