...
title: Algoritmi di ordinamento/ordinamento cocktail
challengeType: 1
forumTopicId: 302312
...
L'<a href="https://rosettacode.org/wiki/Sorting_algorithms/Cocktail_sort" target="_blank" rel="noopener noreferrer nofollow">ordinamento cocktail</a> è un miglioramento del Bubble Sort. Dato un array di numeri, l'ordinamento cocktail attraversa l'array dall'inizio alla fine, spostando il numero più grande alla fine. Poi attraversa l'array all'indietro e sposta il numero più piccolo all'inizio. Ripete questi due passaggi, spostando il numero più grande/piccolo successivo nella sua posizione corretta nell'array finché non è ordinato.

# --instructions--

Scrivi una funzione che ordini un array dato usando l'ordinamento cocktail.
