...
Per ridurre lo spazio verticale tra l'elemento `h1` e il testo `Est. 2020`, modifica il margine inferiore del `h1` impostandolo su `15px`.
...
Il tuo elemento `h1` dovrebbe avere un margine inferiore di `15px`.
