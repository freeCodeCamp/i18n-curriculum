...
Completa ora la classe `TVSeries` aggiungendo la docstring `Child class representing an entire TV series.`

# --hints--

Dovresti aggiungere la docstring `Child class representing an entire TV series.` alla tua classe `TVSeries`.
