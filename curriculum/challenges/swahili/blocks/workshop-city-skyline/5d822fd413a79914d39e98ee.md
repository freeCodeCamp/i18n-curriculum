...
Msimbo wako unaanza kuwa mrefu sana. Ongeza maoni juu ya darasa la `.fb1` yanayosema `FOREGROUND BUILDINGS - "fb" stands for "foreground building"` kusaidia watu kuelewa msimbo wako. Juu ya darasa la `.bb1` ongeza maoni mengine yanayosema `BACKGROUND BUILDINGS - "bb" stands for "background building"`. Ukisahau, maoni katika CSS huonekana hivi: `/* Comment here */`.
