...
Ahora modifica el segundo argumento de color en la función `linear-gradient`, que actualmente es verde puro.

Actualiza la función `rgb` para que el valor de rojo sea `245`, el valor de verde sea `62`, y el valor de azul sea `113`.

# --hints--

La regla CSS `.red` debe tener una propiedad `background` con el valor `linear-gradient(180deg, rgb(122, 74, 14) 0%, rgb(245, 62, 113) 50%, rgb(0, 0, 255) 100%)`.
