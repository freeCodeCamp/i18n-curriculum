...
`To focus on something` means to give your full attention or effort to one specific task or goal. 例如：
...
`To optimize` means to make something as good, fast, or efficient as possible. 例如：
