...
Далі надайте вашим `.stat` елементам `padding-right` зі значенням `10px`.

# --hints--

У вас має бути селектор `.stat`.
...
Ваш селектор `.stat` має мати `padding-right` зі значенням `10px`.
