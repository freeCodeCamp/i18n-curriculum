...
Füge dem Objekt eine letzte Eigenschaft namens `text` hinzu. Give this property the same string value as the one assigned to `text.innerText` in the `goTown` function.
...
Deine `text`-Eigenschaft sollte ein String sein.
