...
Всередині функції `playNextSong` викличте функції `setPlayerDisplay`, `highlightCurrentSong` та `setPlayButtonAccessibleText`, щоб правильно оновити гравця, коли плейлист закінчується.

# --hints--

Ви повинні викликати `setPlayerDisplay` у межах інструкції `else` вашої функції `playNextSong`.
...
Ви повинні викликати `highlightCurrentSong` у межах інструкції `else` вашої функції `playNextSong`.
...
Ви повинні викликати `setPlayButtonAccessibleText` у межах інструкції `else` вашої функції `playNextSong`.
