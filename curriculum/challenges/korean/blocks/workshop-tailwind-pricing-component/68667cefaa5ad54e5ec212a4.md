...
목록 요소로 이동하여 `mt-6`에 `space-y-2`, `text-sm`, `text-fuchsia-100`, `ul` 클래스를 추가해 목록 항목 사이 간격을 조정하고 더 보기 좋게 만드세요.

# --hints--

`ul` 요소에 `mt-6` 클래스가 있어야 합니다.
...
`ul` 요소에 `text-fuchsia-100` 클래스를 추가하세요.
