...
`hr` に色を付けるには、`border` プロパティを調整する必要があります。`hr` セレクターに `border` プロパティを `1px solid rgba(120, 120, 120, 0.6)` に設定してください。

# --hints--

`hr` に `border` プロパティを `1px solid rgba(120, 120, 120, 0.6)` に設定してください。
