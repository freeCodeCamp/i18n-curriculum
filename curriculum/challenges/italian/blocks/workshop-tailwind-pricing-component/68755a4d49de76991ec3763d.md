...
Ora, assegna al `span` all'interno dell'elemento `p` le classi `text-base`, `font-medium` e `text-gray-500`.

# --hints--

Il `span` all'interno del tuo elemento `p` dovrebbe avere la classe `text-base`.
...
Il `span` all'interno del tuo elemento `p` dovrebbe avere la classe `font-medium`.
...
Il `span` all'interno del tuo elemento `p` dovrebbe avere la classe `text-gray-500`.
