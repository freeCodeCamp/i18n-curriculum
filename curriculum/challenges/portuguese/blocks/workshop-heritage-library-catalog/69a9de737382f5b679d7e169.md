...
Para buscar autores correspondentes, verifique cada entrada do catálogo uma por uma.

Adicione um loop `for` vazio dentro de `findByAuthor` para iterar sobre `catalog`. Você vai adicionar o corpo do loop no próximo passo.
