...
title: 'Problem 11: Größtes Produkt in einem Raster'
challengeType: 1
forumTopicId: 301734
...
In dem nachstehenden 20×20-Raster wurden vier Zahlen entlang einer diagonalen Linie rot markiert.
...
Das Produkt dieser Zahlen ist 26 × 63 × 78 × 14 = 1788696.

Was ist das größte Produkt von vier benachbarten Zahlen in derselben Richtung (oben, unten, links, rechts oder diagonal) in einem gegebenen `arr`-Raster?
...
`largestGridProduct(grid)` sollte 70600674 zurückgeben.
