...
Begin with your basic HTML boilerplate. Inclua a declaração `DOCTYPE`, o elemento `html` (com o idioma definido para o inglês), as tags `meta` apropriadas, os elementos `head`, `body` e `title`. Além disso, vincule a folha de estilos à página.
