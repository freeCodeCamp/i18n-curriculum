...
`Got one right` means you answered at least one question correctly, even if others were incorrect. It's often used to express relief or a small success in a challenging situation. Por exemplo:
