...
У межах вашого `.image-wrapper` елемента надайте другому `img` елементу `src` зі значенням `https://cdn.freecodecamp.org/testable-projects-fcc/images/calc.png`, `alt` зі значенням `image of a calculator project`, атрибут `loading`, встановлений у `lazy`, `class` зі значенням `image-2`, атрибут `width`, встановлений у `400`, та атрибут `height`, встановлений у `400`.

# --hints--

Ваш другий `img` елемент повинен мати `src`, встановлений у `https://cdn.freecodecamp.org/testable-projects-fcc/images/calc.png`.
...
Ваш другий `img` елемент повинен мати атрибут `alt`, встановлений у `image of a calculator project`.
...
Ваш другий `img` елемент повинен мати атрибут `loading`, встановлений у `lazy`.
...
Ваш другий `img` елемент повинен мати `class`, встановлений у `image-2`.
...
Ваш другий `img` елемент повинен мати `width`, встановлений у `400`.
...
Ваш другий `img` елемент повинен мати `height`, встановлений у `400`.
