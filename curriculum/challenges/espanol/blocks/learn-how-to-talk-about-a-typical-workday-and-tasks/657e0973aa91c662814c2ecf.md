...
El verbo `review` significa examinar algo, como una lista o un plan.

El verbo `prioritize` significa decidir qué tareas son más importantes para hacer primero.
