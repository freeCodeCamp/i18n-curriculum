...
Mwishowe, unaweza kuendesha majaribio yako ya kuiga hali halisi.

Anza na zamu ya asubuhi. Fanya wito `simulateFestival()` kwa `morningGates` na `"Morning"`. 

# --hints--

Unapaswa kufanya wito `simulateFestival()` kwa `morningGates` na `"Morning"`.
