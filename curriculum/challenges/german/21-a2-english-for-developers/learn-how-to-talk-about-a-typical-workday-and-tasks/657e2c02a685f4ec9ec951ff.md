...
`Lunch Break`: Ein Zeitraum während des Arbeitstages, der für das Mittagessen vorgesehen ist. Beispiel: `I usually take my lunch break at 1:00 PM.`

`Noon`: 12:00 Uhr mitten am Tag. Beispiel: `We have our team meeting at noon.`
...
Places where you can buy and eat food. Vergiss nicht die Stressanzeichen (`é`).
