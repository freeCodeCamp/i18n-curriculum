...
当链接被访问后，你可以使用类似 `a:visited { propertyName: propertyValue; }` 的 <dfn>pseudo-selector</dfn> 来更改链接的属性。

当用户访问链接后，将页脚的 `Visit our website` 链接的颜色更改为 `grey`。

# --hints--

你应该使用 `a:visited` 伪选择器。
