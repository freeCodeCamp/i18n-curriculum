...
`playSong` 함수 안에서 `highlightCurrentSong` 함수를 호출하세요.

그다음, 제어 버튼을 조작해 `highlightCurrentSong` 함수가 어떻게 작동하는지 확인해 보세요.

# --hints--

`highlightCurrentSong`를 `playSong` 함수 안에서 호출해야 합니다.
