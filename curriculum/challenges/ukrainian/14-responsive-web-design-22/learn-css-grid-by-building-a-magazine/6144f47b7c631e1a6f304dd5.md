...
В журналі буде три основні розділи. Ви вже встановили загальний макет у правилі `main`, але можете налаштувати розташування в дочірніх правилах.

Одним із варіантів є властивість `grid-column`, яка є скороченою для `grid-column-start` та `grid-column-end`. Властивість `grid-column` вказує елементу сітки, на якій лінії починатись та закінчуватись.

Створіть правило `.heading` та встановіть властивість `grid-column` на `2 / 3`. Це скаже елементу `.heading` починатися з лінії сітки 2 та закінчуватися на лінії сітки 3.
...
Ваш селектор `.heading` повинен мати властивість `grid-column` зі значенням `2 / 3`.
