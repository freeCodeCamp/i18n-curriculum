...
`gcd(24,36)` має повертати число.

```js
assert(typeof gcd(24, 36) == 'number');
```

`gcd(24,36)` має повертати `12`.

```js
assert.equal(gcd(24, 36), 12);
```

`gcd(30,48)` має повертати `6`.

```js
assert.equal(gcd(30, 48), 6);
```

`gcd(10,15)` має повертати `5`.

```js
assert.equal(gcd(10, 15), 5);
```

`gcd(100,25)` має повертати `25`.

```js
assert.equal(gcd(100, 25), 25);
```

`gcd(13,250)` має повертати `1`.

```js
assert.equal(gcd(13, 250), 1);
```

`gcd(1300,250)` має повертати `50`.
