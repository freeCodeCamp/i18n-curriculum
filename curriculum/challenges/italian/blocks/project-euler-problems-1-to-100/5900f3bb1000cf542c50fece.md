...
title: 'Problema 79: derivazione del codice di accesso'
challengeType: 1
forumTopicId: 302192
...
Un metodo di sicurezza comune usato per il banking online è chiedere all’utente tre caratteri casuali di un codice di accesso. Per esempio, se il codice fosse `531278`, potrebbero chiedere il 2°, 3° e 5° carattere; la risposta attesa sarebbe: `317`.

Gli array `keylog1`, `keylog2` e `keylog3` contengono cinquanta tentativi di accesso riusciti.

Dato che i tre caratteri vengono sempre richiesti in ordine, analizza l’array per determinare il codice di accesso segreto più corto possibile di lunghezza sconosciuta.
