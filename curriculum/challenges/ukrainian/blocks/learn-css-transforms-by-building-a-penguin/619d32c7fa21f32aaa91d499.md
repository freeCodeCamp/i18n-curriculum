...
У межах першої контрольної точки поверніться до `110deg` і збережіть масштабування лівої руки.

# --hints--

Ви повинні надати контрольній точці `10%` значення `transform` рівне `rotate(110deg) scaleX(-1)`.
