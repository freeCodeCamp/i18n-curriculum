...
Altere o `href="https://www.freecodecamp.org/news/"` para `href="https://www.freecodecamp.org"`. Agora, quando você clicar no link no editor interativo, verá a página inicial do freeCodeCamp em uma nova aba do navegador.
...
Altere o `src="https://cdn.freecodecamp.org/curriculum/cat-photo-app/cats.jpg"` para `src="https://cdn.freecodecamp.org/curriculum/cat-photo-app/running-cats.jpg"`. Depois altere o `alt="Two tabby kittens sleeping together on a couch."` para `alt="Two cats running in the dirt."`.
...
Tente clicar na caixa de seleção na janela de visualização para ver ela alternar entre os estados marcado e desmarcado.
...
Remova o atributo `checked` do `input` no editor interativo e você verá que a caixa de seleção não está mais marcada por padrão. 
