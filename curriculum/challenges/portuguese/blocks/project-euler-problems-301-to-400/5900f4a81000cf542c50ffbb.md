...
Dado que $\displaystyle\sum_{n = 2}^{999} g\left(\left\lfloor\frac{{10}^6}{n}\right\rfloor\right) = 27280188$, encontre $\displaystyle\sum_{n = 2}^{999\,999} g\left(\left\lfloor\frac{{10}^{16}}{n}\right\rfloor\right)$.

**Nota:** $\lfloor x\rfloor$ representa a função piso.
