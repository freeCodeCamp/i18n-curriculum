...
Усередині класу додайте приватну властивість `elements` як об’єкт. Усередині неї додайте властивості `singleCardBtn`, `singleCard` і `multipleCardsBtn`, кожна з типом `HTMLElement`.

# --hints--

Ви повинні оголосити властивість `private` з іменем `elements` усередині класу `Game`.
...
Ваша приватна властивість `elements` має містити властивість `singleCardBtn` з типом `HTMLElement`.
...
Ваша приватна властивість `elements` має містити властивість `multipleCardsBtn` з типом `HTMLElement`.
...
Ваша приватна властивість `elements` має містити властивість `singleCard` з типом `HTMLElement`.
