...
Você deve dar a `--window-color1` um valor de `#777`.
...
Você deve dar a `--window-color2` um valor de `#777`.
...
Você deve dar a `--window-color3` um valor de `#777`.
...
Você deve dar a `--window-color4` um valor de `#777`.
