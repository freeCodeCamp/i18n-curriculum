...
Para implementar la funcionalidad de filtrado, necesitarás una función. Declara una función vacía llamada `instrumentCards` que tome un solo parámetro.

# --hints--

Debes tener una función llamada `instrumentCards`.

```js
assert.isFunction(instrumentCards);
```

Tu función `instrumentCards` debe tomar un solo parámetro.
