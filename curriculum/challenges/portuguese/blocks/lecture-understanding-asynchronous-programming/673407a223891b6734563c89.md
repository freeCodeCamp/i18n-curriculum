...
Neste exemplo, estamos fazendo uma requisição `GET` para `https://api.example.com/data`. Isso retorna dados que devem ser convertidos para o formato JSON antes de poderem ser usados. 
