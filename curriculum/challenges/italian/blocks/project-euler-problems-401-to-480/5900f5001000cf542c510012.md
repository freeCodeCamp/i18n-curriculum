...
$E_a'$ è l'immagine ruotata di $E_a$ di $θ$ gradi in senso antiorario attorno all'origine $O(0, 0)$ per $0° &lt; θ &lt; 90°$.
...
Chiamiamo tripla ellissoidale canonica un tripletto ordinato ($a$, $b$, $c$) se $a$, $b$ e $c$ sono numeri interi positivi.

Per esempio, (209, 247, 286) è una tripla ellissoidale canonica.

Sia $C(N)$ il numero di triple ellissoidali canoniche distinte ($a$, $b$, $c$) per $a ≤ N$.
