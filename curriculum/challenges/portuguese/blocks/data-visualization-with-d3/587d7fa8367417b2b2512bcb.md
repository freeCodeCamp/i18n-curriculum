...
**Nota:** Ao usar os atributos `attr()` de largura e altura, eles não devem conter unidades. Este é o bloco de construção do dimensionamento - o elemento terá sempre uma proporção de 5:1 da largura para a altura, não importando o nível de zoom.
