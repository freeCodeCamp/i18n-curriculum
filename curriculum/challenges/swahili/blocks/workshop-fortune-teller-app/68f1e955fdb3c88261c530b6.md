...
Ongeza tamko la `if` ili ukague kama `foundCard` ipo kabla ya kusahihisha vipengele kwa data au sehemu ya maudhui yake.

# --hints--

Unapaswa kutangaza tamko la `if` lenye sharti la `foundCard`.
