...
Наприкінці, потрібно знову відмалювати пісні, оновити доступний текст кнопки відтворення та видалити кнопку скидання зі списку відтворення. Вам також потрібно видалити `resetButton` з DOM.

Викличте функцію `renderSongs()` з аргументом `sortSongs()`, щоб знову намалювати пісні в алфавітному порядку.
...
Використайте метод `remove()`, щоб видалити `resetButton` з DOM.
