...
Entfernen Sie die vorhandenen `print`-Aufrufe. Geben Sie dann, wie zuvor bei `v1`, `v2` und den von `v2.norm()` zurückgegebenen Wert aus.

# --hints--

Sie sollten `print(v1)` und `print(v1.norm())` nicht in Ihrem Code haben.
...
Sie sollten `v2` und `v2.norm()` ausgeben.
