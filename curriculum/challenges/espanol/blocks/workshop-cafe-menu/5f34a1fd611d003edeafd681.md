...
Ese fondo marrón dificulta la lectura del texto. Cambia el color de fondo del elemento `body` a `burlywood` para que tenga algo de color, pero aún puedas leer el texto.
