...
بعد ذلك، اربط العناصر في `row_str` بمسافة وأضف النتيجة إلى القيمة الحالية لـ `board_str`.

# --hints--

يجب أن تستخدم `.join()` لربط العناصر في `row_str` بمسافة وأضف النتيجة إلى القيمة الحالية لـ `board_str`.
