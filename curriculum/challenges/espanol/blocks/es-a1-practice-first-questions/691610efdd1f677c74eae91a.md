...
Esta palabra completa la frase cortés "Nice to meet you".
...
Estas dos palabras juntas son el nombre de un país de Centroamérica.
...
Este diálogo incluye las palabras `gusto`, `El Salvador` y `guatemalteco` (en ese orden).
