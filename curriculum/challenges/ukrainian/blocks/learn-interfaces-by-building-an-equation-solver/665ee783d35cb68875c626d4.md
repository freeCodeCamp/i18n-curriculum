...
Тепер видаліть обидва виклики `print(lin_eq.solve())` і `print(lin_eq.analyze())` зі свого коду.

# --hints--

Ви повинні видалити обидва свої виклики `print(lin_eq.solve())` і `print(lin_eq.analyze())`.
