...
Тепер оновіть свій символ `o`, щоб збігатися з `o` та `0` (цифра).

# --hints--

`freeRegex` повинен використати символьний клас, щоб збігатися з `o` та `0`.
...
`freeRegex` має збігатися з `fr33 m0n3y`.
