...
Ahora Debes ver el mismo grupo de caracteres en tu consola. Tu función `padRow` está haciendo exactamente lo mismo que hacías antes, pero ahora está en una sección reutilizable propia.
