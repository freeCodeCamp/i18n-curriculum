...
Gegeben ist ein String. Berechnen Sie die Häufigkeit jedes einzelnen Zeichens.

Alle Zeichen sollen gezählt werden. Dazu gehören Klein- und Großbuchstaben, Ziffern, Leerzeichen, Sonderzeichen oder andere unterschiedliche Zeichen.

# --instructions--

Schreiben Sie eine Funktion, die die Vorkommen jedes Zeichens in einem gegebenen String zählt.

Die Funktion soll ein 2D-Array zurückgeben, dessen Elemente jeweils die folgende Form haben: `['char', freq]`. Das Zeichen soll ein String mit der Länge 1 sein, und die Häufigkeit ist eine Zahl, die die Anzahl angibt.

Zum Beispiel sollte Ihre Funktion für den String "ab" `[['a', 1], ['b', 1]]` zurückgeben.
