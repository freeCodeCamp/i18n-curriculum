...
Оголосіть змінну `functionCall` і призначте їй цей регулярний вираз: `/([a-z0-9]*)\(([0-9., ]*)\)(?!.*\()/i`

Цей вираз шукатиме виклики функцій на кшталт `sum(1, 4)`.

# --hints--

Ви маєте оголосити змінну `functionCall`.
...
Використайте `const` для оголошення вашої змінної `functionCall`.
...
Призначте `functionCall` наданий регулярний вираз.
