...
تشارك الخرائط والمجموعات بعض الطرق التي تحمل نفس الاسم والغرض. على سبيل المثال، يمكنك استخدام الطريقة `has` على مجموعة للتحقق مما إذا كانت تحتوي على عنصر معين.

استخدم الطريقة `has` للتحقق مما إذا كان الكائن `ballerina` موجودًا في `plantsSet` وسجل النتيجة في وحدة التحكم.

# --hints--

يجب أن تسجل `plantsSet.has(ballerina)` في وحدة التحكم.
