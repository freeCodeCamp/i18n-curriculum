...
لجعل نص الاقتباس يبرز أكثر، امنح المحدِّد `.quote` خاصية `font-family` مضبوطة على `Raleway` مع نظام بديل `sans-serif`.

# --hints--

يجب أن يحتوي المحدِّد `.quote` على خاصية `font-family` مضبوطة على `Raleway` مع نظام بديل `sans-serif`.
