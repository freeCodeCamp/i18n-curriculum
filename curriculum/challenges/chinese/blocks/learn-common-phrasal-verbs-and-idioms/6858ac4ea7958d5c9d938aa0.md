...
一个复合名词。它以指代认证凭据的名词开头，后接指代重新获得访问的进程的名词。
...
这是一个复数名词短语。那些是看起来奇怪或可能危险并可能需要查看的动作。
...
这个短语以动词开头，后跟物主限定词，然后是名词。它的意思是让某人迅速注意或集中于某事。
...
该名词短语描述了一个与工作相关的过渡期。它以一个用作形容词的名词开头，后跟另一个名词。
