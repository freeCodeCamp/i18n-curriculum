...
Hapo awali ulikuwa umeongeza wito wa `console.log()` kwenye kitendakazi chako cha `addCrewMember` kuthibitisha tabia yake, na sasa wito huo hauhitajiki tena. Ili kuzuia terminal kuwa na msongamano katika hatua zijazo, endelea na futa wito wa sasa wa `console.log()`.

# --hints--

Futa wito wa `console.log()` kutoka kwenye kitendakazi chako cha `addCrewMember`. Unapaswa kufuta mstari mzima.
