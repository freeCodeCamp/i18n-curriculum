...
在該 `players` 陣列中，創建一個具有以下屬性的全新物件：
...
*注意*：球隊的號碼是依照姓氏字母順序排列。這與傳統的編號方式不同，傳統編號是與球員球衣上的號碼相對應。

# --hints--

你的 `myFavoriteFootballTeam.players` 陣列應該有一個物件的值。
