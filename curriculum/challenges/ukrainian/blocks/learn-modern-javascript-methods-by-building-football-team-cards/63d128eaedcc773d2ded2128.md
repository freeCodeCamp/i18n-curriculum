...
Під тим об’єктом створіть новий об’єкт із такими властивостями:
...
Ваш масив `myFavoriteFootballTeam.players` має містити два значення.
...
Другим значенням у вашому масиві `myFavoriteFootballTeam.players` має бути об’єкт.

```js
assert.isObject(myFavoriteFootballTeam.players[1])
```

Ваш новий об’єкт має містити властивість `name`.

```js
assert.property(myFavoriteFootballTeam.players[1], 'name');
```

Властивість `name` має бути встановлена в `"Sergio Batista"`.

```js
assert.equal(myFavoriteFootballTeam.players[1]?.name, 'Sergio Batista');
```

Ваш новий об’єкт має містити властивість `position`.

```js
assert.property(myFavoriteFootballTeam.players[1], 'position');
```

Властивість `position` має бути встановлена в `"midfielder"`.

```js
assert.equal(myFavoriteFootballTeam.players[1]?.position, 'midfielder');
```

Ваш новий об’єкт має містити властивість `number`.
...
Властивість `number` має бути встановлена в `2`.

```js
assert.equal(myFavoriteFootballTeam.players[1]?.number, 2);
```

Ваш новий об’єкт має містити властивість `isCaptain`.
...
Ваш новий об’єкт має містити властивість `nickname`.
