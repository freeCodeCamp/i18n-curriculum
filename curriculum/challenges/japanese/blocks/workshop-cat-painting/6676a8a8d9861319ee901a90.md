...
レビュー用のコードを整理して、`.cat-right-ear` セレクターとそのすべてのプロパティを削除してください。

クラスセレクターを使って、`.cat-left-ear` 要素に左右のボーダーをそれぞれ `35px solid transparent` に設定してください。また、下のボーダーは `70px solid #5e5e5e` に設定してください。

# --hints--


`.cat-right-ear` セレクターには `height` プロパティを含めないでください。
...
`.cat-right-ear` セレクターには `width` プロパティを含めないでください。
...
`.cat-right-ear` セレクターには `border-left` プロパティを含めないでください。
...
`.cat-right-ear` セレクターには `border-right` プロパティを含めないでください。
...
`.cat-right-ear` セレクターには `border-top` プロパティを含めないでください。
...
`.cat-right-ear` セレクターには `border-bottom` プロパティを含めないでください。
