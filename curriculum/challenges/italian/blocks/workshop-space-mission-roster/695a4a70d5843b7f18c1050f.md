...
Ordina direttamente l'array locale `sorted` usando la tua funzione di supporto `sortByPriorityDescending()`.

# --hints--

Dovresti invocare `sortByPriorityDescending()` con l'array `sorted`.
