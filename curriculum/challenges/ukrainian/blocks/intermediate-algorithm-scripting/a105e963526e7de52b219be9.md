...
title: Відсортований об’єднання
challengeType: 1
forumTopicId: 16077
...
Напишіть функцію, яка приймає два або більше масивів і повертає новий масив унікальних значень у порядку оригінальних наданих масивів.

Інакше кажучи, усі значення з усіх масивів мають бути включені у їхньому початковому порядку, але без дублікатів у фінальному масиві.

Унікальні числа мають бути відсортовані за їхнім початковим порядком, але фінальний масив не повинен бути відсортований за числовим порядком.

Перевірте твердження для прикладів.
