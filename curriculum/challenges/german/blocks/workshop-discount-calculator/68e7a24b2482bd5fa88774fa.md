...
Entfernen Sie nun die folgenden Zeilen am Ende Ihres Codes:
...
Die Zeile `print(product)` sollte nicht in Ihrem Code enthalten sein.
...
Die Zeile `discount = PercentageDiscount(10)` sollte nicht in Ihrem Code enthalten sein.
...
Die Zeile `print(discount.apply_discount(product))` sollte nicht in Ihrem Code enthalten sein.
...
Die Zeile `fixed_discount = FixedAmountDiscount(5)` sollte nicht in Ihrem Code enthalten sein.
...
Die Zeile `print(fixed_discount.apply_discount(product))` sollte nicht in Ihrem Code enthalten sein.
