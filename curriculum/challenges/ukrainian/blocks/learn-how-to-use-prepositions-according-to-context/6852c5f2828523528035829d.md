...
Чому кімната відпочинку розташована між IT та HR?

## --answers--

Тому що IT та HR попросили про це.

### --feedback--

Розташування базується на зручності, а не на запитах.

---

Тому що це допомагає збалансувати шум між відділами.

### --feedback--

Шум тут не згадується як причина.

---

Тому що це єдиний простір достатнього розміру.

### --feedback--

У листі немає згадки про розмір простору.

---

Тому що це зручне місце, яке однаково доступне для всіх.
...
Боб каже, що кімната відпочинку `arranged between IT and HR` і описує її як `a convenient spot`, що пропонує `a short walk for most teams` і є `equally accessible`. Ці моменти показують, що фокус зроблено на справедливості та легкості доступу.

Подивіться на фінальний пункт у огляді макету.
