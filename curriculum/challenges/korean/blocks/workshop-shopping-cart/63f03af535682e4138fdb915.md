...
`textContent`, `totalNumberOfItems`, `cartSubTotal`, `cartTaxes` 요소들의 `cartTotal`를 모두 숫자 `0`로 설정하세요.

# --hints--

`textContent` 요소의 `totalNumberOfItems`를 `0`로 설정해야 합니다.
...
`textContent` 요소의 `cartSubTotal`를 `0`로 설정해야 합니다.
...
`textContent` 요소의 `cartTaxes`를 `0`로 설정해야 합니다.
...
`textContent` 요소의 `cartTotal`를 `0`로 설정해야 합니다.
