...
Um nachzuvollziehen, welcher Tick während der Simulation gerade verarbeitet wird, erstellen Sie eine Variable namens `tickIndex` und weisen Sie ihr einen Anfangswert von `0` zu.

Diese Variable wird verwendet, um alle Ticks in Ihrer Simulation zu durchlaufen und sicherzustellen, dass jedes Gate in der richtigen Reihenfolge verarbeitet wird.

# --hints--

Sie sollten eine Variable namens `tickIndex` erstellen und ihr den Wert `0` zuweisen.
