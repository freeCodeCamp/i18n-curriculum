...
Ángela und Sebastián sprechen über ihre Berufe.

# --instructions--

Hören Sie sich den Audiotext an und ergänzen Sie den Dialog mit den richtigen Wörtern.
...
Dies ist die zweite Person Konjugation (`tu`) des Verbs `dedicarse`.
...
Dieses Wort bedeutet „Vertreter“.
...
Dieses Substantiv bedeutet „Analyst“.

# --explanation--

Dieser Dialog enthält die Wörter `dedicas`, `representante` und `analista`.
