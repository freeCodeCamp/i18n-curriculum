...
Dovresti dare a `.bb4a` una proprietà `background-color` con il valore `--building-color4`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle(".bb4a")?.backgroundColor.trim(), "var(--building-color4)");
```

Dovresti dare a `.bb4b` una proprietà `background-color` con il valore `--building-color4`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle(".bb4b")?.backgroundColor.trim(), "var(--building-color4)");
```

Dovresti dare a `.bb4c` una proprietà `background-color` con il valore `--building-color4`.
