...
Esta frase de três palavras significa diretamente oposto ou enfrentando algo.

# --explanation--

`Right across from` significa diretamente em frente a algo. Por exemplo:

`The printer is right across from the filing cabinet.` – Isso significa que a impressora está de frente para o armário do outro lado.
