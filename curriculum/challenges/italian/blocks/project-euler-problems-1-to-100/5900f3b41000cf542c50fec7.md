...
title: 'Problema 72: contare le frazioni'
challengeType: 1
forumTopicId: 302185
...
Si può vedere che ci sono `21` elementi in questo insieme.

Quanti elementi conterrebbe l'insieme delle frazioni proprie ridotte per `d` ≤ `limit`?
