...
استخدم نفس إعلان `box-shadow` للعنصر `.two`، لكن غيّر اللون من `#efb762` إلى `#8f0401`.

# --hints--

يجب أن تضبط خاصية `box-shadow` على القيمة `0 0 3px 3px #8f0401`.
...
يجب أن يحتوي العنصر `.two` على قيمة `box-shadow` تساوي `0 0 3px 3px #8f0401`.
