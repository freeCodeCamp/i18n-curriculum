...
Для `span`, який знаходиться всередині елемента `p` з текстом `/month`, додайте класи `text-base`, `font-medium` та `text-gray-500`. Це відокремить його від самої ціни, зробивши текст світлішим.

# --hints--

Ваш елемент `span` має мати клас `text-base`.
...
Ваш елемент `span` має мати клас `font-medium`.
...
Ваш елемент `span` має мати клас `text-gray-500`.
