...
Ebenso sollten Benutzer auf die E-Mail-Adresse klicken können, um eine E-Mail mit ihrem Standard-E-Mail-Client zu senden.

So können Sie E-Mail-Adressen anklickbar machen:

```html
<a href="mailto:contact@company.com">contact@company.com</a>
```

Für diesen letzten Schritt umschließen Sie den Text `fake@email.com` mit einem Ankerelement und verwenden `mailto:`, um daraus eine anklickbare E-Mail-Adresse zu machen.

Mit diesen Änderungen ist Ihre Blogseite nun fertig.

# --hints--

Sie sollten den Text `fake@email.com` in einem `a`-Element umschließen.
...
Ihr `a`-Element sollte ein `href`-Attribut haben.
...
Das `href`-Attribut für Ihr neues `a`-Element sollte auf `mailto:fake@email.com` gesetzt sein.
