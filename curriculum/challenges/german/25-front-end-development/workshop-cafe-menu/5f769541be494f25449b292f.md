...
Du solltest einen `flavor`-Klassenselektor haben.
...
Du solltest die `text-align`-Eigenschaft auf `left` setzen.
...
Dein `flavor`-Klassenselektor sollte die `text-align`-Eigenschaft auf `left` setzen.
