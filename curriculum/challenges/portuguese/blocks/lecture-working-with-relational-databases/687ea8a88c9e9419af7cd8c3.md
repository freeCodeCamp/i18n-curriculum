...
Esta sintaxe é SQL válida, mas propensa a erros.

Como os valores são atribuídos com base na ordem das colunas, o PostgreSQL tentará inserir `'Gino'` na coluna `id`, que espera um inteiro. Isso resulta em um erro como `invalid input syntax for type integer`.

Por essa razão, é mais seguro especificar explicitamente os nomes das colunas ao inserir dados.
