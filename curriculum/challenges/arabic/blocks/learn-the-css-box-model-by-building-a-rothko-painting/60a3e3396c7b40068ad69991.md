...
أضف `box-shadow` إلى `.three` بالقيم `0 0 5px 5px #b20403`.

# --hints--

يجب تعيين خاصية `box-shadow` إلى `0 0 5px 5px #b20403`.
...
يجب أن يحتوي عنصر `.three` على قيمة `box-shadow` تساوي `0 0 5px 5px #b20403`.
