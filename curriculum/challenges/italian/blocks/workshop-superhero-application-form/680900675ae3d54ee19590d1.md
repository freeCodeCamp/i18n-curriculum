...
Ora, indica al modulo come inviare i dati. Aggiungi un attributo `method` con valore `post` e un attributo `action` con valore `https://superhero-application-form.freecodecamp.org` all'elemento modulo.

Così, inviando il modulo, i dati saranno mandati a quell'URL. Lo farai nel passaggio successivo.
...
Il tuo elemento `form` dovrebbe avere un attributo `action` impostato su `https://superhero-application-form.freecodecamp.org`.
