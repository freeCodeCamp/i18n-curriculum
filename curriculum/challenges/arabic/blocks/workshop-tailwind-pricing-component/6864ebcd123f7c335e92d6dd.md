...
الآن يجب أن تعمل على تباعد العناصر داخل ذلك المخطط.

أضف الصنف المساعد `rounded-xl` لإزالة الحواف الحادة للحلقة، و`p-8` لزيادة الحشو، و`gap-6` لإنشاء مساحة بين المحتوى وزر الدعوة إلى الإجراء.

# --hints--

يجب أن يحتوي عنصر `div` على الصنف `rounded-xl`.
...
يجب أن يحتوي عنصر `div` على الصنف `p-8`.
...
يجب أن يحتوي عنصر `div` على الصنف `gap-6`.
