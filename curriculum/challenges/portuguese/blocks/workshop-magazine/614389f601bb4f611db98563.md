...
Seu primeiro elemento `a` deve ter um `href` definido como `https://www.facebook.com/freecodecamp`.
...
Seu segundo elemento `a` deve ter um `href` definido como `https://twitter.com/freecodecamp`.

```js
assert.include(document.querySelector('.social-icons')?.querySelectorAll('a')?.[1]?.getAttribute('href'), 'https://twitter.com/freecodecamp');
```

Seu terceiro elemento `a` deve ter um `href` definido como `https://instagram.com/freecodecamp`.
...
Seu quarto elemento `a` deve ter um `href` definido para `https://www.linkedin.com/school/free-code-camp`.
...
Seu quinto elemento `a` deve ter um `href` definido para `https://www.youtube.com/freecodecamp`.
