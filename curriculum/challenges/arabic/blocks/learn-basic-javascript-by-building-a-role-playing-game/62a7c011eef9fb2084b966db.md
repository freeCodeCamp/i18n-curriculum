...
انقل دالة `goTown` فوق دالة `goStore`. ثم انسخ والصق محتويات دالة `goStore` داخل دالة `goTown`.

# --hints--

يجب أن تأتي دالة `goTown` قبل دالة `goStore`.
...
يجب أن تحتوي دالة `goTown` على نفس محتويات دالة `goStore`.
