...
Dovresti assegnare alla proprietà `filter` il valore `blur(1px)`.
...
Il selettore `.one` dovrebbe avere una proprietà `filter` con il valore `blur(1px)`.
...
Il selettore `.two` dovrebbe avere una proprietà `filter` con il valore `blur(1px)`.
