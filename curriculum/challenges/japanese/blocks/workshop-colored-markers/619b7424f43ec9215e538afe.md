...
次に、2番目のマーカー`two`のクラス`green`を`div`に変更し、3番目のマーカー`three`のクラス`blue`を`div`に変更してください。

# --hints--

2番目のマーカー`div`にはクラス`two`があってはいけません。
...
2番目のマーカー`div`にはクラス`marker`と`green`が必要です。
...
3番目のマーカー`div`にはクラス`three`があってはいけません。
...
3番目のマーカー`div`にはクラス`marker`と`blue`が必要です。
