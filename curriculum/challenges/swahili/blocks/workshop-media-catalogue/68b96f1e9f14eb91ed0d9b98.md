...
Ili kuona kivutio chako maalum kikifanya kazi, badilisha mstari `catalogue.add(series2)` kuwa `catalogue.add('series2')`.

# --hints--

Unapaswa kubadilisha mstari `catalogue.add(series2)` kuwa `catalogue.add('series2')`.
