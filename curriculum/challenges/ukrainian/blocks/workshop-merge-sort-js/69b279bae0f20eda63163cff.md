...
Поза межами визначення функції створіть масив `numbers` зі значеннями: `[4, 10, 6, 14, 2, 1, 8, 5]`.

# --hints--

Ви маєте створити масив з назвою `numbers` із такими значеннями: `[4, 10, 6, 14, 2, 1, 8, 5]`
