...
title: 'Aufgabe 29: unterschiedliche Potenzen'
challengeType: 1
forumTopicId: 301941
...
Betrachten Sie alle ganzzahligen Kombinationen von $a^b$ für 2 ≤ a ≤ 5 und 2 ≤ b ≤ 5:
...
Wenn man sie dann in numerische Reihenfolge bringt und alle Wiederholungen entfernt, erhält man die folgende Folge von 15 unterschiedlichen Gliedern:

<div style='padding-left: 4em;'>
  4, 8, 9, 16, 25, 27, 32, 64, 81, 125, 243, 256, 625, 1024, 3125
</div>

Wie viele unterschiedliche Glieder enthält die Folge, die durch $a^b$ für 2 ≤ `a` ≤ `n` und 2 ≤ `b` ≤ `n` erzeugt wird?
