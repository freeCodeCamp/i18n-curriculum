...
`span` 要素の後に、水平線を作成するための `hr` 要素を追加してください。

コードを読みやすくするため、テンプレートリテラル内の新しい行に追加してください。

# --hints--

`output.innerHTML` 文字列に `hr` 要素を追加してください。
