...
Il terzo elemento `img` dovrebbe avere un `src` impostato su `https://cdn.freecodecamp.org/testable-projects-fcc/images/survey-form-background.jpeg`.
...
Il terzo elemento `img` dovrebbe avere l'attributo `alt` impostato su `four people working on code`.
...
Il terzo elemento `img` dovrebbe avere un attributo `loading` impostato su `lazy`.
...
Il terzo elemento `img` dovrebbe avere l'attributo `class` impostato su `image-3`.
...
Il terzo elemento `img` dovrebbe avere un attributo `width` impostato a `600`.
...
Il terzo elemento `img` dovrebbe avere un attributo `height` impostato a `400`.
