...
その下に `height` プロパティを追加し、数値 `proportionalSize(40)` を代入してください。`proportionalSize()` が画面サイズに比例するように、`height` 関数を使う必要があります。

プロパティにアクセスするには `this` キーワードを使うことを忘れないでください。
...
`proportionalSize(40)` プロパティに `height` を代入してください。
