...
Dentro del ciclo, asigna el evento `oninput` de cada elemento `input` a la función `handleInput`.

¡Con eso, el taller del gestor de formas está completo!

# --hints--

Debes asignar `input.oninput` a la función `handleInput`.
