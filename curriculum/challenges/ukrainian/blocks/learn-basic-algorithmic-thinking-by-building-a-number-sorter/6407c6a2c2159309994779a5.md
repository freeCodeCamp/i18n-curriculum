...
Встановіть властивість `innerText` `outputValueNode` на `num`.

# --hints--

Використайте `innerText`, щоб встановити текст `outputValueNode`.
...
Використайте `innerText`, щоб встановити текст `outputValueNode` на `num`.
