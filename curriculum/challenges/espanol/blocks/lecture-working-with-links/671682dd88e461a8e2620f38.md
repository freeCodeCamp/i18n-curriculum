...
Ahora, ¿qué pasa si el recurso al que quieres enlazar usando una ruta absoluta está en tu máquina local? Aquí te mostramos cómo enlazar al archivo `about.html` con una ruta absoluta:
