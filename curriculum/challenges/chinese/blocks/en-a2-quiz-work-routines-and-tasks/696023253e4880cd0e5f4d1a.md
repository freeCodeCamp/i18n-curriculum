...
听音频。这个问题询问的是什么？<!-- (quiz audio) Tom: What's your typical workday like? -->
...
`To conduct` 意味着组织和执行一项活动或任务。

---

`To ensure` 意味着确保某事将会发生。

---

`To issue` 意味着正式提供或分发某物。

#### --answer--

`To promote` 意味着保持某物安全。
...
听音频。什么时候说那句话合适？<!-- (quiz audio) Sophie: It helps me stay on track. -->
