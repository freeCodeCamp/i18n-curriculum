...
Створіть порожній цикл `while`, який триває, доки є учасники, що чекають (`currentTickQueue > 0`), і ворота мають залишкову пропускну здатність (`processed < gate.capacity`).

# --hints--

Умова вашого циклу `while` має бути `currentTickQueue > 0` і `processed < gate.capacity`.
