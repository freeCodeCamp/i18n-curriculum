...
У своїй функції `defeatMonster` встановіть `gold` на `gold` плюс рівень монстра, помножений на `6.7`. Пам’ятайте, що ви можете отримати рівень монстра, використовуючи `monsters[fighting].level`.
