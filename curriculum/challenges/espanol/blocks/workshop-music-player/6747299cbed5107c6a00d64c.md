...
In previous lessons, you learned about the <dfn>Web Audio API</dfn> and how to use it to play songs. Todos los navegadores modernos son compatibles con la API de Audio Web, que te permite generar y procesar audio en aplicaciones web.
