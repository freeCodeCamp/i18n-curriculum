...
أولًا، أنشئ نسخة سطحية من مصفوفة `crew` المُدخَلة باستخدام `slice()` وقم بتعيينها إلى متغير باسم `sorted`.

# --hints--

يجب عليك استخدام طريقة `slice()` لنسخ مصفوفة `crew` المُدخَلة إلى متغير جديد باسم `sorted`.
