...
Використайте функцію `rgb`, щоб додати чистий синій як третій аргумент для функції `linear-gradient`.

# --hints--

Ваше CSS-правило `.red` повинне мати властивість `background` зі значенням `linear-gradient(90deg, rgb(255, 0, 0), rgb(0, 255, 0), rgb(0, 0, 255))`.
