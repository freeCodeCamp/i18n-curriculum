...
Una hitilafu ndogo. `arg1` na `arg2` ni mfuatano wa herufi, si nambari. `infixToFunction['+']("1", "2")` ingerejesha `12`, ambayo si sahihi kihesabu.

Zungusha kila hoja zako za `infixToFunction[operator]` katika wito wa `parseFloat()`.

# --hints--

Unapaswa kuzungusha `arg1` katika wito wa `parseFloat()`.
...
Unapaswa kuzungusha `arg2` katika wito wa `parseFloat()`.
