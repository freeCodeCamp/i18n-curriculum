...
`get_mood("rock", 111)` sollte `"happy"` zurückgeben.
...
`get_mood("electronic", 74)` sollte `"focus"` zurückgeben.
...
`get_mood("classical", 180)` sollte `"happy"` zurückgeben.
...
`get_mood("rock", 155)` sollte `"hype"` zurückgeben.
...
`get_mood("electronic", 90)` sollte `"happy"` zurückgeben.
...
`get_mood("classical", 67)` sollte `"focus"` zurückgeben.
...
`get_mood("pop", 100)` sollte `"happy"` zurückgeben.
...
`get_mood("electronic", 135)` sollte `"hype"` zurückgeben.
