...
Приєднайте інший `.then()` до наявного методу `.then()`. Цього разу передайте `data` як параметр функції зворотного виклику. Для зворотного виклику використайте фігурну дужку, оскільки у вас буде більше одного виразу. У функції зворотного виклику занесіть `data` на консолі, щоб побачити, як вони виглядають.
