...
Du solltest die `font-size`-Eigenschaft auf `18px` setzen.
...
Deine `p`-Elemente, die in deinen `.item`- Elemente verschachtelt sind, sollten eine `font-size` von `18px` haben.
