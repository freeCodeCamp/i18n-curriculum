...
Dentro da declaração `if`, desconstrua `className` e `category` do objeto `allCategories[id]`.

# --hints--

Você deve desestruturar `className` e `category` do objeto `allCategories[id]`. As propriedades podem estar em qualquer ordem.
