...
ستحتاج إلى عمود للنص وعمود للصور. امنح المحدِّد `.text-with-images` خاصية `grid-template-columns` بقيمة `1fr 2fr`. كما عرّف خاصية `column-gap` بقيمة `3rem` لتوفير مساحة أكبر بين الأعمدة.
