...
This word describes something that grabs attention or makes someone curious. Termina con `-ing`.
...
This word describes a feeling of wanting to learn more about something. Termina con `-ed`.

# --explanation--

`Interesting` means something captures attention or creates curiosity. Por ejemplo:

`This new AI technology is interesting.` - This means the technology is exciting or worth learning about.

`Interested` describes a feeling of wanting to know more about something. Por ejemplo:
