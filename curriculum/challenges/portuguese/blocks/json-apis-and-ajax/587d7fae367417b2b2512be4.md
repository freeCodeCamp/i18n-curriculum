...
Outro interessante "par chave-valor" no primeiro objeto é `"codeNames":["Juggernaut","Mrs. Wallace","ButterCup"]` "Wallace","ButterCup"]`codeNames`codeNames` é a chave e seu valor é um array com três strings. É possível ter arrays de objetos, além de uma chave com um array como valor.
