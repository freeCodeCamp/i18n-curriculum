...
`Graphics driver` is software that controls how your computer displays images and videos. Por ejemplo:
...
`UI framework` refers to the structure or set of tools used to create the visual elements of an application. Por ejemplo:
