...
Usando la stessa sintassi di interpolazione, aggiungi un secondo elemento `p` con il testo `consumedCalories Calories Consumed` e un terzo con il testo `exerciseCalories Calories Burned`. Ricorda di sostituire le tue variabili `consumedCalories` e `exerciseCalories` con i valori appropriati.

# --hints--

Dovresti aggiungere un secondo elemento `p` al tuo template literal.
...
Il tuo secondo elemento `p` dovrebbe essere su una nuova riga.
...
Il tuo secondo elemento `p` dovrebbe avere il testo `${consumedCalories} Calories Consumed`.
...
Dovresti aggiungere un terzo elemento `p` al tuo template literal.
...
Il tuo terzo elemento `p` dovrebbe avere il testo `${exerciseCalories} Calories Burned`.
