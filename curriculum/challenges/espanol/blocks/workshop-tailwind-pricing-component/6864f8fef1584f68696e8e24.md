...
Ahora, deberías pasar al CTA `Start listening` para convertirlo en un botón adecuado.

Asígnale las clases de utilidad `bg-indigo-100`, `px-4`, `py-2`, `text-center`, `font-semibold`, `text-indigo-700` y `hover:bg-indigo-200`.

# --hints--

Tu elemento anchor debe tener la clase `bg-indigo-100`.
...
Tu elemento anchor debe tener la clase `text-indigo-700`.
...
Tu elemento anchor debe tener la clase `hover:bg-indigo-200`.
