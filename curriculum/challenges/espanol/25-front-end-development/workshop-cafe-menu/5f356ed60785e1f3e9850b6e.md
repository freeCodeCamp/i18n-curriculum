...
Cambia el valor de la propiedad `width` a `80%`, para que sea `80%` del ancho de su elemento padre (`body`).
...
No Debes tener una propiedad `width` con el valor de `300px`.
