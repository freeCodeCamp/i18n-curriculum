...
Después de declarar el doctype, necesitas proporcionar un elemento `<html>`. Esto es lo que se conoce como el elemento raíz del documento, lo que significa que todos los demás elementos en el documento serán descendientes de él.
...
De vuelta en el archivo `index.html`, vamos a agregar el elemento `<html>` escribiendo sus etiquetas de apertura y cierre, así:
