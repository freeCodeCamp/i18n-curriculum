...
Nomes de usuário só podem usar caracteres alfanuméricos.

Os únicos números no nome de usuário devem estar no final. Pode haver zero ou mais deles no final. O nome de usuário não pode começar com número.

As letras do nome de usuário podem ser minúsculas e maiúsculas.

Nomes de usuário precisam ter pelo menos dois caracteres. Um nome de usuário de dois caracteres pode usar apenas letras do alfabeto como caracteres.
