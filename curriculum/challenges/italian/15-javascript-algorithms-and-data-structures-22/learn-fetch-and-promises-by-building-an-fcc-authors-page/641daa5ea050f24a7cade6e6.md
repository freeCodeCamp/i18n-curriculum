...
Se questa condizione è soddisfatta, disabilita il pulsante impostando la sua proprietà `disabled` su `true`. Also, set the `textContent` of the button to `"No more data to load"`.
