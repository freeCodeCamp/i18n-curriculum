...
Isso também significa que toda vez que qualquer parte do seu app quiser atualizar o estado, ela **deve** fazer isso através da store do Redux.O fluxo de dados unidirecional torna mais fácil rastrear o gerenciamento de estado em seu aplicativo.
...
**Nota:** O código no editor usa a sintaxe de argumento padrão do ES6 para inicializar este estado com o valor `5`.Se você não está familiarizado com argumentos padrão, pode consultar a <a href="https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/es6/set-default-parameters-for-your-functions" target="_blank" rel="noopener noreferrer nofollow">seção ES6 no Currículo</a> que aborda este tópico.
