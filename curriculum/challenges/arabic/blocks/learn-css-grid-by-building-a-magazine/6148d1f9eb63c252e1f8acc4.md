...
لإعطاء `hr` لونًا، تحتاج إلى تعديل خاصية `border`. عرّف لمحدِّد `hr` خاصية `border` بقيمة `1px solid rgba(120, 120, 120, 0.6)`.

# --hints--

يجب أن تحتوي `hr` على خاصية `border` بقيمة `1px solid rgba(120, 120, 120, 0.6)`.
