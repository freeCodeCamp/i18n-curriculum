...
Нехай $a_n$ — найбільший дійсний корінь многочлена $g(x) = x^3 - 2^n \times x^2 + n$.

Наприклад, $a_2 = 3.86619826\ldots$

Знайдіть останні вісім цифр числа $\displaystyle\sum_{i = 1}^{30} \lfloor {a_i}^{987654321}\rfloor$.

**Примітка:** $\lfloor a\rfloor$ означає функцію підлоги.

# --hints--

`rootsOfCubicPolynomials()` має повертати `28010159`.
