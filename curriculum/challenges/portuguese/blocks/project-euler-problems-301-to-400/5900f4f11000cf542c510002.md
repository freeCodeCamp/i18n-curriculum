...
A partir da origem $O(0, 0, 0)$ todas as linhas são desenhadas até outros pontos da rede.Considere $D(N)$ como o número de linhas distintas feitas desse modo.

Você tem que $D(1\,000\,000) = 831\,909\,254\,469\,114\,121$.
