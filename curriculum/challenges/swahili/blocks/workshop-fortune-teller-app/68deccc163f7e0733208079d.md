...
Ifuatayo, unahitaji kutengeneza kitendakazi cha kuficha vipengele kutoka kwenye DOM. Tangaza kitendakazi cha `hideElements` kinachopokea `...elements` kama kigezo chenye aina ya `HTMLElement[]`.

Kitendakazi hiki, chenye darasa la CSS la `hidden`, kitatumika katika programu nzima kubadili uonekano wa vipengele vya UI.

# --hints--

Unapaswa kuwa umetangaza kitendakazi chenye jina `hideElements`.
...
Kitendakazi chako cha `hideElements` kinapaswa kuwa na kigezo chenye jina `...elements` na aina ya `HTMLElement[]`.
