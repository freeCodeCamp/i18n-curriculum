...
正しいですか、間違っていますか：リウ・ミンは中国出身のUIデザイナーです。
...
リウ・ミンはUIデザイナーですが、自分は中国人ではないとはっきり言っています。
...
リウ・ミンは`我不是中国人 (wǒ bù shì zhōng guó rén)，我是新加坡人 (wǒ shì xīn jiā pō rén)`と言っており、これは彼が中国人ではなくシンガポール人であることを意味します。

また、`我是 (wǒ shì) UI 设计师 (shè jì shī)`とも言っており、これは彼がUIデザイナーであることを意味します。
