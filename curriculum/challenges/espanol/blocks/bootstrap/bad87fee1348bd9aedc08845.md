...
Debes agregar un `<i class="fas fa-info-circle"></i>` dentro de tu elemento `info` button.
...
Debes agregar un `<i class="fas fa-trash"></i>` dentro del elemento de tu botón `delete`.
...
Cada uno de tus elementos `i` debe tener una etiqueta de cierre y `<i class="fas fa-thumbs-up"></i>` está en tu elemento `like` del botón.
