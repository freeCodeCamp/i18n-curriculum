...
En su función `inner`, debe devolver el resultado de llamar a `idToText` con `character + num` como argumento.

# --hints--

Su función `inner` debe usar un retorno explícito.
...
Su función `inner` debería devolver el resultado de llamar a su función `idToText`.
...
Debe pasar `character + num` como argumento a su función `idToText`.
