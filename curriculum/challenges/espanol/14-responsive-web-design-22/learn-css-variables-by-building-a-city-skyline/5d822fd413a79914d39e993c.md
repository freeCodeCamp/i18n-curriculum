...
En la clase `sky` de la consulta de medios, cambie los dos valores de color `#ffcf33` a `#ccc`, el `#ffff66` a `#445` y el `#bbeeff` a `#223`. Luego puede cambiar el tamaño de su ventana para ver los colores de cambio de fondo.
