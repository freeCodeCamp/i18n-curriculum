...
Tengeneza tamko la `if` ili kuangalia kama kitu cha `allCategories` kina sifa ya `id`. Kumbuka, unaweza kutumia njia ya `hasOwnProperty()` kwa hili.

# --hints--

Unapaswa kuwa na tamko la `if` linaloangalia kama kitu cha `allCategories` kina sifa ya `id`
