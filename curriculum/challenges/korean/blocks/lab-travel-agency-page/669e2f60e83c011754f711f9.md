...
1. 세 개의 앵커 요소는 적절한 `alt` 속성을 가진 `img` 요소와 유효한 이미지가 설정된 `src` 속성을 가진 img 요소를 포함해야 합니다. 원한다면 `https://cdn.freecodecamp.org/curriculum/labs/colosseo.jpg`, `https://cdn.freecodecamp.org/curriculum/labs/alps.jpg`, `https://cdn.freecodecamp.org/curriculum/labs/sea.jpg`을 사용할 수 있습니다.
