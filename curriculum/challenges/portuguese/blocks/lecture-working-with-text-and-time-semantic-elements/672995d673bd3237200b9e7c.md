...
Uma abreviação é uma forma reduzida de uma palavra ou frase. Por exemplo, "Dr" seguido de um ponto é uma abreviação da palavra "doctor".
...
Normalmente, o estilo do elemento de abreviação mudará quando você adicionar este atributo. O estilo específico dependerá do navegador.  Some browsers may display a dotted underline, while others may convert the contents to small caps.  When the user hovers over the abbreviation, the full form is displayed as a tooltip.
