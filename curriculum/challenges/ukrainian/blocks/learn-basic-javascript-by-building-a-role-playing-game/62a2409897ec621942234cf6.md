...
Надайте елементу `#text` властивості `background-color` зі значенням `#0a0a23`, `color` зі значенням `#ffffff` та відступ зі значенням `10px` з всіх сторін.
...
Елемент `#text` повинен мати `background-color` зі значенням `#0a0a23`.
...
Елемент `#text` повинен мати `color` зі значенням `#ffffff`.
...
Елемент `#text` повинен мати відступ зі значенням `10px` зі всіх сторін.
