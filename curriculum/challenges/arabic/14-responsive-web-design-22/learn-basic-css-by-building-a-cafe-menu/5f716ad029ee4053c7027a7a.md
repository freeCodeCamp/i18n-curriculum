...
ادمج عنصرين `p` داخل عنصر `article` الخاص بك. نص الأول يجب أن يكون `Donut`والنص الثاني `1.50`. ضع كلاهما على نفس السطر للتأكد من عدم وجود مساحة بينهما.
...
عنصر `article` الجديد يجب أن يحتوي على عنصرين `p`.
...
يجب أن يحتوي العنصر `p` الاول على النص `Donut`.
...
يجب أن يحتوي العنصر `p` الثاني على النص `1.50`.
