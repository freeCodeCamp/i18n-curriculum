...
title: Modifica el Modo Relleno de una Animación
challengeType: 0
...
Esto se puede hacer estableciendo la propiedad `animation-fill-mode` (modo de relleno de animación) en `forwards` (hacia adelante). `animation-fill-mode` especifica el estilo aplicado a un elemento cuando la animación ha terminado. Puedes configurarlo así:
