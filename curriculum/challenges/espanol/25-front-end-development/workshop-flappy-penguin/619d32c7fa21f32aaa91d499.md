...
Dentro del primer punto de referencia, rote a `110deg` y mantenga la escala del brazo izquierdo.

# --hints--

Debe dar al punto de referencia `10%` un `transform` de `rotate(110deg) scaleX(-1)`.
