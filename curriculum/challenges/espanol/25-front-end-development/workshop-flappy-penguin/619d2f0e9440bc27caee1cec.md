...
Dato curioso: La mayoría, si no todos, los aletas no son naturalmente rectangulares.

Dar a los elementos `.arm` las esquinas superior izquierda, superior derecha y inferior derecha de un radio de `30%`, y la esquina inferior izquierda de un radio de `120%`.

# --hints--

Debe dar a `.arm` un `border-radius` de `30% 30% 30% 120%`.
