...
Ви додали клас `center` до деяких елементів у HTML. Тепер слід визначити цей клас, щоб центровано розмістити ці елементи.

Задайте ціль класу `center` і центровано розмістіть елементи з цим класом, встановивши властивість `text-align` у значення `center`.

# --hints--

Ви повинні націлитися на елементи з класом `center`.

```js
assert(new __helpers.CSSHelp(document).getStyle('.center'));
```

Ви повинні встановити властивість `text-align` у значення `center`.
