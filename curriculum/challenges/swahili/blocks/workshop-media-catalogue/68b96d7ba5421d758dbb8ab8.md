...
Tengeneza kifungu kingine cha `except` kinachoshika `MediaError as e`. Ndani ya blokki ya `except`, tumia mfuatano wa herufi wa f-string kuchapisha `Media Error:` ikifuatiwa na nafasi na ujumbe wa kosa.

# --hints--

Unapaswa kuwa na kifungu cha `except` kinachoshika `MediaError as e`.
...
Unapaswa kutumia f-string kuchapisha `Media Error:` ikifuatiwa na nafasi na ujumbe wa kosa ndani ya blokki yako mpya ya `except`.
