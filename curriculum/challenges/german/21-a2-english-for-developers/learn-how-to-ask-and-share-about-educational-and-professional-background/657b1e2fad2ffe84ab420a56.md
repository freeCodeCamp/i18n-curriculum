...
Remember that the main verb stays in its simple form. Only the auxiliary verb `did` is conjugated. Hier ein Beispiel:
...
Dieser Ausdruck bezieht sich auf eine reguläre Gewohnheit, nicht auf ein bestimmtes Ereignis in der Vergangenheit.
...
Bei dieser Option geht es um zukünftige Erwartungen.
