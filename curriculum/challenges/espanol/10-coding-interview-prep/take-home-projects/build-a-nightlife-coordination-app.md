...
Build a full stack JavaScript app that is functionally similar to this: <a href="https://yoyo44.herokuapp.com/" target="_blank" rel="noopener noreferrer nofollow">https://yoyo44.herokuapp.com/</a>. Usa un constructor de sitios de tu elección para completar el proyecto.
...
Cuando hayas terminado, asegúrate que un demo funcional de tu proyecto esté alojado en algún sitio público. Luego, envía la URL a éste, en el link del campo Solución. Opcionalmente, también envía un enlace al código fuente de tu proyecto en el campo GitHub Link.
