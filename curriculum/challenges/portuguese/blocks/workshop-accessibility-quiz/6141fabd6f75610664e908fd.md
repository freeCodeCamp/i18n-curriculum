...
Dentro do elemento `main`, crie um formulário contendo três elementos `section`.Então, faça o formulário enviar para `https://freecodecamp.org/practice-project/accessibility-quiz` usando o método correto.
