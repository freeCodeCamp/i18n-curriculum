...
你最后要做的是为 `family` 计划的 CTA 按钮设置样式。

为它添加 `block`、`rounded-md`、`bg-indigo-600`、`px-4`、`py-2`、`text-center`、`font-semibold`、`text-white` 和 `hover:bg-indigo-700` 类。

至此，你的 Tailwind 定价组件研讨会已完成！

# --hints--

你的锚点元素应具有类 `bg-indigo-600`。
...
你的锚点元素应具有类 `hover:bg-indigo-700`。
