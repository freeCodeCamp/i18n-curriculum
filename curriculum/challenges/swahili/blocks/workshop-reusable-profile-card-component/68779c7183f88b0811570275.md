...
Ongeza vitu viwili zaidi kwenye safu ya data ya `profiles` — kimoja kwa Tiffany na kingine kwa Doug:
...
Mantiki yako ya `map()` haipaswi kubadilika na sasa ionyeshe kadi zote tatu.

Kwa hivyo, mradi wako wa sehemu ya kadi za wasifu zinazoweza kutumika tena umekamilika!

# --hints--

Unapaswa onyesha sehemu za `Card` tatu kabisa.
