...
Якщо є співпадіння, тоді встановіть `userData.currentSong` у `null` і `userData.songCurrentTime` у `0`.

Після цього викличте функцію `pauseSong()`, щоб зупинити відтворення, і функцію `setPlayerDisplay()`, щоб оновити відображення плеєра.
