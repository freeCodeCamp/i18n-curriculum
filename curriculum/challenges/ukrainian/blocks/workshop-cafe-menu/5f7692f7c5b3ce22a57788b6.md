...
Щоб завершити стилізацію, додайте відповідні імена класів `flavor` і `price` до всіх решти елементів `p`.
...
Ваші елементи `.flavor` мають бути елементами `p` з текстом `French Vanilla`, `Caramel Macchiato`, `Pumpkin Spice`, `Hazelnut` і `Mocha`.
...
Ваші елементи `.price` мають бути елементами `p` з текстом `3.00`, `3.75`, `3.50`, `4.00` і `4.50`.
