...
Il testo `.sr-only` è ancora visibile. Esiste un pattern comune per nascondere visivamente il testo in modo che venga letto solo dai lettori di schermo.

Questo pattern consiste nell'impostare le seguenti proprietà CSS:
