...
Ili kusaidia kufuatilia jinsi washiriki wanavyosogea ndani ya mfumo, andika ujumbe ufuatao kwenye konsoli: `overflowAmount + " attendees rerouted to " + gates[nextGateIndex].id`. Unaweza kutumia mfuatano wa herufi kuunganisha au herufi za kiolezo.

# --hints--

Kitendakazi chako cha `rerouteOverflow` kinapaswa kuandika ujumbe ufuatao kwenye konsoli `overflowAmount + " attendees rerouted to " + gates[nextGateIndex].id`.
