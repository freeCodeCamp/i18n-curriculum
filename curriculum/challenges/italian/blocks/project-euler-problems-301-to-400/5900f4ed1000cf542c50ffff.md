...
title: 'Problema 383: confronto di divisibilità tra fattoriali'
challengeType: 1
forumTopicId: 302047
...
Sia $f_5(n)$ il più grande numero intero $x$ per cui $5^x$ divide $n$.

Per esempio, $f_5(625\\,000) = 7$.

Sia $T_5(n)$ il numero di numeri interi $i$ che soddisfano $f_5((2 \times i - 1)!) &lt; 2 \times f_5(i!)$ con $1 ≤ i ≤ n$.
