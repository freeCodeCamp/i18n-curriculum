...
To `update with` means to add new information to something using specific data. 例如：

`The app was updated with new features.` — New tools or functions were added to the app.

To be `clear about` something means to understand it fully or explain it so others do. 例如：
