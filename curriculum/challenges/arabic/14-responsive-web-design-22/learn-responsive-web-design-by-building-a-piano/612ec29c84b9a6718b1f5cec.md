...
بذلك ، لقد اكتمل البيانو!

# --hints--

قاعدة `@media` الثانية يجب أن تحتوي على منتقي `#piano`.
...
يجب أن يكون لمنتقي `#piano` الجديد الخاص بك `width` من `675px`.
...
قاعدة `@media` الثانية يجب أن تحتوي على منتقي `.keys`.
...
يجب أن يكون لمنتقي `.keys` الجديد الخاص بك `width` من `633px`.
