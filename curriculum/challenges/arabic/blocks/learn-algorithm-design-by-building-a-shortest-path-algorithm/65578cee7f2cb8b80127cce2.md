...
قبل استدعاء `print`، أنشئ حلقة `while` تعمل طالما أن `unvisited` ليست فارغة. استخدم الكلمة المفتاحية `pass` لملء جسم الحلقة.

# --hints--

يجب أن يكون لديك حلقة `while` تنفذ طالما أن `unvisited` ليست فارغة. لا تنسَ الكلمة المفتاحية `pass`.
