...
ستحتاج إلى التكرار خلال المصفوفة. لتبسيط الأمر، استخدم حلقة `for` لذلك.
...
يجب أن تُهيئ حلقة `for` المتغير `i` إلى القيمة `0`.
...
يجب أن تزيد حلقة `for` المتغير `i` بمقدار `1` في كل مرة تُنفذ فيها.
