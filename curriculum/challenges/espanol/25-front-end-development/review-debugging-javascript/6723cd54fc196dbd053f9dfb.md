...
- **`console.dir()`**: Este método se usa para mostrar una lista interactiva de las propiedades de un objeto de JavaScript especificado. Produce un listado jerárquico que se puede expandir para ver todas las propiedades anidadas.
