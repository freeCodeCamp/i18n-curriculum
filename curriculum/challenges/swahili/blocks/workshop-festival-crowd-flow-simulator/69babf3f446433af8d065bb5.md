...
Unda mzunguko wa `while` usio na chochote unaoendelea mradi tu kuna washiriki wanaosubiri (`currentTickQueue > 0`) na lango bado lina uwezo wa kupokea (`processed < gate.capacity`).

# --hints--

Sharti la mzunguko wako wa `while` linapaswa kuwa `currentTickQueue > 0` na `processed < gate.capacity`.
