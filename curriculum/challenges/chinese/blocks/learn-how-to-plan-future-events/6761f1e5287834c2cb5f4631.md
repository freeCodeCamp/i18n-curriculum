...
This type of question uses `going to` to ask about someone's **future actions or plans**. You use it when you want to know what someone `intends to do` or has already planned. 例如：
