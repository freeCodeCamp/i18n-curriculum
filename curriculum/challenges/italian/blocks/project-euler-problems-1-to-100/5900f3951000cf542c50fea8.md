...
title: 'Problema 41: primo pandigitale'
challengeType: 1
forumTopicId: 302078
...
Diremo che un numero di `n` cifre è pandigitale se usa esattamente una volta tutte le cifre da 1 a `n`. Per esempio, 2143 è un pandigitale di 4 cifre ed è anche primo.

Qual è il più grande numero primo pandigitale di lunghezza `n` che esiste?
