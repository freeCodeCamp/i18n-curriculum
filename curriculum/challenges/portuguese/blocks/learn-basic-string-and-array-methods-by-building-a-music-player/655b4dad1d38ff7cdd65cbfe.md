...
Você deve chamar a função `pauseSong`.
...
Você deve chamar a função `setPlayerDisplay`.
...
Você deve chamar a função `highlightCurrentSong`.
...
Você deve chamar a função `setPlayButtonAccessibleText`.
