...
Оскільки ви віднімаєте лише одиницю від `i`, ви можете використати <dfn>оператор декременту</dfn> `--`.

Замініть присвоєння з відніманням на оператор декременту.

# --hints--

Ваш цикл `for` не повинен використовувати присвоєння з відніманням.
...
Ваш цикл `for` має використовувати оператор декременту.
