...
Якщо різниця знаходиться в межах заданого `tolerance`, призначте значення `root` рівним `mid` і вийдіть із циклу.

# --hints--

Ви повинні видалити існуючу інструкцію `pass`.
...
Ви повинні призначити значення `mid` змінній `root` і вийти з циклу.
