...
هذه العبارة المكونة من كلمتين تعني الانتقال من وظيفة إلى أخرى. تنتهي الكلمة الأولى بـ `-ing`.

# --explanation--

تعني عبارة `Switching jobs` ترك وظيفتك الحالية والبدء بوظيفة جديدة. على سبيل المثال:

`Lisa is switching jobs because she got a higher-paying offer.` - هذا يعني أن ليزا تغير وظيفتها من أجل راتب أفضل.
