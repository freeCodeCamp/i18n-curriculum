...
是时候给按键设计样式了。 在 `#piano` 规则下方，使用 `class` 选择器定位 `.keys` 元素。 为新规则赋予 `background-color` 属性 `#040404`、`width` 属性 `949px`， 以及 `height` 属性 `180px`。
