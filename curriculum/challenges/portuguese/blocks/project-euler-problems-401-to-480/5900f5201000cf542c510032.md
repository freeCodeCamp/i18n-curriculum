...
Os números de Fibonacci $\{f_n, n ≥ 0\}$ são definidos recursivamente como $f_n = f_{n - 1} + f_{n - 2}$ com casos base $f_0 = 0$ e $f_1 = 1$.
...
Considere $n = {10}^{15}$.Encontre a soma $\displaystyle\sum_{x = 0}^{100} F_n(x)$ e forneça sua resposta módulo $1\,307\,674\,368\,000 \, (= 15!)$.
