...
`Middle of` means the center of a place. Por ejemplo:

`The desk is in the middle of the room.` – This shows it is in the center.

`Reachable` means something or someone can be easily contacted or accessed. Por ejemplo:

`The manager is always reachable by email.` – This means you can contact them easily.

`Behind` shows position at the back of something. Por ejemplo:
