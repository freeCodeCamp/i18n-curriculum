...
Маркери елементів списку потрібно трохи розставити. Тож додайте кожному `span` у елементах списку класи `text-green-700` і `mr-2`.

Також додайте атрибут `aria-hidden` кожному з елементів `span`.

# --hints--

Ваші елементи `span` мають мати клас `text-green-700`.
