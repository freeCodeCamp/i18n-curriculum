...
Um `NodeList` é um objeto semelhante a um array, o que significa que você pode iterar por ele e ele compartilha alguns métodos comuns com um array. Para a função `getCaloriesFromInputs`, tanto um array quanto uma `NodeList` funcionarão como argumento.
