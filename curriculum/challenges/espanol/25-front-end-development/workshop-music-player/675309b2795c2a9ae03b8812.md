...
Note que la carátula del álbum en el HTML y las canciones en el array `userData.songs` han cambiado. Hemos intercambiado las canciones originales por otras más cortas que puede usar para probar su aplicación.
