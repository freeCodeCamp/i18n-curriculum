...
Implementa esplicitamente la moltiplicazione lunga.

Questo è un possibile approccio all'algebra degli interi con precisione arbitraria.

# --instructions--

Scrivi una funzione che prenda due stringhe di numeri grandi come parametri. La tua funzione dovrebbe restituire il prodotto di questi due numeri grandi come stringa.

**Nota:** In JavaScript, le operazioni aritmetiche non sono precise con numeri grandi, quindi dovrai implementare tu stesso una moltiplicazione precisa.
