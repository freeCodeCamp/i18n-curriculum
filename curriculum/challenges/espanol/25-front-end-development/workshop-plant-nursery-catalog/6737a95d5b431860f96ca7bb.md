...
Ahora intenta agregar el objeto `ballerina` a tu `catalogSet` dentro de tu función por segunda vez. Verás que nada sucede, porque el objeto ya está almacenado en tu conjunto y no se permiten elementos duplicados en los conjuntos.

Si quieres, puedes verificar el número de elementos en tu conjunto usando la propiedad `size`, de la misma manera que hiciste antes con tu mapa.

# --hints--

Debes `agregar` el objeto `ballerina` una segunda vez a tu conjunto dentro de la función `displayPlantsSet`.
