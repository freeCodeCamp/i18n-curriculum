...
Como último passo, modifique as strings contidas em `details_list` para que o texto colocado após o sinal de igual esteja alinhado à direita em cada linha. Seu resultado final deve ser assim:
...
Com isso, o projeto está completo!
