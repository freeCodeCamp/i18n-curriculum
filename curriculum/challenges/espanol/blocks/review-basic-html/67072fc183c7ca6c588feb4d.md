...
- **Ruta absoluta**: Una ruta absoluta es un enlace completo a un recurso. Comienza desde el directorio raíz, incluye todos los demás directorios y finalmente el nombre del archivo y su extensión. El "directorio raíz" se refiere al directorio o carpeta de nivel superior en una jerarquía. Una ruta absoluta también incluye el protocolo, que puede ser `http`, `https` o `file`, y el nombre de dominio si el recurso está en la web. Aquí tienes un ejemplo de una ruta absoluta que enlaza al logo de freeCodeCamp:
