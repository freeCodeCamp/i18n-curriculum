...
Поки всі аргументи у виклику функції є ключовими аргументами, порядок аргументів не має значення.

Щоб переконатися в цьому, спробуйте змінити порядок `length=8` і `nums=1` у вашому виклику функції.

# --hints--

Ви повинні змінити порядок `length=8` і `nums=1` у вашому виклику `generate_password()`.
