...
title: Kumulative Standardabweichung
challengeType: 1
forumTopicId: 302240
...
Angenommen, die gesamte interessierende Population besteht aus acht Schülern einer bestimmten Klasse. Für eine endliche Menge von Zahlen wird die Populationsstandardabweichung berechnet, indem die Quadratwurzel des Durchschnitts der quadrierten Abweichungen der Werte von ihrem Mittelwert genommen wird. Die Noten einer Klasse mit acht Schülern (also eine statistische Population) sind die folgenden acht Werte:
...
Berechnen Sie zuerst die Abweichungen jedes Datenpunkts vom Mittelwert und quadrieren Sie das Ergebnis jedes einzelnen:

| Abweichungen jedes Datenpunkts | Ergebnis quadrieren  |
| ------------------------------ | --------------------|
...
Die Varianz ist der Durchschnitt dieser Werte:

$$\sigma ^{2}={\frac {9+1+1+1+0+0+4+16}{8}}={\frac {32}{8}}=4$$

und die Populationsstandardabweichung ist gleich der Quadratwurzel der Varianz:

$$\sigma ={\sqrt {4}}=2$$

Schreiben Sie eine Funktion, die ein Array von Zahlen als Parameter erhält und die <a href="https://rosettacode.org/wiki/Standard_deviation" target="_blank" rel="noopener noreferrer nofollow">Standardabweichung</a> der Reihe zurückgibt.
...
`standardDeviation([75, 83, 96, 100, 121, 125])` sollte `18.239` zurückgeben.
