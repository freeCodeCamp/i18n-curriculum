...
Ainda dentro do loop `while`, incremente o valor de `leftArrayIndex` em 1.

# --hints--

Você deve incrementar o valor atual de `leftArrayIndex` em `1` depois de atribuir o elemento da parte esquerda ao array ordenado.
