...
`Could you...` is a polite way to begin a request of something from someone. `I'll...` is used in the answer to imply a promise or commitment to do something. Por exemplo:
