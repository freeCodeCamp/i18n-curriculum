...
Ifuatayo, mpe vipengele vyako vya `.stat` `padding-right` ya `10px`.

# --hints--

Unapaswa kuwa na kichaguzi cha `.stat`.
...
Kichaguzi chako cha `.stat` kinapaswa kuwa na `padding-right` ya `10px`.
