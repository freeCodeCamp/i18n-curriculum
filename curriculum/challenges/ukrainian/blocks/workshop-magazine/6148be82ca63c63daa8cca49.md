...
Створіть селектор `.author` і надайте йому множину властивостей: `font-size` зі значенням `2rem` та `font-family` зі значенням `Raleway` із запасним варіантом `sans-serif`.
