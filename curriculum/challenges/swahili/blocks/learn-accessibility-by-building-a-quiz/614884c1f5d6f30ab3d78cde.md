...
Toa ukingo wa juu kwa vipengele vya `.formrow`, na nafasi ya ndani ya kushoto na kulia. Thamani zingine za nafasi ya ndani zinapaswa kuwa `0`.

Kisha, ongeza ukubwa wa fonti kwa vipengele vyote vya `input`.

# --hints--

Unapaswa kutumia kichaguzi cha `.formrow` kulenga vipengele vya `.formrow`.

```js
assert.exists(new __helpers.CSSHelp(document).getStyle('.formrow'));
```

Unapaswa kutoa `.formrow` ukingo wa `margin-top` wa angalau `1px`.
...
Unapaswa kutoa `.formrow` nafasi ya ndani ya `padding-top` ya `0`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.formrow')?.paddingTop, '0px');
```

Unapaswa kutoa `.formrow` nafasi ya ndani ya `padding-right` ya angalau `1px`.
...
Unapaswa kutoa `.formrow` nafasi ya ndani ya `padding-bottom` ya `0`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle('.formrow')?.paddingBottom, '0px');
```

Unapaswa kutoa `.formrow` nafasi ya ndani ya `padding-left` ya angalau `1px`.
...
Unapaswa kutumia kichaguzi cha `input` kulenga vipengele vya `input`.
