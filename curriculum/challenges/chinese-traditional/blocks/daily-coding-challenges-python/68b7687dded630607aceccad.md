...
`second_largest([20, 139, 94, 67, 31])` 應該傳回 `94`。
...
`second_largest([2, 3, 4, 6, 6])` 應該傳回 `4`。
...
`second_largest([10, -17, 55.5, 44, 91, 0])` 應該傳回 `55.5`。
...
`second_largest([1, 0, -1, 0, 1, 0, -1, 1, 0])` 應該傳回 `0`。
