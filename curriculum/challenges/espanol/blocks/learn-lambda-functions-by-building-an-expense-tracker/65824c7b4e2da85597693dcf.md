...
Proporciona las otras opciones del menú imprimiendo las siguientes tres cadenas en tu ciclo `while`: `'3. Show total expenses'`, `'4. Filter expenses by category'` y `'5. Exit'`. Sigue agregando las llamadas a `print()` en orden.

# --hints--

Debes tener `print('3. Show total expenses')` en tu ciclo `while`.
...
Debes tener `print('4. Filter expenses by category')` en tu ciclo `while`.
...
Debes tener `print('5. Exit')` en tu ciclo `while`.
