...
Puoi usare HTML, JavaScript, CSS e la libreria di visualizzazione basata su svg D3. Gli elementi del DOM richiesti sono selezionati al momento di ogni test. If you use a front-end framework (like Vue for example), the test results may be inaccurate for dynamic content. Speriamo di supportarli prima o poi, ma questi framework non sono supportati al momento per i progetti D3.
