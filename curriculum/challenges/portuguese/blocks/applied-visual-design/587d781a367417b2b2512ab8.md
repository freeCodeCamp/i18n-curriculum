...
**Nota:** Tente evitar usar a tag `u` quando ela puder ser confundida com um link. Lembre-se de que as tags âncora também têm uma formatação sublinhada por padrão.
