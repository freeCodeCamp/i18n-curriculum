...
Dopo che il tuo `for` loop ha terminato, devi restituire l'array. Dovresti quindi riuscire a vedere il cambiamento `Output` quando clicchi di nuovo il pulsante `Sort`.

# --hints--

Dovresti `return` il `array`.
