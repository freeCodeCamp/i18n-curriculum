...
Du musst die Werte aus deinen `select`-Elementen abrufen. These values will currently be strings and you will convert them into numbers.
...
Deine `map`-Callback-Funktion sollte implizit `dropdown.value` zurückgeben.
