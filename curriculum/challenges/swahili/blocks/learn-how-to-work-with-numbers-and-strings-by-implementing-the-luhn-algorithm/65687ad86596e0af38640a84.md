...
Tumia mzunguko wa `for` kurudia juu ya kila nambari katika orodha ya `odd_digits`. Hamisha wito wako wa `print` kutoka hatua iliyopita ndani ya mzunguko wa `for`, na uubadilishe ili uchapishe kila nambari.

# --hints--

Unapaswa kutumia mzunguko wa `for` juu ya `odd_digits`.
...
Unapaswa kuwa na `--fcc-expected--` ndani ya mzunguko wa `for`.
