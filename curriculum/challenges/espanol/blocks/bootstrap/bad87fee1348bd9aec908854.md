...
Sobre tu left-well, dentro de su elemento `div` con clase `col-xs-6`, agrega un elemento `h4` con el texto `#left-well`.

Sobre tu right-well, dentro de su elemento `div` con clase `col-xs-6`, agrega un elemento `h4` con el texto `#right-well`.
