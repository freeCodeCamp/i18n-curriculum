...
Endelea na uongeze kipengele kingine cha `hr` kati ya kipengee cha `main` na `footer`.

# --hints--

Unapaswa kuongeza kipengele cha pili cha `hr`.

```js
assert.lengthOf(document.querySelectorAll('hr'), 2);
```

Kipengele chako kipya cha `hr` lazima kiwe kati ya kipengee cha `main` na `footer`.
