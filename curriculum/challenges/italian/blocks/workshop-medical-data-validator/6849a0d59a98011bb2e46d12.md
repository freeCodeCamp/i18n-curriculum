...
Dopo l'istruzione `if`, stampa la stringa `Valid format.`. Poi restituisci `True`.

# --hints--

Dovresti stampare `Valid format.` dopo la tua istruzione `if`.
...
Dovresti restituire `True` dopo la tua chiamata `print()`.
