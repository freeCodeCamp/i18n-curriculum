...
Vero o falso: Liu Ming è un designer UI dalla Cina.
...
Liu Ming è un designer UI, ma dice chiaramente di non essere cinese.
...
Liu Ming dice `我不是中国人 (wǒ bù shì zhōng guó rén)，我是新加坡人 (wǒ shì xīn jiā pō rén)`, il che significa che è singaporiano, non cinese.

Dice anche `我是 (wǒ shì) UI 设计师 (shè jì shī)`, il che significa che è un designer UI.
