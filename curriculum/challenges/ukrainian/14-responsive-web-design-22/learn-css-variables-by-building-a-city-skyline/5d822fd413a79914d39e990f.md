...
Вікна розташовані одне на одному в лівій частині секції, позаду фіолетової будівлі. Додайте новий клас під назвою `window-wrap` знизу `.building-wrap`. Зробіть `.window-wrap` контейнером flexbox і використайте властивості `align-items` та `justify-content`, щоб відцентрувати дочірні елементи вертикально і рівномірно розташуйте їх у батьківському елементі.
