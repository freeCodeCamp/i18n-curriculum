...
Dovresti assegnare alla proprietà `transform` il valore `rotate(0.4deg)`.
...
Il selettore `.two` dovrebbe avere una proprietà `transform` con il valore `rotate(0.4deg)`.
