...
`Sample` means a small piece or amount of a product used to test or evaluate it before buying more. 例如：
...
`Make a large order` means to place a big purchase request for many items. 例如：
