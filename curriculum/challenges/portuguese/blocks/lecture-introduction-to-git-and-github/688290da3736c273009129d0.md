...
Clique na aba pull requests no topo da página do repositório, depois ignore o banner novamente e clique em "New Pull Request". Você será levado para uma interface para preparar sua requisição.
...
Em ambos os casos, você vai querer ler a documentação de contribuição do projeto para garantir que entende e segue as diretrizes deles sobre como titular e preencher seu pull request.
