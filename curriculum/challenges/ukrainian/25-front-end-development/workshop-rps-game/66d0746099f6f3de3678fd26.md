...
Тепер настав час протестувати функцію `showResults`.
...
Ви повинні мати змінну під назвою `rockBtn`.
...
Ви повинні мати змінну під назвою `paperBtn`.
...
Ви повинні мати змінну під назвою `scissorsBtn`.
