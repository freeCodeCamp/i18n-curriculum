...
لإكمال دالة `simulateFestival`، اعرض ملخصًا لنتائج المحاكاة. نفذ استدعاء `printSummary()` مع كائن `throughputSummary` المحلي.

# --hints--

يجب استدعاء `printSummary()` مع `throughputSummary`.
