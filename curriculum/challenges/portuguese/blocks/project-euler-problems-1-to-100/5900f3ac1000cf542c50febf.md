...
title: 'Problema 64: Repetições ímpares da raiz quadrada'
challengeType: 1
forumTopicId: 302176
...
Por exemplo, vamos considerar $\sqrt{23}$:
...
Exatamente quatro frações contínuas, para $N \le 13$, têm um período ímpar.

Quantas frações contínuas para $N \le n$ têm um período ímpar?
