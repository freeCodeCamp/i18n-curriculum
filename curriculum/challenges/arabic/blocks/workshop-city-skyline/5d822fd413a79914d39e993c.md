...
في صنف `sky` الخاص باستعلام الوسائط، غيّر قيمتي اللون `#ffcf33` إلى `#ccc`، واللون `#ffff66` إلى `#445`، واللون `#bbeeff` إلى `#223`. بعد ذلك يمكنك تغيير حجم النافذة لترى تغير ألوان الخلفية.

# --hints--

يجب أن تغيّر قيم اللون الأولى من `#ffcf33` إلى `#ccc`.
...
يجب أن تغيّر قيمة اللون الثانية من `#ffff66` إلى `#445`.
...
يجب أن تغيّر قيمة اللون الثالثة من `#bbeeff` إلى `#223`.
