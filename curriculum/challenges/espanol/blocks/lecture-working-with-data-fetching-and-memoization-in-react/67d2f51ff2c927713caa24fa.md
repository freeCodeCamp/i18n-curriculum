...
title: ¿Cómo funcionan el gancho `useCallback` y `React.memo`?
challengeType: 19
...
En la última lección, aprendiste sobre memoización y cómo funciona el hook `useMemo`.

En esta lección, aprenderás cómo funcionan el hook `useCallback` y `React.memo`.

En la última lección, también mencionamos que `useCallback` sirve para memorizar referencias de funciones.
