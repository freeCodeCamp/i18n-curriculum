...
Debes añadir un elemento `p` alrededor de `See more <a href="https://freecatphotoapp.com">cat photos</a> in our gallery.`.
...
Debes seguir teniendo el elemento de anclaje dentro del nuevo párrafo.
