...
Sasa tekeleza njia ya `apply_discount` kwa `PremiumUserDiscount`. Hii inapaswa kutumia punguzo la asilimia 20 kwa watumizi wa premium.

Rudisha `product.price * 0.8` (ambayo inawakilisha asilimia 80 ya bei ya awali, yaani punguzo la asilimia 20).

# --hints--

Darasa lako la `PremiumUserDiscount` linapaswa kuwa na njia ya `apply_discount`.
...
Njia yako ya `apply_discount` inapaswa kurudisha `product.price * 0.8`.
...
Njia yako ya `apply_discount` inapaswa kutumia punguzo la asilimia 20 (asilimia 80 ya bei ya awali).
