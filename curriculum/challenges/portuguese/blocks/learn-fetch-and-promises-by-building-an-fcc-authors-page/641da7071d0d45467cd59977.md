...
Agora, você precisa mostrar algumas informações sobre o autor.Primeiro, mostre o nome do autor.

Crie uma tag `h2` com a `class` `"author-name"`.Em seguida, interpole `author` dentro da tag `h2`.Esse é o nome do autor.
...
Você deve criar um elemento `h2` dentro do elemento `div`.
...
Seu elemento `h2` deve ter uma classe definida como `"author-name"`
...
Você deve interpolar `author` na tag `h2` para mostrar os nomes dos autores.
