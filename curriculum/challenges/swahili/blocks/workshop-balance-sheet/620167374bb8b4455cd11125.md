...
Sehemu ya mwisho ya kichwa cha sehemu ya jedwali lako ni miaka yako. Unda kichaguzi cha `#years`, na wezesha flexbox. Rekebisha maudhui mwisho wa mwelekeo wa flex, na fanya kipengee hicho kiwe sticky. Kifunge juu ya kontena lake kwa `top: 0`.
...
Kichaguzi chako cha `#years` kinapaswa kuwa na sifa ya `position` iliyowekwa kuwa `sticky`.
...
Kichaguzi chako cha `#years` kinapaswa kuwa na sifa ya `top` iliyowekwa kuwa `0`.
