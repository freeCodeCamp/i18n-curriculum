...
Bevor Sie beginnen, die Filterfunktionalität zu Ihrer Seite hinzuzufügen, verlinken Sie Ihre `script.js`-Datei mit dem HTML.

# --hints--

Sie sollten ein `script`-Element mit dem `src`-Attribut haben, das auf `script.js` gesetzt ist.
