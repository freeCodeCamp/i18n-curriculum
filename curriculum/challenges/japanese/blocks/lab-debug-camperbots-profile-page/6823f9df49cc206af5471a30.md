...
2. Camperbotは`pp`で2つの段落を追加しようとしていますが、それも存在しません。正しい段落タグを使うように修正してください。
3. Camperbotは`Background and Interests`のサブ見出しに`h3`要素を使っていますが、構文エラーがあります。問題を見つけて解決してください。
