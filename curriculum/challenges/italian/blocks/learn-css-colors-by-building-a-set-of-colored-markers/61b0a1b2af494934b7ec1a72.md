...
Fantastico. Il tuo pennarello rosso sembra ottimo. Ora tutto quello che devi fare è aggiungere il cappuccio e la manica agli altri pennarelli.

Aggiungi un cappuccio e una manica sia al pennarello verde che a quello blu. Puoi semplicemente copiare gli elementi `div` dal pennarello rosso e incollarli negli altri due pennarelli.

# --hints--

Il tuo pennarello verde `div` dovrebbe contenere due elementi `div`.
...
L'elemento cappuccio `div` del pennarello verde dovrebbe essere prima dell'elemento manica `div`.
...
Il tuo pennarello blu `div` dovrebbe contenere due elementi `div`.
...
L'elemento cappuccio `div` del pennarello blu dovrebbe essere prima dell'elemento manica `div`.
