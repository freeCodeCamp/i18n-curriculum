...
`article`-Elemente enthalten in der Regel mehrere Elemente mit verwandten Informationen. In diesem Fall wird es eine Kaffeesorte und einen Preis für dieses Aroma enthalten. Verschachtel zwei `p` Elemente in deinem `article` Element. Der erste Text sollte `French Vanilla` sein, der zweite `3.00`.
