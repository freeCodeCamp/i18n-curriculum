...
Se você tiver um array multidimensional, pode usar a mesma lógica do waypoint anterior para percorrer tanto o array quanto quaisquer subarrays. Aqui está um exemplo:
