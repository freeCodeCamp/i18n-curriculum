...
Atualmente, se você digitar nos elementos `input` ou `textarea`, não será possível ver o texto. Além disso, a altura deles é muito pequena para que eles sejam fáceis de usar.

Corrija isso definindo o `color` para `#ffffff` e definindo o `min-height` deles para `2em`.

# --hints--

Você deve definir `color` como `#ffffff`.
...
Você deve definir `min-height` como `2em`.
