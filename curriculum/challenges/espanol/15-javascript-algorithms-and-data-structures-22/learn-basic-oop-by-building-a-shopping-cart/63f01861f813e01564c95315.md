...
Dentro de tu `div`, agrega dos elementos `p`. Establece el texto del segundo elemento `p` para que sea el valor de la variable `price`.

# --hints--

Debes agregar dos elementos `p` dentro de tu elemento `div`.
...
Tu segundo elemento `p` debe tener el texto de la variable `price`.
