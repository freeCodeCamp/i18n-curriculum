...
Ainda dentro do bloco `else`, incremente `right_array_index` em `1`.

# --hints--

Você deve adicionar `1` ao valor atual de `right_array_index` após inserir o elemento no array ordenado.
