...
`Makes sense` significa que algo está claro y es fácil de entender. Por ejemplo, si alguien explica por qué llegaron tarde y entiendes su razón, puedes decir, `That makes sense.`
...
Precedido por `make` o `makes`, significa que algo es claro y fácil de entender.
