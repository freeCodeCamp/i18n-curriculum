...
Número 1406357289, es un número pandigital de 0 a 9 porque se compone de cada uno de los dígitos de 0 a 9 en cierto orden, pero también tiene una propiedad bastante interesante de división de subcadenas.

Sea $d_1$ el dígito $1^{st}$, $d_2$ sea el dígito $2^{nd}$, y así sucesivamente. De esta manera, tomamos nota de lo siguiente:

- ${d_2}{d_3}{d_4} = 406$ es divisible por 2
