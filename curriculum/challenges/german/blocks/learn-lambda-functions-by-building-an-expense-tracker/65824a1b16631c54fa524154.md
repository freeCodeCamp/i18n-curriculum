...
Fügen Sie als Nächstes einen weiteren `print()`-Aufruf hinzu und übergeben Sie den String `'2. List all expenses'`.

# --hints--

Sie sollten `'2. List all expenses'` in Ihrer `while`-Schleife nach den vorhandenen `print()`-Aufrufen ausgeben.
