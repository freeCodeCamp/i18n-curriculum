...
`address` 요소는 반드시 실제 지리적 위치를 포함할 필요가 없습니다. 주제에 대한 링크를 제공하는 데 사용할 수 있습니다.

텍스트 `freeCodeCamp` 주위에 링크를 감싸고, 그 위치를 `https://freecodecamp.org`로 설정하세요.
