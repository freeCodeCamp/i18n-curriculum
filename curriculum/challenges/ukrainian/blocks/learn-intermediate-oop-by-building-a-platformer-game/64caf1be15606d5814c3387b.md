...
Додайте ще один булевий вираз, який перевіряє, чи позиція гравця `y` плюс висота гравця більша або дорівнює позиції платформи `y`.

Нижче додайте ще один булевий вираз, який перевіряє, чи позиція гравця `y` менша або дорівнює сумі позиції платформи `y` плюс висота платформи.

# --hints--

Ви не повинні змінювати існуючий масив `platformDetectionRules` та його вміст.
...
У вас має бути булевий вираз, який перевіряє, чи позиція гравця `y` плюс висота гравця більша або дорівнює позиції платформи `y`.
...
У вас має бути булевий вираз, який перевіряє, чи позиція гравця `y` менша або дорівнює сумі позиції платформи `y` плюс висота платформи.
