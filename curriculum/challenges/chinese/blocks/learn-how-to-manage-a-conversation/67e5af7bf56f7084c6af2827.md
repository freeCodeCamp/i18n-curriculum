...
`Thought` is the past form of the irregular verb `to think`. In this context, it is used to express what someone believed to be true. 例如：
...
`To proceed` means to continue or move forward with something. 例如：
