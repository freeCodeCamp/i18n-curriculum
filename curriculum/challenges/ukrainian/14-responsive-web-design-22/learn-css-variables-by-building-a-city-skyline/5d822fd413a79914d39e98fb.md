...
Градієнтні переходи часто поступово змінюються з одного кольору на інший. Якщо потрібна більш різка зміна, перехід можна здійснити за допомогою жорсткої зупинки:
