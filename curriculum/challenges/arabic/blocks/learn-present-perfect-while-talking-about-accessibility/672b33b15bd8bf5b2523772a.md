...
اكتب الكلمات أو العبارات التالية في المكان الصحيح: `software update` ، `real-world feedback` ، `all scenarios` ، `voice command` ، `brainstorming solutions` و `improve its accuracy` .
...
تشير هذه العبارة إلى أن النظام يتعرف على الأوامر الصوتية ويستجيب لها.
...
تشير هذه العبارة إلى التغييرات التي أُجريت على البرنامج.
...
يعني هذا كل حالة أو سيناريو استخدام ممكن.
...
تشير هذه العبارة إلى جعل النظام أكثر دقة وموثوقية.
...
تشير هذه العبارة إلى التفكير في حلول للمشكلات ومناقشتها.
...
تشير هذه العبارة إلى الملاحظات التي تُجمع من المستخدمين الفعليين، وليس من الاختبارات النظرية أو الداخلية.
