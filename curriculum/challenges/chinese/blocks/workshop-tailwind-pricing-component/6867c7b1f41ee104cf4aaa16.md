...
现在，你将使用 `grid` 来排列包装器 `div` 内的项。

为你的包装器 `div` 添加类 `grid`、`grid-rows-[1fr_auto]` 和 `gap-6`。

# --hints--

你的家庭计划的包装器 `div` 元素应具有类 `grid`。
...
你的家庭计划的包装器 `div` 元素应具有类 `grid-rows-[1fr_auto]`。
