...
Для другого аргументу кольору використайте шістнадцятковий код кольору зі значеннями `71` для червоного, `F5` для зеленого та `3E` для синього.

# --hints--

Ваше правило CSS `.green` має містити властивість `background`, встановлену в `linear-gradient(180deg, #55680D, #71F53E)`.
