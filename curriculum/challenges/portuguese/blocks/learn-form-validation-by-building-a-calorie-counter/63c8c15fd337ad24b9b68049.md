...
Em JavaScript, os valores podem ser considerados <dfn>verdadeiros</dfn> ou <dfn>falsos</dfn>.Um valor é considerado verdadeiro se ele for avaliado como `true` quando convertido em um booleano.Um valor é falso se for avaliado como `false` quando convertido para um Booleano. `null` é um exemplo de um valor falso.
