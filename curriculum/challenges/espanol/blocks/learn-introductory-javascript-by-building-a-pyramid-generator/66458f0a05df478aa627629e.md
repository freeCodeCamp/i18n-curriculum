...
Además de las sentencias `if`, JavaScript también tiene sentencias <dfn>else if</dfn>. Las sentencias `else if` te permiten verificar múltiples condiciones en un solo bloque de código.
