...
Ви можете згадати з <a href="/ukrainian/learn/javascript-algorithms-and-data-structures/basic-javascript/comparison-with-the-equality-operator" target="_blank" rel="noopener noreferrer nofollow" mark= "crwd-mark">Порівняння з оператором «дорівнює»</a>, що всі оператори порівняння повертають булеве значення `true` або `false`.
