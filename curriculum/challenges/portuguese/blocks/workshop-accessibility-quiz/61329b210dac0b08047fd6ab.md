...
Continuando com os elementos `meta`, uma definição de `viewport` informa ao navegador como renderizar a página. Inclui uma melhor acessibilidade visual em dispositivos móveis e melhora o *SEO* (search engine optimization).
