...
Agora, chame a função `setPlayButtonAccessibleText` dentro da função `playSong`.

# --hints--

Você deve chamar a função `setPlayButtonAccessibleText` dentro da função `playSong`.
