...
Outro exemplo comum de quando usar o método `e.preventDefault()` está relacionado ao envio de formulários. Por padrão, enviar um formulário envia dados para o servidor e recarrega a página. Usar `e.preventDefault()` impede que isso aconteça.
...
Evitar o comportamento padrão é ótimo quando você precisa de mais controle sobre como o usuário interage com a página, mas é importante ter em mente aspectos como a acessibilidade: seu comportamento personalizado deve oferecer os mesmos recursos que o padrão.
