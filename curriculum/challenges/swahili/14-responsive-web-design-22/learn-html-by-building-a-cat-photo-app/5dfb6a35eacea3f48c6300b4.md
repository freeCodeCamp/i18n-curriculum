...
Your `figcaption` element should have a closing tag. Tagi za kufunga zina `/` mara baada ya herufi ya `<`.
...
Kipengele cha `figcaption` kilichowekwa katika kipengele cha `figure` lazima kiwe chini ya kipengele cha `img`. You have them in the wrong order.
