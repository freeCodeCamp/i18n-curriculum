...
Створіть два елементи `img`, елемент `blockquote` та третій елемент `img` в елементі `aside`. Надайте елементу `blockquote` властивість `class` зі значенням `image-quote`.
