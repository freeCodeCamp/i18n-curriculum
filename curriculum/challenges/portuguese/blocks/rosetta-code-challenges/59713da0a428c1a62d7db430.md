...
<a href="https://rosettacode.org/wiki/Cramer%27s_rule" target="_blank" rel="noopener noreferrer nofollow">A regra de Cramer</a> é uma fórmula para resolver um sistema de equações lineares usando os determinantes de matrizes formadas a partir de subconjuntos dos coeficientes e dos valores do lado direito.
