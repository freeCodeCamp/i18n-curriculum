...
첫 번째 `input`에 `value` 텍스트 내용과 일치하는 `label`를 지정하세요.
...
두 번째 `input`에 `value` 텍스트 내용과 일치하는 `label`를 지정하세요.
...
세 번째 `input`에 `value` 텍스트 내용과 일치하는 `label`를 지정하세요.
...
네 번째 `input`에 `value` 텍스트 내용과 일치하는 `label`를 지정하세요.
