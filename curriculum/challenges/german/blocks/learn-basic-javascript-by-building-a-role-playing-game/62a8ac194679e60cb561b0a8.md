...
Gib deinem leeren `button text`-Array drei String-Elemente. Verwende die drei Strings, die dem Button `innerText`-Eigenschaften in der `goTown`-Funktion zugewiesen sind. Denke daran, dass Arraywerte durch Kommas getrennt werden.
