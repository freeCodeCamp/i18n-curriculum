...
Використайте `const`, щоб оголосити змінну `inner`.
...
Змінна `inner` має бути стрілковою функцією.
...
Єдиним параметром функції `inner` має бути `character`.
...
Функція `inner` має бути порожньою.
