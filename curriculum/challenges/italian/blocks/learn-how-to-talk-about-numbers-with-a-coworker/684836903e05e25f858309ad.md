...
`Up to this point` means everything that has happened from the beginning of the project until now. It is often used in status updates or progress reports. Per esempio:
