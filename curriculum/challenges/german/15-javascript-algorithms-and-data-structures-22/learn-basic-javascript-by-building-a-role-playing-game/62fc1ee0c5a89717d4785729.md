...
Gib deinem `#monsterStats` Element den gleichen `border` und `padding` wie deinem `#stats` Element geben. Setze seine Farbe auf`#ffffff` und gib ihm einen `#c70d0d` Hintergrund.
...
Dein `#monsterStats`-Selektor sollte einen `border` von `1px solid #0a0a23` haben.
...
Dein `#monsterStats`-Selektor sollte eine `color` in `#ffffff` haben.
...
Dein `#monsterStats`-Selektor sollte eine `background-color` in `#c70d0d` haben.
