...
Un número palíndromo se lee igual en ambos sentidos. El número palíndromo más grande obtenido mediante el producto de dos números de 2 dígitos es 9009 = 91 x 99.

Encuentra el número palindromo más grande fabricado con el producto de dos números con `n` digitos.
