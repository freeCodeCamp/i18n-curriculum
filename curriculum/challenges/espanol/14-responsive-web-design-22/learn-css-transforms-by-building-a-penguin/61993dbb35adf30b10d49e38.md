...
Target the `.penguin-body` element, and give it a `width` of `53%`, and a `height` of `45%`. Luego, establezca el `background` en un degradado lineal a `45deg`, `rgb(134, 133, 133)` desde `0%`, `rgb(234, 231, 231)` del `25%`, y `white` del `67%`.
