...
Ahora podemos añadir el espaciado horizontal usando `flex`. En tu selector `p`, agrega una propiedad `display` establecida en `flex` y una propiedad `justify-content` establecida en `space-between`.
