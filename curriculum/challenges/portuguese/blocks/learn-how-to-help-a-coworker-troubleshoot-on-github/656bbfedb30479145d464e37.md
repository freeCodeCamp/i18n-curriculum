...
Significa que Bob enviou alterações para o repositório.Este verbo está no tempo passado.
...
Onde as alterações do código de Bob são armazenadas e gerenciadas.
