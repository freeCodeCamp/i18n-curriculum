...
| Código ISBN | Comprimento | Mensagem | Exemplo de entrada |
|-----------|--------|---------| ------------- |
| Válido | Válida | `Valid ISBN Code.` | `1530051126,10` |
| Número inválido | Válida | `Invalid ISBN Code.` | `1530051125,10` |
| Sem comprimento especificado ou em branco | Válida | `ISBN-10 code should be 10 digits long.` ou `ISBN-13 code should be 13 digits long.`, dependendo do comprimento da entrada. | `9781530051120,10` o `1530051126,13` |
| Contém caracteres não numéricos (exceto pelo dígito de verificação) | Válida | `Invalid character was found.` | `15-0051126,10` |
| Qualquer | Número inválido | `Length should be 10 or 13.` | `1530051126,9` |
| Qualquer | Contém caracteres não numéricos ou em branco | `Length must be a number.` | `1530051125,A` |
| Sem separação por vírgula | Sem separação por vírgula | `Enter comma-separated values.` | `1530051125` |
...
Quando o usuário insere um valor que não é um valor separado por vírgulas, você deve ver a mensagem `Enter comma-separated values.` no console.
...
Quando o usuário inserir um valor não numérico para o comprimento, você deverá ver a mensagem `Length must be a number.` no console.
...
Quando o usuário inserir um código ISBN incorreto com caracteres diferentes de números, você deve ver a mensagem `Invalid character was found.` no console.
...
Quando o usuário inserir `1530051126,10`, você deverá ver a mensagem `Valid ISBN Code.` no console.
...
Quando o usuário inserir `9781530051120,13`, você deverá ver a mensagem `Valid ISBN Code.`.
...
Quando o usuário digita `1530051125,10`, você deve ver a mensagem `Invalid ISBN Code.`.
...
Quando o usuário inserir `9781530051120,10`, você deverá ver a mensagem `ISBN-10 code should be 10 digits long.`.
...
Quando o usuário digita `1530051126,13`, você deve ver a mensagem `ISBN-13 code should be 13 digits long.`.
...
Quando o usuário digita `15-0051126,10`, você deve ver a mensagem `Invalid character was found.`.
...
Quando o usuário digita `1530051126,9`, você deve ver a mensagem `Length should be 10 or 13.`.
...
Quando o usuário inserir `1530051125,A`, você deve ver a mensagem `Length must be a number.`.
...
Quando o usuário digitar `1530051125`, você deverá ver a mensagem `Enter comma-separated values.`.
...
Quando o usuário digita `9971502100,10`, você deve ver a mensagem `Valid ISBN Code.`.
...
Quando o usuário inserir `080442957X,10`, você deverá ver a mensagem `Valid ISBN Code.`.
...
Quando o usuário inserir `9781947172104,13`, você deverá ver a mensagem `Valid ISBN Code.`.
