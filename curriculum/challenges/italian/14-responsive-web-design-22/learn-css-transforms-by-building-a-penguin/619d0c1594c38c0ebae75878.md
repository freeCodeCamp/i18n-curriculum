...
Dovresti dare a `.eye.left` una proprietà `left` con il valore `--fcc-expected--` invece di `--fcc-actual--`.
...
Dovresti dare a `.eye.right` una proprietà `right` con il valore `--fcc-expected--` invece di `--fcc-actual--`.
