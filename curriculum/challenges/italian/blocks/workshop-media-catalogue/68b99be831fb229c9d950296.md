...
Usando la stessa logica, crea un'istruzione `if` che venga eseguita quando la lista `series` non è vuota. Al suo interno, concatena la stringa `=== TV SERIES ===` (che termina con un carattere di nuova riga) al valore corrente di `result`.

Poi, crea un loop `for` che usi l'enumerazione per aggiungere gli elementi nella lista `series` alla variabile `result`. Come hai fatto in precedenza, inizia a indicizzare i valori da `1`.

Con questo, il workshop sul catalogo media è completo.

# --hints--

Dovresti avere una seconda istruzione `if` nel tuo metodo `__str__`.
...
Dovresti avere `result += '=== TV SERIES ===\n'` all'interno della tua seconda istruzione `if`.
...
Dovresti avere un loop `for` nella tua seconda istruzione `if`.
...
Quando `self.items` contiene `TVSeries("Game of Thrones", 2011, "David Benioff & D.B. Weiss", 57, 8, 73)` e `TVSeries("Stranger Things", 2016, "The Duffer Brothers", 50, 4, 34)`, il tuo metodo `__str__` dovrebbe restituire `Media Catalogue (2 items):\n\n=== TV SERIES ===\n1. Game of Thrones (2011) - 8 seasons, 73 episodes, 57 min avg, David Benioff & D.B. Weiss\n2. Stranger Things (2016) - 4 seasons, 34 episodes, 50 min avg, The Duffer Brothers\n`.
...
Quando `self.items` contiene `Movie('Barry Lyndon', 1975, 'Stanley Kubrick', 184)`, `Movie('Fahrenheit 451', 1966, 'Francois Truffaut', 112)`, `TVSeries("Game of Thrones", 2011, "David Benioff & D.B. Weiss", 57, 8, 73)` e `TVSeries("Stranger Things", 2016, "The Duffer Brothers", 50, 4, 34)` il tuo metodo `__str__` dovrebbe restituire `Media Catalogue (4 items):\n\n=== MOVIES ===\n1. Barry Lyndon (1975) - 184 min, Stanley Kubrick\n2. Fahrenheit 451 (1966) - 112 min, Francois Truffaut\n=== TV SERIES ===\n1. Game of Thrones (2011) - 8 seasons, 73 episodes, 57 min avg, David Benioff & D.B. Weiss\n2. Stranger Things (2016) - 4 seasons, 34 episodes, 50 min avg, The Duffer Brothers\n`.
