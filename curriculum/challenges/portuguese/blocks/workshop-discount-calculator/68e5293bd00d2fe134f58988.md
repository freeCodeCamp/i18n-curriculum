...
Retorne `True` se `product.price * 0.9` for maior que `self.amount`, caso contrário retorne `False`. Isso garante que o desconto não exceda 10% do preço original, o que seria irrealista.
