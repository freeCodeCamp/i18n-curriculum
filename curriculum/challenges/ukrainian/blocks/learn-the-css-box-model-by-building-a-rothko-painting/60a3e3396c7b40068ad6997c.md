...
Встановіть `background-color` для `.one` у `#efb762`.

# --hints--

Ви повинні встановити властивість `background-color` у `#efb762`.
...
Ваш елемент `.one` має мати значення ідентифікатора `background-color` рівне `#efb762`.
