...
أضف إلى الجدول الثالث `caption` يحتوي على النص `Net Worth`، وأعد إعداد القسم العلوي والجزء الأساسي للجدول.

# --hints--

يجب أن يحتوي عنصر `table` الثالث على عنصر `caption`.
...
يجب أن يحتوي عنصر `caption` على النص `Net Worth`.
...
يجب أن يحتوي عنصر `table` الثالث على عنصر `thead`.
...
يجب أن يحتوي عنصر `table` الثالث على عنصر `tbody`.
...
يجب أن يكون عنصر `thead` مباشرةً تحت عنصر `caption`.
...
يجب أن يكون عنصر `tbody` مباشرةً تحت عنصر `thead`.
