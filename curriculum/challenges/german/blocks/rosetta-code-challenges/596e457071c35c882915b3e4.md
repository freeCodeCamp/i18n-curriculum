...
title: Eine Liste von Strings vergleichen
challengeType: 1
forumTopicId: 302235
...
Gegeben ist eine Liste mit beliebig vielen Strings. Implementieren Sie eine Funktion für jede der folgenden Bedingungen:

<ul>
  <li>testen Sie, ob alle lexikalisch gleich sind</li>
  <li>testen Sie, ob jeder String lexikalisch kleiner ist als der danach folgende (also ob die Liste in streng aufsteigender Reihenfolge ist)</li>
</ul>
