...
В другій шляховій точці поверніть на `130deg` та збережіть масштабування лівої руки.

# --hints--

Надайте шляховій точці `20%` властивість `transform` зі значенням `rotate(130deg) scaleX(-1)`.
