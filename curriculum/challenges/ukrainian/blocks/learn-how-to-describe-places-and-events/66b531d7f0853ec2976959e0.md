...
This word refers to the act of being present at a place, like a meeting or event. Перша літера є з великою.

# --explanation--

`Attendance` refers to the act of being present at a place, such as a meeting, class, or event. Наприклад:
