...
Si una función flecha tiene un solo parámetro, los paréntesis que engloban el parámetro pueden ser omitidos.
...
Reescribe la función `myConcat` que anexa el contenido de `arr2` a `arr1` para que la función use sintaxis de función flecha.
...
`myConcat` debe ser una función flecha con dos parámetros
