...
Щоб переконатися, що дисплей програвача оновлюється щоразу, коли починається відтворення нової пісні, викличте функцію `setPlayerDisplay()` в межах функції `playSong()`.

Тепер ви повинні побачити назву пісні та виконавця на дисплеї.

# --hints--

Викличте функцію `setPlayerDisplay` у функції `playSong`.
