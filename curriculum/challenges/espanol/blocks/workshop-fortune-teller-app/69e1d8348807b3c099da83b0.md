...
Deberías probar tu progreso hasta ahora. Crea una instancia de la clase `Game` y asígnala a una variable `game`.

En este punto, verás que puedes ver las cartas cuando haces clic en los botones Single Card Reading y
Three Card Spread.

# --hints--

Debes declarar una variable llamada `game`.
...
Tu variable `game` debe inicializarse con `new Game()`.
