...
Una persona con una discapacidad visual no podrá saber qué hay en la imagen a menos que se describa en el texto alt. Un ejemplo de mal texto alt para una imagen de un cachorro sería "Un cachorro lindo."

<img src="https://cdn.freecodecamp.org/curriculum/lecture-transcripts/puppy.png" alt="A cute puppy." />

Este texto no es lo suficientemente específico para transmitir los detalles importantes de la imagen, como ¿cómo se ve el cachorro? ¿Dónde está el cachorro? ¿Hay algún objeto importante alrededor del cachorro?
