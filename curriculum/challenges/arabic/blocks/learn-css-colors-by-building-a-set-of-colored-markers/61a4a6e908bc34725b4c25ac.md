...
بعد ذلك، عيّن نقطة توقف اللون للأحمر إلى `0%`، ونقطة توقف اللون للأخضر إلى `50%`، ونقطة توقف اللون للأزرق إلى `100%`.

# --hints--

يجب أن تحتوي قاعدة CSS الخاصة بـ `.red` على خاصية `background` مضبوطة على `linear-gradient(180deg, rgb(255, 0, 0) 0%, rgb(0, 255, 0) 50%, rgb(0, 0, 255) 100%)`.
