...
Hay varias formas de generar una secuencia autorreferencial. Una muy común (la <a href="https://rosettacode.org/wiki/Look-and-say_sequence" target="_blank" rel="noopener noreferrer nofollow">Look-and-say sequence</a>) es comenzar con un número entero positivo, luego generar el siguiente término concatenando grupos enumerados de dígitos adyacentes iguales:
...
Dependiendo del valor inicial, las series generadas de esta manera siempre convergen a un valor estable o a un patrón cíclico corto. (Para nuestros propósitos, converger significa que un elemento coincide con un elemento visto anteriormente.) La secuencia mostrada, con un valor inicial de 0, converge a un valor estable de 1433223110 después de 11 iteraciones. El valor inicial que converge más rápido es 22. Se estabiliza después del primer elemento. (El siguiente elemento es 22, que ya se ha visto antes.)
