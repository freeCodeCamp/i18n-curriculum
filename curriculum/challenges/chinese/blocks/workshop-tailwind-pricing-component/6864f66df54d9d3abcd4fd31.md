...
对于 `p` 元素内包含文本 `/month` 的 `span`，为其添加 `text-base`、`font-medium` 和 `text-gray-500` 类。这样可以通过使文本更浅来区分它与价格本身。

# --hints--

你的 `span` 元素应具有 `text-base` 类。
