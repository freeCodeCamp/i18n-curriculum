...
I bordi inferiori sotto i tuoi elementi `% Daily Value *` e `Saturated Fat 1g 5%` non si estendono per tutta la larghezza dell'etichetta. Aggiungi `no-divider` all'attributo `class` per questi due elementi.
