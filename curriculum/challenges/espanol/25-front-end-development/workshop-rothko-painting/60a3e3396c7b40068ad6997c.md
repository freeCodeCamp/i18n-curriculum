...
Establezca el `background-color` de `.one` a `#efb762`.

# --hints--

Debe establecer la propiedad `background-color` a `#efb762`.
...
Su elemento `.one` debe tener un valor de `background-color` de `#efb762`.
