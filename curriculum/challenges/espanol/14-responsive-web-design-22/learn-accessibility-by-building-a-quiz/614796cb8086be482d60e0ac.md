...
Su selector debe apuntar a los enlaces dentro de los elementos de la lista.
...
Deberías dar a los elementos `a` dentro de los ítems de la lista una propiedad `color`.
...
Deberías cambiar el color solamente de los elementos `a` dentro de los elementos de lista.
...
Debes dar a la propiedad `color` un contraste con el fondo de al menos 7:1. _Pista: Yo usaría `#dfdfe2`_
