...
Hakuna haja ya kuweka thamani kwa sifa ya `checked`. Badala yake, ongeza tu neno `checked` kwa kipengele cha `input`, kuhakikisha kuna nafasi kati yake na sifa nyingine.
