...
Nachdem deine äußere Schleife beendet ist, musst du das Array zurückgeben. Sobald du dies getan hast, solltest du die `Output`-Änderung sehen können, wenn du den `Sort`-Button erneut anklickst.

# --hints--

Du solltest den `array` mit `return` zurückgeben, nachdem deine äußere Schleife abgeschlossen ist.
