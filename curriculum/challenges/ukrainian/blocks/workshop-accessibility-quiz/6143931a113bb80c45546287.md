...
Всередині другого `section` елемента додайте два `div` елементи з класом `question-block`.

Потім, всередині кожного `div.question-block` елемента додайте один `h3` елемент з текстом зростаючих чисел, починаючи з `1`, і один `fieldset` елемент з класом `question`.

# --hints--

Ви повинні вкласти два `div` елементи всередину другого `section` елемента.

```js
assert.equal(document.querySelectorAll('section:nth-of-type(2) > div')?.length, 2);
```

Ви повинні надати першому новому `div` елементу клас `question-block`.

```js
assert.equal(document.querySelectorAll('section:nth-of-type(2) > div')?.[0]?.className, 'question-block');
```

Ви повинні надати другому новому `div` елементу клас `question-block`.

```js
assert.equal(document.querySelectorAll('section:nth-of-type(2) > div')?.[1]?.className, 'question-block');
```

Ви повинні вкласти один `h3` елемент всередину кожного `div.question-block` елемента.

```js
assert.equal(document.querySelectorAll('section:nth-of-type(2) > div.question-block > h3')?.length, 2);
```

Ви повинні надати першому `h3` елементу текст `1`.

```js
assert.equal(document.querySelectorAll('section:nth-of-type(2) > div.question-block > h3')[0]?.textContent.trim(), '1');
```

Ви повинні надати другому `h3` елементу текст `2`.

```js
assert.equal(document.querySelectorAll('section:nth-of-type(2) > div.question-block > h3')[1]?.textContent.trim(), '2');
```

Ви повинні вкласти один `fieldset` елемент всередину кожного `div.question-block` елемента.

```js
assert.equal(document.querySelectorAll('section:nth-of-type(2) > div.question-block > fieldset')?.length, 2);
```

Ви повинні розмістити перший `fieldset` елемент після першого `h3` елемента.

```js
assert.exists(document.querySelector('section:nth-of-type(2) > div.question-block > h3 + fieldset'));
```

Ви повинні розмістити другий `fieldset` елемент після другого `h3` елемента.

```js
assert.exists(document.querySelector('section:nth-of-type(2) > div.question-block:nth-of-type(2) > h3 + fieldset'));
```

Ви повинні надати першому `fieldset` елементу клас `question`.

```js
assert.equal(document.querySelectorAll('section:nth-of-type(2) > div.question-block > fieldset')?.[0]?.className, 'question');
```

Ви повинні надати другому `fieldset` елементу клас `question`.
