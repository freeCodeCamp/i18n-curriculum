...
誰かが `Is it safe?` と尋ねるとき、それは何かが危険でないか、または何かが十分に保護されているかを知りたいということです。これは、状況や行動が問題ないか、またはそれを行ったり使ったりすることにリスクがあるかどうかを確認する方法です。

# --questions--

## --text--

トムは何が `safe` か知りたいのですか？
...
アリスは空港をバイオメトリクスの使用例としてのみ挙げています。
