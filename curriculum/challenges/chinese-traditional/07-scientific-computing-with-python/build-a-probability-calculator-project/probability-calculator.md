...
- `expected_balls`：一個對象，指示嘗試從帽子中抽取的確切球組以進行實驗。 For example, to determine the probability of drawing 2 blue balls and 1 red ball from the hat, set `expected_balls` to `{'blue':2, 'red':1}`.
