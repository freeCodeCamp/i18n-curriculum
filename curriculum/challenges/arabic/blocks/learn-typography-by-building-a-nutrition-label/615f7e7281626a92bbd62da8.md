...
أسفل آخر عنصر `p` لديك، أنشئ عنصر `p` آخر يحتوي على النص `Sodium 160mg 7%`. ضع كل من `Sodium` و `7%` في عنصر `span` خاص بهما مع صنف `bold` كما فعلت مع العناصر الأخرى.

ثم أضف عنصر `span` إضافي حول `Sodium 160mg` لمحاذاة النص مرة أخرى.
...
يجب أن يحتوي عنصر `p` الجديد على النص `Sodium 160mg 7%`.
...
يجب أن يحتوي عنصر `span` حول `Sodium` على الخاصية `class` مضبوطة على `bold`.
