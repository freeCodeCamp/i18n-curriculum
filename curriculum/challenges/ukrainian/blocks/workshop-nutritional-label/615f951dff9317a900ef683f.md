...
Додайте селектору `.note` відступи зліва та справа по `8px`, прибравши відступи зверху та знизу. Також встановіть властивість `text-indent` у значення `-8px`.

З цими останніми змінами ваша етикетка харчування буде завершена!

# --hints--

Ваш селектор `.note` має мати властивість `padding`, встановлену в `0 8px`.
...
Ваш селектор `.note` має мати властивість `text-indent`, встановлену в `-8px`.
