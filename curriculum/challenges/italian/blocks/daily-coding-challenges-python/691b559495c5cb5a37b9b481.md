...
title: "Sfida 121: l'elemento più frequente"
challengeType: 29
...
- Ci sarà sempre un unico elemento più frequente.

# --hints--

`most_frequent(["a", "b", "a", "c"])` dovrebbe restituire `"a"`.
...
`most_frequent([2, 3, 5, 2, 6, 3, 2, 7, 2, 9])` dovrebbe restituire `2`.
...
`most_frequent([True, False, "False", "True", False])` dovrebbe restituire `False`.
...
`most_frequent([40, 20, 70, 30, 10, 40, 10, 50, 40, 60])` dovrebbe restituire `40`.
