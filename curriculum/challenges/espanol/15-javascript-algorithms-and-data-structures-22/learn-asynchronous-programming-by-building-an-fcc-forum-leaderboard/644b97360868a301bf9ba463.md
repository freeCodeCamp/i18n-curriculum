...
Dentro de la sentencia `if`, desvincula `className` y `category` del objeto `allCategories[id]`.

# --hints--

Debes desvincular `className` y `category` del objeto `allCategories[id]`. Las propiedades pueden estar en cualquier orden.
