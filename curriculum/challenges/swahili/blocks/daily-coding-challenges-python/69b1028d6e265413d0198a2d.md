...
Ikiwa umepewa safu ya data ya nambari ambapo zote isipokuwa nambari moja zinafuata muundo fulani, rudisha safu mpya ya data yenye nambari ile moja ambayo haifuati muundo ikiwa imerekebishwa.

Muundo utakuwa mmoja kati ya:

- Nambari huongezeka kutoka moja hadi nyingine kwa kiasi kilichowekwa (kuongezea).
- Nambari hupungua kutoka moja hadi nyingine kwa kiasi kilichowekwa (kutoa).

Kwa mfano, ukipata `[2, 4, 7, 8, 10]` rudisha `[2, 4, 6, 8, 10]`.
