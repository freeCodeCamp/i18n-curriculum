...
Wakati `self.items` ina `Movie('Dances with Wolves', 1990, 'Kevin Costner', 224)` na `Movie('Annie Hall', 1977, 'Woody Allen', 93)`, njia yako ya `__str__` inapaswa kurudisha `Media Catalogue (2 items):\n\n=== MOVIES ===\n1. Dances with Wolves (1990) - 224 min, Kevin Costner\n2. Annie Hall (1977) - 93 min, Woody Allen\n`.
