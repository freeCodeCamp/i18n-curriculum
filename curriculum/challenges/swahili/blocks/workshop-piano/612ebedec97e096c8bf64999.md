...
Ndani ya hoja ya utafutaji ya `@media`, ongeza kichaguzi cha `.keys` na weka `width` kuwa `318px`.

# --hints--


Kanuni yako ya `@media` inapaswa kuwa na kichaguzi cha `.keys`.
...
Kichaguzi chako kipya cha `.keys` kinapaswa kuwa na `width` ya `318px`.
