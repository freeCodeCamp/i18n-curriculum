...
Usando o operador `and`, adicione uma segunda expressão para verificar o valor da chave `age`.

# --hints--


A chave `age` do seu dicionário `constraints` deve ter o valor de `isinstance(age, int) and age >= 18`.
