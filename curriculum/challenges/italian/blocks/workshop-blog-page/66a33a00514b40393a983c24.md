...
Per il terzo post del blog, dovrai aggiungere un altro elemento `article`.

All'interno dell'elemento `article`, aggiungi un elemento `h3` con il testo `Mr. Whiskers' First Birthday Party`.

Sotto il tuo elemento `h3`, aggiungi due paragrafi di testo lorem ipsum.

# --hints--

Dovresti avere un terzo elemento `article` all'interno del tuo elemento `section` con la proprietà `id` impostata su `posts`.
...
Dovresti avere un elemento `h3` dentro l'elemento `article` con il testo `Mr. Whiskers' First Birthday Party`.
...
Dovresti avere due elementi paragrafo dentro l'elemento `article`.
...
Il tuo primo elemento paragrafo dovrebbe contenere testo lorem ipsum. Controlla attentamente errori di ortografia e punteggiatura.
...
Il tuo secondo elemento paragrafo dovrebbe contenere testo lorem ipsum. Controlla attentamente errori di ortografia e punteggiatura.
...
I tuoi paragrafi dovrebbero venire dopo l'elemento `h3`.
