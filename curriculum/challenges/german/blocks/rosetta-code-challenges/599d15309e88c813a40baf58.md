...
Berechnen Sie die Shannon-Entropie H eines gegebenen Eingabe-Strings.

Gegeben ist die diskrete Zufallsvariable $X$, die ein String aus $N$ „Symbolen“ (Gesamtzeichen) ist und aus $n$ verschiedenen Zeichen besteht (n=2 für binär). Die Shannon-Entropie von X in Bits/Symbol ist:
