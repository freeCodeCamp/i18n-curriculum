...
Ora, aggiungi un `div` con la classe `img-loader`. Dopo, crea un elemento `img` e dagli un URL condizionale per l'immagine usando `{img ? ${CDN_URL}/${img} : LOCAL_DEFAULT_IMG}`.
