...
Sasa, ongeza `div` yenye darasa la vitu `img-loader`. Baada ya hapo, tengeneza kipengele cha `img` na kipa URL ya hali ya sharti kwa picha ukitumia ``${img ? `${CDN_URL}/${img}` : LOCAL_DEFAULT_IMG}``.
