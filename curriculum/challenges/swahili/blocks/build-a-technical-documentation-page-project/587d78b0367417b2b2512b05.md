...
**Lengo:** Jenga programu inayofanana kiutendaji na <a href="https://technical-documentation-page.freecodecamp.rocks" target="_blank" rel="noopener noreferrer nofollow">https://technical-documentation-page.freecodecamp.rocks</a>. **Usikopi mradi huu wa maonyesho**.
...
Timiza hadithi za mtumizi na pita vipimo vyote hapa chini ili kumaliza mradi huu. Toa mtindo wako binafsi. Furahia kuandika msimbo!

**Kumbuka:** Hakikisha unaongeza `<link rel="stylesheet" href="styles.css">` katika HTML yako kuunganisha karatasi yako ya mtindo na kutumia CSS yako
...
Unapaswa kuwa na vipengele vya angalau tano vya `section` vyenye darasa la vitu la `main-section`.
