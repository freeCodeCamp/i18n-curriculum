...
Questa parola suggerisce che Sophie ha sperimentato con il coding in modo informale. Finisce con `-ed`.
...
Questa parola viene usata per descrivere il focus dei progetti di Sophie. Finisce con `-ed`.
...
Questa parola descrive lo stato o la condizione di qualcosa nel passato. È una delle forme passate del verbo `to be`.
