...
title: Prodotto scalare di un vettore
challengeType: 1
forumTopicId: 302343
...
Un vettore può avere uno o più valori rappresentati da una raccolta ordinata. Gli esempi possono essere (x), (x, y) o (x, y, z).

# --instructions--

Scrivi una funzione che prenda due vettori (rappresentati come array monodimensionali) come input e calcoli il loro prodotto scalare. La funzione dovrebbe restituire `null` in caso di input non validi, come vettori di lunghezze diverse o se viene passato qualcosa di diverso da due vettori.
