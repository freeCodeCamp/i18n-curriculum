...
Jetzt sollten Sie die Schriftartgröße für alle `label`-Elemente erhöhen.

Wählen Sie das `label`-Element aus und setzen Sie seine `font-size` auf `1.2rem`.

# --hints--

Sie sollten das `label`-Element ansprechen.
