...
다음으로, 빨간색의 색상 중단점을 `0%`로, 초록색의 색상 중단점을 `50%`로, 파란색의 색상 중단점을 `100%`로 설정하세요.

# --hints--

`.red` CSS 규칙에 `background` 속성을 `linear-gradient(180deg, rgb(255, 0, 0) 0%, rgb(0, 255, 0) 50%, rgb(0, 0, 255) 100%)`로 설정해야 합니다.
