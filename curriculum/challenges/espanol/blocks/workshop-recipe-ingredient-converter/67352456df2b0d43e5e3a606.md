...
Dale a tu `conversionTable` una propiedad `gram`, y asígnale un objeto con una propiedad `cup` establecida en `1/240`, una propiedad `ounce` establecida en `0.0353` y una propiedad `teaspoon` establecida en `0.2`.
