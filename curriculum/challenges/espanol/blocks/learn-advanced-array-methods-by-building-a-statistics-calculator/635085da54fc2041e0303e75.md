...
Finalmente, necesitas devolver el valor de `mean`.

# --hints--

Tu función `getMean` debe usar la palabra reservada `return`.
...
Tu función `getMean` debe volver el valor de `mean`.
...
Tu sentencia `return` debe estar después de la declaración de la variable `mean`.
