...
Dovresti dare a `.blush.left` una proprietà `left` con il valore `--fcc-expected--` invece di `--fcc-actual--`.
...
Dovresti dare a `.blush.right` una proprietà `right` con il valore `--fcc-expected--` invece di `--fcc-actual--`.
