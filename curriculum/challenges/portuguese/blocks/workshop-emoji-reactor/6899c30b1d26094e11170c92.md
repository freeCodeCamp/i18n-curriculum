...
Agora você precisa adicionar um event listener no elemento `happyBtn`.

Escreva o event listener e seu callback para que, quando o botão for clicado, o app registre no console `Button clicked!`.

# --hints--

Quando o `happyBtn` for clicado, `Button clicked!` deve ser registrado no console.
