...
Este é o último grupo de números abaixo de 100.

Em chinês, o número 90 é chamado `九十 (jiǔ shí)`.

Os números de 91 a 99 são formados adicionando o dígito das unidades (1–9) após `九十 (jiǔ shí)` (90).
...
Eu pratiquei a pronúncia dos números de 90 a 99.
