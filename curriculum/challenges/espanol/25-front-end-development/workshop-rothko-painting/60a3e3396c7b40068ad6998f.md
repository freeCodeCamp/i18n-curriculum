...
Aumenta el área y suaviza los bordes de `.one` configurando su `box-shadow` a `0 0 3px 3px #efb762`.

# --hints--

Debes configurar la propiedad `box-shadow` a `0 0 3px 3px #efb762`.
...
Tu elemento `.one` debe tener un valor de `box-shadow` de `0 0 3px 3px #efb762`.
