...
للعثور على المؤلفين المطابقين، تحقق من كل إدخال في الكتالوج واحدًا تلو الآخر.

أضف حلقة `for` فارغة داخل `findByAuthor` للتكرار على `catalog`. ستضيف جسم الحلقة في الخطوة التالية.
