...
Nakili thamani zilizobaki kushoto ndani ya `array` kwa kuweka thamani ya `leftPart[leftArrayIndex]` kwa `array[sortedIndex]`.

# --hints--

Mwili wa mzunguko unapaswa kuweka thamani ya `leftPart[leftArrayIndex]` kwa `array[sortedIndex]`.
