...
Оскільки ви зберігаєте об’єкт, що спричинив виняток, у самому об’єкті винятку, ви можете його певним чином використати.

Після вашого існуючого виклику `print` додайте `print(f'Unable to add {e.obj}: {type(e.obj)}')`.

Такі повідомлення можуть бути надзвичайно корисними, коли ви намагаєтеся налагодити свій код.

# --hints--

У вас має бути `print(f'Unable to add {e.obj}: {type(e.obj)}')` після вашого існуючого виклику `print(f'Media Error: {e}')`.
