...
クラスの中に、オブジェクトとしてのプライベート`elements`プロパティを追加してください。その中に、`singleCardBtn`、`singleCard`、`multipleCardsBtn`というプロパティをそれぞれ`HTMLElement`型で追加してください。

# --hints--

`private`クラスの中に、`elements`という名前の`Game`プロパティを宣言する必要があります。
...
`elements`のプライベートプロパティには、`singleCardBtn`型の`HTMLElement`プロパティが必要です。
...
`elements`のプライベートプロパティには、`multipleCardsBtn`型の`HTMLElement`プロパティが必要です。
...
`elements`のプライベートプロパティには、`singleCard`型の`HTMLElement`プロパティが必要です。
