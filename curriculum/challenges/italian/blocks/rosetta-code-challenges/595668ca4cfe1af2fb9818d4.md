...
Ad esempio, `42` è un numero di Harshad perché `42` è divisibile per `(4 + 2)` senza resto.

Si assume che la serie sia definita come i numeri in ordine crescente.

# --instructions--

Implementa una funzione per generare i membri successivi della sequenza di Harshad.

Usala per restituire un array con dieci membri della sequenza, a partire dal primo numero di Harshad maggiore di `n`.
