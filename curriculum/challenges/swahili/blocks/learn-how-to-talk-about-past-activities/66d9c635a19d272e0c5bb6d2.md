...
Kitenzi msaidizi kinachotumika kuunda maswali katika wakati wa `Present Perfect` kwa `you`.
...
Mfumo wa kitenzi-jina wa kitenzi `have`.

# --explanation--

Unapojiuliza swali kwa `Present Perfect`, unaweza kuanza na `have` au `has` + somo + mfumo wa kitenzi-jina wa kitenzi kuu. Kwa mfano:

`Have you finished your project?` hutumia muundo wa `Have` + somo + `finished`.
