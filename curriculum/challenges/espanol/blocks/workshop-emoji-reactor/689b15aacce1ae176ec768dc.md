...
Ahora, necesitas obtener el primer número en el texto `0/10`, de una manera que funcione incluso para `5/10` o `10/10`.

Analiza el contenido de texto del elemento `.count` para extraer el número actual.

Convierte el conteo de una cadena a un número.

Reemplaza el anterior `console.log(countEl.textContent)` con tu nuevo registro.

Registra el conteo actual en este formato: `console.log("Current count:", currCount)`.

Consejo: recuerda que puedes usar el método `split` para dividir una cadena en un arreglo de subcadenas.

# --hints--

Debes registrar el conteo actual como un número.
...
Debes registrar el conteo actual como un número de una manera que funcione para los distintos valores posibles.
