...
Aggiungi un selettore `:root` all'inizio della tua media query. Poi ridefinisci tutte e quattro le variabili `--building-color` per usare il valore `#000` lì.

# --hints--

Dovresti aggiungere un selettore `:root` alla media query.
...
Dovresti aggiungere `--building-color1` con un valore di `#000`.
...
Dovresti aggiungere `--building-color2` con un valore di `#000`.
...
Dovresti aggiungere `--building-color3` con un valore di `#000`.
...
Dovresti aggiungere `--building-color4` con un valore di `#000`.
