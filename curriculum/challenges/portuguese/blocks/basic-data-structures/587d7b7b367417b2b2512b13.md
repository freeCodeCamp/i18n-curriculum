...
Enquanto `slice()` nos permite ser seletivos sobre quais elementos de um array copiar, entre várias outras tarefas úteis, o novo <dfn>operador spread</dfn> do ES6 nos permite copiar facilmente *todos* os elementos de um array, em ordem, com uma sintaxe simples e altamente legível. A sintaxe de spread é simplesmente essa: `...`
...
A função `copyMachine` deve utilizar o operador `spread operator` com array `arr`
