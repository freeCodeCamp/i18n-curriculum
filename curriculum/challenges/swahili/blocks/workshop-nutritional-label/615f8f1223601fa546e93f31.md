...
Tengeneza kipengele cha mwisho cha `p` kwa sehemu yako ya `.daily-value`. Mpe maandishi ya `Potassium 235mg 6%`. Panga maandishi ya `6%` upande wa kulia, na ondoa mpaka la chini la kipengele cha `p`.
...
Kipengele chako kipya cha `p` kinapaswa kuwa na maandishi ya `Potassium 235mg 6%`.
