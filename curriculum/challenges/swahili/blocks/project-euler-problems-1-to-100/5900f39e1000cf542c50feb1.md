...
title: 'Zoezi la 50: Jumla ya namba msingi mfululizo'
challengeType: 1
forumTopicId: 302161
...
Namba msingi 41, inaweza kuandikwa kama jumla ya namba msingi sita mfululizo:

<div style='text-align: center;'>41 = 2 + 3 + 5 + 7 + 11 + 13</div>

Hii ni jumla ndefu zaidi ya namba msingi mfululizo inayojumuisha namba msingi chini ya mia moja.

Jumla ndefu zaidi ya namba msingi mfululizo chini ya elfu moja inayojumuisha namba msingi, ina maneno 21, na ni sawa na 953.

Ni namba msingi gani, chini ya milioni moja, inaweza kuandikwa kama jumla ya namba msingi nyingi mfululizo? 

# --hints--

`consecutivePrimeSum(1000)` inapaswa kurudisha nambari.

```js
assert(typeof consecutivePrimeSum(1000) === 'number');
```

`consecutivePrimeSum(1000)` inapaswa kurudisha 953.

```js
assert.strictEqual(consecutivePrimeSum(1000), 953);
```

`consecutivePrimeSum(1000000)` inapaswa kurudisha 997651.
