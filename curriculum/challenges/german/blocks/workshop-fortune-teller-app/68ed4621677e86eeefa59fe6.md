...
Jetzt beginnen Sie mit der Arbeit an der `initializeEventListeners()`-Methode. Geben Sie ihr zuerst den Rückgabetyp `void`.

# --hints--

Ihre `initializeEventListeners`-Methode sollte den Rückgabetyp `void` haben.
