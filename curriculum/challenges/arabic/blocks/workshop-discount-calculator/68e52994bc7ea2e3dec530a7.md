...
لإكمال ورشة العمل، أضف عبارة طباعة نهائية لعرض أفضل سعر مع منزلتين عشريتين باستخدام f-string وبالصيغة التالية: `Best price for [product.name] for [user_tier] user: $[best_price]` حيث يجب استبدال `[product.name]` و`[user_tier]` و`[best_price]` بالقيم الفعلية للمتغيرات.

يمكن أن يكون الناتج مثالياً: `Best price for Wireless Buds for Premium user: $93.00`. لاحظ وجود منزلتين عشريتين للسعر.

وبذلك، تكتمل ورشة عمل حاسبة الخصم!

# --hints--

يجب أن يتطابق ناتجك مع الصيغة: `Best price for {product.name} for {user_tier} user: ${best_price:.2f}`.
