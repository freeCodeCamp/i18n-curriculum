...
Тепер завершіть клас `TVSeries`, додавши до нього докстрінг `Child class representing an entire TV series.`

# --hints--

Ви повинні додати докстрінг `Child class representing an entire TV series.` до свого класу `TVSeries`.
