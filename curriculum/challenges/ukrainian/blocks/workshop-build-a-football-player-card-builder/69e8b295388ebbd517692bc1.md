...
Тепер, коли інтерфейс `PlayerData` визначено, оновіть компонент `PlayerCard`, щоб він приймав проп `player` з типом `PlayerData`, що відповідає інтерфейсу `PlayerData`.

Пам’ятайте, що ви можете деструктурувати пропси так:
...
Вам слід оновити `PlayerCard`, щоб він приймав проп `player` з типом `PlayerData`.
