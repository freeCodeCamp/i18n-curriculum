...
Функція Ейлера ${\phi}(n)$ використовується для визначення кількості чисел менших за `n`, які є відносно простими до `n`. Наприклад, оскільки числа 1, 2, 4, 5, 7 і 8 менші за дев’ять та взаємно прості 9, ${\phi}(9) = 6$.
