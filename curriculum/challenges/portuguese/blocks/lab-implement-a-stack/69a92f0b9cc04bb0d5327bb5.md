...
**Nota:** A maioria dos testes depende da função `push`. Implemente `push` primeiro, pois os testes para `pop`, `peek`, `isEmpty` e `clear` exigem adicionar elementos à pilha.
