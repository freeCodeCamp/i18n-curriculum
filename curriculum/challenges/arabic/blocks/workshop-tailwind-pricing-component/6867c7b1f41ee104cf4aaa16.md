...
الآن، ستستخدم `grid` لترتيب العناصر داخل عنصر `div` الغلاف.

أضف الأصناف `grid`، و`grid-rows-[1fr_auto]`، و`gap-6` إلى عنصر `div` الغلاف.

# --hints--

يجب أن يحتوي عنصر `div` الغلاف الخاص بخطة العائلة على الصنف `grid`.
...
يجب أن يحتوي عنصر `div` الغلاف الخاص بخطة العائلة على الصنف `grid-rows-[1fr_auto]`.
...
يجب أن يحتوي عنصر `div` الغلاف الخاص بخطة العائلة على الصنف `gap-6`.
