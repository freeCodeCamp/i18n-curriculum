...
Ongeza `repeating-linear-gradient` nyingine chini ya ile uliyoiweka tu. Ipe mwelekeo wa `90deg`, tumia rangi yako ya jengo kutoka `0%` hadi `12%` na rangi ya dirisha kutoka `12%` hadi `44%`. Hii itaunda madirisha mengi ya mstatili.

# --hints--

Unapaswa kumpa `.fb5` `repeating-linear-gradient` ya pili katika sifa ya `background`.
...
Unapaswa kumpa `repeating-linear-gradient` ya pili mwelekeo wa `90deg`.
...
Unapaswa kumpa `repeating-linear-gradient` ya pili rangi ya kwanza ya `--building-color2` kutoka `0%` hadi `12%`.
...
Unapaswa kumpa `repeating-linear-gradient` ya pili rangi ya pili ya `--window-color2` kutoka `12%` hadi `44%`.
