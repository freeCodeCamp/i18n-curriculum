...
Sie benötigen eine weitere Schnittstelle namens `Deck`. Diese Schnittstelle sollte eine `cards`-Eigenschaft haben, die ein Array der vorherigen Schnittstelle ist.

# --hints--

Sie sollten eine Schnittstelle namens `Deck` deklarieren.
...
Ihre `Deck`-Schnittstelle sollte eine Eigenschaft `cards` vom Typ `Card[]` haben.
