...
Comienza creando un objeto con las tres propiedades anteriores para la `Spanish lavender` (nombre científico `Lavandula stoechas`) de un cultivar llamado `Ballerina` y asígnalo a una variable llamada `ballerina`.
