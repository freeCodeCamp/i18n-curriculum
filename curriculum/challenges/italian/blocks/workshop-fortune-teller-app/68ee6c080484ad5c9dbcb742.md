...
Ora inizierai a creare i metodi.

Crea un metodo chiamato `singleCardSelected`. Al suo interno, chiama la funzione `hideElements` e passa le seguenti proprietà: `singleCardBtn`, `multipleCardsBtn`, `multipleCard`, `text` e `headerTitle`.

Ricorda che devi consultarle tutte usando `this.elements`.

# --hints--

Dovresti definire un metodo chiamato `singleCardSelected`.
...
All’interno di `singleCardSelected`, dovresti chiamare la funzione `hideElements`.
...
Dovresti passare `singleCardBtn` alla funzione `hideElements`.
...
Dovresti passare `multipleCardsBtn` alla funzione `hideElements`.
...
Dovresti passare `multipleCard` alla funzione `hideElements`.
...
Dovresti passare `text` alla funzione `hideElements`.
...
Dovresti passare `headerTitle` alla funzione `hideElements`.
