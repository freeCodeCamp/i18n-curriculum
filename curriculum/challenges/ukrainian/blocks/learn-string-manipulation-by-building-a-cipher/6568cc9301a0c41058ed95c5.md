...
Тепер замініть `new_char` на `encrypted_text`. Також змініть виклик `print()` на `print('char:', char, 'encrypted text:', encrypted_text)`, щоб відобразити цю зміну.

# --hints--

Ви повинні замінити `new_char` на `encrypted_text` всередині свого циклу `for`.
...
Ви повинні перетворити виклик `print()` на `print('char:', char, 'encrypted text:', encrypted_text)` всередині свого циклу `for`.
