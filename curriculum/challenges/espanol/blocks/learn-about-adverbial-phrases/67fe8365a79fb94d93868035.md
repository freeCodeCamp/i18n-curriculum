...
When using `about`, the verb that follows it is in the `-ing` form. This is because `about` is a preposition, and after a preposition, you use the `-ing` form of the verb. Por ejemplo:
