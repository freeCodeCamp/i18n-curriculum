...
Dentro del `stats-grid`, añade dos elementos `div` cada uno con el `className` de `form-group`.

Para el primero, añade un `label` con el `className` de `label`, un `htmlFor` de `pac` y el texto `PAC`, luego un input con un `id` de `pac`, un `className` de `input` y un `type` de `number`.

Y para el segundo, añade `label` con un `htmlFor` de `sho` y el texto `SHO`, luego un input con un `id` de `sho` y un `type` de `number`.

# --hints--

Deberías tener dos elementos `div` cada uno con el `className` de `form-group` dentro del `div` de `className` de `stats-grid`.
...
Tu primer elemento `div` de `className` de `form-group` debería tener un `label` con un atributo `htmlFor` de `pac`, un `className` de `label` y un texto `PAC`.
...
Tu primer elemento `div` de `className` de `form-group` debería tener un `input` con un `className` de `input`, un `id` de `pac` y un `type` de `number`.
...
Tu segundo elemento `div` de `className` de `form-group` debería tener un `label` con un atributo `htmlFor` de `sho`, un `className` de `label` y un texto `SHO`.
...
Tu segundo elemento `div` de `className` de `form-group` debería tener un `input` con un `id` de `sho`, un `className` de `input` y un `type` de `number`.
