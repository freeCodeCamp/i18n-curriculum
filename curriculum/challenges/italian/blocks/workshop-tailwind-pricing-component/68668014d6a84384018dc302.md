...
Il prossimo è l’ultimo elemento di prezzo, il **piano famiglia**.

Per cominciare, assegna al wrapper `div` per il piano le classi `bg-gray-100`, `ring-1`, `ring-gray-300`, `p-8` e `rounded-xl`.

# --hints--

Il tuo elemento wrapper `div` per il piano famiglia dovrebbe avere la classe `bg-gray-100`.
...
Il tuo elemento wrapper `div` per il piano famiglia dovrebbe avere la classe `ring-1`.
...
Il tuo elemento wrapper `div` per il piano famiglia dovrebbe avere la classe `ring-gray-300`.
...
Il tuo elemento wrapper `div` per il piano famiglia dovrebbe avere la classe `p-8`.
...
Il tuo elemento wrapper `div` per il piano famiglia dovrebbe avere la classe `rounded-xl`.
