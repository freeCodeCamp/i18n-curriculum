...
**Objetivo:** Construir um aplicativo que seja funcionalmente semelhante a <a href="https://technical-documentation-page.freecodecamp.rocks" target="_blank" rel="noopener noreferrer nofollow">https://technical-documentation-page.freecodecamp.rocks</a>. **Não copie este projeto de demonstração**.
...
1. Dentro do elemento `#main-doc`, você pode ver vários elementos `section`, cada um com uma classe `main-section`. Deve haver no mínimo cinco.
...
1. Além disso, a navbar deve conter elementos de link (`a`) com a classe `nav-link`. Deve haver um para cada elemento com a classe `main-section`.
