...
title: 'Aufgabe 25: Fibonacci-Zahl mit 1000 Stellen'
challengeType: 1
forumTopicId: 301897
...
Die Fibonacci-Folge wird durch die Rekursionsgleichung definiert:

<div style='padding-left: 4em;'>F<sub>n</sub> = F<sub>n−1</sub> + F<sub>n−2</sub>, wobei F<sub>1</sub> = 1 und F<sub>2</sub> = 1 ist.</div>

Daher sind die ersten 12 Glieder:
...
Das 12. Glied, F<sub>12</sub>, ist das erste Glied mit drei Stellen.

Welcher Index hat das erste Glied der Fibonacci-Folge, das `n` Stellen enthält?
