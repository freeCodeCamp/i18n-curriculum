...
All’interno di ciascuno dei tuoi nuovi elementi `a`, aggiungi un elemento `i` e assegna loro le seguenti classi:

- Il tuo primo elemento `i` dovrebbe avere la classe `fab fa-facebook-f`
- Il tuo secondo elemento `i` dovrebbe avere la classe `fab fa-twitter`
- Il tuo terzo elemento `i` dovrebbe avere la classe `fab fa-instagram`
- Il tuo quarto elemento `i` dovrebbe avere la classe `fab fa-linkedin-in`
- Il tuo quinto elemento `i` dovrebbe avere la classe `fab fa-youtube`
...
Ogni elemento `a` dovrebbe avere solo un elemento `i`.
