...
素晴らしいです。赤いマーカーはいい感じになりましたね。あとは他のマーカーにもキャップとスリーブを追加するだけです。

緑と青のマーカーの両方にキャップとスリーブを追加してください。赤いマーカーから`div`要素をコピーして、他の2つのマーカーに貼り付ければ大丈夫です。

# --hints--

緑のマーカー`div`には`div`要素が2つ含まれているはずです。
...
緑のマーカーのキャップ`div`要素はスリーブ`div`要素の前にあるべきです。
...
青のマーカー`div`には`div`要素が2つ含まれているはずです。
...
青のマーカーのキャップ`div`要素はスリーブ`div`要素の前にあるべきです。
