...
Спочатку створіть поверхневу копію вхідного масиву `crew` за допомогою `slice()` і призначте її змінній з ім’ям `sorted`.

# --hints--

Ви повинні використати метод `slice()`, щоб скопіювати вхідний масив `crew` у нову змінну з ім’ям `sorted`.
