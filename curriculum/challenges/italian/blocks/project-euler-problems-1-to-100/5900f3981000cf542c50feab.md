...
I numeri pentagonali sono generati dalla formula, P<sub>n</sub>=`n`(3`n`−1)/2. I primi dieci numeri pentagonali sono:

1, 5, 12, 22, 35, 51, 70, 92, 117, 145, ...

Si può vedere che P<sub>4</sub> + P<sub>7</sub> = 22 + 70 = 92 = P<sub>8</sub>. Tuttavia, la loro differenza, 70 − 22 = 48, non è pentagonale.

Trova la coppia di numeri pentagonali, P<sub>j</sub> e P<sub>k</sub>, per cui la loro somma e differenza sono pentagonali e D = |P<sub>k</sub> − P<sub>j</sub>| è minimizzato; qual è il valore di D?
