...
In this lab, you'll build an app that will search for Pokémon by name or ID and display the results to the user. ポケモンのデータや画像の取得には、freeCodeCamp の <a href="https://pokeapi-proxy.freecodecamp.rocks/" target="_blank" rel="noopener noreferrer nofollow">PokéAPI プロキシー</a>を使用します。
