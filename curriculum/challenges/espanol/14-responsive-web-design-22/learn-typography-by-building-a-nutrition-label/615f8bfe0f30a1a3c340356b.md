...
Debes crear un segundo nuevo elemento `p` al final del elemento `.daily-value`.
...
El primer elemento `span` no debe estar en negrita.
...
El segundo elemento `span` no debe estar en negrita.
