...
The `span[class~="sr-only"]` selector will select any `span` element whose `class` _includes_ `sr-only`. Створіть такий селектор та надайте йому властивість `border` зі значенням `0`.

# --hints--

Ви повинні мати селектор `span[class~="sr-only"]`.
