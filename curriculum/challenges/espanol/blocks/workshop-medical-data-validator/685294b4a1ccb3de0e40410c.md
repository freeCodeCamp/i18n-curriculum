...
Deberías tener una variable llamada `invalid_records` al final de tu ciclo `for` dentro de la función `validate`.
...
Tu variable `invalid_records` debe tener el valor de `find_invalid_records(**dictionary)`.
