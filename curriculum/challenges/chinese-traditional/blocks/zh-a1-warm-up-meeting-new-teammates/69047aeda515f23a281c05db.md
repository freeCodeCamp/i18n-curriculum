...
<!-- (Audio) Liu Ming: 很高興 (hěn gāo xìng) -->
...
`很高興 (hěn gāo xìng)` means "very happy" or "very glad". It's used to express a positive emotion. For example:
