...
`I like it here` is commonly used to express positive feelings about a current location or environment. Якщо хтось так каже, то часто мається на увазі комфорт, щастя або задоволення від місця, де вони перебувають.
