...
Наступним кроком створіть масив для збереження всіх пісень.

Створіть порожній масив `allSongs`.

# --hints--

У вас має бути змінна з назвою `allSongs`.

```js
assert.isDefined(allSongs)
```

Ви повинні призначити масив змінній `allSongs`.
