...
Tu primer edificio se ve bastante bien ahora. Anida tres nuevos elementos `div` en el contenedor `.background-buildings` y dales las clases de `bb2`, `bb3`, y `bb4` en ese orden. Serán tres edificios más para el fondo.
