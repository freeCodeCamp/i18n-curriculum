...
聆聽音訊。這個問題在問什麼？<!-- (quiz audio) Tom: What's your typical workday like? -->
...
`To conduct` 意味著組織並執行一項活動或任務。

---

`To ensure` 意味著確保某事會發生。

---

`To issue` 意味著正式提供或分發某物。

#### --answer--

`To promote` 意味著保持某物安全。
...
聆聽音訊。什麼時候適合這麼說？<!-- (quiz audio) Sophie: It helps me stay on track. -->
