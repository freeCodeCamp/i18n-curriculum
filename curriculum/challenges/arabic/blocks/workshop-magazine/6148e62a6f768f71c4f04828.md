...
يمكن استخدام خاصية `place-items` لضبط قيمتي `align-items` و `justify-items` في نفس الوقت. تأخذ خاصية `place-items` قيمة واحدة أو قيمتين. إذا وُفرت قيمة واحدة، تُستخدم لكل من خاصيتي `align-items` و `justify-items`. إذا وُفرت قيمتان، تُستخدم القيمة الأولى لخاصية `align-items` والقيمة الثانية لخاصية `justify-items`.
