...
Sasa ni wakati wa kujaribu kitufe cha kusitisha.

Ongeza msikilizaji wa tukio la `"click"` kwenye kipengele cha `pauseButton`, kisha pita `pauseSong` kama hoja ya pili ya msikilizaji wa tukio. Hii ndiyo kitendakazi ambacho msikilizaji wa tukio atakimbia.

Jaribu programu yako kwa kubofya kwanza kitufe cha kucheza kisha kitufe cha kusitisha. Unapaswa kuona kuwa kila kitu kinafanya kazi kama inavyotarajiwa.

# --hints--

Unapaswa kuita njia ya `addEventListener()` kwenye kigezo chako cha `pauseButton`.
...
Unapaswa kupitisha `pauseSong` kama hoja ya pili ya njia yako ya `addEventListener`.
