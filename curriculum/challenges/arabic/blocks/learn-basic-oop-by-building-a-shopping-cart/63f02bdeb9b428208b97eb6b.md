...
يجب أن تُرجع طريقة `calculateTaxes` قيمة `taxRate` (مقسومة على 100 لتحويلها إلى نسبة مئوية) مضروبة في معلمة `amount`.
...
يجب أن تضرب معلمة `amount` في `taxRate` مقسومة على 100 في طريقة `calculateTaxes`.
