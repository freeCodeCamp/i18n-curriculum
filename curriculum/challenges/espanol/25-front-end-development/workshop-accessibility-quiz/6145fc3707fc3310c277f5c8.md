...
Volver a estilizar la página. Seleccione los elementos de lista dentro de la barra de navegación y asígneles los siguientes estilos:
...
Debes usar el selector `nav li` o `nav > ul > li`.
...
Debes darle a los elementos `li` un `color` de `#dfdfe2`.
...
Debes darle a los elementos `li` un `margen` de `0 0.2rem`.
...
Debes darle a los elementos `li` un `relleno` de `0.2rem`.
...
Debes dar a los elementos `li` un `display` de `block`.
