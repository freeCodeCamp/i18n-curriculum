...
링크가 실제로 클릭될 때 링크의 속성을 변경하려면 `a:active { propertyName: propertyValue; }`처럼 생긴 <dfn>의사 선택자</dfn>를 사용하세요.

클릭할 때 푸터 `Visit our website` 링크의 색상을 `white`로 변경하세요.

# --hints--

`a:active` 의사 선택자를 사용하세요.
...
`a:active`에 `color`인 `white`가 있어야 합니다.
