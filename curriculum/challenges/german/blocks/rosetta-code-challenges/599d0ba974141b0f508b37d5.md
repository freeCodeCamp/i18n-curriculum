...
Eine Emirp (eine **Primzahl**, rückwärts geschrieben) ist eine Primzahl, die, wenn man ihre Dezimaldarstellung umkehrt, eine andere Primzahl ergibt.
...
<ul>
  <li>die ersten <code>n</code> Emirp-Zahlen anzeigt.</li>
  <li>die Emirp-Zahlen in einem Bereich anzeigt.</li>
  <li>die Anzahl der Emirps in einem Bereich anzeigt.</li>
  <li>die <code>n<sup>te</sup></code> Emirp-Zahl anzeigt.</li>
</ul>

Die Funktion soll zwei Parameter akzeptieren. Der erste erhält `n` oder den Bereich als Array. Der zweite erhält einen Boolean, der angibt, ob die Funktion die Emirps als Array oder als einzelne Zahl zurückgibt (die Anzahl der Primzahlen im Bereich oder die <code>n<sup>te</sup></code> Primzahl). Je nach Parametern soll die Funktion ein Array oder eine Zahl zurückgeben.
