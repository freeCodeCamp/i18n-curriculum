...
Per aggiungere spazio tra le righe nella griglia, puoi usare la proprietà `row-gap`. Dai al selettore `main` una proprietà `row-gap` con valore `3rem`.

# --hints--

Il tuo selettore `main` dovrebbe avere una proprietà `row-gap` con valore `3rem`.
