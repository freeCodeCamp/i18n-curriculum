...
Nachdem Sie den `left_part`-Index dem sortierten Array zugewiesen haben, erhöhen Sie `left_array_index` um `1`.

# --hints--

Sie sollten `1` zum aktuellen Wert von `left_array_index` hinzufügen.
