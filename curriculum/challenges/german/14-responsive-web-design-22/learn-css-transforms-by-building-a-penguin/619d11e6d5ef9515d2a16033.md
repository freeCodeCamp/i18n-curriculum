...
Kümmere dich um die `.beak` Elemente mit einer `class` von `top` und gib ihnen eine `width` von `20%`, und positioniere sie `60%` von oben, und `40%` links von seinem Elternteil.

# --hints--

Du solltest den `.beak.top`-Selektor verwenden.
