...
Para ver sua exceção personalizada em ação, transforme a linha `catalogue.add(series2)` em `catalogue.add('series2')`.

# --hints--

Você deve transformar a linha `catalogue.add(series2)` em `catalogue.add('series2')`.
