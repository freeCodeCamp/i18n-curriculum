...
Глянувши на об’єкт `"kill monster"`, `"button functions"` зараз має три змінні `goTown`. Змініть третю на `easterEgg`: таким чином гравець отримає доступ до прихованої властивості гри. Не змінюйте `"button text"`.
