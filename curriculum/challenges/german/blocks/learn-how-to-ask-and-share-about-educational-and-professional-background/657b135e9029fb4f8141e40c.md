...
Dies ist die `past simple`-Form des Verbs `to be`, verwendet mit `you`, `we` oder `they`. Der erste Buchstabe ist großgeschrieben.
...
Dieses Wort bedeutet, aktiv an etwas teilzunehmen. Es endet auf `-ed`.
...
Dieser Begriff bezeichnet den Prozess des Abschlusses eines Kaufs.
