...
في الخطوة الأخيرة من ورشة العمل، سجّل الرسالة `"It was fun learning about the different Math methods with you!"` في وحدة التحكم.

وبهذا التغيير الأخير، تكون قد أكملت ورشة عمل MathBot!
...
يجب أن تسجل الرسالة `"It was fun learning about the different Math methods with you!"` في وحدة التحكم.
