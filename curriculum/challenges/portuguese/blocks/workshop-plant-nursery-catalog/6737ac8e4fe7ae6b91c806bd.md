...
Ainda dentro da sua função, adicione o objeto `prettyPolly` ao seu conjunto.

# --hints--

Você deve usar o método `add` para adicionar o objeto `prettyPolly` ao seu conjunto dentro da função `displayPlantsSet`.
