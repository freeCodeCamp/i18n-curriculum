...
O JavaScript tem sete tipos de dados primitivos. Um deles é a String. In JavaScript, a <dfn>string</dfn> represents a sequence of characters and can be enclosed in either single (`'`) or double (`"`) quotes.
