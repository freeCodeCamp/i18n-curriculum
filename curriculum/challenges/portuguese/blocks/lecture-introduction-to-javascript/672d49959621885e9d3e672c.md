...
title: "Como let e const funcionam de forma diferente quando se trata de declaração, atribuição e reatribuição de variáveis?"
challengeType: 19
...
A palavra-chave `let` permite declarar variáveis que podem ser atualizadas ou reatribuídas depois. Você pode pensar em `let` como um container flexível: uma vez que você armazenou um valor nele, pode mudar esse valor conforme precisar durante seu programa.
