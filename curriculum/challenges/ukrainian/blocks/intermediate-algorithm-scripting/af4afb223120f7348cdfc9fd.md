...
Відповідно до третього закону Кеплера, орбітальний період $T$ двох точкових мас, що обертаються одна навколо одної по круговій або еліптичній орбіті, дорівнює:

$$
T = 2 \pi \sqrt{\frac{a^{3}}{\mu}}
$$

- $a$ — напіввеликa вісь орбіти
- $μ = GM$ — стандартний гравітаційний параметр
- $G$ — гравітаційна стала,
- $M$ — маса більш масивного тіла.

Поверніть новий масив, який перетворює середню висоту елементів у їхні орбітальні періоди (у секундах).

Масив міститиме об’єкти у форматі `{name: 'name', avgAlt: avgAlt}`.

Значення слід округлити до найближчого цілого числа. Тіло, навколо якого відбувається обертання, — Земля.
