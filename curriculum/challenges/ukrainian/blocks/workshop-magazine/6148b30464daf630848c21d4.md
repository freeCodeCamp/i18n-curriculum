...
Додайте вашому `.heading` селектору множину властивостей `row-gap`, встановлену в `1.5rem`.

# --hints--

Ваш `.heading` селектор має мати множину властивостей `row-gap`, встановлену в `1.5rem`.
