...
Щоб допомогти відстежувати, як учасники рухаються системою, виведіть у консоль таке повідомлення: `overflowAmount + " attendees rerouted to " + gates[nextGateIndex].id`. Ви можете використати або конкатенацію рядків, або шаблонні літерали.

# --hints--

Ваша функція `rerouteOverflow` має вивести у консоль таке повідомлення `overflowAmount + " attendees rerouted to " + gates[nextGateIndex].id`.
