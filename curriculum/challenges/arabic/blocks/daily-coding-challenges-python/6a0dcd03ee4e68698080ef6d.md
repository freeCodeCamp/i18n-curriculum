...
معطاة سلسلة أرقام مفصولة بفواصل، أرجع مصفوفة من الأرقام مرتبة من الأصغر إلى الأكبر.

# --hints--

`sort_numbers("3,1,2")` يجب أن تُرجع `[1, 2, 3]`.
...
`sort_numbers("5,3,8,1,9,2")` يجب أن تُرجع `[1, 2, 3, 5, 8, 9]`.
...
`sort_numbers("12,61,49,80,19,50,77,38")` يجب أن تُرجع `[12, 19, 38, 49, 50, 61, 77, 80]`.
...
`sort_numbers("0,6,-19,44,-2,7,0")` يجب أن تُرجع `[-19, -2, 0, 0, 6, 7, 44]`.
