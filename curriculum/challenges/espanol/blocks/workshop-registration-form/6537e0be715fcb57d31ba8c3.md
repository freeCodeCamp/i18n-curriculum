...
Por último, cambie el color del texto del elemento de enlace `términos y condiciones` a `#dfdfe2` agregando un nuevo selector en el CSS.

¡Bien hecho! Ha completado la parte final del taller de *Formulario de Registro*.

# --hints--


Debes de dar al elemento `a` un `color` de `#dfdfe2`.
