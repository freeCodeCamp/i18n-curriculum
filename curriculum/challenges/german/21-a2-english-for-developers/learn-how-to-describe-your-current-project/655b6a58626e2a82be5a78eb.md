...
To `steal` means to take something that doesn't belong to you without permission. Zum Beispiel:
...
`Identity` refers to who a person is, including their name, date of birth, and other personal information. Zum Beispiel:
