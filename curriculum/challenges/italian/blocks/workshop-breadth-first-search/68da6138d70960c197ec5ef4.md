...
La tua funzione è ora completa. Testala di nuovo stampando `gen_parentheses(2)` invece di `gen_parentheses(1)`.

# --hints--

Dovresti stampare `gen_parentheses(2)`.
...
Non dovresti avere `print(gen_parentheses(1))` nel tuo codice
