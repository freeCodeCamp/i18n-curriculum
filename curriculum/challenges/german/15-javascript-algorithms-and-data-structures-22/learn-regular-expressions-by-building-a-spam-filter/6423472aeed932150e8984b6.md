...
Mit der gleichen Syntax aktualisierst du `c`, um mit `c`, `{`, `[`, und `(` übereinzustimmen.

# --hints--

Deine `stockRegex` sollte eine Zeichenklasse verwenden, um mit `c`, `{`, `[`, und `(` übereinzustimmen.
...
Deine `stockRegex` sollte mit `570(k 4l3r7` übereinstimmen.

```js
assert.match('570(k 4l3r7', stockRegex);
```

Deine `stockRegex` sollte mit `sto{k alert` übereinstimmen.
