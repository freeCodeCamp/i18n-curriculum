...
Schaffen Sie jetzt etwas Platz, entfernen Sie alle Button-Variablen und die `eventListener`, die Sie für jede erstellt haben.

# --hints--

Die `happyBtn`-Variable sollte nicht existieren.
...
Die `confusedBtn`-Variable sollte nicht existieren.
...
Die `sadBtn`-Variable sollte nicht existieren.
...
Die `lovingBtn`-Variable sollte nicht existieren.
