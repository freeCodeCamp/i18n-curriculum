...
A continuación, tenemos que minimizar las solicitudes HTTP. Cada archivo que solicita tu sitio web suma al tiempo de carga. Reducir el número de solicitudes HTTP puede conducir a cargas de página más rápidas. Puedes:
...
Usa el encabezado Cache-Control para especificar cuánto tiempo los navegadores deben conservar los archivos.
