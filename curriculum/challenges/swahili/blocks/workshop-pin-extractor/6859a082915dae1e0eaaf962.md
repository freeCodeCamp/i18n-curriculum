...
Mwishowe, rudisha `secret_codes`, kisha fungua maoni ya wito wa kitendakazi na sasisha hoja iwe `[poem, poem2, poem3]`. Sasa kitendakazi chako kinafanya kazi na mashairi mengi kwa wakati mmoja, na kinaweza kutoa pini nyingi!

Kitendakazi cha `pin_extractor` kimekamilika.

# --hints--

Kitendakazi kinapaswa kurudisha `secret_codes` mwishoni.
...
Unapaswa kuwa na wito wa kitendakazi `print(pin_extractor([poem, poem2, poem3]))`.
...
`pin_extractor([poem, poem2, poem3])` inapaswa kurudisha `['5202', '3346', '50000']`.
...
Kitendakazi kinapaswa kufanya kazi vizuri na orodha nyingine za mashairi.
