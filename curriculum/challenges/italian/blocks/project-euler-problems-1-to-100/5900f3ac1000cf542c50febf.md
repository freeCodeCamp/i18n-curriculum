...
Tutte le radici quadrate sono periodiche quando scritte come frazioni continue e possono essere espresse nella forma:
...
Se continuiamo otterremmo la seguente espansione:
...
Si può vedere che la sequenza si ripete. Per brevità, usiamo la notazione $\\sqrt{23}=\[4;(1,3,1,8)]$, per indicare che il blocco (1,3,1,8) si ripete all'infinito.

Le prime dieci rappresentazioni in frazioni continue delle radici quadrate (irrazionali) sono:
...
Esattamente quattro frazioni continue, per $N \\le 13$, hanno un periodo dispari.

Quante frazioni continue per $N \\le n$ hanno un periodo dispari?
