...
O elemento `legend` deve ter uma tag de abertura. Opening tags have this syntax: `<elementName>`.
...
O elemento `legend` deve ter uma tag de fechamento. Closing tags have a `/` just after the `<` character.
