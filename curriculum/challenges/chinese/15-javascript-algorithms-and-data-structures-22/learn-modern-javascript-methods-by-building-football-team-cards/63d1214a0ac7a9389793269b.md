...
_注意_：球队号码是按照姓氏字母顺序排列的。 这与传统的编号方式不同，传统的编号方式是数字与球员球衣上的号码相对应。

# --hints--

你的 `myFavoriteFootballTeam.players` 数组应该具有一个对象的值。
