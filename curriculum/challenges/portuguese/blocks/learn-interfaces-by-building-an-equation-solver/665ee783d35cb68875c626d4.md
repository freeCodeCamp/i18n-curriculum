...
Agora, remova as chamadas `print(lin_eq.solve())` e `print(lin_eq.analyze())` do seu código.

# --hints--

Você deve remover ambas as chamadas `print(lin_eq.solve())` e `print(lin_eq.analyze())`.
