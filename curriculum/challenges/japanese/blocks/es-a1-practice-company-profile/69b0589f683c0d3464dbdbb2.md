...
Sebastián は Andes Commerce をデザイン企業とは説明していません。
...
Sebastián は `Andes Commerce es una empresa de tecnología` と言っており、これは「Andes Commerce はテクノロジー企業です」という意味です。

したがって、Andes Commerce はテクノロジー企業です。
