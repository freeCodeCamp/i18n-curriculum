...
Sua função `highlightCurrentEls` deve aplicar aos descendentes do elemento especificado, localizados no índice dado e no índice seguinte, uma borda que seja `dashed`, `red` e com uma largura de sua escolha.
