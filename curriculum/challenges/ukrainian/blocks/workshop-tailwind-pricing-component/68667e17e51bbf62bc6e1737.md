...
Тепер слід стилізувати CTA, щоб він більше нагадував кнопку.

Для кольорів фону та переднього плану призначте йому класи `bg-gradient-to-r`, `from-fuchsia-500`, `to-indigo-600`, `text-white`, `hover:from-fuchsia-600` та `hover:to-indigo-700`. Також призначте йому класи `rounded-md` і `block`.

# --hints--

Ваш елемент посилання має мати клас `bg-gradient-to-r`.
...
Ваш елемент посилання має мати клас `from-fuchsia-500`.
...
Ваш елемент посилання має мати клас `to-indigo-600`.
...
Ваш елемент посилання має мати клас `text-white`.
...
Ваш елемент посилання має мати клас `hover:from-fuchsia-600`.
...
Ваш елемент посилання має мати клас `hover:to-indigo-700`.
...
Ваш елемент посилання має мати клас `rounded-md`.
...
Ваш елемент посилання має мати клас `block`.
