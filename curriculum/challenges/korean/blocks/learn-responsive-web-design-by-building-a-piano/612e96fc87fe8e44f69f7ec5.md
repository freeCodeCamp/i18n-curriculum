...
키 스타일을 지정할 시간입니다. `#piano` 규칙 아래에 `.keys` 선택자로 `class` 요소를 지정하세요. 새 규칙에 `background-color` 속성으로 `#040404`, `width` 속성으로 `949px`, `height` 속성으로 `180px`을 지정하세요.
