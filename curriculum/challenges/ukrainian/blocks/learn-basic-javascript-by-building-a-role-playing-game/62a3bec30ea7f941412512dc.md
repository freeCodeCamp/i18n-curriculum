...
Так само, як ви зробили з кнопками, створіть змінні для наступних `id` і використайте `querySelector()`, щоб присвоїти їм елемент як значення:

`text`, `xpText`, `healthText`, `goldText`, `monsterStats` і `monsterName`.

Не забудьте оголосити їх за допомогою ключового слова `const` і назвати змінні відповідно до `id`.
...
Ваша змінна `text` має містити значення вашого елемента `#text`.
...
Ваша змінна `xpText` має містити значення вашого елемента `#xpText`.
...
Ваша змінна `healthText` має містити значення вашого елемента `#healthText`.
...
Ваша змінна `goldText` має містити значення вашого елемента `#goldText`.
...
Ваша змінна `monsterStats` має містити значення вашого елемента `#monsterStats`.
...
Ваша змінна `monsterName` має містити значення вашого елемента `#monsterName`.
