...
Both radio buttons should have a `name` attribute. تحقق من وجود مسافة بعد اسم opening tag و/أو أن هناك مسافات قبل جميع أسماء السمات.
...
Both radio buttons should have a `type` attribute. تحقق من وجود مسافة بعد اسم opening tag و/أو أن هناك مسافات قبل جميع أسماء السمات.
...
Both radio buttons should have a `name` attribute with the value `indoor-outdoor`. إما أنك حذفت القيمة أو لديك خطأ إملائي. تذكر أن تحيط قيمة السمة بعلامات اقتباس.
