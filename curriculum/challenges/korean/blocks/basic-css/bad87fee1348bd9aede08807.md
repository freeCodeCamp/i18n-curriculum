...
`font-family` 속성을 사용해 요소가 사용할 폰트를 설정할 수 있습니다.

예를 들어, `h2` 요소의 폰트를 `sans-serif`로 설정하려면 다음 CSS를 사용하세요:
...
모든 `p` 요소가 `monospace` 폰트를 사용하도록 만드세요.

# --hints--

`p` 요소가 `monospace` 폰트를 사용해야 합니다.
