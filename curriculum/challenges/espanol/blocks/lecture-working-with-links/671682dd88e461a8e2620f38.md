...
Una URL absoluta es una dirección completa que se usa para acceder a un recurso. Incluye el protocolo (que puede ser `http`, `https` o `file`) y el nombre de dominio si el recurso está en la web. Aquí tienes un ejemplo de una URL absoluta que enlaza con el logo de freeCodeCamp:
...
- Usa una URL absoluta cuando enlaces a un recurso alojado en un sitio web externo.
