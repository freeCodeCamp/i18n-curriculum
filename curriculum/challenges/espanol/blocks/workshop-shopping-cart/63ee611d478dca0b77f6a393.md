...
Aprendiste en una lección anterior que la palabra clave `this` se refiere a la instancia actual que se está construyendo, como viste en el constructor `Dessert`. Aquí, aplicarás la misma idea a la clase `ShoppingCart`.
...
En tu constructor, usa la palabra clave `this` para asignar la propiedad `items` a un arreglo vacío. Además, asigna la propiedad `total` a `0` y la propiedad `taxRate` a `8.25`.

# --hints--

Debes usar la palabra clave `this` para asignar la propiedad `items` de tu clase a un arreglo vacío.
...
Debes usar la palabra clave `this` para asignar la propiedad `total` de tu clase a `0`.
...
Debes usar la palabra clave `this` para asignar la propiedad `taxRate` de tu clase a `8.25`.
