...
Створіть селектор `.author-name a:hover` і надайте йому властивість `background-color` зі значенням `#306203`.
...
Ваш селектор `.author-name a:hover` має мати властивість `background-color` зі значенням `#306203`.
