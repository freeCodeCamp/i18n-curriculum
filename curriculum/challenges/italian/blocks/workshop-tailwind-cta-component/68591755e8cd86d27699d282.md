...
Infine, per rimuovere gli spigoli vivi dell'elemento esterno `div`, aggiungi la classe `rounded-md`.

# --hints--

Il tuo elemento esterno `div` dovrebbe avere la classe di utilità `rounded-md`.
