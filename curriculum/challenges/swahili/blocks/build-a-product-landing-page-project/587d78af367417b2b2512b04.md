...
**Lengo:** Jenga programu inayofanana kiutendaji na <a href="https://product-landing-page.freecodecamp.rocks" target="_blank" rel="noopener noreferrer nofollow">https://product-landing-page.freecodecamp.rocks</a>. **Usikopi mradi huu wa maonyesho**.

**Hadithi za mtumizi:**

1. Ukurasa wako wa kutua wa bidhaa unapaswa kuwa na kipengele cha `header` chenye `id="header"` kinacholingana
1. Unaweza kuona picha ndani ya kipengele cha `header` chenye `id="header-img"` kinacholingana (Nembo itakuwa picha nzuri hapa)
1. Ndani ya kipengele cha `#header`, unaweza kuona kipengele cha `nav` chenye `id="nav-bar"` kinacholingana
1. Unaweza kuona angalau vipengele vitatu vinavyoweza kubofywa ndani ya kipengele cha `nav`, kila kikiwa na darasa la `nav-link`
1. Unapobofya kitufe cha `.nav-link` kilicho ndani ya kipengele cha `nav`, unapelekwa kwenye sehemu inayolingana ya ukurasa wa kutua
1. Unaweza kutazama video ya bidhaa iliyojumuishwa na `id="video"`
1. Ukurasa wako wa kutua una kipengele cha `form` chenye `id="form"` kinacholingana
1. Ndani ya fomu, kuna sehemu ya ingizo ya `input` yenye `id="email"` ambapo unaweza kuingiza anwani ya barua pepe
1. Sehemu ya ingizo ya `#email` inapaswa kuwa na maandishi ya kiwakilishi ili kuwajulisha watumizi ni kwa ajili gani sehemu hiyo
1. Sehemu ya ingizo ya `#email` inatumia uthibitisho wa HTML5 kuthibitisha kuwa maandishi yaliyoingizwa ni anwani ya barua pepe
1. Ndani ya fomu, kuna kitufe cha kuwasilisha cha `input` chenye `id="submit"` kinacholingana
1. Unapobofya kipengele cha `#submit`, barua pepe inawasilishwa kwenye ukurasa wa statiki (tumia URL hii ya mfano: `https://www.freecodecamp.com/email-submit`)
1. Navbar inapaswa kuwa kila wakati juu ya eneo la kuona
1. Ukurasa wako wa kutua wa bidhaa unapaswa kuwa na angalau media query moja
1. Ukurasa wako wa kutua wa bidhaa unapaswa kutumia CSS flexbox angalau mara moja

Kamilisha hadithi za mtumizi na pita vipimo vyote hapa chini ili kumaliza mradi huu. Toa mtindo wako binafsi. Kodingi yenye furaha!
