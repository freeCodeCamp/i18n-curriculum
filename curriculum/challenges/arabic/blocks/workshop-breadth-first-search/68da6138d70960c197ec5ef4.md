...
أصبحت دالتك مكتملة الآن. اختبرها مرة أخرى بطباعة `gen_parentheses(2)` بدلًا من `gen_parentheses(1)`.

# --hints--

يجب أن تطبع `gen_parentheses(2)`.
...
يجب ألا تحتوي شفرتك على `print(gen_parentheses(1))`.
