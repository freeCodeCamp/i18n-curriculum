...
Cuando se llama a `create_character` con un primer argumento que es una cadena, no debe devolver `The character name should be a string`.
...
Cuando `create_character` se llama con un primer argumento que es una cadena vacía, debería devolver `The character should have a name`.
...
Cuando se llama a `create_character` con un primer argumento que no es una cadena vacía, no debe devolver `The character should have a name`.
...
La función `create_character` no debería decir que el carácter es demasiado largo cuando no tiene más de 10 caracteres.
...
Cuando se llama a `create_character` con un primer argumento que no contiene un espacio, no debe devolver `The character name should not contain spaces`.
...
Cuando `create_character` se llama con un segundo, tercer y cuarto argumento que son todos enteros, no debe devolver `All stats should be integers`.
...
Cuando se llama a `create_character` con un segundo, tercer y cuarto argumento que no sean menores que `1`, no debe devolver `All stats should be no less than 1`.
...
Cuando se llama a `create_character` con un segundo, tercer y cuarto argumento que no sean mayores que `4`, no debe devolver `All stats should be no more than 4`.
...
Cuando se llama a `create_character` con un segundo, tercer y cuarto argumento que suman `7` no debe devolver `The character should start with 7 points`.
