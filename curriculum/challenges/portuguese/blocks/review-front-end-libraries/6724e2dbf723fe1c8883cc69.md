...
- **Categorias de Ferramentas de Teste de Segurança**:
  ...
  - **Teste Dinâmico de Segurança de Aplicação**: Essas ferramentas interagem com o front-end da aplicação para descobrir possíveis vulnerabilidades de segurança. Ferramentas DAST não têm acesso ao `source code`.
...
Revise os tópicos e conceitos de Front-End Libraries.
