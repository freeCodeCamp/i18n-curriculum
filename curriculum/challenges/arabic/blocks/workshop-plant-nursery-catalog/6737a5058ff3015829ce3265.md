...
لإضافة عناصر إلى مجموعة، يمكنك استخدام الطريقة `add`. تأخذ معلمة وتضيفها إلى المجموعة فقط إذا لم يكن ذلك العنصر موجودًا بالفعل.

داخل دالتك `displayPlantsSet`، استخدم الطريقة `add` لإضافة الكائن `ballerina` إلى مجموعتك قبل إرجاعها.

# --hints--

يجب أن تُرجع دالتك `displayPlantsSet` كائن `Set` يحتوي على الكائن `ballerina`.
