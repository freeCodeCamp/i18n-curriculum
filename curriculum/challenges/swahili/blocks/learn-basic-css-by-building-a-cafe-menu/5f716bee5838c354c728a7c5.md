...
Chini ya kitindamlo ulichokiweka tu, ongeza vitindamlo vingine vyote na bei kwa kutumia vipengele vitatu zaidi vya `article`, kila kikiwa na vipengele viwili vilivyopangwa ndani vya `p`. Kila kipengele kinapaswa kuwa na maandishi sahihi ya kitindamlo na bei, na vyote viwe na madarasa sahihi.
...
Unapaswa kuwa na vipengele vipya vinne vya `.price`.
...
Kipengele chako cha `section` kinapaswa kuwa na vipengele nane vya `p`.
...
Vipengele vyako vya `.dessert` vinapaswa kuwa na maandishi ya `Donut`, `Cherry Pie`, `Cheesecake`, na `Cinnamon Roll`.
...
Vipengele vipya vya `.price` vinapaswa kuwa na maandishi ya `1.50`, `2.75`, `3.00`, na `2.50`.
...
Hupaswi kuwa na nafasi yoyote kati ya vipengele vyako vya `p`.
