...
Você deve dar a `.fb5` um segundo `repeating-linear-gradient` na propriedade `background`.
...
Você deve dar o segundo `repeating-linear-gradient` uma direção de `90deg`.
...
Você deve dar ao segundo `repeating-linear-gradient` uma cor de inicial de `--building-color2` de `0%` a `12%`.
...
Você deve dar ao segundo `repeating-linear-gradient` uma segunda cor de `--window-color2` de `12%` a `44%`.
