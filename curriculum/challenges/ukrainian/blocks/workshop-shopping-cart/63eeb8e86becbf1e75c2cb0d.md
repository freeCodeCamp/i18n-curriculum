...
Тепер вам потрібен загальний підрахунок кожного продукту, який користувач має у кошику. Оголосіть змінну `totalCountPerProduct` і призначте їй порожній об’єкт.
