...
`Though` is an expression you use to show contrast between two sentences, similar to `but`. It can also be used in the middle or in the end of a sentence, not only in the beginning. Наприклад:

`I know we wanted to travel. We don't have the money for the tickets, though.`

`I suppose` is used to express a mild assumption or agreement. Наприклад:
