...
Debes dar al cuarto `input` un atributo `name` que coincida con el atributo `name` del tercer `input`.
...
Debes dar diferentes atributos `name` al primer `input` y tercer `input`.
