...
La siguiente tarjeta de precios es el **Plan Premium**.

Dale al `div` contenedor del plan premium las clases `bg-gray-950`, `text-white`, `ring-2`, `ring-fuchsia-500` y `p-8`.

# --hints--

Tu elemento `div` contenedor para el plan premium debe tener la clase `bg-gray-950`.
...
Tu elemento `div` contenedor para el plan premium debe tener la clase `text-white`.
...
Tu elemento `div` contenedor para el plan premium debe tener la clase `ring-2`.
...
Tu elemento `div` contenedor para el plan premium debe tener la clase `ring-fuchsia-500`.
...
El elemento `div` contenedor para el plan premium debe tener la clase `p-8`.
