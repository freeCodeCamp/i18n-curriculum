...
`To investigate` significa esaminare attentamente qualcosa, e `to be related to` significa essere collegato o associato a qualcosa. Per esempio:
...
Significa esaminare o analizzare qualcosa in dettaglio. Questo verbo termina con `-ing`
...
Significa avere una connessione o associazione con qualcosa.
