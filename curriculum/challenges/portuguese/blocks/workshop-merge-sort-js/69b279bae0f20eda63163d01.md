...
Depois de imprimir a string, registre o próprio array `numbers` para que a lista não ordenada apareça em seguida.

# --hints--

Você deve chamar `console.log(numbers);` após a mensagem `'Unsorted array: '`.
