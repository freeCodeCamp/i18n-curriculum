...
Hier ist ein Beispiel für ein `input`-Element mit einem Platzhalter auf `Ex. Jane Doe` gesetzt haben:
...
Your `input` element does not have a `placeholder` attribute. Überprüfe, ob nach dem Namen des öffnenden Tags ein Leerzeichen steht und/oder ob vor allen Attributnamen Leerzeichen stehen.
