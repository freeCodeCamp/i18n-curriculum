...
Present continuous is used for actions happening at the moment of speaking. 例えば、次のように記述できます。
...
Present continuous can be used in negative forms to express that something is not happening. 例えば、次のようになります。
