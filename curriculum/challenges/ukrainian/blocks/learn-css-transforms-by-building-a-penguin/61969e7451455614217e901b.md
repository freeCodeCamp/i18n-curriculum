...
Щоб гора виглядала більше як гора, ви можете використати функцію трансформації `skew`, яка приймає два аргументи. Перший — це кут для зсуву по осі x, а другий — кут для зсуву по осі y.

Використайте властивість `transform`, щоб нахилити гору на `0deg` по осі x і на `44deg` по осі y.
...
Ви повинні використати функцію `skew` на `transform`.
