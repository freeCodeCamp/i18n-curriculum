...
Richten Sie nun den Text für die Elemente mit der `right`-Klasse am `price` aus.

# --hints--

Sie sollten einen `price`-Klassen-Selektor haben.
...
Ihr `price`-Klassen-Selektor sollte die `text-align`-Eigenschaft auf `right` setzen.
