...
Вам потрібно повторно відтворити пісні, виділити їх і встановити доступний текст кнопки відтворення, оскільки список пісень зміниться.

Викличте функцію `renderSongs` і передайте масив `userData?.songs` як аргумент, це відобразить змінений плейлист.

Після цього викличте функцію `highlightCurrentSong`, щоб виділити поточну пісню, якщо вона є, а також функцію `setPlayButtonAccessibleText`, щоб оновити доступний текст кнопки відтворення.

# --hints--

Ви не повинні змінювати існуючу функцію `deleteSong` та її вміст.
...
Ви повинні викликати функцію `renderSongs` з `userData?.songs`.
