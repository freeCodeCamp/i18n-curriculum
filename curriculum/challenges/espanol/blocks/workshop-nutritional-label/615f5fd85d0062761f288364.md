...
Dale a tu selector `.calories-info span` un `margin` con un conjunto de `-7px -2px`. Esto desplazará el texto `230` a su lugar.

# --hints--

Tu selector `.calories-info span` debe tener un `margin` con un conjunto de `-7px -2px`.
