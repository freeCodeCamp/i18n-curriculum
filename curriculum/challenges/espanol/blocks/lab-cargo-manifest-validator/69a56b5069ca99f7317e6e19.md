...
Llamar a `validateManifest()` con `{ containerId: null, destination: "Santa Cruz", weight: 304, unit: "kg", hazmat: false }` debe devolver el nuevo objeto `{ containerId: "Invalid" }` sin modificar la entrada original.
