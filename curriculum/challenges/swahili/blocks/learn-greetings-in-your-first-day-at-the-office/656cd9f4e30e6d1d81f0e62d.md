...
Kitenzi `to be` kina aina tofauti kulingana na mhusika. Kwa mtu wa tatu wa umoja (`he`, `she`, `it`), aina sahihi ni `is`.
...
Hii ni aina ya kitenzi `to be`, kinachotumika na `he`, `she`, au `it`.
