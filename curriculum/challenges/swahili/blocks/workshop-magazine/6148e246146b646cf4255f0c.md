...
Unda kichaguzi cha `.list-title, .list-subtitle` na weka sifa ya `color` kuwa `#00beef`.
...
Kichaguzi chako cha `.list-title, .list-subtitle` kinapaswa kuwa na sifa ya `color` iliyowekwa kuwa `#00beef`.
