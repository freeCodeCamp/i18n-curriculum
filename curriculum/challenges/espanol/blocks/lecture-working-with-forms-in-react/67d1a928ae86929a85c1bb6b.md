...
En React, los formularios se gestionan usando state o refs, dándote control total sobre su comportamiento y validación. Estas dos formas de gestionar formularios se llaman entrada "controlada" y "no controlada".
...
Entonces, ¿cuál deberías usar entre inputs controlados y no controlados? 
