...
أنشئ متغيرًا جديدًا باسم `--window-color4` في `:root` وأعطه قيمة `#8cb3d9`. سيكون هذا اللون الثانوي للمبنى الخلفي الأخير.

# --hints--

يجب تعريف متغير الخاصية الجديد `--window-color4`.

```js
assert(new __helpers.CSSHelp(document).isPropertyUsed("--window-color4"));
```

يجب إعطاء `--window-color4` قيمة `#8cb3d9`.
