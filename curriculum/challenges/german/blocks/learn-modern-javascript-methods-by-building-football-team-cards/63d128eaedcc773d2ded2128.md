...
Unter diesem Objekt erstellen Sie ein neues Objekt mit den folgenden Eigenschaften:
...
Ihr `myFavoriteFootballTeam.players` Array sollte zwei Werte enthalten.
...
Ihr `myFavoriteFootballTeam.players` Array sollte als zweiten Wert ein Objekt enthalten.
...
Ihre `name` Eigenschaft sollte auf `"Sergio Batista"` gesetzt sein.
...
Ihre `position` Eigenschaft sollte auf `"midfielder"` gesetzt sein.
...
Ihre `number` Eigenschaft sollte auf `2` gesetzt sein.
