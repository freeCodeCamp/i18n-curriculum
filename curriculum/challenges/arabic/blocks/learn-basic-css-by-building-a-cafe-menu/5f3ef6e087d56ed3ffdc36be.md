...
الآن طبّق الصنف `established` على النص `Est. 2020`.
...
يجب أن يكون الصنف `established` على العنصر الذي يحتوي على النص `Est. 2020`.

```js
assert.match(document.querySelector('.established')?.innerText, /Est\.\s2020/i);
```

يجب أن يحتوي عنصر الصنف `established` على نص مائل.
