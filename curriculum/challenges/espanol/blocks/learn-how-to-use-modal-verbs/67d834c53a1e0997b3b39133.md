...
This three-word phrase expresses strong certainty about something based on evidence or logic. La primer letra se escribe en mayúscula.

# --explanation--

`There must be...` is used when someone is sure about something based on the situation. Por ejemplo:
