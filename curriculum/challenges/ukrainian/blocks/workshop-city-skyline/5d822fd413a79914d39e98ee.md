...
Ваш код починає ставати досить довгим. Додайте коментар над класом `.fb1`, який каже `FOREGROUND BUILDINGS - "fb" stands for "foreground building"`, щоб допомогти людям зрозуміти ваш код. Над класом `.bb1` додайте ще один коментар, який каже `BACKGROUND BUILDINGS - "bb" stands for "background building"`. Якщо ви не пам’ятаєте, коментарі в CSS виглядають так: `/* Comment here */`.
