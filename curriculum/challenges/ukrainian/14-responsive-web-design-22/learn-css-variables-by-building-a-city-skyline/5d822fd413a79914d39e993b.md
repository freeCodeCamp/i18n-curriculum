...
Скопіюйте та вставте весь клас `sky` разом з усіма його властивостями і значеннями в медіазапит. Ви створите іншу колірну схему для панорами, яка змінює день на ніч.

Примітка: потрібно буде прокрутити повз область, яку можна редагувати, щоб скопіювати клас.

# --hints--

Ви не повинні видаляти наявну декларацію `.sky`.
...
Ви повинні скопіювати наявне оголошення `.sky` в медіазапит.
