...
title: "Sfida 356: risolutore di quadrati magici"
challengeType: 29
...
Data una griglia 3x3 con un numero mancante (rappresentato come `0`), restituisci il numero mancante che completa il quadrato magico, oppure `"impossible"` se non esiste un numero valido.

Un quadrato magico è una griglia in cui ogni riga, colonna e diagonale somma allo stesso numero.

# --hints--

`solve_magic_square([[2, 7, 6], [9, 0, 1], [4, 3, 8]])` dovrebbe restituire `5`.
...
`solve_magic_square([[0, 14, 12], [18, 10, 2], [8, 6, 16]])` dovrebbe restituire `4`.
...
`solve_magic_square([[12, 17, 16], [19, 0, 10], [14, 13, 18]])` dovrebbe restituire `"impossible"`.
...
`solve_magic_square([[15, 35, 31], [43, 27, 11], [23, 19, 0]])` dovrebbe restituire `39`.
...
`solve_magic_square([[26, 41, 14], [47, 35, 0], [32, 29, 44]])` dovrebbe restituire `"impossible"`.
