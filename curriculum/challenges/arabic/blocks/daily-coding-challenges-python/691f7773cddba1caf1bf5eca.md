...
معطاة مصفوفة من الأعداد الصحيحة ورقم هدف، ابحث عن كل أزواج العناصر في المصفوفة التي يكون مجموع قيمها مساويًا للهدف وأرجع مجموع مؤشرات هذه الأزواج.

على سبيل المثال، معطاة `[2, 3, 4, 6, 8]` و `10`، ستجد زوجين صالحين:

- `2` و `8` (2 + 8 = 10)، مؤشراتهما `0` و `4`
- `4` و `6` (4 + 6 = 10)، مؤشراتهما `2` و `3`
