...
`Tempting` ni kivumishi kinachoelezea kitu kinachoonekana au kusikika vizuri sana, kinachokufanya utake kufanya au kuwa nacho. Kwa mfano:

`The idea of sleeping in is tempting.` - Hapa, `tempting` inamaanisha wazo la kubaki kitandani kwa muda mrefu ni la kuvutia sana au gumu kuepuka.
...
Kivumishi hiki kinaelezea kitu kinachovutia au kuvutia, katika kesi hii, kubofya kitufe cha kuahirisha kengele. 
