...
Kwa sehemu ya mwisho ya warsha, kuna mabadiliko machache yanayohitajika kwa sehemu ya mawasiliano katika kijachini.

Mabadiliko ya kwanza yatakuwa kuzungusha sehemu ya mawasiliano ndani ya kipengele cha `footer`. Hii itasaidia kisomaji cha skrini kutambua sehemu hii kama kijachini cha ukurasa.

# --hints--

Ukurasa wako unapaswa kuwa na kipengele cha `footer`.
...
Kipengele chako cha `footer` kinapaswa kuwa na kipengele cha `h3` chenye maandishi ya `Contact Me`.
...
Kipengele chako cha `footer` kinapaswa kuwa na kipengele cha `p` chenye maandishi ya `Email me at camperbot@blog.io`.
