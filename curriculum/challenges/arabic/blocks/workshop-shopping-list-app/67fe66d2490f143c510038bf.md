...
بعد ذلك، في عنصر `input` الخاص بمربع الاختيار، أضف خاصية `checked` واضبطها على `isChecked`. رغم أنه ليس من الضروري تمامًا ضبط خاصية `checked`، إلا أن هذه ممارسة جيدة لضمان أن يعكس كل مربع اختيار الحالة الحالية لمصفوفة `selectedItems`.

# --hints--

يجب إضافة خاصية `checked` إلى عنصر `input` الخاص بمربع الاختيار.
...
يجب ضبط خاصية `checked` على `isChecked`.
