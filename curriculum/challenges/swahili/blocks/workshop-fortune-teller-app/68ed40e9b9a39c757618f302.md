...
Sasa unahitaji darasa kuu litakalosaidia kuonyesha UI kwa njia ya mabadiliko katika DOM.

Tengeneza darasa lenye jina `Game`. Ndani yake, ongeza sifa iitwayo `cards` ya aina ya `Card[]`, na kwa sasa, ianze na safu ya data tupu.

# --hints--

Unapaswa kuwa na darasa lenye jina `Game`.
...
Unapaswa kuwa na sifa ya `cards` ndani ya darasa la `Game`.
...
Sifa yako ya `cards` inapaswa kuwa na aina ya `Card[]`.
...
Sifa yako ya cards inapaswa kuwekwa kuwa safu ya data tupu `array`.
