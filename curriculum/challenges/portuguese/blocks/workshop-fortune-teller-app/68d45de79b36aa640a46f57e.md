...
Você precisa de outra interface chamada `Deck`. Essa interface deve ter uma propriedade `cards`, que é um array da interface anterior.

# --hints--

Você deve declarar uma interface chamada `Deck`.
...
Sua interface `Deck` deve ter uma propriedade `cards` do tipo `Card[]`.
