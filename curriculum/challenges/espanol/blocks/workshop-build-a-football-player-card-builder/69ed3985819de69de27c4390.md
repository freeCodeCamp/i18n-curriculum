...
Ahora actualiza `FootballPlayerCard` para pasar `defaultPlayer` a `PlayerCard` en lugar del objeto inline.

# --hints--

Deberías tener `defaultPlayer` como el valor de la prop `player` pasada a `PlayerCard`.
