...
Sasa umeongeza neno kuu la `!important`, unaweza kuondoa `:not(.sr-only)` kutoka kwa kichaguzi chako cha `span`.

# --hints--

Haupaswi kuwa na kichaguzi cha `span:not(.sr-only)`.
...
Haupaswi kubadilisha `font-weight`.
