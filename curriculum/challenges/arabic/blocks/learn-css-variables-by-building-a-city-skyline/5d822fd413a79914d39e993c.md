...
في صنف `sky` من استعلام الوسائط، غيّر قيمتي اللون `#ffcf33` إلى `#ccc`، واللون `#ffff66` إلى `#445`، واللون `#bbeeff` إلى `#223`. بعد ذلك يمكنك تغيير حجم النافذة لترى تغير ألوان الخلفية.
