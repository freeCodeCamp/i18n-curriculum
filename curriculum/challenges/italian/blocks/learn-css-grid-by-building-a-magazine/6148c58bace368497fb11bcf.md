...
Proprio come con Flexbox, con CSS Grid puoi allineare il contenuto degli elementi griglia con `align-items` e `justify-items`. `align-items` allineerà gli elementi figli lungo l'asse delle colonne, e `justify-items` allineerà gli elementi figli lungo l'asse delle righe.
