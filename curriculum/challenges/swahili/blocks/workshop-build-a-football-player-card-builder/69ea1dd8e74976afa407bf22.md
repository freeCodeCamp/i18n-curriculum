...
Ifuatayo, tengeneza aina `Position` yenye thamani `typeof POSITIONS[number]`. Hii itafungua safu ya data ya `POSITIONS` kuwa muungano wa mfuatano wake wa herufi binafsi, na kufanya ionekane kama `"GK" | "CB" | "LB" | ...` na kadhalika.

# --hints--

Unapaswa kutengeneza jina la aina linaloitwa `Position`.
...
Aina yako ya `Position` inapaswa kuwekwa kuwa `typeof POSITIONS[number]`.
