...
Gib den `label`-Elementen Text, und zwar so, dass der `input` vor dem Text steht. Weise den `input`-Elementen anschließend eine, dem Text entsprechende, `value` zu.
...
Du solltest dem ersten `input` eine `value` geben, die mit dem `label`-Textinhalt übereinstimmt.
...
Du solltest dem zweiten `input` eine `value` geben, die mit dem `label`-Textinhalt übereinstimmt.
...
Du solltest dem dritten `input` eine `value` geben, die mit dem `label`-Textinhalt übereinstimmt.
...
Du solltest dem vierten `input` eine `value` geben, die mit dem `label`-Textinhalt übereinstimmt.
