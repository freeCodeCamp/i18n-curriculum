...
Gib dem `.quote`-Selektor eine `font-family`-Eigenschaft mit dem Wert `Raleway` mit einem Fallback von `sans-serif`, um den Zitattext hervorheben zu können.

# --hints--

Dein `.quote`-Selektor sollte eine `font-family`-Eigenschaft mit dem Wert `Raleway` mit einem Fallback von `sans-serif` haben.
