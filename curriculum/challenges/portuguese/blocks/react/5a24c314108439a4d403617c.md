...
**Nota:** O método de ciclo de vida `componentWillMount` será descontinuado em uma versão futura do 16.X e removido na versão 17. Saiba mais neste <a href="https://www.freecodecamp.org/news/how-to-safely-use-reacts-life-cycles-with-fiber-s-async-rendering-fd4469ebbd8f/" target="_blank" rel="noopener noreferrer nofollow">artigo</a>
