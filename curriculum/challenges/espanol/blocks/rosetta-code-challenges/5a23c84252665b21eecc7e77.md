...
Escribe una función para resolver \(Ax = b\) usando eliminación gaussiana y luego sustitución hacia atrás.

\(A\) siendo una matriz de \(n \times n\). Además, \(x\) y \(b\) son vectores de \(n\) por 1.
