...
In the previous lecture, you learned about the <dfn>Web Audio API</dfn> and how to use it to play songs. 所有現代瀏覽器都支持 Web Audio API，它允許你在 Web 應用程序中生成和處理音頻。

Create a variable named `audio` and set it equal to `new Audio()`. 這將創建一個新的 HTML5 `audio` 元素。
