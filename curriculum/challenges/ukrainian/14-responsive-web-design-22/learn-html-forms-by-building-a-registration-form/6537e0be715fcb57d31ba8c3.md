...
Вкінці змініть колір тексту елемента посилання `terms and conditions` на `#dfdfe2`, додавши новий селектор до CSS.

Хороша робота! Ви завершили останню частину практичного проєкту _«Реєстраційна форма»_.
