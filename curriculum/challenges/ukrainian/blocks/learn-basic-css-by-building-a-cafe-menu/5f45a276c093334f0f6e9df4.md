...
Зосередьтеся на пунктах меню та цінах, між кожною лінією є досить великий горизонтальний розрив.

Використайте існуючий селектор, який націлюється на всі `p` елементи, вкладені в елементи з класом `item`, і встановіть для них верхнє та нижнє поле рівним `5px`.
...
Ваші `p` елементи, вкладені у `.item` елементи, повинні мати поле `margin-top` рівне `5px`.
...
Ваші `p` елементи, вкладені у `.item` елементи, повинні мати поле `margin-bottom` рівне `5px`.
...
Ваші `p` елементи, вкладені у `.item` елементи, не повинні мати встановленого поля `margin-left`.
...
Ваші `p` елементи, вкладені у `.item` елементи, не повинні мати встановленого поля `margin-right`.
