...
Sempre all'interno del blocco `else`, incrementa `rightArrayIndex` di `1`.

# --hints--

Dovresti incrementare `rightArrayIndex` dopo aver inserito l'elemento nell'array ordinato.
