...
title: 'Problema 57: convergenti della radice quadrata'
challengeType: 1
forumTopicId: 302168
...
Le tre espansioni successive sono $\\frac {99}{70}$, $\\frac {239}{169}$ e $\\frac {577}{408}$, ma l'ottava espansione, $\\frac {1393}{985}$, è il primo esempio in cui il numero di cifre del numeratore supera quello del denominatore.

Nelle prime `n` espansioni, quante frazioni hanno un numeratore con più cifre del denominatore?
