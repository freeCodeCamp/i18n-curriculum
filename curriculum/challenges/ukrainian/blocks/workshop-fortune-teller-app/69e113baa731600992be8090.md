...
Надано зображення за замовчуванням для картки та URL для виконання API-запиту, вам залишилось лише створити кілька змінних, щоб зберегти їх.

Створіть змінну `CDN_URL` і встановіть її в `https://cdn.freecodecamp.org/curriculum/typescript/tarot-app`. Також створіть змінну `defaultImg` зі значенням `new URL("default.svg", CDN_URL + "/")` та змінну `LOCAL_DEFAULT_IMG` зі значенням `defaultImg`.

# --hints--

Ви маєте створити змінну з іменем `CDN_URL`.
...
Значення вашої змінної `CDN_URL` має бути `"https://cdn.freecodecamp.org/curriculum/typescript/tarot-app"`.
...
Ви маєте створити змінну з іменем `defaultImg`.
...
Значення змінної `defaultImg` має бути встановлене як `new URL("default.svg", CDN_URL + "/")`.
...
Ви маєте створити змінну з іменем `LOCAL_DEFAULT_IMG`.
...
Значення вашої змінної `LOCAL_DEFAULT_IMG` має бути `defaultImg`.
