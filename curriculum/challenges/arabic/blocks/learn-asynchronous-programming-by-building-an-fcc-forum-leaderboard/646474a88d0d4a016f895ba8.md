...
في الخطوات المتبقية، ستضيف الوظيفة لعرض الصور الرمزية للمستخدمين.

داخل العنصر الثاني `td`، أضف عنصر `div` باسم صنف `"avatar-container"`.

# --hints--

يجب أن يكون لديك عنصر `div` داخل العنصر الثاني `td`.
...
يجب أن يحتوي وسم الفتح لعنصر `div` على خاصية صنف بقيمة `"avatar-container"`.
