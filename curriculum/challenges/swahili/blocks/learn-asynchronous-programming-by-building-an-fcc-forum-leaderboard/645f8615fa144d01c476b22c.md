...
Mwishowe, utahitaji kurudisha picha ya avatar ya mtumizi.

Anza kwa kuongeza `return` ikifuatiwa na seti ya herufi za kiolezo. Ndani ya herufi za kiolezo, ongeza kipengele cha `img`.

Ndani ya lebo la `img`, ongeza sifa ya kipengele ya `src` yenye thamani ya `${userAvatarUrl}`. Kwa sifa ya kipengele ya `alt`, ongeza thamani ya `${user.name}`.
...
Unapaswa kurudisha herufi za kiolezo.
...
Unapaswa kuwa na kipengele cha `img` ndani ya herufi za kiolezo.
...
Unapaswa kuwa na sifa ya kipengele ya `src` ndani ya lebo la `img`.
...
Unapaswa kuweka thamani ya sifa ya kipengele ya `src` kuwa ile ya thabiti iitwayo `userAvatarUrl`.
...
Unapaswa kuwa na sifa ya kipengele ya `alt` baada ya sifa ya kipengele ya `src`.
...
Unapaswa kuweka thamani ya sifa ya kipengele ya `alt` kuwa ile ya thabiti iitwayo `user.name`.
