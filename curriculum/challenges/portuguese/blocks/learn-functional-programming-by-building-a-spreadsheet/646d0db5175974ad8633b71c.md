...
As funções internas também podem retornar uma função.Usando a mesma sintaxe das arrow functions, atualize a função `addCharacters` para que retorne uma terceira função que receba um parâmetro `num`.

# --hints--

A arrow function interna deve retornar outra arrow function com o parâmetro `num`.
...
A arrow function mais interna deve estar vazia.
