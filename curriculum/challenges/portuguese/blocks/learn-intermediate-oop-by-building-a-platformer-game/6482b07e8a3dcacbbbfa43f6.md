...
Você deve usar a palavra-chave `let` para declarar sua variável `isCheckpointCollisionDetectionActive`.
...
Você deve atribuir o valor `true` a `isCheckpointCollisionDetectionActive` 
