...
في هذه المرحلة، العناصر متقاربة جدًا من بعضها. أضف `gap-8` لخلق بعض الفراغ بينها، واستخدم `mt-16` لدفعها للأسفل قليلًا من الأعلى.

# --hints--

يجب أن يحتوي عنصر `div` على الصنف `gap-8`.
...
يجب أن يحتوي عنصر `div` على الصنف `mt-16`.
