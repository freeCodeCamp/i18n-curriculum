...
Після `form-row` додайте `div` з атрибутом `className` зі значенням `form-group`. Всередині нього додайте елемент `label` з атрибутом `className` зі значенням `label`, атрибутом `htmlFor` зі значенням `club` та текстом `Club`. Потім додайте елемент input з атрибутом `id` зі значенням `club`, атрибутом `className` зі значенням `input` та атрибутом `type` зі значенням `text`.
...
Ваш `div.form-group` має містити `label` з атрибутом `htmlFor` зі значенням `club`, `className` `label` і текстом `Club`.
...
Ваш Club `form-group` має містити `input` з `id` `club`, `className` `input` і `type` `text`.
