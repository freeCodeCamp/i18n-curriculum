...
Prima di iniziare ad aggiungere la funzionalità di filtro alla tua pagina, collega il tuo file `script.js` all'HTML.

# --hints--

Dovresti avere un elemento `script` con l'attributo `src` impostato su `script.js`.
