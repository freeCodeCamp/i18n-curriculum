...
يجب توسيع المسافة بين علامات عناصر القائمة قليلاً. لذا، أضف إلى كل `span` في عناصر القائمة الصنفين `text-green-700` و `mr-2`.

أيضًا، أضف الخاصية `aria-hidden` إلى كل عنصر من عناصر `span`.

# --hints--

يجب أن تحتوي عناصر `span` على الصنف `text-green-700`.
