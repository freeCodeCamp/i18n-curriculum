...
Aggiungi una proprietà `transition` al selettore `.card-links a` e impostala con il valore `background-color 0.3s ease`.

# --hints--

Il selettore `.card-links a` dovrebbe avere una proprietà `transition` impostata su `background-color 0.3s ease`.
