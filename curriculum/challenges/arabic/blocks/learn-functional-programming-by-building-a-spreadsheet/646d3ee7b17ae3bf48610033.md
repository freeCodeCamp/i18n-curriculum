...
تعيد `infixToFunction[operator]` دالة. استدعِ تلك الدالة مباشرة، مرر `arg1` و `arg2` كالمعلمات.

# --hints--

يجب أن تُرجع دالة الاستدعاء الراجع نتيجة استدعاء `infixToFunction[operator]`.
...
يجب أن تمرر `arg1` كالمعلمة الأولى لاستدعاء `infixToFunction[operator]`.
...
يجب أن تمرر `arg2` كالمعلمة الثانية لاستدعاء `infixToFunction[operator]`.
