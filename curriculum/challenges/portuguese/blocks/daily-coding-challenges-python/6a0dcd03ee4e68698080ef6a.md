...
title: "Desafio 306: extrator de conteúdo HTML"
challengeType: 29
...
Dada uma string de HTML, retorne o conteúdo de texto simples com todas as tags removidas.

# --hints--

`extract_content('<p>hello world</p>')` deve retornar `"hello world"`.
...
`extract_content('<p>hello <span>world</span></p>')` deve retornar `"hello world"`.
...
`extract_content('<a href="example.com">Click me</a>')` deve retornar `"Click me"`.
...
`extract_content('<p><button onClick="learnToCode()">Learn</button> to <code>code<code> <br/>for <strong>free</strong> <br/>on <a href="https://freecodecamp.org/" target="_blank"><span class="highlight">freecodecamp</span>.org</a>')` deve retornar `"Learn to code for free on freecodecamp.org"`.
