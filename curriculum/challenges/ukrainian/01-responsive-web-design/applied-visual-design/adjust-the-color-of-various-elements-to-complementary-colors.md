...
title: Змініть колір різних елементів на доповнюючі кольори
challengeType: 0
...
Згідно з завданням про доповнюючі кольори, якщо розташувати їх один біля одного, вони будуть насиченішими. Проте, використання насиченого візуала на сайті може викликати роздратування і ускладнити читання, особливо якщо фон доповнюючого кольору. In practice, one of the colors is usually dominant and the complement is used to bring visual attention to certain content on the page.
