...
Створіть селектор `body`. Встановіть властивість `font-family` у значення `Baskervville` із запасним варіантом `serif`. Встановіть властивість `color` у `linen` та властивість `background-color` у `rgb(20, 30, 40)`.
