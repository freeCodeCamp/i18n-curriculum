...
За тим самим шаблоном зробіть запит для своїх `number` в `#dinner`, `#snacks` та `#exercise` елементах. Призначте їх змінним, дотримуючись схеми іменування з попередніх двох.
