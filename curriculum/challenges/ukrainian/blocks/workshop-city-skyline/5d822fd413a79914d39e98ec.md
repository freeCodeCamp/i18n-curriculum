...
Знову стисніть будівлі, додавши два порожні елементи `div` у верхній і нижній частинах елемента `.foreground-buildings`, а також ще один між `.fb2` і `.fb3`.

# --hints--

Ви повинні додати два елементи `div` як перші дочірні елементи `.foreground-buildings`.
...
Ви повинні додати один елемент `div` між `.fb2` і `.fb3`.
...
Ви повинні були додати 5 нових елементів `div`.
