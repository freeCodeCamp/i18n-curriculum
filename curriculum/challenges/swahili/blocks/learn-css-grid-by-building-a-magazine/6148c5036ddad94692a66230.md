...
Sasa algoriti ya upangaji kiotomatiki itaanza kufanya kazi unapoongeza kipengele kipya cha ikoni. Hata hivyo, algoriti hii huweka upana wa safu mpya kuwa `auto`, ambayo haitalingana na safu zako za sasa.

Unaweza kughairi hili kwa kutumia sifa ya `grid-auto-columns`. Mpe kichaguzi cha `.social-icons` sifa ya `grid-auto-columns` iliyowekwa kuwa `1fr`.

# --hints--

Kichaguzi chako cha `.social-icons` kinapaswa kuwa na sifa ya `grid-auto-columns` iliyowekwa kuwa `1fr`.
