...
Далі створіть тип `Position` зі значенням `typeof POSITIONS[number]`. Це розпаковує масив `POSITIONS` у множину його окремих рядкових літералів, фактично роблячи його схожим на `"GK" | "CB" | "LB" | ...` і так далі.

# --hints--

Ви маєте створити псевдонім типу з назвою `Position`.
...
Ваш тип `Position` має бути встановлений у `typeof POSITIONS[number]`.
