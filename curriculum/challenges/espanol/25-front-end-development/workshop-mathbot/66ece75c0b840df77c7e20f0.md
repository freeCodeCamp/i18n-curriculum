...
Para el último paso del taller, debe registrar el mensaje `"It was fun learning about the different Math methods with you!"` en la consola.

Y con ese último cambio, ¡ha completado el taller MathBot!

# --hints--

Deberías registrar el mensaje `"It was fun learning about the different Math methods with you!"` en la consola.
