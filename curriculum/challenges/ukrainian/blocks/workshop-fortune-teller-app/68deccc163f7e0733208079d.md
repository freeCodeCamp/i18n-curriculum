...
Далі потрібно створити функцію, яка приховує елементи з DOM. Оголосіть `hideElements` функцію, яка приймає `...elements` як параметр з типом `HTMLElement[]`.

Ця функція з CSS класом `hidden` буде використовуватися у всьому застосунку для перемикання видимості елементів інтерфейсу.

# --hints--

Ви повинні були оголосити функцію з ім’ям `hideElements`.
...
Ваша функція `hideElements` має мати параметр з ім’ям `...elements` і типом `HTMLElement[]`.
