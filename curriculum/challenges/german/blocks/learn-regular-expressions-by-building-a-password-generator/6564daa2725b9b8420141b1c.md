...
Wandeln Sie nun die vier Muster aus der `constraints`-Liste in Raw Strings um.

# --hints--

Sie sollten die vier Strings in der `constraints`-Liste in Raw Strings umwandeln.
