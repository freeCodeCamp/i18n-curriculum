...
اربط `.then()` أخرى بطريقة `.then()` الموجودة. هذه المرة، مرر `data` كمعلمة لدالة الاستدعاء الراجع. استخدم الأقواس المتعرجة في دالة الاستدعاء الراجع لأن لديك أكثر من تعبير واحد. داخل دالة الاستدعاء الراجع، سجّل `data` في وحدة التحكم لترى شكلها.
