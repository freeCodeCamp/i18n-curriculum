...
A saída está correta, `repr` está fornecendo a string necessária para instanciar os objetos.

Agora comente ambas as suas chamadas `print`.

# --hints--

Você deve comentar ambas as suas chamadas `print()`.
