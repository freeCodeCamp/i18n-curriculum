...
为数字 `417` 添加一个新的键，值为空对象。

在该对象中，添加一个属性，其键为 `category`，字符串值为 `"freeCodeCamp Support"`。 

在该属性下，添加另一个名为 `className` 的键，其字符串值为 `"support"`。

# --hints--

你的 `allCategories` 对象应该有一个 `417` 属性。
