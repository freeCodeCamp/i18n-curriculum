...
O elemento `path` precisa que sua forma seja definida.É aí que entra o atributo `d`.É usado para criar uma série de letras e números de comando que desenham uma forma. 
