...
Після вашого вкладеного `for` циклу ви знайшли найменше значення. Потрібно поміняти його місцями з поточним значенням.

Як ви робили у своєму сортуванні бульбашкою, використайте змінну `temp`, щоб зберегти значення за `array[i]`, а потім поміняйте місцями значення за `array[i]` і `array[minIndex]`.

# --hints--

Після вашого вкладеного `for` циклу слід оголосити змінну `temp`.
...
Ви повинні призначити `array[i]` змінній `temp`.
...
Ви повинні призначити `array[minIndex]` змінній `array[i]`.
...
Ви повинні призначити `temp` змінній `array[minIndex]`.
