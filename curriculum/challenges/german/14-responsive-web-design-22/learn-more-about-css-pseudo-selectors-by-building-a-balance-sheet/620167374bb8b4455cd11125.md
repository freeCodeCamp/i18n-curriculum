...
Du solltest einen `#years`-Selektor haben.

```js
assert(new __helpers.CSSHelp(document).getStyle('#years'));
```

Dein `#years`-Selektor sollte eine `display`-Eigenschaft auf `flex` gesetzt haben.

```js
assert(new __helpers.CSSHelp(document).getStyle('#years')?.getPropertyValue('display') === 'flex');
```

Dein `#years`-Selektor sollte eine `justify-content`-Eigenschaft auf `flex-end` gesetzt haben.

```js
assert(new __helpers.CSSHelp(document).getStyle('#years')?.getPropertyValue('justify-content') === 'flex-end');
```

Dein `#years`-Selektor sollte eine `position`-Eigenschaft auf `sticky` gesetzt haben.

```js
assert(new __helpers.CSSHelp(document).getStyle('#years')?.getPropertyValue('position') === 'sticky');
```

Dein `#years`-Selektor sollte eine `top`-Eigenschaft auf `0` gesetzt haben.
