...
Agora complete a classe `TVSeries` adicionando a docstring `Child class representing an entire TV series.`

# --hints--

Você deve adicionar a docstring `Child class representing an entire TV series.` à sua classe `TVSeries`.
