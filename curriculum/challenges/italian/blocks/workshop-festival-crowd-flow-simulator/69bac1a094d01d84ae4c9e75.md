...
Per tenere traccia di quale segno di graduazione viene elaborato durante la simulazione, crea una variabile chiamata `tickIndex` e assegnale un valore iniziale di `0`.

Questa variabile servirà per iterare su tutti i segni di graduazione nella tua simulazione e assicurarti che ogni porta venga elaborata nel corretto ordine.

# --hints--

Devi creare una variabile chiamata `tickIndex` e assegnarle un valore di `0`.
