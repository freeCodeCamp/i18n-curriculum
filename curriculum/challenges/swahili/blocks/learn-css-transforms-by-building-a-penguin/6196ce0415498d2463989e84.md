...
Ili kutoa athari ya mlolongo wa milima, ongeza mlima mwingine, kwa kuunda `div` mpya mara moja baada ya `.left-mountain`, na mpe `div` mpya `class` ya `back-mountain`.
...
Unapaswa kumpa `div` `class` ya `back-mountain`.
