...
Журнали часто використовують вирівняний текст у своєму надрукованому вмісті, щоб структурувати макет і контролювати потік вмісту. Хоча це добре працює у друкованій формі, вирівняний текст на вебсайтах може створювати проблеми з доступністю, наприклад, викликати труднощі для людей із дислексією.

Щоб ваш проєкт виглядав як надрукований журнал, надайте селектору `.text` властивість `text-align` зі значенням `justify`.

# --hints--

Ваш селектор `.text` повинен мати властивість `text-align` зі значенням `justify`.
