...
في الخطوة الأخيرة، تحتاج إلى جعل اللوحة مرئية عند النقر على التبويب المرتبط بها. ويمكنك فعل ذلك بضبط الخاصية `hidden` الخاصة بـ `panel` على `false`.

انقر على أي من التبويبات، ويجب أن ترى محتوى اللوحة المقابل معروضًا.

وبهذا التغيير الأخير، تكتمل ورشة العمل الخاصة بك!

# --hints--

عند نقر التبويب، يجب تعيين الخاصية `hidden` للوحة إلى `false`.
