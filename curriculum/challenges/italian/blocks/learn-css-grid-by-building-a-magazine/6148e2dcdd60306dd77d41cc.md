...
È ora di definire lo stile dell'ultima sezione della rivista: le immagini.

Le immagini sono racchiuse in un elemento `aside` con la classe `image-wrapper`, quindi crea un selettore `.image-wrapper`. Imposta la proprietà `display` su `grid`.
