...
Створіть інструкцію `if`, щоб перевірити, чи має об’єкт `allCategories` властивість `id`. Пам’ятайте, що для цього можна використати метод `hasOwnProperty()`.

# --hints--

Ви повинні мати інструкцію `if`, яка перевіряє, чи має об’єкт `allCategories` властивість `id`
