...
У попередньому модулі ви дізналися, що можна створювати власні кастомні виключення, наслідуючи їх від вбудованого класу `Exception`:
...
Створіть клас із назвою `MediaError`. Нехай він наслідується від класу `Exception` і додайте до нього докстрінг із текстом `Custom exception for media-related errors.`.

# --hints--

Ви маєте створити клас із назвою `MediaError`.
...
Ваш клас `MediaError` має наслідуватися від `Exception`.
...
Ви маєте додати докстрінг `Custom exception for media-related errors.` до вашого класу `MediaError`.
