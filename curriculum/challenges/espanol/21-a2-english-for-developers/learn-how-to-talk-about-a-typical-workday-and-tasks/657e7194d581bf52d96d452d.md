...
`At` se usa para tiempos específicos, `after` para secuencias de acciones, y `to` para indicar dirección o destino.

# --instructions--

Escucha el audio para entender el contexto. Elige las preposiciones correctas para completar oraciones sobre la rutina matutina de Sarah.
...
Se usa para especificar un tiempo.
...
Indica que sigue una secuencia.
