...
Ви повинні мати змінну під назвою `playerScoreSpanElement`.
...
Ви повинні мати змінну під назвою `computerScoreSpanElement`.
...
Ви повинні мати змінну під назвою `roundResultsMsg`.
