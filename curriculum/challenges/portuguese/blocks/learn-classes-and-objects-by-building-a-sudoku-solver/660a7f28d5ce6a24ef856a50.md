...
Agora, modifique o tabuleiro no local acessando a célula na linha e coluna fornecidas e atribuindo a ela o valor de `guess`.

# --hints--

Você deve atribuir `guess` a `self.board[row][col]`.
