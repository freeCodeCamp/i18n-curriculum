...
이제 받은편지함 기능을 시연할 거예요. Ramy가 받은편지함을 확인하고, 첫 번째 이메일을 읽고, 첫 번째 이메일을 삭제한 다음, 변경 사항을 확인하기 위해 다시 받은편지함을 확인할 거예요.

`main` 함수에서 이메일을 보낸 후 다음 코드를 추가하세요:

- Ramy가 `check_inbox` 메서드를 사용해 받은편지함을 확인하게 하세요.
- Ramy가 첫 번째 이메일을 읽게 하세요.
- Ramy가 첫 번째 이메일을 삭제하게 하세요.
- Ramy가 다시 받은편지함을 확인하게 하세요.
