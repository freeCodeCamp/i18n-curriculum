...
Pasemos a los números en los 60.

En chino, el número 60 se llama `六十 (liù shí)`.

Los números del 61 al 69 se forman añadiendo el chino para la cifra de las unidades (1–9) después de `六十 (liù shí)` (60).
...
He practicado la pronunciación de los números del 60 al 69.
