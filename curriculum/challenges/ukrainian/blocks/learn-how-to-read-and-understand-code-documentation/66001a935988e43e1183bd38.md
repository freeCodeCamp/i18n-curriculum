...
Це означає почати щось. Сара пропонує почати з читання описів параметрів.
...
Це означає надати інформацію або деталі. Документація дає інформацію про параметри.
...
Це стосується кожного з параметрів окремо.
