...
معطى مصفوفة ثنائية الأبعاد تمثل مجموعة دومينو، أعد أطول سلسلة صحيحة.
...
- الرقم الأول من الدومينو الأول والرقم الثاني من الدومينو الأخير لا يحتاجان إلى التطابق مع أي شيء.
- يمكن قلب أي دومينو، لذا يمكن لعب `[3, 2]` كـ `[2, 3]`.
- هناك دائمًا سلسلة صحيحة واحدة فقط هي الأطول.

على سبيل المثال، معطى `[[1, 2], [4, 5], [2, 3]]`، أعد `[[1, 2], [2, 3]]`.

# --hints--

`getLongestChain([[1, 2], [4, 5], [2, 3]])` يجب أن تُعيد `[[1, 2], [2, 3]]`.
...
`getLongestChain([[2, 1], [4, 3], [5, 3]])` يجب أن تُعيد `[[4, 3], [3, 5]]`.
...
`getLongestChain([[1, 2], [3, 4], [2, 3], [4, 0]])` يجب أن تُعيد `[[1, 2], [2, 3], [3, 4], [4, 0]]`.
...
`getLongestChain([[6, 6], [6, 1], [1, 1], [0, 3], [2, 3], [4, 1], [5, 6]])` يجب أن تُعيد `[[4, 1], [1, 1], [1, 6], [6, 6], [6, 5]]`.
...
`getLongestChain([[0, 4], [3, 3], [0, 3], [5, 6], [4, 5], [4, 2], [5, 5], [1, 2], [4, 4]])` يجب أن تُعيد `[[3, 3], [3, 0], [0, 4], [4, 4], [4, 5], [5, 5], [5, 6]]`.
