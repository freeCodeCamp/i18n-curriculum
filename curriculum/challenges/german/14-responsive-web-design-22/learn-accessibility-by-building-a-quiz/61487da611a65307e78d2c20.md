...
Behebe dies, indem du den `ul`-Inhalt in einer _Flexbox_ einschließt. Lege anschließend die folgenden CSS-Eigenschaften fest, um den Text korrekt auszurichten:
