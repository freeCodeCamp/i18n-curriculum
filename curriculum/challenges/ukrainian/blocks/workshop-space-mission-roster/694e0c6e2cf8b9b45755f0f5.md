...
Спочатку створіть порожній масив з іменем `eligible`. Потім ітеруйте по кожному астронавту у вхідному масиві `crew` і, якщо він підходить для EVA (тобто його властивість `isEVAEligible` дорівнює `true`), додайте його до масиву `eligible`. Після циклу поверніть масив `eligible`.

# --hints--

Ви повинні створити масив з іменем `eligible`.
...
Ви повинні використати цикл `for`, щоб ітерувати по вхідному масиву `crew`.
...
Ви повинні повернути масив `eligible`.
...
Після виклику `getEVAReadyCrew()` повернутий масив повинен містити лише астронавтів, які підходять для EVA, з вхідного масиву `crew`.
