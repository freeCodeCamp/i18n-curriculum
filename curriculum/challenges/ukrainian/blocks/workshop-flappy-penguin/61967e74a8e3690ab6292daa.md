...
Задайте для елемента `body` властивість `background` як лінійний градієнт під кутом 45 градусів за годинниковою стрілкою, що починається з `rgb(118, 201, 255)` і закінчується `rgb(247, 255, 222)`.
...
Ви повинні задати `background` значення `linear-gradient(45deg, rgb(118, 201, 255), rgb(247, 255, 222))`.
