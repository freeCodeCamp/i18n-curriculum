...
Щоб розташувати елементи в картці, знову потрібні класи сітки. Призначте утилітарні класи `grid`, `grid-rows-[1fr_auto]` і `gap-6` обгортці `div`.

Також приберіть гострі краї за допомогою класу `rounded-xl`.

# --hints--

Ваш елемент-обгортка `div` для преміум-плану має мати клас `grid`.
...
Ваш елемент-обгортка `div` для преміум-плану має мати клас `grid-rows-[1fr_auto]`.
...
Ваш елемент-обгортка `div` для преміум-плану має мати клас `gap-6`.
...
Ваш елемент-обгортка `div` для преміум-плану має мати клас `rounded-xl`.
