...
Crea un selettore `.text` e imposta su di esso una proprietà `grid-column` con valore `2 / 3`.
...
Il tuo selettore `.text` dovrebbe avere una proprietà `grid-column` impostata su `2 / 3`.
