...
Usa el método `addEventListener()` y pasa un evento `"click"` como primer argumento y una función callback vacía con sintaxis de flecha como segundo argumento, por ejemplo, `() => {}`.
