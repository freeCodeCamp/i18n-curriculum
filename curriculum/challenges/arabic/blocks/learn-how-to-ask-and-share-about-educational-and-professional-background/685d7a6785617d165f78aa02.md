...
`majored in`، `coding marathons`، `studies`، `learning experience`، `hands-on`، `played around`، و`background`.
...
الخبرة أو المهارات أو التعليم الذي يمتلكه الشخص.
...
دراسة تخصص رئيسي في الكلية أو الجامعة.
...
تجربة شيء بطريقة ممتعة أو غير رسمية.
...
فعاليات طويلة، غالبًا مسابقات برمجة، يعمل فيها الأشخاص على مشاريع لساعات.
...
التعلم من خلال التطبيق العملي بنفسك، وليس فقط من خلال القراءة.
...
التعلم في المدرسة أو الجامعة أو من خلال الدورات.
...
شيء يعلّمك درسًا من خلال التجربة أو المحاولة.
