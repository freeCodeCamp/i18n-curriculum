...
التالي هو آخر عنصر تسعير، وهو **خطة العائلة**.

ابدأ بإعطاء عنصر التغليف `div` للخطة الأصناف `bg-gray-100`، و`ring-1`، و`ring-gray-300`، و`p-8`، و`rounded-xl`.

# --hints--

يجب أن يحتوي عنصر التغليف `div` الخاص بخطة العائلة على الصنف `bg-gray-100`.
...
يجب أن يحتوي عنصر التغليف `div` الخاص بخطة العائلة على الصنف `ring-1`.
...
يجب أن يحتوي عنصر التغليف `div` الخاص بخطة العائلة على الصنف `ring-gray-300`.
...
يجب أن يحتوي عنصر التغليف `div` الخاص بخطة العائلة على الصنف `p-8`.
...
يجب أن يحتوي عنصر التغليف `div` الخاص بخطة العائلة على الصنف `rounded-xl`.
