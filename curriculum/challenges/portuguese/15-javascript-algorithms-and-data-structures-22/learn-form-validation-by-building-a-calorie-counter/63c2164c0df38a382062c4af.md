...
Passe a string `input[type="text"]` para o método `querySelectorAll()`. Remember that if you use single quotes for your string, you must also use double quotes within it (or vice-versa).
