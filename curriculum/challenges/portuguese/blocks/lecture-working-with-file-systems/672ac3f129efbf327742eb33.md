...
Another way to search for files that you have recently opened is to open Finder by clicking on the Finder icon in the Dock. Então, vá para "Recents" na barra lateral do Finder. E lá, você encontrará todos os arquivos que você visualizou recentemente.
