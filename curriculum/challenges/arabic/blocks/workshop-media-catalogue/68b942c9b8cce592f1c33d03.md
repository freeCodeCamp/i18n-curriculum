...
أكمل الآن صنف `TVSeries` بإضافة سلسلة التوثيق `Child class representing an entire TV series.`

# --hints--

يجب إضافة سلسلة التوثيق `Child class representing an entire TV series.` إلى صنف `TVSeries`.
