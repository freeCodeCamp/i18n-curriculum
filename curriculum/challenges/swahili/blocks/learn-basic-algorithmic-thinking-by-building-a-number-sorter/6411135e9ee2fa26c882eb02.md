...
Kila mzunguko wa `while` loop yako, inapata kipengele kikubwa zaidi kuliko thamani yako ya sasa. Unahitaji kusogeza kipengele hicho kwenda kulia ili kutoa nafasi kwa thamani yako ya sasa.

Fanya hivyo kwa kuweka thamani iliyoko kwenye kielezo cha `j` kwenye kielezo kinachofuata.

# --hints--

Kabla ya kupunguza `j`, weka thamani iliyoko `j` kwenye kielezo `j + 1`.
