...
Dentro do quarto elemento `td`, atualize o valor atual para chamar a função `viewCount` com a variável `views` como argumento.

# --hints--

Você deve chamar a função `viewCount` e passar a variável `views` como argumento.
