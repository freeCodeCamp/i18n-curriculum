...
Sei $n$ ein positiver Integer. Angenommen, für jedes Tripel der Integer $(a, b, c)$ mit $0 ≤ a, b, c ≤ n$ und $gcd(a, b, c) = 1$ gibt es eine Mischung mit dem Verhältnis $(a : b : c)$. Sei $M(n)$ die Menge aller solcher Mischungen.
...
Sei $E(n)$ die Anzahl der Teilmengen von $M(n)$, die das Gemisch mit dem Verhältnis (1 : 1 : 1), d.h. das Gemisch mit gleichen Anteilen $A$, $B$ und $C$, ergeben können.
