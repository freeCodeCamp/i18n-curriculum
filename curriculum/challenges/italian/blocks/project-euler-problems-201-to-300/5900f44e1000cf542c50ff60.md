...
Si può dimostrare che 27 non è un divisore di nessun termine di questa sequenza. Infatti, 27 è il primo numero dispari con questa proprietà.

Trova il ${124}^{\text{esimo}}$ numero dispari che non divide nessun termine della sequenza sopra indicata.
