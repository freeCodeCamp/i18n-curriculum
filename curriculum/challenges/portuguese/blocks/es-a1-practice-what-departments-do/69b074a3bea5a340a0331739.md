...
Neste desafio, você vai praticar identificar departamentos com base em suas tarefas.
...
Este departamento apoia os funcionários.

# --explanation--

`Recursos humanos` significa "Recursos Humanos".

Sebastián diz `el departamento de recursos humanos apoya a los empleados`, que significa "O departamento de Recursos Humanos apoia os funcionários".
