...
Переходимо до наступної будівлі! Створіть нову змінну властивості `--window-color3` у `:root` і надайте їй значення `#d98cb3`. Це буде вторинний колір для рожевих будівель.
