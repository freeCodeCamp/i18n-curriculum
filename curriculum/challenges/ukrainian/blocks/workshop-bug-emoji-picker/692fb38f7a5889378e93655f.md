...
Далі створіть підклас із назвою `Bee`, який розширює клас `Bug` із параметром узагальненого типу, встановленим у `string`.

# --hints--

У вас має бути клас із назвою `Bee`.
...
Ваш клас `Bee` має розширювати `Bug`.
...
Ваш клас `Bee` має розширювати `Bug` із аргументом типу `string`.
