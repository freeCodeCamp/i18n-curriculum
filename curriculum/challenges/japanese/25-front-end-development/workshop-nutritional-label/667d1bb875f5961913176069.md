...
プレビューで、テキストの `8g` の部分が中央に表示されていることに注目してください。 Nest the `span` element containing the text `Total Fat` along with the text `8g`, in an additional `span` element for alignment.
