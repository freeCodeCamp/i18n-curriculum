...
Bootstrap viene con varios colores predefinidos para botones. La clase `btn-info` es usada para llamar la atención a acciones opcionales que el usuario puede tomar.
