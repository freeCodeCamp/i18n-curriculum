...
جميع الوظائف الأساسية أصبحت موجودة الآن. المشكلة الوحيدة هي أن الأغنية التالية لا تُشغل تلقائيًا عند انتهاء الأغنية الحالية.

لإصلاح ذلك، يمكنك إعداد مستمع حدث يكتشف متى تنتهي الأغنية الحالية. مستمع الحدث `"ended"` مناسب لهذا الغرض. يُطلق هذا الحدث عند وصول تشغيل الوسائط إلى نهايته.

أضف مستمع حدث إلى عنصر `audio` يستمع إلى حدث `"ended"`. مرر استدعاء راجع باستخدام صيغة السهم مع أقواس متعرجة فارغة.
...
يجب استخدام صيغة السهم لتمرير استدعاء راجع فارغ إلى مستمع الحدث `"ended"`.
