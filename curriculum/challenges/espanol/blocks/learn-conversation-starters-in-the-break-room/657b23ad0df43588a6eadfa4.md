...
`Are you into board games?` y `They are really fun.`
...
`What's the team's favorite?` y `Many of us enjoy the monthly game night.`

### --feedback--

La primera oración es correcta. La segunda oración es una declaración, no una pregunta.

---

`Are you going to board games?` y `What do board games you play?`

### --feedback--

Estas preguntas no se mencionan en el audio y son gramaticalmente incorrectas.

---

`What's the team's favorite?` y `Are you into playing board games?`
