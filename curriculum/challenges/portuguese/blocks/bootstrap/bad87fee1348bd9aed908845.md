...
Você pode adicionar o ícone `fa-paper-plane` do Font Awesome adicionando `<i class="fa fa-paper-plane"></i>` dentro do seu elemento de `button` de envio.
...
Todos os elementos textuais `<input>`, `<textarea>` e `<select>` com a classe `.form-control` possuem largura de 100%.
...
Você deve adicionar um `<i class="fa fa-paper-plane"></i>` dentro do seu elemento de `button` de envio.
