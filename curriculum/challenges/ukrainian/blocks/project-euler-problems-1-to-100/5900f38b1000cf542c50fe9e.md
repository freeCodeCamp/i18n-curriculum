...
В Англії валюта складається з фунтів стерлінгів, £, та пенсів, p, і в обігу є вісім монет:

<div style='margin-left: 4em;'>1p, 2p, 5p, 10p, 20p, 50p, £1 (100p) та £2 (200p).</div>

Можна отримати £2 таким чином:

<div style='margin-left: 4em;'>1×£1 + 1×50p + 2×20p + 1×5p + 1×2p + 3×1p</div>

Скільки різних способів можна скласти `n` пенсів, використовуючи будь-яку кількість монет?
