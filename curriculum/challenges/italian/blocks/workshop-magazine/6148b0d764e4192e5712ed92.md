...
Per avere un controllo aggiuntivo sul layout del tuo contenuto, puoi inserire una griglia CSS all'interno di un'altra griglia CSS.

Imposta la proprietà `display` del selettore `.heading` su `grid`.

# --hints--

Il tuo selettore `.heading` dovrebbe avere una proprietà `display` impostata su `grid`.
