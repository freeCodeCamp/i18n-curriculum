...
Debes dar al `input` que espera un nombre de pila un atributo `name`. *PD: yo habría elegido `first-name`*

```js
assert.isNotEmpty(document.querySelector('fieldset:nth-child(1) > label:nth-child(1) > input')?.name);
```

Debes darle al `input` que espera un apellido un atributo `name`. *PD: yo habría elegido `last-name`*

```js
assert.isNotEmpty(document.querySelector('fieldset:nth-child(1) > label:nth-child(2) > input')?.name);
```

Debes darle al `email` un atributo `name`. *PD: yo habría elegido `email`*

```js
assert.isNotEmpty(document.querySelector('input[type="email"]')?.name);
```

Debes darle al `password` un atributo `name`. *PD: yo habría elegido `password`*

```js
assert.isNotEmpty(document.querySelector('input[type="password"]')?.name);
```

Debes darle al `checkbox` un atributo `name`. *PD: yo habría elegido `terms`*

```js
assert.isNotEmpty(document.querySelector('input[type="checkbox"]')?.name);
```

Debes darle al `file` un atributo `name`. *PD: yo habría elegido `file`*

```js
assert.isNotEmpty(document.querySelector('input[type="file"]')?.name);
```

Debes darle al `number` un atributo `name`. *PD: yo habría elegido `age`*

```js
assert.isNotEmpty(document.querySelector('input[type="number"]')?.name);
```

Debes darle al elemento `select` un atributo `name`. *PD: yo habría elegido `referrer`*

```js
assert.isNotEmpty(document.querySelector('select')?.name);
```

Debes darle al elemento `textarea` un atributo `name`. *PD: yo habría elegido `bio`*
