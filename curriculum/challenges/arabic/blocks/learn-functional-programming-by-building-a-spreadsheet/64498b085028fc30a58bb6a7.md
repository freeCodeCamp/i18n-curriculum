...
أعلن دالة `elemValue` التي تأخذ معلمة `num`. يجب أن تكون الدالة فارغة.

# --hints--

يجب إعلان متغير `elemValue` بعد دالتك `rangeFromString()`.
