...
将 `address` 元素中的所有文本水平居中，并添加一些 padding。
...
你应该给 `address` 添加 `padding-right` 值为至少 `1px`。
...
你应该给 `address` 添加 `padding-bottom` 值为至少 `1px`。
...
你应该给 `address` 添加 `padding-left` 值为至少 `1px`。
