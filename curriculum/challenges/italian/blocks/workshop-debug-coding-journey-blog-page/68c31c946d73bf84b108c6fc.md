...
Poiché l'intera sezione che contiene i post del blog rappresenta il contenuto principale della pagina, dovrebbe essere racchiusa in un elemento `main`. Questo aiuta i lettori di schermo e altre tecnologie assistive a comprendere meglio la struttura della pagina.
...
Il tuo elemento `main` dovrebbe contenere tutti e tre gli elementi `article`.
