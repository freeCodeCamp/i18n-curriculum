...
Il resto dell'HTML ti è stato fornito. Include le schede dei piani premium e famiglia. Ora è il momento di definire lo stile degli elementi HTML con Tailwind CSS.

Inizia dando all'intera pagina uno sfondo leggermente grigio assegnando all'elemento `body` una classe `bg-gray-100`.

# --hints--

Il tuo elemento body dovrebbe avere la classe `bg-gray-100`.
