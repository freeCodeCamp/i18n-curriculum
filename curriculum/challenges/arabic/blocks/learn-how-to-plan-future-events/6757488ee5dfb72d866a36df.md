...
تعني هذه الكلمة حدوث شيء في وقت لاحق مما هو متوقع. تذكر، هي بصيغة الجمع في هذه الجملة.

# --explanation--

`Delays` هي حالات يحدث فيها شيء ما في وقت لاحق مما هو مخطط أو متوقع. على سبيل المثال:

`The software release faced delays due to testing issues.` - هذا يعني أن الإصدار حدث في وقت لاحق مما هو مخطط بسبب مشاكل في الاختبار.
