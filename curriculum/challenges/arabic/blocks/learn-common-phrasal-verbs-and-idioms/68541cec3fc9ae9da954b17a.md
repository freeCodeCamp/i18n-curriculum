...
`hash out`، `lay down`، `roll it out`، `run it by`، `set up`، `take the time off`، و `touch base on`.
...
هذا الفعل المركب يعني مناقشة شيء بالتفصيل. يبدأ بفعل، يليه حرف جر.
...
هذا الفعل المركب يعني تحديد أو تعريف شيء بوضوح. يبدأ بفعل، يليه ظرف.
...
هذا يعني مناقشة أو التحقق بسرعة من موضوع ما. يبدأ بفعل، يليه اسم، ثم حرف جر.
...
هذا يعني استخدام أيام الإجازة من العمل. يبدأ بفعل، يليه أداة تعريف واسم، ثم حرف جر.
...
هذا يعني التحقق من شخص ما للموافقة أو المراجعة. يبدأ بفعل، يليه ضمير، ثم حرف جر.
...
هذا يعني إطلاق أو تنفيذ شيء جديد. يبدأ بفعل، يليه ضمير، ثم حرف جر.
...
هذا الفعل المركب يعني ترتيب أو تنظيم شيء. يبدأ بفعل، يليه حرف جر.
