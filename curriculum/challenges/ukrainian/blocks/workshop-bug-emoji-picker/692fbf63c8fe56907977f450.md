...
Далі визначте об’єкт з іменем `bugMap` типу `Record<string, Bug<string>>` і наразі призначте йому порожній об’єкт.

# --hints--

У вас має бути константа з іменем `bugMap`.
...
Вашому `bugMap` слід надати анотацію типу `Record<string, Bug<string>>`.
...
Ваш `bugMap` має бути ініціалізований порожнім об’єктом.
