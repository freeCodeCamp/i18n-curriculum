...
Verwenden Sie erneut die `Card`-Komponente zwei weitere Male mit den folgenden:

| Props  | Werte der ersten Karte | Werte der zweiten Karte |
|-------|------------------------------------------------------------|-----------------------------------------------------|
| `name`  | `"Tiffany"` | `"Doug"`|
...
Sie sollten die vorhandene `Card`-Komponente in Ihrer `App`-Komponente nicht verändern.
...
Sie sollten die `Card`-Komponente als Element mit den passenden Props und Werten der ersten Karte verwenden.
...
Sie sollten die `Card`-Komponente als Element mit den passenden Props und Werten der zweiten Karte verwenden.
