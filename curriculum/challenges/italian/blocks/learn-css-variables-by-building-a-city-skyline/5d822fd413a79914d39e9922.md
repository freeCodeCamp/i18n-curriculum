...
Dai all'elemento `.fb3a` una `width` di `80%` e una `height` di `15%`. Poi dai all'elemento `.fb3b` una `width` di `100%` e una `height` di `35%`.

# --hints--

Dovresti dare a `.fb3a` una `width` di `80%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle(".fb3a")?.width, "80%");
```

Dovresti dare a `.fb3a` una `height` di `15%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle(".fb3a")?.height, "15%");
```

Dovresti dare a `.fb3b` una `width` di `100%`.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle(".fb3b")?.width, "100%");
```

Dovresti dare a `.fb3b` una `height` di `35%`.
