...
يمكنك إعطاء قائمتك بعض المساحة بين المحتوى والجانبين مع خصائص `padding` المختلفة.

امنح class تسمى `menu` خاصية `padding-left` و `padding-right` بنفس القيمة `20px`.

# --hints--

يجب عليك تعيين خاصية `padding-left` إلى `20px`.
...
يجب عليك تعيين خاصية `padding-right` إلى `20px`.
...
يجب أن يكون للعنصر `.menu` الخاص بك `padding-left` بقيمة `20px`.
...
يجب أن يكون للعنصر `.menu` الخاص بك `padding-right` بقيمة `20px`.
