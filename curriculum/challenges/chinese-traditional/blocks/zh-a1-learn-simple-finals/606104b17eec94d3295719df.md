...
| ------ | ------------ | ------------------ | --------- | ----------------- |
| `mā`   | first tone   | high, level        | `媽`       | mother            |
| `má`   | second tone  | high, rising       | `麻`       | numb              |
| `mǎ`   | third tone   | falling and rising | `馬`       | horse             |
| `mà`   | fourth tone  | falling            | `罵`       | to scold          |
| `ma`   | neutral tone | short and soft     | `嗎`       | question particle |

Even the same character can also have different meanings when it is pronounced with different tones. For example: `你好 (nǐ hǎo)` means "hello", in which `好 (hǎo)` has the third tone and means "good". `愛好 (ài hào)` means "hobby", in which `好 (hào)` has the fourth tone and means "to like".
