...
- `"We retreated"` se o exército adversário tiver mais personagens do que o seu.
- `"We won"` se seu exército venceu mais batalhas.
- `"We lost"` se o exército adversário venceu mais batalhas.
- `"It was a tie"` se ambos os exércitos venceram o mesmo número de batalhas.
