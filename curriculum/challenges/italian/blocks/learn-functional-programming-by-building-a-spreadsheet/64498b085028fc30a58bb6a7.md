...
Dichiara una funzione `elemValue` che prende un parametro `num`. La funzione dovrebbe essere vuota.

# --hints--

Dovresti dichiarare una variabile `elemValue` dopo la tua funzione `rangeFromString()`.
