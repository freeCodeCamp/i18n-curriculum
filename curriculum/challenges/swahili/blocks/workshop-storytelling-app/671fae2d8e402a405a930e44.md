...
Ongeza msikilizaji wa tukio la `click` kwa `scaryStoryBtn` na upitishe kitendakazi cha `displayStory`. Kisha, bofya kitufe chako na uone matokeo kwenye konsoli.

# --hints--

Unapaswa kuongeza msikilizaji wa tukio la `click` kwa `scaryStoryBtn` ukimpatia kitendakazi cha `displayStory`.
