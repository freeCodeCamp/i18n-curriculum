...
Sukuma majengo pamoja tena kwa kuongeza vipengele viwili tupu vya `div` ndani ya sehemu ya juu na ya chini ya kipengele cha `.foreground-buildings`, na kimoja zaidi kati ya `.fb2` na `.fb3`.
...
Unapaswa kuongeza kipengele kimoja cha `div` kati ya `.fb2` na `.fb3`.
...
Unapaswa kuwa umeongeza vipengele vipya 5 vya `div`.
