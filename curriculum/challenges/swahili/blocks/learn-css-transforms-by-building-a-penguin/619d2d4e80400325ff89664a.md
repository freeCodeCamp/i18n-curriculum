...
Ili kuweka mwelekeo wa mstari wa rangi upande sahihi wa mkono wa kushoto wa pengwini, kwanza uizungushe kwa `130deg`, kisha ubadilishe mhimili wa x.

# --hints--

Unapaswa kumpa `.arm.left` `transform` ya `rotate(130deg) scaleX(-1)`.
