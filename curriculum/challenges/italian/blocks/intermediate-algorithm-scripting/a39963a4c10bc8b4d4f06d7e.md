...
Ti verrà fornito un array iniziale come primo argomento della funzione `destroyer`, seguito da uno o più argomenti. Rimuovi tutti gli elementi dall'array iniziale che hanno lo stesso valore di questi argomenti.

La funzione deve accettare un numero indeterminato di argomenti, nota anche come funzione variadica. Puoi consultare gli argomenti aggiuntivi aggiungendo un parametro rest alla definizione della funzione oppure usando l'oggetto `arguments`.
