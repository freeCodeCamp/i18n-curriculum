...
Fanya mfano wa zamu ya usiku kwa kuita `simulateFestival()` na `nightGates` pamoja na `"Night"`.

Kwa hayo, mifano yako imekamilika!

# --hints--

Unapaswa kuita `simulateFestival()` na `nightGates` pamoja na `"Night"`.
