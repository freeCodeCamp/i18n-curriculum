...
Finalmente, adicione um `console.log` e faça a chamada da função `getShoppingListMsg` com o array `shoppingList` como argumento dentro do `console.log` para ver a lista atualizada registrada no console.
