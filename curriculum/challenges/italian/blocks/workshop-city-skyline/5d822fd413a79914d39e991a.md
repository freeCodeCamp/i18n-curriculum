...
Passiamo al prossimo build! Annida due elementi `div` all'interno di `.fb2` e assegna loro le classi `fb2a` e `fb2b`, in questo ordine.
...
Dovresti dare al primo nuovo elemento `div` una classe `fb2a`.
...
Dovresti dare al secondo nuovo elemento `div` una classe `fb2b`.
