...
Kwa bahati mbaya, sifa hiyo ya `children` inarudisha mkusanyiko wa vipengele, ambao ni kama safu ya data lakini si safu ya data halisi. Wazungushe hoja yako ya pili katika `Array.from()` ili kuibadilisha kuwa safu ya data.

# --hints--

Unapaswa kuzungusha `document.getElementById('container').children` yako ndani ya `Array.from()`.
