...
Wakati wa ukuzaji, ni muhimu kuona mipaka ya chaguo-msingi ya `fieldset`. Hata hivyo, hufanya maudhui yaonekane yamegawanyika sana.

Ondoa `border`, na ongeza `2rem` ya nafasi ya ndani juu na chini tu ya kila `fieldset`. Hakikisha unaondoa `padding` kutoka kushoto na kulia.
...
Unapaswa kuondoa `padding` kutoka kushoto na kulia ya kila `fieldset`.
