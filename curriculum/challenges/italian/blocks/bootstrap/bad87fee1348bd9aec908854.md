...
title: Etichetta bootstrap wells
challengeType: 0
forumTopicId: 18223
...
Per chiarezza, etichetta entrambi i tuoi wells con i loro id.

Sopra il tuo left-well, all'interno del suo elemento `col-xs-6` `div`, aggiungi un elemento `h4` con il testo `#left-well`.

Sopra il tuo right-well, all'interno del suo elemento `col-xs-6` `div`, aggiungi un elemento `h4` con il testo `#right-well`.
...
Tutti i tuoi elementi `h4` dovrebbero avere tag di chiusura.
