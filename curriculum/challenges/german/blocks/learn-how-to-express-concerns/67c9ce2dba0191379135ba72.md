...
`Really` and `too` are both **intensifiers**, but they have different meanings. `Really` strengthens the adjective it modifies without indicating excess. `Too`, on the other hand, indicates excess, meaning more than what is acceptable or manageable. Zum Beispiel:
