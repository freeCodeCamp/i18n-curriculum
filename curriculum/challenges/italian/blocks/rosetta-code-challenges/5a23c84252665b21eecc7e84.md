...
title: Somma massima di una sottosequenza
challengeType: 1
forumTopicId: 302278
...
Data una sequenza di numeri interi, trova una sottosequenza continua che massimizza la somma dei suoi elementi, cioè, gli elementi di nessun'altra singola sottosequenza sommano a un valore più grande di questo.

Una sottosequenza vuota è considerata avere somma \\( 0 \\); quindi se tutti gli elementi sono negativi, il risultato deve essere la sequenza vuota.
