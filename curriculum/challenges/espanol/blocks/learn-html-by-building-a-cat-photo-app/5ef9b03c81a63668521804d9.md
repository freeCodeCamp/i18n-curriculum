...
Un texto provisional (placeholder) nos da una idea de que tipo de información debemos escribir en un elemento input. 

Aquí tienes un ejemplo de un elemento `input` con un placeholder establecido en `e.g. Jane Doe`:
...
Tu elemento `input` debe tener un atributo `placeholder` con el valor `cat photo URL`. Has omitido el valor o tienes un error tipográfico. Recuerda que los valores de los atributos deben estar entre comillas.
