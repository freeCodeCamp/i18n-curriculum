...
Ahora, no podemos leer el texto. Apunta al `footer` y al elemento ancla dentro para establecer el color de fuente a un color de un índice de contraste adecuado.

# --hints--

Debes utilizar el selector `footer, footer a`.
...
Debe establecer el `color` en un valor con un índice de contraste de al menos `7:1`. _Sugerencia: recomiendo `#dfdfe2`_
