...
`Tempting` ist ein Adjektiv, das etwas beschreibt, das sehr schön aussieht oder klingt und Sie dazu verleitet, es tun oder haben zu wollen. Zum Beispiel:

`The idea of sleeping in is tempting.` – Hier bedeutet `tempting`, dass die Vorstellung, länger im Bett zu bleiben, sehr verlockend oder schwer zu widerstehen ist.
...
Dieses Adjektiv beschreibt etwas, das ansprechend oder attraktiv ist, in diesem Fall das Drücken der Schlummertaste.
