...
Per completare lo stile, aggiungi le classi applicabili `flavor` e `price` a tutti gli elementi `p` rimanenti.
...
I tuoi elementi `.flavor` dovrebbero essere i tuoi elementi `p` con il testo `French Vanilla`, `Caramel Macchiato`, `Pumpkin Spice`, `Hazelnut` e `Mocha`.
...
I tuoi elementi `.price` dovrebbero essere i tuoi elementi `p` con il testo `3.00`, `3.75`, `3.50`, `4.00` e `4.50`.
