...
La secuencia Look and say es una secuencia de números definida recursivamente.
...
Escribe una función que acepte una cadena como parámetro, la procese y devuelva la cadena resultante.

# --hints--

`lookAndSay` debería ser una función.

```js
assert(typeof lookAndSay == 'function');
```

`lookAndSay("1")` debería devolver una cadena.

```js
assert(typeof lookAndSay('1') == 'string');
```

`lookAndSay("1")` debería devolver `"11"`.

```js
assert.equal(lookAndSay('1'), '11');
```

`lookAndSay("11")` debería devolver `"21"`.

```js
assert.equal(lookAndSay('11'), '21');
```

`lookAndSay("21")` debería devolver `"1211"`.

```js
assert.equal(lookAndSay('21'), '1211');
```

`lookAndSay("1211")` debería devolver `"111221"`.

```js
assert.equal(lookAndSay('1211'), '111221');
```

`lookAndSay("3542")` debería devolver `"13151412"`.
