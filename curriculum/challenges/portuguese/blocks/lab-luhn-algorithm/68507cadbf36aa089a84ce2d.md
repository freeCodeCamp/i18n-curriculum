...
`verify_card_number('453914889')` deve retornar `VÁLIDO!`.
...
`verify_card_number('4111-1111-1111-1111')` deve retornar `VÁLIDO!`.
...
`verify_card_number('453914881')` deve retornar `INVÁLIDO!`.
...
`verify_card_number('1234 5678 9012 3456')` deve retornar `INVÁLIDO!`.
