...
Direcione o elemento `.beak` com um `class` de `bottom` e dê a ele uma `width` que seja `4%` menor que `.beak.top`, `5%` mais distante do topo e `2%` mais distante da esquerda de seu pai do que `.beak.top`.

# --hints--

Você deve ter um seletor `.beak.bottom`.
