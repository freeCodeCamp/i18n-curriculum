...
Що означає фраза `review and adjust` у плані?

## --answers--

Перегляньте план ще раз і покращіть його, якщо потрібно.

---

Напишіть повністю новий план.

### --feedback--

Фраза не означає починати з початку.

---

Знову протестуйте функцію чату у всіх країнах.

### --feedback--

Тестування — це частина попередніх кроків, що не є значенням `review and adjust`.

---

Запитайте користувачів, чи подобається їм ця функція.

### --feedback--

Відгуки користувачів корисні, але це не фокус тут.
...
Знайдіть крок, у якому йдеться про `reviewing` і `adjusting`. Після цього прочитайте його пояснення. Воно допоможе вам правильно відповісти на це запитання.
