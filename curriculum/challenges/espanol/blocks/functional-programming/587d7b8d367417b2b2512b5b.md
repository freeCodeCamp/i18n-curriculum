...
La programación funcional es un estilo de programación donde las soluciones son funciones simples e aisladas, sin efectos secundarios fuera del ámbito de la función: `INPUT -> PROCESS -> OUTPUT`

La programación funcional se refiere a:

Funciones aisladas: no hay dependencia del estado del programa, lo que incluye variables globales que pueden cambiar

Funciones puras: la misma entrada siempre da la misma salida

Funciones con efectos secundarios limitados: cualquier cambio o mutación en el estado del programa fuera de la función está cuidadosamente controlado
