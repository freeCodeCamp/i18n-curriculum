...
Una forma de mostrar el texto del párrafo es cambiar el valor inicial para el `useState` hook.

Cambie el valor actual de `useState` de `false` a `true` y debería ver que el texto del párrafo ahora se muestra en la pantalla.

# --hints--

Debe cambiar el valor inicial de `useState` a `true`.
