...
マーカーの色が正しくなったので、次はマーカーのスリーブを作成しましょう。赤いマーカーから始めます。

赤いマーカーの`div`要素の中に、新しい`div`要素を作成し、`sleeve`のクラスを付けてください。

# --hints--

新しい`div`要素は赤いマーカーの`div`要素の中にあるべきです。
...
新しい`div`要素には`sleeve`のクラスを付けてください。
