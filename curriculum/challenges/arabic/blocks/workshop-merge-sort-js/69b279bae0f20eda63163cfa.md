...
انسخ القيم المتبقية من اليسار إلى `array` عن طريق تعيين `leftPart[leftArrayIndex]` إلى `array[sortedIndex]`.

# --hints--

يجب أن يقوم جسم الحلقة بتعيين `leftPart[leftArrayIndex]` إلى `array[sortedIndex]`.
