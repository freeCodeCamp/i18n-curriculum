...
- `You were looking for a car to buy. Did you buy it?` - 問句中使用了 `It` 來代替 `the car`。

- `How were your tests last week? Did you do well on all of them?` 你上週的考試表現如何？`Them` 你在所有 `your tests` 上都表現良好嗎？
