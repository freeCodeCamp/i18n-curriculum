...
داخل التكرار الذي أنشأته في الخطوة السابقة، قم بتسكين تكرار `for` آخر للتكرار على متتالية من ثلاثة عناصر تبدأ عند `col_start`. استخدم الدالة `range()` لتوليد هذه المتتالية و`col_no` كمتغير التكرار.

# --hints--

يجب أن تنشئ تكرار `for` يتكرر على `range(col_start, col_start + 3)` داخل جسم التكرار الموجود.
...
يجب أن يستخدم تكرار `for` الخاص بك المتغير `col_no` كمتغير التكرار.
