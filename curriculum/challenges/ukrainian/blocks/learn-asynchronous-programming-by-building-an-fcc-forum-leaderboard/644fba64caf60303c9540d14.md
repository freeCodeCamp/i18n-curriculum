...
Після атрибута `href` встановіть атрибут `class` у константу з іменем `linkClass`.

Після атрибута `class` встановіть атрибут `target` у `"_blank"`.

Нарешті, розмістіть константу `linkText` між тегами посилання, щоб відобразити текст у посиланні.

# --hints--

У вас має бути атрибут `class` після атрибута `href`.
...
Ви маєте встановити значення атрибута `class` у константу з іменем `linkClass`.
...
У вас має бути атрибут `target` після атрибута `class`.
...
Ви маєте встановити значення атрибута `target` у `"_blank"`.
...
Ви маєте розмістити константу `linkText` між тегами посилання.
