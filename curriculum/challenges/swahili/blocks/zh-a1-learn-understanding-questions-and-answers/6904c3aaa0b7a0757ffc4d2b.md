...
Wang Hua anauliza mtu jina lake. Anatumia herufi inayomaanisha "kuitwa" au "kudaiwa jina".
...
Herufi hii ina maana ya "kuitwa" au "kudaiwa jina".

# --explanation--

`叫 (jiào)` ina maana ya "kuitwa". Mara nyingi hutumika baada ya mhusika kuanzisha jina. Kwa mfano:
