...
كيف سيرد جيمس إذا فهم تعليمات سارة؟
...
إذا فهم جيمس التعليمات بوضوح، فإن ردًا بسيطًا مثل `Got it` يُظهر أنه لا يحتاج إلى مزيد من المساعدة.
