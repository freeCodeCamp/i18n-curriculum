...
Usa tu función `chunkCrew()` para crear bloques de tamaño `3` a partir de tu arreglo `EVAReadySquad` y guárdalos en una nueva variable llamada `EVAChunks`.

# --hints--

Debes llamar a `chunkCrew()` con `EVAReadySquad` y `3` y almacenar el resultado en una nueva variable llamada `EVAChunks`.
