...
Створіть нову змінну властивості з назвою `--window-color4` у `:root` і надайте їй значення `#8cb3d9`. Це буде вторинний колір для останньої будівлі на фоні.

# --hints--

Ви повинні визначити нову змінну властивості `--window-color4`.
