...
Для додаткового контролю над макетом вмісту ви можете мати CSS-сітку в межах CSS-сітки.

Встановіть властивість `display` селектора `.heading` на `grid`.

# --hints--

Ваш селектор `.heading` повинен мати властивість `display` зі значенням `grid`.
