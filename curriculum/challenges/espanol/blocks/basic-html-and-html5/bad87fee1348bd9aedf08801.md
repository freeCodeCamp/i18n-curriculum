...
El elemento `p` es el elemento preferido para texto de párrafo en sitios web. `p` es la abreviatura de "paragraph".
...
**Nota:** Como convención, todas las etiquetas HTML se escriben en minúsculas, por ejemplo `<p></p>` y no `<P></P>`.
