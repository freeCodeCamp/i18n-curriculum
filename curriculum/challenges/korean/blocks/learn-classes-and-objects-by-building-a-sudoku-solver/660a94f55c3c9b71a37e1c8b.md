...
스도쿠 퍼즐을 풀 수 없을 때를 위한 `else` 절을 만들고, 새 `else` 블록 안에 다음 문자열 `'The provided puzzle is unsolvable.'`를 출력하세요.

# --hints--

`else` 절을 만들고 `'The provided puzzle is unsolvable.'`를 출력해야 합니다.
