...
أنشئ دالة باسم `setPlayerDisplay`. داخل الدالة، عيّن `textContent` الخاص بـ `playingSong` إلى عنوان الأغنية الحالية إذا كان معرفًا. وإلا، عيّنه إلى سلسلة نصية فارغة.

أسفل ذلك، عيّن `textContent` الخاص بـ `songArtist` إلى اسم فنان الأغنية الحالية إذا كان معرفًا. وإلا، عيّنه إلى سلسلة نصية فارغة.


# --hints--

يجب أن يكون لديك دالة باسم `setPlayerDisplay`.

```js
assert.isFunction(setPlayerDisplay);
```

يجب أن تعيّن دالة `setPlayerDisplay` الخاصة بك `textContent` الخاص بـ `playingSong` إلى عنوان الأغنية الحالية إذا كان معرفًا، أو إلى سلسلة نصية فارغة.
...
يجب أن تعيّن دالة `setPlayerDisplay` الخاصة بك `textContent` الخاص بـ `songArtist` إلى اسم فنان الأغنية الحالية إذا كان معرفًا، أو إلى سلسلة نصية فارغة.
