...
`range()` поверне масив чисел, який потрібно перетворити назад у символи. Приєднайте метод `.map()` до вашого виклику `range()`.

Передайте функцію зворотного виклику, яка приймає `code` як параметр і неявно повертає значення виклику методу `code` з `String.fromCharCode()`.
...
Ви повинні приєднати метод `.map()` до вашого виклику `range`.
...
Використовуйте стрілковий синтаксис для функції зворотного виклику `.map()`.
...
Ваша функція зворотного виклику `.map()` має приймати параметр `code`.
...
Ваша функція зворотного виклику `.map()` має повертати результат виклику `String.fromCharCode()`.
...
Ви повинні передати змінну `code` у `String.fromCharCode()`.
