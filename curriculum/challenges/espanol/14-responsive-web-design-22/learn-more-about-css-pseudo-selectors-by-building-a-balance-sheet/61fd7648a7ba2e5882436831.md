...
Tu elemento `tbody` debe tener cuatro elementos `tr`.
...
Tus primeros tres elementos `tr` deben tener el atributo `class` establecido en `data`.
...
Tu cuarto elemento `tr` debe tener el atributo `class` establecido en `total`.
