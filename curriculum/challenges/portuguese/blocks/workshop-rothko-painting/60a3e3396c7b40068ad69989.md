...
Altere a `background-color` do elemento `.three` para `#b20403`.

# --hints--

Você deve definir o valor da propriedade `background-color` como `#b20403`.
...
O elemento `.three` deve ter uma `background-color` com o valor de `#b20403`.
