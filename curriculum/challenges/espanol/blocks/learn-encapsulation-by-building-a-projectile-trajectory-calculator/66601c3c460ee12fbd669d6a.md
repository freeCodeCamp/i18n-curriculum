...
Ahora puedes eliminar el ciclo para imprimir cada fila de la salida y reemplazarlo con `print(graph.create_trajectory())`.

# --hints--

No debes tener un ciclo en el ámbito global.
...
Deberías tener `print(graph.create_trajectory())`.
