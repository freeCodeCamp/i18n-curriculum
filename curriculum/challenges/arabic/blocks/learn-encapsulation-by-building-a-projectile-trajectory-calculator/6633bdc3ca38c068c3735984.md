...
أضف المحورين x و y إلى الرسم البياني للحصول على الإخراج التالي:
...
الرموز متوفرة كـ `x_axis_tick` و `y_axis_tick`.

# --hints--

يجب أن تُرجع الطريقة الإخراج الصحيح.
...
يجب أن تُرجع الطريقة الإخراج الصحيح لحالات مختلفة.
