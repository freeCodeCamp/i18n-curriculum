...
Останнім елементом, який потрібно додати до кожного з `button` елементів, є атрибути `id`. Вони будуть використовуватися для зв’язування `button` елементів із відповідними панелями вмісту.

Перший `button` елемент має мати атрибут `id` зі значенням `"tab-earth"`, другий — атрибут `id` зі значенням `"tab-saturn"`, а третій — атрибут `id` зі значенням `"tab-mars"`.

# --hints--

Ваш перший `button` елемент має мати атрибут `id`.
...
Ваш перший `button` елемент має мати атрибут `id`, встановлений у `"tab-earth"`.
...
Ваш другий `button` елемент має мати атрибут `id`.
...
Ваш другий `button` елемент має мати атрибут `id`, встановлений у `"tab-saturn"`.
...
Ваш третій `button` елемент має мати атрибут `id`.
...
Ваш третій `button` елемент має мати атрибут `id`, встановлений у `"tab-mars"`.
