...
Esta relação ordenada é muito fácil de ver.Observe que todo valor à esquerda de 8, o nó raiz, é menor que 8, enquanto todo valor à direita é maior que 8.Perceba que esta relação também se aplica a cada uma das subárvores.Por exemplo, o primeiro filho à esquerda é uma subárvore. 3 é o nó pai, e ele possui exatamente dois nós filhos — pelas regras que regem as árvores binárias de busca, sabemos sem nem olhar que o filho à esquerda deste nó (e qualquer um de seus filhos) será menor que 3, e o filho à direita (e qualquer um de seus filhos) será maior que 3 (mas também menor que o valor da raiz da estrutura), e assim por diante.
...
**Dica:** árvores são estruturas de dados naturalmente recursivas!
