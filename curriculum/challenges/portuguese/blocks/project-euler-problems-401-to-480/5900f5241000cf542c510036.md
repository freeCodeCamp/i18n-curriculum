...
Então as potências de 8 mod 11 são cíclicas com período 10, e $8^n + 8^{n + 1} ≡ 8^{n + 2} (\text{mod } 11)$. 8 é chamado de raiz primitiva de Fibonacci de 11.
...
Encontre a soma dos primos menores que $100\,000\,000$ com pelo menos uma raiz primitiva de Fibonacci.
