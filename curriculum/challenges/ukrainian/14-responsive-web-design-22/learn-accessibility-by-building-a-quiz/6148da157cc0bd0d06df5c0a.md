...
Щоб вирівняти всі поля для вводу, створіть новий набір правил, який націлює всі елементи `input` та `label` в межах елемента `.info` і встановіть властивість `display` на `inline-block`.
...
Ви повинні надати елементу `label` властивість `text-align` зі значенням `right`.
