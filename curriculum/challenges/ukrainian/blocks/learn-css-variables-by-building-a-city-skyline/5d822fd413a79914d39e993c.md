...
У класі `sky` медіазапиту змініть два значення кольору `#ffcf33` на `#ccc`, `#ffff66` на `#445` і `#bbeeff` на `#223`. Потім ви можете змінити розмір вікна, щоб побачити, як фон змінює кольори.

# --hints--

Ви маєте змінити перші значення кольору з `#ffcf33` на `#ccc`.
...
Ви маєте змінити друге значення кольору з `#ffff66` на `#445`.
...
Ви маєте змінити третє значення кольору з `#bbeeff` на `#223`.
