...
太棒了。 Your red marker is looking good. Now all you need to do is add the caps and sleeves to your other markers.

爲綠色和藍色彩筆添加筆蓋和筆筒。 你只需從紅色筆中複製 `div` 元素，並將其粘貼到其他兩支筆中。

# --hints--

你的綠色筆 `div` 應該包含兩個 `div` 元素。
