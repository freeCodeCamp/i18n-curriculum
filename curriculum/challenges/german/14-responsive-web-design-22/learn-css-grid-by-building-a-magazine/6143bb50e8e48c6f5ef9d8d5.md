...
Erstelle innerhalb deines `aside`-Elements zwei `img`-Elemente, ein `blockquote`-Element, und ein drittes `img`-Element. Gib dem `blockquote` Element eine `class` von `image-quote`.
...
Deine neuen Elemente sollten in der richtigen Reihenfolge sein.
