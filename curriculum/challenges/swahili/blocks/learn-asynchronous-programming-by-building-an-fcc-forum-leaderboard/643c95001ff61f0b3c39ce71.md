...
Ndani ya njia ya `map`, tengeneza upya vigezo vifuatavyo kutoka kwa kitu cha `item`:
...
Unapaswa kutengeneza upya vigezo vya `id`, `title`, `views`, `posts_count`, `slug`, `posters`, `category_id`, `bumped_at` kutoka kwa kitu cha `item`.
