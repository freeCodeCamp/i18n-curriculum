...
A parte il `Go Premium` CTA, il resto del contenuto è in un `div`. Questo rende la griglia CSS una buona opzione per disporre tutto.

Aggiungi le classi `grid`, `grid-rows-[auto_auto_auto_1fr]` e `gap-y-2` al `div` che racchiude gli elementi `h2`, `p` e `ul`.

# --hints--

Il tuo elemento `div` che racchiude gli elementi `h2`, `p` e `ul` dovrebbe avere la classe `grid`.
...
Il tuo elemento `div` che racchiude gli elementi `h2`, `p` e `ul` dovrebbe avere la classe `grid-rows-[auto_auto_auto_1fr]`.
...
Il tuo elemento `div` che racchiude gli elementi `h2`, `p` e `ul` dovrebbe avere la classe `gap-y-2`.
