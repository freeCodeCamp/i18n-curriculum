...
Переходимо до наступної будівлі! Створіть нову змінну властивості з назвою `--window-color3` у `:root` і надайте їй значення `#d98cb3`. Це буде вторинний колір для рожевих будівель.

# --hints--

Ви повинні визначити нову змінну властивості `--window-color3`.
