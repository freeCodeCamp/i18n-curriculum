...
Ili kutekeleza utendakazi wa kichujio, utahitaji kitendakazi. Tangaza kitendakazi tupu kinachoitwa `instrumentCards` kinachopokea kigezo kimoja.

# --hints--

Unapaswa kuwa na kitendakazi kinachoitwa `instrumentCards`.

```js
assert.isFunction(instrumentCards);
```

Kitendakazi chako cha `instrumentCards` kinapaswa kupokea kigezo kimoja.
