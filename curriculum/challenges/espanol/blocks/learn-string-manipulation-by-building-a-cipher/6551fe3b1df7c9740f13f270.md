...
Algunos aspectos clave para el nombramiento de variables en Python son:
...
Elimina ambas llamadas a `print()` y declara otra variable llamada `alphabet`. Asigna la cadena `'abcdefghijklmnopqrstuvwxyz'` a esta variable.
