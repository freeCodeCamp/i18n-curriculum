...
На цьому етапі елементи розташовані занадто близько один до одного. Додайте `gap-8`, щоб створити між ними трохи простору, і використайте `mt-16`, щоб трохи відсунути їх вниз від верху.

# --hints--

Вашому елементу `div` слід додати клас `gap-8`.
...
Вашому елементу `div` слід додати клас `mt-16`.
