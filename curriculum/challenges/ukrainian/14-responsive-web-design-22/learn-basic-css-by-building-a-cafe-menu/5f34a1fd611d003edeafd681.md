...
На цьому коричневому фоні важко читати текст. Change the `body` element's background color to `burlywood` so it has some color but you are still be able to read the text.
...
Елемент `body` повинен мати фон `burlywood`.
