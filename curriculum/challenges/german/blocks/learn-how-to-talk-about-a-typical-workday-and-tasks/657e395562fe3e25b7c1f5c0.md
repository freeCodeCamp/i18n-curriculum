...
`Danger` ist eine Situation, in der dir etwas Schlimmes passieren kann, oder du dein Leben in Gefahr bringst. You can say that in situations like these, you are `in danger`. For example:
