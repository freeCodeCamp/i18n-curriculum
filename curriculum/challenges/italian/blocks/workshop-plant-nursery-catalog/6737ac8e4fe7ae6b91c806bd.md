...
Sempre all'interno della tua funzione, aggiungi l'oggetto `prettyPolly` al tuo insieme.

# --hints--

Dovresti usare il metodo `add` per aggiungere l'oggetto `prettyPolly` al tuo insieme all'interno della funzione `displayPlantsSet`.
