...
Після вашого циклу while потрібно вставити поточне значення. Пам’ятайте, що цикл завершується, коли `j` виходить за межі масиву або коли значення в `j` менше за ваше поточне значення.

Використайте оператор присвоєння, щоб вставити поточне значення у правильний індекс.

# --hints--

Ви повинні призначити `currValue` індексу `j + 1`.
