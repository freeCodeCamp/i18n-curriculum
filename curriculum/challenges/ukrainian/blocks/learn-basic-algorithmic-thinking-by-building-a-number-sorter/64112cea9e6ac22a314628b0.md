...
Після того, як ваш цикл `for` завершиться, потрібно повернути масив. Потім ви зможете побачити зміну `Output`, коли знову натиснете на кнопку `Sort`.

# --hints--

Вам слід `return` `array`.
