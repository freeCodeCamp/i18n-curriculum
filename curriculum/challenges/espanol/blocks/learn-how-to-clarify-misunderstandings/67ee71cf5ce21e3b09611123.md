...
`Affect` means to cause a change or have an impact on something. Por ejemplo:
...
`Just the menu` means only the menu is involved, not any other part of the software. Por ejemplo:
