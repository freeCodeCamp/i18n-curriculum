...
Kwa hiyo, uhuishaji wako ni laini zaidi na gurudumu lako la Ferris limekamilika.

# --hints--

Unapaswa kuunda kichaguzi kipya cha `75%` katika sheria yako ya `@keyframes cabins`.
...
Kichaguzi chako cha `75%` kinapaswa kuwa na `background-color` iliyowekwa kuwa `yellow`.
