...
Для першого додайте `label` з атрибутом `className` зі значенням `label`, атрибутом `htmlFor` зі значенням `pac` та текстом `PAC`, потім input з атрибутом `id` зі значенням `pac`, атрибутом `className` зі значенням `input` та `type` зі значенням `number`.
...
Ваш перший елемент `div` з `className` `form-group` має містити `label` з атрибутом `htmlFor` зі значенням `pac`, `className` `label` і текстом `PAC`.
...
Ваш перший елемент `div` з `className` `form-group` має містити `input` з `className` `input`, `id` `pac` і `type` `number`.
...
Ваш другий елемент `div` з `className` `form-group` має містити `label` з атрибутом `htmlFor` зі значенням `sho`, `className` `label` і текстом `SHO`.
...
Ваш другий елемент `div` з `className` `form-group` має містити `input` з `id` `sho`, `className` `input` і `type` `number`.
