...
El núcleo de un polígono se define por el conjunto de puntos desde los cuales el límite entero del polígono es visible. Definimos un polígono polar como un polígono para el cual el origen es estrictamente contenido dentro de su núcleo.
