...
Тепер зробіть те саме для решти властивостей. Використайте функцію `getElement`, щоб вибрати кожну з них:
...
Ви повинні отримати доступ до `multipleCardsBtn`, використовуючи метод `getElement` і передаючи `#btn-multiple-cards`.
...
Ви повинні отримати доступ до `multipleCard`, використовуючи метод `getElement` і передаючи `.multiple_card`.
...
Ви повинні отримати доступ до `title`, використовуючи метод `getElement` і передаючи `.title`.
...
Ви повинні отримати доступ до `newReadingBtn`, використовуючи метод `getElement` і передаючи `.btn_reveal`.
...
Ви повинні отримати доступ до `fortuneContainer`, використовуючи метод `getElement` і передаючи `.fortune_container`.
...
Ви повинні отримати доступ до `fortuneDescription`, використовуючи метод `getElement` і передаючи `.fortune_description`.
...
Ви повинні отримати доступ до `headerTitle`, використовуючи метод `getElement` і передаючи `.header_title`.
...
Ви повинні отримати доступ до `subTitle`, використовуючи метод `getElement` і передаючи `.sub_title`.
...
Ви повинні отримати доступ до `cardTitle`, використовуючи метод `getElement` і передаючи `.desc_title`.
...
Ви повинні отримати доступ до `description`, використовуючи метод `getElement` і передаючи `.description`.
...
Ви повинні отримати доступ до `text`, використовуючи метод `getElement` і передаючи `.text`.
