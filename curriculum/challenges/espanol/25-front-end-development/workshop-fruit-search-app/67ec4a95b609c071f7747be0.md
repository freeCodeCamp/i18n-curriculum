...
Dentro del elemento `form`, agrega un elemento `etiqueta`. El elemento `etiqueta` debe tener el texto `Search for fruits:` y un atributo `htmlFor` con el valor de `"search-input"`.

# --hints--

Debe haber un elemento `etiqueta` dentro del elemento `form`.
...
El elemento `etiqueta` debe tener un atributo `htmlFor` con el valor de `"search-input"`.
...
El elemento `etiqueta` debe tener el texto `Search for fruits:`.
